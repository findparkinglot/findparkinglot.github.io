 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xd(n){return Il(void 0,n)}function Il(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!Ld(t)||(n[t]=Il(n[t],e[t]));return n}function Ld(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qd="FirebaseError";class Jt extends Error{constructor(e,t,o){super(t),this.code=e,this.customData=o,this.name=qd,Object.setPrototypeOf(this,Jt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Nl.prototype.create)}}class Nl{constructor(e,t,o){this.service=e,this.serviceName=t,this.errors=o}create(e,...t){const o=t[0]||{},i=`${this.service}/${e}`,s=this.errors[e],r=s?Jd(s,o):"Error",l=`${this.serviceName}: ${r} (${i}).`;return new Jt(i,l,o)}}function Jd(n,e){return n.replace($d,(t,o)=>{const i=e[o];return i!=null?String(i):`<${o}?>`})}const $d=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bn=new Ol("@firebase/app"),B1="@firebase/app-compat",w1="@firebase/analytics-compat",I1="@firebase/analytics",S1="@firebase/app-check-compat",k1="@firebase/app-check",D1="@firebase/auth",T1="@firebase/auth-compat",N1="@firebase/database",M1="@firebase/data-connect",R1="@firebase/database-compat",O1="@firebase/functions",x1="@firebase/functions-compat",L1="@firebase/installations",F1="@firebase/installations-compat",H1="@firebase/messaging",z1="@firebase/messaging-compat",V1="@firebase/performance",j1="@firebase/performance-compat",W1="@firebase/remote-config",G1="@firebase/remote-config-compat",K1="@firebase/storage",Q1="@firebase/storage-compat",Y1="@firebase/firestore",X1="@firebase/ai",q1="@firebase/firestore-compat",J1="firebase",$1="12.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pi="[DEFAULT]",Z1={[vi]:"fire-core",[B1]:"fire-core-compat",[I1]:"fire-analytics",[w1]:"fire-analytics-compat",[k1]:"fire-app-check",[S1]:"fire-app-check-compat",[D1]:"fire-auth",[T1]:"fire-auth-compat",[N1]:"fire-rtdb",[M1]:"fire-data-connect",[R1]:"fire-rtdb-compat",[O1]:"fire-fn",[x1]:"fire-fn-compat",[L1]:"fire-iid",[F1]:"fire-iid-compat",[H1]:"fire-fcm",[z1]:"fire-fcm-compat",[V1]:"fire-perf",[j1]:"fire-perf-compat",[W1]:"fire-rc",[G1]:"fire-rc-compat",[K1]:"fire-gcs",[Q1]:"fire-gcs-compat",[Y1]:"fire-fst",[q1]:"fire-fst-compat",[X1]:"fire-vertex","fire-js":"fire-js",[J1]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const s2=$1;function Fl(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const o={name:Pi,automaticDataCollectionEnabled:!0,...e},i=o.name;if(typeof i!="string"||!i)throw In.create("bad-app-name",{appName:String(i)});if(t||(t=kl()),!t)throw In.create("no-options");const s=Ao.get(i);if(s){if(go(t,s.options)&&go(o,s.config))return s;throw In.create("duplicate-app",{appName:i})}const r=new a1(i);for(const a of Ci.values())r.addComponent(a);const l=new i2(t,o,r);return Ao.set(i,l),l}function r2(n=Pi){const e=Ao.get(n);if(!e&&n===Pi&&kl())return Fl();if(!e)throw In.create("no-app",{appName:n});return e}function it(n,e,t){var r;let o=(r=Z1[n])!=null?r:n;t&&(o+=`-${t}`);const i=o.match(/\s|\//),s=e.match(/\s|\//);if(i||s){const l=[`Unable to register library "${o}" with version "${e}":`];i&&l.push(`library name "${o}" contains illegal characters (whitespace or "/")`),i&&s&&l.push("and"),s&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),bn.warn(l.join(" "));return}_o(new Ht(`${o}-version`,()=>({library:o,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const l2="firebase-heartbeat-database",a2=1,zt="firebase-heartbeat-store";let si=null;function Hl(){return si||(si=v1(l2,a2,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(zt)}catch(t){}}}}).catch(n=>{throw In.create("idb-open",{originalErrorMessage:n.message})})),si}async function c2(n){try{const t=(await Hl()).transaction(zt),o=await t.objectStore(zt).get(zl(n));return await t.done,o}catch(e){if(e instanceof Jt)bn.warn(e.message);else{const t=In.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});bn.warn(t.message)}}}async function hr(n,e){try{const o=(await Hl()).transaction(zt,"readwrite");await o.objectStore(zt).put(e,zl(n)),await o.done}catch(t){if(t instanceof Jt)bn.warn(t.message);else{const o=In.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});bn.warn(o.message)}}}function zl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jl=function(n){try{if(typeof window!="undefined"&&typeof window[n]!="undefined"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new g2(e)}}catch(e){}return new A2},Vn=jl("localStorage"),_2=jl("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class M2{constructor(e,t,o){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=o,this.auth_=null,this.auth_=o.getImmediate({optional:!0}),this.auth_||o.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(Se("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,o)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Oe(e)}}class co{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}co.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es="5",Ql="v",Yl="s",Xl="r",ql="f",Jl=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,$l="ls",Zl="p",Ei="ac",ea="websocket",na="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xo{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const o=new z(Wn,e),i=new z(Wn,t);return this.compare(o,i)!==0}minPost(){return z.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ro;class ma extends xo{static get __EMPTY_NODE(){return ro}static set __EMPTY_NODE(e){ro=e}compare(e,t){return qn(e.name,t.name)}isDefinedOn(e){throw pt("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return z.MIN}maxPost(){return new z(kn,ro)}makePost(e,t){return v(typeof e=="string","KeyIndex indexValue must always be a string."),new z(e,ro)}toString(){return".key"}}const jn=new ma;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function y0(n,e){return qn(n.name,e.name)}function rs(n,e){return qn(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ya,ba;function g0(n){ya=n}function A0(n){ba=n}class _0 extends xo{compare(e,t){const o=e.node.getPriority(),i=t.node.getPriority(),s=o.compareTo(i);return s===0?qn(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return z.MIN}maxPost(){return new z(kn,new Ce("[PRIORITY-POST]",ba))}makePost(e,t){const o=ya(e);return new z(t,new Ce("[PRIORITY-POST]",o))}toString(){return".priority"}}const he=new _0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let It;class M{static get EMPTY_NODE(){return It||(It=new M(new Fe(rs),null,fn.Default))}constructor(e,t,o){this.children_=e,this.priorityNode_=t,this.indexMap_=o,this.lazyHash_=null,this.priorityNode_&&fa(this.priorityNode_),this.children_.isEmpty()&&v(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}isLeafNode(){return!1}getPriority(){return this.priorityNode_||It}updatePriority(e){return this.children_.isEmpty()?this:new M(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const t=this.children_.get(e);return t===null?It:t}}getChild(e){const t=F(e);return t===null?this:this.getImmediateChild(t).getChild(ae(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,t){if(v(t,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(t);{const o=new z(e,t);let i,s;t.isEmpty()?(i=this.children_.remove(e),s=this.indexMap_.removeFromIndexes(o,this.children_)):(i=this.children_.insert(e,t),s=this.indexMap_.addToIndexes(o,this.children_));const r=i.isEmpty()?It:this.priorityNode_;return new M(i,r,s)}}updateChild(e,t){const o=F(e);if(o===null)return t;{v(F(e)!==".priority"||Dn(e)===1,".priority must be the last token in a path");const i=this.getImmediateChild(o).updateChild(ae(e),t);return this.updateImmediateChild(o,i)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let o=0,i=0,s=!0;if(this.forEachChild(he,(r,l)=>{t[r]=l.val(e),o++,s&&M.INTEGER_REGEXP_.test(r)?i=Math.max(i,Number(r)):s=!1}),!e&&s&&i<2*o){const r=[];for(const l in t)r[l]=t[l];return r}else return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+pa(this.getPriority().val())+":"),this.forEachChild(he,(t,o)=>{const i=o.hash();i!==""&&(e+=":"+t+":"+i)}),this.lazyHash_=e===""?"":Wl(e)}return this.lazyHash_}getPredecessorChildName(e,t,o){const i=this.resolveIndex_(o);if(i){const s=i.getPredecessorKey(new z(e,t));return s?s.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const o=t.minKey();return o&&o.name}else return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new z(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const o=t.maxKey();return o&&o.name}else return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new z(t,this.children_.get(t)):null}forEachChild(e,t){const o=this.resolveIndex_(e);return o?o.inorderTraversal(i=>t(i.name,i.node)):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const o=this.resolveIndex_(t);if(o)return o.getIteratorFrom(e,i=>i);{const i=this.children_.getIteratorFrom(e.name,z.Wrap);let s=i.peek();for(;s!=null&&t.compare(s,e)<0;)i.getNext(),s=i.peek();return i}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const o=this.resolveIndex_(t);if(o)return o.getReverseIteratorFrom(e,i=>i);{const i=this.children_.getReverseIteratorFrom(e.name,z.Wrap);let s=i.peek();for(;s!=null&&t.compare(s,e)>0;)i.getNext(),s=i.peek();return i}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===eo?-1:0}withIndex(e){if(e===jn||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new M(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===jn||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority()))if(this.children_.count()===t.children_.count()){const o=this.getIterator(he),i=t.getIterator(he);let s=o.getNext(),r=i.getNext();for(;s&&r;){if(s.name!==r.name||!s.node.equals(r.node))return!1;s=o.getNext(),r=i.getNext()}return s===null&&r===null}else return!1;else return!1}}resolveIndex_(e){return e===jn?null:this.indexMap_.get(e.toString())}}M.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class C0 extends M{constructor(){super(new Fe(rs),M.EMPTY_NODE,fn.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return M.EMPTY_NODE}isEmpty(){return!1}}const eo=new C0;Object.defineProperties(z,{MIN:{value:new z(Wn,M.EMPTY_NODE)},MAX:{value:new z(kn,eo)}});ma.__EMPTY_NODE=M.EMPTY_NODE;Ce.__childrenNodeConstructor=M;b0(eo);A0(eo);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ls extends xo{constructor(e){super(),this.indexPath_=e,v(!H(e)&&F(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const o=this.extractChild(e.node),i=this.extractChild(t.node),s=o.compareTo(i);return s===0?qn(e.name,t.name):s}makePost(e,t){const o=Ee(e),i=M.EMPTY_NODE.updateChild(this.indexPath_,o);return new z(t,i)}maxPost(){const e=M.EMPTY_NODE.updateChild(this.indexPath_,eo);return new z(kn,e)}toString(){return jt(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class E0 extends xo{compare(e,t){const o=e.node.compareTo(t.node);return o===0?qn(e.name,t.name):o}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return z.MIN}maxPost(){return z.MAX}makePost(e,t){const o=Ee(e);return new z(t,o)}toString(){return".value"}}const ga=new E0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Aa(n){return{type:"value",snapshotNode:n}}function at(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function Wt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Gt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function B0(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class as{constructor(e){this.index_=e}updateChild(e,t,o,i,s,r){v(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(t);return l.getChild(i).equals(o.getChild(i))&&l.isEmpty()===o.isEmpty()||(r!=null&&(o.isEmpty()?e.hasChild(t)?r.trackChildChange(Wt(t,l)):v(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?r.trackChildChange(at(t,o)):r.trackChildChange(Gt(t,o,l))),e.isLeafNode()&&o.isEmpty())?e:e.updateImmediateChild(t,o).withIndex(this.index_)}updateFullNode(e,t,o){return o!=null&&(e.isLeafNode()||e.forEachChild(he,(i,s)=>{t.hasChild(i)||o.trackChildChange(Wt(i,s))}),t.isLeafNode()||t.forEachChild(he,(i,s)=>{if(e.hasChild(i)){const r=e.getImmediateChild(i);r.equals(s)||o.trackChildChange(Gt(i,s,r))}else o.trackChildChange(at(i,s))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?M.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bo{constructor(e,t,o){this.path=e,this.affectedTree=t,this.revert=o,this.type=rn.ACK_USER_WRITE,this.source=ds()}operationForChild(e){if(H(this.path)){if(this.affectedTree.value!=null)return v(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new ee(e));return new Bo(J(),t,this.revert)}}else return v(F(this.path)===e,"operationForChild called for unrelated child."),new Bo(ae(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qt{constructor(e,t){this.source=e,this.path=t,this.type=rn.LISTEN_COMPLETE}operationForChild(e){return H(this.path)?new Qt(this.source,J()):new Qt(this.source,ae(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gn{constructor(e,t,o){this.source=e,this.path=t,this.snap=o,this.type=rn.OVERWRITE}operationForChild(e){return H(this.path)?new Gn(this.source,J(),this.snap.getImmediateChild(e)):new Gn(this.source,ae(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ct{constructor(e,t,o){this.source=e,this.path=t,this.children=o,this.type=rn.MERGE}operationForChild(e){if(H(this.path)){const t=this.children.subtree(new ee(e));return t.isEmpty()?null:t.value?new Gn(this.source,J(),t.value):new ct(this.source,J(),t)}else return v(F(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ct(this.source,ae(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lo(n,e){return{eventCache:n,serverCache:e}}function Mt(n,e,t,o){return Lo(new Kn(e,t,o),n.serverCache)}function va(n,e,t,o){return Lo(n.eventCache,new Kn(e,t,o))}function Ii(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Qn(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ms(n,e){return Ba(e,n)}function z0(n,e,t,o,i){v(o>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:o,visible:i}),i&&(n.visibleWrites=Rt(n.visibleWrites,e,t)),n.lastWriteId=o}function V0(n,e,t,o){v(o>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:o,visible:!0}),n.visibleWrites=Si(n.visibleWrites,e,t),n.lastWriteId=o}function j0(n,e){for(let t=0;t<n.allWrites.length;t++){const o=n.allWrites[t];if(o.writeId===e)return o}return null}function W0(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);v(t>=0,"removeWrite called with nonexistent writeId.");const o=n.allWrites[t];n.allWrites.splice(t,1);let i=o.visible,s=!1,r=n.allWrites.length-1;for(;i&&r>=0;){const l=n.allWrites[r];l.visible&&(r>=t&&G0(l,o.path)?i=!1:qe(o.path,l.path)&&(s=!0)),r--}if(i){if(s)return K0(n),!0;if(o.snap)n.visibleWrites=Mr(n.visibleWrites,o.path);else{const l=o.children;ke(l,a=>{n.visibleWrites=Mr(n.visibleWrites,ue(o.path,a))})}return!0}else return!1}function G0(n,e){if(n.snap)return qe(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&qe(ue(n.path,t),e))return!0;return!1}function K0(n){n.visibleWrites=Ca(n.allWrites,Q0,J()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function Q0(n){return n.visible}function Ca(n,e,t){let o=ln.empty();for(let i=0;i<n.length;++i){const s=n[i];if(e(s)){const r=s.path;let l;if(s.snap)qe(t,r)?(l=Le(t,r),o=Rt(o,l,s.snap)):qe(r,t)&&(l=Le(r,t),o=Rt(o,J(),s.snap.getChild(l)));else if(s.children){if(qe(t,r))l=Le(t,r),o=Si(o,l,s.children);else if(qe(r,t))if(l=Le(r,t),H(l))o=Si(o,J(),s.children);else{const a=lt(s.children,F(l));if(a){const d=a.getChild(ae(l));o=Rt(o,J(),d)}}}else throw pt("WriteRecord should have .snap or .children")}}return o}function Ua(n,e,t,o,i){if(!o&&!i){const s=Jn(n.visibleWrites,e);if(s!=null)return s;{const r=Sn(n.visibleWrites,e);if(Di(r))return t;if(t==null&&!ki(r,J()))return null;{const l=t||M.EMPTY_NODE;return dt(r,l)}}}else{const s=Sn(n.visibleWrites,e);if(!i&&Di(s))return t;if(!i&&t==null&&!ki(s,J()))return null;{const r=function(d){return(d.visible||i)&&(!o||!~o.indexOf(d.writeId))&&(qe(d.path,e)||qe(e,d.path))},l=Ca(n.allWrites,r,e),a=t||M.EMPTY_NODE;return dt(l,a)}}}function Y0(n,e,t){let o=M.EMPTY_NODE;const i=Jn(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(he,(s,r)=>{o=o.updateImmediateChild(s,r)}),o;if(t){const s=Sn(n.visibleWrites,e);return t.forEachChild(he,(r,l)=>{const a=dt(Sn(s,new ee(r)),l);o=o.updateImmediateChild(r,a)}),Rr(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}else{const s=Sn(n.visibleWrites,e);return Rr(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}}function X0(n,e,t,o,i){v(o||i,"Either existingEventSnap or existingServerSnap must exist");const s=ue(e,t);if(ki(n.visibleWrites,s))return null;{const r=Sn(n.visibleWrites,s);return Di(r)?i.getChild(t):dt(r,i.getChild(t))}}function q0(n,e,t,o){const i=ue(e,t),s=Jn(n.visibleWrites,i);if(s!=null)return s;if(o.isCompleteForChild(t)){const r=Sn(n.visibleWrites,i);return dt(r,o.getNode().getImmediateChild(t))}else return null}function J0(n,e){return Jn(n.visibleWrites,e)}function $0(n,e,t,o,i,s,r){let l;const a=Sn(n.visibleWrites,e),d=Jn(a,J());if(d!=null)l=d;else if(t!=null)l=dt(a,t);else return[];if(l=l.withIndex(r),!l.isEmpty()&&!l.isLeafNode()){const m=[],u=r.getCompare(),f=s?l.getReverseIteratorFrom(o,r):l.getIteratorFrom(o,r);let b=f.getNext();for(;b&&m.length<i;)u(b,o)!==0&&m.push(b),b=f.getNext();return m}else return[]}function Z0(){return{visibleWrites:ln.empty(),allWrites:[],lastWriteId:-1}}function wo(n,e,t,o){return Ua(n.writeTree,n.treePath,e,t,o)}function ps(n,e){return Y0(n.writeTree,n.treePath,e)}function Or(n,e,t,o){return X0(n.writeTree,n.treePath,e,t,o)}function Io(n,e){return J0(n.writeTree,ue(n.treePath,e))}function eh(n,e,t,o,i,s){return $0(n.writeTree,n.treePath,e,t,o,i,s)}function fs(n,e,t){return q0(n.writeTree,n.treePath,e,t)}function Ea(n,e){return Ba(ue(n.treePath,e),n.writeTree)}function Ba(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ps{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Ps(t)}node(){return this.node_}}class Cs{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=ue(this.path_,e);return new Cs(this.syncTree_,t)}node(){return gs(this.syncTree_,this.path_)}}const Oh=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},Wr=function(n,e,t){if(!n||typeof n!="object")return n;if(v(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return xh(n[".sv"],e,t);if(typeof n[".sv"]=="object")return Lh(n[".sv"],e);v(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},xh=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:v(!1,"Unexpected server value: "+n)}},Lh=function(n,e,t){n.hasOwnProperty("increment")||v(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const o=n.increment;typeof o!="number"&&v(!1,"Unexpected increment value: "+o);const i=e.node();if(v(i!==null&&typeof i!="undefined","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return o;const r=i.getValue();return typeof r!="number"?o:r+o},xa=function(n,e,t,o){return Us(e,new Cs(t,n),o)},La=function(n,e,t){return Us(n,new Ps(e),t)};function Us(n,e,t){const o=n.getPriority().val(),i=Wr(o,e.getImmediateChild(".priority"),t);let s;if(n.isLeafNode()){const r=n,l=Wr(r.getValue(),e,t);return l!==r.getValue()||i!==r.getPriority().val()?new Ce(l,Ee(i)):n}else{const r=n;return s=r,i!==r.getPriority().val()&&(s=s.updatePriority(new Ce(i))),r.forEachChild(he,(l,a)=>{const d=Us(a,e.getImmediateChild(l),t);d!==a&&(s=s.updateImmediateChild(l,d))}),s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vh=/[\[\].#$\/\u0000-\u001F\u007F]/,jh=/[\[\].#$\u0000-\u001F\u007F]/,hi=10*1024*1024,ws=function(n){return typeof n=="string"&&n.length!==0&&!Vh.test(n)},Va=function(n){return typeof n=="string"&&n.length!==0&&!jh.test(n)},Wh=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Va(n)},Oi=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!$i(n)||n&&typeof n=="object"&&un(n,".sv")},ja=function(n,e,t,o){o&&e===void 0||jo(Ro(n,"value"),e,t)},jo=function(n,e,t){const o=t instanceof ee?new a0(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+Hn(o));if(typeof e=="function")throw new Error(n+"contains a function "+Hn(o)+" with contents = "+e.toString());if($i(e))throw new Error(n+"contains "+e.toString()+" "+Hn(o));if(typeof e=="string"&&e.length>hi/3&&Oo(e)>hi)throw new Error(n+"contains a string greater than "+hi+" utf8 bytes "+Hn(o)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,s=!1;if(ke(e,(r,l)=>{if(r===".value")i=!0;else if(r!==".priority"&&r!==".sv"&&(s=!0,!ws(r)))throw new Error(n+" contains an invalid key ("+r+") "+Hn(o)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);c0(o,r),jo(n,l,o),d0(o)}),i&&s)throw new Error(n+' contains ".value" child '+Hn(o)+" in addition to actual children.")}},Gh=function(n,e){let t,o;for(t=0;t<e.length;t++){o=e[t];const s=jt(o);for(let r=0;r<s.length;r++)if(!(s[r]===".priority"&&r===s.length-1)){if(!ws(s[r]))throw new Error(n+"contains an invalid key ("+s[r]+") in path "+o.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(l0);let i=null;for(t=0;t<e.length;t++){if(o=e[t],i!==null&&qe(i,o))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+o.toString());i=o}},Kh=function(n,e,t,o){const i=Ro(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const s=[];ke(e,(r,l)=>{const a=new ee(r);if(jo(i,l,ue(t,a)),os(a)===".priority"&&!Oi(l))throw new Error(i+"contains an invalid value for '"+a.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");s.push(a)}),Gh(i,s)},Is=function(n,e,t,o){if(!Va(t))throw new Error(Ro(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Qh=function(n,e,t,o){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Is(n,e,t)},Ss=function(n,e){if(F(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},Yh=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!ws(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!Wh(t))throw new Error(Ro(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xh{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Wo(n,e){let t=null;for(let o=0;o<e.length;o++){const i=e[o],s=i.getPath();t!==null&&!is(s,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:s}),t.events.push(i)}t&&n.eventLists_.push(t)}function Wa(n,e,t){Wo(n,t),Ga(n,o=>is(o,e))}function an(n,e,t){Wo(n,t),Ga(n,o=>qe(o,e)||qe(e,o))}function Ga(n,e){n.recursionDepth_++;let t=!0;for(let o=0;o<n.eventLists_.length;o++){const i=n.eventLists_[o];if(i){const s=i.path;e(s)?(qh(n.eventLists_[o]),n.eventLists_[o]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function qh(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const o=t.getEventRunner();Tt&&Se("event: "+t.toString()),ft(o)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uu="FIREBASE_DATABASE_EMULATOR_HOST",Hi={};let Eu=!1;function Bu(n,e,t,o){const i=e.lastIndexOf(":"),s=e.substring(0,i),r=Rl(s);n.repoInfo_=new ta(e,r,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),o&&(n.authTokenProvider_=o)}function wu(n,e,t,o,i){let s=o||n.options.databaseURL;s===void 0&&(n.options.projectId||gn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Se("Using default host for project ",n.options.projectId),s=`${n.options.projectId}-default-rtdb.firebaseio.com`);let r=Qr(s,i),l=r.repoInfo,a;typeof process!="undefined"&&pr&&(a=pr[Uu]),a?(s=`http://${a}?ns=${l.namespace}`,r=Qr(s,i),l=r.repoInfo):r.repoInfo.secure;const d=new M2(n.name,n.options,e);Yh("Invalid Firebase Database URL",r),H(r.path)||gn("Database URL must point to the root of a Firebase Database (not including a child path).");const m=Su(l,n,d,new N2(n,t));return new ku(m,n)}function Iu(n,e){const t=Hi[e];(!t||t[n.key]!==n)&&gn(`Database ${e}(${n.repoInfo_}) has already been deleted.`),ru(n),delete t[n.key]}function Su(n,e,t,o){let i=Hi[e.name];i||(i={},Hi[e.name]=i);let s=i[n.toURLString()];return s&&gn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new Zh(n,Eu,t,o),i[n.toURLString()]=s,s}class ku{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(eu(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Rn(this._repo,J())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Iu(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&gn("Cannot call "+e+" on a deleted database.")}}function Du(n=r2(),e){const t=n2(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const o=Wd("database");o&&Tu(t,...o)}return t}function Tu(n,e,t,o={}){n=Xn(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,s=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&go(o,s.repoInfo_.emulatorOptions))return;gn("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let r;if(s.repoInfo_.nodeAdmin)o.mockUserToken&&gn('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new co(co.OWNER);else if(o.mockUserToken){const l=typeof o.mockUserToken=="string"?o.mockUserToken:Gd(o.mockUserToken,n.app.options.projectId);r=new co(l)}Rl(e)&&i1(e),Bu(s,i,o,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
