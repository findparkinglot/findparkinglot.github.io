...
`],description:["2023/6/1 重新開放17處坡度較陡停車場"],styleUrl:["#icon-1538-757575-labelson"],Point:[{coordinates:[`
          ...
          `]}]},{name:["(80/h)客限-板橋凱撒大飯店"],description:['<img src="https://mymaps.usercontent.google.com/hostedimage/m/*/3AE5a_GwnTL8ueDTqRT_QhtkfRb1LPl7FWYZw94PN5L6tw9-mRS3lx4L7WakZPLwQDvUztbRxop6oP-6DMCRqJka8Xd_9cUkcM9WFXG6BLC-hUV_fGrMGxut8Qkr4oWd6MGJ7G-Cb4T3t8n8aAktSeMcYyX-oB-Re_RCKAd263KJsGhiz9nyK1sMf9Z4cSEKioMpNyuGJzOfAA404aB7P1eInE07cQYJEzeWh8XjfYYLyfmZMzvdiZV8Hq6Fj1wA?fife=s16383" height="200" width="auto" /><br><br>感謝hoha5432提供<br>汽車費率 80h 按鈕取票 2 格 或以上 <br>目前對外說不開放臨停，僅供住宿與用餐客人停放。費用沒有公開，根據個人繳費經驗推估約 80h。<br>官網寫說「本飯店提供機車/汽車地下停車場(B2-B5) ，共220個車位。※B2停放機車（可供重型機車停靠，但如需要更大空間可改停靠汽車停車格）」但實際沒有機車格，而是只有大重停車格（為汽車格畫線切出）。  '],styleUrl:["#icon-1633-0288D1"],ExtendedData:[{Data:[{$:{name:"gx_media_links"},value:["https://mymaps.usercontent.google.com/hostedimage/m/*/3AE5a_GwnTL8ueDTqRT_QhtkfRb1LPl7FWYZw94PN5L6tw9-mRS3lx4L7WakZPLwQDvUztbRxop6oP-6DMCRqJka8Xd_9cUkcM9WFXG6BLC-hUV_fGrMGxut8Qkr4oWd6MGJ7G-Cb4T3t8n8aAktSeMcYyX-oB-Re_RCKAd263KJsGhiz9nyK1sMf9Z4cSEKioMpNyuGJzOfAA404aB7P1eInE07cQYJEzeWh8XjfYYLyfmZMzvdiZV8Hq6Fj1wA?fife=s16383"]}]}],Point:[{coordinates:[`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bd="FirebaseError";class Xt extends Error{constructor(e,t,o){super(t),this.code=e,this.customData=o,this.name=bd,Object.setPrototypeOf(this,Xt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,ll.prototype.create)}}class ll{constructor(e,t,o){this.service=e,this.serviceName=t,this.errors=o}create(e,...t){const o=t[0]||{},i=`${this.service}/${e}`,s=this.errors[e],r=s?gd(s,o):"Error",l=`${this.serviceName}: ${r} (${i}).`;return new Xt(i,l,o)}}function gd(n,e){return n.replace(Ad,(t,o)=>{const i=e[o];return i!=null?String(i):`<${o}?>`})}const Ad=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gd{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Kd(t)){const o=t.getImmediate();return`${o.library}/${o.version}`}else return null}).filter(t=>t).join(" ")}}function Kd(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ui="@firebase/app",Xs="0.14.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fn=new dl("@firebase/app"),Qd="@firebase/app-compat",Xd="@firebase/analytics-compat",Yd="@firebase/analytics",Jd="@firebase/app-check-compat",qd="@firebase/app-check",$d="@firebase/auth",Zd="@firebase/auth-compat",e1="@firebase/database",n1="@firebase/data-connect",t1="@firebase/database-compat",o1="@firebase/functions",i1="@firebase/functions-compat",s1="@firebase/installations",r1="@firebase/installations-compat",l1="@firebase/messaging",a1="@firebase/messaging-compat",c1="@firebase/performance",d1="@firebase/performance-compat",h1="@firebase/remote-config",u1="@firebase/remote-config-compat",p1="@firebase/storage",m1="@firebase/storage-compat",f1="@firebase/firestore",y1="@firebase/ai",b1="@firebase/firestore-compat",g1="firebase",A1="12.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pi="[DEFAULT]",_1={[ui]:"fire-core",[Qd]:"fire-core-compat",[Yd]:"fire-analytics",[Xd]:"fire-analytics-compat",[qd]:"fire-app-check",[Jd]:"fire-app-check-compat",[$d]:"fire-auth",[Zd]:"fire-auth-compat",[e1]:"fire-rtdb",[n1]:"fire-data-connect",[t1]:"fire-rtdb-compat",[o1]:"fire-fn",[i1]:"fire-fn-compat",[s1]:"fire-iid",[r1]:"fire-iid-compat",[l1]:"fire-fcm",[a1]:"fire-fcm-compat",[c1]:"fire-perf",[d1]:"fire-perf-compat",[h1]:"fire-rc",[u1]:"fire-rc-compat",[p1]:"fire-gcs",[m1]:"fire-gcs-compat",[f1]:"fire-fst",[b1]:"fire-fst-compat",[y1]:"fire-vertex","fire-js":"fire-js",[g1]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O1(n){fo(new xt("platform-logger",e=>new Gd(e),"PRIVATE")),fo(new xt("heartbeat",e=>new M1(e),"PRIVATE")),ot(ui,Xs,n),ot(ui,Xs,"esm2020"),ot("fire-js","")}O1("");var Zs={};const er="@firebase/database",nr="1.1.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O0(n,e){return Xn(n.name,e.name)}function qi(n,e){return Xn(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let jl,Gl;function F0(n){jl=n}function H0(n){Gl=n}class z0 extends Do{compare(e,t){const o=e.node.getPriority(),i=t.node.getPriority(),s=o.compareTo(i);return s===0?Xn(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return z.MIN}maxPost(){return new z(Bn,new me("[PRIORITY-POST]",Gl))}makePost(e,t){const o=jl(e);return new z(t,new me("[PRIORITY-POST]",o))}toString(){return".priority"}}const se=new z0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V0=Math.log(2);class W0{constructor(e){const t=s=>parseInt(Math.log(s)/V0,10),o=s=>parseInt(Array(s+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=o(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const go=function(n,e,t,o){n.sort(e);const i=function(a,d){const u=d-a;let h,m;if(u===0)return null;if(u===1)return h=n[a],m=t?t(h):h,new fe(m,h.node,fe.BLACK,null,null);{const b=parseInt(u/2,10)+a,g=i(a,b),U=i(b+1,d);return h=n[b],m=t?t(h):h,new fe(m,h.node,fe.BLACK,g,U)}},s=function(a){let d=null,u=null,h=n.length;const m=function(g,U){const D=h-g,B=h;h-=g;const V=i(D+1,B),T=n[D],W=t?t(T):T;b(new fe(W,T.node,U,null,V))},b=function(g){d?(d.left=g,d=g):(u=g,d=g)};for(let g=0;g<a.count;++g){const U=a.nextBitIsOne(),D=Math.pow(2,a.count-(g+1));U?m(D,fe.BLACK):(m(D,fe.BLACK),m(D,fe.RED))}return u},r=new W0(n.length),l=s(r);return new Ne(o||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $i extends Do{constructor(e){super(),this.indexPath_=e,A(!H(e)&&F(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const o=this.extractChild(e.node),i=this.extractChild(t.node),s=o.compareTo(i);return s===0?Xn(e.name,t.name):s}makePost(e,t){const o=be(e),i=R.EMPTY_NODE.updateChild(this.indexPath_,o);return new z(t,i)}maxPost(){const e=R.EMPTY_NODE.updateChild(this.indexPath_,qt);return new z(Bn,e)}toString(){return Ft(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K0 extends Do{compare(e,t){const o=e.node.compareTo(t.node);return o===0?Xn(e.name,t.name):o}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return z.MIN}maxPost(){return z.MAX}makePost(e,t){const o=be(e);return new z(t,o)}toString(){return".value"}}const Kl=new K0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _o(){return{value:null,children:new Map}}function Xl(n,e,t){if(H(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const o=F(e);n.children.has(o)||n.children.set(o,_o());const i=n.children.get(o);e=te(e),Xl(i,e,t)}}function gi(n,e,t){n.value!==null?t(e,n.value):$0(n,(o,i)=>{const s=new X(e.toString()+"/"+o);gi(i,s,t)})}function $0(n,e){n.children.forEach((t,o)=>{e(o,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo{constructor(e,t,o){this.path=e,this.affectedTree=t,this.revert=o,this.type=$e.ACK_USER_WRITE,this.source=ns()}operationForChild(e){if(H(this.path)){if(this.affectedTree.value!=null)return A(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new X(e));return new vo(Q(),t,this.revert)}}else return A(F(this.path)===e,"operationForChild called for unrelated child."),new vo(te(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function To(n,e){return{eventCache:n,serverCache:e}}function kt(n,e,t,o){return To(new jn(e,t,o),n.serverCache)}function Yl(n,e,t,o){return To(n.eventCache,new jn(e,t,o))}function Ai(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Gn(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eu(n){L1(B1),fo(new xt("database",(e,{instanceIdentifier:t})=>{const o=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return Xh(o,i,s,t)},"PUBLIC").setMultipleInstances(!0)),ot(er,nr,n),ot(er,nr,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
