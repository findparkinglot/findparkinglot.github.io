 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A=function(n,e){if(!n)throw ut(e)},ut=function(n){return new Error("Firebase Database ("+ol.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D1="firebase-heartbeat-database",T1=1,Ot="firebase-heartbeat-store";let Zo=null;function gl(){return Zo||(Zo=Gd(D1,T1,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Ot)}catch(t){}}}}).catch(n=>{throw Un.create("idb-open",{originalErrorMessage:n.message})})),Zo}async function M1(n){try{const t=(await gl()).transaction(Ot),o=await t.objectStore(Ot).get(Al(n));return await t.done,o}catch(e){if(e instanceof Qt)fn.warn(e.message);else{const t=Un.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});fn.warn(t.message)}}}async function er(n,e){try{const o=(await gl()).transaction(Ot,"readwrite");await o.objectStore(Ot).put(e,Al(n)),await o.done}catch(t){if(t instanceof Qt)fn.warn(t.message);else{const o=Un.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});fn.warn(o.message)}}}function Al(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N1=1024,R1=30;class x1{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new L1(t),this._heartbeatsCachePromise=this._storage.read().then(o=>(this._heartbeatsCache=o,o))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=nr();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(r=>r.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats.length>R1){const r=F1(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(o){fn.warn(o)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=nr(),{heartbeatsToSend:o,unsentEntries:i}=O1(this._heartbeatsCache.heartbeats),s=ho(JSON.stringify({version:2,heartbeats:o}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return fn.warn(t),""}}}function nr(){return new Date().toISOString().substring(0,10)}function O1(n,e=N1){const t=[];let o=n.slice();for(const i of n){const s=t.find(r=>r.agent===i.agent);if(s){if(s.dates.push(i.date),tr(t)>e){s.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),tr(t)>e){t.pop();break}o=o.slice(1)}return{heartbeatsToSend:t,unsentEntries:o}}class L1{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return gd()?Ad().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await M1(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return er(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return er(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function tr(n){return ho(JSON.stringify({version:2,heartbeats:n})).length}function F1(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let o=1;o<n.length;o++)n[o].date<t&&(t=n[o].date,e=o);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function H1(n){fo(new xt("platform-logger",e=>new Qd(e),"PRIVATE")),fo(new xt("heartbeat",e=>new x1(e),"PRIVATE")),ot(pi,$s,n),ot(pi,$s,"esm2020"),ot("fire-js","")}H1("");var or={};const ir="@firebase/database",sr="1.1.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class W1{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return hn(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o0{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,I1(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(o=>this.appCheck=o)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,o)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)==null||t.get().then(o=>o.addTokenListener(e))}notifyForInvalidToken(){De(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class i0{constructor(e,t,o){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=o,this.auth_=null,this.auth_=o.getImmediate({optional:!0}),this.auth_||o.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(Ce("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,o)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',De(e)}}class io{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}io.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ki="5",El="v",Il="s",Bl="r",Sl="f",wl=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,kl="ls",Dl="p",bi="ac",Tl="websocket",Ml="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r0{constructor(){this.counters_={}}incrementCounter(e,t=1){hn(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return ld(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _0=16384,v0=45e3;let yo=null;typeof MozWebSocket!="undefined"?yo=MozWebSocket:typeof WebSocket!="undefined"&&(yo=WebSocket);class Je{constructor(e,t,o,i,s,r,l){this.connId=e,this.applicationId=o,this.appCheckToken=i,this.authToken=s,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=Jt(this.connId),this.stats_=Xi(t),this.connURL=Je.connectionURL_(t,r,l,i,o),this.nodeAdmin=t.nodeAdmin}static connectionURL_(e,t,o,i,s){const r={};return r[El]=Ki,typeof location!="undefined"&&location.hostname&&wl.test(location.hostname)&&(r[Bl]=Sl),t&&(r[Il]=t),o&&(r[kl]=o),i&&(r[bi]=i),s&&(r[Dl]=s),Rl(e,Tl,r)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Hn.set("previous_websocket_failure",!0);try{let o;dl(),this.mySock=new yo(this.connURL,[],o)}catch(o){this.log_("Error instantiating WebSocket.");const i=o.message||o.data;i&&this.log_(i),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=o=>{this.handleIncomingFrame(o)},this.mySock.onerror=o=>{this.log_("WebSocket error.  Closing connection.");const i=o.message||o.data;i&&this.log_(i),this.onClosed_()}}start(){}static forceDisallow(){Je.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator!="undefined"&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,o=navigator.userAgent.match(t);o&&o.length>1&&parseFloat(o[1])<4.4&&(e=!0)}return!e&&yo!==null&&!Je.forceDisallow_}static previouslyFailed(){return Hn.isInMemoryStorage||Hn.get("previous_websocket_failure")===!0}markConnectionHealthy(){Hn.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const t=this.frames.join("");this.frames=null;const o=Rt(t);this.onMessage(o)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(A(this.frames===null,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(t);else{const o=this.extractFrameCount_(t);o!==null&&this.appendFrame_(o)}}send(e){this.resetKeepAlive();const t=ge(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const o=Pl(t,_0);o.length>1&&this.sendString_(String(o.length));for(let i=0;i<o.length;i++)this.sendString_(o[i])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(v0))}sendString_(e){try{this.mySock.send(e)}catch(t){this.log_("Exception thrown from WebSocket.send():",t.message||t.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}Je.responsesRequiredToBeHealthy=2;Je.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt{static get ALL_TRANSPORTS(){return[tt,Je]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const t=Je&&Je.isAvailable();let o=t&&!Je.previouslyFailed();if(e.webSocketOnly&&(t||De("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),o=!0),o)this.transports_=[Je];else{const i=this.transports_=[];for(const s of Lt.ALL_TRANSPORTS)s&&s.isAvailable()&&i.push(s);Lt.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}Lt.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fr=32,yr=768;class Y{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let o=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[o]=this.pieces_[i],o++);this.pieces_.length=o,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function X(){return new Y("")}function F(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function Bn(n){return n.pieces_.length-n.pieceNum_}function te(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new Y(n.pieces_,e)}function Yi(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function k0(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function Ft(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function Wl(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new Y(e,0)}function le(n,e){const t=[];for(let o=n.pieceNum_;o<n.pieces_.length;o++)t.push(n.pieces_[o]);if(e instanceof Y)for(let o=e.pieceNum_;o<e.pieces_.length;o++)t.push(e.pieces_[o]);else{const o=e.split("/");for(let i=0;i<o.length;i++)o[i].length>0&&t.push(o[i])}return new Y(t,0)}function H(n){return n.pieceNum_>=n.pieces_.length}function Me(n,e){const t=F(n),o=F(e);if(t===null)return e;if(t===o)return Me(te(n),te(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function D0(n,e){const t=Ft(n,0),o=Ft(e,0);for(let i=0;i<t.length&&i<o.length;i++){const s=Qn(t[i],o[i]);if(s!==0)return s}return t.length===o.length?0:t.length<o.length?-1:1}function Ji(n,e){if(Bn(n)!==Bn(e))return!1;for(let t=n.pieceNum_,o=e.pieceNum_;t<=n.pieces_.length;t++,o++)if(n.pieces_[t]!==e.pieces_[o])return!1;return!0}function Xe(n,e){let t=n.pieceNum_,o=e.pieceNum_;if(Bn(n)>Bn(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[o])return!1;++t,++o}return!0}class T0{constructor(e,t){this.errorPrefix_=t,this.parts_=Ft(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let o=0;o<this.parts_.length;o++)this.byteLength_+=ko(this.parts_[o]);jl(this)}}function M0(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=ko(e),jl(n)}function N0(n){const e=n.parts_.pop();n.byteLength_-=ko(e),n.parts_.length>0&&(n.byteLength_-=1)}function jl(n){if(n.byteLength_>yr)throw new Error(n.errorPrefix_+"has a key path longer than "+yr+" bytes ("+n.byteLength_+").");if(n.parts_.length>fr)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+fr+") or object contains a cycle "+On(n))}function On(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let no;class Gl extends Do{static get __EMPTY_NODE(){return no}static set __EMPTY_NODE(e){no=e}compare(e,t){return Qn(e.name,t.name)}isDefinedOn(e){throw ut("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return z.MIN}maxPost(){return new z(In,no)}makePost(e,t){return A(typeof e=="string","KeyIndex indexValue must always be a string."),new z(e,no)}toString(){return".key"}}const zn=new Gl;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let gi;function z0(n){gi=n}const Kl=function(n){return typeof n=="number"?"number:"+Ul(n):"string:"+n},Xl=function(n){if(n.isLeafNode()){const e=n.val();A(typeof e=="string"||typeof e=="number"||typeof e=="object"&&hn(e,".sv"),"Priority must be a string or number.")}else A(n===gi||n.isEmpty(),"priority of unexpected type.");A(n===gi||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ar;class me{static set __childrenNodeConstructor(e){Ar=e}static get __childrenNodeConstructor(){return Ar}constructor(e,t=me.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,A(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),Xl(this.priorityNode_)}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new me(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:me.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return H(e)?this:F(e)===".priority"?this.priorityNode_:me.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return e===".priority"?this.updatePriority(t):t.isEmpty()&&e!==".priority"?this:me.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const o=F(e);return o===null?t:t.isEmpty()&&o!==".priority"?this:(A(o!==".priority"||Bn(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(o,me.__childrenNodeConstructor.EMPTY_NODE.updateChild(te(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+Kl(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",t==="number"?e+=Ul(this.value_):e+=this.value_,this.lazyHash_=Cl(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===me.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof me.__childrenNodeConstructor?-1:(A(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,o=typeof this.value_,i=me.VALUE_TYPE_ORDER.indexOf(t),s=me.VALUE_TYPE_ORDER.indexOf(o);return A(i>=0,"Unknown leaf type: "+t),A(s>=0,"Unknown leaf type: "+o),i===s?o==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:s-i}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}else return!1}}me.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G0=Math.log(2);class K0{constructor(e){const t=s=>parseInt(Math.log(s)/G0,10),o=s=>parseInt(Array(s+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=o(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const go=function(n,e,t,o){n.sort(e);const i=function(a,d){const u=d-a;let h,m;if(u===0)return null;if(u===1)return h=n[a],m=t?t(h):h,new fe(m,h.node,fe.BLACK,null,null);{const b=parseInt(u/2,10)+a,g=i(a,b),U=i(b+1,d);return h=n[b],m=t?t(h):h,new fe(m,h.node,fe.BLACK,g,U)}},s=function(a){let d=null,u=null,h=n.length;const m=function(g,U){const D=h-g,I=h;h-=g;const V=i(D+1,I),T=n[D],W=t?t(T):T;b(new fe(W,T.node,U,null,V))},b=function(g){d?(d.left=g,d=g):(u=g,d=g)};for(let g=0;g<a.count;++g){const U=a.nextBitIsOne(),D=Math.pow(2,a.count-(g+1));U?m(D,fe.BLACK):(m(D,fe.BLACK),m(D,fe.RED))}return u},r=new K0(n.length),l=s(r);return new Ne(o||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let oi;const et={};class pn{static get Default(){return A(et&&se,"ChildrenNode.ts has not been loaded"),oi=oi||new pn({".priority":et},{".priority":se}),oi}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=rt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Ne?t:null}hasIndex(e){return hn(this.indexSet_,e.toString())}addIndex(e,t){A(e!==zn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const o=[];let i=!1;const s=t.getIterator(z.Wrap);let r=s.getNext();for(;r;)i=i||e.isDefinedOn(r.node),o.push(r),r=s.getNext();let l;i?l=go(o,e.getCompare()):l=et;const a=e.toString(),d={...this.indexSet_};d[a]=e;const u={...this.indexes_};return u[a]=l,new pn(u,d)}addToIndexes(e,t){const o=uo(this.indexes_,(i,s)=>{const r=rt(this.indexSet_,s);if(A(r,"Missing index implementation for "+s),i===et)if(r.isDefinedOn(e.node)){const l=[],a=t.getIterator(z.Wrap);let d=a.getNext();for(;d;)d.name!==e.name&&l.push(d),d=a.getNext();return l.push(e),go(l,r.getCompare())}else return et;else{const l=t.get(e.name);let a=i;return l&&(a=a.remove(new z(e.name,l))),a.insert(e,e.node)}});return new pn(o,this.indexSet_)}removeFromIndexes(e,t){const o=uo(this.indexes_,i=>{if(i===et)return i;{const s=t.get(e.name);return s?i.remove(new z(e.name,s)):i}});return new pn(o,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q0=!0;function be(n,e=null){if(n===null)return R.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),A(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new me(t,be(e))}if(!(n instanceof Array)&&Q0){const t=[];let o=!1;if(Pe(n,(r,l)=>{if(r.substring(0,1)!=="."){const a=be(l);a.isEmpty()||(o=o||!a.getPriority().isEmpty(),t.push(new z(r,a)))}}),t.length===0)return R.EMPTY_NODE;const s=go(t,H0,r=>r.name,$i);if(o){const r=go(t,se.getCompare());return new R(s,be(e),new pn({".priority":r},{".priority":se}))}else return new R(s,be(e),pn.Default)}else{let t=R.EMPTY_NODE;return Pe(n,(o,i)=>{if(hn(n,o)&&o.substring(0,1)!=="."){const s=be(i);(s.isLeafNode()||!s.isEmpty())&&(t=t.updateImmediateChild(o,s))}}),t.updatePriority(be(e))}}V0(be);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zi extends Do{constructor(e){super(),this.indexPath_=e,A(!H(e)&&F(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const o=this.extractChild(e.node),i=this.extractChild(t.node),s=o.compareTo(i);return s===0?Qn(e.name,t.name):s}makePost(e,t){const o=be(e),i=R.EMPTY_NODE.updateChild(this.indexPath_,o);return new z(t,i)}maxPost(){const e=R.EMPTY_NODE.updateChild(this.indexPath_,qt);return new z(In,e)}toString(){return Ft(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y0 extends Do{compare(e,t){const o=e.node.compareTo(t.node);return o===0?Qn(e.name,t.name):o}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return z.MIN}maxPost(){return z.MAX}makePost(e,t){const o=be(e);return new z(t,o)}toString(){return".value"}}const Jl=new Y0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class es{constructor(e){this.index_=e}updateChild(e,t,o,i,s,r){A(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(t);return l.getChild(i).equals(o.getChild(i))&&l.isEmpty()===o.isEmpty()||(r!=null&&(o.isEmpty()?e.hasChild(t)?r.trackChildChange(Ht(t,l)):A(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?r.trackChildChange(lt(t,o)):r.trackChildChange(zt(t,o,l))),e.isLeafNode()&&o.isEmpty())?e:e.updateImmediateChild(t,o).withIndex(this.index_)}updateFullNode(e,t,o){return o!=null&&(e.isLeafNode()||e.forEachChild(se,(i,s)=>{t.hasChild(i)||o.trackChildChange(Ht(i,s))}),t.isLeafNode()||t.forEachChild(se,(i,s)=>{if(e.hasChild(i)){const r=e.getImmediateChild(i);r.equals(s)||o.trackChildChange(zt(i,s,r))}else o.trackChildChange(lt(i,s))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?R.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class e2{constructor(){this.rootNode_=R.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _o(){return{value:null,children:new Map}}function $l(n,e,t){if(H(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const o=F(e);n.children.has(o)||n.children.set(o,_o());const i=n.children.get(o);e=te(e),$l(i,e,t)}}function Ai(n,e,t){n.value!==null?t(e,n.value):n2(n,(o,i)=>{const s=new Y(e.toString()+"/"+o);Ai(i,s,t)})}function n2(n,e){n.children.forEach((t,o)=>{e(o,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class t2{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t={...e};return this.last_&&Pe(this.last_,(o,i)=>{t[o]=t[o]-i}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cr=10*1e3,o2=30*1e3,i2=5*60*1e3;class s2{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new t2(e);const o=Cr+(o2-Cr)*Math.random();wt(this.reportStats_.bind(this),Math.floor(o))}reportStats_(){const e=this.statsListener_.get(),t={};let o=!1;Pe(e,(i,s)=>{s>0&&hn(this.statsToReport_,i)&&(t[i]=s,o=!0)}),o&&this.server_.reportStats(t),wt(this.reportStats_.bind(this),Math.floor(Math.random()*2*i2))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var $e;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})($e||($e={}));function ts(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function os(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function is(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo{constructor(e,t,o){this.path=e,this.affectedTree=t,this.revert=o,this.type=$e.ACK_USER_WRITE,this.source=ts()}operationForChild(e){if(H(this.path)){if(this.affectedTree.value!=null)return A(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Y(e));return new vo(X(),t,this.revert)}}else return A(F(this.path)===e,"operationForChild called for unrelated child."),new vo(te(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r2{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function l2(n,e,t,o){const i=[],s=[];return e.forEach(r=>{r.type==="child_changed"&&n.index_.indexedValueChanged(r.oldSnap,r.snapshotNode)&&s.push(J0(r.childName,r.snapshotNode))}),Ut(n,i,"child_removed",e,o,t),Ut(n,i,"child_added",e,o,t),Ut(n,i,"child_moved",s,o,t),Ut(n,i,"child_changed",e,o,t),Ut(n,i,"value",e,o,t),i}function Ut(n,e,t,o,i,s){const r=o.filter(l=>l.type===t);r.sort((l,a)=>c2(n,l,a)),r.forEach(l=>{const a=a2(n,l,s);i.forEach(d=>{d.respondsTo(l.type)&&e.push(d.createEvent(a,n.query_))})})}function a2(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function c2(n,e,t){if(e.childName==null||t.childName==null)throw ut("Should only compare child_ events.");const o=new z(e.childName,e.snapshotNode),i=new z(t.childName,t.snapshotNode);return n.index_.compare(o,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function To(n,e){return{eventCache:n,serverCache:e}}function kt(n,e,t,o){return To(new jn(e,t,o),n.serverCache)}function Zl(n,e,t,o){return To(n.eventCache,new jn(e,t,o))}function _i(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Gn(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ze{constructor(e){this.writeTree_=e}static empty(){return new Ze(new ee(null))}}function Dt(n,e,t){if(H(e))return new Ze(new ee(t));{const o=n.writeTree_.findRootMostValueAndPath(e);if(o!=null){const i=o.path;let s=o.value;const r=Me(i,e);return s=s.updateChild(r,t),new Ze(n.writeTree_.set(i,s))}else{const i=new ee(t),s=n.writeTree_.setTree(e,i);return new Ze(s)}}}function vi(n,e,t){let o=n;return Pe(t,(i,s)=>{o=Dt(o,le(e,i),s)}),o}function Pr(n,e){if(H(e))return Ze.empty();{const t=n.writeTree_.setTree(e,new ee(null));return new Ze(t)}}function Ci(n,e){return Yn(n,e)!=null}function Yn(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(Me(t.path,e)):null}function Ur(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(se,(o,i)=>{e.push(new z(o,i))}):n.writeTree_.children.inorderTraversal((o,i)=>{i.value!=null&&e.push(new z(o,i.value))}),e}function En(n,e){if(H(e))return n;{const t=Yn(n,e);return t!=null?new Ze(new ee(t)):new Ze(n.writeTree_.subtree(e))}}function Pi(n){return n.writeTree_.isEmpty()}function ct(n,e){return ea(X(),n.writeTree_,e)}function ea(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let o=null;return e.children.inorderTraversal((i,s)=>{i===".priority"?(A(s.value!==null,"Priority writes must always be leaf nodes"),o=s.value):t=ea(le(n,i),s,t)}),!t.getChild(n).isEmpty()&&o!==null&&(t=t.updateChild(le(n,".priority"),o)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ss(n,e){return ia(e,n)}function h2(n,e,t,o,i){A(o>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:o,visible:i}),i&&(n.visibleWrites=Dt(n.visibleWrites,e,t)),n.lastWriteId=o}function u2(n,e,t,o){A(o>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:o,visible:!0}),n.visibleWrites=vi(n.visibleWrites,e,t),n.lastWriteId=o}function p2(n,e){for(let t=0;t<n.allWrites.length;t++){const o=n.allWrites[t];if(o.writeId===e)return o}return null}function m2(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);A(t>=0,"removeWrite called with nonexistent writeId.");const o=n.allWrites[t];n.allWrites.splice(t,1);let i=o.visible,s=!1,r=n.allWrites.length-1;for(;i&&r>=0;){const l=n.allWrites[r];l.visible&&(r>=t&&f2(l,o.path)?i=!1:Xe(o.path,l.path)&&(s=!0)),r--}if(i){if(s)return y2(n),!0;if(o.snap)n.visibleWrites=Pr(n.visibleWrites,o.path);else{const l=o.children;Pe(l,a=>{n.visibleWrites=Pr(n.visibleWrites,le(o.path,a))})}return!0}else return!1}function f2(n,e){if(n.snap)return Xe(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Xe(le(n.path,t),e))return!0;return!1}function y2(n){n.visibleWrites=na(n.allWrites,b2,X()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function b2(n){return n.visible}function na(n,e,t){let o=Ze.empty();for(let i=0;i<n.length;++i){const s=n[i];if(e(s)){const r=s.path;let l;if(s.snap)Xe(t,r)?(l=Me(t,r),o=Dt(o,l,s.snap)):Xe(r,t)&&(l=Me(r,t),o=Dt(o,X(),s.snap.getChild(l)));else if(s.children){if(Xe(t,r))l=Me(t,r),o=vi(o,l,s.children);else if(Xe(r,t))if(l=Me(r,t),H(l))o=vi(o,X(),s.children);else{const a=rt(s.children,F(l));if(a){const d=a.getChild(te(l));o=Dt(o,X(),d)}}}else throw ut("WriteRecord should have .snap or .children")}}return o}function ta(n,e,t,o,i){if(!o&&!i){const s=Yn(n.visibleWrites,e);if(s!=null)return s;{const r=En(n.visibleWrites,e);if(Pi(r))return t;if(t==null&&!Ci(r,X()))return null;{const l=t||R.EMPTY_NODE;return ct(r,l)}}}else{const s=En(n.visibleWrites,e);if(!i&&Pi(s))return t;if(!i&&t==null&&!Ci(s,X()))return null;{const r=function(d){return(d.visible||i)&&(!o||!~o.indexOf(d.writeId))&&(Xe(d.path,e)||Xe(e,d.path))},l=na(n.allWrites,r,e),a=t||R.EMPTY_NODE;return ct(l,a)}}}function g2(n,e,t){let o=R.EMPTY_NODE;const i=Yn(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(se,(s,r)=>{o=o.updateImmediateChild(s,r)}),o;if(t){const s=En(n.visibleWrites,e);return t.forEachChild(se,(r,l)=>{const a=ct(En(s,new Y(r)),l);o=o.updateImmediateChild(r,a)}),Ur(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}else{const s=En(n.visibleWrites,e);return Ur(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}}function A2(n,e,t,o,i){A(o||i,"Either existingEventSnap or existingServerSnap must exist");const s=le(e,t);if(Ci(n.visibleWrites,s))return null;{const r=En(n.visibleWrites,s);return Pi(r)?i.getChild(t):ct(r,i.getChild(t))}}function _2(n,e,t,o){const i=le(e,t),s=Yn(n.visibleWrites,i);if(s!=null)return s;if(o.isCompleteForChild(t)){const r=En(n.visibleWrites,i);return ct(r,o.getNode().getImmediateChild(t))}else return null}function v2(n,e){return Yn(n.visibleWrites,e)}function C2(n,e,t,o,i,s,r){let l;const a=En(n.visibleWrites,e),d=Yn(a,X());if(d!=null)l=d;else if(t!=null)l=ct(a,t);else return[];if(l=l.withIndex(r),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=r.getCompare(),m=s?l.getReverseIteratorFrom(o,r):l.getIteratorFrom(o,r);let b=m.getNext();for(;b&&u.length<i;)h(b,o)!==0&&u.push(b),b=m.getNext();return u}else return[]}function P2(){return{visibleWrites:Ze.empty(),allWrites:[],lastWriteId:-1}}function Co(n,e,t,o){return ta(n.writeTree,n.treePath,e,t,o)}function rs(n,e){return g2(n.writeTree,n.treePath,e)}function Er(n,e,t,o){return A2(n.writeTree,n.treePath,e,t,o)}function Po(n,e){return v2(n.writeTree,le(n.treePath,e))}function U2(n,e,t,o,i,s){return C2(n.writeTree,n.treePath,e,t,o,i,s)}function ls(n,e,t){return _2(n.writeTree,n.treePath,e,t)}function oa(n,e){return ia(le(n.treePath,e),n.writeTree)}function ia(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class E2{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,o=e.childName;A(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),A(o!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(o);if(i){const s=i.type;if(t==="child_added"&&s==="child_removed")this.changeMap.set(o,zt(o,e.snapshotNode,i.snapshotNode));else if(t==="child_removed"&&s==="child_added")this.changeMap.delete(o);else if(t==="child_removed"&&s==="child_changed")this.changeMap.set(o,Ht(o,i.oldSnap));else if(t==="child_changed"&&s==="child_added")this.changeMap.set(o,lt(o,e.snapshotNode));else if(t==="child_changed"&&s==="child_changed")this.changeMap.set(o,zt(o,e.snapshotNode,i.oldSnap));else throw ut("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(o,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Io;function X2(n){A(!Io,"__referenceConstructor has already been defined"),Io=n}function Q2(){return A(Io,"Reference.ts has not been loaded"),Io}let Y2=1;class Dr{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ee(null),this.pendingWriteTree_=P2(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ha(n,e,t,o,i){return h2(n.pendingWriteTree_,e,t,o,i),i?mt(n,new Wn(ts(),e,t)):[]}function J2(n,e,t,o){u2(n.pendingWriteTree_,e,t,o);const i=ee.fromObject(t);return mt(n,new at(ts(),e,i))}function Cn(n,e,t=!1){const o=p2(n.pendingWriteTree_,e);if(m2(n.pendingWriteTree_,e)){let s=new ee(null);return o.snap!=null?s=s.set(X(),!0):Pe(o.children,r=>{s=s.set(new Y(r),!0)}),mt(n,new vo(o.path,s,t))}else return[]}function No(n,e,t){return mt(n,new Wn(os(),e,t))}function q2(n,e,t){const o=ee.fromObject(t);return mt(n,new at(os(),e,o))}function $2(n,e){return mt(n,new Wt(os(),e))}function Z2(n,e,t){const o=hs(n,t);if(o){const i=us(o),s=i.path,r=i.queryId,l=Me(s,e),a=new Wt(is(r),l);return ps(n,s,a)}else return[]}function Ii(n,e,t,o,i=!1){const s=e._path,r=n.syncPointTree_.get(s);let l=[];if(r&&(e._queryIdentifier==="default"||da(r,e))){const a=K2(r,e,t,o);W2(r)&&(n.syncPointTree_=n.syncPointTree_.remove(s));const d=a.removed;if(l=a.events,!i){const u=d.findIndex(m=>m._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(s,(m,b)=>Sn(b));if(u&&!h){const m=n.syncPointTree_.subtree(s);if(!m.isEmpty()){const b=th(m);for(let g=0;g<b.length;++g){const U=b[g],D=U.query,I=ma(n,U);n.listenProvider_.startListening(Tt(D),Bo(n,D),I.hashFn,I.onComplete)}}}!h&&d.length>0&&!o&&(u?n.listenProvider_.stopListening(Tt(e),null):d.forEach(m=>{const b=n.queryToTagMap.get(Ro(m));n.listenProvider_.stopListening(Tt(m),b)}))}oh(n,d)}return l}function eh(n,e,t,o){const i=hs(n,o);if(i!=null){const s=us(i),r=s.path,l=s.queryId,a=Me(r,e),d=new Wn(is(l),a,t);return ps(n,r,d)}else return[]}function nh(n,e,t,o){const i=hs(n,o);if(i){const s=us(i),r=s.path,l=s.queryId,a=Me(r,e),d=ee.fromObject(t),u=new at(is(l),a,d);return ps(n,r,u)}else return[]}function Tr(n,e,t,o=!1){const i=e._path;let s=null,r=!1;n.syncPointTree_.foreachOnPath(i,(m,b)=>{const g=Me(m,i);s=s||st(b,g),r=r||Sn(b)});let l=n.syncPointTree_.get(i);l?(r=r||Sn(l),s=s||st(l,X())):(l=new H2,n.syncPointTree_=n.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=R.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((b,g)=>{const U=st(g,X());U&&(s=s.updateImmediateChild(b,U))}));const d=da(l,e);if(!d&&!e._queryParams.loadsAllData()){const m=Ro(e);A(!n.queryToTagMap.has(m),"View does not exist, but we have a tag");const b=ih();n.queryToTagMap.set(m,b),n.tagToQueryMap.set(b,m)}const u=ss(n.pendingWriteTree_,i);let h=G2(l,e,t,u,s,a);if(!d&&!r&&!o){const m=ca(l,e);h=h.concat(sh(n,e,m))}return h}function ds(n,e,t){const i=n.pendingWriteTree_,s=n.syncPointTree_.findOnPath(e,(r,l)=>{const a=Me(r,e),d=st(l,a);if(d)return d});return ta(i,e,s,t,!0)}function mt(n,e){return ua(e,n.syncPointTree_,null,ss(n.pendingWriteTree_,X()))}function ua(n,e,t,o){if(H(n.path))return pa(n,e,t,o);{const i=e.get(X());t==null&&i!=null&&(t=st(i,X()));let s=[];const r=F(n.path),l=n.operationForChild(r),a=e.children.get(r);if(a&&l){const d=t?t.getImmediateChild(r):null,u=oa(o,r);s=s.concat(ua(l,a,d,u))}return i&&(s=s.concat(cs(i,n,o,t))),s}}function pa(n,e,t,o){const i=e.get(X());t==null&&i!=null&&(t=st(i,X()));let s=[];return e.children.inorderTraversal((r,l)=>{const a=t?t.getImmediateChild(r):null,d=oa(o,r),u=n.operationForChild(r);u&&(s=s.concat(pa(u,l,a,d)))}),i&&(s=s.concat(cs(i,n,o,t))),s}function ma(n,e){const t=e.query,o=Bo(n,t);return{hashFn:()=>(x2(e)||R.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return o?Z2(n,t._path,o):$2(n,t._path);{const s=$1(i,t);return Ii(n,t,null,s)}}}}function Bo(n,e){const t=Ro(e);return n.queryToTagMap.get(t)}function Ro(n){return n._path.toString()+"$"+n._queryIdentifier}function hs(n,e){return n.tagToQueryMap.get(e)}function us(n){const e=n.indexOf("$");return A(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new Y(n.substr(0,e))}}function ps(n,e,t){const o=n.syncPointTree_.get(e);A(o,"Missing sync point for query tag that we're tracking");const i=ss(n.pendingWriteTree_,e);return cs(o,t,i,null)}function th(n){return n.fold((e,t,o)=>{if(t&&Sn(t))return[Mo(t)];{let i=[];return t&&(i=aa(t)),Pe(o,(s,r)=>{i=i.concat(r)}),i}})}function Tt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Q2())(n._repo,n._path):n}function oh(n,e){for(let t=0;t<e.length;++t){const o=e[t];if(!o._queryParams.loadsAllData()){const i=Ro(o),s=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(s)}}}function ih(){return Y2++}function sh(n,e,t){const o=e._path,i=Bo(n,e),s=ma(n,t),r=n.listenProvider_.startListening(Tt(e),i,s.hashFn,s.onComplete),l=n.syncPointTree_.subtree(o);if(i)A(!Sn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((d,u,h)=>{if(!H(d)&&u&&Sn(u))return[Mo(u).query];{let m=[];return u&&(m=m.concat(aa(u).map(b=>b.query))),Pe(h,(b,g)=>{m=m.concat(g)}),m}});for(let d=0;d<a.length;++d){const u=a[d];n.listenProvider_.stopListening(Tt(u),Bo(n,u))}}return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bs{constructor(e="",t=null,o={children:{},childCount:0}){this.name=e,this.parent=t,this.node=o}}function gs(n,e){let t=e instanceof Y?e:new Y(e),o=n,i=F(t);for(;i!==null;){const s=rt(o.node.children,i)||{children:{},childCount:0};o=new bs(i,o,s),t=te(t),i=F(t)}return o}function ft(n){return n.node.value}function ba(n,e){n.node.value=e,Bi(n)}function ga(n){return n.node.childCount>0}function ch(n){return ft(n)===void 0&&!ga(n)}function xo(n,e){Pe(n.node.children,(t,o)=>{e(new bs(t,n,o))})}function Aa(n,e,t,o){t&&!o&&e(n),xo(n,i=>{Aa(i,e,!0,o)}),t&&o&&e(n)}function dh(n,e,t){let o=n.parent;for(;o!==null;){if(e(o))return!0;o=o.parent}return!1}function $t(n){return new Y(n.parent===null?n.name:$t(n.parent)+"/"+n.name)}function Bi(n){n.parent!==null&&hh(n.parent,n.name,n)}function hh(n,e,t){const o=ch(t),i=hn(n.node.children,e);o&&i?(delete n.node.children[e],n.node.childCount--,Bi(n)):!o&&!i&&(n.node.children[e]=t.node,n.node.childCount++,Bi(n))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uh=/[\[\].#$\/\u0000-\u001F\u007F]/,ph=/[\[\].#$\u0000-\u001F\u007F]/,si=10*1024*1024,As=function(n){return typeof n=="string"&&n.length!==0&&!uh.test(n)},_a=function(n){return typeof n=="string"&&n.length!==0&&!ph.test(n)},mh=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),_a(n)},Si=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!ji(n)||n&&typeof n=="object"&&hn(n,".sv")},va=function(n,e,t,o){o&&e===void 0||Oo(wo(n,"value"),e,t)},Oo=function(n,e,t){const o=t instanceof Y?new T0(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+On(o));if(typeof e=="function")throw new Error(n+"contains a function "+On(o)+" with contents = "+e.toString());if(ji(e))throw new Error(n+"contains "+e.toString()+" "+On(o));if(typeof e=="string"&&e.length>si/3&&ko(e)>si)throw new Error(n+"contains a string greater than "+si+" utf8 bytes "+On(o)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,s=!1;if(Pe(e,(r,l)=>{if(r===".value")i=!0;else if(r!==".priority"&&r!==".sv"&&(s=!0,!As(r)))throw new Error(n+" contains an invalid key ("+r+") "+On(o)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);M0(o,r),Oo(n,l,o),N0(o)}),i&&s)throw new Error(n+' contains ".value" child '+On(o)+" in addition to actual children.")}},fh=function(n,e){let t,o;for(t=0;t<e.length;t++){o=e[t];const s=Ft(o);for(let r=0;r<s.length;r++)if(!(s[r]===".priority"&&r===s.length-1)){if(!As(s[r]))throw new Error(n+"contains an invalid key ("+s[r]+") in path "+o.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(D0);let i=null;for(t=0;t<e.length;t++){if(o=e[t],i!==null&&Xe(i,o))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+o.toString());i=o}},yh=function(n,e,t,o){const i=wo(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const s=[];Pe(e,(r,l)=>{const a=new Y(r);if(Oo(i,l,le(t,a)),Yi(a)===".priority"&&!Si(l))throw new Error(i+"contains an invalid value for '"+a.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");s.push(a)}),fh(i,s)},_s=function(n,e,t,o){if(!_a(t))throw new Error(wo(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},bh=function(n,e,t,o){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),_s(n,e,t)},vs=function(n,e){if(F(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},gh=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!As(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!mh(t))throw new Error(wo(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ah{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Lo(n,e){let t=null;for(let o=0;o<e.length;o++){const i=e[o],s=i.getPath();t!==null&&!Ji(s,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:s}),t.events.push(i)}t&&n.eventLists_.push(t)}function Ca(n,e,t){Lo(n,t),Pa(n,o=>Ji(o,e))}function en(n,e,t){Lo(n,t),Pa(n,o=>Xe(o,e)||Xe(e,o))}function Pa(n,e){n.recursionDepth_++;let t=!0;for(let o=0;o<n.eventLists_.length;o++){const i=n.eventLists_[o];if(i){const s=i.path;e(s)?(_h(n.eventLists_[o]),n.eventLists_[o]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function _h(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const o=t.getEventRunner();St&&Ce("event: "+t.toString()),pt(o)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vh="repo_interrupt",Ch=25;class Ph{constructor(e,t,o,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=o,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Ah,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=_o(),this.transactionQueueTree_=new bs,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Uh(n,e,t){if(n.stats_=Xi(n.repoInfo_),n.forceRestClient_||t0())n.server_=new Ao(n.repoInfo_,(o,i,s,r)=>{Nr(n,o,i,s,r)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Rr(n,!0),0);else{if(typeof t!="undefined"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ge(t)}catch(o){throw new Error("Invalid authOverride provided: "+o)}}n.persistentConnection_=new mn(n.repoInfo_,e,(o,i,s,r)=>{Nr(n,o,i,s,r)},o=>{Rr(n,o)},o=>{Eh(n,o)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(o=>{n.server_.refreshAuthToken(o)}),n.appCheckProvider_.addTokenChangeListener(o=>{n.server_.refreshAppCheckToken(o.token)}),n.statsReporter_=l0(n.repoInfo_,()=>new s2(n.stats_,n.server_)),n.infoData_=new e2,n.infoSyncTree_=new Dr({startListening:(o,i,s,r)=>{let l=[];const a=n.infoData_.getNode(o._path);return a.isEmpty()||(l=No(n.infoSyncTree_,o._path,a),setTimeout(()=>{r("ok")},0)),l},stopListening:()=>{}}),Cs(n,"connected",!1),n.serverSyncTree_=new Dr({startListening:(o,i,s,r)=>(n.server_.listen(o,s,i,(l,a)=>{const d=r(l,a);en(n.eventQueue_,o._path,d)}),[]),stopListening:(o,i)=>{n.server_.unlisten(o,i)}})}function Ua(n){const t=n.infoData_.getNode(new Y(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Fo(n){return rh({timestamp:Ua(n)})}function Nr(n,e,t,o,i){n.dataUpdateCount++;const s=new Y(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let r=[];if(i)if(o){const a=uo(t,d=>be(d));r=nh(n.serverSyncTree_,s,a,i)}else{const a=be(t);r=eh(n.serverSyncTree_,s,a,i)}else if(o){const a=uo(t,d=>be(d));r=q2(n.serverSyncTree_,s,a)}else{const a=be(t);r=No(n.serverSyncTree_,s,a)}let l=s;r.length>0&&(l=dt(n,s)),en(n.eventQueue_,l,r)}function Rr(n,e){Cs(n,"connected",e),e===!1&&Sh(n)}function Eh(n,e){Pe(e,(t,o)=>{Cs(n,t,o)})}function Cs(n,e,t){const o=new Y("/.info/"+e),i=be(t);n.infoData_.updateSnapshot(o,i);const s=No(n.infoSyncTree_,o,i);en(n.eventQueue_,o,s)}function Ps(n){return n.nextWriteId_++}function Ih(n,e,t,o,i){Ho(n,"set",{path:e.toString(),value:t,priority:o});const s=Fo(n),r=be(t,o),l=ds(n.serverSyncTree_,e),a=ya(r,l,s),d=Ps(n),u=ha(n.serverSyncTree_,e,a,d,!0);Lo(n.eventQueue_,u),n.server_.put(e.toString(),r.val(!0),(m,b)=>{const g=m==="ok";g||De("set at "+e+" failed: "+m);const U=Cn(n.serverSyncTree_,d,!g);en(n.eventQueue_,e,U),ki(n,i,m,b)});const h=Es(n,e);dt(n,h),en(n.eventQueue_,h,[])}function Bh(n,e,t,o){Ho(n,"update",{path:e.toString(),value:t});let i=!0;const s=Fo(n),r={};if(Pe(t,(l,a)=>{i=!1,r[l]=fa(le(e,l),be(a),n.serverSyncTree_,s)}),i)Ce("update() called with empty data.  Don't do anything."),ki(n,o,"ok",void 0);else{const l=Ps(n),a=J2(n.serverSyncTree_,e,r,l);Lo(n.eventQueue_,a),n.server_.merge(e.toString(),t,(d,u)=>{const h=d==="ok";h||De("update at "+e+" failed: "+d);const m=Cn(n.serverSyncTree_,l,!h),b=m.length>0?dt(n,e):e;en(n.eventQueue_,b,m),ki(n,o,d,u)}),Pe(t,d=>{const u=Es(n,le(e,d));dt(n,u)}),en(n.eventQueue_,e,[])}}function Sh(n){Ho(n,"onDisconnectEvents");const e=Fo(n),t=_o();Ai(n.onDisconnect_,X(),(i,s)=>{const r=fa(i,s,n.serverSyncTree_,e);$l(t,i,r)});let o=[];Ai(t,X(),(i,s)=>{o=o.concat(No(n.serverSyncTree_,i,s));const r=Es(n,i);dt(n,r)}),n.onDisconnect_=_o(),en(n.eventQueue_,X(),o)}function wh(n,e,t){let o;F(e._path)===".info"?o=Tr(n.infoSyncTree_,e,t):o=Tr(n.serverSyncTree_,e,t),Ca(n.eventQueue_,e._path,o)}function wi(n,e,t){let o;F(e._path)===".info"?o=Ii(n.infoSyncTree_,e,t):o=Ii(n.serverSyncTree_,e,t),Ca(n.eventQueue_,e._path,o)}function kh(n){n.persistentConnection_&&n.persistentConnection_.interrupt(vh)}function Ho(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),Ce(t,...e)}function ki(n,e,t,o){e&&pt(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let s=i;o&&(s+=": "+o);const r=new Error(s);r.code=i,e(r)}})}function Ea(n,e,t){return ds(n.serverSyncTree_,e,t)||R.EMPTY_NODE}function Us(n,e=n.transactionQueueTree_){if(e||zo(n,e),ft(e)){const t=Ba(n,e);A(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&Dh(n,$t(e),t)}else ga(e)&&xo(e,t=>{Us(n,t)})}function Dh(n,e,t){const o=t.map(d=>d.currentWriteId),i=Ea(n,e,o);let s=i;const r=i.hash();for(let d=0;d<t.length;d++){const u=t[d];A(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=Me(e,u.path);s=s.updateChild(h,u.currentOutputSnapshotRaw)}const l=s.val(!0),a=e;n.server_.put(a.toString(),l,d=>{Ho(n,"transaction put response",{path:a.toString(),status:d});let u=[];if(d==="ok"){const h=[];for(let m=0;m<t.length;m++)t[m].status=2,u=u.concat(Cn(n.serverSyncTree_,t[m].currentWriteId)),t[m].onComplete&&h.push(()=>t[m].onComplete(null,!0,t[m].currentOutputSnapshotResolved)),t[m].unwatcher();zo(n,gs(n.transactionQueueTree_,e)),Us(n,n.transactionQueueTree_),en(n.eventQueue_,e,u);for(let m=0;m<h.length;m++)pt(h[m])}else{if(d==="datastale")for(let h=0;h<t.length;h++)t[h].status===3?t[h].status=4:t[h].status=0;else{De("transaction at "+a.toString()+" failed: "+d);for(let h=0;h<t.length;h++)t[h].status=4,t[h].abortReason=d}dt(n,e)}},r)}function dt(n,e){const t=Ia(n,e),o=$t(t),i=Ba(n,t);return Th(n,i,o),o}function Th(n,e,t){if(e.length===0)return;const o=[];let i=[];const r=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],d=Me(t,a.path);let u=!1,h;if(A(d!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)u=!0,h=a.abortReason,i=i.concat(Cn(n.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=Ch)u=!0,h="maxretry",i=i.concat(Cn(n.serverSyncTree_,a.currentWriteId,!0));else{const m=Ea(n,a.path,r);a.currentInputSnapshot=m;const b=e[l].update(m.val());if(b!==void 0){Oo("transaction failed: Data returned ",b,a.path);let g=be(b);typeof b=="object"&&b!=null&&hn(b,".priority")||(g=g.updatePriority(m.getPriority()));const D=a.currentWriteId,I=Fo(n),V=ya(g,m,I);a.currentOutputSnapshotRaw=g,a.currentOutputSnapshotResolved=V,a.currentWriteId=Ps(n),r.splice(r.indexOf(D),1),i=i.concat(ha(n.serverSyncTree_,a.path,V,a.currentWriteId,a.applyLocally)),i=i.concat(Cn(n.serverSyncTree_,D,!0))}else u=!0,h="nodata",i=i.concat(Cn(n.serverSyncTree_,a.currentWriteId,!0))}en(n.eventQueue_,t,i),i=[],u&&(e[l].status=2,function(m){setTimeout(m,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(h==="nodata"?o.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):o.push(()=>e[l].onComplete(new Error(h),!1,null))))}zo(n,n.transactionQueueTree_);for(let l=0;l<o.length;l++)pt(o[l]);Us(n,n.transactionQueueTree_)}function Ia(n,e){let t,o=n.transactionQueueTree_;for(t=F(e);t!==null&&ft(o)===void 0;)o=gs(o,t),e=te(e),t=F(e);return o}function Ba(n,e){const t=[];return Sa(n,e,t),t.sort((o,i)=>o.order-i.order),t}function Sa(n,e,t){const o=ft(e);if(o)for(let i=0;i<o.length;i++)t.push(o[i]);xo(e,i=>{Sa(n,i,t)})}function zo(n,e){const t=ft(e);if(t){let o=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[o]=t[i],o++);t.length=o,ba(e,t.length>0?t:void 0)}xo(e,o=>{zo(n,o)})}function Es(n,e){const t=$t(Ia(n,e)),o=gs(n.transactionQueueTree_,e);return dh(o,i=>{ri(n,i)}),ri(n,o),Aa(o,i=>{ri(n,i)}),t}function ri(n,e){const t=ft(e);if(t){const o=[];let i=[],s=-1;for(let r=0;r<t.length;r++)t[r].status===3||(t[r].status===1?(A(s===r-1,"All SENT items should be at beginning of queue."),s=r,t[r].status=3,t[r].abortReason="set"):(A(t[r].status===0,"Unexpected transaction status in abort"),t[r].unwatcher(),i=i.concat(Cn(n.serverSyncTree_,t[r].currentWriteId,!0)),t[r].onComplete&&o.push(t[r].onComplete.bind(null,new Error("set"),!1,null))));s===-1?ba(e,void 0):t.length=s+1,en(n.eventQueue_,$t(e),i);for(let r=0;r<o.length;r++)pt(o[r])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mh(n){let e="";const t=n.split("/");for(let o=0;o<t.length;o++)if(t[o].length>0){let i=t[o];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch(s){}e+="/"+i}return e}function Nh(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const o=t.split("=");o.length===2?e[decodeURIComponent(o[0])]=decodeURIComponent(o[1]):De(`Invalid query segment '${t}' in query '${n}'`)}return e}const xr=function(n,e){const t=Rh(n),o=t.namespace;t.domain==="firebase.com"&&yn(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!o||o==="undefined")&&t.domain!=="localhost"&&yn("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||X1();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new Nl(t.host,t.secure,o,i,e,"",o!==t.subdomain),path:new Y(t.pathString)}},Rh=function(n){let e="",t="",o="",i="",s="",r=!0,l="https",a=443;if(typeof n=="string"){let d=n.indexOf("//");d>=0&&(l=n.substring(0,d-1),n=n.substring(d+2));let u=n.indexOf("/");u===-1&&(u=n.length);let h=n.indexOf("?");h===-1&&(h=n.length),e=n.substring(0,Math.min(u,h)),u<h&&(i=Mh(n.substring(u,h)));const m=Nh(n.substring(Math.min(n.length,h)));d=e.indexOf(":"),d>=0?(r=l==="https"||l==="wss",a=parseInt(e.substring(d+1),10)):d=e.length;const b=e.slice(0,d);if(b.toLowerCase()==="localhost")t="localhost";else if(b.split(".").length<=2)t=b;else{const g=e.indexOf(".");o=e.substring(0,g).toLowerCase(),t=e.substring(g+1),s=o}"ns"in m&&(s=m.ns)}return{host:e,port:a,domain:t,subdomain:o,secure:r,scheme:l,pathString:i,namespace:s}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oh{constructor(e,t,o,i){this.eventType=e,this.eventRegistration=t,this.snapshot=o,this.prevName=i}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+ge(this.snapshot.exportVal())}}class Lh{constructor(e,t,o){this.eventRegistration=e,this.error=t,this.path=o}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vo{constructor(e,t,o,i){this._repo=e,this._path=t,this._queryParams=o,this._orderByCalled=i}get key(){return H(this._path)?null:Yi(this._path)}get ref(){return new Dn(this._repo,this._path)}get _queryIdentifier(){const e=vr(this._queryParams),t=Gi(e);return t==="{}"?"default":t}get _queryObject(){return vr(this._queryParams)}isEqual(e){if(e=Xn(e),!(e instanceof Vo))return!1;const t=this._repo===e._repo,o=Ji(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&o&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+k0(this._path)}}function Hh(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function zh(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===zn){const o="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==Vn)throw new Error(o);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==In)throw new Error(o);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===se){if(e!=null&&!Si(e)||t!=null&&!Si(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(A(n.getIndex()instanceof Zi||n.getIndex()===Jl,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class Dn extends Vo{constructor(e,t){super(e,t,new ns,!1)}get parent(){const e=Wl(this._path);return e===null?null:new Dn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class So{constructor(e,t,o){this._node=e,this.ref=t,this._index=o}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Y(e),o=jt(this.ref,e);return new So(this._node.getChild(t),o,se)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(o,i)=>e(new So(i,jt(this.ref,o),se)))}hasChild(e){const t=new Y(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ye(n,e){return n=Xn(n),n._checkNotDeleted("ref"),e!==void 0?jt(n._root,e):n._root}function jt(n,e){return n=Xn(n),F(n._path)===null?bh("child","path",e):_s("child","path",e),new Dn(n._repo,le(n._path,e))}function so(n,e){n=Xn(n),vs("push",n._path),va("push",e,n._path,!0);const t=Ua(n._repo),o=xh(t),i=jt(n,o),s=jt(n,o);let r;return r=Promise.resolve(s),i.then=r.then.bind(r),i.catch=r.then.bind(r,void 0),i}function wa(n){return vs("remove",n._path),Vh(n,null)}function Vh(n,e){n=Xn(n),vs("set",n._path),va("set",e,n._path,!1);const t=new Xt;return Ih(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function Di(n,e){yh("update",e,n._path);const t=new Xt;return Bh(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}class Is{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const o=t._queryParams.getIndex();return new Oh("value",this,new So(e.snapshotNode,new Dn(t._repo,t._path),o))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Lh(this,e,t):null}matches(e){return e instanceof Is?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Wh(n,e,t,o,i){let s;if(typeof o=="object"&&(s=void 0,i=o),typeof o=="function"&&(s=o),i&&i.onlyOnce){const a=t,d=(u,h)=>{wi(n._repo,n,l),a(u,h)};d.userCallback=t.userCallback,d.context=t.context,t=d}const r=new Fh(t,s||void 0),l=new Is(r);return wh(n._repo,n,l),()=>wi(n._repo,n,l)}function ka(n,e,t,o){return Wh(n,"value",e,t,o)}function Da(n,e,t){wi(n._repo,n,null)}class jh{}class Gh extends jh{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){Hh(e,"orderByChild");const t=new Y(this._path);if(H(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const o=new Zi(t),i=Z0(e._queryParams,o);return zh(i),new Vo(e._repo,e._path,i,!0)}}function Kh(n){return _s("orderByChild","path",n),new Gh(n)}function Xh(n,...e){let t=Xn(n);for(const o of e)t=o._apply(t);return t}z2(Dn);X2(Dn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ou(n){z1(w1),fo(new xt("database",(e,{instanceIdentifier:t})=>{const o=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return qh(o,i,s,t)},"PUBLIC").setMultipleInstances(!0)),ot(ir,sr,n),ot(ir,sr,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ot(su,ru,"app");const Rn=n=>n?String(n).split(/[\r\n,=\s]/)[0].trim():"",Mi={apiKey:Rn("AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs"),authDomain:Rn("findparkinglot-2519e.firebaseapp.com"),projectId:Rn("findparkinglot-2519e"),databaseURL:Rn("https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app"),storageBucket:Rn("findparkinglot-2519e.firebasestorage.app"),messagingSenderId:Rn("976769533420"),appId:Rn("1:976769533420:web:f3108318b3def30017acc9")},dn=!!(Mi.apiKey&&Mi.databaseURL);let Lr=null,Ge=null;dn&&(Lr=bl(Mi),Ge=nu(Lr));const ro="parking_overrides",Bt=E({}),Ta=E(!1),Ni=E(null);let Mt=null,li=0;function lo(n,e){if(!n||!Array.isArray(e))return"";const t=Number(e[0]),o=Number(e[1]);return!isFinite(t)||!isFinite(o)?"":`${n}|${t.toFixed(6)},${o.toFixed(6)}`.replace(/[.#$/[\]]/g,"_")}function Ma(n,e){if(!e)return n;const t={...n},o=i=>{const s=e[i];s!=null&&(typeof s=="string"&&s.trim()===""||(t[i]=s))};return o("description"),o("iconKey"),o("category"),o("friendliness"),o("priceInfo"),t}function lu(){if(!(!dn||Mt))try{const n=Ye(Ge,ro);Mt=n,ka(n,e=>{const t={};e.forEach(o=>{t[o.key]=o.val()||{}}),Bt.value=t,Ta.value=!0},e=>{Ni.value=e})}catch(n){Ni.value=n}}function au(){Mt&&(Da(Mt),Mt=null)}function cu(){Kn(()=>{li+=1,lu()}),ht(()=>{li-=1,li<=0&&au()});const n=(s,r)=>{const l=lo(s,r);return l&&Bt.value[l]||null};return{overrides:Bt,ready:Ta,error:Ni,getOverride:n,hasOverride:(s,r)=>!!n(s,r),getOverrideHistory:(s,r)=>{const l=n(s,r);return!l||!l.history||typeof l.history!="object"?[]:Object.entries(l.history).map(([a,d])=>({...d||{},_key:a})).sort((a,d)=>a._key<d._key?1:a._key>d._key?-1:0)},upsertOverride:async(s,r,l)=>{var T,W,Ee;if(!dn)throw new Error("Firebase 尚未設定");const a=lo(s.name,s.geometry);if(!a)throw new Error("無法產生 override key (缺少 name 或 geometry)");const[d,u]=s.geometry,h={id:l.id,nickname:l.nickname||""},m={origName:s.name||"",origLng:Number(d),origLat:Number(u),description:typeof r.description=="string"?r.description.trim():"",iconKey:r.iconKey||"",category:r.category||"",friendliness:r.friendliness||"",priceInfo:typeof r.priceInfo=="string"?r.priceInfo.trim():"",updatedBy:h,updatedAt:Fn()},b=Bt.value[a]||null,g=Ma(s,b),U=["description","iconKey","category","friendliness","priceInfo"],D={},I={};for(const ae of U){const Ie=(T=g==null?void 0:g[ae])!=null?T:"",Ae=(W=m[ae])!=null?W:"";String(Ie)!==String(Ae)&&(D[ae]=Ie,I[ae]=Ae)}const V=so(Ye(Ge,`${ro}/${a}/history`)).key;return await Di(Ye(Ge),{[`${ro}/${a}`]:{...m,history:{...((Ee=Bt.value[a])==null?void 0:Ee.history)||{},[V]:{action:"override",at:Fn(),by:h,before:D,after:I}}}}),a},resetOverride:async(s,r)=>{if(!dn)throw new Error("Firebase 尚未設定");const l=lo(s,r);l&&await wa(Ye(Ge,`${ro}/${l}`))}}}const nn=(n,e)=>{const t=n.__vccOpts||n;for(const[o,i]of e)t[o]=i;return t},du={id:"map"},hu=16,Fr=34,uu=84,pu={__name:"MapBox",props:{parkingTypeKeyArray:Array,degreeOfFriendlinessKeyArray:Array,mapDataList:Array,getLngLat:Boolean,mapStylesSelected:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,goToParkingPlaceData:Object,routeData:Object,favoriteIds:{type:Object,default:()=>new Set},overrideKeys:{type:Object,default:()=>new Set},overrides:{type:Object,default:()=>({})},onlyFavorites:{type:Boolean,default:!1},focusCoord:{type:Array,default:null},routeProfile:{type:String,default:"driving"},communityParkings:{type:Array,default:()=>[]}},emits:["parkingInfo","communityParkingClick","update:goToParkingPlaceData","update:routeData"],setup(n,{expose:e,emit:t}){const o=n,i=t,s="pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",r=E(null),l=E({accessToken:s,bounds:[[119.3620389067818,21.83282743468497],[122.07013958372167,25.34391086143183]],center:[121.5173399,25.0475613],zoom:14,userCoordinates:[null,null]}),a=E(null),d=E([]),u=_=>_>=15?60:_>=13?60+(15-_)*30:_>=11?120+(13-_)*60:240,h=_=>Array.isArray(_)&&_.length>=2&&Number.isFinite(Number(_[0]))&&Number.isFinite(Number(_[1])),m=(_,M,G,$)=>{const K=document.createElement("div");K.className="marker",$&&K.classList.add("is-override"),G&&K.classList.add("is-fav");const we=document.createElement("div");we.className="tag";const xe=document.createElement("div");return xe.className="img",M.properties.icon&&(xe.style.backgroundImage=`url(${J(M.properties.icon)})`,xe.style.backgroundSize="cover",xe.style.backgroundPosition="center center"),K.appendChild(we),K.appendChild(xe),K.addEventListener("click",()=>{r.value.flyTo({center:M.geometry.coordinates,zoom:17,bearing:0,speed:1.5,curve:1.5,easing:C=>C,essential:!0}),i("parkingInfo",{name:_.name,properties:M.properties,geometry:M.geometry.coordinates,address:""})}),K},b=(_,M)=>{const G=document.createElement("div");G.className="marker is-community",M&&G.classList.add("is-fav");const $=document.createElement("div");$.className="tag";const K=document.createElement("div");return K.className="img",_.iconKey&&(K.style.backgroundImage=`url(${J(_.iconKey)})`,K.style.backgroundSize="cover",K.style.backgroundPosition="center center"),G.appendChild($),G.appendChild(K),G.addEventListener("click",()=>{r.value.flyTo({center:_.coordinates,zoom:17,speed:1.5,curve:1.5,essential:!0}),i("communityParkingClick",_)}),G},g=_=>{const M=document.createElement("div");M.className="marker-cluster";const G=Math.min(1,Math.log2(Math.max(2,_))/Math.log2(500)),$=Math.round(Fr+(uu-Fr)*G),K=Math.round(12+10*G);return M.style.width=`${$}px`,M.style.height=`${$}px`,M.style.lineHeight=`${$}px`,M.style.fontSize=`${K}px`,M.textContent=String(_),M},U=()=>{var we,xe,tn,C,N,B,re,Te,Oe,bn,on,he;for(let x=d.value.length-1;x>=0;x--)d.value[x].remove();if(d.value=[],!r.value)return;const _=(xe=(we=r.value).getBounds)==null?void 0:xe.call(we),M=[];for(const x of o.mapDataList)for(const O of x.features){const ce=O.geometry.coordinates;if(!h(ce))continue;const Le=ci(O.properties.name,ce),Fe=(C=(tn=o.favoriteIds)==null?void 0:tn.has)==null?void 0:C.call(tn,Le),_e=lo(O.properties.name,ce),Mn=_e?(B=(N=o.overrideKeys)==null?void 0:N.has)==null?void 0:B.call(N,_e):!1,sn=Mn?(re=o.overrides)==null?void 0:re[_e]:null,ke=typeof(sn==null?void 0:sn.priceInfo)=="string"&&sn.priceInfo.trim()!==""?sn.priceInfo.trim():"",rn=ke||O.properties.priceInfo,ln=ke?ke.split("|"):O.properties.priceArray;!js(_,ce)||o.onlyFavorites&&!Fe||!Vs(O.properties.icon,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray)||!Ws(rn,ln,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)||M.push({coord:[Number(ce[0]),Number(ce[1])],createEl:()=>m(x,O,Fe,Mn)})}for(const x of o.communityParkings||[]){const O=x.coordinates;if(!h(O)||!js(_,O))continue;const ce=ci(x.name,O),Le=(Oe=(Te=o.favoriteIds)==null?void 0:Te.has)==null?void 0:Oe.call(Te,ce);if(o.onlyFavorites&&!Le||!Vs(x.iconKey,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray))continue;const Fe=x.priceInfo||"",_e=Fe?Fe.split("|"):[];Ws(Fe,_e,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)&&M.push({coord:[Number(O[0]),Number(O[1])],createEl:()=>b(x,Le)})}const G=(he=(on=(bn=r.value).getZoom)==null?void 0:on.call(bn))!=null?he:0;if(G>=hu){for(const x of M){const O=new Nn.Marker(x.createEl()).setLngLat(x.coord).addTo(r.value);d.value.push(O)}return}const $=u(G),K=new Map;for(const x of M){const O=r.value.project(x.coord),ce=Math.floor(O.x/$),Le=Math.floor(O.y/$),Fe=`${ce}:${Le}`;let _e=K.get(Fe);_e||(_e={points:[],sumLng:0,sumLat:0},K.set(Fe,_e)),_e.points.push(x),_e.sumLng+=x.coord[0],_e.sumLat+=x.coord[1]}for(const x of K.values())if(x.points.length===1){const O=x.points[0],ce=new Nn.Marker(O.createEl()).setLngLat(O.coord).addTo(r.value);d.value.push(ce)}else{const O=[x.sumLng/x.points.length,x.sumLat/x.points.length],ce=g(x.points.length);ce.addEventListener("click",()=>{var _e,Mn,sn;const Fe=Math.min(((sn=(Mn=(_e=r.value).getZoom)==null?void 0:Mn.call(_e))!=null?sn:0)+2,17);r.value.flyTo({center:O,zoom:Fe,speed:1.5,curve:1.5,essential:!0})});const Le=new Nn.Marker(ce).setLngLat(O).addTo(r.value);d.value.push(Le)}};let D=null,I=null;const V=()=>{D!=null&&(clearTimeout(D),D=null),I!=null&&(typeof cancelIdleCallback=="function"&&cancelIdleCallback(I),I=null)},T=()=>{V(),D=setTimeout(()=>{D=null;const _=()=>{I=null,o.goToParkingPlaceData==null&&U()};typeof requestIdleCallback=="function"?I=requestIdleCallback(_,{timeout:250}):_()},80)},W=()=>{const _=document.getElementById("loading-cover");_&&(_.classList.add("active"),setTimeout(()=>_.remove(),600))},Ee=()=>{r.value.on("dragend",T),r.value.on("zoomend",T),U(),W(),r.value.once("load",()=>{const _=o.focusCoord;Array.isArray(_)&&_[0]!=null&&_[1]!=null&&r.value.flyTo({center:[Number(_[0]),Number(_[1])],zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})})},ae=()=>{r.value=new Nn.Map({container:"map",style:o.mapStylesSelected,center:l.value.center,zoom:16,trackResize:!0,maxBounds:l.value.bounds}),Ee(),r.value.addControl(new Nn.GeolocateControl({positionOptions:{enableHighAccuracy:!0},trackUserLocation:!0,showUserHeading:!0})),r.value.on("geolocate",_=>{r.value.easeTo({bearing:_.coords.heading,duration:1e3,offset:[0,0]})})},Ie=_=>{const{longitude:M,latitude:G}=_.coords;M>=l.value.bounds[0][0]&&M<=l.value.bounds[1][0]&&G>=l.value.bounds[0][1]&&G<=l.value.bounds[1][1]?(l.value.userCoordinates=[M,G],l.value.center=[M,G]):l.value.center=[121.5173399,25.0475613],ae()},Ae=()=>{ae()},de=()=>{const _=document.getElementById("coordinates"),M=a.value.getLngLat();_.style.display="block",_.innerHTML=`[Longitude, Latitude]<br />[${M.lng}, ${M.lat}]`},oe=()=>{a.value=new Nn.Marker({draggable:!0,color:"#2ee7d6"}).setLngLat(r.value.getCenter()).addTo(r.value),de(),a.value.on("dragend",de)};async function Be(_,M){r.value.getLayer("point")||r.value.addLayer({id:"point",type:"circle",source:{type:"geojson",data:{type:"FeatureCollection",features:[{type:"Feature",properties:{},geometry:{type:"Point",coordinates:_}}]}},paint:{"circle-radius":10,"circle-color":"#2ee7d6"}});const K=(await(await fetch(`https://api.mapbox.com/directions/v5/mapbox/${o.routeProfile||"driving"}/${_[0]},${_[1]};${M[0]},${M[1]}?alternatives=false&language=zh-Hant&overview=full&steps=true&exclude=ferry&geometries=geojson&access_token=${l.value.accessToken}`,{method:"GET"})).json()).routes[0],we={type:"Feature",properties:{},geometry:{type:"LineString",coordinates:K.geometry.coordinates}};i("update:routeData",K),r.value.getSource("route")?r.value.getSource("route").setData(we):r.value.addLayer({id:"route",type:"line",source:{type:"geojson",data:we},layout:{"line-join":"round","line-cap":"round"},paint:{"line-color":"#2ee7d6","line-width":5,"line-opacity":.75}})}const Re=_=>{if(l.value.userCoordinates[0]!==null){r.value.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point"));for(let G=d.value.length-1;G>=0;G--){const $=d.value[G].getLngLat();$.lng!=_[0]&&$.lat!=_[1]&&d.value[G].remove()}const M=[[l.value.userCoordinates[0],l.value.userCoordinates[1]],[_[0],_[1]]];r.value.fitBounds(M,{padding:{top:100,bottom:100,left:100,right:100}}),Be(l.value.userCoordinates,_)}else"geolocation"in navigator&&navigator.geolocation.getCurrentPosition(Ie,Ae)},Se=()=>{var _,M;(_=r.value)!=null&&_.getSource("route")&&(r.value.removeLayer("route"),r.value.removeSource("route")),(M=r.value)!=null&&M.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point")),U(),i("update:goToParkingPlaceData",null)};return Kn(()=>{Nn.accessToken=l.value.accessToken,"geolocation"in navigator?navigator.geolocation.getCurrentPosition(Ie,Ae,{enableHighAccuracy:!1,timeout:8e3,maximumAge:6e4}):ae()}),ht(()=>{V()}),Q([()=>o.parkingTypeKeyArray,()=>o.degreeOfFriendlinessKeyArray,()=>o.priceRangeMin,()=>o.priceRangeMax,()=>o.parkingPriceType,()=>o.onlyFavorites,()=>o.favoriteIds,()=>o.communityParkings],()=>T()),Q(()=>o.focusCoord,_=>{!_||!r.value||r.value.flyTo({center:_,zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})}),Q(()=>o.routeProfile,()=>{o.goToParkingPlaceData!==null&&l.value.userCoordinates[0]!==null&&Be(l.value.userCoordinates,o.goToParkingPlaceData)}),Q(()=>o.goToParkingPlaceData,_=>{_!==null?Re(_):Se()}),Q(()=>o.mapStylesSelected,(_,M)=>{M!==_&&r.value&&r.value.setStyle(_)}),Q(()=>o.getLngLat,()=>{if(a.value!==null){a.value.remove();const _=document.getElementById("coordinates");_&&(_.style.display="none")}o.getLngLat===!0&&oe()}),e({getCenter:()=>{if(!r.value)return[...l.value.center];const _=r.value.getCenter();return[_.lng,_.lat]},flyTo:(_,M=17)=>{!r.value||!_||r.value.flyTo({center:_,zoom:M,essential:!0})}}),(_,M)=>(v(),P("div",du))}},mu=nn(pu,[["__scopeId","data-v-09d5679d"]]),fu=n=>(wn("data-v-4ef15e45"),n=n(),kn(),n),yu={key:0,class:"modal-header"},bu=fu(()=>c("span",{class:"material-icons-outlined"},"close",-1)),gu=[bu],Au={class:"modal-body"},_u={key:1,class:"modal-footer"},vu={__name:"BaseModal",props:{modelValue:Boolean,title:{type:String,default:""},closeText:{type:String,default:"關閉"},size:{type:String,default:"md"}},emits:["update:modelValue","close"],setup(n,{emit:e}){const t=n,o=e,i=E(null),s=()=>{o("update:modelValue",!1),o("close")},r=l=>{l.key==="Escape"&&t.modelValue&&s()};return Kn(()=>window.addEventListener("keydown",r)),ht(()=>window.removeEventListener("keydown",r)),Q(()=>t.modelValue,async l=>{var a;document.body.classList.toggle("modal-open",l),l&&(await Kr(),(a=i.value)==null||a.scrollTo({top:0,behavior:"auto"}))}),(l,a)=>(v(),Fi(ac,{to:"body"},[c("div",{class:ie(["modal-overlay",{active:n.modelValue}]),onClick:Hi(s,["self"]),role:"dialog","aria-modal":"true",ref_key:"overlayEl",ref:i},[c("div",{class:ie(["modal-card",[`size-${n.size}`,{active:n.modelValue}]])},[n.title||l.$slots.header?(v(),P("header",yu,[Yo(l.$slots,"header",{},()=>[c("h3",null,w(n.title),1)]),c("button",{class:"modal-close",onClick:s,"aria-label":"關閉"},gu)])):j("",!0),c("div",Au,[Yo(l.$slots,"default",{},void 0)]),l.$slots.footer||n.closeText?(v(),P("footer",_u,[Yo(l.$slots,"footer",{},()=>[c("button",{class:"btn btn-primary",onClick:s},w(n.closeText),1)])])):j("",!0)],2)],2)]))}},Ln=nn(vu,[["__scopeId","data-v-4ef15e45"]]),Cu=["onClick"],Pu={class:"material-icons-outlined"},Uu={class:"fab-item-label"},Eu=["aria-label","aria-expanded"],Iu={class:"material-icons-outlined"},Bu={__name:"FabMenu",props:{items:{type:Array,required:!0},placement:{type:String,default:"right"},mainIcon:{type:String,default:"apps"},mainLabel:{type:String,default:""}},setup(n){const e=E(!1),t=E(null),o=()=>e.value=!e.value,i=r=>{t.value&&!t.value.contains(r.target)&&(e.value=!1)},s=r=>{var l;e.value=!1,(l=r.onClick)==null||l.call(r)};return Kn(()=>document.addEventListener("click",i)),ht(()=>document.removeEventListener("click",i)),(r,l)=>(v(),P("div",{class:ie(["fab-root",`fab-placement-${n.placement}`]),ref_key:"rootEl",ref:t},[Ue(cc,{name:"fab-item",tag:"div",class:"fab-items"},{default:cn(()=>[(v(!0),P(ye,null,Ke(e.value?n.items:[],(a,d)=>(v(),P("button",{key:a.key,class:ie(["fab-item",{highlight:a.highlight}]),style:co({bottom:d*46+"px"}),onClick:u=>s(a)},[c("span",Pu,w(a.icon),1),c("span",Uu,w(a.label),1)],14,Cu))),128))]),_:1}),c("button",{class:ie(["fab-main",{active:e.value}]),onClick:Hi(o,["stop"]),"aria-label":e.value?"收合選單":n.mainLabel||"展開選單","aria-expanded":e.value},[c("span",Iu,w(e.value?"close":n.mainIcon),1)],10,Eu)],2))}},Hr=nn(Bu,[["__scopeId","data-v-b3399b6f"]]),Gt=[{name:"全部",value:"",key:null},{name:"汽車：汽車格(含未確認是否有重機格)",value:"car",key:["icon-1.png","icon-2.png","icon-3.png","icon-5.png"]},{name:"重機：有設重機專用格",value:"motorcycle",key:["icon-6.png","icon-8.png","icon-12.png","icon-13.png"]},{name:"機車：機車格",value:"scooter",key:["icon-7.png","icon-9.png","icon-10.png","icon-11.png"]},{name:"綠星:路邊友善車格(機車格開放重機停放)",value:"greenStar",key:["icon-14.png"]},{name:"重機友善店家:用餐/消費可停重機",value:"friendlyShop",key:["icon-4.png"]},{name:"綠P:重機專用路邊停車格",value:"greenP",key:["icon-15.png"]},{name:"灰P:重機專用路邊停車格(未確認精準座標)",value:"greyP",key:["icon-16.png"]},{name:"藍P:普通大型共用機車格(台北市試辦)",value:"blueP",key:["icon-17.png"]},{name:"紫P:時段性汽機車共用停車格，注意使用時間喔!",value:"purpleP",key:["icon-18.png"]},{name:"紅X:停都不給停",value:"redX",key:["icon-19.png"]},{name:"?:類型未確認",value:"unknown",key:["icon-20.png"]}],Kt=[{name:"全部",value:"",key:null},{name:"最友善：有後牌辨析",value:"friendly",key:["icon-2.png","icon-4.png","icon-6.png","icon-9.png","icon-14.png","icon-15.png"]},{name:"最傳統：悠遊卡、按鈕取票",value:"normal",key:["icon-5.png","icon-11.png","icon-12.png","icon-17.png"]},{name:"最靠北：按鈕請管理員協助、前牌辨析",value:"unfriendly",key:["icon-1.png","icon-7.png","icon-13.png","icon-19.png"]},{name:"未確定",value:"unknown",key:["icon-3.png","icon-8.png","icon-10.png","icon-16.png","icon-20.png"]}],nt=[{name:"依系統設定",value:"system",theme:"system"},{name:"暗色模式",value:"mapbox://styles/jamestim9215/ckvkdj5cd1q4115nzwxa9rny3",theme:"dark"},{name:"亮色模式",value:"mapbox://styles/jamestim9215/ckvueghhu2woc14nrsgysx41v",theme:"light"}],Su="260526",wu=n=>(wn("data-v-fc736dec"),n=n(),kn(),n),ku={class:"range-slider"},Du={class:"range-track"},Tu=["min","max","step","value"],Mu=["min","max","step","value"],Nu={class:"range-values"},Ru=wu(()=>c("span",{class:"range-sep"},"~",-1)),xu={__name:"RangeSlider",props:{min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:10},modelMin:{type:Number,default:0},modelMax:{type:Number,default:100},suffix:{type:String,default:""}},emits:["update:modelMin","update:modelMax"],setup(n,{emit:e}){const t=n,o=e,i=q(()=>t.max-t.min||1),s=q(()=>(t.modelMin-t.min)/i.value*100),r=q(()=>(t.modelMax-t.min)/i.value*100),l=d=>{let u=Number(d.target.value);u>t.modelMax&&(u=t.modelMax),o("update:modelMin",u)},a=d=>{let u=Number(d.target.value);u<t.modelMin&&(u=t.modelMin),o("update:modelMax",u)};return(d,u)=>(v(),P("div",ku,[c("div",Du,[c("div",{class:"range-fill",style:co({left:s.value+"%",right:100-r.value+"%"})},null,4),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMin,onInput:l,class:"range-input range-input-min","aria-label":"最低價格"},null,40,Tu),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMax,onInput:a,class:"range-input range-input-max","aria-label":"最高價格"},null,40,Mu)]),c("div",Nu,[c("span",null,w(n.modelMin)+w(n.suffix),1),Ru,c("span",null,w(n.modelMax)+w(n.suffix),1)])]))}},Ou=nn(xu,[["__scopeId","data-v-fc736dec"]]),Ve=n=>(wn("data-v-511ae798"),n=n(),kn(),n),Lu=Ve(()=>c("span",{class:"material-icons-outlined"},"chevron_left",-1)),Fu=[Lu],Hu=Xr('<header class="side-panel-header" data-v-511ae798><img class="side-panel-logo" src="'+zi+'" alt="重機能停哪" data-v-511ae798><div class="side-panel-titles" data-v-511ae798><h3 data-v-511ae798>重機能停哪?</h3><span class="side-panel-subtitle" data-v-511ae798><span class="material-icons-outlined" data-v-511ae798>tune</span>設定 </span></div></header>',1),zu={class:"side-panel-body"},Vu={class:"form-group"},Wu={class:"form-toggle"},ju={class:"form-toggle-text"},Gu=Ve(()=>c("span",{class:"material-icons-outlined fav-icon"},"star",-1)),Ku={key:0,class:"fav-count"},Xu=["checked"],Qu={class:"form-group"},Yu=Ve(()=>c("label",{class:"form-label"},"甚麼格位",-1)),Ju=["value"],qu=["value"],$u={class:"form-group"},Zu=Ve(()=>c("label",{class:"form-label"},"友善程度",-1)),e3=["value"],n3=["value"],t3={class:"form-group"},o3=Ve(()=>c("label",{class:"form-label"},"收費範圍",-1)),i3={class:"price-chips"},s3=Ve(()=>c("span",{class:"material-icons-outlined"},"money_off",-1)),r3={class:"form-group"},l3=Ve(()=>c("label",{class:"form-label"},"主題顏色",-1)),a3=["value"],c3=["value"],d3=Xr('<section class="form-group" data-v-511ae798><label class="form-label" data-v-511ae798>停車場資料來源</label><div class="link-list" data-v-511ae798><a href="https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&amp;g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&amp;skid=9984dc32-0eac-4e02-b7a8-241e8910f915&amp;shorturl=1&amp;ll=25.078951126084913%2C121.45397636318671&amp;z=11" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-511ae798> Alan大重停車記事 </a></div></section><section class="form-group" data-v-511ae798><label class="form-label" data-v-511ae798>問題回報</label><p class="muted-text" data-v-511ae798> 1. 停車場資訊相關（新場地、收費錯誤）： </p><a href="https://forms.gle/euRCPCPSmvYLm5Rj8" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-511ae798> Alan大重停車記事 回報表單 </a><p class="muted-text mt-8" data-v-511ae798>2. 網頁 BUG、畫面跑版：</p><a href="https://forms.gle/iJCyfqVtpL35WtZM7" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-511ae798> 重機能停哪? 回報表單 </a><a href="https://buymeacoffee.com/jamestim923" target="_blank" rel="noopener" class="btn btn-coffee btn-sm mt-8" data-v-511ae798> ☕️ 請我喝杯咖啡，讓我有動力繼續更新 </a></section>',2),h3={class:"form-group"},u3=Ve(()=>c("label",{class:"form-label"},"資訊",-1)),p3={class:"info-list"},m3=Ve(()=>c("li",null,"版本：v2.2.1",-1)),f3=Ve(()=>c("li",null,"Web 製作：爽爽",-1)),y3=Ve(()=>c("li",null,"資料參考：Alan大重停車記事 Google My Map",-1)),b3=Ve(()=>c("li",null,"地圖：Mapbox GL JS API",-1)),g3=Ve(()=>c("li",null,"© 2026 爽爽 版權所有。本網頁未經准許，禁止任何商業行為",-1)),A3={__name:"SettingsPanel",props:{parkingType:String,degreeOfFriendliness:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,mapStyle:String,active:Boolean,onlyFavorites:Boolean,favoritesCount:{type:Number,default:0}},emits:["update:parkingType","update:degreeOfFriendliness","update:parkingPriceType","update:priceRangeMin","update:priceRangeMax","update:mapStyle","update:active","update:onlyFavorites"],setup(n,{emit:e}){const t=e,o=()=>t("update:active",!1);return(i,s)=>(v(),P("aside",{class:ie(["side-panel",{active:n.active}]),"aria-label":"設定面板"},[c("button",{class:"side-panel-close",onClick:o,"aria-label":"收合設定"},Fu),Hu,c("div",zu,[c("section",Vu,[c("label",Wu,[c("span",ju,[Gu,k(" 只看我的最愛 "),n.favoritesCount?(v(),P("span",Ku,w(n.favoritesCount),1)):j("",!0)]),c("input",{type:"checkbox",class:"switch",checked:n.onlyFavorites,onChange:s[0]||(s[0]=r=>t("update:onlyFavorites",r.target.checked))},null,40,Xu)])]),c("section",Qu,[Yu,c("select",{class:"form-control",value:n.parkingType,onChange:s[1]||(s[1]=r=>t("update:parkingType",r.target.value))},[(v(!0),P(ye,null,Ke(L(Gt),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,qu))),128))],40,Ju)]),c("section",$u,[Zu,c("select",{class:"form-control",value:n.degreeOfFriendliness,onChange:s[2]||(s[2]=r=>t("update:degreeOfFriendliness",r.target.value))},[(v(!0),P(ye,null,Ke(L(Kt),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,n3))),128))],40,e3)]),c("section",t3,[o3,c("div",i3,[c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType===""}]),onClick:s[3]||(s[3]=r=>t("update:parkingPriceType",""))},"全部",2),c("button",{type:"button",class:ie(["chip chip-free",{active:n.parkingPriceType==="free"}]),onClick:s[4]||(s[4]=r=>t("update:parkingPriceType",n.parkingPriceType==="free"?"":"free"))},[s3,k(" 免費 ")],2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="h"}]),onClick:s[5]||(s[5]=r=>t("update:parkingPriceType","h"))},"計時 /時",2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="d"}]),onClick:s[6]||(s[6]=r=>t("update:parkingPriceType","d"))},"計次 /日",2)]),/d|h/.test(n.parkingPriceType)?(v(),Fi(Ou,{key:0,class:"mt-8",min:0,max:300,step:10,"model-min":n.priceRangeMin,"model-max":n.priceRangeMax,suffix:n.parkingPriceType==="h"?" /時":" /日","onUpdate:modelMin":s[7]||(s[7]=r=>t("update:priceRangeMin",r)),"onUpdate:modelMax":s[8]||(s[8]=r=>t("update:priceRangeMax",r))},null,8,["model-min","model-max","suffix"])):j("",!0)]),c("section",r3,[l3,c("select",{class:"form-control",value:n.mapStyle,onChange:s[9]||(s[9]=r=>t("update:mapStyle",r.target.value))},[(v(!0),P(ye,null,Ke(L(nt),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,c3))),128))],40,a3)]),d3,c("section",h3,[u3,c("ul",p3,[m3,c("li",null,"地圖資料更新："+w(L(Su)),1),f3,y3,b3,g3])])])],2))}},_3=nn(A3,[["__scopeId","data-v-511ae798"]]),Qe=n=>(wn("data-v-e6db4a59"),n=n(),kn(),n),v3=Qe(()=>c("span",{class:"material-icons-outlined"},"close",-1)),C3=[v3],P3={class:"info-header"},U3=["src"],E3={class:"info-title"},I3=["aria-label","title"],B3={class:"material-icons-outlined"},S3=["innerHTML"],w3={key:1,class:"info-address"},k3={key:2,class:"info-price"},D3=Qe(()=>c("span",{class:"material-icons-outlined"},"payments",-1)),T3=Qe(()=>c("span",{class:"info-price-label"},"收費",-1)),M3={class:"info-price-value"},N3={key:0,class:"info-price-tag"},R3={key:3,class:"community-tag"},x3=Qe(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),O3={key:4,class:"override-tag"},L3=Qe(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),F3={key:5,class:"source-tag"},H3=Qe(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),z3={class:"info-meta"},V3={class:"badge"},W3={class:"coord"},j3={class:"info-actions"},G3=Qe(()=>c("span",{class:"material-icons-outlined"},"edit",-1)),K3=["title"],X3=Qe(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),Q3=Qe(()=>c("span",{class:"material-icons-outlined"},"share",-1)),Y3={class:"info-actions"},J3=Qe(()=>c("span",{class:"material-icons-outlined"},"map",-1)),q3=Qe(()=>c("span",{class:"material-icons-outlined"},"map",-1)),$3=Qe(()=>c("span",{class:"material-icons-outlined"},"directions",-1)),Z3={__name:"ParkingInfoPanel",props:{info:Object,active:Boolean,isMobile:Boolean,isApple:Boolean,isAndroid:Boolean,hasRoute:Boolean,isFavorite:Boolean,isCommunity:{type:Boolean,default:!1},communityMeta:{type:Object,default:null},isOverridden:{type:Boolean,default:!1},overrideMeta:{type:Object,default:null}},emits:["close","route","openMap","toggleFavorite","editCommunity","editOverride","share"],setup(n,{emit:e}){const t=e,o=new Set(["icon-4.png","icon-14.png","icon-19.png"]),i=s=>!!(s!=null&&s.priceInfo)&&!o.has(s==null?void 0:s.parkingIconKey);return(s,r)=>{var l,a,d,u,h,m,b,g;return v(),P("aside",{class:ie(["info-panel",{active:n.active}]),"aria-label":"停車場資訊"},[c("button",{class:"panel-close",onClick:r[0]||(r[0]=U=>t("close")),"aria-label":"關閉"},C3),c("header",P3,[n.info.parkingIcon?(v(),P("img",{key:0,class:"info-icon",src:n.info.parkingIcon,alt:""},null,8,U3)):j("",!0),c("h3",E3,w(n.info.parkingName),1),c("button",{class:ie(["fav-btn",{active:n.isFavorite}]),onClick:r[1]||(r[1]=U=>t("toggleFavorite")),"aria-label":n.isFavorite?"從我的最愛移除":"加入我的最愛",title:n.isFavorite?"從我的最愛移除":"加入我的最愛"},[c("span",B3,w(n.isFavorite?"star":"star_border"),1)],10,I3)]),n.info.parkingNameDes?(v(),P("div",{key:0,class:"info-desc",innerHTML:n.info.parkingNameDes},null,8,S3)):j("",!0),n.info.address?(v(),P("div",w3,w(n.info.address),1)):j("",!0),i(n.info)?(v(),P("div",k3,[D3,T3,c("span",M3,w(n.info.priceInfo),1),n.isOverridden?(v(),P("span",N3,"車友修改")):j("",!0)])):j("",!0),n.isCommunity?(v(),P("div",R3,[x3,c("span",null,[k(" 共筆停車點 "),(a=(l=n.communityMeta)==null?void 0:l.updatedBy)!=null&&a.nickname||(u=(d=n.communityMeta)==null?void 0:d.updatedBy)!=null&&u.id?(v(),P(ye,{key:0},[k(" · 由 "+w(n.communityMeta.updatedBy.nickname||`匿名#${n.communityMeta.updatedBy.id}`)+" 更新 ",1)],64)):j("",!0)])])):n.isOverridden?(v(),P("div",O3,[L3,c("span",null,[k(" 車友修改資訊 "),(m=(h=n.overrideMeta)==null?void 0:h.updatedBy)!=null&&m.nickname||(g=(b=n.overrideMeta)==null?void 0:b.updatedBy)!=null&&g.id?(v(),P(ye,{key:0},[k(" · 由 "+w(n.overrideMeta.updatedBy.nickname||`匿名#${n.overrideMeta.updatedBy.id}`)+" 更新 ",1)],64)):j("",!0)])])):j("",!0),!n.isCommunity&&n.info.sourceLabel?(v(),P("div",F3,[H3,c("span",null,"資料來源 · "+w(n.info.sourceLabel),1)])):j("",!0),c("div",z3,[c("span",V3,w(n.info.parkingType),1),c("span",W3,w(Number(n.info.geometry[0]).toFixed(5))+", "+w(Number(n.info.geometry[1]).toFixed(5)),1)]),c("div",j3,[n.isCommunity?(v(),P("button",{key:0,class:"btn btn-outline btn-sm",onClick:r[2]||(r[2]=U=>t("editCommunity"))},[G3,k(" 編輯 ")])):(v(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:r[3]||(r[3]=U=>t("editOverride")),title:n.isOverridden?"修改車友提供的資訊 (不會變動官方資料)":"異議 / 補充官方資料 (不會變動官方資料)"},[X3,k(" "+w(n.isOverridden?"修改車友資訊":"異議 / 補充"),1)],8,K3)),c("button",{class:"btn btn-outline btn-sm",onClick:r[4]||(r[4]=U=>t("share")),title:"分享這個停車點"},[Q3,k(" 分享 ")])]),c("div",Y3,[n.isAndroid?j("",!0):(v(),P("button",{key:0,class:"btn btn-primary btn-sm",onClick:r[5]||(r[5]=U=>t("openMap","apple"))},[J3,k(" Apple Map ")])),c("button",{class:ie(["btn","btn-sm",n.isAndroid?"btn-primary":"btn-outline"]),onClick:r[6]||(r[6]=U=>t("openMap","google"))},[q3,k(" Google Map ")],2),n.hasRoute?j("",!0):(v(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:r[7]||(r[7]=U=>t("route"))},[$3,k(" 路線規劃 ")]))])],2)}}},e5=nn(Z3,[["__scopeId","data-v-e6db4a59"]]),Bs=n=>(wn("data-v-caf0ec6e"),n=n(),kn(),n),n5={class:"route-header"},t5=Bs(()=>c("h3",null,[c("span",{class:"material-icons-outlined"},"alt_route"),k(" 路線 ")],-1)),o5=["aria-expanded"],i5={class:"material-icons-outlined"},s5={key:0,class:"route-summary"},r5={class:"route-summary-item"},l5=Bs(()=>c("span",{class:"material-icons-outlined"},"schedule",-1)),a5={class:"route-summary-item"},c5=Bs(()=>c("span",{class:"material-icons-outlined"},"straighten",-1)),d5={class:"route-profile",role:"tablist","aria-label":"交通方式"},h5=["onClick","aria-pressed"],u5={class:"material-icons-outlined"},p5={class:"profile-label"},m5={key:1,class:"route-steps"},f5={__name:"RouteSteps",props:{routeData:Object,active:Boolean,profile:{type:String,default:"driving"}},emits:["cancel","update:profile"],setup(n,{emit:e}){const t=n,o=e,i=E(!0),s=()=>i.value=!i.value,r=[{value:"driving",label:"汽機車",icon:"directions_car"},{value:"cycling",label:"單車",icon:"directions_bike"},{value:"walking",label:"步行",icon:"directions_walk"}],l=q(()=>{var h;const u=(h=t.routeData)==null?void 0:h.distance;return typeof u!="number"?"":u>=1e3?`${(u/1e3).toFixed(1)} km`:`${Math.round(u)} m`}),a=q(()=>{var g;const u=(g=t.routeData)==null?void 0:g.duration;if(typeof u!="number")return"";const h=Math.round(u/60);if(h<60)return`${h} 分`;const m=Math.floor(h/60),b=h%60;return b?`${m} 時 ${b} 分`:`${m} 時`}),d=u=>o("update:profile",u);return(u,h)=>(v(),P("aside",{class:ie(["route-panel",{active:n.active}])},[c("header",n5,[t5,c("button",{class:"route-toggle",onClick:s,"aria-expanded":i.value},[c("span",i5,w(i.value?"expand_less":"expand_more"),1)],8,o5)]),n.routeData?(v(),P("div",s5,[c("div",r5,[l5,c("strong",null,w(a.value),1)]),c("div",a5,[c5,c("strong",null,w(l.value),1)])])):j("",!0),c("div",d5,[(v(),P(ye,null,Ke(r,m=>c("button",{key:m.value,class:ie(["profile-btn",{active:n.profile===m.value}]),onClick:b=>d(m.value),"aria-pressed":n.profile===m.value},[c("span",u5,w(m.icon),1),c("span",p5,w(m.label),1)],10,h5)),64))]),n.routeData&&i.value?(v(),P("ol",m5,[(v(!0),P(ye,null,Ke(n.routeData.legs[0].steps,(m,b)=>(v(),P("li",{key:b,class:"route-step"},w(m.maneuver.instruction),1))),128))])):j("",!0),c("button",{class:"btn btn-danger btn-sm route-cancel",onClick:h[0]||(h[0]=m=>o("cancel"))}," 取消路線規劃 ")],2))}},y5=nn(f5,[["__scopeId","data-v-caf0ec6e"]]);function b5(n,e,t=20,o=[]){const i=(e||"").trim().toLowerCase();if(!i)return[];const s=[];if(Array.isArray(n))for(const r of n)for(const l of r.features){const a=(l.properties.name||"").toLowerCase(),d=(l.properties.description||"").toLowerCase();if((a.includes(i)||d.includes(i))&&(s.push({groupName:r.name,name:l.properties.name,description:l.properties.description,icon:l.properties.icon,geometry:l.geometry.coordinates,properties:l.properties,isCommunity:!1,score:(a.includes(i)?1e3:0)-(a.indexOf(i)===-1?0:a.indexOf(i))}),s.length>500))break}if(Array.isArray(o))for(const r of o){const l=(r.name||"").toLowerCase(),a=(r.description||"").toLowerCase();if(!l.includes(i)&&!a.includes(i))continue;const d=Array.isArray(r.coordinates)?r.coordinates:[null,null];if(!(d[0]==null||d[1]==null)&&(s.push({groupName:"共筆停車點",name:r.name,description:r.description,icon:r.iconKey,geometry:d,properties:{name:r.name,description:r.description,icon:r.iconKey},isCommunity:!0,community:r,score:(l.includes(i)?900:0)-(l.indexOf(i)===-1?0:l.indexOf(i))}),s.length>500))break}return s.sort((r,l)=>l.score-r.score),s.slice(0,t)}const Na=n=>(wn("data-v-2b0f75f6"),n=n(),kn(),n),g5={key:0,class:"search-results",role:"listbox"},A5=["aria-selected","onMouseenter","onClick"],_5=["src"],v5={class:"search-item-text"},C5={class:"search-item-name"},P5={class:"search-item-group"},U5={key:1,class:"search-empty"},E5={class:"search-box",role:"combobox","aria-expanded":"true"},I5=Na(()=>c("span",{class:"material-icons-outlined search-icon"},"search",-1)),B5=Na(()=>c("span",{class:"material-icons-outlined"},"close",-1)),S5=[B5],w5=["aria-label","aria-expanded"],k5={class:"material-icons-outlined"},D5={__name:"SearchBar",props:{mapDataList:Array,communityParkings:{type:Array,default:()=>[]}},emits:["select"],setup(n,{emit:e}){const t=n,o=e,i=E(!1),s=E(""),r=E(-1),l=q(()=>s.value?b5(t.mapDataList,s.value,15,t.communityParkings):[]);Q(s,()=>{r.value=-1});const a=()=>{i.value=!i.value,i.value||(s.value="")},d=()=>{i.value=!1,s.value=""},u=m=>{o("select",m),d()},h=m=>{if(l.value.length)if(m.key==="ArrowDown")m.preventDefault(),r.value=(r.value+1)%l.value.length;else if(m.key==="ArrowUp")m.preventDefault(),r.value=(r.value-1+l.value.length)%l.value.length;else if(m.key==="Enter"){m.preventDefault();const b=r.value>=0?r.value:0;u(l.value[b])}else m.key==="Escape"&&d()};return(m,b)=>(v(),P("div",{class:ie(["search-wrap",{open:i.value}])},[i.value&&l.value.length?(v(),P("ul",g5,[(v(!0),P(ye,null,Ke(l.value,(g,U)=>(v(),P("li",{key:U,class:ie(["search-item",{active:U===r.value}]),role:"option","aria-selected":U===r.value,onMouseenter:D=>r.value=U,onClick:D=>u(g)},[g.icon?(v(),P("img",{key:0,src:L(J)(g.icon),class:"search-item-icon",alt:""},null,8,_5)):j("",!0),c("div",v5,[c("div",C5,w(g.name),1),c("div",P5,w(g.groupName),1)])],42,A5))),128))])):i.value&&s.value&&!l.value.length?(v(),P("div",U5," 找不到「"+w(s.value)+"」相關停車場 ",1)):j("",!0),je(c("div",E5,[I5,je(c("input",{"onUpdate:modelValue":b[0]||(b[0]=g=>s.value=g),class:"search-input",type:"text",placeholder:"搜尋停車場名稱…",autofocus:"",onKeydown:h},null,544),[[It,s.value]]),s.value?(v(),P("button",{key:0,class:"search-clear",onClick:b[1]||(b[1]=g=>s.value=""),"aria-label":"清除"},S5)):j("",!0)],512),[[Et,i.value]]),c("button",{class:ie(["search-toggle",{active:i.value}]),onClick:a,"aria-label":i.value?"關閉搜尋":"開啟搜尋","aria-expanded":i.value},[c("span",k5,w(i.value?"close":"search"),1)],10,w5)],2))}},T5=nn(D5,[["__scopeId","data-v-2b0f75f6"]]),Tn=n=>(wn("data-v-8a26dac9"),n=n(),kn(),n),M5={class:"editor-body"},N5={key:0,class:"editor-note override-note"},R5=Tn(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),x5={key:1,class:"editor-note"},O5=Tn(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),L5={class:"form-group"},F5={class:"form-label"},H5={key:0},z5={key:1,class:"hint-inline"},V5=["readonly","disabled"],W5={class:"form-group"},j5=Tn(()=>c("label",{class:"form-label"},"類別",-1)),G5=["value"],K5={class:"form-group"},X5={class:"form-label"},Q5={key:0,class:"hint-inline"},Y5=["disabled"],J5=["value"],q5={class:"form-group"},$5=Tn(()=>c("label",{class:"form-label"},"收費",-1)),Z5={class:"chip-row"},ep=["onClick"],np={key:0,class:"price-amount"},tp={class:"unit"},op={key:1,class:"price-amount"},ip={class:"form-group"},sp=Tn(()=>c("label",{class:"form-label"},"說明(選填)",-1)),rp={class:"form-group"},lp=Tn(()=>c("label",{class:"form-label"},"暱稱(選填)",-1)),ap=["value"],cp={key:2,class:"error-msg"},dp={key:3,class:"form-group history-section"},hp={class:"form-label"},up=Tn(()=>c("span",{class:"material-icons-outlined",style:{"font-size":"14px","vertical-align":"-2px"}},"history",-1)),pp={class:"history-list"},mp={class:"h-row1"},fp={class:"h-by"},yp={class:"h-time"},bp={key:0,class:"h-diff h-diff-note"},gp={key:1,class:"h-diff-list"},Ap={class:"h-diff-label"},_p={class:"h-diff-old"},vp=Tn(()=>c("span",{class:"h-diff-arrow"},"→",-1)),Cp={class:"h-diff-new"},Pp={key:2,class:"h-diff h-diff-note"},Up=["disabled"],Ep=["disabled"],Ip=["disabled"],Bp=["disabled"],Sp={__name:"CommunityParkingEditor",props:{open:Boolean,mode:{type:String,default:"add"},initial:{type:Object,default:null},defaultCoord:{type:Array,default:()=>[121.5173399,25.0475613]},nickname:{type:String,default:""},isOwner:{type:Boolean,default:!1},isAdmin:{type:Boolean,default:!1},submitting:{type:Boolean,default:!1},hasExistingOverride:{type:Boolean,default:!1},history:{type:Array,default:()=>[]}},emits:["update:open","update:nickname","submit","delete","reset"],setup(n,{emit:e}){const t=n,o=e,i=E(""),s=E(""),r=E("motorcycle"),l=E("friendly"),a=E("free"),d=E(""),u=E(""),h=E([null,null]),m=q(()=>Gt.filter(C=>C.value)),b=q(()=>Kt.filter(C=>C.value)),g={greenStar:"icon-14.png",friendlyShop:"icon-4.png",greenP:"icon-15.png",greyP:"icon-16.png",blueP:"icon-17.png",purpleP:"icon-18.png",redX:"icon-19.png",unknown:"icon-20.png"},U=q(()=>{if(g[r.value])return g[r.value];const C=Gt.find(re=>re.value===r.value),N=Kt.find(re=>re.value===l.value);return C?N&&C.key.find(re=>N.key.includes(re))||C.key[0]:"icon-3.png"}),D=q(()=>!!g[r.value]);function I(C){if(!C)return{type:"free",amount:"",custom:""};const N=C.trim();if(/^free$/i.test(N))return{type:"free",amount:"",custom:""};const B=N.match(/^(\d+(?:\.\d+)?)\s*\/\s*([hd])$/i);return B?{type:B[2].toLowerCase(),amount:B[1],custom:""}:{type:"custom",amount:"",custom:N}}function V(){return a.value==="free"?"Free":a.value==="custom"?u.value.trim():d.value?`${d.value}/${a.value}`:""}const T=()=>{if((t.mode==="edit"||t.mode==="override")&&t.initial){i.value=t.initial.name||"",s.value=t.initial.description||"",r.value=t.initial.category||"motorcycle",l.value=t.initial.friendliness||"friendly";const C=I(t.initial.priceInfo||"");a.value=C.type,d.value=C.amount,u.value=C.custom,h.value=t.initial.coordinates?[...t.initial.coordinates]:[...t.defaultCoord]}else i.value="",s.value="",r.value="motorcycle",l.value="friendly",a.value="free",d.value="",u.value="",h.value=[...t.defaultCoord]};Q(()=>t.open,C=>{C&&T()});const W=E(""),Ee=()=>{if(W.value="",!i.value.trim()){W.value="請輸入名稱";return}if(h.value[0]==null||h.value[1]==null||Number.isNaN(Number(h.value[0]))||Number.isNaN(Number(h.value[1]))){W.value="座標無效";return}o("submit",{name:i.value,description:s.value,iconKey:U.value,category:r.value,friendliness:D.value?"":l.value,priceInfo:V(),coordinates:[Number(h.value[0]),Number(h.value[1])]})},ae=()=>{var C;(C=t.initial)!=null&&C.id&&window.confirm(`確定要刪除「${i.value}」?此動作無法復原。`)&&o("delete",t.initial.id)},Ie=()=>{window.confirm(`確定要重設「${i.value}」回官方原始資料嗎?
你和其他車友先前的修改將被移除。`)&&o("reset")},Ae=q({get:()=>t.open,set:C=>o("update:open",C)}),de=[{value:"free",label:"免費"},{value:"h",label:"計時 / 小時"},{value:"d",label:"計次 / 天"},{value:"custom",label:"其他"}],oe=E(!1),Be=q(()=>!t.history||t.history.length===0?[]:oe.value?t.history:t.history.slice(0,5)),Re={create:"新增",update:"修改",delete:"刪除",override:"覆寫",reset:"重設"};function Se(C){return Re[C]||C||"變更"}function _(C){return C?C.nickname||(C.id?`匿名#${C.id}`:"匿名"):"系統"}function M(C){if(!C||!isFinite(Number(C)))return"";const N=new Date(Number(C)),B=re=>String(re).padStart(2,"0");return`${N.getFullYear()}/${B(N.getMonth()+1)}/${B(N.getDate())} ${B(N.getHours())}:${B(N.getMinutes())}`}const G={name:"名稱",description:"說明",iconKey:"圖示",category:"類別",friendliness:"友善度",priceInfo:"收費",lng:"經度",lat:"緯度"};function $(C){if(C==null||C==="")return"(空)";if(typeof C=="number")return String(C);const N=String(C);return N.length>40?N.slice(0,40)+"…":N}function K(C){return C==null?"":typeof C=="string"?C.trim():String(C)}function we(C){return K(C)===""}function xe(C,N){if(!C||C.action==="delete"||C.action==="reset")return[];if(C.after&&typeof C.after=="object")return Object.keys(C.after).filter(x=>{var Le;const O=(Le=C.before)==null?void 0:Le[x],ce=C.after[x];return!(we(O)&&we(ce)||K(O)===K(ce)||we(O))}).map(x=>{var O;return{label:G[x]||x,before:$((O=C.before)==null?void 0:O[x]),after:$(C.after[x]),hasBefore:!0}});const B=C.snapshot;if(!B||typeof B!="object")return[];const re=new Set(["createdAt","createdBy","updatedAt","updatedBy","origName","origLng","origLat","history"]),Te=t.history.findIndex(he=>he._key===C._key),Oe=Te>=0?t.history[Te+1]:null,bn=Oe?Oe.after&&typeof Oe.after=="object"?{...Oe.before||{},...Oe.after}:Oe.snapshot||null:null,on=[];for(const he of Object.keys(B)){if(re.has(he))continue;const x=B[he];if(bn&&Object.prototype.hasOwnProperty.call(bn,he)){const O=bn[he];if(K(O)===K(x)||we(O))continue;on.push({label:G[he]||he,before:$(O),after:$(x),hasBefore:!0})}}return on}function tn(C){return(C==null?void 0:C.action)==="delete"?"該項目被刪除":(C==null?void 0:C.action)==="reset"?"重設為官方資料":(C==null?void 0:C.action)==="create"?"新增此停車點":""}return(C,N)=>(v(),Fi(Ln,{modelValue:Ae.value,"onUpdate:modelValue":N[9]||(N[9]=B=>Ae.value=B),title:n.mode==="override"?"修改官方停車點":n.mode==="edit"?"編輯停車場":"新增停車場",size:"md"},{footer:cn(()=>[n.mode==="edit"&&n.isOwner?(v(),P("button",{key:0,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:ae}," 刪除 ",8,Up)):j("",!0),n.mode==="override"&&n.hasExistingOverride&&n.isAdmin?(v(),P("button",{key:1,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:Ie,title:"僅站方可使用"}," 重設為官方資料 ",8,Ep)):j("",!0),c("button",{class:"btn btn-outline",disabled:n.submitting,onClick:N[8]||(N[8]=B=>Ae.value=!1)}," 取消 ",8,Ip),c("button",{class:"btn btn-primary",disabled:n.submitting,onClick:Ee},w(n.submitting?"送出中…":n.mode==="override"||n.mode==="edit"?"儲存修改":"新增"),9,Bp)]),default:cn(()=>[c("div",M5,[n.mode==="override"?(v(),P("p",N5,[R5,k(" 你正在「修改官方停車點」:這層修改只會疊加在官方資料之上,不會覆蓋原始資料。所有車友都會看到你的修改,也可以再被其他人修改或重設。 ")])):(v(),P("p",x5,[O5,k(" 共筆停車點:任何人都可以新增或修改。請確認資訊正確、避免不雅內容。 ")])),c("section",L5,[c("label",F5,[k(" 名稱 "),n.mode!=="override"?(v(),P("span",H5,"*")):j("",!0),n.mode==="override"?(v(),P("span",z5,"(官方名稱不可修改)")):j("",!0)]),je(c("input",{"onUpdate:modelValue":N[0]||(N[0]=B=>i.value=B),class:"form-control",type:"text",placeholder:"例:三張里地下停車場",maxlength:"60",readonly:n.mode==="override",disabled:n.mode==="override"},null,8,V5),[[It,i.value]])]),c("section",W5,[j5,je(c("select",{"onUpdate:modelValue":N[1]||(N[1]=B=>r.value=B),class:"form-control"},[(v(!0),P(ye,null,Ke(m.value,B=>(v(),P("option",{key:B.value,value:B.value},w(B.name),9,G5))),128))],512),[[zs,r.value]])]),c("section",K5,[c("label",X5,[k(" 友善程度 "),D.value?(v(),P("span",Q5,"(此類別不適用)")):j("",!0)]),je(c("select",{"onUpdate:modelValue":N[2]||(N[2]=B=>l.value=B),class:"form-control",disabled:D.value},[(v(!0),P(ye,null,Ke(b.value,B=>(v(),P("option",{key:B.value,value:B.value},w(B.name),9,J5))),128))],8,Y5),[[zs,l.value]])]),c("section",q5,[$5,c("div",Z5,[(v(),P(ye,null,Ke(de,B=>c("button",{key:B.value,type:"button",class:ie(["chip",{active:a.value===B.value}]),onClick:re=>a.value=B.value},w(B.label),11,ep)),64))]),a.value==="h"||a.value==="d"?(v(),P("div",np,[je(c("input",{"onUpdate:modelValue":N[3]||(N[3]=B=>d.value=B),type:"number",min:"0",step:"1",class:"form-control compact",placeholder:"金額"},null,512),[[It,d.value]]),c("span",tp,"元 / "+w(a.value==="h"?"小時":"次"),1)])):a.value==="custom"?(v(),P("div",op,[je(c("input",{"onUpdate:modelValue":N[4]||(N[4]=B=>u.value=B),type:"text",class:"form-control",placeholder:"如:平日 30/h、假日 50/d",maxlength:"40"},null,512),[[It,u.value]])])):j("",!0)]),c("section",ip,[sp,je(c("textarea",{"onUpdate:modelValue":N[5]||(N[5]=B=>s.value=B),class:"form-control",rows:"3",placeholder:"後牌辨析、24h、注意事項...",maxlength:"500"},null,512),[[It,s.value]])]),c("section",rp,[lp,c("input",{value:n.nickname,onInput:N[6]||(N[6]=B=>o("update:nickname",B.target.value)),class:"form-control",type:"text",placeholder:"留空將顯示「匿名#xxx-xxx」",maxlength:"20"},null,40,ap)]),W.value?(v(),P("p",cp,w(W.value),1)):j("",!0),n.history.length?(v(),P("section",dp,[c("label",hp,[up,k(" 修改紀錄 ("+w(n.history.length)+") ",1)]),c("ul",pp,[(v(!0),P(ye,null,Ke(Be.value,(B,re)=>(v(),P("li",{key:B._key,class:"history-item"},[c("div",mp,[c("span",{class:ie(["h-action",`h-action-${B.action||"other"}`])},w(Se(B.action)),3),c("span",fp,w(_(B.by)),1),c("span",yp,w(M(B.at)),1)]),tn(B)?(v(),P("div",bp,w(tn(B)),1)):xe(B,re).length?(v(),P("ul",gp,[(v(!0),P(ye,null,Ke(xe(B,re),(Te,Oe)=>(v(),P("li",{key:Oe,class:"h-diff-item"},[c("span",Ap,w(Te.label),1),Te.hasBefore?(v(),P(ye,{key:0},[c("span",_p,w(Te.before),1),vp],64)):j("",!0),c("span",Cp,w(Te.after),1)]))),128))])):(v(),P("div",Pp,"(與上一筆相同)"))]))),128))]),n.history.length>5?(v(),P("button",{key:0,type:"button",class:"history-toggle",onClick:N[7]||(N[7]=B=>oe.value=!oe.value)},w(oe.value?"收起":`顯示全部 ${n.history.length} 筆`),1)):j("",!0)])):j("",!0)])]),_:1},8,["modelValue","title"]))}},wp=nn(Sp,[["__scopeId","data-v-8a26dac9"]]),kp={class:"tour-card-head"},Dp={class:"tour-step-index"},Tp={class:"tour-title"},Mp={key:0,class:"material-icons-outlined"},Np={class:"tour-desc"},Rp={class:"tour-actions"},xp={key:0,class:"material-icons-outlined"},Op={key:1,class:"material-icons-outlined"},An=8,Lp=12,zr=300,oo=16,Fp={__name:"OnboardingTour",props:{active:{type:Boolean,default:!1},steps:{type:Array,required:!0}},emits:["update:active","finish"],setup(n,{emit:e}){const t=n,o=e,i=E(0),s=E(null),r=E(!1),l=q(()=>t.steps[i.value]||null),a=q(()=>i.value>=t.steps.length-1),d=async()=>{await Kr();const I=l.value;if(!I){s.value=null;return}const V=I.selector?document.querySelector(I.selector):null;if(!V){s.value=null;return}const T=V.getBoundingClientRect();if(T.width===0&&T.height===0){s.value=null;return}s.value={top:T.top,left:T.left,width:T.width,height:T.height}},u=async()=>{for(let I=0;I<8;I++){if(await d(),s.value)return;await new Promise(V=>setTimeout(V,150))}};Q(()=>[t.active,i.value],async([I])=>{if(!I){r.value=!1;return}r.value=!1,await u(),r.value=!0},{immediate:!0});const h=()=>d();Kn(()=>{window.addEventListener("resize",h),window.addEventListener("scroll",h,!0)}),ht(()=>{window.removeEventListener("resize",h),window.removeEventListener("scroll",h,!0)});const m=q(()=>{const I=s.value;return I?{top:I.top-An+"px",left:I.left-An+"px",width:I.width+An*2+"px",height:I.height+An*2+"px",borderRadius:Lp+"px"}:{display:"none"}}),b=q(()=>{var oe;const I=s.value,V=window.innerWidth,T=window.innerHeight;if(!I)return{top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:Math.min(zr,V-32)+"px"};const W=((oe=l.value)==null?void 0:oe.placement)||"auto";let Ee=W;if(W==="auto"){const Be=T-(I.top+I.height),Re=I.top;Ee=Be>=Re?"bottom":"top"}const ae=Math.min(zr,V-32);let Ie,Ae,de="";return Ee==="bottom"?(Ie=I.top+I.height+oo+An,Ae=Math.max(16,Math.min(V-ae-16,I.left+I.width/2-ae/2))):Ee==="top"?(Ie=I.top-oo-An,Ae=Math.max(16,Math.min(V-ae-16,I.left+I.width/2-ae/2)),de="translateY(-100%)"):Ee==="right"?(Ie=Math.max(16,I.top+I.height/2),Ae=I.left+I.width+oo+An,de="translateY(-50%)"):(Ie=Math.max(16,I.top+I.height/2),Ae=I.left-oo-An,de="translate(-100%, -50%)"),{top:Ie+"px",left:Ae+"px",width:ae+"px",transform:de}}),g=()=>{a.value?D():i.value+=1},U=()=>D(),D=()=>{o("update:active",!1),o("finish"),i.value=0};return Q(()=>t.active,I=>{I&&(i.value=0)}),(I,V)=>n.active&&l.value?(v(),P("div",{key:0,class:ie(["tour-root",{"is-ready":r.value}])},[c("div",{class:"tour-spotlight",style:co(m.value)},null,4),c("div",{class:"tour-backdrop",onClick:Hi(g,["self"])}),c("div",{class:"tour-card",style:co(b.value),role:"dialog","aria-modal":"true"},[c("div",kp,[c("span",Dp,w(i.value+1)+" / "+w(n.steps.length),1),c("button",{class:"tour-skip",onClick:U,"aria-label":"略過導覽"},"略過")]),c("h3",Tp,[l.value.icon?(v(),P("span",Mp,w(l.value.icon),1)):j("",!0),k(" "+w(l.value.title),1)]),c("p",Np,w(l.value.description),1),c("div",Rp,[c("button",{class:"btn btn-primary tour-next",onClick:g},[k(w(a.value?"完成":"下一步")+" ",1),a.value?(v(),P("span",Op,"check")):(v(),P("span",xp,"arrow_forward"))])])],4)],2)):j("",!0)}},Hp=nn(Fp,[["__scopeId","data-v-1d730a34"]]),vn="community_parkings",Ri=E([]),Ra=E(!1),xi=E(null);let Nt=null,ai=0;function zp(){if(!(!dn||Nt))try{const n=Xh(Ye(Ge,vn),Kh("updatedAt"));Nt=n,ka(n,e=>{const t=[];e.forEach(o=>{var s,r;const i=o.val()||{};t.push({id:o.key,name:i.name||"",description:i.description||"",iconKey:i.iconKey||"icon-3.png",category:i.category||"",friendliness:i.friendliness||"",priceInfo:i.priceInfo||"",coordinates:[(s=i.lng)!=null?s:null,(r=i.lat)!=null?r:null],createdBy:i.createdBy||null,updatedBy:i.updatedBy||null,createdAt:i.createdAt||null,updatedAt:i.updatedAt||null,history:Wp(i.history)})}),Ri.value=t.reverse(),Ra.value=!0},e=>{xi.value=e})}catch(n){xi.value=n}}function Vp(){Nt&&(Da(Nt),Nt=null)}function Wp(n){return!n||typeof n!="object"?[]:Object.entries(n).map(([e,t])=>({...t||{},_key:e})).sort((e,t)=>e._key<t._key?1:e._key>t._key?-1:0)}function jp(){return Kn(()=>{ai+=1,zp()}),ht(()=>{ai-=1,ai<=0&&Vp()}),{items:Ri,ready:Ra,error:xi,addParking:async(o,i)=>{var m,b,g;if(!dn)throw new Error("Firebase 尚未設定");const[s,r]=o.coordinates,a=so(Ye(Ge,vn)).key,d={id:i.id,nickname:i.nickname||""},u={name:((m=o.name)==null?void 0:m.trim())||"",description:((b=o.description)==null?void 0:b.trim())||"",iconKey:o.iconKey||"icon-3.png",category:o.category||"",friendliness:o.friendliness||"",priceInfo:((g=o.priceInfo)==null?void 0:g.trim())||"",lng:Number(s),lat:Number(r),createdBy:d,createdAt:Fn(),updatedBy:d,updatedAt:Fn()},h=so(Ye(Ge,`${vn}/${a}/history`)).key;return await Di(Ye(Ge),{[`${vn}/${a}`]:{...u,history:{[h]:{action:"create",at:Fn(),by:d,snapshot:u}}}}),a},updateParking:async(o,i,s)=>{var g,U,D,I,V;if(!dn)throw new Error("Firebase 尚未設定");const r={id:s.id,nickname:s.nickname||""},l=Ri.value.find(T=>T.id===o)||{},a={};if(i.name!==void 0&&(a.name=((g=i.name)==null?void 0:g.trim())||""),i.description!==void 0&&(a.description=((U=i.description)==null?void 0:U.trim())||""),i.iconKey!==void 0&&(a.iconKey=i.iconKey),i.category!==void 0&&(a.category=i.category),i.friendliness!==void 0&&(a.friendliness=i.friendliness),i.priceInfo!==void 0&&(a.priceInfo=((D=i.priceInfo)==null?void 0:D.trim())||""),i.coordinates){const[T,W]=i.coordinates;a.lng=Number(T),a.lat=Number(W)}const d={},u={};for(const T of Object.keys(a)){let W;T==="lng"?W=(I=l.coordinates)==null?void 0:I[0]:T==="lat"?W=(V=l.coordinates)==null?void 0:V[1]:W=l[T];const Ee=W==null?"":W,ae=a[T]===void 0||a[T]===null?"":a[T];Ee!==ae&&(d[T]=W!=null?W:"",u[T]=a[T])}const h={...a,updatedBy:r,updatedAt:Fn()},m=so(Ye(Ge,`${vn}/${o}/history`)).key,b={};for(const T of Object.keys(h))b[`${vn}/${o}/${T}`]=h[T];return b[`${vn}/${o}/history/${m}`]={action:"update",at:Fn(),by:r,before:d,after:u},Di(Ye(Ge),b)},deleteParking:async o=>{if(!dn)throw new Error("Firebase 尚未設定");return wa(Ye(Ge,`${vn}/${o}`))}}}var Gp={VITE_FIREBASE_DATABASE_URL:"https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app",VITE_FIREBASE_MESSAGING_SENDER_ID:"976769533420",VITE_FIREBASE_MEASUREMENT_ID:"G-XMR8C87T1P",VITE_FIREBASE_STORAGE_BUCKET:"findparkinglot-2519e.firebasestorage.app",VITE_FIREBASE_AUTH_DOMAIN:"findparkinglot-2519e.firebaseapp.com",VITE_MAPBOX_TOKEN:"pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",VITE_FIREBASE_PROJECT_ID:"findparkinglot-2519e",VITE_FIREBASE_APP_ID:"1:976769533420:web:f3108318b3def30017acc9",VITE_FIREBASE_API_KEY:"AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs",BASE_URL:"./",MODE:"production",DEV:!1,PROD:!0,SSR:!1};const xa="community_user_id",Oa="community_user_nickname",Kp="community_is_admin",Xp=String(Gp.VITE_ADMIN_USER_IDS||"").split(",").map(n=>n.trim()).filter(Boolean);function Qp(){const n=e=>Array.from(crypto.getRandomValues(new Uint8Array(e))).map(t=>t.toString(16).padStart(2,"0")).join("");return`${n(2)}-${n(2)}`}let ao=qe.get(xa);ao||(ao=Qp(),qe.set(xa,ao));const Oi=ao,Li=E(qe.get(Oa)||""),Yp=Xp.includes(Oi)||qe.get(Kp)==="1";Q(Li,n=>qe.set(Oa,n||""));function Jp(){return{userId:Oi,nickname:Li,displayName:()=>{var e;return((e=Li.value)==null?void 0:e.trim())||`匿名#${Oi}`},isAdmin:Yp}}const qp=()=>typeof window!="undefined"&&typeof window.gtag=="function",ve=(n,e={})=>{if(qp())try{window.gtag("event",n,e)}catch(t){}},S=n=>(wn("data-v-a298231f"),n=n(),kn(),n),$p={class:"app-title"},Zp=["aria-label","aria-expanded"],em={class:"material-icons-outlined"},nm={key:1,class:"title-logo",src:zi,alt:"重機能停哪"},tm=S(()=>c("h1",null,"重機能停哪?",-1)),om=S(()=>c("pre",{id:"coordinates",class:"coordinates"},null,-1)),im=S(()=>c("h4",{class:"modal-section-title"},"圖案代表甚麼格位",-1)),sm={class:"legend-list"},rm={class:"legend-row"},lm=["src"],am={class:"legend-row"},cm=["src"],dm={class:"legend-row"},hm=["src"],um={class:"legend-row"},pm=["src"],mm={class:"legend-row"},fm=["src"],ym={class:"legend-row"},bm=["src"],gm={class:"legend-row"},Am=["src"],_m={class:"legend-row"},vm=["src"],Cm={class:"legend-row"},Pm=["src"],Um={class:"legend-row"},Em=["src"],Im={class:"legend-row"},Bm=["src"],Sm=S(()=>c("h4",{class:"modal-section-title"},"顏色代表入場方式",-1)),wm={class:"legend-list"},km={class:"legend-row"},Dm=["src"],Tm=["src"],Mm=["src"],Nm={class:"legend-row"},Rm=["src"],xm=["src"],Om=["src"],Lm={class:"legend-row"},Fm=["src"],Hm=["src"],zm=["src"],Vm={class:"legend-row"},Wm=["src"],jm=["src"],Gm=["src"],Km=S(()=>c("h4",{class:"modal-section-title"},"名稱前有價錢",-1)),Xm={class:"legend-list"},Qm={class:"legend-row"},Ym=["src"],Jm=S(()=>c("div",{class:"legend-row"},[c("div",{class:"legend-text"},[k(" ・數字:金額,時段費率複雜會以最高收費標示"),c("br"),k(" ・d/h:d 為計次,h 為計時"),c("br"),k(" ・Free 代表免費 ")])],-1)),qm={class:"share-grid"},$m=S(()=>c("img",{src:Qr,alt:""},null,-1)),Zm=S(()=>c("span",null,"Facebook",-1)),e4=[$m,Zm],n4=S(()=>c("img",{src:Yr,alt:""},null,-1)),t4=S(()=>c("span",null,"LINE",-1)),o4=[n4,t4],i4=S(()=>c("img",{src:Jr,alt:""},null,-1)),s4=S(()=>c("span",null,"Twitter",-1)),r4=[i4,s4],l4=S(()=>c("img",{src:qr,alt:""},null,-1)),a4=S(()=>c("span",null,"複製連結",-1)),c4=[l4,a4],d4={class:"modal-hint",style:{"word-break":"break-all"}},h4={class:"share-grid"},u4=S(()=>c("img",{src:Qr,alt:""},null,-1)),p4=S(()=>c("span",null,"Facebook",-1)),m4=[u4,p4],f4=S(()=>c("img",{src:Yr,alt:""},null,-1)),y4=S(()=>c("span",null,"LINE",-1)),b4=[f4,y4],g4=S(()=>c("img",{src:Jr,alt:""},null,-1)),A4=S(()=>c("span",null,"Twitter",-1)),_4=[g4,A4],v4=S(()=>c("img",{src:qr,alt:""},null,-1)),C4=S(()=>c("span",null,"複製連結",-1)),P4=[v4,C4],U4={class:"os-tabs",role:"tablist","aria-label":"作業系統"},E4=["aria-selected"],I4=S(()=>c("span",{class:"material-icons-outlined"},"phone_iphone",-1)),B4=["aria-selected"],S4=S(()=>c("span",{class:"material-icons-outlined"},"android",-1)),w4=S(()=>c("p",{class:"modal-hint"},"以下以 iOS Safari 為範例",-1)),k4=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Safari 開啟網站並點擊下方分享按鈕",-1)),D4=S(()=>c("img",{class:"full-img",src:hc,alt:""},null,-1)),T4=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「加入主畫面」",-1)),M4=S(()=>c("img",{class:"full-img",src:uc,alt:""},null,-1)),N4=S(()=>c("h4",{class:"modal-section-title"},"3. 確認名稱後按「加入」",-1)),R4=S(()=>c("img",{class:"full-img",src:pc,alt:""},null,-1)),x4=S(()=>c("h4",{class:"modal-section-title"},"4. 完成,圖示已加到主畫面",-1)),O4=S(()=>c("img",{class:"full-img",src:mc,alt:""},null,-1)),L4=S(()=>c("h4",{class:"modal-section-title"},"5. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),F4=S(()=>c("img",{class:"full-img",src:fc,alt:""},null,-1)),H4=S(()=>c("p",{class:"modal-hint"},"以下以 Android Chrome 為範例",-1)),z4=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Chrome 開啟網站並點擊右上角選單，點選「加到主畫面」",-1)),V4=S(()=>c("img",{class:"full-img",src:yc,alt:""},null,-1)),W4=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「安裝」",-1)),j4=S(()=>c("img",{class:"full-img",src:bc,alt:""},null,-1)),G4=S(()=>c("h4",{class:"modal-section-title"},"3. 完成,圖示已加到主畫面",-1)),K4=S(()=>c("img",{class:"full-img",src:gc,alt:""},null,-1)),X4=S(()=>c("h4",{class:"modal-section-title"},"4. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),Q4=S(()=>c("img",{class:"full-img",src:Ac,alt:""},null,-1)),Y4=S(()=>c("div",{class:"welcome-logo-wrap"},[c("img",{class:"welcome-logo",src:zi,alt:"重機能停哪"})],-1)),J4=S(()=>c("div",{class:"welcome-badge"},"✨ 全新介面上線",-1)),q4=S(()=>c("p",{class:"welcome-text"}," 這是一個提供重機停車資訊的地圖，你可以依據「友善程度」「停車格類型」「收費範圍」尋找合適的停車場，並一鍵開啟 Google 或 Apple Map 導航。 ",-1)),$4=S(()=>c("div",{class:"whatsnew-card"},[c("div",{class:"whatsnew-title"},[c("span",{class:"material-icons-outlined"},"auto_awesome"),k(" 本次新功能 ")]),c("ul",{class:"whatsnew-list"},[c("li",null,[c("span",{class:"material-icons-outlined"},"star"),c("span",null,[c("strong",null,"我的最愛"),c("br"),k(" 可以將喜歡的停車場加入我的最愛")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"search"),c("span",null,[c("strong",null,"地點搜尋"),c("br"),k(" 可以搜尋指定的停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_location_alt"),c("span",null,[c("strong",null,"共筆停車點"),c("br"),k(" 可自由新增、編輯, 大家一起分享停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_note"),c("span",null,[c("strong",null,"官方點異議 / 補充"),c("br"),k(" 點開任一官方停車點 → 「異議 / 補充」, 可在不改動原始資料的前提下, 補上實際費率、更正分類或加註說明, 全車友共享")])])])],-1)),Z4=S(()=>c("p",{class:"welcome-text"},[k(" 資料取源於: "),c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"link"},"Alan大重停車記事"),k("，如有停車場相關問題請至該頁面填寫回報表單。 ")],-1)),ef=S(()=>c("p",{class:"welcome-text"},' 公告: 原始資料"大重停車記事已無更新" 已改由 Alan大重停車記事 提供，感謝Alan的辛苦整理與分享！ ',-1)),nf=S(()=>c("p",{class:"welcome-text"},[k(" 本站僅提供資料整合服務，地圖免費提供車友使用，資料不定期更新；若發生無法使用情況，請至 "),c("a",{href:"https://forms.gle/iJCyfqVtpL35WtZM7",target:"_blank",rel:"noopener",class:"link"},"錯誤資訊回報"),k("，也歡迎 "),c("a",{href:"https://buymeacoffee.com/jamestim923",target:"_blank",rel:"noopener",class:"link"},"請我喝杯咖啡 ☕️"),k("讓我有動力繼續更新。 ")],-1)),tf=S(()=>c("p",{class:"welcome-text right"},"— by 爽爽",-1)),of={key:0,class:"pick-crosshair","aria-hidden":"true"},sf=S(()=>c("span",{class:"material-icons-outlined dot"},"gps_fixed",-1)),rf=[sf],lf={key:1,class:"pick-banner"},af=S(()=>c("span",{class:"pick-banner-text"},[c("span",{class:"material-icons-outlined"},"touch_app"),k(" 拖動地圖，將十字線對準目標位置 ")],-1)),cf=S(()=>c("span",{class:"material-icons-outlined"},"check",-1)),df=S(()=>c("p",{class:"welcome-text"},[c("strong",{style:{color:"var(--primary)"}},"這是一個公開共享的「共筆停車點」區。"),k(" 除了官方收錄的「大重停車記事」資料外,任何人都可以新增、修改、補充停車位置——不需要註冊、不需要審核。 ")],-1)),hf=S(()=>c("h4",{class:"modal-section-title"},"如何新增停車位置",-1)),uf=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"點左下角的「共筆停車點」按鈕,再點「新增停車位置」"),c("li",null,"畫面中心會出現青色十字游標,拖動地圖將游標對準目標位置"),c("li",null,"按頂部「使用此位置」,填寫名稱、類別、友善程度、收費等資料"),c("li",null,"按「新增」即完成(座標已自動記錄,圖示會依類別自動套用)")],-1)),pf=S(()=>c("h4",{class:"modal-section-title"},"如何編輯他人新增的位置",-1)),mf=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"地圖上「薰衣草紫色底」的標記即為使用者新增的「共筆停車點」"),c("li",null,"點擊該標記,在資訊面板按「編輯」"),c("li",null,"修改後按「儲存修改」")],-1)),ff=S(()=>c("h4",{class:"modal-section-title"},"注意事項",-1)),yf=S(()=>c("ul",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"請確認資訊正確,避免造成他人困擾"),c("li",null,"不要新增不雅、惡意或無關內容"),c("li",null,"暱稱可選填,留空將顯示為「匿名#xxx-xxx」"),c("li",null,"站方保留必要時清空所有「共筆停車點」資料的權利")],-1)),Vr="onboarding_tour_v1",Wr="filters_v1",bf="https://findparkinglot.github.io/",gf={__name:"App",setup(n){var Rs,xs,Os;const e=navigator.userAgent,t=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(e),o=/iPhone|iPad|iPod/i.test(e),i=/Android/i.test(e),s=E([]),r=()=>{var p;return!!((p=window.matchMedia)!=null&&p.call(window,"(prefers-color-scheme: light)").matches)},l=p=>{var f;if(p==="system"){const y=r()?"light":"dark";return(f=nt.find(pe=>pe.theme===y))==null?void 0:f.value}return p},a=nt.find(p=>p.name===qe.get("mapStyles")),d=(a==null?void 0:a.value)||((Rs=nt.find(p=>p.theme==="dark"))==null?void 0:Rs.value),u=E(d),h=E({getLngLat:!1,mapStylesSelected:l(d)}),m=p=>{const f=l(p);h.value.mapStylesSelected=f;const y=nt.find(ue=>ue.value===f),pe=(y==null?void 0:y.theme)==="light";document.body.classList.toggle("light-theme",pe),document.body.classList.toggle("dark-theme",!pe);const ze=nt.find(ue=>ue.value===p);ze&&qe.set("mapStyles",ze.name)};m(u.value),Q(u,m);const b=(xs=window.matchMedia)==null?void 0:xs.call(window,"(prefers-color-scheme: light)");(Os=b==null?void 0:b.addEventListener)==null||Os.call(b,"change",()=>{u.value==="system"&&m("system")});const g=E(!0),U=E(!1),D=E(i?"android":"ios"),I=E(!1),V=E(!1),T=E(!1),W=E(!1),Ee=[{selector:".mapboxgl-ctrl-geolocate",icon:"my_location",title:"定位你的位置",description:"點右上角的定位按鈕,地圖會自動移到你目前位置,並追蹤方向。"},{selector:".fab-placement-right > .fab-main",icon:"help_outline",title:"功能與教學",description:"右下角的圓形按鈕展開後,可看到「地圖怎麼看」、「加到手機桌面」、「分享」等功能。"},{selector:".search-toggle",icon:"search",title:"搜尋停車點",description:"右下角的搜尋按鈕可依名稱快速找到想去的停車場,點選結果會自動飛到該位置並開啟資訊。"},{selector:".app-title .title-toggle",icon:"menu",title:"篩選與我的最愛",description:"左上角選單可以調整停車類型、友善程度、收費範圍,以及只顯示我的最愛、切換主題。"},{selector:".fab-placement-left > .fab-main",icon:"add_location_alt",title:"共筆停車點",description:"左下角按鈕可新增/編輯共筆停車點,大家一起分享真實的停車資訊。"}],ae=()=>{W.value=!0,ve("onboarding_tour_start")},Ie=()=>{try{localStorage.setItem(Vr,"1")}catch(p){}ve("onboarding_tour_finish")},Ae=()=>{g.value=!1},de=E(!1),oe=E(!1),Be=E(!1),Re=p=>{p!=="menu"&&(de.value=!1),p!=="info"&&(oe.value=!1),p!=="message"&&(g.value=!1),p!=="mobileFAQ"&&(U.value=!1),p!=="faq"&&(I.value=!1),p!=="share"&&(V.value=!1),p!=="communityHelp"&&(T.value=!1),ve("panel_open",{panel:p})};Q(de,p=>p&&Re("menu")),Q(oe,p=>p&&Re("info")),Q(g,p=>p&&Re("message")),Q(U,p=>p&&Re("mobileFAQ")),Q(U,p=>{p&&(i?D.value="android":o&&(D.value="ios"))}),Q(I,p=>p&&Re("faq")),Q(V,p=>p&&Re("share")),Q(T,p=>p&&Re("communityHelp"));const Se=qe.getJSON(Wr,{})||{},_=E(typeof Se.parkingType=="string"?Se.parkingType:""),M=E(typeof Se.degreeOfFriendliness=="string"?Se.degreeOfFriendliness:""),G=E(typeof Se.parkingPriceType=="string"?Se.parkingPriceType:""),$=E(typeof Se.priceRangeMin=="number"?Se.priceRangeMin:0),K=E(typeof Se.priceRangeMax=="number"?Se.priceRangeMax:100),{favorites:we,favoriteIdSet:xe,isFavorite:tn,toggleFavorite:C}=od(),N=E(Se.onlyFavorites===!0);Q([_,M,G,$,K,N],([p,f,y,pe,ze,ue])=>{qe.setJSON(Wr,{parkingType:p,degreeOfFriendliness:f,parkingPriceType:y,priceRangeMin:pe,priceRangeMax:ze,onlyFavorites:ue})});const B=E("driving"),{items:re,addParking:Te,updateParking:Oe,deleteParking:bn}=jp(),{userId:on,nickname:he,isAdmin:x}=Jp(),O=E(null),{overrides:ce,getOverride:Le,getOverrideHistory:Fe,upsertOverride:_e,resetOverride:Mn}=cu(),sn=q(()=>new Set(Object.keys(ce.value||{}))),ke=E(!1),rn=E("add"),ln=E(null),un=E(!1),yt=E([121.5173399,25.0475613]),Ss=E(!1),an=E(!1),Wo=E(!1),ws=q(()=>!oe.value&&!Be.value&&!an.value&&!ke.value),ks=()=>{Wo.value&&ws.value&&(Wo.value=!1,ae())};Q(g,(p,f)=>{if(f&&!p)try{localStorage.getItem(Vr)||(Wo.value=!0,setTimeout(ks,350))}catch(y){}}),Q(ws,p=>{p&&setTimeout(ks,200)});const La=q(()=>{var p;if(!ke.value)return[];if(rn.value==="override")return We.value?Fe(We.value.name,We.value.geometry):[];if(rn.value==="edit"&&((p=ln.value)!=null&&p.id)){const f=(re.value||[]).find(y=>y.id===ln.value.id);return(f==null?void 0:f.history)||[]}return[]}),He=E(null),Fa=()=>{if(!dn){alert("「共筆停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}an.value=!0,ve("community_add_start")},Ha=()=>{var f,y;const p=((y=(f=O.value)==null?void 0:f.getCenter)==null?void 0:y.call(f))||[121.5173399,25.0475613];yt.value=p,rn.value="add",ln.value=null,an.value=!1,ke.value=!0},za=()=>{an.value=!1},Va=p=>{var f,y;yt.value=p.coordinates?[...p.coordinates]:((y=(f=O.value)==null?void 0:f.getCenter)==null?void 0:y.call(f))||[121.5173399,25.0475613],rn.value="edit",ln.value=p,ke.value=!0},jo=p=>{He.value=p,Jn({name:"共筆停車點",properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.coordinates,address:""})},Wa=()=>{He.value&&(oe.value=!1,Va(He.value))},ja=()=>{if(!dn){alert("「修改官方停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}if(!We.value)return;const p=We.value,f=Zt.value,y={id:null,name:p.name,description:(f==null?void 0:f.description)||p.description,iconKey:(f==null?void 0:f.iconKey)||p.iconKey,category:(f==null?void 0:f.category)||Ga(p.iconKey),friendliness:(f==null?void 0:f.friendliness)||Ka(p.iconKey),priceInfo:(f==null?void 0:f.priceInfo)||p.priceInfo,coordinates:p.geometry?[...p.geometry]:[...yt.value]};yt.value=y.coordinates,rn.value="override",ln.value=y,Ss.value=!!f,oe.value=!1,ke.value=!0,ve("override_edit_start",{name:p.name})};function Ga(p){if(!p)return"motorcycle";const f=Gt.find(y=>y.value&&y.key.includes(p));return(f==null?void 0:f.value)||"motorcycle"}function Ka(p){if(!p)return"friendly";const f=Kt.find(y=>y.value&&y.key.includes(p));return(f==null?void 0:f.value)||"friendly"}const Xa=async p=>{if(We.value){un.value=!0;try{const f={id:on,nickname:he.value};await _e(We.value,p,f),ve("override_submit",{name:We.value.name});const y=We.value;ke.value=!1,Jn({name:y.parkingType,properties:{name:y.name,description:y.description,icon:y.iconKey,priceInfo:y.priceInfo,priceArray:[]},geometry:y.geometry,address:Z.value.address})}catch(f){alert("儲存失敗:"+((f==null?void 0:f.message)||f))}finally{un.value=!1}}},Qa=async()=>{if(We.value){un.value=!0;try{const p=We.value,f={id:on,nickname:he.value};await Mn(p.name,p.geometry,f),ve("override_reset",{name:p.name}),ke.value=!1,Jn({name:p.parkingType,properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.geometry,address:Z.value.address})}catch(p){alert("重設失敗:"+((p==null?void 0:p.message)||p))}finally{un.value=!1}}},Ya=async p=>{var f;un.value=!0;try{const y={id:on,nickname:he.value};rn.value==="edit"&&((f=ln.value)!=null&&f.id)?(await Oe(ln.value.id,p,y),ve("community_edit_submit",{name:p==null?void 0:p.name})):(await Te(p,y),ve("community_add_submit",{name:p==null?void 0:p.name})),ke.value=!1,He.value=null}catch(y){alert("儲存失敗:"+((y==null?void 0:y.message)||y))}finally{un.value=!1}},Ja=async p=>{un.value=!0;try{const f={id:on,nickname:he.value};await bn(p,f),ve("community_delete",{id:p}),ke.value=!1,He.value=null}catch(f){alert("刪除失敗:"+((f==null?void 0:f.message)||f))}finally{un.value=!1}},Go=q(()=>{var f,y;if(!He.value||!Z.value.parkingName)return!1;const p=He.value;return p.name===Z.value.parkingName&&Array.isArray(Z.value.geometry)&&((f=p.coordinates)==null?void 0:f[0])===Z.value.geometry[0]&&((y=p.coordinates)==null?void 0:y[1])===Z.value.geometry[1]});Q(oe,p=>{p||(He.value=null)});const bt=E(null),qa=q(()=>{var p;return((p=Gt.find(f=>f.value===_.value))==null?void 0:p.key)||[]}),$a=q(()=>{var p;return((p=Kt.find(f=>f.value===M.value))==null?void 0:p.key)||[]}),Z=E({parkingName:"",parkingNameDes:"",parkingType:"",parkingIcon:"",parkingIconKey:"",priceInfo:"",geometry:[null,null],address:"",sourceLabel:""}),We=E(null),Zt=E(null),Ds=q(()=>ci(Z.value.parkingName,Z.value.geometry)),Ts=q(()=>tn(Ds.value)),Jn=p=>{var $n,Zn,Ls,Fs,Hs;const f=p.properties.icon,y={name:p.properties.name,description:p.properties.description,iconKey:f,priceInfo:p.properties.priceInfo||"",geometry:p.geometry,parkingType:p.name},pe=!!(He.value&&He.value.name===p.properties.name&&Array.isArray(p.geometry)&&(($n=He.value.coordinates)==null?void 0:$n[0])===p.geometry[0]&&((Zn=He.value.coordinates)==null?void 0:Zn[1])===p.geometry[1]);let ze=null,ue=y;pe||(ze=Le(y.name,y.geometry),ze&&(ue=Ma(y,ze))),We.value=pe?null:y,Zt.value=ze,Z.value={parkingName:ue.name,parkingNameDes:ue.description,parkingType:y.parkingType,parkingIcon:J(ue.iconKey),parkingIconKey:ue.iconKey,priceInfo:ue.priceInfo||"",geometry:p.geometry,address:p.address,sourceLabel:pe?"":Qc((Ls=p.properties)==null?void 0:Ls.sourceFolderIndex)},oe.value=!0,ve("parking_view",{parking_name:(Fs=p.properties)==null?void 0:Fs.name,parking_type:p.name,icon:(Hs=p.properties)==null?void 0:Hs.icon,overridden:!!ze})},Za=()=>{if(!Z.value.parkingName)return;const p=!Ts.value;C({id:Ds.value,name:Z.value.parkingName,parkingType:Z.value.parkingType,geometry:Z.value.geometry,address:Z.value.address,icon:Z.value.parkingIconKey}),ve(p?"favorite_add":"favorite_remove",{parking_name:Z.value.parkingName,parking_type:Z.value.parkingType})},ec=p=>"",nc=p=>{var f;p.isCommunity&&p.community?jo(p.community):Jn({name:p.groupName,properties:p.properties,geometry:p.geometry,address:ec(p.geometry)}),bt.value=[...p.geometry],ve("search_select",{parking_name:(f=p.properties)==null?void 0:f.name,group:p.groupName,community:!!p.isCommunity})},gt=E(null),At=E(null),tc=p=>{B.value="driving",gt.value=p,oe.value=!1,At.value=null,ve("route_start",{parking_name:Z.value.parkingName,profile:"driving"})},oc=()=>{gt.value=null,Be.value=!1};Q(At,p=>{Be.value=p!==null});const ic=p=>{const f=Z.value.geometry;let y="";p==="apple"?y=`https://maps.apple.com/?daddr=${f[1]},${f[0]}&dirflg=d&t=m`:p==="google"&&(y=`https://www.google.com/maps/dir/?api=1&destination=${f[1]},${f[0]}&travelmode=driving`),y&&(ve("open_external_map",{provider:p,parking_name:Z.value.parkingName}),window.open(y,"_blank","noopener,noreferrer"))},gn=(p,f=null)=>{const y=f||"https://findparkinglot.github.io/";let pe="";p==="facebook"?pe=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(y)}`:p==="line"?pe=`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(y)}`:p==="twitter"&&(pe=`https://twitter.com/share?url=${encodeURIComponent(y)}`),ve("share",{method:p,scope:f?"spot":"site"}),p==="link"?navigator.clipboard.writeText(y).then(()=>alert("已複製連結"),()=>alert("複製失敗")):window.open(pe,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},Ms=()=>{const p=Z.value.geometry;if(!Array.isArray(p)||p[0]==null||p[1]==null)return"";const f=new URLSearchParams({lng:Number(p[0]).toFixed(6),lat:Number(p[1]).toFixed(6)});return`${bf}?${f.toString()}`},sc=()=>{const p=Ms();p&&(qn.value=p,Xo.value=Z.value.parkingName||"停車點",Ko.value=!0,ve("share_spot_open",{name:Xo.value}))},Ko=E(!1),qn=E(""),Xo=E("");Q([oe,Z],()=>{try{if(!oe.value){window.location.search&&window.history.replaceState({},"",window.location.pathname);return}const p=Ms();if(!p)return;const f=p.slice(p.indexOf("?"));window.history.replaceState({},"",window.location.pathname+f)}catch(p){}},{deep:!0});const _t=E(null),eo=(p,f)=>Math.abs(Number(p)-Number(f))<1e-5,Qo=()=>{var ze;const p=_t.value;if(!p)return;const f=Number(p.lng),y=Number(p.lat);if(!isFinite(f)||!isFinite(y)){_t.value=null;return}const pe=(re.value||[]).find(ue=>ue.coordinates&&eo(ue.coordinates[0],f)&&eo(ue.coordinates[1],y));if(pe){jo(pe),bt.value=[f,y],_t.value=null;return}for(const ue of s.value||[])for(const $n of ue.features||[]){const Zn=(ze=$n.geometry)==null?void 0:ze.coordinates;if(Zn&&eo(Zn[0],f)&&eo(Zn[1],y)){Jn({name:ue.name,properties:$n.properties,geometry:$n.geometry.coordinates,address:""}),bt.value=[f,y],_t.value=null;return}}Array.isArray(s.value)&&s.value.length>0&&(bt.value=[f,y])},Ns=()=>{try{const p=new URLSearchParams(window.location.search),f=p.get("lng"),y=p.get("lat");if(!f||!y)return;_t.value={lng:f,lat:y},Qo()}catch(p){}};Q(re,Qo,{deep:!1}),Q(s,Qo,{deep:!1}),Kn(()=>{s.value=td(Kc()),g.value||Ns()}),Q(g,(p,f)=>{f&&!p&&Ns()});const rc=q(()=>[{key:"share",icon:"share",label:"分享",highlight:!0,onClick:()=>V.value=!0},{key:"howto",icon:"help_outline",label:"怎麼用",onClick:ae},{key:"faq",icon:"map",label:"地圖怎麼看",onClick:()=>I.value=!0},{key:"mobile",icon:"add_to_home_screen",label:"加到手機桌面",onClick:()=>U.value=!0}]),lc=q(()=>[{key:"add",icon:"add_location_alt",label:"新增停車位置",highlight:!0,onClick:Fa},{key:"help",icon:"menu_book",label:"編輯教學",onClick:()=>T.value=!0}]);return(p,f)=>(v(),P(ye,null,[c("div",$p,[an.value?(v(),P("img",nm)):(v(),P("button",{key:0,class:"title-toggle",onClick:f[0]||(f[0]=y=>de.value=!de.value),"aria-label":de.value?"收合設定":"開啟設定","aria-expanded":de.value},[c("span",em,w(de.value?"close":"menu"),1)],8,Zp)),tm]),je(Ue(Hr,{items:rc.value},null,8,["items"]),[[Et,!Be.value&&!oe.value&&!an.value]]),je(Ue(Hr,{items:lc.value,placement:"left","main-icon":"add_location_alt","main-label":"共筆停車點"},null,8,["items"]),[[Et,!Be.value&&!oe.value&&!an.value]]),je(Ue(T5,{"map-data-list":s.value,"community-parkings":L(re),onSelect:nc},null,8,["map-data-list","community-parkings"]),[[Et,!Be.value&&!oe.value&&!an.value]]),om,Ue(mu,{ref_key:"mapBoxRef",ref:O,parkingTypeKeyArray:qa.value,degreeOfFriendlinessKeyArray:$a.value,mapDataList:s.value,getLngLat:h.value.getLngLat,mapStylesSelected:h.value.mapStylesSelected,parkingPriceType:G.value,priceRangeMin:$.value,priceRangeMax:K.value,"favorite-ids":L(xe),"override-keys":sn.value,overrides:L(ce),"only-favorites":N.value,"focus-coord":bt.value,"route-profile":B.value,"community-parkings":L(re),goToParkingPlaceData:gt.value,"onUpdate:goToParkingPlaceData":f[1]||(f[1]=y=>gt.value=y),routeData:At.value,"onUpdate:routeData":f[2]||(f[2]=y=>At.value=y),onParkingInfo:Jn,onCommunityParkingClick:jo},null,8,["parkingTypeKeyArray","degreeOfFriendlinessKeyArray","mapDataList","getLngLat","mapStylesSelected","parkingPriceType","priceRangeMin","priceRangeMax","favorite-ids","override-keys","overrides","only-favorites","focus-coord","route-profile","community-parkings","goToParkingPlaceData","routeData"]),Ue(y5,{"route-data":At.value,active:Be.value,profile:B.value,"onUpdate:profile":f[3]||(f[3]=y=>B.value=y),onCancel:oc},null,8,["route-data","active","profile"]),Ue(_3,{parkingType:_.value,"onUpdate:parkingType":f[4]||(f[4]=y=>_.value=y),degreeOfFriendliness:M.value,"onUpdate:degreeOfFriendliness":f[5]||(f[5]=y=>M.value=y),parkingPriceType:G.value,"onUpdate:parkingPriceType":f[6]||(f[6]=y=>G.value=y),priceRangeMin:$.value,"onUpdate:priceRangeMin":f[7]||(f[7]=y=>$.value=y),priceRangeMax:K.value,"onUpdate:priceRangeMax":f[8]||(f[8]=y=>K.value=y),mapStyle:u.value,"onUpdate:mapStyle":f[9]||(f[9]=y=>u.value=y),active:de.value,"onUpdate:active":f[10]||(f[10]=y=>de.value=y),onlyFavorites:N.value,"onUpdate:onlyFavorites":f[11]||(f[11]=y=>N.value=y),"favorites-count":L(we).length},null,8,["parkingType","degreeOfFriendliness","parkingPriceType","priceRangeMin","priceRangeMax","mapStyle","active","onlyFavorites","favorites-count"]),je(Ue(e5,{info:Z.value,active:oe.value,"is-mobile":L(t),"is-apple":L(o),"is-android":L(i),"has-route":gt.value!==null,"is-favorite":Ts.value,"is-community":Go.value,"community-meta":Go.value?He.value:null,"is-overridden":!Go.value&&!!Zt.value,"override-meta":Zt.value,onClose:f[12]||(f[12]=y=>oe.value=!1),onRoute:f[13]||(f[13]=y=>tc(Z.value.geometry)),onOpenMap:ic,onToggleFavorite:Za,onEditCommunity:Wa,onEditOverride:ja,onShare:sc},null,8,["info","active","is-mobile","is-apple","is-android","has-route","is-favorite","is-community","community-meta","is-overridden","override-meta"]),[[Et,!Be.value]]),Ue(Ln,{modelValue:I.value,"onUpdate:modelValue":f[14]||(f[14]=y=>I.value=y),title:"地圖怎麼看?","close-text":"知道了",size:"lg"},{default:cn(()=>[im,c("div",sm,[c("div",rm,[c("img",{src:L(J)("icon-3.png"),alt:""},null,8,lm),k(" 汽車：汽車格(含未確認是否有重機格) ")]),c("div",am,[c("img",{src:L(J)("icon-8.png"),alt:""},null,8,cm),k(" 重機(有人):有設重機專用格 ")]),c("div",dm,[c("img",{src:L(J)("icon-10.png"),alt:""},null,8,hm),k(" 機車(沒人):機車格 ")]),c("div",um,[c("img",{src:L(J)("icon-14.png"),alt:""},null,8,pm),k(" 綠星:路邊友善車格 ")]),c("div",mm,[c("img",{src:L(J)("icon-4.png"),alt:""},null,8,fm),k(" 重機友善店家:用餐/消費時可停重機的店家 ")]),c("div",ym,[c("img",{src:L(J)("icon-15.png"),alt:""},null,8,bm),k(" 綠P:重機專用路邊停車格 ")]),c("div",gm,[c("img",{src:L(J)("icon-16.png"),alt:""},null,8,Am),k(" 灰P:重機專用路邊停車格(未確認精準座標,歡迎回報) ")]),c("div",_m,[c("img",{src:L(J)("icon-17.png"),alt:""},null,8,vm),k(" 藍P:普通大型共用機車格(台北市試辦) ")]),c("div",Cm,[c("img",{src:L(J)("icon-18.png"),alt:""},null,8,Pm),k(" 紫P:時段性汽機車共用停車格 ")]),c("div",Um,[c("img",{src:L(J)("icon-19.png"),alt:""},null,8,Em),k(" 紅X:停都不給停 ")]),c("div",Im,[c("img",{src:L(J)("icon-20.png"),alt:""},null,8,Bm),k(" ?:類型未確認,歡迎透過共筆回報 ")])]),Sm,c("div",wm,[c("div",km,[c("img",{src:L(J)("icon-2.png"),alt:""},null,8,Dm),c("img",{src:L(J)("icon-6.png"),alt:""},null,8,Tm),c("img",{src:L(J)("icon-9.png"),alt:""},null,8,Mm),k(" 綠色最友善:有後牌辨析 ")]),c("div",Nm,[c("img",{src:L(J)("icon-5.png"),alt:""},null,8,Rm),c("img",{src:L(J)("icon-12.png"),alt:""},null,8,xm),c("img",{src:L(J)("icon-11.png"),alt:""},null,8,Om),k(" 藍色最傳統:悠遊卡 / 按鈕取票 ")]),c("div",Lm,[c("img",{src:L(J)("icon-1.png"),alt:""},null,8,Fm),c("img",{src:L(J)("icon-13.png"),alt:""},null,8,Hm),c("img",{src:L(J)("icon-7.png"),alt:""},null,8,zm),k(" 紅色最靠北:請管理員協助 / 倒退嚕前牌辨析 ")]),c("div",Vm,[c("img",{src:L(J)("icon-3.png"),alt:""},null,8,Wm),c("img",{src:L(J)("icon-8.png"),alt:""},null,8,jm),c("img",{src:L(J)("icon-10.png"),alt:""},null,8,Gm),k(" 灰色未確定:有可能是上述任何情況,停到請回報 ")])]),Km,c("div",Xm,[c("div",Qm,[c("img",{src:L(J)("icon-3.png"),alt:""},null,8,Ym),k(" (30/h)三張里地下停車場 ")]),Jm])]),_:1},8,["modelValue"]),Ue(Ln,{modelValue:V.value,"onUpdate:modelValue":f[19]||(f[19]=y=>V.value=y),title:"分享給朋友",size:"sm"},{default:cn(()=>[c("div",qm,[c("button",{class:"share-btn",onClick:f[15]||(f[15]=y=>gn("facebook")),"aria-label":"Facebook"},e4),c("button",{class:"share-btn",onClick:f[16]||(f[16]=y=>gn("line")),"aria-label":"LINE"},o4),c("button",{class:"share-btn",onClick:f[17]||(f[17]=y=>gn("twitter")),"aria-label":"Twitter"},r4),c("button",{class:"share-btn",onClick:f[18]||(f[18]=y=>gn("link")),"aria-label":"複製連結"},c4)])]),_:1},8,["modelValue"]),Ue(Ln,{modelValue:Ko.value,"onUpdate:modelValue":f[24]||(f[24]=y=>Ko.value=y),title:`分享：${Xo.value}`,size:"sm"},{default:cn(()=>[c("p",d4,w(qn.value),1),c("div",h4,[c("button",{class:"share-btn",onClick:f[20]||(f[20]=y=>gn("facebook",qn.value)),"aria-label":"Facebook"},m4),c("button",{class:"share-btn",onClick:f[21]||(f[21]=y=>gn("line",qn.value)),"aria-label":"LINE"},b4),c("button",{class:"share-btn",onClick:f[22]||(f[22]=y=>gn("twitter",qn.value)),"aria-label":"Twitter"},_4),c("button",{class:"share-btn",onClick:f[23]||(f[23]=y=>gn("link",qn.value)),"aria-label":"複製連結"},P4)])]),_:1},8,["modelValue","title"]),Ue(Ln,{modelValue:U.value,"onUpdate:modelValue":f[27]||(f[27]=y=>U.value=y),title:"如何加入手機桌面?","close-text":"知道了",size:"lg"},{default:cn(()=>[c("div",U4,[c("button",{type:"button",role:"tab","aria-selected":D.value==="ios",class:ie(["os-tab",{"is-active":D.value==="ios"}]),onClick:f[25]||(f[25]=y=>D.value="ios")},[I4,k(" iOS ")],10,E4),c("button",{type:"button",role:"tab","aria-selected":D.value==="android",class:ie(["os-tab",{"is-active":D.value==="android"}]),onClick:f[26]||(f[26]=y=>D.value="android")},[S4,k(" Android ")],10,B4)]),D.value==="ios"?(v(),P(ye,{key:0},[w4,k4,D4,T4,M4,N4,R4,x4,O4,L4,F4],64)):(v(),P(ye,{key:1},[H4,z4,V4,W4,j4,G4,K4,X4,Q4],64))]),_:1},8,["modelValue"]),Ue(Ln,{modelValue:g.value,"onUpdate:modelValue":f[28]||(f[28]=y=>g.value=y),title:"嗨！歡迎使用 重機能停哪?","close-text":"開始使用"},{footer:cn(()=>[c("button",{class:"btn btn-primary",onClick:Ae},"開始使用")]),default:cn(()=>[Y4,J4,q4,$4,Z4,ef,nf,tf]),_:1},8,["modelValue"]),Ue(wp,{open:ke.value,"onUpdate:open":f[29]||(f[29]=y=>ke.value=y),mode:rn.value,initial:ln.value,"default-coord":yt.value,nickname:L(he),"is-owner":!0,"is-admin":L(x),submitting:un.value,"has-existing-override":Ss.value,history:La.value,"onUpdate:nickname":f[30]||(f[30]=y=>he.value=y),onSubmit:f[31]||(f[31]=y=>rn.value==="override"?Xa(y):Ya(y)),onDelete:Ja,onReset:Qa},null,8,["open","mode","initial","default-coord","nickname","is-admin","submitting","has-existing-override","history"]),an.value?(v(),P("div",of,rf)):j("",!0),an.value?(v(),P("div",lf,[af,c("div",{class:"pick-banner-actions"},[c("button",{class:"btn btn-outline btn-sm",onClick:za},"取消"),c("button",{class:"btn btn-primary btn-sm",onClick:Ha},[cf,k(" 使用此位置 ")])])])):j("",!0),Ue(Ln,{modelValue:T.value,"onUpdate:modelValue":f[32]||(f[32]=y=>T.value=y),title:"共筆停車點說明","close-text":"我知道了",size:"lg"},{default:cn(()=>[df,hf,uf,pf,mf,ff,yf]),_:1},8,["modelValue"]),Ue(Hp,{active:W.value,"onUpdate:active":f[33]||(f[33]=y=>W.value=y),steps:Ee,onFinish:Ie},null,8,["active"])],64))}},Af=nn(gf,[["__scopeId","data-v-a298231f"]]);dc(Af).mount("#app");"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./serviceWorker.js").catch(()=>{})});
