 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yd(){return typeof navigator!="undefined"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function cl(){return typeof window!="undefined"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(yd())}function bd(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function dl(){return ol.NODE_ADMIN===!0}function gd(){try{return typeof indexedDB=="object"}catch(n){return!1}}function Ad(){return new Promise((n,e)=>{try{let t=!0;const o="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(o);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(o),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var s;e(((s=i.error)==null?void 0:s.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _d="FirebaseError";class Xt extends Error{constructor(e,t,o){super(t),this.code=e,this.customData=o,this.name=_d,Object.setPrototypeOf(this,Xt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,hl.prototype.create)}}class hl{constructor(e,t,o){this.service=e,this.serviceName=t,this.errors=o}create(e,...t){const o=t[0]||{},i=`${this.service}/${e}`,s=this.errors[e],r=s?vd(s,o):"Error",l=`${this.serviceName}: ${r} (${i}).`;return new Xt(i,l,o)}}function vd(n,e){return n.replace(Cd,(t,o)=>{const i=e[o];return i!=null?String(i):`<${o}?>`})}const Cd=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xd{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Yd(t)){const o=t.getImmediate();return`${o.library}/${o.version}`}else return null}).filter(t=>t).join(" ")}}function Yd(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const pi="@firebase/app",$s="0.14.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fn=new ml("@firebase/app"),Jd="@firebase/app-compat",qd="@firebase/analytics-compat",$d="@firebase/analytics",Zd="@firebase/app-check-compat",e1="@firebase/app-check",n1="@firebase/auth",t1="@firebase/auth-compat",o1="@firebase/database",i1="@firebase/data-connect",s1="@firebase/database-compat",r1="@firebase/functions",l1="@firebase/functions-compat",a1="@firebase/installations",c1="@firebase/installations-compat",d1="@firebase/messaging",h1="@firebase/messaging-compat",u1="@firebase/performance",p1="@firebase/performance-compat",m1="@firebase/remote-config",f1="@firebase/remote-config-compat",y1="@firebase/storage",b1="@firebase/storage-compat",g1="@firebase/firestore",A1="@firebase/ai",_1="@firebase/firestore-compat",v1="firebase",C1="12.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mi="[DEFAULT]",P1={[pi]:"fire-core",[Jd]:"fire-core-compat",[$d]:"fire-analytics",[qd]:"fire-analytics-compat",[e1]:"fire-app-check",[Zd]:"fire-app-check-compat",[n1]:"fire-auth",[t1]:"fire-auth-compat",[o1]:"fire-rtdb",[i1]:"fire-data-connect",[s1]:"fire-rtdb-compat",[r1]:"fire-fn",[l1]:"fire-fn-compat",[a1]:"fire-iid",[c1]:"fire-iid-compat",[d1]:"fire-fcm",[h1]:"fire-fcm-compat",[u1]:"fire-perf",[p1]:"fire-perf-compat",[m1]:"fire-rc",[f1]:"fire-rc-compat",[y1]:"fire-gcs",[b1]:"fire-gcs-compat",[g1]:"fire-fst",[_1]:"fire-fst-compat",[A1]:"fire-vertex","fire-js":"fire-js",[v1]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D1="firebase-heartbeat-database",T1=1,Lt="firebase-heartbeat-store";let Zo=null;function gl(){return Zo||(Zo=Gd(D1,T1,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Lt)}catch(t){}}}}).catch(n=>{throw Un.create("idb-open",{originalErrorMessage:n.message})})),Zo}async function N1(n){try{const t=(await gl()).transaction(Lt),o=await t.objectStore(Lt).get(Al(n));return await t.done,o}catch(e){if(e instanceof Xt)fn.warn(e.message);else{const t=Un.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});fn.warn(t.message)}}}async function er(n,e){try{const o=(await gl()).transaction(Lt,"readwrite");await o.objectStore(Lt).put(e,Al(n)),await o.done}catch(t){if(t instanceof Xt)fn.warn(t.message);else{const o=Un.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});fn.warn(o.message)}}}function Al(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function H1(n){fo(new Ot("platform-logger",e=>new Xd(e),"PRIVATE")),fo(new Ot("heartbeat",e=>new x1(e),"PRIVATE")),ot(pi,$s,n),ot(pi,$s,"esm2020"),ot("fire-js","")}H1("");var or={};const ir="@firebase/database",sr="1.1.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ki="5",El="v",Bl="s",Il="r",Sl="f",wl=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,kl="ls",Dl="p",bi="ac",Tl="websocket",Nl="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ei={},ni={};function Qi(n){const e=n.toString();return ei[e]||(ei[e]=new r0),ei[e]}function l0(n,e){const t=n.toString();return ni[t]||(ni[t]=e()),ni[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ar="start",c0="close",d0="pLPCommand",h0="pRTLPCB",xl="id",Ol="pw",Ll="ser",u0="cb",p0="seg",m0="ts",f0="d",y0="dframe",Fl=1870,Hl=30,b0=Fl-Hl,g0=25e3,A0=3e4;class tt{constructor(e,t,o,i,s,r,l){this.connId=e,this.repoInfo=t,this.applicationId=o,this.appCheckToken=i,this.authToken=s,this.transportSessionId=r,this.lastSessionId=l,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=Jt(e),this.stats_=Qi(t),this.urlFn=a=>(this.appCheckToken&&(a[bi]=this.appCheckToken),Rl(t,Nl,a))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new a0(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(A0)),X1(()=>{if(this.isClosed_)return;this.scriptTagHolder=new Xi((...s)=>{const[r,l,a,d,u]=s;if(this.incrementIncomingBytes_(s),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,r===ar)this.id=l,this.password=a;else if(r===c0)l?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(l,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+r)},(...s)=>{const[r,l]=s;this.incrementIncomingBytes_(s),this.myPacketOrderer.handleResponse(r,l)},()=>{this.onClosed_()},this.urlFn);const o={};o[ar]="t",o[Ll]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(o[u0]=this.scriptTagHolder.uniqueCallbackIdentifier),o[El]=Ki,this.transportSessionId&&(o[Bl]=this.transportSessionId),this.lastSessionId&&(o[kl]=this.lastSessionId),this.applicationId&&(o[Dl]=this.applicationId),this.appCheckToken&&(o[bi]=this.appCheckToken),typeof location!="undefined"&&location.hostname&&wl.test(location.hostname)&&(o[Il]=Sl);const i=this.urlFn(o);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){tt.forceAllow_=!0}static forceDisallow(){tt.forceDisallow_=!0}static isAvailable(){return tt.forceAllow_?!0:!tt.forceDisallow_&&typeof document!="undefined"&&document.createElement!=null&&!J1()&&!q1()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=Ae(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const o=sl(t),i=Pl(o,b0);for(let s=0;s<i.length;s++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[s]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const o={};o[y0]="t",o[xl]=e,o[Ol]=t,this.myDisconnFrame.src=this.urlFn(o),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=Ae(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class Xi{constructor(e,t,o,i){this.onDisconnect=o,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=G1(),window[d0+this.uniqueCallbackIdentifier]=e,window[h0+this.uniqueCallbackIdentifier]=t,this.myIFrame=Xi.createIFrame_();let s="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(s='<script>document.domain="'+document.domain+'";<\/script>');const r="<html><body>"+s+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(r),this.myIFrame.doc.close()}catch(l){Pe("frame writing exception"),l.stack&&Pe(l.stack),Pe(l)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||Pe("No IE domain setting required")}catch(t){const o=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+o+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[xl]=this.myID,e[Ol]=this.myPW,e[Ll]=this.currentSerial;let t=this.urlFn(e),o="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Hl+o.length<=Fl;){const r=this.pendingSegs.shift();o=o+"&"+p0+i+"="+r.seg+"&"+m0+i+"="+r.ts+"&"+f0+i+"="+r.d,i++}return t=t+o,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,o){this.pendingSegs.push({seg:e,ts:t,d:o}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const o=()=>{this.outstandingRequests.delete(t),this.newRequest_()},i=setTimeout(o,Math.floor(g0)),s=()=>{clearTimeout(i),o()};this.addTag(e,s)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const o=this.myIFrame.doc.createElement("script");o.type="text/javascript",o.async=!0,o.src=e,o.onload=o.onreadystatechange=function(){const i=o.readyState;(!i||i==="loaded"||i==="complete")&&(o.onload=o.onreadystatechange=null,o.parentNode&&o.parentNode.removeChild(o),t())},o.onerror=()=>{Pe("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(o)}catch(o){}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function H0(n,e){return Xn(n.name,e.name)}function $i(n,e){return Xn(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let gi;function z0(n){gi=n}const Kl=function(n){return typeof n=="number"?"number:"+Ul(n):"string:"+n},Ql=function(n){if(n.isLeafNode()){const e=n.val();A(typeof e=="string"||typeof e=="number"||typeof e=="object"&&un(e,".sv"),"Priority must be a string or number.")}else A(n===gi||n.isEmpty(),"priority of unexpected type.");A(n===gi||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xl,Yl;function V0(n){Xl=n}function W0(n){Yl=n}class j0 extends Do{compare(e,t){const o=e.node.getPriority(),i=t.node.getPriority(),s=o.compareTo(i);return s===0?Xn(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return z.MIN}maxPost(){return new z(Bn,new fe("[PRIORITY-POST]",Yl))}makePost(e,t){const o=Xl(e);return new z(t,new fe("[PRIORITY-POST]",o))}toString(){return".priority"}}const re=new j0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G0=Math.log(2);class K0{constructor(e){const t=s=>parseInt(Math.log(s)/G0,10),o=s=>parseInt(Array(s+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=o(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const go=function(n,e,t,o){n.sort(e);const i=function(a,d){const u=d-a;let h,m;if(u===0)return null;if(u===1)return h=n[a],m=t?t(h):h,new ye(m,h.node,ye.BLACK,null,null);{const b=parseInt(u/2,10)+a,g=i(a,b),B=i(b+1,d);return h=n[b],m=t?t(h):h,new ye(m,h.node,ye.BLACK,g,B)}},s=function(a){let d=null,u=null,h=n.length;const m=function(g,B){const D=h-g,U=h;h-=g;const W=i(D+1,U),N=n[D],j=t?t(N):N;b(new ye(j,N.node,B,null,W))},b=function(g){d?(d.left=g,d=g):(u=g,d=g)};for(let g=0;g<a.count;++g){const B=a.nextBitIsOne(),D=Math.pow(2,a.count-(g+1));B?m(D,ye.BLACK):(m(D,ye.BLACK),m(D,ye.RED))}return u},r=new K0(n.length),l=s(r);return new xe(o||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let oi;const et={};class pn{static get Default(){return A(et&&re,"ChildrenNode.ts has not been loaded"),oi=oi||new pn({".priority":et},{".priority":re}),oi}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=rt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof xe?t:null}hasIndex(e){return un(this.indexSet_,e.toString())}addIndex(e,t){A(e!==zn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const o=[];let i=!1;const s=t.getIterator(z.Wrap);let r=s.getNext();for(;r;)i=i||e.isDefinedOn(r.node),o.push(r),r=s.getNext();let l;i?l=go(o,e.getCompare()):l=et;const a=e.toString(),d={...this.indexSet_};d[a]=e;const u={...this.indexes_};return u[a]=l,new pn(u,d)}addToIndexes(e,t){const o=uo(this.indexes_,(i,s)=>{const r=rt(this.indexSet_,s);if(A(r,"Missing index implementation for "+s),i===et)if(r.isDefinedOn(e.node)){const l=[],a=t.getIterator(z.Wrap);let d=a.getNext();for(;d;)d.name!==e.name&&l.push(d),d=a.getNext();return l.push(e),go(l,r.getCompare())}else return et;else{const l=t.get(e.name);let a=i;return l&&(a=a.remove(new z(e.name,l))),a.insert(e,e.node)}});return new pn(o,this.indexSet_)}removeFromIndexes(e,t){const o=uo(this.indexes_,i=>{if(i===et)return i;{const s=t.get(e.name);return s?i.remove(new z(e.name,s)):i}});return new pn(o,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X0=!0;function ge(n,e=null){if(n===null)return M.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),A(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new fe(t,ge(e))}if(!(n instanceof Array)&&X0){const t=[];let o=!1;if(Ue(n,(r,l)=>{if(r.substring(0,1)!=="."){const a=ge(l);a.isEmpty()||(o=o||!a.getPriority().isEmpty(),t.push(new z(r,a)))}}),t.length===0)return M.EMPTY_NODE;const s=go(t,H0,r=>r.name,$i);if(o){const r=go(t,re.getCompare());return new M(s,ge(e),new pn({".priority":r},{".priority":re}))}else return new M(s,ge(e),pn.Default)}else{let t=M.EMPTY_NODE;return Ue(n,(o,i)=>{if(un(n,o)&&o.substring(0,1)!=="."){const s=ge(i);(s.isLeafNode()||!s.isEmpty())&&(t=t.updateImmediateChild(o,s))}}),t.updatePriority(ge(e))}}V0(ge);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zi extends Do{constructor(e){super(),this.indexPath_=e,A(!H(e)&&F(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const o=this.extractChild(e.node),i=this.extractChild(t.node),s=o.compareTo(i);return s===0?Xn(e.name,t.name):s}makePost(e,t){const o=ge(e),i=M.EMPTY_NODE.updateChild(this.indexPath_,o);return new z(t,i)}maxPost(){const e=M.EMPTY_NODE.updateChild(this.indexPath_,qt);return new z(Bn,e)}toString(){return Ht(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y0 extends Do{compare(e,t){const o=e.node.compareTo(t.node);return o===0?Xn(e.name,t.name):o}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return z.MIN}maxPost(){return z.MAX}makePost(e,t){const o=ge(e);return new z(t,o)}toString(){return".value"}}const Jl=new Y0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ql(n){return{type:"value",snapshotNode:n}}function lt(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function zt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Vt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function J0(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _o(){return{value:null,children:new Map}}function $l(n,e,t){if(H(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const o=F(e);n.children.has(o)||n.children.set(o,_o());const i=n.children.get(o);e=te(e),$l(i,e,t)}}function Ai(n,e,t){n.value!==null?t(e,n.value):n2(n,(o,i)=>{const s=new X(e.toString()+"/"+o);Ai(i,s,t)})}function n2(n,e){n.children.forEach((t,o)=>{e(o,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class at{constructor(e,t,o){this.source=e,this.path=t,this.children=o,this.type=en.MERGE}operationForChild(e){if(H(this.path)){const t=this.children.subtree(new X(e));return t.isEmpty()?null:t.value?new Wn(this.source,K(),t.value):new at(this.source,K(),t)}else return A(F(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new at(this.source,te(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r2{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function l2(n,e,t,o){const i=[],s=[];return e.forEach(r=>{r.type==="child_changed"&&n.index_.indexedValueChanged(r.oldSnap,r.snapshotNode)&&s.push(J0(r.childName,r.snapshotNode))}),Et(n,i,"child_removed",e,o,t),Et(n,i,"child_added",e,o,t),Et(n,i,"child_moved",s,o,t),Et(n,i,"child_changed",e,o,t),Et(n,i,"value",e,o,t),i}function Et(n,e,t,o,i,s){const r=o.filter(l=>l.type===t);r.sort((l,a)=>c2(n,l,a)),r.forEach(l=>{const a=a2(n,l,s);i.forEach(d=>{d.respondsTo(l.type)&&e.push(d.createEvent(a,n.query_))})})}function a2(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function c2(n,e,t){if(e.childName==null||t.childName==null)throw pt("Should only compare child_ events.");const o=new z(e.childName,e.snapshotNode),i=new z(t.childName,t.snapshotNode);return n.index_.compare(o,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Bo;function Q2(n){A(!Bo,"__referenceConstructor has already been defined"),Bo=n}function X2(){return A(Bo,"Reference.ts has not been loaded"),Bo}let Y2=1;class Dr{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ee(null),this.pendingWriteTree_=P2(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ha(n,e,t,o,i){return h2(n.pendingWriteTree_,e,t,o,i),i?ft(n,new Wn(ts(),e,t)):[]}function J2(n,e,t,o){u2(n.pendingWriteTree_,e,t,o);const i=ee.fromObject(t);return ft(n,new at(ts(),e,i))}function Cn(n,e,t=!1){const o=p2(n.pendingWriteTree_,e);if(m2(n.pendingWriteTree_,e)){let s=new ee(null);return o.snap!=null?s=s.set(K(),!0):Ue(o.children,r=>{s=s.set(new X(r),!0)}),ft(n,new vo(o.path,s,t))}else return[]}function Mo(n,e,t){return ft(n,new Wn(os(),e,t))}function q2(n,e,t){const o=ee.fromObject(t);return ft(n,new at(os(),e,o))}function $2(n,e){return ft(n,new jt(os(),e))}function Z2(n,e,t){const o=hs(n,t);if(o){const i=us(o),s=i.path,r=i.queryId,l=Re(s,e),a=new jt(is(r),l);return ps(n,s,a)}else return[]}function Bi(n,e,t,o,i=!1){const s=e._path,r=n.syncPointTree_.get(s);let l=[];if(r&&(e._queryIdentifier==="default"||da(r,e))){const a=K2(r,e,t,o);W2(r)&&(n.syncPointTree_=n.syncPointTree_.remove(s));const d=a.removed;if(l=a.events,!i){const u=d.findIndex(m=>m._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(s,(m,b)=>Sn(b));if(u&&!h){const m=n.syncPointTree_.subtree(s);if(!m.isEmpty()){const b=th(m);for(let g=0;g<b.length;++g){const B=b[g],D=B.query,U=ma(n,B);n.listenProvider_.startListening(Nt(D),Io(n,D),U.hashFn,U.onComplete)}}}!h&&d.length>0&&!o&&(u?n.listenProvider_.stopListening(Nt(e),null):d.forEach(m=>{const b=n.queryToTagMap.get(Ro(m));n.listenProvider_.stopListening(Nt(m),b)}))}oh(n,d)}return l}function eh(n,e,t,o){const i=hs(n,o);if(i!=null){const s=us(i),r=s.path,l=s.queryId,a=Re(r,e),d=new Wn(is(l),a,t);return ps(n,r,d)}else return[]}function nh(n,e,t,o){const i=hs(n,o);if(i){const s=us(i),r=s.path,l=s.queryId,a=Re(r,e),d=ee.fromObject(t),u=new at(is(l),a,d);return ps(n,r,u)}else return[]}function Tr(n,e,t,o=!1){const i=e._path;let s=null,r=!1;n.syncPointTree_.foreachOnPath(i,(m,b)=>{const g=Re(m,i);s=s||st(b,g),r=r||Sn(b)});let l=n.syncPointTree_.get(i);l?(r=r||Sn(l),s=s||st(l,K())):(l=new H2,n.syncPointTree_=n.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=M.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((b,g)=>{const B=st(g,K());B&&(s=s.updateImmediateChild(b,B))}));const d=da(l,e);if(!d&&!e._queryParams.loadsAllData()){const m=Ro(e);A(!n.queryToTagMap.has(m),"View does not exist, but we have a tag");const b=ih();n.queryToTagMap.set(m,b),n.tagToQueryMap.set(b,m)}const u=ss(n.pendingWriteTree_,i);let h=G2(l,e,t,u,s,a);if(!d&&!r&&!o){const m=ca(l,e);h=h.concat(sh(n,e,m))}return h}function ds(n,e,t){const i=n.pendingWriteTree_,s=n.syncPointTree_.findOnPath(e,(r,l)=>{const a=Re(r,e),d=st(l,a);if(d)return d});return ta(i,e,s,t,!0)}function ft(n,e){return ua(e,n.syncPointTree_,null,ss(n.pendingWriteTree_,K()))}function ua(n,e,t,o){if(H(n.path))return pa(n,e,t,o);{const i=e.get(K());t==null&&i!=null&&(t=st(i,K()));let s=[];const r=F(n.path),l=n.operationForChild(r),a=e.children.get(r);if(a&&l){const d=t?t.getImmediateChild(r):null,u=oa(o,r);s=s.concat(ua(l,a,d,u))}return i&&(s=s.concat(cs(i,n,o,t))),s}}function pa(n,e,t,o){const i=e.get(K());t==null&&i!=null&&(t=st(i,K()));let s=[];return e.children.inorderTraversal((r,l)=>{const a=t?t.getImmediateChild(r):null,d=oa(o,r),u=n.operationForChild(r);u&&(s=s.concat(pa(u,l,a,d)))}),i&&(s=s.concat(cs(i,n,o,t))),s}function ma(n,e){const t=e.query,o=Io(n,t);return{hashFn:()=>(x2(e)||M.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return o?Z2(n,t._path,o):$2(n,t._path);{const s=$1(i,t);return Bi(n,t,null,s)}}}}function Io(n,e){const t=Ro(e);return n.queryToTagMap.get(t)}function Ro(n){return n._path.toString()+"$"+n._queryIdentifier}function hs(n,e){return n.tagToQueryMap.get(e)}function us(n){const e=n.indexOf("$");return A(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new X(n.substr(0,e))}}function ps(n,e,t){const o=n.syncPointTree_.get(e);A(o,"Missing sync point for query tag that we're tracking");const i=ss(n.pendingWriteTree_,e);return cs(o,t,i,null)}function th(n){return n.fold((e,t,o)=>{if(t&&Sn(t))return[No(t)];{let i=[];return t&&(i=aa(t)),Ue(o,(s,r)=>{i=i.concat(r)}),i}})}function Nt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(X2())(n._repo,n._path):n}function oh(n,e){for(let t=0;t<e.length;++t){const o=e[t];if(!o._queryParams.loadsAllData()){const i=Ro(o),s=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(s)}}}function ih(){return Y2++}function sh(n,e,t){const o=e._path,i=Io(n,e),s=ma(n,t),r=n.listenProvider_.startListening(Nt(e),i,s.hashFn,s.onComplete),l=n.syncPointTree_.subtree(o);if(i)A(!Sn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((d,u,h)=>{if(!H(d)&&u&&Sn(u))return[No(u).query];{let m=[];return u&&(m=m.concat(aa(u).map(b=>b.query))),Ue(h,(b,g)=>{m=m.concat(g)}),m}});for(let d=0;d<a.length;++d){const u=a[d];n.listenProvider_.stopListening(Nt(u),Io(n,u))}}return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bs{constructor(e="",t=null,o={children:{},childCount:0}){this.name=e,this.parent=t,this.node=o}}function gs(n,e){let t=e instanceof X?e:new X(e),o=n,i=F(t);for(;i!==null;){const s=rt(o.node.children,i)||{children:{},childCount:0};o=new bs(i,o,s),t=te(t),i=F(t)}return o}function yt(n){return n.node.value}function ba(n,e){n.node.value=e,Ii(n)}function ga(n){return n.node.childCount>0}function ch(n){return yt(n)===void 0&&!ga(n)}function xo(n,e){Ue(n.node.children,(t,o)=>{e(new bs(t,n,o))})}function Aa(n,e,t,o){t&&!o&&e(n),xo(n,i=>{Aa(i,e,!0,o)}),t&&o&&e(n)}function dh(n,e,t){let o=n.parent;for(;o!==null;){if(e(o))return!0;o=o.parent}return!1}function $t(n){return new X(n.parent===null?n.name:$t(n.parent)+"/"+n.name)}function Ii(n){n.parent!==null&&hh(n.parent,n.name,n)}function hh(n,e,t){const o=ch(t),i=un(n.node.children,e);o&&i?(delete n.node.children[e],n.node.childCount--,Ii(n)):!o&&!i&&(n.node.children[e]=t.node,n.node.childCount++,Ii(n))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nh(n){let e="";const t=n.split("/");for(let o=0;o<t.length;o++)if(t[o].length>0){let i=t[o];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch(s){}e+="/"+i}return e}function Mh(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const o=t.split("=");o.length===2?e[decodeURIComponent(o[0])]=decodeURIComponent(o[1]):Ne(`Invalid query segment '${t}' in query '${n}'`)}return e}const xr=function(n,e){const t=Rh(n),o=t.namespace;t.domain==="firebase.com"&&yn(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!o||o==="undefined")&&t.domain!=="localhost"&&yn("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||Q1();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new Ml(t.host,t.secure,o,i,e,"",o!==t.subdomain),path:new X(t.pathString)}},Rh=function(n){let e="",t="",o="",i="",s="",r=!0,l="https",a=443;if(typeof n=="string"){let d=n.indexOf("//");d>=0&&(l=n.substring(0,d-1),n=n.substring(d+2));let u=n.indexOf("/");u===-1&&(u=n.length);let h=n.indexOf("?");h===-1&&(h=n.length),e=n.substring(0,Math.min(u,h)),u<h&&(i=Nh(n.substring(u,h)));const m=Mh(n.substring(Math.min(n.length,h)));d=e.indexOf(":"),d>=0?(r=l==="https"||l==="wss",a=parseInt(e.substring(d+1),10)):d=e.length;const b=e.slice(0,d);if(b.toLowerCase()==="localhost")t="localhost";else if(b.split(".").length<=2)t=b;else{const g=e.indexOf(".");o=e.substring(0,g).toLowerCase(),t=e.substring(g+1),s=o}"ns"in m&&(s=m.ns)}return{host:e,port:a,domain:t,subdomain:o,secure:r,scheme:l,pathString:i,namespace:s}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vo{constructor(e,t,o,i){this._repo=e,this._path=t,this._queryParams=o,this._orderByCalled=i}get key(){return H(this._path)?null:Yi(this._path)}get ref(){return new Dn(this._repo,this._path)}get _queryIdentifier(){const e=vr(this._queryParams),t=Gi(e);return t==="{}"?"default":t}get _queryObject(){return vr(this._queryParams)}isEqual(e){if(e=Qn(e),!(e instanceof Vo))return!1;const t=this._repo===e._repo,o=Ji(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&o&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+k0(this._path)}}function Hh(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function zh(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===zn){const o="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==Vn)throw new Error(o);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==Bn)throw new Error(o);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===re){if(e!=null&&!Si(e)||t!=null&&!Si(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(A(n.getIndex()instanceof Zi||n.getIndex()===Jl,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class Dn extends Vo{constructor(e,t){super(e,t,new ns,!1)}get parent(){const e=Wl(this._path);return e===null?null:new Dn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class So{constructor(e,t,o){this._node=e,this.ref=t,this._index=o}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new X(e),o=Gt(this.ref,e);return new So(this._node.getChild(t),o,re)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(o,i)=>e(new So(i,Gt(this.ref,o),re)))}hasChild(e){const t=new X(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function qe(n,e){return n=Qn(n),n._checkNotDeleted("ref"),e!==void 0?Gt(n._root,e):n._root}function Gt(n,e){return n=Qn(n),F(n._path)===null?bh("child","path",e):_s("child","path",e),new Dn(n._repo,le(n._path,e))}function so(n,e){n=Qn(n),vs("push",n._path),va("push",e,n._path,!0);const t=Ua(n._repo),o=xh(t),i=Gt(n,o),s=Gt(n,o);let r;return r=Promise.resolve(s),i.then=r.then.bind(r),i.catch=r.then.bind(r,void 0),i}function wa(n){return vs("remove",n._path),Vh(n,null)}function Vh(n,e){n=Qn(n),vs("set",n._path),va("set",e,n._path,!1);const t=new Qt;return Bh(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function Di(n,e){yh("update",e,n._path);const t=new Qt;return Ih(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}class Bs{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const o=t._queryParams.getIndex();return new Oh("value",this,new So(e.snapshotNode,new Dn(t._repo,t._path),o))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Lh(this,e,t):null}matches(e){return e instanceof Bs?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Wh(n,e,t,o,i){let s;if(typeof o=="object"&&(s=void 0,i=o),typeof o=="function"&&(s=o),i&&i.onlyOnce){const a=t,d=(u,h)=>{wi(n._repo,n,l),a(u,h)};d.userCallback=t.userCallback,d.context=t.context,t=d}const r=new Fh(t,s||void 0),l=new Bs(r);return wh(n._repo,n,l),()=>wi(n._repo,n,l)}function ka(n,e,t,o){return Wh(n,"value",e,t,o)}function Da(n,e,t){wi(n._repo,n,null)}class jh{}class Gh extends jh{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){Hh(e,"orderByChild");const t=new X(this._path);if(H(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const o=new Zi(t),i=Z0(e._queryParams,o);return zh(i),new Vo(e._repo,e._path,i,!0)}}function Kh(n){return _s("orderByChild","path",n),new Gh(n)}function Qh(n,...e){let t=Qn(n);for(const o of e)t=o._apply(t);return t}z2(Dn);Q2(Dn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xh="FIREBASE_DATABASE_EMULATOR_HOST",Ti={};let Yh=!1;function Jh(n,e,t,o){const i=e.lastIndexOf(":"),s=e.substring(0,i),r=pl(s);n.repoInfo_=new Ml(e,r,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),o&&(n.authTokenProvider_=o)}function qh(n,e,t,o,i){let s=o||n.options.databaseURL;s===void 0&&(n.options.projectId||yn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Pe("Using default host for project ",n.options.projectId),s=`${n.options.projectId}-default-rtdb.firebaseio.com`);let r=xr(s,i),l=r.repoInfo,a;typeof process!="undefined"&&or&&(a=or[Xh]),a?(s=`http://${a}?ns=${l.namespace}`,r=xr(s,i),l=r.repoInfo):r.repoInfo.secure;const d=new i0(n.name,n.options,e);gh("Invalid Firebase Database URL",r),H(r.path)||yn("Database URL must point to the root of a Firebase Database (not including a child path).");const u=Zh(l,n,d,new o0(n,t));return new eu(u,n)}function $h(n,e){const t=Ti[e];(!t||t[n.key]!==n)&&yn(`Database ${e}(${n.repoInfo_}) has already been deleted.`),kh(n),delete t[n.key]}function Zh(n,e,t,o){let i=Ti[e.name];i||(i={},Ti[e.name]=i);let s=i[n.toURLString()];return s&&yn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new Ph(n,Yh,t,o),i[n.toURLString()]=s,s}class eu{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Uh(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Dn(this._repo,K())),this._rootInternal}_delete(){return this._rootInternal!==null&&($h(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&yn("Cannot call "+e+" on a deleted database.")}}function nu(n=k1(),e){const t=E1(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const o=md("database");o&&tu(t,...o)}return t}function tu(n,e,t,o={}){n=Qn(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,s=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&po(o,s.repoInfo_.emulatorOptions))return;yn("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let r;if(s.repoInfo_.nodeAdmin)o.mockUserToken&&yn('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new io(io.OWNER);else if(o.mockUserToken){const l=typeof o.mockUserToken=="string"?o.mockUserToken:fd(o.mockUserToken,n.app.options.projectId);r=new io(l)}pl(e)&&Sd(e),Jh(s,i,o,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ou(n){z1(w1),fo(new Ot("database",(e,{instanceIdentifier:t})=>{const o=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return qh(o,i,s,t)},"PUBLIC").setMultipleInstances(!0)),ot(ir,sr,n),ot(ir,sr,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ot(su,ru,"app");const Rn=n=>n?String(n).split(/[\r\n,=\s]/)[0].trim():"",Ni={apiKey:Rn("AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs"),authDomain:Rn("findparkinglot-2519e.firebaseapp.com"),projectId:Rn("findparkinglot-2519e"),databaseURL:Rn("https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app"),storageBucket:Rn("findparkinglot-2519e.firebasestorage.app"),messagingSenderId:Rn("976769533420"),appId:Rn("1:976769533420:web:f3108318b3def30017acc9")},hn=!!(Ni.apiKey&&Ni.databaseURL);let Lr=null,Qe=null;hn&&(Lr=bl(Ni),Qe=nu(Lr));const ro="parking_overrides",St=E({}),Ta=E(!1),Mi=E(null);let Mt=null,li=0;function lo(n,e){if(!n||!Array.isArray(e))return"";const t=Number(e[0]),o=Number(e[1]);return!isFinite(t)||!isFinite(o)?"":`${n}|${t.toFixed(6)},${o.toFixed(6)}`.replace(/[.#$/[\]]/g,"_")}function Na(n,e){if(!e)return n;const t={...n},o=i=>{const s=e[i];s!=null&&(typeof s=="string"&&s.trim()===""||(t[i]=s))};return o("description"),o("iconKey"),o("category"),o("friendliness"),o("priceInfo"),t}function lu(){if(!(!hn||Mt))try{const n=qe(Qe,ro);Mt=n,ka(n,e=>{const t={};e.forEach(o=>{t[o.key]=o.val()||{}}),St.value=t,Ta.value=!0},e=>{Mi.value=e})}catch(n){Mi.value=n}}function au(){Mt&&(Da(Mt),Mt=null)}function cu(){Kn(()=>{li+=1,lu()}),ut(()=>{li-=1,li<=0&&au()});const n=(s,r)=>{const l=lo(s,r);return l&&St.value[l]||null};return{overrides:St,ready:Ta,error:Mi,getOverride:n,hasOverride:(s,r)=>!!n(s,r),getOverrideHistory:(s,r)=>{const l=n(s,r);return!l||!l.history||typeof l.history!="object"?[]:Object.entries(l.history).map(([a,d])=>({...d||{},_key:a})).sort((a,d)=>a._key<d._key?1:a._key>d._key?-1:0)},upsertOverride:async(s,r,l)=>{var N,j,Be;if(!hn)throw new Error("Firebase 尚未設定");const a=lo(s.name,s.geometry);if(!a)throw new Error("無法產生 override key (缺少 name 或 geometry)");const[d,u]=s.geometry,h={id:l.id,nickname:l.nickname||""},m={origName:s.name||"",origLng:Number(d),origLat:Number(u),description:typeof r.description=="string"?r.description.trim():"",iconKey:r.iconKey||"",category:r.category||"",friendliness:r.friendliness||"",priceInfo:typeof r.priceInfo=="string"?r.priceInfo.trim():"",updatedBy:h,updatedAt:Fn()},b=St.value[a]||null,g=Na(s,b),B=["description","iconKey","category","friendliness","priceInfo"],D={},U={};for(const ae of B){const Ie=(N=g==null?void 0:g[ae])!=null?N:"",_e=(j=m[ae])!=null?j:"";String(Ie)!==String(_e)&&(D[ae]=Ie,U[ae]=_e)}const W=so(qe(Qe,`${ro}/${a}/history`)).key;return await Di(qe(Qe),{[`${ro}/${a}`]:{...m,history:{...((Be=St.value[a])==null?void 0:Be.history)||{},[W]:{action:"override",at:Fn(),by:h,before:D,after:U}}}}),a},resetOverride:async(s,r)=>{if(!hn)throw new Error("Firebase 尚未設定");const l=lo(s,r);l&&await wa(qe(Qe,`${ro}/${l}`))}}}const on=(n,e)=>{const t=n.__vccOpts||n;for(const[o,i]of e)t[o]=i;return t},du={id:"map"},hu=16,Fr=34,uu=84,pu={__name:"MapBox",props:{parkingTypeKeyArray:Array,degreeOfFriendlinessKeyArray:Array,mapDataList:Array,getLngLat:Boolean,mapStylesSelected:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,goToParkingPlaceData:Object,routeData:Object,favoriteIds:{type:Object,default:()=>new Set},overrideKeys:{type:Object,default:()=>new Set},overrides:{type:Object,default:()=>({})},onlyFavorites:{type:Boolean,default:!1},focusCoord:{type:Array,default:null},routeProfile:{type:String,default:"driving"},communityParkings:{type:Array,default:()=>[]}},emits:["parkingInfo","communityParkingClick","update:goToParkingPlaceData","update:routeData"],setup(n,{expose:e,emit:t}){const o=n,i=t,s="pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",r=E(null),l=E({accessToken:s,bounds:[[119.3620389067818,21.83282743468497],[122.07013958372167,25.34391086143183]],center:[121.5173399,25.0475613],zoom:14,userCoordinates:[null,null]}),a=E(null),d=E([]),u=v=>v>=15?60:v>=13?60+(15-v)*30:v>=11?120+(13-v)*60:240,h=v=>Array.isArray(v)&&v.length>=2&&Number.isFinite(Number(v[0]))&&Number.isFinite(Number(v[1])),m=(v,R,G,$,J)=>{const de=document.createElement("div");de.className="marker",$&&de.classList.add("is-override"),G&&de.classList.add("is-fav");const sn=document.createElement("div");sn.className="tag";const ke=document.createElement("div");ke.className="img";const C=J||R.properties.icon;return C&&(ke.style.backgroundImage=`url(${Y(C)})`,ke.style.backgroundSize="cover",ke.style.backgroundPosition="center center"),de.appendChild(sn),de.appendChild(ke),de.addEventListener("click",()=>{r.value.flyTo({center:R.geometry.coordinates,zoom:17,bearing:0,speed:1.5,curve:1.5,easing:I=>I,essential:!0}),i("parkingInfo",{name:v.name,properties:R.properties,geometry:R.geometry.coordinates,address:""})}),de},b=(v,R)=>{const G=document.createElement("div");G.className="marker is-community",R&&G.classList.add("is-fav");const $=document.createElement("div");$.className="tag";const J=document.createElement("div");return J.className="img",v.iconKey&&(J.style.backgroundImage=`url(${Y(v.iconKey)})`,J.style.backgroundSize="cover",J.style.backgroundPosition="center center"),G.appendChild($),G.appendChild(J),G.addEventListener("click",()=>{r.value.flyTo({center:v.coordinates,zoom:17,speed:1.5,curve:1.5,essential:!0}),i("communityParkingClick",v)}),G},g=v=>{const R=document.createElement("div");R.className="marker-cluster";const G=Math.min(1,Math.log2(Math.max(2,v))/Math.log2(500)),$=Math.round(Fr+(uu-Fr)*G),J=Math.round(12+10*G);return R.style.width=`${$}px`,R.style.height=`${$}px`,R.style.lineHeight=`${$}px`,R.style.fontSize=`${J}px`,R.textContent=String(v),R},B=()=>{var de,sn,ke,C,T,I,se,Me,Le,bn,rn,pe;for(let x=d.value.length-1;x>=0;x--)d.value[x].remove();if(d.value=[],!r.value)return;const v=(sn=(de=r.value).getBounds)==null?void 0:sn.call(de),R=[];for(const x of o.mapDataList)for(const O of x.features){const ce=O.geometry.coordinates;if(!h(ce))continue;const Fe=ci(O.properties.name,ce),He=(C=(ke=o.favoriteIds)==null?void 0:ke.has)==null?void 0:C.call(ke,Fe),ve=lo(O.properties.name,ce),Nn=ve?(I=(T=o.overrideKeys)==null?void 0:T.has)==null?void 0:I.call(T,ve):!1,De=Nn?(se=o.overrides)==null?void 0:se[ve]:null,Te=typeof(De==null?void 0:De.priceInfo)=="string"&&De.priceInfo.trim()!==""?De.priceInfo.trim():"",ln=Te||O.properties.priceInfo,an=Te?Te.split("|"):O.properties.priceArray,je=(typeof(De==null?void 0:De.iconKey)=="string"&&De.iconKey.trim()!==""?De.iconKey.trim():"")||O.properties.icon;!js(v,ce)||o.onlyFavorites&&!He||!Vs(je,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray)||!Ws(ln,an,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)||R.push({coord:[Number(ce[0]),Number(ce[1])],createEl:()=>m(x,O,He,Nn,je)})}for(const x of o.communityParkings||[]){const O=x.coordinates;if(!h(O)||!js(v,O))continue;const ce=ci(x.name,O),Fe=(Le=(Me=o.favoriteIds)==null?void 0:Me.has)==null?void 0:Le.call(Me,ce);if(o.onlyFavorites&&!Fe||!Vs(x.iconKey,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray))continue;const He=x.priceInfo||"",ve=He?He.split("|"):[];Ws(He,ve,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)&&R.push({coord:[Number(O[0]),Number(O[1])],createEl:()=>b(x,Fe)})}const G=(pe=(rn=(bn=r.value).getZoom)==null?void 0:rn.call(bn))!=null?pe:0;if(G>=hu){for(const x of R){const O=new Mn.Marker(x.createEl()).setLngLat(x.coord).addTo(r.value);d.value.push(O)}return}const $=u(G),J=new Map;for(const x of R){const O=r.value.project(x.coord),ce=Math.floor(O.x/$),Fe=Math.floor(O.y/$),He=`${ce}:${Fe}`;let ve=J.get(He);ve||(ve={points:[],sumLng:0,sumLat:0},J.set(He,ve)),ve.points.push(x),ve.sumLng+=x.coord[0],ve.sumLat+=x.coord[1]}for(const x of J.values())if(x.points.length===1){const O=x.points[0],ce=new Mn.Marker(O.createEl()).setLngLat(O.coord).addTo(r.value);d.value.push(ce)}else{const O=[x.sumLng/x.points.length,x.sumLat/x.points.length],ce=g(x.points.length);ce.addEventListener("click",()=>{var ve,Nn,De;const He=Math.min(((De=(Nn=(ve=r.value).getZoom)==null?void 0:Nn.call(ve))!=null?De:0)+2,17);r.value.flyTo({center:O,zoom:He,speed:1.5,curve:1.5,essential:!0})});const Fe=new Mn.Marker(ce).setLngLat(O).addTo(r.value);d.value.push(Fe)}};let D=null,U=null;const W=()=>{D!=null&&(clearTimeout(D),D=null),U!=null&&(typeof cancelIdleCallback=="function"&&cancelIdleCallback(U),U=null)},N=()=>{W(),D=setTimeout(()=>{D=null;const v=()=>{U=null,o.goToParkingPlaceData==null&&B()};typeof requestIdleCallback=="function"?U=requestIdleCallback(v,{timeout:250}):v()},80)},j=()=>{const v=document.getElementById("loading-cover");v&&(v.classList.add("active"),setTimeout(()=>v.remove(),600))},Be=()=>{r.value.on("dragend",N),r.value.on("zoomend",N),B(),j(),r.value.once("load",()=>{const v=o.focusCoord;Array.isArray(v)&&v[0]!=null&&v[1]!=null&&r.value.flyTo({center:[Number(v[0]),Number(v[1])],zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})})},ae=()=>{r.value=new Mn.Map({container:"map",style:o.mapStylesSelected,center:l.value.center,zoom:16,trackResize:!0,maxBounds:l.value.bounds}),Be(),r.value.addControl(new Mn.GeolocateControl({positionOptions:{enableHighAccuracy:!0},trackUserLocation:!0,showUserHeading:!0})),r.value.on("geolocate",v=>{r.value.easeTo({bearing:v.coords.heading,duration:1e3,offset:[0,0]})})},Ie=v=>{const{longitude:R,latitude:G}=v.coords;R>=l.value.bounds[0][0]&&R<=l.value.bounds[1][0]&&G>=l.value.bounds[0][1]&&G<=l.value.bounds[1][1]?(l.value.userCoordinates=[R,G],l.value.center=[R,G]):l.value.center=[121.5173399,25.0475613],ae()},_e=()=>{ae()},ue=()=>{const v=document.getElementById("coordinates"),R=a.value.getLngLat();v.style.display="block",v.innerHTML=`[Longitude, Latitude]<br />[${R.lng}, ${R.lat}]`},oe=()=>{a.value=new Mn.Marker({draggable:!0,color:"#2ee7d6"}).setLngLat(r.value.getCenter()).addTo(r.value),ue(),a.value.on("dragend",ue)};async function Se(v,R){r.value.getLayer("point")||r.value.addLayer({id:"point",type:"circle",source:{type:"geojson",data:{type:"FeatureCollection",features:[{type:"Feature",properties:{},geometry:{type:"Point",coordinates:v}}]}},paint:{"circle-radius":10,"circle-color":"#2ee7d6"}});const J=(await(await fetch(`https://api.mapbox.com/directions/v5/mapbox/${o.routeProfile||"driving"}/${v[0]},${v[1]};${R[0]},${R[1]}?alternatives=false&language=zh-Hant&overview=full&steps=true&exclude=ferry&geometries=geojson&access_token=${l.value.accessToken}`,{method:"GET"})).json()).routes[0],de={type:"Feature",properties:{},geometry:{type:"LineString",coordinates:J.geometry.coordinates}};i("update:routeData",J),r.value.getSource("route")?r.value.getSource("route").setData(de):r.value.addLayer({id:"route",type:"line",source:{type:"geojson",data:de},layout:{"line-join":"round","line-cap":"round"},paint:{"line-color":"#2ee7d6","line-width":5,"line-opacity":.75}})}const Oe=v=>{if(l.value.userCoordinates[0]!==null){r.value.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point"));for(let G=d.value.length-1;G>=0;G--){const $=d.value[G].getLngLat();$.lng!=v[0]&&$.lat!=v[1]&&d.value[G].remove()}const R=[[l.value.userCoordinates[0],l.value.userCoordinates[1]],[v[0],v[1]]];r.value.fitBounds(R,{padding:{top:100,bottom:100,left:100,right:100}}),Se(l.value.userCoordinates,v)}else"geolocation"in navigator&&navigator.geolocation.getCurrentPosition(Ie,_e)},we=()=>{var v,R;(v=r.value)!=null&&v.getSource("route")&&(r.value.removeLayer("route"),r.value.removeSource("route")),(R=r.value)!=null&&R.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point")),B(),i("update:goToParkingPlaceData",null)};return Kn(()=>{Mn.accessToken=l.value.accessToken,"geolocation"in navigator?navigator.geolocation.getCurrentPosition(Ie,_e,{enableHighAccuracy:!1,timeout:8e3,maximumAge:6e4}):ae()}),ut(()=>{W()}),Q([()=>o.parkingTypeKeyArray,()=>o.degreeOfFriendlinessKeyArray,()=>o.priceRangeMin,()=>o.priceRangeMax,()=>o.parkingPriceType,()=>o.onlyFavorites,()=>o.favoriteIds,()=>o.communityParkings],()=>N()),Q(()=>o.focusCoord,v=>{!v||!r.value||r.value.flyTo({center:v,zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})}),Q(()=>o.routeProfile,()=>{o.goToParkingPlaceData!==null&&l.value.userCoordinates[0]!==null&&Se(l.value.userCoordinates,o.goToParkingPlaceData)}),Q(()=>o.goToParkingPlaceData,v=>{v!==null?Oe(v):we()}),Q(()=>o.mapStylesSelected,(v,R)=>{R!==v&&r.value&&r.value.setStyle(v)}),Q(()=>o.getLngLat,()=>{if(a.value!==null){a.value.remove();const v=document.getElementById("coordinates");v&&(v.style.display="none")}o.getLngLat===!0&&oe()}),e({getCenter:()=>{if(!r.value)return[...l.value.center];const v=r.value.getCenter();return[v.lng,v.lat]},flyTo:(v,R=17)=>{!r.value||!v||r.value.flyTo({center:v,zoom:R,essential:!0})}}),(v,R)=>(_(),P("div",du))}},mu=on(pu,[["__scopeId","data-v-6569608f"]]),fu=n=>(wn("data-v-4ef15e45"),n=n(),kn(),n),yu={key:0,class:"modal-header"},bu=fu(()=>c("span",{class:"material-icons-outlined"},"close",-1)),gu=[bu],Au={class:"modal-body"},_u={key:1,class:"modal-footer"},vu={__name:"BaseModal",props:{modelValue:Boolean,title:{type:String,default:""},closeText:{type:String,default:"關閉"},size:{type:String,default:"md"}},emits:["update:modelValue","close"],setup(n,{emit:e}){const t=n,o=e,i=E(null),s=()=>{o("update:modelValue",!1),o("close")},r=l=>{l.key==="Escape"&&t.modelValue&&s()};return Kn(()=>window.addEventListener("keydown",r)),ut(()=>window.removeEventListener("keydown",r)),Q(()=>t.modelValue,async l=>{var a;document.body.classList.toggle("modal-open",l),l&&(await Kr(),(a=i.value)==null||a.scrollTo({top:0,behavior:"auto"}))}),(l,a)=>(_(),Fi(ac,{to:"body"},[c("div",{class:ie(["modal-overlay",{active:n.modelValue}]),onClick:Hi(s,["self"]),role:"dialog","aria-modal":"true",ref_key:"overlayEl",ref:i},[c("div",{class:ie(["modal-card",[`size-${n.size}`,{active:n.modelValue}]])},[n.title||l.$slots.header?(_(),P("header",yu,[Yo(l.$slots,"header",{},()=>[c("h3",null,w(n.title),1)]),c("button",{class:"modal-close",onClick:s,"aria-label":"關閉"},gu)])):V("",!0),c("div",Au,[Yo(l.$slots,"default",{},void 0)]),l.$slots.footer||n.closeText?(_(),P("footer",_u,[Yo(l.$slots,"footer",{},()=>[c("button",{class:"btn btn-primary",onClick:s},w(n.closeText),1)])])):V("",!0)],2)],2)]))}},Ln=on(vu,[["__scopeId","data-v-4ef15e45"]]),Cu=["onClick"],Pu={class:"material-icons-outlined"},Uu={class:"fab-item-label"},Eu=["aria-label","aria-expanded"],Bu={class:"material-icons-outlined"},Iu={__name:"FabMenu",props:{items:{type:Array,required:!0},placement:{type:String,default:"right"},mainIcon:{type:String,default:"apps"},mainLabel:{type:String,default:""}},setup(n){const e=E(!1),t=E(null),o=()=>e.value=!e.value,i=r=>{t.value&&!t.value.contains(r.target)&&(e.value=!1)},s=r=>{var l;e.value=!1,(l=r.onClick)==null||l.call(r)};return Kn(()=>document.addEventListener("click",i)),ut(()=>document.removeEventListener("click",i)),(r,l)=>(_(),P("div",{class:ie(["fab-root",`fab-placement-${n.placement}`]),ref_key:"rootEl",ref:t},[Ee(cc,{name:"fab-item",tag:"div",class:"fab-items"},{default:dn(()=>[(_(!0),P(be,null,Xe(e.value?n.items:[],(a,d)=>(_(),P("button",{key:a.key,class:ie(["fab-item",{highlight:a.highlight}]),style:co({bottom:d*46+"px"}),onClick:u=>s(a)},[c("span",Pu,w(a.icon),1),c("span",Uu,w(a.label),1)],14,Cu))),128))]),_:1}),c("button",{class:ie(["fab-main",{active:e.value}]),onClick:Hi(o,["stop"]),"aria-label":e.value?"收合選單":n.mainLabel||"展開選單","aria-expanded":e.value},[c("span",Bu,w(e.value?"close":n.mainIcon),1)],10,Eu)],2))}},Hr=on(Iu,[["__scopeId","data-v-b3399b6f"]]),ht=[{name:"全部",value:"",key:null},{name:"汽車：汽車格(含未確認是否有重機格)",value:"car",key:["icon-1.png","icon-2.png","icon-3.png","icon-5.png"]},{name:"重機：有設重機專用格",value:"motorcycle",key:["icon-6.png","icon-8.png","icon-12.png","icon-13.png"]},{name:"機車：機車格",value:"scooter",key:["icon-7.png","icon-9.png","icon-10.png","icon-11.png"]},{name:"綠星:路邊友善車格(機車格開放重機停放)",value:"greenStar",key:["icon-14.png"]},{name:"重機友善店家:用餐/消費可停重機",value:"friendlyShop",key:["icon-4.png"]},{name:"綠P:重機專用路邊停車格",value:"greenP",key:["icon-15.png"]},{name:"灰P:重機專用路邊停車格(未確認精準座標)",value:"greyP",key:["icon-16.png"]},{name:"藍P:普通大型共用機車格(台北市試辦)",value:"blueP",key:["icon-17.png"]},{name:"紫P:時段性汽機車共用停車格，注意使用時間喔!",value:"purpleP",key:["icon-18.png"]},{name:"紅X:停都不給停",value:"redX",key:["icon-19.png"]},{name:"?:類型未確認",value:"unknown",key:["icon-20.png"]}];function Su(n){if(!n)return"未分類";const e=ht.find(t=>Array.isArray(t.key)&&t.key.includes(n));return e?e.name.split(/[：:]/)[0]:"未分類"}const Kt=[{name:"全部",value:"",key:null},{name:"最友善：有後牌辨析",value:"friendly",key:["icon-2.png","icon-4.png","icon-6.png","icon-9.png","icon-14.png","icon-15.png"]},{name:"最傳統：悠遊卡、按鈕取票",value:"normal",key:["icon-5.png","icon-11.png","icon-12.png","icon-17.png"]},{name:"最靠北：按鈕請管理員協助、前牌辨析",value:"unfriendly",key:["icon-1.png","icon-7.png","icon-13.png","icon-19.png"]},{name:"未確定",value:"unknown",key:["icon-3.png","icon-8.png","icon-10.png","icon-16.png","icon-20.png"]}],nt=[{name:"依系統設定",value:"system",theme:"system"},{name:"暗色模式",value:"mapbox://styles/jamestim9215/ckvkdj5cd1q4115nzwxa9rny3",theme:"dark"},{name:"亮色模式",value:"mapbox://styles/jamestim9215/ckvueghhu2woc14nrsgysx41v",theme:"light"}],wu="260528",ku=n=>(wn("data-v-fc736dec"),n=n(),kn(),n),Du={class:"range-slider"},Tu={class:"range-track"},Nu=["min","max","step","value"],Mu=["min","max","step","value"],Ru={class:"range-values"},xu=ku(()=>c("span",{class:"range-sep"},"~",-1)),Ou={__name:"RangeSlider",props:{min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:10},modelMin:{type:Number,default:0},modelMax:{type:Number,default:100},suffix:{type:String,default:""}},emits:["update:modelMin","update:modelMax"],setup(n,{emit:e}){const t=n,o=e,i=q(()=>t.max-t.min||1),s=q(()=>(t.modelMin-t.min)/i.value*100),r=q(()=>(t.modelMax-t.min)/i.value*100),l=d=>{let u=Number(d.target.value);u>t.modelMax&&(u=t.modelMax),o("update:modelMin",u)},a=d=>{let u=Number(d.target.value);u<t.modelMin&&(u=t.modelMin),o("update:modelMax",u)};return(d,u)=>(_(),P("div",Du,[c("div",Tu,[c("div",{class:"range-fill",style:co({left:s.value+"%",right:100-r.value+"%"})},null,4),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMin,onInput:l,class:"range-input range-input-min","aria-label":"最低價格"},null,40,Nu),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMax,onInput:a,class:"range-input range-input-max","aria-label":"最高價格"},null,40,Mu)]),c("div",Ru,[c("span",null,w(n.modelMin)+w(n.suffix),1),xu,c("span",null,w(n.modelMax)+w(n.suffix),1)])]))}},Lu=on(Ou,[["__scopeId","data-v-fc736dec"]]),We=n=>(wn("data-v-c813ca92"),n=n(),kn(),n),Fu=We(()=>c("span",{class:"material-icons-outlined"},"chevron_left",-1)),Hu=[Fu],zu=Qr('<header class="side-panel-header" data-v-c813ca92><img class="side-panel-logo" src="'+zi+'" alt="重機能停哪" data-v-c813ca92><div class="side-panel-titles" data-v-c813ca92><h3 data-v-c813ca92>重機能停哪?</h3><span class="side-panel-subtitle" data-v-c813ca92><span class="material-icons-outlined" data-v-c813ca92>tune</span>設定 </span></div></header>',1),Vu={class:"side-panel-body"},Wu={class:"form-group"},ju={class:"form-toggle"},Gu={class:"form-toggle-text"},Ku=We(()=>c("span",{class:"material-icons-outlined fav-icon"},"star",-1)),Qu={key:0,class:"fav-count"},Xu=["checked"],Yu={class:"form-group"},Ju=We(()=>c("label",{class:"form-label"},"甚麼格位",-1)),qu=["value"],$u=["value"],Zu={class:"form-group"},e3=We(()=>c("label",{class:"form-label"},"友善程度",-1)),n3=["value"],t3=["value"],o3={class:"form-group"},i3=We(()=>c("label",{class:"form-label"},"收費範圍",-1)),s3={class:"price-chips"},r3=We(()=>c("span",{class:"material-icons-outlined"},"money_off",-1)),l3={class:"form-group"},a3=We(()=>c("label",{class:"form-label"},"主題顏色",-1)),c3=["value"],d3=["value"],h3=Qr('<section class="form-group" data-v-c813ca92><label class="form-label" data-v-c813ca92>停車場資料來源</label><div class="link-list" data-v-c813ca92><a href="https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&amp;g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&amp;skid=9984dc32-0eac-4e02-b7a8-241e8910f915&amp;shorturl=1&amp;ll=25.078951126084913%2C121.45397636318671&amp;z=11" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-c813ca92> Alan大重停車記事 </a></div></section><section class="form-group" data-v-c813ca92><label class="form-label" data-v-c813ca92>問題回報</label><p class="muted-text" data-v-c813ca92> 1. 停車場資訊相關（新場地、收費錯誤）： </p><a href="https://forms.gle/euRCPCPSmvYLm5Rj8" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-c813ca92> Alan大重停車記事 回報表單 </a><p class="muted-text mt-8" data-v-c813ca92>2. 網頁 BUG、畫面跑版：</p><a href="https://forms.gle/iJCyfqVtpL35WtZM7" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-c813ca92> 重機能停哪? 回報表單 </a><a href="https://buymeacoffee.com/jamestim923" target="_blank" rel="noopener" class="btn btn-coffee btn-sm mt-8" data-v-c813ca92> ☕️ 請我喝杯咖啡，讓我有動力繼續更新 </a></section>',2),u3={class:"form-group"},p3=We(()=>c("label",{class:"form-label"},"資訊",-1)),m3={class:"info-list"},f3=We(()=>c("li",null,"版本：v2.2.1",-1)),y3=We(()=>c("li",null,"Web 製作：爽爽",-1)),b3=We(()=>c("li",null,"資料參考：Alan大重停車記事 Google My Map",-1)),g3=We(()=>c("li",null,"地圖：Mapbox GL JS API",-1)),A3=We(()=>c("li",null,"© 2026 爽爽 版權所有。本網頁未經准許，禁止任何商業行為",-1)),_3={__name:"SettingsPanel",props:{parkingType:String,degreeOfFriendliness:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,mapStyle:String,active:Boolean,onlyFavorites:Boolean,favoritesCount:{type:Number,default:0}},emits:["update:parkingType","update:degreeOfFriendliness","update:parkingPriceType","update:priceRangeMin","update:priceRangeMax","update:mapStyle","update:active","update:onlyFavorites"],setup(n,{emit:e}){const t=e,o=()=>t("update:active",!1);return(i,s)=>(_(),P("aside",{class:ie(["side-panel",{active:n.active}]),"aria-label":"設定面板"},[c("button",{class:"side-panel-close",onClick:o,"aria-label":"收合設定"},Hu),zu,c("div",Vu,[c("section",Wu,[c("label",ju,[c("span",Gu,[Ku,k(" 只看我的最愛 "),n.favoritesCount?(_(),P("span",Qu,w(n.favoritesCount),1)):V("",!0)]),c("input",{type:"checkbox",class:"switch",checked:n.onlyFavorites,onChange:s[0]||(s[0]=r=>t("update:onlyFavorites",r.target.checked))},null,40,Xu)])]),c("section",Yu,[Ju,c("select",{class:"form-control",value:n.parkingType,onChange:s[1]||(s[1]=r=>t("update:parkingType",r.target.value))},[(_(!0),P(be,null,Xe(L(ht),r=>(_(),P("option",{value:r.value,key:r.value},w(r.name),9,$u))),128))],40,qu)]),c("section",Zu,[e3,c("select",{class:"form-control",value:n.degreeOfFriendliness,onChange:s[2]||(s[2]=r=>t("update:degreeOfFriendliness",r.target.value))},[(_(!0),P(be,null,Xe(L(Kt),r=>(_(),P("option",{value:r.value,key:r.value},w(r.name),9,t3))),128))],40,n3)]),c("section",o3,[i3,c("div",s3,[c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType===""}]),onClick:s[3]||(s[3]=r=>t("update:parkingPriceType",""))},"全部",2),c("button",{type:"button",class:ie(["chip chip-free",{active:n.parkingPriceType==="free"}]),onClick:s[4]||(s[4]=r=>t("update:parkingPriceType",n.parkingPriceType==="free"?"":"free"))},[r3,k(" 免費 ")],2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="h"}]),onClick:s[5]||(s[5]=r=>t("update:parkingPriceType","h"))},"計時 /時",2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="d"}]),onClick:s[6]||(s[6]=r=>t("update:parkingPriceType","d"))},"計次 /日",2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="t"}]),onClick:s[7]||(s[7]=r=>t("update:parkingPriceType","t"))},"計次 /不限時",2)]),/d|h|t/.test(n.parkingPriceType)?(_(),Fi(Lu,{key:0,class:"mt-8",min:0,max:300,step:10,"model-min":n.priceRangeMin,"model-max":n.priceRangeMax,suffix:n.parkingPriceType==="h"?" /時":n.parkingPriceType==="d"?" /日":" /次","onUpdate:modelMin":s[8]||(s[8]=r=>t("update:priceRangeMin",r)),"onUpdate:modelMax":s[9]||(s[9]=r=>t("update:priceRangeMax",r))},null,8,["model-min","model-max","suffix"])):V("",!0)]),c("section",l3,[a3,c("select",{class:"form-control",value:n.mapStyle,onChange:s[10]||(s[10]=r=>t("update:mapStyle",r.target.value))},[(_(!0),P(be,null,Xe(L(nt),r=>(_(),P("option",{value:r.value,key:r.value},w(r.name),9,d3))),128))],40,c3)]),h3,c("section",u3,[p3,c("ul",m3,[f3,c("li",null,"地圖資料更新："+w(L(wu)),1),y3,b3,g3,A3])])])],2))}},v3=on(_3,[["__scopeId","data-v-c813ca92"]]),Je=n=>(wn("data-v-d09400e9"),n=n(),kn(),n),C3=Je(()=>c("span",{class:"material-icons-outlined"},"close",-1)),P3=[C3],U3={class:"info-header"},E3=["src"],B3={class:"info-title"},I3=["aria-label","title"],S3={class:"material-icons-outlined"},w3=["innerHTML"],k3={key:1,class:"info-address"},D3={key:2,class:"info-price"},T3=Je(()=>c("span",{class:"material-icons-outlined"},"payments",-1)),N3=Je(()=>c("span",{class:"info-price-label"},"收費",-1)),M3={class:"info-price-value"},R3={key:0,class:"info-price-tag"},x3={key:3,class:"community-tag"},O3=Je(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),L3={key:4,class:"override-tag"},F3=Je(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),H3={key:5,class:"source-tag"},z3=Je(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),V3={class:"info-meta"},W3={class:"badge-group"},j3={class:"badge"},G3={key:0,class:"badge badge-icon",title:"依圖示分類"},K3={class:"coord"},Q3={class:"info-actions"},X3=Je(()=>c("span",{class:"material-icons-outlined"},"edit",-1)),Y3=["title"],J3=Je(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),q3=Je(()=>c("span",{class:"material-icons-outlined"},"share",-1)),$3={class:"info-actions"},Z3=Je(()=>c("span",{class:"material-icons-outlined"},"map",-1)),e5=Je(()=>c("span",{class:"material-icons-outlined"},"map",-1)),n5=Je(()=>c("span",{class:"material-icons-outlined"},"directions",-1)),t5={__name:"ParkingInfoPanel",props:{info:Object,active:Boolean,isMobile:Boolean,isApple:Boolean,isAndroid:Boolean,hasRoute:Boolean,isFavorite:Boolean,isCommunity:{type:Boolean,default:!1},communityMeta:{type:Object,default:null},isOverridden:{type:Boolean,default:!1},overrideMeta:{type:Object,default:null}},emits:["close","route","openMap","toggleFavorite","editCommunity","editOverride","share"],setup(n,{emit:e}){const t=n,o=e,i=new Set(["icon-4.png","icon-14.png","icon-19.png"]),s=l=>l!=null&&l.priceInfo?t.isCommunity||t.isOverridden?!0:!i.has(l==null?void 0:l.parkingIconKey):!1,r=l=>{if(!l)return"";if(/^free$/i.test(l.trim()))return"免費";const a=l.trim().match(/^(\d+(?:\.\d+)?)\s*\/\s*(h|d|次)$/i);if(!a)return l;const d=a[2].toLowerCase(),u=d==="h"?"小時":d==="d"?"日":"次 (不限時)";return`${a[1]} 元 / ${u}`};return(l,a)=>{var d,u,h,m,b,g,B,D;return _(),P("aside",{class:ie(["info-panel",{active:n.active}]),"aria-label":"停車場資訊"},[c("button",{class:"panel-close",onClick:a[0]||(a[0]=U=>o("close")),"aria-label":"關閉"},P3),c("header",U3,[n.info.parkingIcon?(_(),P("img",{key:0,class:"info-icon",src:n.info.parkingIcon,alt:""},null,8,E3)):V("",!0),c("h3",B3,w(n.info.parkingName),1),c("button",{class:ie(["fav-btn",{active:n.isFavorite}]),onClick:a[1]||(a[1]=U=>o("toggleFavorite")),"aria-label":n.isFavorite?"從我的最愛移除":"加入我的最愛",title:n.isFavorite?"從我的最愛移除":"加入我的最愛"},[c("span",S3,w(n.isFavorite?"star":"star_border"),1)],10,I3)]),n.info.parkingNameDes?(_(),P("div",{key:0,class:"info-desc",innerHTML:n.info.parkingNameDes},null,8,w3)):V("",!0),n.info.address?(_(),P("div",k3,w(n.info.address),1)):V("",!0),s(n.info)?(_(),P("div",D3,[T3,N3,c("span",M3,w(r(n.info.priceInfo)),1),n.isOverridden?(_(),P("span",R3,"車友修改")):V("",!0)])):V("",!0),n.isCommunity?(_(),P("div",x3,[O3,c("span",null,[k(" 共筆停車點 "),(u=(d=n.communityMeta)==null?void 0:d.updatedBy)!=null&&u.nickname||(m=(h=n.communityMeta)==null?void 0:h.updatedBy)!=null&&m.id?(_(),P(be,{key:0},[k(" · 由 "+w(n.communityMeta.updatedBy.nickname||`匿名#${n.communityMeta.updatedBy.id}`)+" 更新 ",1)],64)):V("",!0)])])):n.isOverridden?(_(),P("div",L3,[F3,c("span",null,[k(" 車友修改資訊 "),(g=(b=n.overrideMeta)==null?void 0:b.updatedBy)!=null&&g.nickname||(D=(B=n.overrideMeta)==null?void 0:B.updatedBy)!=null&&D.id?(_(),P(be,{key:0},[k(" · 由 "+w(n.overrideMeta.updatedBy.nickname||`匿名#${n.overrideMeta.updatedBy.id}`)+" 更新 ",1)],64)):V("",!0)])])):V("",!0),!n.isCommunity&&n.info.sourceLabel?(_(),P("div",H3,[z3,c("span",null,"資料來源 · "+w(n.info.sourceLabel),1)])):V("",!0),c("div",V3,[c("div",W3,[c("span",j3,w(n.info.parkingType),1),n.info.iconCategory&&n.info.iconCategory!==n.info.parkingType?(_(),P("span",G3,w(n.info.iconCategory),1)):V("",!0)]),c("span",K3,w(Number(n.info.geometry[0]).toFixed(5))+", "+w(Number(n.info.geometry[1]).toFixed(5)),1)]),c("div",Q3,[n.isCommunity?(_(),P("button",{key:0,class:"btn btn-outline btn-sm",onClick:a[2]||(a[2]=U=>o("editCommunity"))},[X3,k(" 編輯 ")])):(_(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[3]||(a[3]=U=>o("editOverride")),title:n.isOverridden?"修改車友提供的資訊 (不會變動官方資料)":"異議 / 補充官方資料 (不會變動官方資料)"},[J3,k(" "+w(n.isOverridden?"修改車友資訊":"異議 / 補充"),1)],8,Y3)),c("button",{class:"btn btn-outline btn-sm",onClick:a[4]||(a[4]=U=>o("share")),title:"分享這個停車點"},[q3,k(" 分享 ")])]),c("div",$3,[n.isAndroid?V("",!0):(_(),P("button",{key:0,class:"btn btn-primary btn-sm",onClick:a[5]||(a[5]=U=>o("openMap","apple"))},[Z3,k(" Apple Map ")])),c("button",{class:ie(["btn","btn-sm",n.isAndroid?"btn-primary":"btn-outline"]),onClick:a[6]||(a[6]=U=>o("openMap","google"))},[e5,k(" Google Map ")],2),n.hasRoute?V("",!0):(_(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[7]||(a[7]=U=>o("route"))},[n5,k(" 路線規劃 ")]))])],2)}}},o5=on(t5,[["__scopeId","data-v-d09400e9"]]),Is=n=>(wn("data-v-caf0ec6e"),n=n(),kn(),n),i5={class:"route-header"},s5=Is(()=>c("h3",null,[c("span",{class:"material-icons-outlined"},"alt_route"),k(" 路線 ")],-1)),r5=["aria-expanded"],l5={class:"material-icons-outlined"},a5={key:0,class:"route-summary"},c5={class:"route-summary-item"},d5=Is(()=>c("span",{class:"material-icons-outlined"},"schedule",-1)),h5={class:"route-summary-item"},u5=Is(()=>c("span",{class:"material-icons-outlined"},"straighten",-1)),p5={class:"route-profile",role:"tablist","aria-label":"交通方式"},m5=["onClick","aria-pressed"],f5={class:"material-icons-outlined"},y5={class:"profile-label"},b5={key:1,class:"route-steps"},g5={__name:"RouteSteps",props:{routeData:Object,active:Boolean,profile:{type:String,default:"driving"}},emits:["cancel","update:profile"],setup(n,{emit:e}){const t=n,o=e,i=E(!0),s=()=>i.value=!i.value,r=[{value:"driving",label:"汽機車",icon:"directions_car"},{value:"cycling",label:"單車",icon:"directions_bike"},{value:"walking",label:"步行",icon:"directions_walk"}],l=q(()=>{var h;const u=(h=t.routeData)==null?void 0:h.distance;return typeof u!="number"?"":u>=1e3?`${(u/1e3).toFixed(1)} km`:`${Math.round(u)} m`}),a=q(()=>{var g;const u=(g=t.routeData)==null?void 0:g.duration;if(typeof u!="number")return"";const h=Math.round(u/60);if(h<60)return`${h} 分`;const m=Math.floor(h/60),b=h%60;return b?`${m} 時 ${b} 分`:`${m} 時`}),d=u=>o("update:profile",u);return(u,h)=>(_(),P("aside",{class:ie(["route-panel",{active:n.active}])},[c("header",i5,[s5,c("button",{class:"route-toggle",onClick:s,"aria-expanded":i.value},[c("span",l5,w(i.value?"expand_less":"expand_more"),1)],8,r5)]),n.routeData?(_(),P("div",a5,[c("div",c5,[d5,c("strong",null,w(a.value),1)]),c("div",h5,[u5,c("strong",null,w(l.value),1)])])):V("",!0),c("div",p5,[(_(),P(be,null,Xe(r,m=>c("button",{key:m.value,class:ie(["profile-btn",{active:n.profile===m.value}]),onClick:b=>d(m.value),"aria-pressed":n.profile===m.value},[c("span",f5,w(m.icon),1),c("span",y5,w(m.label),1)],10,m5)),64))]),n.routeData&&i.value?(_(),P("ol",b5,[(_(!0),P(be,null,Xe(n.routeData.legs[0].steps,(m,b)=>(_(),P("li",{key:b,class:"route-step"},w(m.maneuver.instruction),1))),128))])):V("",!0),c("button",{class:"btn btn-danger btn-sm route-cancel",onClick:h[0]||(h[0]=m=>o("cancel"))}," 取消路線規劃 ")],2))}},A5=on(g5,[["__scopeId","data-v-caf0ec6e"]]);function _5(n,e,t=20,o=[]){const i=(e||"").trim().toLowerCase();if(!i)return[];const s=[];if(Array.isArray(n))for(const r of n)for(const l of r.features){const a=(l.properties.name||"").toLowerCase(),d=(l.properties.description||"").toLowerCase();if((a.includes(i)||d.includes(i))&&(s.push({groupName:r.name,name:l.properties.name,description:l.properties.description,icon:l.properties.icon,geometry:l.geometry.coordinates,properties:l.properties,isCommunity:!1,score:(a.includes(i)?1e3:0)-(a.indexOf(i)===-1?0:a.indexOf(i))}),s.length>500))break}if(Array.isArray(o))for(const r of o){const l=(r.name||"").toLowerCase(),a=(r.description||"").toLowerCase();if(!l.includes(i)&&!a.includes(i))continue;const d=Array.isArray(r.coordinates)?r.coordinates:[null,null];if(!(d[0]==null||d[1]==null)&&(s.push({groupName:"共筆停車點",name:r.name,description:r.description,icon:r.iconKey,geometry:d,properties:{name:r.name,description:r.description,icon:r.iconKey},isCommunity:!0,community:r,score:(l.includes(i)?900:0)-(l.indexOf(i)===-1?0:l.indexOf(i))}),s.length>500))break}return s.sort((r,l)=>l.score-r.score),s.slice(0,t)}const Ma=n=>(wn("data-v-2b0f75f6"),n=n(),kn(),n),v5={key:0,class:"search-results",role:"listbox"},C5=["aria-selected","onMouseenter","onClick"],P5=["src"],U5={class:"search-item-text"},E5={class:"search-item-name"},B5={class:"search-item-group"},I5={key:1,class:"search-empty"},S5={class:"search-box",role:"combobox","aria-expanded":"true"},w5=Ma(()=>c("span",{class:"material-icons-outlined search-icon"},"search",-1)),k5=Ma(()=>c("span",{class:"material-icons-outlined"},"close",-1)),D5=[k5],T5=["aria-label","aria-expanded"],N5={class:"material-icons-outlined"},M5={__name:"SearchBar",props:{mapDataList:Array,communityParkings:{type:Array,default:()=>[]}},emits:["select"],setup(n,{emit:e}){const t=n,o=e,i=E(!1),s=E(""),r=E(-1),l=q(()=>s.value?_5(t.mapDataList,s.value,15,t.communityParkings):[]);Q(s,()=>{r.value=-1});const a=()=>{i.value=!i.value,i.value||(s.value="")},d=()=>{i.value=!1,s.value=""},u=m=>{o("select",m),d()},h=m=>{if(l.value.length)if(m.key==="ArrowDown")m.preventDefault(),r.value=(r.value+1)%l.value.length;else if(m.key==="ArrowUp")m.preventDefault(),r.value=(r.value-1+l.value.length)%l.value.length;else if(m.key==="Enter"){m.preventDefault();const b=r.value>=0?r.value:0;u(l.value[b])}else m.key==="Escape"&&d()};return(m,b)=>(_(),P("div",{class:ie(["search-wrap",{open:i.value}])},[i.value&&l.value.length?(_(),P("ul",v5,[(_(!0),P(be,null,Xe(l.value,(g,B)=>(_(),P("li",{key:B,class:ie(["search-item",{active:B===r.value}]),role:"option","aria-selected":B===r.value,onMouseenter:D=>r.value=B,onClick:D=>u(g)},[g.icon?(_(),P("img",{key:0,src:L(Y)(g.icon),class:"search-item-icon",alt:""},null,8,P5)):V("",!0),c("div",U5,[c("div",E5,w(g.name),1),c("div",B5,w(g.groupName),1)])],42,C5))),128))])):i.value&&s.value&&!l.value.length?(_(),P("div",I5," 找不到「"+w(s.value)+"」相關停車場 ",1)):V("",!0),Ke(c("div",S5,[w5,Ke(c("input",{"onUpdate:modelValue":b[0]||(b[0]=g=>s.value=g),class:"search-input",type:"text",placeholder:"搜尋停車場名稱…",autofocus:"",onKeydown:h},null,544),[[It,s.value]]),s.value?(_(),P("button",{key:0,class:"search-clear",onClick:b[1]||(b[1]=g=>s.value=""),"aria-label":"清除"},D5)):V("",!0)],512),[[Bt,i.value]]),c("button",{class:ie(["search-toggle",{active:i.value}]),onClick:a,"aria-label":i.value?"關閉搜尋":"開啟搜尋","aria-expanded":i.value},[c("span",N5,w(i.value?"close":"search"),1)],10,T5)],2))}},R5=on(M5,[["__scopeId","data-v-2b0f75f6"]]),Tn=n=>(wn("data-v-95843aaa"),n=n(),kn(),n),x5={class:"editor-body"},O5={key:0,class:"editor-note override-note"},L5=Tn(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),F5={key:1,class:"editor-note"},H5=Tn(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),z5={class:"form-group"},V5={class:"form-label"},W5={key:0},j5={key:1,class:"hint-inline"},G5=["readonly","disabled"],K5={class:"form-group"},Q5=Tn(()=>c("label",{class:"form-label"},"類別",-1)),X5=["value"],Y5={class:"form-group"},J5={class:"form-label"},q5={key:0,class:"hint-inline"},$5=["disabled"],Z5=["value"],ep={class:"form-group"},np=Tn(()=>c("label",{class:"form-label"},"收費",-1)),tp={class:"chip-row"},op=["onClick"],ip={key:0,class:"price-amount"},sp={class:"unit"},rp={key:1,class:"price-amount"},lp={class:"form-group"},ap=Tn(()=>c("label",{class:"form-label"},"說明(選填)",-1)),cp={class:"form-group"},dp=Tn(()=>c("label",{class:"form-label"},"暱稱(選填)",-1)),hp=["value"],up={key:2,class:"error-msg"},pp={key:3,class:"form-group history-section"},mp={class:"form-label"},fp=Tn(()=>c("span",{class:"material-icons-outlined",style:{"font-size":"14px","vertical-align":"-2px"}},"history",-1)),yp={class:"history-list"},bp={class:"h-row1"},gp={class:"h-by"},Ap={class:"h-time"},_p={key:0,class:"h-diff h-diff-note"},vp={key:1,class:"h-diff-list"},Cp={class:"h-diff-label"},Pp={class:"h-diff-old"},Up=Tn(()=>c("span",{class:"h-diff-arrow"},"→",-1)),Ep={class:"h-diff-new"},Bp={key:2,class:"h-diff h-diff-note"},Ip=["disabled"],Sp=["disabled"],wp=["disabled"],kp=["disabled"],Dp={__name:"CommunityParkingEditor",props:{open:Boolean,mode:{type:String,default:"add"},initial:{type:Object,default:null},defaultCoord:{type:Array,default:()=>[121.5173399,25.0475613]},nickname:{type:String,default:""},isOwner:{type:Boolean,default:!1},isAdmin:{type:Boolean,default:!1},submitting:{type:Boolean,default:!1},hasExistingOverride:{type:Boolean,default:!1},history:{type:Array,default:()=>[]}},emits:["update:open","update:nickname","submit","delete","reset"],setup(n,{emit:e}){const t=n,o=e,i=E(""),s=E(""),r=E("motorcycle"),l=E("friendly"),a=E("free"),d=E(""),u=E(""),h=E([null,null]),m=q(()=>ht.filter(C=>C.value)),b=q(()=>Kt.filter(C=>C.value)),g={greenStar:"icon-14.png",friendlyShop:"icon-4.png",greenP:"icon-15.png",greyP:"icon-16.png",blueP:"icon-17.png",purpleP:"icon-18.png",redX:"icon-19.png",unknown:"icon-20.png"},B=q(()=>{if(g[r.value])return g[r.value];const C=ht.find(se=>se.value===r.value),T=Kt.find(se=>se.value===l.value);return C?T&&C.key.find(se=>T.key.includes(se))||C.key[0]:"icon-3.png"}),D=q(()=>!!g[r.value]);function U(C){if(!C)return{type:"free",amount:"",custom:""};const T=C.trim();if(/^free$/i.test(T))return{type:"free",amount:"",custom:""};const I=T.match(/^(\d+(?:\.\d+)?)\s*\/\s*([hd次])$/i);return I?{type:I[2].toLowerCase(),amount:I[1],custom:""}:{type:"custom",amount:"",custom:T}}function W(){return a.value==="free"?"Free":a.value==="custom"?u.value.trim():d.value?`${d.value}/${a.value}`:""}const N=()=>{if((t.mode==="edit"||t.mode==="override")&&t.initial){i.value=t.initial.name||"",s.value=t.initial.description||"",r.value=t.initial.category||"motorcycle",l.value=t.initial.friendliness||"friendly";const C=U(t.initial.priceInfo||"");a.value=C.type,d.value=C.amount,u.value=C.custom,h.value=t.initial.coordinates?[...t.initial.coordinates]:[...t.defaultCoord]}else i.value="",s.value="",r.value="motorcycle",l.value="friendly",a.value="free",d.value="",u.value="",h.value=[...t.defaultCoord]};Q(()=>t.open,C=>{C&&N()});const j=E(""),Be=()=>{if(j.value="",!i.value.trim()){j.value="請輸入名稱";return}if(h.value[0]==null||h.value[1]==null||Number.isNaN(Number(h.value[0]))||Number.isNaN(Number(h.value[1]))){j.value="座標無效";return}o("submit",{name:i.value,description:s.value,iconKey:B.value,category:r.value,friendliness:D.value?"":l.value,priceInfo:W(),coordinates:[Number(h.value[0]),Number(h.value[1])]})},ae=()=>{var C;(C=t.initial)!=null&&C.id&&window.confirm(`確定要刪除「${i.value}」?此動作無法復原。`)&&o("delete",t.initial.id)},Ie=()=>{window.confirm(`確定要重設「${i.value}」回官方原始資料嗎?
你和其他車友先前的修改將被移除。`)&&o("reset")},_e=q({get:()=>t.open,set:C=>o("update:open",C)}),ue=[{value:"free",label:"免費"},{value:"h",label:"計時 / 小時"},{value:"d",label:"計次 / 天"},{value:"次",label:"計次 / 不限時"},{value:"custom",label:"其他"}],oe=E(!1),Se=q(()=>!t.history||t.history.length===0?[]:oe.value?t.history:t.history.slice(0,5)),Oe={create:"新增",update:"修改",delete:"刪除",override:"覆寫",reset:"重設"};function we(C){return Oe[C]||C||"變更"}function v(C){return C?C.nickname||(C.id?`匿名#${C.id}`:"匿名"):"系統"}function R(C){if(!C||!isFinite(Number(C)))return"";const T=new Date(Number(C)),I=se=>String(se).padStart(2,"0");return`${T.getFullYear()}/${I(T.getMonth()+1)}/${I(T.getDate())} ${I(T.getHours())}:${I(T.getMinutes())}`}const G={name:"名稱",description:"說明",iconKey:"圖示",category:"類別",friendliness:"友善度",priceInfo:"收費",lng:"經度",lat:"緯度"};function $(C){if(C==null||C==="")return"(空)";if(typeof C=="number")return String(C);const T=String(C);return T.length>40?T.slice(0,40)+"…":T}function J(C){return C==null?"":typeof C=="string"?C.trim():String(C)}function de(C){return J(C)===""}function sn(C,T){if(!C||C.action==="delete"||C.action==="reset")return[];if(C.after&&typeof C.after=="object")return Object.keys(C.after).filter(x=>{var Fe;const O=(Fe=C.before)==null?void 0:Fe[x],ce=C.after[x];return!(de(O)&&de(ce)||J(O)===J(ce)||de(O))}).map(x=>{var O;return{label:G[x]||x,before:$((O=C.before)==null?void 0:O[x]),after:$(C.after[x]),hasBefore:!0}});const I=C.snapshot;if(!I||typeof I!="object")return[];const se=new Set(["createdAt","createdBy","updatedAt","updatedBy","origName","origLng","origLat","history"]),Me=t.history.findIndex(pe=>pe._key===C._key),Le=Me>=0?t.history[Me+1]:null,bn=Le?Le.after&&typeof Le.after=="object"?{...Le.before||{},...Le.after}:Le.snapshot||null:null,rn=[];for(const pe of Object.keys(I)){if(se.has(pe))continue;const x=I[pe];if(bn&&Object.prototype.hasOwnProperty.call(bn,pe)){const O=bn[pe];if(J(O)===J(x)||de(O))continue;rn.push({label:G[pe]||pe,before:$(O),after:$(x),hasBefore:!0})}}return rn}function ke(C){return(C==null?void 0:C.action)==="delete"?"該項目被刪除":(C==null?void 0:C.action)==="reset"?"重設為官方資料":(C==null?void 0:C.action)==="create"?"新增此停車點":""}return(C,T)=>(_(),Fi(Ln,{modelValue:_e.value,"onUpdate:modelValue":T[9]||(T[9]=I=>_e.value=I),title:n.mode==="override"?"修改官方停車點":n.mode==="edit"?"編輯停車場":"新增停車場",size:"md"},{footer:dn(()=>[n.mode==="edit"&&n.isOwner?(_(),P("button",{key:0,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:ae}," 刪除 ",8,Ip)):V("",!0),n.mode==="override"&&n.hasExistingOverride&&n.isAdmin?(_(),P("button",{key:1,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:Ie,title:"僅站方可使用"}," 重設為官方資料 ",8,Sp)):V("",!0),c("button",{class:"btn btn-outline",disabled:n.submitting,onClick:T[8]||(T[8]=I=>_e.value=!1)}," 取消 ",8,wp),c("button",{class:"btn btn-primary",disabled:n.submitting,onClick:Be},w(n.submitting?"送出中…":n.mode==="override"||n.mode==="edit"?"儲存修改":"新增"),9,kp)]),default:dn(()=>[c("div",x5,[n.mode==="override"?(_(),P("p",O5,[L5,k(" 你正在「修改官方停車點」:這層修改只會疊加在官方資料之上,不會覆蓋原始資料。所有車友都會看到你的修改,也可以再被其他人修改或重設。 ")])):(_(),P("p",F5,[H5,k(" 共筆停車點:任何人都可以新增或修改。請確認資訊正確、避免不雅內容。 ")])),c("section",z5,[c("label",V5,[k(" 名稱 "),n.mode!=="override"?(_(),P("span",W5,"*")):V("",!0),n.mode==="override"?(_(),P("span",j5,"(官方名稱不可修改)")):V("",!0)]),Ke(c("input",{"onUpdate:modelValue":T[0]||(T[0]=I=>i.value=I),class:"form-control",type:"text",placeholder:"例:三張里地下停車場",maxlength:"60",readonly:n.mode==="override",disabled:n.mode==="override"},null,8,G5),[[It,i.value]])]),c("section",K5,[Q5,Ke(c("select",{"onUpdate:modelValue":T[1]||(T[1]=I=>r.value=I),class:"form-control"},[(_(!0),P(be,null,Xe(m.value,I=>(_(),P("option",{key:I.value,value:I.value},w(I.name),9,X5))),128))],512),[[zs,r.value]])]),c("section",Y5,[c("label",J5,[k(" 友善程度 "),D.value?(_(),P("span",q5,"(此類別不適用)")):V("",!0)]),Ke(c("select",{"onUpdate:modelValue":T[2]||(T[2]=I=>l.value=I),class:"form-control",disabled:D.value},[(_(!0),P(be,null,Xe(b.value,I=>(_(),P("option",{key:I.value,value:I.value},w(I.name),9,Z5))),128))],8,$5),[[zs,l.value]])]),c("section",ep,[np,c("div",tp,[(_(),P(be,null,Xe(ue,I=>c("button",{key:I.value,type:"button",class:ie(["chip",{active:a.value===I.value}]),onClick:se=>a.value=I.value},w(I.label),11,op)),64))]),a.value==="h"||a.value==="d"||a.value==="次"?(_(),P("div",ip,[Ke(c("input",{"onUpdate:modelValue":T[3]||(T[3]=I=>d.value=I),type:"number",min:"0",step:"1",class:"form-control compact",placeholder:"金額"},null,512),[[It,d.value]]),c("span",sp," 元 / "+w(a.value==="h"?"小時":a.value==="d"?"天":"次 (不限時)"),1)])):a.value==="custom"?(_(),P("div",rp,[Ke(c("input",{"onUpdate:modelValue":T[4]||(T[4]=I=>u.value=I),type:"text",class:"form-control",placeholder:"如:平日 30/h、假日 50/d",maxlength:"40"},null,512),[[It,u.value]])])):V("",!0)]),c("section",lp,[ap,Ke(c("textarea",{"onUpdate:modelValue":T[5]||(T[5]=I=>s.value=I),class:"form-control",rows:"3",placeholder:"後牌辨析、24h、注意事項...",maxlength:"500"},null,512),[[It,s.value]])]),c("section",cp,[dp,c("input",{value:n.nickname,onInput:T[6]||(T[6]=I=>o("update:nickname",I.target.value)),class:"form-control",type:"text",placeholder:"留空將顯示「匿名#xxx-xxx」",maxlength:"20"},null,40,hp)]),j.value?(_(),P("p",up,w(j.value),1)):V("",!0),n.history.length?(_(),P("section",pp,[c("label",mp,[fp,k(" 修改紀錄 ("+w(n.history.length)+") ",1)]),c("ul",yp,[(_(!0),P(be,null,Xe(Se.value,(I,se)=>(_(),P("li",{key:I._key,class:"history-item"},[c("div",bp,[c("span",{class:ie(["h-action",`h-action-${I.action||"other"}`])},w(we(I.action)),3),c("span",gp,w(v(I.by)),1),c("span",Ap,w(R(I.at)),1)]),ke(I)?(_(),P("div",_p,w(ke(I)),1)):sn(I,se).length?(_(),P("ul",vp,[(_(!0),P(be,null,Xe(sn(I,se),(Me,Le)=>(_(),P("li",{key:Le,class:"h-diff-item"},[c("span",Cp,w(Me.label),1),Me.hasBefore?(_(),P(be,{key:0},[c("span",Pp,w(Me.before),1),Up],64)):V("",!0),c("span",Ep,w(Me.after),1)]))),128))])):(_(),P("div",Bp,"(與上一筆相同)"))]))),128))]),n.history.length>5?(_(),P("button",{key:0,type:"button",class:"history-toggle",onClick:T[7]||(T[7]=I=>oe.value=!oe.value)},w(oe.value?"收起":`顯示全部 ${n.history.length} 筆`),1)):V("",!0)])):V("",!0)])]),_:1},8,["modelValue","title"]))}},Tp=on(Dp,[["__scopeId","data-v-95843aaa"]]),Np={class:"tour-card-head"},Mp={class:"tour-step-index"},Rp={class:"tour-title"},xp={key:0,class:"material-icons-outlined"},Op={class:"tour-desc"},Lp={class:"tour-actions"},Fp={key:0,class:"material-icons-outlined"},Hp={key:1,class:"material-icons-outlined"},An=8,zp=12,zr=300,oo=16,Vp={__name:"OnboardingTour",props:{active:{type:Boolean,default:!1},steps:{type:Array,required:!0}},emits:["update:active","finish"],setup(n,{emit:e}){const t=n,o=e,i=E(0),s=E(null),r=E(!1),l=q(()=>t.steps[i.value]||null),a=q(()=>i.value>=t.steps.length-1),d=async()=>{await Kr();const U=l.value;if(!U){s.value=null;return}const W=U.selector?document.querySelector(U.selector):null;if(!W){s.value=null;return}const N=W.getBoundingClientRect();if(N.width===0&&N.height===0){s.value=null;return}s.value={top:N.top,left:N.left,width:N.width,height:N.height}},u=async()=>{for(let U=0;U<8;U++){if(await d(),s.value)return;await new Promise(W=>setTimeout(W,150))}};Q(()=>[t.active,i.value],async([U])=>{if(!U){r.value=!1;return}r.value=!1,await u(),r.value=!0},{immediate:!0});const h=()=>d();Kn(()=>{window.addEventListener("resize",h),window.addEventListener("scroll",h,!0)}),ut(()=>{window.removeEventListener("resize",h),window.removeEventListener("scroll",h,!0)});const m=q(()=>{const U=s.value;return U?{top:U.top-An+"px",left:U.left-An+"px",width:U.width+An*2+"px",height:U.height+An*2+"px",borderRadius:zp+"px"}:{display:"none"}}),b=q(()=>{var oe;const U=s.value,W=window.innerWidth,N=window.innerHeight;if(!U)return{top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:Math.min(zr,W-32)+"px"};const j=((oe=l.value)==null?void 0:oe.placement)||"auto";let Be=j;if(j==="auto"){const Se=N-(U.top+U.height),Oe=U.top;Be=Se>=Oe?"bottom":"top"}const ae=Math.min(zr,W-32);let Ie,_e,ue="";return Be==="bottom"?(Ie=U.top+U.height+oo+An,_e=Math.max(16,Math.min(W-ae-16,U.left+U.width/2-ae/2))):Be==="top"?(Ie=U.top-oo-An,_e=Math.max(16,Math.min(W-ae-16,U.left+U.width/2-ae/2)),ue="translateY(-100%)"):Be==="right"?(Ie=Math.max(16,U.top+U.height/2),_e=U.left+U.width+oo+An,ue="translateY(-50%)"):(Ie=Math.max(16,U.top+U.height/2),_e=U.left-oo-An,ue="translate(-100%, -50%)"),{top:Ie+"px",left:_e+"px",width:ae+"px",transform:ue}}),g=()=>{a.value?D():i.value+=1},B=()=>D(),D=()=>{o("update:active",!1),o("finish"),i.value=0};return Q(()=>t.active,U=>{U&&(i.value=0)}),(U,W)=>n.active&&l.value?(_(),P("div",{key:0,class:ie(["tour-root",{"is-ready":r.value}])},[c("div",{class:"tour-spotlight",style:co(m.value)},null,4),c("div",{class:"tour-backdrop",onClick:Hi(g,["self"])}),c("div",{class:"tour-card",style:co(b.value),role:"dialog","aria-modal":"true"},[c("div",Np,[c("span",Mp,w(i.value+1)+" / "+w(n.steps.length),1),c("button",{class:"tour-skip",onClick:B,"aria-label":"略過導覽"},"略過")]),c("h3",Rp,[l.value.icon?(_(),P("span",xp,w(l.value.icon),1)):V("",!0),k(" "+w(l.value.title),1)]),c("p",Op,w(l.value.description),1),c("div",Lp,[c("button",{class:"btn btn-primary tour-next",onClick:g},[k(w(a.value?"完成":"下一步")+" ",1),a.value?(_(),P("span",Hp,"check")):(_(),P("span",Fp,"arrow_forward"))])])],4)],2)):V("",!0)}},Wp=on(Vp,[["__scopeId","data-v-1d730a34"]]),vn="community_parkings",Ri=E([]),Ra=E(!1),xi=E(null);let Rt=null,ai=0;function jp(){if(!(!hn||Rt))try{const n=Qh(qe(Qe,vn),Kh("updatedAt"));Rt=n,ka(n,e=>{const t=[];e.forEach(o=>{var s,r;const i=o.val()||{};t.push({id:o.key,name:i.name||"",description:i.description||"",iconKey:i.iconKey||"icon-3.png",category:i.category||"",friendliness:i.friendliness||"",priceInfo:i.priceInfo||"",coordinates:[(s=i.lng)!=null?s:null,(r=i.lat)!=null?r:null],createdBy:i.createdBy||null,updatedBy:i.updatedBy||null,createdAt:i.createdAt||null,updatedAt:i.updatedAt||null,history:Kp(i.history)})}),Ri.value=t.reverse(),Ra.value=!0},e=>{xi.value=e})}catch(n){xi.value=n}}function Gp(){Rt&&(Da(Rt),Rt=null)}function Kp(n){return!n||typeof n!="object"?[]:Object.entries(n).map(([e,t])=>({...t||{},_key:e})).sort((e,t)=>e._key<t._key?1:e._key>t._key?-1:0)}function Qp(){return Kn(()=>{ai+=1,jp()}),ut(()=>{ai-=1,ai<=0&&Gp()}),{items:Ri,ready:Ra,error:xi,addParking:async(o,i)=>{var m,b,g;if(!hn)throw new Error("Firebase 尚未設定");const[s,r]=o.coordinates,a=so(qe(Qe,vn)).key,d={id:i.id,nickname:i.nickname||""},u={name:((m=o.name)==null?void 0:m.trim())||"",description:((b=o.description)==null?void 0:b.trim())||"",iconKey:o.iconKey||"icon-3.png",category:o.category||"",friendliness:o.friendliness||"",priceInfo:((g=o.priceInfo)==null?void 0:g.trim())||"",lng:Number(s),lat:Number(r),createdBy:d,createdAt:Fn(),updatedBy:d,updatedAt:Fn()},h=so(qe(Qe,`${vn}/${a}/history`)).key;return await Di(qe(Qe),{[`${vn}/${a}`]:{...u,history:{[h]:{action:"create",at:Fn(),by:d,snapshot:u}}}}),a},updateParking:async(o,i,s)=>{var g,B,D,U,W;if(!hn)throw new Error("Firebase 尚未設定");const r={id:s.id,nickname:s.nickname||""},l=Ri.value.find(N=>N.id===o)||{},a={};if(i.name!==void 0&&(a.name=((g=i.name)==null?void 0:g.trim())||""),i.description!==void 0&&(a.description=((B=i.description)==null?void 0:B.trim())||""),i.iconKey!==void 0&&(a.iconKey=i.iconKey),i.category!==void 0&&(a.category=i.category),i.friendliness!==void 0&&(a.friendliness=i.friendliness),i.priceInfo!==void 0&&(a.priceInfo=((D=i.priceInfo)==null?void 0:D.trim())||""),i.coordinates){const[N,j]=i.coordinates;a.lng=Number(N),a.lat=Number(j)}const d={},u={};for(const N of Object.keys(a)){let j;N==="lng"?j=(U=l.coordinates)==null?void 0:U[0]:N==="lat"?j=(W=l.coordinates)==null?void 0:W[1]:j=l[N];const Be=j==null?"":j,ae=a[N]===void 0||a[N]===null?"":a[N];Be!==ae&&(d[N]=j!=null?j:"",u[N]=a[N])}const h={...a,updatedBy:r,updatedAt:Fn()},m=so(qe(Qe,`${vn}/${o}/history`)).key,b={};for(const N of Object.keys(h))b[`${vn}/${o}/${N}`]=h[N];return b[`${vn}/${o}/history/${m}`]={action:"update",at:Fn(),by:r,before:d,after:u},Di(qe(Qe),b)},deleteParking:async o=>{if(!hn)throw new Error("Firebase 尚未設定");return wa(qe(Qe,`${vn}/${o}`))}}}var Xp={VITE_FIREBASE_DATABASE_URL:"https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app",VITE_FIREBASE_MESSAGING_SENDER_ID:"976769533420",VITE_FIREBASE_MEASUREMENT_ID:"G-XMR8C87T1P",VITE_FIREBASE_STORAGE_BUCKET:"findparkinglot-2519e.firebasestorage.app",VITE_FIREBASE_AUTH_DOMAIN:"findparkinglot-2519e.firebaseapp.com",VITE_MAPBOX_TOKEN:"pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",VITE_FIREBASE_PROJECT_ID:"findparkinglot-2519e",VITE_FIREBASE_APP_ID:"1:976769533420:web:f3108318b3def30017acc9",VITE_FIREBASE_API_KEY:"AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs",BASE_URL:"./",MODE:"production",DEV:!1,PROD:!0,SSR:!1};const xa="community_user_id",Oa="community_user_nickname",Yp="community_is_admin",Jp=String(Xp.VITE_ADMIN_USER_IDS||"").split(",").map(n=>n.trim()).filter(Boolean);function qp(){const n=e=>Array.from(crypto.getRandomValues(new Uint8Array(e))).map(t=>t.toString(16).padStart(2,"0")).join("");return`${n(2)}-${n(2)}`}let ao=Ze.get(xa);ao||(ao=qp(),Ze.set(xa,ao));const Oi=ao,Li=E(Ze.get(Oa)||""),$p=Jp.includes(Oi)||Ze.get(Yp)==="1";Q(Li,n=>Ze.set(Oa,n||""));function Zp(){return{userId:Oi,nickname:Li,displayName:()=>{var e;return((e=Li.value)==null?void 0:e.trim())||`匿名#${Oi}`},isAdmin:$p}}const em=()=>typeof window!="undefined"&&typeof window.gtag=="function",Ce=(n,e={})=>{if(em())try{window.gtag("event",n,e)}catch(t){}},S=n=>(wn("data-v-5a156f87"),n=n(),kn(),n),nm={class:"app-title"},tm=["aria-label","aria-expanded"],om={class:"material-icons-outlined"},im={key:1,class:"title-logo",src:zi,alt:"重機能停哪"},sm=S(()=>c("h1",null,"重機能停哪?",-1)),rm=S(()=>c("pre",{id:"coordinates",class:"coordinates"},null,-1)),lm=S(()=>c("h4",{class:"modal-section-title"},"圖案代表甚麼格位",-1)),am={class:"legend-list"},cm={class:"legend-row"},dm=["src"],hm={class:"legend-row"},um=["src"],pm={class:"legend-row"},mm=["src"],fm={class:"legend-row"},ym=["src"],bm={class:"legend-row"},gm=["src"],Am={class:"legend-row"},_m=["src"],vm={class:"legend-row"},Cm=["src"],Pm={class:"legend-row"},Um=["src"],Em={class:"legend-row"},Bm=["src"],Im={class:"legend-row"},Sm=["src"],wm={class:"legend-row"},km=["src"],Dm=S(()=>c("h4",{class:"modal-section-title"},"顏色代表入場方式",-1)),Tm={class:"legend-list"},Nm={class:"legend-row"},Mm=["src"],Rm=["src"],xm=["src"],Om={class:"legend-row"},Lm=["src"],Fm=["src"],Hm=["src"],zm={class:"legend-row"},Vm=["src"],Wm=["src"],jm=["src"],Gm={class:"legend-row"},Km=["src"],Qm=["src"],Xm=["src"],Ym=S(()=>c("h4",{class:"modal-section-title"},"名稱前有價錢",-1)),Jm={class:"legend-list"},qm={class:"legend-row"},$m=["src"],Zm=S(()=>c("div",{class:"legend-row"},[c("div",{class:"legend-text"},[k(" ・數字:金額,時段費率複雜會以最高收費標示"),c("br"),k(" ・d/h:d 為計次,h 為計時"),c("br"),k(" ・Free 代表免費 ")])],-1)),e4={class:"share-grid"},n4=S(()=>c("img",{src:Xr,alt:""},null,-1)),t4=S(()=>c("span",null,"Facebook",-1)),o4=[n4,t4],i4=S(()=>c("img",{src:Yr,alt:""},null,-1)),s4=S(()=>c("span",null,"LINE",-1)),r4=[i4,s4],l4=S(()=>c("img",{src:Jr,alt:""},null,-1)),a4=S(()=>c("span",null,"Twitter",-1)),c4=[l4,a4],d4=S(()=>c("img",{src:qr,alt:""},null,-1)),h4=S(()=>c("span",null,"複製連結",-1)),u4=[d4,h4],p4={class:"modal-hint",style:{"word-break":"break-all"}},m4={class:"share-grid"},f4=S(()=>c("img",{src:Xr,alt:""},null,-1)),y4=S(()=>c("span",null,"Facebook",-1)),b4=[f4,y4],g4=S(()=>c("img",{src:Yr,alt:""},null,-1)),A4=S(()=>c("span",null,"LINE",-1)),_4=[g4,A4],v4=S(()=>c("img",{src:Jr,alt:""},null,-1)),C4=S(()=>c("span",null,"Twitter",-1)),P4=[v4,C4],U4=S(()=>c("img",{src:qr,alt:""},null,-1)),E4=S(()=>c("span",null,"複製連結",-1)),B4=[U4,E4],I4={class:"os-tabs",role:"tablist","aria-label":"作業系統"},S4=["aria-selected"],w4=S(()=>c("span",{class:"material-icons-outlined"},"phone_iphone",-1)),k4=["aria-selected"],D4=S(()=>c("span",{class:"material-icons-outlined"},"android",-1)),T4=S(()=>c("p",{class:"modal-hint"},"以下以 iOS Safari 為範例",-1)),N4=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Safari 開啟網站並點擊下方分享按鈕",-1)),M4=S(()=>c("img",{class:"full-img",src:hc,alt:""},null,-1)),R4=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「加入主畫面」",-1)),x4=S(()=>c("img",{class:"full-img",src:uc,alt:""},null,-1)),O4=S(()=>c("h4",{class:"modal-section-title"},"3. 確認名稱後按「加入」",-1)),L4=S(()=>c("img",{class:"full-img",src:pc,alt:""},null,-1)),F4=S(()=>c("h4",{class:"modal-section-title"},"4. 完成,圖示已加到主畫面",-1)),H4=S(()=>c("img",{class:"full-img",src:mc,alt:""},null,-1)),z4=S(()=>c("h4",{class:"modal-section-title"},"5. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),V4=S(()=>c("img",{class:"full-img",src:fc,alt:""},null,-1)),W4=S(()=>c("p",{class:"modal-hint"},"以下以 Android Chrome 為範例",-1)),j4=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Chrome 開啟網站並點擊右上角選單，點選「加到主畫面」",-1)),G4=S(()=>c("img",{class:"full-img",src:yc,alt:""},null,-1)),K4=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「安裝」",-1)),Q4=S(()=>c("img",{class:"full-img",src:bc,alt:""},null,-1)),X4=S(()=>c("h4",{class:"modal-section-title"},"3. 完成,圖示已加到主畫面",-1)),Y4=S(()=>c("img",{class:"full-img",src:gc,alt:""},null,-1)),J4=S(()=>c("h4",{class:"modal-section-title"},"4. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),q4=S(()=>c("img",{class:"full-img",src:Ac,alt:""},null,-1)),$4=S(()=>c("div",{class:"welcome-logo-wrap"},[c("img",{class:"welcome-logo",src:zi,alt:"重機能停哪"})],-1)),Z4=S(()=>c("div",{class:"welcome-badge"},"✨ 全新介面上線",-1)),ef=S(()=>c("p",{class:"welcome-text"}," 這是一個提供重機停車資訊的地圖，你可以依據「友善程度」「停車格類型」「收費範圍」尋找合適的停車場，並一鍵開啟 Google 或 Apple Map 導航。 ",-1)),nf=S(()=>c("div",{class:"whatsnew-card"},[c("div",{class:"whatsnew-title"},[c("span",{class:"material-icons-outlined"},"auto_awesome"),k(" 本次新功能 ")]),c("ul",{class:"whatsnew-list"},[c("li",null,[c("span",{class:"material-icons-outlined"},"star"),c("span",null,[c("strong",null,"我的最愛"),c("br"),k(" 可以將喜歡的停車場加入我的最愛")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"search"),c("span",null,[c("strong",null,"地點搜尋"),c("br"),k(" 可以搜尋指定的停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_location_alt"),c("span",null,[c("strong",null,"共筆停車點"),c("br"),k(" 可自由新增、編輯, 大家一起分享停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_note"),c("span",null,[c("strong",null,"官方點異議 / 補充"),c("br"),k(" 點開任一官方停車點 → 「異議 / 補充」, 可在不改動原始資料的前提下, 補上實際費率、更正分類或加註說明, 全車友共享")])])])],-1)),tf=S(()=>c("p",{class:"welcome-text"},[k(" 資料取源於: "),c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"link"},"Alan大重停車記事"),k("，如有停車場相關問題請至該頁面填寫回報表單。 ")],-1)),of=S(()=>c("p",{class:"welcome-text"},' 公告: 原始資料"大重停車記事已無更新" 已改由 Alan大重停車記事 提供，感謝Alan的辛苦整理與分享！ ',-1)),sf=S(()=>c("p",{class:"welcome-text"},[k(" 本站僅提供資料整合服務，地圖免費提供車友使用，資料不定期更新；若發生無法使用情況，請至 "),c("a",{href:"https://forms.gle/iJCyfqVtpL35WtZM7",target:"_blank",rel:"noopener",class:"link"},"錯誤資訊回報"),k("，也歡迎 "),c("a",{href:"https://buymeacoffee.com/jamestim923",target:"_blank",rel:"noopener",class:"link"},"請我喝杯咖啡 ☕️"),k("讓我有動力繼續更新。 ")],-1)),rf=S(()=>c("p",{class:"welcome-text right"},"— by 爽爽",-1)),lf={key:0,class:"pick-crosshair","aria-hidden":"true"},af=S(()=>c("span",{class:"material-icons-outlined dot"},"gps_fixed",-1)),cf=[af],df={key:1,class:"pick-banner"},hf=S(()=>c("span",{class:"pick-banner-text"},[c("span",{class:"material-icons-outlined"},"touch_app"),k(" 拖動地圖，將十字線對準目標位置 ")],-1)),uf=S(()=>c("span",{class:"material-icons-outlined"},"check",-1)),pf=S(()=>c("p",{class:"welcome-text"},[c("strong",{style:{color:"var(--primary)"}},"這是一個公開共享的「共筆停車點」區。"),k(" 除了官方收錄的「大重停車記事」資料外,任何人都可以新增、修改、補充停車位置——不需要註冊、不需要審核。 ")],-1)),mf=S(()=>c("h4",{class:"modal-section-title"},"如何新增停車位置",-1)),ff=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"點左下角的「共筆停車點」按鈕,再點「新增停車位置」"),c("li",null,"畫面中心會出現青色十字游標,拖動地圖將游標對準目標位置"),c("li",null,"按頂部「使用此位置」,填寫名稱、類別、友善程度、收費等資料"),c("li",null,"按「新增」即完成(座標已自動記錄,圖示會依類別自動套用)")],-1)),yf=S(()=>c("h4",{class:"modal-section-title"},"如何編輯他人新增的位置",-1)),bf=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"地圖上「薰衣草紫色底」的標記即為使用者新增的「共筆停車點」"),c("li",null,"點擊該標記,在資訊面板按「編輯」"),c("li",null,"修改後按「儲存修改」")],-1)),gf=S(()=>c("h4",{class:"modal-section-title"},"注意事項",-1)),Af=S(()=>c("ul",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"請確認資訊正確,避免造成他人困擾"),c("li",null,"不要新增不雅、惡意或無關內容"),c("li",null,"暱稱可選填,留空將顯示為「匿名#xxx-xxx」"),c("li",null,"站方保留必要時清空所有「共筆停車點」資料的權利")],-1)),Vr="onboarding_tour_v1",Wr="filters_v1",_f="https://findparkinglot.github.io/",vf={__name:"App",setup(n){var Rs,xs,Os;const e=navigator.userAgent,t=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(e),o=/iPhone|iPad|iPod/i.test(e),i=/Android/i.test(e),s=E([]),r=()=>{var p;return!!((p=window.matchMedia)!=null&&p.call(window,"(prefers-color-scheme: light)").matches)},l=p=>{var f;if(p==="system"){const y=r()?"light":"dark";return(f=nt.find(me=>me.theme===y))==null?void 0:f.value}return p},a=nt.find(p=>p.name===Ze.get("mapStyles")),d=(a==null?void 0:a.value)||((Rs=nt.find(p=>p.theme==="dark"))==null?void 0:Rs.value),u=E(d),h=E({getLngLat:!1,mapStylesSelected:l(d)}),m=p=>{const f=l(p);h.value.mapStylesSelected=f;const y=nt.find(he=>he.value===f),me=(y==null?void 0:y.theme)==="light";document.body.classList.toggle("light-theme",me),document.body.classList.toggle("dark-theme",!me);const Ve=nt.find(he=>he.value===p);Ve&&Ze.set("mapStyles",Ve.name)};m(u.value),Q(u,m);const b=(xs=window.matchMedia)==null?void 0:xs.call(window,"(prefers-color-scheme: light)");(Os=b==null?void 0:b.addEventListener)==null||Os.call(b,"change",()=>{u.value==="system"&&m("system")});const g=E(!0),B=E(!1),D=E(i?"android":"ios"),U=E(!1),W=E(!1),N=E(!1),j=E(!1),Be=[{selector:".mapboxgl-ctrl-geolocate",icon:"my_location",title:"定位你的位置",description:"點右上角的定位按鈕,地圖會自動移到你目前位置,並追蹤方向。"},{selector:".fab-placement-right > .fab-main",icon:"help_outline",title:"功能與教學",description:"右下角的圓形按鈕展開後,可看到「地圖怎麼看」、「加到手機桌面」、「分享」等功能。"},{selector:".search-toggle",icon:"search",title:"搜尋停車點",description:"右下角的搜尋按鈕可依名稱快速找到想去的停車場,點選結果會自動飛到該位置並開啟資訊。"},{selector:".app-title .title-toggle",icon:"menu",title:"篩選與我的最愛",description:"左上角選單可以調整停車類型、友善程度、收費範圍,以及只顯示我的最愛、切換主題。"},{selector:".fab-placement-left > .fab-main",icon:"add_location_alt",title:"共筆停車點",description:"左下角按鈕可新增/編輯共筆停車點,大家一起分享真實的停車資訊。"}],ae=()=>{j.value=!0,Ce("onboarding_tour_start")},Ie=()=>{try{localStorage.setItem(Vr,"1")}catch(p){}Ce("onboarding_tour_finish")},_e=()=>{g.value=!1},ue=E(!1),oe=E(!1),Se=E(!1),Oe=p=>{p!=="menu"&&(ue.value=!1),p!=="info"&&(oe.value=!1),p!=="message"&&(g.value=!1),p!=="mobileFAQ"&&(B.value=!1),p!=="faq"&&(U.value=!1),p!=="share"&&(W.value=!1),p!=="communityHelp"&&(N.value=!1),Ce("panel_open",{panel:p})};Q(ue,p=>p&&Oe("menu")),Q(oe,p=>p&&Oe("info")),Q(g,p=>p&&Oe("message")),Q(B,p=>p&&Oe("mobileFAQ")),Q(B,p=>{p&&(i?D.value="android":o&&(D.value="ios"))}),Q(U,p=>p&&Oe("faq")),Q(W,p=>p&&Oe("share")),Q(N,p=>p&&Oe("communityHelp"));const we=Ze.getJSON(Wr,{})||{},v=E(typeof we.parkingType=="string"?we.parkingType:""),R=E(typeof we.degreeOfFriendliness=="string"?we.degreeOfFriendliness:""),G=E(typeof we.parkingPriceType=="string"?we.parkingPriceType:""),$=E(typeof we.priceRangeMin=="number"?we.priceRangeMin:0),J=E(typeof we.priceRangeMax=="number"?we.priceRangeMax:100),{favorites:de,favoriteIdSet:sn,isFavorite:ke,toggleFavorite:C}=od(),T=E(we.onlyFavorites===!0);Q([v,R,G,$,J,T],([p,f,y,me,Ve,he])=>{Ze.setJSON(Wr,{parkingType:p,degreeOfFriendliness:f,parkingPriceType:y,priceRangeMin:me,priceRangeMax:Ve,onlyFavorites:he})});const I=E("driving"),{items:se,addParking:Me,updateParking:Le,deleteParking:bn}=Qp(),{userId:rn,nickname:pe,isAdmin:x}=Zp(),O=E(null),{overrides:ce,getOverride:Fe,getOverrideHistory:He,upsertOverride:ve,resetOverride:Nn}=cu(),De=q(()=>new Set(Object.keys(ce.value||{}))),Te=E(!1),ln=E("add"),an=E(null),je=E(!1),bt=E([121.5173399,25.0475613]),Ss=E(!1),cn=E(!1),Wo=E(!1),ws=q(()=>!oe.value&&!Se.value&&!cn.value&&!Te.value),ks=()=>{Wo.value&&ws.value&&(Wo.value=!1,ae())};Q(g,(p,f)=>{if(f&&!p)try{localStorage.getItem(Vr)||(Wo.value=!0,setTimeout(ks,350))}catch(y){}}),Q(ws,p=>{p&&setTimeout(ks,200)});const La=q(()=>{var p;if(!Te.value)return[];if(ln.value==="override")return Ge.value?He(Ge.value.name,Ge.value.geometry):[];if(ln.value==="edit"&&((p=an.value)!=null&&p.id)){const f=(se.value||[]).find(y=>y.id===an.value.id);return(f==null?void 0:f.history)||[]}return[]}),ze=E(null),Fa=()=>{if(!hn){alert("「共筆停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}cn.value=!0,Ce("community_add_start")},Ha=()=>{var f,y;const p=((y=(f=O.value)==null?void 0:f.getCenter)==null?void 0:y.call(f))||[121.5173399,25.0475613];bt.value=p,ln.value="add",an.value=null,cn.value=!1,Te.value=!0},za=()=>{cn.value=!1},Va=p=>{var f,y;bt.value=p.coordinates?[...p.coordinates]:((y=(f=O.value)==null?void 0:f.getCenter)==null?void 0:y.call(f))||[121.5173399,25.0475613],ln.value="edit",an.value=p,Te.value=!0},jo=p=>{ze.value=p,Jn({name:"共筆停車點",properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.coordinates,address:""})},Wa=()=>{ze.value&&(oe.value=!1,Va(ze.value))},ja=()=>{if(!hn){alert("「修改官方停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}if(!Ge.value)return;const p=Ge.value,f=Zt.value,y={id:null,name:p.name,description:(f==null?void 0:f.description)||p.description,iconKey:(f==null?void 0:f.iconKey)||p.iconKey,category:(f==null?void 0:f.category)||Ga(p.iconKey),friendliness:(f==null?void 0:f.friendliness)||Ka(p.iconKey),priceInfo:(f==null?void 0:f.priceInfo)||p.priceInfo,coordinates:p.geometry?[...p.geometry]:[...bt.value]};bt.value=y.coordinates,ln.value="override",an.value=y,Ss.value=!!f,oe.value=!1,Te.value=!0,Ce("override_edit_start",{name:p.name})};function Ga(p){if(!p)return"motorcycle";const f=ht.find(y=>y.value&&y.key.includes(p));return(f==null?void 0:f.value)||"motorcycle"}function Ka(p){if(!p)return"friendly";const f=Kt.find(y=>y.value&&y.key.includes(p));return(f==null?void 0:f.value)||"friendly"}const Qa=async p=>{if(Ge.value){je.value=!0;try{const f={id:rn,nickname:pe.value};await ve(Ge.value,p,f),Ce("override_submit",{name:Ge.value.name});const y=Ge.value;Te.value=!1,Jn({name:y.parkingType,properties:{name:y.name,description:y.description,icon:y.iconKey,priceInfo:y.priceInfo,priceArray:[]},geometry:y.geometry,address:Z.value.address})}catch(f){alert("儲存失敗:"+((f==null?void 0:f.message)||f))}finally{je.value=!1}}},Xa=async()=>{if(Ge.value){je.value=!0;try{const p=Ge.value,f={id:rn,nickname:pe.value};await Nn(p.name,p.geometry,f),Ce("override_reset",{name:p.name}),Te.value=!1,Jn({name:p.parkingType,properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.geometry,address:Z.value.address})}catch(p){alert("重設失敗:"+((p==null?void 0:p.message)||p))}finally{je.value=!1}}},Ya=async p=>{var f;je.value=!0;try{const y={id:rn,nickname:pe.value};ln.value==="edit"&&((f=an.value)!=null&&f.id)?(await Le(an.value.id,p,y),Ce("community_edit_submit",{name:p==null?void 0:p.name})):(await Me(p,y),Ce("community_add_submit",{name:p==null?void 0:p.name})),Te.value=!1,ze.value=null}catch(y){alert("儲存失敗:"+((y==null?void 0:y.message)||y))}finally{je.value=!1}},Ja=async p=>{je.value=!0;try{const f={id:rn,nickname:pe.value};await bn(p,f),Ce("community_delete",{id:p}),Te.value=!1,ze.value=null}catch(f){alert("刪除失敗:"+((f==null?void 0:f.message)||f))}finally{je.value=!1}},Go=q(()=>{var f,y;if(!ze.value||!Z.value.parkingName)return!1;const p=ze.value;return p.name===Z.value.parkingName&&Array.isArray(Z.value.geometry)&&((f=p.coordinates)==null?void 0:f[0])===Z.value.geometry[0]&&((y=p.coordinates)==null?void 0:y[1])===Z.value.geometry[1]});Q(oe,p=>{p||(ze.value=null)});const gt=E(null),qa=q(()=>{var p;return((p=ht.find(f=>f.value===v.value))==null?void 0:p.key)||[]}),$a=q(()=>{var p;return((p=Kt.find(f=>f.value===R.value))==null?void 0:p.key)||[]}),Z=E({parkingName:"",parkingNameDes:"",parkingType:"",parkingIcon:"",parkingIconKey:"",iconCategory:"",priceInfo:"",geometry:[null,null],address:"",sourceLabel:""}),Ge=E(null),Zt=E(null),Ds=q(()=>ci(Z.value.parkingName,Z.value.geometry)),Ts=q(()=>ke(Ds.value)),Jn=p=>{var $n,Zn,Ls,Fs,Hs;const f=p.properties.icon,y={name:p.properties.name,description:p.properties.description,iconKey:f,priceInfo:p.properties.priceInfo||"",geometry:p.geometry,parkingType:p.name},me=!!(ze.value&&ze.value.name===p.properties.name&&Array.isArray(p.geometry)&&(($n=ze.value.coordinates)==null?void 0:$n[0])===p.geometry[0]&&((Zn=ze.value.coordinates)==null?void 0:Zn[1])===p.geometry[1]);let Ve=null,he=y;me||(Ve=Fe(y.name,y.geometry),Ve&&(he=Na(y,Ve))),Ge.value=me?null:y,Zt.value=Ve,Z.value={parkingName:he.name,parkingNameDes:he.description,parkingType:y.parkingType,iconCategory:Su(he.iconKey),parkingIcon:Y(he.iconKey),parkingIconKey:he.iconKey,priceInfo:he.priceInfo||"",geometry:p.geometry,address:p.address,sourceLabel:me?"":Xc((Ls=p.properties)==null?void 0:Ls.sourceFolderIndex)},oe.value=!0,Ce("parking_view",{parking_name:(Fs=p.properties)==null?void 0:Fs.name,parking_type:p.name,icon:(Hs=p.properties)==null?void 0:Hs.icon,overridden:!!Ve})},Za=()=>{if(!Z.value.parkingName)return;const p=!Ts.value;C({id:Ds.value,name:Z.value.parkingName,parkingType:Z.value.parkingType,geometry:Z.value.geometry,address:Z.value.address,icon:Z.value.parkingIconKey}),Ce(p?"favorite_add":"favorite_remove",{parking_name:Z.value.parkingName,parking_type:Z.value.parkingType})},ec=p=>"",nc=p=>{var f;p.isCommunity&&p.community?jo(p.community):Jn({name:p.groupName,properties:p.properties,geometry:p.geometry,address:ec(p.geometry)}),gt.value=[...p.geometry],Ce("search_select",{parking_name:(f=p.properties)==null?void 0:f.name,group:p.groupName,community:!!p.isCommunity})},At=E(null),_t=E(null),tc=p=>{I.value="driving",At.value=p,oe.value=!1,_t.value=null,Ce("route_start",{parking_name:Z.value.parkingName,profile:"driving"})},oc=()=>{At.value=null,Se.value=!1};Q(_t,p=>{Se.value=p!==null});const ic=p=>{const f=Z.value.geometry;let y="";p==="apple"?y=`https://maps.apple.com/?daddr=${f[1]},${f[0]}&dirflg=d&t=m`:p==="google"&&(y=`https://www.google.com/maps/dir/?api=1&destination=${f[1]},${f[0]}&travelmode=driving`),y&&(Ce("open_external_map",{provider:p,parking_name:Z.value.parkingName}),window.open(y,"_blank","noopener,noreferrer"))},gn=(p,f=null)=>{const y=f||"https://findparkinglot.github.io/";let me="";p==="facebook"?me=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(y)}`:p==="line"?me=`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(y)}`:p==="twitter"&&(me=`https://twitter.com/share?url=${encodeURIComponent(y)}`),Ce("share",{method:p,scope:f?"spot":"site"}),p==="link"?navigator.clipboard.writeText(y).then(()=>alert("已複製連結"),()=>alert("複製失敗")):window.open(me,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},Ns=()=>{const p=Z.value.geometry;if(!Array.isArray(p)||p[0]==null||p[1]==null)return"";const f=new URLSearchParams({lng:Number(p[0]).toFixed(6),lat:Number(p[1]).toFixed(6)});return`${_f}?${f.toString()}`},sc=()=>{const p=Ns();p&&(qn.value=p,Qo.value=Z.value.parkingName||"停車點",Ko.value=!0,Ce("share_spot_open",{name:Qo.value}))},Ko=E(!1),qn=E(""),Qo=E("");Q([oe,Z],()=>{try{if(!oe.value){window.location.search&&window.history.replaceState({},"",window.location.pathname);return}const p=Ns();if(!p)return;const f=p.slice(p.indexOf("?"));window.history.replaceState({},"",window.location.pathname+f)}catch(p){}},{deep:!0});const vt=E(null),eo=(p,f)=>Math.abs(Number(p)-Number(f))<1e-5,Xo=()=>{var Ve;const p=vt.value;if(!p)return;const f=Number(p.lng),y=Number(p.lat);if(!isFinite(f)||!isFinite(y)){vt.value=null;return}const me=(se.value||[]).find(he=>he.coordinates&&eo(he.coordinates[0],f)&&eo(he.coordinates[1],y));if(me){jo(me),gt.value=[f,y],vt.value=null;return}for(const he of s.value||[])for(const $n of he.features||[]){const Zn=(Ve=$n.geometry)==null?void 0:Ve.coordinates;if(Zn&&eo(Zn[0],f)&&eo(Zn[1],y)){Jn({name:he.name,properties:$n.properties,geometry:$n.geometry.coordinates,address:""}),gt.value=[f,y],vt.value=null;return}}Array.isArray(s.value)&&s.value.length>0&&(gt.value=[f,y])},Ms=()=>{try{const p=new URLSearchParams(window.location.search),f=p.get("lng"),y=p.get("lat");if(!f||!y)return;vt.value={lng:f,lat:y},Xo()}catch(p){}};Q(se,Xo,{deep:!1}),Q(s,Xo,{deep:!1}),Kn(()=>{s.value=td(Kc()),g.value||Ms()}),Q(g,(p,f)=>{f&&!p&&Ms()});const rc=q(()=>[{key:"share",icon:"share",label:"分享",highlight:!0,onClick:()=>W.value=!0},{key:"howto",icon:"help_outline",label:"怎麼用",onClick:ae},{key:"faq",icon:"map",label:"地圖怎麼看",onClick:()=>U.value=!0},{key:"mobile",icon:"add_to_home_screen",label:"加到手機桌面",onClick:()=>B.value=!0}]),lc=q(()=>[{key:"add",icon:"add_location_alt",label:"新增停車位置",highlight:!0,onClick:Fa},{key:"help",icon:"menu_book",label:"編輯教學",onClick:()=>N.value=!0}]);return(p,f)=>(_(),P(be,null,[c("div",nm,[cn.value?(_(),P("img",im)):(_(),P("button",{key:0,class:"title-toggle",onClick:f[0]||(f[0]=y=>ue.value=!ue.value),"aria-label":ue.value?"收合設定":"開啟設定","aria-expanded":ue.value},[c("span",om,w(ue.value?"close":"menu"),1)],8,tm)),sm]),Ke(Ee(Hr,{items:rc.value},null,8,["items"]),[[Bt,!Se.value&&!oe.value&&!cn.value]]),Ke(Ee(Hr,{items:lc.value,placement:"left","main-icon":"add_location_alt","main-label":"共筆停車點"},null,8,["items"]),[[Bt,!Se.value&&!oe.value&&!cn.value]]),Ke(Ee(R5,{"map-data-list":s.value,"community-parkings":L(se),onSelect:nc},null,8,["map-data-list","community-parkings"]),[[Bt,!Se.value&&!oe.value&&!cn.value]]),rm,Ee(mu,{ref_key:"mapBoxRef",ref:O,parkingTypeKeyArray:qa.value,degreeOfFriendlinessKeyArray:$a.value,mapDataList:s.value,getLngLat:h.value.getLngLat,mapStylesSelected:h.value.mapStylesSelected,parkingPriceType:G.value,priceRangeMin:$.value,priceRangeMax:J.value,"favorite-ids":L(sn),"override-keys":De.value,overrides:L(ce),"only-favorites":T.value,"focus-coord":gt.value,"route-profile":I.value,"community-parkings":L(se),goToParkingPlaceData:At.value,"onUpdate:goToParkingPlaceData":f[1]||(f[1]=y=>At.value=y),routeData:_t.value,"onUpdate:routeData":f[2]||(f[2]=y=>_t.value=y),onParkingInfo:Jn,onCommunityParkingClick:jo},null,8,["parkingTypeKeyArray","degreeOfFriendlinessKeyArray","mapDataList","getLngLat","mapStylesSelected","parkingPriceType","priceRangeMin","priceRangeMax","favorite-ids","override-keys","overrides","only-favorites","focus-coord","route-profile","community-parkings","goToParkingPlaceData","routeData"]),Ee(A5,{"route-data":_t.value,active:Se.value,profile:I.value,"onUpdate:profile":f[3]||(f[3]=y=>I.value=y),onCancel:oc},null,8,["route-data","active","profile"]),Ee(v3,{parkingType:v.value,"onUpdate:parkingType":f[4]||(f[4]=y=>v.value=y),degreeOfFriendliness:R.value,"onUpdate:degreeOfFriendliness":f[5]||(f[5]=y=>R.value=y),parkingPriceType:G.value,"onUpdate:parkingPriceType":f[6]||(f[6]=y=>G.value=y),priceRangeMin:$.value,"onUpdate:priceRangeMin":f[7]||(f[7]=y=>$.value=y),priceRangeMax:J.value,"onUpdate:priceRangeMax":f[8]||(f[8]=y=>J.value=y),mapStyle:u.value,"onUpdate:mapStyle":f[9]||(f[9]=y=>u.value=y),active:ue.value,"onUpdate:active":f[10]||(f[10]=y=>ue.value=y),onlyFavorites:T.value,"onUpdate:onlyFavorites":f[11]||(f[11]=y=>T.value=y),"favorites-count":L(de).length},null,8,["parkingType","degreeOfFriendliness","parkingPriceType","priceRangeMin","priceRangeMax","mapStyle","active","onlyFavorites","favorites-count"]),Ke(Ee(o5,{info:Z.value,active:oe.value,"is-mobile":L(t),"is-apple":L(o),"is-android":L(i),"has-route":At.value!==null,"is-favorite":Ts.value,"is-community":Go.value,"community-meta":Go.value?ze.value:null,"is-overridden":!Go.value&&!!Zt.value,"override-meta":Zt.value,onClose:f[12]||(f[12]=y=>oe.value=!1),onRoute:f[13]||(f[13]=y=>tc(Z.value.geometry)),onOpenMap:ic,onToggleFavorite:Za,onEditCommunity:Wa,onEditOverride:ja,onShare:sc},null,8,["info","active","is-mobile","is-apple","is-android","has-route","is-favorite","is-community","community-meta","is-overridden","override-meta"]),[[Bt,!Se.value]]),Ee(Ln,{modelValue:U.value,"onUpdate:modelValue":f[14]||(f[14]=y=>U.value=y),title:"地圖怎麼看?","close-text":"知道了",size:"lg"},{default:dn(()=>[lm,c("div",am,[c("div",cm,[c("img",{src:L(Y)("icon-3.png"),alt:""},null,8,dm),k(" 汽車：汽車格(含未確認是否有重機格) ")]),c("div",hm,[c("img",{src:L(Y)("icon-8.png"),alt:""},null,8,um),k(" 重機(有人):有設重機專用格 ")]),c("div",pm,[c("img",{src:L(Y)("icon-10.png"),alt:""},null,8,mm),k(" 機車(沒人):機車格 ")]),c("div",fm,[c("img",{src:L(Y)("icon-14.png"),alt:""},null,8,ym),k(" 綠星:路邊友善車格 ")]),c("div",bm,[c("img",{src:L(Y)("icon-4.png"),alt:""},null,8,gm),k(" 重機友善店家:用餐/消費時可停重機的店家 ")]),c("div",Am,[c("img",{src:L(Y)("icon-15.png"),alt:""},null,8,_m),k(" 綠P:重機專用路邊停車格 ")]),c("div",vm,[c("img",{src:L(Y)("icon-16.png"),alt:""},null,8,Cm),k(" 灰P:重機專用路邊停車格(未確認精準座標,歡迎回報) ")]),c("div",Pm,[c("img",{src:L(Y)("icon-17.png"),alt:""},null,8,Um),k(" 藍P:普通大型共用機車格(台北市試辦) ")]),c("div",Em,[c("img",{src:L(Y)("icon-18.png"),alt:""},null,8,Bm),k(" 紫P:時段性汽機車共用停車格 ")]),c("div",Im,[c("img",{src:L(Y)("icon-19.png"),alt:""},null,8,Sm),k(" 紅X:停都不給停 ")]),c("div",wm,[c("img",{src:L(Y)("icon-20.png"),alt:""},null,8,km),k(" ?:類型未確認,歡迎透過共筆回報 ")])]),Dm,c("div",Tm,[c("div",Nm,[c("img",{src:L(Y)("icon-2.png"),alt:""},null,8,Mm),c("img",{src:L(Y)("icon-6.png"),alt:""},null,8,Rm),c("img",{src:L(Y)("icon-9.png"),alt:""},null,8,xm),k(" 綠色最友善:有後牌辨析 ")]),c("div",Om,[c("img",{src:L(Y)("icon-5.png"),alt:""},null,8,Lm),c("img",{src:L(Y)("icon-12.png"),alt:""},null,8,Fm),c("img",{src:L(Y)("icon-11.png"),alt:""},null,8,Hm),k(" 藍色最傳統:悠遊卡 / 按鈕取票 ")]),c("div",zm,[c("img",{src:L(Y)("icon-1.png"),alt:""},null,8,Vm),c("img",{src:L(Y)("icon-13.png"),alt:""},null,8,Wm),c("img",{src:L(Y)("icon-7.png"),alt:""},null,8,jm),k(" 紅色最靠北:請管理員協助 / 倒退嚕前牌辨析 ")]),c("div",Gm,[c("img",{src:L(Y)("icon-3.png"),alt:""},null,8,Km),c("img",{src:L(Y)("icon-8.png"),alt:""},null,8,Qm),c("img",{src:L(Y)("icon-10.png"),alt:""},null,8,Xm),k(" 灰色未確定:有可能是上述任何情況,停到請回報 ")])]),Ym,c("div",Jm,[c("div",qm,[c("img",{src:L(Y)("icon-3.png"),alt:""},null,8,$m),k(" (30/h)三張里地下停車場 ")]),Zm])]),_:1},8,["modelValue"]),Ee(Ln,{modelValue:W.value,"onUpdate:modelValue":f[19]||(f[19]=y=>W.value=y),title:"分享給朋友",size:"sm"},{default:dn(()=>[c("div",e4,[c("button",{class:"share-btn",onClick:f[15]||(f[15]=y=>gn("facebook")),"aria-label":"Facebook"},o4),c("button",{class:"share-btn",onClick:f[16]||(f[16]=y=>gn("line")),"aria-label":"LINE"},r4),c("button",{class:"share-btn",onClick:f[17]||(f[17]=y=>gn("twitter")),"aria-label":"Twitter"},c4),c("button",{class:"share-btn",onClick:f[18]||(f[18]=y=>gn("link")),"aria-label":"複製連結"},u4)])]),_:1},8,["modelValue"]),Ee(Ln,{modelValue:Ko.value,"onUpdate:modelValue":f[24]||(f[24]=y=>Ko.value=y),title:`分享：${Qo.value}`,size:"sm"},{default:dn(()=>[c("p",p4,w(qn.value),1),c("div",m4,[c("button",{class:"share-btn",onClick:f[20]||(f[20]=y=>gn("facebook",qn.value)),"aria-label":"Facebook"},b4),c("button",{class:"share-btn",onClick:f[21]||(f[21]=y=>gn("line",qn.value)),"aria-label":"LINE"},_4),c("button",{class:"share-btn",onClick:f[22]||(f[22]=y=>gn("twitter",qn.value)),"aria-label":"Twitter"},P4),c("button",{class:"share-btn",onClick:f[23]||(f[23]=y=>gn("link",qn.value)),"aria-label":"複製連結"},B4)])]),_:1},8,["modelValue","title"]),Ee(Ln,{modelValue:B.value,"onUpdate:modelValue":f[27]||(f[27]=y=>B.value=y),title:"如何加入手機桌面?","close-text":"知道了",size:"lg"},{default:dn(()=>[c("div",I4,[c("button",{type:"button",role:"tab","aria-selected":D.value==="ios",class:ie(["os-tab",{"is-active":D.value==="ios"}]),onClick:f[25]||(f[25]=y=>D.value="ios")},[w4,k(" iOS ")],10,S4),c("button",{type:"button",role:"tab","aria-selected":D.value==="android",class:ie(["os-tab",{"is-active":D.value==="android"}]),onClick:f[26]||(f[26]=y=>D.value="android")},[D4,k(" Android ")],10,k4)]),D.value==="ios"?(_(),P(be,{key:0},[T4,N4,M4,R4,x4,O4,L4,F4,H4,z4,V4],64)):(_(),P(be,{key:1},[W4,j4,G4,K4,Q4,X4,Y4,J4,q4],64))]),_:1},8,["modelValue"]),Ee(Ln,{modelValue:g.value,"onUpdate:modelValue":f[28]||(f[28]=y=>g.value=y),title:"嗨！歡迎使用 重機能停哪?","close-text":"開始使用"},{footer:dn(()=>[c("button",{class:"btn btn-primary",onClick:_e},"開始使用")]),default:dn(()=>[$4,Z4,ef,nf,tf,of,sf,rf]),_:1},8,["modelValue"]),Ee(Tp,{open:Te.value,"onUpdate:open":f[29]||(f[29]=y=>Te.value=y),mode:ln.value,initial:an.value,"default-coord":bt.value,nickname:L(pe),"is-owner":!0,"is-admin":L(x),submitting:je.value,"has-existing-override":Ss.value,history:La.value,"onUpdate:nickname":f[30]||(f[30]=y=>pe.value=y),onSubmit:f[31]||(f[31]=y=>ln.value==="override"?Qa(y):Ya(y)),onDelete:Ja,onReset:Xa},null,8,["open","mode","initial","default-coord","nickname","is-admin","submitting","has-existing-override","history"]),cn.value?(_(),P("div",lf,cf)):V("",!0),cn.value?(_(),P("div",df,[hf,c("div",{class:"pick-banner-actions"},[c("button",{class:"btn btn-outline btn-sm",onClick:za},"取消"),c("button",{class:"btn btn-primary btn-sm",onClick:Ha},[uf,k(" 使用此位置 ")])])])):V("",!0),Ee(Ln,{modelValue:N.value,"onUpdate:modelValue":f[32]||(f[32]=y=>N.value=y),title:"共筆停車點說明","close-text":"我知道了",size:"lg"},{default:dn(()=>[pf,mf,ff,yf,bf,gf,Af]),_:1},8,["modelValue"]),Ee(Wp,{active:j.value,"onUpdate:active":f[33]||(f[33]=y=>j.value=y),steps:Be,onFinish:Ie},null,8,["active"])],64))}},Cf=on(vf,[["__scopeId","data-v-5a156f87"]]);dc(Cf).mount("#app");"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./serviceWorker.js").catch(()=>{})});
