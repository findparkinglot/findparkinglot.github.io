...
`],description:["2023/6/1 重新開放17處坡度較陡停車場"],styleUrl:["#icon-1538-757575-labelson"],Point:[{coordinates:[`
          ...
          `]}]},{name:["(80/h)客限-板橋凱撒大飯店"],description:['<img src="https://mymaps.usercontent.google.com/hostedimage/m/*/3AE5a_Gx_4kPJUIKHOkhJHMGpEezeX2PKAq5I-8ckidZF-OqVSPBxDX4pe-NljcB0uaUd-p1jl_x_gvyTbJB-UgNvzg4mFGyB7to7zNiNns-1OZoGuD2oVftZk1v0v0ejARu0DvWnmuy-LwMnjCFWe1RZBwcpaVqoMHUEZb75a_u9wf14jExhBZN0veW9uRYtk4NCNLQ9iZ0fB1ixNHrqCL9V6lFhiYKWWGPCK3DXUUvXFRppGwtfYSTNaELclsA?fife=s16383" height="200" width="auto" /><br><br>感謝hoha5432提供<br>汽車費率 80h 按鈕取票 2 格 或以上 <br>目前對外說不開放臨停，僅供住宿與用餐客人停放。費用沒有公開，根據個人繳費經驗推估約 80h。<br>官網寫說「本飯店提供機車/汽車地下停車場(B2-B5) ，共220個車位。※B2停放機車（可供重型機車停靠，但如需要更大空間可改停靠汽車停車格）」但實際沒有機車格，而是只有大重停車格（為汽車格畫線切出）。  '],styleUrl:["#icon-1633-0288D1"],ExtendedData:[{Data:[{$:{name:"gx_media_links"},value:["https://mymaps.usercontent.google.com/hostedimage/m/*/3AE5a_Gx_4kPJUIKHOkhJHMGpEezeX2PKAq5I-8ckidZF-OqVSPBxDX4pe-NljcB0uaUd-p1jl_x_gvyTbJB-UgNvzg4mFGyB7to7zNiNns-1OZoGuD2oVftZk1v0v0ejARu0DvWnmuy-LwMnjCFWe1RZBwcpaVqoMHUEZb75a_u9wf14jExhBZN0veW9uRYtk4NCNLQ9iZ0fB1ixNHrqCL9V6lFhiYKWWGPCK3DXUUvXFRppGwtfYSTNaELclsA?fife=s16383"]}]}],Point:[{coordinates:[`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A=function(n,e){if(!n)throw pt(e)},pt=function(n){return new Error("Firebase Database ("+ol.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const il=function(n){const e=[];let t=0;for(let o=0;o<n.length;o++){let i=n.charCodeAt(o);i<128?e[t++]=i:i<2048?(e[t++]=i>>6|192,e[t++]=i&63|128):(i&64512)===55296&&o+1<n.length&&(n.charCodeAt(o+1)&64512)===56320?(i=65536+((i&1023)<<10)+(n.charCodeAt(++o)&1023),e[t++]=i>>18|240,e[t++]=i>>12&63|128,e[t++]=i>>6&63|128,e[t++]=i&63|128):(e[t++]=i>>12|224,e[t++]=i>>6&63|128,e[t++]=i&63|128)}return e},sd=function(n){const e=[];let t=0,o=0;for(;t<n.length;){const i=n[t++];if(i<128)e[o++]=String.fromCharCode(i);else if(i>191&&i<224){const s=n[t++];e[o++]=String.fromCharCode((i&31)<<6|s&63)}else if(i>239&&i<365){const s=n[t++],r=n[t++],l=n[t++],a=((i&7)<<18|(s&63)<<12|(r&63)<<6|l&63)-65536;e[o++]=String.fromCharCode(55296+(a>>10)),e[o++]=String.fromCharCode(56320+(a&1023))}else{const s=n[t++],r=n[t++];e[o++]=String.fromCharCode((i&15)<<12|(s&63)<<6|r&63)}}return e.join("")},Vi={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,e){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,o=[];for(let i=0;i<n.length;i+=3){const s=n[i],r=i+1<n.length,l=r?n[i+1]:0,a=i+2<n.length,d=a?n[i+2]:0,u=s>>2,h=(s&3)<<4|l>>4;let m=(l&15)<<2|d>>6,g=d&63;a||(g=64,r||(m=64)),o.push(t[u],t[h],t[m],t[g])}return o.join("")},encodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(n):this.encodeByteArray(il(n),e)},decodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(n):sd(this.decodeStringToByteArray(n,e))},decodeStringToByteArray(n,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,o=[];for(let i=0;i<n.length;){const s=t[n.charAt(i++)],l=i<n.length?t[n.charAt(i)]:0;++i;const d=i<n.length?t[n.charAt(i)]:64;++i;const h=i<n.length?t[n.charAt(i)]:64;if(++i,s==null||l==null||d==null||h==null)throw new rd;const m=s<<2|l>>4;if(o.push(m),d!==64){const g=l<<4&240|d>>2;if(o.push(g),h!==64){const b=d<<6&192|h;o.push(b)}}}return o},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class rd extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const sl=function(n){const e=il(n);return Vi.encodeByteArray(e,!0)},ho=function(n){return sl(n).replace(/\./g,"")},di=function(n){try{return Vi.decodeString(n,!0)}catch(e){}return null};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ld(n){return rl(void 0,n)}function rl(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!ad(t)||(n[t]=rl(n[t],e[t]));return n}function ad(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dd=()=>cd().__FIREBASE_DEFAULTS__,hd=()=>{if(typeof process=="undefined"||typeof Ks=="undefined")return;const n=Ks.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},ud=()=>{if(typeof document=="undefined")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch(t){return}const e=n&&di(n[1]);return e&&JSON.parse(e)},ll=()=>{try{return id()||dd()||hd()||ud()}catch(n){return}},pd=n=>{var e,t;return(t=(e=ll())==null?void 0:e.emulatorHosts)==null?void 0:t[n]},md=n=>{const e=pd(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const o=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),o]:[e.substring(0,t),o]},al=()=>{var n;return(n=ll())==null?void 0:n.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yd(){return typeof navigator!="undefined"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function cl(){return typeof window!="undefined"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(yd())}function gd(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function dl(){return ol.NODE_ADMIN===!0}function bd(){try{return typeof indexedDB=="object"}catch(n){return!1}}function Ad(){return new Promise((n,e)=>{try{let t=!0;const o="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(o);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(o),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var s;e(((s=i.error)==null?void 0:s.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _d="FirebaseError";class Qt extends Error{constructor(e,t,o){super(t),this.code=e,this.customData=o,this.name=_d,Object.setPrototypeOf(this,Qt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,hl.prototype.create)}}class hl{constructor(e,t,o){this.service=e,this.serviceName=t,this.errors=o}create(e,...t){const o=t[0]||{},i=`${this.service}/${e}`,s=this.errors[e],r=s?vd(s,o):"Error",l=`${this.serviceName}: ${r} (${i}).`;return new Qt(i,l,o)}}function vd(n,e){return n.replace(Cd,(t,o)=>{const i=e[o];return i!=null?String(i):`<${o}?>`})}const Cd=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xt(n){return JSON.parse(n)}function Ae(n){return JSON.stringify(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ul=function(n){let e={},t={},o={},i="";try{const s=n.split(".");e=xt(di(s[0])||""),t=xt(di(s[1])||""),i=s[2],o=t.d||{},delete t.d}catch(s){}return{header:e,claims:t,data:o,signature:i}},Pd=function(n){const e=ul(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},Ud=function(n){const e=ul(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ed(n){const e=[];for(const[t,o]of Object.entries(n))Array.isArray(o)?o.forEach(i=>{e.push(encodeURIComponent(t)+"="+encodeURIComponent(i))}):e.push(encodeURIComponent(t)+"="+encodeURIComponent(o));return e.length?"&"+e.join("&"):""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pl(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch(e){return!1}}async function Sd(n){return(await fetch(n,{credentials:"include"})).ok}class Ot{constructor(e,t,o){this.name=e,this.instanceFactory=t,this.type=o,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ne;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(ne||(ne={}));const Nd={debug:ne.DEBUG,verbose:ne.VERBOSE,info:ne.INFO,warn:ne.WARN,error:ne.ERROR,silent:ne.SILENT},Md=ne.INFO,Rd={[ne.DEBUG]:"log",[ne.VERBOSE]:"log",[ne.INFO]:"info",[ne.WARN]:"warn",[ne.ERROR]:"error"},xd=(n,e,...t)=>{if(e<n.logLevel)return;const o=new Date().toISOString(),i=Rd[e];if(!i)throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class ml{constructor(e){this.name=e,this._logLevel=Md,this._logHandler=xd,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ne))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Nd[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ne.DEBUG,...e),this._logHandler(this,ne.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ne.VERBOSE,...e),this._logHandler(this,ne.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ne.INFO,...e),this._logHandler(this,ne.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ne.WARN,...e),this._logHandler(this,ne.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ne.ERROR,...e),this._logHandler(this,ne.ERROR,...e)}}const Od=(n,e)=>e.some(t=>n instanceof t);let Ys,qs;function Ld(){return Ys||(Ys=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Fd(){return qs||(qs=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const fl=new WeakMap,hi=new WeakMap,yl=new WeakMap,qo=new WeakMap,Wi=new WeakMap;function Hd(n){const e=new Promise((t,o)=>{const i=()=>{n.removeEventListener("success",s),n.removeEventListener("error",r)},s=()=>{t(Pn(n.result)),i()},r=()=>{o(n.error),i()};n.addEventListener("success",s),n.addEventListener("error",r)});return e.then(t=>{t instanceof IDBCursor&&fl.set(t,n)}).catch(()=>{}),Wi.set(e,n),e}function zd(n){if(hi.has(n))return;const e=new Promise((t,o)=>{const i=()=>{n.removeEventListener("complete",s),n.removeEventListener("error",r),n.removeEventListener("abort",r)},s=()=>{t(),i()},r=()=>{o(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",s),n.addEventListener("error",r),n.addEventListener("abort",r)});hi.set(n,e)}let ui={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return hi.get(n);if(e==="objectStoreNames")return n.objectStoreNames||yl.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return Pn(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Vd(n){ui=n(ui)}function Wd(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const o=n.call(Jo(this),e,...t);return yl.set(o,e.sort?e.sort():[e]),Pn(o)}:Fd().includes(n)?function(...e){return n.apply(Jo(this),e),Pn(fl.get(this))}:function(...e){return Pn(n.apply(Jo(this),e))}}function jd(n){return typeof n=="function"?Wd(n):(n instanceof IDBTransaction&&zd(n),Od(n,Ld())?new Proxy(n,ui):n)}function Pn(n){if(n instanceof IDBRequest)return Hd(n);if(qo.has(n))return qo.get(n);const e=jd(n);return e!==n&&(qo.set(n,e),Wi.set(e,n)),e}const Jo=n=>Wi.get(n);function Gd(n,e,{blocked:t,upgrade:o,blocking:i,terminated:s}={}){const r=indexedDB.open(n,e),l=Pn(r);return o&&r.addEventListener("upgradeneeded",a=>{o(Pn(r.result),a.oldVersion,a.newVersion,Pn(r.transaction),a)}),t&&r.addEventListener("blocked",a=>t(a.oldVersion,a.newVersion,a)),l.then(a=>{s&&a.addEventListener("close",()=>s()),i&&a.addEventListener("versionchange",d=>i(d.oldVersion,d.newVersion,d))}).catch(()=>{}),l}const Kd=["get","getKey","getAll","getAllKeys","count"],Xd=["put","add","delete","clear"],$o=new Map;function Js(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if($o.get(e))return $o.get(e);const t=e.replace(/FromIndex$/,""),o=e!==t,i=Xd.includes(t);if(!(t in(o?IDBIndex:IDBObjectStore).prototype)||!(i||Kd.includes(t)))return;const s=async function(r,...l){const a=this.transaction(r,i?"readwrite":"readonly");let d=a.store;return o&&(d=d.index(l.shift())),(await Promise.all([d[t](...l),i&&a.done]))[0]};return $o.set(e,s),s}Vd(n=>({...n,get:(e,t,o)=>Js(e,t)||n.get(e,t,o),has:(e,t)=>!!Js(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qd{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Yd(t)){const o=t.getImmediate();return`${o.library}/${o.version}`}else return null}).filter(t=>t).join(" ")}}function Yd(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const pi="@firebase/app",$s="0.14.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fn=new ml("@firebase/app"),qd="@firebase/app-compat",Jd="@firebase/analytics-compat",$d="@firebase/analytics",Zd="@firebase/app-check-compat",e1="@firebase/app-check",n1="@firebase/auth",t1="@firebase/auth-compat",o1="@firebase/database",i1="@firebase/data-connect",s1="@firebase/database-compat",r1="@firebase/functions",l1="@firebase/functions-compat",a1="@firebase/installations",c1="@firebase/installations-compat",d1="@firebase/messaging",h1="@firebase/messaging-compat",u1="@firebase/performance",p1="@firebase/performance-compat",m1="@firebase/remote-config",f1="@firebase/remote-config-compat",y1="@firebase/storage",g1="@firebase/storage-compat",b1="@firebase/firestore",A1="@firebase/ai",_1="@firebase/firestore-compat",v1="firebase",C1="12.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mi="[DEFAULT]",P1={[pi]:"fire-core",[qd]:"fire-core-compat",[$d]:"fire-analytics",[Jd]:"fire-analytics-compat",[e1]:"fire-app-check",[Zd]:"fire-app-check-compat",[n1]:"fire-auth",[t1]:"fire-auth-compat",[o1]:"fire-rtdb",[i1]:"fire-data-connect",[s1]:"fire-rtdb-compat",[r1]:"fire-fn",[l1]:"fire-fn-compat",[a1]:"fire-iid",[c1]:"fire-iid-compat",[d1]:"fire-fcm",[h1]:"fire-fcm-compat",[u1]:"fire-perf",[p1]:"fire-perf-compat",[m1]:"fire-rc",[f1]:"fire-rc-compat",[y1]:"fire-gcs",[g1]:"fire-gcs-compat",[b1]:"fire-fst",[_1]:"fire-fst-compat",[A1]:"fire-vertex","fire-js":"fire-js",[v1]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mo=new Map,U1=new Map,fi=new Map;function Zs(n,e){try{n.container.addComponent(e)}catch(t){fn.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function fo(n){const e=n.name;if(fi.has(e))return fn.debug(`There were multiple attempts to register component ${e}.`),!1;fi.set(e,n);for(const t of mo.values())Zs(t,n);for(const t of U1.values())Zs(t,n);return!0}function E1(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function B1(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S1{constructor(e,t,o){this._isDeleted=!1,this._options={...e},this._config={...t},this._name=t.name,this._automaticDataCollectionEnabled=t.automaticDataCollectionEnabled,this._container=o,this.container.addComponent(new Ot("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this.checkDestroyed(),this._automaticDataCollectionEnabled=e}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(e){this._isDeleted=e}checkDestroyed(){if(this.isDeleted)throw Un.create("app-deleted",{appName:this._name})}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const w1=C1;function gl(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const o={name:mi,automaticDataCollectionEnabled:!0,...e},i=o.name;if(typeof i!="string"||!i)throw Un.create("bad-app-name",{appName:String(i)});if(t||(t=al()),!t)throw Un.create("no-options");const s=mo.get(i);if(s){if(po(t,s.options)&&po(o,s.config))return s;throw Un.create("duplicate-app",{appName:i})}const r=new Td(i);for(const a of fi.values())r.addComponent(a);const l=new S1(t,o,r);return mo.set(i,l),l}function k1(n=mi){const e=mo.get(n);if(!e&&n===mi&&al())return gl();if(!e)throw Un.create("no-app",{appName:n});return e}function ot(n,e,t){var r;let o=(r=P1[n])!=null?r:n;t&&(o+=`-${t}`);const i=o.match(/\s|\//),s=e.match(/\s|\//);if(i||s){const l=[`Unable to register library "${o}" with version "${e}":`];i&&l.push(`library name "${o}" contains illegal characters (whitespace or "/")`),i&&s&&l.push("and"),s&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),fn.warn(l.join(" "));return}fo(new Ot(`${o}-version`,()=>({library:o,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D1="firebase-heartbeat-database",T1=1,Lt="firebase-heartbeat-store";let Zo=null;function bl(){return Zo||(Zo=Gd(D1,T1,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Lt)}catch(t){}}}}).catch(n=>{throw Un.create("idb-open",{originalErrorMessage:n.message})})),Zo}async function N1(n){try{const t=(await bl()).transaction(Lt),o=await t.objectStore(Lt).get(Al(n));return await t.done,o}catch(e){if(e instanceof Qt)fn.warn(e.message);else{const t=Un.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});fn.warn(t.message)}}}async function er(n,e){try{const o=(await bl()).transaction(Lt,"readwrite");await o.objectStore(Lt).put(e,Al(n)),await o.done}catch(t){if(t instanceof Qt)fn.warn(t.message);else{const o=Un.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});fn.warn(o.message)}}}function Al(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const M1=1024,R1=30;class x1{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new L1(t),this._heartbeatsCachePromise=this._storage.read().then(o=>(this._heartbeatsCache=o,o))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=nr();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(r=>r.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats.length>R1){const r=F1(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(o){fn.warn(o)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=nr(),{heartbeatsToSend:o,unsentEntries:i}=O1(this._heartbeatsCache.heartbeats),s=ho(JSON.stringify({version:2,heartbeats:o}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return fn.warn(t),""}}}function nr(){return new Date().toISOString().substring(0,10)}function O1(n,e=M1){const t=[];let o=n.slice();for(const i of n){const s=t.find(r=>r.agent===i.agent);if(s){if(s.dates.push(i.date),tr(t)>e){s.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),tr(t)>e){t.pop();break}o=o.slice(1)}return{heartbeatsToSend:t,unsentEntries:o}}class L1{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return bd()?Ad().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await N1(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return er(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return er(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function tr(n){return ho(JSON.stringify({version:2,heartbeats:n})).length}function F1(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let o=1;o<n.length;o++)n[o].date<t&&(t=n[o].date,e=o);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function H1(n){fo(new Ot("platform-logger",e=>new Qd(e),"PRIVATE")),fo(new Ot("heartbeat",e=>new x1(e),"PRIVATE")),ot(pi,$s,n),ot(pi,$s,"esm2020"),ot("fire-js","")}H1("");var or={};const ir="@firebase/database",sr="1.1.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class W1{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return un(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vl=function(n){try{if(typeof window!="undefined"&&typeof window[n]!="undefined"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new V1(e)}}catch(e){}return new W1},Hn=vl("localStorage"),j1=vl("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const it=new ml("@firebase/database"),G1=function(){let n=1;return function(){return n++}}(),Cl=function(n){const e=Id(n),t=new Bd;t.update(e);const o=t.digest();return Vi.encodeByteArray(o)},Yt=function(...n){let e="";for(let t=0;t<n.length;t++){const o=n[t];Array.isArray(o)||o&&typeof o=="object"&&typeof o.length=="number"?e+=Yt.apply(null,o):typeof o=="object"?e+=Ae(o):e+=o,e+=" "}return e};let wt=null,rr=!0;const K1=function(n,e){A(!e,"Can't turn on custom loggers persistently."),it.logLevel=ne.VERBOSE,wt=it.log.bind(it)},Pe=function(...n){if(rr===!0&&(rr=!1,wt===null&&j1.get("logging_enabled")===!0&&K1()),wt){const e=Yt.apply(null,n);wt(e)}},qt=function(n){return function(...e){Pe(n,...e)}},yi=function(...n){const e="FIREBASE INTERNAL ERROR: "+Yt(...n);it.error(e)},yn=function(...n){const e=`FIREBASE FATAL ERROR: ${Yt(...n)}`;throw it.error(e),new Error(e)},Ne=function(...n){const e="FIREBASE WARNING: "+Yt(...n);it.warn(e)},X1=function(){typeof window!="undefined"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&Ne("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},ji=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},Q1=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},Vn="[MIN_NAME]",Bn="[MAX_NAME]",Qn=function(n,e){if(n===e)return 0;if(n===Vn||e===Bn)return-1;if(e===Vn||n===Bn)return 1;{const t=lr(n),o=lr(e);return t!==null?o!==null?t-o===0?n.length-e.length:t-o:-1:o!==null?1:n<e?-1:1}},Y1=function(n,e){return n===e?0:n<e?-1:1},Ct=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+Ae(e))},Gi=function(n){if(typeof n!="object"||n===null)return Ae(n);const e=[];for(const o in n)e.push(o);e.sort();let t="{";for(let o=0;o<e.length;o++)o!==0&&(t+=","),t+=Ae(e[o]),t+=":",t+=Gi(n[e[o]]);return t+="}",t},Pl=function(n,e){const t=n.length;if(t<=e)return[n];const o=[];for(let i=0;i<t;i+=e)i+e>t?o.push(n.substring(i,t)):o.push(n.substring(i,i+e));return o};function Ue(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const Ul=function(n){A(!ji(n),"Invalid JSON number");const e=11,t=52,o=(1<<e-1)-1;let i,s,r,l,a;n===0?(s=0,r=0,i=1/n===-1/0?1:0):(i=n<0,n=Math.abs(n),n>=Math.pow(2,1-o)?(l=Math.min(Math.floor(Math.log(n)/Math.LN2),o),s=l+o,r=Math.round(n*Math.pow(2,t-l)-Math.pow(2,t))):(s=0,r=Math.round(n/Math.pow(2,1-o-t))));const d=[];for(a=t;a;a-=1)d.push(r%2?1:0),r=Math.floor(r/2);for(a=e;a;a-=1)d.push(s%2?1:0),s=Math.floor(s/2);d.push(i?1:0),d.reverse();const u=d.join("");let h="";for(a=0;a<64;a+=8){let m=parseInt(u.substr(a,8),2).toString(16);m.length===1&&(m="0"+m),h=h+m}return h.toLowerCase()},q1=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},J1=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function $1(n,e){let t="Unknown Error";n==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":n==="permission_denied"?t="Client doesn't have permission to access the desired data.":n==="unavailable"&&(t="The service is unavailable");const o=new Error(n+" at "+e._path.toString()+": "+t);return o.code=n.toUpperCase(),o}const Z1=new RegExp("^-?(0*)\\d{1,10}$"),e0=-2147483648,n0=2147483647,lr=function(n){if(Z1.test(n)){const e=Number(n);if(e>=e0&&e<=n0)return e}return null},mt=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw Ne("Exception was thrown by user callback.",t),e},Math.floor(0))}},t0=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},kt=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno!="undefined"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o0{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,B1(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(o=>this.appCheck=o)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,o)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)==null||t.get().then(o=>o.addTokenListener(e))}notifyForInvalidToken(){Ne(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class i0{constructor(e,t,o){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=o,this.auth_=null,this.auth_=o.getImmediate({optional:!0}),this.auth_||o.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(Pe("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,o)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Ne(e)}}class io{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}io.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ki="5",El="v",Bl="s",Il="r",Sl="f",wl=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,kl="ls",Dl="p",gi="ac",Tl="websocket",Nl="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r0{constructor(){this.counters_={}}incrementCounter(e,t=1){un(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return ld(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ei={},ni={};function Xi(n){const e=n.toString();return ei[e]||(ei[e]=new r0),ei[e]}function l0(n,e){const t=n.toString();return ni[t]||(ni[t]=e()),ni[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class a0{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const o=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<o.length;++i)o[i]&&mt(()=>{this.onMessage_(o[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ar="start",c0="close",d0="pLPCommand",h0="pRTLPCB",xl="id",Ol="pw",Ll="ser",u0="cb",p0="seg",m0="ts",f0="d",y0="dframe",Fl=1870,Hl=30,g0=Fl-Hl,b0=25e3,A0=3e4;class tt{constructor(e,t,o,i,s,r,l){this.connId=e,this.repoInfo=t,this.applicationId=o,this.appCheckToken=i,this.authToken=s,this.transportSessionId=r,this.lastSessionId=l,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=qt(e),this.stats_=Xi(t),this.urlFn=a=>(this.appCheckToken&&(a[gi]=this.appCheckToken),Rl(t,Nl,a))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new a0(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(A0)),Q1(()=>{if(this.isClosed_)return;this.scriptTagHolder=new Qi((...s)=>{const[r,l,a,d,u]=s;if(this.incrementIncomingBytes_(s),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,r===ar)this.id=l,this.password=a;else if(r===c0)l?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(l,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+r)},(...s)=>{const[r,l]=s;this.incrementIncomingBytes_(s),this.myPacketOrderer.handleResponse(r,l)},()=>{this.onClosed_()},this.urlFn);const o={};o[ar]="t",o[Ll]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(o[u0]=this.scriptTagHolder.uniqueCallbackIdentifier),o[El]=Ki,this.transportSessionId&&(o[Bl]=this.transportSessionId),this.lastSessionId&&(o[kl]=this.lastSessionId),this.applicationId&&(o[Dl]=this.applicationId),this.appCheckToken&&(o[gi]=this.appCheckToken),typeof location!="undefined"&&location.hostname&&wl.test(location.hostname)&&(o[Il]=Sl);const i=this.urlFn(o);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){tt.forceAllow_=!0}static forceDisallow(){tt.forceDisallow_=!0}static isAvailable(){return tt.forceAllow_?!0:!tt.forceDisallow_&&typeof document!="undefined"&&document.createElement!=null&&!q1()&&!J1()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=Ae(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const o=sl(t),i=Pl(o,g0);for(let s=0;s<i.length;s++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[s]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const o={};o[y0]="t",o[xl]=e,o[Ol]=t,this.myDisconnFrame.src=this.urlFn(o),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=Ae(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class Qi{constructor(e,t,o,i){this.onDisconnect=o,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=G1(),window[d0+this.uniqueCallbackIdentifier]=e,window[h0+this.uniqueCallbackIdentifier]=t,this.myIFrame=Qi.createIFrame_();let s="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(s='<script>document.domain="'+document.domain+'";<\/script>');const r="<html><body>"+s+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(r),this.myIFrame.doc.close()}catch(l){Pe("frame writing exception"),l.stack&&Pe(l.stack),Pe(l)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||Pe("No IE domain setting required")}catch(t){const o=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+o+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[xl]=this.myID,e[Ol]=this.myPW,e[Ll]=this.currentSerial;let t=this.urlFn(e),o="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Hl+o.length<=Fl;){const r=this.pendingSegs.shift();o=o+"&"+p0+i+"="+r.seg+"&"+m0+i+"="+r.ts+"&"+f0+i+"="+r.d,i++}return t=t+o,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,o){this.pendingSegs.push({seg:e,ts:t,d:o}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const o=()=>{this.outstandingRequests.delete(t),this.newRequest_()},i=setTimeout(o,Math.floor(b0)),s=()=>{clearTimeout(i),o()};this.addTag(e,s)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const o=this.myIFrame.doc.createElement("script");o.type="text/javascript",o.async=!0,o.src=e,o.onload=o.onreadystatechange=function(){const i=o.readyState;(!i||i==="loaded"||i==="complete")&&(o.onload=o.onreadystatechange=null,o.parentNode&&o.parentNode.removeChild(o),t())},o.onerror=()=>{Pe("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(o)}catch(o){}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _0=16384,v0=45e3;let yo=null;typeof MozWebSocket!="undefined"?yo=MozWebSocket:typeof WebSocket!="undefined"&&(yo=WebSocket);class $e{constructor(e,t,o,i,s,r,l){this.connId=e,this.applicationId=o,this.appCheckToken=i,this.authToken=s,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=qt(this.connId),this.stats_=Xi(t),this.connURL=$e.connectionURL_(t,r,l,i,o),this.nodeAdmin=t.nodeAdmin}static connectionURL_(e,t,o,i,s){const r={};return r[El]=Ki,typeof location!="undefined"&&location.hostname&&wl.test(location.hostname)&&(r[Il]=Sl),t&&(r[Bl]=t),o&&(r[kl]=o),i&&(r[gi]=i),s&&(r[Dl]=s),Rl(e,Tl,r)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Hn.set("previous_websocket_failure",!0);try{let o;dl(),this.mySock=new yo(this.connURL,[],o)}catch(o){this.log_("Error instantiating WebSocket.");const i=o.message||o.data;i&&this.log_(i),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=o=>{this.handleIncomingFrame(o)},this.mySock.onerror=o=>{this.log_("WebSocket error.  Closing connection.");const i=o.message||o.data;i&&this.log_(i),this.onClosed_()}}start(){}static forceDisallow(){$e.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator!="undefined"&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,o=navigator.userAgent.match(t);o&&o.length>1&&parseFloat(o[1])<4.4&&(e=!0)}return!e&&yo!==null&&!$e.forceDisallow_}static previouslyFailed(){return Hn.isInMemoryStorage||Hn.get("previous_websocket_failure")===!0}markConnectionHealthy(){Hn.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const t=this.frames.join("");this.frames=null;const o=xt(t);this.onMessage(o)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(A(this.frames===null,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(t);else{const o=this.extractFrameCount_(t);o!==null&&this.appendFrame_(o)}}send(e){this.resetKeepAlive();const t=Ae(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const o=Pl(t,_0);o.length>1&&this.sendString_(String(o.length));for(let i=0;i<o.length;i++)this.sendString_(o[i])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(v0))}sendString_(e){try{this.mySock.send(e)}catch(t){this.log_("Exception thrown from WebSocket.send():",t.message||t.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}$e.responsesRequiredToBeHealthy=2;$e.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ft{static get ALL_TRANSPORTS(){return[tt,$e]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const t=$e&&$e.isAvailable();let o=t&&!$e.previouslyFailed();if(e.webSocketOnly&&(t||Ne("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),o=!0),o)this.transports_=[$e];else{const i=this.transports_=[];for(const s of Ft.ALL_TRANSPORTS)s&&s.isAvailable()&&i.push(s);Ft.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}Ft.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const C0=6e4,P0=5e3,U0=10*1024,E0=100*1024,ti="t",cr="d",B0="s",dr="r",I0="e",hr="o",ur="a",pr="n",mr="p",S0="h";class w0{constructor(e,t,o,i,s,r,l,a,d,u){this.id=e,this.repoInfo_=t,this.applicationId_=o,this.appCheckToken_=i,this.authToken_=s,this.onMessage_=r,this.onReady_=l,this.onDisconnect_=a,this.onKill_=d,this.lastSessionId=u,this.connectionCount=0,this.pendingDataMessages=[],this.state_=0,this.log_=qt("c:"+this.id+":"),this.transportManager_=new Ft(t),this.log_("Connection created"),this.start_()}start_(){const e=this.transportManager_.initialTransport();this.conn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,null,this.lastSessionId),this.primaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const t=this.connReceiver_(this.conn_),o=this.disconnReceiver_(this.conn_);this.tx_=this.conn_,this.rx_=this.conn_,this.secondaryConn_=null,this.isHealthy_=!1,setTimeout(()=>{this.conn_&&this.conn_.open(t,o)},Math.floor(0));const i=e.healthyTimeout||0;i>0&&(this.healthyTimeout_=kt(()=>{this.healthyTimeout_=null,this.isHealthy_||(this.conn_&&this.conn_.bytesReceived>E0?(this.log_("Connection exceeded healthy timeout but has received "+this.conn_.bytesReceived+" bytes.  Marking connection healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()):this.conn_&&this.conn_.bytesSent>U0?this.log_("Connection exceeded healthy timeout but has sent "+this.conn_.bytesSent+" bytes.  Leaving connection alive."):(this.log_("Closing unhealthy connection after timeout."),this.close()))},Math.floor(i)))}nextTransportId_(){return"c:"+this.id+":"+this.connectionCount++}disconnReceiver_(e){return t=>{e===this.conn_?this.onConnectionLost_(t):e===this.secondaryConn_?(this.log_("Secondary connection lost."),this.onSecondaryConnectionLost_()):this.log_("closing an old connection")}}connReceiver_(e){return t=>{this.state_!==2&&(e===this.rx_?this.onPrimaryMessageReceived_(t):e===this.secondaryConn_?this.onSecondaryMessageReceived_(t):this.log_("message on old connection"))}}sendRequest(e){const t={t:"d",d:e};this.sendData_(t)}tryCleanupConnection(){this.tx_===this.secondaryConn_&&this.rx_===this.secondaryConn_&&(this.log_("cleaning up and promoting a connection: "+this.secondaryConn_.connId),this.conn_=this.secondaryConn_,this.secondaryConn_=null)}onSecondaryControl_(e){if(ti in e){const t=e[ti];t===ur?this.upgradeIfSecondaryHealthy_():t===dr?(this.log_("Got a reset on secondary, closing it"),this.secondaryConn_.close(),(this.tx_===this.secondaryConn_||this.rx_===this.secondaryConn_)&&this.close()):t===hr&&(this.log_("got pong on secondary."),this.secondaryResponsesRequired_--,this.upgradeIfSecondaryHealthy_())}}onSecondaryMessageReceived_(e){const t=Ct("t",e),o=Ct("d",e);if(t==="c")this.onSecondaryControl_(o);else if(t==="d")this.pendingDataMessages.push(o);else throw new Error("Unknown protocol layer: "+t)}upgradeIfSecondaryHealthy_(){this.secondaryResponsesRequired_<=0?(this.log_("Secondary connection is healthy."),this.isHealthy_=!0,this.secondaryConn_.markConnectionHealthy(),this.proceedWithUpgrade_()):(this.log_("sending ping on secondary."),this.secondaryConn_.send({t:"c",d:{t:mr,d:{}}}))}proceedWithUpgrade_(){this.secondaryConn_.start(),this.log_("sending client ack on secondary"),this.secondaryConn_.send({t:"c",d:{t:ur,d:{}}}),this.log_("Ending transmission on primary"),this.conn_.send({t:"c",d:{t:pr,d:{}}}),this.tx_=this.secondaryConn_,this.tryCleanupConnection()}onPrimaryMessageReceived_(e){const t=Ct("t",e),o=Ct("d",e);t==="c"?this.onControl_(o):t==="d"&&this.onDataMessage_(o)}onDataMessage_(e){this.onPrimaryResponse_(),this.onMessage_(e)}onPrimaryResponse_(){this.isHealthy_||(this.primaryResponsesRequired_--,this.primaryResponsesRequired_<=0&&(this.log_("Primary connection is healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()))}onControl_(e){const t=Ct(ti,e);if(cr in e){const o=e[cr];if(t===S0){const i={...o};this.repoInfo_.isUsingEmulator&&(i.h=this.repoInfo_.host),this.onHandshake_(i)}else if(t===pr){this.log_("recvd end transmission on primary"),this.rx_=this.secondaryConn_;for(let i=0;i<this.pendingDataMessages.length;++i)this.onDataMessage_(this.pendingDataMessages[i]);this.pendingDataMessages=[],this.tryCleanupConnection()}else t===B0?this.onConnectionShutdown_(o):t===dr?this.onReset_(o):t===I0?yi("Server Error: "+o):t===hr?(this.log_("got pong on primary."),this.onPrimaryResponse_(),this.sendPingOnPrimaryIfNecessary_()):yi("Unknown control packet command: "+t)}}onHandshake_(e){const t=e.ts,o=e.v,i=e.h;this.sessionId=e.s,this.repoInfo_.host=i,this.state_===0&&(this.conn_.start(),this.onConnectionEstablished_(this.conn_,t),Ki!==o&&Ne("Protocol version mismatch detected"),this.tryStartUpgrade_())}tryStartUpgrade_(){const e=this.transportManager_.upgradeTransport();e&&this.startUpgrade_(e)}startUpgrade_(e){this.secondaryConn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,this.sessionId),this.secondaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const t=this.connReceiver_(this.secondaryConn_),o=this.disconnReceiver_(this.secondaryConn_);this.secondaryConn_.open(t,o),kt(()=>{this.secondaryConn_&&(this.log_("Timed out trying to upgrade."),this.secondaryConn_.close())},Math.floor(C0))}onReset_(e){this.log_("Reset packet received.  New host: "+e),this.repoInfo_.host=e,this.state_===1?this.close():(this.closeConnections_(),this.start_())}onConnectionEstablished_(e,t){this.log_("Realtime connection established."),this.conn_=e,this.state_=1,this.onReady_&&(this.onReady_(t,this.sessionId),this.onReady_=null),this.primaryResponsesRequired_===0?(this.log_("Primary connection is healthy."),this.isHealthy_=!0):kt(()=>{this.sendPingOnPrimaryIfNecessary_()},Math.floor(P0))}sendPingOnPrimaryIfNecessary_(){!this.isHealthy_&&this.state_===1&&(this.log_("sending ping on primary."),this.sendData_({t:"c",d:{t:mr,d:{}}}))}onSecondaryConnectionLost_(){const e=this.secondaryConn_;this.secondaryConn_=null,(this.tx_===e||this.rx_===e)&&this.close()}onConnectionLost_(e){this.conn_=null,!e&&this.state_===0?(this.log_("Realtime connection failed."),this.repoInfo_.isCacheableHost()&&(Hn.remove("host:"+this.repoInfo_.host),this.repoInfo_.internalHost=this.repoInfo_.host)):this.state_===1&&this.log_("Realtime connection lost."),this.close()}onConnectionShutdown_(e){this.log_("Connection shutdown command received. Shutting down..."),this.onKill_&&(this.onKill_(e),this.onKill_=null),this.onDisconnect_=null,this.close()}sendData_(e){if(this.state_!==1)throw"Connection is not connected";this.tx_.send(e)}close(){this.state_!==2&&(this.log_("Closing realtime connection."),this.state_=2,this.closeConnections_(),this.onDisconnect_&&(this.onDisconnect_(),this.onDisconnect_=null))}closeConnections_(){this.log_("Shutting down all connections"),this.conn_&&(this.conn_.close(),this.conn_=null),this.secondaryConn_&&(this.secondaryConn_.close(),this.secondaryConn_=null),this.healthyTimeout_&&(clearTimeout(this.healthyTimeout_),this.healthyTimeout_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zl{put(e,t,o,i){}merge(e,t,o,i){}refreshAuthToken(e){}refreshAppCheckToken(e){}onDisconnectPut(e,t,o){}onDisconnectMerge(e,t,o){}onDisconnectCancel(e,t){}reportStats(e){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class go extends Vl{static getInstance(){return new go}constructor(){super(["online"]),this.online_=!0,typeof window!="undefined"&&typeof window.addEventListener!="undefined"&&!cl()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return A(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fr=32,yr=768;class Q{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let o=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[o]=this.pieces_[i],o++);this.pieces_.length=o,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function K(){return new Q("")}function F(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function In(n){return n.pieces_.length-n.pieceNum_}function te(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new Q(n.pieces_,e)}function Yi(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function k0(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function Ht(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function Wl(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new Q(e,0)}function le(n,e){const t=[];for(let o=n.pieceNum_;o<n.pieces_.length;o++)t.push(n.pieces_[o]);if(e instanceof Q)for(let o=e.pieceNum_;o<e.pieces_.length;o++)t.push(e.pieces_[o]);else{const o=e.split("/");for(let i=0;i<o.length;i++)o[i].length>0&&t.push(o[i])}return new Q(t,0)}function H(n){return n.pieceNum_>=n.pieces_.length}function Re(n,e){const t=F(n),o=F(e);if(t===null)return e;if(t===o)return Re(te(n),te(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function D0(n,e){const t=Ht(n,0),o=Ht(e,0);for(let i=0;i<t.length&&i<o.length;i++){const s=Qn(t[i],o[i]);if(s!==0)return s}return t.length===o.length?0:t.length<o.length?-1:1}function qi(n,e){if(In(n)!==In(e))return!1;for(let t=n.pieceNum_,o=e.pieceNum_;t<=n.pieces_.length;t++,o++)if(n.pieces_[t]!==e.pieces_[o])return!1;return!0}function Ye(n,e){let t=n.pieceNum_,o=e.pieceNum_;if(In(n)>In(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[o])return!1;++t,++o}return!0}class T0{constructor(e,t){this.errorPrefix_=t,this.parts_=Ht(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let o=0;o<this.parts_.length;o++)this.byteLength_+=ko(this.parts_[o]);jl(this)}}function N0(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=ko(e),jl(n)}function M0(n){const e=n.parts_.pop();n.byteLength_-=ko(e),n.parts_.length>0&&(n.byteLength_-=1)}function jl(n){if(n.byteLength_>yr)throw new Error(n.errorPrefix_+"has a key path longer than "+yr+" bytes ("+n.byteLength_+").");if(n.parts_.length>fr)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+fr+") or object contains a cycle "+On(n))}function On(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Do{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const o=new z(Vn,e),i=new z(Vn,t);return this.compare(o,i)!==0}minPost(){return z.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let no;class Gl extends Do{static get __EMPTY_NODE(){return no}static set __EMPTY_NODE(e){no=e}compare(e,t){return Qn(e.name,t.name)}isDefinedOn(e){throw pt("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return z.MIN}maxPost(){return new z(Bn,no)}makePost(e,t){return A(typeof e=="string","KeyIndex indexValue must always be a string."),new z(e,no)}toString(){return".key"}}const zn=new Gl;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function H0(n,e){return Qn(n.name,e.name)}function $i(n,e){return Qn(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bi;function z0(n){bi=n}const Kl=function(n){return typeof n=="number"?"number:"+Ul(n):"string:"+n},Xl=function(n){if(n.isLeafNode()){const e=n.val();A(typeof e=="string"||typeof e=="number"||typeof e=="object"&&un(e,".sv"),"Priority must be a string or number.")}else A(n===bi||n.isEmpty(),"priority of unexpected type.");A(n===bi||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ar;class fe{static set __childrenNodeConstructor(e){Ar=e}static get __childrenNodeConstructor(){return Ar}constructor(e,t=fe.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,A(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),Xl(this.priorityNode_)}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new fe(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:fe.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return H(e)?this:F(e)===".priority"?this.priorityNode_:fe.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return e===".priority"?this.updatePriority(t):t.isEmpty()&&e!==".priority"?this:fe.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const o=F(e);return o===null?t:t.isEmpty()&&o!==".priority"?this:(A(o!==".priority"||In(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(o,fe.__childrenNodeConstructor.EMPTY_NODE.updateChild(te(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+Kl(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",t==="number"?e+=Ul(this.value_):e+=this.value_,this.lazyHash_=Cl(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===fe.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof fe.__childrenNodeConstructor?-1:(A(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,o=typeof this.value_,i=fe.VALUE_TYPE_ORDER.indexOf(t),s=fe.VALUE_TYPE_ORDER.indexOf(o);return A(i>=0,"Unknown leaf type: "+t),A(s>=0,"Unknown leaf type: "+o),i===s?o==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:s-i}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}else return!1}}fe.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ql,Yl;function V0(n){Ql=n}function W0(n){Yl=n}class j0 extends Do{compare(e,t){const o=e.node.getPriority(),i=t.node.getPriority(),s=o.compareTo(i);return s===0?Qn(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return z.MIN}maxPost(){return new z(Bn,new fe("[PRIORITY-POST]",Yl))}makePost(e,t){const o=Ql(e);return new z(t,new fe("[PRIORITY-POST]",o))}toString(){return".priority"}}const re=new j0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G0=Math.log(2);class K0{constructor(e){const t=s=>parseInt(Math.log(s)/G0,10),o=s=>parseInt(Array(s+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=o(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const bo=function(n,e,t,o){n.sort(e);const i=function(a,d){const u=d-a;let h,m;if(u===0)return null;if(u===1)return h=n[a],m=t?t(h):h,new ye(m,h.node,ye.BLACK,null,null);{const g=parseInt(u/2,10)+a,b=i(a,g),B=i(g+1,d);return h=n[g],m=t?t(h):h,new ye(m,h.node,ye.BLACK,b,B)}},s=function(a){let d=null,u=null,h=n.length;const m=function(b,B){const D=h-b,U=h;h-=b;const W=i(D+1,U),N=n[D],j=t?t(N):N;g(new ye(j,N.node,B,null,W))},g=function(b){d?(d.left=b,d=b):(u=b,d=b)};for(let b=0;b<a.count;++b){const B=a.nextBitIsOne(),D=Math.pow(2,a.count-(b+1));B?m(D,ye.BLACK):(m(D,ye.BLACK),m(D,ye.RED))}return u},r=new K0(n.length),l=s(r);return new xe(o||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let oi;const et={};class pn{static get Default(){return A(et&&re,"ChildrenNode.ts has not been loaded"),oi=oi||new pn({".priority":et},{".priority":re}),oi}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=rt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof xe?t:null}hasIndex(e){return un(this.indexSet_,e.toString())}addIndex(e,t){A(e!==zn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const o=[];let i=!1;const s=t.getIterator(z.Wrap);let r=s.getNext();for(;r;)i=i||e.isDefinedOn(r.node),o.push(r),r=s.getNext();let l;i?l=bo(o,e.getCompare()):l=et;const a=e.toString(),d={...this.indexSet_};d[a]=e;const u={...this.indexes_};return u[a]=l,new pn(u,d)}addToIndexes(e,t){const o=uo(this.indexes_,(i,s)=>{const r=rt(this.indexSet_,s);if(A(r,"Missing index implementation for "+s),i===et)if(r.isDefinedOn(e.node)){const l=[],a=t.getIterator(z.Wrap);let d=a.getNext();for(;d;)d.name!==e.name&&l.push(d),d=a.getNext();return l.push(e),bo(l,r.getCompare())}else return et;else{const l=t.get(e.name);let a=i;return l&&(a=a.remove(new z(e.name,l))),a.insert(e,e.node)}});return new pn(o,this.indexSet_)}removeFromIndexes(e,t){const o=uo(this.indexes_,i=>{if(i===et)return i;{const s=t.get(e.name);return s?i.remove(new z(e.name,s)):i}});return new pn(o,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q0=!0;function be(n,e=null){if(n===null)return M.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),A(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new fe(t,be(e))}if(!(n instanceof Array)&&Q0){const t=[];let o=!1;if(Ue(n,(r,l)=>{if(r.substring(0,1)!=="."){const a=be(l);a.isEmpty()||(o=o||!a.getPriority().isEmpty(),t.push(new z(r,a)))}}),t.length===0)return M.EMPTY_NODE;const s=bo(t,H0,r=>r.name,$i);if(o){const r=bo(t,re.getCompare());return new M(s,be(e),new pn({".priority":r},{".priority":re}))}else return new M(s,be(e),pn.Default)}else{let t=M.EMPTY_NODE;return Ue(n,(o,i)=>{if(un(n,o)&&o.substring(0,1)!=="."){const s=be(i);(s.isLeafNode()||!s.isEmpty())&&(t=t.updateImmediateChild(o,s))}}),t.updatePriority(be(e))}}V0(be);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zi extends Do{constructor(e){super(),this.indexPath_=e,A(!H(e)&&F(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const o=this.extractChild(e.node),i=this.extractChild(t.node),s=o.compareTo(i);return s===0?Qn(e.name,t.name):s}makePost(e,t){const o=be(e),i=M.EMPTY_NODE.updateChild(this.indexPath_,o);return new z(t,i)}maxPost(){const e=M.EMPTY_NODE.updateChild(this.indexPath_,Jt);return new z(Bn,e)}toString(){return Ht(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y0 extends Do{compare(e,t){const o=e.node.compareTo(t.node);return o===0?Qn(e.name,t.name):o}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return z.MIN}maxPost(){return z.MAX}makePost(e,t){const o=be(e);return new z(t,o)}toString(){return".value"}}const ql=new Y0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jl(n){return{type:"value",snapshotNode:n}}function lt(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function zt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Vt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function q0(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class es{constructor(e){this.index_=e}updateChild(e,t,o,i,s,r){A(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(t);return l.getChild(i).equals(o.getChild(i))&&l.isEmpty()===o.isEmpty()||(r!=null&&(o.isEmpty()?e.hasChild(t)?r.trackChildChange(zt(t,l)):A(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?r.trackChildChange(lt(t,o)):r.trackChildChange(Vt(t,o,l))),e.isLeafNode()&&o.isEmpty())?e:e.updateImmediateChild(t,o).withIndex(this.index_)}updateFullNode(e,t,o){return o!=null&&(e.isLeafNode()||e.forEachChild(re,(i,s)=>{t.hasChild(i)||o.trackChildChange(zt(i,s))}),t.isLeafNode()||t.forEachChild(re,(i,s)=>{if(e.hasChild(i)){const r=e.getImmediateChild(i);r.equals(s)||o.trackChildChange(Vt(i,s,r))}else o.trackChildChange(lt(i,s))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?M.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ns{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=re}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return A(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return A(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:Vn}hasEnd(){return this.endSet_}getIndexEndValue(){return A(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return A(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:Bn}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return A(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===re}copy(){const e=new ns;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function $0(n){return n.loadsAllData()?new es(n.getIndex()):n.hasLimit()?new J0(n):new Wt(n)}function Z0(n,e){const t=n.copy();return t.index_=e,t}function _r(n){const e={};if(n.isDefault())return e;let t;if(n.index_===re?t="$priority":n.index_===ql?t="$value":n.index_===zn?t="$key":(A(n.index_ instanceof Zi,"Unrecognized index type!"),t=n.index_.toString()),e.orderBy=Ae(t),n.startSet_){const o=n.startAfterSet_?"startAfter":"startAt";e[o]=Ae(n.indexStartValue_),n.startNameSet_&&(e[o]+=","+Ae(n.indexStartName_))}if(n.endSet_){const o=n.endBeforeSet_?"endBefore":"endAt";e[o]=Ae(n.indexEndValue_),n.endNameSet_&&(e[o]+=","+Ae(n.indexEndName_))}return n.limitSet_&&(n.isViewFromLeft()?e.limitToFirst=n.limit_:e.limitToLast=n.limit_),e}function vr(n){const e={};if(n.startSet_&&(e.sp=n.indexStartValue_,n.startNameSet_&&(e.sn=n.indexStartName_),e.sin=!n.startAfterSet_),n.endSet_&&(e.ep=n.indexEndValue_,n.endNameSet_&&(e.en=n.indexEndName_),e.ein=!n.endBeforeSet_),n.limitSet_){e.l=n.limit_;let t=n.viewFrom_;t===""&&(n.isViewFromLeft()?t="l":t="r"),e.vf=t}return n.index_!==re&&(e.i=n.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ao extends zl{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(A(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,t,o,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=o,this.appCheckTokenProvider_=i,this.log_=qt("p:rest:"),this.listens_={}}listen(e,t,o,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=Ao.getListenId_(e,o),l={};this.listens_[r]=l;const a=_r(e._queryParams);this.restRequest_(s+".json",a,(d,u)=>{let h=u;if(d===404&&(h=null,d=null),d===null&&this.onDataUpdate_(s,h,!1,o),rt(this.listens_,r)===l){let m;d?d===401?m="permission_denied":m="rest_error:"+d:m="ok",i(m,null)}})}unlisten(e,t){const o=Ao.getListenId_(e,t);delete this.listens_[o]}get(e){const t=_r(e._queryParams),o=e._path.toString(),i=new Xt;return this.restRequest_(o+".json",t,(s,r)=>{let l=r;s===404&&(l=null,s=null),s===null?(this.onDataUpdate_(o,l,!1,null),i.resolve(l)):i.reject(new Error(l))}),i.promise}refreshAuthToken(e){}restRequest_(e,t={},o){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Ed(t);this.log_("Sending REST request for "+r);const l=new XMLHttpRequest;l.onreadystatechange=()=>{if(o&&l.readyState===4){this.log_("REST Response for "+r+" received. status:",l.status,"response:",l.responseText);let a=null;if(l.status>=200&&l.status<300){try{a=xt(l.responseText)}catch(d){Ne("Failed to parse JSON response for "+r+": "+l.responseText)}o(null,a)}else l.status!==401&&l.status!==404&&Ne("Got unsuccessful REST response for "+r+" Status: "+l.status),o(l.status);o=null}},l.open("GET",r,!0),l.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _o(){return{value:null,children:new Map}}function $l(n,e,t){if(H(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const o=F(e);n.children.has(o)||n.children.set(o,_o());const i=n.children.get(o);e=te(e),$l(i,e,t)}}function Ai(n,e,t){n.value!==null?t(e,n.value):n2(n,(o,i)=>{const s=new Q(e.toString()+"/"+o);Ai(i,s,t)})}function n2(n,e){n.children.forEach((t,o)=>{e(o,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class t2{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t={...e};return this.last_&&Ue(this.last_,(o,i)=>{t[o]=t[o]-i}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cr=10*1e3,o2=30*1e3,i2=5*60*1e3;class s2{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new t2(e);const o=Cr+(o2-Cr)*Math.random();kt(this.reportStats_.bind(this),Math.floor(o))}reportStats_(){const e=this.statsListener_.get(),t={};let o=!1;Ue(e,(i,s)=>{s>0&&un(this.statsToReport_,i)&&(t[i]=s,o=!0)}),o&&this.server_.reportStats(t),kt(this.reportStats_.bind(this),Math.floor(Math.random()*2*i2))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var en;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(en||(en={}));function ts(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function os(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function is(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo{constructor(e,t,o){this.path=e,this.affectedTree=t,this.revert=o,this.type=en.ACK_USER_WRITE,this.source=ts()}operationForChild(e){if(H(this.path)){if(this.affectedTree.value!=null)return A(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Q(e));return new vo(K(),t,this.revert)}}else return A(F(this.path)===e,"operationForChild called for unrelated child."),new vo(te(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jt{constructor(e,t){this.source=e,this.path=t,this.type=en.LISTEN_COMPLETE}operationForChild(e){return H(this.path)?new jt(this.source,K()):new jt(this.source,te(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wn{constructor(e,t,o){this.source=e,this.path=t,this.snap=o,this.type=en.OVERWRITE}operationForChild(e){return H(this.path)?new Wn(this.source,K(),this.snap.getImmediateChild(e)):new Wn(this.source,te(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class at{constructor(e,t,o){this.source=e,this.path=t,this.children=o,this.type=en.MERGE}operationForChild(e){if(H(this.path)){const t=this.children.subtree(new Q(e));return t.isEmpty()?null:t.value?new Wn(this.source,K(),t.value):new at(this.source,K(),t)}else return A(F(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new at(this.source,te(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r2{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function l2(n,e,t,o){const i=[],s=[];return e.forEach(r=>{r.type==="child_changed"&&n.index_.indexedValueChanged(r.oldSnap,r.snapshotNode)&&s.push(q0(r.childName,r.snapshotNode))}),Et(n,i,"child_removed",e,o,t),Et(n,i,"child_added",e,o,t),Et(n,i,"child_moved",s,o,t),Et(n,i,"child_changed",e,o,t),Et(n,i,"value",e,o,t),i}function Et(n,e,t,o,i,s){const r=o.filter(l=>l.type===t);r.sort((l,a)=>c2(n,l,a)),r.forEach(l=>{const a=a2(n,l,s);i.forEach(d=>{d.respondsTo(l.type)&&e.push(d.createEvent(a,n.query_))})})}function a2(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function c2(n,e,t){if(e.childName==null||t.childName==null)throw pt("Should only compare child_ events.");const o=new z(e.childName,e.snapshotNode),i=new z(t.childName,t.snapshotNode);return n.index_.compare(o,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function To(n,e){return{eventCache:n,serverCache:e}}function Dt(n,e,t,o){return To(new jn(e,t,o),n.serverCache)}function Zl(n,e,t,o){return To(n.eventCache,new jn(e,t,o))}function _i(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Gn(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ii;const d2=()=>(ii||(ii=new xe(Y1)),ii);class ee{static fromObject(e){let t=new ee(null);return Ue(e,(o,i)=>{t=t.set(new Q(o),i)}),t}constructor(e,t=d2()){this.value=e,this.children=t}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(this.value!=null&&t(this.value))return{path:K(),value:this.value};if(H(e))return null;{const o=F(e),i=this.children.get(o);if(i!==null){const s=i.findRootMostMatchingPathAndValue(te(e),t);return s!=null?{path:le(new Q(o),s.path),value:s.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(H(e))return this;{const t=F(e),o=this.children.get(t);return o!==null?o.subtree(te(e)):new ee(null)}}set(e,t){if(H(e))return new ee(t,this.children);{const o=F(e),s=(this.children.get(o)||new ee(null)).set(te(e),t),r=this.children.insert(o,s);return new ee(this.value,r)}}remove(e){if(H(e))return this.children.isEmpty()?new ee(null):new ee(null,this.children);{const t=F(e),o=this.children.get(t);if(o){const i=o.remove(te(e));let s;return i.isEmpty()?s=this.children.remove(t):s=this.children.insert(t,i),this.value===null&&s.isEmpty()?new ee(null):new ee(this.value,s)}else return this}}get(e){if(H(e))return this.value;{const t=F(e),o=this.children.get(t);return o?o.get(te(e)):null}}setTree(e,t){if(H(e))return t;{const o=F(e),s=(this.children.get(o)||new ee(null)).setTree(te(e),t);let r;return s.isEmpty()?r=this.children.remove(o):r=this.children.insert(o,s),new ee(this.value,r)}}fold(e){return this.fold_(K(),e)}fold_(e,t){const o={};return this.children.inorderTraversal((i,s)=>{o[i]=s.fold_(le(e,i),t)}),t(e,this.value,o)}findOnPath(e,t){return this.findOnPath_(e,K(),t)}findOnPath_(e,t,o){const i=this.value?o(t,this.value):!1;if(i)return i;if(H(e))return null;{const s=F(e),r=this.children.get(s);return r?r.findOnPath_(te(e),le(t,s),o):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,K(),t)}foreachOnPath_(e,t,o){if(H(e))return this;{this.value&&o(t,this.value);const i=F(e),s=this.children.get(i);return s?s.foreachOnPath_(te(e),le(t,i),o):new ee(null)}}foreach(e){this.foreach_(K(),e)}foreach_(e,t){this.children.inorderTraversal((o,i)=>{i.foreach_(le(e,o),t)}),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal((t,o)=>{o.value&&e(t,o.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn{constructor(e){this.writeTree_=e}static empty(){return new nn(new ee(null))}}function Tt(n,e,t){if(H(e))return new nn(new ee(t));{const o=n.writeTree_.findRootMostValueAndPath(e);if(o!=null){const i=o.path;let s=o.value;const r=Re(i,e);return s=s.updateChild(r,t),new nn(n.writeTree_.set(i,s))}else{const i=new ee(t),s=n.writeTree_.setTree(e,i);return new nn(s)}}}function vi(n,e,t){let o=n;return Ue(t,(i,s)=>{o=Tt(o,le(e,i),s)}),o}function Pr(n,e){if(H(e))return nn.empty();{const t=n.writeTree_.setTree(e,new ee(null));return new nn(t)}}function Ci(n,e){return Yn(n,e)!=null}function Yn(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(Re(t.path,e)):null}function Ur(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(re,(o,i)=>{e.push(new z(o,i))}):n.writeTree_.children.inorderTraversal((o,i)=>{i.value!=null&&e.push(new z(o,i.value))}),e}function En(n,e){if(H(e))return n;{const t=Yn(n,e);return t!=null?new nn(new ee(t)):new nn(n.writeTree_.subtree(e))}}function Pi(n){return n.writeTree_.isEmpty()}function ct(n,e){return ea(K(),n.writeTree_,e)}function ea(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let o=null;return e.children.inorderTraversal((i,s)=>{i===".priority"?(A(s.value!==null,"Priority writes must always be leaf nodes"),o=s.value):t=ea(le(n,i),s,t)}),!t.getChild(n).isEmpty()&&o!==null&&(t=t.updateChild(le(n,".priority"),o)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ss(n,e){return ia(e,n)}function h2(n,e,t,o,i){A(o>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:o,visible:i}),i&&(n.visibleWrites=Tt(n.visibleWrites,e,t)),n.lastWriteId=o}function u2(n,e,t,o){A(o>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:o,visible:!0}),n.visibleWrites=vi(n.visibleWrites,e,t),n.lastWriteId=o}function p2(n,e){for(let t=0;t<n.allWrites.length;t++){const o=n.allWrites[t];if(o.writeId===e)return o}return null}function m2(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);A(t>=0,"removeWrite called with nonexistent writeId.");const o=n.allWrites[t];n.allWrites.splice(t,1);let i=o.visible,s=!1,r=n.allWrites.length-1;for(;i&&r>=0;){const l=n.allWrites[r];l.visible&&(r>=t&&f2(l,o.path)?i=!1:Ye(o.path,l.path)&&(s=!0)),r--}if(i){if(s)return y2(n),!0;if(o.snap)n.visibleWrites=Pr(n.visibleWrites,o.path);else{const l=o.children;Ue(l,a=>{n.visibleWrites=Pr(n.visibleWrites,le(o.path,a))})}return!0}else return!1}function f2(n,e){if(n.snap)return Ye(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Ye(le(n.path,t),e))return!0;return!1}function y2(n){n.visibleWrites=na(n.allWrites,g2,K()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function g2(n){return n.visible}function na(n,e,t){let o=nn.empty();for(let i=0;i<n.length;++i){const s=n[i];if(e(s)){const r=s.path;let l;if(s.snap)Ye(t,r)?(l=Re(t,r),o=Tt(o,l,s.snap)):Ye(r,t)&&(l=Re(r,t),o=Tt(o,K(),s.snap.getChild(l)));else if(s.children){if(Ye(t,r))l=Re(t,r),o=vi(o,l,s.children);else if(Ye(r,t))if(l=Re(r,t),H(l))o=vi(o,K(),s.children);else{const a=rt(s.children,F(l));if(a){const d=a.getChild(te(l));o=Tt(o,K(),d)}}}else throw pt("WriteRecord should have .snap or .children")}}return o}function ta(n,e,t,o,i){if(!o&&!i){const s=Yn(n.visibleWrites,e);if(s!=null)return s;{const r=En(n.visibleWrites,e);if(Pi(r))return t;if(t==null&&!Ci(r,K()))return null;{const l=t||M.EMPTY_NODE;return ct(r,l)}}}else{const s=En(n.visibleWrites,e);if(!i&&Pi(s))return t;if(!i&&t==null&&!Ci(s,K()))return null;{const r=function(d){return(d.visible||i)&&(!o||!~o.indexOf(d.writeId))&&(Ye(d.path,e)||Ye(e,d.path))},l=na(n.allWrites,r,e),a=t||M.EMPTY_NODE;return ct(l,a)}}}function b2(n,e,t){let o=M.EMPTY_NODE;const i=Yn(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(re,(s,r)=>{o=o.updateImmediateChild(s,r)}),o;if(t){const s=En(n.visibleWrites,e);return t.forEachChild(re,(r,l)=>{const a=ct(En(s,new Q(r)),l);o=o.updateImmediateChild(r,a)}),Ur(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}else{const s=En(n.visibleWrites,e);return Ur(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}}function A2(n,e,t,o,i){A(o||i,"Either existingEventSnap or existingServerSnap must exist");const s=le(e,t);if(Ci(n.visibleWrites,s))return null;{const r=En(n.visibleWrites,s);return Pi(r)?i.getChild(t):ct(r,i.getChild(t))}}function _2(n,e,t,o){const i=le(e,t),s=Yn(n.visibleWrites,i);if(s!=null)return s;if(o.isCompleteForChild(t)){const r=En(n.visibleWrites,i);return ct(r,o.getNode().getImmediateChild(t))}else return null}function v2(n,e){return Yn(n.visibleWrites,e)}function C2(n,e,t,o,i,s,r){let l;const a=En(n.visibleWrites,e),d=Yn(a,K());if(d!=null)l=d;else if(t!=null)l=ct(a,t);else return[];if(l=l.withIndex(r),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=r.getCompare(),m=s?l.getReverseIteratorFrom(o,r):l.getIteratorFrom(o,r);let g=m.getNext();for(;g&&u.length<i;)h(g,o)!==0&&u.push(g),g=m.getNext();return u}else return[]}function P2(){return{visibleWrites:nn.empty(),allWrites:[],lastWriteId:-1}}function Co(n,e,t,o){return ta(n.writeTree,n.treePath,e,t,o)}function rs(n,e){return b2(n.writeTree,n.treePath,e)}function Er(n,e,t,o){return A2(n.writeTree,n.treePath,e,t,o)}function Po(n,e){return v2(n.writeTree,le(n.treePath,e))}function U2(n,e,t,o,i,s){return C2(n.writeTree,n.treePath,e,t,o,i,s)}function ls(n,e,t){return _2(n.writeTree,n.treePath,e,t)}function oa(n,e){return ia(le(n.treePath,e),n.writeTree)}function ia(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class E2{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,o=e.childName;A(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),A(o!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(o);if(i){const s=i.type;if(t==="child_added"&&s==="child_removed")this.changeMap.set(o,Vt(o,e.snapshotNode,i.snapshotNode));else if(t==="child_removed"&&s==="child_added")this.changeMap.delete(o);else if(t==="child_removed"&&s==="child_changed")this.changeMap.set(o,zt(o,i.oldSnap));else if(t==="child_changed"&&s==="child_added")this.changeMap.set(o,lt(o,e.snapshotNode));else if(t==="child_changed"&&s==="child_changed")this.changeMap.set(o,Vt(o,e.snapshotNode,i.oldSnap));else throw pt("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(o,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class B2{getCompleteChild(e){return null}getChildAfterChild(e,t,o){return null}}const sa=new B2;class as{constructor(e,t,o=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=o}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const o=this.optCompleteServerCache_!=null?new jn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return ls(this.writes_,e,o)}}getChildAfterChild(e,t,o){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Gn(this.viewCache_),s=U2(this.writes_,i,t,1,o,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function I2(n){return{filter:n}}function S2(n,e){A(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),A(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function w2(n,e,t,o,i){const s=new E2;let r,l;if(t.type===en.OVERWRITE){const d=t;d.source.fromUser?r=Ui(n,e,d.path,d.snap,o,i,s):(A(d.source.fromServer,"Unknown source."),l=d.source.tagged||e.serverCache.isFiltered()&&!H(d.path),r=Uo(n,e,d.path,d.snap,o,i,l,s))}else if(t.type===en.MERGE){const d=t;d.source.fromUser?r=D2(n,e,d.path,d.children,o,i,s):(A(d.source.fromServer,"Unknown source."),l=d.source.tagged||e.serverCache.isFiltered(),r=Ei(n,e,d.path,d.children,o,i,l,s))}else if(t.type===en.ACK_USER_WRITE){const d=t;d.revert?r=M2(n,e,d.path,o,i,s):r=T2(n,e,d.path,d.affectedTree,o,i,s)}else if(t.type===en.LISTEN_COMPLETE)r=N2(n,e,t.path,o,s);else throw pt("Unknown operation type: "+t.type);const a=s.getChanges();return k2(e,r,a),{viewCache:r,changes:a}}function k2(n,e,t){const o=e.eventCache;if(o.isFullyInitialized()){const i=o.getNode().isLeafNode()||o.getNode().isEmpty(),s=_i(n);(t.length>0||!n.eventCache.isFullyInitialized()||i&&!o.getNode().equals(s)||!o.getNode().getPriority().equals(s.getPriority()))&&t.push(Jl(_i(e)))}}function ra(n,e,t,o,i,s){const r=e.eventCache;if(Po(o,t)!=null)return e;{let l,a;if(H(t))if(A(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const d=Gn(e),u=d instanceof M?d:M.EMPTY_NODE,h=rs(o,u);l=n.filter.updateFullNode(e.eventCache.getNode(),h,s)}else{const d=Co(o,Gn(e));l=n.filter.updateFullNode(e.eventCache.getNode(),d,s)}else{const d=F(t);if(d===".priority"){A(In(t)===1,"Can't have a priority with additional path components");const u=r.getNode();a=e.serverCache.getNode();const h=Er(o,t,u,a);h!=null?l=n.filter.updatePriority(u,h):l=r.getNode()}else{const u=te(t);let h;if(r.isCompleteForChild(d)){a=e.serverCache.getNode();const m=Er(o,t,r.getNode(),a);m!=null?h=r.getNode().getImmediateChild(d).updateChild(u,m):h=r.getNode().getImmediateChild(d)}else h=ls(o,d,e.serverCache);h!=null?l=n.filter.updateChild(r.getNode(),d,h,u,i,s):l=r.getNode()}}return Dt(e,l,r.isFullyInitialized()||H(t),n.filter.filtersNodes())}}function Uo(n,e,t,o,i,s,r,l){const a=e.serverCache;let d;const u=r?n.filter:n.filter.getIndexedFilter();if(H(t))d=u.updateFullNode(a.getNode(),o,null);else if(u.filtersNodes()&&!a.isFiltered()){const g=a.getNode().updateChild(t,o);d=u.updateFullNode(a.getNode(),g,null)}else{const g=F(t);if(!a.isCompleteForPath(t)&&In(t)>1)return e;const b=te(t),D=a.getNode().getImmediateChild(g).updateChild(b,o);g===".priority"?d=u.updatePriority(a.getNode(),D):d=u.updateChild(a.getNode(),g,D,b,sa,null)}const h=Zl(e,d,a.isFullyInitialized()||H(t),u.filtersNodes()),m=new as(i,h,s);return ra(n,h,t,i,m,l)}function Ui(n,e,t,o,i,s,r){const l=e.eventCache;let a,d;const u=new as(i,e,s);if(H(t))d=n.filter.updateFullNode(e.eventCache.getNode(),o,r),a=Dt(e,d,!0,n.filter.filtersNodes());else{const h=F(t);if(h===".priority")d=n.filter.updatePriority(e.eventCache.getNode(),o),a=Dt(e,d,l.isFullyInitialized(),l.isFiltered());else{const m=te(t),g=l.getNode().getImmediateChild(h);let b;if(H(m))b=o;else{const B=u.getCompleteChild(h);B!=null?Yi(m)===".priority"&&B.getChild(Wl(m)).isEmpty()?b=B:b=B.updateChild(m,o):b=M.EMPTY_NODE}if(g.equals(b))a=e;else{const B=n.filter.updateChild(l.getNode(),h,b,m,u,r);a=Dt(e,B,l.isFullyInitialized(),n.filter.filtersNodes())}}}return a}function Br(n,e){return n.eventCache.isCompleteForChild(e)}function D2(n,e,t,o,i,s,r){let l=e;return o.foreach((a,d)=>{const u=le(t,a);Br(e,F(u))&&(l=Ui(n,l,u,d,i,s,r))}),o.foreach((a,d)=>{const u=le(t,a);Br(e,F(u))||(l=Ui(n,l,u,d,i,s,r))}),l}function Ir(n,e,t){return t.foreach((o,i)=>{e=e.updateChild(o,i)}),e}function Ei(n,e,t,o,i,s,r,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let a=e,d;H(t)?d=o:d=new ee(null).setTree(t,o);const u=e.serverCache.getNode();return d.children.inorderTraversal((h,m)=>{if(u.hasChild(h)){const g=e.serverCache.getNode().getImmediateChild(h),b=Ir(n,g,m);a=Uo(n,a,new Q(h),b,i,s,r,l)}}),d.children.inorderTraversal((h,m)=>{const g=!e.serverCache.isCompleteForChild(h)&&m.value===null;if(!u.hasChild(h)&&!g){const b=e.serverCache.getNode().getImmediateChild(h),B=Ir(n,b,m);a=Uo(n,a,new Q(h),B,i,s,r,l)}}),a}function T2(n,e,t,o,i,s,r){if(Po(i,t)!=null)return e;const l=e.serverCache.isFiltered(),a=e.serverCache;if(o.value!=null){if(H(t)&&a.isFullyInitialized()||a.isCompleteForPath(t))return Uo(n,e,t,a.getNode().getChild(t),i,s,l,r);if(H(t)){let d=new ee(null);return a.getNode().forEachChild(zn,(u,h)=>{d=d.set(new Q(u),h)}),Ei(n,e,t,d,i,s,l,r)}else return e}else{let d=new ee(null);return o.foreach((u,h)=>{const m=le(t,u);a.isCompleteForPath(m)&&(d=d.set(u,a.getNode().getChild(m)))}),Ei(n,e,t,d,i,s,l,r)}}function N2(n,e,t,o,i){const s=e.serverCache,r=Zl(e,s.getNode(),s.isFullyInitialized()||H(t),s.isFiltered());return ra(n,r,t,o,sa,i)}function M2(n,e,t,o,i,s){let r;if(Po(o,t)!=null)return e;{const l=new as(o,e,i),a=e.eventCache.getNode();let d;if(H(t)||F(t)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Co(o,Gn(e));else{const h=e.serverCache.getNode();A(h instanceof M,"serverChildren would be complete if leaf node"),u=rs(o,h)}u=u,d=n.filter.updateFullNode(a,u,s)}else{const u=F(t);let h=ls(o,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=a.getImmediateChild(u)),h!=null?d=n.filter.updateChild(a,u,h,te(t),l,s):e.eventCache.getNode().hasChild(u)?d=n.filter.updateChild(a,u,M.EMPTY_NODE,te(t),l,s):d=a,d.isEmpty()&&e.serverCache.isFullyInitialized()&&(r=Co(o,Gn(e)),r.isLeafNode()&&(d=n.filter.updateFullNode(d,r,s)))}return r=e.serverCache.isFullyInitialized()||Po(o,K())!=null,Dt(e,d,r,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class R2{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const o=this.query_._queryParams,i=new es(o.getIndex()),s=$0(o);this.processor_=I2(s);const r=t.serverCache,l=t.eventCache,a=i.updateFullNode(M.EMPTY_NODE,r.getNode(),null),d=s.updateFullNode(M.EMPTY_NODE,l.getNode(),null),u=new jn(a,r.isFullyInitialized(),i.filtersNodes()),h=new jn(d,l.isFullyInitialized(),s.filtersNodes());this.viewCache_=To(h,u),this.eventGenerator_=new r2(this.query_)}get query(){return this.query_}}function x2(n){return n.viewCache_.serverCache.getNode()}function O2(n,e){const t=Gn(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!H(e)&&!t.getImmediateChild(F(e)).isEmpty())?t.getChild(e):null}function Sr(n){return n.eventRegistrations_.length===0}function L2(n,e){n.eventRegistrations_.push(e)}function wr(n,e,t){const o=[];if(t){A(e==null,"A cancel should cancel all event registrations.");const i=n.query._path;n.eventRegistrations_.forEach(s=>{const r=s.createCancelEvent(t,i);r&&o.push(r)})}if(e){let i=[];for(let s=0;s<n.eventRegistrations_.length;++s){const r=n.eventRegistrations_[s];if(!r.matches(e))i.push(r);else if(e.hasAnyCallback()){i=i.concat(n.eventRegistrations_.slice(s+1));break}}n.eventRegistrations_=i}else n.eventRegistrations_=[];return o}function kr(n,e,t,o){e.type===en.MERGE&&e.source.queryId!==null&&(A(Gn(n.viewCache_),"We should always have a full cache before handling merges"),A(_i(n.viewCache_),"Missing event cache, even though we have a server cache"));const i=n.viewCache_,s=w2(n.processor_,i,e,t,o);return S2(n.processor_,s.viewCache),A(s.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=s.viewCache,la(n,s.changes,s.viewCache.eventCache.getNode(),null)}function F2(n,e){const t=n.viewCache_.eventCache,o=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(re,(s,r)=>{o.push(lt(s,r))}),t.isFullyInitialized()&&o.push(Jl(t.getNode())),la(n,o,t.getNode(),e)}function la(n,e,t,o){const i=o?[o]:n.eventRegistrations_;return l2(n.eventGenerator_,e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Eo;class H2{constructor(){this.views=new Map}}function z2(n){A(!Eo,"__referenceConstructor has already been defined"),Eo=n}function V2(){return A(Eo,"Reference.ts has not been loaded"),Eo}function W2(n){return n.views.size===0}function cs(n,e,t,o){const i=e.source.queryId;if(i!==null){const s=n.views.get(i);return A(s!=null,"SyncTree gave us an op for an invalid query."),kr(s,e,t,o)}else{let s=[];for(const r of n.views.values())s=s.concat(kr(r,e,t,o));return s}}function j2(n,e,t,o,i){const s=e._queryIdentifier,r=n.views.get(s);if(!r){let l=Co(t,i?o:null),a=!1;l?a=!0:o instanceof M?(l=rs(t,o),a=!1):(l=M.EMPTY_NODE,a=!1);const d=To(new jn(l,a,!1),new jn(o,i,!1));return new R2(e,d)}return r}function G2(n,e,t,o,i,s){const r=j2(n,e,o,i,s);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,r),L2(r,t),F2(r,t)}function K2(n,e,t,o){const i=e._queryIdentifier,s=[];let r=[];const l=Sn(n);if(i==="default")for(const[a,d]of n.views.entries())r=r.concat(wr(d,t,o)),Sr(d)&&(n.views.delete(a),d.query._queryParams.loadsAllData()||s.push(d.query));else{const a=n.views.get(i);a&&(r=r.concat(wr(a,t,o)),Sr(a)&&(n.views.delete(i),a.query._queryParams.loadsAllData()||s.push(a.query)))}return l&&!Sn(n)&&s.push(new(V2())(e._repo,e._path)),{removed:s,events:r}}function aa(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function st(n,e){let t=null;for(const o of n.views.values())t=t||O2(o,e);return t}function ca(n,e){if(e._queryParams.loadsAllData())return No(n);{const o=e._queryIdentifier;return n.views.get(o)}}function da(n,e){return ca(n,e)!=null}function Sn(n){return No(n)!=null}function No(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Bo;function X2(n){A(!Bo,"__referenceConstructor has already been defined"),Bo=n}function Q2(){return A(Bo,"Reference.ts has not been loaded"),Bo}let Y2=1;class Dr{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ee(null),this.pendingWriteTree_=P2(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ha(n,e,t,o,i){return h2(n.pendingWriteTree_,e,t,o,i),i?ft(n,new Wn(ts(),e,t)):[]}function q2(n,e,t,o){u2(n.pendingWriteTree_,e,t,o);const i=ee.fromObject(t);return ft(n,new at(ts(),e,i))}function Cn(n,e,t=!1){const o=p2(n.pendingWriteTree_,e);if(m2(n.pendingWriteTree_,e)){let s=new ee(null);return o.snap!=null?s=s.set(K(),!0):Ue(o.children,r=>{s=s.set(new Q(r),!0)}),ft(n,new vo(o.path,s,t))}else return[]}function Mo(n,e,t){return ft(n,new Wn(os(),e,t))}function J2(n,e,t){const o=ee.fromObject(t);return ft(n,new at(os(),e,o))}function $2(n,e){return ft(n,new jt(os(),e))}function Z2(n,e,t){const o=hs(n,t);if(o){const i=us(o),s=i.path,r=i.queryId,l=Re(s,e),a=new jt(is(r),l);return ps(n,s,a)}else return[]}function Bi(n,e,t,o,i=!1){const s=e._path,r=n.syncPointTree_.get(s);let l=[];if(r&&(e._queryIdentifier==="default"||da(r,e))){const a=K2(r,e,t,o);W2(r)&&(n.syncPointTree_=n.syncPointTree_.remove(s));const d=a.removed;if(l=a.events,!i){const u=d.findIndex(m=>m._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(s,(m,g)=>Sn(g));if(u&&!h){const m=n.syncPointTree_.subtree(s);if(!m.isEmpty()){const g=th(m);for(let b=0;b<g.length;++b){const B=g[b],D=B.query,U=ma(n,B);n.listenProvider_.startListening(Nt(D),Io(n,D),U.hashFn,U.onComplete)}}}!h&&d.length>0&&!o&&(u?n.listenProvider_.stopListening(Nt(e),null):d.forEach(m=>{const g=n.queryToTagMap.get(Ro(m));n.listenProvider_.stopListening(Nt(m),g)}))}oh(n,d)}return l}function eh(n,e,t,o){const i=hs(n,o);if(i!=null){const s=us(i),r=s.path,l=s.queryId,a=Re(r,e),d=new Wn(is(l),a,t);return ps(n,r,d)}else return[]}function nh(n,e,t,o){const i=hs(n,o);if(i){const s=us(i),r=s.path,l=s.queryId,a=Re(r,e),d=ee.fromObject(t),u=new at(is(l),a,d);return ps(n,r,u)}else return[]}function Tr(n,e,t,o=!1){const i=e._path;let s=null,r=!1;n.syncPointTree_.foreachOnPath(i,(m,g)=>{const b=Re(m,i);s=s||st(g,b),r=r||Sn(g)});let l=n.syncPointTree_.get(i);l?(r=r||Sn(l),s=s||st(l,K())):(l=new H2,n.syncPointTree_=n.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=M.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((g,b)=>{const B=st(b,K());B&&(s=s.updateImmediateChild(g,B))}));const d=da(l,e);if(!d&&!e._queryParams.loadsAllData()){const m=Ro(e);A(!n.queryToTagMap.has(m),"View does not exist, but we have a tag");const g=ih();n.queryToTagMap.set(m,g),n.tagToQueryMap.set(g,m)}const u=ss(n.pendingWriteTree_,i);let h=G2(l,e,t,u,s,a);if(!d&&!r&&!o){const m=ca(l,e);h=h.concat(sh(n,e,m))}return h}function ds(n,e,t){const i=n.pendingWriteTree_,s=n.syncPointTree_.findOnPath(e,(r,l)=>{const a=Re(r,e),d=st(l,a);if(d)return d});return ta(i,e,s,t,!0)}function ft(n,e){return ua(e,n.syncPointTree_,null,ss(n.pendingWriteTree_,K()))}function ua(n,e,t,o){if(H(n.path))return pa(n,e,t,o);{const i=e.get(K());t==null&&i!=null&&(t=st(i,K()));let s=[];const r=F(n.path),l=n.operationForChild(r),a=e.children.get(r);if(a&&l){const d=t?t.getImmediateChild(r):null,u=oa(o,r);s=s.concat(ua(l,a,d,u))}return i&&(s=s.concat(cs(i,n,o,t))),s}}function pa(n,e,t,o){const i=e.get(K());t==null&&i!=null&&(t=st(i,K()));let s=[];return e.children.inorderTraversal((r,l)=>{const a=t?t.getImmediateChild(r):null,d=oa(o,r),u=n.operationForChild(r);u&&(s=s.concat(pa(u,l,a,d)))}),i&&(s=s.concat(cs(i,n,o,t))),s}function ma(n,e){const t=e.query,o=Io(n,t);return{hashFn:()=>(x2(e)||M.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return o?Z2(n,t._path,o):$2(n,t._path);{const s=$1(i,t);return Bi(n,t,null,s)}}}}function Io(n,e){const t=Ro(e);return n.queryToTagMap.get(t)}function Ro(n){return n._path.toString()+"$"+n._queryIdentifier}function hs(n,e){return n.tagToQueryMap.get(e)}function us(n){const e=n.indexOf("$");return A(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new Q(n.substr(0,e))}}function ps(n,e,t){const o=n.syncPointTree_.get(e);A(o,"Missing sync point for query tag that we're tracking");const i=ss(n.pendingWriteTree_,e);return cs(o,t,i,null)}function th(n){return n.fold((e,t,o)=>{if(t&&Sn(t))return[No(t)];{let i=[];return t&&(i=aa(t)),Ue(o,(s,r)=>{i=i.concat(r)}),i}})}function Nt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Q2())(n._repo,n._path):n}function oh(n,e){for(let t=0;t<e.length;++t){const o=e[t];if(!o._queryParams.loadsAllData()){const i=Ro(o),s=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(s)}}}function ih(){return Y2++}function sh(n,e,t){const o=e._path,i=Io(n,e),s=ma(n,t),r=n.listenProvider_.startListening(Nt(e),i,s.hashFn,s.onComplete),l=n.syncPointTree_.subtree(o);if(i)A(!Sn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((d,u,h)=>{if(!H(d)&&u&&Sn(u))return[No(u).query];{let m=[];return u&&(m=m.concat(aa(u).map(g=>g.query))),Ue(h,(g,b)=>{m=m.concat(b)}),m}});for(let d=0;d<a.length;++d){const u=a[d];n.listenProvider_.stopListening(Nt(u),Io(n,u))}}return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ms{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new ms(t)}node(){return this.node_}}class fs{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=le(this.path_,e);return new fs(this.syncTree_,t)}node(){return ds(this.syncTree_,this.path_)}}const rh=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},Nr=function(n,e,t){if(!n||typeof n!="object")return n;if(A(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return lh(n[".sv"],e,t);if(typeof n[".sv"]=="object")return ah(n[".sv"],e);A(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},lh=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:A(!1,"Unexpected server value: "+n)}},ah=function(n,e,t){n.hasOwnProperty("increment")||A(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const o=n.increment;typeof o!="number"&&A(!1,"Unexpected increment value: "+o);const i=e.node();if(A(i!==null&&typeof i!="undefined","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return o;const r=i.getValue();return typeof r!="number"?o:r+o},fa=function(n,e,t,o){return ys(e,new fs(t,n),o)},ya=function(n,e,t){return ys(n,new ms(e),t)};function ys(n,e,t){const o=n.getPriority().val(),i=Nr(o,e.getImmediateChild(".priority"),t);let s;if(n.isLeafNode()){const r=n,l=Nr(r.getValue(),e,t);return l!==r.getValue()||i!==r.getPriority().val()?new fe(l,be(i)):n}else{const r=n;return s=r,i!==r.getPriority().val()&&(s=s.updatePriority(new fe(i))),r.forEachChild(re,(l,a)=>{const d=ys(a,e.getImmediateChild(l),t);d!==a&&(s=s.updateImmediateChild(l,d))}),s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gs{constructor(e="",t=null,o={children:{},childCount:0}){this.name=e,this.parent=t,this.node=o}}function bs(n,e){let t=e instanceof Q?e:new Q(e),o=n,i=F(t);for(;i!==null;){const s=rt(o.node.children,i)||{children:{},childCount:0};o=new gs(i,o,s),t=te(t),i=F(t)}return o}function yt(n){return n.node.value}function ga(n,e){n.node.value=e,Ii(n)}function ba(n){return n.node.childCount>0}function ch(n){return yt(n)===void 0&&!ba(n)}function xo(n,e){Ue(n.node.children,(t,o)=>{e(new gs(t,n,o))})}function Aa(n,e,t,o){t&&!o&&e(n),xo(n,i=>{Aa(i,e,!0,o)}),t&&o&&e(n)}function dh(n,e,t){let o=n.parent;for(;o!==null;){if(e(o))return!0;o=o.parent}return!1}function $t(n){return new Q(n.parent===null?n.name:$t(n.parent)+"/"+n.name)}function Ii(n){n.parent!==null&&hh(n.parent,n.name,n)}function hh(n,e,t){const o=ch(t),i=un(n.node.children,e);o&&i?(delete n.node.children[e],n.node.childCount--,Ii(n)):!o&&!i&&(n.node.children[e]=t.node,n.node.childCount++,Ii(n))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uh=/[\[\].#$\/\u0000-\u001F\u007F]/,ph=/[\[\].#$\u0000-\u001F\u007F]/,si=10*1024*1024,As=function(n){return typeof n=="string"&&n.length!==0&&!uh.test(n)},_a=function(n){return typeof n=="string"&&n.length!==0&&!ph.test(n)},mh=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),_a(n)},Si=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!ji(n)||n&&typeof n=="object"&&un(n,".sv")},va=function(n,e,t,o){o&&e===void 0||Oo(wo(n,"value"),e,t)},Oo=function(n,e,t){const o=t instanceof Q?new T0(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+On(o));if(typeof e=="function")throw new Error(n+"contains a function "+On(o)+" with contents = "+e.toString());if(ji(e))throw new Error(n+"contains "+e.toString()+" "+On(o));if(typeof e=="string"&&e.length>si/3&&ko(e)>si)throw new Error(n+"contains a string greater than "+si+" utf8 bytes "+On(o)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,s=!1;if(Ue(e,(r,l)=>{if(r===".value")i=!0;else if(r!==".priority"&&r!==".sv"&&(s=!0,!As(r)))throw new Error(n+" contains an invalid key ("+r+") "+On(o)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);N0(o,r),Oo(n,l,o),M0(o)}),i&&s)throw new Error(n+' contains ".value" child '+On(o)+" in addition to actual children.")}},fh=function(n,e){let t,o;for(t=0;t<e.length;t++){o=e[t];const s=Ht(o);for(let r=0;r<s.length;r++)if(!(s[r]===".priority"&&r===s.length-1)){if(!As(s[r]))throw new Error(n+"contains an invalid key ("+s[r]+") in path "+o.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(D0);let i=null;for(t=0;t<e.length;t++){if(o=e[t],i!==null&&Ye(i,o))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+o.toString());i=o}},yh=function(n,e,t,o){const i=wo(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const s=[];Ue(e,(r,l)=>{const a=new Q(r);if(Oo(i,l,le(t,a)),Yi(a)===".priority"&&!Si(l))throw new Error(i+"contains an invalid value for '"+a.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");s.push(a)}),fh(i,s)},_s=function(n,e,t,o){if(!_a(t))throw new Error(wo(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},gh=function(n,e,t,o){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),_s(n,e,t)},vs=function(n,e){if(F(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},bh=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!As(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!mh(t))throw new Error(wo(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ah{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Lo(n,e){let t=null;for(let o=0;o<e.length;o++){const i=e[o],s=i.getPath();t!==null&&!qi(s,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:s}),t.events.push(i)}t&&n.eventLists_.push(t)}function Ca(n,e,t){Lo(n,t),Pa(n,o=>qi(o,e))}function tn(n,e,t){Lo(n,t),Pa(n,o=>Ye(o,e)||Ye(e,o))}function Pa(n,e){n.recursionDepth_++;let t=!0;for(let o=0;o<n.eventLists_.length;o++){const i=n.eventLists_[o];if(i){const s=i.path;e(s)?(_h(n.eventLists_[o]),n.eventLists_[o]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function _h(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const o=t.getEventRunner();wt&&Pe("event: "+t.toString()),mt(o)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vh="repo_interrupt",Ch=25;class Ph{constructor(e,t,o,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=o,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Ah,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=_o(),this.transactionQueueTree_=new gs,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Uh(n,e,t){if(n.stats_=Xi(n.repoInfo_),n.forceRestClient_||t0())n.server_=new Ao(n.repoInfo_,(o,i,s,r)=>{Mr(n,o,i,s,r)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Rr(n,!0),0);else{if(typeof t!="undefined"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ae(t)}catch(o){throw new Error("Invalid authOverride provided: "+o)}}n.persistentConnection_=new mn(n.repoInfo_,e,(o,i,s,r)=>{Mr(n,o,i,s,r)},o=>{Rr(n,o)},o=>{Eh(n,o)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(o=>{n.server_.refreshAuthToken(o)}),n.appCheckProvider_.addTokenChangeListener(o=>{n.server_.refreshAppCheckToken(o.token)}),n.statsReporter_=l0(n.repoInfo_,()=>new s2(n.stats_,n.server_)),n.infoData_=new e2,n.infoSyncTree_=new Dr({startListening:(o,i,s,r)=>{let l=[];const a=n.infoData_.getNode(o._path);return a.isEmpty()||(l=Mo(n.infoSyncTree_,o._path,a),setTimeout(()=>{r("ok")},0)),l},stopListening:()=>{}}),Cs(n,"connected",!1),n.serverSyncTree_=new Dr({startListening:(o,i,s,r)=>(n.server_.listen(o,s,i,(l,a)=>{const d=r(l,a);tn(n.eventQueue_,o._path,d)}),[]),stopListening:(o,i)=>{n.server_.unlisten(o,i)}})}function Ua(n){const t=n.infoData_.getNode(new Q(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Fo(n){return rh({timestamp:Ua(n)})}function Mr(n,e,t,o,i){n.dataUpdateCount++;const s=new Q(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let r=[];if(i)if(o){const a=uo(t,d=>be(d));r=nh(n.serverSyncTree_,s,a,i)}else{const a=be(t);r=eh(n.serverSyncTree_,s,a,i)}else if(o){const a=uo(t,d=>be(d));r=J2(n.serverSyncTree_,s,a)}else{const a=be(t);r=Mo(n.serverSyncTree_,s,a)}let l=s;r.length>0&&(l=dt(n,s)),tn(n.eventQueue_,l,r)}function Rr(n,e){Cs(n,"connected",e),e===!1&&Sh(n)}function Eh(n,e){Ue(e,(t,o)=>{Cs(n,t,o)})}function Cs(n,e,t){const o=new Q("/.info/"+e),i=be(t);n.infoData_.updateSnapshot(o,i);const s=Mo(n.infoSyncTree_,o,i);tn(n.eventQueue_,o,s)}function Ps(n){return n.nextWriteId_++}function Bh(n,e,t,o,i){Ho(n,"set",{path:e.toString(),value:t,priority:o});const s=Fo(n),r=be(t,o),l=ds(n.serverSyncTree_,e),a=ya(r,l,s),d=Ps(n),u=ha(n.serverSyncTree_,e,a,d,!0);Lo(n.eventQueue_,u),n.server_.put(e.toString(),r.val(!0),(m,g)=>{const b=m==="ok";b||Ne("set at "+e+" failed: "+m);const B=Cn(n.serverSyncTree_,d,!b);tn(n.eventQueue_,e,B),ki(n,i,m,g)});const h=Es(n,e);dt(n,h),tn(n.eventQueue_,h,[])}function Ih(n,e,t,o){Ho(n,"update",{path:e.toString(),value:t});let i=!0;const s=Fo(n),r={};if(Ue(t,(l,a)=>{i=!1,r[l]=fa(le(e,l),be(a),n.serverSyncTree_,s)}),i)Pe("update() called with empty data.  Don't do anything."),ki(n,o,"ok",void 0);else{const l=Ps(n),a=q2(n.serverSyncTree_,e,r,l);Lo(n.eventQueue_,a),n.server_.merge(e.toString(),t,(d,u)=>{const h=d==="ok";h||Ne("update at "+e+" failed: "+d);const m=Cn(n.serverSyncTree_,l,!h),g=m.length>0?dt(n,e):e;tn(n.eventQueue_,g,m),ki(n,o,d,u)}),Ue(t,d=>{const u=Es(n,le(e,d));dt(n,u)}),tn(n.eventQueue_,e,[])}}function Sh(n){Ho(n,"onDisconnectEvents");const e=Fo(n),t=_o();Ai(n.onDisconnect_,K(),(i,s)=>{const r=fa(i,s,n.serverSyncTree_,e);$l(t,i,r)});let o=[];Ai(t,K(),(i,s)=>{o=o.concat(Mo(n.serverSyncTree_,i,s));const r=Es(n,i);dt(n,r)}),n.onDisconnect_=_o(),tn(n.eventQueue_,K(),o)}function wh(n,e,t){let o;F(e._path)===".info"?o=Tr(n.infoSyncTree_,e,t):o=Tr(n.serverSyncTree_,e,t),Ca(n.eventQueue_,e._path,o)}function wi(n,e,t){let o;F(e._path)===".info"?o=Bi(n.infoSyncTree_,e,t):o=Bi(n.serverSyncTree_,e,t),Ca(n.eventQueue_,e._path,o)}function kh(n){n.persistentConnection_&&n.persistentConnection_.interrupt(vh)}function Ho(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),Pe(t,...e)}function ki(n,e,t,o){e&&mt(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let s=i;o&&(s+=": "+o);const r=new Error(s);r.code=i,e(r)}})}function Ea(n,e,t){return ds(n.serverSyncTree_,e,t)||M.EMPTY_NODE}function Us(n,e=n.transactionQueueTree_){if(e||zo(n,e),yt(e)){const t=Ia(n,e);A(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&Dh(n,$t(e),t)}else ba(e)&&xo(e,t=>{Us(n,t)})}function Dh(n,e,t){const o=t.map(d=>d.currentWriteId),i=Ea(n,e,o);let s=i;const r=i.hash();for(let d=0;d<t.length;d++){const u=t[d];A(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=Re(e,u.path);s=s.updateChild(h,u.currentOutputSnapshotRaw)}const l=s.val(!0),a=e;n.server_.put(a.toString(),l,d=>{Ho(n,"transaction put response",{path:a.toString(),status:d});let u=[];if(d==="ok"){const h=[];for(let m=0;m<t.length;m++)t[m].status=2,u=u.concat(Cn(n.serverSyncTree_,t[m].currentWriteId)),t[m].onComplete&&h.push(()=>t[m].onComplete(null,!0,t[m].currentOutputSnapshotResolved)),t[m].unwatcher();zo(n,bs(n.transactionQueueTree_,e)),Us(n,n.transactionQueueTree_),tn(n.eventQueue_,e,u);for(let m=0;m<h.length;m++)mt(h[m])}else{if(d==="datastale")for(let h=0;h<t.length;h++)t[h].status===3?t[h].status=4:t[h].status=0;else{Ne("transaction at "+a.toString()+" failed: "+d);for(let h=0;h<t.length;h++)t[h].status=4,t[h].abortReason=d}dt(n,e)}},r)}function dt(n,e){const t=Ba(n,e),o=$t(t),i=Ia(n,t);return Th(n,i,o),o}function Th(n,e,t){if(e.length===0)return;const o=[];let i=[];const r=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],d=Re(t,a.path);let u=!1,h;if(A(d!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)u=!0,h=a.abortReason,i=i.concat(Cn(n.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=Ch)u=!0,h="maxretry",i=i.concat(Cn(n.serverSyncTree_,a.currentWriteId,!0));else{const m=Ea(n,a.path,r);a.currentInputSnapshot=m;const g=e[l].update(m.val());if(g!==void 0){Oo("transaction failed: Data returned ",g,a.path);let b=be(g);typeof g=="object"&&g!=null&&un(g,".priority")||(b=b.updatePriority(m.getPriority()));const D=a.currentWriteId,U=Fo(n),W=ya(b,m,U);a.currentOutputSnapshotRaw=b,a.currentOutputSnapshotResolved=W,a.currentWriteId=Ps(n),r.splice(r.indexOf(D),1),i=i.concat(ha(n.serverSyncTree_,a.path,W,a.currentWriteId,a.applyLocally)),i=i.concat(Cn(n.serverSyncTree_,D,!0))}else u=!0,h="nodata",i=i.concat(Cn(n.serverSyncTree_,a.currentWriteId,!0))}tn(n.eventQueue_,t,i),i=[],u&&(e[l].status=2,function(m){setTimeout(m,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(h==="nodata"?o.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):o.push(()=>e[l].onComplete(new Error(h),!1,null))))}zo(n,n.transactionQueueTree_);for(let l=0;l<o.length;l++)mt(o[l]);Us(n,n.transactionQueueTree_)}function Ba(n,e){let t,o=n.transactionQueueTree_;for(t=F(e);t!==null&&yt(o)===void 0;)o=bs(o,t),e=te(e),t=F(e);return o}function Ia(n,e){const t=[];return Sa(n,e,t),t.sort((o,i)=>o.order-i.order),t}function Sa(n,e,t){const o=yt(e);if(o)for(let i=0;i<o.length;i++)t.push(o[i]);xo(e,i=>{Sa(n,i,t)})}function zo(n,e){const t=yt(e);if(t){let o=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[o]=t[i],o++);t.length=o,ga(e,t.length>0?t:void 0)}xo(e,o=>{zo(n,o)})}function Es(n,e){const t=$t(Ba(n,e)),o=bs(n.transactionQueueTree_,e);return dh(o,i=>{ri(n,i)}),ri(n,o),Aa(o,i=>{ri(n,i)}),t}function ri(n,e){const t=yt(e);if(t){const o=[];let i=[],s=-1;for(let r=0;r<t.length;r++)t[r].status===3||(t[r].status===1?(A(s===r-1,"All SENT items should be at beginning of queue."),s=r,t[r].status=3,t[r].abortReason="set"):(A(t[r].status===0,"Unexpected transaction status in abort"),t[r].unwatcher(),i=i.concat(Cn(n.serverSyncTree_,t[r].currentWriteId,!0)),t[r].onComplete&&o.push(t[r].onComplete.bind(null,new Error("set"),!1,null))));s===-1?ga(e,void 0):t.length=s+1,tn(n.eventQueue_,$t(e),i);for(let r=0;r<o.length;r++)mt(o[r])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nh(n){let e="";const t=n.split("/");for(let o=0;o<t.length;o++)if(t[o].length>0){let i=t[o];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch(s){}e+="/"+i}return e}function Mh(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const o=t.split("=");o.length===2?e[decodeURIComponent(o[0])]=decodeURIComponent(o[1]):Ne(`Invalid query segment '${t}' in query '${n}'`)}return e}const xr=function(n,e){const t=Rh(n),o=t.namespace;t.domain==="firebase.com"&&yn(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!o||o==="undefined")&&t.domain!=="localhost"&&yn("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||X1();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new Ml(t.host,t.secure,o,i,e,"",o!==t.subdomain),path:new Q(t.pathString)}},Rh=function(n){let e="",t="",o="",i="",s="",r=!0,l="https",a=443;if(typeof n=="string"){let d=n.indexOf("//");d>=0&&(l=n.substring(0,d-1),n=n.substring(d+2));let u=n.indexOf("/");u===-1&&(u=n.length);let h=n.indexOf("?");h===-1&&(h=n.length),e=n.substring(0,Math.min(u,h)),u<h&&(i=Nh(n.substring(u,h)));const m=Mh(n.substring(Math.min(n.length,h)));d=e.indexOf(":"),d>=0?(r=l==="https"||l==="wss",a=parseInt(e.substring(d+1),10)):d=e.length;const g=e.slice(0,d);if(g.toLowerCase()==="localhost")t="localhost";else if(g.split(".").length<=2)t=g;else{const b=e.indexOf(".");o=e.substring(0,b).toLowerCase(),t=e.substring(b+1),s=o}"ns"in m&&(s=m.ns)}return{host:e,port:a,domain:t,subdomain:o,secure:r,scheme:l,pathString:i,namespace:s}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Or="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",xh=function(){let n=0;const e=[];return function(t){const o=t===n;n=t;let i;const s=new Array(8);for(i=7;i>=0;i--)s[i]=Or.charAt(t%64),t=Math.floor(t/64);A(t===0,"Cannot push at time == 0");let r=s.join("");if(o){for(i=11;i>=0&&e[i]===63;i--)e[i]=0;e[i]++}else for(i=0;i<12;i++)e[i]=Math.floor(Math.random()*64);for(i=0;i<12;i++)r+=Or.charAt(e[i]);return A(r.length===20,"nextPushId: Length should be 20."),r}}();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oh{constructor(e,t,o,i){this.eventType=e,this.eventRegistration=t,this.snapshot=o,this.prevName=i}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+Ae(this.snapshot.exportVal())}}class Lh{constructor(e,t,o){this.eventRegistration=e,this.error=t,this.path=o}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vo{constructor(e,t,o,i){this._repo=e,this._path=t,this._queryParams=o,this._orderByCalled=i}get key(){return H(this._path)?null:Yi(this._path)}get ref(){return new Dn(this._repo,this._path)}get _queryIdentifier(){const e=vr(this._queryParams),t=Gi(e);return t==="{}"?"default":t}get _queryObject(){return vr(this._queryParams)}isEqual(e){if(e=Xn(e),!(e instanceof Vo))return!1;const t=this._repo===e._repo,o=qi(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&o&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+k0(this._path)}}function Hh(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function zh(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===zn){const o="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==Vn)throw new Error(o);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==Bn)throw new Error(o);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===re){if(e!=null&&!Si(e)||t!=null&&!Si(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(A(n.getIndex()instanceof Zi||n.getIndex()===ql,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class Dn extends Vo{constructor(e,t){super(e,t,new ns,!1)}get parent(){const e=Wl(this._path);return e===null?null:new Dn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class So{constructor(e,t,o){this._node=e,this.ref=t,this._index=o}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Q(e),o=Gt(this.ref,e);return new So(this._node.getChild(t),o,re)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(o,i)=>e(new So(i,Gt(this.ref,o),re)))}hasChild(e){const t=new Q(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Je(n,e){return n=Xn(n),n._checkNotDeleted("ref"),e!==void 0?Gt(n._root,e):n._root}function Gt(n,e){return n=Xn(n),F(n._path)===null?gh("child","path",e):_s("child","path",e),new Dn(n._repo,le(n._path,e))}function so(n,e){n=Xn(n),vs("push",n._path),va("push",e,n._path,!0);const t=Ua(n._repo),o=xh(t),i=Gt(n,o),s=Gt(n,o);let r;return r=Promise.resolve(s),i.then=r.then.bind(r),i.catch=r.then.bind(r,void 0),i}function wa(n){return vs("remove",n._path),Vh(n,null)}function Vh(n,e){n=Xn(n),vs("set",n._path),va("set",e,n._path,!1);const t=new Xt;return Bh(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function Di(n,e){yh("update",e,n._path);const t=new Xt;return Ih(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}class Bs{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const o=t._queryParams.getIndex();return new Oh("value",this,new So(e.snapshotNode,new Dn(t._repo,t._path),o))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Lh(this,e,t):null}matches(e){return e instanceof Bs?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Wh(n,e,t,o,i){let s;if(typeof o=="object"&&(s=void 0,i=o),typeof o=="function"&&(s=o),i&&i.onlyOnce){const a=t,d=(u,h)=>{wi(n._repo,n,l),a(u,h)};d.userCallback=t.userCallback,d.context=t.context,t=d}const r=new Fh(t,s||void 0),l=new Bs(r);return wh(n._repo,n,l),()=>wi(n._repo,n,l)}function ka(n,e,t,o){return Wh(n,"value",e,t,o)}function Da(n,e,t){wi(n._repo,n,null)}class jh{}class Gh extends jh{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){Hh(e,"orderByChild");const t=new Q(this._path);if(H(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const o=new Zi(t),i=Z0(e._queryParams,o);return zh(i),new Vo(e._repo,e._path,i,!0)}}function Kh(n){return _s("orderByChild","path",n),new Gh(n)}function Xh(n,...e){let t=Xn(n);for(const o of e)t=o._apply(t);return t}z2(Dn);X2(Dn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qh="FIREBASE_DATABASE_EMULATOR_HOST",Ti={};let Yh=!1;function qh(n,e,t,o){const i=e.lastIndexOf(":"),s=e.substring(0,i),r=pl(s);n.repoInfo_=new Ml(e,r,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),o&&(n.authTokenProvider_=o)}function Jh(n,e,t,o,i){let s=o||n.options.databaseURL;s===void 0&&(n.options.projectId||yn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Pe("Using default host for project ",n.options.projectId),s=`${n.options.projectId}-default-rtdb.firebaseio.com`);let r=xr(s,i),l=r.repoInfo,a;typeof process!="undefined"&&or&&(a=or[Qh]),a?(s=`http://${a}?ns=${l.namespace}`,r=xr(s,i),l=r.repoInfo):r.repoInfo.secure;const d=new i0(n.name,n.options,e);bh("Invalid Firebase Database URL",r),H(r.path)||yn("Database URL must point to the root of a Firebase Database (not including a child path).");const u=Zh(l,n,d,new o0(n,t));return new eu(u,n)}function $h(n,e){const t=Ti[e];(!t||t[n.key]!==n)&&yn(`Database ${e}(${n.repoInfo_}) has already been deleted.`),kh(n),delete t[n.key]}function Zh(n,e,t,o){let i=Ti[e.name];i||(i={},Ti[e.name]=i);let s=i[n.toURLString()];return s&&yn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new Ph(n,Yh,t,o),i[n.toURLString()]=s,s}class eu{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Uh(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Dn(this._repo,K())),this._rootInternal}_delete(){return this._rootInternal!==null&&($h(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&yn("Cannot call "+e+" on a deleted database.")}}function nu(n=k1(),e){const t=E1(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const o=md("database");o&&tu(t,...o)}return t}function tu(n,e,t,o={}){n=Xn(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,s=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&po(o,s.repoInfo_.emulatorOptions))return;yn("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let r;if(s.repoInfo_.nodeAdmin)o.mockUserToken&&yn('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new io(io.OWNER);else if(o.mockUserToken){const l=typeof o.mockUserToken=="string"?o.mockUserToken:fd(o.mockUserToken,n.app.options.projectId);r=new io(l)}pl(e)&&Sd(e),qh(s,i,o,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ou(n){z1(w1),fo(new Ot("database",(e,{instanceIdentifier:t})=>{const o=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return Jh(o,i,s,t)},"PUBLIC").setMultipleInstances(!0)),ot(ir,sr,n),ot(ir,sr,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iu={".sv":"timestamp"};function Fn(){return iu}mn.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};mn.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};ou();var su="firebase",ru="12.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ot(su,ru,"app");const Rn=n=>n?String(n).split(/[\r\n,=\s]/)[0].trim():"",Ni={apiKey:Rn("AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs"),authDomain:Rn("findparkinglot-2519e.firebaseapp.com"),projectId:Rn("findparkinglot-2519e"),databaseURL:Rn("https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app"),storageBucket:Rn("findparkinglot-2519e.firebasestorage.app"),messagingSenderId:Rn("976769533420"),appId:Rn("1:976769533420:web:f3108318b3def30017acc9")},hn=!!(Ni.apiKey&&Ni.databaseURL);let Lr=null,Xe=null;hn&&(Lr=gl(Ni),Xe=nu(Lr));const ro="parking_overrides",St=E({}),Ta=E(!1),Mi=E(null);let Mt=null,li=0;function lo(n,e){if(!n||!Array.isArray(e))return"";const t=Number(e[0]),o=Number(e[1]);return!isFinite(t)||!isFinite(o)?"":`${n}|${t.toFixed(6)},${o.toFixed(6)}`.replace(/[.#$/[\]]/g,"_")}function Na(n,e){if(!e)return n;const t={...n},o=i=>{const s=e[i];s!=null&&(typeof s=="string"&&s.trim()===""||(t[i]=s))};return o("description"),o("iconKey"),o("category"),o("friendliness"),o("priceInfo"),t}function lu(){if(!(!hn||Mt))try{const n=Je(Xe,ro);Mt=n,ka(n,e=>{const t={};e.forEach(o=>{t[o.key]=o.val()||{}}),St.value=t,Ta.value=!0},e=>{Mi.value=e})}catch(n){Mi.value=n}}function au(){Mt&&(Da(Mt),Mt=null)}function cu(){Kn(()=>{li+=1,lu()}),ut(()=>{li-=1,li<=0&&au()});const n=(s,r)=>{const l=lo(s,r);return l&&St.value[l]||null};return{overrides:St,ready:Ta,error:Mi,getOverride:n,hasOverride:(s,r)=>!!n(s,r),getOverrideHistory:(s,r)=>{const l=n(s,r);return!l||!l.history||typeof l.history!="object"?[]:Object.entries(l.history).map(([a,d])=>({...d||{},_key:a})).sort((a,d)=>a._key<d._key?1:a._key>d._key?-1:0)},upsertOverride:async(s,r,l)=>{var N,j,Be;if(!hn)throw new Error("Firebase 尚未設定");const a=lo(s.name,s.geometry);if(!a)throw new Error("無法產生 override key (缺少 name 或 geometry)");const[d,u]=s.geometry,h={id:l.id,nickname:l.nickname||""},m={origName:s.name||"",origLng:Number(d),origLat:Number(u),description:typeof r.description=="string"?r.description.trim():"",iconKey:r.iconKey||"",category:r.category||"",friendliness:r.friendliness||"",priceInfo:typeof r.priceInfo=="string"?r.priceInfo.trim():"",updatedBy:h,updatedAt:Fn()},g=St.value[a]||null,b=Na(s,g),B=["description","iconKey","category","friendliness","priceInfo"],D={},U={};for(const ae of B){const Ie=(N=b==null?void 0:b[ae])!=null?N:"",_e=(j=m[ae])!=null?j:"";String(Ie)!==String(_e)&&(D[ae]=Ie,U[ae]=_e)}const W=so(Je(Xe,`${ro}/${a}/history`)).key;return await Di(Je(Xe),{[`${ro}/${a}`]:{...m,history:{...((Be=St.value[a])==null?void 0:Be.history)||{},[W]:{action:"override",at:Fn(),by:h,before:D,after:U}}}}),a},resetOverride:async(s,r)=>{if(!hn)throw new Error("Firebase 尚未設定");const l=lo(s,r);l&&await wa(Je(Xe,`${ro}/${l}`))}}}const on=(n,e)=>{const t=n.__vccOpts||n;for(const[o,i]of e)t[o]=i;return t},du={id:"map"},hu=16,Fr=34,uu=84,pu={__name:"MapBox",props:{parkingTypeKeyArray:Array,degreeOfFriendlinessKeyArray:Array,mapDataList:Array,getLngLat:Boolean,mapStylesSelected:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,goToParkingPlaceData:Object,routeData:Object,favoriteIds:{type:Object,default:()=>new Set},overrideKeys:{type:Object,default:()=>new Set},overrides:{type:Object,default:()=>({})},onlyFavorites:{type:Boolean,default:!1},focusCoord:{type:Array,default:null},routeProfile:{type:String,default:"driving"},communityParkings:{type:Array,default:()=>[]}},emits:["parkingInfo","communityParkingClick","update:goToParkingPlaceData","update:routeData"],setup(n,{expose:e,emit:t}){const o=n,i=t,s="pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",r=E(null),l=E({accessToken:s,bounds:[[119.3620389067818,21.83282743468497],[122.07013958372167,25.34391086143183]],center:[121.5173399,25.0475613],zoom:14,userCoordinates:[null,null]}),a=E(null),d=E([]),u=v=>v>=15?60:v>=13?60+(15-v)*30:v>=11?120+(13-v)*60:240,h=v=>Array.isArray(v)&&v.length>=2&&Number.isFinite(Number(v[0]))&&Number.isFinite(Number(v[1])),m=(v,R,G,$,q)=>{const de=document.createElement("div");de.className="marker",$&&de.classList.add("is-override"),G&&de.classList.add("is-fav");const sn=document.createElement("div");sn.className="tag";const ke=document.createElement("div");ke.className="img";const C=q||R.properties.icon;return C&&(ke.style.backgroundImage=`url(${Y(C)})`,ke.style.backgroundSize="cover",ke.style.backgroundPosition="center center"),de.appendChild(sn),de.appendChild(ke),de.addEventListener("click",()=>{r.value.flyTo({center:R.geometry.coordinates,zoom:17,bearing:0,speed:1.5,curve:1.5,easing:I=>I,essential:!0}),i("parkingInfo",{name:v.name,properties:R.properties,geometry:R.geometry.coordinates,address:""})}),de},g=(v,R)=>{const G=document.createElement("div");G.className="marker is-community",R&&G.classList.add("is-fav");const $=document.createElement("div");$.className="tag";const q=document.createElement("div");return q.className="img",v.iconKey&&(q.style.backgroundImage=`url(${Y(v.iconKey)})`,q.style.backgroundSize="cover",q.style.backgroundPosition="center center"),G.appendChild($),G.appendChild(q),G.addEventListener("click",()=>{r.value.flyTo({center:v.coordinates,zoom:17,speed:1.5,curve:1.5,essential:!0}),i("communityParkingClick",v)}),G},b=v=>{const R=document.createElement("div");R.className="marker-cluster";const G=Math.min(1,Math.log2(Math.max(2,v))/Math.log2(500)),$=Math.round(Fr+(uu-Fr)*G),q=Math.round(12+10*G);return R.style.width=`${$}px`,R.style.height=`${$}px`,R.style.lineHeight=`${$}px`,R.style.fontSize=`${q}px`,R.textContent=String(v),R},B=()=>{var de,sn,ke,C,T,I,se,Me,Le,gn,rn,pe;for(let x=d.value.length-1;x>=0;x--)d.value[x].remove();if(d.value=[],!r.value)return;const v=(sn=(de=r.value).getBounds)==null?void 0:sn.call(de),R=[];for(const x of o.mapDataList)for(const O of x.features){const ce=O.geometry.coordinates;if(!h(ce))continue;const Fe=ci(O.properties.name,ce),He=(C=(ke=o.favoriteIds)==null?void 0:ke.has)==null?void 0:C.call(ke,Fe),ve=lo(O.properties.name,ce),Nn=ve?(I=(T=o.overrideKeys)==null?void 0:T.has)==null?void 0:I.call(T,ve):!1,De=Nn?(se=o.overrides)==null?void 0:se[ve]:null,Te=typeof(De==null?void 0:De.priceInfo)=="string"&&De.priceInfo.trim()!==""?De.priceInfo.trim():"",ln=Te||O.properties.priceInfo,an=Te?Te.split("|"):O.properties.priceArray,je=(typeof(De==null?void 0:De.iconKey)=="string"&&De.iconKey.trim()!==""?De.iconKey.trim():"")||O.properties.icon;!js(v,ce)||o.onlyFavorites&&!He||!Vs(je,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray)||!Ws(ln,an,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)||R.push({coord:[Number(ce[0]),Number(ce[1])],createEl:()=>m(x,O,He,Nn,je)})}for(const x of o.communityParkings||[]){const O=x.coordinates;if(!h(O)||!js(v,O))continue;const ce=ci(x.name,O),Fe=(Le=(Me=o.favoriteIds)==null?void 0:Me.has)==null?void 0:Le.call(Me,ce);if(o.onlyFavorites&&!Fe||!Vs(x.iconKey,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray))continue;const He=x.priceInfo||"",ve=He?He.split("|"):[];Ws(He,ve,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)&&R.push({coord:[Number(O[0]),Number(O[1])],createEl:()=>g(x,Fe)})}const G=(pe=(rn=(gn=r.value).getZoom)==null?void 0:rn.call(gn))!=null?pe:0;if(G>=hu){for(const x of R){const O=new Mn.Marker(x.createEl()).setLngLat(x.coord).addTo(r.value);d.value.push(O)}return}const $=u(G),q=new Map;for(const x of R){const O=r.value.project(x.coord),ce=Math.floor(O.x/$),Fe=Math.floor(O.y/$),He=`${ce}:${Fe}`;let ve=q.get(He);ve||(ve={points:[],sumLng:0,sumLat:0},q.set(He,ve)),ve.points.push(x),ve.sumLng+=x.coord[0],ve.sumLat+=x.coord[1]}for(const x of q.values())if(x.points.length===1){const O=x.points[0],ce=new Mn.Marker(O.createEl()).setLngLat(O.coord).addTo(r.value);d.value.push(ce)}else{const O=[x.sumLng/x.points.length,x.sumLat/x.points.length],ce=b(x.points.length);ce.addEventListener("click",()=>{var ve,Nn,De;const He=Math.min(((De=(Nn=(ve=r.value).getZoom)==null?void 0:Nn.call(ve))!=null?De:0)+2,17);r.value.flyTo({center:O,zoom:He,speed:1.5,curve:1.5,essential:!0})});const Fe=new Mn.Marker(ce).setLngLat(O).addTo(r.value);d.value.push(Fe)}};let D=null,U=null;const W=()=>{D!=null&&(clearTimeout(D),D=null),U!=null&&(typeof cancelIdleCallback=="function"&&cancelIdleCallback(U),U=null)},N=()=>{W(),D=setTimeout(()=>{D=null;const v=()=>{U=null,o.goToParkingPlaceData==null&&B()};typeof requestIdleCallback=="function"?U=requestIdleCallback(v,{timeout:250}):v()},80)},j=()=>{const v=document.getElementById("loading-cover");v&&(v.classList.add("active"),setTimeout(()=>v.remove(),600))},Be=()=>{r.value.on("dragend",N),r.value.on("zoomend",N),B(),j(),r.value.once("load",()=>{const v=o.focusCoord;Array.isArray(v)&&v[0]!=null&&v[1]!=null&&r.value.flyTo({center:[Number(v[0]),Number(v[1])],zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})})},ae=()=>{r.value=new Mn.Map({container:"map",style:o.mapStylesSelected,center:l.value.center,zoom:16,trackResize:!0,maxBounds:l.value.bounds}),Be(),r.value.addControl(new Mn.GeolocateControl({positionOptions:{enableHighAccuracy:!0},trackUserLocation:!0,showUserHeading:!0})),r.value.on("geolocate",v=>{r.value.easeTo({bearing:v.coords.heading,duration:1e3,offset:[0,0]})})},Ie=v=>{const{longitude:R,latitude:G}=v.coords;R>=l.value.bounds[0][0]&&R<=l.value.bounds[1][0]&&G>=l.value.bounds[0][1]&&G<=l.value.bounds[1][1]?(l.value.userCoordinates=[R,G],l.value.center=[R,G]):l.value.center=[121.5173399,25.0475613],ae()},_e=()=>{ae()},ue=()=>{const v=document.getElementById("coordinates"),R=a.value.getLngLat();v.style.display="block",v.innerHTML=`[Longitude, Latitude]<br />[${R.lng}, ${R.lat}]`},oe=()=>{a.value=new Mn.Marker({draggable:!0,color:"#2ee7d6"}).setLngLat(r.value.getCenter()).addTo(r.value),ue(),a.value.on("dragend",ue)};async function Se(v,R){r.value.getLayer("point")||r.value.addLayer({id:"point",type:"circle",source:{type:"geojson",data:{type:"FeatureCollection",features:[{type:"Feature",properties:{},geometry:{type:"Point",coordinates:v}}]}},paint:{"circle-radius":10,"circle-color":"#2ee7d6"}});const q=(await(await fetch(`https://api.mapbox.com/directions/v5/mapbox/${o.routeProfile||"driving"}/${v[0]},${v[1]};${R[0]},${R[1]}?alternatives=false&language=zh-Hant&overview=full&steps=true&exclude=ferry&geometries=geojson&access_token=${l.value.accessToken}`,{method:"GET"})).json()).routes[0],de={type:"Feature",properties:{},geometry:{type:"LineString",coordinates:q.geometry.coordinates}};i("update:routeData",q),r.value.getSource("route")?r.value.getSource("route").setData(de):r.value.addLayer({id:"route",type:"line",source:{type:"geojson",data:de},layout:{"line-join":"round","line-cap":"round"},paint:{"line-color":"#2ee7d6","line-width":5,"line-opacity":.75}})}const Oe=v=>{if(l.value.userCoordinates[0]!==null){r.value.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point"));for(let G=d.value.length-1;G>=0;G--){const $=d.value[G].getLngLat();$.lng!=v[0]&&$.lat!=v[1]&&d.value[G].remove()}const R=[[l.value.userCoordinates[0],l.value.userCoordinates[1]],[v[0],v[1]]];r.value.fitBounds(R,{padding:{top:100,bottom:100,left:100,right:100}}),Se(l.value.userCoordinates,v)}else"geolocation"in navigator&&navigator.geolocation.getCurrentPosition(Ie,_e)},we=()=>{var v,R;(v=r.value)!=null&&v.getSource("route")&&(r.value.removeLayer("route"),r.value.removeSource("route")),(R=r.value)!=null&&R.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point")),B(),i("update:goToParkingPlaceData",null)};return Kn(()=>{Mn.accessToken=l.value.accessToken,"geolocation"in navigator?navigator.geolocation.getCurrentPosition(Ie,_e,{enableHighAccuracy:!1,timeout:8e3,maximumAge:6e4}):ae()}),ut(()=>{W()}),X([()=>o.parkingTypeKeyArray,()=>o.degreeOfFriendlinessKeyArray,()=>o.priceRangeMin,()=>o.priceRangeMax,()=>o.parkingPriceType,()=>o.onlyFavorites,()=>o.favoriteIds,()=>o.communityParkings,()=>o.overrides],()=>N(),{deep:!0}),X(()=>o.focusCoord,v=>{!v||!r.value||r.value.flyTo({center:v,zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})}),X(()=>o.routeProfile,()=>{o.goToParkingPlaceData!==null&&l.value.userCoordinates[0]!==null&&Se(l.value.userCoordinates,o.goToParkingPlaceData)}),X(()=>o.goToParkingPlaceData,v=>{v!==null?Oe(v):we()}),X(()=>o.mapStylesSelected,(v,R)=>{R!==v&&r.value&&r.value.setStyle(v)}),X(()=>o.getLngLat,()=>{if(a.value!==null){a.value.remove();const v=document.getElementById("coordinates");v&&(v.style.display="none")}o.getLngLat===!0&&oe()}),e({getCenter:()=>{if(!r.value)return[...l.value.center];const v=r.value.getCenter();return[v.lng,v.lat]},flyTo:(v,R=17)=>{!r.value||!v||r.value.flyTo({center:v,zoom:R,essential:!0})}}),(v,R)=>(_(),P("div",du))}},mu=on(pu,[["__scopeId","data-v-d2d2184f"]]),fu=n=>(wn("data-v-4ef15e45"),n=n(),kn(),n),yu={key:0,class:"modal-header"},gu=fu(()=>c("span",{class:"material-icons-outlined"},"close",-1)),bu=[gu],Au={class:"modal-body"},_u={key:1,class:"modal-footer"},vu={__name:"BaseModal",props:{modelValue:Boolean,title:{type:String,default:""},closeText:{type:String,default:"關閉"},size:{type:String,default:"md"}},emits:["update:modelValue","close"],setup(n,{emit:e}){const t=n,o=e,i=E(null),s=()=>{o("update:modelValue",!1),o("close")},r=l=>{l.key==="Escape"&&t.modelValue&&s()};return Kn(()=>window.addEventListener("keydown",r)),ut(()=>window.removeEventListener("keydown",r)),X(()=>t.modelValue,async l=>{var a;document.body.classList.toggle("modal-open",l),l&&(await Kr(),(a=i.value)==null||a.scrollTo({top:0,behavior:"auto"}))}),(l,a)=>(_(),Fi(ac,{to:"body"},[c("div",{class:ie(["modal-overlay",{active:n.modelValue}]),onClick:Hi(s,["self"]),role:"dialog","aria-modal":"true",ref_key:"overlayEl",ref:i},[c("div",{class:ie(["modal-card",[`size-${n.size}`,{active:n.modelValue}]])},[n.title||l.$slots.header?(_(),P("header",yu,[Yo(l.$slots,"header",{},()=>[c("h3",null,w(n.title),1)]),c("button",{class:"modal-close",onClick:s,"aria-label":"關閉"},bu)])):V("",!0),c("div",Au,[Yo(l.$slots,"default",{},void 0)]),l.$slots.footer||n.closeText?(_(),P("footer",_u,[Yo(l.$slots,"footer",{},()=>[c("button",{class:"btn btn-primary",onClick:s},w(n.closeText),1)])])):V("",!0)],2)],2)]))}},Ln=on(vu,[["__scopeId","data-v-4ef15e45"]]),Cu=["onClick"],Pu={class:"material-icons-outlined"},Uu={class:"fab-item-label"},Eu=["aria-label","aria-expanded"],Bu={class:"material-icons-outlined"},Iu={__name:"FabMenu",props:{items:{type:Array,required:!0},placement:{type:String,default:"right"},mainIcon:{type:String,default:"apps"},mainLabel:{type:String,default:""}},setup(n){const e=E(!1),t=E(null),o=()=>e.value=!e.value,i=r=>{t.value&&!t.value.contains(r.target)&&(e.value=!1)},s=r=>{var l;e.value=!1,(l=r.onClick)==null||l.call(r)};return Kn(()=>document.addEventListener("click",i)),ut(()=>document.removeEventListener("click",i)),(r,l)=>(_(),P("div",{class:ie(["fab-root",`fab-placement-${n.placement}`]),ref_key:"rootEl",ref:t},[Ee(cc,{name:"fab-item",tag:"div",class:"fab-items"},{default:dn(()=>[(_(!0),P(ge,null,Qe(e.value?n.items:[],(a,d)=>(_(),P("button",{key:a.key,class:ie(["fab-item",{highlight:a.highlight}]),style:co({bottom:d*46+"px"}),onClick:u=>s(a)},[c("span",Pu,w(a.icon),1),c("span",Uu,w(a.label),1)],14,Cu))),128))]),_:1}),c("button",{class:ie(["fab-main",{active:e.value}]),onClick:Hi(o,["stop"]),"aria-label":e.value?"收合選單":n.mainLabel||"展開選單","aria-expanded":e.value},[c("span",Bu,w(e.value?"close":n.mainIcon),1)],10,Eu)],2))}},Hr=on(Iu,[["__scopeId","data-v-b3399b6f"]]),ht=[{name:"全部",value:"",key:null},{name:"汽車：汽車格(含未確認是否有重機格)",value:"car",key:["icon-1.png","icon-2.png","icon-3.png","icon-5.png"]},{name:"重機：有設重機專用格",value:"motorcycle",key:["icon-6.png","icon-8.png","icon-12.png","icon-13.png"]},{name:"機車：機車格",value:"scooter",key:["icon-7.png","icon-9.png","icon-10.png","icon-11.png"]},{name:"綠星:路邊友善車格(機車格開放重機停放)",value:"greenStar",key:["icon-14.png"]},{name:"重機友善店家:用餐/消費可停重機",value:"friendlyShop",key:["icon-4.png"]},{name:"綠P:重機專用路邊停車格",value:"greenP",key:["icon-15.png"]},{name:"灰P:重機專用路邊停車格(未確認精準座標)",value:"greyP",key:["icon-16.png"]},{name:"藍P:普通大型共用機車格(台北市試辦)",value:"blueP",key:["icon-17.png"]},{name:"紫P:時段性汽機車共用停車格，注意使用時間喔!",value:"purpleP",key:["icon-18.png"]},{name:"紅X:停都不給停",value:"redX",key:["icon-19.png"]},{name:"?:類型未確認",value:"unknown",key:["icon-20.png"]}];function Su(n){if(!n)return"未分類";const e=ht.find(t=>Array.isArray(t.key)&&t.key.includes(n));return e?e.name.split(/[：:]/)[0]:"未分類"}const Kt=[{name:"全部",value:"",key:null},{name:"最友善：有後牌辨析",value:"friendly",key:["icon-2.png","icon-4.png","icon-6.png","icon-9.png","icon-14.png","icon-15.png"]},{name:"最傳統：悠遊卡、按鈕取票",value:"normal",key:["icon-5.png","icon-11.png","icon-12.png","icon-17.png"]},{name:"最靠北：按鈕請管理員協助、前牌辨析",value:"unfriendly",key:["icon-1.png","icon-7.png","icon-13.png","icon-19.png"]},{name:"未確定",value:"unknown",key:["icon-3.png","icon-8.png","icon-10.png","icon-16.png","icon-20.png"]}],nt=[{name:"依系統設定",value:"system",theme:"system"},{name:"暗色模式",value:"mapbox://styles/jamestim9215/ckvkdj5cd1q4115nzwxa9rny3",theme:"dark"},{name:"亮色模式",value:"mapbox://styles/jamestim9215/ckvueghhu2woc14nrsgysx41v",theme:"light"}],wu="260529",ku=n=>(wn("data-v-fc736dec"),n=n(),kn(),n),Du={class:"range-slider"},Tu={class:"range-track"},Nu=["min","max","step","value"],Mu=["min","max","step","value"],Ru={class:"range-values"},xu=ku(()=>c("span",{class:"range-sep"},"~",-1)),Ou={__name:"RangeSlider",props:{min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:10},modelMin:{type:Number,default:0},modelMax:{type:Number,default:100},suffix:{type:String,default:""}},emits:["update:modelMin","update:modelMax"],setup(n,{emit:e}){const t=n,o=e,i=J(()=>t.max-t.min||1),s=J(()=>(t.modelMin-t.min)/i.value*100),r=J(()=>(t.modelMax-t.min)/i.value*100),l=d=>{let u=Number(d.target.value);u>t.modelMax&&(u=t.modelMax),o("update:modelMin",u)},a=d=>{let u=Number(d.target.value);u<t.modelMin&&(u=t.modelMin),o("update:modelMax",u)};return(d,u)=>(_(),P("div",Du,[c("div",Tu,[c("div",{class:"range-fill",style:co({left:s.value+"%",right:100-r.value+"%"})},null,4),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMin,onInput:l,class:"range-input range-input-min","aria-label":"最低價格"},null,40,Nu),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMax,onInput:a,class:"range-input range-input-max","aria-label":"最高價格"},null,40,Mu)]),c("div",Ru,[c("span",null,w(n.modelMin)+w(n.suffix),1),xu,c("span",null,w(n.modelMax)+w(n.suffix),1)])]))}},Lu=on(Ou,[["__scopeId","data-v-fc736dec"]]),We=n=>(wn("data-v-c813ca92"),n=n(),kn(),n),Fu=We(()=>c("span",{class:"material-icons-outlined"},"chevron_left",-1)),Hu=[Fu],zu=Xr('<header class="side-panel-header" data-v-c813ca92><img class="side-panel-logo" src="'+zi+'" alt="重機能停哪" data-v-c813ca92><div class="side-panel-titles" data-v-c813ca92><h3 data-v-c813ca92>重機能停哪?</h3><span class="side-panel-subtitle" data-v-c813ca92><span class="material-icons-outlined" data-v-c813ca92>tune</span>設定 </span></div></header>',1),Vu={class:"side-panel-body"},Wu={class:"form-group"},ju={class:"form-toggle"},Gu={class:"form-toggle-text"},Ku=We(()=>c("span",{class:"material-icons-outlined fav-icon"},"star",-1)),Xu={key:0,class:"fav-count"},Qu=["checked"],Yu={class:"form-group"},qu=We(()=>c("label",{class:"form-label"},"甚麼格位",-1)),Ju=["value"],$u=["value"],Zu={class:"form-group"},e3=We(()=>c("label",{class:"form-label"},"友善程度",-1)),n3=["value"],t3=["value"],o3={class:"form-group"},i3=We(()=>c("label",{class:"form-label"},"收費範圍",-1)),s3={class:"price-chips"},r3=We(()=>c("span",{class:"material-icons-outlined"},"money_off",-1)),l3={class:"form-group"},a3=We(()=>c("label",{class:"form-label"},"主題顏色",-1)),c3=["value"],d3=["value"],h3=Xr('<section class="form-group" data-v-c813ca92><label class="form-label" data-v-c813ca92>停車場資料來源</label><div class="link-list" data-v-c813ca92><a href="https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&amp;g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&amp;skid=9984dc32-0eac-4e02-b7a8-241e8910f915&amp;shorturl=1&amp;ll=25.078951126084913%2C121.45397636318671&amp;z=11" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-c813ca92> Alan大重停車記事 </a></div></section><section class="form-group" data-v-c813ca92><label class="form-label" data-v-c813ca92>問題回報</label><p class="muted-text" data-v-c813ca92> 1. 停車場資訊相關（新場地、收費錯誤）： </p><a href="https://forms.gle/euRCPCPSmvYLm5Rj8" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-c813ca92> Alan大重停車記事 回報表單 </a><p class="muted-text mt-8" data-v-c813ca92>2. 網頁 BUG、畫面跑版：</p><a href="https://forms.gle/iJCyfqVtpL35WtZM7" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-c813ca92> 重機能停哪? 回報表單 </a><a href="https://buymeacoffee.com/jamestim923" target="_blank" rel="noopener" class="btn btn-coffee btn-sm mt-8" data-v-c813ca92> ☕️ 請我喝杯咖啡，讓我有動力繼續更新 </a></section>',2),u3={class:"form-group"},p3=We(()=>c("label",{class:"form-label"},"資訊",-1)),m3={class:"info-list"},f3=We(()=>c("li",null,"版本：v2.2.1",-1)),y3=We(()=>c("li",null,"Web 製作：爽爽",-1)),g3=We(()=>c("li",null,"資料參考：Alan大重停車記事 Google My Map",-1)),b3=We(()=>c("li",null,"地圖：Mapbox GL JS API",-1)),A3=We(()=>c("li",null,"© 2026 爽爽 版權所有。本網頁未經准許，禁止任何商業行為",-1)),_3={__name:"SettingsPanel",props:{parkingType:String,degreeOfFriendliness:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,mapStyle:String,active:Boolean,onlyFavorites:Boolean,favoritesCount:{type:Number,default:0}},emits:["update:parkingType","update:degreeOfFriendliness","update:parkingPriceType","update:priceRangeMin","update:priceRangeMax","update:mapStyle","update:active","update:onlyFavorites"],setup(n,{emit:e}){const t=e,o=()=>t("update:active",!1);return(i,s)=>(_(),P("aside",{class:ie(["side-panel",{active:n.active}]),"aria-label":"設定面板"},[c("button",{class:"side-panel-close",onClick:o,"aria-label":"收合設定"},Hu),zu,c("div",Vu,[c("section",Wu,[c("label",ju,[c("span",Gu,[Ku,k(" 只看我的最愛 "),n.favoritesCount?(_(),P("span",Xu,w(n.favoritesCount),1)):V("",!0)]),c("input",{type:"checkbox",class:"switch",checked:n.onlyFavorites,onChange:s[0]||(s[0]=r=>t("update:onlyFavorites",r.target.checked))},null,40,Qu)])]),c("section",Yu,[qu,c("select",{class:"form-control",value:n.parkingType,onChange:s[1]||(s[1]=r=>t("update:parkingType",r.target.value))},[(_(!0),P(ge,null,Qe(L(ht),r=>(_(),P("option",{value:r.value,key:r.value},w(r.name),9,$u))),128))],40,Ju)]),c("section",Zu,[e3,c("select",{class:"form-control",value:n.degreeOfFriendliness,onChange:s[2]||(s[2]=r=>t("update:degreeOfFriendliness",r.target.value))},[(_(!0),P(ge,null,Qe(L(Kt),r=>(_(),P("option",{value:r.value,key:r.value},w(r.name),9,t3))),128))],40,n3)]),c("section",o3,[i3,c("div",s3,[c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType===""}]),onClick:s[3]||(s[3]=r=>t("update:parkingPriceType",""))},"全部",2),c("button",{type:"button",class:ie(["chip chip-free",{active:n.parkingPriceType==="free"}]),onClick:s[4]||(s[4]=r=>t("update:parkingPriceType",n.parkingPriceType==="free"?"":"free"))},[r3,k(" 免費 ")],2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="h"}]),onClick:s[5]||(s[5]=r=>t("update:parkingPriceType","h"))},"計時 /時",2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="d"}]),onClick:s[6]||(s[6]=r=>t("update:parkingPriceType","d"))},"計次 /日",2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="t"}]),onClick:s[7]||(s[7]=r=>t("update:parkingPriceType","t"))},"計次 /不限時",2)]),/d|h|t/.test(n.parkingPriceType)?(_(),Fi(Lu,{key:0,class:"mt-8",min:0,max:300,step:10,"model-min":n.priceRangeMin,"model-max":n.priceRangeMax,suffix:n.parkingPriceType==="h"?" /時":n.parkingPriceType==="d"?" /日":" /次","onUpdate:modelMin":s[8]||(s[8]=r=>t("update:priceRangeMin",r)),"onUpdate:modelMax":s[9]||(s[9]=r=>t("update:priceRangeMax",r))},null,8,["model-min","model-max","suffix"])):V("",!0)]),c("section",l3,[a3,c("select",{class:"form-control",value:n.mapStyle,onChange:s[10]||(s[10]=r=>t("update:mapStyle",r.target.value))},[(_(!0),P(ge,null,Qe(L(nt),r=>(_(),P("option",{value:r.value,key:r.value},w(r.name),9,d3))),128))],40,c3)]),h3,c("section",u3,[p3,c("ul",m3,[f3,c("li",null,"地圖資料更新："+w(L(wu)),1),y3,g3,b3,A3])])])],2))}},v3=on(_3,[["__scopeId","data-v-c813ca92"]]),qe=n=>(wn("data-v-d09400e9"),n=n(),kn(),n),C3=qe(()=>c("span",{class:"material-icons-outlined"},"close",-1)),P3=[C3],U3={class:"info-header"},E3=["src"],B3={class:"info-title"},I3=["aria-label","title"],S3={class:"material-icons-outlined"},w3=["innerHTML"],k3={key:1,class:"info-address"},D3={key:2,class:"info-price"},T3=qe(()=>c("span",{class:"material-icons-outlined"},"payments",-1)),N3=qe(()=>c("span",{class:"info-price-label"},"收費",-1)),M3={class:"info-price-value"},R3={key:0,class:"info-price-tag"},x3={key:3,class:"community-tag"},O3=qe(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),L3={key:4,class:"override-tag"},F3=qe(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),H3={key:5,class:"source-tag"},z3=qe(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),V3={class:"info-meta"},W3={class:"badge-group"},j3={class:"badge"},G3={key:0,class:"badge badge-icon",title:"依圖示分類"},K3={class:"coord"},X3={class:"info-actions"},Q3=qe(()=>c("span",{class:"material-icons-outlined"},"edit",-1)),Y3=["title"],q3=qe(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),J3=qe(()=>c("span",{class:"material-icons-outlined"},"share",-1)),$3={class:"info-actions"},Z3=qe(()=>c("span",{class:"material-icons-outlined"},"map",-1)),e5=qe(()=>c("span",{class:"material-icons-outlined"},"map",-1)),n5=qe(()=>c("span",{class:"material-icons-outlined"},"directions",-1)),t5={__name:"ParkingInfoPanel",props:{info:Object,active:Boolean,isMobile:Boolean,isApple:Boolean,isAndroid:Boolean,hasRoute:Boolean,isFavorite:Boolean,isCommunity:{type:Boolean,default:!1},communityMeta:{type:Object,default:null},isOverridden:{type:Boolean,default:!1},overrideMeta:{type:Object,default:null}},emits:["close","route","openMap","toggleFavorite","editCommunity","editOverride","share"],setup(n,{emit:e}){const t=n,o=e,i=new Set(["icon-4.png","icon-14.png","icon-19.png"]),s=l=>l!=null&&l.priceInfo?t.isCommunity||t.isOverridden?!0:!i.has(l==null?void 0:l.parkingIconKey):!1,r=l=>{if(!l)return"";if(/^free$/i.test(l.trim()))return"免費";const a=l.trim().match(/^(\d+(?:\.\d+)?)\s*\/\s*(h|d|次)$/i);if(!a)return l;const d=a[2].toLowerCase(),u=d==="h"?"小時":d==="d"?"日":"次 (不限時)";return`${a[1]} 元 / ${u}`};return(l,a)=>{var d,u,h,m,g,b,B,D;return _(),P("aside",{class:ie(["info-panel",{active:n.active}]),"aria-label":"停車場資訊"},[c("button",{class:"panel-close",onClick:a[0]||(a[0]=U=>o("close")),"aria-label":"關閉"},P3),c("header",U3,[n.info.parkingIcon?(_(),P("img",{key:0,class:"info-icon",src:n.info.parkingIcon,alt:""},null,8,E3)):V("",!0),c("h3",B3,w(n.info.parkingName),1),c("button",{class:ie(["fav-btn",{active:n.isFavorite}]),onClick:a[1]||(a[1]=U=>o("toggleFavorite")),"aria-label":n.isFavorite?"從我的最愛移除":"加入我的最愛",title:n.isFavorite?"從我的最愛移除":"加入我的最愛"},[c("span",S3,w(n.isFavorite?"star":"star_border"),1)],10,I3)]),n.info.parkingNameDes?(_(),P("div",{key:0,class:"info-desc",innerHTML:n.info.parkingNameDes},null,8,w3)):V("",!0),n.info.address?(_(),P("div",k3,w(n.info.address),1)):V("",!0),s(n.info)?(_(),P("div",D3,[T3,N3,c("span",M3,w(r(n.info.priceInfo)),1),n.isOverridden?(_(),P("span",R3,"車友修改")):V("",!0)])):V("",!0),n.isCommunity?(_(),P("div",x3,[O3,c("span",null,[k(" 共筆停車點 "),(u=(d=n.communityMeta)==null?void 0:d.updatedBy)!=null&&u.nickname||(m=(h=n.communityMeta)==null?void 0:h.updatedBy)!=null&&m.id?(_(),P(ge,{key:0},[k(" · 由 "+w(n.communityMeta.updatedBy.nickname||`匿名#${n.communityMeta.updatedBy.id}`)+" 更新 ",1)],64)):V("",!0)])])):n.isOverridden?(_(),P("div",L3,[F3,c("span",null,[k(" 車友修改資訊 "),(b=(g=n.overrideMeta)==null?void 0:g.updatedBy)!=null&&b.nickname||(D=(B=n.overrideMeta)==null?void 0:B.updatedBy)!=null&&D.id?(_(),P(ge,{key:0},[k(" · 由 "+w(n.overrideMeta.updatedBy.nickname||`匿名#${n.overrideMeta.updatedBy.id}`)+" 更新 ",1)],64)):V("",!0)])])):V("",!0),!n.isCommunity&&n.info.sourceLabel?(_(),P("div",H3,[z3,c("span",null,"資料來源 · "+w(n.info.sourceLabel),1)])):V("",!0),c("div",V3,[c("div",W3,[c("span",j3,w(n.info.parkingType),1),n.info.iconCategory&&n.info.iconCategory!==n.info.parkingType?(_(),P("span",G3,w(n.info.iconCategory),1)):V("",!0)]),c("span",K3,w(Number(n.info.geometry[0]).toFixed(5))+", "+w(Number(n.info.geometry[1]).toFixed(5)),1)]),c("div",X3,[n.isCommunity?(_(),P("button",{key:0,class:"btn btn-outline btn-sm",onClick:a[2]||(a[2]=U=>o("editCommunity"))},[Q3,k(" 編輯 ")])):(_(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[3]||(a[3]=U=>o("editOverride")),title:n.isOverridden?"修改車友提供的資訊 (不會變動官方資料)":"異議 / 補充官方資料 (不會變動官方資料)"},[q3,k(" "+w(n.isOverridden?"修改車友資訊":"異議 / 補充"),1)],8,Y3)),c("button",{class:"btn btn-outline btn-sm",onClick:a[4]||(a[4]=U=>o("share")),title:"分享這個停車點"},[J3,k(" 分享 ")])]),c("div",$3,[n.isAndroid?V("",!0):(_(),P("button",{key:0,class:"btn btn-primary btn-sm",onClick:a[5]||(a[5]=U=>o("openMap","apple"))},[Z3,k(" Apple Map ")])),c("button",{class:ie(["btn","btn-sm",n.isAndroid?"btn-primary":"btn-outline"]),onClick:a[6]||(a[6]=U=>o("openMap","google"))},[e5,k(" Google Map ")],2),n.hasRoute?V("",!0):(_(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[7]||(a[7]=U=>o("route"))},[n5,k(" 路線規劃 ")]))])],2)}}},o5=on(t5,[["__scopeId","data-v-d09400e9"]]),Is=n=>(wn("data-v-caf0ec6e"),n=n(),kn(),n),i5={class:"route-header"},s5=Is(()=>c("h3",null,[c("span",{class:"material-icons-outlined"},"alt_route"),k(" 路線 ")],-1)),r5=["aria-expanded"],l5={class:"material-icons-outlined"},a5={key:0,class:"route-summary"},c5={class:"route-summary-item"},d5=Is(()=>c("span",{class:"material-icons-outlined"},"schedule",-1)),h5={class:"route-summary-item"},u5=Is(()=>c("span",{class:"material-icons-outlined"},"straighten",-1)),p5={class:"route-profile",role:"tablist","aria-label":"交通方式"},m5=["onClick","aria-pressed"],f5={class:"material-icons-outlined"},y5={class:"profile-label"},g5={key:1,class:"route-steps"},b5={__name:"RouteSteps",props:{routeData:Object,active:Boolean,profile:{type:String,default:"driving"}},emits:["cancel","update:profile"],setup(n,{emit:e}){const t=n,o=e,i=E(!0),s=()=>i.value=!i.value,r=[{value:"driving",label:"汽機車",icon:"directions_car"},{value:"cycling",label:"單車",icon:"directions_bike"},{value:"walking",label:"步行",icon:"directions_walk"}],l=J(()=>{var h;const u=(h=t.routeData)==null?void 0:h.distance;return typeof u!="number"?"":u>=1e3?`${(u/1e3).toFixed(1)} km`:`${Math.round(u)} m`}),a=J(()=>{var b;const u=(b=t.routeData)==null?void 0:b.duration;if(typeof u!="number")return"";const h=Math.round(u/60);if(h<60)return`${h} 分`;const m=Math.floor(h/60),g=h%60;return g?`${m} 時 ${g} 分`:`${m} 時`}),d=u=>o("update:profile",u);return(u,h)=>(_(),P("aside",{class:ie(["route-panel",{active:n.active}])},[c("header",i5,[s5,c("button",{class:"route-toggle",onClick:s,"aria-expanded":i.value},[c("span",l5,w(i.value?"expand_less":"expand_more"),1)],8,r5)]),n.routeData?(_(),P("div",a5,[c("div",c5,[d5,c("strong",null,w(a.value),1)]),c("div",h5,[u5,c("strong",null,w(l.value),1)])])):V("",!0),c("div",p5,[(_(),P(ge,null,Qe(r,m=>c("button",{key:m.value,class:ie(["profile-btn",{active:n.profile===m.value}]),onClick:g=>d(m.value),"aria-pressed":n.profile===m.value},[c("span",f5,w(m.icon),1),c("span",y5,w(m.label),1)],10,m5)),64))]),n.routeData&&i.value?(_(),P("ol",g5,[(_(!0),P(ge,null,Qe(n.routeData.legs[0].steps,(m,g)=>(_(),P("li",{key:g,class:"route-step"},w(m.maneuver.instruction),1))),128))])):V("",!0),c("button",{class:"btn btn-danger btn-sm route-cancel",onClick:h[0]||(h[0]=m=>o("cancel"))}," 取消路線規劃 ")],2))}},A5=on(b5,[["__scopeId","data-v-caf0ec6e"]]);function _5(n,e,t=20,o=[]){const i=(e||"").trim().toLowerCase();if(!i)return[];const s=[];if(Array.isArray(n))for(const r of n)for(const l of r.features){const a=(l.properties.name||"").toLowerCase(),d=(l.properties.description||"").toLowerCase();if((a.includes(i)||d.includes(i))&&(s.push({groupName:r.name,name:l.properties.name,description:l.properties.description,icon:l.properties.icon,geometry:l.geometry.coordinates,properties:l.properties,isCommunity:!1,score:(a.includes(i)?1e3:0)-(a.indexOf(i)===-1?0:a.indexOf(i))}),s.length>500))break}if(Array.isArray(o))for(const r of o){const l=(r.name||"").toLowerCase(),a=(r.description||"").toLowerCase();if(!l.includes(i)&&!a.includes(i))continue;const d=Array.isArray(r.coordinates)?r.coordinates:[null,null];if(!(d[0]==null||d[1]==null)&&(s.push({groupName:"共筆停車點",name:r.name,description:r.description,icon:r.iconKey,geometry:d,properties:{name:r.name,description:r.description,icon:r.iconKey},isCommunity:!0,community:r,score:(l.includes(i)?900:0)-(l.indexOf(i)===-1?0:l.indexOf(i))}),s.length>500))break}return s.sort((r,l)=>l.score-r.score),s.slice(0,t)}const Ma=n=>(wn("data-v-2b0f75f6"),n=n(),kn(),n),v5={key:0,class:"search-results",role:"listbox"},C5=["aria-selected","onMouseenter","onClick"],P5=["src"],U5={class:"search-item-text"},E5={class:"search-item-name"},B5={class:"search-item-group"},I5={key:1,class:"search-empty"},S5={class:"search-box",role:"combobox","aria-expanded":"true"},w5=Ma(()=>c("span",{class:"material-icons-outlined search-icon"},"search",-1)),k5=Ma(()=>c("span",{class:"material-icons-outlined"},"close",-1)),D5=[k5],T5=["aria-label","aria-expanded"],N5={class:"material-icons-outlined"},M5={__name:"SearchBar",props:{mapDataList:Array,communityParkings:{type:Array,default:()=>[]}},emits:["select"],setup(n,{emit:e}){const t=n,o=e,i=E(!1),s=E(""),r=E(-1),l=J(()=>s.value?_5(t.mapDataList,s.value,15,t.communityParkings):[]);X(s,()=>{r.value=-1});const a=()=>{i.value=!i.value,i.value||(s.value="")},d=()=>{i.value=!1,s.value=""},u=m=>{o("select",m),d()},h=m=>{if(l.value.length)if(m.key==="ArrowDown")m.preventDefault(),r.value=(r.value+1)%l.value.length;else if(m.key==="ArrowUp")m.preventDefault(),r.value=(r.value-1+l.value.length)%l.value.length;else if(m.key==="Enter"){m.preventDefault();const g=r.value>=0?r.value:0;u(l.value[g])}else m.key==="Escape"&&d()};return(m,g)=>(_(),P("div",{class:ie(["search-wrap",{open:i.value}])},[i.value&&l.value.length?(_(),P("ul",v5,[(_(!0),P(ge,null,Qe(l.value,(b,B)=>(_(),P("li",{key:B,class:ie(["search-item",{active:B===r.value}]),role:"option","aria-selected":B===r.value,onMouseenter:D=>r.value=B,onClick:D=>u(b)},[b.icon?(_(),P("img",{key:0,src:L(Y)(b.icon),class:"search-item-icon",alt:""},null,8,P5)):V("",!0),c("div",U5,[c("div",E5,w(b.name),1),c("div",B5,w(b.groupName),1)])],42,C5))),128))])):i.value&&s.value&&!l.value.length?(_(),P("div",I5," 找不到「"+w(s.value)+"」相關停車場 ",1)):V("",!0),Ke(c("div",S5,[w5,Ke(c("input",{"onUpdate:modelValue":g[0]||(g[0]=b=>s.value=b),class:"search-input",type:"text",placeholder:"搜尋停車場名稱…",autofocus:"",onKeydown:h},null,544),[[It,s.value]]),s.value?(_(),P("button",{key:0,class:"search-clear",onClick:g[1]||(g[1]=b=>s.value=""),"aria-label":"清除"},D5)):V("",!0)],512),[[Bt,i.value]]),c("button",{class:ie(["search-toggle",{active:i.value}]),onClick:a,"aria-label":i.value?"關閉搜尋":"開啟搜尋","aria-expanded":i.value},[c("span",N5,w(i.value?"close":"search"),1)],10,T5)],2))}},R5=on(M5,[["__scopeId","data-v-2b0f75f6"]]),Tn=n=>(wn("data-v-95843aaa"),n=n(),kn(),n),x5={class:"editor-body"},O5={key:0,class:"editor-note override-note"},L5=Tn(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),F5={key:1,class:"editor-note"},H5=Tn(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),z5={class:"form-group"},V5={class:"form-label"},W5={key:0},j5={key:1,class:"hint-inline"},G5=["readonly","disabled"],K5={class:"form-group"},X5=Tn(()=>c("label",{class:"form-label"},"類別",-1)),Q5=["value"],Y5={class:"form-group"},q5={class:"form-label"},J5={key:0,class:"hint-inline"},$5=["disabled"],Z5=["value"],ep={class:"form-group"},np=Tn(()=>c("label",{class:"form-label"},"收費",-1)),tp={class:"chip-row"},op=["onClick"],ip={key:0,class:"price-amount"},sp={class:"unit"},rp={key:1,class:"price-amount"},lp={class:"form-group"},ap=Tn(()=>c("label",{class:"form-label"},"說明(選填)",-1)),cp={class:"form-group"},dp=Tn(()=>c("label",{class:"form-label"},"暱稱(選填)",-1)),hp=["value"],up={key:2,class:"error-msg"},pp={key:3,class:"form-group history-section"},mp={class:"form-label"},fp=Tn(()=>c("span",{class:"material-icons-outlined",style:{"font-size":"14px","vertical-align":"-2px"}},"history",-1)),yp={class:"history-list"},gp={class:"h-row1"},bp={class:"h-by"},Ap={class:"h-time"},_p={key:0,class:"h-diff h-diff-note"},vp={key:1,class:"h-diff-list"},Cp={class:"h-diff-label"},Pp={class:"h-diff-old"},Up=Tn(()=>c("span",{class:"h-diff-arrow"},"→",-1)),Ep={class:"h-diff-new"},Bp={key:2,class:"h-diff h-diff-note"},Ip=["disabled"],Sp=["disabled"],wp=["disabled"],kp=["disabled"],Dp={__name:"CommunityParkingEditor",props:{open:Boolean,mode:{type:String,default:"add"},initial:{type:Object,default:null},defaultCoord:{type:Array,default:()=>[121.5173399,25.0475613]},nickname:{type:String,default:""},isOwner:{type:Boolean,default:!1},isAdmin:{type:Boolean,default:!1},submitting:{type:Boolean,default:!1},hasExistingOverride:{type:Boolean,default:!1},history:{type:Array,default:()=>[]}},emits:["update:open","update:nickname","submit","delete","reset"],setup(n,{emit:e}){const t=n,o=e,i=E(""),s=E(""),r=E("motorcycle"),l=E("friendly"),a=E("free"),d=E(""),u=E(""),h=E([null,null]),m=J(()=>ht.filter(C=>C.value)),g=J(()=>Kt.filter(C=>C.value)),b={greenStar:"icon-14.png",friendlyShop:"icon-4.png",greenP:"icon-15.png",greyP:"icon-16.png",blueP:"icon-17.png",purpleP:"icon-18.png",redX:"icon-19.png",unknown:"icon-20.png"},B=J(()=>{if(b[r.value])return b[r.value];const C=ht.find(se=>se.value===r.value),T=Kt.find(se=>se.value===l.value);return C?T&&C.key.find(se=>T.key.includes(se))||C.key[0]:"icon-3.png"}),D=J(()=>!!b[r.value]);function U(C){if(!C)return{type:"free",amount:"",custom:""};const T=C.trim();if(/^free$/i.test(T))return{type:"free",amount:"",custom:""};const I=T.match(/^(\d+(?:\.\d+)?)\s*\/\s*([hd次])$/i);return I?{type:I[2].toLowerCase(),amount:I[1],custom:""}:{type:"custom",amount:"",custom:T}}function W(){return a.value==="free"?"Free":a.value==="custom"?u.value.trim():d.value?`${d.value}/${a.value}`:""}const N=()=>{if((t.mode==="edit"||t.mode==="override")&&t.initial){i.value=t.initial.name||"",s.value=t.initial.description||"",r.value=t.initial.category||"motorcycle",l.value=t.initial.friendliness||"friendly";const C=U(t.initial.priceInfo||"");a.value=C.type,d.value=C.amount,u.value=C.custom,h.value=t.initial.coordinates?[...t.initial.coordinates]:[...t.defaultCoord]}else i.value="",s.value="",r.value="motorcycle",l.value="friendly",a.value="free",d.value="",u.value="",h.value=[...t.defaultCoord]};X(()=>t.open,C=>{C&&N()});const j=E(""),Be=()=>{if(j.value="",!i.value.trim()){j.value="請輸入名稱";return}if(h.value[0]==null||h.value[1]==null||Number.isNaN(Number(h.value[0]))||Number.isNaN(Number(h.value[1]))){j.value="座標無效";return}o("submit",{name:i.value,description:s.value,iconKey:B.value,category:r.value,friendliness:D.value?"":l.value,priceInfo:W(),coordinates:[Number(h.value[0]),Number(h.value[1])]})},ae=()=>{var C;(C=t.initial)!=null&&C.id&&window.confirm(`確定要刪除「${i.value}」?此動作無法復原。`)&&o("delete",t.initial.id)},Ie=()=>{window.confirm(`確定要重設「${i.value}」回官方原始資料嗎?
你和其他車友先前的修改將被移除。`)&&o("reset")},_e=J({get:()=>t.open,set:C=>o("update:open",C)}),ue=[{value:"free",label:"免費"},{value:"h",label:"計時 / 小時"},{value:"d",label:"計次 / 天"},{value:"次",label:"計次 / 不限時"},{value:"custom",label:"其他"}],oe=E(!1),Se=J(()=>!t.history||t.history.length===0?[]:oe.value?t.history:t.history.slice(0,5)),Oe={create:"新增",update:"修改",delete:"刪除",override:"覆寫",reset:"重設"};function we(C){return Oe[C]||C||"變更"}function v(C){return C?C.nickname||(C.id?`匿名#${C.id}`:"匿名"):"系統"}function R(C){if(!C||!isFinite(Number(C)))return"";const T=new Date(Number(C)),I=se=>String(se).padStart(2,"0");return`${T.getFullYear()}/${I(T.getMonth()+1)}/${I(T.getDate())} ${I(T.getHours())}:${I(T.getMinutes())}`}const G={name:"名稱",description:"說明",iconKey:"圖示",category:"類別",friendliness:"友善度",priceInfo:"收費",lng:"經度",lat:"緯度"};function $(C){if(C==null||C==="")return"(空)";if(typeof C=="number")return String(C);const T=String(C);return T.length>40?T.slice(0,40)+"…":T}function q(C){return C==null?"":typeof C=="string"?C.trim():String(C)}function de(C){return q(C)===""}function sn(C,T){if(!C||C.action==="delete"||C.action==="reset")return[];if(C.after&&typeof C.after=="object")return Object.keys(C.after).filter(x=>{var Fe;const O=(Fe=C.before)==null?void 0:Fe[x],ce=C.after[x];return!(de(O)&&de(ce)||q(O)===q(ce)||de(O))}).map(x=>{var O;return{label:G[x]||x,before:$((O=C.before)==null?void 0:O[x]),after:$(C.after[x]),hasBefore:!0}});const I=C.snapshot;if(!I||typeof I!="object")return[];const se=new Set(["createdAt","createdBy","updatedAt","updatedBy","origName","origLng","origLat","history"]),Me=t.history.findIndex(pe=>pe._key===C._key),Le=Me>=0?t.history[Me+1]:null,gn=Le?Le.after&&typeof Le.after=="object"?{...Le.before||{},...Le.after}:Le.snapshot||null:null,rn=[];for(const pe of Object.keys(I)){if(se.has(pe))continue;const x=I[pe];if(gn&&Object.prototype.hasOwnProperty.call(gn,pe)){const O=gn[pe];if(q(O)===q(x)||de(O))continue;rn.push({label:G[pe]||pe,before:$(O),after:$(x),hasBefore:!0})}}return rn}function ke(C){return(C==null?void 0:C.action)==="delete"?"該項目被刪除":(C==null?void 0:C.action)==="reset"?"重設為官方資料":(C==null?void 0:C.action)==="create"?"新增此停車點":""}return(C,T)=>(_(),Fi(Ln,{modelValue:_e.value,"onUpdate:modelValue":T[9]||(T[9]=I=>_e.value=I),title:n.mode==="override"?"修改官方停車點":n.mode==="edit"?"編輯停車場":"新增停車場",size:"md"},{footer:dn(()=>[n.mode==="edit"&&n.isOwner?(_(),P("button",{key:0,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:ae}," 刪除 ",8,Ip)):V("",!0),n.mode==="override"&&n.hasExistingOverride&&n.isAdmin?(_(),P("button",{key:1,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:Ie,title:"僅站方可使用"}," 重設為官方資料 ",8,Sp)):V("",!0),c("button",{class:"btn btn-outline",disabled:n.submitting,onClick:T[8]||(T[8]=I=>_e.value=!1)}," 取消 ",8,wp),c("button",{class:"btn btn-primary",disabled:n.submitting,onClick:Be},w(n.submitting?"送出中…":n.mode==="override"||n.mode==="edit"?"儲存修改":"新增"),9,kp)]),default:dn(()=>[c("div",x5,[n.mode==="override"?(_(),P("p",O5,[L5,k(" 你正在「修改官方停車點」:這層修改只會疊加在官方資料之上,不會覆蓋原始資料。所有車友都會看到你的修改,也可以再被其他人修改或重設。 ")])):(_(),P("p",F5,[H5,k(" 共筆停車點:任何人都可以新增或修改。請確認資訊正確、避免不雅內容。 ")])),c("section",z5,[c("label",V5,[k(" 名稱 "),n.mode!=="override"?(_(),P("span",W5,"*")):V("",!0),n.mode==="override"?(_(),P("span",j5,"(官方名稱不可修改)")):V("",!0)]),Ke(c("input",{"onUpdate:modelValue":T[0]||(T[0]=I=>i.value=I),class:"form-control",type:"text",placeholder:"例:三張里地下停車場",maxlength:"60",readonly:n.mode==="override",disabled:n.mode==="override"},null,8,G5),[[It,i.value]])]),c("section",K5,[X5,Ke(c("select",{"onUpdate:modelValue":T[1]||(T[1]=I=>r.value=I),class:"form-control"},[(_(!0),P(ge,null,Qe(m.value,I=>(_(),P("option",{key:I.value,value:I.value},w(I.name),9,Q5))),128))],512),[[zs,r.value]])]),c("section",Y5,[c("label",q5,[k(" 友善程度 "),D.value?(_(),P("span",J5,"(此類別不適用)")):V("",!0)]),Ke(c("select",{"onUpdate:modelValue":T[2]||(T[2]=I=>l.value=I),class:"form-control",disabled:D.value},[(_(!0),P(ge,null,Qe(g.value,I=>(_(),P("option",{key:I.value,value:I.value},w(I.name),9,Z5))),128))],8,$5),[[zs,l.value]])]),c("section",ep,[np,c("div",tp,[(_(),P(ge,null,Qe(ue,I=>c("button",{key:I.value,type:"button",class:ie(["chip",{active:a.value===I.value}]),onClick:se=>a.value=I.value},w(I.label),11,op)),64))]),a.value==="h"||a.value==="d"||a.value==="次"?(_(),P("div",ip,[Ke(c("input",{"onUpdate:modelValue":T[3]||(T[3]=I=>d.value=I),type:"number",min:"0",step:"1",class:"form-control compact",placeholder:"金額"},null,512),[[It,d.value]]),c("span",sp," 元 / "+w(a.value==="h"?"小時":a.value==="d"?"天":"次 (不限時)"),1)])):a.value==="custom"?(_(),P("div",rp,[Ke(c("input",{"onUpdate:modelValue":T[4]||(T[4]=I=>u.value=I),type:"text",class:"form-control",placeholder:"如:平日 30/h、假日 50/d",maxlength:"40"},null,512),[[It,u.value]])])):V("",!0)]),c("section",lp,[ap,Ke(c("textarea",{"onUpdate:modelValue":T[5]||(T[5]=I=>s.value=I),class:"form-control",rows:"3",placeholder:"後牌辨析、24h、注意事項...",maxlength:"500"},null,512),[[It,s.value]])]),c("section",cp,[dp,c("input",{value:n.nickname,onInput:T[6]||(T[6]=I=>o("update:nickname",I.target.value)),class:"form-control",type:"text",placeholder:"留空將顯示「匿名#xxx-xxx」",maxlength:"20"},null,40,hp)]),j.value?(_(),P("p",up,w(j.value),1)):V("",!0),n.history.length?(_(),P("section",pp,[c("label",mp,[fp,k(" 修改紀錄 ("+w(n.history.length)+") ",1)]),c("ul",yp,[(_(!0),P(ge,null,Qe(Se.value,(I,se)=>(_(),P("li",{key:I._key,class:"history-item"},[c("div",gp,[c("span",{class:ie(["h-action",`h-action-${I.action||"other"}`])},w(we(I.action)),3),c("span",bp,w(v(I.by)),1),c("span",Ap,w(R(I.at)),1)]),ke(I)?(_(),P("div",_p,w(ke(I)),1)):sn(I,se).length?(_(),P("ul",vp,[(_(!0),P(ge,null,Qe(sn(I,se),(Me,Le)=>(_(),P("li",{key:Le,class:"h-diff-item"},[c("span",Cp,w(Me.label),1),Me.hasBefore?(_(),P(ge,{key:0},[c("span",Pp,w(Me.before),1),Up],64)):V("",!0),c("span",Ep,w(Me.after),1)]))),128))])):(_(),P("div",Bp,"(與上一筆相同)"))]))),128))]),n.history.length>5?(_(),P("button",{key:0,type:"button",class:"history-toggle",onClick:T[7]||(T[7]=I=>oe.value=!oe.value)},w(oe.value?"收起":`顯示全部 ${n.history.length} 筆`),1)):V("",!0)])):V("",!0)])]),_:1},8,["modelValue","title"]))}},Tp=on(Dp,[["__scopeId","data-v-95843aaa"]]),Np={class:"tour-card-head"},Mp={class:"tour-step-index"},Rp={class:"tour-title"},xp={key:0,class:"material-icons-outlined"},Op={class:"tour-desc"},Lp={class:"tour-actions"},Fp={key:0,class:"material-icons-outlined"},Hp={key:1,class:"material-icons-outlined"},An=8,zp=12,zr=300,oo=16,Vp={__name:"OnboardingTour",props:{active:{type:Boolean,default:!1},steps:{type:Array,required:!0}},emits:["update:active","finish"],setup(n,{emit:e}){const t=n,o=e,i=E(0),s=E(null),r=E(!1),l=J(()=>t.steps[i.value]||null),a=J(()=>i.value>=t.steps.length-1),d=async()=>{await Kr();const U=l.value;if(!U){s.value=null;return}const W=U.selector?document.querySelector(U.selector):null;if(!W){s.value=null;return}const N=W.getBoundingClientRect();if(N.width===0&&N.height===0){s.value=null;return}s.value={top:N.top,left:N.left,width:N.width,height:N.height}},u=async()=>{for(let U=0;U<8;U++){if(await d(),s.value)return;await new Promise(W=>setTimeout(W,150))}};X(()=>[t.active,i.value],async([U])=>{if(!U){r.value=!1;return}r.value=!1,await u(),r.value=!0},{immediate:!0});const h=()=>d();Kn(()=>{window.addEventListener("resize",h),window.addEventListener("scroll",h,!0)}),ut(()=>{window.removeEventListener("resize",h),window.removeEventListener("scroll",h,!0)});const m=J(()=>{const U=s.value;return U?{top:U.top-An+"px",left:U.left-An+"px",width:U.width+An*2+"px",height:U.height+An*2+"px",borderRadius:zp+"px"}:{display:"none"}}),g=J(()=>{var oe;const U=s.value,W=window.innerWidth,N=window.innerHeight;if(!U)return{top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:Math.min(zr,W-32)+"px"};const j=((oe=l.value)==null?void 0:oe.placement)||"auto";let Be=j;if(j==="auto"){const Se=N-(U.top+U.height),Oe=U.top;Be=Se>=Oe?"bottom":"top"}const ae=Math.min(zr,W-32);let Ie,_e,ue="";return Be==="bottom"?(Ie=U.top+U.height+oo+An,_e=Math.max(16,Math.min(W-ae-16,U.left+U.width/2-ae/2))):Be==="top"?(Ie=U.top-oo-An,_e=Math.max(16,Math.min(W-ae-16,U.left+U.width/2-ae/2)),ue="translateY(-100%)"):Be==="right"?(Ie=Math.max(16,U.top+U.height/2),_e=U.left+U.width+oo+An,ue="translateY(-50%)"):(Ie=Math.max(16,U.top+U.height/2),_e=U.left-oo-An,ue="translate(-100%, -50%)"),{top:Ie+"px",left:_e+"px",width:ae+"px",transform:ue}}),b=()=>{a.value?D():i.value+=1},B=()=>D(),D=()=>{o("update:active",!1),o("finish"),i.value=0};return X(()=>t.active,U=>{U&&(i.value=0)}),(U,W)=>n.active&&l.value?(_(),P("div",{key:0,class:ie(["tour-root",{"is-ready":r.value}])},[c("div",{class:"tour-spotlight",style:co(m.value)},null,4),c("div",{class:"tour-backdrop",onClick:Hi(b,["self"])}),c("div",{class:"tour-card",style:co(g.value),role:"dialog","aria-modal":"true"},[c("div",Np,[c("span",Mp,w(i.value+1)+" / "+w(n.steps.length),1),c("button",{class:"tour-skip",onClick:B,"aria-label":"略過導覽"},"略過")]),c("h3",Rp,[l.value.icon?(_(),P("span",xp,w(l.value.icon),1)):V("",!0),k(" "+w(l.value.title),1)]),c("p",Op,w(l.value.description),1),c("div",Lp,[c("button",{class:"btn btn-primary tour-next",onClick:b},[k(w(a.value?"完成":"下一步")+" ",1),a.value?(_(),P("span",Hp,"check")):(_(),P("span",Fp,"arrow_forward"))])])],4)],2)):V("",!0)}},Wp=on(Vp,[["__scopeId","data-v-1d730a34"]]),vn="community_parkings",Ri=E([]),Ra=E(!1),xi=E(null);let Rt=null,ai=0;function jp(){if(!(!hn||Rt))try{const n=Xh(Je(Xe,vn),Kh("updatedAt"));Rt=n,ka(n,e=>{const t=[];e.forEach(o=>{var s,r;const i=o.val()||{};t.push({id:o.key,name:i.name||"",description:i.description||"",iconKey:i.iconKey||"icon-3.png",category:i.category||"",friendliness:i.friendliness||"",priceInfo:i.priceInfo||"",coordinates:[(s=i.lng)!=null?s:null,(r=i.lat)!=null?r:null],createdBy:i.createdBy||null,updatedBy:i.updatedBy||null,createdAt:i.createdAt||null,updatedAt:i.updatedAt||null,history:Kp(i.history)})}),Ri.value=t.reverse(),Ra.value=!0},e=>{xi.value=e})}catch(n){xi.value=n}}function Gp(){Rt&&(Da(Rt),Rt=null)}function Kp(n){return!n||typeof n!="object"?[]:Object.entries(n).map(([e,t])=>({...t||{},_key:e})).sort((e,t)=>e._key<t._key?1:e._key>t._key?-1:0)}function Xp(){return Kn(()=>{ai+=1,jp()}),ut(()=>{ai-=1,ai<=0&&Gp()}),{items:Ri,ready:Ra,error:xi,addParking:async(o,i)=>{var m,g,b;if(!hn)throw new Error("Firebase 尚未設定");const[s,r]=o.coordinates,a=so(Je(Xe,vn)).key,d={id:i.id,nickname:i.nickname||""},u={name:((m=o.name)==null?void 0:m.trim())||"",description:((g=o.description)==null?void 0:g.trim())||"",iconKey:o.iconKey||"icon-3.png",category:o.category||"",friendliness:o.friendliness||"",priceInfo:((b=o.priceInfo)==null?void 0:b.trim())||"",lng:Number(s),lat:Number(r),createdBy:d,createdAt:Fn(),updatedBy:d,updatedAt:Fn()},h=so(Je(Xe,`${vn}/${a}/history`)).key;return await Di(Je(Xe),{[`${vn}/${a}`]:{...u,history:{[h]:{action:"create",at:Fn(),by:d,snapshot:u}}}}),a},updateParking:async(o,i,s)=>{var b,B,D,U,W;if(!hn)throw new Error("Firebase 尚未設定");const r={id:s.id,nickname:s.nickname||""},l=Ri.value.find(N=>N.id===o)||{},a={};if(i.name!==void 0&&(a.name=((b=i.name)==null?void 0:b.trim())||""),i.description!==void 0&&(a.description=((B=i.description)==null?void 0:B.trim())||""),i.iconKey!==void 0&&(a.iconKey=i.iconKey),i.category!==void 0&&(a.category=i.category),i.friendliness!==void 0&&(a.friendliness=i.friendliness),i.priceInfo!==void 0&&(a.priceInfo=((D=i.priceInfo)==null?void 0:D.trim())||""),i.coordinates){const[N,j]=i.coordinates;a.lng=Number(N),a.lat=Number(j)}const d={},u={};for(const N of Object.keys(a)){let j;N==="lng"?j=(U=l.coordinates)==null?void 0:U[0]:N==="lat"?j=(W=l.coordinates)==null?void 0:W[1]:j=l[N];const Be=j==null?"":j,ae=a[N]===void 0||a[N]===null?"":a[N];Be!==ae&&(d[N]=j!=null?j:"",u[N]=a[N])}const h={...a,updatedBy:r,updatedAt:Fn()},m=so(Je(Xe,`${vn}/${o}/history`)).key,g={};for(const N of Object.keys(h))g[`${vn}/${o}/${N}`]=h[N];return g[`${vn}/${o}/history/${m}`]={action:"update",at:Fn(),by:r,before:d,after:u},Di(Je(Xe),g)},deleteParking:async o=>{if(!hn)throw new Error("Firebase 尚未設定");return wa(Je(Xe,`${vn}/${o}`))}}}var Qp={VITE_FIREBASE_DATABASE_URL:"https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app",VITE_FIREBASE_MESSAGING_SENDER_ID:"976769533420",VITE_FIREBASE_MEASUREMENT_ID:"G-XMR8C87T1P",VITE_FIREBASE_STORAGE_BUCKET:"findparkinglot-2519e.firebasestorage.app",VITE_FIREBASE_AUTH_DOMAIN:"findparkinglot-2519e.firebaseapp.com",VITE_MAPBOX_TOKEN:"pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",VITE_FIREBASE_PROJECT_ID:"findparkinglot-2519e",VITE_FIREBASE_APP_ID:"1:976769533420:web:f3108318b3def30017acc9",VITE_FIREBASE_API_KEY:"AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs",BASE_URL:"./",MODE:"production",DEV:!1,PROD:!0,SSR:!1};const xa="community_user_id",Oa="community_user_nickname",Yp="community_is_admin",qp=String(Qp.VITE_ADMIN_USER_IDS||"").split(",").map(n=>n.trim()).filter(Boolean);function Jp(){const n=e=>Array.from(crypto.getRandomValues(new Uint8Array(e))).map(t=>t.toString(16).padStart(2,"0")).join("");return`${n(2)}-${n(2)}`}let ao=Ze.get(xa);ao||(ao=Jp(),Ze.set(xa,ao));const Oi=ao,Li=E(Ze.get(Oa)||""),$p=qp.includes(Oi)||Ze.get(Yp)==="1";X(Li,n=>Ze.set(Oa,n||""));function Zp(){return{userId:Oi,nickname:Li,displayName:()=>{var e;return((e=Li.value)==null?void 0:e.trim())||`匿名#${Oi}`},isAdmin:$p}}const em=()=>typeof window!="undefined"&&typeof window.gtag=="function",Ce=(n,e={})=>{if(em())try{window.gtag("event",n,e)}catch(t){}},S=n=>(wn("data-v-5a156f87"),n=n(),kn(),n),nm={class:"app-title"},tm=["aria-label","aria-expanded"],om={class:"material-icons-outlined"},im={key:1,class:"title-logo",src:zi,alt:"重機能停哪"},sm=S(()=>c("h1",null,"重機能停哪?",-1)),rm=S(()=>c("pre",{id:"coordinates",class:"coordinates"},null,-1)),lm=S(()=>c("h4",{class:"modal-section-title"},"圖案代表甚麼格位",-1)),am={class:"legend-list"},cm={class:"legend-row"},dm=["src"],hm={class:"legend-row"},um=["src"],pm={class:"legend-row"},mm=["src"],fm={class:"legend-row"},ym=["src"],gm={class:"legend-row"},bm=["src"],Am={class:"legend-row"},_m=["src"],vm={class:"legend-row"},Cm=["src"],Pm={class:"legend-row"},Um=["src"],Em={class:"legend-row"},Bm=["src"],Im={class:"legend-row"},Sm=["src"],wm={class:"legend-row"},km=["src"],Dm=S(()=>c("h4",{class:"modal-section-title"},"顏色代表入場方式",-1)),Tm={class:"legend-list"},Nm={class:"legend-row"},Mm=["src"],Rm=["src"],xm=["src"],Om={class:"legend-row"},Lm=["src"],Fm=["src"],Hm=["src"],zm={class:"legend-row"},Vm=["src"],Wm=["src"],jm=["src"],Gm={class:"legend-row"},Km=["src"],Xm=["src"],Qm=["src"],Ym=S(()=>c("h4",{class:"modal-section-title"},"名稱前有價錢",-1)),qm={class:"legend-list"},Jm={class:"legend-row"},$m=["src"],Zm=S(()=>c("div",{class:"legend-row"},[c("div",{class:"legend-text"},[k(" ・數字:金額,時段費率複雜會以最高收費標示"),c("br"),k(" ・d/h:d 為計次,h 為計時"),c("br"),k(" ・Free 代表免費 ")])],-1)),e4={class:"share-grid"},n4=S(()=>c("img",{src:Qr,alt:""},null,-1)),t4=S(()=>c("span",null,"Facebook",-1)),o4=[n4,t4],i4=S(()=>c("img",{src:Yr,alt:""},null,-1)),s4=S(()=>c("span",null,"LINE",-1)),r4=[i4,s4],l4=S(()=>c("img",{src:qr,alt:""},null,-1)),a4=S(()=>c("span",null,"Twitter",-1)),c4=[l4,a4],d4=S(()=>c("img",{src:Jr,alt:""},null,-1)),h4=S(()=>c("span",null,"複製連結",-1)),u4=[d4,h4],p4={class:"modal-hint",style:{"word-break":"break-all"}},m4={class:"share-grid"},f4=S(()=>c("img",{src:Qr,alt:""},null,-1)),y4=S(()=>c("span",null,"Facebook",-1)),g4=[f4,y4],b4=S(()=>c("img",{src:Yr,alt:""},null,-1)),A4=S(()=>c("span",null,"LINE",-1)),_4=[b4,A4],v4=S(()=>c("img",{src:qr,alt:""},null,-1)),C4=S(()=>c("span",null,"Twitter",-1)),P4=[v4,C4],U4=S(()=>c("img",{src:Jr,alt:""},null,-1)),E4=S(()=>c("span",null,"複製連結",-1)),B4=[U4,E4],I4={class:"os-tabs",role:"tablist","aria-label":"作業系統"},S4=["aria-selected"],w4=S(()=>c("span",{class:"material-icons-outlined"},"phone_iphone",-1)),k4=["aria-selected"],D4=S(()=>c("span",{class:"material-icons-outlined"},"android",-1)),T4=S(()=>c("p",{class:"modal-hint"},"以下以 iOS Safari 為範例",-1)),N4=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Safari 開啟網站並點擊下方分享按鈕",-1)),M4=S(()=>c("img",{class:"full-img",src:hc,alt:""},null,-1)),R4=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「加入主畫面」",-1)),x4=S(()=>c("img",{class:"full-img",src:uc,alt:""},null,-1)),O4=S(()=>c("h4",{class:"modal-section-title"},"3. 確認名稱後按「加入」",-1)),L4=S(()=>c("img",{class:"full-img",src:pc,alt:""},null,-1)),F4=S(()=>c("h4",{class:"modal-section-title"},"4. 完成,圖示已加到主畫面",-1)),H4=S(()=>c("img",{class:"full-img",src:mc,alt:""},null,-1)),z4=S(()=>c("h4",{class:"modal-section-title"},"5. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),V4=S(()=>c("img",{class:"full-img",src:fc,alt:""},null,-1)),W4=S(()=>c("p",{class:"modal-hint"},"以下以 Android Chrome 為範例",-1)),j4=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Chrome 開啟網站並點擊右上角選單，點選「加到主畫面」",-1)),G4=S(()=>c("img",{class:"full-img",src:yc,alt:""},null,-1)),K4=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「安裝」",-1)),X4=S(()=>c("img",{class:"full-img",src:gc,alt:""},null,-1)),Q4=S(()=>c("h4",{class:"modal-section-title"},"3. 完成,圖示已加到主畫面",-1)),Y4=S(()=>c("img",{class:"full-img",src:bc,alt:""},null,-1)),q4=S(()=>c("h4",{class:"modal-section-title"},"4. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),J4=S(()=>c("img",{class:"full-img",src:Ac,alt:""},null,-1)),$4=S(()=>c("div",{class:"welcome-logo-wrap"},[c("img",{class:"welcome-logo",src:zi,alt:"重機能停哪"})],-1)),Z4=S(()=>c("div",{class:"welcome-badge"},"✨ 全新介面上線",-1)),ef=S(()=>c("p",{class:"welcome-text"}," 這是一個提供重機停車資訊的地圖，你可以依據「友善程度」「停車格類型」「收費範圍」尋找合適的停車場，並一鍵開啟 Google 或 Apple Map 導航。 ",-1)),nf=S(()=>c("div",{class:"whatsnew-card"},[c("div",{class:"whatsnew-title"},[c("span",{class:"material-icons-outlined"},"auto_awesome"),k(" 本次新功能 ")]),c("ul",{class:"whatsnew-list"},[c("li",null,[c("span",{class:"material-icons-outlined"},"star"),c("span",null,[c("strong",null,"我的最愛"),c("br"),k(" 可以將喜歡的停車場加入我的最愛")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"search"),c("span",null,[c("strong",null,"地點搜尋"),c("br"),k(" 可以搜尋指定的停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_location_alt"),c("span",null,[c("strong",null,"共筆停車點"),c("br"),k(" 可自由新增、編輯, 大家一起分享停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_note"),c("span",null,[c("strong",null,"官方點異議 / 補充"),c("br"),k(" 點開任一官方停車點 → 「異議 / 補充」, 可在不改動原始資料的前提下, 補上實際費率、更正分類或加註說明, 全車友共享")])])])],-1)),tf=S(()=>c("p",{class:"welcome-text"},[k(" 資料取源於: "),c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"link"},"Alan大重停車記事"),k("，如有停車場相關問題請至該頁面填寫回報表單。 ")],-1)),of=S(()=>c("p",{class:"welcome-text"},' 公告: 原始資料"大重停車記事已無更新" 已改由 Alan大重停車記事 提供，感謝Alan的辛苦整理與分享！ ',-1)),sf=S(()=>c("p",{class:"welcome-text"},[k(" 本站僅提供資料整合服務，地圖免費提供車友使用，資料不定期更新；若發生無法使用情況，請至 "),c("a",{href:"https://forms.gle/iJCyfqVtpL35WtZM7",target:"_blank",rel:"noopener",class:"link"},"錯誤資訊回報"),k("，也歡迎 "),c("a",{href:"https://buymeacoffee.com/jamestim923",target:"_blank",rel:"noopener",class:"link"},"請我喝杯咖啡 ☕️"),k("讓我有動力繼續更新。 ")],-1)),rf=S(()=>c("p",{class:"welcome-text right"},"— by 爽爽",-1)),lf={key:0,class:"pick-crosshair","aria-hidden":"true"},af=S(()=>c("span",{class:"material-icons-outlined dot"},"gps_fixed",-1)),cf=[af],df={key:1,class:"pick-banner"},hf=S(()=>c("span",{class:"pick-banner-text"},[c("span",{class:"material-icons-outlined"},"touch_app"),k(" 拖動地圖，將十字線對準目標位置 ")],-1)),uf=S(()=>c("span",{class:"material-icons-outlined"},"check",-1)),pf=S(()=>c("p",{class:"welcome-text"},[c("strong",{style:{color:"var(--primary)"}},"這是一個公開共享的「共筆停車點」區。"),k(" 除了官方收錄的「大重停車記事」資料外,任何人都可以新增、修改、補充停車位置——不需要註冊、不需要審核。 ")],-1)),mf=S(()=>c("h4",{class:"modal-section-title"},"如何新增停車位置",-1)),ff=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"點左下角的「共筆停車點」按鈕,再點「新增停車位置」"),c("li",null,"畫面中心會出現青色十字游標,拖動地圖將游標對準目標位置"),c("li",null,"按頂部「使用此位置」,填寫名稱、類別、友善程度、收費等資料"),c("li",null,"按「新增」即完成(座標已自動記錄,圖示會依類別自動套用)")],-1)),yf=S(()=>c("h4",{class:"modal-section-title"},"如何編輯他人新增的位置",-1)),gf=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"地圖上「薰衣草紫色底」的標記即為使用者新增的「共筆停車點」"),c("li",null,"點擊該標記,在資訊面板按「編輯」"),c("li",null,"修改後按「儲存修改」")],-1)),bf=S(()=>c("h4",{class:"modal-section-title"},"注意事項",-1)),Af=S(()=>c("ul",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"請確認資訊正確,避免造成他人困擾"),c("li",null,"不要新增不雅、惡意或無關內容"),c("li",null,"暱稱可選填,留空將顯示為「匿名#xxx-xxx」"),c("li",null,"站方保留必要時清空所有「共筆停車點」資料的權利")],-1)),Vr="onboarding_tour_v1",Wr="filters_v1",_f="https://findparkinglot.github.io/",vf={__name:"App",setup(n){var Rs,xs,Os;const e=navigator.userAgent,t=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(e),o=/iPhone|iPad|iPod/i.test(e),i=/Android/i.test(e),s=E([]),r=()=>{var p;return!!((p=window.matchMedia)!=null&&p.call(window,"(prefers-color-scheme: light)").matches)},l=p=>{var f;if(p==="system"){const y=r()?"light":"dark";return(f=nt.find(me=>me.theme===y))==null?void 0:f.value}return p},a=nt.find(p=>p.name===Ze.get("mapStyles")),d=(a==null?void 0:a.value)||((Rs=nt.find(p=>p.theme==="dark"))==null?void 0:Rs.value),u=E(d),h=E({getLngLat:!1,mapStylesSelected:l(d)}),m=p=>{const f=l(p);h.value.mapStylesSelected=f;const y=nt.find(he=>he.value===f),me=(y==null?void 0:y.theme)==="light";document.body.classList.toggle("light-theme",me),document.body.classList.toggle("dark-theme",!me);const Ve=nt.find(he=>he.value===p);Ve&&Ze.set("mapStyles",Ve.name)};m(u.value),X(u,m);const g=(xs=window.matchMedia)==null?void 0:xs.call(window,"(prefers-color-scheme: light)");(Os=g==null?void 0:g.addEventListener)==null||Os.call(g,"change",()=>{u.value==="system"&&m("system")});const b=E(!0),B=E(!1),D=E(i?"android":"ios"),U=E(!1),W=E(!1),N=E(!1),j=E(!1),Be=[{selector:".mapboxgl-ctrl-geolocate",icon:"my_location",title:"定位你的位置",description:"點右上角的定位按鈕,地圖會自動移到你目前位置,並追蹤方向。"},{selector:".fab-placement-right > .fab-main",icon:"help_outline",title:"功能與教學",description:"右下角的圓形按鈕展開後,可看到「地圖怎麼看」、「加到手機桌面」、「分享」等功能。"},{selector:".search-toggle",icon:"search",title:"搜尋停車點",description:"右下角的搜尋按鈕可依名稱快速找到想去的停車場,點選結果會自動飛到該位置並開啟資訊。"},{selector:".app-title .title-toggle",icon:"menu",title:"篩選與我的最愛",description:"左上角選單可以調整停車類型、友善程度、收費範圍,以及只顯示我的最愛、切換主題。"},{selector:".fab-placement-left > .fab-main",icon:"add_location_alt",title:"共筆停車點",description:"左下角按鈕可新增/編輯共筆停車點,大家一起分享真實的停車資訊。"}],ae=()=>{j.value=!0,Ce("onboarding_tour_start")},Ie=()=>{try{localStorage.setItem(Vr,"1")}catch(p){}Ce("onboarding_tour_finish")},_e=()=>{b.value=!1},ue=E(!1),oe=E(!1),Se=E(!1),Oe=p=>{p!=="menu"&&(ue.value=!1),p!=="info"&&(oe.value=!1),p!=="message"&&(b.value=!1),p!=="mobileFAQ"&&(B.value=!1),p!=="faq"&&(U.value=!1),p!=="share"&&(W.value=!1),p!=="communityHelp"&&(N.value=!1),Ce("panel_open",{panel:p})};X(ue,p=>p&&Oe("menu")),X(oe,p=>p&&Oe("info")),X(b,p=>p&&Oe("message")),X(B,p=>p&&Oe("mobileFAQ")),X(B,p=>{p&&(i?D.value="android":o&&(D.value="ios"))}),X(U,p=>p&&Oe("faq")),X(W,p=>p&&Oe("share")),X(N,p=>p&&Oe("communityHelp"));const we=Ze.getJSON(Wr,{})||{},v=E(typeof we.parkingType=="string"?we.parkingType:""),R=E(typeof we.degreeOfFriendliness=="string"?we.degreeOfFriendliness:""),G=E(typeof we.parkingPriceType=="string"?we.parkingPriceType:""),$=E(typeof we.priceRangeMin=="number"?we.priceRangeMin:0),q=E(typeof we.priceRangeMax=="number"?we.priceRangeMax:100),{favorites:de,favoriteIdSet:sn,isFavorite:ke,toggleFavorite:C}=od(),T=E(we.onlyFavorites===!0);X([v,R,G,$,q,T],([p,f,y,me,Ve,he])=>{Ze.setJSON(Wr,{parkingType:p,degreeOfFriendliness:f,parkingPriceType:y,priceRangeMin:me,priceRangeMax:Ve,onlyFavorites:he})});const I=E("driving"),{items:se,addParking:Me,updateParking:Le,deleteParking:gn}=Xp(),{userId:rn,nickname:pe,isAdmin:x}=Zp(),O=E(null),{overrides:ce,getOverride:Fe,getOverrideHistory:He,upsertOverride:ve,resetOverride:Nn}=cu(),De=J(()=>new Set(Object.keys(ce.value||{}))),Te=E(!1),ln=E("add"),an=E(null),je=E(!1),gt=E([121.5173399,25.0475613]),Ss=E(!1),cn=E(!1),Wo=E(!1),ws=J(()=>!oe.value&&!Se.value&&!cn.value&&!Te.value),ks=()=>{Wo.value&&ws.value&&(Wo.value=!1,ae())};X(b,(p,f)=>{if(f&&!p)try{localStorage.getItem(Vr)||(Wo.value=!0,setTimeout(ks,350))}catch(y){}}),X(ws,p=>{p&&setTimeout(ks,200)});const La=J(()=>{var p;if(!Te.value)return[];if(ln.value==="override")return Ge.value?He(Ge.value.name,Ge.value.geometry):[];if(ln.value==="edit"&&((p=an.value)!=null&&p.id)){const f=(se.value||[]).find(y=>y.id===an.value.id);return(f==null?void 0:f.history)||[]}return[]}),ze=E(null),Fa=()=>{if(!hn){alert("「共筆停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}cn.value=!0,Ce("community_add_start")},Ha=()=>{var f,y;const p=((y=(f=O.value)==null?void 0:f.getCenter)==null?void 0:y.call(f))||[121.5173399,25.0475613];gt.value=p,ln.value="add",an.value=null,cn.value=!1,Te.value=!0},za=()=>{cn.value=!1},Va=p=>{var f,y;gt.value=p.coordinates?[...p.coordinates]:((y=(f=O.value)==null?void 0:f.getCenter)==null?void 0:y.call(f))||[121.5173399,25.0475613],ln.value="edit",an.value=p,Te.value=!0},jo=p=>{ze.value=p,qn({name:"共筆停車點",properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.coordinates,address:""})},Wa=()=>{ze.value&&(oe.value=!1,Va(ze.value))},ja=()=>{if(!hn){alert("「修改官方停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}if(!Ge.value)return;const p=Ge.value,f=Zt.value,y={id:null,name:p.name,description:(f==null?void 0:f.description)||p.description,iconKey:(f==null?void 0:f.iconKey)||p.iconKey,category:(f==null?void 0:f.category)||Ga(p.iconKey),friendliness:(f==null?void 0:f.friendliness)||Ka(p.iconKey),priceInfo:(f==null?void 0:f.priceInfo)||p.priceInfo,coordinates:p.geometry?[...p.geometry]:[...gt.value]};gt.value=y.coordinates,ln.value="override",an.value=y,Ss.value=!!f,oe.value=!1,Te.value=!0,Ce("override_edit_start",{name:p.name})};function Ga(p){if(!p)return"motorcycle";const f=ht.find(y=>y.value&&y.key.includes(p));return(f==null?void 0:f.value)||"motorcycle"}function Ka(p){if(!p)return"friendly";const f=Kt.find(y=>y.value&&y.key.includes(p));return(f==null?void 0:f.value)||"friendly"}const Xa=async p=>{if(Ge.value){je.value=!0;try{const f={id:rn,nickname:pe.value};await ve(Ge.value,p,f),Ce("override_submit",{name:Ge.value.name});const y=Ge.value;Te.value=!1,qn({name:y.parkingType,properties:{name:y.name,description:y.description,icon:y.iconKey,priceInfo:y.priceInfo,priceArray:[]},geometry:y.geometry,address:Z.value.address})}catch(f){alert("儲存失敗:"+((f==null?void 0:f.message)||f))}finally{je.value=!1}}},Qa=async()=>{if(Ge.value){je.value=!0;try{const p=Ge.value,f={id:rn,nickname:pe.value};await Nn(p.name,p.geometry,f),Ce("override_reset",{name:p.name}),Te.value=!1,qn({name:p.parkingType,properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.geometry,address:Z.value.address})}catch(p){alert("重設失敗:"+((p==null?void 0:p.message)||p))}finally{je.value=!1}}},Ya=async p=>{var f;je.value=!0;try{const y={id:rn,nickname:pe.value};ln.value==="edit"&&((f=an.value)!=null&&f.id)?(await Le(an.value.id,p,y),Ce("community_edit_submit",{name:p==null?void 0:p.name})):(await Me(p,y),Ce("community_add_submit",{name:p==null?void 0:p.name})),Te.value=!1,ze.value=null}catch(y){alert("儲存失敗:"+((y==null?void 0:y.message)||y))}finally{je.value=!1}},qa=async p=>{je.value=!0;try{const f={id:rn,nickname:pe.value};await gn(p,f),Ce("community_delete",{id:p}),Te.value=!1,ze.value=null}catch(f){alert("刪除失敗:"+((f==null?void 0:f.message)||f))}finally{je.value=!1}},Go=J(()=>{var f,y;if(!ze.value||!Z.value.parkingName)return!1;const p=ze.value;return p.name===Z.value.parkingName&&Array.isArray(Z.value.geometry)&&((f=p.coordinates)==null?void 0:f[0])===Z.value.geometry[0]&&((y=p.coordinates)==null?void 0:y[1])===Z.value.geometry[1]});X(oe,p=>{p||(ze.value=null)});const bt=E(null),Ja=J(()=>{var p;return((p=ht.find(f=>f.value===v.value))==null?void 0:p.key)||[]}),$a=J(()=>{var p;return((p=Kt.find(f=>f.value===R.value))==null?void 0:p.key)||[]}),Z=E({parkingName:"",parkingNameDes:"",parkingType:"",parkingIcon:"",parkingIconKey:"",iconCategory:"",priceInfo:"",geometry:[null,null],address:"",sourceLabel:""}),Ge=E(null),Zt=E(null),Ds=J(()=>ci(Z.value.parkingName,Z.value.geometry)),Ts=J(()=>ke(Ds.value)),qn=p=>{var $n,Zn,Ls,Fs,Hs;const f=p.properties.icon,y={name:p.properties.name,description:p.properties.description,iconKey:f,priceInfo:p.properties.priceInfo||"",geometry:p.geometry,parkingType:p.name},me=!!(ze.value&&ze.value.name===p.properties.name&&Array.isArray(p.geometry)&&(($n=ze.value.coordinates)==null?void 0:$n[0])===p.geometry[0]&&((Zn=ze.value.coordinates)==null?void 0:Zn[1])===p.geometry[1]);let Ve=null,he=y;me||(Ve=Fe(y.name,y.geometry),Ve&&(he=Na(y,Ve))),Ge.value=me?null:y,Zt.value=Ve,Z.value={parkingName:he.name,parkingNameDes:he.description,parkingType:y.parkingType,iconCategory:Su(he.iconKey),parkingIcon:Y(he.iconKey),parkingIconKey:he.iconKey,priceInfo:he.priceInfo||"",geometry:p.geometry,address:p.address,sourceLabel:me?"":Qc((Ls=p.properties)==null?void 0:Ls.sourceFolderIndex)},oe.value=!0,Ce("parking_view",{parking_name:(Fs=p.properties)==null?void 0:Fs.name,parking_type:p.name,icon:(Hs=p.properties)==null?void 0:Hs.icon,overridden:!!Ve})},Za=()=>{if(!Z.value.parkingName)return;const p=!Ts.value;C({id:Ds.value,name:Z.value.parkingName,parkingType:Z.value.parkingType,geometry:Z.value.geometry,address:Z.value.address,icon:Z.value.parkingIconKey}),Ce(p?"favorite_add":"favorite_remove",{parking_name:Z.value.parkingName,parking_type:Z.value.parkingType})},ec=p=>"",nc=p=>{var f;p.isCommunity&&p.community?jo(p.community):qn({name:p.groupName,properties:p.properties,geometry:p.geometry,address:ec(p.geometry)}),bt.value=[...p.geometry],Ce("search_select",{parking_name:(f=p.properties)==null?void 0:f.name,group:p.groupName,community:!!p.isCommunity})},At=E(null),_t=E(null),tc=p=>{I.value="driving",At.value=p,oe.value=!1,_t.value=null,Ce("route_start",{parking_name:Z.value.parkingName,profile:"driving"})},oc=()=>{At.value=null,Se.value=!1};X(_t,p=>{Se.value=p!==null});const ic=p=>{const f=Z.value.geometry;let y="";p==="apple"?y=`https://maps.apple.com/?daddr=${f[1]},${f[0]}&dirflg=d&t=m`:p==="google"&&(y=`https://www.google.com/maps/dir/?api=1&destination=${f[1]},${f[0]}&travelmode=driving`),y&&(Ce("open_external_map",{provider:p,parking_name:Z.value.parkingName}),window.open(y,"_blank","noopener,noreferrer"))},bn=(p,f=null)=>{const y=f||"https://findparkinglot.github.io/";let me="";p==="facebook"?me=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(y)}`:p==="line"?me=`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(y)}`:p==="twitter"&&(me=`https://twitter.com/share?url=${encodeURIComponent(y)}`),Ce("share",{method:p,scope:f?"spot":"site"}),p==="link"?navigator.clipboard.writeText(y).then(()=>alert("已複製連結"),()=>alert("複製失敗")):window.open(me,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},Ns=()=>{const p=Z.value.geometry;if(!Array.isArray(p)||p[0]==null||p[1]==null)return"";const f=new URLSearchParams({lng:Number(p[0]).toFixed(6),lat:Number(p[1]).toFixed(6)});return`${_f}?${f.toString()}`},sc=()=>{const p=Ns();p&&(Jn.value=p,Xo.value=Z.value.parkingName||"停車點",Ko.value=!0,Ce("share_spot_open",{name:Xo.value}))},Ko=E(!1),Jn=E(""),Xo=E("");X([oe,Z],()=>{try{if(!oe.value){window.location.search&&window.history.replaceState({},"",window.location.pathname);return}const p=Ns();if(!p)return;const f=p.slice(p.indexOf("?"));window.history.replaceState({},"",window.location.pathname+f)}catch(p){}},{deep:!0});const vt=E(null),eo=(p,f)=>Math.abs(Number(p)-Number(f))<1e-5,Qo=()=>{var Ve;const p=vt.value;if(!p)return;const f=Number(p.lng),y=Number(p.lat);if(!isFinite(f)||!isFinite(y)){vt.value=null;return}const me=(se.value||[]).find(he=>he.coordinates&&eo(he.coordinates[0],f)&&eo(he.coordinates[1],y));if(me){jo(me),bt.value=[f,y],vt.value=null;return}for(const he of s.value||[])for(const $n of he.features||[]){const Zn=(Ve=$n.geometry)==null?void 0:Ve.coordinates;if(Zn&&eo(Zn[0],f)&&eo(Zn[1],y)){qn({name:he.name,properties:$n.properties,geometry:$n.geometry.coordinates,address:""}),bt.value=[f,y],vt.value=null;return}}Array.isArray(s.value)&&s.value.length>0&&(bt.value=[f,y])},Ms=()=>{try{const p=new URLSearchParams(window.location.search),f=p.get("lng"),y=p.get("lat");if(!f||!y)return;vt.value={lng:f,lat:y},Qo()}catch(p){}};X(se,Qo,{deep:!1}),X(s,Qo,{deep:!1}),Kn(()=>{s.value=td(Kc()),b.value||Ms()}),X(b,(p,f)=>{f&&!p&&Ms()});const rc=J(()=>[{key:"share",icon:"share",label:"分享",highlight:!0,onClick:()=>W.value=!0},{key:"howto",icon:"help_outline",label:"怎麼用",onClick:ae},{key:"faq",icon:"map",label:"地圖怎麼看",onClick:()=>U.value=!0},{key:"mobile",icon:"add_to_home_screen",label:"加到手機桌面",onClick:()=>B.value=!0}]),lc=J(()=>[{key:"add",icon:"add_location_alt",label:"新增停車位置",highlight:!0,onClick:Fa},{key:"help",icon:"menu_book",label:"編輯教學",onClick:()=>N.value=!0}]);return(p,f)=>(_(),P(ge,null,[c("div",nm,[cn.value?(_(),P("img",im)):(_(),P("button",{key:0,class:"title-toggle",onClick:f[0]||(f[0]=y=>ue.value=!ue.value),"aria-label":ue.value?"收合設定":"開啟設定","aria-expanded":ue.value},[c("span",om,w(ue.value?"close":"menu"),1)],8,tm)),sm]),Ke(Ee(Hr,{items:rc.value},null,8,["items"]),[[Bt,!Se.value&&!oe.value&&!cn.value]]),Ke(Ee(Hr,{items:lc.value,placement:"left","main-icon":"add_location_alt","main-label":"共筆停車點"},null,8,["items"]),[[Bt,!Se.value&&!oe.value&&!cn.value]]),Ke(Ee(R5,{"map-data-list":s.value,"community-parkings":L(se),onSelect:nc},null,8,["map-data-list","community-parkings"]),[[Bt,!Se.value&&!oe.value&&!cn.value]]),rm,Ee(mu,{ref_key:"mapBoxRef",ref:O,parkingTypeKeyArray:Ja.value,degreeOfFriendlinessKeyArray:$a.value,mapDataList:s.value,getLngLat:h.value.getLngLat,mapStylesSelected:h.value.mapStylesSelected,parkingPriceType:G.value,priceRangeMin:$.value,priceRangeMax:q.value,"favorite-ids":L(sn),"override-keys":De.value,overrides:L(ce),"only-favorites":T.value,"focus-coord":bt.value,"route-profile":I.value,"community-parkings":L(se),goToParkingPlaceData:At.value,"onUpdate:goToParkingPlaceData":f[1]||(f[1]=y=>At.value=y),routeData:_t.value,"onUpdate:routeData":f[2]||(f[2]=y=>_t.value=y),onParkingInfo:qn,onCommunityParkingClick:jo},null,8,["parkingTypeKeyArray","degreeOfFriendlinessKeyArray","mapDataList","getLngLat","mapStylesSelected","parkingPriceType","priceRangeMin","priceRangeMax","favorite-ids","override-keys","overrides","only-favorites","focus-coord","route-profile","community-parkings","goToParkingPlaceData","routeData"]),Ee(A5,{"route-data":_t.value,active:Se.value,profile:I.value,"onUpdate:profile":f[3]||(f[3]=y=>I.value=y),onCancel:oc},null,8,["route-data","active","profile"]),Ee(v3,{parkingType:v.value,"onUpdate:parkingType":f[4]||(f[4]=y=>v.value=y),degreeOfFriendliness:R.value,"onUpdate:degreeOfFriendliness":f[5]||(f[5]=y=>R.value=y),parkingPriceType:G.value,"onUpdate:parkingPriceType":f[6]||(f[6]=y=>G.value=y),priceRangeMin:$.value,"onUpdate:priceRangeMin":f[7]||(f[7]=y=>$.value=y),priceRangeMax:q.value,"onUpdate:priceRangeMax":f[8]||(f[8]=y=>q.value=y),mapStyle:u.value,"onUpdate:mapStyle":f[9]||(f[9]=y=>u.value=y),active:ue.value,"onUpdate:active":f[10]||(f[10]=y=>ue.value=y),onlyFavorites:T.value,"onUpdate:onlyFavorites":f[11]||(f[11]=y=>T.value=y),"favorites-count":L(de).length},null,8,["parkingType","degreeOfFriendliness","parkingPriceType","priceRangeMin","priceRangeMax","mapStyle","active","onlyFavorites","favorites-count"]),Ke(Ee(o5,{info:Z.value,active:oe.value,"is-mobile":L(t),"is-apple":L(o),"is-android":L(i),"has-route":At.value!==null,"is-favorite":Ts.value,"is-community":Go.value,"community-meta":Go.value?ze.value:null,"is-overridden":!Go.value&&!!Zt.value,"override-meta":Zt.value,onClose:f[12]||(f[12]=y=>oe.value=!1),onRoute:f[13]||(f[13]=y=>tc(Z.value.geometry)),onOpenMap:ic,onToggleFavorite:Za,onEditCommunity:Wa,onEditOverride:ja,onShare:sc},null,8,["info","active","is-mobile","is-apple","is-android","has-route","is-favorite","is-community","community-meta","is-overridden","override-meta"]),[[Bt,!Se.value]]),Ee(Ln,{modelValue:U.value,"onUpdate:modelValue":f[14]||(f[14]=y=>U.value=y),title:"地圖怎麼看?","close-text":"知道了",size:"lg"},{default:dn(()=>[lm,c("div",am,[c("div",cm,[c("img",{src:L(Y)("icon-3.png"),alt:""},null,8,dm),k(" 汽車：汽車格(含未確認是否有重機格) ")]),c("div",hm,[c("img",{src:L(Y)("icon-8.png"),alt:""},null,8,um),k(" 重機(有人):有設重機專用格 ")]),c("div",pm,[c("img",{src:L(Y)("icon-10.png"),alt:""},null,8,mm),k(" 機車(沒人):機車格 ")]),c("div",fm,[c("img",{src:L(Y)("icon-14.png"),alt:""},null,8,ym),k(" 綠星:路邊友善車格 ")]),c("div",gm,[c("img",{src:L(Y)("icon-4.png"),alt:""},null,8,bm),k(" 重機友善店家:用餐/消費時可停重機的店家 ")]),c("div",Am,[c("img",{src:L(Y)("icon-15.png"),alt:""},null,8,_m),k(" 綠P:重機專用路邊停車格 ")]),c("div",vm,[c("img",{src:L(Y)("icon-16.png"),alt:""},null,8,Cm),k(" 灰P:重機專用路邊停車格(未確認精準座標,歡迎回報) ")]),c("div",Pm,[c("img",{src:L(Y)("icon-17.png"),alt:""},null,8,Um),k(" 藍P:普通大型共用機車格(台北市試辦) ")]),c("div",Em,[c("img",{src:L(Y)("icon-18.png"),alt:""},null,8,Bm),k(" 紫P:時段性汽機車共用停車格 ")]),c("div",Im,[c("img",{src:L(Y)("icon-19.png"),alt:""},null,8,Sm),k(" 紅X:停都不給停 ")]),c("div",wm,[c("img",{src:L(Y)("icon-20.png"),alt:""},null,8,km),k(" ?:類型未確認,歡迎透過共筆回報 ")])]),Dm,c("div",Tm,[c("div",Nm,[c("img",{src:L(Y)("icon-2.png"),alt:""},null,8,Mm),c("img",{src:L(Y)("icon-6.png"),alt:""},null,8,Rm),c("img",{src:L(Y)("icon-9.png"),alt:""},null,8,xm),k(" 綠色最友善:有後牌辨析 ")]),c("div",Om,[c("img",{src:L(Y)("icon-5.png"),alt:""},null,8,Lm),c("img",{src:L(Y)("icon-12.png"),alt:""},null,8,Fm),c("img",{src:L(Y)("icon-11.png"),alt:""},null,8,Hm),k(" 藍色最傳統:悠遊卡 / 按鈕取票 ")]),c("div",zm,[c("img",{src:L(Y)("icon-1.png"),alt:""},null,8,Vm),c("img",{src:L(Y)("icon-13.png"),alt:""},null,8,Wm),c("img",{src:L(Y)("icon-7.png"),alt:""},null,8,jm),k(" 紅色最靠北:請管理員協助 / 倒退嚕前牌辨析 ")]),c("div",Gm,[c("img",{src:L(Y)("icon-3.png"),alt:""},null,8,Km),c("img",{src:L(Y)("icon-8.png"),alt:""},null,8,Xm),c("img",{src:L(Y)("icon-10.png"),alt:""},null,8,Qm),k(" 灰色未確定:有可能是上述任何情況,停到請回報 ")])]),Ym,c("div",qm,[c("div",Jm,[c("img",{src:L(Y)("icon-3.png"),alt:""},null,8,$m),k(" (30/h)三張里地下停車場 ")]),Zm])]),_:1},8,["modelValue"]),Ee(Ln,{modelValue:W.value,"onUpdate:modelValue":f[19]||(f[19]=y=>W.value=y),title:"分享給朋友",size:"sm"},{default:dn(()=>[c("div",e4,[c("button",{class:"share-btn",onClick:f[15]||(f[15]=y=>bn("facebook")),"aria-label":"Facebook"},o4),c("button",{class:"share-btn",onClick:f[16]||(f[16]=y=>bn("line")),"aria-label":"LINE"},r4),c("button",{class:"share-btn",onClick:f[17]||(f[17]=y=>bn("twitter")),"aria-label":"Twitter"},c4),c("button",{class:"share-btn",onClick:f[18]||(f[18]=y=>bn("link")),"aria-label":"複製連結"},u4)])]),_:1},8,["modelValue"]),Ee(Ln,{modelValue:Ko.value,"onUpdate:modelValue":f[24]||(f[24]=y=>Ko.value=y),title:`分享：${Xo.value}`,size:"sm"},{default:dn(()=>[c("p",p4,w(Jn.value),1),c("div",m4,[c("button",{class:"share-btn",onClick:f[20]||(f[20]=y=>bn("facebook",Jn.value)),"aria-label":"Facebook"},g4),c("button",{class:"share-btn",onClick:f[21]||(f[21]=y=>bn("line",Jn.value)),"aria-label":"LINE"},_4),c("button",{class:"share-btn",onClick:f[22]||(f[22]=y=>bn("twitter",Jn.value)),"aria-label":"Twitter"},P4),c("button",{class:"share-btn",onClick:f[23]||(f[23]=y=>bn("link",Jn.value)),"aria-label":"複製連結"},B4)])]),_:1},8,["modelValue","title"]),Ee(Ln,{modelValue:B.value,"onUpdate:modelValue":f[27]||(f[27]=y=>B.value=y),title:"如何加入手機桌面?","close-text":"知道了",size:"lg"},{default:dn(()=>[c("div",I4,[c("button",{type:"button",role:"tab","aria-selected":D.value==="ios",class:ie(["os-tab",{"is-active":D.value==="ios"}]),onClick:f[25]||(f[25]=y=>D.value="ios")},[w4,k(" iOS ")],10,S4),c("button",{type:"button",role:"tab","aria-selected":D.value==="android",class:ie(["os-tab",{"is-active":D.value==="android"}]),onClick:f[26]||(f[26]=y=>D.value="android")},[D4,k(" Android ")],10,k4)]),D.value==="ios"?(_(),P(ge,{key:0},[T4,N4,M4,R4,x4,O4,L4,F4,H4,z4,V4],64)):(_(),P(ge,{key:1},[W4,j4,G4,K4,X4,Q4,Y4,q4,J4],64))]),_:1},8,["modelValue"]),Ee(Ln,{modelValue:b.value,"onUpdate:modelValue":f[28]||(f[28]=y=>b.value=y),title:"嗨！歡迎使用 重機能停哪?","close-text":"開始使用"},{footer:dn(()=>[c("button",{class:"btn btn-primary",onClick:_e},"開始使用")]),default:dn(()=>[$4,Z4,ef,nf,tf,of,sf,rf]),_:1},8,["modelValue"]),Ee(Tp,{open:Te.value,"onUpdate:open":f[29]||(f[29]=y=>Te.value=y),mode:ln.value,initial:an.value,"default-coord":gt.value,nickname:L(pe),"is-owner":!0,"is-admin":L(x),submitting:je.value,"has-existing-override":Ss.value,history:La.value,"onUpdate:nickname":f[30]||(f[30]=y=>pe.value=y),onSubmit:f[31]||(f[31]=y=>ln.value==="override"?Xa(y):Ya(y)),onDelete:qa,onReset:Qa},null,8,["open","mode","initial","default-coord","nickname","is-admin","submitting","has-existing-override","history"]),cn.value?(_(),P("div",lf,cf)):V("",!0),cn.value?(_(),P("div",df,[hf,c("div",{class:"pick-banner-actions"},[c("button",{class:"btn btn-outline btn-sm",onClick:za},"取消"),c("button",{class:"btn btn-primary btn-sm",onClick:Ha},[uf,k(" 使用此位置 ")])])])):V("",!0),Ee(Ln,{modelValue:N.value,"onUpdate:modelValue":f[32]||(f[32]=y=>N.value=y),title:"共筆停車點說明","close-text":"我知道了",size:"lg"},{default:dn(()=>[pf,mf,ff,yf,gf,bf,Af]),_:1},8,["modelValue"]),Ee(Wp,{active:j.value,"onUpdate:active":f[33]||(f[33]=y=>j.value=y),steps:Be,onFinish:Ie},null,8,["active"])],64))}},Cf=on(vf,[["__scopeId","data-v-5a156f87"]]);dc(Cf).mount("#app");"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./serviceWorker.js").catch(()=>{})});
