 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A=function(n,e){if(!n)throw mt(e)},mt=function(n){return new Error("Firebase Database ("+al.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cl=function(n){const e=[];let t=0;for(let o=0;o<n.length;o++){let i=n.charCodeAt(o);i<128?e[t++]=i:i<2048?(e[t++]=i>>6|192,e[t++]=i&63|128):(i&64512)===55296&&o+1<n.length&&(n.charCodeAt(o+1)&64512)===56320?(i=65536+((i&1023)<<10)+(n.charCodeAt(++o)&1023),e[t++]=i>>18|240,e[t++]=i>>12&63|128,e[t++]=i>>6&63|128,e[t++]=i&63|128):(e[t++]=i>>12|224,e[t++]=i>>6&63|128,e[t++]=i&63|128)}return e},fd=function(n){const e=[];let t=0,o=0;for(;t<n.length;){const i=n[t++];if(i<128)e[o++]=String.fromCharCode(i);else if(i>191&&i<224){const s=n[t++];e[o++]=String.fromCharCode((i&31)<<6|s&63)}else if(i>239&&i<365){const s=n[t++],r=n[t++],l=n[t++],a=((i&7)<<18|(s&63)<<12|(r&63)<<6|l&63)-65536;e[o++]=String.fromCharCode(55296+(a>>10)),e[o++]=String.fromCharCode(56320+(a&1023))}else{const s=n[t++],r=n[t++];e[o++]=String.fromCharCode((i&15)<<12|(s&63)<<6|r&63)}}return e.join("")},Xi={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,e){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,o=[];for(let i=0;i<n.length;i+=3){const s=n[i],r=i+1<n.length,l=r?n[i+1]:0,a=i+2<n.length,d=a?n[i+2]:0,p=s>>2,h=(s&3)<<4|l>>4;let f=(l&15)<<2|d>>6,b=d&63;a||(b=64,r||(f=64)),o.push(t[p],t[h],t[f],t[b])}return o.join("")},encodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(n):this.encodeByteArray(cl(n),e)},decodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(n):fd(this.decodeStringToByteArray(n,e))},decodeStringToByteArray(n,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,o=[];for(let i=0;i<n.length;){const s=t[n.charAt(i++)],l=i<n.length?t[n.charAt(i)]:0;++i;const d=i<n.length?t[n.charAt(i)]:64;++i;const h=i<n.length?t[n.charAt(i)]:64;if(++i,s==null||l==null||d==null||h==null)throw new yd;const f=s<<2|l>>4;if(o.push(f),d!==64){const b=l<<4&240|d>>2;if(o.push(b),h!==64){const g=d<<6&192|h;o.push(g)}}}return o},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class yd extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const dl=function(n){const e=cl(n);return Xi.encodeByteArray(e,!0)},fo=function(n){return dl(n).replace(/\./g,"")},fi=function(n){try{return Xi.decodeString(n,!0)}catch(e){}return null};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _d=()=>Ad().__FIREBASE_DEFAULTS__,vd=()=>{if(typeof process=="undefined"||typeof qs=="undefined")return;const n=qs.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},Cd=()=>{if(typeof document=="undefined")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch(t){return}const e=n&&fi(n[1]);return e&&JSON.parse(e)},ul=()=>{try{return md()||_d()||vd()||Cd()}catch(n){return}},Pd=n=>{var e,t;return(t=(e=ul())==null?void 0:e.emulatorHosts)==null?void 0:t[n]},Ud=n=>{const e=Pd(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const o=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),o]:[e.substring(0,t),o]},pl=()=>{var n;return(n=ul())==null?void 0:n.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pn=new Al("@firebase/app"),r1="@firebase/app-compat",l1="@firebase/analytics-compat",a1="@firebase/analytics",c1="@firebase/app-check-compat",d1="@firebase/app-check",h1="@firebase/auth",u1="@firebase/auth-compat",p1="@firebase/database",m1="@firebase/data-connect",f1="@firebase/database-compat",y1="@firebase/functions",b1="@firebase/functions-compat",g1="@firebase/installations",A1="@firebase/installations-compat",_1="@firebase/messaging",v1="@firebase/messaging-compat",C1="@firebase/performance",P1="@firebase/performance-compat",U1="@firebase/remote-config",E1="@firebase/remote-config-compat",B1="@firebase/storage",w1="@firebase/storage-compat",I1="@firebase/firestore",S1="@firebase/ai",k1="@firebase/firestore-compat",D1="firebase",T1="12.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ai="[DEFAULT]",N1={[gi]:"fire-core",[r1]:"fire-core-compat",[a1]:"fire-analytics",[l1]:"fire-analytics-compat",[d1]:"fire-app-check",[c1]:"fire-app-check-compat",[h1]:"fire-auth",[u1]:"fire-auth-compat",[p1]:"fire-rtdb",[m1]:"fire-data-connect",[f1]:"fire-rtdb-compat",[y1]:"fire-fn",[b1]:"fire-fn-compat",[g1]:"fire-iid",[A1]:"fire-iid-compat",[_1]:"fire-fcm",[v1]:"fire-fcm-compat",[C1]:"fire-perf",[P1]:"fire-perf-compat",[U1]:"fire-rc",[E1]:"fire-rc-compat",[B1]:"fire-gcs",[w1]:"fire-gcs-compat",[I1]:"fire-fst",[k1]:"fire-fst-compat",[S1]:"fire-vertex","fire-js":"fire-js",[D1]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const go=new Map,M1=new Map,_i=new Map;function ir(n,e){try{n.container.addComponent(e)}catch(t){pn.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Ao(n){const e=n.name;if(_i.has(e))return pn.debug(`There were multiple attempts to register component ${e}.`),!1;_i.set(e,n);for(const t of go.values())ir(t,n);for(const t of M1.values())ir(t,n);return!0}function R1(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function O1(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F1=T1;function Cl(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const o={name:Ai,automaticDataCollectionEnabled:!0,...e},i=o.name;if(typeof i!="string"||!i)throw wn.create("bad-app-name",{appName:String(i)});if(t||(t=pl()),!t)throw wn.create("no-options");const s=go.get(i);if(s){if(bo(t,s.options)&&bo(o,s.config))return s;throw wn.create("duplicate-app",{appName:i})}const r=new Vd(i);for(const a of _i.values())r.addComponent(a);const l=new L1(t,o,r);return go.set(i,l),l}function H1(n=Ai){const e=go.get(n);if(!e&&n===Ai&&pl())return Cl();if(!e)throw wn.create("no-app",{appName:n});return e}function it(n,e,t){var r;let o=(r=N1[n])!=null?r:n;t&&(o+=`-${t}`);const i=o.match(/\s|\//),s=e.match(/\s|\//);if(i||s){const l=[`Unable to register library "${o}" with version "${e}":`];i&&l.push(`library name "${o}" contains illegal characters (whitespace or "/")`),i&&s&&l.push("and"),s&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),pn.warn(l.join(" "));return}Ao(new Lt(`${o}-version`,()=>({library:o,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const z1="firebase-heartbeat-database",V1=1,Ft="firebase-heartbeat-store";let ii=null;function Pl(){return ii||(ii=n1(z1,V1,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Ft)}catch(t){}}}}).catch(n=>{throw wn.create("idb-open",{originalErrorMessage:n.message})})),ii}async function W1(n){try{const t=(await Pl()).transaction(Ft),o=await t.objectStore(Ft).get(Ul(n));return await t.done,o}catch(e){if(e instanceof Yt)pn.warn(e.message);else{const t=wn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});pn.warn(t.message)}}}async function sr(n,e){try{const o=(await Pl()).transaction(Ft,"readwrite");await o.objectStore(Ft).put(e,Ul(n)),await o.done}catch(t){if(t instanceof Yt)pn.warn(t.message);else{const o=wn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});pn.warn(o.message)}}}function Ul(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const j1=1024,G1=30;class K1{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Q1(t),this._heartbeatsCachePromise=this._storage.read().then(o=>(this._heartbeatsCache=o,o))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=rr();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(r=>r.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats.length>G1){const r=Y1(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(o){pn.warn(o)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=rr(),{heartbeatsToSend:o,unsentEntries:i}=X1(this._heartbeatsCache.heartbeats),s=fo(JSON.stringify({version:2,heartbeats:o}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return pn.warn(t),""}}}function rr(){return new Date().toISOString().substring(0,10)}function X1(n,e=j1){const t=[];let o=n.slice();for(const i of n){const s=t.find(r=>r.agent===i.agent);if(s){if(s.dates.push(i.date),lr(t)>e){s.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),lr(t)>e){t.pop();break}o=o.slice(1)}return{heartbeatsToSend:t,unsentEntries:o}}class Q1{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Id()?Sd().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await W1(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return sr(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return sr(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function lr(n){return fo(JSON.stringify({version:2,heartbeats:n})).length}function Y1(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let o=1;o<n.length;o++)n[o].date<t&&(t=n[o].date,e=o);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function J1(n){Ao(new Lt("platform-logger",e=>new i1(e),"PRIVATE")),Ao(new Lt("heartbeat",e=>new K1(e),"PRIVATE")),it(gi,or,n),it(gi,or,"esm2020"),it("fire-js","")}J1("");var ar={};const cr="@firebase/database",dr="1.1.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class p2{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,O1(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(o=>this.appCheck=o)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,o)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)==null||t.get().then(o=>o.addTokenListener(e))}notifyForInvalidToken(){De(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class m2{constructor(e,t,o){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=o,this.auth_=null,this.auth_=o.getImmediate({optional:!0}),this.auth_||o.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(we("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,o)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',De(e)}}class ao{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}ao.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qi="5",kl="v",Dl="s",Tl="r",Nl="f",Ml=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Rl="ls",Ol="p",Ci="ac",xl="websocket",Ll="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo extends Xl{static getInstance(){return new vo}constructor(){super(["online"]),this.online_=!0,typeof window!="undefined"&&typeof window.addEventListener!="undefined"&&!ml()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return A(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let so;class Jl extends Ro{static get __EMPTY_NODE(){return so}static set __EMPTY_NODE(e){so=e}compare(e,t){return qn(e.name,t.name)}isDefinedOn(e){throw mt("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return z.MIN}maxPost(){return new z(Sn,so)}makePost(e,t){return A(typeof e=="string","KeyIndex indexValue must always be a string."),new z(e,so)}toString(){return".key"}}const jn=new Jl;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function J2(n,e){return qn(n.name,e.name)}function os(n,e){return qn(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Pi;function q2(n){Pi=n}const ql=function(n){return typeof n=="number"?"number:"+Sl(n):"string:"+n},$l=function(n){if(n.isLeafNode()){const e=n.val();A(typeof e=="string"||typeof e=="number"||typeof e=="object"&&cn(e,".sv"),"Priority must be a string or number.")}else A(n===Pi||n.isEmpty(),"priority of unexpected type.");A(n===Pi||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Zl,ea;function $2(n){Zl=n}function Z2(n){ea=n}class e0 extends Ro{compare(e,t){const o=e.node.getPriority(),i=t.node.getPriority(),s=o.compareTo(i);return s===0?qn(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return z.MIN}maxPost(){return new z(Sn,new ge("[PRIORITY-POST]",ea))}makePost(e,t){const o=Zl(e);return new z(t,new ge("[PRIORITY-POST]",o))}toString(){return".priority"}}const se=new e0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const n0=Math.log(2);class t0{constructor(e){const t=s=>parseInt(Math.log(s)/n0,10),o=s=>parseInt(Array(s+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=o(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Co=function(n,e,t,o){n.sort(e);const i=function(a,d){const p=d-a;let h,f;if(p===0)return null;if(p===1)return h=n[a],f=t?t(h):h,new Ae(f,h.node,Ae.BLACK,null,null);{const b=parseInt(p/2,10)+a,g=i(a,b),B=i(b+1,d);return h=n[b],f=t?t(h):h,new Ae(f,h.node,Ae.BLACK,g,B)}},s=function(a){let d=null,p=null,h=n.length;const f=function(g,B){const D=h-g,U=h;h-=g;const G=i(D+1,U),N=n[D],V=t?t(N):N;b(new Ae(V,N.node,B,null,G))},b=function(g){d?(d.left=g,d=g):(p=g,d=g)};for(let g=0;g<a.count;++g){const B=a.nextBitIsOne(),D=Math.pow(2,a.count-(g+1));B?f(D,Ae.BLACK):(f(D,Ae.BLACK),f(D,Ae.RED))}return p},r=new t0(n.length),l=s(r);return new Re(o||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ai;const nt={};class hn{static get Default(){return A(nt&&se,"ChildrenNode.ts has not been loaded"),ai=ai||new hn({".priority":nt},{".priority":se}),ai}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=lt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Re?t:null}hasIndex(e){return cn(this.indexSet_,e.toString())}addIndex(e,t){A(e!==jn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const o=[];let i=!1;const s=t.getIterator(z.Wrap);let r=s.getNext();for(;r;)i=i||e.isDefinedOn(r.node),o.push(r),r=s.getNext();let l;i?l=Co(o,e.getCompare()):l=nt;const a=e.toString(),d={...this.indexSet_};d[a]=e;const p={...this.indexes_};return p[a]=l,new hn(p,d)}addToIndexes(e,t){const o=yo(this.indexes_,(i,s)=>{const r=lt(this.indexSet_,s);if(A(r,"Missing index implementation for "+s),i===nt)if(r.isDefinedOn(e.node)){const l=[],a=t.getIterator(z.Wrap);let d=a.getNext();for(;d;)d.name!==e.name&&l.push(d),d=a.getNext();return l.push(e),Co(l,r.getCompare())}else return nt;else{const l=t.get(e.name);let a=i;return l&&(a=a.remove(new z(e.name,l))),a.insert(e,e.node)}});return new hn(o,this.indexSet_)}removeFromIndexes(e,t){const o=yo(this.indexes_,i=>{if(i===nt)return i;{const s=t.get(e.name);return s?i.remove(new z(e.name,s)):i}});return new hn(o,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class is extends Ro{constructor(e){super(),this.indexPath_=e,A(!H(e)&&F(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const o=this.extractChild(e.node),i=this.extractChild(t.node),s=o.compareTo(i);return s===0?qn(e.name,t.name):s}makePost(e,t){const o=_e(e),i=M.EMPTY_NODE.updateChild(this.indexPath_,o);return new z(t,i)}maxPost(){const e=M.EMPTY_NODE.updateChild(this.indexPath_,$t);return new z(Sn,e)}toString(){return zt(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class s0 extends Ro{compare(e,t){const o=e.node.compareTo(t.node);return o===0?qn(e.name,t.name):o}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return z.MIN}maxPost(){return z.MAX}makePost(e,t){const o=_e(e);return new z(t,o)}toString(){return".value"}}const na=new s0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Po extends Kl{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(A(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,t,o,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=o,this.appCheckTokenProvider_=i,this.log_=qt("p:rest:"),this.listens_={}}listen(e,t,o,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=Po.getListenId_(e,o),l={};this.listens_[r]=l;const a=Er(e._queryParams);this.restRequest_(s+".json",a,(d,p)=>{let h=p;if(d===404&&(h=null,d=null),d===null&&this.onDataUpdate_(s,h,!1,o),lt(this.listens_,r)===l){let f;d?d===401?f="permission_denied":f="rest_error:"+d:f="ok",i(f,null)}})}unlisten(e,t){const o=Po.getListenId_(e,t);delete this.listens_[o]}get(e){const t=Er(e._queryParams),o=e._path.toString(),i=new Qt;return this.restRequest_(o+".json",t,(s,r)=>{let l=r;s===404&&(l=null,s=null),s===null?(this.onDataUpdate_(o,l,!1,null),i.resolve(l)):i.reject(new Error(l))}),i.promise}refreshAuthToken(e){}restRequest_(e,t={},o){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Rd(t);this.log_("Sending REST request for "+r);const l=new XMLHttpRequest;l.onreadystatechange=()=>{if(o&&l.readyState===4){this.log_("REST Response for "+r+" received. status:",l.status,"response:",l.responseText);let a=null;if(l.status>=200&&l.status<300){try{a=xt(l.responseText)}catch(d){De("Failed to parse JSON response for "+r+": "+l.responseText)}o(null,a)}else l.status!==401&&l.status!==404&&De("Got unsuccessful REST response for "+r+" Status: "+l.status),o(l.status);o=null}},l.open("GET",r,!0),l.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uo(){return{value:null,children:new Map}}function oa(n,e,t){if(H(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const o=F(e);n.children.has(o)||n.children.set(o,Uo());const i=n.children.get(o);e=oe(e),oa(i,e,t)}}function Ui(n,e,t){n.value!==null?t(e,n.value):h0(n,(o,i)=>{const s=new J(e.toString()+"/"+o);Ui(i,s,t)})}function h0(n,e){n.children.forEach((t,o)=>{e(o,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wr=10*1e3,p0=30*1e3,m0=5*60*1e3;class f0{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new u0(e);const o=wr+(p0-wr)*Math.random();Dt(this.reportStats_.bind(this),Math.floor(o))}reportStats_(){const e=this.statsListener_.get(),t={};let o=!1;Ie(e,(i,s)=>{s>0&&cn(this.statsToReport_,i)&&(t[i]=s,o=!0)}),o&&this.server_.reportStats(t),Dt(this.reportStats_.bind(this),Math.floor(Math.random()*2*m0))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt{constructor(e,t){this.source=e,this.path=t,this.type=tn.LISTEN_COMPLETE}operationForChild(e){return H(this.path)?new Gt(this.source,X()):new Gt(this.source,oe(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kn{constructor(e,t,o){this.source=e,this.path=t,this.snap=o,this.type=tn.OVERWRITE}operationForChild(e){return H(this.path)?new Kn(this.source,X(),this.snap.getImmediateChild(e)):new Kn(this.source,oe(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ct{constructor(e,t,o){this.source=e,this.path=t,this.children=o,this.type=tn.MERGE}operationForChild(e){if(H(this.path)){const t=this.children.subtree(new J(e));return t.isEmpty()?null:t.value?new Kn(this.source,X(),t.value):new ct(this.source,X(),t)}else return A(F(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ct(this.source,oe(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xn{constructor(e,t,o){this.node_=e,this.fullyInitialized_=t,this.filtered_=o}isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(e){if(H(e))return this.isFullyInitialized()&&!this.filtered_;const t=F(e);return this.isCompleteForChild(t)}isCompleteForChild(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}getNode(){return this.node_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oo(n,e){return{eventCache:n,serverCache:e}}function Tt(n,e,t,o){return Oo(new Xn(e,t,o),n.serverCache)}function ia(n,e,t,o){return Oo(n.eventCache,new Xn(e,t,o))}function Ei(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Qn(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ci;const _0=()=>(ci||(ci=new Re(s2)),ci);class ne{static fromObject(e){let t=new ne(null);return Ie(e,(o,i)=>{t=t.set(new J(o),i)}),t}constructor(e,t=_0()){this.value=e,this.children=t}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(this.value!=null&&t(this.value))return{path:X(),value:this.value};if(H(e))return null;{const o=F(e),i=this.children.get(o);if(i!==null){const s=i.findRootMostMatchingPathAndValue(oe(e),t);return s!=null?{path:ae(new J(o),s.path),value:s.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(H(e))return this;{const t=F(e),o=this.children.get(t);return o!==null?o.subtree(oe(e)):new ne(null)}}set(e,t){if(H(e))return new ne(t,this.children);{const o=F(e),s=(this.children.get(o)||new ne(null)).set(oe(e),t),r=this.children.insert(o,s);return new ne(this.value,r)}}remove(e){if(H(e))return this.children.isEmpty()?new ne(null):new ne(null,this.children);{const t=F(e),o=this.children.get(t);if(o){const i=o.remove(oe(e));let s;return i.isEmpty()?s=this.children.remove(t):s=this.children.insert(t,i),this.value===null&&s.isEmpty()?new ne(null):new ne(this.value,s)}else return this}}get(e){if(H(e))return this.value;{const t=F(e),o=this.children.get(t);return o?o.get(oe(e)):null}}setTree(e,t){if(H(e))return t;{const o=F(e),s=(this.children.get(o)||new ne(null)).setTree(oe(e),t);let r;return s.isEmpty()?r=this.children.remove(o):r=this.children.insert(o,s),new ne(this.value,r)}}fold(e){return this.fold_(X(),e)}fold_(e,t){const o={};return this.children.inorderTraversal((i,s)=>{o[i]=s.fold_(ae(e,i),t)}),t(e,this.value,o)}findOnPath(e,t){return this.findOnPath_(e,X(),t)}findOnPath_(e,t,o){const i=this.value?o(t,this.value):!1;if(i)return i;if(H(e))return null;{const s=F(e),r=this.children.get(s);return r?r.findOnPath_(oe(e),ae(t,s),o):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,X(),t)}foreachOnPath_(e,t,o){if(H(e))return this;{this.value&&o(t,this.value);const i=F(e),s=this.children.get(i);return s?s.foreachOnPath_(oe(e),ae(t,i),o):new ne(null)}}foreach(e){this.foreach_(X(),e)}foreach_(e,t){this.children.inorderTraversal((o,i)=>{i.foreach_(ae(e,o),t)}),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal((t,o)=>{o.value&&e(t,o.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ds(n,e){return ca(e,n)}function v0(n,e,t,o,i){A(o>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:o,visible:i}),i&&(n.visibleWrites=Nt(n.visibleWrites,e,t)),n.lastWriteId=o}function C0(n,e,t,o){A(o>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:o,visible:!0}),n.visibleWrites=Bi(n.visibleWrites,e,t),n.lastWriteId=o}function P0(n,e){for(let t=0;t<n.allWrites.length;t++){const o=n.allWrites[t];if(o.writeId===e)return o}return null}function U0(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);A(t>=0,"removeWrite called with nonexistent writeId.");const o=n.allWrites[t];n.allWrites.splice(t,1);let i=o.visible,s=!1,r=n.allWrites.length-1;for(;i&&r>=0;){const l=n.allWrites[r];l.visible&&(r>=t&&E0(l,o.path)?i=!1:Qe(o.path,l.path)&&(s=!0)),r--}if(i){if(s)return B0(n),!0;if(o.snap)n.visibleWrites=Ir(n.visibleWrites,o.path);else{const l=o.children;Ie(l,a=>{n.visibleWrites=Ir(n.visibleWrites,ae(o.path,a))})}return!0}else return!1}function E0(n,e){if(n.snap)return Qe(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Qe(ae(n.path,t),e))return!0;return!1}function B0(n){n.visibleWrites=ra(n.allWrites,w0,X()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function w0(n){return n.visible}function ra(n,e,t){let o=on.empty();for(let i=0;i<n.length;++i){const s=n[i];if(e(s)){const r=s.path;let l;if(s.snap)Qe(t,r)?(l=Me(t,r),o=Nt(o,l,s.snap)):Qe(r,t)&&(l=Me(r,t),o=Nt(o,X(),s.snap.getChild(l)));else if(s.children){if(Qe(t,r))l=Me(t,r),o=Bi(o,l,s.children);else if(Qe(r,t))if(l=Me(r,t),H(l))o=Bi(o,X(),s.children);else{const a=lt(s.children,F(l));if(a){const d=a.getChild(oe(l));o=Nt(o,X(),d)}}}else throw mt("WriteRecord should have .snap or .children")}}return o}function la(n,e,t,o,i){if(!o&&!i){const s=$n(n.visibleWrites,e);if(s!=null)return s;{const r=In(n.visibleWrites,e);if(Ii(r))return t;if(t==null&&!wi(r,X()))return null;{const l=t||M.EMPTY_NODE;return dt(r,l)}}}else{const s=In(n.visibleWrites,e);if(!i&&Ii(s))return t;if(!i&&t==null&&!wi(s,X()))return null;{const r=function(d){return(d.visible||i)&&(!o||!~o.indexOf(d.writeId))&&(Qe(d.path,e)||Qe(e,d.path))},l=ra(n.allWrites,r,e),a=t||M.EMPTY_NODE;return dt(l,a)}}}function I0(n,e,t){let o=M.EMPTY_NODE;const i=$n(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(se,(s,r)=>{o=o.updateImmediateChild(s,r)}),o;if(t){const s=In(n.visibleWrites,e);return t.forEachChild(se,(r,l)=>{const a=dt(In(s,new J(r)),l);o=o.updateImmediateChild(r,a)}),Sr(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}else{const s=In(n.visibleWrites,e);return Sr(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}}function S0(n,e,t,o,i){A(o||i,"Either existingEventSnap or existingServerSnap must exist");const s=ae(e,t);if(wi(n.visibleWrites,s))return null;{const r=In(n.visibleWrites,s);return Ii(r)?i.getChild(t):dt(r,i.getChild(t))}}function k0(n,e,t,o){const i=ae(e,t),s=$n(n.visibleWrites,i);if(s!=null)return s;if(o.isCompleteForChild(t)){const r=In(n.visibleWrites,i);return dt(r,o.getNode().getImmediateChild(t))}else return null}function D0(n,e){return $n(n.visibleWrites,e)}function T0(n,e,t,o,i,s,r){let l;const a=In(n.visibleWrites,e),d=$n(a,X());if(d!=null)l=d;else if(t!=null)l=dt(a,t);else return[];if(l=l.withIndex(r),!l.isEmpty()&&!l.isLeafNode()){const p=[],h=r.getCompare(),f=s?l.getReverseIteratorFrom(o,r):l.getIteratorFrom(o,r);let b=f.getNext();for(;b&&p.length<i;)h(b,o)!==0&&p.push(b),b=f.getNext();return p}else return[]}function N0(){return{visibleWrites:on.empty(),allWrites:[],lastWriteId:-1}}function Bo(n,e,t,o){return la(n.writeTree,n.treePath,e,t,o)}function hs(n,e){return I0(n.writeTree,n.treePath,e)}function kr(n,e,t,o){return S0(n.writeTree,n.treePath,e,t,o)}function wo(n,e){return D0(n.writeTree,ae(n.treePath,e))}function M0(n,e,t,o,i,s){return T0(n.writeTree,n.treePath,e,t,o,i,s)}function us(n,e,t){return k0(n.writeTree,n.treePath,e,t)}function aa(n,e){return ca(ae(n.treePath,e),n.writeTree)}function ca(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class O0{getCompleteChild(e){return null}getChildAfterChild(e,t,o){return null}}const da=new O0;class ps{constructor(e,t,o=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=o}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const o=this.optCompleteServerCache_!=null?new Xn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return us(this.writes_,e,o)}}getChildAfterChild(e,t,o){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Qn(this.viewCache_),s=M0(this.writes_,i,t,1,o,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function x0(n){return{filter:n}}function L0(n,e){A(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),A(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function F0(n,e,t,o,i){const s=new R0;let r,l;if(t.type===tn.OVERWRITE){const d=t;d.source.fromUser?r=Si(n,e,d.path,d.snap,o,i,s):(A(d.source.fromServer,"Unknown source."),l=d.source.tagged||e.serverCache.isFiltered()&&!H(d.path),r=Io(n,e,d.path,d.snap,o,i,l,s))}else if(t.type===tn.MERGE){const d=t;d.source.fromUser?r=z0(n,e,d.path,d.children,o,i,s):(A(d.source.fromServer,"Unknown source."),l=d.source.tagged||e.serverCache.isFiltered(),r=ki(n,e,d.path,d.children,o,i,l,s))}else if(t.type===tn.ACK_USER_WRITE){const d=t;d.revert?r=j0(n,e,d.path,o,i,s):r=V0(n,e,d.path,d.affectedTree,o,i,s)}else if(t.type===tn.LISTEN_COMPLETE)r=W0(n,e,t.path,o,s);else throw mt("Unknown operation type: "+t.type);const a=s.getChanges();return H0(e,r,a),{viewCache:r,changes:a}}function H0(n,e,t){const o=e.eventCache;if(o.isFullyInitialized()){const i=o.getNode().isLeafNode()||o.getNode().isEmpty(),s=Ei(n);(t.length>0||!n.eventCache.isFullyInitialized()||i&&!o.getNode().equals(s)||!o.getNode().getPriority().equals(s.getPriority()))&&t.push(ta(Ei(e)))}}function ha(n,e,t,o,i,s){const r=e.eventCache;if(wo(o,t)!=null)return e;{let l,a;if(H(t))if(A(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const d=Qn(e),p=d instanceof M?d:M.EMPTY_NODE,h=hs(o,p);l=n.filter.updateFullNode(e.eventCache.getNode(),h,s)}else{const d=Bo(o,Qn(e));l=n.filter.updateFullNode(e.eventCache.getNode(),d,s)}else{const d=F(t);if(d===".priority"){A(kn(t)===1,"Can't have a priority with additional path components");const p=r.getNode();a=e.serverCache.getNode();const h=kr(o,t,p,a);h!=null?l=n.filter.updatePriority(p,h):l=r.getNode()}else{const p=oe(t);let h;if(r.isCompleteForChild(d)){a=e.serverCache.getNode();const f=kr(o,t,r.getNode(),a);f!=null?h=r.getNode().getImmediateChild(d).updateChild(p,f):h=r.getNode().getImmediateChild(d)}else h=us(o,d,e.serverCache);h!=null?l=n.filter.updateChild(r.getNode(),d,h,p,i,s):l=r.getNode()}}return Tt(e,l,r.isFullyInitialized()||H(t),n.filter.filtersNodes())}}function Io(n,e,t,o,i,s,r,l){const a=e.serverCache;let d;const p=r?n.filter:n.filter.getIndexedFilter();if(H(t))d=p.updateFullNode(a.getNode(),o,null);else if(p.filtersNodes()&&!a.isFiltered()){const b=a.getNode().updateChild(t,o);d=p.updateFullNode(a.getNode(),b,null)}else{const b=F(t);if(!a.isCompleteForPath(t)&&kn(t)>1)return e;const g=oe(t),D=a.getNode().getImmediateChild(b).updateChild(g,o);b===".priority"?d=p.updatePriority(a.getNode(),D):d=p.updateChild(a.getNode(),b,D,g,da,null)}const h=ia(e,d,a.isFullyInitialized()||H(t),p.filtersNodes()),f=new ps(i,h,s);return ha(n,h,t,i,f,l)}function Si(n,e,t,o,i,s,r){const l=e.eventCache;let a,d;const p=new ps(i,e,s);if(H(t))d=n.filter.updateFullNode(e.eventCache.getNode(),o,r),a=Tt(e,d,!0,n.filter.filtersNodes());else{const h=F(t);if(h===".priority")d=n.filter.updatePriority(e.eventCache.getNode(),o),a=Tt(e,d,l.isFullyInitialized(),l.isFiltered());else{const f=oe(t),b=l.getNode().getImmediateChild(h);let g;if(H(f))g=o;else{const B=p.getCompleteChild(h);B!=null?es(f)===".priority"&&B.getChild(Ql(f)).isEmpty()?g=B:g=B.updateChild(f,o):g=M.EMPTY_NODE}if(b.equals(g))a=e;else{const B=n.filter.updateChild(l.getNode(),h,g,f,p,r);a=Tt(e,B,l.isFullyInitialized(),n.filter.filtersNodes())}}}return a}function Dr(n,e){return n.eventCache.isCompleteForChild(e)}function z0(n,e,t,o,i,s,r){let l=e;return o.foreach((a,d)=>{const p=ae(t,a);Dr(e,F(p))&&(l=Si(n,l,p,d,i,s,r))}),o.foreach((a,d)=>{const p=ae(t,a);Dr(e,F(p))||(l=Si(n,l,p,d,i,s,r))}),l}function Tr(n,e,t){return t.foreach((o,i)=>{e=e.updateChild(o,i)}),e}function ki(n,e,t,o,i,s,r,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let a=e,d;H(t)?d=o:d=new ne(null).setTree(t,o);const p=e.serverCache.getNode();return d.children.inorderTraversal((h,f)=>{if(p.hasChild(h)){const b=e.serverCache.getNode().getImmediateChild(h),g=Tr(n,b,f);a=Io(n,a,new J(h),g,i,s,r,l)}}),d.children.inorderTraversal((h,f)=>{const b=!e.serverCache.isCompleteForChild(h)&&f.value===null;if(!p.hasChild(h)&&!b){const g=e.serverCache.getNode().getImmediateChild(h),B=Tr(n,g,f);a=Io(n,a,new J(h),B,i,s,r,l)}}),a}function V0(n,e,t,o,i,s,r){if(wo(i,t)!=null)return e;const l=e.serverCache.isFiltered(),a=e.serverCache;if(o.value!=null){if(H(t)&&a.isFullyInitialized()||a.isCompleteForPath(t))return Io(n,e,t,a.getNode().getChild(t),i,s,l,r);if(H(t)){let d=new ne(null);return a.getNode().forEachChild(jn,(p,h)=>{d=d.set(new J(p),h)}),ki(n,e,t,d,i,s,l,r)}else return e}else{let d=new ne(null);return o.foreach((p,h)=>{const f=ae(t,p);a.isCompleteForPath(f)&&(d=d.set(p,a.getNode().getChild(f)))}),ki(n,e,t,d,i,s,l,r)}}function W0(n,e,t,o,i){const s=e.serverCache,r=ia(e,s.getNode(),s.isFullyInitialized()||H(t),s.isFiltered());return ha(n,r,t,o,da,i)}function j0(n,e,t,o,i,s){let r;if(wo(o,t)!=null)return e;{const l=new ps(o,e,i),a=e.eventCache.getNode();let d;if(H(t)||F(t)===".priority"){let p;if(e.serverCache.isFullyInitialized())p=Bo(o,Qn(e));else{const h=e.serverCache.getNode();A(h instanceof M,"serverChildren would be complete if leaf node"),p=hs(o,h)}p=p,d=n.filter.updateFullNode(a,p,s)}else{const p=F(t);let h=us(o,p,e.serverCache);h==null&&e.serverCache.isCompleteForChild(p)&&(h=a.getImmediateChild(p)),h!=null?d=n.filter.updateChild(a,p,h,oe(t),l,s):e.eventCache.getNode().hasChild(p)?d=n.filter.updateChild(a,p,M.EMPTY_NODE,oe(t),l,s):d=a,d.isEmpty()&&e.serverCache.isFullyInitialized()&&(r=Bo(o,Qn(e)),r.isLeafNode()&&(d=n.filter.updateFullNode(d,r,s)))}return r=e.serverCache.isFullyInitialized()||wo(o,X())!=null,Tt(e,d,r,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let So;class J0{constructor(){this.views=new Map}}function q0(n){A(!So,"__referenceConstructor has already been defined"),So=n}function $0(){return A(So,"Reference.ts has not been loaded"),So}function Z0(n){return n.views.size===0}function ms(n,e,t,o){const i=e.source.queryId;if(i!==null){const s=n.views.get(i);return A(s!=null,"SyncTree gave us an op for an invalid query."),Rr(s,e,t,o)}else{let s=[];for(const r of n.views.values())s=s.concat(Rr(r,e,t,o));return s}}function eh(n,e,t,o,i){const s=e._queryIdentifier,r=n.views.get(s);if(!r){let l=Bo(t,i?o:null),a=!1;l?a=!0:o instanceof M?(l=hs(t,o),a=!1):(l=M.EMPTY_NODE,a=!1);const d=Oo(new Xn(l,a,!1),new Xn(o,i,!1));return new G0(e,d)}return r}function nh(n,e,t,o,i,s){const r=eh(n,e,o,i,s);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,r),Q0(r,t),Y0(r,t)}function th(n,e,t,o){const i=e._queryIdentifier,s=[];let r=[];const l=Dn(n);if(i==="default")for(const[a,d]of n.views.entries())r=r.concat(Mr(d,t,o)),Nr(d)&&(n.views.delete(a),d.query._queryParams.loadsAllData()||s.push(d.query));else{const a=n.views.get(i);a&&(r=r.concat(Mr(a,t,o)),Nr(a)&&(n.views.delete(i),a.query._queryParams.loadsAllData()||s.push(a.query)))}return l&&!Dn(n)&&s.push(new($0())(e._repo,e._path)),{removed:s,events:r}}function pa(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function rt(n,e){let t=null;for(const o of n.views.values())t=t||X0(o,e);return t}function ma(n,e){if(e._queryParams.loadsAllData())return xo(n);{const o=e._queryIdentifier;return n.views.get(o)}}function fa(n,e){return ma(n,e)!=null}function Dn(n){return xo(n)!=null}function xo(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ko;function oh(n){A(!ko,"__referenceConstructor has already been defined"),ko=n}function ih(){return A(ko,"Reference.ts has not been loaded"),ko}let sh=1;class Or{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ne(null),this.pendingWriteTree_=N0(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ya(n,e,t,o,i){return v0(n.pendingWriteTree_,e,t,o,i),i?yt(n,new Kn(ls(),e,t)):[]}function rh(n,e,t,o){C0(n.pendingWriteTree_,e,t,o);const i=ne.fromObject(t);return yt(n,new ct(ls(),e,i))}function En(n,e,t=!1){const o=P0(n.pendingWriteTree_,e);if(U0(n.pendingWriteTree_,e)){let s=new ne(null);return o.snap!=null?s=s.set(X(),!0):Ie(o.children,r=>{s=s.set(new J(r),!0)}),yt(n,new Eo(o.path,s,t))}else return[]}function Lo(n,e,t){return yt(n,new Kn(as(),e,t))}function lh(n,e,t){const o=ne.fromObject(t);return yt(n,new ct(as(),e,o))}function ah(n,e){return yt(n,new Gt(as(),e))}function ch(n,e,t){const o=ys(n,t);if(o){const i=bs(o),s=i.path,r=i.queryId,l=Me(s,e),a=new Gt(cs(r),l);return gs(n,s,a)}else return[]}function Di(n,e,t,o,i=!1){const s=e._path,r=n.syncPointTree_.get(s);let l=[];if(r&&(e._queryIdentifier==="default"||fa(r,e))){const a=th(r,e,t,o);Z0(r)&&(n.syncPointTree_=n.syncPointTree_.remove(s));const d=a.removed;if(l=a.events,!i){const p=d.findIndex(f=>f._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(s,(f,b)=>Dn(b));if(p&&!h){const f=n.syncPointTree_.subtree(s);if(!f.isEmpty()){const b=uh(f);for(let g=0;g<b.length;++g){const B=b[g],D=B.query,U=Aa(n,B);n.listenProvider_.startListening(Mt(D),Do(n,D),U.hashFn,U.onComplete)}}}!h&&d.length>0&&!o&&(p?n.listenProvider_.stopListening(Mt(e),null):d.forEach(f=>{const b=n.queryToTagMap.get(Fo(f));n.listenProvider_.stopListening(Mt(f),b)}))}ph(n,d)}return l}function dh(n,e,t,o){const i=ys(n,o);if(i!=null){const s=bs(i),r=s.path,l=s.queryId,a=Me(r,e),d=new Kn(cs(l),a,t);return gs(n,r,d)}else return[]}function hh(n,e,t,o){const i=ys(n,o);if(i){const s=bs(i),r=s.path,l=s.queryId,a=Me(r,e),d=ne.fromObject(t),p=new ct(cs(l),a,d);return gs(n,r,p)}else return[]}function xr(n,e,t,o=!1){const i=e._path;let s=null,r=!1;n.syncPointTree_.foreachOnPath(i,(f,b)=>{const g=Me(f,i);s=s||rt(b,g),r=r||Dn(b)});let l=n.syncPointTree_.get(i);l?(r=r||Dn(l),s=s||rt(l,X())):(l=new J0,n.syncPointTree_=n.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=M.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((b,g)=>{const B=rt(g,X());B&&(s=s.updateImmediateChild(b,B))}));const d=fa(l,e);if(!d&&!e._queryParams.loadsAllData()){const f=Fo(e);A(!n.queryToTagMap.has(f),"View does not exist, but we have a tag");const b=mh();n.queryToTagMap.set(f,b),n.tagToQueryMap.set(b,f)}const p=ds(n.pendingWriteTree_,i);let h=nh(l,e,t,p,s,a);if(!d&&!r&&!o){const f=ma(l,e);h=h.concat(fh(n,e,f))}return h}function fs(n,e,t){const i=n.pendingWriteTree_,s=n.syncPointTree_.findOnPath(e,(r,l)=>{const a=Me(r,e),d=rt(l,a);if(d)return d});return la(i,e,s,t,!0)}function yt(n,e){return ba(e,n.syncPointTree_,null,ds(n.pendingWriteTree_,X()))}function ba(n,e,t,o){if(H(n.path))return ga(n,e,t,o);{const i=e.get(X());t==null&&i!=null&&(t=rt(i,X()));let s=[];const r=F(n.path),l=n.operationForChild(r),a=e.children.get(r);if(a&&l){const d=t?t.getImmediateChild(r):null,p=aa(o,r);s=s.concat(ba(l,a,d,p))}return i&&(s=s.concat(ms(i,n,o,t))),s}}function ga(n,e,t,o){const i=e.get(X());t==null&&i!=null&&(t=rt(i,X()));let s=[];return e.children.inorderTraversal((r,l)=>{const a=t?t.getImmediateChild(r):null,d=aa(o,r),p=n.operationForChild(r);p&&(s=s.concat(ga(p,l,a,d)))}),i&&(s=s.concat(ms(i,n,o,t))),s}function Aa(n,e){const t=e.query,o=Do(n,t);return{hashFn:()=>(K0(e)||M.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return o?ch(n,t._path,o):ah(n,t._path);{const s=a2(i,t);return Di(n,t,null,s)}}}}function Do(n,e){const t=Fo(e);return n.queryToTagMap.get(t)}function Fo(n){return n._path.toString()+"$"+n._queryIdentifier}function ys(n,e){return n.tagToQueryMap.get(e)}function bs(n){const e=n.indexOf("$");return A(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new J(n.substr(0,e))}}function gs(n,e,t){const o=n.syncPointTree_.get(e);A(o,"Missing sync point for query tag that we're tracking");const i=ds(n.pendingWriteTree_,e);return ms(o,t,i,null)}function uh(n){return n.fold((e,t,o)=>{if(t&&Dn(t))return[xo(t)];{let i=[];return t&&(i=pa(t)),Ie(o,(s,r)=>{i=i.concat(r)}),i}})}function Mt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(ih())(n._repo,n._path):n}function ph(n,e){for(let t=0;t<e.length;++t){const o=e[t];if(!o._queryParams.loadsAllData()){const i=Fo(o),s=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(s)}}}function mh(){return sh++}function fh(n,e,t){const o=e._path,i=Do(n,e),s=Aa(n,t),r=n.listenProvider_.startListening(Mt(e),i,s.hashFn,s.onComplete),l=n.syncPointTree_.subtree(o);if(i)A(!Dn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((d,p,h)=>{if(!H(d)&&p&&Dn(p))return[xo(p).query];{let f=[];return p&&(f=f.concat(pa(p).map(b=>b.query))),Ie(h,(b,g)=>{f=f.concat(g)}),f}});for(let d=0;d<a.length;++d){const p=a[d];n.listenProvider_.stopListening(Mt(p),Do(n,p))}}return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cs{constructor(e="",t=null,o={children:{},childCount:0}){this.name=e,this.parent=t,this.node=o}}function Ps(n,e){let t=e instanceof J?e:new J(e),o=n,i=F(t);for(;i!==null;){const s=lt(o.node.children,i)||{children:{},childCount:0};o=new Cs(i,o,s),t=oe(t),i=F(t)}return o}function bt(n){return n.node.value}function Ca(n,e){n.node.value=e,Ti(n)}function Pa(n){return n.node.childCount>0}function Ah(n){return bt(n)===void 0&&!Pa(n)}function Ho(n,e){Ie(n.node.children,(t,o)=>{e(new Cs(t,n,o))})}function Ua(n,e,t,o){t&&!o&&e(n),Ho(n,i=>{Ua(i,e,!0,o)}),t&&o&&e(n)}function _h(n,e,t){let o=n.parent;for(;o!==null;){if(e(o))return!0;o=o.parent}return!1}function Zt(n){return new J(n.parent===null?n.name:Zt(n.parent)+"/"+n.name)}function Ti(n){n.parent!==null&&vh(n.parent,n.name,n)}function vh(n,e,t){const o=Ah(t),i=cn(n.node.children,e);o&&i?(delete n.node.children[e],n.node.childCount--,Ti(n)):!o&&!i&&(n.node.children[e]=t.node,n.node.childCount++,Ti(n))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sh{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Vo(n,e){let t=null;for(let o=0;o<e.length;o++){const i=e[o],s=i.getPath();t!==null&&!ns(s,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:s}),t.events.push(i)}t&&n.eventLists_.push(t)}function wa(n,e,t){Vo(n,t),Ia(n,o=>ns(o,e))}function sn(n,e,t){Vo(n,t),Ia(n,o=>Qe(o,e)||Qe(e,o))}function Ia(n,e){n.recursionDepth_++;let t=!0;for(let o=0;o<n.eventLists_.length;o++){const i=n.eventLists_[o];if(i){const s=i.path;e(s)?(kh(n.eventLists_[o]),n.eventLists_[o]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function kh(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const o=t.getEventRunner();kt&&we("event: "+t.toString()),ft(o)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dh="repo_interrupt",Th=25;class Nh{constructor(e,t,o,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=o,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Sh,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Uo(),this.transactionQueueTree_=new Cs,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Mh(n,e,t){if(n.stats_=$i(n.repoInfo_),n.forceRestClient_||u2())n.server_=new Po(n.repoInfo_,(o,i,s,r)=>{Fr(n,o,i,s,r)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Hr(n,!0),0);else{if(typeof t!="undefined"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ve(t)}catch(o){throw new Error("Invalid authOverride provided: "+o)}}n.persistentConnection_=new un(n.repoInfo_,e,(o,i,s,r)=>{Fr(n,o,i,s,r)},o=>{Hr(n,o)},o=>{Rh(n,o)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(o=>{n.server_.refreshAuthToken(o)}),n.appCheckProvider_.addTokenChangeListener(o=>{n.server_.refreshAppCheckToken(o.token)}),n.statsReporter_=b2(n.repoInfo_,()=>new f0(n.stats_,n.server_)),n.infoData_=new d0,n.infoSyncTree_=new Or({startListening:(o,i,s,r)=>{let l=[];const a=n.infoData_.getNode(o._path);return a.isEmpty()||(l=Lo(n.infoSyncTree_,o._path,a),setTimeout(()=>{r("ok")},0)),l},stopListening:()=>{}}),ws(n,"connected",!1),n.serverSyncTree_=new Or({startListening:(o,i,s,r)=>(n.server_.listen(o,s,i,(l,a)=>{const d=r(l,a);sn(n.eventQueue_,o._path,d)}),[]),stopListening:(o,i)=>{n.server_.unlisten(o,i)}})}function Sa(n){const t=n.infoData_.getNode(new J(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Wo(n){return yh({timestamp:Sa(n)})}function Fr(n,e,t,o,i){n.dataUpdateCount++;const s=new J(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let r=[];if(i)if(o){const a=yo(t,d=>_e(d));r=hh(n.serverSyncTree_,s,a,i)}else{const a=_e(t);r=dh(n.serverSyncTree_,s,a,i)}else if(o){const a=yo(t,d=>_e(d));r=lh(n.serverSyncTree_,s,a)}else{const a=_e(t);r=Lo(n.serverSyncTree_,s,a)}let l=s;r.length>0&&(l=ht(n,s)),sn(n.eventQueue_,l,r)}function Hr(n,e){ws(n,"connected",e),e===!1&&Lh(n)}function Rh(n,e){Ie(e,(t,o)=>{ws(n,t,o)})}function ws(n,e,t){const o=new J("/.info/"+e),i=_e(t);n.infoData_.updateSnapshot(o,i);const s=Lo(n.infoSyncTree_,o,i);sn(n.eventQueue_,o,s)}function Is(n){return n.nextWriteId_++}function Oh(n,e,t,o,i){jo(n,"set",{path:e.toString(),value:t,priority:o});const s=Wo(n),r=_e(t,o),l=fs(n.serverSyncTree_,e),a=va(r,l,s),d=Is(n),p=ya(n.serverSyncTree_,e,a,d,!0);Vo(n.eventQueue_,p),n.server_.put(e.toString(),r.val(!0),(f,b)=>{const g=f==="ok";g||De("set at "+e+" failed: "+f);const B=En(n.serverSyncTree_,d,!g);sn(n.eventQueue_,e,B),Ri(n,i,f,b)});const h=ks(n,e);ht(n,h),sn(n.eventQueue_,h,[])}function xh(n,e,t,o){jo(n,"update",{path:e.toString(),value:t});let i=!0;const s=Wo(n),r={};if(Ie(t,(l,a)=>{i=!1,r[l]=_a(ae(e,l),_e(a),n.serverSyncTree_,s)}),i)we("update() called with empty data.  Don't do anything."),Ri(n,o,"ok",void 0);else{const l=Is(n),a=rh(n.serverSyncTree_,e,r,l);Vo(n.eventQueue_,a),n.server_.merge(e.toString(),t,(d,p)=>{const h=d==="ok";h||De("update at "+e+" failed: "+d);const f=En(n.serverSyncTree_,l,!h),b=f.length>0?ht(n,e):e;sn(n.eventQueue_,b,f),Ri(n,o,d,p)}),Ie(t,d=>{const p=ks(n,ae(e,d));ht(n,p)}),sn(n.eventQueue_,e,[])}}function Lh(n){jo(n,"onDisconnectEvents");const e=Wo(n),t=Uo();Ui(n.onDisconnect_,X(),(i,s)=>{const r=_a(i,s,n.serverSyncTree_,e);oa(t,i,r)});let o=[];Ui(t,X(),(i,s)=>{o=o.concat(Lo(n.serverSyncTree_,i,s));const r=ks(n,i);ht(n,r)}),n.onDisconnect_=Uo(),sn(n.eventQueue_,X(),o)}function Fh(n,e,t){let o;F(e._path)===".info"?o=xr(n.infoSyncTree_,e,t):o=xr(n.serverSyncTree_,e,t),wa(n.eventQueue_,e._path,o)}function Mi(n,e,t){let o;F(e._path)===".info"?o=Di(n.infoSyncTree_,e,t):o=Di(n.serverSyncTree_,e,t),wa(n.eventQueue_,e._path,o)}function Hh(n){n.persistentConnection_&&n.persistentConnection_.interrupt(Dh)}function jo(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),we(t,...e)}function Ri(n,e,t,o){e&&ft(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let s=i;o&&(s+=": "+o);const r=new Error(s);r.code=i,e(r)}})}function ka(n,e,t){return fs(n.serverSyncTree_,e,t)||M.EMPTY_NODE}function Ss(n,e=n.transactionQueueTree_){if(e||Go(n,e),bt(e)){const t=Ta(n,e);A(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&zh(n,Zt(e),t)}else Pa(e)&&Ho(e,t=>{Ss(n,t)})}function zh(n,e,t){const o=t.map(d=>d.currentWriteId),i=ka(n,e,o);let s=i;const r=i.hash();for(let d=0;d<t.length;d++){const p=t[d];A(p.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),p.status=1,p.retryCount++;const h=Me(e,p.path);s=s.updateChild(h,p.currentOutputSnapshotRaw)}const l=s.val(!0),a=e;n.server_.put(a.toString(),l,d=>{jo(n,"transaction put response",{path:a.toString(),status:d});let p=[];if(d==="ok"){const h=[];for(let f=0;f<t.length;f++)t[f].status=2,p=p.concat(En(n.serverSyncTree_,t[f].currentWriteId)),t[f].onComplete&&h.push(()=>t[f].onComplete(null,!0,t[f].currentOutputSnapshotResolved)),t[f].unwatcher();Go(n,Ps(n.transactionQueueTree_,e)),Ss(n,n.transactionQueueTree_),sn(n.eventQueue_,e,p);for(let f=0;f<h.length;f++)ft(h[f])}else{if(d==="datastale")for(let h=0;h<t.length;h++)t[h].status===3?t[h].status=4:t[h].status=0;else{De("transaction at "+a.toString()+" failed: "+d);for(let h=0;h<t.length;h++)t[h].status=4,t[h].abortReason=d}ht(n,e)}},r)}function ht(n,e){const t=Da(n,e),o=Zt(t),i=Ta(n,t);return Vh(n,i,o),o}function Vh(n,e,t){if(e.length===0)return;const o=[];let i=[];const r=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],d=Me(t,a.path);let p=!1,h;if(A(d!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)p=!0,h=a.abortReason,i=i.concat(En(n.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=Th)p=!0,h="maxretry",i=i.concat(En(n.serverSyncTree_,a.currentWriteId,!0));else{const f=ka(n,a.path,r);a.currentInputSnapshot=f;const b=e[l].update(f.val());if(b!==void 0){zo("transaction failed: Data returned ",b,a.path);let g=_e(b);typeof b=="object"&&b!=null&&cn(b,".priority")||(g=g.updatePriority(f.getPriority()));const D=a.currentWriteId,U=Wo(n),G=va(g,f,U);a.currentOutputSnapshotRaw=g,a.currentOutputSnapshotResolved=G,a.currentWriteId=Is(n),r.splice(r.indexOf(D),1),i=i.concat(ya(n.serverSyncTree_,a.path,G,a.currentWriteId,a.applyLocally)),i=i.concat(En(n.serverSyncTree_,D,!0))}else p=!0,h="nodata",i=i.concat(En(n.serverSyncTree_,a.currentWriteId,!0))}sn(n.eventQueue_,t,i),i=[],p&&(e[l].status=2,function(f){setTimeout(f,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(h==="nodata"?o.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):o.push(()=>e[l].onComplete(new Error(h),!1,null))))}Go(n,n.transactionQueueTree_);for(let l=0;l<o.length;l++)ft(o[l]);Ss(n,n.transactionQueueTree_)}function Da(n,e){let t,o=n.transactionQueueTree_;for(t=F(e);t!==null&&bt(o)===void 0;)o=Ps(o,t),e=oe(e),t=F(e);return o}function Ta(n,e){const t=[];return Na(n,e,t),t.sort((o,i)=>o.order-i.order),t}function Na(n,e,t){const o=bt(e);if(o)for(let i=0;i<o.length;i++)t.push(o[i]);Ho(e,i=>{Na(n,i,t)})}function Go(n,e){const t=bt(e);if(t){let o=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[o]=t[i],o++);t.length=o,Ca(e,t.length>0?t:void 0)}Ho(e,o=>{Go(n,o)})}function ks(n,e){const t=Zt(Da(n,e)),o=Ps(n.transactionQueueTree_,e);return _h(o,i=>{hi(n,i)}),hi(n,o),Ua(o,i=>{hi(n,i)}),t}function hi(n,e){const t=bt(e);if(t){const o=[];let i=[],s=-1;for(let r=0;r<t.length;r++)t[r].status===3||(t[r].status===1?(A(s===r-1,"All SENT items should be at beginning of queue."),s=r,t[r].status=3,t[r].abortReason="set"):(A(t[r].status===0,"Unexpected transaction status in abort"),t[r].unwatcher(),i=i.concat(En(n.serverSyncTree_,t[r].currentWriteId,!0)),t[r].onComplete&&o.push(t[r].onComplete.bind(null,new Error("set"),!1,null))));s===-1?Ca(e,void 0):t.length=s+1,sn(n.eventQueue_,Zt(e),i);for(let r=0;r<o.length;r++)ft(o[r])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wh(n){let e="";const t=n.split("/");for(let o=0;o<t.length;o++)if(t[o].length>0){let i=t[o];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch(s){}e+="/"+i}return e}function jh(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const o=t.split("=");o.length===2?e[decodeURIComponent(o[0])]=decodeURIComponent(o[1]):De(`Invalid query segment '${t}' in query '${n}'`)}return e}const zr=function(n,e){const t=Gh(n),o=t.namespace;t.domain==="firebase.com"&&mn(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!o||o==="undefined")&&t.domain!=="localhost"&&mn("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||o2();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new Fl(t.host,t.secure,o,i,e,"",o!==t.subdomain),path:new J(t.pathString)}},Gh=function(n){let e="",t="",o="",i="",s="",r=!0,l="https",a=443;if(typeof n=="string"){let d=n.indexOf("//");d>=0&&(l=n.substring(0,d-1),n=n.substring(d+2));let p=n.indexOf("/");p===-1&&(p=n.length);let h=n.indexOf("?");h===-1&&(h=n.length),e=n.substring(0,Math.min(p,h)),p<h&&(i=Wh(n.substring(p,h)));const f=jh(n.substring(Math.min(n.length,h)));d=e.indexOf(":"),d>=0?(r=l==="https"||l==="wss",a=parseInt(e.substring(d+1),10)):d=e.length;const b=e.slice(0,d);if(b.toLowerCase()==="localhost")t="localhost";else if(b.split(".").length<=2)t=b;else{const g=e.indexOf(".");o=e.substring(0,g).toLowerCase(),t=e.substring(g+1),s=o}"ns"in f&&(s=f.ns)}return{host:e,port:a,domain:t,subdomain:o,secure:r,scheme:l,pathString:i,namespace:s}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xh{constructor(e,t,o,i){this.eventType=e,this.eventRegistration=t,this.snapshot=o,this.prevName=i}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+ve(this.snapshot.exportVal())}}class Qh{constructor(e,t,o){this.eventRegistration=e,this.error=t,this.path=o}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ko{constructor(e,t,o,i){this._repo=e,this._path=t,this._queryParams=o,this._orderByCalled=i}get key(){return H(this._path)?null:es(this._path)}get ref(){return new Mn(this._repo,this._path)}get _queryIdentifier(){const e=Br(this._queryParams),t=Ji(e);return t==="{}"?"default":t}get _queryObject(){return Br(this._queryParams)}isEqual(e){if(e=Jn(e),!(e instanceof Ko))return!1;const t=this._repo===e._repo,o=ns(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&o&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+H2(this._path)}}function Jh(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function qh(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===jn){const o="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==Gn)throw new Error(o);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==Sn)throw new Error(o);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===se){if(e!=null&&!Ni(e)||t!=null&&!Ni(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(A(n.getIndex()instanceof is||n.getIndex()===na,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class Mn extends Ko{constructor(e,t){super(e,t,new rs,!1)}get parent(){const e=Ql(this._path);return e===null?null:new Mn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class To{constructor(e,t,o){this._node=e,this.ref=t,this._index=o}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new J(e),o=Kt(this.ref,e);return new To(this._node.getChild(t),o,se)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(o,i)=>e(new To(i,Kt(this.ref,o),se)))}hasChild(e){const t=new J(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ze(n,e){return n=Jn(n),n._checkNotDeleted("ref"),e!==void 0?Kt(n._root,e):n._root}function Kt(n,e){return n=Jn(n),F(n._path)===null?wh("child","path",e):Es("child","path",e),new Mn(n._repo,ae(n._path,e))}function co(n,e){n=Jn(n),Bs("push",n._path),Ba("push",e,n._path,!0);const t=Sa(n._repo),o=Kh(t),i=Kt(n,o),s=Kt(n,o);let r;return r=Promise.resolve(s),i.then=r.then.bind(r),i.catch=r.then.bind(r,void 0),i}function Ma(n){return Bs("remove",n._path),$h(n,null)}function $h(n,e){n=Jn(n),Bs("set",n._path),Ba("set",e,n._path,!1);const t=new Qt;return Oh(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function Oi(n,e){Bh("update",e,n._path);const t=new Qt;return xh(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}class Ds{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const o=t._queryParams.getIndex();return new Xh("value",this,new To(e.snapshotNode,new Mn(t._repo,t._path),o))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Qh(this,e,t):null}matches(e){return e instanceof Ds?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Zh(n,e,t,o,i){let s;if(typeof o=="object"&&(s=void 0,i=o),typeof o=="function"&&(s=o),i&&i.onlyOnce){const a=t,d=(p,h)=>{Mi(n._repo,n,l),a(p,h)};d.userCallback=t.userCallback,d.context=t.context,t=d}const r=new Yh(t,s||void 0),l=new Ds(r);return Fh(n._repo,n,l),()=>Mi(n._repo,n,l)}function Ra(n,e,t,o){return Zh(n,"value",e,t,o)}function Oa(n,e,t){Mi(n._repo,n,null)}class eu{}class nu extends eu{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){Jh(e,"orderByChild");const t=new J(this._path);if(H(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const o=new is(t),i=c0(e._queryParams,o);return qh(i),new Ko(e._repo,e._path,i,!0)}}function tu(n){return Es("orderByChild","path",n),new nu(n)}function ou(n,...e){let t=Jn(n);for(const o of e)t=o._apply(t);return t}q0(Mn);oh(Mn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iu="FIREBASE_DATABASE_EMULATOR_HOST",xi={};let su=!1;function ru(n,e,t,o){const i=e.lastIndexOf(":"),s=e.substring(0,i),r=gl(s);n.repoInfo_=new Fl(e,r,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),o&&(n.authTokenProvider_=o)}function lu(n,e,t,o,i){let s=o||n.options.databaseURL;s===void 0&&(n.options.projectId||mn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),we("Using default host for project ",n.options.projectId),s=`${n.options.projectId}-default-rtdb.firebaseio.com`);let r=zr(s,i),l=r.repoInfo,a;typeof process!="undefined"&&ar&&(a=ar[iu]),a?(s=`http://${a}?ns=${l.namespace}`,r=zr(s,i),l=r.repoInfo):r.repoInfo.secure;const d=new m2(n.name,n.options,e);Ih("Invalid Firebase Database URL",r),H(r.path)||mn("Database URL must point to the root of a Firebase Database (not including a child path).");const p=cu(l,n,d,new p2(n,t));return new du(p,n)}function au(n,e){const t=xi[e];(!t||t[n.key]!==n)&&mn(`Database ${e}(${n.repoInfo_}) has already been deleted.`),Hh(n),delete t[n.key]}function cu(n,e,t,o){let i=xi[e.name];i||(i={},xi[e.name]=i);let s=i[n.toURLString()];return s&&mn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new Nh(n,su,t,o),i[n.toURLString()]=s,s}class du{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Mh(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Mn(this._repo,X())),this._rootInternal}_delete(){return this._rootInternal!==null&&(au(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&mn("Cannot call "+e+" on a deleted database.")}}function hu(n=H1(),e){const t=R1(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const o=Ud("database");o&&uu(t,...o)}return t}function uu(n,e,t,o={}){n=Jn(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,s=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&bo(o,s.repoInfo_.emulatorOptions))return;mn("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let r;if(s.repoInfo_.nodeAdmin)o.mockUserToken&&mn('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new ao(ao.OWNER);else if(o.mockUserToken){const l=typeof o.mockUserToken=="string"?o.mockUserToken:Ed(o.mockUserToken,n.app.options.projectId);r=new ao(l)}gl(e)&&Ld(e),ru(s,i,o,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pu(n){q1(F1),Ao(new Lt("database",(e,{instanceIdentifier:t})=>{const o=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return lu(o,i,s,t)},"PUBLIC").setMultipleInstances(!0)),it(cr,dr,n),it(cr,dr,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mu={".sv":"timestamp"};function Vn(){return mu}un.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};un.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};pu();var fu="firebase",yu="12.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */it(fu,yu,"app");const Fn=n=>n?String(n).split(/[\r\n,=\s]/)[0].trim():"",Li={apiKey:Fn("AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs"),authDomain:Fn("findparkinglot-2519e.firebaseapp.com"),projectId:Fn("findparkinglot-2519e"),databaseURL:Fn("https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app"),storageBucket:Fn("findparkinglot-2519e.firebasestorage.app"),messagingSenderId:Fn("976769533420"),appId:Fn("1:976769533420:web:f3108318b3def30017acc9")},an=!!(Li.apiKey&&Li.databaseURL);let Wr=null,Xe=null;an&&(Wr=Cl(Li),Xe=hu(Wr));const ho="parking_overrides",St=E({}),xa=E(!1),Fi=E(null);let Rt=null,ui=0;function uo(n,e){if(!n||!Array.isArray(e))return"";const t=Number(e[0]),o=Number(e[1]);return!isFinite(t)||!isFinite(o)?"":`${n}|${t.toFixed(6)},${o.toFixed(6)}`.replace(/[.#$/[\]]/g,"_")}function La(n,e){if(!e)return n;const t={...n},o=i=>{const s=e[i];s!=null&&(typeof s=="string"&&s.trim()===""||(t[i]=s))};return o("description"),o("iconKey"),o("category"),o("friendliness"),o("priceInfo"),t}function bu(){if(!(!an||Rt))try{const n=Ze(Xe,ho);Rt=n,Ra(n,e=>{const t={};e.forEach(o=>{t[o.key]=o.val()||{}}),St.value=t,xa.value=!0},e=>{Fi.value=e})}catch(n){Fi.value=n}}function gu(){Rt&&(Oa(Rt),Rt=null)}function Au(){Yn(()=>{ui+=1,bu()}),pt(()=>{ui-=1,ui<=0&&gu()});const n=(s,r)=>{const l=uo(s,r);return l&&St.value[l]||null};return{overrides:St,ready:xa,error:Fi,getOverride:n,hasOverride:(s,r)=>!!n(s,r),getOverrideHistory:(s,r)=>{const l=n(s,r);return!l||!l.history||typeof l.history!="object"?[]:Object.entries(l.history).map(([a,d])=>({...d||{},_key:a})).sort((a,d)=>a._key<d._key?1:a._key>d._key?-1:0)},upsertOverride:async(s,r,l)=>{var N,V,Pe;if(!an)throw new Error("Firebase 尚未設定");const a=uo(s.name,s.geometry);if(!a)throw new Error("無法產生 override key (缺少 name 或 geometry)");const[d,p]=s.geometry,h={id:l.id,nickname:l.nickname||""},f={origName:s.name||"",origLng:Number(d),origLat:Number(p),description:typeof r.description=="string"?r.description.trim():"",iconKey:r.iconKey||"",category:r.category||"",friendliness:r.friendliness||"",priceInfo:typeof r.priceInfo=="string"?r.priceInfo.trim():"",updatedBy:h,updatedAt:Vn()},b=St.value[a]||null,g=La(s,b),B=["description","iconKey","category","friendliness","priceInfo"],D={},U={};for(const ce of B){const Se=(N=g==null?void 0:g[ce])!=null?N:"",Ue=(V=f[ce])!=null?V:"";String(Se)!==String(Ue)&&(D[ce]=Se,U[ce]=Ue)}const G=co(Ze(Xe,`${ho}/${a}/history`)).key;return await Oi(Ze(Xe),{[`${ho}/${a}`]:{...f,history:{...((Pe=St.value[a])==null?void 0:Pe.history)||{},[G]:{action:"override",at:Vn(),by:h,before:D,after:U}}}}),a},resetOverride:async(s,r)=>{if(!an)throw new Error("Firebase 尚未設定");const l=uo(s,r);l&&await Ma(Ze(Xe,`${ho}/${l}`))}}}const rn=(n,e)=>{const t=n.__vccOpts||n;for(const[o,i]of e)t[o]=i;return t},_u={id:"map"},vu=16,jr=34,Cu=84,Pu={__name:"MapBox",props:{parkingTypeKeyArray:Array,degreeOfFriendlinessKeyArray:Array,mapDataList:Array,getLngLat:Boolean,mapStylesSelected:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,goToParkingPlaceData:Object,routeData:Object,favoriteIds:{type:Object,default:()=>new Set},overrideKeys:{type:Object,default:()=>new Set},overrides:{type:Object,default:()=>({})},onlyFavorites:{type:Boolean,default:!1},showOfficial:{type:Boolean,default:!0},showOverridden:{type:Boolean,default:!0},showCommunity:{type:Boolean,default:!0},focusCoord:{type:Array,default:null},routeProfile:{type:String,default:"driving"},communityParkings:{type:Array,default:()=>[]}},emits:["parkingInfo","communityParkingClick","update:goToParkingPlaceData","update:routeData"],setup(n,{expose:e,emit:t}){const o=n,i=t,s="pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",r=E(null),l=E({accessToken:s,bounds:[[119.3620389067818,21.83282743468497],[122.07013958372167,25.34391086143183]],center:[121.5173399,25.0475613],zoom:14,userCoordinates:[null,null]}),a=E(null),d=E([]),p=P=>P>=15?60:P>=13?60+(15-P)*30:P>=11?120+(13-P)*60:240,h=P=>Array.isArray(P)&&P.length>=2&&Number.isFinite(Number(P[0]))&&Number.isFinite(Number(P[1])),f=(P,R,Q,W,Z)=>{const ie=document.createElement("div");ie.className="marker",W&&ie.classList.add("is-override"),Q&&ie.classList.add("is-fav");const Oe=document.createElement("div");Oe.className="tag";const be=document.createElement("div");be.className="img";const _=Z||R.properties.icon;return _&&(be.style.backgroundImage=`url(${q(_)})`,be.style.backgroundSize="cover",be.style.backgroundPosition="center center"),ie.appendChild(Oe),ie.appendChild(be),ie.addEventListener("click",()=>{r.value.flyTo({center:R.geometry.coordinates,zoom:17,bearing:0,speed:1.5,curve:1.5,easing:w=>w,essential:!0}),i("parkingInfo",{name:P.name,properties:R.properties,geometry:R.geometry.coordinates,address:""})}),ie},b=(P,R)=>{const Q=document.createElement("div");Q.className="marker is-community",R&&Q.classList.add("is-fav");const W=document.createElement("div");W.className="tag";const Z=document.createElement("div");return Z.className="img",P.iconKey&&(Z.style.backgroundImage=`url(${q(P.iconKey)})`,Z.style.backgroundSize="cover",Z.style.backgroundPosition="center center"),Q.appendChild(W),Q.appendChild(Z),Q.addEventListener("click",()=>{r.value.flyTo({center:P.coordinates,zoom:17,speed:1.5,curve:1.5,essential:!0}),i("communityParkingClick",P)}),Q},g=P=>{const R=document.createElement("div");R.className="marker-cluster";const Q=Math.min(1,Math.log2(Math.max(2,P))/Math.log2(500)),W=Math.round(jr+(Cu-jr)*Q),Z=Math.round(12+10*Q);return R.style.width=`${W}px`,R.style.height=`${W}px`,R.style.lineHeight=`${W}px`,R.style.fontSize=`${Z}px`,R.textContent=String(P),R},B=()=>{var ie,Oe,be,_,T,w,le,Ne,xe,fn,On,Ee;for(let O=d.value.length-1;O>=0;O--)d.value[O].remove();if(d.value=[],!r.value)return;const P=(Oe=(ie=r.value).getBounds)==null?void 0:Oe.call(ie),R=[];for(const O of o.mapDataList)for(const x of O.features){const de=x.geometry.coordinates;if(!h(de))continue;const Le=mi(x.properties.name,de),Fe=(_=(be=o.favoriteIds)==null?void 0:be.has)==null?void 0:_.call(be,Le),he=uo(x.properties.name,de),He=he?(w=(T=o.overrideKeys)==null?void 0:T.has)==null?void 0:w.call(T,he):!1;if(He){if(!o.showOfficial&&!o.showOverridden)continue}else if(!o.showOfficial)continue;const ke=He?(le=o.overrides)==null?void 0:le[he]:null,xn=typeof(ke==null?void 0:ke.priceInfo)=="string"&&ke.priceInfo.trim()!==""?ke.priceInfo.trim():"",eo=xn||x.properties.priceInfo,Xo=xn?xn.split("|"):x.properties.priceArray,no=(typeof(ke==null?void 0:ke.iconKey)=="string"&&ke.iconKey.trim()!==""?ke.iconKey.trim():"")||x.properties.icon;!Ys(P,de)||o.onlyFavorites&&!Fe||!Xs(no,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray)||!Qs(eo,Xo,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)||R.push({coord:[Number(de[0]),Number(de[1])],createEl:()=>f(O,x,Fe,He,no)})}for(const O of o.communityParkings||[]){if(!o.showCommunity)break;const x=O.coordinates;if(!h(x)||!Ys(P,x))continue;const de=mi(O.name,x),Le=(xe=(Ne=o.favoriteIds)==null?void 0:Ne.has)==null?void 0:xe.call(Ne,de);if(o.onlyFavorites&&!Le||!Xs(O.iconKey,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray))continue;const Fe=O.priceInfo||"",he=Fe?Fe.split("|"):[];Qs(Fe,he,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)&&R.push({coord:[Number(x[0]),Number(x[1])],createEl:()=>b(O,Le)})}const Q=(Ee=(On=(fn=r.value).getZoom)==null?void 0:On.call(fn))!=null?Ee:0;if(Q>=vu){for(const O of R){const x=new Ln.Marker(O.createEl()).setLngLat(O.coord).addTo(r.value);d.value.push(x)}return}const W=p(Q),Z=new Map;for(const O of R){const x=r.value.project(O.coord),de=Math.floor(x.x/W),Le=Math.floor(x.y/W),Fe=`${de}:${Le}`;let he=Z.get(Fe);he||(he={points:[],sumLng:0,sumLat:0},Z.set(Fe,he)),he.points.push(O),he.sumLng+=O.coord[0],he.sumLat+=O.coord[1]}for(const O of Z.values())if(O.points.length===1){const x=O.points[0],de=new Ln.Marker(x.createEl()).setLngLat(x.coord).addTo(r.value);d.value.push(de)}else{const x=[O.sumLng/O.points.length,O.sumLat/O.points.length],de=g(O.points.length);de.addEventListener("click",()=>{var he,He,ke;const Fe=Math.min(((ke=(He=(he=r.value).getZoom)==null?void 0:He.call(he))!=null?ke:0)+2,17);r.value.flyTo({center:x,zoom:Fe,speed:1.5,curve:1.5,essential:!0})});const Le=new Ln.Marker(de).setLngLat(x).addTo(r.value);d.value.push(Le)}};let D=null,U=null;const G=()=>{D!=null&&(clearTimeout(D),D=null),U!=null&&(typeof cancelIdleCallback=="function"&&cancelIdleCallback(U),U=null)},N=()=>{G(),D=setTimeout(()=>{D=null;const P=()=>{U=null,o.goToParkingPlaceData==null&&B()};typeof requestIdleCallback=="function"?U=requestIdleCallback(P,{timeout:250}):P()},80)},V=()=>{const P=document.getElementById("loading-cover");P&&(P.classList.add("active"),setTimeout(()=>P.remove(),600))},Pe=()=>{r.value.on("dragend",N),r.value.on("zoomend",N),B(),V(),r.value.once("load",()=>{const P=o.focusCoord;Array.isArray(P)&&P[0]!=null&&P[1]!=null&&r.value.flyTo({center:[Number(P[0]),Number(P[1])],zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})})},ce=()=>{r.value=new Ln.Map({container:"map",style:o.mapStylesSelected,center:l.value.center,zoom:16,trackResize:!0,maxBounds:l.value.bounds}),Pe(),r.value.addControl(new Ln.GeolocateControl({positionOptions:{enableHighAccuracy:!0},trackUserLocation:!0,showUserHeading:!0})),r.value.on("geolocate",P=>{r.value.easeTo({bearing:P.coords.heading,duration:1e3,offset:[0,0]})})},Se=P=>{const{longitude:R,latitude:Q}=P.coords;R>=l.value.bounds[0][0]&&R<=l.value.bounds[1][0]&&Q>=l.value.bounds[0][1]&&Q<=l.value.bounds[1][1]?(l.value.userCoordinates=[R,Q],l.value.center=[R,Q]):l.value.center=[121.5173399,25.0475613],ce()},Ue=()=>{ce()},Je=()=>{const P=document.getElementById("coordinates"),R=a.value.getLngLat();P.style.display="block",P.innerHTML=`[Longitude, Latitude]<br />[${R.lng}, ${R.lat}]`},pe=()=>{a.value=new Ln.Marker({draggable:!0,color:"#2ee7d6"}).setLngLat(r.value.getCenter()).addTo(r.value),Je(),a.value.on("dragend",Je)};async function re(P,R){r.value.getLayer("point")||r.value.addLayer({id:"point",type:"circle",source:{type:"geojson",data:{type:"FeatureCollection",features:[{type:"Feature",properties:{},geometry:{type:"Point",coordinates:P}}]}},paint:{"circle-radius":10,"circle-color":"#2ee7d6"}});const Z=(await(await fetch(`https://api.mapbox.com/directions/v5/mapbox/${o.routeProfile||"driving"}/${P[0]},${P[1]};${R[0]},${R[1]}?alternatives=false&language=zh-Hant&overview=full&steps=true&exclude=ferry&geometries=geojson&access_token=${l.value.accessToken}`,{method:"GET"})).json()).routes[0],ie={type:"Feature",properties:{},geometry:{type:"LineString",coordinates:Z.geometry.coordinates}};i("update:routeData",Z),r.value.getSource("route")?r.value.getSource("route").setData(ie):r.value.addLayer({id:"route",type:"line",source:{type:"geojson",data:ie},layout:{"line-join":"round","line-cap":"round"},paint:{"line-color":"#2ee7d6","line-width":5,"line-opacity":.75}})}const Te=P=>{if(l.value.userCoordinates[0]!==null){r.value.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point"));for(let Q=d.value.length-1;Q>=0;Q--){const W=d.value[Q].getLngLat();W.lng!=P[0]&&W.lat!=P[1]&&d.value[Q].remove()}const R=[[l.value.userCoordinates[0],l.value.userCoordinates[1]],[P[0],P[1]]];r.value.fitBounds(R,{padding:{top:100,bottom:100,left:100,right:100}}),re(l.value.userCoordinates,P)}else"geolocation"in navigator&&navigator.geolocation.getCurrentPosition(Se,Ue)},je=()=>{var P,R;(P=r.value)!=null&&P.getSource("route")&&(r.value.removeLayer("route"),r.value.removeSource("route")),(R=r.value)!=null&&R.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point")),B(),i("update:goToParkingPlaceData",null)};return Yn(()=>{Ln.accessToken=l.value.accessToken,"geolocation"in navigator?navigator.geolocation.getCurrentPosition(Se,Ue,{enableHighAccuracy:!1,timeout:8e3,maximumAge:6e4}):ce()}),pt(()=>{G()}),K([()=>o.parkingTypeKeyArray,()=>o.degreeOfFriendlinessKeyArray,()=>o.priceRangeMin,()=>o.priceRangeMax,()=>o.parkingPriceType,()=>o.onlyFavorites,()=>o.showOfficial,()=>o.showOverridden,()=>o.showCommunity,()=>o.favoriteIds,()=>o.communityParkings,()=>o.overrides],()=>N(),{deep:!0}),K(()=>o.focusCoord,P=>{!P||!r.value||r.value.flyTo({center:P,zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})}),K(()=>o.routeProfile,()=>{o.goToParkingPlaceData!==null&&l.value.userCoordinates[0]!==null&&re(l.value.userCoordinates,o.goToParkingPlaceData)}),K(()=>o.goToParkingPlaceData,P=>{P!==null?Te(P):je()}),K(()=>o.mapStylesSelected,(P,R)=>{R!==P&&r.value&&r.value.setStyle(P)}),K(()=>o.getLngLat,()=>{if(a.value!==null){a.value.remove();const P=document.getElementById("coordinates");P&&(P.style.display="none")}o.getLngLat===!0&&pe()}),e({getCenter:()=>{if(!r.value)return[...l.value.center];const P=r.value.getCenter();return[P.lng,P.lat]},flyTo:(P,R=17)=>{!r.value||!P||r.value.flyTo({center:P,zoom:R,essential:!0})}}),(P,R)=>(v(),C("div",_u))}},Uu=rn(Pu,[["__scopeId","data-v-98a3b97e"]]),Eu=n=>(Tn("data-v-4ef15e45"),n=n(),Nn(),n),Bu={key:0,class:"modal-header"},wu=Eu(()=>c("span",{class:"material-icons-outlined"},"close",-1)),Iu=[wu],Su={class:"modal-body"},ku={key:1,class:"modal-footer"},Du={__name:"BaseModal",props:{modelValue:Boolean,title:{type:String,default:""},closeText:{type:String,default:"關閉"},size:{type:String,default:"md"}},emits:["update:modelValue","close"],setup(n,{emit:e}){const t=n,o=e,i=E(null),s=()=>{o("update:modelValue",!1),o("close")},r=l=>{l.key==="Escape"&&t.modelValue&&s()};return Yn(()=>window.addEventListener("keydown",r)),pt(()=>window.removeEventListener("keydown",r)),K(()=>t.modelValue,async l=>{var a;document.body.classList.toggle("modal-open",l),l&&(await qr(),(a=i.value)==null||a.scrollTo({top:0,behavior:"auto"}))}),(l,a)=>(v(),ji(gc,{to:"body"},[c("div",{class:$(["modal-overlay",{active:n.modelValue}]),onClick:Gi(s,["self"]),role:"dialog","aria-modal":"true",ref_key:"overlayEl",ref:i},[c("div",{class:$(["modal-card",[`size-${n.size}`,{active:n.modelValue}]])},[n.title||l.$slots.header?(v(),C("header",Bu,[ei(l.$slots,"header",{},()=>[c("h3",null,I(n.title),1)]),c("button",{class:"modal-close",onClick:s,"aria-label":"關閉"},Iu)])):j("",!0),c("div",Su,[ei(l.$slots,"default",{},void 0)]),l.$slots.footer||n.closeText?(v(),C("footer",ku,[ei(l.$slots,"footer",{},()=>[c("button",{class:"btn btn-primary",onClick:s},I(n.closeText),1)])])):j("",!0)],2)],2)]))}},Pn=rn(Du,[["__scopeId","data-v-4ef15e45"]]),Tu=["onClick"],Nu={class:"material-icons-outlined"},Mu={class:"fab-item-label"},Ru=["aria-label","aria-expanded"],Ou={class:"material-icons-outlined"},xu={__name:"FabMenu",props:{items:{type:Array,required:!0},placement:{type:String,default:"right"},mainIcon:{type:String,default:"apps"},mainLabel:{type:String,default:""}},setup(n){const e=E(!1),t=E(null),o=()=>e.value=!e.value,i=r=>{t.value&&!t.value.contains(r.target)&&(e.value=!1)},s=r=>{var l;e.value=!1,(l=r.onClick)==null||l.call(r)};return Yn(()=>document.addEventListener("click",i)),pt(()=>document.removeEventListener("click",i)),(r,l)=>(v(),C("div",{class:$(["fab-root",`fab-placement-${n.placement}`]),ref_key:"rootEl",ref:t},[Be(Ac,{name:"fab-item",tag:"div",class:"fab-items"},{default:$e(()=>[(v(!0),C(ye,null,We(e.value?n.items:[],(a,d)=>(v(),C("button",{key:a.key,class:$(["fab-item",{highlight:a.highlight}]),style:mo({bottom:d*46+"px"}),onClick:p=>s(a)},[c("span",Nu,I(a.icon),1),c("span",Mu,I(a.label),1)],14,Tu))),128))]),_:1}),c("button",{class:$(["fab-main",{active:e.value}]),onClick:Gi(o,["stop"]),"aria-label":e.value?"收合選單":n.mainLabel||"展開選單","aria-expanded":e.value},[c("span",Ou,I(e.value?"close":n.mainIcon),1)],10,Ru)],2))}},Gr=rn(xu,[["__scopeId","data-v-b3399b6f"]]),ut=[{name:"全部",value:"",key:null},{name:"汽車：汽車格(含未確認是否有重機格)",value:"car",key:["icon-1.png","icon-2.png","icon-3.png","icon-5.png"]},{name:"重機：有設重機專用格",value:"motorcycle",key:["icon-6.png","icon-8.png","icon-12.png","icon-13.png"]},{name:"機車：機車格",value:"scooter",key:["icon-7.png","icon-9.png","icon-10.png","icon-11.png"]},{name:"綠星:路邊友善車格(機車格開放重機停放)",value:"greenStar",key:["icon-14.png"]},{name:"重機友善店家:用餐/消費可停重機",value:"friendlyShop",key:["icon-4.png"]},{name:"綠P:重機專用路邊停車格",value:"greenP",key:["icon-15.png"]},{name:"灰P:重機專用路邊停車格(未確認精準座標)",value:"greyP",key:["icon-16.png"]},{name:"藍P:普通大型共用機車格(台北市試辦)",value:"blueP",key:["icon-17.png"]},{name:"紫P:時段性汽機車共用停車格，注意使用時間喔!",value:"purpleP",key:["icon-18.png"]},{name:"紅X:停都不給停",value:"redX",key:["icon-19.png"]},{name:"?:類型未確認",value:"unknown",key:["icon-20.png"]}];function Lu(n){if(!n)return"未分類";const e=ut.find(t=>Array.isArray(t.key)&&t.key.includes(n));return e?e.name.split(/[：:]/)[0]:"未分類"}const Xt=[{name:"全部",value:"",key:null},{name:"最友善：有後牌辨析",value:"friendly",key:["icon-2.png","icon-4.png","icon-6.png","icon-9.png","icon-14.png","icon-15.png"]},{name:"最傳統：悠遊卡、按鈕取票",value:"normal",key:["icon-5.png","icon-11.png","icon-12.png","icon-17.png"]},{name:"最靠北：按鈕請管理員協助、前牌辨析",value:"unfriendly",key:["icon-1.png","icon-7.png","icon-13.png","icon-19.png"]},{name:"未確定",value:"unknown",key:["icon-3.png","icon-8.png","icon-10.png","icon-16.png","icon-20.png"]}],tt=[{name:"依系統設定",value:"system",theme:"system"},{name:"暗色模式",value:"mapbox://styles/jamestim9215/ckvkdj5cd1q4115nzwxa9rny3",theme:"dark"},{name:"亮色模式",value:"mapbox://styles/jamestim9215/ckvueghhu2woc14nrsgysx41v",theme:"light"}],Fu="260715",Hu=n=>(Tn("data-v-fc736dec"),n=n(),Nn(),n),zu={class:"range-slider"},Vu={class:"range-track"},Wu=["min","max","step","value"],ju=["min","max","step","value"],Gu={class:"range-values"},Ku=Hu(()=>c("span",{class:"range-sep"},"~",-1)),Xu={__name:"RangeSlider",props:{min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:10},modelMin:{type:Number,default:0},modelMax:{type:Number,default:100},suffix:{type:String,default:""}},emits:["update:modelMin","update:modelMax"],setup(n,{emit:e}){const t=n,o=e,i=Y(()=>t.max-t.min||1),s=Y(()=>(t.modelMin-t.min)/i.value*100),r=Y(()=>(t.modelMax-t.min)/i.value*100),l=d=>{let p=Number(d.target.value);p>t.modelMax&&(p=t.modelMax),o("update:modelMin",p)},a=d=>{let p=Number(d.target.value);p<t.modelMin&&(p=t.modelMin),o("update:modelMax",p)};return(d,p)=>(v(),C("div",zu,[c("div",Vu,[c("div",{class:"range-fill",style:mo({left:s.value+"%",right:100-r.value+"%"})},null,4),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMin,onInput:l,class:"range-input range-input-min","aria-label":"最低價格"},null,40,Wu),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMax,onInput:a,class:"range-input range-input-max","aria-label":"最高價格"},null,40,ju)]),c("div",Gu,[c("span",null,I(n.modelMin)+I(n.suffix),1),Ku,c("span",null,I(n.modelMax)+I(n.suffix),1)])]))}},Qu=rn(Xu,[["__scopeId","data-v-fc736dec"]]),Ce=n=>(Tn("data-v-c2b4c756"),n=n(),Nn(),n),Yu=Ce(()=>c("span",{class:"material-icons-outlined"},"chevron_left",-1)),Ju=[Yu],qu=$r('<header class="side-panel-header" data-v-c2b4c756><img class="side-panel-logo" src="'+Ki+'" alt="重機能停哪" data-v-c2b4c756><div class="side-panel-titles" data-v-c2b4c756><h3 data-v-c2b4c756>重機能停哪?</h3><span class="side-panel-subtitle" data-v-c2b4c756><span class="material-icons-outlined" data-v-c2b4c756>tune</span>設定 </span></div></header>',1),$u={class:"side-panel-body"},Zu={class:"form-group"},e3={class:"form-toggle"},n3={class:"form-toggle-text"},t3=Ce(()=>c("span",{class:"material-icons-outlined fav-icon"},"star",-1)),o3={class:"source-count"},i3=["checked"],s3={class:"form-group"},r3=Ce(()=>c("label",{class:"form-label"},"顯示分類",-1)),l3={class:"source-chips"},a3=["aria-pressed"],c3=Ce(()=>c("span",{class:"material-icons-outlined source-icon"},"place",-1)),d3={class:"chip-count"},h3=["aria-pressed"],u3=Ce(()=>c("span",{class:"material-icons-outlined source-icon"},"edit_location_alt",-1)),p3={class:"chip-count"},m3=["aria-pressed"],f3=Ce(()=>c("span",{class:"material-icons-outlined source-icon"},"add_location_alt",-1)),y3={class:"chip-count"},b3={class:"form-group"},g3=Ce(()=>c("label",{class:"form-label"},"甚麼格位",-1)),A3=["value"],_3=["value"],v3={class:"form-group"},C3=Ce(()=>c("label",{class:"form-label"},"友善程度",-1)),P3=["value"],U3=["value"],E3={class:"form-group"},B3=Ce(()=>c("label",{class:"form-label"},"收費範圍",-1)),w3={class:"price-chips"},I3=Ce(()=>c("span",{class:"material-icons-outlined"},"money_off",-1)),S3={class:"form-group"},k3=Ce(()=>c("label",{class:"form-label"},"主題顏色",-1)),D3=["value"],T3=["value"],N3=Ce(()=>c("section",{class:"form-group"},[c("label",{class:"form-label"},"停車場資料來源"),c("div",{class:"link-list"},[c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"btn btn-outline btn-sm"}," Alan大重停車記事 ")])],-1)),M3={class:"form-group"},R3=$r('<label class="form-label" data-v-c2b4c756>問題回報</label><p class="muted-text" data-v-c2b4c756> 1. 停車場資訊相關（新場地、收費錯誤）： </p><a href="https://forms.gle/euRCPCPSmvYLm5Rj8" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-c2b4c756> Alan大重停車記事 回報表單 </a><p class="muted-text mt-8" data-v-c2b4c756>2. 網頁 BUG、畫面跑版：</p><a href="https://forms.gle/iJCyfqVtpL35WtZM7" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-c2b4c756> 重機能停哪? 回報表單 </a>',5),O3={class:"form-group"},x3=Ce(()=>c("label",{class:"form-label"},"資訊",-1)),L3={class:"info-list"},F3=Ce(()=>c("li",null,"版本：v2.3.0",-1)),H3=Ce(()=>c("li",null,"Web 製作：爽爽",-1)),z3=Ce(()=>c("li",null,"資料參考：Alan大重停車記事 Google My Map",-1)),V3=Ce(()=>c("li",null,"地圖：Mapbox GL JS API",-1)),W3=Ce(()=>c("li",null,"© 2026 爽爽 版權所有。本網頁未經准許，禁止任何商業行為",-1)),j3={__name:"SettingsPanel",props:{parkingType:String,degreeOfFriendliness:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,mapStyle:String,active:Boolean,onlyFavorites:Boolean,favoritesCount:{type:Number,default:0},showOfficial:{type:Boolean,default:!0},showOverridden:{type:Boolean,default:!0},showCommunity:{type:Boolean,default:!0},officialCount:{type:Number,default:0},overriddenCount:{type:Number,default:0},communityCount:{type:Number,default:0}},emits:["update:parkingType","update:degreeOfFriendliness","update:parkingPriceType","update:priceRangeMin","update:priceRangeMax","update:mapStyle","update:active","update:onlyFavorites","update:showOfficial","update:showOverridden","update:showCommunity","open-support"],setup(n,{emit:e}){const t=e,o=()=>t("update:active",!1);return(i,s)=>(v(),C("aside",{class:$(["side-panel",{active:n.active}]),"aria-label":"設定面板"},[c("button",{class:"side-panel-close",onClick:o,"aria-label":"收合設定"},Ju),qu,c("div",$u,[c("section",Zu,[c("label",e3,[c("span",n3,[t3,k(" 只看我的最愛 "),c("span",o3,"("+I(n.favoritesCount)+")",1)]),c("input",{type:"checkbox",class:"switch",checked:n.onlyFavorites,onChange:s[0]||(s[0]=r=>t("update:onlyFavorites",r.target.checked))},null,40,i3)])]),c("section",s3,[r3,c("div",l3,[c("button",{type:"button",class:$(["chip source-chip source-chip-official",{active:n.showOfficial}]),onClick:s[1]||(s[1]=r=>t("update:showOfficial",!n.showOfficial)),"aria-pressed":n.showOfficial},[c3,k(" 官方 "),c("span",d3,I(n.officialCount),1)],10,a3),c("button",{type:"button",class:$(["chip source-chip source-chip-override",{active:n.showOverridden}]),onClick:s[2]||(s[2]=r=>t("update:showOverridden",!n.showOverridden)),"aria-pressed":n.showOverridden},[u3,k(" 修改 "),c("span",p3,I(n.overriddenCount),1)],10,h3),c("button",{type:"button",class:$(["chip source-chip source-chip-community",{active:n.showCommunity}]),onClick:s[3]||(s[3]=r=>t("update:showCommunity",!n.showCommunity)),"aria-pressed":n.showCommunity},[f3,k(" 共筆 "),c("span",y3,I(n.communityCount),1)],10,m3)])]),c("section",b3,[g3,c("select",{class:"form-control",value:n.parkingType,onChange:s[4]||(s[4]=r=>t("update:parkingType",r.target.value))},[(v(!0),C(ye,null,We(L(ut),r=>(v(),C("option",{value:r.value,key:r.value},I(r.name),9,_3))),128))],40,A3)]),c("section",v3,[C3,c("select",{class:"form-control",value:n.degreeOfFriendliness,onChange:s[5]||(s[5]=r=>t("update:degreeOfFriendliness",r.target.value))},[(v(!0),C(ye,null,We(L(Xt),r=>(v(),C("option",{value:r.value,key:r.value},I(r.name),9,U3))),128))],40,P3)]),c("section",E3,[B3,c("div",w3,[c("button",{type:"button",class:$(["chip",{active:n.parkingPriceType===""}]),onClick:s[6]||(s[6]=r=>t("update:parkingPriceType",""))},"全部",2),c("button",{type:"button",class:$(["chip chip-free",{active:n.parkingPriceType==="free"}]),onClick:s[7]||(s[7]=r=>t("update:parkingPriceType",n.parkingPriceType==="free"?"":"free"))},[I3,k(" 免費 ")],2),c("button",{type:"button",class:$(["chip",{active:n.parkingPriceType==="h"}]),onClick:s[8]||(s[8]=r=>t("update:parkingPriceType","h"))},"計時 /時",2),c("button",{type:"button",class:$(["chip",{active:n.parkingPriceType==="d"}]),onClick:s[9]||(s[9]=r=>t("update:parkingPriceType","d"))},"計次 /日",2),c("button",{type:"button",class:$(["chip",{active:n.parkingPriceType==="t"}]),onClick:s[10]||(s[10]=r=>t("update:parkingPriceType","t"))},"計次 /不限時",2)]),/d|h|t/.test(n.parkingPriceType)?(v(),ji(Qu,{key:0,class:"mt-8",min:0,max:300,step:10,"model-min":n.priceRangeMin,"model-max":n.priceRangeMax,suffix:n.parkingPriceType==="h"?" /時":n.parkingPriceType==="d"?" /日":" /次","onUpdate:modelMin":s[11]||(s[11]=r=>t("update:priceRangeMin",r)),"onUpdate:modelMax":s[12]||(s[12]=r=>t("update:priceRangeMax",r))},null,8,["model-min","model-max","suffix"])):j("",!0)]),c("section",S3,[k3,c("select",{class:"form-control",value:n.mapStyle,onChange:s[13]||(s[13]=r=>t("update:mapStyle",r.target.value))},[(v(!0),C(ye,null,We(L(tt),r=>(v(),C("option",{value:r.value,key:r.value},I(r.name),9,T3))),128))],40,D3)]),N3,c("section",M3,[R3,c("button",{type:"button",class:"btn btn-coffee btn-sm mt-8",onClick:s[14]||(s[14]=r=>t("open-support"))}," ❤️ 贊助支持，讓我有動力繼續更新 ")]),c("section",O3,[x3,c("ul",L3,[F3,c("li",null,"地圖資料更新：自動更新於"+I(L(Fu)),1),H3,z3,V3,W3])])])],2))}},G3=rn(j3,[["__scopeId","data-v-c2b4c756"]]),Ye=n=>(Tn("data-v-d09400e9"),n=n(),Nn(),n),K3=Ye(()=>c("span",{class:"material-icons-outlined"},"close",-1)),X3=[K3],Q3={class:"info-header"},Y3=["src"],J3={class:"info-title"},q3=["aria-label","title"],$3={class:"material-icons-outlined"},Z3=["innerHTML"],e5={key:1,class:"info-address"},n5={key:2,class:"info-price"},t5=Ye(()=>c("span",{class:"material-icons-outlined"},"payments",-1)),o5=Ye(()=>c("span",{class:"info-price-label"},"收費",-1)),i5={class:"info-price-value"},s5={key:0,class:"info-price-tag"},r5={key:3,class:"community-tag"},l5=Ye(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),a5={key:4,class:"override-tag"},c5=Ye(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),d5={key:5,class:"source-tag"},h5=Ye(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),u5={class:"info-meta"},p5={class:"badge-group"},m5={class:"badge"},f5={key:0,class:"badge badge-icon",title:"依圖示分類"},y5={class:"coord"},b5={class:"info-actions"},g5=Ye(()=>c("span",{class:"material-icons-outlined"},"edit",-1)),A5=["title"],_5=Ye(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),v5=Ye(()=>c("span",{class:"material-icons-outlined"},"share",-1)),C5={class:"info-actions"},P5=Ye(()=>c("span",{class:"material-icons-outlined"},"map",-1)),U5=Ye(()=>c("span",{class:"material-icons-outlined"},"map",-1)),E5=Ye(()=>c("span",{class:"material-icons-outlined"},"directions",-1)),B5={__name:"ParkingInfoPanel",props:{info:Object,active:Boolean,isMobile:Boolean,isApple:Boolean,isAndroid:Boolean,hasRoute:Boolean,isFavorite:Boolean,isCommunity:{type:Boolean,default:!1},communityMeta:{type:Object,default:null},isOverridden:{type:Boolean,default:!1},overrideMeta:{type:Object,default:null}},emits:["close","route","openMap","toggleFavorite","editCommunity","editOverride","share"],setup(n,{emit:e}){const t=n,o=e,i=new Set(["icon-4.png","icon-14.png","icon-19.png"]),s=l=>l!=null&&l.priceInfo?t.isCommunity||t.isOverridden?!0:!i.has(l==null?void 0:l.parkingIconKey):!1,r=l=>{if(!l)return"";if(/^free$/i.test(l.trim()))return"免費";const a=l.trim().match(/^(\d+(?:\.\d+)?)\s*\/\s*(h|d|次)$/i);if(!a)return l;const d=a[2].toLowerCase(),p=d==="h"?"小時":d==="d"?"日":"次 (不限時)";return`${a[1]} 元 / ${p}`};return(l,a)=>{var d,p,h,f,b,g,B,D;return v(),C("aside",{class:$(["info-panel",{active:n.active}]),"aria-label":"停車場資訊"},[c("button",{class:"panel-close",onClick:a[0]||(a[0]=U=>o("close")),"aria-label":"關閉"},X3),c("header",Q3,[n.info.parkingIcon?(v(),C("img",{key:0,class:"info-icon",src:n.info.parkingIcon,alt:""},null,8,Y3)):j("",!0),c("h3",J3,I(n.info.parkingName),1),c("button",{class:$(["fav-btn",{active:n.isFavorite}]),onClick:a[1]||(a[1]=U=>o("toggleFavorite")),"aria-label":n.isFavorite?"從我的最愛移除":"加入我的最愛",title:n.isFavorite?"從我的最愛移除":"加入我的最愛"},[c("span",$3,I(n.isFavorite?"star":"star_border"),1)],10,q3)]),n.info.parkingNameDes?(v(),C("div",{key:0,class:"info-desc",innerHTML:n.info.parkingNameDes},null,8,Z3)):j("",!0),n.info.address?(v(),C("div",e5,I(n.info.address),1)):j("",!0),s(n.info)?(v(),C("div",n5,[t5,o5,c("span",i5,I(r(n.info.priceInfo)),1),n.isOverridden?(v(),C("span",s5,"車友修改")):j("",!0)])):j("",!0),n.isCommunity?(v(),C("div",r5,[l5,c("span",null,[k(" 共筆停車點 "),(p=(d=n.communityMeta)==null?void 0:d.updatedBy)!=null&&p.nickname||(f=(h=n.communityMeta)==null?void 0:h.updatedBy)!=null&&f.id?(v(),C(ye,{key:0},[k(" · 由 "+I(n.communityMeta.updatedBy.nickname||`匿名#${n.communityMeta.updatedBy.id}`)+" 更新 ",1)],64)):j("",!0)])])):n.isOverridden?(v(),C("div",a5,[c5,c("span",null,[k(" 車友修改資訊 "),(g=(b=n.overrideMeta)==null?void 0:b.updatedBy)!=null&&g.nickname||(D=(B=n.overrideMeta)==null?void 0:B.updatedBy)!=null&&D.id?(v(),C(ye,{key:0},[k(" · 由 "+I(n.overrideMeta.updatedBy.nickname||`匿名#${n.overrideMeta.updatedBy.id}`)+" 更新 ",1)],64)):j("",!0)])])):j("",!0),!n.isCommunity&&n.info.sourceLabel?(v(),C("div",d5,[h5,c("span",null,"資料來源 · "+I(n.info.sourceLabel),1)])):j("",!0),c("div",u5,[c("div",p5,[c("span",m5,I(n.info.parkingType),1),n.info.iconCategory&&n.info.iconCategory!==n.info.parkingType?(v(),C("span",f5,I(n.info.iconCategory),1)):j("",!0)]),c("span",y5,I(Number(n.info.geometry[0]).toFixed(5))+", "+I(Number(n.info.geometry[1]).toFixed(5)),1)]),c("div",b5,[n.isCommunity?(v(),C("button",{key:0,class:"btn btn-outline btn-sm",onClick:a[2]||(a[2]=U=>o("editCommunity"))},[g5,k(" 編輯 ")])):(v(),C("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[3]||(a[3]=U=>o("editOverride")),title:n.isOverridden?"修改車友提供的資訊 (不會變動官方資料)":"異議 / 補充官方資料 (不會變動官方資料)"},[_5,k(" "+I(n.isOverridden?"修改車友資訊":"異議 / 補充"),1)],8,A5)),c("button",{class:"btn btn-outline btn-sm",onClick:a[4]||(a[4]=U=>o("share")),title:"分享這個停車點"},[v5,k(" 分享 ")])]),c("div",C5,[n.isAndroid?j("",!0):(v(),C("button",{key:0,class:"btn btn-primary btn-sm",onClick:a[5]||(a[5]=U=>o("openMap","apple"))},[P5,k(" Apple Map ")])),c("button",{class:$(["btn","btn-sm",n.isAndroid?"btn-primary":"btn-outline"]),onClick:a[6]||(a[6]=U=>o("openMap","google"))},[U5,k(" Google Map ")],2),n.hasRoute?j("",!0):(v(),C("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[7]||(a[7]=U=>o("route"))},[E5,k(" 路線規劃 ")]))])],2)}}},w5=rn(B5,[["__scopeId","data-v-d09400e9"]]),Ts=n=>(Tn("data-v-caf0ec6e"),n=n(),Nn(),n),I5={class:"route-header"},S5=Ts(()=>c("h3",null,[c("span",{class:"material-icons-outlined"},"alt_route"),k(" 路線 ")],-1)),k5=["aria-expanded"],D5={class:"material-icons-outlined"},T5={key:0,class:"route-summary"},N5={class:"route-summary-item"},M5=Ts(()=>c("span",{class:"material-icons-outlined"},"schedule",-1)),R5={class:"route-summary-item"},O5=Ts(()=>c("span",{class:"material-icons-outlined"},"straighten",-1)),x5={class:"route-profile",role:"tablist","aria-label":"交通方式"},L5=["onClick","aria-pressed"],F5={class:"material-icons-outlined"},H5={class:"profile-label"},z5={key:1,class:"route-steps"},V5={__name:"RouteSteps",props:{routeData:Object,active:Boolean,profile:{type:String,default:"driving"}},emits:["cancel","update:profile"],setup(n,{emit:e}){const t=n,o=e,i=E(!0),s=()=>i.value=!i.value,r=[{value:"driving",label:"汽機車",icon:"directions_car"},{value:"cycling",label:"單車",icon:"directions_bike"},{value:"walking",label:"步行",icon:"directions_walk"}],l=Y(()=>{var h;const p=(h=t.routeData)==null?void 0:h.distance;return typeof p!="number"?"":p>=1e3?`${(p/1e3).toFixed(1)} km`:`${Math.round(p)} m`}),a=Y(()=>{var g;const p=(g=t.routeData)==null?void 0:g.duration;if(typeof p!="number")return"";const h=Math.round(p/60);if(h<60)return`${h} 分`;const f=Math.floor(h/60),b=h%60;return b?`${f} 時 ${b} 分`:`${f} 時`}),d=p=>o("update:profile",p);return(p,h)=>(v(),C("aside",{class:$(["route-panel",{active:n.active}])},[c("header",I5,[S5,c("button",{class:"route-toggle",onClick:s,"aria-expanded":i.value},[c("span",D5,I(i.value?"expand_less":"expand_more"),1)],8,k5)]),n.routeData?(v(),C("div",T5,[c("div",N5,[M5,c("strong",null,I(a.value),1)]),c("div",R5,[O5,c("strong",null,I(l.value),1)])])):j("",!0),c("div",x5,[(v(),C(ye,null,We(r,f=>c("button",{key:f.value,class:$(["profile-btn",{active:n.profile===f.value}]),onClick:b=>d(f.value),"aria-pressed":n.profile===f.value},[c("span",F5,I(f.icon),1),c("span",H5,I(f.label),1)],10,L5)),64))]),n.routeData&&i.value?(v(),C("ol",z5,[(v(!0),C(ye,null,We(n.routeData.legs[0].steps,(f,b)=>(v(),C("li",{key:b,class:"route-step"},I(f.maneuver.instruction),1))),128))])):j("",!0),c("button",{class:"btn btn-danger btn-sm route-cancel",onClick:h[0]||(h[0]=f=>o("cancel"))}," 取消路線規劃 ")],2))}},W5=rn(V5,[["__scopeId","data-v-caf0ec6e"]]);function j5(n,e,t=20,o=[]){const i=(e||"").trim().toLowerCase();if(!i)return[];const s=[];if(Array.isArray(n))for(const r of n)for(const l of r.features){const a=(l.properties.name||"").toLowerCase(),d=(l.properties.description||"").toLowerCase();if((a.includes(i)||d.includes(i))&&(s.push({groupName:r.name,name:l.properties.name,description:l.properties.description,icon:l.properties.icon,geometry:l.geometry.coordinates,properties:l.properties,isCommunity:!1,score:(a.includes(i)?1e3:0)-(a.indexOf(i)===-1?0:a.indexOf(i))}),s.length>500))break}if(Array.isArray(o))for(const r of o){const l=(r.name||"").toLowerCase(),a=(r.description||"").toLowerCase();if(!l.includes(i)&&!a.includes(i))continue;const d=Array.isArray(r.coordinates)?r.coordinates:[null,null];if(!(d[0]==null||d[1]==null)&&(s.push({groupName:"共筆停車點",name:r.name,description:r.description,icon:r.iconKey,geometry:d,properties:{name:r.name,description:r.description,icon:r.iconKey},isCommunity:!0,community:r,score:(l.includes(i)?900:0)-(l.indexOf(i)===-1?0:l.indexOf(i))}),s.length>500))break}return s.sort((r,l)=>l.score-r.score),s.slice(0,t)}const Fa=n=>(Tn("data-v-2b0f75f6"),n=n(),Nn(),n),G5={key:0,class:"search-results",role:"listbox"},K5=["aria-selected","onMouseenter","onClick"],X5=["src"],Q5={class:"search-item-text"},Y5={class:"search-item-name"},J5={class:"search-item-group"},q5={key:1,class:"search-empty"},$5={class:"search-box",role:"combobox","aria-expanded":"true"},Z5=Fa(()=>c("span",{class:"material-icons-outlined search-icon"},"search",-1)),ep=Fa(()=>c("span",{class:"material-icons-outlined"},"close",-1)),np=[ep],tp=["aria-label","aria-expanded"],op={class:"material-icons-outlined"},ip={__name:"SearchBar",props:{mapDataList:Array,communityParkings:{type:Array,default:()=>[]}},emits:["select"],setup(n,{emit:e}){const t=n,o=e,i=E(!1),s=E(""),r=E(-1),l=Y(()=>s.value?j5(t.mapDataList,s.value,15,t.communityParkings):[]);K(s,()=>{r.value=-1});const a=()=>{i.value=!i.value,i.value||(s.value="")},d=()=>{i.value=!1,s.value=""},p=f=>{o("select",f),d()},h=f=>{if(l.value.length)if(f.key==="ArrowDown")f.preventDefault(),r.value=(r.value+1)%l.value.length;else if(f.key==="ArrowUp")f.preventDefault(),r.value=(r.value-1+l.value.length)%l.value.length;else if(f.key==="Enter"){f.preventDefault();const b=r.value>=0?r.value:0;p(l.value[b])}else f.key==="Escape"&&d()};return(f,b)=>(v(),C("div",{class:$(["search-wrap",{open:i.value}])},[i.value&&l.value.length?(v(),C("ul",G5,[(v(!0),C(ye,null,We(l.value,(g,B)=>(v(),C("li",{key:B,class:$(["search-item",{active:B===r.value}]),role:"option","aria-selected":B===r.value,onMouseenter:D=>r.value=B,onClick:D=>p(g)},[g.icon?(v(),C("img",{key:0,src:L(q)(g.icon),class:"search-item-icon",alt:""},null,8,X5)):j("",!0),c("div",Q5,[c("div",Y5,I(g.name),1),c("div",J5,I(g.groupName),1)])],42,K5))),128))])):i.value&&s.value&&!l.value.length?(v(),C("div",q5," 找不到「"+I(s.value)+"」相關停車場 ",1)):j("",!0),Ke(c("div",$5,[Z5,Ke(c("input",{"onUpdate:modelValue":b[0]||(b[0]=g=>s.value=g),class:"search-input",type:"text",placeholder:"搜尋停車場名稱…",autofocus:"",onKeydown:h},null,544),[[It,s.value]]),s.value?(v(),C("button",{key:0,class:"search-clear",onClick:b[1]||(b[1]=g=>s.value=""),"aria-label":"清除"},np)):j("",!0)],512),[[wt,i.value]]),c("button",{class:$(["search-toggle",{active:i.value}]),onClick:a,"aria-label":i.value?"關閉搜尋":"開啟搜尋","aria-expanded":i.value},[c("span",op,I(i.value?"close":"search"),1)],10,tp)],2))}},sp=rn(ip,[["__scopeId","data-v-2b0f75f6"]]),Rn=n=>(Tn("data-v-95843aaa"),n=n(),Nn(),n),rp={class:"editor-body"},lp={key:0,class:"editor-note override-note"},ap=Rn(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),cp={key:1,class:"editor-note"},dp=Rn(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),hp={class:"form-group"},up={class:"form-label"},pp={key:0},mp={key:1,class:"hint-inline"},fp=["readonly","disabled"],yp={class:"form-group"},bp=Rn(()=>c("label",{class:"form-label"},"類別",-1)),gp=["value"],Ap={class:"form-group"},_p={class:"form-label"},vp={key:0,class:"hint-inline"},Cp=["disabled"],Pp=["value"],Up={class:"form-group"},Ep=Rn(()=>c("label",{class:"form-label"},"收費",-1)),Bp={class:"chip-row"},wp=["onClick"],Ip={key:0,class:"price-amount"},Sp={class:"unit"},kp={key:1,class:"price-amount"},Dp={class:"form-group"},Tp=Rn(()=>c("label",{class:"form-label"},"說明(選填)",-1)),Np={class:"form-group"},Mp=Rn(()=>c("label",{class:"form-label"},"暱稱(選填)",-1)),Rp=["value"],Op={key:2,class:"error-msg"},xp={key:3,class:"form-group history-section"},Lp={class:"form-label"},Fp=Rn(()=>c("span",{class:"material-icons-outlined",style:{"font-size":"14px","vertical-align":"-2px"}},"history",-1)),Hp={class:"history-list"},zp={class:"h-row1"},Vp={class:"h-by"},Wp={class:"h-time"},jp={key:0,class:"h-diff h-diff-note"},Gp={key:1,class:"h-diff-list"},Kp={class:"h-diff-label"},Xp={class:"h-diff-old"},Qp=Rn(()=>c("span",{class:"h-diff-arrow"},"→",-1)),Yp={class:"h-diff-new"},Jp={key:2,class:"h-diff h-diff-note"},qp=["disabled"],$p=["disabled"],Zp=["disabled"],em=["disabled"],nm={__name:"CommunityParkingEditor",props:{open:Boolean,mode:{type:String,default:"add"},initial:{type:Object,default:null},defaultCoord:{type:Array,default:()=>[121.5173399,25.0475613]},nickname:{type:String,default:""},isOwner:{type:Boolean,default:!1},isAdmin:{type:Boolean,default:!1},submitting:{type:Boolean,default:!1},hasExistingOverride:{type:Boolean,default:!1},history:{type:Array,default:()=>[]}},emits:["update:open","update:nickname","submit","delete","reset"],setup(n,{emit:e}){const t=n,o=e,i=E(""),s=E(""),r=E("motorcycle"),l=E("friendly"),a=E("free"),d=E(""),p=E(""),h=E([null,null]),f=Y(()=>ut.filter(_=>_.value)),b=Y(()=>Xt.filter(_=>_.value)),g={greenStar:"icon-14.png",friendlyShop:"icon-4.png",greenP:"icon-15.png",greyP:"icon-16.png",blueP:"icon-17.png",purpleP:"icon-18.png",redX:"icon-19.png",unknown:"icon-20.png"},B=Y(()=>{if(g[r.value])return g[r.value];const _=ut.find(le=>le.value===r.value),T=Xt.find(le=>le.value===l.value);return _?T&&_.key.find(le=>T.key.includes(le))||_.key[0]:"icon-3.png"}),D=Y(()=>!!g[r.value]);function U(_){if(!_)return{type:"free",amount:"",custom:""};const T=_.trim();if(/^free$/i.test(T))return{type:"free",amount:"",custom:""};const w=T.match(/^(\d+(?:\.\d+)?)\s*\/\s*([hd次])$/i);return w?{type:w[2].toLowerCase(),amount:w[1],custom:""}:{type:"custom",amount:"",custom:T}}function G(){return a.value==="free"?"Free":a.value==="custom"?p.value.trim():d.value?`${d.value}/${a.value}`:""}const N=()=>{if((t.mode==="edit"||t.mode==="override")&&t.initial){i.value=t.initial.name||"",s.value=t.initial.description||"",r.value=t.initial.category||"motorcycle",l.value=t.initial.friendliness||"friendly";const _=U(t.initial.priceInfo||"");a.value=_.type,d.value=_.amount,p.value=_.custom,h.value=t.initial.coordinates?[...t.initial.coordinates]:[...t.defaultCoord]}else i.value="",s.value="",r.value="motorcycle",l.value="friendly",a.value="free",d.value="",p.value="",h.value=[...t.defaultCoord]};K(()=>t.open,_=>{_&&N()});const V=E(""),Pe=()=>{if(V.value="",!i.value.trim()){V.value="請輸入名稱";return}if(h.value[0]==null||h.value[1]==null||Number.isNaN(Number(h.value[0]))||Number.isNaN(Number(h.value[1]))){V.value="座標無效";return}o("submit",{name:i.value,description:s.value,iconKey:B.value,category:r.value,friendliness:D.value?"":l.value,priceInfo:G(),coordinates:[Number(h.value[0]),Number(h.value[1])]})},ce=()=>{var _;(_=t.initial)!=null&&_.id&&window.confirm(`確定要刪除「${i.value}」?此動作無法復原。`)&&o("delete",t.initial.id)},Se=()=>{window.confirm(`確定要重設「${i.value}」回官方原始資料嗎?
你和其他車友先前的修改將被移除。`)&&o("reset")},Ue=Y({get:()=>t.open,set:_=>o("update:open",_)}),Je=[{value:"free",label:"免費"},{value:"h",label:"計時 / 小時"},{value:"d",label:"計次 / 天"},{value:"次",label:"計次 / 不限時"},{value:"custom",label:"其他"}],pe=E(!1),re=Y(()=>!t.history||t.history.length===0?[]:pe.value?t.history:t.history.slice(0,5)),Te={create:"新增",update:"修改",delete:"刪除",override:"覆寫",reset:"重設"};function je(_){return Te[_]||_||"變更"}function P(_){return _?_.nickname||(_.id?`匿名#${_.id}`:"匿名"):"系統"}function R(_){if(!_||!isFinite(Number(_)))return"";const T=new Date(Number(_)),w=le=>String(le).padStart(2,"0");return`${T.getFullYear()}/${w(T.getMonth()+1)}/${w(T.getDate())} ${w(T.getHours())}:${w(T.getMinutes())}`}const Q={name:"名稱",description:"說明",iconKey:"圖示",category:"類別",friendliness:"友善度",priceInfo:"收費",lng:"經度",lat:"緯度"};function W(_){if(_==null||_==="")return"(空)";if(typeof _=="number")return String(_);const T=String(_);return T.length>40?T.slice(0,40)+"…":T}function Z(_){return _==null?"":typeof _=="string"?_.trim():String(_)}function ie(_){return Z(_)===""}function Oe(_,T){if(!_||_.action==="delete"||_.action==="reset")return[];if(_.after&&typeof _.after=="object")return Object.keys(_.after).filter(O=>{var Le;const x=(Le=_.before)==null?void 0:Le[O],de=_.after[O];return!(ie(x)&&ie(de)||Z(x)===Z(de)||ie(x))}).map(O=>{var x;return{label:Q[O]||O,before:W((x=_.before)==null?void 0:x[O]),after:W(_.after[O]),hasBefore:!0}});const w=_.snapshot;if(!w||typeof w!="object")return[];const le=new Set(["createdAt","createdBy","updatedAt","updatedBy","origName","origLng","origLat","history"]),Ne=t.history.findIndex(Ee=>Ee._key===_._key),xe=Ne>=0?t.history[Ne+1]:null,fn=xe?xe.after&&typeof xe.after=="object"?{...xe.before||{},...xe.after}:xe.snapshot||null:null,On=[];for(const Ee of Object.keys(w)){if(le.has(Ee))continue;const O=w[Ee];if(fn&&Object.prototype.hasOwnProperty.call(fn,Ee)){const x=fn[Ee];if(Z(x)===Z(O)||ie(x))continue;On.push({label:Q[Ee]||Ee,before:W(x),after:W(O),hasBefore:!0})}}return On}function be(_){return(_==null?void 0:_.action)==="delete"?"該項目被刪除":(_==null?void 0:_.action)==="reset"?"重設為官方資料":(_==null?void 0:_.action)==="create"?"新增此停車點":""}return(_,T)=>(v(),ji(Pn,{modelValue:Ue.value,"onUpdate:modelValue":T[9]||(T[9]=w=>Ue.value=w),title:n.mode==="override"?"修改官方停車點":n.mode==="edit"?"編輯停車場":"新增停車場",size:"md"},{footer:$e(()=>[n.mode==="edit"&&n.isOwner?(v(),C("button",{key:0,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:ce}," 刪除 ",8,qp)):j("",!0),n.mode==="override"&&n.hasExistingOverride&&n.isAdmin?(v(),C("button",{key:1,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:Se,title:"僅站方可使用"}," 重設為官方資料 ",8,$p)):j("",!0),c("button",{class:"btn btn-outline",disabled:n.submitting,onClick:T[8]||(T[8]=w=>Ue.value=!1)}," 取消 ",8,Zp),c("button",{class:"btn btn-primary",disabled:n.submitting,onClick:Pe},I(n.submitting?"送出中…":n.mode==="override"||n.mode==="edit"?"儲存修改":"新增"),9,em)]),default:$e(()=>[c("div",rp,[n.mode==="override"?(v(),C("p",lp,[ap,k(" 你正在「修改官方停車點」:這層修改只會疊加在官方資料之上,不會覆蓋原始資料。所有車友都會看到你的修改,也可以再被其他人修改或重設。 ")])):(v(),C("p",cp,[dp,k(" 共筆停車點:任何人都可以新增或修改。請確認資訊正確、避免不雅內容。 ")])),c("section",hp,[c("label",up,[k(" 名稱 "),n.mode!=="override"?(v(),C("span",pp,"*")):j("",!0),n.mode==="override"?(v(),C("span",mp,"(官方名稱不可修改)")):j("",!0)]),Ke(c("input",{"onUpdate:modelValue":T[0]||(T[0]=w=>i.value=w),class:"form-control",type:"text",placeholder:"例:三張里地下停車場",maxlength:"60",readonly:n.mode==="override",disabled:n.mode==="override"},null,8,fp),[[It,i.value]])]),c("section",yp,[bp,Ke(c("select",{"onUpdate:modelValue":T[1]||(T[1]=w=>r.value=w),class:"form-control"},[(v(!0),C(ye,null,We(f.value,w=>(v(),C("option",{key:w.value,value:w.value},I(w.name),9,gp))),128))],512),[[Ks,r.value]])]),c("section",Ap,[c("label",_p,[k(" 友善程度 "),D.value?(v(),C("span",vp,"(此類別不適用)")):j("",!0)]),Ke(c("select",{"onUpdate:modelValue":T[2]||(T[2]=w=>l.value=w),class:"form-control",disabled:D.value},[(v(!0),C(ye,null,We(b.value,w=>(v(),C("option",{key:w.value,value:w.value},I(w.name),9,Pp))),128))],8,Cp),[[Ks,l.value]])]),c("section",Up,[Ep,c("div",Bp,[(v(),C(ye,null,We(Je,w=>c("button",{key:w.value,type:"button",class:$(["chip",{active:a.value===w.value}]),onClick:le=>a.value=w.value},I(w.label),11,wp)),64))]),a.value==="h"||a.value==="d"||a.value==="次"?(v(),C("div",Ip,[Ke(c("input",{"onUpdate:modelValue":T[3]||(T[3]=w=>d.value=w),type:"number",min:"0",step:"1",class:"form-control compact",placeholder:"金額"},null,512),[[It,d.value]]),c("span",Sp," 元 / "+I(a.value==="h"?"小時":a.value==="d"?"天":"次 (不限時)"),1)])):a.value==="custom"?(v(),C("div",kp,[Ke(c("input",{"onUpdate:modelValue":T[4]||(T[4]=w=>p.value=w),type:"text",class:"form-control",placeholder:"如:平日 30/h、假日 50/d",maxlength:"40"},null,512),[[It,p.value]])])):j("",!0)]),c("section",Dp,[Tp,Ke(c("textarea",{"onUpdate:modelValue":T[5]||(T[5]=w=>s.value=w),class:"form-control",rows:"3",placeholder:"後牌辨析、24h、注意事項...",maxlength:"500"},null,512),[[It,s.value]])]),c("section",Np,[Mp,c("input",{value:n.nickname,onInput:T[6]||(T[6]=w=>o("update:nickname",w.target.value)),class:"form-control",type:"text",placeholder:"留空將顯示「匿名#xxx-xxx」",maxlength:"20"},null,40,Rp)]),V.value?(v(),C("p",Op,I(V.value),1)):j("",!0),n.history.length?(v(),C("section",xp,[c("label",Lp,[Fp,k(" 修改紀錄 ("+I(n.history.length)+") ",1)]),c("ul",Hp,[(v(!0),C(ye,null,We(re.value,(w,le)=>(v(),C("li",{key:w._key,class:"history-item"},[c("div",zp,[c("span",{class:$(["h-action",`h-action-${w.action||"other"}`])},I(je(w.action)),3),c("span",Vp,I(P(w.by)),1),c("span",Wp,I(R(w.at)),1)]),be(w)?(v(),C("div",jp,I(be(w)),1)):Oe(w,le).length?(v(),C("ul",Gp,[(v(!0),C(ye,null,We(Oe(w,le),(Ne,xe)=>(v(),C("li",{key:xe,class:"h-diff-item"},[c("span",Kp,I(Ne.label),1),Ne.hasBefore?(v(),C(ye,{key:0},[c("span",Xp,I(Ne.before),1),Qp],64)):j("",!0),c("span",Yp,I(Ne.after),1)]))),128))])):(v(),C("div",Jp,"(與上一筆相同)"))]))),128))]),n.history.length>5?(v(),C("button",{key:0,type:"button",class:"history-toggle",onClick:T[7]||(T[7]=w=>pe.value=!pe.value)},I(pe.value?"收起":`顯示全部 ${n.history.length} 筆`),1)):j("",!0)])):j("",!0)])]),_:1},8,["modelValue","title"]))}},tm=rn(nm,[["__scopeId","data-v-95843aaa"]]),om={class:"tour-card-head"},im={class:"tour-step-index"},sm={class:"tour-title"},rm={key:0,class:"material-icons-outlined"},lm={class:"tour-desc"},am={class:"tour-actions"},cm={key:0,class:"material-icons-outlined"},dm={key:1,class:"material-icons-outlined"},vn=8,hm=12,Kr=300,lo=16,um={__name:"OnboardingTour",props:{active:{type:Boolean,default:!1},steps:{type:Array,required:!0}},emits:["update:active","finish"],setup(n,{emit:e}){const t=n,o=e,i=E(0),s=E(null),r=E(!1),l=Y(()=>t.steps[i.value]||null),a=Y(()=>i.value>=t.steps.length-1),d=async()=>{await qr();const U=l.value;if(!U){s.value=null;return}const G=U.selector?document.querySelector(U.selector):null;if(!G){s.value=null;return}const N=G.getBoundingClientRect();if(N.width===0&&N.height===0){s.value=null;return}s.value={top:N.top,left:N.left,width:N.width,height:N.height}},p=async()=>{for(let U=0;U<8;U++){if(await d(),s.value)return;await new Promise(G=>setTimeout(G,150))}};K(()=>[t.active,i.value],async([U])=>{if(!U){r.value=!1;return}r.value=!1,await p(),r.value=!0},{immediate:!0});const h=()=>d();Yn(()=>{window.addEventListener("resize",h),window.addEventListener("scroll",h,!0)}),pt(()=>{window.removeEventListener("resize",h),window.removeEventListener("scroll",h,!0)});const f=Y(()=>{const U=s.value;return U?{top:U.top-vn+"px",left:U.left-vn+"px",width:U.width+vn*2+"px",height:U.height+vn*2+"px",borderRadius:hm+"px"}:{display:"none"}}),b=Y(()=>{var pe;const U=s.value,G=window.innerWidth,N=window.innerHeight;if(!U)return{top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:Math.min(Kr,G-32)+"px"};const V=((pe=l.value)==null?void 0:pe.placement)||"auto";let Pe=V;if(V==="auto"){const re=N-(U.top+U.height),Te=U.top;Pe=re>=Te?"bottom":"top"}const ce=Math.min(Kr,G-32);let Se,Ue,Je="";return Pe==="bottom"?(Se=U.top+U.height+lo+vn,Ue=Math.max(16,Math.min(G-ce-16,U.left+U.width/2-ce/2))):Pe==="top"?(Se=U.top-lo-vn,Ue=Math.max(16,Math.min(G-ce-16,U.left+U.width/2-ce/2)),Je="translateY(-100%)"):Pe==="right"?(Se=Math.max(16,U.top+U.height/2),Ue=U.left+U.width+lo+vn,Je="translateY(-50%)"):(Se=Math.max(16,U.top+U.height/2),Ue=U.left-lo-vn,Je="translate(-100%, -50%)"),{top:Se+"px",left:Ue+"px",width:ce+"px",transform:Je}}),g=()=>{a.value?D():i.value+=1},B=()=>D(),D=()=>{o("update:active",!1),o("finish"),i.value=0};return K(()=>t.active,U=>{U&&(i.value=0)}),(U,G)=>n.active&&l.value?(v(),C("div",{key:0,class:$(["tour-root",{"is-ready":r.value}])},[c("div",{class:"tour-spotlight",style:mo(f.value)},null,4),c("div",{class:"tour-backdrop",onClick:Gi(g,["self"])}),c("div",{class:"tour-card",style:mo(b.value),role:"dialog","aria-modal":"true"},[c("div",om,[c("span",im,I(i.value+1)+" / "+I(n.steps.length),1),c("button",{class:"tour-skip",onClick:B,"aria-label":"略過導覽"},"略過")]),c("h3",sm,[l.value.icon?(v(),C("span",rm,I(l.value.icon),1)):j("",!0),k(" "+I(l.value.title),1)]),c("p",lm,I(l.value.description),1),c("div",am,[c("button",{class:"btn btn-primary tour-next",onClick:g},[k(I(a.value?"完成":"下一步")+" ",1),a.value?(v(),C("span",dm,"check")):(v(),C("span",cm,"arrow_forward"))])])],4)],2)):j("",!0)}},pm=rn(um,[["__scopeId","data-v-1d730a34"]]),Un="community_parkings",Hi=E([]),Ha=E(!1),zi=E(null);let Ot=null,pi=0;function mm(){if(!(!an||Ot))try{const n=ou(Ze(Xe,Un),tu("updatedAt"));Ot=n,Ra(n,e=>{const t=[];e.forEach(o=>{var s,r;const i=o.val()||{};t.push({id:o.key,name:i.name||"",description:i.description||"",iconKey:i.iconKey||"icon-3.png",category:i.category||"",friendliness:i.friendliness||"",priceInfo:i.priceInfo||"",coordinates:[(s=i.lng)!=null?s:null,(r=i.lat)!=null?r:null],createdBy:i.createdBy||null,updatedBy:i.updatedBy||null,createdAt:i.createdAt||null,updatedAt:i.updatedAt||null,history:ym(i.history)})}),Hi.value=t.reverse(),Ha.value=!0},e=>{zi.value=e})}catch(n){zi.value=n}}function fm(){Ot&&(Oa(Ot),Ot=null)}function ym(n){return!n||typeof n!="object"?[]:Object.entries(n).map(([e,t])=>({...t||{},_key:e})).sort((e,t)=>e._key<t._key?1:e._key>t._key?-1:0)}function bm(){return Yn(()=>{pi+=1,mm()}),pt(()=>{pi-=1,pi<=0&&fm()}),{items:Hi,ready:Ha,error:zi,addParking:async(o,i)=>{var f,b,g;if(!an)throw new Error("Firebase 尚未設定");const[s,r]=o.coordinates,a=co(Ze(Xe,Un)).key,d={id:i.id,nickname:i.nickname||""},p={name:((f=o.name)==null?void 0:f.trim())||"",description:((b=o.description)==null?void 0:b.trim())||"",iconKey:o.iconKey||"icon-3.png",category:o.category||"",friendliness:o.friendliness||"",priceInfo:((g=o.priceInfo)==null?void 0:g.trim())||"",lng:Number(s),lat:Number(r),createdBy:d,createdAt:Vn(),updatedBy:d,updatedAt:Vn()},h=co(Ze(Xe,`${Un}/${a}/history`)).key;return await Oi(Ze(Xe),{[`${Un}/${a}`]:{...p,history:{[h]:{action:"create",at:Vn(),by:d,snapshot:p}}}}),a},updateParking:async(o,i,s)=>{var g,B,D,U,G;if(!an)throw new Error("Firebase 尚未設定");const r={id:s.id,nickname:s.nickname||""},l=Hi.value.find(N=>N.id===o)||{},a={};if(i.name!==void 0&&(a.name=((g=i.name)==null?void 0:g.trim())||""),i.description!==void 0&&(a.description=((B=i.description)==null?void 0:B.trim())||""),i.iconKey!==void 0&&(a.iconKey=i.iconKey),i.category!==void 0&&(a.category=i.category),i.friendliness!==void 0&&(a.friendliness=i.friendliness),i.priceInfo!==void 0&&(a.priceInfo=((D=i.priceInfo)==null?void 0:D.trim())||""),i.coordinates){const[N,V]=i.coordinates;a.lng=Number(N),a.lat=Number(V)}const d={},p={};for(const N of Object.keys(a)){let V;N==="lng"?V=(U=l.coordinates)==null?void 0:U[0]:N==="lat"?V=(G=l.coordinates)==null?void 0:G[1]:V=l[N];const Pe=V==null?"":V,ce=a[N]===void 0||a[N]===null?"":a[N];Pe!==ce&&(d[N]=V!=null?V:"",p[N]=a[N])}const h={...a,updatedBy:r,updatedAt:Vn()},f=co(Ze(Xe,`${Un}/${o}/history`)).key,b={};for(const N of Object.keys(h))b[`${Un}/${o}/${N}`]=h[N];return b[`${Un}/${o}/history/${f}`]={action:"update",at:Vn(),by:r,before:d,after:p},Oi(Ze(Xe),b)},deleteParking:async o=>{if(!an)throw new Error("Firebase 尚未設定");return Ma(Ze(Xe,`${Un}/${o}`))}}}var gm={VITE_FIREBASE_DATABASE_URL:"https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app",VITE_FIREBASE_MESSAGING_SENDER_ID:"976769533420",VITE_FIREBASE_MEASUREMENT_ID:"G-XMR8C87T1P",VITE_FIREBASE_STORAGE_BUCKET:"findparkinglot-2519e.firebasestorage.app",VITE_FIREBASE_AUTH_DOMAIN:"findparkinglot-2519e.firebaseapp.com",VITE_MAPBOX_TOKEN:"pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",VITE_FIREBASE_PROJECT_ID:"findparkinglot-2519e",VITE_FIREBASE_APP_ID:"1:976769533420:web:f3108318b3def30017acc9",VITE_FIREBASE_API_KEY:"AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs",BASE_URL:"./",MODE:"production",DEV:!1,PROD:!0,SSR:!1};const za="community_user_id",Va="community_user_nickname",Am="community_is_admin",_m=String(gm.VITE_ADMIN_USER_IDS||"").split(",").map(n=>n.trim()).filter(Boolean);function vm(){const n=e=>Array.from(crypto.getRandomValues(new Uint8Array(e))).map(t=>t.toString(16).padStart(2,"0")).join("");return`${n(2)}-${n(2)}`}let po=nn.get(za);po||(po=vm(),nn.set(za,po));const Vi=po,Wi=E(nn.get(Va)||""),Cm=_m.includes(Vi)||nn.get(Am)==="1";K(Wi,n=>nn.set(Va,n||""));function Pm(){return{userId:Vi,nickname:Wi,displayName:()=>{var e;return((e=Wi.value)==null?void 0:e.trim())||`匿名#${Vi}`},isAdmin:Cm}}const Um=()=>typeof window!="undefined"&&typeof window.gtag=="function",fe=(n,e={})=>{if(Um())try{window.gtag("event",n,e)}catch(t){}},S=n=>(Tn("data-v-739ea748"),n=n(),Nn(),n),Em={class:"app-title"},Bm=["aria-label","aria-expanded"],wm={class:"material-icons-outlined"},Im={key:1,class:"title-logo",src:Ki,alt:"重機能停哪"},Sm=S(()=>c("h1",null,"重機能停哪?",-1)),km=S(()=>c("pre",{id:"coordinates",class:"coordinates"},null,-1)),Dm=S(()=>c("h4",{class:"modal-section-title"},"圖案代表甚麼格位",-1)),Tm={class:"legend-list"},Nm={class:"legend-row"},Mm=["src"],Rm={class:"legend-row"},Om=["src"],xm={class:"legend-row"},Lm=["src"],Fm={class:"legend-row"},Hm=["src"],zm={class:"legend-row"},Vm=["src"],Wm={class:"legend-row"},jm=["src"],Gm={class:"legend-row"},Km=["src"],Xm={class:"legend-row"},Qm=["src"],Ym={class:"legend-row"},Jm=["src"],qm={class:"legend-row"},$m=["src"],Zm={class:"legend-row"},e4=["src"],n4=S(()=>c("h4",{class:"modal-section-title"},"顏色代表入場方式",-1)),t4={class:"legend-list"},o4={class:"legend-row"},i4=["src"],s4=["src"],r4=["src"],l4={class:"legend-row"},a4=["src"],c4=["src"],d4=["src"],h4={class:"legend-row"},u4=["src"],p4=["src"],m4=["src"],f4={class:"legend-row"},y4=["src"],b4=["src"],g4=["src"],A4=S(()=>c("h4",{class:"modal-section-title"},"名稱前有價錢",-1)),_4={class:"legend-list"},v4={class:"legend-row"},C4=["src"],P4=S(()=>c("div",{class:"legend-row"},[c("div",{class:"legend-text"},[k(" ・數字:金額,時段費率複雜會以最高收費標示"),c("br"),k(" ・d/h:d 為計次,h 為計時"),c("br"),k(" ・Free 代表免費 ")])],-1)),U4={class:"share-grid"},E4=S(()=>c("img",{src:Zr,alt:""},null,-1)),B4=S(()=>c("span",null,"Facebook",-1)),w4=[E4,B4],I4=S(()=>c("img",{src:el,alt:""},null,-1)),S4=S(()=>c("span",null,"LINE",-1)),k4=[I4,S4],D4=S(()=>c("img",{src:nl,alt:""},null,-1)),T4=S(()=>c("span",null,"Twitter",-1)),N4=[D4,T4],M4=S(()=>c("img",{src:tl,alt:""},null,-1)),R4=S(()=>c("span",null,"複製連結",-1)),O4=[M4,R4],x4={class:"modal-hint",style:{"word-break":"break-all"}},L4={class:"share-grid"},F4=S(()=>c("img",{src:Zr,alt:""},null,-1)),H4=S(()=>c("span",null,"Facebook",-1)),z4=[F4,H4],V4=S(()=>c("img",{src:el,alt:""},null,-1)),W4=S(()=>c("span",null,"LINE",-1)),j4=[V4,W4],G4=S(()=>c("img",{src:nl,alt:""},null,-1)),K4=S(()=>c("span",null,"Twitter",-1)),X4=[G4,K4],Q4=S(()=>c("img",{src:tl,alt:""},null,-1)),Y4=S(()=>c("span",null,"複製連結",-1)),J4=[Q4,Y4],q4=S(()=>c("p",{class:"modal-hint"}," 若覺得本站有幫助，歡迎透過以下連結請我喝一杯咖啡，讓我有動力繼續維護更新！ ",-1)),$4={class:"support-list"},Z4=["onClick"],ef={class:"material-icons-outlined support-btn-icon"},nf={class:"support-btn-body"},tf={class:"support-btn-label"},of={key:0,class:"support-btn-badge"},sf={class:"support-btn-desc"},rf=S(()=>c("span",{class:"material-icons-outlined support-btn-arrow"},"open_in_new",-1)),lf={class:"os-tabs",role:"tablist","aria-label":"作業系統"},af=["aria-selected"],cf=S(()=>c("span",{class:"material-icons-outlined"},"phone_iphone",-1)),df=["aria-selected"],hf=S(()=>c("span",{class:"material-icons-outlined"},"android",-1)),uf=S(()=>c("p",{class:"modal-hint"},"以下以 iOS Safari 為範例",-1)),pf=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Safari 開啟網站並點擊下方分享按鈕",-1)),mf=S(()=>c("img",{class:"full-img",src:vc,alt:""},null,-1)),ff=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「加入主畫面」",-1)),yf=S(()=>c("img",{class:"full-img",src:Cc,alt:""},null,-1)),bf=S(()=>c("h4",{class:"modal-section-title"},"3. 確認名稱後按「加入」",-1)),gf=S(()=>c("img",{class:"full-img",src:Pc,alt:""},null,-1)),Af=S(()=>c("h4",{class:"modal-section-title"},"4. 完成,圖示已加到主畫面",-1)),_f=S(()=>c("img",{class:"full-img",src:Uc,alt:""},null,-1)),vf=S(()=>c("h4",{class:"modal-section-title"},"5. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),Cf=S(()=>c("img",{class:"full-img",src:Ec,alt:""},null,-1)),Pf=S(()=>c("p",{class:"modal-hint"},"以下以 Android Chrome 為範例",-1)),Uf=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Chrome 開啟網站並點擊右上角選單，點選「加到主畫面」",-1)),Ef=S(()=>c("img",{class:"full-img",src:Bc,alt:""},null,-1)),Bf=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「安裝」",-1)),wf=S(()=>c("img",{class:"full-img",src:wc,alt:""},null,-1)),If=S(()=>c("h4",{class:"modal-section-title"},"3. 完成,圖示已加到主畫面",-1)),Sf=S(()=>c("img",{class:"full-img",src:Ic,alt:""},null,-1)),kf=S(()=>c("h4",{class:"modal-section-title"},"4. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),Df=S(()=>c("img",{class:"full-img",src:Sc,alt:""},null,-1)),Tf=S(()=>c("div",{class:"welcome-logo-wrap"},[c("img",{class:"welcome-logo",src:Ki,alt:"重機能停哪"})],-1)),Nf=S(()=>c("div",{class:"welcome-badge"},"✨ 全新介面上線",-1)),Mf=S(()=>c("p",{class:"welcome-text"}," 這是一個提供重機停車資訊的地圖，你可以依據「友善程度」「停車格類型」「收費範圍」尋找合適的停車場，並一鍵開啟 Google 或 Apple Map 導航。 ",-1)),Rf=S(()=>c("div",{class:"whatsnew-card"},[c("div",{class:"whatsnew-title"},[c("span",{class:"material-icons-outlined"},"auto_awesome"),k(" 本次新功能 ")]),c("ul",{class:"whatsnew-list"},[c("li",null,[c("span",{class:"material-icons-outlined"},"star"),c("span",null,[c("strong",null,"我的最愛"),c("br"),k(" 可以將喜歡的停車場加入我的最愛")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"search"),c("span",null,[c("strong",null,"地點搜尋"),c("br"),k(" 可以搜尋指定的停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_location_alt"),c("span",null,[c("strong",null,"共筆停車點"),c("br"),k(" 可自由新增、編輯, 大家一起分享停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_note"),c("span",null,[c("strong",null,"官方點異議 / 補充"),c("br"),k(" 點開任一官方停車點 → 「異議 / 補充」, 可在不改動原始資料的前提下, 補上實際費率、更正分類或加註說明, 全車友共享")])])])],-1)),Of=S(()=>c("p",{class:"welcome-text"},[k(" 資料取源於: "),c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"link"},"Alan大重停車記事"),k("，如有停車場相關問題請至該頁面填寫回報表單。 ")],-1)),xf=S(()=>c("p",{class:"welcome-text"},' 公告: 原始資料"大重停車記事已無更新" 已改由 Alan大重停車記事 提供，感謝Alan的辛苦整理與分享！ ',-1)),Lf=S(()=>c("p",{class:"welcome-text"},[k(" 本站僅提供資料整合服務，地圖免費提供車友使用，資料不定期更新；若發生無法使用情況，請至 "),c("a",{href:"https://forms.gle/iJCyfqVtpL35WtZM7",target:"_blank",rel:"noopener",class:"link"},"錯誤資訊回報"),k("，也歡迎贊助讓我有動力繼續更新。 ")],-1)),Ff=S(()=>c("p",{class:"welcome-text right"},"— by 爽爽",-1)),Hf={key:0,class:"pick-crosshair","aria-hidden":"true"},zf=S(()=>c("span",{class:"material-icons-outlined dot"},"gps_fixed",-1)),Vf=[zf],Wf={key:1,class:"pick-banner"},jf=S(()=>c("span",{class:"pick-banner-text"},[c("span",{class:"material-icons-outlined"},"touch_app"),k(" 拖動地圖，將十字線對準目標位置 ")],-1)),Gf=S(()=>c("span",{class:"material-icons-outlined"},"check",-1)),Kf=S(()=>c("p",{class:"welcome-text"},[c("strong",{style:{color:"var(--primary)"}},"這是一個公開共享的「共筆停車點」區。"),k(" 除了官方收錄的「大重停車記事」資料外,任何人都可以新增、修改、補充停車位置——不需要註冊、不需要審核。 ")],-1)),Xf=S(()=>c("h4",{class:"modal-section-title"},"如何新增停車位置",-1)),Qf=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"點左下角的「共筆停車點」按鈕,再點「新增停車位置」"),c("li",null,"畫面中心會出現青色十字游標,拖動地圖將游標對準目標位置"),c("li",null,"按頂部「使用此位置」,填寫名稱、類別、友善程度、收費等資料"),c("li",null,"按「新增」即完成(座標已自動記錄,圖示會依類別自動套用)")],-1)),Yf=S(()=>c("h4",{class:"modal-section-title"},"如何編輯他人新增的位置",-1)),Jf=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"地圖上「薰衣草紫色底」的標記即為使用者新增的「共筆停車點」"),c("li",null,"點擊該標記,在資訊面板按「編輯」"),c("li",null,"修改後按「儲存修改」")],-1)),qf=S(()=>c("h4",{class:"modal-section-title"},"注意事項",-1)),$f=S(()=>c("ul",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"請確認資訊正確,避免造成他人困擾"),c("li",null,"不要新增不雅、惡意或無關內容"),c("li",null,"暱稱可選填,留空將顯示為「匿名#xxx-xxx」"),c("li",null,"站方保留必要時清空所有「共筆停車點」資料的權利")],-1)),Xr="onboarding_tour_v1",Qr="filters_v1",Zf="https://findparkinglot.github.io/",ey={__name:"App",setup(n){var zs,Vs,Ws;const e=navigator.userAgent,t=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(e),o=/iPhone|iPad|iPod/i.test(e),i=/Android/i.test(e),s=E([]),r=()=>{var u;return!!((u=window.matchMedia)!=null&&u.call(window,"(prefers-color-scheme: light)").matches)},l=u=>{var m;if(u==="system"){const y=r()?"light":"dark";return(m=tt.find(me=>me.theme===y))==null?void 0:m.value}return u},a=tt.find(u=>u.name===nn.get("mapStyles")),d=(a==null?void 0:a.value)||((zs=tt.find(u=>u.theme==="dark"))==null?void 0:zs.value),p=E(d),h=E({getLngLat:!1,mapStylesSelected:l(d)}),f=u=>{const m=l(u);h.value.mapStylesSelected=m;const y=tt.find(ue=>ue.value===m),me=(y==null?void 0:y.theme)==="light";document.body.classList.toggle("light-theme",me),document.body.classList.toggle("dark-theme",!me);const Ve=tt.find(ue=>ue.value===u);Ve&&nn.set("mapStyles",Ve.name)};f(p.value),K(p,f);const b=(Vs=window.matchMedia)==null?void 0:Vs.call(window,"(prefers-color-scheme: light)");(Ws=b==null?void 0:b.addEventListener)==null||Ws.call(b,"change",()=>{p.value==="system"&&f("system")});const g=E(!0),B=E(!1),D=E(i?"android":"ios"),U=E(!1),G=E(!1),N=E(!1),V=E(!1),Pe=E(!1),ce=[{selector:".mapboxgl-ctrl-geolocate",icon:"my_location",title:"定位你的位置",description:"點右上角的定位按鈕,地圖會自動移到你目前位置,並追蹤方向。"},{selector:".fab-placement-right > .fab-main",icon:"help_outline",title:"功能與教學",description:"右下角的圓形按鈕展開後,可看到「地圖怎麼看」、「加到手機桌面」、「分享」等功能。"},{selector:".search-toggle",icon:"search",title:"搜尋停車點",description:"右下角的搜尋按鈕可依名稱快速找到想去的停車場,點選結果會自動飛到該位置並開啟資訊。"},{selector:".app-title .title-toggle",icon:"menu",title:"篩選與我的最愛",description:"左上角選單可以調整停車類型、友善程度、收費範圍,以及只顯示我的最愛、切換主題。"},{selector:".fab-placement-left > .fab-main",icon:"add_location_alt",title:"共筆停車點",description:"左下角按鈕可新增/編輯共筆停車點,大家一起分享真實的停車資訊。"}],Se=()=>{Pe.value=!0,fe("onboarding_tour_start")},Ue=()=>{try{localStorage.setItem(Xr,"1")}catch(u){}fe("onboarding_tour_finish")},Je=()=>{g.value=!1},pe=E(!1),re=E(!1),Te=E(!1),je=u=>{u!=="menu"&&(pe.value=!1),u!=="info"&&(re.value=!1),u!=="message"&&(g.value=!1),u!=="mobileFAQ"&&(B.value=!1),u!=="faq"&&(U.value=!1),u!=="share"&&(G.value=!1),u!=="communityHelp"&&(N.value=!1),u!=="support"&&(V.value=!1),fe("panel_open",{panel:u})};K(pe,u=>u&&je("menu")),K(re,u=>u&&je("info")),K(g,u=>u&&je("message")),K(B,u=>u&&je("mobileFAQ")),K(B,u=>{u&&(i?D.value="android":o&&(D.value="ios"))}),K(U,u=>u&&je("faq")),K(G,u=>u&&je("share")),K(N,u=>u&&je("communityHelp")),K(V,u=>u&&je("support"));const P=[{key:"buymeacoffee",url:"https://buymeacoffee.com/jamestim923",label:"Buy Me a Coffee",description:"請我喝杯咖啡 ☕️ (美金贊助)",icon:"local_cafe",primary:!1}],R=()=>{V.value=!0,fe("support_open")},Q=u=>{fe("support_click",{provider:u.key}),window.open(u.url,"_blank","noopener,noreferrer")},W=nn.getJSON(Qr,{})||{},Z=E(typeof W.parkingType=="string"?W.parkingType:""),ie=E(typeof W.degreeOfFriendliness=="string"?W.degreeOfFriendliness:""),Oe=E(typeof W.parkingPriceType=="string"?W.parkingPriceType:""),be=E(typeof W.priceRangeMin=="number"?W.priceRangeMin:0),_=E(typeof W.priceRangeMax=="number"?W.priceRangeMax:100),T=E(W.showOfficial!==!1),w=E(W.showOverridden!==!1),le=E(W.showCommunity!==!1),{favorites:Ne,favoriteIdSet:xe,isFavorite:fn,toggleFavorite:On}=pd(),Ee=E(W.onlyFavorites===!0);K([Z,ie,Oe,be,_,Ee,T,w,le],([u,m,y,me,Ve,ue,An,_n,io])=>{nn.setJSON(Qr,{parkingType:u,degreeOfFriendliness:m,parkingPriceType:y,priceRangeMin:me,priceRangeMax:Ve,onlyFavorites:ue,showOfficial:An,showOverridden:_n,showCommunity:io})});const O=E("driving"),{items:x,addParking:de,updateParking:Le,deleteParking:Fe}=bm(),{userId:he,nickname:He,isAdmin:ke}=Pm(),xn=E(null),{overrides:eo,getOverride:Xo,getOverrideHistory:no,upsertOverride:Wa,resetOverride:ja}=Au(),Ns=Y(()=>new Set(Object.keys(eo.value||{}))),Ga=Y(()=>(s.value||[]).reduce((u,m)=>{var y;return u+(((y=m==null?void 0:m.features)==null?void 0:y.length)||0)},0)),Ka=Y(()=>Ns.value.size),Xa=Y(()=>(x.value||[]).length),qe=E(!1),yn=E("add"),bn=E(null),dn=E(!1),gt=E([121.5173399,25.0475613]),Ms=E(!1),ln=E(!1),Qo=E(!1),Rs=Y(()=>!re.value&&!Te.value&&!ln.value&&!qe.value),Os=()=>{Qo.value&&Rs.value&&(Qo.value=!1,Se())};K(g,(u,m)=>{if(m&&!u)try{localStorage.getItem(Xr)||(Qo.value=!0,setTimeout(Os,350))}catch(y){}}),K(Rs,u=>{u&&setTimeout(Os,200)});const Qa=Y(()=>{var u;if(!qe.value)return[];if(yn.value==="override")return Ge.value?no(Ge.value.name,Ge.value.geometry):[];if(yn.value==="edit"&&((u=bn.value)!=null&&u.id)){const m=(x.value||[]).find(y=>y.id===bn.value.id);return(m==null?void 0:m.history)||[]}return[]}),ze=E(null),Ya=()=>{if(!an){alert("「共筆停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}ln.value=!0,fe("community_add_start")},Ja=()=>{var m,y;const u=((y=(m=xn.value)==null?void 0:m.getCenter)==null?void 0:y.call(m))||[121.5173399,25.0475613];gt.value=u,yn.value="add",bn.value=null,ln.value=!1,qe.value=!0},qa=()=>{ln.value=!1},$a=u=>{var m,y;gt.value=u.coordinates?[...u.coordinates]:((y=(m=xn.value)==null?void 0:m.getCenter)==null?void 0:y.call(m))||[121.5173399,25.0475613],yn.value="edit",bn.value=u,qe.value=!0},Yo=u=>{ze.value=u,Zn({name:"共筆停車點",properties:{name:u.name,description:u.description,icon:u.iconKey,priceInfo:u.priceInfo,priceArray:[]},geometry:u.coordinates,address:""})},Za=()=>{ze.value&&(re.value=!1,$a(ze.value))},ec=()=>{if(!an){alert("「修改官方停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}if(!Ge.value)return;const u=Ge.value,m=to.value,y={id:null,name:u.name,description:(m==null?void 0:m.description)||u.description,iconKey:(m==null?void 0:m.iconKey)||u.iconKey,category:(m==null?void 0:m.category)||nc(u.iconKey),friendliness:(m==null?void 0:m.friendliness)||tc(u.iconKey),priceInfo:(m==null?void 0:m.priceInfo)||u.priceInfo,coordinates:u.geometry?[...u.geometry]:[...gt.value]};gt.value=y.coordinates,yn.value="override",bn.value=y,Ms.value=!!m,re.value=!1,qe.value=!0,fe("override_edit_start",{name:u.name})};function nc(u){if(!u)return"motorcycle";const m=ut.find(y=>y.value&&y.key.includes(u));return(m==null?void 0:m.value)||"motorcycle"}function tc(u){if(!u)return"friendly";const m=Xt.find(y=>y.value&&y.key.includes(u));return(m==null?void 0:m.value)||"friendly"}const oc=async u=>{if(Ge.value){dn.value=!0;try{const m={id:he,nickname:He.value};await Wa(Ge.value,u,m),fe("override_submit",{name:Ge.value.name});const y=Ge.value;qe.value=!1,Zn({name:y.parkingType,properties:{name:y.name,description:y.description,icon:y.iconKey,priceInfo:y.priceInfo,priceArray:[]},geometry:y.geometry,address:ee.value.address})}catch(m){alert("儲存失敗:"+((m==null?void 0:m.message)||m))}finally{dn.value=!1}}},ic=async()=>{if(Ge.value){dn.value=!0;try{const u=Ge.value,m={id:he,nickname:He.value};await ja(u.name,u.geometry,m),fe("override_reset",{name:u.name}),qe.value=!1,Zn({name:u.parkingType,properties:{name:u.name,description:u.description,icon:u.iconKey,priceInfo:u.priceInfo,priceArray:[]},geometry:u.geometry,address:ee.value.address})}catch(u){alert("重設失敗:"+((u==null?void 0:u.message)||u))}finally{dn.value=!1}}},sc=async u=>{var m;dn.value=!0;try{const y={id:he,nickname:He.value};yn.value==="edit"&&((m=bn.value)!=null&&m.id)?(await Le(bn.value.id,u,y),fe("community_edit_submit",{name:u==null?void 0:u.name})):(await de(u,y),fe("community_add_submit",{name:u==null?void 0:u.name})),qe.value=!1,ze.value=null}catch(y){alert("儲存失敗:"+((y==null?void 0:y.message)||y))}finally{dn.value=!1}},rc=async u=>{dn.value=!0;try{const m={id:he,nickname:He.value};await Fe(u,m),fe("community_delete",{id:u}),qe.value=!1,ze.value=null}catch(m){alert("刪除失敗:"+((m==null?void 0:m.message)||m))}finally{dn.value=!1}},Jo=Y(()=>{var m,y;if(!ze.value||!ee.value.parkingName)return!1;const u=ze.value;return u.name===ee.value.parkingName&&Array.isArray(ee.value.geometry)&&((m=u.coordinates)==null?void 0:m[0])===ee.value.geometry[0]&&((y=u.coordinates)==null?void 0:y[1])===ee.value.geometry[1]});K(re,u=>{u||(ze.value=null)});const At=E(null),lc=Y(()=>{var u;return((u=ut.find(m=>m.value===Z.value))==null?void 0:u.key)||[]}),ac=Y(()=>{var u;return((u=Xt.find(m=>m.value===ie.value))==null?void 0:u.key)||[]}),ee=E({parkingName:"",parkingNameDes:"",parkingType:"",parkingIcon:"",parkingIconKey:"",iconCategory:"",priceInfo:"",geometry:[null,null],address:"",sourceLabel:""}),Ge=E(null),to=E(null),xs=Y(()=>mi(ee.value.parkingName,ee.value.geometry)),Ls=Y(()=>fn(xs.value)),Zn=u=>{var An,_n,io,js,Gs;const m=u.properties.icon,y={name:u.properties.name,description:u.properties.description,iconKey:m,priceInfo:u.properties.priceInfo||"",geometry:u.geometry,parkingType:u.name},me=!!(ze.value&&ze.value.name===u.properties.name&&Array.isArray(u.geometry)&&((An=ze.value.coordinates)==null?void 0:An[0])===u.geometry[0]&&((_n=ze.value.coordinates)==null?void 0:_n[1])===u.geometry[1]);let Ve=null,ue=y;me||(Ve=Xo(y.name,y.geometry),Ve&&(ue=La(y,Ve))),Ge.value=me?null:y,to.value=Ve,ee.value={parkingName:ue.name,parkingNameDes:ue.description,parkingType:y.parkingType,iconCategory:Lu(ue.iconKey),parkingIcon:q(ue.iconKey),parkingIconKey:ue.iconKey,priceInfo:ue.priceInfo||"",geometry:u.geometry,address:u.address,sourceLabel:me?"":id((io=u.properties)==null?void 0:io.sourceFolderIndex)},re.value=!0,fe("parking_view",{parking_name:(js=u.properties)==null?void 0:js.name,parking_type:u.name,icon:(Gs=u.properties)==null?void 0:Gs.icon,overridden:!!Ve})},cc=()=>{if(!ee.value.parkingName)return;const u=!Ls.value;On({id:xs.value,name:ee.value.parkingName,parkingType:ee.value.parkingType,geometry:ee.value.geometry,address:ee.value.address,icon:ee.value.parkingIconKey}),fe(u?"favorite_add":"favorite_remove",{parking_name:ee.value.parkingName,parking_type:ee.value.parkingType})},dc=u=>"",hc=u=>{var m;u.isCommunity&&u.community?Yo(u.community):Zn({name:u.groupName,properties:u.properties,geometry:u.geometry,address:dc(u.geometry)}),At.value=[...u.geometry],fe("search_select",{parking_name:(m=u.properties)==null?void 0:m.name,group:u.groupName,community:!!u.isCommunity})},_t=E(null),vt=E(null),uc=u=>{O.value="driving",_t.value=u,re.value=!1,vt.value=null,fe("route_start",{parking_name:ee.value.parkingName,profile:"driving"})},pc=()=>{_t.value=null,Te.value=!1};K(vt,u=>{Te.value=u!==null});const mc=u=>{const m=ee.value.geometry;let y="";u==="apple"?y=`https://maps.apple.com/?daddr=${m[1]},${m[0]}&dirflg=d&t=m`:u==="google"&&(y=`https://www.google.com/maps/dir/?api=1&destination=${m[1]},${m[0]}&travelmode=driving`),y&&(fe("open_external_map",{provider:u,parking_name:ee.value.parkingName}),window.open(y,"_blank","noopener,noreferrer"))},gn=(u,m=null)=>{const y=m||"https://findparkinglot.github.io/";let me="";u==="facebook"?me=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(y)}`:u==="line"?me=`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(y)}`:u==="twitter"&&(me=`https://twitter.com/share?url=${encodeURIComponent(y)}`),fe("share",{method:u,scope:m?"spot":"site"}),u==="link"?navigator.clipboard.writeText(y).then(()=>alert("已複製連結"),()=>alert("複製失敗")):window.open(me,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},Fs=()=>{const u=ee.value.geometry;if(!Array.isArray(u)||u[0]==null||u[1]==null)return"";const m=new URLSearchParams({lng:Number(u[0]).toFixed(6),lat:Number(u[1]).toFixed(6)});return`${Zf}?${m.toString()}`},fc=()=>{const u=Fs();u&&(et.value=u,$o.value=ee.value.parkingName||"停車點",qo.value=!0,fe("share_spot_open",{name:$o.value}))},qo=E(!1),et=E(""),$o=E("");K([re,ee],()=>{try{if(!re.value){window.location.search&&window.history.replaceState({},"",window.location.pathname);return}const u=Fs();if(!u)return;const m=u.slice(u.indexOf("?"));window.history.replaceState({},"",window.location.pathname+m)}catch(u){}},{deep:!0});const Ct=E(null),oo=(u,m)=>Math.abs(Number(u)-Number(m))<1e-5,Zo=()=>{var Ve;const u=Ct.value;if(!u)return;const m=Number(u.lng),y=Number(u.lat);if(!isFinite(m)||!isFinite(y)){Ct.value=null;return}const me=(x.value||[]).find(ue=>ue.coordinates&&oo(ue.coordinates[0],m)&&oo(ue.coordinates[1],y));if(me){Yo(me),At.value=[m,y],Ct.value=null;return}for(const ue of s.value||[])for(const An of ue.features||[]){const _n=(Ve=An.geometry)==null?void 0:Ve.coordinates;if(_n&&oo(_n[0],m)&&oo(_n[1],y)){Zn({name:ue.name,properties:An.properties,geometry:An.geometry.coordinates,address:""}),At.value=[m,y],Ct.value=null;return}}Array.isArray(s.value)&&s.value.length>0&&(At.value=[m,y])},Hs=()=>{try{const u=new URLSearchParams(window.location.search),m=u.get("lng"),y=u.get("lat");if(!m||!y)return;Ct.value={lng:m,lat:y},Zo()}catch(u){}};K(x,Zo,{deep:!1}),K(s,Zo,{deep:!1}),Yn(()=>{s.value=ud(td()),g.value||Hs()}),K(g,(u,m)=>{m&&!u&&Hs()});const yc=Y(()=>[{key:"share",icon:"share",label:"分享",highlight:!0,onClick:()=>G.value=!0},{key:"howto",icon:"help_outline",label:"怎麼用",onClick:Se},{key:"faq",icon:"map",label:"地圖怎麼看",onClick:()=>U.value=!0},{key:"mobile",icon:"add_to_home_screen",label:"加到手機桌面",onClick:()=>B.value=!0}]),bc=Y(()=>[{key:"add",icon:"add_location_alt",label:"新增停車位置",highlight:!0,onClick:Ya},{key:"help",icon:"menu_book",label:"編輯教學",onClick:()=>N.value=!0}]);return(u,m)=>(v(),C(ye,null,[c("div",Em,[ln.value?(v(),C("img",Im)):(v(),C("button",{key:0,class:"title-toggle",onClick:m[0]||(m[0]=y=>pe.value=!pe.value),"aria-label":pe.value?"收合設定":"開啟設定","aria-expanded":pe.value},[c("span",wm,I(pe.value?"close":"menu"),1)],8,Bm)),Sm]),Ke(Be(Gr,{items:yc.value},null,8,["items"]),[[wt,!Te.value&&!re.value&&!ln.value]]),Ke(Be(Gr,{items:bc.value,placement:"left","main-icon":"add_location_alt","main-label":"共筆停車點"},null,8,["items"]),[[wt,!Te.value&&!re.value&&!ln.value]]),Ke(Be(sp,{"map-data-list":s.value,"community-parkings":L(x),onSelect:hc},null,8,["map-data-list","community-parkings"]),[[wt,!Te.value&&!re.value&&!ln.value]]),km,Be(Uu,{ref_key:"mapBoxRef",ref:xn,parkingTypeKeyArray:lc.value,degreeOfFriendlinessKeyArray:ac.value,mapDataList:s.value,getLngLat:h.value.getLngLat,mapStylesSelected:h.value.mapStylesSelected,parkingPriceType:Oe.value,priceRangeMin:be.value,priceRangeMax:_.value,"favorite-ids":L(xe),"override-keys":Ns.value,overrides:L(eo),"only-favorites":Ee.value,"show-official":T.value,"show-overridden":w.value,"show-community":le.value,"focus-coord":At.value,"route-profile":O.value,"community-parkings":L(x),goToParkingPlaceData:_t.value,"onUpdate:goToParkingPlaceData":m[1]||(m[1]=y=>_t.value=y),routeData:vt.value,"onUpdate:routeData":m[2]||(m[2]=y=>vt.value=y),onParkingInfo:Zn,onCommunityParkingClick:Yo},null,8,["parkingTypeKeyArray","degreeOfFriendlinessKeyArray","mapDataList","getLngLat","mapStylesSelected","parkingPriceType","priceRangeMin","priceRangeMax","favorite-ids","override-keys","overrides","only-favorites","show-official","show-overridden","show-community","focus-coord","route-profile","community-parkings","goToParkingPlaceData","routeData"]),Be(W5,{"route-data":vt.value,active:Te.value,profile:O.value,"onUpdate:profile":m[3]||(m[3]=y=>O.value=y),onCancel:pc},null,8,["route-data","active","profile"]),Be(G3,{parkingType:Z.value,"onUpdate:parkingType":m[4]||(m[4]=y=>Z.value=y),degreeOfFriendliness:ie.value,"onUpdate:degreeOfFriendliness":m[5]||(m[5]=y=>ie.value=y),parkingPriceType:Oe.value,"onUpdate:parkingPriceType":m[6]||(m[6]=y=>Oe.value=y),priceRangeMin:be.value,"onUpdate:priceRangeMin":m[7]||(m[7]=y=>be.value=y),priceRangeMax:_.value,"onUpdate:priceRangeMax":m[8]||(m[8]=y=>_.value=y),mapStyle:p.value,"onUpdate:mapStyle":m[9]||(m[9]=y=>p.value=y),active:pe.value,"onUpdate:active":m[10]||(m[10]=y=>pe.value=y),onlyFavorites:Ee.value,"onUpdate:onlyFavorites":m[11]||(m[11]=y=>Ee.value=y),showOfficial:T.value,"onUpdate:showOfficial":m[12]||(m[12]=y=>T.value=y),showOverridden:w.value,"onUpdate:showOverridden":m[13]||(m[13]=y=>w.value=y),showCommunity:le.value,"onUpdate:showCommunity":m[14]||(m[14]=y=>le.value=y),"favorites-count":L(Ne).length,"official-count":Ga.value,"overridden-count":Ka.value,"community-count":Xa.value,onOpenSupport:R},null,8,["parkingType","degreeOfFriendliness","parkingPriceType","priceRangeMin","priceRangeMax","mapStyle","active","onlyFavorites","showOfficial","showOverridden","showCommunity","favorites-count","official-count","overridden-count","community-count"]),Ke(Be(w5,{info:ee.value,active:re.value,"is-mobile":L(t),"is-apple":L(o),"is-android":L(i),"has-route":_t.value!==null,"is-favorite":Ls.value,"is-community":Jo.value,"community-meta":Jo.value?ze.value:null,"is-overridden":!Jo.value&&!!to.value,"override-meta":to.value,onClose:m[15]||(m[15]=y=>re.value=!1),onRoute:m[16]||(m[16]=y=>uc(ee.value.geometry)),onOpenMap:mc,onToggleFavorite:cc,onEditCommunity:Za,onEditOverride:ec,onShare:fc},null,8,["info","active","is-mobile","is-apple","is-android","has-route","is-favorite","is-community","community-meta","is-overridden","override-meta"]),[[wt,!Te.value]]),Be(Pn,{modelValue:U.value,"onUpdate:modelValue":m[17]||(m[17]=y=>U.value=y),title:"地圖怎麼看?","close-text":"知道了",size:"lg"},{default:$e(()=>[Dm,c("div",Tm,[c("div",Nm,[c("img",{src:L(q)("icon-3.png"),alt:""},null,8,Mm),k(" 汽車：汽車格(含未確認是否有重機格) ")]),c("div",Rm,[c("img",{src:L(q)("icon-8.png"),alt:""},null,8,Om),k(" 重機(有人):有設重機專用格 ")]),c("div",xm,[c("img",{src:L(q)("icon-10.png"),alt:""},null,8,Lm),k(" 機車(沒人):機車格 ")]),c("div",Fm,[c("img",{src:L(q)("icon-14.png"),alt:""},null,8,Hm),k(" 綠星:路邊友善車格 ")]),c("div",zm,[c("img",{src:L(q)("icon-4.png"),alt:""},null,8,Vm),k(" 重機友善店家:用餐/消費時可停重機的店家 ")]),c("div",Wm,[c("img",{src:L(q)("icon-15.png"),alt:""},null,8,jm),k(" 綠P:重機專用路邊停車格 ")]),c("div",Gm,[c("img",{src:L(q)("icon-16.png"),alt:""},null,8,Km),k(" 灰P:重機專用路邊停車格(未確認精準座標,歡迎回報) ")]),c("div",Xm,[c("img",{src:L(q)("icon-17.png"),alt:""},null,8,Qm),k(" 藍P:普通大型共用機車格(台北市試辦) ")]),c("div",Ym,[c("img",{src:L(q)("icon-18.png"),alt:""},null,8,Jm),k(" 紫P:時段性汽機車共用停車格 ")]),c("div",qm,[c("img",{src:L(q)("icon-19.png"),alt:""},null,8,$m),k(" 紅X:停都不給停 ")]),c("div",Zm,[c("img",{src:L(q)("icon-20.png"),alt:""},null,8,e4),k(" ?:類型未確認,歡迎透過共筆回報 ")])]),n4,c("div",t4,[c("div",o4,[c("img",{src:L(q)("icon-2.png"),alt:""},null,8,i4),c("img",{src:L(q)("icon-6.png"),alt:""},null,8,s4),c("img",{src:L(q)("icon-9.png"),alt:""},null,8,r4),k(" 綠色最友善:有後牌辨析 ")]),c("div",l4,[c("img",{src:L(q)("icon-5.png"),alt:""},null,8,a4),c("img",{src:L(q)("icon-12.png"),alt:""},null,8,c4),c("img",{src:L(q)("icon-11.png"),alt:""},null,8,d4),k(" 藍色最傳統:悠遊卡 / 按鈕取票 ")]),c("div",h4,[c("img",{src:L(q)("icon-1.png"),alt:""},null,8,u4),c("img",{src:L(q)("icon-13.png"),alt:""},null,8,p4),c("img",{src:L(q)("icon-7.png"),alt:""},null,8,m4),k(" 紅色最靠北:請管理員協助 / 倒退嚕前牌辨析 ")]),c("div",f4,[c("img",{src:L(q)("icon-3.png"),alt:""},null,8,y4),c("img",{src:L(q)("icon-8.png"),alt:""},null,8,b4),c("img",{src:L(q)("icon-10.png"),alt:""},null,8,g4),k(" 灰色未確定:有可能是上述任何情況,停到請回報 ")])]),A4,c("div",_4,[c("div",v4,[c("img",{src:L(q)("icon-3.png"),alt:""},null,8,C4),k(" (30/h)三張里地下停車場 ")]),P4])]),_:1},8,["modelValue"]),Be(Pn,{modelValue:G.value,"onUpdate:modelValue":m[22]||(m[22]=y=>G.value=y),title:"分享給朋友",size:"sm"},{default:$e(()=>[c("div",U4,[c("button",{class:"share-btn",onClick:m[18]||(m[18]=y=>gn("facebook")),"aria-label":"Facebook"},w4),c("button",{class:"share-btn",onClick:m[19]||(m[19]=y=>gn("line")),"aria-label":"LINE"},k4),c("button",{class:"share-btn",onClick:m[20]||(m[20]=y=>gn("twitter")),"aria-label":"Twitter"},N4),c("button",{class:"share-btn",onClick:m[21]||(m[21]=y=>gn("link")),"aria-label":"複製連結"},O4)])]),_:1},8,["modelValue"]),Be(Pn,{modelValue:qo.value,"onUpdate:modelValue":m[27]||(m[27]=y=>qo.value=y),title:`分享：${$o.value}`,size:"sm"},{default:$e(()=>[c("p",x4,I(et.value),1),c("div",L4,[c("button",{class:"share-btn",onClick:m[23]||(m[23]=y=>gn("facebook",et.value)),"aria-label":"Facebook"},z4),c("button",{class:"share-btn",onClick:m[24]||(m[24]=y=>gn("line",et.value)),"aria-label":"LINE"},j4),c("button",{class:"share-btn",onClick:m[25]||(m[25]=y=>gn("twitter",et.value)),"aria-label":"Twitter"},X4),c("button",{class:"share-btn",onClick:m[26]||(m[26]=y=>gn("link",et.value)),"aria-label":"複製連結"},J4)])]),_:1},8,["modelValue","title"]),Be(Pn,{modelValue:V.value,"onUpdate:modelValue":m[28]||(m[28]=y=>V.value=y),title:"支持「重機能停哪?」","close-text":"關閉",size:"sm"},{default:$e(()=>[q4,c("div",$4,[(v(),C(ye,null,We(P,y=>c("button",{key:y.key,type:"button",class:$(["support-btn",{"is-primary":y.primary}]),onClick:me=>Q(y)},[c("span",ef,I(y.icon),1),c("span",nf,[c("span",tf,[k(I(y.label)+" ",1),y.primary?(v(),C("span",of,"推薦")):j("",!0)]),c("span",sf,I(y.description),1)]),rf],10,Z4)),64))])]),_:1},8,["modelValue"]),Be(Pn,{modelValue:B.value,"onUpdate:modelValue":m[31]||(m[31]=y=>B.value=y),title:"如何加入手機桌面?","close-text":"知道了",size:"lg"},{default:$e(()=>[c("div",lf,[c("button",{type:"button",role:"tab","aria-selected":D.value==="ios",class:$(["os-tab",{"is-active":D.value==="ios"}]),onClick:m[29]||(m[29]=y=>D.value="ios")},[cf,k(" iOS ")],10,af),c("button",{type:"button",role:"tab","aria-selected":D.value==="android",class:$(["os-tab",{"is-active":D.value==="android"}]),onClick:m[30]||(m[30]=y=>D.value="android")},[hf,k(" Android ")],10,df)]),D.value==="ios"?(v(),C(ye,{key:0},[uf,pf,mf,ff,yf,bf,gf,Af,_f,vf,Cf],64)):(v(),C(ye,{key:1},[Pf,Uf,Ef,Bf,wf,If,Sf,kf,Df],64))]),_:1},8,["modelValue"]),Be(Pn,{modelValue:g.value,"onUpdate:modelValue":m[32]||(m[32]=y=>g.value=y),title:"嗨！歡迎使用 重機能停哪?","close-text":"開始使用"},{footer:$e(()=>[c("button",{class:"btn btn-primary",onClick:Je},"開始使用")]),default:$e(()=>[Tf,Nf,Mf,Rf,Of,xf,Lf,c("div",{class:"welcome-support-wrap"},[c("button",{type:"button",class:"btn btn-coffee btn-sm",onClick:R}," ❤️ 贊助支持，讓我有動力繼續更新 ")]),Ff]),_:1},8,["modelValue"]),Be(tm,{open:qe.value,"onUpdate:open":m[33]||(m[33]=y=>qe.value=y),mode:yn.value,initial:bn.value,"default-coord":gt.value,nickname:L(He),"is-owner":!0,"is-admin":L(ke),submitting:dn.value,"has-existing-override":Ms.value,history:Qa.value,"onUpdate:nickname":m[34]||(m[34]=y=>He.value=y),onSubmit:m[35]||(m[35]=y=>yn.value==="override"?oc(y):sc(y)),onDelete:rc,onReset:ic},null,8,["open","mode","initial","default-coord","nickname","is-admin","submitting","has-existing-override","history"]),ln.value?(v(),C("div",Hf,Vf)):j("",!0),ln.value?(v(),C("div",Wf,[jf,c("div",{class:"pick-banner-actions"},[c("button",{class:"btn btn-outline btn-sm",onClick:qa},"取消"),c("button",{class:"btn btn-primary btn-sm",onClick:Ja},[Gf,k(" 使用此位置 ")])])])):j("",!0),Be(Pn,{modelValue:N.value,"onUpdate:modelValue":m[36]||(m[36]=y=>N.value=y),title:"共筆停車點說明","close-text":"我知道了",size:"lg"},{default:$e(()=>[Kf,Xf,Qf,Yf,Jf,qf,$f]),_:1},8,["modelValue"]),Be(pm,{active:Pe.value,"onUpdate:active":m[37]||(m[37]=y=>Pe.value=y),steps:ce,onFinish:Ue},null,8,["active"])],64))}},ny=rn(ey,[["__scopeId","data-v-739ea748"]]);_c(ny).mount("#app");"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./serviceWorker.js").catch(()=>{})});
