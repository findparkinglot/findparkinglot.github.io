 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const al=function(n){const e=[];let t=0;for(let o=0;o<n.length;o++){let i=n.charCodeAt(o);i<128?e[t++]=i:i<2048?(e[t++]=i>>6|192,e[t++]=i&63|128):(i&64512)===55296&&o+1<n.length&&(n.charCodeAt(o+1)&64512)===56320?(i=65536+((i&1023)<<10)+(n.charCodeAt(++o)&1023),e[t++]=i>>18|240,e[t++]=i>>12&63|128,e[t++]=i>>6&63|128,e[t++]=i&63|128):(e[t++]=i>>12|224,e[t++]=i>>6&63|128,e[t++]=i&63|128)}return e},cd=function(n){const e=[];let t=0,o=0;for(;t<n.length;){const i=n[t++];if(i<128)e[o++]=String.fromCharCode(i);else if(i>191&&i<224){const s=n[t++];e[o++]=String.fromCharCode((i&31)<<6|s&63)}else if(i>239&&i<365){const s=n[t++],r=n[t++],l=n[t++],a=((i&7)<<18|(s&63)<<12|(r&63)<<6|l&63)-65536;e[o++]=String.fromCharCode(55296+(a>>10)),e[o++]=String.fromCharCode(56320+(a&1023))}else{const s=n[t++],r=n[t++];e[o++]=String.fromCharCode((i&15)<<12|(s&63)<<6|r&63)}}return e.join("")},Ki={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,e){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,o=[];for(let i=0;i<n.length;i+=3){const s=n[i],r=i+1<n.length,l=r?n[i+1]:0,a=i+2<n.length,d=a?n[i+2]:0,u=s>>2,h=(s&3)<<4|l>>4;let f=(l&15)<<2|d>>6,b=d&63;a||(b=64,r||(f=64)),o.push(t[u],t[h],t[f],t[b])}return o.join("")},encodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(n):this.encodeByteArray(al(n),e)},decodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(n):cd(this.decodeStringToByteArray(n,e))},decodeStringToByteArray(n,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,o=[];for(let i=0;i<n.length;){const s=t[n.charAt(i++)],l=i<n.length?t[n.charAt(i)]:0;++i;const d=i<n.length?t[n.charAt(i)]:64;++i;const h=i<n.length?t[n.charAt(i)]:64;if(++i,s==null||l==null||d==null||h==null)throw new dd;const f=s<<2|l>>4;if(o.push(f),d!==64){const b=l<<4&240|d>>2;if(o.push(b),h!==64){const g=d<<6&192|h;o.push(g)}}}return o},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class dd extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const cl=function(n){const e=al(n);return Ki.encodeByteArray(e,!0)},po=function(n){return cl(n).replace(/\./g,"")},mi=function(n){try{return Ki.decodeString(n,!0)}catch(e){}return null};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hd(n){return dl(void 0,n)}function dl(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!ud(t)||(n[t]=dl(n[t],e[t]));return n}function ud(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pd(){if(typeof self!="undefined")return self;if(typeof window!="undefined")return window;if(typeof global!="undefined")return global;throw new Error("Unable to locate global object.")}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const md=()=>pd().__FIREBASE_DEFAULTS__,fd=()=>{if(typeof process=="undefined"||typeof qs=="undefined")return;const n=qs.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},yd=()=>{if(typeof document=="undefined")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch(t){return}const e=n&&mi(n[1]);return e&&JSON.parse(e)},hl=()=>{try{return ad()||md()||fd()||yd()}catch(n){return}},bd=n=>{var e,t;return(t=(e=hl())==null?void 0:e.emulatorHosts)==null?void 0:t[n]},gd=n=>{const e=bd(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const o=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),o]:[e.substring(0,t),o]},ul=()=>{var n;return(n=hl())==null?void 0:n.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _d(){return typeof navigator!="undefined"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function pl(){return typeof window!="undefined"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(_d())}function vd(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function ml(){return ll.NODE_ADMIN===!0}function Cd(){try{return typeof indexedDB=="object"}catch(n){return!1}}function Pd(){return new Promise((n,e)=>{try{let t=!0;const o="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(o);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(o),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var s;e(((s=i.error)==null?void 0:s.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ud="FirebaseError";class Yt extends Error{constructor(e,t,o){super(t),this.code=e,this.customData=o,this.name=Ud,Object.setPrototypeOf(this,Yt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,fl.prototype.create)}}class fl{constructor(e,t,o){this.service=e,this.serviceName=t,this.errors=o}create(e,...t){const o=t[0]||{},i=`${this.service}/${e}`,s=this.errors[e],r=s?Ed(s,o):"Error",l=`${this.serviceName}: ${r} (${i}).`;return new Yt(i,l,o)}}function Ed(n,e){return n.replace(Id,(t,o)=>{const i=e[o];return i!=null?String(i):`<${o}?>`})}const Id=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yl=function(n){let e={},t={},o={},i="";try{const s=n.split(".");e=Ot(mi(s[0])||""),t=Ot(mi(s[1])||""),i=s[2],o=t.d||{},delete t.d}catch(s){}return{header:e,claims:t,data:o,signature:i}},Bd=function(n){const e=yl(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},Sd=function(n){const e=yl(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wd(n){const e=[];for(const[t,o]of Object.entries(n))Array.isArray(o)?o.forEach(i=>{e.push(encodeURIComponent(t)+"="+encodeURIComponent(i))}):e.push(encodeURIComponent(t)+"="+encodeURIComponent(o));return e.length?"&"+e.join("&"):""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ne;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(ne||(ne={}));const Od={debug:ne.DEBUG,verbose:ne.VERBOSE,info:ne.INFO,warn:ne.WARN,error:ne.ERROR,silent:ne.SILENT},Ld=ne.INFO,Fd={[ne.DEBUG]:"log",[ne.VERBOSE]:"log",[ne.INFO]:"info",[ne.WARN]:"warn",[ne.ERROR]:"error"},Hd=(n,e,...t)=>{if(e<n.logLevel)return;const o=new Date().toISOString(),i=Fd[e];if(!i)throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class gl{constructor(e){this.name=e,this._logLevel=Ld,this._logHandler=Hd,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ne))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Od[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ne.DEBUG,...e),this._logHandler(this,ne.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ne.VERBOSE,...e),this._logHandler(this,ne.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ne.INFO,...e),this._logHandler(this,ne.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ne.WARN,...e),this._logHandler(this,ne.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ne.ERROR,...e),this._logHandler(this,ne.ERROR,...e)}}const zd=(n,e)=>e.some(t=>n instanceof t);let Zs,er;function Vd(){return Zs||(Zs=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Wd(){return er||(er=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Al=new WeakMap,fi=new WeakMap,_l=new WeakMap,ei=new WeakMap,Qi=new WeakMap;function jd(n){const e=new Promise((t,o)=>{const i=()=>{n.removeEventListener("success",s),n.removeEventListener("error",r)},s=()=>{t(En(n.result)),i()},r=()=>{o(n.error),i()};n.addEventListener("success",s),n.addEventListener("error",r)});return e.then(t=>{t instanceof IDBCursor&&Al.set(t,n)}).catch(()=>{}),Qi.set(e,n),e}function Gd(n){if(fi.has(n))return;const e=new Promise((t,o)=>{const i=()=>{n.removeEventListener("complete",s),n.removeEventListener("error",r),n.removeEventListener("abort",r)},s=()=>{t(),i()},r=()=>{o(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",s),n.addEventListener("error",r),n.addEventListener("abort",r)});fi.set(n,e)}let yi={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return fi.get(n);if(e==="objectStoreNames")return n.objectStoreNames||_l.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return En(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Kd(n){yi=n(yi)}function Qd(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const o=n.call(ni(this),e,...t);return _l.set(o,e.sort?e.sort():[e]),En(o)}:Wd().includes(n)?function(...e){return n.apply(ni(this),e),En(Al.get(this))}:function(...e){return En(n.apply(ni(this),e))}}function Xd(n){return typeof n=="function"?Qd(n):(n instanceof IDBTransaction&&Gd(n),zd(n,Vd())?new Proxy(n,yi):n)}function En(n){if(n instanceof IDBRequest)return jd(n);if(ei.has(n))return ei.get(n);const e=Xd(n);return e!==n&&(ei.set(n,e),Qi.set(e,n)),e}const ni=n=>Qi.get(n);function Yd(n,e,{blocked:t,upgrade:o,blocking:i,terminated:s}={}){const r=indexedDB.open(n,e),l=En(r);return o&&r.addEventListener("upgradeneeded",a=>{o(En(r.result),a.oldVersion,a.newVersion,En(r.transaction),a)}),t&&r.addEventListener("blocked",a=>t(a.oldVersion,a.newVersion,a)),l.then(a=>{s&&a.addEventListener("close",()=>s()),i&&a.addEventListener("versionchange",d=>i(d.oldVersion,d.newVersion,d))}).catch(()=>{}),l}const qd=["get","getKey","getAll","getAllKeys","count"],Jd=["put","add","delete","clear"],ti=new Map;function nr(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(ti.get(e))return ti.get(e);const t=e.replace(/FromIndex$/,""),o=e!==t,i=Jd.includes(t);if(!(t in(o?IDBIndex:IDBObjectStore).prototype)||!(i||qd.includes(t)))return;const s=async function(r,...l){const a=this.transaction(r,i?"readwrite":"readonly");let d=a.store;return o&&(d=d.index(l.shift())),(await Promise.all([d[t](...l),i&&a.done]))[0]};return ti.set(e,s),s}Kd(n=>({...n,get:(e,t,o)=>nr(e,t)||n.get(e,t,o),has:(e,t)=>!!nr(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $d{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Zd(t)){const o=t.getImmediate();return`${o.library}/${o.version}`}else return null}).filter(t=>t).join(" ")}}function Zd(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const bi="@firebase/app",tr="0.14.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mn=new gl("@firebase/app"),e1="@firebase/app-compat",n1="@firebase/analytics-compat",t1="@firebase/analytics",o1="@firebase/app-check-compat",i1="@firebase/app-check",s1="@firebase/auth",r1="@firebase/auth-compat",l1="@firebase/database",a1="@firebase/data-connect",c1="@firebase/database-compat",d1="@firebase/functions",h1="@firebase/functions-compat",u1="@firebase/installations",p1="@firebase/installations-compat",m1="@firebase/messaging",f1="@firebase/messaging-compat",y1="@firebase/performance",b1="@firebase/performance-compat",g1="@firebase/remote-config",A1="@firebase/remote-config-compat",_1="@firebase/storage",v1="@firebase/storage-compat",C1="@firebase/firestore",P1="@firebase/ai",U1="@firebase/firestore-compat",E1="firebase",I1="12.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gi="[DEFAULT]",B1={[bi]:"fire-core",[e1]:"fire-core-compat",[t1]:"fire-analytics",[n1]:"fire-analytics-compat",[i1]:"fire-app-check",[o1]:"fire-app-check-compat",[s1]:"fire-auth",[r1]:"fire-auth-compat",[l1]:"fire-rtdb",[a1]:"fire-data-connect",[c1]:"fire-rtdb-compat",[d1]:"fire-fn",[h1]:"fire-fn-compat",[u1]:"fire-iid",[p1]:"fire-iid-compat",[m1]:"fire-fcm",[f1]:"fire-fcm-compat",[y1]:"fire-perf",[b1]:"fire-perf-compat",[g1]:"fire-rc",[A1]:"fire-rc-compat",[_1]:"fire-gcs",[v1]:"fire-gcs-compat",[C1]:"fire-fst",[U1]:"fire-fst-compat",[P1]:"fire-vertex","fire-js":"fire-js",[E1]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yo=new Map,S1=new Map,Ai=new Map;function or(n,e){try{n.container.addComponent(e)}catch(t){mn.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function bo(n){const e=n.name;if(Ai.has(e))return mn.debug(`There were multiple attempts to register component ${e}.`),!1;Ai.set(e,n);for(const t of yo.values())or(t,n);for(const t of S1.values())or(t,n);return!0}function w1(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function k1(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N1=I1;function vl(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const o={name:gi,automaticDataCollectionEnabled:!0,...e},i=o.name;if(typeof i!="string"||!i)throw In.create("bad-app-name",{appName:String(i)});if(t||(t=ul()),!t)throw In.create("no-options");const s=yo.get(i);if(s){if(fo(t,s.options)&&fo(o,s.config))return s;throw In.create("duplicate-app",{appName:i})}const r=new xd(i);for(const a of Ai.values())r.addComponent(a);const l=new T1(t,o,r);return yo.set(i,l),l}function M1(n=gi){const e=yo.get(n);if(!e&&n===gi&&ul())return vl();if(!e)throw In.create("no-app",{appName:n});return e}function ot(n,e,t){var r;let o=(r=B1[n])!=null?r:n;t&&(o+=`-${t}`);const i=o.match(/\s|\//),s=e.match(/\s|\//);if(i||s){const l=[`Unable to register library "${o}" with version "${e}":`];i&&l.push(`library name "${o}" contains illegal characters (whitespace or "/")`),i&&s&&l.push("and"),s&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),mn.warn(l.join(" "));return}bo(new Lt(`${o}-version`,()=>({library:o,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R1="firebase-heartbeat-database",x1=1,Ft="firebase-heartbeat-store";let oi=null;function Cl(){return oi||(oi=Yd(R1,x1,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Ft)}catch(t){}}}}).catch(n=>{throw In.create("idb-open",{originalErrorMessage:n.message})})),oi}async function O1(n){try{const t=(await Cl()).transaction(Ft),o=await t.objectStore(Ft).get(Pl(n));return await t.done,o}catch(e){if(e instanceof Yt)mn.warn(e.message);else{const t=In.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});mn.warn(t.message)}}}async function ir(n,e){try{const o=(await Cl()).transaction(Ft,"readwrite");await o.objectStore(Ft).put(e,Pl(n)),await o.done}catch(t){if(t instanceof Yt)mn.warn(t.message);else{const o=In.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});mn.warn(o.message)}}}function Pl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L1=1024,F1=30;class H1{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new V1(t),this._heartbeatsCachePromise=this._storage.read().then(o=>(this._heartbeatsCache=o,o))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=sr();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(r=>r.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats.length>F1){const r=W1(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(o){mn.warn(o)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=sr(),{heartbeatsToSend:o,unsentEntries:i}=z1(this._heartbeatsCache.heartbeats),s=po(JSON.stringify({version:2,heartbeats:o}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return mn.warn(t),""}}}function sr(){return new Date().toISOString().substring(0,10)}function z1(n,e=L1){const t=[];let o=n.slice();for(const i of n){const s=t.find(r=>r.agent===i.agent);if(s){if(s.dates.push(i.date),rr(t)>e){s.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),rr(t)>e){t.pop();break}o=o.slice(1)}return{heartbeatsToSend:t,unsentEntries:o}}class V1{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Cd()?Pd().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await O1(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return ir(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return ir(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function rr(n){return po(JSON.stringify({version:2,heartbeats:n})).length}function W1(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let o=1;o<n.length;o++)n[o].date<t&&(t=n[o].date,e=o);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j1(n){bo(new Lt("platform-logger",e=>new $d(e),"PRIVATE")),bo(new Lt("heartbeat",e=>new H1(e),"PRIVATE")),ot(bi,tr,n),ot(bi,tr,"esm2020"),ot("fire-js","")}j1("");var lr={};const ar="@firebase/database",cr="1.1.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const El=function(n){try{if(typeof window!="undefined"&&typeof window[n]!="undefined"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new K1(e)}}catch(e){}return new Q1},Hn=El("localStorage"),X1=El("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const it=new gl("@firebase/database"),Y1=function(){let n=1;return function(){return n++}}(),Il=function(n){const e=Dd(n),t=new kd;t.update(e);const o=t.digest();return Ki.encodeByteArray(o)},qt=function(...n){let e="";for(let t=0;t<n.length;t++){const o=n[t];Array.isArray(o)||o&&typeof o=="object"&&typeof o.length=="number"?e+=qt.apply(null,o):typeof o=="object"?e+=Ce(o):e+=o,e+=" "}return e};let kt=null,dr=!0;const q1=function(n,e){A(!e,"Can't turn on custom loggers persistently."),it.logLevel=ne.VERBOSE,kt=it.log.bind(it)},Ie=function(...n){if(dr===!0&&(dr=!1,kt===null&&X1.get("logging_enabled")===!0&&q1()),kt){const e=qt.apply(null,n);kt(e)}},Jt=function(n){return function(...e){Ie(n,...e)}},_i=function(...n){const e="FIREBASE INTERNAL ERROR: "+qt(...n);it.error(e)},fn=function(...n){const e=`FIREBASE FATAL ERROR: ${qt(...n)}`;throw it.error(e),new Error(e)},De=function(...n){const e="FIREBASE WARNING: "+qt(...n);it.warn(e)},J1=function(){typeof window!="undefined"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&De("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},Xi=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},$1=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},Vn="[MIN_NAME]",Sn="[MAX_NAME]",Xn=function(n,e){if(n===e)return 0;if(n===Vn||e===Sn)return-1;if(e===Vn||n===Sn)return 1;{const t=hr(n),o=hr(e);return t!==null?o!==null?t-o===0?n.length-e.length:t-o:-1:o!==null?1:n<e?-1:1}},Z1=function(n,e){return n===e?0:n<e?-1:1},Pt=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+Ce(e))},Yi=function(n){if(typeof n!="object"||n===null)return Ce(n);const e=[];for(const o in n)e.push(o);e.sort();let t="{";for(let o=0;o<e.length;o++)o!==0&&(t+=","),t+=Ce(e[o]),t+=":",t+=Yi(n[e[o]]);return t+="}",t},Bl=function(n,e){const t=n.length;if(t<=e)return[n];const o=[];for(let i=0;i<t;i+=e)i+e>t?o.push(n.substring(i,t)):o.push(n.substring(i,i+e));return o};function Be(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const Sl=function(n){A(!Xi(n),"Invalid JSON number");const e=11,t=52,o=(1<<e-1)-1;let i,s,r,l,a;n===0?(s=0,r=0,i=1/n===-1/0?1:0):(i=n<0,n=Math.abs(n),n>=Math.pow(2,1-o)?(l=Math.min(Math.floor(Math.log(n)/Math.LN2),o),s=l+o,r=Math.round(n*Math.pow(2,t-l)-Math.pow(2,t))):(s=0,r=Math.round(n/Math.pow(2,1-o-t))));const d=[];for(a=t;a;a-=1)d.push(r%2?1:0),r=Math.floor(r/2);for(a=e;a;a-=1)d.push(s%2?1:0),s=Math.floor(s/2);d.push(i?1:0),d.reverse();const u=d.join("");let h="";for(a=0;a<64;a+=8){let f=parseInt(u.substr(a,8),2).toString(16);f.length===1&&(f="0"+f),h=h+f}return h.toLowerCase()},e0=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},n0=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function t0(n,e){let t="Unknown Error";n==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":n==="permission_denied"?t="Client doesn't have permission to access the desired data.":n==="unavailable"&&(t="The service is unavailable");const o=new Error(n+" at "+e._path.toString()+": "+t);return o.code=n.toUpperCase(),o}const o0=new RegExp("^-?(0*)\\d{1,10}$"),i0=-2147483648,s0=2147483647,hr=function(n){if(o0.test(n)){const e=Number(n);if(e>=i0&&e<=s0)return e}return null},mt=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw De("Exception was thrown by user callback.",t),e},Math.floor(0))}},r0=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Dt=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno!="undefined"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class l0{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,k1(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(o=>this.appCheck=o)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,o)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)==null||t.get().then(o=>o.addTokenListener(e))}notifyForInvalidToken(){De(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class a0{constructor(e,t,o){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=o,this.auth_=null,this.auth_=o.getImmediate({optional:!0}),this.auth_||o.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(Ie("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,o)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',De(e)}}class ro{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}ro.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qi="5",wl="v",kl="s",Dl="r",Tl="f",Nl=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Ml="ls",Rl="p",vi="ac",xl="websocket",Ol="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class d0{constructor(){this.counters_={}}incrementCounter(e,t=1){dn(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return hd(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ii={},si={};function Ji(n){const e=n.toString();return ii[e]||(ii[e]=new d0),ii[e]}function h0(n,e){const t=n.toString();return si[t]||(si[t]=e()),si[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class u0{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const o=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<o.length;++i)o[i]&&mt(()=>{this.onMessage_(o[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ur="start",p0="close",m0="pLPCommand",f0="pRTLPCB",Hl="id",zl="pw",Vl="ser",y0="cb",b0="seg",g0="ts",A0="d",_0="dframe",Wl=1870,jl=30,v0=Wl-jl,C0=25e3,P0=3e4;class tt{constructor(e,t,o,i,s,r,l){this.connId=e,this.repoInfo=t,this.applicationId=o,this.appCheckToken=i,this.authToken=s,this.transportSessionId=r,this.lastSessionId=l,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=Jt(e),this.stats_=Ji(t),this.urlFn=a=>(this.appCheckToken&&(a[vi]=this.appCheckToken),Fl(t,Ol,a))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new u0(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(P0)),$1(()=>{if(this.isClosed_)return;this.scriptTagHolder=new $i((...s)=>{const[r,l,a,d,u]=s;if(this.incrementIncomingBytes_(s),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,r===ur)this.id=l,this.password=a;else if(r===p0)l?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(l,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+r)},(...s)=>{const[r,l]=s;this.incrementIncomingBytes_(s),this.myPacketOrderer.handleResponse(r,l)},()=>{this.onClosed_()},this.urlFn);const o={};o[ur]="t",o[Vl]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(o[y0]=this.scriptTagHolder.uniqueCallbackIdentifier),o[wl]=qi,this.transportSessionId&&(o[kl]=this.transportSessionId),this.lastSessionId&&(o[Ml]=this.lastSessionId),this.applicationId&&(o[Rl]=this.applicationId),this.appCheckToken&&(o[vi]=this.appCheckToken),typeof location!="undefined"&&location.hostname&&Nl.test(location.hostname)&&(o[Dl]=Tl);const i=this.urlFn(o);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){tt.forceAllow_=!0}static forceDisallow(){tt.forceDisallow_=!0}static isAvailable(){return tt.forceAllow_?!0:!tt.forceDisallow_&&typeof document!="undefined"&&document.createElement!=null&&!e0()&&!n0()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=Ce(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const o=cl(t),i=Bl(o,v0);for(let s=0;s<i.length;s++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[s]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const o={};o[_0]="t",o[Hl]=e,o[zl]=t,this.myDisconnFrame.src=this.urlFn(o),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=Ce(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class $i{constructor(e,t,o,i){this.onDisconnect=o,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=Y1(),window[m0+this.uniqueCallbackIdentifier]=e,window[f0+this.uniqueCallbackIdentifier]=t,this.myIFrame=$i.createIFrame_();let s="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(s='<script>document.domain="'+document.domain+'";<\/script>');const r="<html><body>"+s+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(r),this.myIFrame.doc.close()}catch(l){Ie("frame writing exception"),l.stack&&Ie(l.stack),Ie(l)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||Ie("No IE domain setting required")}catch(t){const o=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+o+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Hl]=this.myID,e[zl]=this.myPW,e[Vl]=this.currentSerial;let t=this.urlFn(e),o="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+jl+o.length<=Wl;){const r=this.pendingSegs.shift();o=o+"&"+b0+i+"="+r.seg+"&"+g0+i+"="+r.ts+"&"+A0+i+"="+r.d,i++}return t=t+o,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,o){this.pendingSegs.push({seg:e,ts:t,d:o}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const o=()=>{this.outstandingRequests.delete(t),this.newRequest_()},i=setTimeout(o,Math.floor(C0)),s=()=>{clearTimeout(i),o()};this.addTag(e,s)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const o=this.myIFrame.doc.createElement("script");o.type="text/javascript",o.async=!0,o.src=e,o.onload=o.onreadystatechange=function(){const i=o.readyState;(!i||i==="loaded"||i==="complete")&&(o.onload=o.onreadystatechange=null,o.parentNode&&o.parentNode.removeChild(o),t())},o.onerror=()=>{Ie("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(o)}catch(o){}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ar=32,_r=768;class Y{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let o=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[o]=this.pieces_[i],o++);this.pieces_.length=o,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function Q(){return new Y("")}function L(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function wn(n){return n.pieces_.length-n.pieceNum_}function te(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new Y(n.pieces_,e)}function Zi(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function M0(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function zt(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function Ql(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new Y(e,0)}function ae(n,e){const t=[];for(let o=n.pieceNum_;o<n.pieces_.length;o++)t.push(n.pieces_[o]);if(e instanceof Y)for(let o=e.pieceNum_;o<e.pieces_.length;o++)t.push(e.pieces_[o]);else{const o=e.split("/");for(let i=0;i<o.length;i++)o[i].length>0&&t.push(o[i])}return new Y(t,0)}function F(n){return n.pieceNum_>=n.pieces_.length}function Re(n,e){const t=L(n),o=L(e);if(t===null)return e;if(t===o)return Re(te(n),te(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function R0(n,e){const t=zt(n,0),o=zt(e,0);for(let i=0;i<t.length&&i<o.length;i++){const s=Xn(t[i],o[i]);if(s!==0)return s}return t.length===o.length?0:t.length<o.length?-1:1}function es(n,e){if(wn(n)!==wn(e))return!1;for(let t=n.pieceNum_,o=e.pieceNum_;t<=n.pieces_.length;t++,o++)if(n.pieces_[t]!==e.pieces_[o])return!1;return!0}function Qe(n,e){let t=n.pieceNum_,o=e.pieceNum_;if(wn(n)>wn(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[o])return!1;++t,++o}return!0}class x0{constructor(e,t){this.errorPrefix_=t,this.parts_=zt(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let o=0;o<this.parts_.length;o++)this.byteLength_+=To(this.parts_[o]);Xl(this)}}function O0(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=To(e),Xl(n)}function L0(n){const e=n.parts_.pop();n.byteLength_-=To(e),n.parts_.length>0&&(n.byteLength_-=1)}function Xl(n){if(n.byteLength_>_r)throw new Error(n.errorPrefix_+"has a key path longer than "+_r+" bytes ("+n.byteLength_+").");if(n.parts_.length>Ar)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Ar+") or object contains a cycle "+Ln(n))}function Ln(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class No{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const o=new H(Vn,e),i=new H(Vn,t);return this.compare(o,i)!==0}minPost(){return H.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let oo;class Yl extends No{static get __EMPTY_NODE(){return oo}static set __EMPTY_NODE(e){oo=e}compare(e,t){return Xn(e.name,t.name)}isDefinedOn(e){throw pt("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return H.MIN}maxPost(){return new H(Sn,oo)}makePost(e,t){return A(typeof e=="string","KeyIndex indexValue must always be a string."),new H(e,oo)}toString(){return".key"}}const zn=new Yl;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j0(n,e){return Xn(n.name,e.name)}function ts(n,e){return Xn(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ci;function G0(n){Ci=n}const ql=function(n){return typeof n=="number"?"number:"+Sl(n):"string:"+n},Jl=function(n){if(n.isLeafNode()){const e=n.val();A(typeof e=="string"||typeof e=="number"||typeof e=="object"&&dn(e,".sv"),"Priority must be a string or number.")}else A(n===Ci||n.isEmpty(),"priority of unexpected type.");A(n===Ci||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $l,Zl;function K0(n){$l=n}function Q0(n){Zl=n}class X0 extends No{compare(e,t){const o=e.node.getPriority(),i=t.node.getPriority(),s=o.compareTo(i);return s===0?Xn(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return H.MIN}maxPost(){return new H(Sn,new Ae("[PRIORITY-POST]",Zl))}makePost(e,t){const o=$l(e);return new H(t,new Ae("[PRIORITY-POST]",o))}toString(){return".priority"}}const re=new X0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Y0=Math.log(2);class q0{constructor(e){const t=s=>parseInt(Math.log(s)/Y0,10),o=s=>parseInt(Array(s+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=o(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const _o=function(n,e,t,o){n.sort(e);const i=function(a,d){const u=d-a;let h,f;if(u===0)return null;if(u===1)return h=n[a],f=t?t(h):h,new _e(f,h.node,_e.BLACK,null,null);{const b=parseInt(u/2,10)+a,g=i(a,b),I=i(b+1,d);return h=n[b],f=t?t(h):h,new _e(f,h.node,_e.BLACK,g,I)}},s=function(a){let d=null,u=null,h=n.length;const f=function(g,I){const D=h-g,U=h;h-=g;const j=i(D+1,U),T=n[D],V=t?t(T):T;b(new _e(V,T.node,I,null,j))},b=function(g){d?(d.left=g,d=g):(u=g,d=g)};for(let g=0;g<a.count;++g){const I=a.nextBitIsOne(),D=Math.pow(2,a.count-(g+1));I?f(D,_e.BLACK):(f(D,_e.BLACK),f(D,_e.RED))}return u},r=new q0(n.length),l=s(r);return new xe(o||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Et;class N{static get EMPTY_NODE(){return Et||(Et=new N(new xe(ts),null,un.Default))}constructor(e,t,o){this.children_=e,this.priorityNode_=t,this.indexMap_=o,this.lazyHash_=null,this.priorityNode_&&Jl(this.priorityNode_),this.children_.isEmpty()&&A(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}isLeafNode(){return!1}getPriority(){return this.priorityNode_||Et}updatePriority(e){return this.children_.isEmpty()?this:new N(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const t=this.children_.get(e);return t===null?Et:t}}getChild(e){const t=L(e);return t===null?this:this.getImmediateChild(t).getChild(te(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,t){if(A(t,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(t);{const o=new H(e,t);let i,s;t.isEmpty()?(i=this.children_.remove(e),s=this.indexMap_.removeFromIndexes(o,this.children_)):(i=this.children_.insert(e,t),s=this.indexMap_.addToIndexes(o,this.children_));const r=i.isEmpty()?Et:this.priorityNode_;return new N(i,r,s)}}updateChild(e,t){const o=L(e);if(o===null)return t;{A(L(e)!==".priority"||wn(e)===1,".priority must be the last token in a path");const i=this.getImmediateChild(o).updateChild(te(e),t);return this.updateImmediateChild(o,i)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let o=0,i=0,s=!0;if(this.forEachChild(re,(r,l)=>{t[r]=l.val(e),o++,s&&N.INTEGER_REGEXP_.test(r)?i=Math.max(i,Number(r)):s=!1}),!e&&s&&i<2*o){const r=[];for(const l in t)r[l]=t[l];return r}else return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+ql(this.getPriority().val())+":"),this.forEachChild(re,(t,o)=>{const i=o.hash();i!==""&&(e+=":"+t+":"+i)}),this.lazyHash_=e===""?"":Il(e)}return this.lazyHash_}getPredecessorChildName(e,t,o){const i=this.resolveIndex_(o);if(i){const s=i.getPredecessorKey(new H(e,t));return s?s.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const o=t.minKey();return o&&o.name}else return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new H(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const o=t.maxKey();return o&&o.name}else return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new H(t,this.children_.get(t)):null}forEachChild(e,t){const o=this.resolveIndex_(e);return o?o.inorderTraversal(i=>t(i.name,i.node)):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const o=this.resolveIndex_(t);if(o)return o.getIteratorFrom(e,i=>i);{const i=this.children_.getIteratorFrom(e.name,H.Wrap);let s=i.peek();for(;s!=null&&t.compare(s,e)<0;)i.getNext(),s=i.peek();return i}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const o=this.resolveIndex_(t);if(o)return o.getReverseIteratorFrom(e,i=>i);{const i=this.children_.getReverseIteratorFrom(e.name,H.Wrap);let s=i.peek();for(;s!=null&&t.compare(s,e)>0;)i.getNext(),s=i.peek();return i}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===$t?-1:0}withIndex(e){if(e===zn||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new N(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===zn||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority()))if(this.children_.count()===t.children_.count()){const o=this.getIterator(re),i=t.getIterator(re);let s=o.getNext(),r=i.getNext();for(;s&&r;){if(s.name!==r.name||!s.node.equals(r.node))return!1;s=o.getNext(),r=i.getNext()}return s===null&&r===null}else return!1;else return!1}}resolveIndex_(e){return e===zn?null:this.indexMap_.get(e.toString())}}N.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class J0 extends N{constructor(){super(new xe(ts),N.EMPTY_NODE,un.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return N.EMPTY_NODE}isEmpty(){return!1}}const $t=new J0;Object.defineProperties(H,{MIN:{value:new H(Vn,N.EMPTY_NODE)},MAX:{value:new H(Sn,$t)}});Yl.__EMPTY_NODE=N.EMPTY_NODE;Ae.__childrenNodeConstructor=N;G0($t);Q0($t);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $0=!0;function ve(n,e=null){if(n===null)return N.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),A(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new Ae(t,ve(e))}if(!(n instanceof Array)&&$0){const t=[];let o=!1;if(Be(n,(r,l)=>{if(r.substring(0,1)!=="."){const a=ve(l);a.isEmpty()||(o=o||!a.getPriority().isEmpty(),t.push(new H(r,a)))}}),t.length===0)return N.EMPTY_NODE;const s=_o(t,j0,r=>r.name,ts);if(o){const r=_o(t,re.getCompare());return new N(s,ve(e),new un({".priority":r},{".priority":re}))}else return new N(s,ve(e),un.Default)}else{let t=N.EMPTY_NODE;return Be(n,(o,i)=>{if(dn(n,o)&&o.substring(0,1)!=="."){const s=ve(i);(s.isLeafNode()||!s.isEmpty())&&(t=t.updateImmediateChild(o,s))}}),t.updatePriority(ve(e))}}K0(ve);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class os extends No{constructor(e){super(),this.indexPath_=e,A(!F(e)&&L(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const o=this.extractChild(e.node),i=this.extractChild(t.node),s=o.compareTo(i);return s===0?Xn(e.name,t.name):s}makePost(e,t){const o=ve(e),i=N.EMPTY_NODE.updateChild(this.indexPath_,o);return new H(t,i)}maxPost(){const e=N.EMPTY_NODE.updateChild(this.indexPath_,$t);return new H(Sn,e)}toString(){return zt(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Z0 extends No{compare(e,t){const o=e.node.compareTo(t.node);return o===0?Xn(e.name,t.name):o}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return H.MIN}maxPost(){return H.MAX}makePost(e,t){const o=ve(e);return new H(t,o)}toString(){return".value"}}const ea=new Z0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function na(n){return{type:"value",snapshotNode:n}}function lt(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function Vt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Wt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function e2(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo extends Gl{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(A(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,t,o,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=o,this.appCheckTokenProvider_=i,this.log_=Jt("p:rest:"),this.listens_={}}listen(e,t,o,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=vo.getListenId_(e,o),l={};this.listens_[r]=l;const a=Ur(e._queryParams);this.restRequest_(s+".json",a,(d,u)=>{let h=u;if(d===404&&(h=null,d=null),d===null&&this.onDataUpdate_(s,h,!1,o),rt(this.listens_,r)===l){let f;d?d===401?f="permission_denied":f="rest_error:"+d:f="ok",i(f,null)}})}unlisten(e,t){const o=vo.getListenId_(e,t);delete this.listens_[o]}get(e){const t=Ur(e._queryParams),o=e._path.toString(),i=new Xt;return this.restRequest_(o+".json",t,(s,r)=>{let l=r;s===404&&(l=null,s=null),s===null?(this.onDataUpdate_(o,l,!1,null),i.resolve(l)):i.reject(new Error(l))}),i.promise}refreshAuthToken(e){}restRequest_(e,t={},o){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+wd(t);this.log_("Sending REST request for "+r);const l=new XMLHttpRequest;l.onreadystatechange=()=>{if(o&&l.readyState===4){this.log_("REST Response for "+r+" received. status:",l.status,"response:",l.responseText);let a=null;if(l.status>=200&&l.status<300){try{a=Ot(l.responseText)}catch(d){De("Failed to parse JSON response for "+r+": "+l.responseText)}o(null,a)}else l.status!==401&&l.status!==404&&De("Got unsuccessful REST response for "+r+" Status: "+l.status),o(l.status);o=null}},l.open("GET",r,!0),l.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class i2{constructor(){this.rootNode_=N.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r2{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t={...e};return this.last_&&Be(this.last_,(o,i)=>{t[o]=t[o]-i}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ir=10*1e3,l2=30*1e3,a2=5*60*1e3;class c2{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new r2(e);const o=Ir+(l2-Ir)*Math.random();Dt(this.reportStats_.bind(this),Math.floor(o))}reportStats_(){const e=this.statsListener_.get(),t={};let o=!1;Be(e,(i,s)=>{s>0&&dn(this.statsToReport_,i)&&(t[i]=s,o=!0)}),o&&this.server_.reportStats(t),Dt(this.reportStats_.bind(this),Math.floor(Math.random()*2*a2))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Po{constructor(e,t,o){this.path=e,this.affectedTree=t,this.revert=o,this.type=on.ACK_USER_WRITE,this.source=rs()}operationForChild(e){if(F(this.path)){if(this.affectedTree.value!=null)return A(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Y(e));return new Po(Q(),t,this.revert)}}else return A(L(this.path)===e,"operationForChild called for unrelated child."),new Po(te(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt{constructor(e,t){this.source=e,this.path=t,this.type=on.LISTEN_COMPLETE}operationForChild(e){return F(this.path)?new Gt(this.source,Q()):new Gt(this.source,te(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wn{constructor(e,t,o){this.source=e,this.path=t,this.snap=o,this.type=on.OVERWRITE}operationForChild(e){return F(this.path)?new Wn(this.source,Q(),this.snap.getImmediateChild(e)):new Wn(this.source,te(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class at{constructor(e,t,o){this.source=e,this.path=t,this.children=o,this.type=on.MERGE}operationForChild(e){if(F(this.path)){const t=this.children.subtree(new Y(e));return t.isEmpty()?null:t.value?new Wn(this.source,Q(),t.value):new at(this.source,Q(),t)}else return A(L(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new at(this.source,te(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class d2{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function h2(n,e,t,o){const i=[],s=[];return e.forEach(r=>{r.type==="child_changed"&&n.index_.indexedValueChanged(r.oldSnap,r.snapshotNode)&&s.push(e2(r.childName,r.snapshotNode))}),It(n,i,"child_removed",e,o,t),It(n,i,"child_added",e,o,t),It(n,i,"child_moved",s,o,t),It(n,i,"child_changed",e,o,t),It(n,i,"value",e,o,t),i}function It(n,e,t,o,i,s){const r=o.filter(l=>l.type===t);r.sort((l,a)=>p2(n,l,a)),r.forEach(l=>{const a=u2(n,l,s);i.forEach(d=>{d.respondsTo(l.type)&&e.push(d.createEvent(a,n.query_))})})}function u2(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function p2(n,e,t){if(e.childName==null||t.childName==null)throw pt("Should only compare child_ events.");const o=new H(e.childName,e.snapshotNode),i=new H(t.childName,t.snapshotNode);return n.index_.compare(o,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mo(n,e){return{eventCache:n,serverCache:e}}function Tt(n,e,t,o){return Mo(new jn(e,t,o),n.serverCache)}function oa(n,e,t,o){return Mo(n.eventCache,new jn(e,t,o))}function Ui(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Gn(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ai;const m2=()=>(ai||(ai=new xe(Z1)),ai);class ee{static fromObject(e){let t=new ee(null);return Be(e,(o,i)=>{t=t.set(new Y(o),i)}),t}constructor(e,t=m2()){this.value=e,this.children=t}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(this.value!=null&&t(this.value))return{path:Q(),value:this.value};if(F(e))return null;{const o=L(e),i=this.children.get(o);if(i!==null){const s=i.findRootMostMatchingPathAndValue(te(e),t);return s!=null?{path:ae(new Y(o),s.path),value:s.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(F(e))return this;{const t=L(e),o=this.children.get(t);return o!==null?o.subtree(te(e)):new ee(null)}}set(e,t){if(F(e))return new ee(t,this.children);{const o=L(e),s=(this.children.get(o)||new ee(null)).set(te(e),t),r=this.children.insert(o,s);return new ee(this.value,r)}}remove(e){if(F(e))return this.children.isEmpty()?new ee(null):new ee(null,this.children);{const t=L(e),o=this.children.get(t);if(o){const i=o.remove(te(e));let s;return i.isEmpty()?s=this.children.remove(t):s=this.children.insert(t,i),this.value===null&&s.isEmpty()?new ee(null):new ee(this.value,s)}else return this}}get(e){if(F(e))return this.value;{const t=L(e),o=this.children.get(t);return o?o.get(te(e)):null}}setTree(e,t){if(F(e))return t;{const o=L(e),s=(this.children.get(o)||new ee(null)).setTree(te(e),t);let r;return s.isEmpty()?r=this.children.remove(o):r=this.children.insert(o,s),new ee(this.value,r)}}fold(e){return this.fold_(Q(),e)}fold_(e,t){const o={};return this.children.inorderTraversal((i,s)=>{o[i]=s.fold_(ae(e,i),t)}),t(e,this.value,o)}findOnPath(e,t){return this.findOnPath_(e,Q(),t)}findOnPath_(e,t,o){const i=this.value?o(t,this.value):!1;if(i)return i;if(F(e))return null;{const s=L(e),r=this.children.get(s);return r?r.findOnPath_(te(e),ae(t,s),o):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,Q(),t)}foreachOnPath_(e,t,o){if(F(e))return this;{this.value&&o(t,this.value);const i=L(e),s=this.children.get(i);return s?s.foreachOnPath_(te(e),ae(t,i),o):new ee(null)}}foreach(e){this.foreach_(Q(),e)}foreach_(e,t){this.children.inorderTraversal((o,i)=>{i.foreach_(ae(e,o),t)}),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal((t,o)=>{o.value&&e(t,o.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sn{constructor(e){this.writeTree_=e}static empty(){return new sn(new ee(null))}}function Nt(n,e,t){if(F(e))return new sn(new ee(t));{const o=n.writeTree_.findRootMostValueAndPath(e);if(o!=null){const i=o.path;let s=o.value;const r=Re(i,e);return s=s.updateChild(r,t),new sn(n.writeTree_.set(i,s))}else{const i=new ee(t),s=n.writeTree_.setTree(e,i);return new sn(s)}}}function Ei(n,e,t){let o=n;return Be(t,(i,s)=>{o=Nt(o,ae(e,i),s)}),o}function Br(n,e){if(F(e))return sn.empty();{const t=n.writeTree_.setTree(e,new ee(null));return new sn(t)}}function Ii(n,e){return Yn(n,e)!=null}function Yn(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(Re(t.path,e)):null}function Sr(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(re,(o,i)=>{e.push(new H(o,i))}):n.writeTree_.children.inorderTraversal((o,i)=>{i.value!=null&&e.push(new H(o,i.value))}),e}function Bn(n,e){if(F(e))return n;{const t=Yn(n,e);return t!=null?new sn(new ee(t)):new sn(n.writeTree_.subtree(e))}}function Bi(n){return n.writeTree_.isEmpty()}function ct(n,e){return ia(Q(),n.writeTree_,e)}function ia(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let o=null;return e.children.inorderTraversal((i,s)=>{i===".priority"?(A(s.value!==null,"Priority writes must always be leaf nodes"),o=s.value):t=ia(ae(n,i),s,t)}),!t.getChild(n).isEmpty()&&o!==null&&(t=t.updateChild(ae(n,".priority"),o)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cs(n,e){return aa(e,n)}function f2(n,e,t,o,i){A(o>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:o,visible:i}),i&&(n.visibleWrites=Nt(n.visibleWrites,e,t)),n.lastWriteId=o}function y2(n,e,t,o){A(o>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:o,visible:!0}),n.visibleWrites=Ei(n.visibleWrites,e,t),n.lastWriteId=o}function b2(n,e){for(let t=0;t<n.allWrites.length;t++){const o=n.allWrites[t];if(o.writeId===e)return o}return null}function g2(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);A(t>=0,"removeWrite called with nonexistent writeId.");const o=n.allWrites[t];n.allWrites.splice(t,1);let i=o.visible,s=!1,r=n.allWrites.length-1;for(;i&&r>=0;){const l=n.allWrites[r];l.visible&&(r>=t&&A2(l,o.path)?i=!1:Qe(o.path,l.path)&&(s=!0)),r--}if(i){if(s)return _2(n),!0;if(o.snap)n.visibleWrites=Br(n.visibleWrites,o.path);else{const l=o.children;Be(l,a=>{n.visibleWrites=Br(n.visibleWrites,ae(o.path,a))})}return!0}else return!1}function A2(n,e){if(n.snap)return Qe(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Qe(ae(n.path,t),e))return!0;return!1}function _2(n){n.visibleWrites=sa(n.allWrites,v2,Q()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function v2(n){return n.visible}function sa(n,e,t){let o=sn.empty();for(let i=0;i<n.length;++i){const s=n[i];if(e(s)){const r=s.path;let l;if(s.snap)Qe(t,r)?(l=Re(t,r),o=Nt(o,l,s.snap)):Qe(r,t)&&(l=Re(r,t),o=Nt(o,Q(),s.snap.getChild(l)));else if(s.children){if(Qe(t,r))l=Re(t,r),o=Ei(o,l,s.children);else if(Qe(r,t))if(l=Re(r,t),F(l))o=Ei(o,Q(),s.children);else{const a=rt(s.children,L(l));if(a){const d=a.getChild(te(l));o=Nt(o,Q(),d)}}}else throw pt("WriteRecord should have .snap or .children")}}return o}function ra(n,e,t,o,i){if(!o&&!i){const s=Yn(n.visibleWrites,e);if(s!=null)return s;{const r=Bn(n.visibleWrites,e);if(Bi(r))return t;if(t==null&&!Ii(r,Q()))return null;{const l=t||N.EMPTY_NODE;return ct(r,l)}}}else{const s=Bn(n.visibleWrites,e);if(!i&&Bi(s))return t;if(!i&&t==null&&!Ii(s,Q()))return null;{const r=function(d){return(d.visible||i)&&(!o||!~o.indexOf(d.writeId))&&(Qe(d.path,e)||Qe(e,d.path))},l=sa(n.allWrites,r,e),a=t||N.EMPTY_NODE;return ct(l,a)}}}function C2(n,e,t){let o=N.EMPTY_NODE;const i=Yn(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(re,(s,r)=>{o=o.updateImmediateChild(s,r)}),o;if(t){const s=Bn(n.visibleWrites,e);return t.forEachChild(re,(r,l)=>{const a=ct(Bn(s,new Y(r)),l);o=o.updateImmediateChild(r,a)}),Sr(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}else{const s=Bn(n.visibleWrites,e);return Sr(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}}function P2(n,e,t,o,i){A(o||i,"Either existingEventSnap or existingServerSnap must exist");const s=ae(e,t);if(Ii(n.visibleWrites,s))return null;{const r=Bn(n.visibleWrites,s);return Bi(r)?i.getChild(t):ct(r,i.getChild(t))}}function U2(n,e,t,o){const i=ae(e,t),s=Yn(n.visibleWrites,i);if(s!=null)return s;if(o.isCompleteForChild(t)){const r=Bn(n.visibleWrites,i);return ct(r,o.getNode().getImmediateChild(t))}else return null}function E2(n,e){return Yn(n.visibleWrites,e)}function I2(n,e,t,o,i,s,r){let l;const a=Bn(n.visibleWrites,e),d=Yn(a,Q());if(d!=null)l=d;else if(t!=null)l=ct(a,t);else return[];if(l=l.withIndex(r),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=r.getCompare(),f=s?l.getReverseIteratorFrom(o,r):l.getIteratorFrom(o,r);let b=f.getNext();for(;b&&u.length<i;)h(b,o)!==0&&u.push(b),b=f.getNext();return u}else return[]}function B2(){return{visibleWrites:sn.empty(),allWrites:[],lastWriteId:-1}}function Uo(n,e,t,o){return ra(n.writeTree,n.treePath,e,t,o)}function ds(n,e){return C2(n.writeTree,n.treePath,e)}function wr(n,e,t,o){return P2(n.writeTree,n.treePath,e,t,o)}function Eo(n,e){return E2(n.writeTree,ae(n.treePath,e))}function S2(n,e,t,o,i,s){return I2(n.writeTree,n.treePath,e,t,o,i,s)}function hs(n,e,t){return U2(n.writeTree,n.treePath,e,t)}function la(n,e){return aa(ae(n.treePath,e),n.writeTree)}function aa(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class w2{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,o=e.childName;A(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),A(o!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(o);if(i){const s=i.type;if(t==="child_added"&&s==="child_removed")this.changeMap.set(o,Wt(o,e.snapshotNode,i.snapshotNode));else if(t==="child_removed"&&s==="child_added")this.changeMap.delete(o);else if(t==="child_removed"&&s==="child_changed")this.changeMap.set(o,Vt(o,i.oldSnap));else if(t==="child_changed"&&s==="child_added")this.changeMap.set(o,lt(o,e.snapshotNode));else if(t==="child_changed"&&s==="child_changed")this.changeMap.set(o,Wt(o,e.snapshotNode,i.oldSnap));else throw pt("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(o,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class k2{getCompleteChild(e){return null}getChildAfterChild(e,t,o){return null}}const ca=new k2;class us{constructor(e,t,o=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=o}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const o=this.optCompleteServerCache_!=null?new jn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return hs(this.writes_,e,o)}}getChildAfterChild(e,t,o){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Gn(this.viewCache_),s=S2(this.writes_,i,t,1,o,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function D2(n){return{filter:n}}function T2(n,e){A(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),A(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function N2(n,e,t,o,i){const s=new w2;let r,l;if(t.type===on.OVERWRITE){const d=t;d.source.fromUser?r=Si(n,e,d.path,d.snap,o,i,s):(A(d.source.fromServer,"Unknown source."),l=d.source.tagged||e.serverCache.isFiltered()&&!F(d.path),r=Io(n,e,d.path,d.snap,o,i,l,s))}else if(t.type===on.MERGE){const d=t;d.source.fromUser?r=R2(n,e,d.path,d.children,o,i,s):(A(d.source.fromServer,"Unknown source."),l=d.source.tagged||e.serverCache.isFiltered(),r=wi(n,e,d.path,d.children,o,i,l,s))}else if(t.type===on.ACK_USER_WRITE){const d=t;d.revert?r=L2(n,e,d.path,o,i,s):r=x2(n,e,d.path,d.affectedTree,o,i,s)}else if(t.type===on.LISTEN_COMPLETE)r=O2(n,e,t.path,o,s);else throw pt("Unknown operation type: "+t.type);const a=s.getChanges();return M2(e,r,a),{viewCache:r,changes:a}}function M2(n,e,t){const o=e.eventCache;if(o.isFullyInitialized()){const i=o.getNode().isLeafNode()||o.getNode().isEmpty(),s=Ui(n);(t.length>0||!n.eventCache.isFullyInitialized()||i&&!o.getNode().equals(s)||!o.getNode().getPriority().equals(s.getPriority()))&&t.push(na(Ui(e)))}}function da(n,e,t,o,i,s){const r=e.eventCache;if(Eo(o,t)!=null)return e;{let l,a;if(F(t))if(A(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const d=Gn(e),u=d instanceof N?d:N.EMPTY_NODE,h=ds(o,u);l=n.filter.updateFullNode(e.eventCache.getNode(),h,s)}else{const d=Uo(o,Gn(e));l=n.filter.updateFullNode(e.eventCache.getNode(),d,s)}else{const d=L(t);if(d===".priority"){A(wn(t)===1,"Can't have a priority with additional path components");const u=r.getNode();a=e.serverCache.getNode();const h=wr(o,t,u,a);h!=null?l=n.filter.updatePriority(u,h):l=r.getNode()}else{const u=te(t);let h;if(r.isCompleteForChild(d)){a=e.serverCache.getNode();const f=wr(o,t,r.getNode(),a);f!=null?h=r.getNode().getImmediateChild(d).updateChild(u,f):h=r.getNode().getImmediateChild(d)}else h=hs(o,d,e.serverCache);h!=null?l=n.filter.updateChild(r.getNode(),d,h,u,i,s):l=r.getNode()}}return Tt(e,l,r.isFullyInitialized()||F(t),n.filter.filtersNodes())}}function Io(n,e,t,o,i,s,r,l){const a=e.serverCache;let d;const u=r?n.filter:n.filter.getIndexedFilter();if(F(t))d=u.updateFullNode(a.getNode(),o,null);else if(u.filtersNodes()&&!a.isFiltered()){const b=a.getNode().updateChild(t,o);d=u.updateFullNode(a.getNode(),b,null)}else{const b=L(t);if(!a.isCompleteForPath(t)&&wn(t)>1)return e;const g=te(t),D=a.getNode().getImmediateChild(b).updateChild(g,o);b===".priority"?d=u.updatePriority(a.getNode(),D):d=u.updateChild(a.getNode(),b,D,g,ca,null)}const h=oa(e,d,a.isFullyInitialized()||F(t),u.filtersNodes()),f=new us(i,h,s);return da(n,h,t,i,f,l)}function Si(n,e,t,o,i,s,r){const l=e.eventCache;let a,d;const u=new us(i,e,s);if(F(t))d=n.filter.updateFullNode(e.eventCache.getNode(),o,r),a=Tt(e,d,!0,n.filter.filtersNodes());else{const h=L(t);if(h===".priority")d=n.filter.updatePriority(e.eventCache.getNode(),o),a=Tt(e,d,l.isFullyInitialized(),l.isFiltered());else{const f=te(t),b=l.getNode().getImmediateChild(h);let g;if(F(f))g=o;else{const I=u.getCompleteChild(h);I!=null?Zi(f)===".priority"&&I.getChild(Ql(f)).isEmpty()?g=I:g=I.updateChild(f,o):g=N.EMPTY_NODE}if(b.equals(g))a=e;else{const I=n.filter.updateChild(l.getNode(),h,g,f,u,r);a=Tt(e,I,l.isFullyInitialized(),n.filter.filtersNodes())}}}return a}function kr(n,e){return n.eventCache.isCompleteForChild(e)}function R2(n,e,t,o,i,s,r){let l=e;return o.foreach((a,d)=>{const u=ae(t,a);kr(e,L(u))&&(l=Si(n,l,u,d,i,s,r))}),o.foreach((a,d)=>{const u=ae(t,a);kr(e,L(u))||(l=Si(n,l,u,d,i,s,r))}),l}function Dr(n,e,t){return t.foreach((o,i)=>{e=e.updateChild(o,i)}),e}function wi(n,e,t,o,i,s,r,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let a=e,d;F(t)?d=o:d=new ee(null).setTree(t,o);const u=e.serverCache.getNode();return d.children.inorderTraversal((h,f)=>{if(u.hasChild(h)){const b=e.serverCache.getNode().getImmediateChild(h),g=Dr(n,b,f);a=Io(n,a,new Y(h),g,i,s,r,l)}}),d.children.inorderTraversal((h,f)=>{const b=!e.serverCache.isCompleteForChild(h)&&f.value===null;if(!u.hasChild(h)&&!b){const g=e.serverCache.getNode().getImmediateChild(h),I=Dr(n,g,f);a=Io(n,a,new Y(h),I,i,s,r,l)}}),a}function x2(n,e,t,o,i,s,r){if(Eo(i,t)!=null)return e;const l=e.serverCache.isFiltered(),a=e.serverCache;if(o.value!=null){if(F(t)&&a.isFullyInitialized()||a.isCompleteForPath(t))return Io(n,e,t,a.getNode().getChild(t),i,s,l,r);if(F(t)){let d=new ee(null);return a.getNode().forEachChild(zn,(u,h)=>{d=d.set(new Y(u),h)}),wi(n,e,t,d,i,s,l,r)}else return e}else{let d=new ee(null);return o.foreach((u,h)=>{const f=ae(t,u);a.isCompleteForPath(f)&&(d=d.set(u,a.getNode().getChild(f)))}),wi(n,e,t,d,i,s,l,r)}}function O2(n,e,t,o,i){const s=e.serverCache,r=oa(e,s.getNode(),s.isFullyInitialized()||F(t),s.isFiltered());return da(n,r,t,o,ca,i)}function L2(n,e,t,o,i,s){let r;if(Eo(o,t)!=null)return e;{const l=new us(o,e,i),a=e.eventCache.getNode();let d;if(F(t)||L(t)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Uo(o,Gn(e));else{const h=e.serverCache.getNode();A(h instanceof N,"serverChildren would be complete if leaf node"),u=ds(o,h)}u=u,d=n.filter.updateFullNode(a,u,s)}else{const u=L(t);let h=hs(o,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=a.getImmediateChild(u)),h!=null?d=n.filter.updateChild(a,u,h,te(t),l,s):e.eventCache.getNode().hasChild(u)?d=n.filter.updateChild(a,u,N.EMPTY_NODE,te(t),l,s):d=a,d.isEmpty()&&e.serverCache.isFullyInitialized()&&(r=Uo(o,Gn(e)),r.isLeafNode()&&(d=n.filter.updateFullNode(d,r,s)))}return r=e.serverCache.isFullyInitialized()||Eo(o,Q())!=null,Tt(e,d,r,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class F2{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const o=this.query_._queryParams,i=new is(o.getIndex()),s=t2(o);this.processor_=D2(s);const r=t.serverCache,l=t.eventCache,a=i.updateFullNode(N.EMPTY_NODE,r.getNode(),null),d=s.updateFullNode(N.EMPTY_NODE,l.getNode(),null),u=new jn(a,r.isFullyInitialized(),i.filtersNodes()),h=new jn(d,l.isFullyInitialized(),s.filtersNodes());this.viewCache_=Mo(h,u),this.eventGenerator_=new d2(this.query_)}get query(){return this.query_}}function H2(n){return n.viewCache_.serverCache.getNode()}function z2(n,e){const t=Gn(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!F(e)&&!t.getImmediateChild(L(e)).isEmpty())?t.getChild(e):null}function Tr(n){return n.eventRegistrations_.length===0}function V2(n,e){n.eventRegistrations_.push(e)}function Nr(n,e,t){const o=[];if(t){A(e==null,"A cancel should cancel all event registrations.");const i=n.query._path;n.eventRegistrations_.forEach(s=>{const r=s.createCancelEvent(t,i);r&&o.push(r)})}if(e){let i=[];for(let s=0;s<n.eventRegistrations_.length;++s){const r=n.eventRegistrations_[s];if(!r.matches(e))i.push(r);else if(e.hasAnyCallback()){i=i.concat(n.eventRegistrations_.slice(s+1));break}}n.eventRegistrations_=i}else n.eventRegistrations_=[];return o}function Mr(n,e,t,o){e.type===on.MERGE&&e.source.queryId!==null&&(A(Gn(n.viewCache_),"We should always have a full cache before handling merges"),A(Ui(n.viewCache_),"Missing event cache, even though we have a server cache"));const i=n.viewCache_,s=N2(n.processor_,i,e,t,o);return T2(n.processor_,s.viewCache),A(s.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=s.viewCache,ha(n,s.changes,s.viewCache.eventCache.getNode(),null)}function W2(n,e){const t=n.viewCache_.eventCache,o=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(re,(s,r)=>{o.push(lt(s,r))}),t.isFullyInitialized()&&o.push(na(t.getNode())),ha(n,o,t.getNode(),e)}function ha(n,e,t,o){const i=o?[o]:n.eventRegistrations_;return h2(n.eventGenerator_,e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Bo;class j2{constructor(){this.views=new Map}}function G2(n){A(!Bo,"__referenceConstructor has already been defined"),Bo=n}function K2(){return A(Bo,"Reference.ts has not been loaded"),Bo}function Q2(n){return n.views.size===0}function ps(n,e,t,o){const i=e.source.queryId;if(i!==null){const s=n.views.get(i);return A(s!=null,"SyncTree gave us an op for an invalid query."),Mr(s,e,t,o)}else{let s=[];for(const r of n.views.values())s=s.concat(Mr(r,e,t,o));return s}}function X2(n,e,t,o,i){const s=e._queryIdentifier,r=n.views.get(s);if(!r){let l=Uo(t,i?o:null),a=!1;l?a=!0:o instanceof N?(l=ds(t,o),a=!1):(l=N.EMPTY_NODE,a=!1);const d=Mo(new jn(l,a,!1),new jn(o,i,!1));return new F2(e,d)}return r}function Y2(n,e,t,o,i,s){const r=X2(n,e,o,i,s);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,r),V2(r,t),W2(r,t)}function q2(n,e,t,o){const i=e._queryIdentifier,s=[];let r=[];const l=kn(n);if(i==="default")for(const[a,d]of n.views.entries())r=r.concat(Nr(d,t,o)),Tr(d)&&(n.views.delete(a),d.query._queryParams.loadsAllData()||s.push(d.query));else{const a=n.views.get(i);a&&(r=r.concat(Nr(a,t,o)),Tr(a)&&(n.views.delete(i),a.query._queryParams.loadsAllData()||s.push(a.query)))}return l&&!kn(n)&&s.push(new(K2())(e._repo,e._path)),{removed:s,events:r}}function ua(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function st(n,e){let t=null;for(const o of n.views.values())t=t||z2(o,e);return t}function pa(n,e){if(e._queryParams.loadsAllData())return Ro(n);{const o=e._queryIdentifier;return n.views.get(o)}}function ma(n,e){return pa(n,e)!=null}function kn(n){return Ro(n)!=null}function Ro(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let So;function J2(n){A(!So,"__referenceConstructor has already been defined"),So=n}function $2(){return A(So,"Reference.ts has not been loaded"),So}let Z2=1;class Rr{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ee(null),this.pendingWriteTree_=B2(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function fa(n,e,t,o,i){return f2(n.pendingWriteTree_,e,t,o,i),i?ft(n,new Wn(rs(),e,t)):[]}function eh(n,e,t,o){y2(n.pendingWriteTree_,e,t,o);const i=ee.fromObject(t);return ft(n,new at(rs(),e,i))}function Un(n,e,t=!1){const o=b2(n.pendingWriteTree_,e);if(g2(n.pendingWriteTree_,e)){let s=new ee(null);return o.snap!=null?s=s.set(Q(),!0):Be(o.children,r=>{s=s.set(new Y(r),!0)}),ft(n,new Po(o.path,s,t))}else return[]}function xo(n,e,t){return ft(n,new Wn(ls(),e,t))}function nh(n,e,t){const o=ee.fromObject(t);return ft(n,new at(ls(),e,o))}function th(n,e){return ft(n,new Gt(ls(),e))}function oh(n,e,t){const o=fs(n,t);if(o){const i=ys(o),s=i.path,r=i.queryId,l=Re(s,e),a=new Gt(as(r),l);return bs(n,s,a)}else return[]}function ki(n,e,t,o,i=!1){const s=e._path,r=n.syncPointTree_.get(s);let l=[];if(r&&(e._queryIdentifier==="default"||ma(r,e))){const a=q2(r,e,t,o);Q2(r)&&(n.syncPointTree_=n.syncPointTree_.remove(s));const d=a.removed;if(l=a.events,!i){const u=d.findIndex(f=>f._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(s,(f,b)=>kn(b));if(u&&!h){const f=n.syncPointTree_.subtree(s);if(!f.isEmpty()){const b=rh(f);for(let g=0;g<b.length;++g){const I=b[g],D=I.query,U=ga(n,I);n.listenProvider_.startListening(Mt(D),wo(n,D),U.hashFn,U.onComplete)}}}!h&&d.length>0&&!o&&(u?n.listenProvider_.stopListening(Mt(e),null):d.forEach(f=>{const b=n.queryToTagMap.get(Oo(f));n.listenProvider_.stopListening(Mt(f),b)}))}lh(n,d)}return l}function ih(n,e,t,o){const i=fs(n,o);if(i!=null){const s=ys(i),r=s.path,l=s.queryId,a=Re(r,e),d=new Wn(as(l),a,t);return bs(n,r,d)}else return[]}function sh(n,e,t,o){const i=fs(n,o);if(i){const s=ys(i),r=s.path,l=s.queryId,a=Re(r,e),d=ee.fromObject(t),u=new at(as(l),a,d);return bs(n,r,u)}else return[]}function xr(n,e,t,o=!1){const i=e._path;let s=null,r=!1;n.syncPointTree_.foreachOnPath(i,(f,b)=>{const g=Re(f,i);s=s||st(b,g),r=r||kn(b)});let l=n.syncPointTree_.get(i);l?(r=r||kn(l),s=s||st(l,Q())):(l=new j2,n.syncPointTree_=n.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=N.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((b,g)=>{const I=st(g,Q());I&&(s=s.updateImmediateChild(b,I))}));const d=ma(l,e);if(!d&&!e._queryParams.loadsAllData()){const f=Oo(e);A(!n.queryToTagMap.has(f),"View does not exist, but we have a tag");const b=ah();n.queryToTagMap.set(f,b),n.tagToQueryMap.set(b,f)}const u=cs(n.pendingWriteTree_,i);let h=Y2(l,e,t,u,s,a);if(!d&&!r&&!o){const f=pa(l,e);h=h.concat(ch(n,e,f))}return h}function ms(n,e,t){const i=n.pendingWriteTree_,s=n.syncPointTree_.findOnPath(e,(r,l)=>{const a=Re(r,e),d=st(l,a);if(d)return d});return ra(i,e,s,t,!0)}function ft(n,e){return ya(e,n.syncPointTree_,null,cs(n.pendingWriteTree_,Q()))}function ya(n,e,t,o){if(F(n.path))return ba(n,e,t,o);{const i=e.get(Q());t==null&&i!=null&&(t=st(i,Q()));let s=[];const r=L(n.path),l=n.operationForChild(r),a=e.children.get(r);if(a&&l){const d=t?t.getImmediateChild(r):null,u=la(o,r);s=s.concat(ya(l,a,d,u))}return i&&(s=s.concat(ps(i,n,o,t))),s}}function ba(n,e,t,o){const i=e.get(Q());t==null&&i!=null&&(t=st(i,Q()));let s=[];return e.children.inorderTraversal((r,l)=>{const a=t?t.getImmediateChild(r):null,d=la(o,r),u=n.operationForChild(r);u&&(s=s.concat(ba(u,l,a,d)))}),i&&(s=s.concat(ps(i,n,o,t))),s}function ga(n,e){const t=e.query,o=wo(n,t);return{hashFn:()=>(H2(e)||N.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return o?oh(n,t._path,o):th(n,t._path);{const s=t0(i,t);return ki(n,t,null,s)}}}}function wo(n,e){const t=Oo(e);return n.queryToTagMap.get(t)}function Oo(n){return n._path.toString()+"$"+n._queryIdentifier}function fs(n,e){return n.tagToQueryMap.get(e)}function ys(n){const e=n.indexOf("$");return A(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new Y(n.substr(0,e))}}function bs(n,e,t){const o=n.syncPointTree_.get(e);A(o,"Missing sync point for query tag that we're tracking");const i=cs(n.pendingWriteTree_,e);return ps(o,t,i,null)}function rh(n){return n.fold((e,t,o)=>{if(t&&kn(t))return[Ro(t)];{let i=[];return t&&(i=ua(t)),Be(o,(s,r)=>{i=i.concat(r)}),i}})}function Mt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new($2())(n._repo,n._path):n}function lh(n,e){for(let t=0;t<e.length;++t){const o=e[t];if(!o._queryParams.loadsAllData()){const i=Oo(o),s=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(s)}}}function ah(){return Z2++}function ch(n,e,t){const o=e._path,i=wo(n,e),s=ga(n,t),r=n.listenProvider_.startListening(Mt(e),i,s.hashFn,s.onComplete),l=n.syncPointTree_.subtree(o);if(i)A(!kn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((d,u,h)=>{if(!F(d)&&u&&kn(u))return[Ro(u).query];{let f=[];return u&&(f=f.concat(ua(u).map(b=>b.query))),Be(h,(b,g)=>{f=f.concat(g)}),f}});for(let d=0;d<a.length;++d){const u=a[d];n.listenProvider_.stopListening(Mt(u),wo(n,u))}}return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yh=/[\[\].#$\/\u0000-\u001F\u007F]/,bh=/[\[\].#$\u0000-\u001F\u007F]/,ci=10*1024*1024,Ps=function(n){return typeof n=="string"&&n.length!==0&&!yh.test(n)},Ua=function(n){return typeof n=="string"&&n.length!==0&&!bh.test(n)},gh=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Ua(n)},Ti=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Xi(n)||n&&typeof n=="object"&&dn(n,".sv")},Ea=function(n,e,t,o){o&&e===void 0||Fo(Do(n,"value"),e,t)},Fo=function(n,e,t){const o=t instanceof Y?new x0(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+Ln(o));if(typeof e=="function")throw new Error(n+"contains a function "+Ln(o)+" with contents = "+e.toString());if(Xi(e))throw new Error(n+"contains "+e.toString()+" "+Ln(o));if(typeof e=="string"&&e.length>ci/3&&To(e)>ci)throw new Error(n+"contains a string greater than "+ci+" utf8 bytes "+Ln(o)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,s=!1;if(Be(e,(r,l)=>{if(r===".value")i=!0;else if(r!==".priority"&&r!==".sv"&&(s=!0,!Ps(r)))throw new Error(n+" contains an invalid key ("+r+") "+Ln(o)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);O0(o,r),Fo(n,l,o),L0(o)}),i&&s)throw new Error(n+' contains ".value" child '+Ln(o)+" in addition to actual children.")}},Ah=function(n,e){let t,o;for(t=0;t<e.length;t++){o=e[t];const s=zt(o);for(let r=0;r<s.length;r++)if(!(s[r]===".priority"&&r===s.length-1)){if(!Ps(s[r]))throw new Error(n+"contains an invalid key ("+s[r]+") in path "+o.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(R0);let i=null;for(t=0;t<e.length;t++){if(o=e[t],i!==null&&Qe(i,o))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+o.toString());i=o}},_h=function(n,e,t,o){const i=Do(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const s=[];Be(e,(r,l)=>{const a=new Y(r);if(Fo(i,l,ae(t,a)),Zi(a)===".priority"&&!Ti(l))throw new Error(i+"contains an invalid value for '"+a.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");s.push(a)}),Ah(i,s)},Us=function(n,e,t,o){if(!Ua(t))throw new Error(Do(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},vh=function(n,e,t,o){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Us(n,e,t)},Es=function(n,e){if(L(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},Ch=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Ps(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!gh(t))throw new Error(Do(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ph{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Ho(n,e){let t=null;for(let o=0;o<e.length;o++){const i=e[o],s=i.getPath();t!==null&&!es(s,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:s}),t.events.push(i)}t&&n.eventLists_.push(t)}function Ia(n,e,t){Ho(n,t),Ba(n,o=>es(o,e))}function rn(n,e,t){Ho(n,t),Ba(n,o=>Qe(o,e)||Qe(e,o))}function Ba(n,e){n.recursionDepth_++;let t=!0;for(let o=0;o<n.eventLists_.length;o++){const i=n.eventLists_[o];if(i){const s=i.path;e(s)?(Uh(n.eventLists_[o]),n.eventLists_[o]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Uh(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const o=t.getEventRunner();kt&&Ie("event: "+t.toString()),mt(o)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eh="repo_interrupt",Ih=25;class Bh{constructor(e,t,o,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=o,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Ph,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Co(),this.transactionQueueTree_=new vs,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Sh(n,e,t){if(n.stats_=Ji(n.repoInfo_),n.forceRestClient_||r0())n.server_=new vo(n.repoInfo_,(o,i,s,r)=>{Lr(n,o,i,s,r)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Fr(n,!0),0);else{if(typeof t!="undefined"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ce(t)}catch(o){throw new Error("Invalid authOverride provided: "+o)}}n.persistentConnection_=new pn(n.repoInfo_,e,(o,i,s,r)=>{Lr(n,o,i,s,r)},o=>{Fr(n,o)},o=>{wh(n,o)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(o=>{n.server_.refreshAuthToken(o)}),n.appCheckProvider_.addTokenChangeListener(o=>{n.server_.refreshAppCheckToken(o.token)}),n.statsReporter_=h0(n.repoInfo_,()=>new c2(n.stats_,n.server_)),n.infoData_=new i2,n.infoSyncTree_=new Rr({startListening:(o,i,s,r)=>{let l=[];const a=n.infoData_.getNode(o._path);return a.isEmpty()||(l=xo(n.infoSyncTree_,o._path,a),setTimeout(()=>{r("ok")},0)),l},stopListening:()=>{}}),Is(n,"connected",!1),n.serverSyncTree_=new Rr({startListening:(o,i,s,r)=>(n.server_.listen(o,s,i,(l,a)=>{const d=r(l,a);rn(n.eventQueue_,o._path,d)}),[]),stopListening:(o,i)=>{n.server_.unlisten(o,i)}})}function Sa(n){const t=n.infoData_.getNode(new Y(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function zo(n){return dh({timestamp:Sa(n)})}function Lr(n,e,t,o,i){n.dataUpdateCount++;const s=new Y(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let r=[];if(i)if(o){const a=mo(t,d=>ve(d));r=sh(n.serverSyncTree_,s,a,i)}else{const a=ve(t);r=ih(n.serverSyncTree_,s,a,i)}else if(o){const a=mo(t,d=>ve(d));r=nh(n.serverSyncTree_,s,a)}else{const a=ve(t);r=xo(n.serverSyncTree_,s,a)}let l=s;r.length>0&&(l=dt(n,s)),rn(n.eventQueue_,l,r)}function Fr(n,e){Is(n,"connected",e),e===!1&&Th(n)}function wh(n,e){Be(e,(t,o)=>{Is(n,t,o)})}function Is(n,e,t){const o=new Y("/.info/"+e),i=ve(t);n.infoData_.updateSnapshot(o,i);const s=xo(n.infoSyncTree_,o,i);rn(n.eventQueue_,o,s)}function Bs(n){return n.nextWriteId_++}function kh(n,e,t,o,i){Vo(n,"set",{path:e.toString(),value:t,priority:o});const s=zo(n),r=ve(t,o),l=ms(n.serverSyncTree_,e),a=_a(r,l,s),d=Bs(n),u=fa(n.serverSyncTree_,e,a,d,!0);Ho(n.eventQueue_,u),n.server_.put(e.toString(),r.val(!0),(f,b)=>{const g=f==="ok";g||De("set at "+e+" failed: "+f);const I=Un(n.serverSyncTree_,d,!g);rn(n.eventQueue_,e,I),Mi(n,i,f,b)});const h=ws(n,e);dt(n,h),rn(n.eventQueue_,h,[])}function Dh(n,e,t,o){Vo(n,"update",{path:e.toString(),value:t});let i=!0;const s=zo(n),r={};if(Be(t,(l,a)=>{i=!1,r[l]=Aa(ae(e,l),ve(a),n.serverSyncTree_,s)}),i)Ie("update() called with empty data.  Don't do anything."),Mi(n,o,"ok",void 0);else{const l=Bs(n),a=eh(n.serverSyncTree_,e,r,l);Ho(n.eventQueue_,a),n.server_.merge(e.toString(),t,(d,u)=>{const h=d==="ok";h||De("update at "+e+" failed: "+d);const f=Un(n.serverSyncTree_,l,!h),b=f.length>0?dt(n,e):e;rn(n.eventQueue_,b,f),Mi(n,o,d,u)}),Be(t,d=>{const u=ws(n,ae(e,d));dt(n,u)}),rn(n.eventQueue_,e,[])}}function Th(n){Vo(n,"onDisconnectEvents");const e=zo(n),t=Co();Pi(n.onDisconnect_,Q(),(i,s)=>{const r=Aa(i,s,n.serverSyncTree_,e);ta(t,i,r)});let o=[];Pi(t,Q(),(i,s)=>{o=o.concat(xo(n.serverSyncTree_,i,s));const r=ws(n,i);dt(n,r)}),n.onDisconnect_=Co(),rn(n.eventQueue_,Q(),o)}function Nh(n,e,t){let o;L(e._path)===".info"?o=xr(n.infoSyncTree_,e,t):o=xr(n.serverSyncTree_,e,t),Ia(n.eventQueue_,e._path,o)}function Ni(n,e,t){let o;L(e._path)===".info"?o=ki(n.infoSyncTree_,e,t):o=ki(n.serverSyncTree_,e,t),Ia(n.eventQueue_,e._path,o)}function Mh(n){n.persistentConnection_&&n.persistentConnection_.interrupt(Eh)}function Vo(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),Ie(t,...e)}function Mi(n,e,t,o){e&&mt(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let s=i;o&&(s+=": "+o);const r=new Error(s);r.code=i,e(r)}})}function wa(n,e,t){return ms(n.serverSyncTree_,e,t)||N.EMPTY_NODE}function Ss(n,e=n.transactionQueueTree_){if(e||Wo(n,e),yt(e)){const t=Da(n,e);A(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&Rh(n,Zt(e),t)}else Ca(e)&&Lo(e,t=>{Ss(n,t)})}function Rh(n,e,t){const o=t.map(d=>d.currentWriteId),i=wa(n,e,o);let s=i;const r=i.hash();for(let d=0;d<t.length;d++){const u=t[d];A(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=Re(e,u.path);s=s.updateChild(h,u.currentOutputSnapshotRaw)}const l=s.val(!0),a=e;n.server_.put(a.toString(),l,d=>{Vo(n,"transaction put response",{path:a.toString(),status:d});let u=[];if(d==="ok"){const h=[];for(let f=0;f<t.length;f++)t[f].status=2,u=u.concat(Un(n.serverSyncTree_,t[f].currentWriteId)),t[f].onComplete&&h.push(()=>t[f].onComplete(null,!0,t[f].currentOutputSnapshotResolved)),t[f].unwatcher();Wo(n,Cs(n.transactionQueueTree_,e)),Ss(n,n.transactionQueueTree_),rn(n.eventQueue_,e,u);for(let f=0;f<h.length;f++)mt(h[f])}else{if(d==="datastale")for(let h=0;h<t.length;h++)t[h].status===3?t[h].status=4:t[h].status=0;else{De("transaction at "+a.toString()+" failed: "+d);for(let h=0;h<t.length;h++)t[h].status=4,t[h].abortReason=d}dt(n,e)}},r)}function dt(n,e){const t=ka(n,e),o=Zt(t),i=Da(n,t);return xh(n,i,o),o}function xh(n,e,t){if(e.length===0)return;const o=[];let i=[];const r=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],d=Re(t,a.path);let u=!1,h;if(A(d!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)u=!0,h=a.abortReason,i=i.concat(Un(n.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=Ih)u=!0,h="maxretry",i=i.concat(Un(n.serverSyncTree_,a.currentWriteId,!0));else{const f=wa(n,a.path,r);a.currentInputSnapshot=f;const b=e[l].update(f.val());if(b!==void 0){Fo("transaction failed: Data returned ",b,a.path);let g=ve(b);typeof b=="object"&&b!=null&&dn(b,".priority")||(g=g.updatePriority(f.getPriority()));const D=a.currentWriteId,U=zo(n),j=_a(g,f,U);a.currentOutputSnapshotRaw=g,a.currentOutputSnapshotResolved=j,a.currentWriteId=Bs(n),r.splice(r.indexOf(D),1),i=i.concat(fa(n.serverSyncTree_,a.path,j,a.currentWriteId,a.applyLocally)),i=i.concat(Un(n.serverSyncTree_,D,!0))}else u=!0,h="nodata",i=i.concat(Un(n.serverSyncTree_,a.currentWriteId,!0))}rn(n.eventQueue_,t,i),i=[],u&&(e[l].status=2,function(f){setTimeout(f,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(h==="nodata"?o.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):o.push(()=>e[l].onComplete(new Error(h),!1,null))))}Wo(n,n.transactionQueueTree_);for(let l=0;l<o.length;l++)mt(o[l]);Ss(n,n.transactionQueueTree_)}function ka(n,e){let t,o=n.transactionQueueTree_;for(t=L(e);t!==null&&yt(o)===void 0;)o=Cs(o,t),e=te(e),t=L(e);return o}function Da(n,e){const t=[];return Ta(n,e,t),t.sort((o,i)=>o.order-i.order),t}function Ta(n,e,t){const o=yt(e);if(o)for(let i=0;i<o.length;i++)t.push(o[i]);Lo(e,i=>{Ta(n,i,t)})}function Wo(n,e){const t=yt(e);if(t){let o=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[o]=t[i],o++);t.length=o,va(e,t.length>0?t:void 0)}Lo(e,o=>{Wo(n,o)})}function ws(n,e){const t=Zt(ka(n,e)),o=Cs(n.transactionQueueTree_,e);return mh(o,i=>{di(n,i)}),di(n,o),Pa(o,i=>{di(n,i)}),t}function di(n,e){const t=yt(e);if(t){const o=[];let i=[],s=-1;for(let r=0;r<t.length;r++)t[r].status===3||(t[r].status===1?(A(s===r-1,"All SENT items should be at beginning of queue."),s=r,t[r].status=3,t[r].abortReason="set"):(A(t[r].status===0,"Unexpected transaction status in abort"),t[r].unwatcher(),i=i.concat(Un(n.serverSyncTree_,t[r].currentWriteId,!0)),t[r].onComplete&&o.push(t[r].onComplete.bind(null,new Error("set"),!1,null))));s===-1?va(e,void 0):t.length=s+1,rn(n.eventQueue_,Zt(e),i);for(let r=0;r<o.length;r++)mt(o[r])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oh(n){let e="";const t=n.split("/");for(let o=0;o<t.length;o++)if(t[o].length>0){let i=t[o];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch(s){}e+="/"+i}return e}function Lh(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const o=t.split("=");o.length===2?e[decodeURIComponent(o[0])]=decodeURIComponent(o[1]):De(`Invalid query segment '${t}' in query '${n}'`)}return e}const Hr=function(n,e){const t=Fh(n),o=t.namespace;t.domain==="firebase.com"&&fn(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!o||o==="undefined")&&t.domain!=="localhost"&&fn("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||J1();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new Ll(t.host,t.secure,o,i,e,"",o!==t.subdomain),path:new Y(t.pathString)}},Fh=function(n){let e="",t="",o="",i="",s="",r=!0,l="https",a=443;if(typeof n=="string"){let d=n.indexOf("//");d>=0&&(l=n.substring(0,d-1),n=n.substring(d+2));let u=n.indexOf("/");u===-1&&(u=n.length);let h=n.indexOf("?");h===-1&&(h=n.length),e=n.substring(0,Math.min(u,h)),u<h&&(i=Oh(n.substring(u,h)));const f=Lh(n.substring(Math.min(n.length,h)));d=e.indexOf(":"),d>=0?(r=l==="https"||l==="wss",a=parseInt(e.substring(d+1),10)):d=e.length;const b=e.slice(0,d);if(b.toLowerCase()==="localhost")t="localhost";else if(b.split(".").length<=2)t=b;else{const g=e.indexOf(".");o=e.substring(0,g).toLowerCase(),t=e.substring(g+1),s=o}"ns"in f&&(s=f.ns)}return{host:e,port:a,domain:t,subdomain:o,secure:r,scheme:l,pathString:i,namespace:s}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zh{constructor(e,t,o,i){this.eventType=e,this.eventRegistration=t,this.snapshot=o,this.prevName=i}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+Ce(this.snapshot.exportVal())}}class Vh{constructor(e,t,o){this.eventRegistration=e,this.error=t,this.path=o}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jo{constructor(e,t,o,i){this._repo=e,this._path=t,this._queryParams=o,this._orderByCalled=i}get key(){return F(this._path)?null:Zi(this._path)}get ref(){return new Nn(this._repo,this._path)}get _queryIdentifier(){const e=Er(this._queryParams),t=Yi(e);return t==="{}"?"default":t}get _queryObject(){return Er(this._queryParams)}isEqual(e){if(e=Qn(e),!(e instanceof jo))return!1;const t=this._repo===e._repo,o=es(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&o&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+M0(this._path)}}function jh(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function Gh(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===zn){const o="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==Vn)throw new Error(o);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==Sn)throw new Error(o);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===re){if(e!=null&&!Ti(e)||t!=null&&!Ti(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(A(n.getIndex()instanceof os||n.getIndex()===ea,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class Nn extends jo{constructor(e,t){super(e,t,new ss,!1)}get parent(){const e=Ql(this._path);return e===null?null:new Nn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class ko{constructor(e,t,o){this._node=e,this.ref=t,this._index=o}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Y(e),o=Kt(this.ref,e);return new ko(this._node.getChild(t),o,re)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(o,i)=>e(new ko(i,Kt(this.ref,o),re)))}hasChild(e){const t=new Y(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function en(n,e){return n=Qn(n),n._checkNotDeleted("ref"),e!==void 0?Kt(n._root,e):n._root}function Kt(n,e){return n=Qn(n),L(n._path)===null?vh("child","path",e):Us("child","path",e),new Nn(n._repo,ae(n._path,e))}function lo(n,e){n=Qn(n),Es("push",n._path),Ea("push",e,n._path,!0);const t=Sa(n._repo),o=Hh(t),i=Kt(n,o),s=Kt(n,o);let r;return r=Promise.resolve(s),i.then=r.then.bind(r),i.catch=r.then.bind(r,void 0),i}function Na(n){return Es("remove",n._path),Kh(n,null)}function Kh(n,e){n=Qn(n),Es("set",n._path),Ea("set",e,n._path,!1);const t=new Xt;return kh(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function Ri(n,e){_h("update",e,n._path);const t=new Xt;return Dh(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}class ks{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const o=t._queryParams.getIndex();return new zh("value",this,new ko(e.snapshotNode,new Nn(t._repo,t._path),o))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Vh(this,e,t):null}matches(e){return e instanceof ks?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Qh(n,e,t,o,i){let s;if(typeof o=="object"&&(s=void 0,i=o),typeof o=="function"&&(s=o),i&&i.onlyOnce){const a=t,d=(u,h)=>{Ni(n._repo,n,l),a(u,h)};d.userCallback=t.userCallback,d.context=t.context,t=d}const r=new Wh(t,s||void 0),l=new ks(r);return Nh(n._repo,n,l),()=>Ni(n._repo,n,l)}function Ma(n,e,t,o){return Qh(n,"value",e,t,o)}function Ra(n,e,t){Ni(n._repo,n,null)}class Xh{}class Yh extends Xh{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){jh(e,"orderByChild");const t=new Y(this._path);if(F(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const o=new os(t),i=o2(e._queryParams,o);return Gh(i),new jo(e._repo,e._path,i,!0)}}function qh(n){return Us("orderByChild","path",n),new Yh(n)}function Jh(n,...e){let t=Qn(n);for(const o of e)t=o._apply(t);return t}G2(Nn);J2(Nn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $h="FIREBASE_DATABASE_EMULATOR_HOST",xi={};let Zh=!1;function eu(n,e,t,o){const i=e.lastIndexOf(":"),s=e.substring(0,i),r=bl(s);n.repoInfo_=new Ll(e,r,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),o&&(n.authTokenProvider_=o)}function nu(n,e,t,o,i){let s=o||n.options.databaseURL;s===void 0&&(n.options.projectId||fn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ie("Using default host for project ",n.options.projectId),s=`${n.options.projectId}-default-rtdb.firebaseio.com`);let r=Hr(s,i),l=r.repoInfo,a;typeof process!="undefined"&&lr&&(a=lr[$h]),a?(s=`http://${a}?ns=${l.namespace}`,r=Hr(s,i),l=r.repoInfo):r.repoInfo.secure;const d=new a0(n.name,n.options,e);Ch("Invalid Firebase Database URL",r),F(r.path)||fn("Database URL must point to the root of a Firebase Database (not including a child path).");const u=ou(l,n,d,new l0(n,t));return new iu(u,n)}function tu(n,e){const t=xi[e];(!t||t[n.key]!==n)&&fn(`Database ${e}(${n.repoInfo_}) has already been deleted.`),Mh(n),delete t[n.key]}function ou(n,e,t,o){let i=xi[e.name];i||(i={},xi[e.name]=i);let s=i[n.toURLString()];return s&&fn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new Bh(n,Zh,t,o),i[n.toURLString()]=s,s}class iu{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Sh(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Nn(this._repo,Q())),this._rootInternal}_delete(){return this._rootInternal!==null&&(tu(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&fn("Cannot call "+e+" on a deleted database.")}}function su(n=M1(),e){const t=w1(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const o=gd("database");o&&ru(t,...o)}return t}function ru(n,e,t,o={}){n=Qn(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,s=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&fo(o,s.repoInfo_.emulatorOptions))return;fn("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let r;if(s.repoInfo_.nodeAdmin)o.mockUserToken&&fn('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new ro(ro.OWNER);else if(o.mockUserToken){const l=typeof o.mockUserToken=="string"?o.mockUserToken:Ad(o.mockUserToken,n.app.options.projectId);r=new ro(l)}bl(e)&&Td(e),eu(s,i,o,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lu(n){G1(N1),bo(new Lt("database",(e,{instanceIdentifier:t})=>{const o=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return nu(o,i,s,t)},"PUBLIC").setMultipleInstances(!0)),ot(ar,cr,n),ot(ar,cr,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const au={".sv":"timestamp"};function Fn(){return au}pn.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};pn.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};lu();var cu="firebase",du="12.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ot(cu,du,"app");const xn=n=>n?String(n).split(/[\r\n,=\s]/)[0].trim():"",Oi={apiKey:xn("AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs"),authDomain:xn("findparkinglot-2519e.firebaseapp.com"),projectId:xn("findparkinglot-2519e"),databaseURL:xn("https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app"),storageBucket:xn("findparkinglot-2519e.firebasestorage.app"),messagingSenderId:xn("976769533420"),appId:xn("1:976769533420:web:f3108318b3def30017acc9")},cn=!!(Oi.apiKey&&Oi.databaseURL);let Vr=null,Ke=null;cn&&(Vr=vl(Oi),Ke=su(Vr));const ao="parking_overrides",wt=E({}),xa=E(!1),Li=E(null);let Rt=null,hi=0;function co(n,e){if(!n||!Array.isArray(e))return"";const t=Number(e[0]),o=Number(e[1]);return!isFinite(t)||!isFinite(o)?"":`${n}|${t.toFixed(6)},${o.toFixed(6)}`.replace(/[.#$/[\]]/g,"_")}function Oa(n,e){if(!e)return n;const t={...n},o=i=>{const s=e[i];s!=null&&(typeof s=="string"&&s.trim()===""||(t[i]=s))};return o("description"),o("iconKey"),o("category"),o("friendliness"),o("priceInfo"),t}function hu(){if(!(!cn||Rt))try{const n=en(Ke,ao);Rt=n,Ma(n,e=>{const t={};e.forEach(o=>{t[o.key]=o.val()||{}}),wt.value=t,xa.value=!0},e=>{Li.value=e})}catch(n){Li.value=n}}function uu(){Rt&&(Ra(Rt),Rt=null)}function pu(){Kn(()=>{hi+=1,hu()}),ut(()=>{hi-=1,hi<=0&&uu()});const n=(s,r)=>{const l=co(s,r);return l&&wt.value[l]||null};return{overrides:wt,ready:xa,error:Li,getOverride:n,hasOverride:(s,r)=>!!n(s,r),getOverrideHistory:(s,r)=>{const l=n(s,r);return!l||!l.history||typeof l.history!="object"?[]:Object.entries(l.history).map(([a,d])=>({...d||{},_key:a})).sort((a,d)=>a._key<d._key?1:a._key>d._key?-1:0)},upsertOverride:async(s,r,l)=>{var T,V,Pe;if(!cn)throw new Error("Firebase 尚未設定");const a=co(s.name,s.geometry);if(!a)throw new Error("無法產生 override key (缺少 name 或 geometry)");const[d,u]=s.geometry,h={id:l.id,nickname:l.nickname||""},f={origName:s.name||"",origLng:Number(d),origLat:Number(u),description:typeof r.description=="string"?r.description.trim():"",iconKey:r.iconKey||"",category:r.category||"",friendliness:r.friendliness||"",priceInfo:typeof r.priceInfo=="string"?r.priceInfo.trim():"",updatedBy:h,updatedAt:Fn()},b=wt.value[a]||null,g=Oa(s,b),I=["description","iconKey","category","friendliness","priceInfo"],D={},U={};for(const ce of I){const Se=(T=g==null?void 0:g[ce])!=null?T:"",Ue=(V=f[ce])!=null?V:"";String(Se)!==String(Ue)&&(D[ce]=Se,U[ce]=Ue)}const j=lo(en(Ke,`${ao}/${a}/history`)).key;return await Ri(en(Ke),{[`${ao}/${a}`]:{...f,history:{...((Pe=wt.value[a])==null?void 0:Pe.history)||{},[j]:{action:"override",at:Fn(),by:h,before:D,after:U}}}}),a},resetOverride:async(s,r)=>{if(!cn)throw new Error("Firebase 尚未設定");const l=co(s,r);l&&await Na(en(Ke,`${ao}/${l}`))}}}const ln=(n,e)=>{const t=n.__vccOpts||n;for(const[o,i]of e)t[o]=i;return t},mu={id:"map"},fu=16,Wr=34,yu=84,bu={__name:"MapBox",props:{parkingTypeKeyArray:Array,degreeOfFriendlinessKeyArray:Array,mapDataList:Array,getLngLat:Boolean,mapStylesSelected:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,goToParkingPlaceData:Object,routeData:Object,favoriteIds:{type:Object,default:()=>new Set},overrideKeys:{type:Object,default:()=>new Set},overrides:{type:Object,default:()=>({})},onlyFavorites:{type:Boolean,default:!1},focusCoord:{type:Array,default:null},routeProfile:{type:String,default:"driving"},communityParkings:{type:Array,default:()=>[]}},emits:["parkingInfo","communityParkingClick","update:goToParkingPlaceData","update:routeData"],setup(n,{expose:e,emit:t}){const o=n,i=t,s="pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",r=E(null),l=E({accessToken:s,bounds:[[119.3620389067818,21.83282743468497],[122.07013958372167,25.34391086143183]],center:[121.5173399,25.0475613],zoom:14,userCoordinates:[null,null]}),a=E(null),d=E([]),u=P=>P>=15?60:P>=13?60+(15-P)*30:P>=11?120+(13-P)*60:240,h=P=>Array.isArray(P)&&P.length>=2&&Number.isFinite(Number(P[0]))&&Number.isFinite(Number(P[1])),f=(P,R,X,G,J)=>{const ie=document.createElement("div");ie.className="marker",G&&ie.classList.add("is-override"),X&&ie.classList.add("is-fav");const Le=document.createElement("div");Le.className="tag";const be=document.createElement("div");be.className="img";const v=J||R.properties.icon;return v&&(be.style.backgroundImage=`url(${q(v)})`,be.style.backgroundSize="cover",be.style.backgroundPosition="center center"),ie.appendChild(Le),ie.appendChild(be),ie.addEventListener("click",()=>{r.value.flyTo({center:R.geometry.coordinates,zoom:17,bearing:0,speed:1.5,curve:1.5,easing:S=>S,essential:!0}),i("parkingInfo",{name:P.name,properties:R.properties,geometry:R.geometry.coordinates,address:""})}),ie},b=(P,R)=>{const X=document.createElement("div");X.className="marker is-community",R&&X.classList.add("is-fav");const G=document.createElement("div");G.className="tag";const J=document.createElement("div");return J.className="img",P.iconKey&&(J.style.backgroundImage=`url(${q(P.iconKey)})`,J.style.backgroundSize="cover",J.style.backgroundPosition="center center"),X.appendChild(G),X.appendChild(J),X.addEventListener("click",()=>{r.value.flyTo({center:P.coordinates,zoom:17,speed:1.5,curve:1.5,essential:!0}),i("communityParkingClick",P)}),X},g=P=>{const R=document.createElement("div");R.className="marker-cluster";const X=Math.min(1,Math.log2(Math.max(2,P))/Math.log2(500)),G=Math.round(Wr+(yu-Wr)*X),J=Math.round(12+10*X);return R.style.width=`${G}px`,R.style.height=`${G}px`,R.style.lineHeight=`${G}px`,R.style.fontSize=`${J}px`,R.textContent=String(P),R},I=()=>{var ie,Le,be,v,M,S,ue,Ne,we,qe,Je,Me;for(let x=d.value.length-1;x>=0;x--)d.value[x].remove();if(d.value=[],!r.value)return;const P=(Le=(ie=r.value).getBounds)==null?void 0:Le.call(ie),R=[];for(const x of o.mapDataList)for(const z of x.features){const se=z.geometry.coordinates;if(!h(se))continue;const ge=pi(z.properties.name,se),Fe=(v=(be=o.favoriteIds)==null?void 0:be.has)==null?void 0:v.call(be,ge),pe=co(z.properties.name,se),yn=pe?(S=(M=o.overrideKeys)==null?void 0:M.has)==null?void 0:S.call(M,pe):!1,ke=yn?(ue=o.overrides)==null?void 0:ue[pe]:null,bt=typeof(ke==null?void 0:ke.priceInfo)=="string"&&ke.priceInfo.trim()!==""?ke.priceInfo.trim():"",Go=bt||z.properties.priceInfo,Ko=bt?bt.split("|"):z.properties.priceArray,eo=(typeof(ke==null?void 0:ke.iconKey)=="string"&&ke.iconKey.trim()!==""?ke.iconKey.trim():"")||z.properties.icon;!Xs(P,se)||o.onlyFavorites&&!Fe||!Ks(eo,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray)||!Qs(Go,Ko,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)||R.push({coord:[Number(se[0]),Number(se[1])],createEl:()=>f(x,z,Fe,yn,eo)})}for(const x of o.communityParkings||[]){const z=x.coordinates;if(!h(z)||!Xs(P,z))continue;const se=pi(x.name,z),ge=(we=(Ne=o.favoriteIds)==null?void 0:Ne.has)==null?void 0:we.call(Ne,se);if(o.onlyFavorites&&!ge||!Ks(x.iconKey,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray))continue;const Fe=x.priceInfo||"",pe=Fe?Fe.split("|"):[];Qs(Fe,pe,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)&&R.push({coord:[Number(z[0]),Number(z[1])],createEl:()=>b(x,ge)})}const X=(Me=(Je=(qe=r.value).getZoom)==null?void 0:Je.call(qe))!=null?Me:0;if(X>=fu){for(const x of R){const z=new Rn.Marker(x.createEl()).setLngLat(x.coord).addTo(r.value);d.value.push(z)}return}const G=u(X),J=new Map;for(const x of R){const z=r.value.project(x.coord),se=Math.floor(z.x/G),ge=Math.floor(z.y/G),Fe=`${se}:${ge}`;let pe=J.get(Fe);pe||(pe={points:[],sumLng:0,sumLat:0},J.set(Fe,pe)),pe.points.push(x),pe.sumLng+=x.coord[0],pe.sumLat+=x.coord[1]}for(const x of J.values())if(x.points.length===1){const z=x.points[0],se=new Rn.Marker(z.createEl()).setLngLat(z.coord).addTo(r.value);d.value.push(se)}else{const z=[x.sumLng/x.points.length,x.sumLat/x.points.length],se=g(x.points.length);se.addEventListener("click",()=>{var pe,yn,ke;const Fe=Math.min(((ke=(yn=(pe=r.value).getZoom)==null?void 0:yn.call(pe))!=null?ke:0)+2,17);r.value.flyTo({center:z,zoom:Fe,speed:1.5,curve:1.5,essential:!0})});const ge=new Rn.Marker(se).setLngLat(z).addTo(r.value);d.value.push(ge)}};let D=null,U=null;const j=()=>{D!=null&&(clearTimeout(D),D=null),U!=null&&(typeof cancelIdleCallback=="function"&&cancelIdleCallback(U),U=null)},T=()=>{j(),D=setTimeout(()=>{D=null;const P=()=>{U=null,o.goToParkingPlaceData==null&&I()};typeof requestIdleCallback=="function"?U=requestIdleCallback(P,{timeout:250}):P()},80)},V=()=>{const P=document.getElementById("loading-cover");P&&(P.classList.add("active"),setTimeout(()=>P.remove(),600))},Pe=()=>{r.value.on("dragend",T),r.value.on("zoomend",T),I(),V(),r.value.once("load",()=>{const P=o.focusCoord;Array.isArray(P)&&P[0]!=null&&P[1]!=null&&r.value.flyTo({center:[Number(P[0]),Number(P[1])],zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})})},ce=()=>{r.value=new Rn.Map({container:"map",style:o.mapStylesSelected,center:l.value.center,zoom:16,trackResize:!0,maxBounds:l.value.bounds}),Pe(),r.value.addControl(new Rn.GeolocateControl({positionOptions:{enableHighAccuracy:!0},trackUserLocation:!0,showUserHeading:!0})),r.value.on("geolocate",P=>{r.value.easeTo({bearing:P.coords.heading,duration:1e3,offset:[0,0]})})},Se=P=>{const{longitude:R,latitude:X}=P.coords;R>=l.value.bounds[0][0]&&R<=l.value.bounds[1][0]&&X>=l.value.bounds[0][1]&&X<=l.value.bounds[1][1]?(l.value.userCoordinates=[R,X],l.value.center=[R,X]):l.value.center=[121.5173399,25.0475613],ce()},Ue=()=>{ce()},Ye=()=>{const P=document.getElementById("coordinates"),R=a.value.getLngLat();P.style.display="block",P.innerHTML=`[Longitude, Latitude]<br />[${R.lng}, ${R.lat}]`},he=()=>{a.value=new Rn.Marker({draggable:!0,color:"#2ee7d6"}).setLngLat(r.value.getCenter()).addTo(r.value),Ye(),a.value.on("dragend",Ye)};async function le(P,R){r.value.getLayer("point")||r.value.addLayer({id:"point",type:"circle",source:{type:"geojson",data:{type:"FeatureCollection",features:[{type:"Feature",properties:{},geometry:{type:"Point",coordinates:P}}]}},paint:{"circle-radius":10,"circle-color":"#2ee7d6"}});const J=(await(await fetch(`https://api.mapbox.com/directions/v5/mapbox/${o.routeProfile||"driving"}/${P[0]},${P[1]};${R[0]},${R[1]}?alternatives=false&language=zh-Hant&overview=full&steps=true&exclude=ferry&geometries=geojson&access_token=${l.value.accessToken}`,{method:"GET"})).json()).routes[0],ie={type:"Feature",properties:{},geometry:{type:"LineString",coordinates:J.geometry.coordinates}};i("update:routeData",J),r.value.getSource("route")?r.value.getSource("route").setData(ie):r.value.addLayer({id:"route",type:"line",source:{type:"geojson",data:ie},layout:{"line-join":"round","line-cap":"round"},paint:{"line-color":"#2ee7d6","line-width":5,"line-opacity":.75}})}const Te=P=>{if(l.value.userCoordinates[0]!==null){r.value.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point"));for(let X=d.value.length-1;X>=0;X--){const G=d.value[X].getLngLat();G.lng!=P[0]&&G.lat!=P[1]&&d.value[X].remove()}const R=[[l.value.userCoordinates[0],l.value.userCoordinates[1]],[P[0],P[1]]];r.value.fitBounds(R,{padding:{top:100,bottom:100,left:100,right:100}}),le(l.value.userCoordinates,P)}else"geolocation"in navigator&&navigator.geolocation.getCurrentPosition(Se,Ue)},We=()=>{var P,R;(P=r.value)!=null&&P.getSource("route")&&(r.value.removeLayer("route"),r.value.removeSource("route")),(R=r.value)!=null&&R.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point")),I(),i("update:goToParkingPlaceData",null)};return Kn(()=>{Rn.accessToken=l.value.accessToken,"geolocation"in navigator?navigator.geolocation.getCurrentPosition(Se,Ue,{enableHighAccuracy:!1,timeout:8e3,maximumAge:6e4}):ce()}),ut(()=>{j()}),K([()=>o.parkingTypeKeyArray,()=>o.degreeOfFriendlinessKeyArray,()=>o.priceRangeMin,()=>o.priceRangeMax,()=>o.parkingPriceType,()=>o.onlyFavorites,()=>o.favoriteIds,()=>o.communityParkings,()=>o.overrides],()=>T(),{deep:!0}),K(()=>o.focusCoord,P=>{!P||!r.value||r.value.flyTo({center:P,zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})}),K(()=>o.routeProfile,()=>{o.goToParkingPlaceData!==null&&l.value.userCoordinates[0]!==null&&le(l.value.userCoordinates,o.goToParkingPlaceData)}),K(()=>o.goToParkingPlaceData,P=>{P!==null?Te(P):We()}),K(()=>o.mapStylesSelected,(P,R)=>{R!==P&&r.value&&r.value.setStyle(P)}),K(()=>o.getLngLat,()=>{if(a.value!==null){a.value.remove();const P=document.getElementById("coordinates");P&&(P.style.display="none")}o.getLngLat===!0&&he()}),e({getCenter:()=>{if(!r.value)return[...l.value.center];const P=r.value.getCenter();return[P.lng,P.lat]},flyTo:(P,R=17)=>{!r.value||!P||r.value.flyTo({center:P,zoom:R,essential:!0})}}),(P,R)=>(_(),C("div",mu))}},gu=ln(bu,[["__scopeId","data-v-d2d2184f"]]),Au=n=>(Dn("data-v-4ef15e45"),n=n(),Tn(),n),_u={key:0,class:"modal-header"},vu=Au(()=>c("span",{class:"material-icons-outlined"},"close",-1)),Cu=[vu],Pu={class:"modal-body"},Uu={key:1,class:"modal-footer"},Eu={__name:"BaseModal",props:{modelValue:Boolean,title:{type:String,default:""},closeText:{type:String,default:"關閉"},size:{type:String,default:"md"}},emits:["update:modelValue","close"],setup(n,{emit:e}){const t=n,o=e,i=E(null),s=()=>{o("update:modelValue",!1),o("close")},r=l=>{l.key==="Escape"&&t.modelValue&&s()};return Kn(()=>window.addEventListener("keydown",r)),ut(()=>window.removeEventListener("keydown",r)),K(()=>t.modelValue,async l=>{var a;document.body.classList.toggle("modal-open",l),l&&(await qr(),(a=i.value)==null||a.scrollTo({top:0,behavior:"auto"}))}),(l,a)=>(_(),Wi(uc,{to:"body"},[c("div",{class:oe(["modal-overlay",{active:n.modelValue}]),onClick:ji(s,["self"]),role:"dialog","aria-modal":"true",ref_key:"overlayEl",ref:i},[c("div",{class:oe(["modal-card",[`size-${n.size}`,{active:n.modelValue}]])},[n.title||l.$slots.header?(_(),C("header",_u,[Zo(l.$slots,"header",{},()=>[c("h3",null,w(n.title),1)]),c("button",{class:"modal-close",onClick:s,"aria-label":"關閉"},Cu)])):W("",!0),c("div",Pu,[Zo(l.$slots,"default",{},void 0)]),l.$slots.footer||n.closeText?(_(),C("footer",Uu,[Zo(l.$slots,"footer",{},()=>[c("button",{class:"btn btn-primary",onClick:s},w(n.closeText),1)])])):W("",!0)],2)],2)]))}},Cn=ln(Eu,[["__scopeId","data-v-4ef15e45"]]),Iu=["onClick"],Bu={class:"material-icons-outlined"},Su={class:"fab-item-label"},wu=["aria-label","aria-expanded"],ku={class:"material-icons-outlined"},Du={__name:"FabMenu",props:{items:{type:Array,required:!0},placement:{type:String,default:"right"},mainIcon:{type:String,default:"apps"},mainLabel:{type:String,default:""}},setup(n){const e=E(!1),t=E(null),o=()=>e.value=!e.value,i=r=>{t.value&&!t.value.contains(r.target)&&(e.value=!1)},s=r=>{var l;e.value=!1,(l=r.onClick)==null||l.call(r)};return Kn(()=>document.addEventListener("click",i)),ut(()=>document.removeEventListener("click",i)),(r,l)=>(_(),C("div",{class:oe(["fab-root",`fab-placement-${n.placement}`]),ref_key:"rootEl",ref:t},[Ee(pc,{name:"fab-item",tag:"div",class:"fab-items"},{default:Ze(()=>[(_(!0),C(ye,null,Ve(e.value?n.items:[],(a,d)=>(_(),C("button",{key:a.key,class:oe(["fab-item",{highlight:a.highlight}]),style:uo({bottom:d*46+"px"}),onClick:u=>s(a)},[c("span",Bu,w(a.icon),1),c("span",Su,w(a.label),1)],14,Iu))),128))]),_:1}),c("button",{class:oe(["fab-main",{active:e.value}]),onClick:ji(o,["stop"]),"aria-label":e.value?"收合選單":n.mainLabel||"展開選單","aria-expanded":e.value},[c("span",ku,w(e.value?"close":n.mainIcon),1)],10,wu)],2))}},jr=ln(Du,[["__scopeId","data-v-b3399b6f"]]),ht=[{name:"全部",value:"",key:null},{name:"汽車：汽車格(含未確認是否有重機格)",value:"car",key:["icon-1.png","icon-2.png","icon-3.png","icon-5.png"]},{name:"重機：有設重機專用格",value:"motorcycle",key:["icon-6.png","icon-8.png","icon-12.png","icon-13.png"]},{name:"機車：機車格",value:"scooter",key:["icon-7.png","icon-9.png","icon-10.png","icon-11.png"]},{name:"綠星:路邊友善車格(機車格開放重機停放)",value:"greenStar",key:["icon-14.png"]},{name:"重機友善店家:用餐/消費可停重機",value:"friendlyShop",key:["icon-4.png"]},{name:"綠P:重機專用路邊停車格",value:"greenP",key:["icon-15.png"]},{name:"灰P:重機專用路邊停車格(未確認精準座標)",value:"greyP",key:["icon-16.png"]},{name:"藍P:普通大型共用機車格(台北市試辦)",value:"blueP",key:["icon-17.png"]},{name:"紫P:時段性汽機車共用停車格，注意使用時間喔!",value:"purpleP",key:["icon-18.png"]},{name:"紅X:停都不給停",value:"redX",key:["icon-19.png"]},{name:"?:類型未確認",value:"unknown",key:["icon-20.png"]}];function Tu(n){if(!n)return"未分類";const e=ht.find(t=>Array.isArray(t.key)&&t.key.includes(n));return e?e.name.split(/[：:]/)[0]:"未分類"}const Qt=[{name:"全部",value:"",key:null},{name:"最友善：有後牌辨析",value:"friendly",key:["icon-2.png","icon-4.png","icon-6.png","icon-9.png","icon-14.png","icon-15.png"]},{name:"最傳統：悠遊卡、按鈕取票",value:"normal",key:["icon-5.png","icon-11.png","icon-12.png","icon-17.png"]},{name:"最靠北：按鈕請管理員協助、前牌辨析",value:"unfriendly",key:["icon-1.png","icon-7.png","icon-13.png","icon-19.png"]},{name:"未確定",value:"unknown",key:["icon-3.png","icon-8.png","icon-10.png","icon-16.png","icon-20.png"]}],nt=[{name:"依系統設定",value:"system",theme:"system"},{name:"暗色模式",value:"mapbox://styles/jamestim9215/ckvkdj5cd1q4115nzwxa9rny3",theme:"dark"},{name:"亮色模式",value:"mapbox://styles/jamestim9215/ckvueghhu2woc14nrsgysx41v",theme:"light"}],Nu="260603",Mu=n=>(Dn("data-v-fc736dec"),n=n(),Tn(),n),Ru={class:"range-slider"},xu={class:"range-track"},Ou=["min","max","step","value"],Lu=["min","max","step","value"],Fu={class:"range-values"},Hu=Mu(()=>c("span",{class:"range-sep"},"~",-1)),zu={__name:"RangeSlider",props:{min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:10},modelMin:{type:Number,default:0},modelMax:{type:Number,default:100},suffix:{type:String,default:""}},emits:["update:modelMin","update:modelMax"],setup(n,{emit:e}){const t=n,o=e,i=$(()=>t.max-t.min||1),s=$(()=>(t.modelMin-t.min)/i.value*100),r=$(()=>(t.modelMax-t.min)/i.value*100),l=d=>{let u=Number(d.target.value);u>t.modelMax&&(u=t.modelMax),o("update:modelMin",u)},a=d=>{let u=Number(d.target.value);u<t.modelMin&&(u=t.modelMin),o("update:modelMax",u)};return(d,u)=>(_(),C("div",Ru,[c("div",xu,[c("div",{class:"range-fill",style:uo({left:s.value+"%",right:100-r.value+"%"})},null,4),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMin,onInput:l,class:"range-input range-input-min","aria-label":"最低價格"},null,40,Ou),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMax,onInput:a,class:"range-input range-input-max","aria-label":"最高價格"},null,40,Lu)]),c("div",Fu,[c("span",null,w(n.modelMin)+w(n.suffix),1),Hu,c("span",null,w(n.modelMax)+w(n.suffix),1)])]))}},Vu=ln(zu,[["__scopeId","data-v-fc736dec"]]),Oe=n=>(Dn("data-v-906f2db2"),n=n(),Tn(),n),Wu=Oe(()=>c("span",{class:"material-icons-outlined"},"chevron_left",-1)),ju=[Wu],Gu=Jr('<header class="side-panel-header" data-v-906f2db2><img class="side-panel-logo" src="'+Gi+'" alt="重機能停哪" data-v-906f2db2><div class="side-panel-titles" data-v-906f2db2><h3 data-v-906f2db2>重機能停哪?</h3><span class="side-panel-subtitle" data-v-906f2db2><span class="material-icons-outlined" data-v-906f2db2>tune</span>設定 </span></div></header>',1),Ku={class:"side-panel-body"},Qu={class:"form-group"},Xu={class:"form-toggle"},Yu={class:"form-toggle-text"},qu=Oe(()=>c("span",{class:"material-icons-outlined fav-icon"},"star",-1)),Ju={key:0,class:"fav-count"},$u=["checked"],Zu={class:"form-group"},e3=Oe(()=>c("label",{class:"form-label"},"甚麼格位",-1)),n3=["value"],t3=["value"],o3={class:"form-group"},i3=Oe(()=>c("label",{class:"form-label"},"友善程度",-1)),s3=["value"],r3=["value"],l3={class:"form-group"},a3=Oe(()=>c("label",{class:"form-label"},"收費範圍",-1)),c3={class:"price-chips"},d3=Oe(()=>c("span",{class:"material-icons-outlined"},"money_off",-1)),h3={class:"form-group"},u3=Oe(()=>c("label",{class:"form-label"},"主題顏色",-1)),p3=["value"],m3=["value"],f3=Oe(()=>c("section",{class:"form-group"},[c("label",{class:"form-label"},"停車場資料來源"),c("div",{class:"link-list"},[c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"btn btn-outline btn-sm"}," Alan大重停車記事 ")])],-1)),y3={class:"form-group"},b3=Jr('<label class="form-label" data-v-906f2db2>問題回報</label><p class="muted-text" data-v-906f2db2> 1. 停車場資訊相關（新場地、收費錯誤）： </p><a href="https://forms.gle/euRCPCPSmvYLm5Rj8" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-906f2db2> Alan大重停車記事 回報表單 </a><p class="muted-text mt-8" data-v-906f2db2>2. 網頁 BUG、畫面跑版：</p><a href="https://forms.gle/iJCyfqVtpL35WtZM7" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-906f2db2> 重機能停哪? 回報表單 </a>',5),g3={class:"form-group"},A3=Oe(()=>c("label",{class:"form-label"},"資訊",-1)),_3={class:"info-list"},v3=Oe(()=>c("li",null,"版本：v2.2.1",-1)),C3=Oe(()=>c("li",null,"Web 製作：爽爽",-1)),P3=Oe(()=>c("li",null,"資料參考：Alan大重停車記事 Google My Map",-1)),U3=Oe(()=>c("li",null,"地圖：Mapbox GL JS API",-1)),E3=Oe(()=>c("li",null,"© 2026 爽爽 版權所有。本網頁未經准許，禁止任何商業行為",-1)),I3={__name:"SettingsPanel",props:{parkingType:String,degreeOfFriendliness:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,mapStyle:String,active:Boolean,onlyFavorites:Boolean,favoritesCount:{type:Number,default:0}},emits:["update:parkingType","update:degreeOfFriendliness","update:parkingPriceType","update:priceRangeMin","update:priceRangeMax","update:mapStyle","update:active","update:onlyFavorites","open-support"],setup(n,{emit:e}){const t=e,o=()=>t("update:active",!1);return(i,s)=>(_(),C("aside",{class:oe(["side-panel",{active:n.active}]),"aria-label":"設定面板"},[c("button",{class:"side-panel-close",onClick:o,"aria-label":"收合設定"},ju),Gu,c("div",Ku,[c("section",Qu,[c("label",Xu,[c("span",Yu,[qu,k(" 只看我的最愛 "),n.favoritesCount?(_(),C("span",Ju,w(n.favoritesCount),1)):W("",!0)]),c("input",{type:"checkbox",class:"switch",checked:n.onlyFavorites,onChange:s[0]||(s[0]=r=>t("update:onlyFavorites",r.target.checked))},null,40,$u)])]),c("section",Zu,[e3,c("select",{class:"form-control",value:n.parkingType,onChange:s[1]||(s[1]=r=>t("update:parkingType",r.target.value))},[(_(!0),C(ye,null,Ve(O(ht),r=>(_(),C("option",{value:r.value,key:r.value},w(r.name),9,t3))),128))],40,n3)]),c("section",o3,[i3,c("select",{class:"form-control",value:n.degreeOfFriendliness,onChange:s[2]||(s[2]=r=>t("update:degreeOfFriendliness",r.target.value))},[(_(!0),C(ye,null,Ve(O(Qt),r=>(_(),C("option",{value:r.value,key:r.value},w(r.name),9,r3))),128))],40,s3)]),c("section",l3,[a3,c("div",c3,[c("button",{type:"button",class:oe(["chip",{active:n.parkingPriceType===""}]),onClick:s[3]||(s[3]=r=>t("update:parkingPriceType",""))},"全部",2),c("button",{type:"button",class:oe(["chip chip-free",{active:n.parkingPriceType==="free"}]),onClick:s[4]||(s[4]=r=>t("update:parkingPriceType",n.parkingPriceType==="free"?"":"free"))},[d3,k(" 免費 ")],2),c("button",{type:"button",class:oe(["chip",{active:n.parkingPriceType==="h"}]),onClick:s[5]||(s[5]=r=>t("update:parkingPriceType","h"))},"計時 /時",2),c("button",{type:"button",class:oe(["chip",{active:n.parkingPriceType==="d"}]),onClick:s[6]||(s[6]=r=>t("update:parkingPriceType","d"))},"計次 /日",2),c("button",{type:"button",class:oe(["chip",{active:n.parkingPriceType==="t"}]),onClick:s[7]||(s[7]=r=>t("update:parkingPriceType","t"))},"計次 /不限時",2)]),/d|h|t/.test(n.parkingPriceType)?(_(),Wi(Vu,{key:0,class:"mt-8",min:0,max:300,step:10,"model-min":n.priceRangeMin,"model-max":n.priceRangeMax,suffix:n.parkingPriceType==="h"?" /時":n.parkingPriceType==="d"?" /日":" /次","onUpdate:modelMin":s[8]||(s[8]=r=>t("update:priceRangeMin",r)),"onUpdate:modelMax":s[9]||(s[9]=r=>t("update:priceRangeMax",r))},null,8,["model-min","model-max","suffix"])):W("",!0)]),c("section",h3,[u3,c("select",{class:"form-control",value:n.mapStyle,onChange:s[10]||(s[10]=r=>t("update:mapStyle",r.target.value))},[(_(!0),C(ye,null,Ve(O(nt),r=>(_(),C("option",{value:r.value,key:r.value},w(r.name),9,m3))),128))],40,p3)]),f3,c("section",y3,[b3,c("button",{type:"button",class:"btn btn-coffee btn-sm mt-8",onClick:s[11]||(s[11]=r=>t("open-support"))}," ❤️ 贊助支持，讓我有動力繼續更新 ")]),c("section",g3,[A3,c("ul",_3,[v3,c("li",null,"地圖資料更新："+w(O(Nu)),1),C3,P3,U3,E3])])])],2))}},B3=ln(I3,[["__scopeId","data-v-906f2db2"]]),Xe=n=>(Dn("data-v-d09400e9"),n=n(),Tn(),n),S3=Xe(()=>c("span",{class:"material-icons-outlined"},"close",-1)),w3=[S3],k3={class:"info-header"},D3=["src"],T3={class:"info-title"},N3=["aria-label","title"],M3={class:"material-icons-outlined"},R3=["innerHTML"],x3={key:1,class:"info-address"},O3={key:2,class:"info-price"},L3=Xe(()=>c("span",{class:"material-icons-outlined"},"payments",-1)),F3=Xe(()=>c("span",{class:"info-price-label"},"收費",-1)),H3={class:"info-price-value"},z3={key:0,class:"info-price-tag"},V3={key:3,class:"community-tag"},W3=Xe(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),j3={key:4,class:"override-tag"},G3=Xe(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),K3={key:5,class:"source-tag"},Q3=Xe(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),X3={class:"info-meta"},Y3={class:"badge-group"},q3={class:"badge"},J3={key:0,class:"badge badge-icon",title:"依圖示分類"},$3={class:"coord"},Z3={class:"info-actions"},e5=Xe(()=>c("span",{class:"material-icons-outlined"},"edit",-1)),n5=["title"],t5=Xe(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),o5=Xe(()=>c("span",{class:"material-icons-outlined"},"share",-1)),i5={class:"info-actions"},s5=Xe(()=>c("span",{class:"material-icons-outlined"},"map",-1)),r5=Xe(()=>c("span",{class:"material-icons-outlined"},"map",-1)),l5=Xe(()=>c("span",{class:"material-icons-outlined"},"directions",-1)),a5={__name:"ParkingInfoPanel",props:{info:Object,active:Boolean,isMobile:Boolean,isApple:Boolean,isAndroid:Boolean,hasRoute:Boolean,isFavorite:Boolean,isCommunity:{type:Boolean,default:!1},communityMeta:{type:Object,default:null},isOverridden:{type:Boolean,default:!1},overrideMeta:{type:Object,default:null}},emits:["close","route","openMap","toggleFavorite","editCommunity","editOverride","share"],setup(n,{emit:e}){const t=n,o=e,i=new Set(["icon-4.png","icon-14.png","icon-19.png"]),s=l=>l!=null&&l.priceInfo?t.isCommunity||t.isOverridden?!0:!i.has(l==null?void 0:l.parkingIconKey):!1,r=l=>{if(!l)return"";if(/^free$/i.test(l.trim()))return"免費";const a=l.trim().match(/^(\d+(?:\.\d+)?)\s*\/\s*(h|d|次)$/i);if(!a)return l;const d=a[2].toLowerCase(),u=d==="h"?"小時":d==="d"?"日":"次 (不限時)";return`${a[1]} 元 / ${u}`};return(l,a)=>{var d,u,h,f,b,g,I,D;return _(),C("aside",{class:oe(["info-panel",{active:n.active}]),"aria-label":"停車場資訊"},[c("button",{class:"panel-close",onClick:a[0]||(a[0]=U=>o("close")),"aria-label":"關閉"},w3),c("header",k3,[n.info.parkingIcon?(_(),C("img",{key:0,class:"info-icon",src:n.info.parkingIcon,alt:""},null,8,D3)):W("",!0),c("h3",T3,w(n.info.parkingName),1),c("button",{class:oe(["fav-btn",{active:n.isFavorite}]),onClick:a[1]||(a[1]=U=>o("toggleFavorite")),"aria-label":n.isFavorite?"從我的最愛移除":"加入我的最愛",title:n.isFavorite?"從我的最愛移除":"加入我的最愛"},[c("span",M3,w(n.isFavorite?"star":"star_border"),1)],10,N3)]),n.info.parkingNameDes?(_(),C("div",{key:0,class:"info-desc",innerHTML:n.info.parkingNameDes},null,8,R3)):W("",!0),n.info.address?(_(),C("div",x3,w(n.info.address),1)):W("",!0),s(n.info)?(_(),C("div",O3,[L3,F3,c("span",H3,w(r(n.info.priceInfo)),1),n.isOverridden?(_(),C("span",z3,"車友修改")):W("",!0)])):W("",!0),n.isCommunity?(_(),C("div",V3,[W3,c("span",null,[k(" 共筆停車點 "),(u=(d=n.communityMeta)==null?void 0:d.updatedBy)!=null&&u.nickname||(f=(h=n.communityMeta)==null?void 0:h.updatedBy)!=null&&f.id?(_(),C(ye,{key:0},[k(" · 由 "+w(n.communityMeta.updatedBy.nickname||`匿名#${n.communityMeta.updatedBy.id}`)+" 更新 ",1)],64)):W("",!0)])])):n.isOverridden?(_(),C("div",j3,[G3,c("span",null,[k(" 車友修改資訊 "),(g=(b=n.overrideMeta)==null?void 0:b.updatedBy)!=null&&g.nickname||(D=(I=n.overrideMeta)==null?void 0:I.updatedBy)!=null&&D.id?(_(),C(ye,{key:0},[k(" · 由 "+w(n.overrideMeta.updatedBy.nickname||`匿名#${n.overrideMeta.updatedBy.id}`)+" 更新 ",1)],64)):W("",!0)])])):W("",!0),!n.isCommunity&&n.info.sourceLabel?(_(),C("div",K3,[Q3,c("span",null,"資料來源 · "+w(n.info.sourceLabel),1)])):W("",!0),c("div",X3,[c("div",Y3,[c("span",q3,w(n.info.parkingType),1),n.info.iconCategory&&n.info.iconCategory!==n.info.parkingType?(_(),C("span",J3,w(n.info.iconCategory),1)):W("",!0)]),c("span",$3,w(Number(n.info.geometry[0]).toFixed(5))+", "+w(Number(n.info.geometry[1]).toFixed(5)),1)]),c("div",Z3,[n.isCommunity?(_(),C("button",{key:0,class:"btn btn-outline btn-sm",onClick:a[2]||(a[2]=U=>o("editCommunity"))},[e5,k(" 編輯 ")])):(_(),C("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[3]||(a[3]=U=>o("editOverride")),title:n.isOverridden?"修改車友提供的資訊 (不會變動官方資料)":"異議 / 補充官方資料 (不會變動官方資料)"},[t5,k(" "+w(n.isOverridden?"修改車友資訊":"異議 / 補充"),1)],8,n5)),c("button",{class:"btn btn-outline btn-sm",onClick:a[4]||(a[4]=U=>o("share")),title:"分享這個停車點"},[o5,k(" 分享 ")])]),c("div",i5,[n.isAndroid?W("",!0):(_(),C("button",{key:0,class:"btn btn-primary btn-sm",onClick:a[5]||(a[5]=U=>o("openMap","apple"))},[s5,k(" Apple Map ")])),c("button",{class:oe(["btn","btn-sm",n.isAndroid?"btn-primary":"btn-outline"]),onClick:a[6]||(a[6]=U=>o("openMap","google"))},[r5,k(" Google Map ")],2),n.hasRoute?W("",!0):(_(),C("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[7]||(a[7]=U=>o("route"))},[l5,k(" 路線規劃 ")]))])],2)}}},c5=ln(a5,[["__scopeId","data-v-d09400e9"]]),Ds=n=>(Dn("data-v-caf0ec6e"),n=n(),Tn(),n),d5={class:"route-header"},h5=Ds(()=>c("h3",null,[c("span",{class:"material-icons-outlined"},"alt_route"),k(" 路線 ")],-1)),u5=["aria-expanded"],p5={class:"material-icons-outlined"},m5={key:0,class:"route-summary"},f5={class:"route-summary-item"},y5=Ds(()=>c("span",{class:"material-icons-outlined"},"schedule",-1)),b5={class:"route-summary-item"},g5=Ds(()=>c("span",{class:"material-icons-outlined"},"straighten",-1)),A5={class:"route-profile",role:"tablist","aria-label":"交通方式"},_5=["onClick","aria-pressed"],v5={class:"material-icons-outlined"},C5={class:"profile-label"},P5={key:1,class:"route-steps"},U5={__name:"RouteSteps",props:{routeData:Object,active:Boolean,profile:{type:String,default:"driving"}},emits:["cancel","update:profile"],setup(n,{emit:e}){const t=n,o=e,i=E(!0),s=()=>i.value=!i.value,r=[{value:"driving",label:"汽機車",icon:"directions_car"},{value:"cycling",label:"單車",icon:"directions_bike"},{value:"walking",label:"步行",icon:"directions_walk"}],l=$(()=>{var h;const u=(h=t.routeData)==null?void 0:h.distance;return typeof u!="number"?"":u>=1e3?`${(u/1e3).toFixed(1)} km`:`${Math.round(u)} m`}),a=$(()=>{var g;const u=(g=t.routeData)==null?void 0:g.duration;if(typeof u!="number")return"";const h=Math.round(u/60);if(h<60)return`${h} 分`;const f=Math.floor(h/60),b=h%60;return b?`${f} 時 ${b} 分`:`${f} 時`}),d=u=>o("update:profile",u);return(u,h)=>(_(),C("aside",{class:oe(["route-panel",{active:n.active}])},[c("header",d5,[h5,c("button",{class:"route-toggle",onClick:s,"aria-expanded":i.value},[c("span",p5,w(i.value?"expand_less":"expand_more"),1)],8,u5)]),n.routeData?(_(),C("div",m5,[c("div",f5,[y5,c("strong",null,w(a.value),1)]),c("div",b5,[g5,c("strong",null,w(l.value),1)])])):W("",!0),c("div",A5,[(_(),C(ye,null,Ve(r,f=>c("button",{key:f.value,class:oe(["profile-btn",{active:n.profile===f.value}]),onClick:b=>d(f.value),"aria-pressed":n.profile===f.value},[c("span",v5,w(f.icon),1),c("span",C5,w(f.label),1)],10,_5)),64))]),n.routeData&&i.value?(_(),C("ol",P5,[(_(!0),C(ye,null,Ve(n.routeData.legs[0].steps,(f,b)=>(_(),C("li",{key:b,class:"route-step"},w(f.maneuver.instruction),1))),128))])):W("",!0),c("button",{class:"btn btn-danger btn-sm route-cancel",onClick:h[0]||(h[0]=f=>o("cancel"))}," 取消路線規劃 ")],2))}},E5=ln(U5,[["__scopeId","data-v-caf0ec6e"]]);function I5(n,e,t=20,o=[]){const i=(e||"").trim().toLowerCase();if(!i)return[];const s=[];if(Array.isArray(n))for(const r of n)for(const l of r.features){const a=(l.properties.name||"").toLowerCase(),d=(l.properties.description||"").toLowerCase();if((a.includes(i)||d.includes(i))&&(s.push({groupName:r.name,name:l.properties.name,description:l.properties.description,icon:l.properties.icon,geometry:l.geometry.coordinates,properties:l.properties,isCommunity:!1,score:(a.includes(i)?1e3:0)-(a.indexOf(i)===-1?0:a.indexOf(i))}),s.length>500))break}if(Array.isArray(o))for(const r of o){const l=(r.name||"").toLowerCase(),a=(r.description||"").toLowerCase();if(!l.includes(i)&&!a.includes(i))continue;const d=Array.isArray(r.coordinates)?r.coordinates:[null,null];if(!(d[0]==null||d[1]==null)&&(s.push({groupName:"共筆停車點",name:r.name,description:r.description,icon:r.iconKey,geometry:d,properties:{name:r.name,description:r.description,icon:r.iconKey},isCommunity:!0,community:r,score:(l.includes(i)?900:0)-(l.indexOf(i)===-1?0:l.indexOf(i))}),s.length>500))break}return s.sort((r,l)=>l.score-r.score),s.slice(0,t)}const La=n=>(Dn("data-v-2b0f75f6"),n=n(),Tn(),n),B5={key:0,class:"search-results",role:"listbox"},S5=["aria-selected","onMouseenter","onClick"],w5=["src"],k5={class:"search-item-text"},D5={class:"search-item-name"},T5={class:"search-item-group"},N5={key:1,class:"search-empty"},M5={class:"search-box",role:"combobox","aria-expanded":"true"},R5=La(()=>c("span",{class:"material-icons-outlined search-icon"},"search",-1)),x5=La(()=>c("span",{class:"material-icons-outlined"},"close",-1)),O5=[x5],L5=["aria-label","aria-expanded"],F5={class:"material-icons-outlined"},H5={__name:"SearchBar",props:{mapDataList:Array,communityParkings:{type:Array,default:()=>[]}},emits:["select"],setup(n,{emit:e}){const t=n,o=e,i=E(!1),s=E(""),r=E(-1),l=$(()=>s.value?I5(t.mapDataList,s.value,15,t.communityParkings):[]);K(s,()=>{r.value=-1});const a=()=>{i.value=!i.value,i.value||(s.value="")},d=()=>{i.value=!1,s.value=""},u=f=>{o("select",f),d()},h=f=>{if(l.value.length)if(f.key==="ArrowDown")f.preventDefault(),r.value=(r.value+1)%l.value.length;else if(f.key==="ArrowUp")f.preventDefault(),r.value=(r.value-1+l.value.length)%l.value.length;else if(f.key==="Enter"){f.preventDefault();const b=r.value>=0?r.value:0;u(l.value[b])}else f.key==="Escape"&&d()};return(f,b)=>(_(),C("div",{class:oe(["search-wrap",{open:i.value}])},[i.value&&l.value.length?(_(),C("ul",B5,[(_(!0),C(ye,null,Ve(l.value,(g,I)=>(_(),C("li",{key:I,class:oe(["search-item",{active:I===r.value}]),role:"option","aria-selected":I===r.value,onMouseenter:D=>r.value=I,onClick:D=>u(g)},[g.icon?(_(),C("img",{key:0,src:O(q)(g.icon),class:"search-item-icon",alt:""},null,8,w5)):W("",!0),c("div",k5,[c("div",D5,w(g.name),1),c("div",T5,w(g.groupName),1)])],42,S5))),128))])):i.value&&s.value&&!l.value.length?(_(),C("div",N5," 找不到「"+w(s.value)+"」相關停車場 ",1)):W("",!0),Ge(c("div",M5,[R5,Ge(c("input",{"onUpdate:modelValue":b[0]||(b[0]=g=>s.value=g),class:"search-input",type:"text",placeholder:"搜尋停車場名稱…",autofocus:"",onKeydown:h},null,544),[[St,s.value]]),s.value?(_(),C("button",{key:0,class:"search-clear",onClick:b[1]||(b[1]=g=>s.value=""),"aria-label":"清除"},O5)):W("",!0)],512),[[Bt,i.value]]),c("button",{class:oe(["search-toggle",{active:i.value}]),onClick:a,"aria-label":i.value?"關閉搜尋":"開啟搜尋","aria-expanded":i.value},[c("span",F5,w(i.value?"close":"search"),1)],10,L5)],2))}},z5=ln(H5,[["__scopeId","data-v-2b0f75f6"]]),Mn=n=>(Dn("data-v-95843aaa"),n=n(),Tn(),n),V5={class:"editor-body"},W5={key:0,class:"editor-note override-note"},j5=Mn(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),G5={key:1,class:"editor-note"},K5=Mn(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),Q5={class:"form-group"},X5={class:"form-label"},Y5={key:0},q5={key:1,class:"hint-inline"},J5=["readonly","disabled"],$5={class:"form-group"},Z5=Mn(()=>c("label",{class:"form-label"},"類別",-1)),ep=["value"],np={class:"form-group"},tp={class:"form-label"},op={key:0,class:"hint-inline"},ip=["disabled"],sp=["value"],rp={class:"form-group"},lp=Mn(()=>c("label",{class:"form-label"},"收費",-1)),ap={class:"chip-row"},cp=["onClick"],dp={key:0,class:"price-amount"},hp={class:"unit"},up={key:1,class:"price-amount"},pp={class:"form-group"},mp=Mn(()=>c("label",{class:"form-label"},"說明(選填)",-1)),fp={class:"form-group"},yp=Mn(()=>c("label",{class:"form-label"},"暱稱(選填)",-1)),bp=["value"],gp={key:2,class:"error-msg"},Ap={key:3,class:"form-group history-section"},_p={class:"form-label"},vp=Mn(()=>c("span",{class:"material-icons-outlined",style:{"font-size":"14px","vertical-align":"-2px"}},"history",-1)),Cp={class:"history-list"},Pp={class:"h-row1"},Up={class:"h-by"},Ep={class:"h-time"},Ip={key:0,class:"h-diff h-diff-note"},Bp={key:1,class:"h-diff-list"},Sp={class:"h-diff-label"},wp={class:"h-diff-old"},kp=Mn(()=>c("span",{class:"h-diff-arrow"},"→",-1)),Dp={class:"h-diff-new"},Tp={key:2,class:"h-diff h-diff-note"},Np=["disabled"],Mp=["disabled"],Rp=["disabled"],xp=["disabled"],Op={__name:"CommunityParkingEditor",props:{open:Boolean,mode:{type:String,default:"add"},initial:{type:Object,default:null},defaultCoord:{type:Array,default:()=>[121.5173399,25.0475613]},nickname:{type:String,default:""},isOwner:{type:Boolean,default:!1},isAdmin:{type:Boolean,default:!1},submitting:{type:Boolean,default:!1},hasExistingOverride:{type:Boolean,default:!1},history:{type:Array,default:()=>[]}},emits:["update:open","update:nickname","submit","delete","reset"],setup(n,{emit:e}){const t=n,o=e,i=E(""),s=E(""),r=E("motorcycle"),l=E("friendly"),a=E("free"),d=E(""),u=E(""),h=E([null,null]),f=$(()=>ht.filter(v=>v.value)),b=$(()=>Qt.filter(v=>v.value)),g={greenStar:"icon-14.png",friendlyShop:"icon-4.png",greenP:"icon-15.png",greyP:"icon-16.png",blueP:"icon-17.png",purpleP:"icon-18.png",redX:"icon-19.png",unknown:"icon-20.png"},I=$(()=>{if(g[r.value])return g[r.value];const v=ht.find(ue=>ue.value===r.value),M=Qt.find(ue=>ue.value===l.value);return v?M&&v.key.find(ue=>M.key.includes(ue))||v.key[0]:"icon-3.png"}),D=$(()=>!!g[r.value]);function U(v){if(!v)return{type:"free",amount:"",custom:""};const M=v.trim();if(/^free$/i.test(M))return{type:"free",amount:"",custom:""};const S=M.match(/^(\d+(?:\.\d+)?)\s*\/\s*([hd次])$/i);return S?{type:S[2].toLowerCase(),amount:S[1],custom:""}:{type:"custom",amount:"",custom:M}}function j(){return a.value==="free"?"Free":a.value==="custom"?u.value.trim():d.value?`${d.value}/${a.value}`:""}const T=()=>{if((t.mode==="edit"||t.mode==="override")&&t.initial){i.value=t.initial.name||"",s.value=t.initial.description||"",r.value=t.initial.category||"motorcycle",l.value=t.initial.friendliness||"friendly";const v=U(t.initial.priceInfo||"");a.value=v.type,d.value=v.amount,u.value=v.custom,h.value=t.initial.coordinates?[...t.initial.coordinates]:[...t.defaultCoord]}else i.value="",s.value="",r.value="motorcycle",l.value="friendly",a.value="free",d.value="",u.value="",h.value=[...t.defaultCoord]};K(()=>t.open,v=>{v&&T()});const V=E(""),Pe=()=>{if(V.value="",!i.value.trim()){V.value="請輸入名稱";return}if(h.value[0]==null||h.value[1]==null||Number.isNaN(Number(h.value[0]))||Number.isNaN(Number(h.value[1]))){V.value="座標無效";return}o("submit",{name:i.value,description:s.value,iconKey:I.value,category:r.value,friendliness:D.value?"":l.value,priceInfo:j(),coordinates:[Number(h.value[0]),Number(h.value[1])]})},ce=()=>{var v;(v=t.initial)!=null&&v.id&&window.confirm(`確定要刪除「${i.value}」?此動作無法復原。`)&&o("delete",t.initial.id)},Se=()=>{window.confirm(`確定要重設「${i.value}」回官方原始資料嗎?
你和其他車友先前的修改將被移除。`)&&o("reset")},Ue=$({get:()=>t.open,set:v=>o("update:open",v)}),Ye=[{value:"free",label:"免費"},{value:"h",label:"計時 / 小時"},{value:"d",label:"計次 / 天"},{value:"次",label:"計次 / 不限時"},{value:"custom",label:"其他"}],he=E(!1),le=$(()=>!t.history||t.history.length===0?[]:he.value?t.history:t.history.slice(0,5)),Te={create:"新增",update:"修改",delete:"刪除",override:"覆寫",reset:"重設"};function We(v){return Te[v]||v||"變更"}function P(v){return v?v.nickname||(v.id?`匿名#${v.id}`:"匿名"):"系統"}function R(v){if(!v||!isFinite(Number(v)))return"";const M=new Date(Number(v)),S=ue=>String(ue).padStart(2,"0");return`${M.getFullYear()}/${S(M.getMonth()+1)}/${S(M.getDate())} ${S(M.getHours())}:${S(M.getMinutes())}`}const X={name:"名稱",description:"說明",iconKey:"圖示",category:"類別",friendliness:"友善度",priceInfo:"收費",lng:"經度",lat:"緯度"};function G(v){if(v==null||v==="")return"(空)";if(typeof v=="number")return String(v);const M=String(v);return M.length>40?M.slice(0,40)+"…":M}function J(v){return v==null?"":typeof v=="string"?v.trim():String(v)}function ie(v){return J(v)===""}function Le(v,M){if(!v||v.action==="delete"||v.action==="reset")return[];if(v.after&&typeof v.after=="object")return Object.keys(v.after).filter(x=>{var ge;const z=(ge=v.before)==null?void 0:ge[x],se=v.after[x];return!(ie(z)&&ie(se)||J(z)===J(se)||ie(z))}).map(x=>{var z;return{label:X[x]||x,before:G((z=v.before)==null?void 0:z[x]),after:G(v.after[x]),hasBefore:!0}});const S=v.snapshot;if(!S||typeof S!="object")return[];const ue=new Set(["createdAt","createdBy","updatedAt","updatedBy","origName","origLng","origLat","history"]),Ne=t.history.findIndex(Me=>Me._key===v._key),we=Ne>=0?t.history[Ne+1]:null,qe=we?we.after&&typeof we.after=="object"?{...we.before||{},...we.after}:we.snapshot||null:null,Je=[];for(const Me of Object.keys(S)){if(ue.has(Me))continue;const x=S[Me];if(qe&&Object.prototype.hasOwnProperty.call(qe,Me)){const z=qe[Me];if(J(z)===J(x)||ie(z))continue;Je.push({label:X[Me]||Me,before:G(z),after:G(x),hasBefore:!0})}}return Je}function be(v){return(v==null?void 0:v.action)==="delete"?"該項目被刪除":(v==null?void 0:v.action)==="reset"?"重設為官方資料":(v==null?void 0:v.action)==="create"?"新增此停車點":""}return(v,M)=>(_(),Wi(Cn,{modelValue:Ue.value,"onUpdate:modelValue":M[9]||(M[9]=S=>Ue.value=S),title:n.mode==="override"?"修改官方停車點":n.mode==="edit"?"編輯停車場":"新增停車場",size:"md"},{footer:Ze(()=>[n.mode==="edit"&&n.isOwner?(_(),C("button",{key:0,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:ce}," 刪除 ",8,Np)):W("",!0),n.mode==="override"&&n.hasExistingOverride&&n.isAdmin?(_(),C("button",{key:1,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:Se,title:"僅站方可使用"}," 重設為官方資料 ",8,Mp)):W("",!0),c("button",{class:"btn btn-outline",disabled:n.submitting,onClick:M[8]||(M[8]=S=>Ue.value=!1)}," 取消 ",8,Rp),c("button",{class:"btn btn-primary",disabled:n.submitting,onClick:Pe},w(n.submitting?"送出中…":n.mode==="override"||n.mode==="edit"?"儲存修改":"新增"),9,xp)]),default:Ze(()=>[c("div",V5,[n.mode==="override"?(_(),C("p",W5,[j5,k(" 你正在「修改官方停車點」:這層修改只會疊加在官方資料之上,不會覆蓋原始資料。所有車友都會看到你的修改,也可以再被其他人修改或重設。 ")])):(_(),C("p",G5,[K5,k(" 共筆停車點:任何人都可以新增或修改。請確認資訊正確、避免不雅內容。 ")])),c("section",Q5,[c("label",X5,[k(" 名稱 "),n.mode!=="override"?(_(),C("span",Y5,"*")):W("",!0),n.mode==="override"?(_(),C("span",q5,"(官方名稱不可修改)")):W("",!0)]),Ge(c("input",{"onUpdate:modelValue":M[0]||(M[0]=S=>i.value=S),class:"form-control",type:"text",placeholder:"例:三張里地下停車場",maxlength:"60",readonly:n.mode==="override",disabled:n.mode==="override"},null,8,J5),[[St,i.value]])]),c("section",$5,[Z5,Ge(c("select",{"onUpdate:modelValue":M[1]||(M[1]=S=>r.value=S),class:"form-control"},[(_(!0),C(ye,null,Ve(f.value,S=>(_(),C("option",{key:S.value,value:S.value},w(S.name),9,ep))),128))],512),[[Gs,r.value]])]),c("section",np,[c("label",tp,[k(" 友善程度 "),D.value?(_(),C("span",op,"(此類別不適用)")):W("",!0)]),Ge(c("select",{"onUpdate:modelValue":M[2]||(M[2]=S=>l.value=S),class:"form-control",disabled:D.value},[(_(!0),C(ye,null,Ve(b.value,S=>(_(),C("option",{key:S.value,value:S.value},w(S.name),9,sp))),128))],8,ip),[[Gs,l.value]])]),c("section",rp,[lp,c("div",ap,[(_(),C(ye,null,Ve(Ye,S=>c("button",{key:S.value,type:"button",class:oe(["chip",{active:a.value===S.value}]),onClick:ue=>a.value=S.value},w(S.label),11,cp)),64))]),a.value==="h"||a.value==="d"||a.value==="次"?(_(),C("div",dp,[Ge(c("input",{"onUpdate:modelValue":M[3]||(M[3]=S=>d.value=S),type:"number",min:"0",step:"1",class:"form-control compact",placeholder:"金額"},null,512),[[St,d.value]]),c("span",hp," 元 / "+w(a.value==="h"?"小時":a.value==="d"?"天":"次 (不限時)"),1)])):a.value==="custom"?(_(),C("div",up,[Ge(c("input",{"onUpdate:modelValue":M[4]||(M[4]=S=>u.value=S),type:"text",class:"form-control",placeholder:"如:平日 30/h、假日 50/d",maxlength:"40"},null,512),[[St,u.value]])])):W("",!0)]),c("section",pp,[mp,Ge(c("textarea",{"onUpdate:modelValue":M[5]||(M[5]=S=>s.value=S),class:"form-control",rows:"3",placeholder:"後牌辨析、24h、注意事項...",maxlength:"500"},null,512),[[St,s.value]])]),c("section",fp,[yp,c("input",{value:n.nickname,onInput:M[6]||(M[6]=S=>o("update:nickname",S.target.value)),class:"form-control",type:"text",placeholder:"留空將顯示「匿名#xxx-xxx」",maxlength:"20"},null,40,bp)]),V.value?(_(),C("p",gp,w(V.value),1)):W("",!0),n.history.length?(_(),C("section",Ap,[c("label",_p,[vp,k(" 修改紀錄 ("+w(n.history.length)+") ",1)]),c("ul",Cp,[(_(!0),C(ye,null,Ve(le.value,(S,ue)=>(_(),C("li",{key:S._key,class:"history-item"},[c("div",Pp,[c("span",{class:oe(["h-action",`h-action-${S.action||"other"}`])},w(We(S.action)),3),c("span",Up,w(P(S.by)),1),c("span",Ep,w(R(S.at)),1)]),be(S)?(_(),C("div",Ip,w(be(S)),1)):Le(S,ue).length?(_(),C("ul",Bp,[(_(!0),C(ye,null,Ve(Le(S,ue),(Ne,we)=>(_(),C("li",{key:we,class:"h-diff-item"},[c("span",Sp,w(Ne.label),1),Ne.hasBefore?(_(),C(ye,{key:0},[c("span",wp,w(Ne.before),1),kp],64)):W("",!0),c("span",Dp,w(Ne.after),1)]))),128))])):(_(),C("div",Tp,"(與上一筆相同)"))]))),128))]),n.history.length>5?(_(),C("button",{key:0,type:"button",class:"history-toggle",onClick:M[7]||(M[7]=S=>he.value=!he.value)},w(he.value?"收起":`顯示全部 ${n.history.length} 筆`),1)):W("",!0)])):W("",!0)])]),_:1},8,["modelValue","title"]))}},Lp=ln(Op,[["__scopeId","data-v-95843aaa"]]),Fp={class:"tour-card-head"},Hp={class:"tour-step-index"},zp={class:"tour-title"},Vp={key:0,class:"material-icons-outlined"},Wp={class:"tour-desc"},jp={class:"tour-actions"},Gp={key:0,class:"material-icons-outlined"},Kp={key:1,class:"material-icons-outlined"},_n=8,Qp=12,Gr=300,so=16,Xp={__name:"OnboardingTour",props:{active:{type:Boolean,default:!1},steps:{type:Array,required:!0}},emits:["update:active","finish"],setup(n,{emit:e}){const t=n,o=e,i=E(0),s=E(null),r=E(!1),l=$(()=>t.steps[i.value]||null),a=$(()=>i.value>=t.steps.length-1),d=async()=>{await qr();const U=l.value;if(!U){s.value=null;return}const j=U.selector?document.querySelector(U.selector):null;if(!j){s.value=null;return}const T=j.getBoundingClientRect();if(T.width===0&&T.height===0){s.value=null;return}s.value={top:T.top,left:T.left,width:T.width,height:T.height}},u=async()=>{for(let U=0;U<8;U++){if(await d(),s.value)return;await new Promise(j=>setTimeout(j,150))}};K(()=>[t.active,i.value],async([U])=>{if(!U){r.value=!1;return}r.value=!1,await u(),r.value=!0},{immediate:!0});const h=()=>d();Kn(()=>{window.addEventListener("resize",h),window.addEventListener("scroll",h,!0)}),ut(()=>{window.removeEventListener("resize",h),window.removeEventListener("scroll",h,!0)});const f=$(()=>{const U=s.value;return U?{top:U.top-_n+"px",left:U.left-_n+"px",width:U.width+_n*2+"px",height:U.height+_n*2+"px",borderRadius:Qp+"px"}:{display:"none"}}),b=$(()=>{var he;const U=s.value,j=window.innerWidth,T=window.innerHeight;if(!U)return{top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:Math.min(Gr,j-32)+"px"};const V=((he=l.value)==null?void 0:he.placement)||"auto";let Pe=V;if(V==="auto"){const le=T-(U.top+U.height),Te=U.top;Pe=le>=Te?"bottom":"top"}const ce=Math.min(Gr,j-32);let Se,Ue,Ye="";return Pe==="bottom"?(Se=U.top+U.height+so+_n,Ue=Math.max(16,Math.min(j-ce-16,U.left+U.width/2-ce/2))):Pe==="top"?(Se=U.top-so-_n,Ue=Math.max(16,Math.min(j-ce-16,U.left+U.width/2-ce/2)),Ye="translateY(-100%)"):Pe==="right"?(Se=Math.max(16,U.top+U.height/2),Ue=U.left+U.width+so+_n,Ye="translateY(-50%)"):(Se=Math.max(16,U.top+U.height/2),Ue=U.left-so-_n,Ye="translate(-100%, -50%)"),{top:Se+"px",left:Ue+"px",width:ce+"px",transform:Ye}}),g=()=>{a.value?D():i.value+=1},I=()=>D(),D=()=>{o("update:active",!1),o("finish"),i.value=0};return K(()=>t.active,U=>{U&&(i.value=0)}),(U,j)=>n.active&&l.value?(_(),C("div",{key:0,class:oe(["tour-root",{"is-ready":r.value}])},[c("div",{class:"tour-spotlight",style:uo(f.value)},null,4),c("div",{class:"tour-backdrop",onClick:ji(g,["self"])}),c("div",{class:"tour-card",style:uo(b.value),role:"dialog","aria-modal":"true"},[c("div",Fp,[c("span",Hp,w(i.value+1)+" / "+w(n.steps.length),1),c("button",{class:"tour-skip",onClick:I,"aria-label":"略過導覽"},"略過")]),c("h3",zp,[l.value.icon?(_(),C("span",Vp,w(l.value.icon),1)):W("",!0),k(" "+w(l.value.title),1)]),c("p",Wp,w(l.value.description),1),c("div",jp,[c("button",{class:"btn btn-primary tour-next",onClick:g},[k(w(a.value?"完成":"下一步")+" ",1),a.value?(_(),C("span",Kp,"check")):(_(),C("span",Gp,"arrow_forward"))])])],4)],2)):W("",!0)}},Yp=ln(Xp,[["__scopeId","data-v-1d730a34"]]),Pn="community_parkings",Fi=E([]),Fa=E(!1),Hi=E(null);let xt=null,ui=0;function qp(){if(!(!cn||xt))try{const n=Jh(en(Ke,Pn),qh("updatedAt"));xt=n,Ma(n,e=>{const t=[];e.forEach(o=>{var s,r;const i=o.val()||{};t.push({id:o.key,name:i.name||"",description:i.description||"",iconKey:i.iconKey||"icon-3.png",category:i.category||"",friendliness:i.friendliness||"",priceInfo:i.priceInfo||"",coordinates:[(s=i.lng)!=null?s:null,(r=i.lat)!=null?r:null],createdBy:i.createdBy||null,updatedBy:i.updatedBy||null,createdAt:i.createdAt||null,updatedAt:i.updatedAt||null,history:$p(i.history)})}),Fi.value=t.reverse(),Fa.value=!0},e=>{Hi.value=e})}catch(n){Hi.value=n}}function Jp(){xt&&(Ra(xt),xt=null)}function $p(n){return!n||typeof n!="object"?[]:Object.entries(n).map(([e,t])=>({...t||{},_key:e})).sort((e,t)=>e._key<t._key?1:e._key>t._key?-1:0)}function Zp(){return Kn(()=>{ui+=1,qp()}),ut(()=>{ui-=1,ui<=0&&Jp()}),{items:Fi,ready:Fa,error:Hi,addParking:async(o,i)=>{var f,b,g;if(!cn)throw new Error("Firebase 尚未設定");const[s,r]=o.coordinates,a=lo(en(Ke,Pn)).key,d={id:i.id,nickname:i.nickname||""},u={name:((f=o.name)==null?void 0:f.trim())||"",description:((b=o.description)==null?void 0:b.trim())||"",iconKey:o.iconKey||"icon-3.png",category:o.category||"",friendliness:o.friendliness||"",priceInfo:((g=o.priceInfo)==null?void 0:g.trim())||"",lng:Number(s),lat:Number(r),createdBy:d,createdAt:Fn(),updatedBy:d,updatedAt:Fn()},h=lo(en(Ke,`${Pn}/${a}/history`)).key;return await Ri(en(Ke),{[`${Pn}/${a}`]:{...u,history:{[h]:{action:"create",at:Fn(),by:d,snapshot:u}}}}),a},updateParking:async(o,i,s)=>{var g,I,D,U,j;if(!cn)throw new Error("Firebase 尚未設定");const r={id:s.id,nickname:s.nickname||""},l=Fi.value.find(T=>T.id===o)||{},a={};if(i.name!==void 0&&(a.name=((g=i.name)==null?void 0:g.trim())||""),i.description!==void 0&&(a.description=((I=i.description)==null?void 0:I.trim())||""),i.iconKey!==void 0&&(a.iconKey=i.iconKey),i.category!==void 0&&(a.category=i.category),i.friendliness!==void 0&&(a.friendliness=i.friendliness),i.priceInfo!==void 0&&(a.priceInfo=((D=i.priceInfo)==null?void 0:D.trim())||""),i.coordinates){const[T,V]=i.coordinates;a.lng=Number(T),a.lat=Number(V)}const d={},u={};for(const T of Object.keys(a)){let V;T==="lng"?V=(U=l.coordinates)==null?void 0:U[0]:T==="lat"?V=(j=l.coordinates)==null?void 0:j[1]:V=l[T];const Pe=V==null?"":V,ce=a[T]===void 0||a[T]===null?"":a[T];Pe!==ce&&(d[T]=V!=null?V:"",u[T]=a[T])}const h={...a,updatedBy:r,updatedAt:Fn()},f=lo(en(Ke,`${Pn}/${o}/history`)).key,b={};for(const T of Object.keys(h))b[`${Pn}/${o}/${T}`]=h[T];return b[`${Pn}/${o}/history/${f}`]={action:"update",at:Fn(),by:r,before:d,after:u},Ri(en(Ke),b)},deleteParking:async o=>{if(!cn)throw new Error("Firebase 尚未設定");return Na(en(Ke,`${Pn}/${o}`))}}}var em={VITE_FIREBASE_DATABASE_URL:"https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app",VITE_FIREBASE_MESSAGING_SENDER_ID:"976769533420",VITE_FIREBASE_MEASUREMENT_ID:"G-XMR8C87T1P",VITE_FIREBASE_STORAGE_BUCKET:"findparkinglot-2519e.firebasestorage.app",VITE_FIREBASE_AUTH_DOMAIN:"findparkinglot-2519e.firebaseapp.com",VITE_MAPBOX_TOKEN:"pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",VITE_FIREBASE_PROJECT_ID:"findparkinglot-2519e",VITE_FIREBASE_APP_ID:"1:976769533420:web:f3108318b3def30017acc9",VITE_FIREBASE_API_KEY:"AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs",BASE_URL:"./",MODE:"production",DEV:!1,PROD:!0,SSR:!1};const Ha="community_user_id",za="community_user_nickname",nm="community_is_admin",tm=String(em.VITE_ADMIN_USER_IDS||"").split(",").map(n=>n.trim()).filter(Boolean);function om(){const n=e=>Array.from(crypto.getRandomValues(new Uint8Array(e))).map(t=>t.toString(16).padStart(2,"0")).join("");return`${n(2)}-${n(2)}`}let ho=tn.get(Ha);ho||(ho=om(),tn.set(Ha,ho));const zi=ho,Vi=E(tn.get(za)||""),im=tm.includes(zi)||tn.get(nm)==="1";K(Vi,n=>tn.set(za,n||""));function sm(){return{userId:zi,nickname:Vi,displayName:()=>{var e;return((e=Vi.value)==null?void 0:e.trim())||`匿名#${zi}`},isAdmin:im}}const rm=()=>typeof window!="undefined"&&typeof window.gtag=="function",fe=(n,e={})=>{if(rm())try{window.gtag("event",n,e)}catch(t){}},B=n=>(Dn("data-v-da60fa10"),n=n(),Tn(),n),lm={class:"app-title"},am=["aria-label","aria-expanded"],cm={class:"material-icons-outlined"},dm={key:1,class:"title-logo",src:Gi,alt:"重機能停哪"},hm=B(()=>c("h1",null,"重機能停哪?",-1)),um=B(()=>c("pre",{id:"coordinates",class:"coordinates"},null,-1)),pm=B(()=>c("h4",{class:"modal-section-title"},"圖案代表甚麼格位",-1)),mm={class:"legend-list"},fm={class:"legend-row"},ym=["src"],bm={class:"legend-row"},gm=["src"],Am={class:"legend-row"},_m=["src"],vm={class:"legend-row"},Cm=["src"],Pm={class:"legend-row"},Um=["src"],Em={class:"legend-row"},Im=["src"],Bm={class:"legend-row"},Sm=["src"],wm={class:"legend-row"},km=["src"],Dm={class:"legend-row"},Tm=["src"],Nm={class:"legend-row"},Mm=["src"],Rm={class:"legend-row"},xm=["src"],Om=B(()=>c("h4",{class:"modal-section-title"},"顏色代表入場方式",-1)),Lm={class:"legend-list"},Fm={class:"legend-row"},Hm=["src"],zm=["src"],Vm=["src"],Wm={class:"legend-row"},jm=["src"],Gm=["src"],Km=["src"],Qm={class:"legend-row"},Xm=["src"],Ym=["src"],qm=["src"],Jm={class:"legend-row"},$m=["src"],Zm=["src"],e4=["src"],n4=B(()=>c("h4",{class:"modal-section-title"},"名稱前有價錢",-1)),t4={class:"legend-list"},o4={class:"legend-row"},i4=["src"],s4=B(()=>c("div",{class:"legend-row"},[c("div",{class:"legend-text"},[k(" ・數字:金額,時段費率複雜會以最高收費標示"),c("br"),k(" ・d/h:d 為計次,h 為計時"),c("br"),k(" ・Free 代表免費 ")])],-1)),r4={class:"share-grid"},l4=B(()=>c("img",{src:$r,alt:""},null,-1)),a4=B(()=>c("span",null,"Facebook",-1)),c4=[l4,a4],d4=B(()=>c("img",{src:Zr,alt:""},null,-1)),h4=B(()=>c("span",null,"LINE",-1)),u4=[d4,h4],p4=B(()=>c("img",{src:el,alt:""},null,-1)),m4=B(()=>c("span",null,"Twitter",-1)),f4=[p4,m4],y4=B(()=>c("img",{src:nl,alt:""},null,-1)),b4=B(()=>c("span",null,"複製連結",-1)),g4=[y4,b4],A4={class:"modal-hint",style:{"word-break":"break-all"}},_4={class:"share-grid"},v4=B(()=>c("img",{src:$r,alt:""},null,-1)),C4=B(()=>c("span",null,"Facebook",-1)),P4=[v4,C4],U4=B(()=>c("img",{src:Zr,alt:""},null,-1)),E4=B(()=>c("span",null,"LINE",-1)),I4=[U4,E4],B4=B(()=>c("img",{src:el,alt:""},null,-1)),S4=B(()=>c("span",null,"Twitter",-1)),w4=[B4,S4],k4=B(()=>c("img",{src:nl,alt:""},null,-1)),D4=B(()=>c("span",null,"複製連結",-1)),T4=[k4,D4],N4=B(()=>c("p",{class:"modal-hint"}," 若覺得本站有幫助，歡迎透過以下任一方式贊助，讓我有動力繼續維護更新！ ",-1)),M4={class:"support-list"},R4=["onClick"],x4={class:"material-icons-outlined support-btn-icon"},O4={class:"support-btn-body"},L4={class:"support-btn-label"},F4={key:0,class:"support-btn-badge"},H4={class:"support-btn-desc"},z4=B(()=>c("span",{class:"material-icons-outlined support-btn-arrow"},"open_in_new",-1)),V4={class:"os-tabs",role:"tablist","aria-label":"作業系統"},W4=["aria-selected"],j4=B(()=>c("span",{class:"material-icons-outlined"},"phone_iphone",-1)),G4=["aria-selected"],K4=B(()=>c("span",{class:"material-icons-outlined"},"android",-1)),Q4=B(()=>c("p",{class:"modal-hint"},"以下以 iOS Safari 為範例",-1)),X4=B(()=>c("h4",{class:"modal-section-title"},"1. 使用 Safari 開啟網站並點擊下方分享按鈕",-1)),Y4=B(()=>c("img",{class:"full-img",src:fc,alt:""},null,-1)),q4=B(()=>c("h4",{class:"modal-section-title"},"2. 點選「加入主畫面」",-1)),J4=B(()=>c("img",{class:"full-img",src:yc,alt:""},null,-1)),$4=B(()=>c("h4",{class:"modal-section-title"},"3. 確認名稱後按「加入」",-1)),Z4=B(()=>c("img",{class:"full-img",src:bc,alt:""},null,-1)),ef=B(()=>c("h4",{class:"modal-section-title"},"4. 完成,圖示已加到主畫面",-1)),nf=B(()=>c("img",{class:"full-img",src:gc,alt:""},null,-1)),tf=B(()=>c("h4",{class:"modal-section-title"},"5. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),of=B(()=>c("img",{class:"full-img",src:Ac,alt:""},null,-1)),sf=B(()=>c("p",{class:"modal-hint"},"以下以 Android Chrome 為範例",-1)),rf=B(()=>c("h4",{class:"modal-section-title"},"1. 使用 Chrome 開啟網站並點擊右上角選單，點選「加到主畫面」",-1)),lf=B(()=>c("img",{class:"full-img",src:_c,alt:""},null,-1)),af=B(()=>c("h4",{class:"modal-section-title"},"2. 點選「安裝」",-1)),cf=B(()=>c("img",{class:"full-img",src:vc,alt:""},null,-1)),df=B(()=>c("h4",{class:"modal-section-title"},"3. 完成,圖示已加到主畫面",-1)),hf=B(()=>c("img",{class:"full-img",src:Cc,alt:""},null,-1)),uf=B(()=>c("h4",{class:"modal-section-title"},"4. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),pf=B(()=>c("img",{class:"full-img",src:Pc,alt:""},null,-1)),mf=B(()=>c("div",{class:"welcome-logo-wrap"},[c("img",{class:"welcome-logo",src:Gi,alt:"重機能停哪"})],-1)),ff=B(()=>c("div",{class:"welcome-badge"},"✨ 全新介面上線",-1)),yf=B(()=>c("p",{class:"welcome-text"}," 這是一個提供重機停車資訊的地圖，你可以依據「友善程度」「停車格類型」「收費範圍」尋找合適的停車場，並一鍵開啟 Google 或 Apple Map 導航。 ",-1)),bf=B(()=>c("div",{class:"whatsnew-card"},[c("div",{class:"whatsnew-title"},[c("span",{class:"material-icons-outlined"},"auto_awesome"),k(" 本次新功能 ")]),c("ul",{class:"whatsnew-list"},[c("li",null,[c("span",{class:"material-icons-outlined"},"star"),c("span",null,[c("strong",null,"我的最愛"),c("br"),k(" 可以將喜歡的停車場加入我的最愛")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"search"),c("span",null,[c("strong",null,"地點搜尋"),c("br"),k(" 可以搜尋指定的停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_location_alt"),c("span",null,[c("strong",null,"共筆停車點"),c("br"),k(" 可自由新增、編輯, 大家一起分享停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_note"),c("span",null,[c("strong",null,"官方點異議 / 補充"),c("br"),k(" 點開任一官方停車點 → 「異議 / 補充」, 可在不改動原始資料的前提下, 補上實際費率、更正分類或加註說明, 全車友共享")])])])],-1)),gf=B(()=>c("p",{class:"welcome-text"},[k(" 資料取源於: "),c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"link"},"Alan大重停車記事"),k("，如有停車場相關問題請至該頁面填寫回報表單。 ")],-1)),Af=B(()=>c("p",{class:"welcome-text"},' 公告: 原始資料"大重停車記事已無更新" 已改由 Alan大重停車記事 提供，感謝Alan的辛苦整理與分享！ ',-1)),_f=B(()=>c("p",{class:"welcome-text"},[k(" 本站僅提供資料整合服務，地圖免費提供車友使用，資料不定期更新；若發生無法使用情況，請至 "),c("a",{href:"https://forms.gle/iJCyfqVtpL35WtZM7",target:"_blank",rel:"noopener",class:"link"},"錯誤資訊回報"),k("，也歡迎贊助讓我有動力繼續更新。 ")],-1)),vf=B(()=>c("p",{class:"welcome-text right"},"— by 爽爽",-1)),Cf={key:0,class:"pick-crosshair","aria-hidden":"true"},Pf=B(()=>c("span",{class:"material-icons-outlined dot"},"gps_fixed",-1)),Uf=[Pf],Ef={key:1,class:"pick-banner"},If=B(()=>c("span",{class:"pick-banner-text"},[c("span",{class:"material-icons-outlined"},"touch_app"),k(" 拖動地圖，將十字線對準目標位置 ")],-1)),Bf=B(()=>c("span",{class:"material-icons-outlined"},"check",-1)),Sf=B(()=>c("p",{class:"welcome-text"},[c("strong",{style:{color:"var(--primary)"}},"這是一個公開共享的「共筆停車點」區。"),k(" 除了官方收錄的「大重停車記事」資料外,任何人都可以新增、修改、補充停車位置——不需要註冊、不需要審核。 ")],-1)),wf=B(()=>c("h4",{class:"modal-section-title"},"如何新增停車位置",-1)),kf=B(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"點左下角的「共筆停車點」按鈕,再點「新增停車位置」"),c("li",null,"畫面中心會出現青色十字游標,拖動地圖將游標對準目標位置"),c("li",null,"按頂部「使用此位置」,填寫名稱、類別、友善程度、收費等資料"),c("li",null,"按「新增」即完成(座標已自動記錄,圖示會依類別自動套用)")],-1)),Df=B(()=>c("h4",{class:"modal-section-title"},"如何編輯他人新增的位置",-1)),Tf=B(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"地圖上「薰衣草紫色底」的標記即為使用者新增的「共筆停車點」"),c("li",null,"點擊該標記,在資訊面板按「編輯」"),c("li",null,"修改後按「儲存修改」")],-1)),Nf=B(()=>c("h4",{class:"modal-section-title"},"注意事項",-1)),Mf=B(()=>c("ul",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"請確認資訊正確,避免造成他人困擾"),c("li",null,"不要新增不雅、惡意或無關內容"),c("li",null,"暱稱可選填,留空將顯示為「匿名#xxx-xxx」"),c("li",null,"站方保留必要時清空所有「共筆停車點」資料的權利")],-1)),Kr="onboarding_tour_v1",Qr="filters_v1",Rf="https://findparkinglot.github.io/",xf={__name:"App",setup(n){var Fs,Hs,zs;const e=navigator.userAgent,t=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(e),o=/iPhone|iPad|iPod/i.test(e),i=/Android/i.test(e),s=E([]),r=()=>{var p;return!!((p=window.matchMedia)!=null&&p.call(window,"(prefers-color-scheme: light)").matches)},l=p=>{var m;if(p==="system"){const y=r()?"light":"dark";return(m=nt.find(me=>me.theme===y))==null?void 0:m.value}return p},a=nt.find(p=>p.name===tn.get("mapStyles")),d=(a==null?void 0:a.value)||((Fs=nt.find(p=>p.theme==="dark"))==null?void 0:Fs.value),u=E(d),h=E({getLngLat:!1,mapStylesSelected:l(d)}),f=p=>{const m=l(p);h.value.mapStylesSelected=m;const y=nt.find(de=>de.value===m),me=(y==null?void 0:y.theme)==="light";document.body.classList.toggle("light-theme",me),document.body.classList.toggle("dark-theme",!me);const ze=nt.find(de=>de.value===p);ze&&tn.set("mapStyles",ze.name)};f(u.value),K(u,f);const b=(Hs=window.matchMedia)==null?void 0:Hs.call(window,"(prefers-color-scheme: light)");(zs=b==null?void 0:b.addEventListener)==null||zs.call(b,"change",()=>{u.value==="system"&&f("system")});const g=E(!0),I=E(!1),D=E(i?"android":"ios"),U=E(!1),j=E(!1),T=E(!1),V=E(!1),Pe=E(!1),ce=[{selector:".mapboxgl-ctrl-geolocate",icon:"my_location",title:"定位你的位置",description:"點右上角的定位按鈕,地圖會自動移到你目前位置,並追蹤方向。"},{selector:".fab-placement-right > .fab-main",icon:"help_outline",title:"功能與教學",description:"右下角的圓形按鈕展開後,可看到「地圖怎麼看」、「加到手機桌面」、「分享」等功能。"},{selector:".search-toggle",icon:"search",title:"搜尋停車點",description:"右下角的搜尋按鈕可依名稱快速找到想去的停車場,點選結果會自動飛到該位置並開啟資訊。"},{selector:".app-title .title-toggle",icon:"menu",title:"篩選與我的最愛",description:"左上角選單可以調整停車類型、友善程度、收費範圍,以及只顯示我的最愛、切換主題。"},{selector:".fab-placement-left > .fab-main",icon:"add_location_alt",title:"共筆停車點",description:"左下角按鈕可新增/編輯共筆停車點,大家一起分享真實的停車資訊。"}],Se=()=>{Pe.value=!0,fe("onboarding_tour_start")},Ue=()=>{try{localStorage.setItem(Kr,"1")}catch(p){}fe("onboarding_tour_finish")},Ye=()=>{g.value=!1},he=E(!1),le=E(!1),Te=E(!1),We=p=>{p!=="menu"&&(he.value=!1),p!=="info"&&(le.value=!1),p!=="message"&&(g.value=!1),p!=="mobileFAQ"&&(I.value=!1),p!=="faq"&&(U.value=!1),p!=="share"&&(j.value=!1),p!=="communityHelp"&&(T.value=!1),p!=="support"&&(V.value=!1),fe("panel_open",{panel:p})};K(he,p=>p&&We("menu")),K(le,p=>p&&We("info")),K(g,p=>p&&We("message")),K(I,p=>p&&We("mobileFAQ")),K(I,p=>{p&&(i?D.value="android":o&&(D.value="ios"))}),K(U,p=>p&&We("faq")),K(j,p=>p&&We("share")),K(T,p=>p&&We("communityHelp")),K(V,p=>p&&We("support"));const P=[{key:"portaly",url:"https://portaly.cc/findparkinglot/support",label:"Portaly 平台贊助",description:"台幣贊助",icon:"volunteer_activism",primary:!1},{key:"buymeacoffee",url:"https://buymeacoffee.com/jamestim923",label:"Buy Me a Coffee",description:"請我喝杯咖啡 ☕️ (美金贊助)",icon:"local_cafe",primary:!1}],R=()=>{V.value=!0,fe("support_open")},X=p=>{fe("support_click",{provider:p.key}),window.open(p.url,"_blank","noopener,noreferrer")},G=tn.getJSON(Qr,{})||{},J=E(typeof G.parkingType=="string"?G.parkingType:""),ie=E(typeof G.degreeOfFriendliness=="string"?G.degreeOfFriendliness:""),Le=E(typeof G.parkingPriceType=="string"?G.parkingPriceType:""),be=E(typeof G.priceRangeMin=="number"?G.priceRangeMin:0),v=E(typeof G.priceRangeMax=="number"?G.priceRangeMax:100),{favorites:M,favoriteIdSet:S,isFavorite:ue,toggleFavorite:Ne}=ld(),we=E(G.onlyFavorites===!0);K([J,ie,Le,be,v,we],([p,m,y,me,ze,de])=>{tn.setJSON(Qr,{parkingType:p,degreeOfFriendliness:m,parkingPriceType:y,priceRangeMin:me,priceRangeMax:ze,onlyFavorites:de})});const qe=E("driving"),{items:Je,addParking:Me,updateParking:x,deleteParking:z}=Zp(),{userId:se,nickname:ge,isAdmin:Fe}=sm(),pe=E(null),{overrides:yn,getOverride:ke,getOverrideHistory:bt,upsertOverride:Go,resetOverride:Ko}=pu(),eo=$(()=>new Set(Object.keys(yn.value||{}))),$e=E(!1),bn=E("add"),gn=E(null),hn=E(!1),gt=E([121.5173399,25.0475613]),Ts=E(!1),an=E(!1),Qo=E(!1),Ns=$(()=>!le.value&&!Te.value&&!an.value&&!$e.value),Ms=()=>{Qo.value&&Ns.value&&(Qo.value=!1,Se())};K(g,(p,m)=>{if(m&&!p)try{localStorage.getItem(Kr)||(Qo.value=!0,setTimeout(Ms,350))}catch(y){}}),K(Ns,p=>{p&&setTimeout(Ms,200)});const Va=$(()=>{var p;if(!$e.value)return[];if(bn.value==="override")return je.value?bt(je.value.name,je.value.geometry):[];if(bn.value==="edit"&&((p=gn.value)!=null&&p.id)){const m=(Je.value||[]).find(y=>y.id===gn.value.id);return(m==null?void 0:m.history)||[]}return[]}),He=E(null),Wa=()=>{if(!cn){alert("「共筆停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}an.value=!0,fe("community_add_start")},ja=()=>{var m,y;const p=((y=(m=pe.value)==null?void 0:m.getCenter)==null?void 0:y.call(m))||[121.5173399,25.0475613];gt.value=p,bn.value="add",gn.value=null,an.value=!1,$e.value=!0},Ga=()=>{an.value=!1},Ka=p=>{var m,y;gt.value=p.coordinates?[...p.coordinates]:((y=(m=pe.value)==null?void 0:m.getCenter)==null?void 0:y.call(m))||[121.5173399,25.0475613],bn.value="edit",gn.value=p,$e.value=!0},Xo=p=>{He.value=p,qn({name:"共筆停車點",properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.coordinates,address:""})},Qa=()=>{He.value&&(le.value=!1,Ka(He.value))},Xa=()=>{if(!cn){alert("「修改官方停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}if(!je.value)return;const p=je.value,m=no.value,y={id:null,name:p.name,description:(m==null?void 0:m.description)||p.description,iconKey:(m==null?void 0:m.iconKey)||p.iconKey,category:(m==null?void 0:m.category)||Ya(p.iconKey),friendliness:(m==null?void 0:m.friendliness)||qa(p.iconKey),priceInfo:(m==null?void 0:m.priceInfo)||p.priceInfo,coordinates:p.geometry?[...p.geometry]:[...gt.value]};gt.value=y.coordinates,bn.value="override",gn.value=y,Ts.value=!!m,le.value=!1,$e.value=!0,fe("override_edit_start",{name:p.name})};function Ya(p){if(!p)return"motorcycle";const m=ht.find(y=>y.value&&y.key.includes(p));return(m==null?void 0:m.value)||"motorcycle"}function qa(p){if(!p)return"friendly";const m=Qt.find(y=>y.value&&y.key.includes(p));return(m==null?void 0:m.value)||"friendly"}const Ja=async p=>{if(je.value){hn.value=!0;try{const m={id:se,nickname:ge.value};await Go(je.value,p,m),fe("override_submit",{name:je.value.name});const y=je.value;$e.value=!1,qn({name:y.parkingType,properties:{name:y.name,description:y.description,icon:y.iconKey,priceInfo:y.priceInfo,priceArray:[]},geometry:y.geometry,address:Z.value.address})}catch(m){alert("儲存失敗:"+((m==null?void 0:m.message)||m))}finally{hn.value=!1}}},$a=async()=>{if(je.value){hn.value=!0;try{const p=je.value,m={id:se,nickname:ge.value};await Ko(p.name,p.geometry,m),fe("override_reset",{name:p.name}),$e.value=!1,qn({name:p.parkingType,properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.geometry,address:Z.value.address})}catch(p){alert("重設失敗:"+((p==null?void 0:p.message)||p))}finally{hn.value=!1}}},Za=async p=>{var m;hn.value=!0;try{const y={id:se,nickname:ge.value};bn.value==="edit"&&((m=gn.value)!=null&&m.id)?(await x(gn.value.id,p,y),fe("community_edit_submit",{name:p==null?void 0:p.name})):(await Me(p,y),fe("community_add_submit",{name:p==null?void 0:p.name})),$e.value=!1,He.value=null}catch(y){alert("儲存失敗:"+((y==null?void 0:y.message)||y))}finally{hn.value=!1}},ec=async p=>{hn.value=!0;try{const m={id:se,nickname:ge.value};await z(p,m),fe("community_delete",{id:p}),$e.value=!1,He.value=null}catch(m){alert("刪除失敗:"+((m==null?void 0:m.message)||m))}finally{hn.value=!1}},Yo=$(()=>{var m,y;if(!He.value||!Z.value.parkingName)return!1;const p=He.value;return p.name===Z.value.parkingName&&Array.isArray(Z.value.geometry)&&((m=p.coordinates)==null?void 0:m[0])===Z.value.geometry[0]&&((y=p.coordinates)==null?void 0:y[1])===Z.value.geometry[1]});K(le,p=>{p||(He.value=null)});const At=E(null),nc=$(()=>{var p;return((p=ht.find(m=>m.value===J.value))==null?void 0:p.key)||[]}),tc=$(()=>{var p;return((p=Qt.find(m=>m.value===ie.value))==null?void 0:p.key)||[]}),Z=E({parkingName:"",parkingNameDes:"",parkingType:"",parkingIcon:"",parkingIconKey:"",iconCategory:"",priceInfo:"",geometry:[null,null],address:"",sourceLabel:""}),je=E(null),no=E(null),Rs=$(()=>pi(Z.value.parkingName,Z.value.geometry)),xs=$(()=>ue(Rs.value)),qn=p=>{var $n,Zn,Vs,Ws,js;const m=p.properties.icon,y={name:p.properties.name,description:p.properties.description,iconKey:m,priceInfo:p.properties.priceInfo||"",geometry:p.geometry,parkingType:p.name},me=!!(He.value&&He.value.name===p.properties.name&&Array.isArray(p.geometry)&&(($n=He.value.coordinates)==null?void 0:$n[0])===p.geometry[0]&&((Zn=He.value.coordinates)==null?void 0:Zn[1])===p.geometry[1]);let ze=null,de=y;me||(ze=ke(y.name,y.geometry),ze&&(de=Oa(y,ze))),je.value=me?null:y,no.value=ze,Z.value={parkingName:de.name,parkingNameDes:de.description,parkingType:y.parkingType,iconCategory:Tu(de.iconKey),parkingIcon:q(de.iconKey),parkingIconKey:de.iconKey,priceInfo:de.priceInfo||"",geometry:p.geometry,address:p.address,sourceLabel:me?"":$c((Vs=p.properties)==null?void 0:Vs.sourceFolderIndex)},le.value=!0,fe("parking_view",{parking_name:(Ws=p.properties)==null?void 0:Ws.name,parking_type:p.name,icon:(js=p.properties)==null?void 0:js.icon,overridden:!!ze})},oc=()=>{if(!Z.value.parkingName)return;const p=!xs.value;Ne({id:Rs.value,name:Z.value.parkingName,parkingType:Z.value.parkingType,geometry:Z.value.geometry,address:Z.value.address,icon:Z.value.parkingIconKey}),fe(p?"favorite_add":"favorite_remove",{parking_name:Z.value.parkingName,parking_type:Z.value.parkingType})},ic=p=>"",sc=p=>{var m;p.isCommunity&&p.community?Xo(p.community):qn({name:p.groupName,properties:p.properties,geometry:p.geometry,address:ic(p.geometry)}),At.value=[...p.geometry],fe("search_select",{parking_name:(m=p.properties)==null?void 0:m.name,group:p.groupName,community:!!p.isCommunity})},_t=E(null),vt=E(null),rc=p=>{qe.value="driving",_t.value=p,le.value=!1,vt.value=null,fe("route_start",{parking_name:Z.value.parkingName,profile:"driving"})},lc=()=>{_t.value=null,Te.value=!1};K(vt,p=>{Te.value=p!==null});const ac=p=>{const m=Z.value.geometry;let y="";p==="apple"?y=`https://maps.apple.com/?daddr=${m[1]},${m[0]}&dirflg=d&t=m`:p==="google"&&(y=`https://www.google.com/maps/dir/?api=1&destination=${m[1]},${m[0]}&travelmode=driving`),y&&(fe("open_external_map",{provider:p,parking_name:Z.value.parkingName}),window.open(y,"_blank","noopener,noreferrer"))},An=(p,m=null)=>{const y=m||"https://findparkinglot.github.io/";let me="";p==="facebook"?me=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(y)}`:p==="line"?me=`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(y)}`:p==="twitter"&&(me=`https://twitter.com/share?url=${encodeURIComponent(y)}`),fe("share",{method:p,scope:m?"spot":"site"}),p==="link"?navigator.clipboard.writeText(y).then(()=>alert("已複製連結"),()=>alert("複製失敗")):window.open(me,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},Os=()=>{const p=Z.value.geometry;if(!Array.isArray(p)||p[0]==null||p[1]==null)return"";const m=new URLSearchParams({lng:Number(p[0]).toFixed(6),lat:Number(p[1]).toFixed(6)});return`${Rf}?${m.toString()}`},cc=()=>{const p=Os();p&&(Jn.value=p,Jo.value=Z.value.parkingName||"停車點",qo.value=!0,fe("share_spot_open",{name:Jo.value}))},qo=E(!1),Jn=E(""),Jo=E("");K([le,Z],()=>{try{if(!le.value){window.location.search&&window.history.replaceState({},"",window.location.pathname);return}const p=Os();if(!p)return;const m=p.slice(p.indexOf("?"));window.history.replaceState({},"",window.location.pathname+m)}catch(p){}},{deep:!0});const Ct=E(null),to=(p,m)=>Math.abs(Number(p)-Number(m))<1e-5,$o=()=>{var ze;const p=Ct.value;if(!p)return;const m=Number(p.lng),y=Number(p.lat);if(!isFinite(m)||!isFinite(y)){Ct.value=null;return}const me=(Je.value||[]).find(de=>de.coordinates&&to(de.coordinates[0],m)&&to(de.coordinates[1],y));if(me){Xo(me),At.value=[m,y],Ct.value=null;return}for(const de of s.value||[])for(const $n of de.features||[]){const Zn=(ze=$n.geometry)==null?void 0:ze.coordinates;if(Zn&&to(Zn[0],m)&&to(Zn[1],y)){qn({name:de.name,properties:$n.properties,geometry:$n.geometry.coordinates,address:""}),At.value=[m,y],Ct.value=null;return}}Array.isArray(s.value)&&s.value.length>0&&(At.value=[m,y])},Ls=()=>{try{const p=new URLSearchParams(window.location.search),m=p.get("lng"),y=p.get("lat");if(!m||!y)return;Ct.value={lng:m,lat:y},$o()}catch(p){}};K(Je,$o,{deep:!1}),K(s,$o,{deep:!1}),Kn(()=>{s.value=rd(qc()),g.value||Ls()}),K(g,(p,m)=>{m&&!p&&Ls()});const dc=$(()=>[{key:"share",icon:"share",label:"分享",highlight:!0,onClick:()=>j.value=!0},{key:"howto",icon:"help_outline",label:"怎麼用",onClick:Se},{key:"faq",icon:"map",label:"地圖怎麼看",onClick:()=>U.value=!0},{key:"mobile",icon:"add_to_home_screen",label:"加到手機桌面",onClick:()=>I.value=!0}]),hc=$(()=>[{key:"add",icon:"add_location_alt",label:"新增停車位置",highlight:!0,onClick:Wa},{key:"help",icon:"menu_book",label:"編輯教學",onClick:()=>T.value=!0}]);return(p,m)=>(_(),C(ye,null,[c("div",lm,[an.value?(_(),C("img",dm)):(_(),C("button",{key:0,class:"title-toggle",onClick:m[0]||(m[0]=y=>he.value=!he.value),"aria-label":he.value?"收合設定":"開啟設定","aria-expanded":he.value},[c("span",cm,w(he.value?"close":"menu"),1)],8,am)),hm]),Ge(Ee(jr,{items:dc.value},null,8,["items"]),[[Bt,!Te.value&&!le.value&&!an.value]]),Ge(Ee(jr,{items:hc.value,placement:"left","main-icon":"add_location_alt","main-label":"共筆停車點"},null,8,["items"]),[[Bt,!Te.value&&!le.value&&!an.value]]),Ge(Ee(z5,{"map-data-list":s.value,"community-parkings":O(Je),onSelect:sc},null,8,["map-data-list","community-parkings"]),[[Bt,!Te.value&&!le.value&&!an.value]]),um,Ee(gu,{ref_key:"mapBoxRef",ref:pe,parkingTypeKeyArray:nc.value,degreeOfFriendlinessKeyArray:tc.value,mapDataList:s.value,getLngLat:h.value.getLngLat,mapStylesSelected:h.value.mapStylesSelected,parkingPriceType:Le.value,priceRangeMin:be.value,priceRangeMax:v.value,"favorite-ids":O(S),"override-keys":eo.value,overrides:O(yn),"only-favorites":we.value,"focus-coord":At.value,"route-profile":qe.value,"community-parkings":O(Je),goToParkingPlaceData:_t.value,"onUpdate:goToParkingPlaceData":m[1]||(m[1]=y=>_t.value=y),routeData:vt.value,"onUpdate:routeData":m[2]||(m[2]=y=>vt.value=y),onParkingInfo:qn,onCommunityParkingClick:Xo},null,8,["parkingTypeKeyArray","degreeOfFriendlinessKeyArray","mapDataList","getLngLat","mapStylesSelected","parkingPriceType","priceRangeMin","priceRangeMax","favorite-ids","override-keys","overrides","only-favorites","focus-coord","route-profile","community-parkings","goToParkingPlaceData","routeData"]),Ee(E5,{"route-data":vt.value,active:Te.value,profile:qe.value,"onUpdate:profile":m[3]||(m[3]=y=>qe.value=y),onCancel:lc},null,8,["route-data","active","profile"]),Ee(B3,{parkingType:J.value,"onUpdate:parkingType":m[4]||(m[4]=y=>J.value=y),degreeOfFriendliness:ie.value,"onUpdate:degreeOfFriendliness":m[5]||(m[5]=y=>ie.value=y),parkingPriceType:Le.value,"onUpdate:parkingPriceType":m[6]||(m[6]=y=>Le.value=y),priceRangeMin:be.value,"onUpdate:priceRangeMin":m[7]||(m[7]=y=>be.value=y),priceRangeMax:v.value,"onUpdate:priceRangeMax":m[8]||(m[8]=y=>v.value=y),mapStyle:u.value,"onUpdate:mapStyle":m[9]||(m[9]=y=>u.value=y),active:he.value,"onUpdate:active":m[10]||(m[10]=y=>he.value=y),onlyFavorites:we.value,"onUpdate:onlyFavorites":m[11]||(m[11]=y=>we.value=y),"favorites-count":O(M).length,onOpenSupport:R},null,8,["parkingType","degreeOfFriendliness","parkingPriceType","priceRangeMin","priceRangeMax","mapStyle","active","onlyFavorites","favorites-count"]),Ge(Ee(c5,{info:Z.value,active:le.value,"is-mobile":O(t),"is-apple":O(o),"is-android":O(i),"has-route":_t.value!==null,"is-favorite":xs.value,"is-community":Yo.value,"community-meta":Yo.value?He.value:null,"is-overridden":!Yo.value&&!!no.value,"override-meta":no.value,onClose:m[12]||(m[12]=y=>le.value=!1),onRoute:m[13]||(m[13]=y=>rc(Z.value.geometry)),onOpenMap:ac,onToggleFavorite:oc,onEditCommunity:Qa,onEditOverride:Xa,onShare:cc},null,8,["info","active","is-mobile","is-apple","is-android","has-route","is-favorite","is-community","community-meta","is-overridden","override-meta"]),[[Bt,!Te.value]]),Ee(Cn,{modelValue:U.value,"onUpdate:modelValue":m[14]||(m[14]=y=>U.value=y),title:"地圖怎麼看?","close-text":"知道了",size:"lg"},{default:Ze(()=>[pm,c("div",mm,[c("div",fm,[c("img",{src:O(q)("icon-3.png"),alt:""},null,8,ym),k(" 汽車：汽車格(含未確認是否有重機格) ")]),c("div",bm,[c("img",{src:O(q)("icon-8.png"),alt:""},null,8,gm),k(" 重機(有人):有設重機專用格 ")]),c("div",Am,[c("img",{src:O(q)("icon-10.png"),alt:""},null,8,_m),k(" 機車(沒人):機車格 ")]),c("div",vm,[c("img",{src:O(q)("icon-14.png"),alt:""},null,8,Cm),k(" 綠星:路邊友善車格 ")]),c("div",Pm,[c("img",{src:O(q)("icon-4.png"),alt:""},null,8,Um),k(" 重機友善店家:用餐/消費時可停重機的店家 ")]),c("div",Em,[c("img",{src:O(q)("icon-15.png"),alt:""},null,8,Im),k(" 綠P:重機專用路邊停車格 ")]),c("div",Bm,[c("img",{src:O(q)("icon-16.png"),alt:""},null,8,Sm),k(" 灰P:重機專用路邊停車格(未確認精準座標,歡迎回報) ")]),c("div",wm,[c("img",{src:O(q)("icon-17.png"),alt:""},null,8,km),k(" 藍P:普通大型共用機車格(台北市試辦) ")]),c("div",Dm,[c("img",{src:O(q)("icon-18.png"),alt:""},null,8,Tm),k(" 紫P:時段性汽機車共用停車格 ")]),c("div",Nm,[c("img",{src:O(q)("icon-19.png"),alt:""},null,8,Mm),k(" 紅X:停都不給停 ")]),c("div",Rm,[c("img",{src:O(q)("icon-20.png"),alt:""},null,8,xm),k(" ?:類型未確認,歡迎透過共筆回報 ")])]),Om,c("div",Lm,[c("div",Fm,[c("img",{src:O(q)("icon-2.png"),alt:""},null,8,Hm),c("img",{src:O(q)("icon-6.png"),alt:""},null,8,zm),c("img",{src:O(q)("icon-9.png"),alt:""},null,8,Vm),k(" 綠色最友善:有後牌辨析 ")]),c("div",Wm,[c("img",{src:O(q)("icon-5.png"),alt:""},null,8,jm),c("img",{src:O(q)("icon-12.png"),alt:""},null,8,Gm),c("img",{src:O(q)("icon-11.png"),alt:""},null,8,Km),k(" 藍色最傳統:悠遊卡 / 按鈕取票 ")]),c("div",Qm,[c("img",{src:O(q)("icon-1.png"),alt:""},null,8,Xm),c("img",{src:O(q)("icon-13.png"),alt:""},null,8,Ym),c("img",{src:O(q)("icon-7.png"),alt:""},null,8,qm),k(" 紅色最靠北:請管理員協助 / 倒退嚕前牌辨析 ")]),c("div",Jm,[c("img",{src:O(q)("icon-3.png"),alt:""},null,8,$m),c("img",{src:O(q)("icon-8.png"),alt:""},null,8,Zm),c("img",{src:O(q)("icon-10.png"),alt:""},null,8,e4),k(" 灰色未確定:有可能是上述任何情況,停到請回報 ")])]),n4,c("div",t4,[c("div",o4,[c("img",{src:O(q)("icon-3.png"),alt:""},null,8,i4),k(" (30/h)三張里地下停車場 ")]),s4])]),_:1},8,["modelValue"]),Ee(Cn,{modelValue:j.value,"onUpdate:modelValue":m[19]||(m[19]=y=>j.value=y),title:"分享給朋友",size:"sm"},{default:Ze(()=>[c("div",r4,[c("button",{class:"share-btn",onClick:m[15]||(m[15]=y=>An("facebook")),"aria-label":"Facebook"},c4),c("button",{class:"share-btn",onClick:m[16]||(m[16]=y=>An("line")),"aria-label":"LINE"},u4),c("button",{class:"share-btn",onClick:m[17]||(m[17]=y=>An("twitter")),"aria-label":"Twitter"},f4),c("button",{class:"share-btn",onClick:m[18]||(m[18]=y=>An("link")),"aria-label":"複製連結"},g4)])]),_:1},8,["modelValue"]),Ee(Cn,{modelValue:qo.value,"onUpdate:modelValue":m[24]||(m[24]=y=>qo.value=y),title:`分享：${Jo.value}`,size:"sm"},{default:Ze(()=>[c("p",A4,w(Jn.value),1),c("div",_4,[c("button",{class:"share-btn",onClick:m[20]||(m[20]=y=>An("facebook",Jn.value)),"aria-label":"Facebook"},P4),c("button",{class:"share-btn",onClick:m[21]||(m[21]=y=>An("line",Jn.value)),"aria-label":"LINE"},I4),c("button",{class:"share-btn",onClick:m[22]||(m[22]=y=>An("twitter",Jn.value)),"aria-label":"Twitter"},w4),c("button",{class:"share-btn",onClick:m[23]||(m[23]=y=>An("link",Jn.value)),"aria-label":"複製連結"},T4)])]),_:1},8,["modelValue","title"]),Ee(Cn,{modelValue:V.value,"onUpdate:modelValue":m[25]||(m[25]=y=>V.value=y),title:"支持「重機能停哪?」","close-text":"關閉",size:"sm"},{default:Ze(()=>[N4,c("div",M4,[(_(),C(ye,null,Ve(P,y=>c("button",{key:y.key,type:"button",class:oe(["support-btn",{"is-primary":y.primary}]),onClick:me=>X(y)},[c("span",x4,w(y.icon),1),c("span",O4,[c("span",L4,[k(w(y.label)+" ",1),y.primary?(_(),C("span",F4,"推薦")):W("",!0)]),c("span",H4,w(y.description),1)]),z4],10,R4)),64))])]),_:1},8,["modelValue"]),Ee(Cn,{modelValue:I.value,"onUpdate:modelValue":m[28]||(m[28]=y=>I.value=y),title:"如何加入手機桌面?","close-text":"知道了",size:"lg"},{default:Ze(()=>[c("div",V4,[c("button",{type:"button",role:"tab","aria-selected":D.value==="ios",class:oe(["os-tab",{"is-active":D.value==="ios"}]),onClick:m[26]||(m[26]=y=>D.value="ios")},[j4,k(" iOS ")],10,W4),c("button",{type:"button",role:"tab","aria-selected":D.value==="android",class:oe(["os-tab",{"is-active":D.value==="android"}]),onClick:m[27]||(m[27]=y=>D.value="android")},[K4,k(" Android ")],10,G4)]),D.value==="ios"?(_(),C(ye,{key:0},[Q4,X4,Y4,q4,J4,$4,Z4,ef,nf,tf,of],64)):(_(),C(ye,{key:1},[sf,rf,lf,af,cf,df,hf,uf,pf],64))]),_:1},8,["modelValue"]),Ee(Cn,{modelValue:g.value,"onUpdate:modelValue":m[29]||(m[29]=y=>g.value=y),title:"嗨！歡迎使用 重機能停哪?","close-text":"開始使用"},{footer:Ze(()=>[c("button",{class:"btn btn-primary",onClick:Ye},"開始使用")]),default:Ze(()=>[mf,ff,yf,bf,gf,Af,_f,c("div",{class:"welcome-support-wrap"},[c("button",{type:"button",class:"btn btn-coffee btn-sm",onClick:R}," ❤️ 贊助支持，讓我有動力繼續更新 ")]),vf]),_:1},8,["modelValue"]),Ee(Lp,{open:$e.value,"onUpdate:open":m[30]||(m[30]=y=>$e.value=y),mode:bn.value,initial:gn.value,"default-coord":gt.value,nickname:O(ge),"is-owner":!0,"is-admin":O(Fe),submitting:hn.value,"has-existing-override":Ts.value,history:Va.value,"onUpdate:nickname":m[31]||(m[31]=y=>ge.value=y),onSubmit:m[32]||(m[32]=y=>bn.value==="override"?Ja(y):Za(y)),onDelete:ec,onReset:$a},null,8,["open","mode","initial","default-coord","nickname","is-admin","submitting","has-existing-override","history"]),an.value?(_(),C("div",Cf,Uf)):W("",!0),an.value?(_(),C("div",Ef,[If,c("div",{class:"pick-banner-actions"},[c("button",{class:"btn btn-outline btn-sm",onClick:Ga},"取消"),c("button",{class:"btn btn-primary btn-sm",onClick:ja},[Bf,k(" 使用此位置 ")])])])):W("",!0),Ee(Cn,{modelValue:T.value,"onUpdate:modelValue":m[33]||(m[33]=y=>T.value=y),title:"共筆停車點說明","close-text":"我知道了",size:"lg"},{default:Ze(()=>[Sf,wf,kf,Df,Tf,Nf,Mf]),_:1},8,["modelValue"]),Ee(Yp,{active:Pe.value,"onUpdate:active":m[34]||(m[34]=y=>Pe.value=y),steps:ce,onFinish:Ue},null,8,["active"])],64))}},Of=ln(xf,[["__scopeId","data-v-da60fa10"]]);mc(Of).mount("#app");"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./serviceWorker.js").catch(()=>{})});
