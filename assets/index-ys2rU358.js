 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ee;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(ee||(ee={}));const kd={debug:ee.DEBUG,verbose:ee.VERBOSE,info:ee.INFO,warn:ee.WARN,error:ee.ERROR,silent:ee.SILENT},Dd=ee.INFO,Td={[ee.DEBUG]:"log",[ee.VERBOSE]:"log",[ee.INFO]:"info",[ee.WARN]:"warn",[ee.ERROR]:"error"},Md=(n,e,...t)=>{if(e<n.logLevel)return;const o=new Date().toISOString(),i=Td[e];if(!i)throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class dl{constructor(e){this.name=e,this._logLevel=Dd,this._logHandler=Md,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ee))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?kd[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ee.DEBUG,...e),this._logHandler(this,ee.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ee.VERBOSE,...e),this._logHandler(this,ee.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ee.INFO,...e),this._logHandler(this,ee.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ee.WARN,...e),this._logHandler(this,ee.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ee.ERROR,...e),this._logHandler(this,ee.ERROR,...e)}}const Nd=(n,e)=>e.some(t=>n instanceof t);let Gs,Ks;function Rd(){return Gs||(Gs=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function xd(){return Ks||(Ks=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const hl=new WeakMap,di=new WeakMap,ul=new WeakMap,Xo=new WeakMap,Vi=new WeakMap;function Od(n){const e=new Promise((t,o)=>{const i=()=>{n.removeEventListener("success",s),n.removeEventListener("error",r)},s=()=>{t(Pn(n.result)),i()},r=()=>{o(n.error),i()};n.addEventListener("success",s),n.addEventListener("error",r)});return e.then(t=>{t instanceof IDBCursor&&hl.set(t,n)}).catch(()=>{}),Vi.set(e,n),e}function Ld(n){if(di.has(n))return;const e=new Promise((t,o)=>{const i=()=>{n.removeEventListener("complete",s),n.removeEventListener("error",r),n.removeEventListener("abort",r)},s=()=>{t(),i()},r=()=>{o(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",s),n.addEventListener("error",r),n.addEventListener("abort",r)});di.set(n,e)}let hi={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return di.get(n);if(e==="objectStoreNames")return n.objectStoreNames||ul.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return Pn(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Fd(n){hi=n(hi)}function Hd(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const o=n.call(Jo(this),e,...t);return ul.set(o,e.sort?e.sort():[e]),Pn(o)}:xd().includes(n)?function(...e){return n.apply(Jo(this),e),Pn(hl.get(this))}:function(...e){return Pn(n.apply(Jo(this),e))}}function zd(n){return typeof n=="function"?Hd(n):(n instanceof IDBTransaction&&Ld(n),Nd(n,Rd())?new Proxy(n,hi):n)}function Pn(n){if(n instanceof IDBRequest)return Od(n);if(Xo.has(n))return Xo.get(n);const e=zd(n);return e!==n&&(Xo.set(n,e),Vi.set(e,n)),e}const Jo=n=>Vi.get(n);function Vd(n,e,{blocked:t,upgrade:o,blocking:i,terminated:s}={}){const r=indexedDB.open(n,e),l=Pn(r);return o&&r.addEventListener("upgradeneeded",a=>{o(Pn(r.result),a.oldVersion,a.newVersion,Pn(r.transaction),a)}),t&&r.addEventListener("blocked",a=>t(a.oldVersion,a.newVersion,a)),l.then(a=>{s&&a.addEventListener("close",()=>s()),i&&a.addEventListener("versionchange",d=>i(d.oldVersion,d.newVersion,d))}).catch(()=>{}),l}const Wd=["get","getKey","getAll","getAllKeys","count"],jd=["put","add","delete","clear"],qo=new Map;function Qs(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(qo.get(e))return qo.get(e);const t=e.replace(/FromIndex$/,""),o=e!==t,i=jd.includes(t);if(!(t in(o?IDBIndex:IDBObjectStore).prototype)||!(i||Wd.includes(t)))return;const s=async function(r,...l){const a=this.transaction(r,i?"readwrite":"readonly");let d=a.store;return o&&(d=d.index(l.shift())),(await Promise.all([d[t](...l),i&&a.done]))[0]};return qo.set(e,s),s}Fd(n=>({...n,get:(e,t,o)=>Qs(e,t)||n.get(e,t,o),has:(e,t)=>!!Qs(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fn=new dl("@firebase/app"),Qd="@firebase/app-compat",Yd="@firebase/analytics-compat",Xd="@firebase/analytics",Jd="@firebase/app-check-compat",qd="@firebase/app-check",$d="@firebase/auth",Zd="@firebase/auth-compat",e1="@firebase/database",n1="@firebase/data-connect",t1="@firebase/database-compat",o1="@firebase/functions",i1="@firebase/functions-compat",s1="@firebase/installations",r1="@firebase/installations-compat",l1="@firebase/messaging",a1="@firebase/messaging-compat",c1="@firebase/performance",d1="@firebase/performance-compat",h1="@firebase/remote-config",u1="@firebase/remote-config-compat",p1="@firebase/storage",m1="@firebase/storage-compat",f1="@firebase/firestore",y1="@firebase/ai",b1="@firebase/firestore-compat",g1="firebase",A1="12.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D1=1024,T1=30;class M1{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new R1(t),this._heartbeatsCachePromise=this._storage.read().then(o=>(this._heartbeatsCache=o,o))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=qs();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(r=>r.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats.length>T1){const r=x1(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(o){fn.warn(o)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=qs(),{heartbeatsToSend:o,unsentEntries:i}=N1(this._heartbeatsCache.heartbeats),s=ho(JSON.stringify({version:2,heartbeats:o}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return fn.warn(t),""}}}function qs(){return new Date().toISOString().substring(0,10)}function N1(n,e=D1){const t=[];let o=n.slice();for(const i of n){const s=t.find(r=>r.agent===i.agent);if(s){if(s.dates.push(i.date),$s(t)>e){s.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),$s(t)>e){t.pop();break}o=o.slice(1)}return{heartbeatsToSend:t,unsentEntries:o}}class R1{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return fd()?yd().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await k1(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return Js(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return Js(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function $s(n){return ho(JSON.stringify({version:2,heartbeats:n})).length}function x1(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let o=1;o<n.length;o++)n[o].date<t&&(t=n[o].date,e=o);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O1(n){fo(new xt("platform-logger",e=>new Gd(e),"PRIVATE")),fo(new xt("heartbeat",e=>new M1(e),"PRIVATE")),ot(ui,Ys,n),ot(ui,Ys,"esm2020"),ot("fire-js","")}O1("");var Zs={};const er="@firebase/database",nr="1.1.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt{static get ALL_TRANSPORTS(){return[tt,Je]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const t=Je&&Je.isAvailable();let o=t&&!Je.previouslyFailed();if(e.webSocketOnly&&(t||we("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),o=!0),o)this.transports_=[Je];else{const i=this.transports_=[];for(const s of Lt.ALL_TRANSPORTS)s&&s.isAvailable()&&i.push(s);Lt.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}Lt.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let no;class zl extends Do{static get __EMPTY_NODE(){return no}static set __EMPTY_NODE(e){no=e}compare(e,t){return Yn(e.name,t.name)}isDefinedOn(e){throw ut("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return z.MIN}maxPost(){return new z(In,no)}makePost(e,t){return A(typeof e=="string","KeyIndex indexValue must always be a string."),new z(e,no)}toString(){return".key"}}const zn=new zl;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O0(n,e){return Yn(n.name,e.name)}function qi(n,e){return Yn(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let jl,Gl;function F0(n){jl=n}function H0(n){Gl=n}class z0 extends Do{compare(e,t){const o=e.node.getPriority(),i=t.node.getPriority(),s=o.compareTo(i);return s===0?Yn(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return z.MIN}maxPost(){return new z(In,new me("[PRIORITY-POST]",Gl))}makePost(e,t){const o=jl(e);return new z(t,new me("[PRIORITY-POST]",o))}toString(){return".priority"}}const se=new z0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V0=Math.log(2);class W0{constructor(e){const t=s=>parseInt(Math.log(s)/V0,10),o=s=>parseInt(Array(s+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=o(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const go=function(n,e,t,o){n.sort(e);const i=function(a,d){const u=d-a;let h,m;if(u===0)return null;if(u===1)return h=n[a],m=t?t(h):h,new fe(m,h.node,fe.BLACK,null,null);{const b=parseInt(u/2,10)+a,g=i(a,b),U=i(b+1,d);return h=n[b],m=t?t(h):h,new fe(m,h.node,fe.BLACK,g,U)}},s=function(a){let d=null,u=null,h=n.length;const m=function(g,U){const D=h-g,I=h;h-=g;const V=i(D+1,I),T=n[D],W=t?t(T):T;b(new fe(W,T.node,U,null,V))},b=function(g){d?(d.left=g,d=g):(u=g,d=g)};for(let g=0;g<a.count;++g){const U=a.nextBitIsOne(),D=Math.pow(2,a.count-(g+1));U?m(D,fe.BLACK):(m(D,fe.BLACK),m(D,fe.RED))}return u},r=new W0(n.length),l=s(r);return new Ne(o||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ti;const et={};class pn{static get Default(){return A(et&&se,"ChildrenNode.ts has not been loaded"),ti=ti||new pn({".priority":et},{".priority":se}),ti}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=rt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Ne?t:null}hasIndex(e){return dn(this.indexSet_,e.toString())}addIndex(e,t){A(e!==zn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const o=[];let i=!1;const s=t.getIterator(z.Wrap);let r=s.getNext();for(;r;)i=i||e.isDefinedOn(r.node),o.push(r),r=s.getNext();let l;i?l=go(o,e.getCompare()):l=et;const a=e.toString(),d={...this.indexSet_};d[a]=e;const u={...this.indexes_};return u[a]=l,new pn(u,d)}addToIndexes(e,t){const o=uo(this.indexes_,(i,s)=>{const r=rt(this.indexSet_,s);if(A(r,"Missing index implementation for "+s),i===et)if(r.isDefinedOn(e.node)){const l=[],a=t.getIterator(z.Wrap);let d=a.getNext();for(;d;)d.name!==e.name&&l.push(d),d=a.getNext();return l.push(e),go(l,r.getCompare())}else return et;else{const l=t.get(e.name);let a=i;return l&&(a=a.remove(new z(e.name,l))),a.insert(e,e.node)}});return new pn(o,this.indexSet_)}removeFromIndexes(e,t){const o=uo(this.indexes_,i=>{if(i===et)return i;{const s=t.get(e.name);return s?i.remove(new z(e.name,s)):i}});return new pn(o,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $i extends Do{constructor(e){super(),this.indexPath_=e,A(!H(e)&&F(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const o=this.extractChild(e.node),i=this.extractChild(t.node),s=o.compareTo(i);return s===0?Yn(e.name,t.name):s}makePost(e,t){const o=be(e),i=R.EMPTY_NODE.updateChild(this.indexPath_,o);return new z(t,i)}maxPost(){const e=R.EMPTY_NODE.updateChild(this.indexPath_,qt);return new z(In,e)}toString(){return Ft(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K0 extends Do{compare(e,t){const o=e.node.compareTo(t.node);return o===0?Yn(e.name,t.name):o}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return z.MIN}maxPost(){return z.MAX}makePost(e,t){const o=be(e);return new z(t,o)}toString(){return".value"}}const Kl=new K0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo{constructor(e,t,o){this.path=e,this.affectedTree=t,this.revert=o,this.type=$e.ACK_USER_WRITE,this.source=ns()}operationForChild(e){if(H(this.path)){if(this.affectedTree.value!=null)return A(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Y(e));return new vo(Q(),t,this.revert)}}else return A(F(this.path)===e,"operationForChild called for unrelated child."),new vo(te(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function To(n,e){return{eventCache:n,serverCache:e}}function kt(n,e,t,o){return To(new jn(e,t,o),n.serverCache)}function Xl(n,e,t,o){return To(n.eventCache,new jn(e,t,o))}function Ai(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Gn(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function is(n,e){return ea(e,n)}function a2(n,e,t,o,i){A(o>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:o,visible:i}),i&&(n.visibleWrites=Dt(n.visibleWrites,e,t)),n.lastWriteId=o}function c2(n,e,t,o){A(o>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:o,visible:!0}),n.visibleWrites=_i(n.visibleWrites,e,t),n.lastWriteId=o}function d2(n,e){for(let t=0;t<n.allWrites.length;t++){const o=n.allWrites[t];if(o.writeId===e)return o}return null}function h2(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);A(t>=0,"removeWrite called with nonexistent writeId.");const o=n.allWrites[t];n.allWrites.splice(t,1);let i=o.visible,s=!1,r=n.allWrites.length-1;for(;i&&r>=0;){const l=n.allWrites[r];l.visible&&(r>=t&&u2(l,o.path)?i=!1:Qe(o.path,l.path)&&(s=!0)),r--}if(i){if(s)return p2(n),!0;if(o.snap)n.visibleWrites=Ar(n.visibleWrites,o.path);else{const l=o.children;Pe(l,a=>{n.visibleWrites=Ar(n.visibleWrites,le(o.path,a))})}return!0}else return!1}function u2(n,e){if(n.snap)return Qe(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Qe(le(n.path,t),e))return!0;return!1}function p2(n){n.visibleWrites=ql(n.allWrites,m2,Q()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function m2(n){return n.visible}function ql(n,e,t){let o=Ze.empty();for(let i=0;i<n.length;++i){const s=n[i];if(e(s)){const r=s.path;let l;if(s.snap)Qe(t,r)?(l=Me(t,r),o=Dt(o,l,s.snap)):Qe(r,t)&&(l=Me(r,t),o=Dt(o,Q(),s.snap.getChild(l)));else if(s.children){if(Qe(t,r))l=Me(t,r),o=_i(o,l,s.children);else if(Qe(r,t))if(l=Me(r,t),H(l))o=_i(o,Q(),s.children);else{const a=rt(s.children,F(l));if(a){const d=a.getChild(te(l));o=Dt(o,Q(),d)}}}else throw ut("WriteRecord should have .snap or .children")}}return o}function $l(n,e,t,o,i){if(!o&&!i){const s=Xn(n.visibleWrites,e);if(s!=null)return s;{const r=En(n.visibleWrites,e);if(Ci(r))return t;if(t==null&&!vi(r,Q()))return null;{const l=t||R.EMPTY_NODE;return ct(r,l)}}}else{const s=En(n.visibleWrites,e);if(!i&&Ci(s))return t;if(!i&&t==null&&!vi(s,Q()))return null;{const r=function(d){return(d.visible||i)&&(!o||!~o.indexOf(d.writeId))&&(Qe(d.path,e)||Qe(e,d.path))},l=ql(n.allWrites,r,e),a=t||R.EMPTY_NODE;return ct(l,a)}}}function f2(n,e,t){let o=R.EMPTY_NODE;const i=Xn(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(se,(s,r)=>{o=o.updateImmediateChild(s,r)}),o;if(t){const s=En(n.visibleWrites,e);return t.forEachChild(se,(r,l)=>{const a=ct(En(s,new Y(r)),l);o=o.updateImmediateChild(r,a)}),_r(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}else{const s=En(n.visibleWrites,e);return _r(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}}function y2(n,e,t,o,i){A(o||i,"Either existingEventSnap or existingServerSnap must exist");const s=le(e,t);if(vi(n.visibleWrites,s))return null;{const r=En(n.visibleWrites,s);return Ci(r)?i.getChild(t):ct(r,i.getChild(t))}}function b2(n,e,t,o){const i=le(e,t),s=Xn(n.visibleWrites,i);if(s!=null)return s;if(o.isCompleteForChild(t)){const r=En(n.visibleWrites,i);return ct(r,o.getNode().getImmediateChild(t))}else return null}function g2(n,e){return Xn(n.visibleWrites,e)}function A2(n,e,t,o,i,s,r){let l;const a=En(n.visibleWrites,e),d=Xn(a,Q());if(d!=null)l=d;else if(t!=null)l=ct(a,t);else return[];if(l=l.withIndex(r),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=r.getCompare(),m=s?l.getReverseIteratorFrom(o,r):l.getIteratorFrom(o,r);let b=m.getNext();for(;b&&u.length<i;)h(b,o)!==0&&u.push(b),b=m.getNext();return u}else return[]}function _2(){return{visibleWrites:Ze.empty(),allWrites:[],lastWriteId:-1}}function Co(n,e,t,o){return $l(n.writeTree,n.treePath,e,t,o)}function ss(n,e){return f2(n.writeTree,n.treePath,e)}function vr(n,e,t,o){return y2(n.writeTree,n.treePath,e,t,o)}function Po(n,e){return g2(n.writeTree,le(n.treePath,e))}function v2(n,e,t,o,i,s){return A2(n.writeTree,n.treePath,e,t,o,i,s)}function rs(n,e,t){return b2(n.writeTree,n.treePath,e,t)}function Zl(n,e){return ea(le(n.treePath,e),n.writeTree)}function ea(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Io;function j2(n){A(!Io,"__referenceConstructor has already been defined"),Io=n}function G2(){return A(Io,"Reference.ts has not been loaded"),Io}let K2=1;class Br{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Z(null),this.pendingWriteTree_=_2(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function la(n,e,t,o,i){return a2(n.pendingWriteTree_,e,t,o,i),i?mt(n,new Wn(ns(),e,t)):[]}function Q2(n,e,t,o){c2(n.pendingWriteTree_,e,t,o);const i=Z.fromObject(t);return mt(n,new at(ns(),e,i))}function Cn(n,e,t=!1){const o=d2(n.pendingWriteTree_,e);if(h2(n.pendingWriteTree_,e)){let s=new Z(null);return o.snap!=null?s=s.set(Q(),!0):Pe(o.children,r=>{s=s.set(new Y(r),!0)}),mt(n,new vo(o.path,s,t))}else return[]}function No(n,e,t){return mt(n,new Wn(ts(),e,t))}function Y2(n,e,t){const o=Z.fromObject(t);return mt(n,new at(ts(),e,o))}function X2(n,e){return mt(n,new Wt(ts(),e))}function J2(n,e,t){const o=ds(n,t);if(o){const i=hs(o),s=i.path,r=i.queryId,l=Me(s,e),a=new Wt(os(r),l);return us(n,s,a)}else return[]}function Ei(n,e,t,o,i=!1){const s=e._path,r=n.syncPointTree_.get(s);let l=[];if(r&&(e._queryIdentifier==="default"||ra(r,e))){const a=W2(r,e,t,o);H2(r)&&(n.syncPointTree_=n.syncPointTree_.remove(s));const d=a.removed;if(l=a.events,!i){const u=d.findIndex(m=>m._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(s,(m,b)=>Sn(b));if(u&&!h){const m=n.syncPointTree_.subtree(s);if(!m.isEmpty()){const b=Z2(m);for(let g=0;g<b.length;++g){const U=b[g],D=U.query,I=da(n,U);n.listenProvider_.startListening(Tt(D),Bo(n,D),I.hashFn,I.onComplete)}}}!h&&d.length>0&&!o&&(u?n.listenProvider_.stopListening(Tt(e),null):d.forEach(m=>{const b=n.queryToTagMap.get(Ro(m));n.listenProvider_.stopListening(Tt(m),b)}))}eh(n,d)}return l}function q2(n,e,t,o){const i=ds(n,o);if(i!=null){const s=hs(i),r=s.path,l=s.queryId,a=Me(r,e),d=new Wn(os(l),a,t);return us(n,r,d)}else return[]}function $2(n,e,t,o){const i=ds(n,o);if(i){const s=hs(i),r=s.path,l=s.queryId,a=Me(r,e),d=Z.fromObject(t),u=new at(os(l),a,d);return us(n,r,u)}else return[]}function Sr(n,e,t,o=!1){const i=e._path;let s=null,r=!1;n.syncPointTree_.foreachOnPath(i,(m,b)=>{const g=Me(m,i);s=s||st(b,g),r=r||Sn(b)});let l=n.syncPointTree_.get(i);l?(r=r||Sn(l),s=s||st(l,Q())):(l=new O2,n.syncPointTree_=n.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=R.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((b,g)=>{const U=st(g,Q());U&&(s=s.updateImmediateChild(b,U))}));const d=ra(l,e);if(!d&&!e._queryParams.loadsAllData()){const m=Ro(e);A(!n.queryToTagMap.has(m),"View does not exist, but we have a tag");const b=nh();n.queryToTagMap.set(m,b),n.tagToQueryMap.set(b,m)}const u=is(n.pendingWriteTree_,i);let h=V2(l,e,t,u,s,a);if(!d&&!r&&!o){const m=sa(l,e);h=h.concat(th(n,e,m))}return h}function cs(n,e,t){const i=n.pendingWriteTree_,s=n.syncPointTree_.findOnPath(e,(r,l)=>{const a=Me(r,e),d=st(l,a);if(d)return d});return $l(i,e,s,t,!0)}function mt(n,e){return aa(e,n.syncPointTree_,null,is(n.pendingWriteTree_,Q()))}function aa(n,e,t,o){if(H(n.path))return ca(n,e,t,o);{const i=e.get(Q());t==null&&i!=null&&(t=st(i,Q()));let s=[];const r=F(n.path),l=n.operationForChild(r),a=e.children.get(r);if(a&&l){const d=t?t.getImmediateChild(r):null,u=Zl(o,r);s=s.concat(aa(l,a,d,u))}return i&&(s=s.concat(as(i,n,o,t))),s}}function ca(n,e,t,o){const i=e.get(Q());t==null&&i!=null&&(t=st(i,Q()));let s=[];return e.children.inorderTraversal((r,l)=>{const a=t?t.getImmediateChild(r):null,d=Zl(o,r),u=n.operationForChild(r);u&&(s=s.concat(ca(u,l,a,d)))}),i&&(s=s.concat(as(i,n,o,t))),s}function da(n,e){const t=e.query,o=Bo(n,t);return{hashFn:()=>(M2(e)||R.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return o?J2(n,t._path,o):X2(n,t._path);{const s=X1(i,t);return Ei(n,t,null,s)}}}}function Bo(n,e){const t=Ro(e);return n.queryToTagMap.get(t)}function Ro(n){return n._path.toString()+"$"+n._queryIdentifier}function ds(n,e){return n.tagToQueryMap.get(e)}function hs(n){const e=n.indexOf("$");return A(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new Y(n.substr(0,e))}}function us(n,e,t){const o=n.syncPointTree_.get(e);A(o,"Missing sync point for query tag that we're tracking");const i=is(n.pendingWriteTree_,e);return as(o,t,i,null)}function Z2(n){return n.fold((e,t,o)=>{if(t&&Sn(t))return[Mo(t)];{let i=[];return t&&(i=ia(t)),Pe(o,(s,r)=>{i=i.concat(r)}),i}})}function Tt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(G2())(n._repo,n._path):n}function eh(n,e){for(let t=0;t<e.length;++t){const o=e[t];if(!o._queryParams.loadsAllData()){const i=Ro(o),s=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(s)}}}function nh(){return K2++}function th(n,e,t){const o=e._path,i=Bo(n,e),s=da(n,t),r=n.listenProvider_.startListening(Tt(e),i,s.hashFn,s.onComplete),l=n.syncPointTree_.subtree(o);if(i)A(!Sn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((d,u,h)=>{if(!H(d)&&u&&Sn(u))return[Mo(u).query];{let m=[];return u&&(m=m.concat(ia(u).map(b=>b.query))),Pe(h,(b,g)=>{m=m.concat(g)}),m}});for(let d=0;d<a.length;++d){const u=a[d];n.listenProvider_.stopListening(Tt(u),Bo(n,u))}}return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yh{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Lo(n,e){let t=null;for(let o=0;o<e.length;o++){const i=e[o],s=i.getPath();t!==null&&!Xi(s,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:s}),t.events.push(i)}t&&n.eventLists_.push(t)}function ga(n,e,t){Lo(n,t),Aa(n,o=>Xi(o,e))}function en(n,e,t){Lo(n,t),Aa(n,o=>Qe(o,e)||Qe(e,o))}function Aa(n,e){n.recursionDepth_++;let t=!0;for(let o=0;o<n.eventLists_.length;o++){const i=n.eventLists_[o];if(i){const s=i.path;e(s)?(bh(n.eventLists_[o]),n.eventLists_[o]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function bh(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const o=t.getEventRunner();St&&Ce("event: "+t.toString()),pt(o)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kh(n){let e="";const t=n.split("/");for(let o=0;o<t.length;o++)if(t[o].length>0){let i=t[o];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch(s){}e+="/"+i}return e}function Dh(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const o=t.split("=");o.length===2?e[decodeURIComponent(o[0])]=decodeURIComponent(o[1]):we(`Invalid query segment '${t}' in query '${n}'`)}return e}const Tr=function(n,e){const t=Th(n),o=t.namespace;t.domain==="firebase.com"&&yn(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!o||o==="undefined")&&t.domain!=="localhost"&&yn("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||j1();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new kl(t.host,t.secure,o,i,e,"",o!==t.subdomain),path:new Y(t.pathString)}},Th=function(n){let e="",t="",o="",i="",s="",r=!0,l="https",a=443;if(typeof n=="string"){let d=n.indexOf("//");d>=0&&(l=n.substring(0,d-1),n=n.substring(d+2));let u=n.indexOf("/");u===-1&&(u=n.length);let h=n.indexOf("?");h===-1&&(h=n.length),e=n.substring(0,Math.min(u,h)),u<h&&(i=kh(n.substring(u,h)));const m=Dh(n.substring(Math.min(n.length,h)));d=e.indexOf(":"),d>=0?(r=l==="https"||l==="wss",a=parseInt(e.substring(d+1),10)):d=e.length;const b=e.slice(0,d);if(b.toLowerCase()==="localhost")t="localhost";else if(b.split(".").length<=2)t=b;else{const g=e.indexOf(".");o=e.substring(0,g).toLowerCase(),t=e.substring(g+1),s=o}"ns"in m&&(s=m.ns)}return{host:e,port:a,domain:t,subdomain:o,secure:r,scheme:l,pathString:i,namespace:s}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mr="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",Mh=function(){let n=0;const e=[];return function(t){const o=t===n;n=t;let i;const s=new Array(8);for(i=7;i>=0;i--)s[i]=Mr.charAt(t%64),t=Math.floor(t/64);A(t===0,"Cannot push at time == 0");let r=s.join("");if(o){for(i=11;i>=0&&e[i]===63;i--)e[i]=0;e[i]++}else for(i=0;i<12;i++)e[i]=Math.floor(Math.random()*64);for(i=0;i<12;i++)r+=Mr.charAt(e[i]);return A(r.length===20,"nextPushId: Length should be 20."),r}}();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vo{constructor(e,t,o,i){this._repo=e,this._path=t,this._queryParams=o,this._orderByCalled=i}get key(){return H(this._path)?null:Yi(this._path)}get ref(){return new Dn(this._repo,this._path)}get _queryIdentifier(){const e=br(this._queryParams),t=ji(e);return t==="{}"?"default":t}get _queryObject(){return br(this._queryParams)}isEqual(e){if(e=Qn(e),!(e instanceof Vo))return!1;const t=this._repo===e._repo,o=Xi(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&o&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+B0(this._path)}}function Oh(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function Lh(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===zn){const o="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==Vn)throw new Error(o);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==In)throw new Error(o);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===se){if(e!=null&&!Bi(e)||t!=null&&!Bi(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(A(n.getIndex()instanceof $i||n.getIndex()===Kl,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class Dn extends Vo{constructor(e,t){super(e,t,new es,!1)}get parent(){const e=Fl(this._path);return e===null?null:new Dn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class So{constructor(e,t,o){this._node=e,this.ref=t,this._index=o}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Y(e),o=jt(this.ref,e);return new So(this._node.getChild(t),o,se)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(o,i)=>e(new So(i,jt(this.ref,o),se)))}hasChild(e){const t=new Y(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Xe(n,e){return n=Qn(n),n._checkNotDeleted("ref"),e!==void 0?jt(n._root,e):n._root}function jt(n,e){return n=Qn(n),F(n._path)===null?mh("child","path",e):As("child","path",e),new Dn(n._repo,le(n._path,e))}function so(n,e){n=Qn(n),_s("push",n._path),ba("push",e,n._path,!0);const t=_a(n._repo),o=Mh(t),i=jt(n,o),s=jt(n,o);let r;return r=Promise.resolve(s),i.then=r.then.bind(r),i.catch=r.then.bind(r,void 0),i}function Ea(n){return _s("remove",n._path),Fh(n,null)}function Fh(n,e){n=Qn(n),_s("set",n._path),ba("set",e,n._path,!1);const t=new Qt;return Ph(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function ki(n,e){ph("update",e,n._path);const t=new Qt;return Uh(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}class Es{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const o=t._queryParams.getIndex();return new Nh("value",this,new So(e.snapshotNode,new Dn(t._repo,t._path),o))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Rh(this,e,t):null}matches(e){return e instanceof Es?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Hh(n,e,t,o,i){let s;if(typeof o=="object"&&(s=void 0,i=o),typeof o=="function"&&(s=o),i&&i.onlyOnce){const a=t,d=(u,h)=>{Si(n._repo,n,l),a(u,h)};d.userCallback=t.userCallback,d.context=t.context,t=d}const r=new xh(t,s||void 0),l=new Es(r);return Ih(n._repo,n,l),()=>Si(n._repo,n,l)}function Ia(n,e,t,o){return Hh(n,"value",e,t,o)}function Ba(n,e,t){Si(n._repo,n,null)}class zh{}class Vh extends zh{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){Oh(e,"orderByChild");const t=new Y(this._path);if(H(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const o=new $i(t),i=J0(e._queryParams,o);return Lh(i),new Vo(e._repo,e._path,i,!0)}}function Wh(n){return As("orderByChild","path",n),new Vh(n)}function jh(n,...e){let t=Qn(n);for(const o of e)t=o._apply(t);return t}L2(Dn);j2(Dn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gh="FIREBASE_DATABASE_EMULATOR_HOST",Di={};let Kh=!1;function Qh(n,e,t,o){const i=e.lastIndexOf(":"),s=e.substring(0,i),r=cl(s);n.repoInfo_=new kl(e,r,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),o&&(n.authTokenProvider_=o)}function Yh(n,e,t,o,i){let s=o||n.options.databaseURL;s===void 0&&(n.options.projectId||yn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ce("Using default host for project ",n.options.projectId),s=`${n.options.projectId}-default-rtdb.firebaseio.com`);let r=Tr(s,i),l=r.repoInfo,a;typeof process!="undefined"&&Zs&&(a=Zs[Gh]),a?(s=`http://${a}?ns=${l.namespace}`,r=Tr(s,i),l=r.repoInfo):r.repoInfo.secure;const d=new n0(n.name,n.options,e);fh("Invalid Firebase Database URL",r),H(r.path)||yn("Database URL must point to the root of a Firebase Database (not including a child path).");const u=Jh(l,n,d,new e0(n,t));return new qh(u,n)}function Xh(n,e){const t=Di[e];(!t||t[n.key]!==n)&&yn(`Database ${e}(${n.repoInfo_}) has already been deleted.`),Bh(n),delete t[n.key]}function Jh(n,e,t,o){let i=Di[e.name];i||(i={},Di[e.name]=i);let s=i[n.toURLString()];return s&&yn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new _h(n,Kh,t,o),i[n.toURLString()]=s,s}class qh{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(vh(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Dn(this._repo,Q())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Xh(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&yn("Cannot call "+e+" on a deleted database.")}}function $h(n=B1(),e){const t=C1(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const o=hd("database");o&&Zh(t,...o)}return t}function Zh(n,e,t,o={}){n=Qn(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,s=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&po(o,s.repoInfo_.emulatorOptions))return;yn("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let r;if(s.repoInfo_.nodeAdmin)o.mockUserToken&&yn('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new io(io.OWNER);else if(o.mockUserToken){const l=typeof o.mockUserToken=="string"?o.mockUserToken:ud(o.mockUserToken,n.app.options.projectId);r=new io(l)}cl(e)&&Ed(e),Qh(s,i,o,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ot(tu,ou,"app");const Rn=n=>n?String(n).split(/[\r\n,=\s]/)[0].trim():"",Ti={apiKey:Rn("AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs"),authDomain:Rn("findparkinglot-2519e.firebaseapp.com"),projectId:Rn("findparkinglot-2519e"),databaseURL:Rn("https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app"),storageBucket:Rn("findparkinglot-2519e.firebasestorage.app"),messagingSenderId:Rn("976769533420"),appId:Rn("1:976769533420:web:f3108318b3def30017acc9")},cn=!!(Ti.apiKey&&Ti.databaseURL);let Nr=null,Ge=null;cn&&(Nr=pl(Ti),Ge=$h(Nr));const ro="parking_overrides",Bt=E({}),Sa=E(!1),Mi=E(null);let Mt=null,ri=0;function lo(n,e){if(!n||!Array.isArray(e))return"";const t=Number(e[0]),o=Number(e[1]);return!isFinite(t)||!isFinite(o)?"":`${n}|${t.toFixed(6)},${o.toFixed(6)}`.replace(/[.#$/[\]]/g,"_")}function wa(n,e){if(!e)return n;const t={...n},o=i=>{const s=e[i];s!=null&&(typeof s=="string"&&s.trim()===""||(t[i]=s))};return o("description"),o("iconKey"),o("category"),o("friendliness"),o("priceInfo"),t}function iu(){if(!(!cn||Mt))try{const n=Xe(Ge,ro);Mt=n,Ia(n,e=>{const t={};e.forEach(o=>{t[o.key]=o.val()||{}}),Bt.value=t,Sa.value=!0},e=>{Mi.value=e})}catch(n){Mi.value=n}}function su(){Mt&&(Ba(Mt),Mt=null)}function ru(){Kn(()=>{ri+=1,iu()}),ht(()=>{ri-=1,ri<=0&&su()});const n=(s,r)=>{const l=lo(s,r);return l&&Bt.value[l]||null};return{overrides:Bt,ready:Sa,error:Mi,getOverride:n,hasOverride:(s,r)=>!!n(s,r),getOverrideHistory:(s,r)=>{const l=n(s,r);return!l||!l.history||typeof l.history!="object"?[]:Object.entries(l.history).map(([a,d])=>({...d||{},_key:a})).sort((a,d)=>a._key<d._key?1:a._key>d._key?-1:0)},upsertOverride:async(s,r,l)=>{var T,W,Ee;if(!cn)throw new Error("Firebase 尚未設定");const a=lo(s.name,s.geometry);if(!a)throw new Error("無法產生 override key (缺少 name 或 geometry)");const[d,u]=s.geometry,h={id:l.id,nickname:l.nickname||""},m={origName:s.name||"",origLng:Number(d),origLat:Number(u),description:typeof r.description=="string"?r.description.trim():"",iconKey:r.iconKey||"",category:r.category||"",friendliness:r.friendliness||"",priceInfo:typeof r.priceInfo=="string"?r.priceInfo.trim():"",updatedBy:h,updatedAt:Fn()},b=Bt.value[a]||null,g=wa(s,b),U=["description","iconKey","category","friendliness","priceInfo"],D={},I={};for(const ae of U){const Ie=(T=g==null?void 0:g[ae])!=null?T:"",Ae=(W=m[ae])!=null?W:"";String(Ie)!==String(Ae)&&(D[ae]=Ie,I[ae]=Ae)}const V=so(Xe(Ge,`${ro}/${a}/history`)).key;return await ki(Xe(Ge),{[`${ro}/${a}`]:{...m,history:{...((Ee=Bt.value[a])==null?void 0:Ee.history)||{},[V]:{action:"override",at:Fn(),by:h,before:D,after:I}}}}),a},resetOverride:async(s,r)=>{if(!cn)throw new Error("Firebase 尚未設定");const l=lo(s,r);l&&await Ea(Xe(Ge,`${ro}/${l}`))}}}const nn=(n,e)=>{const t=n.__vccOpts||n;for(const[o,i]of e)t[o]=i;return t},lu={id:"map"},au=16,Rr=34,cu=84,du={__name:"MapBox",props:{parkingTypeKeyArray:Array,degreeOfFriendlinessKeyArray:Array,mapDataList:Array,getLngLat:Boolean,mapStylesSelected:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,goToParkingPlaceData:Object,routeData:Object,favoriteIds:{type:Object,default:()=>new Set},overrideKeys:{type:Object,default:()=>new Set},overrides:{type:Object,default:()=>({})},onlyFavorites:{type:Boolean,default:!1},focusCoord:{type:Array,default:null},routeProfile:{type:String,default:"driving"},communityParkings:{type:Array,default:()=>[]}},emits:["parkingInfo","communityParkingClick","update:goToParkingPlaceData","update:routeData"],setup(n,{expose:e,emit:t}){const o=n,i=t,s="pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",r=E(null),l=E({accessToken:s,bounds:[[119.3620389067818,21.83282743468497],[122.07013958372167,25.34391086143183]],center:[121.5173399,25.0475613],zoom:14,userCoordinates:[null,null]}),a=E(null),d=E([]),u=_=>_>=15?60:_>=13?60+(15-_)*30:_>=11?120+(13-_)*60:240,h=_=>Array.isArray(_)&&_.length>=2&&Number.isFinite(Number(_[0]))&&Number.isFinite(Number(_[1])),m=(_,M,G,q)=>{const K=document.createElement("div");K.className="marker",q&&K.classList.add("is-override"),G&&K.classList.add("is-fav");const Se=document.createElement("div");Se.className="tag";const xe=document.createElement("div");return xe.className="img",M.properties.icon&&(xe.style.backgroundImage=`url(${X(M.properties.icon)})`,xe.style.backgroundSize="cover",xe.style.backgroundPosition="center center"),K.appendChild(Se),K.appendChild(xe),K.addEventListener("click",()=>{r.value.flyTo({center:M.geometry.coordinates,zoom:17,bearing:0,speed:1.5,curve:1.5,easing:C=>C,essential:!0}),i("parkingInfo",{name:_.name,properties:M.properties,geometry:M.geometry.coordinates,address:""})}),K},b=(_,M)=>{const G=document.createElement("div");G.className="marker is-community",M&&G.classList.add("is-fav");const q=document.createElement("div");q.className="tag";const K=document.createElement("div");return K.className="img",_.iconKey&&(K.style.backgroundImage=`url(${X(_.iconKey)})`,K.style.backgroundSize="cover",K.style.backgroundPosition="center center"),G.appendChild(q),G.appendChild(K),G.addEventListener("click",()=>{r.value.flyTo({center:_.coordinates,zoom:17,speed:1.5,curve:1.5,essential:!0}),i("communityParkingClick",_)}),G},g=_=>{const M=document.createElement("div");M.className="marker-cluster";const G=Math.min(1,Math.log2(Math.max(2,_))/Math.log2(500)),q=Math.round(Rr+(cu-Rr)*G),K=Math.round(12+10*G);return M.style.width=`${q}px`,M.style.height=`${q}px`,M.style.lineHeight=`${q}px`,M.style.fontSize=`${K}px`,M.textContent=String(_),M},U=()=>{var Se,xe,tn,C,N,B,re,De,Oe,bn,on,he;for(let x=d.value.length-1;x>=0;x--)d.value[x].remove();if(d.value=[],!r.value)return;const _=(xe=(Se=r.value).getBounds)==null?void 0:xe.call(Se),M=[];for(const x of o.mapDataList)for(const O of x.features){const ce=O.geometry.coordinates;if(!h(ce))continue;const Le=ai(O.properties.name,ce),Fe=(C=(tn=o.favoriteIds)==null?void 0:tn.has)==null?void 0:C.call(tn,Le),_e=lo(O.properties.name,ce),Mn=_e?(B=(N=o.overrideKeys)==null?void 0:N.has)==null?void 0:B.call(N,_e):!1,sn=Mn?(re=o.overrides)==null?void 0:re[_e]:null,Te=typeof(sn==null?void 0:sn.priceInfo)=="string"&&sn.priceInfo.trim()!==""?sn.priceInfo.trim():"",rn=Te||O.properties.priceInfo,ln=Te?Te.split("|"):O.properties.priceArray;!Hs(_,ce)||o.onlyFavorites&&!Fe||!Ls(O.properties.icon,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray)||!Fs(rn,ln,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)||M.push({coord:[Number(ce[0]),Number(ce[1])],createEl:()=>m(x,O,Fe,Mn)})}for(const x of o.communityParkings||[]){const O=x.coordinates;if(!h(O)||!Hs(_,O))continue;const ce=ai(x.name,O),Le=(Oe=(De=o.favoriteIds)==null?void 0:De.has)==null?void 0:Oe.call(De,ce);if(o.onlyFavorites&&!Le||!Ls(x.iconKey,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray))continue;const Fe=x.priceInfo||"",_e=Fe?Fe.split("|"):[];Fs(Fe,_e,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)&&M.push({coord:[Number(O[0]),Number(O[1])],createEl:()=>b(x,Le)})}const G=(he=(on=(bn=r.value).getZoom)==null?void 0:on.call(bn))!=null?he:0;if(G>=au){for(const x of M){const O=new Nn.Marker(x.createEl()).setLngLat(x.coord).addTo(r.value);d.value.push(O)}return}const q=u(G),K=new Map;for(const x of M){const O=r.value.project(x.coord),ce=Math.floor(O.x/q),Le=Math.floor(O.y/q),Fe=`${ce}:${Le}`;let _e=K.get(Fe);_e||(_e={points:[],sumLng:0,sumLat:0},K.set(Fe,_e)),_e.points.push(x),_e.sumLng+=x.coord[0],_e.sumLat+=x.coord[1]}for(const x of K.values())if(x.points.length===1){const O=x.points[0],ce=new Nn.Marker(O.createEl()).setLngLat(O.coord).addTo(r.value);d.value.push(ce)}else{const O=[x.sumLng/x.points.length,x.sumLat/x.points.length],ce=g(x.points.length);ce.addEventListener("click",()=>{var _e,Mn,sn;const Fe=Math.min(((sn=(Mn=(_e=r.value).getZoom)==null?void 0:Mn.call(_e))!=null?sn:0)+2,17);r.value.flyTo({center:O,zoom:Fe,speed:1.5,curve:1.5,essential:!0})});const Le=new Nn.Marker(ce).setLngLat(O).addTo(r.value);d.value.push(Le)}};let D=null,I=null;const V=()=>{D!=null&&(clearTimeout(D),D=null),I!=null&&(typeof cancelIdleCallback=="function"&&cancelIdleCallback(I),I=null)},T=()=>{V(),D=setTimeout(()=>{D=null;const _=()=>{I=null,o.goToParkingPlaceData==null&&U()};typeof requestIdleCallback=="function"?I=requestIdleCallback(_,{timeout:250}):_()},80)},W=()=>{const _=document.getElementById("loading-cover");_&&(_.classList.add("active"),setTimeout(()=>_.remove(),600))},Ee=()=>{r.value.on("dragend",T),r.value.on("zoomend",T),U(),W(),r.value.once("load",()=>{const _=o.focusCoord;Array.isArray(_)&&_[0]!=null&&_[1]!=null&&r.value.flyTo({center:[Number(_[0]),Number(_[1])],zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})})},ae=()=>{r.value=new Nn.Map({container:"map",style:o.mapStylesSelected,center:l.value.center,zoom:16,trackResize:!0,maxBounds:l.value.bounds}),Ee(),r.value.addControl(new Nn.GeolocateControl({positionOptions:{enableHighAccuracy:!0},trackUserLocation:!0,showUserHeading:!0})),r.value.on("geolocate",_=>{r.value.easeTo({bearing:_.coords.heading,duration:1e3,offset:[0,0]})})},Ie=_=>{const{longitude:M,latitude:G}=_.coords;M>=l.value.bounds[0][0]&&M<=l.value.bounds[1][0]&&G>=l.value.bounds[0][1]&&G<=l.value.bounds[1][1]?(l.value.userCoordinates=[M,G],l.value.center=[M,G]):l.value.center=[121.5173399,25.0475613],ae()},Ae=()=>{ae()},de=()=>{const _=document.getElementById("coordinates"),M=a.value.getLngLat();_.style.display="block",_.innerHTML=`[Longitude, Latitude]<br />[${M.lng}, ${M.lat}]`},oe=()=>{a.value=new Nn.Marker({draggable:!0,color:"#2ee7d6"}).setLngLat(r.value.getCenter()).addTo(r.value),de(),a.value.on("dragend",de)};async function ke(_,M){r.value.getLayer("point")||r.value.addLayer({id:"point",type:"circle",source:{type:"geojson",data:{type:"FeatureCollection",features:[{type:"Feature",properties:{},geometry:{type:"Point",coordinates:_}}]}},paint:{"circle-radius":10,"circle-color":"#2ee7d6"}});const K=(await(await fetch(`https://api.mapbox.com/directions/v5/mapbox/${o.routeProfile||"driving"}/${_[0]},${_[1]};${M[0]},${M[1]}?alternatives=false&language=zh-Hant&overview=full&steps=true&exclude=ferry&geometries=geojson&access_token=${l.value.accessToken}`,{method:"GET"})).json()).routes[0],Se={type:"Feature",properties:{},geometry:{type:"LineString",coordinates:K.geometry.coordinates}};i("update:routeData",K),r.value.getSource("route")?r.value.getSource("route").setData(Se):r.value.addLayer({id:"route",type:"line",source:{type:"geojson",data:Se},layout:{"line-join":"round","line-cap":"round"},paint:{"line-color":"#2ee7d6","line-width":5,"line-opacity":.75}})}const Re=_=>{if(l.value.userCoordinates[0]!==null){r.value.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point"));for(let G=d.value.length-1;G>=0;G--){const q=d.value[G].getLngLat();q.lng!=_[0]&&q.lat!=_[1]&&d.value[G].remove()}const M=[[l.value.userCoordinates[0],l.value.userCoordinates[1]],[_[0],_[1]]];r.value.fitBounds(M,{padding:{top:100,bottom:100,left:100,right:100}}),ke(l.value.userCoordinates,_)}else"geolocation"in navigator&&navigator.geolocation.getCurrentPosition(Ie,Ae)},Be=()=>{var _,M;(_=r.value)!=null&&_.getSource("route")&&(r.value.removeLayer("route"),r.value.removeSource("route")),(M=r.value)!=null&&M.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point")),U(),i("update:goToParkingPlaceData",null)};return Kn(()=>{Nn.accessToken=l.value.accessToken,"geolocation"in navigator?navigator.geolocation.getCurrentPosition(Ie,Ae,{enableHighAccuracy:!1,timeout:8e3,maximumAge:6e4}):ae()}),ht(()=>{V()}),J([()=>o.parkingTypeKeyArray,()=>o.degreeOfFriendlinessKeyArray,()=>o.priceRangeMin,()=>o.priceRangeMax,()=>o.parkingPriceType,()=>o.onlyFavorites,()=>o.favoriteIds,()=>o.communityParkings],()=>T()),J(()=>o.focusCoord,_=>{!_||!r.value||r.value.flyTo({center:_,zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})}),J(()=>o.routeProfile,()=>{o.goToParkingPlaceData!==null&&l.value.userCoordinates[0]!==null&&ke(l.value.userCoordinates,o.goToParkingPlaceData)}),J(()=>o.goToParkingPlaceData,_=>{_!==null?Re(_):Be()}),J(()=>o.mapStylesSelected,(_,M)=>{M!==_&&r.value&&r.value.setStyle(_)}),J(()=>o.getLngLat,()=>{if(a.value!==null){a.value.remove();const _=document.getElementById("coordinates");_&&(_.style.display="none")}o.getLngLat===!0&&oe()}),e({getCenter:()=>{if(!r.value)return[...l.value.center];const _=r.value.getCenter();return[_.lng,_.lat]},flyTo:(_,M=17)=>{!r.value||!_||r.value.flyTo({center:_,zoom:M,essential:!0})}}),(_,M)=>(v(),P("div",lu))}},hu=nn(du,[["__scopeId","data-v-09d5679d"]]),uu=n=>(wn("data-v-4ef15e45"),n=n(),kn(),n),pu={key:0,class:"modal-header"},mu=uu(()=>c("span",{class:"material-icons-outlined"},"close",-1)),fu=[mu],yu={class:"modal-body"},bu={key:1,class:"modal-footer"},gu={__name:"BaseModal",props:{modelValue:Boolean,title:{type:String,default:""},closeText:{type:String,default:"關閉"},size:{type:String,default:"md"}},emits:["update:modelValue","close"],setup(n,{emit:e}){const t=n,o=e,i=E(null),s=()=>{o("update:modelValue",!1),o("close")},r=l=>{l.key==="Escape"&&t.modelValue&&s()};return Kn(()=>window.addEventListener("keydown",r)),ht(()=>window.removeEventListener("keydown",r)),J(()=>t.modelValue,async l=>{var a;document.body.classList.toggle("modal-open",l),l&&(await Vr(),(a=i.value)==null||a.scrollTo({top:0,behavior:"auto"}))}),(l,a)=>(v(),Li(sc,{to:"body"},[c("div",{class:ie(["modal-overlay",{active:n.modelValue}]),onClick:Fi(s,["self"]),role:"dialog","aria-modal":"true",ref_key:"overlayEl",ref:i},[c("div",{class:ie(["modal-card",[`size-${n.size}`,{active:n.modelValue}]])},[n.title||l.$slots.header?(v(),P("header",pu,[Yo(l.$slots,"header",{},()=>[c("h3",null,w(n.title),1)]),c("button",{class:"modal-close",onClick:s,"aria-label":"關閉"},fu)])):j("",!0),c("div",yu,[Yo(l.$slots,"default",{},void 0)]),l.$slots.footer||n.closeText?(v(),P("footer",bu,[Yo(l.$slots,"footer",{},()=>[c("button",{class:"btn btn-primary",onClick:s},w(n.closeText),1)])])):j("",!0)],2)],2)]))}},Ln=nn(gu,[["__scopeId","data-v-4ef15e45"]]),Au=["onClick"],_u={class:"material-icons-outlined"},vu={class:"fab-item-label"},Cu=["aria-label","aria-expanded"],Pu={class:"material-icons-outlined"},Uu={__name:"FabMenu",props:{items:{type:Array,required:!0},placement:{type:String,default:"right"},mainIcon:{type:String,default:"apps"},mainLabel:{type:String,default:""}},setup(n){const e=E(!1),t=E(null),o=()=>e.value=!e.value,i=r=>{t.value&&!t.value.contains(r.target)&&(e.value=!1)},s=r=>{var l;e.value=!1,(l=r.onClick)==null||l.call(r)};return Kn(()=>document.addEventListener("click",i)),ht(()=>document.removeEventListener("click",i)),(r,l)=>(v(),P("div",{class:ie(["fab-root",`fab-placement-${n.placement}`]),ref_key:"rootEl",ref:t},[Ue(rc,{name:"fab-item",tag:"div",class:"fab-items"},{default:an(()=>[(v(!0),P(ye,null,Ke(e.value?n.items:[],(a,d)=>(v(),P("button",{key:a.key,class:ie(["fab-item",{highlight:a.highlight}]),style:co({bottom:d*46+"px"}),onClick:u=>s(a)},[c("span",_u,w(a.icon),1),c("span",vu,w(a.label),1)],14,Au))),128))]),_:1}),c("button",{class:ie(["fab-main",{active:e.value}]),onClick:Fi(o,["stop"]),"aria-label":e.value?"收合選單":n.mainLabel||"展開選單","aria-expanded":e.value},[c("span",Pu,w(e.value?"close":n.mainIcon),1)],10,Cu)],2))}},xr=nn(Uu,[["__scopeId","data-v-b3399b6f"]]),Gt=[{name:"全部",value:"",key:null},{name:"汽車：汽車格(含未確認是否有重機格)",value:"car",key:["icon-1.png","icon-2.png","icon-3.png","icon-5.png"]},{name:"重機：有設重機專用格",value:"motorcycle",key:["icon-6.png","icon-8.png","icon-12.png","icon-13.png"]},{name:"機車：機車格",value:"scooter",key:["icon-7.png","icon-9.png","icon-10.png","icon-11.png"]},{name:"綠星:路邊友善車格(機車格開放重機停放)",value:"greenStar",key:["icon-14.png"]},{name:"重機友善店家:用餐/消費可停重機",value:"friendlyShop",key:["icon-4.png"]},{name:"綠P:重機專用路邊停車格",value:"greenP",key:["icon-15.png"]},{name:"灰P:重機專用路邊停車格(未確認精準座標)",value:"greyP",key:["icon-16.png"]},{name:"藍P:普通大型共用機車格(台北市試辦)",value:"blueP",key:["icon-17.png"]},{name:"紫P:時段性汽機車共用停車格，注意使用時間喔!",value:"purpleP",key:["icon-18.png"]},{name:"紅X:停都不給停",value:"redX",key:["icon-19.png"]},{name:"?:類型未確認",value:"unknown",key:["icon-20.png"]}],Kt=[{name:"全部",value:"",key:null},{name:"最友善：有後牌辨析",value:"friendly",key:["icon-2.png","icon-4.png","icon-6.png","icon-9.png","icon-14.png","icon-15.png"]},{name:"最傳統：悠遊卡、按鈕取票",value:"normal",key:["icon-5.png","icon-11.png","icon-12.png","icon-17.png"]},{name:"最靠北：按鈕請管理員協助、前牌辨析",value:"unfriendly",key:["icon-1.png","icon-7.png","icon-13.png","icon-19.png"]},{name:"未確定",value:"unknown",key:["icon-3.png","icon-8.png","icon-10.png","icon-16.png","icon-20.png"]}],nt=[{name:"依系統設定",value:"system",theme:"system"},{name:"暗色模式",value:"mapbox://styles/jamestim9215/ckvkdj5cd1q4115nzwxa9rny3",theme:"dark"},{name:"亮色模式",value:"mapbox://styles/jamestim9215/ckvueghhu2woc14nrsgysx41v",theme:"light"}],Eu="260526",Iu=n=>(wn("data-v-fc736dec"),n=n(),kn(),n),Bu={class:"range-slider"},Su={class:"range-track"},wu=["min","max","step","value"],ku=["min","max","step","value"],Du={class:"range-values"},Tu=Iu(()=>c("span",{class:"range-sep"},"~",-1)),Mu={__name:"RangeSlider",props:{min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:10},modelMin:{type:Number,default:0},modelMax:{type:Number,default:100},suffix:{type:String,default:""}},emits:["update:modelMin","update:modelMax"],setup(n,{emit:e}){const t=n,o=e,i=ne(()=>t.max-t.min||1),s=ne(()=>(t.modelMin-t.min)/i.value*100),r=ne(()=>(t.modelMax-t.min)/i.value*100),l=d=>{let u=Number(d.target.value);u>t.modelMax&&(u=t.modelMax),o("update:modelMin",u)},a=d=>{let u=Number(d.target.value);u<t.modelMin&&(u=t.modelMin),o("update:modelMax",u)};return(d,u)=>(v(),P("div",Bu,[c("div",Su,[c("div",{class:"range-fill",style:co({left:s.value+"%",right:100-r.value+"%"})},null,4),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMin,onInput:l,class:"range-input range-input-min","aria-label":"最低價格"},null,40,wu),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMax,onInput:a,class:"range-input range-input-max","aria-label":"最高價格"},null,40,ku)]),c("div",Du,[c("span",null,w(n.modelMin)+w(n.suffix),1),Tu,c("span",null,w(n.modelMax)+w(n.suffix),1)])]))}},Nu=nn(Mu,[["__scopeId","data-v-fc736dec"]]),Ve=n=>(wn("data-v-511ae798"),n=n(),kn(),n),Ru=Ve(()=>c("span",{class:"material-icons-outlined"},"chevron_left",-1)),xu=[Ru],Ou=Wr('<header class="side-panel-header" data-v-511ae798><img class="side-panel-logo" src="'+Hi+'" alt="重機能停哪" data-v-511ae798><div class="side-panel-titles" data-v-511ae798><h3 data-v-511ae798>重機能停哪?</h3><span class="side-panel-subtitle" data-v-511ae798><span class="material-icons-outlined" data-v-511ae798>tune</span>設定 </span></div></header>',1),Lu={class:"side-panel-body"},Fu={class:"form-group"},Hu={class:"form-toggle"},zu={class:"form-toggle-text"},Vu=Ve(()=>c("span",{class:"material-icons-outlined fav-icon"},"star",-1)),Wu={key:0,class:"fav-count"},ju=["checked"],Gu={class:"form-group"},Ku=Ve(()=>c("label",{class:"form-label"},"甚麼格位",-1)),Qu=["value"],Yu=["value"],Xu={class:"form-group"},Ju=Ve(()=>c("label",{class:"form-label"},"友善程度",-1)),qu=["value"],$u=["value"],Zu={class:"form-group"},e3=Ve(()=>c("label",{class:"form-label"},"收費範圍",-1)),n3={class:"price-chips"},t3=Ve(()=>c("span",{class:"material-icons-outlined"},"money_off",-1)),o3={class:"form-group"},i3=Ve(()=>c("label",{class:"form-label"},"主題顏色",-1)),s3=["value"],r3=["value"],l3=Wr('<section class="form-group" data-v-511ae798><label class="form-label" data-v-511ae798>停車場資料來源</label><div class="link-list" data-v-511ae798><a href="https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&amp;g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&amp;skid=9984dc32-0eac-4e02-b7a8-241e8910f915&amp;shorturl=1&amp;ll=25.078951126084913%2C121.45397636318671&amp;z=11" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-511ae798> Alan大重停車記事 </a></div></section><section class="form-group" data-v-511ae798><label class="form-label" data-v-511ae798>問題回報</label><p class="muted-text" data-v-511ae798> 1. 停車場資訊相關（新場地、收費錯誤）： </p><a href="https://forms.gle/euRCPCPSmvYLm5Rj8" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-511ae798> Alan大重停車記事 回報表單 </a><p class="muted-text mt-8" data-v-511ae798>2. 網頁 BUG、畫面跑版：</p><a href="https://forms.gle/iJCyfqVtpL35WtZM7" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-511ae798> 重機能停哪? 回報表單 </a><a href="https://buymeacoffee.com/jamestim923" target="_blank" rel="noopener" class="btn btn-coffee btn-sm mt-8" data-v-511ae798> ☕️ 請我喝杯咖啡，讓我有動力繼續更新 </a></section>',2),a3={class:"form-group"},c3=Ve(()=>c("label",{class:"form-label"},"資訊",-1)),d3={class:"info-list"},h3=Ve(()=>c("li",null,"版本：v2.2.1",-1)),u3=Ve(()=>c("li",null,"Web 製作：爽爽",-1)),p3=Ve(()=>c("li",null,"資料參考：Alan大重停車記事 Google My Map",-1)),m3=Ve(()=>c("li",null,"地圖：Mapbox GL JS API",-1)),f3=Ve(()=>c("li",null,"© 2026 爽爽 版權所有。本網頁未經准許，禁止任何商業行為",-1)),y3={__name:"SettingsPanel",props:{parkingType:String,degreeOfFriendliness:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,mapStyle:String,active:Boolean,onlyFavorites:Boolean,favoritesCount:{type:Number,default:0}},emits:["update:parkingType","update:degreeOfFriendliness","update:parkingPriceType","update:priceRangeMin","update:priceRangeMax","update:mapStyle","update:active","update:onlyFavorites"],setup(n,{emit:e}){const t=e,o=()=>t("update:active",!1);return(i,s)=>(v(),P("aside",{class:ie(["side-panel",{active:n.active}]),"aria-label":"設定面板"},[c("button",{class:"side-panel-close",onClick:o,"aria-label":"收合設定"},xu),Ou,c("div",Lu,[c("section",Fu,[c("label",Hu,[c("span",zu,[Vu,k(" 只看我的最愛 "),n.favoritesCount?(v(),P("span",Wu,w(n.favoritesCount),1)):j("",!0)]),c("input",{type:"checkbox",class:"switch",checked:n.onlyFavorites,onChange:s[0]||(s[0]=r=>t("update:onlyFavorites",r.target.checked))},null,40,ju)])]),c("section",Gu,[Ku,c("select",{class:"form-control",value:n.parkingType,onChange:s[1]||(s[1]=r=>t("update:parkingType",r.target.value))},[(v(!0),P(ye,null,Ke(L(Gt),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,Yu))),128))],40,Qu)]),c("section",Xu,[Ju,c("select",{class:"form-control",value:n.degreeOfFriendliness,onChange:s[2]||(s[2]=r=>t("update:degreeOfFriendliness",r.target.value))},[(v(!0),P(ye,null,Ke(L(Kt),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,$u))),128))],40,qu)]),c("section",Zu,[e3,c("div",n3,[c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType===""}]),onClick:s[3]||(s[3]=r=>t("update:parkingPriceType",""))},"全部",2),c("button",{type:"button",class:ie(["chip chip-free",{active:n.parkingPriceType==="free"}]),onClick:s[4]||(s[4]=r=>t("update:parkingPriceType",n.parkingPriceType==="free"?"":"free"))},[t3,k(" 免費 ")],2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="h"}]),onClick:s[5]||(s[5]=r=>t("update:parkingPriceType","h"))},"計時 /時",2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="d"}]),onClick:s[6]||(s[6]=r=>t("update:parkingPriceType","d"))},"計次 /日",2)]),/d|h/.test(n.parkingPriceType)?(v(),Li(Nu,{key:0,class:"mt-8",min:0,max:300,step:10,"model-min":n.priceRangeMin,"model-max":n.priceRangeMax,suffix:n.parkingPriceType==="h"?" /時":" /日","onUpdate:modelMin":s[7]||(s[7]=r=>t("update:priceRangeMin",r)),"onUpdate:modelMax":s[8]||(s[8]=r=>t("update:priceRangeMax",r))},null,8,["model-min","model-max","suffix"])):j("",!0)]),c("section",o3,[i3,c("select",{class:"form-control",value:n.mapStyle,onChange:s[9]||(s[9]=r=>t("update:mapStyle",r.target.value))},[(v(!0),P(ye,null,Ke(L(nt),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,r3))),128))],40,s3)]),l3,c("section",a3,[c3,c("ul",d3,[h3,c("li",null,"地圖資料更新："+w(L(Eu)),1),u3,p3,m3,f3])])])],2))}},b3=nn(y3,[["__scopeId","data-v-511ae798"]]),Ye=n=>(wn("data-v-e6db4a59"),n=n(),kn(),n),g3=Ye(()=>c("span",{class:"material-icons-outlined"},"close",-1)),A3=[g3],_3={class:"info-header"},v3=["src"],C3={class:"info-title"},P3=["aria-label","title"],U3={class:"material-icons-outlined"},E3=["innerHTML"],I3={key:1,class:"info-address"},B3={key:2,class:"info-price"},S3=Ye(()=>c("span",{class:"material-icons-outlined"},"payments",-1)),w3=Ye(()=>c("span",{class:"info-price-label"},"收費",-1)),k3={class:"info-price-value"},D3={key:0,class:"info-price-tag"},T3={key:3,class:"community-tag"},M3=Ye(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),N3={key:4,class:"override-tag"},R3=Ye(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),x3={key:5,class:"source-tag"},O3=Ye(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),L3={class:"info-meta"},F3={class:"badge"},H3={class:"coord"},z3={class:"info-actions"},V3=Ye(()=>c("span",{class:"material-icons-outlined"},"edit",-1)),W3=["title"],j3=Ye(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),G3=Ye(()=>c("span",{class:"material-icons-outlined"},"share",-1)),K3={class:"info-actions"},Q3=Ye(()=>c("span",{class:"material-icons-outlined"},"map",-1)),Y3=Ye(()=>c("span",{class:"material-icons-outlined"},"map",-1)),X3=Ye(()=>c("span",{class:"material-icons-outlined"},"directions",-1)),J3={__name:"ParkingInfoPanel",props:{info:Object,active:Boolean,isMobile:Boolean,isApple:Boolean,isAndroid:Boolean,hasRoute:Boolean,isFavorite:Boolean,isCommunity:{type:Boolean,default:!1},communityMeta:{type:Object,default:null},isOverridden:{type:Boolean,default:!1},overrideMeta:{type:Object,default:null}},emits:["close","route","openMap","toggleFavorite","editCommunity","editOverride","share"],setup(n,{emit:e}){const t=e,o=new Set(["icon-4.png","icon-14.png","icon-19.png"]),i=s=>!!(s!=null&&s.priceInfo)&&!o.has(s==null?void 0:s.parkingIconKey);return(s,r)=>{var l,a,d,u,h,m,b,g;return v(),P("aside",{class:ie(["info-panel",{active:n.active}]),"aria-label":"停車場資訊"},[c("button",{class:"panel-close",onClick:r[0]||(r[0]=U=>t("close")),"aria-label":"關閉"},A3),c("header",_3,[n.info.parkingIcon?(v(),P("img",{key:0,class:"info-icon",src:n.info.parkingIcon,alt:""},null,8,v3)):j("",!0),c("h3",C3,w(n.info.parkingName),1),c("button",{class:ie(["fav-btn",{active:n.isFavorite}]),onClick:r[1]||(r[1]=U=>t("toggleFavorite")),"aria-label":n.isFavorite?"從我的最愛移除":"加入我的最愛",title:n.isFavorite?"從我的最愛移除":"加入我的最愛"},[c("span",U3,w(n.isFavorite?"star":"star_border"),1)],10,P3)]),n.info.parkingNameDes?(v(),P("div",{key:0,class:"info-desc",innerHTML:n.info.parkingNameDes},null,8,E3)):j("",!0),n.info.address?(v(),P("div",I3,w(n.info.address),1)):j("",!0),i(n.info)?(v(),P("div",B3,[S3,w3,c("span",k3,w(n.info.priceInfo),1),n.isOverridden?(v(),P("span",D3,"車友修改")):j("",!0)])):j("",!0),n.isCommunity?(v(),P("div",T3,[M3,c("span",null,[k(" 共筆停車點 "),(a=(l=n.communityMeta)==null?void 0:l.updatedBy)!=null&&a.nickname||(u=(d=n.communityMeta)==null?void 0:d.updatedBy)!=null&&u.id?(v(),P(ye,{key:0},[k(" · 由 "+w(n.communityMeta.updatedBy.nickname||`匿名#${n.communityMeta.updatedBy.id}`)+" 更新 ",1)],64)):j("",!0)])])):n.isOverridden?(v(),P("div",N3,[R3,c("span",null,[k(" 車友修改資訊 "),(m=(h=n.overrideMeta)==null?void 0:h.updatedBy)!=null&&m.nickname||(g=(b=n.overrideMeta)==null?void 0:b.updatedBy)!=null&&g.id?(v(),P(ye,{key:0},[k(" · 由 "+w(n.overrideMeta.updatedBy.nickname||`匿名#${n.overrideMeta.updatedBy.id}`)+" 更新 ",1)],64)):j("",!0)])])):j("",!0),!n.isCommunity&&n.info.sourceLabel?(v(),P("div",x3,[O3,c("span",null,"資料來源 · "+w(n.info.sourceLabel),1)])):j("",!0),c("div",L3,[c("span",F3,w(n.info.parkingType),1),c("span",H3,w(Number(n.info.geometry[0]).toFixed(5))+", "+w(Number(n.info.geometry[1]).toFixed(5)),1)]),c("div",z3,[n.isCommunity?(v(),P("button",{key:0,class:"btn btn-outline btn-sm",onClick:r[2]||(r[2]=U=>t("editCommunity"))},[V3,k(" 編輯 ")])):(v(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:r[3]||(r[3]=U=>t("editOverride")),title:n.isOverridden?"修改車友提供的資訊 (不會變動官方資料)":"異議 / 補充官方資料 (不會變動官方資料)"},[j3,k(" "+w(n.isOverridden?"修改車友資訊":"異議 / 補充"),1)],8,W3)),c("button",{class:"btn btn-outline btn-sm",onClick:r[4]||(r[4]=U=>t("share")),title:"分享這個停車點"},[G3,k(" 分享 ")])]),c("div",K3,[n.isAndroid?j("",!0):(v(),P("button",{key:0,class:"btn btn-primary btn-sm",onClick:r[5]||(r[5]=U=>t("openMap","apple"))},[Q3,k(" Apple Map ")])),c("button",{class:ie(["btn","btn-sm",n.isAndroid?"btn-primary":"btn-outline"]),onClick:r[6]||(r[6]=U=>t("openMap","google"))},[Y3,k(" Google Map ")],2),n.hasRoute?j("",!0):(v(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:r[7]||(r[7]=U=>t("route"))},[X3,k(" 路線規劃 ")]))])],2)}}},q3=nn(J3,[["__scopeId","data-v-e6db4a59"]]),Is=n=>(wn("data-v-caf0ec6e"),n=n(),kn(),n),$3={class:"route-header"},Z3=Is(()=>c("h3",null,[c("span",{class:"material-icons-outlined"},"alt_route"),k(" 路線 ")],-1)),e5=["aria-expanded"],n5={class:"material-icons-outlined"},t5={key:0,class:"route-summary"},o5={class:"route-summary-item"},i5=Is(()=>c("span",{class:"material-icons-outlined"},"schedule",-1)),s5={class:"route-summary-item"},r5=Is(()=>c("span",{class:"material-icons-outlined"},"straighten",-1)),l5={class:"route-profile",role:"tablist","aria-label":"交通方式"},a5=["onClick","aria-pressed"],c5={class:"material-icons-outlined"},d5={class:"profile-label"},h5={key:1,class:"route-steps"},u5={__name:"RouteSteps",props:{routeData:Object,active:Boolean,profile:{type:String,default:"driving"}},emits:["cancel","update:profile"],setup(n,{emit:e}){const t=n,o=e,i=E(!0),s=()=>i.value=!i.value,r=[{value:"driving",label:"汽機車",icon:"directions_car"},{value:"cycling",label:"單車",icon:"directions_bike"},{value:"walking",label:"步行",icon:"directions_walk"}],l=ne(()=>{var h;const u=(h=t.routeData)==null?void 0:h.distance;return typeof u!="number"?"":u>=1e3?`${(u/1e3).toFixed(1)} km`:`${Math.round(u)} m`}),a=ne(()=>{var g;const u=(g=t.routeData)==null?void 0:g.duration;if(typeof u!="number")return"";const h=Math.round(u/60);if(h<60)return`${h} 分`;const m=Math.floor(h/60),b=h%60;return b?`${m} 時 ${b} 分`:`${m} 時`}),d=u=>o("update:profile",u);return(u,h)=>(v(),P("aside",{class:ie(["route-panel",{active:n.active}])},[c("header",$3,[Z3,c("button",{class:"route-toggle",onClick:s,"aria-expanded":i.value},[c("span",n5,w(i.value?"expand_less":"expand_more"),1)],8,e5)]),n.routeData?(v(),P("div",t5,[c("div",o5,[i5,c("strong",null,w(a.value),1)]),c("div",s5,[r5,c("strong",null,w(l.value),1)])])):j("",!0),c("div",l5,[(v(),P(ye,null,Ke(r,m=>c("button",{key:m.value,class:ie(["profile-btn",{active:n.profile===m.value}]),onClick:b=>d(m.value),"aria-pressed":n.profile===m.value},[c("span",c5,w(m.icon),1),c("span",d5,w(m.label),1)],10,a5)),64))]),n.routeData&&i.value?(v(),P("ol",h5,[(v(!0),P(ye,null,Ke(n.routeData.legs[0].steps,(m,b)=>(v(),P("li",{key:b,class:"route-step"},w(m.maneuver.instruction),1))),128))])):j("",!0),c("button",{class:"btn btn-danger btn-sm route-cancel",onClick:h[0]||(h[0]=m=>o("cancel"))}," 取消路線規劃 ")],2))}},p5=nn(u5,[["__scopeId","data-v-caf0ec6e"]]);function m5(n,e,t=20,o=[]){const i=(e||"").trim().toLowerCase();if(!i)return[];const s=[];if(Array.isArray(n))for(const r of n)for(const l of r.features){const a=(l.properties.name||"").toLowerCase(),d=(l.properties.description||"").toLowerCase();if((a.includes(i)||d.includes(i))&&(s.push({groupName:r.name,name:l.properties.name,description:l.properties.description,icon:l.properties.icon,geometry:l.geometry.coordinates,properties:l.properties,isCommunity:!1,score:(a.includes(i)?1e3:0)-(a.indexOf(i)===-1?0:a.indexOf(i))}),s.length>500))break}if(Array.isArray(o))for(const r of o){const l=(r.name||"").toLowerCase(),a=(r.description||"").toLowerCase();if(!l.includes(i)&&!a.includes(i))continue;const d=Array.isArray(r.coordinates)?r.coordinates:[null,null];if(!(d[0]==null||d[1]==null)&&(s.push({groupName:"共筆停車點",name:r.name,description:r.description,icon:r.iconKey,geometry:d,properties:{name:r.name,description:r.description,icon:r.iconKey},isCommunity:!0,community:r,score:(l.includes(i)?900:0)-(l.indexOf(i)===-1?0:l.indexOf(i))}),s.length>500))break}return s.sort((r,l)=>l.score-r.score),s.slice(0,t)}const ka=n=>(wn("data-v-2b0f75f6"),n=n(),kn(),n),f5={key:0,class:"search-results",role:"listbox"},y5=["aria-selected","onMouseenter","onClick"],b5=["src"],g5={class:"search-item-text"},A5={class:"search-item-name"},_5={class:"search-item-group"},v5={key:1,class:"search-empty"},C5={class:"search-box",role:"combobox","aria-expanded":"true"},P5=ka(()=>c("span",{class:"material-icons-outlined search-icon"},"search",-1)),U5=ka(()=>c("span",{class:"material-icons-outlined"},"close",-1)),E5=[U5],I5=["aria-label","aria-expanded"],B5={class:"material-icons-outlined"},S5={__name:"SearchBar",props:{mapDataList:Array,communityParkings:{type:Array,default:()=>[]}},emits:["select"],setup(n,{emit:e}){const t=n,o=e,i=E(!1),s=E(""),r=E(-1),l=ne(()=>s.value?m5(t.mapDataList,s.value,15,t.communityParkings):[]);J(s,()=>{r.value=-1});const a=()=>{i.value=!i.value,i.value||(s.value="")},d=()=>{i.value=!1,s.value=""},u=m=>{o("select",m),d()},h=m=>{if(l.value.length)if(m.key==="ArrowDown")m.preventDefault(),r.value=(r.value+1)%l.value.length;else if(m.key==="ArrowUp")m.preventDefault(),r.value=(r.value-1+l.value.length)%l.value.length;else if(m.key==="Enter"){m.preventDefault();const b=r.value>=0?r.value:0;u(l.value[b])}else m.key==="Escape"&&d()};return(m,b)=>(v(),P("div",{class:ie(["search-wrap",{open:i.value}])},[i.value&&l.value.length?(v(),P("ul",f5,[(v(!0),P(ye,null,Ke(l.value,(g,U)=>(v(),P("li",{key:U,class:ie(["search-item",{active:U===r.value}]),role:"option","aria-selected":U===r.value,onMouseenter:D=>r.value=U,onClick:D=>u(g)},[g.icon?(v(),P("img",{key:0,src:L(X)(g.icon),class:"search-item-icon",alt:""},null,8,b5)):j("",!0),c("div",g5,[c("div",A5,w(g.name),1),c("div",_5,w(g.groupName),1)])],42,y5))),128))])):i.value&&s.value&&!l.value.length?(v(),P("div",v5," 找不到「"+w(s.value)+"」相關停車場 ",1)):j("",!0),je(c("div",C5,[P5,je(c("input",{"onUpdate:modelValue":b[0]||(b[0]=g=>s.value=g),class:"search-input",type:"text",placeholder:"搜尋停車場名稱…",autofocus:"",onKeydown:h},null,544),[[It,s.value]]),s.value?(v(),P("button",{key:0,class:"search-clear",onClick:b[1]||(b[1]=g=>s.value=""),"aria-label":"清除"},E5)):j("",!0)],512),[[Et,i.value]]),c("button",{class:ie(["search-toggle",{active:i.value}]),onClick:a,"aria-label":i.value?"關閉搜尋":"開啟搜尋","aria-expanded":i.value},[c("span",B5,w(i.value?"close":"search"),1)],10,I5)],2))}},w5=nn(S5,[["__scopeId","data-v-2b0f75f6"]]),Tn=n=>(wn("data-v-8a26dac9"),n=n(),kn(),n),k5={class:"editor-body"},D5={key:0,class:"editor-note override-note"},T5=Tn(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),M5={key:1,class:"editor-note"},N5=Tn(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),R5={class:"form-group"},x5={class:"form-label"},O5={key:0},L5={key:1,class:"hint-inline"},F5=["readonly","disabled"],H5={class:"form-group"},z5=Tn(()=>c("label",{class:"form-label"},"類別",-1)),V5=["value"],W5={class:"form-group"},j5={class:"form-label"},G5={key:0,class:"hint-inline"},K5=["disabled"],Q5=["value"],Y5={class:"form-group"},X5=Tn(()=>c("label",{class:"form-label"},"收費",-1)),J5={class:"chip-row"},q5=["onClick"],$5={key:0,class:"price-amount"},Z5={class:"unit"},ep={key:1,class:"price-amount"},np={class:"form-group"},tp=Tn(()=>c("label",{class:"form-label"},"說明(選填)",-1)),op={class:"form-group"},ip=Tn(()=>c("label",{class:"form-label"},"暱稱(選填)",-1)),sp=["value"],rp={key:2,class:"error-msg"},lp={key:3,class:"form-group history-section"},ap={class:"form-label"},cp=Tn(()=>c("span",{class:"material-icons-outlined",style:{"font-size":"14px","vertical-align":"-2px"}},"history",-1)),dp={class:"history-list"},hp={class:"h-row1"},up={class:"h-by"},pp={class:"h-time"},mp={key:0,class:"h-diff h-diff-note"},fp={key:1,class:"h-diff-list"},yp={class:"h-diff-label"},bp={class:"h-diff-old"},gp=Tn(()=>c("span",{class:"h-diff-arrow"},"→",-1)),Ap={class:"h-diff-new"},_p={key:2,class:"h-diff h-diff-note"},vp=["disabled"],Cp=["disabled"],Pp=["disabled"],Up=["disabled"],Ep={__name:"CommunityParkingEditor",props:{open:Boolean,mode:{type:String,default:"add"},initial:{type:Object,default:null},defaultCoord:{type:Array,default:()=>[121.5173399,25.0475613]},nickname:{type:String,default:""},isOwner:{type:Boolean,default:!1},isAdmin:{type:Boolean,default:!1},submitting:{type:Boolean,default:!1},hasExistingOverride:{type:Boolean,default:!1},history:{type:Array,default:()=>[]}},emits:["update:open","update:nickname","submit","delete","reset"],setup(n,{emit:e}){const t=n,o=e,i=E(""),s=E(""),r=E("motorcycle"),l=E("friendly"),a=E("free"),d=E(""),u=E(""),h=E([null,null]),m=ne(()=>Gt.filter(C=>C.value)),b=ne(()=>Kt.filter(C=>C.value)),g={greenStar:"icon-14.png",friendlyShop:"icon-4.png",greenP:"icon-15.png",greyP:"icon-16.png",blueP:"icon-17.png",purpleP:"icon-18.png",redX:"icon-19.png",unknown:"icon-20.png"},U=ne(()=>{if(g[r.value])return g[r.value];const C=Gt.find(re=>re.value===r.value),N=Kt.find(re=>re.value===l.value);return C?N&&C.key.find(re=>N.key.includes(re))||C.key[0]:"icon-3.png"}),D=ne(()=>!!g[r.value]);function I(C){if(!C)return{type:"free",amount:"",custom:""};const N=C.trim();if(/^free$/i.test(N))return{type:"free",amount:"",custom:""};const B=N.match(/^(\d+(?:\.\d+)?)\s*\/\s*([hd])$/i);return B?{type:B[2].toLowerCase(),amount:B[1],custom:""}:{type:"custom",amount:"",custom:N}}function V(){return a.value==="free"?"Free":a.value==="custom"?u.value.trim():d.value?`${d.value}/${a.value}`:""}const T=()=>{if((t.mode==="edit"||t.mode==="override")&&t.initial){i.value=t.initial.name||"",s.value=t.initial.description||"",r.value=t.initial.category||"motorcycle",l.value=t.initial.friendliness||"friendly";const C=I(t.initial.priceInfo||"");a.value=C.type,d.value=C.amount,u.value=C.custom,h.value=t.initial.coordinates?[...t.initial.coordinates]:[...t.defaultCoord]}else i.value="",s.value="",r.value="motorcycle",l.value="friendly",a.value="free",d.value="",u.value="",h.value=[...t.defaultCoord]};J(()=>t.open,C=>{C&&T()});const W=E(""),Ee=()=>{if(W.value="",!i.value.trim()){W.value="請輸入名稱";return}if(h.value[0]==null||h.value[1]==null||Number.isNaN(Number(h.value[0]))||Number.isNaN(Number(h.value[1]))){W.value="座標無效";return}o("submit",{name:i.value,description:s.value,iconKey:U.value,category:r.value,friendliness:D.value?"":l.value,priceInfo:V(),coordinates:[Number(h.value[0]),Number(h.value[1])]})},ae=()=>{var C;(C=t.initial)!=null&&C.id&&window.confirm(`確定要刪除「${i.value}」?此動作無法復原。`)&&o("delete",t.initial.id)},Ie=()=>{window.confirm(`確定要重設「${i.value}」回官方原始資料嗎?
你和其他車友先前的修改將被移除。`)&&o("reset")},Ae=ne({get:()=>t.open,set:C=>o("update:open",C)}),de=[{value:"free",label:"免費"},{value:"h",label:"計時 / 小時"},{value:"d",label:"計次 / 天"},{value:"custom",label:"其他"}],oe=E(!1),ke=ne(()=>!t.history||t.history.length===0?[]:oe.value?t.history:t.history.slice(0,5)),Re={create:"新增",update:"修改",delete:"刪除",override:"覆寫",reset:"重設"};function Be(C){return Re[C]||C||"變更"}function _(C){return C?C.nickname||(C.id?`匿名#${C.id}`:"匿名"):"系統"}function M(C){if(!C||!isFinite(Number(C)))return"";const N=new Date(Number(C)),B=re=>String(re).padStart(2,"0");return`${N.getFullYear()}/${B(N.getMonth()+1)}/${B(N.getDate())} ${B(N.getHours())}:${B(N.getMinutes())}`}const G={name:"名稱",description:"說明",iconKey:"圖示",category:"類別",friendliness:"友善度",priceInfo:"收費",lng:"經度",lat:"緯度"};function q(C){if(C==null||C==="")return"(空)";if(typeof C=="number")return String(C);const N=String(C);return N.length>40?N.slice(0,40)+"…":N}function K(C){return C==null?"":typeof C=="string"?C.trim():String(C)}function Se(C){return K(C)===""}function xe(C,N){if(!C||C.action==="delete"||C.action==="reset")return[];if(C.after&&typeof C.after=="object")return Object.keys(C.after).filter(x=>{var Le;const O=(Le=C.before)==null?void 0:Le[x],ce=C.after[x];return!(Se(O)&&Se(ce)||K(O)===K(ce)||Se(O))}).map(x=>{var O;return{label:G[x]||x,before:q((O=C.before)==null?void 0:O[x]),after:q(C.after[x]),hasBefore:!0}});const B=C.snapshot;if(!B||typeof B!="object")return[];const re=new Set(["createdAt","createdBy","updatedAt","updatedBy","origName","origLng","origLat","history"]),De=t.history.findIndex(he=>he._key===C._key),Oe=De>=0?t.history[De+1]:null,bn=Oe?Oe.after&&typeof Oe.after=="object"?{...Oe.before||{},...Oe.after}:Oe.snapshot||null:null,on=[];for(const he of Object.keys(B)){if(re.has(he))continue;const x=B[he];if(bn&&Object.prototype.hasOwnProperty.call(bn,he)){const O=bn[he];if(K(O)===K(x)||Se(O))continue;on.push({label:G[he]||he,before:q(O),after:q(x),hasBefore:!0})}}return on}function tn(C){return(C==null?void 0:C.action)==="delete"?"該項目被刪除":(C==null?void 0:C.action)==="reset"?"重設為官方資料":(C==null?void 0:C.action)==="create"?"新增此停車點":""}return(C,N)=>(v(),Li(Ln,{modelValue:Ae.value,"onUpdate:modelValue":N[9]||(N[9]=B=>Ae.value=B),title:n.mode==="override"?"修改官方停車點":n.mode==="edit"?"編輯停車場":"新增停車場",size:"md"},{footer:an(()=>[n.mode==="edit"&&n.isOwner?(v(),P("button",{key:0,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:ae}," 刪除 ",8,vp)):j("",!0),n.mode==="override"&&n.hasExistingOverride&&n.isAdmin?(v(),P("button",{key:1,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:Ie,title:"僅站方可使用"}," 重設為官方資料 ",8,Cp)):j("",!0),c("button",{class:"btn btn-outline",disabled:n.submitting,onClick:N[8]||(N[8]=B=>Ae.value=!1)}," 取消 ",8,Pp),c("button",{class:"btn btn-primary",disabled:n.submitting,onClick:Ee},w(n.submitting?"送出中…":n.mode==="override"||n.mode==="edit"?"儲存修改":"新增"),9,Up)]),default:an(()=>[c("div",k5,[n.mode==="override"?(v(),P("p",D5,[T5,k(" 你正在「修改官方停車點」:這層修改只會疊加在官方資料之上,不會覆蓋原始資料。所有車友都會看到你的修改,也可以再被其他人修改或重設。 ")])):(v(),P("p",M5,[N5,k(" 共筆停車點:任何人都可以新增或修改。請確認資訊正確、避免不雅內容。 ")])),c("section",R5,[c("label",x5,[k(" 名稱 "),n.mode!=="override"?(v(),P("span",O5,"*")):j("",!0),n.mode==="override"?(v(),P("span",L5,"(官方名稱不可修改)")):j("",!0)]),je(c("input",{"onUpdate:modelValue":N[0]||(N[0]=B=>i.value=B),class:"form-control",type:"text",placeholder:"例:三張里地下停車場",maxlength:"60",readonly:n.mode==="override",disabled:n.mode==="override"},null,8,F5),[[It,i.value]])]),c("section",H5,[z5,je(c("select",{"onUpdate:modelValue":N[1]||(N[1]=B=>r.value=B),class:"form-control"},[(v(!0),P(ye,null,Ke(m.value,B=>(v(),P("option",{key:B.value,value:B.value},w(B.name),9,V5))),128))],512),[[Os,r.value]])]),c("section",W5,[c("label",j5,[k(" 友善程度 "),D.value?(v(),P("span",G5,"(此類別不適用)")):j("",!0)]),je(c("select",{"onUpdate:modelValue":N[2]||(N[2]=B=>l.value=B),class:"form-control",disabled:D.value},[(v(!0),P(ye,null,Ke(b.value,B=>(v(),P("option",{key:B.value,value:B.value},w(B.name),9,Q5))),128))],8,K5),[[Os,l.value]])]),c("section",Y5,[X5,c("div",J5,[(v(),P(ye,null,Ke(de,B=>c("button",{key:B.value,type:"button",class:ie(["chip",{active:a.value===B.value}]),onClick:re=>a.value=B.value},w(B.label),11,q5)),64))]),a.value==="h"||a.value==="d"?(v(),P("div",$5,[je(c("input",{"onUpdate:modelValue":N[3]||(N[3]=B=>d.value=B),type:"number",min:"0",step:"1",class:"form-control compact",placeholder:"金額"},null,512),[[It,d.value]]),c("span",Z5,"元 / "+w(a.value==="h"?"小時":"次"),1)])):a.value==="custom"?(v(),P("div",ep,[je(c("input",{"onUpdate:modelValue":N[4]||(N[4]=B=>u.value=B),type:"text",class:"form-control",placeholder:"如:平日 30/h、假日 50/d",maxlength:"40"},null,512),[[It,u.value]])])):j("",!0)]),c("section",np,[tp,je(c("textarea",{"onUpdate:modelValue":N[5]||(N[5]=B=>s.value=B),class:"form-control",rows:"3",placeholder:"後牌辨析、24h、注意事項...",maxlength:"500"},null,512),[[It,s.value]])]),c("section",op,[ip,c("input",{value:n.nickname,onInput:N[6]||(N[6]=B=>o("update:nickname",B.target.value)),class:"form-control",type:"text",placeholder:"留空將顯示「匿名#xxx-xxx」",maxlength:"20"},null,40,sp)]),W.value?(v(),P("p",rp,w(W.value),1)):j("",!0),n.history.length?(v(),P("section",lp,[c("label",ap,[cp,k(" 修改紀錄 ("+w(n.history.length)+") ",1)]),c("ul",dp,[(v(!0),P(ye,null,Ke(ke.value,(B,re)=>(v(),P("li",{key:B._key,class:"history-item"},[c("div",hp,[c("span",{class:ie(["h-action",`h-action-${B.action||"other"}`])},w(Be(B.action)),3),c("span",up,w(_(B.by)),1),c("span",pp,w(M(B.at)),1)]),tn(B)?(v(),P("div",mp,w(tn(B)),1)):xe(B,re).length?(v(),P("ul",fp,[(v(!0),P(ye,null,Ke(xe(B,re),(De,Oe)=>(v(),P("li",{key:Oe,class:"h-diff-item"},[c("span",yp,w(De.label),1),De.hasBefore?(v(),P(ye,{key:0},[c("span",bp,w(De.before),1),gp],64)):j("",!0),c("span",Ap,w(De.after),1)]))),128))])):(v(),P("div",_p,"(與上一筆相同)"))]))),128))]),n.history.length>5?(v(),P("button",{key:0,type:"button",class:"history-toggle",onClick:N[7]||(N[7]=B=>oe.value=!oe.value)},w(oe.value?"收起":`顯示全部 ${n.history.length} 筆`),1)):j("",!0)])):j("",!0)])]),_:1},8,["modelValue","title"]))}},Ip=nn(Ep,[["__scopeId","data-v-8a26dac9"]]),Bp={class:"tour-card-head"},Sp={class:"tour-step-index"},wp={class:"tour-title"},kp={key:0,class:"material-icons-outlined"},Dp={class:"tour-desc"},Tp={class:"tour-actions"},Mp={key:0,class:"material-icons-outlined"},Np={key:1,class:"material-icons-outlined"},An=8,Rp=12,Or=300,oo=16,xp={__name:"OnboardingTour",props:{active:{type:Boolean,default:!1},steps:{type:Array,required:!0}},emits:["update:active","finish"],setup(n,{emit:e}){const t=n,o=e,i=E(0),s=E(null),r=E(!1),l=ne(()=>t.steps[i.value]||null),a=ne(()=>i.value>=t.steps.length-1),d=async()=>{await Vr();const I=l.value;if(!I){s.value=null;return}const V=I.selector?document.querySelector(I.selector):null;if(!V){s.value=null;return}const T=V.getBoundingClientRect();if(T.width===0&&T.height===0){s.value=null;return}s.value={top:T.top,left:T.left,width:T.width,height:T.height}},u=async()=>{for(let I=0;I<8;I++){if(await d(),s.value)return;await new Promise(V=>setTimeout(V,150))}};J(()=>[t.active,i.value],async([I])=>{if(!I){r.value=!1;return}r.value=!1,await u(),r.value=!0},{immediate:!0});const h=()=>d();Kn(()=>{window.addEventListener("resize",h),window.addEventListener("scroll",h,!0)}),ht(()=>{window.removeEventListener("resize",h),window.removeEventListener("scroll",h,!0)});const m=ne(()=>{const I=s.value;return I?{top:I.top-An+"px",left:I.left-An+"px",width:I.width+An*2+"px",height:I.height+An*2+"px",borderRadius:Rp+"px"}:{display:"none"}}),b=ne(()=>{var oe;const I=s.value,V=window.innerWidth,T=window.innerHeight;if(!I)return{top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:Math.min(Or,V-32)+"px"};const W=((oe=l.value)==null?void 0:oe.placement)||"auto";let Ee=W;if(W==="auto"){const ke=T-(I.top+I.height),Re=I.top;Ee=ke>=Re?"bottom":"top"}const ae=Math.min(Or,V-32);let Ie,Ae,de="";return Ee==="bottom"?(Ie=I.top+I.height+oo+An,Ae=Math.max(16,Math.min(V-ae-16,I.left+I.width/2-ae/2))):Ee==="top"?(Ie=I.top-oo-An,Ae=Math.max(16,Math.min(V-ae-16,I.left+I.width/2-ae/2)),de="translateY(-100%)"):Ee==="right"?(Ie=Math.max(16,I.top+I.height/2),Ae=I.left+I.width+oo+An,de="translateY(-50%)"):(Ie=Math.max(16,I.top+I.height/2),Ae=I.left-oo-An,de="translate(-100%, -50%)"),{top:Ie+"px",left:Ae+"px",width:ae+"px",transform:de}}),g=()=>{a.value?D():i.value+=1},U=()=>D(),D=()=>{o("update:active",!1),o("finish"),i.value=0};return J(()=>t.active,I=>{I&&(i.value=0)}),(I,V)=>n.active&&l.value?(v(),P("div",{key:0,class:ie(["tour-root",{"is-ready":r.value}])},[c("div",{class:"tour-spotlight",style:co(m.value)},null,4),c("div",{class:"tour-backdrop",onClick:Fi(g,["self"])}),c("div",{class:"tour-card",style:co(b.value),role:"dialog","aria-modal":"true"},[c("div",Bp,[c("span",Sp,w(i.value+1)+" / "+w(n.steps.length),1),c("button",{class:"tour-skip",onClick:U,"aria-label":"略過導覽"},"略過")]),c("h3",wp,[l.value.icon?(v(),P("span",kp,w(l.value.icon),1)):j("",!0),k(" "+w(l.value.title),1)]),c("p",Dp,w(l.value.description),1),c("div",Tp,[c("button",{class:"btn btn-primary tour-next",onClick:g},[k(w(a.value?"完成":"下一步")+" ",1),a.value?(v(),P("span",Np,"check")):(v(),P("span",Mp,"arrow_forward"))])])],4)],2)):j("",!0)}},Op=nn(xp,[["__scopeId","data-v-1d730a34"]]),vn="community_parkings",Ni=E([]),Da=E(!1),Ri=E(null);let Nt=null,li=0;function Lp(){if(!(!cn||Nt))try{const n=jh(Xe(Ge,vn),Wh("updatedAt"));Nt=n,Ia(n,e=>{const t=[];e.forEach(o=>{var s,r;const i=o.val()||{};t.push({id:o.key,name:i.name||"",description:i.description||"",iconKey:i.iconKey||"icon-3.png",category:i.category||"",friendliness:i.friendliness||"",priceInfo:i.priceInfo||"",coordinates:[(s=i.lng)!=null?s:null,(r=i.lat)!=null?r:null],createdBy:i.createdBy||null,updatedBy:i.updatedBy||null,createdAt:i.createdAt||null,updatedAt:i.updatedAt||null,history:Hp(i.history)})}),Ni.value=t.reverse(),Da.value=!0},e=>{Ri.value=e})}catch(n){Ri.value=n}}function Fp(){Nt&&(Ba(Nt),Nt=null)}function Hp(n){return!n||typeof n!="object"?[]:Object.entries(n).map(([e,t])=>({...t||{},_key:e})).sort((e,t)=>e._key<t._key?1:e._key>t._key?-1:0)}function zp(){return Kn(()=>{li+=1,Lp()}),ht(()=>{li-=1,li<=0&&Fp()}),{items:Ni,ready:Da,error:Ri,addParking:async(o,i)=>{var m,b,g;if(!cn)throw new Error("Firebase 尚未設定");const[s,r]=o.coordinates,a=so(Xe(Ge,vn)).key,d={id:i.id,nickname:i.nickname||""},u={name:((m=o.name)==null?void 0:m.trim())||"",description:((b=o.description)==null?void 0:b.trim())||"",iconKey:o.iconKey||"icon-3.png",category:o.category||"",friendliness:o.friendliness||"",priceInfo:((g=o.priceInfo)==null?void 0:g.trim())||"",lng:Number(s),lat:Number(r),createdBy:d,createdAt:Fn(),updatedBy:d,updatedAt:Fn()},h=so(Xe(Ge,`${vn}/${a}/history`)).key;return await ki(Xe(Ge),{[`${vn}/${a}`]:{...u,history:{[h]:{action:"create",at:Fn(),by:d,snapshot:u}}}}),a},updateParking:async(o,i,s)=>{var g,U,D,I,V;if(!cn)throw new Error("Firebase 尚未設定");const r={id:s.id,nickname:s.nickname||""},l=Ni.value.find(T=>T.id===o)||{},a={};if(i.name!==void 0&&(a.name=((g=i.name)==null?void 0:g.trim())||""),i.description!==void 0&&(a.description=((U=i.description)==null?void 0:U.trim())||""),i.iconKey!==void 0&&(a.iconKey=i.iconKey),i.category!==void 0&&(a.category=i.category),i.friendliness!==void 0&&(a.friendliness=i.friendliness),i.priceInfo!==void 0&&(a.priceInfo=((D=i.priceInfo)==null?void 0:D.trim())||""),i.coordinates){const[T,W]=i.coordinates;a.lng=Number(T),a.lat=Number(W)}const d={},u={};for(const T of Object.keys(a)){let W;T==="lng"?W=(I=l.coordinates)==null?void 0:I[0]:T==="lat"?W=(V=l.coordinates)==null?void 0:V[1]:W=l[T];const Ee=W==null?"":W,ae=a[T]===void 0||a[T]===null?"":a[T];Ee!==ae&&(d[T]=W!=null?W:"",u[T]=a[T])}const h={...a,updatedBy:r,updatedAt:Fn()},m=so(Xe(Ge,`${vn}/${o}/history`)).key,b={};for(const T of Object.keys(h))b[`${vn}/${o}/${T}`]=h[T];return b[`${vn}/${o}/history/${m}`]={action:"update",at:Fn(),by:r,before:d,after:u},ki(Xe(Ge),b)},deleteParking:async o=>{if(!cn)throw new Error("Firebase 尚未設定");return Ea(Xe(Ge,`${vn}/${o}`))}}}var Vp={VITE_FIREBASE_DATABASE_URL:"https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app",VITE_FIREBASE_MESSAGING_SENDER_ID:"976769533420",VITE_FIREBASE_MEASUREMENT_ID:"G-XMR8C87T1P",VITE_FIREBASE_STORAGE_BUCKET:"findparkinglot-2519e.firebasestorage.app",VITE_FIREBASE_AUTH_DOMAIN:"findparkinglot-2519e.firebaseapp.com",VITE_MAPBOX_TOKEN:"pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",VITE_FIREBASE_PROJECT_ID:"findparkinglot-2519e",VITE_FIREBASE_APP_ID:"1:976769533420:web:f3108318b3def30017acc9",VITE_FIREBASE_API_KEY:"AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs",BASE_URL:"./",MODE:"production",DEV:!1,PROD:!0,SSR:!1};const Ta="community_user_id",Ma="community_user_nickname",Wp="community_is_admin",jp=String(Vp.VITE_ADMIN_USER_IDS||"").split(",").map(n=>n.trim()).filter(Boolean);function Gp(){const n=e=>Array.from(crypto.getRandomValues(new Uint8Array(e))).map(t=>t.toString(16).padStart(2,"0")).join("");return`${n(2)}-${n(2)}`}let ao=qe.get(Ta);ao||(ao=Gp(),qe.set(Ta,ao));const xi=ao,Oi=E(qe.get(Ma)||""),Kp=jp.includes(xi)||qe.get(Wp)==="1";J(Oi,n=>qe.set(Ma,n||""));function Qp(){return{userId:xi,nickname:Oi,displayName:()=>{var e;return((e=Oi.value)==null?void 0:e.trim())||`匿名#${xi}`},isAdmin:Kp}}const Yp=()=>typeof window!="undefined"&&typeof window.gtag=="function",ve=(n,e={})=>{if(Yp())try{window.gtag("event",n,e)}catch(t){}},S=n=>(wn("data-v-e919e563"),n=n(),kn(),n),Xp={class:"app-title"},Jp=["aria-label","aria-expanded"],qp={class:"material-icons-outlined"},$p={key:1,class:"title-logo",src:Hi,alt:"重機能停哪"},Zp=S(()=>c("h1",null,"重機能停哪?",-1)),em=S(()=>c("pre",{id:"coordinates",class:"coordinates"},null,-1)),nm=S(()=>c("h4",{class:"modal-section-title"},"圖案代表甚麼格位",-1)),tm={class:"legend-list"},om={class:"legend-row"},im=["src"],sm={class:"legend-row"},rm=["src"],lm={class:"legend-row"},am=["src"],cm={class:"legend-row"},dm=["src"],hm={class:"legend-row"},um=["src"],pm={class:"legend-row"},mm=["src"],fm={class:"legend-row"},ym=["src"],bm={class:"legend-row"},gm=["src"],Am={class:"legend-row"},_m=["src"],vm={class:"legend-row"},Cm=["src"],Pm={class:"legend-row"},Um=["src"],Em=S(()=>c("h4",{class:"modal-section-title"},"顏色代表入場方式",-1)),Im={class:"legend-list"},Bm={class:"legend-row"},Sm=["src"],wm=["src"],km=["src"],Dm={class:"legend-row"},Tm=["src"],Mm=["src"],Nm=["src"],Rm={class:"legend-row"},xm=["src"],Om=["src"],Lm=["src"],Fm={class:"legend-row"},Hm=["src"],zm=["src"],Vm=["src"],Wm=S(()=>c("h4",{class:"modal-section-title"},"名稱前有價錢",-1)),jm={class:"legend-list"},Gm={class:"legend-row"},Km=["src"],Qm=S(()=>c("div",{class:"legend-row"},[c("div",{class:"legend-text"},[k(" ・數字:金額,時段費率複雜會以最高收費標示"),c("br"),k(" ・d/h:d 為計次,h 為計時"),c("br"),k(" ・Free 代表免費 ")])],-1)),Ym={class:"share-grid"},Xm=S(()=>c("img",{src:jr,alt:""},null,-1)),Jm=S(()=>c("span",null,"Facebook",-1)),qm=[Xm,Jm],$m=S(()=>c("img",{src:Gr,alt:""},null,-1)),Zm=S(()=>c("span",null,"LINE",-1)),e4=[$m,Zm],n4=S(()=>c("img",{src:Kr,alt:""},null,-1)),t4=S(()=>c("span",null,"Twitter",-1)),o4=[n4,t4],i4=S(()=>c("img",{src:Qr,alt:""},null,-1)),s4=S(()=>c("span",null,"複製連結",-1)),r4=[i4,s4],l4={class:"modal-hint",style:{"word-break":"break-all"}},a4={class:"share-grid"},c4=S(()=>c("img",{src:jr,alt:""},null,-1)),d4=S(()=>c("span",null,"Facebook",-1)),h4=[c4,d4],u4=S(()=>c("img",{src:Gr,alt:""},null,-1)),p4=S(()=>c("span",null,"LINE",-1)),m4=[u4,p4],f4=S(()=>c("img",{src:Kr,alt:""},null,-1)),y4=S(()=>c("span",null,"Twitter",-1)),b4=[f4,y4],g4=S(()=>c("img",{src:Qr,alt:""},null,-1)),A4=S(()=>c("span",null,"複製連結",-1)),_4=[g4,A4],v4={class:"os-tabs",role:"tablist","aria-label":"作業系統"},C4=["aria-selected"],P4=S(()=>c("span",{class:"material-icons-outlined"},"phone_iphone",-1)),U4=["aria-selected"],E4=S(()=>c("span",{class:"material-icons-outlined"},"android",-1)),I4=S(()=>c("p",{class:"modal-hint"},"以下以 iOS Safari 為範例",-1)),B4=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Safari 開啟網站並點擊下方分享按鈕",-1)),S4=S(()=>c("img",{class:"full-img",src:ac,alt:""},null,-1)),w4=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「加入主畫面」",-1)),k4=S(()=>c("img",{class:"full-img",src:cc,alt:""},null,-1)),D4=S(()=>c("h4",{class:"modal-section-title"},"3. 確認名稱後按「加入」",-1)),T4=S(()=>c("img",{class:"full-img",src:dc,alt:""},null,-1)),M4=S(()=>c("h4",{class:"modal-section-title"},"4. 完成,圖示已加到主畫面",-1)),N4=S(()=>c("img",{class:"full-img",src:hc,alt:""},null,-1)),R4=S(()=>c("h4",{class:"modal-section-title"},"5. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),x4=S(()=>c("img",{class:"full-img",src:uc,alt:""},null,-1)),O4=S(()=>c("p",{class:"modal-hint"},"以下以 Android Chrome 為範例",-1)),L4=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Chrome 開啟網站並點擊右上角選單，點選「加到主畫面」",-1)),F4=S(()=>c("img",{class:"full-img",src:pc,alt:""},null,-1)),H4=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「安裝」",-1)),z4=S(()=>c("img",{class:"full-img",src:mc,alt:""},null,-1)),V4=S(()=>c("h4",{class:"modal-section-title"},"3. 完成,圖示已加到主畫面",-1)),W4=S(()=>c("img",{class:"full-img",src:fc,alt:""},null,-1)),j4=S(()=>c("h4",{class:"modal-section-title"},"4. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),G4=S(()=>c("img",{class:"full-img",src:yc,alt:""},null,-1)),K4=S(()=>c("div",{class:"welcome-logo-wrap"},[c("img",{class:"welcome-logo",src:Hi,alt:"重機能停哪"})],-1)),Q4=S(()=>c("div",{class:"welcome-badge"},"✨ 全新介面上線",-1)),Y4=S(()=>c("p",{class:"welcome-text"}," 這是一個提供重機停車資訊的地圖，你可以依據「友善程度」「停車格類型」「收費範圍」尋找合適的停車場，並一鍵開啟 Google 或 Apple Map 導航。 ",-1)),X4=S(()=>c("div",{class:"whatsnew-card"},[c("div",{class:"whatsnew-title"},[c("span",{class:"material-icons-outlined"},"auto_awesome"),k(" 本次新功能 ")]),c("ul",{class:"whatsnew-list"},[c("li",null,[c("span",{class:"material-icons-outlined"},"star"),c("span",null,[c("strong",null,"我的最愛"),c("br"),k(" 可以將喜歡的停車場加入我的最愛")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"search"),c("span",null,[c("strong",null,"地點搜尋"),c("br"),k(" 可以搜尋指定的停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_location_alt"),c("span",null,[c("strong",null,"共筆停車點"),c("br"),k(" 可自由新增、編輯, 大家一起分享停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_note"),c("span",null,[c("strong",null,"官方點異議 / 補充"),c("br"),k(" 點開任一官方停車點 → 「異議 / 補充」, 可在不改動原始資料的前提下, 補上實際費率、更正分類或加註說明, 全車友共享")])])])],-1)),J4=S(()=>c("p",{class:"welcome-text"},[k(" 資料取源於: "),c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"link"},"Alan大重停車記事"),k("，如有停車場相關問題請至該頁面填寫回報表單。 ")],-1)),q4=S(()=>c("p",{class:"welcome-text"},' 公告: 原始資料"大重停車記事已無更新" 已改由 Alan大重停車記事 提供，感謝Alan的辛苦整理與分享！ ',-1)),$4=S(()=>c("p",{class:"welcome-text"},[k(" 本站僅提供資料整合服務，地圖免費提供車友使用，資料不定期更新；若發生無法使用情況，請至 "),c("a",{href:"https://forms.gle/iJCyfqVtpL35WtZM7",target:"_blank",rel:"noopener",class:"link"},"錯誤資訊回報"),k("，也歡迎 "),c("a",{href:"https://buymeacoffee.com/jamestim923",target:"_blank",rel:"noopener",class:"link"},"請我喝杯咖啡 ☕️"),k("讓我有動力繼續更新。 ")],-1)),Z4=S(()=>c("p",{class:"welcome-text right"},"— by 爽爽",-1)),ef={key:0,class:"pick-crosshair","aria-hidden":"true"},nf=S(()=>c("span",{class:"material-icons-outlined dot"},"gps_fixed",-1)),tf=[nf],of={key:1,class:"pick-banner"},sf=S(()=>c("span",{class:"pick-banner-text"},[c("span",{class:"material-icons-outlined"},"touch_app"),k(" 拖動地圖，將十字線對準目標位置 ")],-1)),rf=S(()=>c("span",{class:"material-icons-outlined"},"check",-1)),lf=S(()=>c("p",{class:"welcome-text"},[c("strong",{style:{color:"var(--primary)"}},"這是一個公開共享的「共筆停車點」區。"),k(" 除了官方收錄的「大重停車記事」資料外,任何人都可以新增、修改、補充停車位置——不需要註冊、不需要審核。 ")],-1)),af=S(()=>c("h4",{class:"modal-section-title"},"如何新增停車位置",-1)),cf=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"點左下角的「共筆停車點」按鈕,再點「新增停車位置」"),c("li",null,"畫面中心會出現青色十字游標,拖動地圖將游標對準目標位置"),c("li",null,"按頂部「使用此位置」,填寫名稱、類別、友善程度、收費等資料"),c("li",null,"按「新增」即完成(座標已自動記錄,圖示會依類別自動套用)")],-1)),df=S(()=>c("h4",{class:"modal-section-title"},"如何編輯他人新增的位置",-1)),hf=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"地圖上「薰衣草紫色底」的標記即為使用者新增的「共筆停車點」"),c("li",null,"點擊該標記,在資訊面板按「編輯」"),c("li",null,"修改後按「儲存修改」")],-1)),uf=S(()=>c("h4",{class:"modal-section-title"},"注意事項",-1)),pf=S(()=>c("ul",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"請確認資訊正確,避免造成他人困擾"),c("li",null,"不要新增不雅、惡意或無關內容"),c("li",null,"暱稱可選填,留空將顯示為「匿名#xxx-xxx」"),c("li",null,"站方保留必要時清空所有「共筆停車點」資料的權利")],-1)),Lr="onboarding_tour_v1",Fr="filters_v1",mf="https://findparkinglot.github.io/",ff={__name:"App",setup(n){var Ds,Ts,Ms;const e=navigator.userAgent,t=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(e),o=/iPhone|iPad|iPod/i.test(e),i=/Android/i.test(e),s=E([]),r=()=>{var p;return!!((p=window.matchMedia)!=null&&p.call(window,"(prefers-color-scheme: light)").matches)},l=p=>{var f;if(p==="system"){const y=r()?"light":"dark";return(f=nt.find(pe=>pe.theme===y))==null?void 0:f.value}return p},a=nt.find(p=>p.name===qe.get("mapStyles")),d=(a==null?void 0:a.value)||((Ds=nt.find(p=>p.theme==="dark"))==null?void 0:Ds.value),u=E(d),h=E({getLngLat:!1,mapStylesSelected:l(d)}),m=p=>{const f=l(p);h.value.mapStylesSelected=f;const y=nt.find(ue=>ue.value===f),pe=(y==null?void 0:y.theme)==="light";document.body.classList.toggle("light-theme",pe),document.body.classList.toggle("dark-theme",!pe);const ze=nt.find(ue=>ue.value===p);ze&&qe.set("mapStyles",ze.name)};m(u.value),J(u,m);const b=(Ts=window.matchMedia)==null?void 0:Ts.call(window,"(prefers-color-scheme: light)");(Ms=b==null?void 0:b.addEventListener)==null||Ms.call(b,"change",()=>{u.value==="system"&&m("system")});const g=E(!0),U=E(!1),D=E(i?"android":"ios"),I=E(!1),V=E(!1),T=E(!1),W=E(!1),Ee=[{selector:".mapboxgl-ctrl-geolocate",icon:"my_location",title:"定位你的位置",description:"點右上角的定位按鈕,地圖會自動移到你目前位置,並追蹤方向。"},{selector:".fab-placement-right > .fab-main",icon:"help_outline",title:"功能與教學",description:"右下角的圓形按鈕展開後,可看到「地圖怎麼看」、「加到手機桌面」、「分享」等功能。"},{selector:".search-toggle",icon:"search",title:"搜尋停車點",description:"右下角的搜尋按鈕可依名稱快速找到想去的停車場,點選結果會自動飛到該位置並開啟資訊。"},{selector:".app-title .title-toggle",icon:"menu",title:"篩選與我的最愛",description:"左上角選單可以調整停車類型、友善程度、收費範圍,以及只顯示我的最愛、切換主題。"},{selector:".fab-placement-left > .fab-main",icon:"add_location_alt",title:"共筆停車點",description:"左下角按鈕可新增/編輯共筆停車點,大家一起分享真實的停車資訊。"}],ae=()=>{W.value=!0,ve("onboarding_tour_start")},Ie=()=>{try{localStorage.setItem(Lr,"1")}catch(p){}ve("onboarding_tour_finish")},Ae=()=>{g.value=!1};J(g,(p,f)=>{if(f&&!p)try{localStorage.getItem(Lr)||setTimeout(ae,350)}catch(y){}});const de=E(!1),oe=E(!1),ke=E(!1),Re=p=>{p!=="menu"&&(de.value=!1),p!=="info"&&(oe.value=!1),p!=="message"&&(g.value=!1),p!=="mobileFAQ"&&(U.value=!1),p!=="faq"&&(I.value=!1),p!=="share"&&(V.value=!1),p!=="communityHelp"&&(T.value=!1),ve("panel_open",{panel:p})};J(de,p=>p&&Re("menu")),J(oe,p=>p&&Re("info")),J(g,p=>p&&Re("message")),J(U,p=>p&&Re("mobileFAQ")),J(U,p=>{p&&(i?D.value="android":o&&(D.value="ios"))}),J(I,p=>p&&Re("faq")),J(V,p=>p&&Re("share")),J(T,p=>p&&Re("communityHelp"));const Be=qe.getJSON(Fr,{})||{},_=E(typeof Be.parkingType=="string"?Be.parkingType:""),M=E(typeof Be.degreeOfFriendliness=="string"?Be.degreeOfFriendliness:""),G=E(typeof Be.parkingPriceType=="string"?Be.parkingPriceType:""),q=E(typeof Be.priceRangeMin=="number"?Be.priceRangeMin:0),K=E(typeof Be.priceRangeMax=="number"?Be.priceRangeMax:100),{favorites:Se,favoriteIdSet:xe,isFavorite:tn,toggleFavorite:C}=ed(),N=E(Be.onlyFavorites===!0);J([_,M,G,q,K,N],([p,f,y,pe,ze,ue])=>{qe.setJSON(Fr,{parkingType:p,degreeOfFriendliness:f,parkingPriceType:y,priceRangeMin:pe,priceRangeMax:ze,onlyFavorites:ue})});const B=E("driving"),{items:re,addParking:De,updateParking:Oe,deleteParking:bn}=zp(),{userId:on,nickname:he,isAdmin:x}=Qp(),O=E(null),{overrides:ce,getOverride:Le,getOverrideHistory:Fe,upsertOverride:_e,resetOverride:Mn}=ru(),sn=ne(()=>new Set(Object.keys(ce.value||{}))),Te=E(!1),rn=E("add"),ln=E(null),hn=E(!1),yt=E([121.5173399,25.0475613]),Bs=E(!1),Na=ne(()=>{var p;if(!Te.value)return[];if(rn.value==="override")return We.value?Fe(We.value.name,We.value.geometry):[];if(rn.value==="edit"&&((p=ln.value)!=null&&p.id)){const f=(re.value||[]).find(y=>y.id===ln.value.id);return(f==null?void 0:f.history)||[]}return[]}),un=E(!1),He=E(null),Ra=()=>{if(!cn){alert("「共筆停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}un.value=!0,ve("community_add_start")},xa=()=>{var f,y;const p=((y=(f=O.value)==null?void 0:f.getCenter)==null?void 0:y.call(f))||[121.5173399,25.0475613];yt.value=p,rn.value="add",ln.value=null,un.value=!1,Te.value=!0},Oa=()=>{un.value=!1},La=p=>{var f,y;yt.value=p.coordinates?[...p.coordinates]:((y=(f=O.value)==null?void 0:f.getCenter)==null?void 0:y.call(f))||[121.5173399,25.0475613],rn.value="edit",ln.value=p,Te.value=!0},Wo=p=>{He.value=p,Jn({name:"共筆停車點",properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.coordinates,address:""})},Fa=()=>{He.value&&(oe.value=!1,La(He.value))},Ha=()=>{if(!cn){alert("「修改官方停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}if(!We.value)return;const p=We.value,f=Zt.value,y={id:null,name:p.name,description:(f==null?void 0:f.description)||p.description,iconKey:(f==null?void 0:f.iconKey)||p.iconKey,category:(f==null?void 0:f.category)||za(p.iconKey),friendliness:(f==null?void 0:f.friendliness)||Va(p.iconKey),priceInfo:(f==null?void 0:f.priceInfo)||p.priceInfo,coordinates:p.geometry?[...p.geometry]:[...yt.value]};yt.value=y.coordinates,rn.value="override",ln.value=y,Bs.value=!!f,oe.value=!1,Te.value=!0,ve("override_edit_start",{name:p.name})};function za(p){if(!p)return"motorcycle";const f=Gt.find(y=>y.value&&y.key.includes(p));return(f==null?void 0:f.value)||"motorcycle"}function Va(p){if(!p)return"friendly";const f=Kt.find(y=>y.value&&y.key.includes(p));return(f==null?void 0:f.value)||"friendly"}const Wa=async p=>{if(We.value){hn.value=!0;try{const f={id:on,nickname:he.value};await _e(We.value,p,f),ve("override_submit",{name:We.value.name});const y=We.value;Te.value=!1,Jn({name:y.parkingType,properties:{name:y.name,description:y.description,icon:y.iconKey,priceInfo:y.priceInfo,priceArray:[]},geometry:y.geometry,address:$.value.address})}catch(f){alert("儲存失敗:"+((f==null?void 0:f.message)||f))}finally{hn.value=!1}}},ja=async()=>{if(We.value){hn.value=!0;try{const p=We.value,f={id:on,nickname:he.value};await Mn(p.name,p.geometry,f),ve("override_reset",{name:p.name}),Te.value=!1,Jn({name:p.parkingType,properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.geometry,address:$.value.address})}catch(p){alert("重設失敗:"+((p==null?void 0:p.message)||p))}finally{hn.value=!1}}},Ga=async p=>{var f;hn.value=!0;try{const y={id:on,nickname:he.value};rn.value==="edit"&&((f=ln.value)!=null&&f.id)?(await Oe(ln.value.id,p,y),ve("community_edit_submit",{name:p==null?void 0:p.name})):(await De(p,y),ve("community_add_submit",{name:p==null?void 0:p.name})),Te.value=!1,He.value=null}catch(y){alert("儲存失敗:"+((y==null?void 0:y.message)||y))}finally{hn.value=!1}},Ka=async p=>{hn.value=!0;try{const f={id:on,nickname:he.value};await bn(p,f),ve("community_delete",{id:p}),Te.value=!1,He.value=null}catch(f){alert("刪除失敗:"+((f==null?void 0:f.message)||f))}finally{hn.value=!1}},jo=ne(()=>{var f,y;if(!He.value||!$.value.parkingName)return!1;const p=He.value;return p.name===$.value.parkingName&&Array.isArray($.value.geometry)&&((f=p.coordinates)==null?void 0:f[0])===$.value.geometry[0]&&((y=p.coordinates)==null?void 0:y[1])===$.value.geometry[1]});J(oe,p=>{p||(He.value=null)});const bt=E(null),Qa=ne(()=>{var p;return((p=Gt.find(f=>f.value===_.value))==null?void 0:p.key)||[]}),Ya=ne(()=>{var p;return((p=Kt.find(f=>f.value===M.value))==null?void 0:p.key)||[]}),$=E({parkingName:"",parkingNameDes:"",parkingType:"",parkingIcon:"",parkingIconKey:"",priceInfo:"",geometry:[null,null],address:"",sourceLabel:""}),We=E(null),Zt=E(null),Ss=ne(()=>ai($.value.parkingName,$.value.geometry)),ws=ne(()=>tn(Ss.value)),Jn=p=>{var $n,Zn,Ns,Rs,xs;const f=p.properties.icon,y={name:p.properties.name,description:p.properties.description,iconKey:f,priceInfo:p.properties.priceInfo||"",geometry:p.geometry,parkingType:p.name},pe=!!(He.value&&He.value.name===p.properties.name&&Array.isArray(p.geometry)&&(($n=He.value.coordinates)==null?void 0:$n[0])===p.geometry[0]&&((Zn=He.value.coordinates)==null?void 0:Zn[1])===p.geometry[1]);let ze=null,ue=y;pe||(ze=Le(y.name,y.geometry),ze&&(ue=wa(y,ze))),We.value=pe?null:y,Zt.value=ze,$.value={parkingName:ue.name,parkingNameDes:ue.description,parkingType:y.parkingType,parkingIcon:X(ue.iconKey),parkingIconKey:ue.iconKey,priceInfo:ue.priceInfo||"",geometry:p.geometry,address:p.address,sourceLabel:pe?"":Gc((Ns=p.properties)==null?void 0:Ns.sourceFolderIndex)},oe.value=!0,ve("parking_view",{parking_name:(Rs=p.properties)==null?void 0:Rs.name,parking_type:p.name,icon:(xs=p.properties)==null?void 0:xs.icon,overridden:!!ze})},Xa=()=>{if(!$.value.parkingName)return;const p=!ws.value;C({id:Ss.value,name:$.value.parkingName,parkingType:$.value.parkingType,geometry:$.value.geometry,address:$.value.address,icon:$.value.parkingIconKey}),ve(p?"favorite_add":"favorite_remove",{parking_name:$.value.parkingName,parking_type:$.value.parkingType})},Ja=p=>"",qa=p=>{var f;p.isCommunity&&p.community?Wo(p.community):Jn({name:p.groupName,properties:p.properties,geometry:p.geometry,address:Ja(p.geometry)}),bt.value=[...p.geometry],ve("search_select",{parking_name:(f=p.properties)==null?void 0:f.name,group:p.groupName,community:!!p.isCommunity})},gt=E(null),At=E(null),$a=p=>{B.value="driving",gt.value=p,oe.value=!1,At.value=null,ve("route_start",{parking_name:$.value.parkingName,profile:"driving"})},Za=()=>{gt.value=null,ke.value=!1};J(At,p=>{ke.value=p!==null});const ec=p=>{const f=$.value.geometry;let y="";p==="apple"?y=`https://maps.apple.com/?daddr=${f[1]},${f[0]}&dirflg=d&t=m`:p==="google"&&(y=`https://www.google.com/maps/dir/?api=1&destination=${f[1]},${f[0]}&travelmode=driving`),y&&(ve("open_external_map",{provider:p,parking_name:$.value.parkingName}),window.open(y,"_blank","noopener,noreferrer"))},gn=(p,f=null)=>{const y=f||"https://findparkinglot.github.io/";let pe="";p==="facebook"?pe=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(y)}`:p==="line"?pe=`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(y)}`:p==="twitter"&&(pe=`https://twitter.com/share?url=${encodeURIComponent(y)}`),ve("share",{method:p,scope:f?"spot":"site"}),p==="link"?navigator.clipboard.writeText(y).then(()=>alert("已複製連結"),()=>alert("複製失敗")):window.open(pe,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},ks=()=>{const p=$.value.geometry;if(!Array.isArray(p)||p[0]==null||p[1]==null)return"";const f=new URLSearchParams({lng:Number(p[0]).toFixed(6),lat:Number(p[1]).toFixed(6)});return`${mf}?${f.toString()}`},nc=()=>{const p=ks();p&&(qn.value=p,Ko.value=$.value.parkingName||"停車點",Go.value=!0,ve("share_spot_open",{name:Ko.value}))},Go=E(!1),qn=E(""),Ko=E("");J([oe,$],()=>{try{if(!oe.value){window.location.search&&window.history.replaceState({},"",window.location.pathname);return}const p=ks();if(!p)return;const f=p.slice(p.indexOf("?"));window.history.replaceState({},"",window.location.pathname+f)}catch(p){}},{deep:!0});const _t=E(null),eo=(p,f)=>Math.abs(Number(p)-Number(f))<1e-5,Qo=()=>{var ze;const p=_t.value;if(!p)return;const f=Number(p.lng),y=Number(p.lat);if(!isFinite(f)||!isFinite(y)){_t.value=null;return}const pe=(re.value||[]).find(ue=>ue.coordinates&&eo(ue.coordinates[0],f)&&eo(ue.coordinates[1],y));if(pe){Wo(pe),bt.value=[f,y],_t.value=null;return}for(const ue of s.value||[])for(const $n of ue.features||[]){const Zn=(ze=$n.geometry)==null?void 0:ze.coordinates;if(Zn&&eo(Zn[0],f)&&eo(Zn[1],y)){Jn({name:ue.name,properties:$n.properties,geometry:$n.geometry.coordinates,address:""}),bt.value=[f,y],_t.value=null;return}}Array.isArray(s.value)&&s.value.length>0&&(bt.value=[f,y])},tc=()=>{try{const p=new URLSearchParams(window.location.search),f=p.get("lng"),y=p.get("lat");if(!f||!y)return;_t.value={lng:f,lat:y},Qo()}catch(p){}};J(re,Qo,{deep:!1}),J(s,Qo,{deep:!1}),Kn(()=>{s.value=Zc(Wc()),tc()});const oc=ne(()=>[{key:"share",icon:"share",label:"分享",highlight:!0,onClick:()=>V.value=!0},{key:"howto",icon:"help_outline",label:"怎麼用",onClick:ae},{key:"faq",icon:"map",label:"地圖怎麼看",onClick:()=>I.value=!0},{key:"mobile",icon:"add_to_home_screen",label:"加到手機桌面",onClick:()=>U.value=!0}]),ic=ne(()=>[{key:"add",icon:"add_location_alt",label:"新增停車位置",highlight:!0,onClick:Ra},{key:"help",icon:"menu_book",label:"編輯教學",onClick:()=>T.value=!0}]);return(p,f)=>(v(),P(ye,null,[c("div",Xp,[un.value?(v(),P("img",$p)):(v(),P("button",{key:0,class:"title-toggle",onClick:f[0]||(f[0]=y=>de.value=!de.value),"aria-label":de.value?"收合設定":"開啟設定","aria-expanded":de.value},[c("span",qp,w(de.value?"close":"menu"),1)],8,Jp)),Zp]),je(Ue(xr,{items:oc.value},null,8,["items"]),[[Et,!ke.value&&!oe.value&&!un.value]]),je(Ue(xr,{items:ic.value,placement:"left","main-icon":"add_location_alt","main-label":"共筆停車點"},null,8,["items"]),[[Et,!ke.value&&!oe.value&&!un.value]]),je(Ue(w5,{"map-data-list":s.value,"community-parkings":L(re),onSelect:qa},null,8,["map-data-list","community-parkings"]),[[Et,!ke.value&&!oe.value&&!un.value]]),em,Ue(hu,{ref_key:"mapBoxRef",ref:O,parkingTypeKeyArray:Qa.value,degreeOfFriendlinessKeyArray:Ya.value,mapDataList:s.value,getLngLat:h.value.getLngLat,mapStylesSelected:h.value.mapStylesSelected,parkingPriceType:G.value,priceRangeMin:q.value,priceRangeMax:K.value,"favorite-ids":L(xe),"override-keys":sn.value,overrides:L(ce),"only-favorites":N.value,"focus-coord":bt.value,"route-profile":B.value,"community-parkings":L(re),goToParkingPlaceData:gt.value,"onUpdate:goToParkingPlaceData":f[1]||(f[1]=y=>gt.value=y),routeData:At.value,"onUpdate:routeData":f[2]||(f[2]=y=>At.value=y),onParkingInfo:Jn,onCommunityParkingClick:Wo},null,8,["parkingTypeKeyArray","degreeOfFriendlinessKeyArray","mapDataList","getLngLat","mapStylesSelected","parkingPriceType","priceRangeMin","priceRangeMax","favorite-ids","override-keys","overrides","only-favorites","focus-coord","route-profile","community-parkings","goToParkingPlaceData","routeData"]),Ue(p5,{"route-data":At.value,active:ke.value,profile:B.value,"onUpdate:profile":f[3]||(f[3]=y=>B.value=y),onCancel:Za},null,8,["route-data","active","profile"]),Ue(b3,{parkingType:_.value,"onUpdate:parkingType":f[4]||(f[4]=y=>_.value=y),degreeOfFriendliness:M.value,"onUpdate:degreeOfFriendliness":f[5]||(f[5]=y=>M.value=y),parkingPriceType:G.value,"onUpdate:parkingPriceType":f[6]||(f[6]=y=>G.value=y),priceRangeMin:q.value,"onUpdate:priceRangeMin":f[7]||(f[7]=y=>q.value=y),priceRangeMax:K.value,"onUpdate:priceRangeMax":f[8]||(f[8]=y=>K.value=y),mapStyle:u.value,"onUpdate:mapStyle":f[9]||(f[9]=y=>u.value=y),active:de.value,"onUpdate:active":f[10]||(f[10]=y=>de.value=y),onlyFavorites:N.value,"onUpdate:onlyFavorites":f[11]||(f[11]=y=>N.value=y),"favorites-count":L(Se).length},null,8,["parkingType","degreeOfFriendliness","parkingPriceType","priceRangeMin","priceRangeMax","mapStyle","active","onlyFavorites","favorites-count"]),je(Ue(q3,{info:$.value,active:oe.value,"is-mobile":L(t),"is-apple":L(o),"is-android":L(i),"has-route":gt.value!==null,"is-favorite":ws.value,"is-community":jo.value,"community-meta":jo.value?He.value:null,"is-overridden":!jo.value&&!!Zt.value,"override-meta":Zt.value,onClose:f[12]||(f[12]=y=>oe.value=!1),onRoute:f[13]||(f[13]=y=>$a($.value.geometry)),onOpenMap:ec,onToggleFavorite:Xa,onEditCommunity:Fa,onEditOverride:Ha,onShare:nc},null,8,["info","active","is-mobile","is-apple","is-android","has-route","is-favorite","is-community","community-meta","is-overridden","override-meta"]),[[Et,!ke.value]]),Ue(Ln,{modelValue:I.value,"onUpdate:modelValue":f[14]||(f[14]=y=>I.value=y),title:"地圖怎麼看?","close-text":"知道了",size:"lg"},{default:an(()=>[nm,c("div",tm,[c("div",om,[c("img",{src:L(X)("icon-3.png"),alt:""},null,8,im),k(" 汽車：汽車格(含未確認是否有重機格) ")]),c("div",sm,[c("img",{src:L(X)("icon-8.png"),alt:""},null,8,rm),k(" 重機(有人):有設重機專用格 ")]),c("div",lm,[c("img",{src:L(X)("icon-10.png"),alt:""},null,8,am),k(" 機車(沒人):機車格 ")]),c("div",cm,[c("img",{src:L(X)("icon-14.png"),alt:""},null,8,dm),k(" 綠星:路邊友善車格 ")]),c("div",hm,[c("img",{src:L(X)("icon-4.png"),alt:""},null,8,um),k(" 重機友善店家:用餐/消費時可停重機的店家 ")]),c("div",pm,[c("img",{src:L(X)("icon-15.png"),alt:""},null,8,mm),k(" 綠P:重機專用路邊停車格 ")]),c("div",fm,[c("img",{src:L(X)("icon-16.png"),alt:""},null,8,ym),k(" 灰P:重機專用路邊停車格(未確認精準座標,歡迎回報) ")]),c("div",bm,[c("img",{src:L(X)("icon-17.png"),alt:""},null,8,gm),k(" 藍P:普通大型共用機車格(台北市試辦) ")]),c("div",Am,[c("img",{src:L(X)("icon-18.png"),alt:""},null,8,_m),k(" 紫P:時段性汽機車共用停車格 ")]),c("div",vm,[c("img",{src:L(X)("icon-19.png"),alt:""},null,8,Cm),k(" 紅X:停都不給停 ")]),c("div",Pm,[c("img",{src:L(X)("icon-20.png"),alt:""},null,8,Um),k(" ?:類型未確認,歡迎透過共筆回報 ")])]),Em,c("div",Im,[c("div",Bm,[c("img",{src:L(X)("icon-2.png"),alt:""},null,8,Sm),c("img",{src:L(X)("icon-6.png"),alt:""},null,8,wm),c("img",{src:L(X)("icon-9.png"),alt:""},null,8,km),k(" 綠色最友善:有後牌辨析 ")]),c("div",Dm,[c("img",{src:L(X)("icon-5.png"),alt:""},null,8,Tm),c("img",{src:L(X)("icon-12.png"),alt:""},null,8,Mm),c("img",{src:L(X)("icon-11.png"),alt:""},null,8,Nm),k(" 藍色最傳統:悠遊卡 / 按鈕取票 ")]),c("div",Rm,[c("img",{src:L(X)("icon-1.png"),alt:""},null,8,xm),c("img",{src:L(X)("icon-13.png"),alt:""},null,8,Om),c("img",{src:L(X)("icon-7.png"),alt:""},null,8,Lm),k(" 紅色最靠北:請管理員協助 / 倒退嚕前牌辨析 ")]),c("div",Fm,[c("img",{src:L(X)("icon-3.png"),alt:""},null,8,Hm),c("img",{src:L(X)("icon-8.png"),alt:""},null,8,zm),c("img",{src:L(X)("icon-10.png"),alt:""},null,8,Vm),k(" 灰色未確定:有可能是上述任何情況,停到請回報 ")])]),Wm,c("div",jm,[c("div",Gm,[c("img",{src:L(X)("icon-3.png"),alt:""},null,8,Km),k(" (30/h)三張里地下停車場 ")]),Qm])]),_:1},8,["modelValue"]),Ue(Ln,{modelValue:V.value,"onUpdate:modelValue":f[19]||(f[19]=y=>V.value=y),title:"分享給朋友",size:"sm"},{default:an(()=>[c("div",Ym,[c("button",{class:"share-btn",onClick:f[15]||(f[15]=y=>gn("facebook")),"aria-label":"Facebook"},qm),c("button",{class:"share-btn",onClick:f[16]||(f[16]=y=>gn("line")),"aria-label":"LINE"},e4),c("button",{class:"share-btn",onClick:f[17]||(f[17]=y=>gn("twitter")),"aria-label":"Twitter"},o4),c("button",{class:"share-btn",onClick:f[18]||(f[18]=y=>gn("link")),"aria-label":"複製連結"},r4)])]),_:1},8,["modelValue"]),Ue(Ln,{modelValue:Go.value,"onUpdate:modelValue":f[24]||(f[24]=y=>Go.value=y),title:`分享：${Ko.value}`,size:"sm"},{default:an(()=>[c("p",l4,w(qn.value),1),c("div",a4,[c("button",{class:"share-btn",onClick:f[20]||(f[20]=y=>gn("facebook",qn.value)),"aria-label":"Facebook"},h4),c("button",{class:"share-btn",onClick:f[21]||(f[21]=y=>gn("line",qn.value)),"aria-label":"LINE"},m4),c("button",{class:"share-btn",onClick:f[22]||(f[22]=y=>gn("twitter",qn.value)),"aria-label":"Twitter"},b4),c("button",{class:"share-btn",onClick:f[23]||(f[23]=y=>gn("link",qn.value)),"aria-label":"複製連結"},_4)])]),_:1},8,["modelValue","title"]),Ue(Ln,{modelValue:U.value,"onUpdate:modelValue":f[27]||(f[27]=y=>U.value=y),title:"如何加入手機桌面?","close-text":"知道了",size:"lg"},{default:an(()=>[c("div",v4,[c("button",{type:"button",role:"tab","aria-selected":D.value==="ios",class:ie(["os-tab",{"is-active":D.value==="ios"}]),onClick:f[25]||(f[25]=y=>D.value="ios")},[P4,k(" iOS ")],10,C4),c("button",{type:"button",role:"tab","aria-selected":D.value==="android",class:ie(["os-tab",{"is-active":D.value==="android"}]),onClick:f[26]||(f[26]=y=>D.value="android")},[E4,k(" Android ")],10,U4)]),D.value==="ios"?(v(),P(ye,{key:0},[I4,B4,S4,w4,k4,D4,T4,M4,N4,R4,x4],64)):(v(),P(ye,{key:1},[O4,L4,F4,H4,z4,V4,W4,j4,G4],64))]),_:1},8,["modelValue"]),Ue(Ln,{modelValue:g.value,"onUpdate:modelValue":f[28]||(f[28]=y=>g.value=y),title:"嗨！歡迎使用 重機能停哪?","close-text":"開始使用"},{footer:an(()=>[c("button",{class:"btn btn-primary",onClick:Ae},"開始使用")]),default:an(()=>[K4,Q4,Y4,X4,J4,q4,$4,Z4]),_:1},8,["modelValue"]),Ue(Ip,{open:Te.value,"onUpdate:open":f[29]||(f[29]=y=>Te.value=y),mode:rn.value,initial:ln.value,"default-coord":yt.value,nickname:L(he),"is-owner":!0,"is-admin":L(x),submitting:hn.value,"has-existing-override":Bs.value,history:Na.value,"onUpdate:nickname":f[30]||(f[30]=y=>he.value=y),onSubmit:f[31]||(f[31]=y=>rn.value==="override"?Wa(y):Ga(y)),onDelete:Ka,onReset:ja},null,8,["open","mode","initial","default-coord","nickname","is-admin","submitting","has-existing-override","history"]),un.value?(v(),P("div",ef,tf)):j("",!0),un.value?(v(),P("div",of,[sf,c("div",{class:"pick-banner-actions"},[c("button",{class:"btn btn-outline btn-sm",onClick:Oa},"取消"),c("button",{class:"btn btn-primary btn-sm",onClick:xa},[rf,k(" 使用此位置 ")])])])):j("",!0),Ue(Ln,{modelValue:T.value,"onUpdate:modelValue":f[32]||(f[32]=y=>T.value=y),title:"共筆停車點說明","close-text":"我知道了",size:"lg"},{default:an(()=>[lf,af,cf,df,hf,uf,pf]),_:1},8,["modelValue"]),Ue(Op,{active:W.value,"onUpdate:active":f[33]||(f[33]=y=>W.value=y),steps:Ee,onFinish:Ie},null,8,["active"])],64))}},yf=nn(ff,[["__scopeId","data-v-e919e563"]]);lc(yf).mount("#app");"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./serviceWorker.js").catch(()=>{})});
