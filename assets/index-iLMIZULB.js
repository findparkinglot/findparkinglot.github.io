 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kn(n){return n&&n._delegate?n._delegate:n}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mn=new dl("@firebase/app"),Qd="@firebase/app-compat",Yd="@firebase/analytics-compat",Xd="@firebase/analytics",Jd="@firebase/app-check-compat",qd="@firebase/app-check",$d="@firebase/auth",Zd="@firebase/auth-compat",e1="@firebase/database",n1="@firebase/data-connect",t1="@firebase/database-compat",o1="@firebase/functions",i1="@firebase/functions-compat",s1="@firebase/installations",r1="@firebase/installations-compat",l1="@firebase/messaging",a1="@firebase/messaging-compat",c1="@firebase/performance",d1="@firebase/performance-compat",h1="@firebase/remote-config",u1="@firebase/remote-config-compat",p1="@firebase/storage",m1="@firebase/storage-compat",f1="@firebase/firestore",y1="@firebase/ai",b1="@firebase/firestore-compat",g1="firebase",A1="12.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pi="[DEFAULT]",_1={[ui]:"fire-core",[Qd]:"fire-core-compat",[Xd]:"fire-analytics",[Yd]:"fire-analytics-compat",[qd]:"fire-app-check",[Jd]:"fire-app-check-compat",[$d]:"fire-auth",[Zd]:"fire-auth-compat",[e1]:"fire-rtdb",[n1]:"fire-data-connect",[t1]:"fire-rtdb-compat",[o1]:"fire-fn",[i1]:"fire-fn-compat",[s1]:"fire-iid",[r1]:"fire-iid-compat",[l1]:"fire-fcm",[a1]:"fire-fcm-compat",[c1]:"fire-perf",[d1]:"fire-perf-compat",[h1]:"fire-rc",[u1]:"fire-rc-compat",[p1]:"fire-gcs",[m1]:"fire-gcs-compat",[f1]:"fire-fst",[b1]:"fire-fst-compat",[y1]:"fire-vertex","fire-js":"fire-js",[g1]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mo=new Map,v1=new Map,mi=new Map;function Xs(n,e){try{n.container.addComponent(e)}catch(t){mn.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function fo(n){const e=n.name;if(mi.has(e))return mn.debug(`There were multiple attempts to register component ${e}.`),!1;mi.set(e,n);for(const t of mo.values())Xs(t,n);for(const t of v1.values())Xs(t,n);return!0}function C1(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function P1(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I1=A1;function pl(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const o={name:pi,automaticDataCollectionEnabled:!0,...e},i=o.name;if(typeof i!="string"||!i)throw Pn.create("bad-app-name",{appName:String(i)});if(t||(t=il()),!t)throw Pn.create("no-options");const s=mo.get(i);if(s){if(po(t,s.options)&&po(o,s.config))return s;throw Pn.create("duplicate-app",{appName:i})}const r=new wd(i);for(const a of mi.values())r.addComponent(a);const l=new E1(t,o,r);return mo.set(i,l),l}function B1(n=pi){const e=mo.get(n);if(!e&&n===pi&&il())return pl();if(!e)throw Pn.create("no-app",{appName:n});return e}function ot(n,e,t){var r;let o=(r=_1[n])!=null?r:n;t&&(o+=`-${t}`);const i=o.match(/\s|\//),s=e.match(/\s|\//);if(i||s){const l=[`Unable to register library "${o}" with version "${e}":`];i&&l.push(`library name "${o}" contains illegal characters (whitespace or "/")`),i&&s&&l.push("and"),s&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),mn.warn(l.join(" "));return}fo(new xt(`${o}-version`,()=>({library:o,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S1="firebase-heartbeat-database",w1=1,Ot="firebase-heartbeat-store";let $o=null;function ml(){return $o||($o=Vd(S1,w1,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Ot)}catch(t){}}}}).catch(n=>{throw Pn.create("idb-open",{originalErrorMessage:n.message})})),$o}async function k1(n){try{const t=(await ml()).transaction(Ot),o=await t.objectStore(Ot).get(fl(n));return await t.done,o}catch(e){if(e instanceof Yt)mn.warn(e.message);else{const t=Pn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});mn.warn(t.message)}}}async function Js(n,e){try{const o=(await ml()).transaction(Ot,"readwrite");await o.objectStore(Ot).put(e,fl(n)),await o.done}catch(t){if(t instanceof Yt)mn.warn(t.message);else{const o=Pn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});mn.warn(o.message)}}}function fl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T1=1024,D1=30;class N1{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new R1(t),this._heartbeatsCachePromise=this._storage.read().then(o=>(this._heartbeatsCache=o,o))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=qs();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(r=>r.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats.length>D1){const r=x1(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(o){mn.warn(o)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=qs(),{heartbeatsToSend:o,unsentEntries:i}=M1(this._heartbeatsCache.heartbeats),s=ho(JSON.stringify({version:2,heartbeats:o}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return mn.warn(t),""}}}function qs(){return new Date().toISOString().substring(0,10)}function M1(n,e=T1){const t=[];let o=n.slice();for(const i of n){const s=t.find(r=>r.agent===i.agent);if(s){if(s.dates.push(i.date),$s(t)>e){s.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),$s(t)>e){t.pop();break}o=o.slice(1)}return{heartbeatsToSend:t,unsentEntries:o}}class R1{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return fd()?yd().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await k1(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return Js(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return Js(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function $s(n){return ho(JSON.stringify({version:2,heartbeats:n})).length}function x1(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let o=1;o<n.length;o++)n[o].date<t&&(t=n[o].date,e=o);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H1{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return cn(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bl=function(n){try{if(typeof window!="undefined"&&typeof window[n]!="undefined"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new F1(e)}}catch(e){}return new H1},Fn=bl("localStorage"),z1=bl("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gi="5",vl="v",Cl="s",Pl="r",Ul="f",El=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Il="ls",Bl="p",yi="ac",Sl="websocket",wl="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kl{constructor(e,t,o,i,s=!1,r="",l=!1,a=!1,d=null){this.secure=t,this.namespace=o,this.webSocketOnly=i,this.nodeAdmin=s,this.persistenceKey=r,this.includeNamespaceInQueryParams=l,this.isUsingEmulator=a,this.emulatorOptions=d,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=Fn.get("host:"+e)||this._host}isCacheableHost(){return this.internalHost.substr(0,2)==="s-"}isCustomHost(){return this._domain!=="firebaseio.com"&&this._domain!=="firebaseio-demo.com"}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&Fn.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}}function t0(n){return n.host!==n.internalHost||n.isCustomHost()||n.includeNamespaceInQueryParams}function Tl(n,e,t){A(typeof e=="string","typeof type must == string"),A(typeof t=="object","typeof params must == object");let o;if(e===Sl)o=(n.secure?"wss://":"ws://")+n.internalHost+"/.ws?";else if(e===wl)o=(n.secure?"https://":"http://")+n.internalHost+"/.lp?";else throw new Error("Unknown connection type: "+e);t0(n)&&(t.ns=n.namespace);const i=[];return Pe(t,(s,r)=>{i.push(s+"="+r)}),o+i.join("&")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o0{constructor(){this.counters_={}}incrementCounter(e,t=1){cn(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return id(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b0=16384,g0=45e3;let yo=null;typeof MozWebSocket!="undefined"?yo=MozWebSocket:typeof WebSocket!="undefined"&&(yo=WebSocket);class Xe{constructor(e,t,o,i,s,r,l){this.connId=e,this.applicationId=o,this.appCheckToken=i,this.authToken=s,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=Jt(this.connId),this.stats_=Ki(t),this.connURL=Xe.connectionURL_(t,r,l,i,o),this.nodeAdmin=t.nodeAdmin}static connectionURL_(e,t,o,i,s){const r={};return r[vl]=Gi,typeof location!="undefined"&&location.hostname&&El.test(location.hostname)&&(r[Pl]=Ul),t&&(r[Cl]=t),o&&(r[Il]=o),i&&(r[yi]=i),s&&(r[Bl]=s),Tl(e,Sl,r)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Fn.set("previous_websocket_failure",!0);try{let o;rl(),this.mySock=new yo(this.connURL,[],o)}catch(o){this.log_("Error instantiating WebSocket.");const i=o.message||o.data;i&&this.log_(i),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=o=>{this.handleIncomingFrame(o)},this.mySock.onerror=o=>{this.log_("WebSocket error.  Closing connection.");const i=o.message||o.data;i&&this.log_(i),this.onClosed_()}}start(){}static forceDisallow(){Xe.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator!="undefined"&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,o=navigator.userAgent.match(t);o&&o.length>1&&parseFloat(o[1])<4.4&&(e=!0)}return!e&&yo!==null&&!Xe.forceDisallow_}static previouslyFailed(){return Fn.isInMemoryStorage||Fn.get("previous_websocket_failure")===!0}markConnectionHealthy(){Fn.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const t=this.frames.join("");this.frames=null;const o=Rt(t);this.onMessage(o)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(A(this.frames===null,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(t);else{const o=this.extractFrameCount_(t);o!==null&&this.appendFrame_(o)}}send(e){this.resetKeepAlive();const t=ge(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const o=Al(t,b0);o.length>1&&this.sendString_(String(o.length));for(let i=0;i<o.length;i++)this.sendString_(o[i])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(g0))}sendString_(e){try{this.mySock.send(e)}catch(t){this.log_("Exception thrown from WebSocket.send():",t.message||t.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}Xe.responsesRequiredToBeHealthy=2;Xe.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt{static get ALL_TRANSPORTS(){return[tt,Xe]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const t=Xe&&Xe.isAvailable();let o=t&&!Xe.previouslyFailed();if(e.webSocketOnly&&(t||we("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),o=!0),o)this.transports_=[Xe];else{const i=this.transports_=[];for(const s of Lt.ALL_TRANSPORTS)s&&s.isAvailable()&&i.push(s);Lt.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}Lt.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class To{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const o=new z(zn,e),i=new z(zn,t);return this.compare(o,i)!==0}minPost(){return z.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O0(n,e){return Qn(n.name,e.name)}function qi(n,e){return Qn(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bi;function L0(n){bi=n}const Vl=function(n){return typeof n=="number"?"number:"+_l(n):"string:"+n},Wl=function(n){if(n.isLeafNode()){const e=n.val();A(typeof e=="string"||typeof e=="number"||typeof e=="object"&&cn(e,".sv"),"Priority must be a string or number.")}else A(n===bi||n.isEmpty(),"priority of unexpected type.");A(n===bi||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let jl,Gl;function F0(n){jl=n}function H0(n){Gl=n}class z0 extends To{compare(e,t){const o=e.node.getPriority(),i=t.node.getPriority(),s=o.compareTo(i);return s===0?Qn(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return z.MIN}maxPost(){return new z(En,new me("[PRIORITY-POST]",Gl))}makePost(e,t){const o=jl(e);return new z(t,new me("[PRIORITY-POST]",o))}toString(){return".priority"}}const se=new z0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ti;const et={};class un{static get Default(){return A(et&&se,"ChildrenNode.ts has not been loaded"),ti=ti||new un({".priority":et},{".priority":se}),ti}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=rt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Me?t:null}hasIndex(e){return cn(this.indexSet_,e.toString())}addIndex(e,t){A(e!==Hn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const o=[];let i=!1;const s=t.getIterator(z.Wrap);let r=s.getNext();for(;r;)i=i||e.isDefinedOn(r.node),o.push(r),r=s.getNext();let l;i?l=go(o,e.getCompare()):l=et;const a=e.toString(),d={...this.indexSet_};d[a]=e;const u={...this.indexes_};return u[a]=l,new un(u,d)}addToIndexes(e,t){const o=uo(this.indexes_,(i,s)=>{const r=rt(this.indexSet_,s);if(A(r,"Missing index implementation for "+s),i===et)if(r.isDefinedOn(e.node)){const l=[],a=t.getIterator(z.Wrap);let d=a.getNext();for(;d;)d.name!==e.name&&l.push(d),d=a.getNext();return l.push(e),go(l,r.getCompare())}else return et;else{const l=t.get(e.name);let a=i;return l&&(a=a.remove(new z(e.name,l))),a.insert(e,e.node)}});return new un(o,this.indexSet_)}removeFromIndexes(e,t){const o=uo(this.indexes_,i=>{if(i===et)return i;{const s=t.get(e.name);return s?i.remove(new z(e.name,s)):i}});return new un(o,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Pt;class R{static get EMPTY_NODE(){return Pt||(Pt=new R(new Me(qi),null,un.Default))}constructor(e,t,o){this.children_=e,this.priorityNode_=t,this.indexMap_=o,this.lazyHash_=null,this.priorityNode_&&Wl(this.priorityNode_),this.children_.isEmpty()&&A(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}isLeafNode(){return!1}getPriority(){return this.priorityNode_||Pt}updatePriority(e){return this.children_.isEmpty()?this:new R(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const t=this.children_.get(e);return t===null?Pt:t}}getChild(e){const t=F(e);return t===null?this:this.getImmediateChild(t).getChild(te(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,t){if(A(t,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(t);{const o=new z(e,t);let i,s;t.isEmpty()?(i=this.children_.remove(e),s=this.indexMap_.removeFromIndexes(o,this.children_)):(i=this.children_.insert(e,t),s=this.indexMap_.addToIndexes(o,this.children_));const r=i.isEmpty()?Pt:this.priorityNode_;return new R(i,r,s)}}updateChild(e,t){const o=F(e);if(o===null)return t;{A(F(e)!==".priority"||In(e)===1,".priority must be the last token in a path");const i=this.getImmediateChild(o).updateChild(te(e),t);return this.updateImmediateChild(o,i)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let o=0,i=0,s=!0;if(this.forEachChild(se,(r,l)=>{t[r]=l.val(e),o++,s&&R.INTEGER_REGEXP_.test(r)?i=Math.max(i,Number(r)):s=!1}),!e&&s&&i<2*o){const r=[];for(const l in t)r[l]=t[l];return r}else return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+Vl(this.getPriority().val())+":"),this.forEachChild(se,(t,o)=>{const i=o.hash();i!==""&&(e+=":"+t+":"+i)}),this.lazyHash_=e===""?"":gl(e)}return this.lazyHash_}getPredecessorChildName(e,t,o){const i=this.resolveIndex_(o);if(i){const s=i.getPredecessorKey(new z(e,t));return s?s.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const o=t.minKey();return o&&o.name}else return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new z(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const o=t.maxKey();return o&&o.name}else return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new z(t,this.children_.get(t)):null}forEachChild(e,t){const o=this.resolveIndex_(e);return o?o.inorderTraversal(i=>t(i.name,i.node)):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const o=this.resolveIndex_(t);if(o)return o.getIteratorFrom(e,i=>i);{const i=this.children_.getIteratorFrom(e.name,z.Wrap);let s=i.peek();for(;s!=null&&t.compare(s,e)<0;)i.getNext(),s=i.peek();return i}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const o=this.resolveIndex_(t);if(o)return o.getReverseIteratorFrom(e,i=>i);{const i=this.children_.getReverseIteratorFrom(e.name,z.Wrap);let s=i.peek();for(;s!=null&&t.compare(s,e)>0;)i.getNext(),s=i.peek();return i}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===qt?-1:0}withIndex(e){if(e===Hn||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new R(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===Hn||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority()))if(this.children_.count()===t.children_.count()){const o=this.getIterator(se),i=t.getIterator(se);let s=o.getNext(),r=i.getNext();for(;s&&r;){if(s.name!==r.name||!s.node.equals(r.node))return!1;s=o.getNext(),r=i.getNext()}return s===null&&r===null}else return!1;else return!1}}resolveIndex_(e){return e===Hn?null:this.indexMap_.get(e.toString())}}R.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class j0 extends R{constructor(){super(new Me(qi),R.EMPTY_NODE,un.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return R.EMPTY_NODE}isEmpty(){return!1}}const qt=new j0;Object.defineProperties(z,{MIN:{value:new z(zn,R.EMPTY_NODE)},MAX:{value:new z(En,qt)}});zl.__EMPTY_NODE=R.EMPTY_NODE;me.__childrenNodeConstructor=R;L0(qt);H0(qt);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $i extends To{constructor(e){super(),this.indexPath_=e,A(!H(e)&&F(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const o=this.extractChild(e.node),i=this.extractChild(t.node),s=o.compareTo(i);return s===0?Qn(e.name,t.name):s}makePost(e,t){const o=be(e),i=R.EMPTY_NODE.updateChild(this.indexPath_,o);return new z(t,i)}maxPost(){const e=R.EMPTY_NODE.updateChild(this.indexPath_,qt);return new z(En,e)}toString(){return Ft(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K0 extends To{compare(e,t){const o=e.node.compareTo(t.node);return o===0?Qn(e.name,t.name):o}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return z.MIN}maxPost(){return z.MAX}makePost(e,t){const o=be(e);return new z(t,o)}toString(){return".value"}}const Kl=new K0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class es{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=se}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return A(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return A(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:zn}hasEnd(){return this.endSet_}getIndexEndValue(){return A(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return A(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:En}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return A(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===se}copy(){const e=new es;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function X0(n){return n.loadsAllData()?new Zi(n.getIndex()):n.hasLimit()?new Y0(n):new Vt(n)}function J0(n,e){const t=n.copy();return t.index_=e,t}function yr(n){const e={};if(n.isDefault())return e;let t;if(n.index_===se?t="$priority":n.index_===Kl?t="$value":n.index_===Hn?t="$key":(A(n.index_ instanceof $i,"Unrecognized index type!"),t=n.index_.toString()),e.orderBy=ge(t),n.startSet_){const o=n.startAfterSet_?"startAfter":"startAt";e[o]=ge(n.indexStartValue_),n.startNameSet_&&(e[o]+=","+ge(n.indexStartName_))}if(n.endSet_){const o=n.endBeforeSet_?"endBefore":"endAt";e[o]=ge(n.indexEndValue_),n.endNameSet_&&(e[o]+=","+ge(n.indexEndName_))}return n.limitSet_&&(n.isViewFromLeft()?e.limitToFirst=n.limit_:e.limitToLast=n.limit_),e}function br(n){const e={};if(n.startSet_&&(e.sp=n.indexStartValue_,n.startNameSet_&&(e.sn=n.indexStartName_),e.sin=!n.startAfterSet_),n.endSet_&&(e.ep=n.indexEndValue_,n.endNameSet_&&(e.en=n.indexEndName_),e.ein=!n.endBeforeSet_),n.limitSet_){e.l=n.limit_;let t=n.viewFrom_;t===""&&(n.isViewFromLeft()?t="l":t="r"),e.vf=t}return n.index_!==se&&(e.i=n.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gr=10*1e3,e2=30*1e3,n2=5*60*1e3;class t2{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Z0(e);const o=gr+(e2-gr)*Math.random();wt(this.reportStats_.bind(this),Math.floor(o))}reportStats_(){const e=this.statsListener_.get(),t={};let o=!1;Pe(e,(i,s)=>{s>0&&cn(this.statsToReport_,i)&&(t[i]=s,o=!0)}),o&&this.server_.reportStats(t),wt(this.reportStats_.bind(this),Math.floor(Math.random()*2*n2))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var qe;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(qe||(qe={}));function ns(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function ts(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function os(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo{constructor(e,t,o){this.path=e,this.affectedTree=t,this.revert=o,this.type=qe.ACK_USER_WRITE,this.source=ns()}operationForChild(e){if(H(this.path)){if(this.affectedTree.value!=null)return A(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Y(e));return new vo(Q(),t,this.revert)}}else return A(F(this.path)===e,"operationForChild called for unrelated child."),new vo(te(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt{constructor(e,t){this.source=e,this.path=t,this.type=qe.LISTEN_COMPLETE}operationForChild(e){return H(this.path)?new Wt(this.source,Q()):new Wt(this.source,te(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vn{constructor(e,t,o){this.source=e,this.path=t,this.snap=o,this.type=qe.OVERWRITE}operationForChild(e){return H(this.path)?new Vn(this.source,Q(),this.snap.getImmediateChild(e)):new Vn(this.source,te(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wn{constructor(e,t,o){this.node_=e,this.fullyInitialized_=t,this.filtered_=o}isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(e){if(H(e))return this.isFullyInitialized()&&!this.filtered_;const t=F(e);return this.isCompleteForChild(t)}isCompleteForChild(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}getNode(){return this.node_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Do(n,e){return{eventCache:n,serverCache:e}}function kt(n,e,t,o){return Do(new Wn(e,t,o),n.serverCache)}function Xl(n,e,t,o){return Do(n.eventCache,new Wn(e,t,o))}function Ai(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function jn(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $e{constructor(e){this.writeTree_=e}static empty(){return new $e(new Z(null))}}function Tt(n,e,t){if(H(e))return new $e(new Z(t));{const o=n.writeTree_.findRootMostValueAndPath(e);if(o!=null){const i=o.path;let s=o.value;const r=Ne(i,e);return s=s.updateChild(r,t),new $e(n.writeTree_.set(i,s))}else{const i=new Z(t),s=n.writeTree_.setTree(e,i);return new $e(s)}}}function _i(n,e,t){let o=n;return Pe(t,(i,s)=>{o=Tt(o,le(e,i),s)}),o}function Ar(n,e){if(H(e))return $e.empty();{const t=n.writeTree_.setTree(e,new Z(null));return new $e(t)}}function vi(n,e){return Yn(n,e)!=null}function Yn(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(Ne(t.path,e)):null}function _r(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(se,(o,i)=>{e.push(new z(o,i))}):n.writeTree_.children.inorderTraversal((o,i)=>{i.value!=null&&e.push(new z(o,i.value))}),e}function Un(n,e){if(H(e))return n;{const t=Yn(n,e);return t!=null?new $e(new Z(t)):new $e(n.writeTree_.subtree(e))}}function Ci(n){return n.writeTree_.isEmpty()}function ct(n,e){return Jl(Q(),n.writeTree_,e)}function Jl(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let o=null;return e.children.inorderTraversal((i,s)=>{i===".priority"?(A(s.value!==null,"Priority writes must always be leaf nodes"),o=s.value):t=Jl(le(n,i),s,t)}),!t.getChild(n).isEmpty()&&o!==null&&(t=t.updateChild(le(n,".priority"),o)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function is(n,e){return ea(e,n)}function a2(n,e,t,o,i){A(o>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:o,visible:i}),i&&(n.visibleWrites=Tt(n.visibleWrites,e,t)),n.lastWriteId=o}function c2(n,e,t,o){A(o>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:o,visible:!0}),n.visibleWrites=_i(n.visibleWrites,e,t),n.lastWriteId=o}function d2(n,e){for(let t=0;t<n.allWrites.length;t++){const o=n.allWrites[t];if(o.writeId===e)return o}return null}function h2(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);A(t>=0,"removeWrite called with nonexistent writeId.");const o=n.allWrites[t];n.allWrites.splice(t,1);let i=o.visible,s=!1,r=n.allWrites.length-1;for(;i&&r>=0;){const l=n.allWrites[r];l.visible&&(r>=t&&u2(l,o.path)?i=!1:Ke(o.path,l.path)&&(s=!0)),r--}if(i){if(s)return p2(n),!0;if(o.snap)n.visibleWrites=Ar(n.visibleWrites,o.path);else{const l=o.children;Pe(l,a=>{n.visibleWrites=Ar(n.visibleWrites,le(o.path,a))})}return!0}else return!1}function u2(n,e){if(n.snap)return Ke(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Ke(le(n.path,t),e))return!0;return!1}function p2(n){n.visibleWrites=ql(n.allWrites,m2,Q()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function m2(n){return n.visible}function ql(n,e,t){let o=$e.empty();for(let i=0;i<n.length;++i){const s=n[i];if(e(s)){const r=s.path;let l;if(s.snap)Ke(t,r)?(l=Ne(t,r),o=Tt(o,l,s.snap)):Ke(r,t)&&(l=Ne(r,t),o=Tt(o,Q(),s.snap.getChild(l)));else if(s.children){if(Ke(t,r))l=Ne(t,r),o=_i(o,l,s.children);else if(Ke(r,t))if(l=Ne(r,t),H(l))o=_i(o,Q(),s.children);else{const a=rt(s.children,F(l));if(a){const d=a.getChild(te(l));o=Tt(o,Q(),d)}}}else throw ut("WriteRecord should have .snap or .children")}}return o}function $l(n,e,t,o,i){if(!o&&!i){const s=Yn(n.visibleWrites,e);if(s!=null)return s;{const r=Un(n.visibleWrites,e);if(Ci(r))return t;if(t==null&&!vi(r,Q()))return null;{const l=t||R.EMPTY_NODE;return ct(r,l)}}}else{const s=Un(n.visibleWrites,e);if(!i&&Ci(s))return t;if(!i&&t==null&&!vi(s,Q()))return null;{const r=function(d){return(d.visible||i)&&(!o||!~o.indexOf(d.writeId))&&(Ke(d.path,e)||Ke(e,d.path))},l=ql(n.allWrites,r,e),a=t||R.EMPTY_NODE;return ct(l,a)}}}function f2(n,e,t){let o=R.EMPTY_NODE;const i=Yn(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(se,(s,r)=>{o=o.updateImmediateChild(s,r)}),o;if(t){const s=Un(n.visibleWrites,e);return t.forEachChild(se,(r,l)=>{const a=ct(Un(s,new Y(r)),l);o=o.updateImmediateChild(r,a)}),_r(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}else{const s=Un(n.visibleWrites,e);return _r(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}}function y2(n,e,t,o,i){A(o||i,"Either existingEventSnap or existingServerSnap must exist");const s=le(e,t);if(vi(n.visibleWrites,s))return null;{const r=Un(n.visibleWrites,s);return Ci(r)?i.getChild(t):ct(r,i.getChild(t))}}function b2(n,e,t,o){const i=le(e,t),s=Yn(n.visibleWrites,i);if(s!=null)return s;if(o.isCompleteForChild(t)){const r=Un(n.visibleWrites,i);return ct(r,o.getNode().getImmediateChild(t))}else return null}function g2(n,e){return Yn(n.visibleWrites,e)}function A2(n,e,t,o,i,s,r){let l;const a=Un(n.visibleWrites,e),d=Yn(a,Q());if(d!=null)l=d;else if(t!=null)l=ct(a,t);else return[];if(l=l.withIndex(r),!l.isEmpty()&&!l.isLeafNode()){const u=[],h=r.getCompare(),m=s?l.getReverseIteratorFrom(o,r):l.getIteratorFrom(o,r);let b=m.getNext();for(;b&&u.length<i;)h(b,o)!==0&&u.push(b),b=m.getNext();return u}else return[]}function _2(){return{visibleWrites:$e.empty(),allWrites:[],lastWriteId:-1}}function Co(n,e,t,o){return $l(n.writeTree,n.treePath,e,t,o)}function ss(n,e){return f2(n.writeTree,n.treePath,e)}function vr(n,e,t,o){return y2(n.writeTree,n.treePath,e,t,o)}function Po(n,e){return g2(n.writeTree,le(n.treePath,e))}function v2(n,e,t,o,i,s){return A2(n.writeTree,n.treePath,e,t,o,i,s)}function rs(n,e,t){return b2(n.writeTree,n.treePath,e,t)}function Zl(n,e){return ea(le(n.treePath,e),n.writeTree)}function ea(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class P2{getCompleteChild(e){return null}getChildAfterChild(e,t,o){return null}}const na=new P2;class ls{constructor(e,t,o=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=o}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const o=this.optCompleteServerCache_!=null?new Wn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return rs(this.writes_,e,o)}}getChildAfterChild(e,t,o){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:jn(this.viewCache_),s=v2(this.writes_,i,t,1,o,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Eo;class O2{constructor(){this.views=new Map}}function L2(n){A(!Eo,"__referenceConstructor has already been defined"),Eo=n}function F2(){return A(Eo,"Reference.ts has not been loaded"),Eo}function H2(n){return n.views.size===0}function as(n,e,t,o){const i=e.source.queryId;if(i!==null){const s=n.views.get(i);return A(s!=null,"SyncTree gave us an op for an invalid query."),Ir(s,e,t,o)}else{let s=[];for(const r of n.views.values())s=s.concat(Ir(r,e,t,o));return s}}function z2(n,e,t,o,i){const s=e._queryIdentifier,r=n.views.get(s);if(!r){let l=Co(t,i?o:null),a=!1;l?a=!0:o instanceof R?(l=ss(t,o),a=!1):(l=R.EMPTY_NODE,a=!1);const d=Do(new Wn(l,a,!1),new Wn(o,i,!1));return new D2(e,d)}return r}function V2(n,e,t,o,i,s){const r=z2(n,e,o,i,s);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,r),R2(r,t),x2(r,t)}function W2(n,e,t,o){const i=e._queryIdentifier,s=[];let r=[];const l=Bn(n);if(i==="default")for(const[a,d]of n.views.entries())r=r.concat(Er(d,t,o)),Ur(d)&&(n.views.delete(a),d.query._queryParams.loadsAllData()||s.push(d.query));else{const a=n.views.get(i);a&&(r=r.concat(Er(a,t,o)),Ur(a)&&(n.views.delete(i),a.query._queryParams.loadsAllData()||s.push(a.query)))}return l&&!Bn(n)&&s.push(new(F2())(e._repo,e._path)),{removed:s,events:r}}function ia(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function st(n,e){let t=null;for(const o of n.views.values())t=t||M2(o,e);return t}function sa(n,e){if(e._queryParams.loadsAllData())return No(n);{const o=e._queryIdentifier;return n.views.get(o)}}function ra(n,e){return sa(n,e)!=null}function Bn(n){return No(n)!=null}function No(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Io;function j2(n){A(!Io,"__referenceConstructor has already been defined"),Io=n}function G2(){return A(Io,"Reference.ts has not been loaded"),Io}let K2=1;class Br{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Z(null),this.pendingWriteTree_=_2(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function la(n,e,t,o,i){return a2(n.pendingWriteTree_,e,t,o,i),i?mt(n,new Vn(ns(),e,t)):[]}function Q2(n,e,t,o){c2(n.pendingWriteTree_,e,t,o);const i=Z.fromObject(t);return mt(n,new at(ns(),e,i))}function vn(n,e,t=!1){const o=d2(n.pendingWriteTree_,e);if(h2(n.pendingWriteTree_,e)){let s=new Z(null);return o.snap!=null?s=s.set(Q(),!0):Pe(o.children,r=>{s=s.set(new Y(r),!0)}),mt(n,new vo(o.path,s,t))}else return[]}function Mo(n,e,t){return mt(n,new Vn(ts(),e,t))}function Y2(n,e,t){const o=Z.fromObject(t);return mt(n,new at(ts(),e,o))}function X2(n,e){return mt(n,new Wt(ts(),e))}function J2(n,e,t){const o=ds(n,t);if(o){const i=hs(o),s=i.path,r=i.queryId,l=Ne(s,e),a=new Wt(os(r),l);return us(n,s,a)}else return[]}function Ei(n,e,t,o,i=!1){const s=e._path,r=n.syncPointTree_.get(s);let l=[];if(r&&(e._queryIdentifier==="default"||ra(r,e))){const a=W2(r,e,t,o);H2(r)&&(n.syncPointTree_=n.syncPointTree_.remove(s));const d=a.removed;if(l=a.events,!i){const u=d.findIndex(m=>m._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(s,(m,b)=>Bn(b));if(u&&!h){const m=n.syncPointTree_.subtree(s);if(!m.isEmpty()){const b=Z2(m);for(let g=0;g<b.length;++g){const U=b[g],T=U.query,I=da(n,U);n.listenProvider_.startListening(Dt(T),Bo(n,T),I.hashFn,I.onComplete)}}}!h&&d.length>0&&!o&&(u?n.listenProvider_.stopListening(Dt(e),null):d.forEach(m=>{const b=n.queryToTagMap.get(Ro(m));n.listenProvider_.stopListening(Dt(m),b)}))}eh(n,d)}return l}function q2(n,e,t,o){const i=ds(n,o);if(i!=null){const s=hs(i),r=s.path,l=s.queryId,a=Ne(r,e),d=new Vn(os(l),a,t);return us(n,r,d)}else return[]}function $2(n,e,t,o){const i=ds(n,o);if(i){const s=hs(i),r=s.path,l=s.queryId,a=Ne(r,e),d=Z.fromObject(t),u=new at(os(l),a,d);return us(n,r,u)}else return[]}function Sr(n,e,t,o=!1){const i=e._path;let s=null,r=!1;n.syncPointTree_.foreachOnPath(i,(m,b)=>{const g=Ne(m,i);s=s||st(b,g),r=r||Bn(b)});let l=n.syncPointTree_.get(i);l?(r=r||Bn(l),s=s||st(l,Q())):(l=new O2,n.syncPointTree_=n.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=R.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((b,g)=>{const U=st(g,Q());U&&(s=s.updateImmediateChild(b,U))}));const d=ra(l,e);if(!d&&!e._queryParams.loadsAllData()){const m=Ro(e);A(!n.queryToTagMap.has(m),"View does not exist, but we have a tag");const b=nh();n.queryToTagMap.set(m,b),n.tagToQueryMap.set(b,m)}const u=is(n.pendingWriteTree_,i);let h=V2(l,e,t,u,s,a);if(!d&&!r&&!o){const m=sa(l,e);h=h.concat(th(n,e,m))}return h}function cs(n,e,t){const i=n.pendingWriteTree_,s=n.syncPointTree_.findOnPath(e,(r,l)=>{const a=Ne(r,e),d=st(l,a);if(d)return d});return $l(i,e,s,t,!0)}function mt(n,e){return aa(e,n.syncPointTree_,null,is(n.pendingWriteTree_,Q()))}function aa(n,e,t,o){if(H(n.path))return ca(n,e,t,o);{const i=e.get(Q());t==null&&i!=null&&(t=st(i,Q()));let s=[];const r=F(n.path),l=n.operationForChild(r),a=e.children.get(r);if(a&&l){const d=t?t.getImmediateChild(r):null,u=Zl(o,r);s=s.concat(aa(l,a,d,u))}return i&&(s=s.concat(as(i,n,o,t))),s}}function ca(n,e,t,o){const i=e.get(Q());t==null&&i!=null&&(t=st(i,Q()));let s=[];return e.children.inorderTraversal((r,l)=>{const a=t?t.getImmediateChild(r):null,d=Zl(o,r),u=n.operationForChild(r);u&&(s=s.concat(ca(u,l,a,d)))}),i&&(s=s.concat(as(i,n,o,t))),s}function da(n,e){const t=e.query,o=Bo(n,t);return{hashFn:()=>(N2(e)||R.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return o?J2(n,t._path,o):X2(n,t._path);{const s=X1(i,t);return Ei(n,t,null,s)}}}}function Bo(n,e){const t=Ro(e);return n.queryToTagMap.get(t)}function Ro(n){return n._path.toString()+"$"+n._queryIdentifier}function ds(n,e){return n.tagToQueryMap.get(e)}function hs(n){const e=n.indexOf("$");return A(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new Y(n.substr(0,e))}}function us(n,e,t){const o=n.syncPointTree_.get(e);A(o,"Missing sync point for query tag that we're tracking");const i=is(n.pendingWriteTree_,e);return as(o,t,i,null)}function Z2(n){return n.fold((e,t,o)=>{if(t&&Bn(t))return[No(t)];{let i=[];return t&&(i=ia(t)),Pe(o,(s,r)=>{i=i.concat(r)}),i}})}function Dt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(G2())(n._repo,n._path):n}function eh(n,e){for(let t=0;t<e.length;++t){const o=e[t];if(!o._queryParams.loadsAllData()){const i=Ro(o),s=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(s)}}}function nh(){return K2++}function th(n,e,t){const o=e._path,i=Bo(n,e),s=da(n,t),r=n.listenProvider_.startListening(Dt(e),i,s.hashFn,s.onComplete),l=n.syncPointTree_.subtree(o);if(i)A(!Bn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((d,u,h)=>{if(!H(d)&&u&&Bn(u))return[No(u).query];{let m=[];return u&&(m=m.concat(ia(u).map(b=>b.query))),Pe(h,(b,g)=>{m=m.concat(g)}),m}});for(let d=0;d<a.length;++d){const u=a[d];n.listenProvider_.stopListening(Dt(u),Bo(n,u))}}return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ch=/[\[\].#$\/\u0000-\u001F\u007F]/,dh=/[\[\].#$\u0000-\u001F\u007F]/,ii=10*1024*1024,gs=function(n){return typeof n=="string"&&n.length!==0&&!ch.test(n)},ya=function(n){return typeof n=="string"&&n.length!==0&&!dh.test(n)},hh=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),ya(n)},Bi=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!Wi(n)||n&&typeof n=="object"&&cn(n,".sv")},ba=function(n,e,t,o){o&&e===void 0||Oo(wo(n,"value"),e,t)},Oo=function(n,e,t){const o=t instanceof Y?new w0(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+xn(o));if(typeof e=="function")throw new Error(n+"contains a function "+xn(o)+" with contents = "+e.toString());if(Wi(e))throw new Error(n+"contains "+e.toString()+" "+xn(o));if(typeof e=="string"&&e.length>ii/3&&ko(e)>ii)throw new Error(n+"contains a string greater than "+ii+" utf8 bytes "+xn(o)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,s=!1;if(Pe(e,(r,l)=>{if(r===".value")i=!0;else if(r!==".priority"&&r!==".sv"&&(s=!0,!gs(r)))throw new Error(n+" contains an invalid key ("+r+") "+xn(o)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);k0(o,r),Oo(n,l,o),T0(o)}),i&&s)throw new Error(n+' contains ".value" child '+xn(o)+" in addition to actual children.")}},uh=function(n,e){let t,o;for(t=0;t<e.length;t++){o=e[t];const s=Ft(o);for(let r=0;r<s.length;r++)if(!(s[r]===".priority"&&r===s.length-1)){if(!gs(s[r]))throw new Error(n+"contains an invalid key ("+s[r]+") in path "+o.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(S0);let i=null;for(t=0;t<e.length;t++){if(o=e[t],i!==null&&Ke(i,o))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+o.toString());i=o}},ph=function(n,e,t,o){const i=wo(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const s=[];Pe(e,(r,l)=>{const a=new Y(r);if(Oo(i,l,le(t,a)),Yi(a)===".priority"&&!Bi(l))throw new Error(i+"contains an invalid value for '"+a.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");s.push(a)}),uh(i,s)},As=function(n,e,t,o){if(!ya(t))throw new Error(wo(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},mh=function(n,e,t,o){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),As(n,e,t)},_s=function(n,e){if(F(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},fh=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!gs(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!hh(t))throw new Error(wo(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yh{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Lo(n,e){let t=null;for(let o=0;o<e.length;o++){const i=e[o],s=i.getPath();t!==null&&!Xi(s,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:s}),t.events.push(i)}t&&n.eventLists_.push(t)}function ga(n,e,t){Lo(n,t),Aa(n,o=>Xi(o,e))}function Ze(n,e,t){Lo(n,t),Aa(n,o=>Ke(o,e)||Ke(e,o))}function Aa(n,e){n.recursionDepth_++;let t=!0;for(let o=0;o<n.eventLists_.length;o++){const i=n.eventLists_[o];if(i){const s=i.path;e(s)?(bh(n.eventLists_[o]),n.eventLists_[o]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function bh(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const o=t.getEventRunner();St&&Ce("event: "+t.toString()),pt(o)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vo{constructor(e,t,o,i){this._repo=e,this._path=t,this._queryParams=o,this._orderByCalled=i}get key(){return H(this._path)?null:Yi(this._path)}get ref(){return new kn(this._repo,this._path)}get _queryIdentifier(){const e=br(this._queryParams),t=ji(e);return t==="{}"?"default":t}get _queryObject(){return br(this._queryParams)}isEqual(e){if(e=Kn(e),!(e instanceof Vo))return!1;const t=this._repo===e._repo,o=Xi(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&o&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+B0(this._path)}}function Oh(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function Lh(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===Hn){const o="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==zn)throw new Error(o);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==En)throw new Error(o);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===se){if(e!=null&&!Bi(e)||t!=null&&!Bi(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(A(n.getIndex()instanceof $i||n.getIndex()===Kl,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class kn extends Vo{constructor(e,t){super(e,t,new es,!1)}get parent(){const e=Fl(this._path);return e===null?null:new kn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class So{constructor(e,t,o){this._node=e,this.ref=t,this._index=o}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Y(e),o=jt(this.ref,e);return new So(this._node.getChild(t),o,se)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(o,i)=>e(new So(i,jt(this.ref,o),se)))}hasChild(e){const t=new Y(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ye(n,e){return n=Kn(n),n._checkNotDeleted("ref"),e!==void 0?jt(n._root,e):n._root}function jt(n,e){return n=Kn(n),F(n._path)===null?mh("child","path",e):As("child","path",e),new kn(n._repo,le(n._path,e))}function so(n,e){n=Kn(n),_s("push",n._path),ba("push",e,n._path,!0);const t=_a(n._repo),o=Nh(t),i=jt(n,o),s=jt(n,o);let r;return r=Promise.resolve(s),i.then=r.then.bind(r),i.catch=r.then.bind(r,void 0),i}function Ea(n){return _s("remove",n._path),Fh(n,null)}function Fh(n,e){n=Kn(n),_s("set",n._path),ba("set",e,n._path,!1);const t=new Qt;return Ph(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function ki(n,e){ph("update",e,n._path);const t=new Qt;return Uh(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}class Es{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const o=t._queryParams.getIndex();return new Mh("value",this,new So(e.snapshotNode,new kn(t._repo,t._path),o))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Rh(this,e,t):null}matches(e){return e instanceof Es?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Hh(n,e,t,o,i){let s;if(typeof o=="object"&&(s=void 0,i=o),typeof o=="function"&&(s=o),i&&i.onlyOnce){const a=t,d=(u,h)=>{Si(n._repo,n,l),a(u,h)};d.userCallback=t.userCallback,d.context=t.context,t=d}const r=new xh(t,s||void 0),l=new Es(r);return Ih(n._repo,n,l),()=>Si(n._repo,n,l)}function Ia(n,e,t,o){return Hh(n,"value",e,t,o)}function Ba(n,e,t){Si(n._repo,n,null)}class zh{}class Vh extends zh{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){Oh(e,"orderByChild");const t=new Y(this._path);if(H(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const o=new $i(t),i=J0(e._queryParams,o);return Lh(i),new Vo(e._repo,e._path,i,!0)}}function Wh(n){return As("orderByChild","path",n),new Vh(n)}function jh(n,...e){let t=Kn(n);for(const o of e)t=o._apply(t);return t}L2(kn);j2(kn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gh="FIREBASE_DATABASE_EMULATOR_HOST",Ti={};let Kh=!1;function Qh(n,e,t,o){const i=e.lastIndexOf(":"),s=e.substring(0,i),r=cl(s);n.repoInfo_=new kl(e,r,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),o&&(n.authTokenProvider_=o)}function Yh(n,e,t,o,i){let s=o||n.options.databaseURL;s===void 0&&(n.options.projectId||fn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ce("Using default host for project ",n.options.projectId),s=`${n.options.projectId}-default-rtdb.firebaseio.com`);let r=Dr(s,i),l=r.repoInfo,a;typeof process!="undefined"&&Zs&&(a=Zs[Gh]),a?(s=`http://${a}?ns=${l.namespace}`,r=Dr(s,i),l=r.repoInfo):r.repoInfo.secure;const d=new n0(n.name,n.options,e);fh("Invalid Firebase Database URL",r),H(r.path)||fn("Database URL must point to the root of a Firebase Database (not including a child path).");const u=Jh(l,n,d,new e0(n,t));return new qh(u,n)}function Xh(n,e){const t=Ti[e];(!t||t[n.key]!==n)&&fn(`Database ${e}(${n.repoInfo_}) has already been deleted.`),Bh(n),delete t[n.key]}function Jh(n,e,t,o){let i=Ti[e.name];i||(i={},Ti[e.name]=i);let s=i[n.toURLString()];return s&&fn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new _h(n,Kh,t,o),i[n.toURLString()]=s,s}class qh{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(vh(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new kn(this._repo,Q())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Xh(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&fn("Cannot call "+e+" on a deleted database.")}}function $h(n=B1(),e){const t=C1(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const o=hd("database");o&&Zh(t,...o)}return t}function Zh(n,e,t,o={}){n=Kn(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,s=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&po(o,s.repoInfo_.emulatorOptions))return;fn("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let r;if(s.repoInfo_.nodeAdmin)o.mockUserToken&&fn('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new io(io.OWNER);else if(o.mockUserToken){const l=typeof o.mockUserToken=="string"?o.mockUserToken:ud(o.mockUserToken,n.app.options.projectId);r=new io(l)}cl(e)&&Ed(e),Qh(s,i,o,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eu(n){L1(I1),fo(new xt("database",(e,{instanceIdentifier:t})=>{const o=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return Yh(o,i,s,t)},"PUBLIC").setMultipleInstances(!0)),ot(er,nr,n),ot(er,nr,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nu={".sv":"timestamp"};function Ln(){return nu}pn.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};pn.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};eu();var tu="firebase",ou="12.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ot(tu,ou,"app");const Mn=n=>n?String(n).split(/[\r\n,=\s]/)[0].trim():"",Di={apiKey:Mn("AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs"),authDomain:Mn("findparkinglot-2519e.firebaseapp.com"),projectId:Mn("findparkinglot-2519e"),databaseURL:Mn("https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app"),storageBucket:Mn("findparkinglot-2519e.firebasestorage.app"),messagingSenderId:Mn("976769533420"),appId:Mn("1:976769533420:web:f3108318b3def30017acc9")},an=!!(Di.apiKey&&Di.databaseURL);let Mr=null,je=null;an&&(Mr=pl(Di),je=$h(Mr));const ro="parking_overrides",Bt=E({}),Sa=E(!1),Ni=E(null);let Nt=null,ri=0;function lo(n,e){if(!n||!Array.isArray(e))return"";const t=Number(e[0]),o=Number(e[1]);return!isFinite(t)||!isFinite(o)?"":`${n}|${t.toFixed(6)},${o.toFixed(6)}`.replace(/[.#$/[\]]/g,"_")}function wa(n,e){if(!e)return n;const t={...n},o=i=>{const s=e[i];s!=null&&(typeof s=="string"&&s.trim()===""||(t[i]=s))};return o("description"),o("iconKey"),o("category"),o("friendliness"),o("priceInfo"),t}function iu(){if(!(!an||Nt))try{const n=Ye(je,ro);Nt=n,Ia(n,e=>{const t={};e.forEach(o=>{t[o.key]=o.val()||{}}),Bt.value=t,Sa.value=!0},e=>{Ni.value=e})}catch(n){Ni.value=n}}function su(){Nt&&(Ba(Nt),Nt=null)}function ru(){Gn(()=>{ri+=1,iu()}),ht(()=>{ri-=1,ri<=0&&su()});const n=(s,r)=>{const l=lo(s,r);return l&&Bt.value[l]||null};return{overrides:Bt,ready:Sa,error:Ni,getOverride:n,hasOverride:(s,r)=>!!n(s,r),getOverrideHistory:(s,r)=>{const l=n(s,r);return!l||!l.history||typeof l.history!="object"?[]:Object.entries(l.history).map(([a,d])=>({...d||{},_key:a})).sort((a,d)=>a._key<d._key?1:a._key>d._key?-1:0)},upsertOverride:async(s,r,l)=>{var D,W,Ee;if(!an)throw new Error("Firebase 尚未設定");const a=lo(s.name,s.geometry);if(!a)throw new Error("無法產生 override key (缺少 name 或 geometry)");const[d,u]=s.geometry,h={id:l.id,nickname:l.nickname||""},m={origName:s.name||"",origLng:Number(d),origLat:Number(u),description:typeof r.description=="string"?r.description.trim():"",iconKey:r.iconKey||"",category:r.category||"",friendliness:r.friendliness||"",priceInfo:typeof r.priceInfo=="string"?r.priceInfo.trim():"",updatedBy:h,updatedAt:Ln()},b=Bt.value[a]||null,g=wa(s,b),U=["description","iconKey","category","friendliness","priceInfo"],T={},I={};for(const ae of U){const Ie=(D=g==null?void 0:g[ae])!=null?D:"",Ae=(W=m[ae])!=null?W:"";String(Ie)!==String(Ae)&&(T[ae]=Ie,I[ae]=Ae)}const V=so(Ye(je,`${ro}/${a}/history`)).key;return await ki(Ye(je),{[`${ro}/${a}`]:{...m,history:{...((Ee=Bt.value[a])==null?void 0:Ee.history)||{},[V]:{action:"override",at:Ln(),by:h,before:T,after:I}}}}),a},resetOverride:async(s,r)=>{if(!an)throw new Error("Firebase 尚未設定");const l=lo(s,r);l&&await Ea(Ye(je,`${ro}/${l}`))}}}const en=(n,e)=>{const t=n.__vccOpts||n;for(const[o,i]of e)t[o]=i;return t},lu={id:"map"},au=16,Rr=34,cu=84,du={__name:"MapBox",props:{parkingTypeKeyArray:Array,degreeOfFriendlinessKeyArray:Array,mapDataList:Array,getLngLat:Boolean,mapStylesSelected:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,goToParkingPlaceData:Object,routeData:Object,favoriteIds:{type:Object,default:()=>new Set},overrideKeys:{type:Object,default:()=>new Set},overrides:{type:Object,default:()=>({})},onlyFavorites:{type:Boolean,default:!1},focusCoord:{type:Array,default:null},routeProfile:{type:String,default:"driving"},communityParkings:{type:Array,default:()=>[]}},emits:["parkingInfo","communityParkingClick","update:goToParkingPlaceData","update:routeData"],setup(n,{expose:e,emit:t}){const o=n,i=t,s="pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",r=E(null),l=E({accessToken:s,bounds:[[119.3620389067818,21.83282743468497],[122.07013958372167,25.34391086143183]],center:[121.5173399,25.0475613],zoom:14,userCoordinates:[null,null]}),a=E(null),d=E([]),u=_=>_>=15?60:_>=13?60+(15-_)*30:_>=11?120+(13-_)*60:240,h=_=>Array.isArray(_)&&_.length>=2&&Number.isFinite(Number(_[0]))&&Number.isFinite(Number(_[1])),m=(_,N,G,q)=>{const K=document.createElement("div");K.className="marker",q&&K.classList.add("is-override"),G&&K.classList.add("is-fav");const Se=document.createElement("div");Se.className="tag";const xe=document.createElement("div");return xe.className="img",N.properties.icon&&(xe.style.backgroundImage=`url(${X(N.properties.icon)})`,xe.style.backgroundSize="cover",xe.style.backgroundPosition="center center"),K.appendChild(Se),K.appendChild(xe),K.addEventListener("click",()=>{r.value.flyTo({center:N.geometry.coordinates,zoom:17,bearing:0,speed:1.5,curve:1.5,easing:C=>C,essential:!0}),i("parkingInfo",{name:_.name,properties:N.properties,geometry:N.geometry.coordinates,address:""})}),K},b=(_,N)=>{const G=document.createElement("div");G.className="marker is-community",N&&G.classList.add("is-fav");const q=document.createElement("div");q.className="tag";const K=document.createElement("div");return K.className="img",_.iconKey&&(K.style.backgroundImage=`url(${X(_.iconKey)})`,K.style.backgroundSize="cover",K.style.backgroundPosition="center center"),G.appendChild(q),G.appendChild(K),G.addEventListener("click",()=>{r.value.flyTo({center:_.coordinates,zoom:17,speed:1.5,curve:1.5,essential:!0}),i("communityParkingClick",_)}),G},g=_=>{const N=document.createElement("div");N.className="marker-cluster";const G=Math.min(1,Math.log2(Math.max(2,_))/Math.log2(500)),q=Math.round(Rr+(cu-Rr)*G),K=Math.round(12+10*G);return N.style.width=`${q}px`,N.style.height=`${q}px`,N.style.lineHeight=`${q}px`,N.style.fontSize=`${K}px`,N.textContent=String(_),N},U=()=>{var Se,xe,nn,C,M,B,re,Te,Oe,yn,tn,he;for(let x=d.value.length-1;x>=0;x--)d.value[x].remove();if(d.value=[],!r.value)return;const _=(xe=(Se=r.value).getBounds)==null?void 0:xe.call(Se),N=[];for(const x of o.mapDataList)for(const O of x.features){const ce=O.geometry.coordinates;if(!h(ce))continue;const Le=ai(O.properties.name,ce),Fe=(C=(nn=o.favoriteIds)==null?void 0:nn.has)==null?void 0:C.call(nn,Le),_e=lo(O.properties.name,ce),Dn=_e?(B=(M=o.overrideKeys)==null?void 0:M.has)==null?void 0:B.call(M,_e):!1,on=Dn?(re=o.overrides)==null?void 0:re[_e]:null,De=typeof(on==null?void 0:on.priceInfo)=="string"&&on.priceInfo.trim()!==""?on.priceInfo.trim():"",sn=De||O.properties.priceInfo,rn=De?De.split("|"):O.properties.priceArray;!Hs(_,ce)||o.onlyFavorites&&!Fe||!Ls(O.properties.icon,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray)||!Fs(sn,rn,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)||N.push({coord:[Number(ce[0]),Number(ce[1])],createEl:()=>m(x,O,Fe,Dn)})}for(const x of o.communityParkings||[]){const O=x.coordinates;if(!h(O)||!Hs(_,O))continue;const ce=ai(x.name,O),Le=(Oe=(Te=o.favoriteIds)==null?void 0:Te.has)==null?void 0:Oe.call(Te,ce);if(o.onlyFavorites&&!Le||!Ls(x.iconKey,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray))continue;const Fe=x.priceInfo||"",_e=Fe?Fe.split("|"):[];Fs(Fe,_e,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)&&N.push({coord:[Number(O[0]),Number(O[1])],createEl:()=>b(x,Le)})}const G=(he=(tn=(yn=r.value).getZoom)==null?void 0:tn.call(yn))!=null?he:0;if(G>=au){for(const x of N){const O=new Nn.Marker(x.createEl()).setLngLat(x.coord).addTo(r.value);d.value.push(O)}return}const q=u(G),K=new Map;for(const x of N){const O=r.value.project(x.coord),ce=Math.floor(O.x/q),Le=Math.floor(O.y/q),Fe=`${ce}:${Le}`;let _e=K.get(Fe);_e||(_e={points:[],sumLng:0,sumLat:0},K.set(Fe,_e)),_e.points.push(x),_e.sumLng+=x.coord[0],_e.sumLat+=x.coord[1]}for(const x of K.values())if(x.points.length===1){const O=x.points[0],ce=new Nn.Marker(O.createEl()).setLngLat(O.coord).addTo(r.value);d.value.push(ce)}else{const O=[x.sumLng/x.points.length,x.sumLat/x.points.length],ce=g(x.points.length);ce.addEventListener("click",()=>{var _e,Dn,on;const Fe=Math.min(((on=(Dn=(_e=r.value).getZoom)==null?void 0:Dn.call(_e))!=null?on:0)+2,17);r.value.flyTo({center:O,zoom:Fe,speed:1.5,curve:1.5,essential:!0})});const Le=new Nn.Marker(ce).setLngLat(O).addTo(r.value);d.value.push(Le)}};let T=null,I=null;const V=()=>{T!=null&&(clearTimeout(T),T=null),I!=null&&(typeof cancelIdleCallback=="function"&&cancelIdleCallback(I),I=null)},D=()=>{V(),T=setTimeout(()=>{T=null;const _=()=>{I=null,o.goToParkingPlaceData==null&&U()};typeof requestIdleCallback=="function"?I=requestIdleCallback(_,{timeout:250}):_()},80)},W=()=>{const _=document.getElementById("loading-cover");_&&(_.classList.add("active"),setTimeout(()=>_.remove(),600))},Ee=()=>{r.value.on("dragend",D),r.value.on("zoomend",D),U(),W(),r.value.once("load",()=>{const _=o.focusCoord;Array.isArray(_)&&_[0]!=null&&_[1]!=null&&r.value.flyTo({center:[Number(_[0]),Number(_[1])],zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})})},ae=()=>{r.value=new Nn.Map({container:"map",style:o.mapStylesSelected,center:l.value.center,zoom:16,trackResize:!0,maxBounds:l.value.bounds}),Ee(),r.value.addControl(new Nn.GeolocateControl({positionOptions:{enableHighAccuracy:!0},trackUserLocation:!0,showUserHeading:!0})),r.value.on("geolocate",_=>{r.value.easeTo({bearing:_.coords.heading,duration:1e3,offset:[0,0]})})},Ie=_=>{const{longitude:N,latitude:G}=_.coords;N>=l.value.bounds[0][0]&&N<=l.value.bounds[1][0]&&G>=l.value.bounds[0][1]&&G<=l.value.bounds[1][1]?(l.value.userCoordinates=[N,G],l.value.center=[N,G]):l.value.center=[121.5173399,25.0475613],ae()},Ae=()=>{ae()},de=()=>{const _=document.getElementById("coordinates"),N=a.value.getLngLat();_.style.display="block",_.innerHTML=`[Longitude, Latitude]<br />[${N.lng}, ${N.lat}]`},oe=()=>{a.value=new Nn.Marker({draggable:!0,color:"#2ee7d6"}).setLngLat(r.value.getCenter()).addTo(r.value),de(),a.value.on("dragend",de)};async function ke(_,N){r.value.getLayer("point")||r.value.addLayer({id:"point",type:"circle",source:{type:"geojson",data:{type:"FeatureCollection",features:[{type:"Feature",properties:{},geometry:{type:"Point",coordinates:_}}]}},paint:{"circle-radius":10,"circle-color":"#2ee7d6"}});const K=(await(await fetch(`https://api.mapbox.com/directions/v5/mapbox/${o.routeProfile||"driving"}/${_[0]},${_[1]};${N[0]},${N[1]}?alternatives=false&language=zh-Hant&overview=full&steps=true&exclude=ferry&geometries=geojson&access_token=${l.value.accessToken}`,{method:"GET"})).json()).routes[0],Se={type:"Feature",properties:{},geometry:{type:"LineString",coordinates:K.geometry.coordinates}};i("update:routeData",K),r.value.getSource("route")?r.value.getSource("route").setData(Se):r.value.addLayer({id:"route",type:"line",source:{type:"geojson",data:Se},layout:{"line-join":"round","line-cap":"round"},paint:{"line-color":"#2ee7d6","line-width":5,"line-opacity":.75}})}const Re=_=>{if(l.value.userCoordinates[0]!==null){r.value.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point"));for(let G=d.value.length-1;G>=0;G--){const q=d.value[G].getLngLat();q.lng!=_[0]&&q.lat!=_[1]&&d.value[G].remove()}const N=[[l.value.userCoordinates[0],l.value.userCoordinates[1]],[_[0],_[1]]];r.value.fitBounds(N,{padding:{top:100,bottom:100,left:100,right:100}}),ke(l.value.userCoordinates,_)}else"geolocation"in navigator&&navigator.geolocation.getCurrentPosition(Ie,Ae)},Be=()=>{var _,N;(_=r.value)!=null&&_.getSource("route")&&(r.value.removeLayer("route"),r.value.removeSource("route")),(N=r.value)!=null&&N.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point")),U(),i("update:goToParkingPlaceData",null)};return Gn(()=>{Nn.accessToken=l.value.accessToken,"geolocation"in navigator?navigator.geolocation.getCurrentPosition(Ie,Ae,{enableHighAccuracy:!1,timeout:8e3,maximumAge:6e4}):ae()}),ht(()=>{V()}),J([()=>o.parkingTypeKeyArray,()=>o.degreeOfFriendlinessKeyArray,()=>o.priceRangeMin,()=>o.priceRangeMax,()=>o.parkingPriceType,()=>o.onlyFavorites,()=>o.favoriteIds,()=>o.communityParkings],()=>D()),J(()=>o.focusCoord,_=>{!_||!r.value||r.value.flyTo({center:_,zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})}),J(()=>o.routeProfile,()=>{o.goToParkingPlaceData!==null&&l.value.userCoordinates[0]!==null&&ke(l.value.userCoordinates,o.goToParkingPlaceData)}),J(()=>o.goToParkingPlaceData,_=>{_!==null?Re(_):Be()}),J(()=>o.mapStylesSelected,(_,N)=>{N!==_&&r.value&&r.value.setStyle(_)}),J(()=>o.getLngLat,()=>{if(a.value!==null){a.value.remove();const _=document.getElementById("coordinates");_&&(_.style.display="none")}o.getLngLat===!0&&oe()}),e({getCenter:()=>{if(!r.value)return[...l.value.center];const _=r.value.getCenter();return[_.lng,_.lat]},flyTo:(_,N=17)=>{!r.value||!_||r.value.flyTo({center:_,zoom:N,essential:!0})}}),(_,N)=>(v(),P("div",lu))}},hu=en(du,[["__scopeId","data-v-09d5679d"]]),uu=n=>(Sn("data-v-4ef15e45"),n=n(),wn(),n),pu={key:0,class:"modal-header"},mu=uu(()=>c("span",{class:"material-icons-outlined"},"close",-1)),fu=[mu],yu={class:"modal-body"},bu={key:1,class:"modal-footer"},gu={__name:"BaseModal",props:{modelValue:Boolean,title:{type:String,default:""},closeText:{type:String,default:"關閉"},size:{type:String,default:"md"}},emits:["update:modelValue","close"],setup(n,{emit:e}){const t=n,o=e,i=E(null),s=()=>{o("update:modelValue",!1),o("close")},r=l=>{l.key==="Escape"&&t.modelValue&&s()};return Gn(()=>window.addEventListener("keydown",r)),ht(()=>window.removeEventListener("keydown",r)),J(()=>t.modelValue,async l=>{var a;document.body.classList.toggle("modal-open",l),l&&(await Vr(),(a=i.value)==null||a.scrollTo({top:0,behavior:"auto"}))}),(l,a)=>(v(),Li(sc,{to:"body"},[c("div",{class:ie(["modal-overlay",{active:n.modelValue}]),onClick:Fi(s,["self"]),role:"dialog","aria-modal":"true",ref_key:"overlayEl",ref:i},[c("div",{class:ie(["modal-card",[`size-${n.size}`,{active:n.modelValue}]])},[n.title||l.$slots.header?(v(),P("header",pu,[Yo(l.$slots,"header",{},()=>[c("h3",null,w(n.title),1)]),c("button",{class:"modal-close",onClick:s,"aria-label":"關閉"},fu)])):j("",!0),c("div",yu,[Yo(l.$slots,"default",{},void 0)]),l.$slots.footer||n.closeText?(v(),P("footer",bu,[Yo(l.$slots,"footer",{},()=>[c("button",{class:"btn btn-primary",onClick:s},w(n.closeText),1)])])):j("",!0)],2)],2)]))}},On=en(gu,[["__scopeId","data-v-4ef15e45"]]),Au=["onClick"],_u={class:"material-icons-outlined"},vu={class:"fab-item-label"},Cu=["aria-label","aria-expanded"],Pu={class:"material-icons-outlined"},Uu={__name:"FabMenu",props:{items:{type:Array,required:!0},placement:{type:String,default:"right"},mainIcon:{type:String,default:"apps"},mainLabel:{type:String,default:""}},setup(n){const e=E(!1),t=E(null),o=()=>e.value=!e.value,i=r=>{t.value&&!t.value.contains(r.target)&&(e.value=!1)},s=r=>{var l;e.value=!1,(l=r.onClick)==null||l.call(r)};return Gn(()=>document.addEventListener("click",i)),ht(()=>document.removeEventListener("click",i)),(r,l)=>(v(),P("div",{class:ie(["fab-root",`fab-placement-${n.placement}`]),ref_key:"rootEl",ref:t},[Ue(rc,{name:"fab-item",tag:"div",class:"fab-items"},{default:ln(()=>[(v(!0),P(ye,null,Ge(e.value?n.items:[],(a,d)=>(v(),P("button",{key:a.key,class:ie(["fab-item",{highlight:a.highlight}]),style:co({bottom:d*46+"px"}),onClick:u=>s(a)},[c("span",_u,w(a.icon),1),c("span",vu,w(a.label),1)],14,Au))),128))]),_:1}),c("button",{class:ie(["fab-main",{active:e.value}]),onClick:Fi(o,["stop"]),"aria-label":e.value?"收合選單":n.mainLabel||"展開選單","aria-expanded":e.value},[c("span",Pu,w(e.value?"close":n.mainIcon),1)],10,Cu)],2))}},xr=en(Uu,[["__scopeId","data-v-b3399b6f"]]),Gt=[{name:"全部",value:"",key:null},{name:"汽車：汽車格(含未確認是否有重機格)",value:"car",key:["icon-1.png","icon-2.png","icon-3.png","icon-5.png"]},{name:"重機：有設重機專用格",value:"motorcycle",key:["icon-6.png","icon-8.png","icon-12.png","icon-13.png"]},{name:"機車：機車格",value:"scooter",key:["icon-7.png","icon-9.png","icon-10.png","icon-11.png"]},{name:"綠星:路邊友善車格(機車格開放重機停放)",value:"greenStar",key:["icon-14.png"]},{name:"重機友善店家:用餐/消費可停重機",value:"friendlyShop",key:["icon-4.png"]},{name:"綠P:重機專用路邊停車格",value:"greenP",key:["icon-15.png"]},{name:"灰P:重機專用路邊停車格(未確認精準座標)",value:"greyP",key:["icon-16.png"]},{name:"藍P:普通大型共用機車格(台北市試辦)",value:"blueP",key:["icon-17.png"]},{name:"紫P:時段性汽機車共用停車格，注意使用時間喔!",value:"purpleP",key:["icon-18.png"]},{name:"紅X:停都不給停",value:"redX",key:["icon-19.png"]},{name:"?:類型未確認",value:"unknown",key:["icon-20.png"]}],Kt=[{name:"全部",value:"",key:null},{name:"最友善：有後牌辨析",value:"friendly",key:["icon-2.png","icon-4.png","icon-6.png","icon-9.png","icon-14.png","icon-15.png"]},{name:"最傳統：悠遊卡、按鈕取票",value:"normal",key:["icon-5.png","icon-11.png","icon-12.png","icon-17.png"]},{name:"最靠北：按鈕請管理員協助、前牌辨析",value:"unfriendly",key:["icon-1.png","icon-7.png","icon-13.png","icon-19.png"]},{name:"未確定",value:"unknown",key:["icon-3.png","icon-8.png","icon-10.png","icon-16.png","icon-20.png"]}],nt=[{name:"依系統設定",value:"system",theme:"system"},{name:"暗色模式",value:"mapbox://styles/jamestim9215/ckvkdj5cd1q4115nzwxa9rny3",theme:"dark"},{name:"亮色模式",value:"mapbox://styles/jamestim9215/ckvueghhu2woc14nrsgysx41v",theme:"light"}],Eu=n=>(Sn("data-v-fc736dec"),n=n(),wn(),n),Iu={class:"range-slider"},Bu={class:"range-track"},Su=["min","max","step","value"],wu=["min","max","step","value"],ku={class:"range-values"},Tu=Eu(()=>c("span",{class:"range-sep"},"~",-1)),Du={__name:"RangeSlider",props:{min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:10},modelMin:{type:Number,default:0},modelMax:{type:Number,default:100},suffix:{type:String,default:""}},emits:["update:modelMin","update:modelMax"],setup(n,{emit:e}){const t=n,o=e,i=ne(()=>t.max-t.min||1),s=ne(()=>(t.modelMin-t.min)/i.value*100),r=ne(()=>(t.modelMax-t.min)/i.value*100),l=d=>{let u=Number(d.target.value);u>t.modelMax&&(u=t.modelMax),o("update:modelMin",u)},a=d=>{let u=Number(d.target.value);u<t.modelMin&&(u=t.modelMin),o("update:modelMax",u)};return(d,u)=>(v(),P("div",Iu,[c("div",Bu,[c("div",{class:"range-fill",style:co({left:s.value+"%",right:100-r.value+"%"})},null,4),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMin,onInput:l,class:"range-input range-input-min","aria-label":"最低價格"},null,40,Su),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMax,onInput:a,class:"range-input range-input-max","aria-label":"最高價格"},null,40,wu)]),c("div",ku,[c("span",null,w(n.modelMin)+w(n.suffix),1),Tu,c("span",null,w(n.modelMax)+w(n.suffix),1)])]))}},Nu=en(Du,[["__scopeId","data-v-fc736dec"]]),Xn=n=>(Sn("data-v-27bdb53c"),n=n(),wn(),n),Mu=Xn(()=>c("span",{class:"material-icons-outlined"},"chevron_left",-1)),Ru=[Mu],xu=Wr('<header class="side-panel-header" data-v-27bdb53c><img class="side-panel-logo" src="'+Hi+'" alt="重機能停哪" data-v-27bdb53c><div class="side-panel-titles" data-v-27bdb53c><h3 data-v-27bdb53c>重機能停哪?</h3><span class="side-panel-subtitle" data-v-27bdb53c><span class="material-icons-outlined" data-v-27bdb53c>tune</span>設定 </span></div></header>',1),Ou={class:"side-panel-body"},Lu={class:"form-group"},Fu={class:"form-toggle"},Hu={class:"form-toggle-text"},zu=Xn(()=>c("span",{class:"material-icons-outlined fav-icon"},"star",-1)),Vu={key:0,class:"fav-count"},Wu=["checked"],ju={class:"form-group"},Gu=Xn(()=>c("label",{class:"form-label"},"甚麼格位",-1)),Ku=["value"],Qu=["value"],Yu={class:"form-group"},Xu=Xn(()=>c("label",{class:"form-label"},"友善程度",-1)),Ju=["value"],qu=["value"],$u={class:"form-group"},Zu=Xn(()=>c("label",{class:"form-label"},"收費範圍",-1)),e3={class:"price-chips"},n3=Xn(()=>c("span",{class:"material-icons-outlined"},"money_off",-1)),t3={class:"form-group"},o3=Xn(()=>c("label",{class:"form-label"},"主題顏色",-1)),i3=["value"],s3=["value"],r3=Wr('<section class="form-group" data-v-27bdb53c><label class="form-label" data-v-27bdb53c>停車場資料來源</label><div class="link-list" data-v-27bdb53c><a href="https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&amp;g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&amp;skid=9984dc32-0eac-4e02-b7a8-241e8910f915&amp;shorturl=1&amp;ll=25.078951126084913%2C121.45397636318671&amp;z=11" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-27bdb53c> Alan大重停車記事 </a></div></section><section class="form-group" data-v-27bdb53c><label class="form-label" data-v-27bdb53c>問題回報</label><p class="muted-text" data-v-27bdb53c> 1. 停車場資訊相關（新場地、收費錯誤）： </p><a href="https://forms.gle/euRCPCPSmvYLm5Rj8" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-27bdb53c> Alan大重停車記事 回報表單 </a><p class="muted-text mt-8" data-v-27bdb53c>2. 網頁 BUG、畫面跑版：</p><a href="https://forms.gle/iJCyfqVtpL35WtZM7" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-27bdb53c> 重機能停哪? 回報表單 </a><a href="https://buymeacoffee.com/jamestim923" target="_blank" rel="noopener" class="btn btn-coffee btn-sm mt-8" data-v-27bdb53c> ☕️ 請我喝杯咖啡，讓我有動力繼續更新 </a></section><section class="form-group" data-v-27bdb53c><label class="form-label" data-v-27bdb53c>資訊</label><ul class="info-list" data-v-27bdb53c><li data-v-27bdb53c>版本：v2.2.1</li><li data-v-27bdb53c>地圖資料更新：260525</li><li data-v-27bdb53c>Web 製作：爽爽</li><li data-v-27bdb53c>資料參考：Alan大重停車記事 Google My Map</li><li data-v-27bdb53c>地圖：Mapbox GL JS API</li><li data-v-27bdb53c>© 2026 爽爽 版權所有。本網頁未經准許，禁止任何商業行為</li></ul></section>',3),l3={__name:"SettingsPanel",props:{parkingType:String,degreeOfFriendliness:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,mapStyle:String,active:Boolean,onlyFavorites:Boolean,favoritesCount:{type:Number,default:0}},emits:["update:parkingType","update:degreeOfFriendliness","update:parkingPriceType","update:priceRangeMin","update:priceRangeMax","update:mapStyle","update:active","update:onlyFavorites"],setup(n,{emit:e}){const t=e,o=()=>t("update:active",!1);return(i,s)=>(v(),P("aside",{class:ie(["side-panel",{active:n.active}]),"aria-label":"設定面板"},[c("button",{class:"side-panel-close",onClick:o,"aria-label":"收合設定"},Ru),xu,c("div",Ou,[c("section",Lu,[c("label",Fu,[c("span",Hu,[zu,k(" 只看我的最愛 "),n.favoritesCount?(v(),P("span",Vu,w(n.favoritesCount),1)):j("",!0)]),c("input",{type:"checkbox",class:"switch",checked:n.onlyFavorites,onChange:s[0]||(s[0]=r=>t("update:onlyFavorites",r.target.checked))},null,40,Wu)])]),c("section",ju,[Gu,c("select",{class:"form-control",value:n.parkingType,onChange:s[1]||(s[1]=r=>t("update:parkingType",r.target.value))},[(v(!0),P(ye,null,Ge(L(Gt),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,Qu))),128))],40,Ku)]),c("section",Yu,[Xu,c("select",{class:"form-control",value:n.degreeOfFriendliness,onChange:s[2]||(s[2]=r=>t("update:degreeOfFriendliness",r.target.value))},[(v(!0),P(ye,null,Ge(L(Kt),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,qu))),128))],40,Ju)]),c("section",$u,[Zu,c("div",e3,[c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType===""}]),onClick:s[3]||(s[3]=r=>t("update:parkingPriceType",""))},"全部",2),c("button",{type:"button",class:ie(["chip chip-free",{active:n.parkingPriceType==="free"}]),onClick:s[4]||(s[4]=r=>t("update:parkingPriceType",n.parkingPriceType==="free"?"":"free"))},[n3,k(" 免費 ")],2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="h"}]),onClick:s[5]||(s[5]=r=>t("update:parkingPriceType","h"))},"計時 /時",2),c("button",{type:"button",class:ie(["chip",{active:n.parkingPriceType==="d"}]),onClick:s[6]||(s[6]=r=>t("update:parkingPriceType","d"))},"計次 /日",2)]),/d|h/.test(n.parkingPriceType)?(v(),Li(Nu,{key:0,class:"mt-8",min:0,max:300,step:10,"model-min":n.priceRangeMin,"model-max":n.priceRangeMax,suffix:n.parkingPriceType==="h"?" /時":" /日","onUpdate:modelMin":s[7]||(s[7]=r=>t("update:priceRangeMin",r)),"onUpdate:modelMax":s[8]||(s[8]=r=>t("update:priceRangeMax",r))},null,8,["model-min","model-max","suffix"])):j("",!0)]),c("section",t3,[o3,c("select",{class:"form-control",value:n.mapStyle,onChange:s[9]||(s[9]=r=>t("update:mapStyle",r.target.value))},[(v(!0),P(ye,null,Ge(L(nt),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,s3))),128))],40,i3)]),r3])],2))}},a3=en(l3,[["__scopeId","data-v-27bdb53c"]]),Qe=n=>(Sn("data-v-e6db4a59"),n=n(),wn(),n),c3=Qe(()=>c("span",{class:"material-icons-outlined"},"close",-1)),d3=[c3],h3={class:"info-header"},u3=["src"],p3={class:"info-title"},m3=["aria-label","title"],f3={class:"material-icons-outlined"},y3=["innerHTML"],b3={key:1,class:"info-address"},g3={key:2,class:"info-price"},A3=Qe(()=>c("span",{class:"material-icons-outlined"},"payments",-1)),_3=Qe(()=>c("span",{class:"info-price-label"},"收費",-1)),v3={class:"info-price-value"},C3={key:0,class:"info-price-tag"},P3={key:3,class:"community-tag"},U3=Qe(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),E3={key:4,class:"override-tag"},I3=Qe(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),B3={key:5,class:"source-tag"},S3=Qe(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),w3={class:"info-meta"},k3={class:"badge"},T3={class:"coord"},D3={class:"info-actions"},N3=Qe(()=>c("span",{class:"material-icons-outlined"},"edit",-1)),M3=["title"],R3=Qe(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),x3=Qe(()=>c("span",{class:"material-icons-outlined"},"share",-1)),O3={class:"info-actions"},L3=Qe(()=>c("span",{class:"material-icons-outlined"},"map",-1)),F3=Qe(()=>c("span",{class:"material-icons-outlined"},"map",-1)),H3=Qe(()=>c("span",{class:"material-icons-outlined"},"directions",-1)),z3={__name:"ParkingInfoPanel",props:{info:Object,active:Boolean,isMobile:Boolean,isApple:Boolean,isAndroid:Boolean,hasRoute:Boolean,isFavorite:Boolean,isCommunity:{type:Boolean,default:!1},communityMeta:{type:Object,default:null},isOverridden:{type:Boolean,default:!1},overrideMeta:{type:Object,default:null}},emits:["close","route","openMap","toggleFavorite","editCommunity","editOverride","share"],setup(n,{emit:e}){const t=e,o=new Set(["icon-4.png","icon-14.png","icon-19.png"]),i=s=>!!(s!=null&&s.priceInfo)&&!o.has(s==null?void 0:s.parkingIconKey);return(s,r)=>{var l,a,d,u,h,m,b,g;return v(),P("aside",{class:ie(["info-panel",{active:n.active}]),"aria-label":"停車場資訊"},[c("button",{class:"panel-close",onClick:r[0]||(r[0]=U=>t("close")),"aria-label":"關閉"},d3),c("header",h3,[n.info.parkingIcon?(v(),P("img",{key:0,class:"info-icon",src:n.info.parkingIcon,alt:""},null,8,u3)):j("",!0),c("h3",p3,w(n.info.parkingName),1),c("button",{class:ie(["fav-btn",{active:n.isFavorite}]),onClick:r[1]||(r[1]=U=>t("toggleFavorite")),"aria-label":n.isFavorite?"從我的最愛移除":"加入我的最愛",title:n.isFavorite?"從我的最愛移除":"加入我的最愛"},[c("span",f3,w(n.isFavorite?"star":"star_border"),1)],10,m3)]),n.info.parkingNameDes?(v(),P("div",{key:0,class:"info-desc",innerHTML:n.info.parkingNameDes},null,8,y3)):j("",!0),n.info.address?(v(),P("div",b3,w(n.info.address),1)):j("",!0),i(n.info)?(v(),P("div",g3,[A3,_3,c("span",v3,w(n.info.priceInfo),1),n.isOverridden?(v(),P("span",C3,"車友修改")):j("",!0)])):j("",!0),n.isCommunity?(v(),P("div",P3,[U3,c("span",null,[k(" 共筆停車點 "),(a=(l=n.communityMeta)==null?void 0:l.updatedBy)!=null&&a.nickname||(u=(d=n.communityMeta)==null?void 0:d.updatedBy)!=null&&u.id?(v(),P(ye,{key:0},[k(" · 由 "+w(n.communityMeta.updatedBy.nickname||`匿名#${n.communityMeta.updatedBy.id}`)+" 更新 ",1)],64)):j("",!0)])])):n.isOverridden?(v(),P("div",E3,[I3,c("span",null,[k(" 車友修改資訊 "),(m=(h=n.overrideMeta)==null?void 0:h.updatedBy)!=null&&m.nickname||(g=(b=n.overrideMeta)==null?void 0:b.updatedBy)!=null&&g.id?(v(),P(ye,{key:0},[k(" · 由 "+w(n.overrideMeta.updatedBy.nickname||`匿名#${n.overrideMeta.updatedBy.id}`)+" 更新 ",1)],64)):j("",!0)])])):j("",!0),!n.isCommunity&&n.info.sourceLabel?(v(),P("div",B3,[S3,c("span",null,"資料來源 · "+w(n.info.sourceLabel),1)])):j("",!0),c("div",w3,[c("span",k3,w(n.info.parkingType),1),c("span",T3,w(Number(n.info.geometry[0]).toFixed(5))+", "+w(Number(n.info.geometry[1]).toFixed(5)),1)]),c("div",D3,[n.isCommunity?(v(),P("button",{key:0,class:"btn btn-outline btn-sm",onClick:r[2]||(r[2]=U=>t("editCommunity"))},[N3,k(" 編輯 ")])):(v(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:r[3]||(r[3]=U=>t("editOverride")),title:n.isOverridden?"修改車友提供的資訊 (不會變動官方資料)":"異議 / 補充官方資料 (不會變動官方資料)"},[R3,k(" "+w(n.isOverridden?"修改車友資訊":"異議 / 補充"),1)],8,M3)),c("button",{class:"btn btn-outline btn-sm",onClick:r[4]||(r[4]=U=>t("share")),title:"分享這個停車點"},[x3,k(" 分享 ")])]),c("div",O3,[n.isAndroid?j("",!0):(v(),P("button",{key:0,class:"btn btn-primary btn-sm",onClick:r[5]||(r[5]=U=>t("openMap","apple"))},[L3,k(" Apple Map ")])),c("button",{class:ie(["btn","btn-sm",n.isAndroid?"btn-primary":"btn-outline"]),onClick:r[6]||(r[6]=U=>t("openMap","google"))},[F3,k(" Google Map ")],2),n.hasRoute?j("",!0):(v(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:r[7]||(r[7]=U=>t("route"))},[H3,k(" 路線規劃 ")]))])],2)}}},V3=en(z3,[["__scopeId","data-v-e6db4a59"]]),Is=n=>(Sn("data-v-caf0ec6e"),n=n(),wn(),n),W3={class:"route-header"},j3=Is(()=>c("h3",null,[c("span",{class:"material-icons-outlined"},"alt_route"),k(" 路線 ")],-1)),G3=["aria-expanded"],K3={class:"material-icons-outlined"},Q3={key:0,class:"route-summary"},Y3={class:"route-summary-item"},X3=Is(()=>c("span",{class:"material-icons-outlined"},"schedule",-1)),J3={class:"route-summary-item"},q3=Is(()=>c("span",{class:"material-icons-outlined"},"straighten",-1)),$3={class:"route-profile",role:"tablist","aria-label":"交通方式"},Z3=["onClick","aria-pressed"],e5={class:"material-icons-outlined"},n5={class:"profile-label"},t5={key:1,class:"route-steps"},o5={__name:"RouteSteps",props:{routeData:Object,active:Boolean,profile:{type:String,default:"driving"}},emits:["cancel","update:profile"],setup(n,{emit:e}){const t=n,o=e,i=E(!0),s=()=>i.value=!i.value,r=[{value:"driving",label:"汽機車",icon:"directions_car"},{value:"cycling",label:"單車",icon:"directions_bike"},{value:"walking",label:"步行",icon:"directions_walk"}],l=ne(()=>{var h;const u=(h=t.routeData)==null?void 0:h.distance;return typeof u!="number"?"":u>=1e3?`${(u/1e3).toFixed(1)} km`:`${Math.round(u)} m`}),a=ne(()=>{var g;const u=(g=t.routeData)==null?void 0:g.duration;if(typeof u!="number")return"";const h=Math.round(u/60);if(h<60)return`${h} 分`;const m=Math.floor(h/60),b=h%60;return b?`${m} 時 ${b} 分`:`${m} 時`}),d=u=>o("update:profile",u);return(u,h)=>(v(),P("aside",{class:ie(["route-panel",{active:n.active}])},[c("header",W3,[j3,c("button",{class:"route-toggle",onClick:s,"aria-expanded":i.value},[c("span",K3,w(i.value?"expand_less":"expand_more"),1)],8,G3)]),n.routeData?(v(),P("div",Q3,[c("div",Y3,[X3,c("strong",null,w(a.value),1)]),c("div",J3,[q3,c("strong",null,w(l.value),1)])])):j("",!0),c("div",$3,[(v(),P(ye,null,Ge(r,m=>c("button",{key:m.value,class:ie(["profile-btn",{active:n.profile===m.value}]),onClick:b=>d(m.value),"aria-pressed":n.profile===m.value},[c("span",e5,w(m.icon),1),c("span",n5,w(m.label),1)],10,Z3)),64))]),n.routeData&&i.value?(v(),P("ol",t5,[(v(!0),P(ye,null,Ge(n.routeData.legs[0].steps,(m,b)=>(v(),P("li",{key:b,class:"route-step"},w(m.maneuver.instruction),1))),128))])):j("",!0),c("button",{class:"btn btn-danger btn-sm route-cancel",onClick:h[0]||(h[0]=m=>o("cancel"))}," 取消路線規劃 ")],2))}},i5=en(o5,[["__scopeId","data-v-caf0ec6e"]]);function s5(n,e,t=20,o=[]){const i=(e||"").trim().toLowerCase();if(!i)return[];const s=[];if(Array.isArray(n))for(const r of n)for(const l of r.features){const a=(l.properties.name||"").toLowerCase(),d=(l.properties.description||"").toLowerCase();if((a.includes(i)||d.includes(i))&&(s.push({groupName:r.name,name:l.properties.name,description:l.properties.description,icon:l.properties.icon,geometry:l.geometry.coordinates,properties:l.properties,isCommunity:!1,score:(a.includes(i)?1e3:0)-(a.indexOf(i)===-1?0:a.indexOf(i))}),s.length>500))break}if(Array.isArray(o))for(const r of o){const l=(r.name||"").toLowerCase(),a=(r.description||"").toLowerCase();if(!l.includes(i)&&!a.includes(i))continue;const d=Array.isArray(r.coordinates)?r.coordinates:[null,null];if(!(d[0]==null||d[1]==null)&&(s.push({groupName:"共筆停車點",name:r.name,description:r.description,icon:r.iconKey,geometry:d,properties:{name:r.name,description:r.description,icon:r.iconKey},isCommunity:!0,community:r,score:(l.includes(i)?900:0)-(l.indexOf(i)===-1?0:l.indexOf(i))}),s.length>500))break}return s.sort((r,l)=>l.score-r.score),s.slice(0,t)}const ka=n=>(Sn("data-v-2b0f75f6"),n=n(),wn(),n),r5={key:0,class:"search-results",role:"listbox"},l5=["aria-selected","onMouseenter","onClick"],a5=["src"],c5={class:"search-item-text"},d5={class:"search-item-name"},h5={class:"search-item-group"},u5={key:1,class:"search-empty"},p5={class:"search-box",role:"combobox","aria-expanded":"true"},m5=ka(()=>c("span",{class:"material-icons-outlined search-icon"},"search",-1)),f5=ka(()=>c("span",{class:"material-icons-outlined"},"close",-1)),y5=[f5],b5=["aria-label","aria-expanded"],g5={class:"material-icons-outlined"},A5={__name:"SearchBar",props:{mapDataList:Array,communityParkings:{type:Array,default:()=>[]}},emits:["select"],setup(n,{emit:e}){const t=n,o=e,i=E(!1),s=E(""),r=E(-1),l=ne(()=>s.value?s5(t.mapDataList,s.value,15,t.communityParkings):[]);J(s,()=>{r.value=-1});const a=()=>{i.value=!i.value,i.value||(s.value="")},d=()=>{i.value=!1,s.value=""},u=m=>{o("select",m),d()},h=m=>{if(l.value.length)if(m.key==="ArrowDown")m.preventDefault(),r.value=(r.value+1)%l.value.length;else if(m.key==="ArrowUp")m.preventDefault(),r.value=(r.value-1+l.value.length)%l.value.length;else if(m.key==="Enter"){m.preventDefault();const b=r.value>=0?r.value:0;u(l.value[b])}else m.key==="Escape"&&d()};return(m,b)=>(v(),P("div",{class:ie(["search-wrap",{open:i.value}])},[i.value&&l.value.length?(v(),P("ul",r5,[(v(!0),P(ye,null,Ge(l.value,(g,U)=>(v(),P("li",{key:U,class:ie(["search-item",{active:U===r.value}]),role:"option","aria-selected":U===r.value,onMouseenter:T=>r.value=U,onClick:T=>u(g)},[g.icon?(v(),P("img",{key:0,src:L(X)(g.icon),class:"search-item-icon",alt:""},null,8,a5)):j("",!0),c("div",c5,[c("div",d5,w(g.name),1),c("div",h5,w(g.groupName),1)])],42,l5))),128))])):i.value&&s.value&&!l.value.length?(v(),P("div",u5," 找不到「"+w(s.value)+"」相關停車場 ",1)):j("",!0),We(c("div",p5,[m5,We(c("input",{"onUpdate:modelValue":b[0]||(b[0]=g=>s.value=g),class:"search-input",type:"text",placeholder:"搜尋停車場名稱…",autofocus:"",onKeydown:h},null,544),[[It,s.value]]),s.value?(v(),P("button",{key:0,class:"search-clear",onClick:b[1]||(b[1]=g=>s.value=""),"aria-label":"清除"},y5)):j("",!0)],512),[[Et,i.value]]),c("button",{class:ie(["search-toggle",{active:i.value}]),onClick:a,"aria-label":i.value?"關閉搜尋":"開啟搜尋","aria-expanded":i.value},[c("span",g5,w(i.value?"close":"search"),1)],10,b5)],2))}},_5=en(A5,[["__scopeId","data-v-2b0f75f6"]]),Tn=n=>(Sn("data-v-8a26dac9"),n=n(),wn(),n),v5={class:"editor-body"},C5={key:0,class:"editor-note override-note"},P5=Tn(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),U5={key:1,class:"editor-note"},E5=Tn(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),I5={class:"form-group"},B5={class:"form-label"},S5={key:0},w5={key:1,class:"hint-inline"},k5=["readonly","disabled"],T5={class:"form-group"},D5=Tn(()=>c("label",{class:"form-label"},"類別",-1)),N5=["value"],M5={class:"form-group"},R5={class:"form-label"},x5={key:0,class:"hint-inline"},O5=["disabled"],L5=["value"],F5={class:"form-group"},H5=Tn(()=>c("label",{class:"form-label"},"收費",-1)),z5={class:"chip-row"},V5=["onClick"],W5={key:0,class:"price-amount"},j5={class:"unit"},G5={key:1,class:"price-amount"},K5={class:"form-group"},Q5=Tn(()=>c("label",{class:"form-label"},"說明(選填)",-1)),Y5={class:"form-group"},X5=Tn(()=>c("label",{class:"form-label"},"暱稱(選填)",-1)),J5=["value"],q5={key:2,class:"error-msg"},$5={key:3,class:"form-group history-section"},Z5={class:"form-label"},ep=Tn(()=>c("span",{class:"material-icons-outlined",style:{"font-size":"14px","vertical-align":"-2px"}},"history",-1)),np={class:"history-list"},tp={class:"h-row1"},op={class:"h-by"},ip={class:"h-time"},sp={key:0,class:"h-diff h-diff-note"},rp={key:1,class:"h-diff-list"},lp={class:"h-diff-label"},ap={class:"h-diff-old"},cp=Tn(()=>c("span",{class:"h-diff-arrow"},"→",-1)),dp={class:"h-diff-new"},hp={key:2,class:"h-diff h-diff-note"},up=["disabled"],pp=["disabled"],mp=["disabled"],fp=["disabled"],yp={__name:"CommunityParkingEditor",props:{open:Boolean,mode:{type:String,default:"add"},initial:{type:Object,default:null},defaultCoord:{type:Array,default:()=>[121.5173399,25.0475613]},nickname:{type:String,default:""},isOwner:{type:Boolean,default:!1},isAdmin:{type:Boolean,default:!1},submitting:{type:Boolean,default:!1},hasExistingOverride:{type:Boolean,default:!1},history:{type:Array,default:()=>[]}},emits:["update:open","update:nickname","submit","delete","reset"],setup(n,{emit:e}){const t=n,o=e,i=E(""),s=E(""),r=E("motorcycle"),l=E("friendly"),a=E("free"),d=E(""),u=E(""),h=E([null,null]),m=ne(()=>Gt.filter(C=>C.value)),b=ne(()=>Kt.filter(C=>C.value)),g={greenStar:"icon-14.png",friendlyShop:"icon-4.png",greenP:"icon-15.png",greyP:"icon-16.png",blueP:"icon-17.png",purpleP:"icon-18.png",redX:"icon-19.png",unknown:"icon-20.png"},U=ne(()=>{if(g[r.value])return g[r.value];const C=Gt.find(re=>re.value===r.value),M=Kt.find(re=>re.value===l.value);return C?M&&C.key.find(re=>M.key.includes(re))||C.key[0]:"icon-3.png"}),T=ne(()=>!!g[r.value]);function I(C){if(!C)return{type:"free",amount:"",custom:""};const M=C.trim();if(/^free$/i.test(M))return{type:"free",amount:"",custom:""};const B=M.match(/^(\d+(?:\.\d+)?)\s*\/\s*([hd])$/i);return B?{type:B[2].toLowerCase(),amount:B[1],custom:""}:{type:"custom",amount:"",custom:M}}function V(){return a.value==="free"?"Free":a.value==="custom"?u.value.trim():d.value?`${d.value}/${a.value}`:""}const D=()=>{if((t.mode==="edit"||t.mode==="override")&&t.initial){i.value=t.initial.name||"",s.value=t.initial.description||"",r.value=t.initial.category||"motorcycle",l.value=t.initial.friendliness||"friendly";const C=I(t.initial.priceInfo||"");a.value=C.type,d.value=C.amount,u.value=C.custom,h.value=t.initial.coordinates?[...t.initial.coordinates]:[...t.defaultCoord]}else i.value="",s.value="",r.value="motorcycle",l.value="friendly",a.value="free",d.value="",u.value="",h.value=[...t.defaultCoord]};J(()=>t.open,C=>{C&&D()});const W=E(""),Ee=()=>{if(W.value="",!i.value.trim()){W.value="請輸入名稱";return}if(h.value[0]==null||h.value[1]==null||Number.isNaN(Number(h.value[0]))||Number.isNaN(Number(h.value[1]))){W.value="座標無效";return}o("submit",{name:i.value,description:s.value,iconKey:U.value,category:r.value,friendliness:T.value?"":l.value,priceInfo:V(),coordinates:[Number(h.value[0]),Number(h.value[1])]})},ae=()=>{var C;(C=t.initial)!=null&&C.id&&window.confirm(`確定要刪除「${i.value}」?此動作無法復原。`)&&o("delete",t.initial.id)},Ie=()=>{window.confirm(`確定要重設「${i.value}」回官方原始資料嗎?
你和其他車友先前的修改將被移除。`)&&o("reset")},Ae=ne({get:()=>t.open,set:C=>o("update:open",C)}),de=[{value:"free",label:"免費"},{value:"h",label:"計時 / 小時"},{value:"d",label:"計次 / 天"},{value:"custom",label:"其他"}],oe=E(!1),ke=ne(()=>!t.history||t.history.length===0?[]:oe.value?t.history:t.history.slice(0,5)),Re={create:"新增",update:"修改",delete:"刪除",override:"覆寫",reset:"重設"};function Be(C){return Re[C]||C||"變更"}function _(C){return C?C.nickname||(C.id?`匿名#${C.id}`:"匿名"):"系統"}function N(C){if(!C||!isFinite(Number(C)))return"";const M=new Date(Number(C)),B=re=>String(re).padStart(2,"0");return`${M.getFullYear()}/${B(M.getMonth()+1)}/${B(M.getDate())} ${B(M.getHours())}:${B(M.getMinutes())}`}const G={name:"名稱",description:"說明",iconKey:"圖示",category:"類別",friendliness:"友善度",priceInfo:"收費",lng:"經度",lat:"緯度"};function q(C){if(C==null||C==="")return"(空)";if(typeof C=="number")return String(C);const M=String(C);return M.length>40?M.slice(0,40)+"…":M}function K(C){return C==null?"":typeof C=="string"?C.trim():String(C)}function Se(C){return K(C)===""}function xe(C,M){if(!C||C.action==="delete"||C.action==="reset")return[];if(C.after&&typeof C.after=="object")return Object.keys(C.after).filter(x=>{var Le;const O=(Le=C.before)==null?void 0:Le[x],ce=C.after[x];return!(Se(O)&&Se(ce)||K(O)===K(ce)||Se(O))}).map(x=>{var O;return{label:G[x]||x,before:q((O=C.before)==null?void 0:O[x]),after:q(C.after[x]),hasBefore:!0}});const B=C.snapshot;if(!B||typeof B!="object")return[];const re=new Set(["createdAt","createdBy","updatedAt","updatedBy","origName","origLng","origLat","history"]),Te=t.history.findIndex(he=>he._key===C._key),Oe=Te>=0?t.history[Te+1]:null,yn=Oe?Oe.after&&typeof Oe.after=="object"?{...Oe.before||{},...Oe.after}:Oe.snapshot||null:null,tn=[];for(const he of Object.keys(B)){if(re.has(he))continue;const x=B[he];if(yn&&Object.prototype.hasOwnProperty.call(yn,he)){const O=yn[he];if(K(O)===K(x)||Se(O))continue;tn.push({label:G[he]||he,before:q(O),after:q(x),hasBefore:!0})}}return tn}function nn(C){return(C==null?void 0:C.action)==="delete"?"該項目被刪除":(C==null?void 0:C.action)==="reset"?"重設為官方資料":(C==null?void 0:C.action)==="create"?"新增此停車點":""}return(C,M)=>(v(),Li(On,{modelValue:Ae.value,"onUpdate:modelValue":M[9]||(M[9]=B=>Ae.value=B),title:n.mode==="override"?"修改官方停車點":n.mode==="edit"?"編輯停車場":"新增停車場",size:"md"},{footer:ln(()=>[n.mode==="edit"&&n.isOwner?(v(),P("button",{key:0,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:ae}," 刪除 ",8,up)):j("",!0),n.mode==="override"&&n.hasExistingOverride&&n.isAdmin?(v(),P("button",{key:1,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:Ie,title:"僅站方可使用"}," 重設為官方資料 ",8,pp)):j("",!0),c("button",{class:"btn btn-outline",disabled:n.submitting,onClick:M[8]||(M[8]=B=>Ae.value=!1)}," 取消 ",8,mp),c("button",{class:"btn btn-primary",disabled:n.submitting,onClick:Ee},w(n.submitting?"送出中…":n.mode==="override"||n.mode==="edit"?"儲存修改":"新增"),9,fp)]),default:ln(()=>[c("div",v5,[n.mode==="override"?(v(),P("p",C5,[P5,k(" 你正在「修改官方停車點」:這層修改只會疊加在官方資料之上,不會覆蓋原始資料。所有車友都會看到你的修改,也可以再被其他人修改或重設。 ")])):(v(),P("p",U5,[E5,k(" 共筆停車點:任何人都可以新增或修改。請確認資訊正確、避免不雅內容。 ")])),c("section",I5,[c("label",B5,[k(" 名稱 "),n.mode!=="override"?(v(),P("span",S5,"*")):j("",!0),n.mode==="override"?(v(),P("span",w5,"(官方名稱不可修改)")):j("",!0)]),We(c("input",{"onUpdate:modelValue":M[0]||(M[0]=B=>i.value=B),class:"form-control",type:"text",placeholder:"例:三張里地下停車場",maxlength:"60",readonly:n.mode==="override",disabled:n.mode==="override"},null,8,k5),[[It,i.value]])]),c("section",T5,[D5,We(c("select",{"onUpdate:modelValue":M[1]||(M[1]=B=>r.value=B),class:"form-control"},[(v(!0),P(ye,null,Ge(m.value,B=>(v(),P("option",{key:B.value,value:B.value},w(B.name),9,N5))),128))],512),[[Os,r.value]])]),c("section",M5,[c("label",R5,[k(" 友善程度 "),T.value?(v(),P("span",x5,"(此類別不適用)")):j("",!0)]),We(c("select",{"onUpdate:modelValue":M[2]||(M[2]=B=>l.value=B),class:"form-control",disabled:T.value},[(v(!0),P(ye,null,Ge(b.value,B=>(v(),P("option",{key:B.value,value:B.value},w(B.name),9,L5))),128))],8,O5),[[Os,l.value]])]),c("section",F5,[H5,c("div",z5,[(v(),P(ye,null,Ge(de,B=>c("button",{key:B.value,type:"button",class:ie(["chip",{active:a.value===B.value}]),onClick:re=>a.value=B.value},w(B.label),11,V5)),64))]),a.value==="h"||a.value==="d"?(v(),P("div",W5,[We(c("input",{"onUpdate:modelValue":M[3]||(M[3]=B=>d.value=B),type:"number",min:"0",step:"1",class:"form-control compact",placeholder:"金額"},null,512),[[It,d.value]]),c("span",j5,"元 / "+w(a.value==="h"?"小時":"次"),1)])):a.value==="custom"?(v(),P("div",G5,[We(c("input",{"onUpdate:modelValue":M[4]||(M[4]=B=>u.value=B),type:"text",class:"form-control",placeholder:"如:平日 30/h、假日 50/d",maxlength:"40"},null,512),[[It,u.value]])])):j("",!0)]),c("section",K5,[Q5,We(c("textarea",{"onUpdate:modelValue":M[5]||(M[5]=B=>s.value=B),class:"form-control",rows:"3",placeholder:"後牌辨析、24h、注意事項...",maxlength:"500"},null,512),[[It,s.value]])]),c("section",Y5,[X5,c("input",{value:n.nickname,onInput:M[6]||(M[6]=B=>o("update:nickname",B.target.value)),class:"form-control",type:"text",placeholder:"留空將顯示「匿名#xxx-xxx」",maxlength:"20"},null,40,J5)]),W.value?(v(),P("p",q5,w(W.value),1)):j("",!0),n.history.length?(v(),P("section",$5,[c("label",Z5,[ep,k(" 修改紀錄 ("+w(n.history.length)+") ",1)]),c("ul",np,[(v(!0),P(ye,null,Ge(ke.value,(B,re)=>(v(),P("li",{key:B._key,class:"history-item"},[c("div",tp,[c("span",{class:ie(["h-action",`h-action-${B.action||"other"}`])},w(Be(B.action)),3),c("span",op,w(_(B.by)),1),c("span",ip,w(N(B.at)),1)]),nn(B)?(v(),P("div",sp,w(nn(B)),1)):xe(B,re).length?(v(),P("ul",rp,[(v(!0),P(ye,null,Ge(xe(B,re),(Te,Oe)=>(v(),P("li",{key:Oe,class:"h-diff-item"},[c("span",lp,w(Te.label),1),Te.hasBefore?(v(),P(ye,{key:0},[c("span",ap,w(Te.before),1),cp],64)):j("",!0),c("span",dp,w(Te.after),1)]))),128))])):(v(),P("div",hp,"(與上一筆相同)"))]))),128))]),n.history.length>5?(v(),P("button",{key:0,type:"button",class:"history-toggle",onClick:M[7]||(M[7]=B=>oe.value=!oe.value)},w(oe.value?"收起":`顯示全部 ${n.history.length} 筆`),1)):j("",!0)])):j("",!0)])]),_:1},8,["modelValue","title"]))}},bp=en(yp,[["__scopeId","data-v-8a26dac9"]]),gp={class:"tour-card-head"},Ap={class:"tour-step-index"},_p={class:"tour-title"},vp={key:0,class:"material-icons-outlined"},Cp={class:"tour-desc"},Pp={class:"tour-actions"},Up={key:0,class:"material-icons-outlined"},Ep={key:1,class:"material-icons-outlined"},gn=8,Ip=12,Or=300,oo=16,Bp={__name:"OnboardingTour",props:{active:{type:Boolean,default:!1},steps:{type:Array,required:!0}},emits:["update:active","finish"],setup(n,{emit:e}){const t=n,o=e,i=E(0),s=E(null),r=E(!1),l=ne(()=>t.steps[i.value]||null),a=ne(()=>i.value>=t.steps.length-1),d=async()=>{await Vr();const I=l.value;if(!I){s.value=null;return}const V=I.selector?document.querySelector(I.selector):null;if(!V){s.value=null;return}const D=V.getBoundingClientRect();if(D.width===0&&D.height===0){s.value=null;return}s.value={top:D.top,left:D.left,width:D.width,height:D.height}},u=async()=>{for(let I=0;I<8;I++){if(await d(),s.value)return;await new Promise(V=>setTimeout(V,150))}};J(()=>[t.active,i.value],async([I])=>{if(!I){r.value=!1;return}r.value=!1,await u(),r.value=!0},{immediate:!0});const h=()=>d();Gn(()=>{window.addEventListener("resize",h),window.addEventListener("scroll",h,!0)}),ht(()=>{window.removeEventListener("resize",h),window.removeEventListener("scroll",h,!0)});const m=ne(()=>{const I=s.value;return I?{top:I.top-gn+"px",left:I.left-gn+"px",width:I.width+gn*2+"px",height:I.height+gn*2+"px",borderRadius:Ip+"px"}:{display:"none"}}),b=ne(()=>{var oe;const I=s.value,V=window.innerWidth,D=window.innerHeight;if(!I)return{top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:Math.min(Or,V-32)+"px"};const W=((oe=l.value)==null?void 0:oe.placement)||"auto";let Ee=W;if(W==="auto"){const ke=D-(I.top+I.height),Re=I.top;Ee=ke>=Re?"bottom":"top"}const ae=Math.min(Or,V-32);let Ie,Ae,de="";return Ee==="bottom"?(Ie=I.top+I.height+oo+gn,Ae=Math.max(16,Math.min(V-ae-16,I.left+I.width/2-ae/2))):Ee==="top"?(Ie=I.top-oo-gn,Ae=Math.max(16,Math.min(V-ae-16,I.left+I.width/2-ae/2)),de="translateY(-100%)"):Ee==="right"?(Ie=Math.max(16,I.top+I.height/2),Ae=I.left+I.width+oo+gn,de="translateY(-50%)"):(Ie=Math.max(16,I.top+I.height/2),Ae=I.left-oo-gn,de="translate(-100%, -50%)"),{top:Ie+"px",left:Ae+"px",width:ae+"px",transform:de}}),g=()=>{a.value?T():i.value+=1},U=()=>T(),T=()=>{o("update:active",!1),o("finish"),i.value=0};return J(()=>t.active,I=>{I&&(i.value=0)}),(I,V)=>n.active&&l.value?(v(),P("div",{key:0,class:ie(["tour-root",{"is-ready":r.value}])},[c("div",{class:"tour-spotlight",style:co(m.value)},null,4),c("div",{class:"tour-backdrop",onClick:Fi(g,["self"])}),c("div",{class:"tour-card",style:co(b.value),role:"dialog","aria-modal":"true"},[c("div",gp,[c("span",Ap,w(i.value+1)+" / "+w(n.steps.length),1),c("button",{class:"tour-skip",onClick:U,"aria-label":"略過導覽"},"略過")]),c("h3",_p,[l.value.icon?(v(),P("span",vp,w(l.value.icon),1)):j("",!0),k(" "+w(l.value.title),1)]),c("p",Cp,w(l.value.description),1),c("div",Pp,[c("button",{class:"btn btn-primary tour-next",onClick:g},[k(w(a.value?"完成":"下一步")+" ",1),a.value?(v(),P("span",Ep,"check")):(v(),P("span",Up,"arrow_forward"))])])],4)],2)):j("",!0)}},Sp=en(Bp,[["__scopeId","data-v-1d730a34"]]),_n="community_parkings",Mi=E([]),Ta=E(!1),Ri=E(null);let Mt=null,li=0;function wp(){if(!(!an||Mt))try{const n=jh(Ye(je,_n),Wh("updatedAt"));Mt=n,Ia(n,e=>{const t=[];e.forEach(o=>{var s,r;const i=o.val()||{};t.push({id:o.key,name:i.name||"",description:i.description||"",iconKey:i.iconKey||"icon-3.png",category:i.category||"",friendliness:i.friendliness||"",priceInfo:i.priceInfo||"",coordinates:[(s=i.lng)!=null?s:null,(r=i.lat)!=null?r:null],createdBy:i.createdBy||null,updatedBy:i.updatedBy||null,createdAt:i.createdAt||null,updatedAt:i.updatedAt||null,history:Tp(i.history)})}),Mi.value=t.reverse(),Ta.value=!0},e=>{Ri.value=e})}catch(n){Ri.value=n}}function kp(){Mt&&(Ba(Mt),Mt=null)}function Tp(n){return!n||typeof n!="object"?[]:Object.entries(n).map(([e,t])=>({...t||{},_key:e})).sort((e,t)=>e._key<t._key?1:e._key>t._key?-1:0)}function Dp(){return Gn(()=>{li+=1,wp()}),ht(()=>{li-=1,li<=0&&kp()}),{items:Mi,ready:Ta,error:Ri,addParking:async(o,i)=>{var m,b,g;if(!an)throw new Error("Firebase 尚未設定");const[s,r]=o.coordinates,a=so(Ye(je,_n)).key,d={id:i.id,nickname:i.nickname||""},u={name:((m=o.name)==null?void 0:m.trim())||"",description:((b=o.description)==null?void 0:b.trim())||"",iconKey:o.iconKey||"icon-3.png",category:o.category||"",friendliness:o.friendliness||"",priceInfo:((g=o.priceInfo)==null?void 0:g.trim())||"",lng:Number(s),lat:Number(r),createdBy:d,createdAt:Ln(),updatedBy:d,updatedAt:Ln()},h=so(Ye(je,`${_n}/${a}/history`)).key;return await ki(Ye(je),{[`${_n}/${a}`]:{...u,history:{[h]:{action:"create",at:Ln(),by:d,snapshot:u}}}}),a},updateParking:async(o,i,s)=>{var g,U,T,I,V;if(!an)throw new Error("Firebase 尚未設定");const r={id:s.id,nickname:s.nickname||""},l=Mi.value.find(D=>D.id===o)||{},a={};if(i.name!==void 0&&(a.name=((g=i.name)==null?void 0:g.trim())||""),i.description!==void 0&&(a.description=((U=i.description)==null?void 0:U.trim())||""),i.iconKey!==void 0&&(a.iconKey=i.iconKey),i.category!==void 0&&(a.category=i.category),i.friendliness!==void 0&&(a.friendliness=i.friendliness),i.priceInfo!==void 0&&(a.priceInfo=((T=i.priceInfo)==null?void 0:T.trim())||""),i.coordinates){const[D,W]=i.coordinates;a.lng=Number(D),a.lat=Number(W)}const d={},u={};for(const D of Object.keys(a)){let W;D==="lng"?W=(I=l.coordinates)==null?void 0:I[0]:D==="lat"?W=(V=l.coordinates)==null?void 0:V[1]:W=l[D];const Ee=W==null?"":W,ae=a[D]===void 0||a[D]===null?"":a[D];Ee!==ae&&(d[D]=W!=null?W:"",u[D]=a[D])}const h={...a,updatedBy:r,updatedAt:Ln()},m=so(Ye(je,`${_n}/${o}/history`)).key,b={};for(const D of Object.keys(h))b[`${_n}/${o}/${D}`]=h[D];return b[`${_n}/${o}/history/${m}`]={action:"update",at:Ln(),by:r,before:d,after:u},ki(Ye(je),b)},deleteParking:async o=>{if(!an)throw new Error("Firebase 尚未設定");return Ea(Ye(je,`${_n}/${o}`))}}}var Np={VITE_FIREBASE_DATABASE_URL:"https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app",VITE_FIREBASE_MESSAGING_SENDER_ID:"976769533420",VITE_FIREBASE_MEASUREMENT_ID:"G-XMR8C87T1P",VITE_FIREBASE_STORAGE_BUCKET:"findparkinglot-2519e.firebasestorage.app",VITE_FIREBASE_AUTH_DOMAIN:"findparkinglot-2519e.firebaseapp.com",VITE_MAPBOX_TOKEN:"pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",VITE_FIREBASE_PROJECT_ID:"findparkinglot-2519e",VITE_FIREBASE_APP_ID:"1:976769533420:web:f3108318b3def30017acc9",VITE_FIREBASE_API_KEY:"AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs",BASE_URL:"./",MODE:"production",DEV:!1,PROD:!0,SSR:!1};const Da="community_user_id",Na="community_user_nickname",Mp="community_is_admin",Rp=String(Np.VITE_ADMIN_USER_IDS||"").split(",").map(n=>n.trim()).filter(Boolean);function xp(){const n=e=>Array.from(crypto.getRandomValues(new Uint8Array(e))).map(t=>t.toString(16).padStart(2,"0")).join("");return`${n(2)}-${n(2)}`}let ao=Je.get(Da);ao||(ao=xp(),Je.set(Da,ao));const xi=ao,Oi=E(Je.get(Na)||""),Op=Rp.includes(xi)||Je.get(Mp)==="1";J(Oi,n=>Je.set(Na,n||""));function Lp(){return{userId:xi,nickname:Oi,displayName:()=>{var e;return((e=Oi.value)==null?void 0:e.trim())||`匿名#${xi}`},isAdmin:Op}}const Fp=()=>typeof window!="undefined"&&typeof window.gtag=="function",ve=(n,e={})=>{if(Fp())try{window.gtag("event",n,e)}catch(t){}},S=n=>(Sn("data-v-e919e563"),n=n(),wn(),n),Hp={class:"app-title"},zp=["aria-label","aria-expanded"],Vp={class:"material-icons-outlined"},Wp={key:1,class:"title-logo",src:Hi,alt:"重機能停哪"},jp=S(()=>c("h1",null,"重機能停哪?",-1)),Gp=S(()=>c("pre",{id:"coordinates",class:"coordinates"},null,-1)),Kp=S(()=>c("h4",{class:"modal-section-title"},"圖案代表甚麼格位",-1)),Qp={class:"legend-list"},Yp={class:"legend-row"},Xp=["src"],Jp={class:"legend-row"},qp=["src"],$p={class:"legend-row"},Zp=["src"],em={class:"legend-row"},nm=["src"],tm={class:"legend-row"},om=["src"],im={class:"legend-row"},sm=["src"],rm={class:"legend-row"},lm=["src"],am={class:"legend-row"},cm=["src"],dm={class:"legend-row"},hm=["src"],um={class:"legend-row"},pm=["src"],mm={class:"legend-row"},fm=["src"],ym=S(()=>c("h4",{class:"modal-section-title"},"顏色代表入場方式",-1)),bm={class:"legend-list"},gm={class:"legend-row"},Am=["src"],_m=["src"],vm=["src"],Cm={class:"legend-row"},Pm=["src"],Um=["src"],Em=["src"],Im={class:"legend-row"},Bm=["src"],Sm=["src"],wm=["src"],km={class:"legend-row"},Tm=["src"],Dm=["src"],Nm=["src"],Mm=S(()=>c("h4",{class:"modal-section-title"},"名稱前有價錢",-1)),Rm={class:"legend-list"},xm={class:"legend-row"},Om=["src"],Lm=S(()=>c("div",{class:"legend-row"},[c("div",{class:"legend-text"},[k(" ・數字:金額,時段費率複雜會以最高收費標示"),c("br"),k(" ・d/h:d 為計次,h 為計時"),c("br"),k(" ・Free 代表免費 ")])],-1)),Fm={class:"share-grid"},Hm=S(()=>c("img",{src:jr,alt:""},null,-1)),zm=S(()=>c("span",null,"Facebook",-1)),Vm=[Hm,zm],Wm=S(()=>c("img",{src:Gr,alt:""},null,-1)),jm=S(()=>c("span",null,"LINE",-1)),Gm=[Wm,jm],Km=S(()=>c("img",{src:Kr,alt:""},null,-1)),Qm=S(()=>c("span",null,"Twitter",-1)),Ym=[Km,Qm],Xm=S(()=>c("img",{src:Qr,alt:""},null,-1)),Jm=S(()=>c("span",null,"複製連結",-1)),qm=[Xm,Jm],$m={class:"modal-hint",style:{"word-break":"break-all"}},Zm={class:"share-grid"},e4=S(()=>c("img",{src:jr,alt:""},null,-1)),n4=S(()=>c("span",null,"Facebook",-1)),t4=[e4,n4],o4=S(()=>c("img",{src:Gr,alt:""},null,-1)),i4=S(()=>c("span",null,"LINE",-1)),s4=[o4,i4],r4=S(()=>c("img",{src:Kr,alt:""},null,-1)),l4=S(()=>c("span",null,"Twitter",-1)),a4=[r4,l4],c4=S(()=>c("img",{src:Qr,alt:""},null,-1)),d4=S(()=>c("span",null,"複製連結",-1)),h4=[c4,d4],u4={class:"os-tabs",role:"tablist","aria-label":"作業系統"},p4=["aria-selected"],m4=S(()=>c("span",{class:"material-icons-outlined"},"phone_iphone",-1)),f4=["aria-selected"],y4=S(()=>c("span",{class:"material-icons-outlined"},"android",-1)),b4=S(()=>c("p",{class:"modal-hint"},"以下以 iOS Safari 為範例",-1)),g4=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Safari 開啟網站並點擊下方分享按鈕",-1)),A4=S(()=>c("img",{class:"full-img",src:ac,alt:""},null,-1)),_4=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「加入主畫面」",-1)),v4=S(()=>c("img",{class:"full-img",src:cc,alt:""},null,-1)),C4=S(()=>c("h4",{class:"modal-section-title"},"3. 確認名稱後按「加入」",-1)),P4=S(()=>c("img",{class:"full-img",src:dc,alt:""},null,-1)),U4=S(()=>c("h4",{class:"modal-section-title"},"4. 完成,圖示已加到主畫面",-1)),E4=S(()=>c("img",{class:"full-img",src:hc,alt:""},null,-1)),I4=S(()=>c("h4",{class:"modal-section-title"},"5. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),B4=S(()=>c("img",{class:"full-img",src:uc,alt:""},null,-1)),S4=S(()=>c("p",{class:"modal-hint"},"以下以 Android Chrome 為範例",-1)),w4=S(()=>c("h4",{class:"modal-section-title"},"1. 使用 Chrome 開啟網站並點擊右上角選單，點選「加到主畫面」",-1)),k4=S(()=>c("img",{class:"full-img",src:pc,alt:""},null,-1)),T4=S(()=>c("h4",{class:"modal-section-title"},"2. 點選「安裝」",-1)),D4=S(()=>c("img",{class:"full-img",src:mc,alt:""},null,-1)),N4=S(()=>c("h4",{class:"modal-section-title"},"3. 完成,圖示已加到主畫面",-1)),M4=S(()=>c("img",{class:"full-img",src:fc,alt:""},null,-1)),R4=S(()=>c("h4",{class:"modal-section-title"},"4. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),x4=S(()=>c("img",{class:"full-img",src:yc,alt:""},null,-1)),O4=S(()=>c("div",{class:"welcome-logo-wrap"},[c("img",{class:"welcome-logo",src:Hi,alt:"重機能停哪"})],-1)),L4=S(()=>c("div",{class:"welcome-badge"},"✨ 全新介面上線",-1)),F4=S(()=>c("p",{class:"welcome-text"}," 這是一個提供重機停車資訊的地圖，你可以依據「友善程度」「停車格類型」「收費範圍」尋找合適的停車場，並一鍵開啟 Google 或 Apple Map 導航。 ",-1)),H4=S(()=>c("div",{class:"whatsnew-card"},[c("div",{class:"whatsnew-title"},[c("span",{class:"material-icons-outlined"},"auto_awesome"),k(" 本次新功能 ")]),c("ul",{class:"whatsnew-list"},[c("li",null,[c("span",{class:"material-icons-outlined"},"star"),c("span",null,[c("strong",null,"我的最愛"),c("br"),k(" 可以將喜歡的停車場加入我的最愛")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"search"),c("span",null,[c("strong",null,"地點搜尋"),c("br"),k(" 可以搜尋指定的停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_location_alt"),c("span",null,[c("strong",null,"共筆停車點"),c("br"),k(" 可自由新增、編輯, 大家一起分享停車地點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"edit_note"),c("span",null,[c("strong",null,"官方點異議 / 補充"),c("br"),k(" 點開任一官方停車點 → 「異議 / 補充」, 可在不改動原始資料的前提下, 補上實際費率、更正分類或加註說明, 全車友共享")])])])],-1)),z4=S(()=>c("p",{class:"welcome-text"},[k(" 資料取源於: "),c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"link"},"Alan大重停車記事"),k("，如有停車場相關問題請至該頁面填寫回報表單。 ")],-1)),V4=S(()=>c("p",{class:"welcome-text"},' 公告: 原始資料"大重停車記事已無更新" 已改由 Alan大重停車記事 提供，感謝Alan的辛苦整理與分享！ ',-1)),W4=S(()=>c("p",{class:"welcome-text"},[k(" 本站僅提供資料整合服務，地圖免費提供車友使用，資料不定期更新；若發生無法使用情況，請至 "),c("a",{href:"https://forms.gle/iJCyfqVtpL35WtZM7",target:"_blank",rel:"noopener",class:"link"},"錯誤資訊回報"),k("，也歡迎 "),c("a",{href:"https://buymeacoffee.com/jamestim923",target:"_blank",rel:"noopener",class:"link"},"請我喝杯咖啡 ☕️"),k("讓我有動力繼續更新。 ")],-1)),j4=S(()=>c("p",{class:"welcome-text right"},"— by 爽爽",-1)),G4={key:0,class:"pick-crosshair","aria-hidden":"true"},K4=S(()=>c("span",{class:"material-icons-outlined dot"},"gps_fixed",-1)),Q4=[K4],Y4={key:1,class:"pick-banner"},X4=S(()=>c("span",{class:"pick-banner-text"},[c("span",{class:"material-icons-outlined"},"touch_app"),k(" 拖動地圖，將十字線對準目標位置 ")],-1)),J4=S(()=>c("span",{class:"material-icons-outlined"},"check",-1)),q4=S(()=>c("p",{class:"welcome-text"},[c("strong",{style:{color:"var(--primary)"}},"這是一個公開共享的「共筆停車點」區。"),k(" 除了官方收錄的「大重停車記事」資料外,任何人都可以新增、修改、補充停車位置——不需要註冊、不需要審核。 ")],-1)),$4=S(()=>c("h4",{class:"modal-section-title"},"如何新增停車位置",-1)),Z4=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"點左下角的「共筆停車點」按鈕,再點「新增停車位置」"),c("li",null,"畫面中心會出現青色十字游標,拖動地圖將游標對準目標位置"),c("li",null,"按頂部「使用此位置」,填寫名稱、類別、友善程度、收費等資料"),c("li",null,"按「新增」即完成(座標已自動記錄,圖示會依類別自動套用)")],-1)),ef=S(()=>c("h4",{class:"modal-section-title"},"如何編輯他人新增的位置",-1)),nf=S(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"地圖上「薰衣草紫色底」的標記即為使用者新增的「共筆停車點」"),c("li",null,"點擊該標記,在資訊面板按「編輯」"),c("li",null,"修改後按「儲存修改」")],-1)),tf=S(()=>c("h4",{class:"modal-section-title"},"注意事項",-1)),of=S(()=>c("ul",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"請確認資訊正確,避免造成他人困擾"),c("li",null,"不要新增不雅、惡意或無關內容"),c("li",null,"暱稱可選填,留空將顯示為「匿名#xxx-xxx」"),c("li",null,"站方保留必要時清空所有「共筆停車點」資料的權利")],-1)),Lr="onboarding_tour_v1",Fr="filters_v1",sf="https://findparkinglot.github.io/",rf={__name:"App",setup(n){var Ts,Ds,Ns;const e=navigator.userAgent,t=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(e),o=/iPhone|iPad|iPod/i.test(e),i=/Android/i.test(e),s=E([]),r=()=>{var p;return!!((p=window.matchMedia)!=null&&p.call(window,"(prefers-color-scheme: light)").matches)},l=p=>{var f;if(p==="system"){const y=r()?"light":"dark";return(f=nt.find(pe=>pe.theme===y))==null?void 0:f.value}return p},a=nt.find(p=>p.name===Je.get("mapStyles")),d=(a==null?void 0:a.value)||((Ts=nt.find(p=>p.theme==="dark"))==null?void 0:Ts.value),u=E(d),h=E({getLngLat:!1,mapStylesSelected:l(d)}),m=p=>{const f=l(p);h.value.mapStylesSelected=f;const y=nt.find(ue=>ue.value===f),pe=(y==null?void 0:y.theme)==="light";document.body.classList.toggle("light-theme",pe),document.body.classList.toggle("dark-theme",!pe);const ze=nt.find(ue=>ue.value===p);ze&&Je.set("mapStyles",ze.name)};m(u.value),J(u,m);const b=(Ds=window.matchMedia)==null?void 0:Ds.call(window,"(prefers-color-scheme: light)");(Ns=b==null?void 0:b.addEventListener)==null||Ns.call(b,"change",()=>{u.value==="system"&&m("system")});const g=E(!0),U=E(!1),T=E(i?"android":"ios"),I=E(!1),V=E(!1),D=E(!1),W=E(!1),Ee=[{selector:".mapboxgl-ctrl-geolocate",icon:"my_location",title:"定位你的位置",description:"點右上角的定位按鈕,地圖會自動移到你目前位置,並追蹤方向。"},{selector:".fab-placement-right > .fab-main",icon:"help_outline",title:"功能與教學",description:"右下角的圓形按鈕展開後,可看到「地圖怎麼看」、「加到手機桌面」、「分享」等功能。"},{selector:".search-toggle",icon:"search",title:"搜尋停車點",description:"右下角的搜尋按鈕可依名稱快速找到想去的停車場,點選結果會自動飛到該位置並開啟資訊。"},{selector:".app-title .title-toggle",icon:"menu",title:"篩選與我的最愛",description:"左上角選單可以調整停車類型、友善程度、收費範圍,以及只顯示我的最愛、切換主題。"},{selector:".fab-placement-left > .fab-main",icon:"add_location_alt",title:"共筆停車點",description:"左下角按鈕可新增/編輯共筆停車點,大家一起分享真實的停車資訊。"}],ae=()=>{W.value=!0,ve("onboarding_tour_start")},Ie=()=>{try{localStorage.setItem(Lr,"1")}catch(p){}ve("onboarding_tour_finish")},Ae=()=>{g.value=!1};J(g,(p,f)=>{if(f&&!p)try{localStorage.getItem(Lr)||setTimeout(ae,350)}catch(y){}});const de=E(!1),oe=E(!1),ke=E(!1),Re=p=>{p!=="menu"&&(de.value=!1),p!=="info"&&(oe.value=!1),p!=="message"&&(g.value=!1),p!=="mobileFAQ"&&(U.value=!1),p!=="faq"&&(I.value=!1),p!=="share"&&(V.value=!1),p!=="communityHelp"&&(D.value=!1),ve("panel_open",{panel:p})};J(de,p=>p&&Re("menu")),J(oe,p=>p&&Re("info")),J(g,p=>p&&Re("message")),J(U,p=>p&&Re("mobileFAQ")),J(U,p=>{p&&(i?T.value="android":o&&(T.value="ios"))}),J(I,p=>p&&Re("faq")),J(V,p=>p&&Re("share")),J(D,p=>p&&Re("communityHelp"));const Be=Je.getJSON(Fr,{})||{},_=E(typeof Be.parkingType=="string"?Be.parkingType:""),N=E(typeof Be.degreeOfFriendliness=="string"?Be.degreeOfFriendliness:""),G=E(typeof Be.parkingPriceType=="string"?Be.parkingPriceType:""),q=E(typeof Be.priceRangeMin=="number"?Be.priceRangeMin:0),K=E(typeof Be.priceRangeMax=="number"?Be.priceRangeMax:100),{favorites:Se,favoriteIdSet:xe,isFavorite:nn,toggleFavorite:C}=ed(),M=E(Be.onlyFavorites===!0);J([_,N,G,q,K,M],([p,f,y,pe,ze,ue])=>{Je.setJSON(Fr,{parkingType:p,degreeOfFriendliness:f,parkingPriceType:y,priceRangeMin:pe,priceRangeMax:ze,onlyFavorites:ue})});const B=E("driving"),{items:re,addParking:Te,updateParking:Oe,deleteParking:yn}=Dp(),{userId:tn,nickname:he,isAdmin:x}=Lp(),O=E(null),{overrides:ce,getOverride:Le,getOverrideHistory:Fe,upsertOverride:_e,resetOverride:Dn}=ru(),on=ne(()=>new Set(Object.keys(ce.value||{}))),De=E(!1),sn=E("add"),rn=E(null),dn=E(!1),yt=E([121.5173399,25.0475613]),Bs=E(!1),Ma=ne(()=>{var p;if(!De.value)return[];if(sn.value==="override")return Ve.value?Fe(Ve.value.name,Ve.value.geometry):[];if(sn.value==="edit"&&((p=rn.value)!=null&&p.id)){const f=(re.value||[]).find(y=>y.id===rn.value.id);return(f==null?void 0:f.history)||[]}return[]}),hn=E(!1),He=E(null),Ra=()=>{if(!an){alert("「共筆停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}hn.value=!0,ve("community_add_start")},xa=()=>{var f,y;const p=((y=(f=O.value)==null?void 0:f.getCenter)==null?void 0:y.call(f))||[121.5173399,25.0475613];yt.value=p,sn.value="add",rn.value=null,hn.value=!1,De.value=!0},Oa=()=>{hn.value=!1},La=p=>{var f,y;yt.value=p.coordinates?[...p.coordinates]:((y=(f=O.value)==null?void 0:f.getCenter)==null?void 0:y.call(f))||[121.5173399,25.0475613],sn.value="edit",rn.value=p,De.value=!0},Wo=p=>{He.value=p,Jn({name:"共筆停車點",properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.coordinates,address:""})},Fa=()=>{He.value&&(oe.value=!1,La(He.value))},Ha=()=>{if(!an){alert("「修改官方停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}if(!Ve.value)return;const p=Ve.value,f=Zt.value,y={id:null,name:p.name,description:(f==null?void 0:f.description)||p.description,iconKey:(f==null?void 0:f.iconKey)||p.iconKey,category:(f==null?void 0:f.category)||za(p.iconKey),friendliness:(f==null?void 0:f.friendliness)||Va(p.iconKey),priceInfo:(f==null?void 0:f.priceInfo)||p.priceInfo,coordinates:p.geometry?[...p.geometry]:[...yt.value]};yt.value=y.coordinates,sn.value="override",rn.value=y,Bs.value=!!f,oe.value=!1,De.value=!0,ve("override_edit_start",{name:p.name})};function za(p){if(!p)return"motorcycle";const f=Gt.find(y=>y.value&&y.key.includes(p));return(f==null?void 0:f.value)||"motorcycle"}function Va(p){if(!p)return"friendly";const f=Kt.find(y=>y.value&&y.key.includes(p));return(f==null?void 0:f.value)||"friendly"}const Wa=async p=>{if(Ve.value){dn.value=!0;try{const f={id:tn,nickname:he.value};await _e(Ve.value,p,f),ve("override_submit",{name:Ve.value.name});const y=Ve.value;De.value=!1,Jn({name:y.parkingType,properties:{name:y.name,description:y.description,icon:y.iconKey,priceInfo:y.priceInfo,priceArray:[]},geometry:y.geometry,address:$.value.address})}catch(f){alert("儲存失敗:"+((f==null?void 0:f.message)||f))}finally{dn.value=!1}}},ja=async()=>{if(Ve.value){dn.value=!0;try{const p=Ve.value,f={id:tn,nickname:he.value};await Dn(p.name,p.geometry,f),ve("override_reset",{name:p.name}),De.value=!1,Jn({name:p.parkingType,properties:{name:p.name,description:p.description,icon:p.iconKey,priceInfo:p.priceInfo,priceArray:[]},geometry:p.geometry,address:$.value.address})}catch(p){alert("重設失敗:"+((p==null?void 0:p.message)||p))}finally{dn.value=!1}}},Ga=async p=>{var f;dn.value=!0;try{const y={id:tn,nickname:he.value};sn.value==="edit"&&((f=rn.value)!=null&&f.id)?(await Oe(rn.value.id,p,y),ve("community_edit_submit",{name:p==null?void 0:p.name})):(await Te(p,y),ve("community_add_submit",{name:p==null?void 0:p.name})),De.value=!1,He.value=null}catch(y){alert("儲存失敗:"+((y==null?void 0:y.message)||y))}finally{dn.value=!1}},Ka=async p=>{dn.value=!0;try{const f={id:tn,nickname:he.value};await yn(p,f),ve("community_delete",{id:p}),De.value=!1,He.value=null}catch(f){alert("刪除失敗:"+((f==null?void 0:f.message)||f))}finally{dn.value=!1}},jo=ne(()=>{var f,y;if(!He.value||!$.value.parkingName)return!1;const p=He.value;return p.name===$.value.parkingName&&Array.isArray($.value.geometry)&&((f=p.coordinates)==null?void 0:f[0])===$.value.geometry[0]&&((y=p.coordinates)==null?void 0:y[1])===$.value.geometry[1]});J(oe,p=>{p||(He.value=null)});const bt=E(null),Qa=ne(()=>{var p;return((p=Gt.find(f=>f.value===_.value))==null?void 0:p.key)||[]}),Ya=ne(()=>{var p;return((p=Kt.find(f=>f.value===N.value))==null?void 0:p.key)||[]}),$=E({parkingName:"",parkingNameDes:"",parkingType:"",parkingIcon:"",parkingIconKey:"",priceInfo:"",geometry:[null,null],address:"",sourceLabel:""}),Ve=E(null),Zt=E(null),Ss=ne(()=>ai($.value.parkingName,$.value.geometry)),ws=ne(()=>nn(Ss.value)),Jn=p=>{var $n,Zn,Ms,Rs,xs;const f=p.properties.icon,y={name:p.properties.name,description:p.properties.description,iconKey:f,priceInfo:p.properties.priceInfo||"",geometry:p.geometry,parkingType:p.name},pe=!!(He.value&&He.value.name===p.properties.name&&Array.isArray(p.geometry)&&(($n=He.value.coordinates)==null?void 0:$n[0])===p.geometry[0]&&((Zn=He.value.coordinates)==null?void 0:Zn[1])===p.geometry[1]);let ze=null,ue=y;pe||(ze=Le(y.name,y.geometry),ze&&(ue=wa(y,ze))),Ve.value=pe?null:y,Zt.value=ze,$.value={parkingName:ue.name,parkingNameDes:ue.description,parkingType:y.parkingType,parkingIcon:X(ue.iconKey),parkingIconKey:ue.iconKey,priceInfo:ue.priceInfo||"",geometry:p.geometry,address:p.address,sourceLabel:pe?"":Gc((Ms=p.properties)==null?void 0:Ms.sourceFolderIndex)},oe.value=!0,ve("parking_view",{parking_name:(Rs=p.properties)==null?void 0:Rs.name,parking_type:p.name,icon:(xs=p.properties)==null?void 0:xs.icon,overridden:!!ze})},Xa=()=>{if(!$.value.parkingName)return;const p=!ws.value;C({id:Ss.value,name:$.value.parkingName,parkingType:$.value.parkingType,geometry:$.value.geometry,address:$.value.address,icon:$.value.parkingIconKey}),ve(p?"favorite_add":"favorite_remove",{parking_name:$.value.parkingName,parking_type:$.value.parkingType})},Ja=p=>"",qa=p=>{var f;p.isCommunity&&p.community?Wo(p.community):Jn({name:p.groupName,properties:p.properties,geometry:p.geometry,address:Ja(p.geometry)}),bt.value=[...p.geometry],ve("search_select",{parking_name:(f=p.properties)==null?void 0:f.name,group:p.groupName,community:!!p.isCommunity})},gt=E(null),At=E(null),$a=p=>{B.value="driving",gt.value=p,oe.value=!1,At.value=null,ve("route_start",{parking_name:$.value.parkingName,profile:"driving"})},Za=()=>{gt.value=null,ke.value=!1};J(At,p=>{ke.value=p!==null});const ec=p=>{const f=$.value.geometry;let y="";p==="apple"?y=`https://maps.apple.com/?daddr=${f[1]},${f[0]}&dirflg=d&t=m`:p==="google"&&(y=`https://www.google.com/maps/dir/?api=1&destination=${f[1]},${f[0]}&travelmode=driving`),y&&(ve("open_external_map",{provider:p,parking_name:$.value.parkingName}),window.open(y,"_blank","noopener,noreferrer"))},bn=(p,f=null)=>{const y=f||"https://findparkinglot.github.io/";let pe="";p==="facebook"?pe=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(y)}`:p==="line"?pe=`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(y)}`:p==="twitter"&&(pe=`https://twitter.com/share?url=${encodeURIComponent(y)}`),ve("share",{method:p,scope:f?"spot":"site"}),p==="link"?navigator.clipboard.writeText(y).then(()=>alert("已複製連結"),()=>alert("複製失敗")):window.open(pe,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},ks=()=>{const p=$.value.geometry;if(!Array.isArray(p)||p[0]==null||p[1]==null)return"";const f=new URLSearchParams({lng:Number(p[0]).toFixed(6),lat:Number(p[1]).toFixed(6)});return`${sf}?${f.toString()}`},nc=()=>{const p=ks();p&&(qn.value=p,Ko.value=$.value.parkingName||"停車點",Go.value=!0,ve("share_spot_open",{name:Ko.value}))},Go=E(!1),qn=E(""),Ko=E("");J([oe,$],()=>{try{if(!oe.value){window.location.search&&window.history.replaceState({},"",window.location.pathname);return}const p=ks();if(!p)return;const f=p.slice(p.indexOf("?"));window.history.replaceState({},"",window.location.pathname+f)}catch(p){}},{deep:!0});const _t=E(null),eo=(p,f)=>Math.abs(Number(p)-Number(f))<1e-5,Qo=()=>{var ze;const p=_t.value;if(!p)return;const f=Number(p.lng),y=Number(p.lat);if(!isFinite(f)||!isFinite(y)){_t.value=null;return}const pe=(re.value||[]).find(ue=>ue.coordinates&&eo(ue.coordinates[0],f)&&eo(ue.coordinates[1],y));if(pe){Wo(pe),bt.value=[f,y],_t.value=null;return}for(const ue of s.value||[])for(const $n of ue.features||[]){const Zn=(ze=$n.geometry)==null?void 0:ze.coordinates;if(Zn&&eo(Zn[0],f)&&eo(Zn[1],y)){Jn({name:ue.name,properties:$n.properties,geometry:$n.geometry.coordinates,address:""}),bt.value=[f,y],_t.value=null;return}}Array.isArray(s.value)&&s.value.length>0&&(bt.value=[f,y])},tc=()=>{try{const p=new URLSearchParams(window.location.search),f=p.get("lng"),y=p.get("lat");if(!f||!y)return;_t.value={lng:f,lat:y},Qo()}catch(p){}};J(re,Qo,{deep:!1}),J(s,Qo,{deep:!1}),Gn(()=>{s.value=Zc(Wc()),tc()});const oc=ne(()=>[{key:"share",icon:"share",label:"分享",highlight:!0,onClick:()=>V.value=!0},{key:"howto",icon:"help_outline",label:"怎麼用",onClick:ae},{key:"faq",icon:"map",label:"地圖怎麼看",onClick:()=>I.value=!0},{key:"mobile",icon:"add_to_home_screen",label:"加到手機桌面",onClick:()=>U.value=!0}]),ic=ne(()=>[{key:"add",icon:"add_location_alt",label:"新增停車位置",highlight:!0,onClick:Ra},{key:"help",icon:"menu_book",label:"編輯教學",onClick:()=>D.value=!0}]);return(p,f)=>(v(),P(ye,null,[c("div",Hp,[hn.value?(v(),P("img",Wp)):(v(),P("button",{key:0,class:"title-toggle",onClick:f[0]||(f[0]=y=>de.value=!de.value),"aria-label":de.value?"收合設定":"開啟設定","aria-expanded":de.value},[c("span",Vp,w(de.value?"close":"menu"),1)],8,zp)),jp]),We(Ue(xr,{items:oc.value},null,8,["items"]),[[Et,!ke.value&&!oe.value&&!hn.value]]),We(Ue(xr,{items:ic.value,placement:"left","main-icon":"add_location_alt","main-label":"共筆停車點"},null,8,["items"]),[[Et,!ke.value&&!oe.value&&!hn.value]]),We(Ue(_5,{"map-data-list":s.value,"community-parkings":L(re),onSelect:qa},null,8,["map-data-list","community-parkings"]),[[Et,!ke.value&&!oe.value&&!hn.value]]),Gp,Ue(hu,{ref_key:"mapBoxRef",ref:O,parkingTypeKeyArray:Qa.value,degreeOfFriendlinessKeyArray:Ya.value,mapDataList:s.value,getLngLat:h.value.getLngLat,mapStylesSelected:h.value.mapStylesSelected,parkingPriceType:G.value,priceRangeMin:q.value,priceRangeMax:K.value,"favorite-ids":L(xe),"override-keys":on.value,overrides:L(ce),"only-favorites":M.value,"focus-coord":bt.value,"route-profile":B.value,"community-parkings":L(re),goToParkingPlaceData:gt.value,"onUpdate:goToParkingPlaceData":f[1]||(f[1]=y=>gt.value=y),routeData:At.value,"onUpdate:routeData":f[2]||(f[2]=y=>At.value=y),onParkingInfo:Jn,onCommunityParkingClick:Wo},null,8,["parkingTypeKeyArray","degreeOfFriendlinessKeyArray","mapDataList","getLngLat","mapStylesSelected","parkingPriceType","priceRangeMin","priceRangeMax","favorite-ids","override-keys","overrides","only-favorites","focus-coord","route-profile","community-parkings","goToParkingPlaceData","routeData"]),Ue(i5,{"route-data":At.value,active:ke.value,profile:B.value,"onUpdate:profile":f[3]||(f[3]=y=>B.value=y),onCancel:Za},null,8,["route-data","active","profile"]),Ue(a3,{parkingType:_.value,"onUpdate:parkingType":f[4]||(f[4]=y=>_.value=y),degreeOfFriendliness:N.value,"onUpdate:degreeOfFriendliness":f[5]||(f[5]=y=>N.value=y),parkingPriceType:G.value,"onUpdate:parkingPriceType":f[6]||(f[6]=y=>G.value=y),priceRangeMin:q.value,"onUpdate:priceRangeMin":f[7]||(f[7]=y=>q.value=y),priceRangeMax:K.value,"onUpdate:priceRangeMax":f[8]||(f[8]=y=>K.value=y),mapStyle:u.value,"onUpdate:mapStyle":f[9]||(f[9]=y=>u.value=y),active:de.value,"onUpdate:active":f[10]||(f[10]=y=>de.value=y),onlyFavorites:M.value,"onUpdate:onlyFavorites":f[11]||(f[11]=y=>M.value=y),"favorites-count":L(Se).length},null,8,["parkingType","degreeOfFriendliness","parkingPriceType","priceRangeMin","priceRangeMax","mapStyle","active","onlyFavorites","favorites-count"]),We(Ue(V3,{info:$.value,active:oe.value,"is-mobile":L(t),"is-apple":L(o),"is-android":L(i),"has-route":gt.value!==null,"is-favorite":ws.value,"is-community":jo.value,"community-meta":jo.value?He.value:null,"is-overridden":!jo.value&&!!Zt.value,"override-meta":Zt.value,onClose:f[12]||(f[12]=y=>oe.value=!1),onRoute:f[13]||(f[13]=y=>$a($.value.geometry)),onOpenMap:ec,onToggleFavorite:Xa,onEditCommunity:Fa,onEditOverride:Ha,onShare:nc},null,8,["info","active","is-mobile","is-apple","is-android","has-route","is-favorite","is-community","community-meta","is-overridden","override-meta"]),[[Et,!ke.value]]),Ue(On,{modelValue:I.value,"onUpdate:modelValue":f[14]||(f[14]=y=>I.value=y),title:"地圖怎麼看?","close-text":"知道了",size:"lg"},{default:ln(()=>[Kp,c("div",Qp,[c("div",Yp,[c("img",{src:L(X)("icon-3.png"),alt:""},null,8,Xp),k(" 汽車：汽車格(含未確認是否有重機格) ")]),c("div",Jp,[c("img",{src:L(X)("icon-8.png"),alt:""},null,8,qp),k(" 重機(有人):有設重機專用格 ")]),c("div",$p,[c("img",{src:L(X)("icon-10.png"),alt:""},null,8,Zp),k(" 機車(沒人):機車格 ")]),c("div",em,[c("img",{src:L(X)("icon-14.png"),alt:""},null,8,nm),k(" 綠星:路邊友善車格 ")]),c("div",tm,[c("img",{src:L(X)("icon-4.png"),alt:""},null,8,om),k(" 重機友善店家:用餐/消費時可停重機的店家 ")]),c("div",im,[c("img",{src:L(X)("icon-15.png"),alt:""},null,8,sm),k(" 綠P:重機專用路邊停車格 ")]),c("div",rm,[c("img",{src:L(X)("icon-16.png"),alt:""},null,8,lm),k(" 灰P:重機專用路邊停車格(未確認精準座標,歡迎回報) ")]),c("div",am,[c("img",{src:L(X)("icon-17.png"),alt:""},null,8,cm),k(" 藍P:普通大型共用機車格(台北市試辦) ")]),c("div",dm,[c("img",{src:L(X)("icon-18.png"),alt:""},null,8,hm),k(" 紫P:時段性汽機車共用停車格 ")]),c("div",um,[c("img",{src:L(X)("icon-19.png"),alt:""},null,8,pm),k(" 紅X:停都不給停 ")]),c("div",mm,[c("img",{src:L(X)("icon-20.png"),alt:""},null,8,fm),k(" ?:類型未確認,歡迎透過共筆回報 ")])]),ym,c("div",bm,[c("div",gm,[c("img",{src:L(X)("icon-2.png"),alt:""},null,8,Am),c("img",{src:L(X)("icon-6.png"),alt:""},null,8,_m),c("img",{src:L(X)("icon-9.png"),alt:""},null,8,vm),k(" 綠色最友善:有後牌辨析 ")]),c("div",Cm,[c("img",{src:L(X)("icon-5.png"),alt:""},null,8,Pm),c("img",{src:L(X)("icon-12.png"),alt:""},null,8,Um),c("img",{src:L(X)("icon-11.png"),alt:""},null,8,Em),k(" 藍色最傳統:悠遊卡 / 按鈕取票 ")]),c("div",Im,[c("img",{src:L(X)("icon-1.png"),alt:""},null,8,Bm),c("img",{src:L(X)("icon-13.png"),alt:""},null,8,Sm),c("img",{src:L(X)("icon-7.png"),alt:""},null,8,wm),k(" 紅色最靠北:請管理員協助 / 倒退嚕前牌辨析 ")]),c("div",km,[c("img",{src:L(X)("icon-3.png"),alt:""},null,8,Tm),c("img",{src:L(X)("icon-8.png"),alt:""},null,8,Dm),c("img",{src:L(X)("icon-10.png"),alt:""},null,8,Nm),k(" 灰色未確定:有可能是上述任何情況,停到請回報 ")])]),Mm,c("div",Rm,[c("div",xm,[c("img",{src:L(X)("icon-3.png"),alt:""},null,8,Om),k(" (30/h)三張里地下停車場 ")]),Lm])]),_:1},8,["modelValue"]),Ue(On,{modelValue:V.value,"onUpdate:modelValue":f[19]||(f[19]=y=>V.value=y),title:"分享給朋友",size:"sm"},{default:ln(()=>[c("div",Fm,[c("button",{class:"share-btn",onClick:f[15]||(f[15]=y=>bn("facebook")),"aria-label":"Facebook"},Vm),c("button",{class:"share-btn",onClick:f[16]||(f[16]=y=>bn("line")),"aria-label":"LINE"},Gm),c("button",{class:"share-btn",onClick:f[17]||(f[17]=y=>bn("twitter")),"aria-label":"Twitter"},Ym),c("button",{class:"share-btn",onClick:f[18]||(f[18]=y=>bn("link")),"aria-label":"複製連結"},qm)])]),_:1},8,["modelValue"]),Ue(On,{modelValue:Go.value,"onUpdate:modelValue":f[24]||(f[24]=y=>Go.value=y),title:`分享：${Ko.value}`,size:"sm"},{default:ln(()=>[c("p",$m,w(qn.value),1),c("div",Zm,[c("button",{class:"share-btn",onClick:f[20]||(f[20]=y=>bn("facebook",qn.value)),"aria-label":"Facebook"},t4),c("button",{class:"share-btn",onClick:f[21]||(f[21]=y=>bn("line",qn.value)),"aria-label":"LINE"},s4),c("button",{class:"share-btn",onClick:f[22]||(f[22]=y=>bn("twitter",qn.value)),"aria-label":"Twitter"},a4),c("button",{class:"share-btn",onClick:f[23]||(f[23]=y=>bn("link",qn.value)),"aria-label":"複製連結"},h4)])]),_:1},8,["modelValue","title"]),Ue(On,{modelValue:U.value,"onUpdate:modelValue":f[27]||(f[27]=y=>U.value=y),title:"如何加入手機桌面?","close-text":"知道了",size:"lg"},{default:ln(()=>[c("div",u4,[c("button",{type:"button",role:"tab","aria-selected":T.value==="ios",class:ie(["os-tab",{"is-active":T.value==="ios"}]),onClick:f[25]||(f[25]=y=>T.value="ios")},[m4,k(" iOS ")],10,p4),c("button",{type:"button",role:"tab","aria-selected":T.value==="android",class:ie(["os-tab",{"is-active":T.value==="android"}]),onClick:f[26]||(f[26]=y=>T.value="android")},[y4,k(" Android ")],10,f4)]),T.value==="ios"?(v(),P(ye,{key:0},[b4,g4,A4,_4,v4,C4,P4,U4,E4,I4,B4],64)):(v(),P(ye,{key:1},[S4,w4,k4,T4,D4,N4,M4,R4,x4],64))]),_:1},8,["modelValue"]),Ue(On,{modelValue:g.value,"onUpdate:modelValue":f[28]||(f[28]=y=>g.value=y),title:"嗨！歡迎使用 重機能停哪?","close-text":"開始使用"},{footer:ln(()=>[c("button",{class:"btn btn-primary",onClick:Ae},"開始使用")]),default:ln(()=>[O4,L4,F4,H4,z4,V4,W4,j4]),_:1},8,["modelValue"]),Ue(bp,{open:De.value,"onUpdate:open":f[29]||(f[29]=y=>De.value=y),mode:sn.value,initial:rn.value,"default-coord":yt.value,nickname:L(he),"is-owner":!0,"is-admin":L(x),submitting:dn.value,"has-existing-override":Bs.value,history:Ma.value,"onUpdate:nickname":f[30]||(f[30]=y=>he.value=y),onSubmit:f[31]||(f[31]=y=>sn.value==="override"?Wa(y):Ga(y)),onDelete:Ka,onReset:ja},null,8,["open","mode","initial","default-coord","nickname","is-admin","submitting","has-existing-override","history"]),hn.value?(v(),P("div",G4,Q4)):j("",!0),hn.value?(v(),P("div",Y4,[X4,c("div",{class:"pick-banner-actions"},[c("button",{class:"btn btn-outline btn-sm",onClick:Oa},"取消"),c("button",{class:"btn btn-primary btn-sm",onClick:xa},[J4,k(" 使用此位置 ")])])])):j("",!0),Ue(On,{modelValue:D.value,"onUpdate:modelValue":f[32]||(f[32]=y=>D.value=y),title:"共筆停車點說明","close-text":"我知道了",size:"lg"},{default:ln(()=>[q4,$4,Z4,ef,nf,tf,of]),_:1},8,["modelValue"]),Ue(Sp,{active:W.value,"onUpdate:active":f[33]||(f[33]=y=>W.value=y),steps:Ee,onFinish:Ie},null,8,["active"])],64))}},lf=en(rf,[["__scopeId","data-v-e919e563"]]);lc(lf).mount("#app");"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./serviceWorker.js").catch(()=>{})});
