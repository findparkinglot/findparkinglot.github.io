 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _=function(n,e){if(!n)throw pt(e)},pt=function(n){return new Error("Firebase Database ("+Cl.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ul=function(n){const e=[];let t=0;for(let o=0;o<n.length;o++){let i=n.charCodeAt(o);i<128?e[t++]=i:i<2048?(e[t++]=i>>6|192,e[t++]=i&63|128):(i&64512)===55296&&o+1<n.length&&(n.charCodeAt(o+1)&64512)===56320?(i=65536+((i&1023)<<10)+(n.charCodeAt(++o)&1023),e[t++]=i>>18|240,e[t++]=i>>12&63|128,e[t++]=i>>6&63|128,e[t++]=i&63|128):(e[t++]=i>>12|224,e[t++]=i>>6&63|128,e[t++]=i&63|128)}return e},kd=function(n){const e=[];let t=0,o=0;for(;t<n.length;){const i=n[t++];if(i<128)e[o++]=String.fromCharCode(i);else if(i>191&&i<224){const s=n[t++];e[o++]=String.fromCharCode((i&31)<<6|s&63)}else if(i>239&&i<365){const s=n[t++],r=n[t++],l=n[t++],a=((i&7)<<18|(s&63)<<12|(r&63)<<6|l&63)-65536;e[o++]=String.fromCharCode(55296+(a>>10)),e[o++]=String.fromCharCode(56320+(a&1023))}else{const s=n[t++],r=n[t++];e[o++]=String.fromCharCode((i&15)<<12|(s&63)<<6|r&63)}}return e.join("")},qi={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,e){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,o=[];for(let i=0;i<n.length;i+=3){const s=n[i],r=i+1<n.length,l=r?n[i+1]:0,a=i+2<n.length,d=a?n[i+2]:0,m=s>>2,h=(s&3)<<4|l>>4;let f=(l&15)<<2|d>>6,b=d&63;a||(b=64,r||(f=64)),o.push(t[m],t[h],t[f],t[b])}return o.join("")},encodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(n):this.encodeByteArray(Ul(n),e)},decodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(n):kd(this.decodeStringToByteArray(n,e))},decodeStringToByteArray(n,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,o=[];for(let i=0;i<n.length;){const s=t[n.charAt(i++)],l=i<n.length?t[n.charAt(i)]:0;++i;const d=i<n.length?t[n.charAt(i)]:64;++i;const h=i<n.length?t[n.charAt(i)]:64;if(++i,s==null||l==null||d==null||h==null)throw new Dd;const f=s<<2|l>>4;if(o.push(f),d!==64){const b=l<<4&240|d>>2;if(o.push(b),h!==64){const g=d<<6&192|h;o.push(g)}}}return o},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class Dd extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const El=function(n){const e=Ul(n);return qi.encodeByteArray(e,!0)},fo=function(n){return El(n).replace(/\./g,"")},bi=function(n){try{return qi.decodeString(n,!0)}catch(e){}return null};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Td(n){return Bl(void 0,n)}function Bl(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!Nd(t)||(n[t]=Bl(n[t],e[t]));return n}function Nd(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rd=()=>Md().__FIREBASE_DEFAULTS__,Od=()=>{if(typeof process=="undefined"||typeof nr=="undefined")return;const n=nr.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},xd=()=>{if(typeof document=="undefined")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch(t){return}const e=n&&bi(n[1]);return e&&JSON.parse(e)},wl=()=>{try{return Sd()||Rd()||Od()||xd()}catch(n){return}},Ld=n=>{var e,t;return(t=(e=wl())==null?void 0:e.emulatorHosts)==null?void 0:t[n]},Fd=n=>{const e=Ld(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const o=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),o]:[e.substring(0,t),o]},Il=()=>{var n;return(n=wl())==null?void 0:n.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zd(){return typeof navigator!="undefined"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Sl(){return typeof window!="undefined"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(zd())}function Vd(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function kl(){return Cl.NODE_ADMIN===!0}function Wd(){try{return typeof indexedDB=="object"}catch(n){return!1}}function jd(){return new Promise((n,e)=>{try{let t=!0;const o="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(o);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(o),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var s;e(((s=i.error)==null?void 0:s.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gd="FirebaseError";class Xt extends Error{constructor(e,t,o){super(t),this.code=e,this.customData=o,this.name=Gd,Object.setPrototypeOf(this,Xt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Dl.prototype.create)}}class Dl{constructor(e,t,o){this.service=e,this.serviceName=t,this.errors=o}create(e,...t){const o=t[0]||{},i=`${this.service}/${e}`,s=this.errors[e],r=s?Kd(s,o):"Error",l=`${this.serviceName}: ${r} (${i}).`;return new Xt(i,l,o)}}function Kd(n,e){return n.replace(Qd,(t,o)=>{const i=e[o];return i!=null?String(i):`<${o}?>`})}const Qd=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xt(n){return JSON.parse(n)}function Pe(n){return JSON.stringify(n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tl=function(n){let e={},t={},o={},i="";try{const s=n.split(".");e=xt(bi(s[0])||""),t=xt(bi(s[1])||""),i=s[2],o=t.d||{},delete t.d}catch(s){}return{header:e,claims:t,data:o,signature:i}},Yd=function(n){const e=Tl(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},Xd=function(n){const e=Tl(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qd(n){const e=[];for(const[t,o]of Object.entries(n))Array.isArray(o)?o.forEach(i=>{e.push(encodeURIComponent(t)+"="+encodeURIComponent(i))}):e.push(encodeURIComponent(t)+"="+encodeURIComponent(o));return e.length?"&"+e.join("&"):""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $d=function(n){const e=[];let t=0;for(let o=0;o<n.length;o++){let i=n.charCodeAt(o);if(i>=55296&&i<=56319){const s=i-55296;o++,_(o<n.length,"Surrogate pair missing trail surrogate.");const r=n.charCodeAt(o)-56320;i=65536+(s<<10)+r}i<128?e[t++]=i:i<2048?(e[t++]=i>>6|192,e[t++]=i&63|128):i<65536?(e[t++]=i>>12|224,e[t++]=i>>6&63|128,e[t++]=i&63|128):(e[t++]=i>>18|240,e[t++]=i>>12&63|128,e[t++]=i>>6&63|128,e[t++]=i&63|128)}return e},Mo=function(n){let e=0;for(let t=0;t<n.length;t++){const o=n.charCodeAt(t);o<128?e++:o<2048?e+=2:o>=55296&&o<=56319?(e+=4,t++):e+=3}return e};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qn(n){return n&&n._delegate?n._delegate:n}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class e1{constructor(e,t){this.name=e,this.container=t,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const t=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(t)){const o=new Yt;if(this.instancesDeferred.set(t,o),this.isInitialized(t)||this.shouldAutoInitialize())try{const i=this.getOrInitializeService({instanceIdentifier:t});i&&o.resolve(i)}catch(i){}}return this.instancesDeferred.get(t).promise}getImmediate(e){var i;const t=this.normalizeInstanceIdentifier(e==null?void 0:e.identifier),o=(i=e==null?void 0:e.optional)!=null?i:!1;if(this.isInitialized(t)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:t})}catch(s){if(o)return null;throw s}else{if(o)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(t1(e))try{this.getOrInitializeService({instanceIdentifier:Hn})}catch(t){}for(const[t,o]of this.instancesDeferred.entries()){const i=this.normalizeInstanceIdentifier(t);try{const s=this.getOrInitializeService({instanceIdentifier:i});o.resolve(s)}catch(s){}}}}clearInstance(e=Hn){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(t=>"INTERNAL"in t).map(t=>t.INTERNAL.delete()),...e.filter(t=>"_delete"in t).map(t=>t._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=Hn){return this.instances.has(e)}getOptions(e=Hn){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:t={}}=e,o=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(o))throw Error(`${this.name}(${o}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const i=this.getOrInitializeService({instanceIdentifier:o,options:t});for(const[s,r]of this.instancesDeferred.entries()){const l=this.normalizeInstanceIdentifier(s);o===l&&r.resolve(i)}return i}onInit(e,t){var r;const o=this.normalizeInstanceIdentifier(t),i=(r=this.onInitCallbacks.get(o))!=null?r:new Set;i.add(e),this.onInitCallbacks.set(o,i);const s=this.instances.get(o);return s&&e(s,o),()=>{i.delete(e)}}invokeOnInitCallbacks(e,t){const o=this.onInitCallbacks.get(t);if(o)for(const i of o)try{i(e,t)}catch(s){}}getOrInitializeService({instanceIdentifier:e,options:t={}}){let o=this.instances.get(e);if(!o&&this.component&&(o=this.component.instanceFactory(this.container,{instanceIdentifier:n1(e),options:t}),this.instances.set(e,o),this.instancesOptions.set(e,t),this.invokeOnInitCallbacks(o,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,o)}catch(i){}return o||null}normalizeInstanceIdentifier(e=Hn){return this.component?this.component.multipleInstances?e:Hn:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function n1(n){return n===Hn?void 0:n}function t1(n){return n.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var te;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(te||(te={}));const i1={debug:te.DEBUG,verbose:te.VERBOSE,info:te.INFO,warn:te.WARN,error:te.ERROR,silent:te.SILENT},s1=te.INFO,r1={[te.DEBUG]:"log",[te.VERBOSE]:"log",[te.INFO]:"info",[te.WARN]:"warn",[te.ERROR]:"error"},l1=(n,e,...t)=>{if(e<n.logLevel)return;const o=new Date().toISOString(),i=r1[e];if(!i)throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Ml{constructor(e){this.name=e,this._logLevel=s1,this._logHandler=l1,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in te))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?i1[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,te.DEBUG,...e),this._logHandler(this,te.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,te.VERBOSE,...e),this._logHandler(this,te.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,te.INFO,...e),this._logHandler(this,te.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,te.WARN,...e),this._logHandler(this,te.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,te.ERROR,...e),this._logHandler(this,te.ERROR,...e)}}const a1=(n,e)=>e.some(t=>n instanceof t);let ir,sr;function c1(){return ir||(ir=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function d1(){return sr||(sr=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Rl=new WeakMap,gi=new WeakMap,Ol=new WeakMap,ni=new WeakMap,Ji=new WeakMap;function h1(n){const e=new Promise((t,o)=>{const i=()=>{n.removeEventListener("success",s),n.removeEventListener("error",r)},s=()=>{t(wn(n.result)),i()},r=()=>{o(n.error),i()};n.addEventListener("success",s),n.addEventListener("error",r)});return e.then(t=>{t instanceof IDBCursor&&Rl.set(t,n)}).catch(()=>{}),Ji.set(e,n),e}function u1(n){if(gi.has(n))return;const e=new Promise((t,o)=>{const i=()=>{n.removeEventListener("complete",s),n.removeEventListener("error",r),n.removeEventListener("abort",r)},s=()=>{t(),i()},r=()=>{o(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",s),n.addEventListener("error",r),n.addEventListener("abort",r)});gi.set(n,e)}let Ai={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return gi.get(n);if(e==="objectStoreNames")return n.objectStoreNames||Ol.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return wn(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function m1(n){Ai=n(Ai)}function p1(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const o=n.call(ti(this),e,...t);return Ol.set(o,e.sort?e.sort():[e]),wn(o)}:d1().includes(n)?function(...e){return n.apply(ti(this),e),wn(Rl.get(this))}:function(...e){return wn(n.apply(ti(this),e))}}function f1(n){return typeof n=="function"?p1(n):(n instanceof IDBTransaction&&u1(n),a1(n,c1())?new Proxy(n,Ai):n)}function wn(n){if(n instanceof IDBRequest)return h1(n);if(ni.has(n))return ni.get(n);const e=f1(n);return e!==n&&(ni.set(n,e),Ji.set(e,n)),e}const ti=n=>Ji.get(n);function y1(n,e,{blocked:t,upgrade:o,blocking:i,terminated:s}={}){const r=indexedDB.open(n,e),l=wn(r);return o&&r.addEventListener("upgradeneeded",a=>{o(wn(r.result),a.oldVersion,a.newVersion,wn(r.transaction),a)}),t&&r.addEventListener("blocked",a=>t(a.oldVersion,a.newVersion,a)),l.then(a=>{s&&a.addEventListener("close",()=>s()),i&&a.addEventListener("versionchange",d=>i(d.oldVersion,d.newVersion,d))}).catch(()=>{}),l}const b1=["get","getKey","getAll","getAllKeys","count"],g1=["put","add","delete","clear"],oi=new Map;function rr(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(oi.get(e))return oi.get(e);const t=e.replace(/FromIndex$/,""),o=e!==t,i=g1.includes(t);if(!(t in(o?IDBIndex:IDBObjectStore).prototype)||!(i||b1.includes(t)))return;const s=async function(r,...l){const a=this.transaction(r,i?"readwrite":"readonly");let d=a.store;return o&&(d=d.index(l.shift())),(await Promise.all([d[t](...l),i&&a.done]))[0]};return oi.set(e,s),s}m1(n=>({...n,get:(e,t,o)=>rr(e,t)||n.get(e,t,o),has:(e,t)=>!!rr(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class A1{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(_1(t)){const o=t.getImmediate();return`${o.library}/${o.version}`}else return null}).filter(t=>t).join(" ")}}function _1(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const _i="@firebase/app",lr="0.14.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fn=new Ml("@firebase/app"),v1="@firebase/app-compat",P1="@firebase/analytics-compat",C1="@firebase/analytics",U1="@firebase/app-check-compat",E1="@firebase/app-check",B1="@firebase/auth",w1="@firebase/auth-compat",I1="@firebase/database",S1="@firebase/data-connect",k1="@firebase/database-compat",D1="@firebase/functions",T1="@firebase/functions-compat",N1="@firebase/installations",M1="@firebase/installations-compat",R1="@firebase/messaging",O1="@firebase/messaging-compat",x1="@firebase/performance",L1="@firebase/performance-compat",F1="@firebase/remote-config",H1="@firebase/remote-config-compat",z1="@firebase/storage",V1="@firebase/storage-compat",W1="@firebase/firestore",j1="@firebase/ai",G1="@firebase/firestore-compat",K1="firebase",Q1="12.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vi="[DEFAULT]",Y1={[_i]:"fire-core",[v1]:"fire-core-compat",[C1]:"fire-analytics",[P1]:"fire-analytics-compat",[E1]:"fire-app-check",[U1]:"fire-app-check-compat",[B1]:"fire-auth",[w1]:"fire-auth-compat",[I1]:"fire-rtdb",[S1]:"fire-data-connect",[k1]:"fire-rtdb-compat",[D1]:"fire-fn",[T1]:"fire-fn-compat",[N1]:"fire-iid",[M1]:"fire-iid-compat",[R1]:"fire-fcm",[O1]:"fire-fcm-compat",[x1]:"fire-perf",[L1]:"fire-perf-compat",[F1]:"fire-rc",[H1]:"fire-rc-compat",[z1]:"fire-gcs",[V1]:"fire-gcs-compat",[W1]:"fire-fst",[G1]:"fire-fst-compat",[j1]:"fire-vertex","fire-js":"fire-js",[K1]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const go=new Map,X1=new Map,Pi=new Map;function ar(n,e){try{n.container.addComponent(e)}catch(t){fn.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Ao(n){const e=n.name;if(Pi.has(e))return fn.debug(`There were multiple attempts to register component ${e}.`),!1;Pi.set(e,n);for(const t of go.values())ar(t,n);for(const t of X1.values())ar(t,n);return!0}function q1(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function J1(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const e2=Q1;function xl(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const o={name:vi,automaticDataCollectionEnabled:!0,...e},i=o.name;if(typeof i!="string"||!i)throw In.create("bad-app-name",{appName:String(i)});if(t||(t=Il()),!t)throw In.create("no-options");const s=go.get(i);if(s){if(bo(t,s.options)&&bo(o,s.config))return s;throw In.create("duplicate-app",{appName:i})}const r=new o1(i);for(const a of Pi.values())r.addComponent(a);const l=new Z1(t,o,r);return go.set(i,l),l}function n2(n=vi){const e=go.get(n);if(!e&&n===vi&&Il())return xl();if(!e)throw In.create("no-app",{appName:n});return e}function it(n,e,t){var r;let o=(r=Y1[n])!=null?r:n;t&&(o+=`-${t}`);const i=o.match(/\s|\//),s=e.match(/\s|\//);if(i||s){const l=[`Unable to register library "${o}" with version "${e}":`];i&&l.push(`library name "${o}" contains illegal characters (whitespace or "/")`),i&&s&&l.push("and"),s&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),fn.warn(l.join(" "));return}Ao(new Lt(`${o}-version`,()=>({library:o,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const t2="firebase-heartbeat-database",o2=1,Ft="firebase-heartbeat-store";let ii=null;function Ll(){return ii||(ii=y1(t2,o2,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Ft)}catch(t){}}}}).catch(n=>{throw In.create("idb-open",{originalErrorMessage:n.message})})),ii}async function i2(n){try{const t=(await Ll()).transaction(Ft),o=await t.objectStore(Ft).get(Fl(n));return await t.done,o}catch(e){if(e instanceof Xt)fn.warn(e.message);else{const t=In.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});fn.warn(t.message)}}}async function cr(n,e){try{const o=(await Ll()).transaction(Ft,"readwrite");await o.objectStore(Ft).put(e,Fl(n)),await o.done}catch(t){if(t instanceof Xt)fn.warn(t.message);else{const o=In.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});fn.warn(o.message)}}}function Fl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const s2=1024,r2=30;class l2{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new c2(t),this._heartbeatsCachePromise=this._storage.read().then(o=>(this._heartbeatsCache=o,o))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=dr();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(r=>r.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats.length>r2){const r=d2(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(o){fn.warn(o)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=dr(),{heartbeatsToSend:o,unsentEntries:i}=a2(this._heartbeatsCache.heartbeats),s=fo(JSON.stringify({version:2,heartbeats:o}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return fn.warn(t),""}}}function dr(){return new Date().toISOString().substring(0,10)}function a2(n,e=s2){const t=[];let o=n.slice();for(const i of n){const s=t.find(r=>r.agent===i.agent);if(s){if(s.dates.push(i.date),hr(t)>e){s.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),hr(t)>e){t.pop();break}o=o.slice(1)}return{heartbeatsToSend:t,unsentEntries:o}}class c2{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Wd()?jd().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await i2(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return cr(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return cr(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function hr(n){return fo(JSON.stringify({version:2,heartbeats:n})).length}function d2(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let o=1;o<n.length;o++)n[o].date<t&&(t=n[o].date,e=o);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function h2(n){Ao(new Lt("platform-logger",e=>new A1(e),"PRIVATE")),Ao(new Lt("heartbeat",e=>new l2(e),"PRIVATE")),it(_i,lr,n),it(_i,lr,"esm2020"),it("fire-js","")}h2("");var ur={};const mr="@firebase/database",pr="1.1.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class p2{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return hn(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zl=function(n){try{if(typeof window!="undefined"&&typeof window[n]!="undefined"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new m2(e)}}catch(e){}return new p2},Wn=zl("localStorage"),f2=zl("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const st=new Ml("@firebase/database"),y2=function(){let n=1;return function(){return n++}}(),Vl=function(n){const e=$d(n),t=new Jd;t.update(e);const o=t.digest();return qi.encodeByteArray(o)},qt=function(...n){let e="";for(let t=0;t<n.length;t++){const o=n[t];Array.isArray(o)||o&&typeof o=="object"&&typeof o.length=="number"?e+=qt.apply(null,o):typeof o=="object"?e+=Pe(o):e+=o,e+=" "}return e};let kt=null,fr=!0;const b2=function(n,e){_(!e,"Can't turn on custom loggers persistently."),st.logLevel=te.VERBOSE,kt=st.log.bind(st)},we=function(...n){if(fr===!0&&(fr=!1,kt===null&&f2.get("logging_enabled")===!0&&b2()),kt){const e=qt.apply(null,n);kt(e)}},Jt=function(n){return function(...e){we(n,...e)}},Ci=function(...n){const e="FIREBASE INTERNAL ERROR: "+qt(...n);st.error(e)},yn=function(...n){const e=`FIREBASE FATAL ERROR: ${qt(...n)}`;throw st.error(e),new Error(e)},Me=function(...n){const e="FIREBASE WARNING: "+qt(...n);st.warn(e)},g2=function(){typeof window!="undefined"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&Me("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},$i=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},A2=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},Gn="[MIN_NAME]",kn="[MAX_NAME]",Jn=function(n,e){if(n===e)return 0;if(n===Gn||e===kn)return-1;if(e===Gn||n===kn)return 1;{const t=yr(n),o=yr(e);return t!==null?o!==null?t-o===0?n.length-e.length:t-o:-1:o!==null?1:n<e?-1:1}},_2=function(n,e){return n===e?0:n<e?-1:1},Ct=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+Pe(e))},Zi=function(n){if(typeof n!="object"||n===null)return Pe(n);const e=[];for(const o in n)e.push(o);e.sort();let t="{";for(let o=0;o<e.length;o++)o!==0&&(t+=","),t+=Pe(e[o]),t+=":",t+=Zi(n[e[o]]);return t+="}",t},Wl=function(n,e){const t=n.length;if(t<=e)return[n];const o=[];for(let i=0;i<t;i+=e)i+e>t?o.push(n.substring(i,t)):o.push(n.substring(i,i+e));return o};function Ie(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const jl=function(n){_(!$i(n),"Invalid JSON number");const e=11,t=52,o=(1<<e-1)-1;let i,s,r,l,a;n===0?(s=0,r=0,i=1/n===-1/0?1:0):(i=n<0,n=Math.abs(n),n>=Math.pow(2,1-o)?(l=Math.min(Math.floor(Math.log(n)/Math.LN2),o),s=l+o,r=Math.round(n*Math.pow(2,t-l)-Math.pow(2,t))):(s=0,r=Math.round(n/Math.pow(2,1-o-t))));const d=[];for(a=t;a;a-=1)d.push(r%2?1:0),r=Math.floor(r/2);for(a=e;a;a-=1)d.push(s%2?1:0),s=Math.floor(s/2);d.push(i?1:0),d.reverse();const m=d.join("");let h="";for(a=0;a<64;a+=8){let f=parseInt(m.substr(a,8),2).toString(16);f.length===1&&(f="0"+f),h=h+f}return h.toLowerCase()},v2=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},P2=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function C2(n,e){let t="Unknown Error";n==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":n==="permission_denied"?t="Client doesn't have permission to access the desired data.":n==="unavailable"&&(t="The service is unavailable");const o=new Error(n+" at "+e._path.toString()+": "+t);return o.code=n.toUpperCase(),o}const U2=new RegExp("^-?(0*)\\d{1,10}$"),E2=-2147483648,B2=2147483647,yr=function(n){if(U2.test(n)){const e=Number(n);if(e>=E2&&e<=B2)return e}return null},ft=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw Me("Exception was thrown by user callback.",t),e},Math.floor(0))}},w2=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Dt=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno!="undefined"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class I2{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,J1(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(o=>this.appCheck=o)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,o)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)==null||t.get().then(o=>o.addTokenListener(e))}notifyForInvalidToken(){Me(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S2{constructor(e,t,o){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=o,this.auth_=null,this.auth_=o.getImmediate({optional:!0}),this.auth_||o.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(we("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,o)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Me(e)}}class ao{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}ao.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es="5",Gl="v",Kl="s",Ql="r",Yl="f",Xl=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,ql="ls",Jl="p",Ui="ac",$l="websocket",Zl="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ea{constructor(e,t,o,i,s=!1,r="",l=!1,a=!1,d=null){this.secure=t,this.namespace=o,this.webSocketOnly=i,this.nodeAdmin=s,this.persistenceKey=r,this.includeNamespaceInQueryParams=l,this.isUsingEmulator=a,this.emulatorOptions=d,this._host=e.toLowerCase(),this._domain=this._host.substr(this._host.indexOf(".")+1),this.internalHost=Wn.get("host:"+e)||this._host}isCacheableHost(){return this.internalHost.substr(0,2)==="s-"}isCustomHost(){return this._domain!=="firebaseio.com"&&this._domain!=="firebaseio-demo.com"}get host(){return this._host}set host(e){e!==this.internalHost&&(this.internalHost=e,this.isCacheableHost()&&Wn.set("host:"+this._host,this.internalHost))}toString(){let e=this.toURLString();return this.persistenceKey&&(e+="<"+this.persistenceKey+">"),e}toURLString(){const e=this.secure?"https://":"http://",t=this.includeNamespaceInQueryParams?`?ns=${this.namespace}`:"";return`${e}${this.host}/${t}`}}function k2(n){return n.host!==n.internalHost||n.isCustomHost()||n.includeNamespaceInQueryParams}function na(n,e,t){_(typeof e=="string","typeof type must == string"),_(typeof t=="object","typeof params must == object");let o;if(e===$l)o=(n.secure?"wss://":"ws://")+n.internalHost+"/.ws?";else if(e===Zl)o=(n.secure?"https://":"http://")+n.internalHost+"/.lp?";else throw new Error("Unknown connection type: "+e);k2(n)&&(t.ns=n.namespace);const i=[];return Ie(t,(s,r)=>{i.push(s+"="+r)}),o+i.join("&")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class D2{constructor(){this.counters_={}}incrementCounter(e,t=1){hn(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return Td(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const si={},ri={};function ns(n){const e=n.toString();return si[e]||(si[e]=new D2),si[e]}function T2(n,e){const t=n.toString();return ri[t]||(ri[t]=e()),ri[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class N2{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const o=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<o.length;++i)o[i]&&ft(()=>{this.onMessage_(o[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const br="start",M2="close",R2="pLPCommand",O2="pRTLPCB",ta="id",oa="pw",ia="ser",x2="cb",L2="seg",F2="ts",H2="d",z2="dframe",sa=1870,ra=30,V2=sa-ra,W2=25e3,j2=3e4;class ot{constructor(e,t,o,i,s,r,l){this.connId=e,this.repoInfo=t,this.applicationId=o,this.appCheckToken=i,this.authToken=s,this.transportSessionId=r,this.lastSessionId=l,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=Jt(e),this.stats_=ns(t),this.urlFn=a=>(this.appCheckToken&&(a[Ui]=this.appCheckToken),na(t,Zl,a))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new N2(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(j2)),A2(()=>{if(this.isClosed_)return;this.scriptTagHolder=new ts((...s)=>{const[r,l,a,d,m]=s;if(this.incrementIncomingBytes_(s),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,r===br)this.id=l,this.password=a;else if(r===M2)l?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(l,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+r)},(...s)=>{const[r,l]=s;this.incrementIncomingBytes_(s),this.myPacketOrderer.handleResponse(r,l)},()=>{this.onClosed_()},this.urlFn);const o={};o[br]="t",o[ia]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(o[x2]=this.scriptTagHolder.uniqueCallbackIdentifier),o[Gl]=es,this.transportSessionId&&(o[Kl]=this.transportSessionId),this.lastSessionId&&(o[ql]=this.lastSessionId),this.applicationId&&(o[Jl]=this.applicationId),this.appCheckToken&&(o[Ui]=this.appCheckToken),typeof location!="undefined"&&location.hostname&&Xl.test(location.hostname)&&(o[Ql]=Yl);const i=this.urlFn(o);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){ot.forceAllow_=!0}static forceDisallow(){ot.forceDisallow_=!0}static isAvailable(){return ot.forceAllow_?!0:!ot.forceDisallow_&&typeof document!="undefined"&&document.createElement!=null&&!v2()&&!P2()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=Pe(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const o=El(t),i=Wl(o,V2);for(let s=0;s<i.length;s++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[s]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const o={};o[z2]="t",o[ta]=e,o[oa]=t,this.myDisconnFrame.src=this.urlFn(o),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=Pe(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class ts{constructor(e,t,o,i){this.onDisconnect=o,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=y2(),window[R2+this.uniqueCallbackIdentifier]=e,window[O2+this.uniqueCallbackIdentifier]=t,this.myIFrame=ts.createIFrame_();let s="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(s='<script>document.domain="'+document.domain+'";<\/script>');const r="<html><body>"+s+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(r),this.myIFrame.doc.close()}catch(l){we("frame writing exception"),l.stack&&we(l.stack),we(l)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||we("No IE domain setting required")}catch(t){const o=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+o+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[ta]=this.myID,e[oa]=this.myPW,e[ia]=this.currentSerial;let t=this.urlFn(e),o="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+ra+o.length<=sa;){const r=this.pendingSegs.shift();o=o+"&"+L2+i+"="+r.seg+"&"+F2+i+"="+r.ts+"&"+H2+i+"="+r.d,i++}return t=t+o,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,o){this.pendingSegs.push({seg:e,ts:t,d:o}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const o=()=>{this.outstandingRequests.delete(t),this.newRequest_()},i=setTimeout(o,Math.floor(W2)),s=()=>{clearTimeout(i),o()};this.addTag(e,s)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const o=this.myIFrame.doc.createElement("script");o.type="text/javascript",o.async=!0,o.src=e,o.onload=o.onreadystatechange=function(){const i=o.readyState;(!i||i==="loaded"||i==="complete")&&(o.onload=o.onreadystatechange=null,o.parentNode&&o.parentNode.removeChild(o),t())},o.onerror=()=>{we("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(o)}catch(o){}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G2=16384,K2=45e3;let _o=null;typeof MozWebSocket!="undefined"?_o=MozWebSocket:typeof WebSocket!="undefined"&&(_o=WebSocket);class tn{constructor(e,t,o,i,s,r,l){this.connId=e,this.applicationId=o,this.appCheckToken=i,this.authToken=s,this.keepaliveTimer=null,this.frames=null,this.totalFrames=0,this.bytesSent=0,this.bytesReceived=0,this.log_=Jt(this.connId),this.stats_=ns(t),this.connURL=tn.connectionURL_(t,r,l,i,o),this.nodeAdmin=t.nodeAdmin}static connectionURL_(e,t,o,i,s){const r={};return r[Gl]=es,typeof location!="undefined"&&location.hostname&&Xl.test(location.hostname)&&(r[Ql]=Yl),t&&(r[Kl]=t),o&&(r[ql]=o),i&&(r[Ui]=i),s&&(r[Jl]=s),na(e,$l,r)}open(e,t){this.onDisconnect=t,this.onMessage=e,this.log_("Websocket connecting to "+this.connURL),this.everConnected_=!1,Wn.set("previous_websocket_failure",!0);try{let o;kl(),this.mySock=new _o(this.connURL,[],o)}catch(o){this.log_("Error instantiating WebSocket.");const i=o.message||o.data;i&&this.log_(i),this.onClosed_();return}this.mySock.onopen=()=>{this.log_("Websocket connected."),this.everConnected_=!0},this.mySock.onclose=()=>{this.log_("Websocket connection was disconnected."),this.mySock=null,this.onClosed_()},this.mySock.onmessage=o=>{this.handleIncomingFrame(o)},this.mySock.onerror=o=>{this.log_("WebSocket error.  Closing connection.");const i=o.message||o.data;i&&this.log_(i),this.onClosed_()}}start(){}static forceDisallow(){tn.forceDisallow_=!0}static isAvailable(){let e=!1;if(typeof navigator!="undefined"&&navigator.userAgent){const t=/Android ([0-9]{0,}\.[0-9]{0,})/,o=navigator.userAgent.match(t);o&&o.length>1&&parseFloat(o[1])<4.4&&(e=!0)}return!e&&_o!==null&&!tn.forceDisallow_}static previouslyFailed(){return Wn.isInMemoryStorage||Wn.get("previous_websocket_failure")===!0}markConnectionHealthy(){Wn.remove("previous_websocket_failure")}appendFrame_(e){if(this.frames.push(e),this.frames.length===this.totalFrames){const t=this.frames.join("");this.frames=null;const o=xt(t);this.onMessage(o)}}handleNewFrameCount_(e){this.totalFrames=e,this.frames=[]}extractFrameCount_(e){if(_(this.frames===null,"We already have a frame buffer"),e.length<=6){const t=Number(e);if(!isNaN(t))return this.handleNewFrameCount_(t),null}return this.handleNewFrameCount_(1),e}handleIncomingFrame(e){if(this.mySock===null)return;const t=e.data;if(this.bytesReceived+=t.length,this.stats_.incrementCounter("bytes_received",t.length),this.resetKeepAlive(),this.frames!==null)this.appendFrame_(t);else{const o=this.extractFrameCount_(t);o!==null&&this.appendFrame_(o)}}send(e){this.resetKeepAlive();const t=Pe(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const o=Wl(t,G2);o.length>1&&this.sendString_(String(o.length));for(let i=0;i<o.length;i++)this.sendString_(o[i])}shutdown_(){this.isClosed_=!0,this.keepaliveTimer&&(clearInterval(this.keepaliveTimer),this.keepaliveTimer=null),this.mySock&&(this.mySock.close(),this.mySock=null)}onClosed_(){this.isClosed_||(this.log_("WebSocket is closing itself"),this.shutdown_(),this.onDisconnect&&(this.onDisconnect(this.everConnected_),this.onDisconnect=null))}close(){this.isClosed_||(this.log_("WebSocket is being closed"),this.shutdown_())}resetKeepAlive(){clearInterval(this.keepaliveTimer),this.keepaliveTimer=setInterval(()=>{this.mySock&&this.sendString_("0"),this.resetKeepAlive()},Math.floor(K2))}sendString_(e){try{this.mySock.send(e)}catch(t){this.log_("Exception thrown from WebSocket.send():",t.message||t.data,"Closing connection."),setTimeout(this.onClosed_.bind(this),0)}}}tn.responsesRequiredToBeHealthy=2;tn.healthyTimeout=3e4;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht{static get ALL_TRANSPORTS(){return[ot,tn]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const t=tn&&tn.isAvailable();let o=t&&!tn.previouslyFailed();if(e.webSocketOnly&&(t||Me("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),o=!0),o)this.transports_=[tn];else{const i=this.transports_=[];for(const s of Ht.ALL_TRANSPORTS)s&&s.isAvailable()&&i.push(s);Ht.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}Ht.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q2=6e4,Y2=5e3,X2=10*1024,q2=100*1024,li="t",gr="d",J2="s",Ar="r",$2="e",_r="o",vr="a",Pr="n",Cr="p",Z2="h";class e0{constructor(e,t,o,i,s,r,l,a,d,m){this.id=e,this.repoInfo_=t,this.applicationId_=o,this.appCheckToken_=i,this.authToken_=s,this.onMessage_=r,this.onReady_=l,this.onDisconnect_=a,this.onKill_=d,this.lastSessionId=m,this.connectionCount=0,this.pendingDataMessages=[],this.state_=0,this.log_=Jt("c:"+this.id+":"),this.transportManager_=new Ht(t),this.log_("Connection created"),this.start_()}start_(){const e=this.transportManager_.initialTransport();this.conn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,null,this.lastSessionId),this.primaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const t=this.connReceiver_(this.conn_),o=this.disconnReceiver_(this.conn_);this.tx_=this.conn_,this.rx_=this.conn_,this.secondaryConn_=null,this.isHealthy_=!1,setTimeout(()=>{this.conn_&&this.conn_.open(t,o)},Math.floor(0));const i=e.healthyTimeout||0;i>0&&(this.healthyTimeout_=Dt(()=>{this.healthyTimeout_=null,this.isHealthy_||(this.conn_&&this.conn_.bytesReceived>q2?(this.log_("Connection exceeded healthy timeout but has received "+this.conn_.bytesReceived+" bytes.  Marking connection healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()):this.conn_&&this.conn_.bytesSent>X2?this.log_("Connection exceeded healthy timeout but has sent "+this.conn_.bytesSent+" bytes.  Leaving connection alive."):(this.log_("Closing unhealthy connection after timeout."),this.close()))},Math.floor(i)))}nextTransportId_(){return"c:"+this.id+":"+this.connectionCount++}disconnReceiver_(e){return t=>{e===this.conn_?this.onConnectionLost_(t):e===this.secondaryConn_?(this.log_("Secondary connection lost."),this.onSecondaryConnectionLost_()):this.log_("closing an old connection")}}connReceiver_(e){return t=>{this.state_!==2&&(e===this.rx_?this.onPrimaryMessageReceived_(t):e===this.secondaryConn_?this.onSecondaryMessageReceived_(t):this.log_("message on old connection"))}}sendRequest(e){const t={t:"d",d:e};this.sendData_(t)}tryCleanupConnection(){this.tx_===this.secondaryConn_&&this.rx_===this.secondaryConn_&&(this.log_("cleaning up and promoting a connection: "+this.secondaryConn_.connId),this.conn_=this.secondaryConn_,this.secondaryConn_=null)}onSecondaryControl_(e){if(li in e){const t=e[li];t===vr?this.upgradeIfSecondaryHealthy_():t===Ar?(this.log_("Got a reset on secondary, closing it"),this.secondaryConn_.close(),(this.tx_===this.secondaryConn_||this.rx_===this.secondaryConn_)&&this.close()):t===_r&&(this.log_("got pong on secondary."),this.secondaryResponsesRequired_--,this.upgradeIfSecondaryHealthy_())}}onSecondaryMessageReceived_(e){const t=Ct("t",e),o=Ct("d",e);if(t==="c")this.onSecondaryControl_(o);else if(t==="d")this.pendingDataMessages.push(o);else throw new Error("Unknown protocol layer: "+t)}upgradeIfSecondaryHealthy_(){this.secondaryResponsesRequired_<=0?(this.log_("Secondary connection is healthy."),this.isHealthy_=!0,this.secondaryConn_.markConnectionHealthy(),this.proceedWithUpgrade_()):(this.log_("sending ping on secondary."),this.secondaryConn_.send({t:"c",d:{t:Cr,d:{}}}))}proceedWithUpgrade_(){this.secondaryConn_.start(),this.log_("sending client ack on secondary"),this.secondaryConn_.send({t:"c",d:{t:vr,d:{}}}),this.log_("Ending transmission on primary"),this.conn_.send({t:"c",d:{t:Pr,d:{}}}),this.tx_=this.secondaryConn_,this.tryCleanupConnection()}onPrimaryMessageReceived_(e){const t=Ct("t",e),o=Ct("d",e);t==="c"?this.onControl_(o):t==="d"&&this.onDataMessage_(o)}onDataMessage_(e){this.onPrimaryResponse_(),this.onMessage_(e)}onPrimaryResponse_(){this.isHealthy_||(this.primaryResponsesRequired_--,this.primaryResponsesRequired_<=0&&(this.log_("Primary connection is healthy."),this.isHealthy_=!0,this.conn_.markConnectionHealthy()))}onControl_(e){const t=Ct(li,e);if(gr in e){const o=e[gr];if(t===Z2){const i={...o};this.repoInfo_.isUsingEmulator&&(i.h=this.repoInfo_.host),this.onHandshake_(i)}else if(t===Pr){this.log_("recvd end transmission on primary"),this.rx_=this.secondaryConn_;for(let i=0;i<this.pendingDataMessages.length;++i)this.onDataMessage_(this.pendingDataMessages[i]);this.pendingDataMessages=[],this.tryCleanupConnection()}else t===J2?this.onConnectionShutdown_(o):t===Ar?this.onReset_(o):t===$2?Ci("Server Error: "+o):t===_r?(this.log_("got pong on primary."),this.onPrimaryResponse_(),this.sendPingOnPrimaryIfNecessary_()):Ci("Unknown control packet command: "+t)}}onHandshake_(e){const t=e.ts,o=e.v,i=e.h;this.sessionId=e.s,this.repoInfo_.host=i,this.state_===0&&(this.conn_.start(),this.onConnectionEstablished_(this.conn_,t),es!==o&&Me("Protocol version mismatch detected"),this.tryStartUpgrade_())}tryStartUpgrade_(){const e=this.transportManager_.upgradeTransport();e&&this.startUpgrade_(e)}startUpgrade_(e){this.secondaryConn_=new e(this.nextTransportId_(),this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,this.sessionId),this.secondaryResponsesRequired_=e.responsesRequiredToBeHealthy||0;const t=this.connReceiver_(this.secondaryConn_),o=this.disconnReceiver_(this.secondaryConn_);this.secondaryConn_.open(t,o),Dt(()=>{this.secondaryConn_&&(this.log_("Timed out trying to upgrade."),this.secondaryConn_.close())},Math.floor(Q2))}onReset_(e){this.log_("Reset packet received.  New host: "+e),this.repoInfo_.host=e,this.state_===1?this.close():(this.closeConnections_(),this.start_())}onConnectionEstablished_(e,t){this.log_("Realtime connection established."),this.conn_=e,this.state_=1,this.onReady_&&(this.onReady_(t,this.sessionId),this.onReady_=null),this.primaryResponsesRequired_===0?(this.log_("Primary connection is healthy."),this.isHealthy_=!0):Dt(()=>{this.sendPingOnPrimaryIfNecessary_()},Math.floor(Y2))}sendPingOnPrimaryIfNecessary_(){!this.isHealthy_&&this.state_===1&&(this.log_("sending ping on primary."),this.sendData_({t:"c",d:{t:Cr,d:{}}}))}onSecondaryConnectionLost_(){const e=this.secondaryConn_;this.secondaryConn_=null,(this.tx_===e||this.rx_===e)&&this.close()}onConnectionLost_(e){this.conn_=null,!e&&this.state_===0?(this.log_("Realtime connection failed."),this.repoInfo_.isCacheableHost()&&(Wn.remove("host:"+this.repoInfo_.host),this.repoInfo_.internalHost=this.repoInfo_.host)):this.state_===1&&this.log_("Realtime connection lost."),this.close()}onConnectionShutdown_(e){this.log_("Connection shutdown command received. Shutting down..."),this.onKill_&&(this.onKill_(e),this.onKill_=null),this.onDisconnect_=null,this.close()}sendData_(e){if(this.state_!==1)throw"Connection is not connected";this.tx_.send(e)}close(){this.state_!==2&&(this.log_("Closing realtime connection."),this.state_=2,this.closeConnections_(),this.onDisconnect_&&(this.onDisconnect_(),this.onDisconnect_=null))}closeConnections_(){this.log_("Shutting down all connections"),this.conn_&&(this.conn_.close(),this.conn_=null),this.secondaryConn_&&(this.secondaryConn_.close(),this.secondaryConn_=null),this.healthyTimeout_&&(clearTimeout(this.healthyTimeout_),this.healthyTimeout_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class la{put(e,t,o,i){}merge(e,t,o,i){}refreshAuthToken(e){}refreshAppCheckToken(e){}onDisconnectPut(e,t,o){}onDisconnectMerge(e,t,o){}onDisconnectCancel(e,t){}reportStats(e){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo extends aa{static getInstance(){return new vo}constructor(){super(["online"]),this.online_=!0,typeof window!="undefined"&&typeof window.addEventListener!="undefined"&&!Sl()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return _(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ur=32,Er=768;class q{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let o=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[o]=this.pieces_[i],o++);this.pieces_.length=o,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function Q(){return new q("")}function L(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function Dn(n){return n.pieces_.length-n.pieceNum_}function oe(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new q(n.pieces_,e)}function os(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function n0(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function zt(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function ca(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new q(e,0)}function de(n,e){const t=[];for(let o=n.pieceNum_;o<n.pieces_.length;o++)t.push(n.pieces_[o]);if(e instanceof q)for(let o=e.pieceNum_;o<e.pieces_.length;o++)t.push(e.pieces_[o]);else{const o=e.split("/");for(let i=0;i<o.length;i++)o[i].length>0&&t.push(o[i])}return new q(t,0)}function F(n){return n.pieceNum_>=n.pieces_.length}function Re(n,e){const t=L(n),o=L(e);if(t===null)return e;if(t===o)return Re(oe(n),oe(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function t0(n,e){const t=zt(n,0),o=zt(e,0);for(let i=0;i<t.length&&i<o.length;i++){const s=Jn(t[i],o[i]);if(s!==0)return s}return t.length===o.length?0:t.length<o.length?-1:1}function is(n,e){if(Dn(n)!==Dn(e))return!1;for(let t=n.pieceNum_,o=e.pieceNum_;t<=n.pieces_.length;t++,o++)if(n.pieces_[t]!==e.pieces_[o])return!1;return!0}function Xe(n,e){let t=n.pieceNum_,o=e.pieceNum_;if(Dn(n)>Dn(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[o])return!1;++t,++o}return!0}class o0{constructor(e,t){this.errorPrefix_=t,this.parts_=zt(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let o=0;o<this.parts_.length;o++)this.byteLength_+=Mo(this.parts_[o]);da(this)}}function i0(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=Mo(e),da(n)}function s0(n){const e=n.parts_.pop();n.byteLength_-=Mo(e),n.parts_.length>0&&(n.byteLength_-=1)}function da(n){if(n.byteLength_>Er)throw new Error(n.errorPrefix_+"has a key path longer than "+Er+" bytes ("+n.byteLength_+").");if(n.parts_.length>Ur)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+Ur+") or object contains a cycle "+zn(n))}function zn(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ut=1e3,r0=60*5*1e3,Br=30*1e3,l0=1.3,a0=3e4,c0="server_kill",wr=3;class pn extends la{constructor(e,t,o,i,s,r,l,a){if(super(),this.repoInfo_=e,this.applicationId_=t,this.onDataUpdate_=o,this.onConnectStatus_=i,this.onServerInfoUpdate_=s,this.authTokenProvider_=r,this.appCheckTokenProvider_=l,this.authOverride_=a,this.id=pn.nextPersistentConnectionId_++,this.log_=Jt("p:"+this.id+":"),this.interruptReasons_={},this.listens=new Map,this.outstandingPuts_=[],this.outstandingGets_=[],this.outstandingPutCount_=0,this.outstandingGetCount_=0,this.onDisconnectRequestQueue_=[],this.connected_=!1,this.reconnectDelay_=Ut,this.maxReconnectDelay_=r0,this.securityDebugCallback_=null,this.lastSessionId=null,this.establishConnectionTimer_=null,this.visible_=!1,this.requestCBHash_={},this.requestNumber_=0,this.realtime_=null,this.authToken_=null,this.appCheckToken_=null,this.forceTokenRefresh_=!1,this.invalidAuthTokenCount_=0,this.invalidAppCheckTokenCount_=0,this.firstConnection_=!0,this.lastConnectionAttemptTime_=null,this.lastConnectionEstablishedTime_=null,a&&!kl())throw new Error("Auth override specified in options, but not supported on non Node.js platforms");ss.getInstance().on("visible",this.onVisible_,this),e.host.indexOf("fblocal")===-1&&vo.getInstance().on("online",this.onOnline_,this)}sendRequest(e,t,o){const i=++this.requestNumber_,s={r:i,a:e,b:t};this.log_(Pe(s)),_(this.connected_,"sendRequest call when we're not connected not allowed."),this.realtime_.sendRequest(s),o&&(this.requestCBHash_[i]=o)}get(e){this.initConnection_();const t=new Yt,i={action:"g",request:{p:e._path.toString(),q:e._queryObject},onComplete:r=>{const l=r.d;r.s==="ok"?t.resolve(l):t.reject(l)}};this.outstandingGets_.push(i),this.outstandingGetCount_++;const s=this.outstandingGets_.length-1;return this.connected_&&this.sendGet_(s),t.promise}listen(e,t,o,i){this.initConnection_();const s=e._queryIdentifier,r=e._path.toString();this.log_("Listen called for "+r+" "+s),this.listens.has(r)||this.listens.set(r,new Map),_(e._queryParams.isDefault()||!e._queryParams.loadsAllData(),"listen() called for non-default but complete query"),_(!this.listens.get(r).has(s),"listen() called twice for same path/queryId.");const l={onComplete:i,hashFn:t,query:e,tag:o};this.listens.get(r).set(s,l),this.connected_&&this.sendListen_(l)}sendGet_(e){const t=this.outstandingGets_[e];this.sendRequest("g",t.request,o=>{delete this.outstandingGets_[e],this.outstandingGetCount_--,this.outstandingGetCount_===0&&(this.outstandingGets_=[]),t.onComplete&&t.onComplete(o)})}sendListen_(e){const t=e.query,o=t._path.toString(),i=t._queryIdentifier;this.log_("Listen on "+o+" for "+i);const s={p:o},r="q";e.tag&&(s.q=t._queryObject,s.t=e.tag),s.h=e.hashFn(),this.sendRequest(r,s,l=>{const a=l.d,d=l.s;pn.warnOnListenWarnings_(a,t),(this.listens.get(o)&&this.listens.get(o).get(i))===e&&(this.log_("listen response",l),d!=="ok"&&this.removeListen_(o,i),e.onComplete&&e.onComplete(d,a))})}static warnOnListenWarnings_(e,t){if(e&&typeof e=="object"&&hn(e,"w")){const o=lt(e,"w");if(Array.isArray(o)&&~o.indexOf("no_index")){const i='".indexOn": "'+t._queryParams.getIndex().toString()+'"',s=t._path.toString();Me(`Using an unspecified index. Your data will be downloaded and filtered on the client. Consider adding ${i} at ${s} to your security rules for better performance.`)}}}refreshAuthToken(e){this.authToken_=e,this.log_("Auth token refreshed"),this.authToken_?this.tryAuth():this.connected_&&this.sendRequest("unauth",{},()=>{}),this.reduceReconnectDelayIfAdminCredential_(e)}reduceReconnectDelayIfAdminCredential_(e){(e&&e.length===40||Xd(e))&&(this.log_("Admin auth credential detected.  Reducing max reconnect time."),this.maxReconnectDelay_=Br)}refreshAppCheckToken(e){this.appCheckToken_=e,this.log_("App check token refreshed"),this.appCheckToken_?this.tryAppCheck():this.connected_&&this.sendRequest("unappeck",{},()=>{})}tryAuth(){if(this.connected_&&this.authToken_){const e=this.authToken_,t=Yd(e)?"auth":"gauth",o={cred:e};this.authOverride_===null?o.noauth=!0:typeof this.authOverride_=="object"&&(o.authvar=this.authOverride_),this.sendRequest(t,o,i=>{const s=i.s,r=i.d||"error";this.authToken_===e&&(s==="ok"?this.invalidAuthTokenCount_=0:this.onAuthRevoked_(s,r))})}}tryAppCheck(){this.connected_&&this.appCheckToken_&&this.sendRequest("appcheck",{token:this.appCheckToken_},e=>{const t=e.s,o=e.d||"error";t==="ok"?this.invalidAppCheckTokenCount_=0:this.onAppCheckRevoked_(t,o)})}unlisten(e,t){const o=e._path.toString(),i=e._queryIdentifier;this.log_("Unlisten called for "+o+" "+i),_(e._queryParams.isDefault()||!e._queryParams.loadsAllData(),"unlisten() called for non-default but complete query"),this.removeListen_(o,i)&&this.connected_&&this.sendUnlisten_(o,i,e._queryObject,t)}sendUnlisten_(e,t,o,i){this.log_("Unlisten on "+e+" for "+t);const s={p:e},r="n";i&&(s.q=o,s.t=i),this.sendRequest(r,s)}onDisconnectPut(e,t,o){this.initConnection_(),this.connected_?this.sendOnDisconnect_("o",e,t,o):this.onDisconnectRequestQueue_.push({pathString:e,action:"o",data:t,onComplete:o})}onDisconnectMerge(e,t,o){this.initConnection_(),this.connected_?this.sendOnDisconnect_("om",e,t,o):this.onDisconnectRequestQueue_.push({pathString:e,action:"om",data:t,onComplete:o})}onDisconnectCancel(e,t){this.initConnection_(),this.connected_?this.sendOnDisconnect_("oc",e,null,t):this.onDisconnectRequestQueue_.push({pathString:e,action:"oc",data:null,onComplete:t})}sendOnDisconnect_(e,t,o,i){const s={p:t,d:o};this.log_("onDisconnect "+e,s),this.sendRequest(e,s,r=>{i&&setTimeout(()=>{i(r.s,r.d)},Math.floor(0))})}put(e,t,o,i){this.putInternal("p",e,t,o,i)}merge(e,t,o,i){this.putInternal("m",e,t,o,i)}putInternal(e,t,o,i,s){this.initConnection_();const r={p:t,d:o};s!==void 0&&(r.h=s),this.outstandingPuts_.push({action:e,request:r,onComplete:i}),this.outstandingPutCount_++;const l=this.outstandingPuts_.length-1;this.connected_?this.sendPut_(l):this.log_("Buffering put: "+t)}sendPut_(e){const t=this.outstandingPuts_[e].action,o=this.outstandingPuts_[e].request,i=this.outstandingPuts_[e].onComplete;this.outstandingPuts_[e].queued=this.connected_,this.sendRequest(t,o,s=>{this.log_(t+" response",s),delete this.outstandingPuts_[e],this.outstandingPutCount_--,this.outstandingPutCount_===0&&(this.outstandingPuts_=[]),i&&i(s.s,s.d)})}reportStats(e){if(this.connected_){const t={c:e};this.log_("reportStats",t),this.sendRequest("s",t,o=>{if(o.s!=="ok"){const s=o.d;this.log_("reportStats","Error sending stats: "+s)}})}}onDataMessage_(e){if("r"in e){this.log_("from server: "+Pe(e));const t=e.r,o=this.requestCBHash_[t];o&&(delete this.requestCBHash_[t],o(e.b))}else{if("error"in e)throw"A server-side error has occurred: "+e.error;"a"in e&&this.onDataPush_(e.a,e.b)}}onDataPush_(e,t){this.log_("handleServerMessage",e,t),e==="d"?this.onDataUpdate_(t.p,t.d,!1,t.t):e==="m"?this.onDataUpdate_(t.p,t.d,!0,t.t):e==="c"?this.onListenRevoked_(t.p,t.q):e==="ac"?this.onAuthRevoked_(t.s,t.d):e==="apc"?this.onAppCheckRevoked_(t.s,t.d):e==="sd"?this.onSecurityDebugPacket_(t):Ci("Unrecognized action received from server: "+Pe(e)+`
Are you using the latest client?`)}onReady_(e,t){this.log_("connection ready"),this.connected_=!0,this.lastConnectionEstablishedTime_=new Date().getTime(),this.handleTimestamp_(e),this.lastSessionId=t,this.firstConnection_&&this.sendConnectStats_(),this.restoreState_(),this.firstConnection_=!1,this.onConnectStatus_(!0)}scheduleConnect_(e){_(!this.realtime_,"Scheduling a connect when we're already connected/ing?"),this.establishConnectionTimer_&&clearTimeout(this.establishConnectionTimer_),this.establishConnectionTimer_=setTimeout(()=>{this.establishConnectionTimer_=null,this.establishConnection_()},Math.floor(e))}initConnection_(){!this.realtime_&&this.firstConnection_&&this.scheduleConnect_(0)}onVisible_(e){e&&!this.visible_&&this.reconnectDelay_===this.maxReconnectDelay_&&(this.log_("Window became visible.  Reducing delay."),this.reconnectDelay_=Ut,this.realtime_||this.scheduleConnect_(0)),this.visible_=e}onOnline_(e){e?(this.log_("Browser went online."),this.reconnectDelay_=Ut,this.realtime_||this.scheduleConnect_(0)):(this.log_("Browser went offline.  Killing connection."),this.realtime_&&this.realtime_.close())}onRealtimeDisconnect_(){if(this.log_("data client disconnected"),this.connected_=!1,this.realtime_=null,this.cancelSentTransactions_(),this.requestCBHash_={},this.shouldReconnect_()){this.visible_?this.lastConnectionEstablishedTime_&&(new Date().getTime()-this.lastConnectionEstablishedTime_>a0&&(this.reconnectDelay_=Ut),this.lastConnectionEstablishedTime_=null):(this.log_("Window isn't visible.  Delaying reconnect."),this.reconnectDelay_=this.maxReconnectDelay_,this.lastConnectionAttemptTime_=new Date().getTime());const e=Math.max(0,new Date().getTime()-this.lastConnectionAttemptTime_);let t=Math.max(0,this.reconnectDelay_-e);t=Math.random()*t,this.log_("Trying to reconnect in "+t+"ms"),this.scheduleConnect_(t),this.reconnectDelay_=Math.min(this.maxReconnectDelay_,this.reconnectDelay_*l0)}this.onConnectStatus_(!1)}async establishConnection_(){if(this.shouldReconnect_()){this.log_("Making a connection attempt"),this.lastConnectionAttemptTime_=new Date().getTime(),this.lastConnectionEstablishedTime_=null;const e=this.onDataMessage_.bind(this),t=this.onReady_.bind(this),o=this.onRealtimeDisconnect_.bind(this),i=this.id+":"+pn.nextConnectionId_++,s=this.lastSessionId;let r=!1,l=null;const a=function(){l?l.close():(r=!0,o())},d=function(h){_(l,"sendRequest call when we're not connected not allowed."),l.sendRequest(h)};this.realtime_={close:a,sendRequest:d};const m=this.forceTokenRefresh_;this.forceTokenRefresh_=!1;try{const[h,f]=await Promise.all([this.authTokenProvider_.getToken(m),this.appCheckTokenProvider_.getToken(m)]);r?we("getToken() completed but was canceled"):(we("getToken() completed. Creating connection."),this.authToken_=h&&h.accessToken,this.appCheckToken_=f&&f.token,l=new e0(i,this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,e,t,o,b=>{Me(b+" ("+this.repoInfo_.toString()+")"),this.interrupt(c0)},s))}catch(h){this.log_("Failed to get token: "+h),r||(this.repoInfo_.nodeAdmin&&Me(h),a())}}}interrupt(e){we("Interrupting connection for reason: "+e),this.interruptReasons_[e]=!0,this.realtime_?this.realtime_.close():(this.establishConnectionTimer_&&(clearTimeout(this.establishConnectionTimer_),this.establishConnectionTimer_=null),this.connected_&&this.onRealtimeDisconnect_())}resume(e){we("Resuming connection for reason: "+e),delete this.interruptReasons_[e],tr(this.interruptReasons_)&&(this.reconnectDelay_=Ut,this.realtime_||this.scheduleConnect_(0))}handleTimestamp_(e){const t=e-new Date().getTime();this.onServerInfoUpdate_({serverTimeOffset:t})}cancelSentTransactions_(){for(let e=0;e<this.outstandingPuts_.length;e++){const t=this.outstandingPuts_[e];t&&"h"in t.request&&t.queued&&(t.onComplete&&t.onComplete("disconnect"),delete this.outstandingPuts_[e],this.outstandingPutCount_--)}this.outstandingPutCount_===0&&(this.outstandingPuts_=[])}onListenRevoked_(e,t){let o;t?o=t.map(s=>Zi(s)).join("$"):o="default";const i=this.removeListen_(e,o);i&&i.onComplete&&i.onComplete("permission_denied")}removeListen_(e,t){const o=new q(e).toString();let i;if(this.listens.has(o)){const s=this.listens.get(o);i=s.get(t),s.delete(t),s.size===0&&this.listens.delete(o)}else i=void 0;return i}onAuthRevoked_(e,t){we("Auth token revoked: "+e+"/"+t),this.authToken_=null,this.forceTokenRefresh_=!0,this.realtime_.close(),(e==="invalid_token"||e==="permission_denied")&&(this.invalidAuthTokenCount_++,this.invalidAuthTokenCount_>=wr&&(this.reconnectDelay_=Br,this.authTokenProvider_.notifyForInvalidToken()))}onAppCheckRevoked_(e,t){we("App check token revoked: "+e+"/"+t),this.appCheckToken_=null,this.forceTokenRefresh_=!0,(e==="invalid_token"||e==="permission_denied")&&(this.invalidAppCheckTokenCount_++,this.invalidAppCheckTokenCount_>=wr&&this.appCheckTokenProvider_.notifyForInvalidToken())}onSecurityDebugPacket_(e){this.securityDebugCallback_?this.securityDebugCallback_(e):"msg"in e}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const t of e.values())this.sendListen_(t);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let t="js";e["sdk."+t+"."+Hl.replace(/\./g,"-")]=1,Sl()?e["framework.cordova"]=1:Vd()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=vo.getInstance().currentlyOnline();return tr(this.interruptReasons_)&&e}}pn.nextPersistentConnectionId_=0;pn.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ro{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const o=new H(Gn,e),i=new H(Gn,t);return this.compare(o,i)!==0}minPost(){return H.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let so;class ha extends Ro{static get __EMPTY_NODE(){return so}static set __EMPTY_NODE(e){so=e}compare(e,t){return Jn(e.name,t.name)}isDefinedOn(e){throw pt("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return H.MIN}maxPost(){return new H(kn,so)}makePost(e,t){return _(typeof e=="string","KeyIndex indexValue must always be a string."),new H(e,so)}toString(){return".key"}}const jn=new ha;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ro{constructor(e,t,o,i,s=null){this.isReverse_=i,this.resultGenerator_=s,this.nodeStack_=[];let r=1;for(;!e.isEmpty();)if(e=e,r=t?o(e.key,t):1,i&&(r*=-1),r<0)this.isReverse_?e=e.left:e=e.right;else if(r===0){this.nodeStack_.push(e);break}else this.nodeStack_.push(e),this.isReverse_?e=e.right:e=e.left}getNext(){if(this.nodeStack_.length===0)return null;let e=this.nodeStack_.pop(),t;if(this.resultGenerator_?t=this.resultGenerator_(e.key,e.value):t={key:e.key,value:e.value},this.isReverse_)for(e=e.left;!e.isEmpty();)this.nodeStack_.push(e),e=e.right;else for(e=e.right;!e.isEmpty();)this.nodeStack_.push(e),e=e.left;return t}hasNext(){return this.nodeStack_.length>0}peek(){if(this.nodeStack_.length===0)return null;const e=this.nodeStack_[this.nodeStack_.length-1];return this.resultGenerator_?this.resultGenerator_(e.key,e.value):{key:e.key,value:e.value}}}class _e{constructor(e,t,o,i,s){this.key=e,this.value=t,this.color=o!=null?o:_e.RED,this.left=i!=null?i:Oe.EMPTY_NODE,this.right=s!=null?s:Oe.EMPTY_NODE}copy(e,t,o,i,s){return new _e(e!=null?e:this.key,t!=null?t:this.value,o!=null?o:this.color,i!=null?i:this.left,s!=null?s:this.right)}count(){return this.left.count()+1+this.right.count()}isEmpty(){return!1}inorderTraversal(e){return this.left.inorderTraversal(e)||!!e(this.key,this.value)||this.right.inorderTraversal(e)}reverseTraversal(e){return this.right.reverseTraversal(e)||e(this.key,this.value)||this.left.reverseTraversal(e)}min_(){return this.left.isEmpty()?this:this.left.min_()}minKey(){return this.min_().key}maxKey(){return this.right.isEmpty()?this.key:this.right.maxKey()}insert(e,t,o){let i=this;const s=o(e,i.key);return s<0?i=i.copy(null,null,null,i.left.insert(e,t,o),null):s===0?i=i.copy(null,t,null,null,null):i=i.copy(null,null,null,null,i.right.insert(e,t,o)),i.fixUp_()}removeMin_(){if(this.left.isEmpty())return Oe.EMPTY_NODE;let e=this;return!e.left.isRed_()&&!e.left.left.isRed_()&&(e=e.moveRedLeft_()),e=e.copy(null,null,null,e.left.removeMin_(),null),e.fixUp_()}remove(e,t){let o,i;if(o=this,t(e,o.key)<0)!o.left.isEmpty()&&!o.left.isRed_()&&!o.left.left.isRed_()&&(o=o.moveRedLeft_()),o=o.copy(null,null,null,o.left.remove(e,t),null);else{if(o.left.isRed_()&&(o=o.rotateRight_()),!o.right.isEmpty()&&!o.right.isRed_()&&!o.right.left.isRed_()&&(o=o.moveRedRight_()),t(e,o.key)===0){if(o.right.isEmpty())return Oe.EMPTY_NODE;i=o.right.min_(),o=o.copy(i.key,i.value,null,null,o.right.removeMin_())}o=o.copy(null,null,null,null,o.right.remove(e,t))}return o.fixUp_()}isRed_(){return this.color}fixUp_(){let e=this;return e.right.isRed_()&&!e.left.isRed_()&&(e=e.rotateLeft_()),e.left.isRed_()&&e.left.left.isRed_()&&(e=e.rotateRight_()),e.left.isRed_()&&e.right.isRed_()&&(e=e.colorFlip_()),e}moveRedLeft_(){let e=this.colorFlip_();return e.right.left.isRed_()&&(e=e.copy(null,null,null,null,e.right.rotateRight_()),e=e.rotateLeft_(),e=e.colorFlip_()),e}moveRedRight_(){let e=this.colorFlip_();return e.left.left.isRed_()&&(e=e.rotateRight_(),e=e.colorFlip_()),e}rotateLeft_(){const e=this.copy(null,null,_e.RED,null,this.right.left);return this.right.copy(null,null,this.color,e,null)}rotateRight_(){const e=this.copy(null,null,_e.RED,this.left.right,null);return this.left.copy(null,null,this.color,null,e)}colorFlip_(){const e=this.left.copy(null,null,!this.left.color,null,null),t=this.right.copy(null,null,!this.right.color,null,null);return this.copy(null,null,!this.color,e,t)}checkMaxDepth_(){const e=this.check_();return Math.pow(2,e)<=this.count()+1}check_(){if(this.isRed_()&&this.left.isRed_())throw new Error("Red node has red child("+this.key+","+this.value+")");if(this.right.isRed_())throw new Error("Right child of ("+this.key+","+this.value+") is red");const e=this.left.check_();if(e!==this.right.check_())throw new Error("Black depths differ");return e+(this.isRed_()?0:1)}}_e.RED=!0;_e.BLACK=!1;class d0{copy(e,t,o,i,s){return this}insert(e,t,o){return new _e(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}}class Oe{constructor(e,t=Oe.EMPTY_NODE){this.comparator_=e,this.root_=t}insert(e,t){return new Oe(this.comparator_,this.root_.insert(e,t,this.comparator_).copy(null,null,_e.BLACK,null,null))}remove(e){return new Oe(this.comparator_,this.root_.remove(e,this.comparator_).copy(null,null,_e.BLACK,null,null))}get(e){let t,o=this.root_;for(;!o.isEmpty();){if(t=this.comparator_(e,o.key),t===0)return o.value;t<0?o=o.left:t>0&&(o=o.right)}return null}getPredecessorKey(e){let t,o=this.root_,i=null;for(;!o.isEmpty();)if(t=this.comparator_(e,o.key),t===0){if(o.left.isEmpty())return i?i.key:null;for(o=o.left;!o.right.isEmpty();)o=o.right;return o.key}else t<0?o=o.left:t>0&&(i=o,o=o.right);throw new Error("Attempted to find predecessor key for a nonexistent key.  What gives?")}isEmpty(){return this.root_.isEmpty()}count(){return this.root_.count()}minKey(){return this.root_.minKey()}maxKey(){return this.root_.maxKey()}inorderTraversal(e){return this.root_.inorderTraversal(e)}reverseTraversal(e){return this.root_.reverseTraversal(e)}getIterator(e){return new ro(this.root_,null,this.comparator_,!1,e)}getIteratorFrom(e,t){return new ro(this.root_,e,this.comparator_,!1,t)}getReverseIteratorFrom(e,t){return new ro(this.root_,e,this.comparator_,!0,t)}getReverseIterator(e){return new ro(this.root_,null,this.comparator_,!0,e)}}Oe.EMPTY_NODE=new d0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function h0(n,e){return Jn(n.name,e.name)}function rs(n,e){return Jn(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ei;function u0(n){Ei=n}const ua=function(n){return typeof n=="number"?"number:"+jl(n):"string:"+n},ma=function(n){if(n.isLeafNode()){const e=n.val();_(typeof e=="string"||typeof e=="number"||typeof e=="object"&&hn(e,".sv"),"Priority must be a string or number.")}else _(n===Ei||n.isEmpty(),"priority of unexpected type.");_(n===Ei||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ir;class Ae{static set __childrenNodeConstructor(e){Ir=e}static get __childrenNodeConstructor(){return Ir}constructor(e,t=Ae.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,_(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),ma(this.priorityNode_)}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new Ae(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:Ae.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return F(e)?this:L(e)===".priority"?this.priorityNode_:Ae.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return e===".priority"?this.updatePriority(t):t.isEmpty()&&e!==".priority"?this:Ae.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const o=L(e);return o===null?t:t.isEmpty()&&o!==".priority"?this:(_(o!==".priority"||Dn(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(o,Ae.__childrenNodeConstructor.EMPTY_NODE.updateChild(oe(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+ua(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",t==="number"?e+=jl(this.value_):e+=this.value_,this.lazyHash_=Vl(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===Ae.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof Ae.__childrenNodeConstructor?-1:(_(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,o=typeof this.value_,i=Ae.VALUE_TYPE_ORDER.indexOf(t),s=Ae.VALUE_TYPE_ORDER.indexOf(o);return _(i>=0,"Unknown leaf type: "+t),_(s>=0,"Unknown leaf type: "+o),i===s?o==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:s-i}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}else return!1}}Ae.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let pa,fa;function m0(n){pa=n}function p0(n){fa=n}class f0 extends Ro{compare(e,t){const o=e.node.getPriority(),i=t.node.getPriority(),s=o.compareTo(i);return s===0?Jn(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return H.MIN}maxPost(){return new H(kn,new Ae("[PRIORITY-POST]",fa))}makePost(e,t){const o=pa(e);return new H(t,new Ae("[PRIORITY-POST]",o))}toString(){return".priority"}}const ae=new f0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const y0=Math.log(2);class b0{constructor(e){const t=s=>parseInt(Math.log(s)/y0,10),o=s=>parseInt(Array(s+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=o(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Po=function(n,e,t,o){n.sort(e);const i=function(a,d){const m=d-a;let h,f;if(m===0)return null;if(m===1)return h=n[a],f=t?t(h):h,new _e(f,h.node,_e.BLACK,null,null);{const b=parseInt(m/2,10)+a,g=i(a,b),B=i(b+1,d);return h=n[b],f=t?t(h):h,new _e(f,h.node,_e.BLACK,g,B)}},s=function(a){let d=null,m=null,h=n.length;const f=function(g,B){const D=h-g,U=h;h-=g;const W=i(D+1,U),T=n[D],G=t?t(T):T;b(new _e(G,T.node,B,null,W))},b=function(g){d?(d.left=g,d=g):(m=g,d=g)};for(let g=0;g<a.count;++g){const B=a.nextBitIsOne(),D=Math.pow(2,a.count-(g+1));B?f(D,_e.BLACK):(f(D,_e.BLACK),f(D,_e.RED))}return m},r=new b0(n.length),l=s(r);return new Oe(o||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ai;const nt={};class mn{static get Default(){return _(nt&&ae,"ChildrenNode.ts has not been loaded"),ai=ai||new mn({".priority":nt},{".priority":ae}),ai}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=lt(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Oe?t:null}hasIndex(e){return hn(this.indexSet_,e.toString())}addIndex(e,t){_(e!==jn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const o=[];let i=!1;const s=t.getIterator(H.Wrap);let r=s.getNext();for(;r;)i=i||e.isDefinedOn(r.node),o.push(r),r=s.getNext();let l;i?l=Po(o,e.getCompare()):l=nt;const a=e.toString(),d={...this.indexSet_};d[a]=e;const m={...this.indexes_};return m[a]=l,new mn(m,d)}addToIndexes(e,t){const o=yo(this.indexes_,(i,s)=>{const r=lt(this.indexSet_,s);if(_(r,"Missing index implementation for "+s),i===nt)if(r.isDefinedOn(e.node)){const l=[],a=t.getIterator(H.Wrap);let d=a.getNext();for(;d;)d.name!==e.name&&l.push(d),d=a.getNext();return l.push(e),Po(l,r.getCompare())}else return nt;else{const l=t.get(e.name);let a=i;return l&&(a=a.remove(new H(e.name,l))),a.insert(e,e.node)}});return new mn(o,this.indexSet_)}removeFromIndexes(e,t){const o=yo(this.indexes_,i=>{if(i===nt)return i;{const s=t.get(e.name);return s?i.remove(new H(e.name,s)):i}});return new mn(o,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Et;class N{static get EMPTY_NODE(){return Et||(Et=new N(new Oe(rs),null,mn.Default))}constructor(e,t,o){this.children_=e,this.priorityNode_=t,this.indexMap_=o,this.lazyHash_=null,this.priorityNode_&&ma(this.priorityNode_),this.children_.isEmpty()&&_(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}isLeafNode(){return!1}getPriority(){return this.priorityNode_||Et}updatePriority(e){return this.children_.isEmpty()?this:new N(this.children_,e,this.indexMap_)}getImmediateChild(e){if(e===".priority")return this.getPriority();{const t=this.children_.get(e);return t===null?Et:t}}getChild(e){const t=L(e);return t===null?this:this.getImmediateChild(t).getChild(oe(e))}hasChild(e){return this.children_.get(e)!==null}updateImmediateChild(e,t){if(_(t,"We should always be passing snapshot nodes"),e===".priority")return this.updatePriority(t);{const o=new H(e,t);let i,s;t.isEmpty()?(i=this.children_.remove(e),s=this.indexMap_.removeFromIndexes(o,this.children_)):(i=this.children_.insert(e,t),s=this.indexMap_.addToIndexes(o,this.children_));const r=i.isEmpty()?Et:this.priorityNode_;return new N(i,r,s)}}updateChild(e,t){const o=L(e);if(o===null)return t;{_(L(e)!==".priority"||Dn(e)===1,".priority must be the last token in a path");const i=this.getImmediateChild(o).updateChild(oe(e),t);return this.updateImmediateChild(o,i)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let o=0,i=0,s=!0;if(this.forEachChild(ae,(r,l)=>{t[r]=l.val(e),o++,s&&N.INTEGER_REGEXP_.test(r)?i=Math.max(i,Number(r)):s=!1}),!e&&s&&i<2*o){const r=[];for(const l in t)r[l]=t[l];return r}else return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(this.lazyHash_===null){let e="";this.getPriority().isEmpty()||(e+="priority:"+ua(this.getPriority().val())+":"),this.forEachChild(ae,(t,o)=>{const i=o.hash();i!==""&&(e+=":"+t+":"+i)}),this.lazyHash_=e===""?"":Vl(e)}return this.lazyHash_}getPredecessorChildName(e,t,o){const i=this.resolveIndex_(o);if(i){const s=i.getPredecessorKey(new H(e,t));return s?s.name:null}else return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const o=t.minKey();return o&&o.name}else return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new H(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const o=t.maxKey();return o&&o.name}else return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new H(t,this.children_.get(t)):null}forEachChild(e,t){const o=this.resolveIndex_(e);return o?o.inorderTraversal(i=>t(i.name,i.node)):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const o=this.resolveIndex_(t);if(o)return o.getIteratorFrom(e,i=>i);{const i=this.children_.getIteratorFrom(e.name,H.Wrap);let s=i.peek();for(;s!=null&&t.compare(s,e)<0;)i.getNext(),s=i.peek();return i}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const o=this.resolveIndex_(t);if(o)return o.getReverseIteratorFrom(e,i=>i);{const i=this.children_.getReverseIteratorFrom(e.name,H.Wrap);let s=i.peek();for(;s!=null&&t.compare(s,e)>0;)i.getNext(),s=i.peek();return i}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===$t?-1:0}withIndex(e){if(e===jn||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new N(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===jn||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority()))if(this.children_.count()===t.children_.count()){const o=this.getIterator(ae),i=t.getIterator(ae);let s=o.getNext(),r=i.getNext();for(;s&&r;){if(s.name!==r.name||!s.node.equals(r.node))return!1;s=o.getNext(),r=i.getNext()}return s===null&&r===null}else return!1;else return!1}}resolveIndex_(e){return e===jn?null:this.indexMap_.get(e.toString())}}N.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;class g0 extends N{constructor(){super(new Oe(rs),N.EMPTY_NODE,mn.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return N.EMPTY_NODE}isEmpty(){return!1}}const $t=new g0;Object.defineProperties(H,{MIN:{value:new H(Gn,N.EMPTY_NODE)},MAX:{value:new H(kn,$t)}});ha.__EMPTY_NODE=N.EMPTY_NODE;Ae.__childrenNodeConstructor=N;u0($t);p0($t);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A0=!0;function ve(n,e=null){if(n===null)return N.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),_(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new Ae(t,ve(e))}if(!(n instanceof Array)&&A0){const t=[];let o=!1;if(Ie(n,(r,l)=>{if(r.substring(0,1)!=="."){const a=ve(l);a.isEmpty()||(o=o||!a.getPriority().isEmpty(),t.push(new H(r,a)))}}),t.length===0)return N.EMPTY_NODE;const s=Po(t,h0,r=>r.name,rs);if(o){const r=Po(t,ae.getCompare());return new N(s,ve(e),new mn({".priority":r},{".priority":ae}))}else return new N(s,ve(e),mn.Default)}else{let t=N.EMPTY_NODE;return Ie(n,(o,i)=>{if(hn(n,o)&&o.substring(0,1)!=="."){const s=ve(i);(s.isLeafNode()||!s.isEmpty())&&(t=t.updateImmediateChild(o,s))}}),t.updatePriority(ve(e))}}m0(ve);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ls extends Ro{constructor(e){super(),this.indexPath_=e,_(!F(e)&&L(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const o=this.extractChild(e.node),i=this.extractChild(t.node),s=o.compareTo(i);return s===0?Jn(e.name,t.name):s}makePost(e,t){const o=ve(e),i=N.EMPTY_NODE.updateChild(this.indexPath_,o);return new H(t,i)}maxPost(){const e=N.EMPTY_NODE.updateChild(this.indexPath_,$t);return new H(kn,e)}toString(){return zt(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _0 extends Ro{compare(e,t){const o=e.node.compareTo(t.node);return o===0?Jn(e.name,t.name):o}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return H.MIN}maxPost(){return H.MAX}makePost(e,t){const o=ve(e);return new H(t,o)}toString(){return".value"}}const ya=new _0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ba(n){return{type:"value",snapshotNode:n}}function at(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function Vt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Wt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function v0(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class as{constructor(e){this.index_=e}updateChild(e,t,o,i,s,r){_(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(t);return l.getChild(i).equals(o.getChild(i))&&l.isEmpty()===o.isEmpty()||(r!=null&&(o.isEmpty()?e.hasChild(t)?r.trackChildChange(Vt(t,l)):_(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?r.trackChildChange(at(t,o)):r.trackChildChange(Wt(t,o,l))),e.isLeafNode()&&o.isEmpty())?e:e.updateImmediateChild(t,o).withIndex(this.index_)}updateFullNode(e,t,o){return o!=null&&(e.isLeafNode()||e.forEachChild(ae,(i,s)=>{t.hasChild(i)||o.trackChildChange(Vt(i,s))}),t.isLeafNode()||t.forEachChild(ae,(i,s)=>{if(e.hasChild(i)){const r=e.getImmediateChild(i);r.equals(s)||o.trackChildChange(Wt(i,s,r))}else o.trackChildChange(at(i,s))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?N.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class P0{constructor(e){this.withinDirectionalStart=t=>this.reverse_?this.withinEndPost(t):this.withinStartPost(t),this.withinDirectionalEnd=t=>this.reverse_?this.withinStartPost(t):this.withinEndPost(t),this.withinStartPost=t=>{const o=this.index_.compare(this.rangedFilter_.getStartPost(),t);return this.startIsInclusive_?o<=0:o<0},this.withinEndPost=t=>{const o=this.index_.compare(t,this.rangedFilter_.getEndPost());return this.endIsInclusive_?o<=0:o<0},this.rangedFilter_=new jt(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft(),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}updateChild(e,t,o,i,s,r){return this.rangedFilter_.matches(new H(t,o))||(o=N.EMPTY_NODE),e.getImmediateChild(t).equals(o)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,o,i,s,r):this.fullLimitUpdateChild_(e,t,o,s,r)}updateFullNode(e,t,o){let i;if(t.isLeafNode()||t.isEmpty())i=N.EMPTY_NODE.withIndex(this.index_);else if(this.limit_*2<t.numChildren()&&t.isIndexed(this.index_)){i=N.EMPTY_NODE.withIndex(this.index_);let s;this.reverse_?s=t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):s=t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let r=0;for(;s.hasNext()&&r<this.limit_;){const l=s.getNext();if(this.withinDirectionalStart(l))if(this.withinDirectionalEnd(l))i=i.updateImmediateChild(l.name,l.node),r++;else break;else continue}}else{i=t.withIndex(this.index_),i=i.updatePriority(N.EMPTY_NODE);let s;this.reverse_?s=i.getReverseIterator(this.index_):s=i.getIterator(this.index_);let r=0;for(;s.hasNext();){const l=s.getNext();r<this.limit_&&this.withinDirectionalStart(l)&&this.withinDirectionalEnd(l)?r++:i=i.updateImmediateChild(l.name,N.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,i,o)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,t,o,i,s){let r;if(this.reverse_){const h=this.index_.getCompare();r=(f,b)=>h(b,f)}else r=this.index_.getCompare();const l=e;_(l.numChildren()===this.limit_,"");const a=new H(t,o),d=this.reverse_?l.getFirstChild(this.index_):l.getLastChild(this.index_),m=this.rangedFilter_.matches(a);if(l.hasChild(t)){const h=l.getImmediateChild(t);let f=i.getChildAfterChild(this.index_,d,this.reverse_);for(;f!=null&&(f.name===t||l.hasChild(f.name));)f=i.getChildAfterChild(this.index_,f,this.reverse_);const b=f==null?1:r(f,a);if(m&&!o.isEmpty()&&b>=0)return s!=null&&s.trackChildChange(Wt(t,o,h)),l.updateImmediateChild(t,o);{s!=null&&s.trackChildChange(Vt(t,h));const B=l.updateImmediateChild(t,N.EMPTY_NODE);return f!=null&&this.rangedFilter_.matches(f)?(s!=null&&s.trackChildChange(at(f.name,f.node)),B.updateImmediateChild(f.name,f.node)):B}}else return o.isEmpty()?e:m&&r(d,a)>=0?(s!=null&&(s.trackChildChange(Vt(d.name,d.node)),s.trackChildChange(at(t,o))),l.updateImmediateChild(t,o).updateImmediateChild(d.name,N.EMPTY_NODE)):e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cs{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=ae}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return _(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return _(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:Gn}hasEnd(){return this.endSet_}getIndexEndValue(){return _(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return _(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:kn}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return _(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===ae}copy(){const e=new cs;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function C0(n){return n.loadsAllData()?new as(n.getIndex()):n.hasLimit()?new P0(n):new jt(n)}function U0(n,e){const t=n.copy();return t.index_=e,t}function Sr(n){const e={};if(n.isDefault())return e;let t;if(n.index_===ae?t="$priority":n.index_===ya?t="$value":n.index_===jn?t="$key":(_(n.index_ instanceof ls,"Unrecognized index type!"),t=n.index_.toString()),e.orderBy=Pe(t),n.startSet_){const o=n.startAfterSet_?"startAfter":"startAt";e[o]=Pe(n.indexStartValue_),n.startNameSet_&&(e[o]+=","+Pe(n.indexStartName_))}if(n.endSet_){const o=n.endBeforeSet_?"endBefore":"endAt";e[o]=Pe(n.indexEndValue_),n.endNameSet_&&(e[o]+=","+Pe(n.indexEndName_))}return n.limitSet_&&(n.isViewFromLeft()?e.limitToFirst=n.limit_:e.limitToLast=n.limit_),e}function kr(n){const e={};if(n.startSet_&&(e.sp=n.indexStartValue_,n.startNameSet_&&(e.sn=n.indexStartName_),e.sin=!n.startAfterSet_),n.endSet_&&(e.ep=n.indexEndValue_,n.endNameSet_&&(e.en=n.indexEndName_),e.ein=!n.endBeforeSet_),n.limitSet_){e.l=n.limit_;let t=n.viewFrom_;t===""&&(n.isViewFromLeft()?t="l":t="r"),e.vf=t}return n.index_!==ae&&(e.i=n.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Co extends la{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(_(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,t,o,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=o,this.appCheckTokenProvider_=i,this.log_=Jt("p:rest:"),this.listens_={}}listen(e,t,o,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=Co.getListenId_(e,o),l={};this.listens_[r]=l;const a=Sr(e._queryParams);this.restRequest_(s+".json",a,(d,m)=>{let h=m;if(d===404&&(h=null,d=null),d===null&&this.onDataUpdate_(s,h,!1,o),lt(this.listens_,r)===l){let f;d?d===401?f="permission_denied":f="rest_error:"+d:f="ok",i(f,null)}})}unlisten(e,t){const o=Co.getListenId_(e,t);delete this.listens_[o]}get(e){const t=Sr(e._queryParams),o=e._path.toString(),i=new Yt;return this.restRequest_(o+".json",t,(s,r)=>{let l=r;s===404&&(l=null,s=null),s===null?(this.onDataUpdate_(o,l,!1,null),i.resolve(l)):i.reject(new Error(l))}),i.promise}refreshAuthToken(e){}restRequest_(e,t={},o){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+qd(t);this.log_("Sending REST request for "+r);const l=new XMLHttpRequest;l.onreadystatechange=()=>{if(o&&l.readyState===4){this.log_("REST Response for "+r+" received. status:",l.status,"response:",l.responseText);let a=null;if(l.status>=200&&l.status<300){try{a=xt(l.responseText)}catch(d){Me("Failed to parse JSON response for "+r+": "+l.responseText)}o(null,a)}else l.status!==401&&l.status!==404&&Me("Got unsuccessful REST response for "+r+" Status: "+l.status),o(l.status);o=null}},l.open("GET",r,!0),l.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class E0{constructor(){this.rootNode_=N.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uo(){return{value:null,children:new Map}}function ga(n,e,t){if(F(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const o=L(e);n.children.has(o)||n.children.set(o,Uo());const i=n.children.get(o);e=oe(e),ga(i,e,t)}}function Bi(n,e,t){n.value!==null?t(e,n.value):B0(n,(o,i)=>{const s=new q(e.toString()+"/"+o);Bi(i,s,t)})}function B0(n,e){n.children.forEach((t,o)=>{e(o,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class w0{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t={...e};return this.last_&&Ie(this.last_,(o,i)=>{t[o]=t[o]-i}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dr=10*1e3,I0=30*1e3,S0=5*60*1e3;class k0{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new w0(e);const o=Dr+(I0-Dr)*Math.random();Dt(this.reportStats_.bind(this),Math.floor(o))}reportStats_(){const e=this.statsListener_.get(),t={};let o=!1;Ie(e,(i,s)=>{s>0&&hn(this.statsToReport_,i)&&(t[i]=s,o=!0)}),o&&this.server_.reportStats(t),Dt(this.reportStats_.bind(this),Math.floor(Math.random()*2*S0))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var sn;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(sn||(sn={}));function ds(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function hs(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function us(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eo{constructor(e,t,o){this.path=e,this.affectedTree=t,this.revert=o,this.type=sn.ACK_USER_WRITE,this.source=ds()}operationForChild(e){if(F(this.path)){if(this.affectedTree.value!=null)return _(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new q(e));return new Eo(Q(),t,this.revert)}}else return _(L(this.path)===e,"operationForChild called for unrelated child."),new Eo(oe(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt{constructor(e,t){this.source=e,this.path=t,this.type=sn.LISTEN_COMPLETE}operationForChild(e){return F(this.path)?new Gt(this.source,Q()):new Gt(this.source,oe(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kn{constructor(e,t,o){this.source=e,this.path=t,this.snap=o,this.type=sn.OVERWRITE}operationForChild(e){return F(this.path)?new Kn(this.source,Q(),this.snap.getImmediateChild(e)):new Kn(this.source,oe(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ct{constructor(e,t,o){this.source=e,this.path=t,this.children=o,this.type=sn.MERGE}operationForChild(e){if(F(this.path)){const t=this.children.subtree(new q(e));return t.isEmpty()?null:t.value?new Kn(this.source,Q(),t.value):new ct(this.source,Q(),t)}else return _(L(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new ct(this.source,oe(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qn{constructor(e,t,o){this.node_=e,this.fullyInitialized_=t,this.filtered_=o}isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(e){if(F(e))return this.isFullyInitialized()&&!this.filtered_;const t=L(e);return this.isCompleteForChild(t)}isCompleteForChild(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}getNode(){return this.node_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class D0{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function T0(n,e,t,o){const i=[],s=[];return e.forEach(r=>{r.type==="child_changed"&&n.index_.indexedValueChanged(r.oldSnap,r.snapshotNode)&&s.push(v0(r.childName,r.snapshotNode))}),Bt(n,i,"child_removed",e,o,t),Bt(n,i,"child_added",e,o,t),Bt(n,i,"child_moved",s,o,t),Bt(n,i,"child_changed",e,o,t),Bt(n,i,"value",e,o,t),i}function Bt(n,e,t,o,i,s){const r=o.filter(l=>l.type===t);r.sort((l,a)=>M0(n,l,a)),r.forEach(l=>{const a=N0(n,l,s);i.forEach(d=>{d.respondsTo(l.type)&&e.push(d.createEvent(a,n.query_))})})}function N0(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function M0(n,e,t){if(e.childName==null||t.childName==null)throw pt("Should only compare child_ events.");const o=new H(e.childName,e.snapshotNode),i=new H(t.childName,t.snapshotNode);return n.index_.compare(o,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oo(n,e){return{eventCache:n,serverCache:e}}function Tt(n,e,t,o){return Oo(new Qn(e,t,o),n.serverCache)}function Aa(n,e,t,o){return Oo(n.eventCache,new Qn(e,t,o))}function wi(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Yn(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ci;const R0=()=>(ci||(ci=new Oe(_2)),ci);class ne{static fromObject(e){let t=new ne(null);return Ie(e,(o,i)=>{t=t.set(new q(o),i)}),t}constructor(e,t=R0()){this.value=e,this.children=t}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(this.value!=null&&t(this.value))return{path:Q(),value:this.value};if(F(e))return null;{const o=L(e),i=this.children.get(o);if(i!==null){const s=i.findRootMostMatchingPathAndValue(oe(e),t);return s!=null?{path:de(new q(o),s.path),value:s.value}:null}else return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,()=>!0)}subtree(e){if(F(e))return this;{const t=L(e),o=this.children.get(t);return o!==null?o.subtree(oe(e)):new ne(null)}}set(e,t){if(F(e))return new ne(t,this.children);{const o=L(e),s=(this.children.get(o)||new ne(null)).set(oe(e),t),r=this.children.insert(o,s);return new ne(this.value,r)}}remove(e){if(F(e))return this.children.isEmpty()?new ne(null):new ne(null,this.children);{const t=L(e),o=this.children.get(t);if(o){const i=o.remove(oe(e));let s;return i.isEmpty()?s=this.children.remove(t):s=this.children.insert(t,i),this.value===null&&s.isEmpty()?new ne(null):new ne(this.value,s)}else return this}}get(e){if(F(e))return this.value;{const t=L(e),o=this.children.get(t);return o?o.get(oe(e)):null}}setTree(e,t){if(F(e))return t;{const o=L(e),s=(this.children.get(o)||new ne(null)).setTree(oe(e),t);let r;return s.isEmpty()?r=this.children.remove(o):r=this.children.insert(o,s),new ne(this.value,r)}}fold(e){return this.fold_(Q(),e)}fold_(e,t){const o={};return this.children.inorderTraversal((i,s)=>{o[i]=s.fold_(de(e,i),t)}),t(e,this.value,o)}findOnPath(e,t){return this.findOnPath_(e,Q(),t)}findOnPath_(e,t,o){const i=this.value?o(t,this.value):!1;if(i)return i;if(F(e))return null;{const s=L(e),r=this.children.get(s);return r?r.findOnPath_(oe(e),de(t,s),o):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,Q(),t)}foreachOnPath_(e,t,o){if(F(e))return this;{this.value&&o(t,this.value);const i=L(e),s=this.children.get(i);return s?s.foreachOnPath_(oe(e),de(t,i),o):new ne(null)}}foreach(e){this.foreach_(Q(),e)}foreach_(e,t){this.children.inorderTraversal((o,i)=>{i.foreach_(de(e,o),t)}),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal((t,o)=>{o.value&&e(t,o.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rn{constructor(e){this.writeTree_=e}static empty(){return new rn(new ne(null))}}function Nt(n,e,t){if(F(e))return new rn(new ne(t));{const o=n.writeTree_.findRootMostValueAndPath(e);if(o!=null){const i=o.path;let s=o.value;const r=Re(i,e);return s=s.updateChild(r,t),new rn(n.writeTree_.set(i,s))}else{const i=new ne(t),s=n.writeTree_.setTree(e,i);return new rn(s)}}}function Ii(n,e,t){let o=n;return Ie(t,(i,s)=>{o=Nt(o,de(e,i),s)}),o}function Tr(n,e){if(F(e))return rn.empty();{const t=n.writeTree_.setTree(e,new ne(null));return new rn(t)}}function Si(n,e){return $n(n,e)!=null}function $n(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(Re(t.path,e)):null}function Nr(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(ae,(o,i)=>{e.push(new H(o,i))}):n.writeTree_.children.inorderTraversal((o,i)=>{i.value!=null&&e.push(new H(o,i.value))}),e}function Sn(n,e){if(F(e))return n;{const t=$n(n,e);return t!=null?new rn(new ne(t)):new rn(n.writeTree_.subtree(e))}}function ki(n){return n.writeTree_.isEmpty()}function dt(n,e){return _a(Q(),n.writeTree_,e)}function _a(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let o=null;return e.children.inorderTraversal((i,s)=>{i===".priority"?(_(s.value!==null,"Priority writes must always be leaf nodes"),o=s.value):t=_a(de(n,i),s,t)}),!t.getChild(n).isEmpty()&&o!==null&&(t=t.updateChild(de(n,".priority"),o)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ms(n,e){return Ua(e,n)}function O0(n,e,t,o,i){_(o>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:o,visible:i}),i&&(n.visibleWrites=Nt(n.visibleWrites,e,t)),n.lastWriteId=o}function x0(n,e,t,o){_(o>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:o,visible:!0}),n.visibleWrites=Ii(n.visibleWrites,e,t),n.lastWriteId=o}function L0(n,e){for(let t=0;t<n.allWrites.length;t++){const o=n.allWrites[t];if(o.writeId===e)return o}return null}function F0(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);_(t>=0,"removeWrite called with nonexistent writeId.");const o=n.allWrites[t];n.allWrites.splice(t,1);let i=o.visible,s=!1,r=n.allWrites.length-1;for(;i&&r>=0;){const l=n.allWrites[r];l.visible&&(r>=t&&H0(l,o.path)?i=!1:Xe(o.path,l.path)&&(s=!0)),r--}if(i){if(s)return z0(n),!0;if(o.snap)n.visibleWrites=Tr(n.visibleWrites,o.path);else{const l=o.children;Ie(l,a=>{n.visibleWrites=Tr(n.visibleWrites,de(o.path,a))})}return!0}else return!1}function H0(n,e){if(n.snap)return Xe(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Xe(de(n.path,t),e))return!0;return!1}function z0(n){n.visibleWrites=va(n.allWrites,V0,Q()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function V0(n){return n.visible}function va(n,e,t){let o=rn.empty();for(let i=0;i<n.length;++i){const s=n[i];if(e(s)){const r=s.path;let l;if(s.snap)Xe(t,r)?(l=Re(t,r),o=Nt(o,l,s.snap)):Xe(r,t)&&(l=Re(r,t),o=Nt(o,Q(),s.snap.getChild(l)));else if(s.children){if(Xe(t,r))l=Re(t,r),o=Ii(o,l,s.children);else if(Xe(r,t))if(l=Re(r,t),F(l))o=Ii(o,Q(),s.children);else{const a=lt(s.children,L(l));if(a){const d=a.getChild(oe(l));o=Nt(o,Q(),d)}}}else throw pt("WriteRecord should have .snap or .children")}}return o}function Pa(n,e,t,o,i){if(!o&&!i){const s=$n(n.visibleWrites,e);if(s!=null)return s;{const r=Sn(n.visibleWrites,e);if(ki(r))return t;if(t==null&&!Si(r,Q()))return null;{const l=t||N.EMPTY_NODE;return dt(r,l)}}}else{const s=Sn(n.visibleWrites,e);if(!i&&ki(s))return t;if(!i&&t==null&&!Si(s,Q()))return null;{const r=function(d){return(d.visible||i)&&(!o||!~o.indexOf(d.writeId))&&(Xe(d.path,e)||Xe(e,d.path))},l=va(n.allWrites,r,e),a=t||N.EMPTY_NODE;return dt(l,a)}}}function W0(n,e,t){let o=N.EMPTY_NODE;const i=$n(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(ae,(s,r)=>{o=o.updateImmediateChild(s,r)}),o;if(t){const s=Sn(n.visibleWrites,e);return t.forEachChild(ae,(r,l)=>{const a=dt(Sn(s,new q(r)),l);o=o.updateImmediateChild(r,a)}),Nr(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}else{const s=Sn(n.visibleWrites,e);return Nr(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}}function j0(n,e,t,o,i){_(o||i,"Either existingEventSnap or existingServerSnap must exist");const s=de(e,t);if(Si(n.visibleWrites,s))return null;{const r=Sn(n.visibleWrites,s);return ki(r)?i.getChild(t):dt(r,i.getChild(t))}}function G0(n,e,t,o){const i=de(e,t),s=$n(n.visibleWrites,i);if(s!=null)return s;if(o.isCompleteForChild(t)){const r=Sn(n.visibleWrites,i);return dt(r,o.getNode().getImmediateChild(t))}else return null}function K0(n,e){return $n(n.visibleWrites,e)}function Q0(n,e,t,o,i,s,r){let l;const a=Sn(n.visibleWrites,e),d=$n(a,Q());if(d!=null)l=d;else if(t!=null)l=dt(a,t);else return[];if(l=l.withIndex(r),!l.isEmpty()&&!l.isLeafNode()){const m=[],h=r.getCompare(),f=s?l.getReverseIteratorFrom(o,r):l.getIteratorFrom(o,r);let b=f.getNext();for(;b&&m.length<i;)h(b,o)!==0&&m.push(b),b=f.getNext();return m}else return[]}function Y0(){return{visibleWrites:rn.empty(),allWrites:[],lastWriteId:-1}}function Bo(n,e,t,o){return Pa(n.writeTree,n.treePath,e,t,o)}function ps(n,e){return W0(n.writeTree,n.treePath,e)}function Mr(n,e,t,o){return j0(n.writeTree,n.treePath,e,t,o)}function wo(n,e){return K0(n.writeTree,de(n.treePath,e))}function X0(n,e,t,o,i,s){return Q0(n.writeTree,n.treePath,e,t,o,i,s)}function fs(n,e,t){return G0(n.writeTree,n.treePath,e,t)}function Ca(n,e){return Ua(de(n.treePath,e),n.writeTree)}function Ua(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class q0{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,o=e.childName;_(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),_(o!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(o);if(i){const s=i.type;if(t==="child_added"&&s==="child_removed")this.changeMap.set(o,Wt(o,e.snapshotNode,i.snapshotNode));else if(t==="child_removed"&&s==="child_added")this.changeMap.delete(o);else if(t==="child_removed"&&s==="child_changed")this.changeMap.set(o,Vt(o,i.oldSnap));else if(t==="child_changed"&&s==="child_added")this.changeMap.set(o,at(o,e.snapshotNode));else if(t==="child_changed"&&s==="child_changed")this.changeMap.set(o,Wt(o,e.snapshotNode,i.oldSnap));else throw pt("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(o,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class J0{getCompleteChild(e){return null}getChildAfterChild(e,t,o){return null}}const Ea=new J0;class ys{constructor(e,t,o=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=o}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const o=this.optCompleteServerCache_!=null?new Qn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return fs(this.writes_,e,o)}}getChildAfterChild(e,t,o){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Yn(this.viewCache_),s=X0(this.writes_,i,t,1,o,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $0(n){return{filter:n}}function Z0(n,e){_(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),_(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function eh(n,e,t,o,i){const s=new q0;let r,l;if(t.type===sn.OVERWRITE){const d=t;d.source.fromUser?r=Di(n,e,d.path,d.snap,o,i,s):(_(d.source.fromServer,"Unknown source."),l=d.source.tagged||e.serverCache.isFiltered()&&!F(d.path),r=Io(n,e,d.path,d.snap,o,i,l,s))}else if(t.type===sn.MERGE){const d=t;d.source.fromUser?r=th(n,e,d.path,d.children,o,i,s):(_(d.source.fromServer,"Unknown source."),l=d.source.tagged||e.serverCache.isFiltered(),r=Ti(n,e,d.path,d.children,o,i,l,s))}else if(t.type===sn.ACK_USER_WRITE){const d=t;d.revert?r=sh(n,e,d.path,o,i,s):r=oh(n,e,d.path,d.affectedTree,o,i,s)}else if(t.type===sn.LISTEN_COMPLETE)r=ih(n,e,t.path,o,s);else throw pt("Unknown operation type: "+t.type);const a=s.getChanges();return nh(e,r,a),{viewCache:r,changes:a}}function nh(n,e,t){const o=e.eventCache;if(o.isFullyInitialized()){const i=o.getNode().isLeafNode()||o.getNode().isEmpty(),s=wi(n);(t.length>0||!n.eventCache.isFullyInitialized()||i&&!o.getNode().equals(s)||!o.getNode().getPriority().equals(s.getPriority()))&&t.push(ba(wi(e)))}}function Ba(n,e,t,o,i,s){const r=e.eventCache;if(wo(o,t)!=null)return e;{let l,a;if(F(t))if(_(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const d=Yn(e),m=d instanceof N?d:N.EMPTY_NODE,h=ps(o,m);l=n.filter.updateFullNode(e.eventCache.getNode(),h,s)}else{const d=Bo(o,Yn(e));l=n.filter.updateFullNode(e.eventCache.getNode(),d,s)}else{const d=L(t);if(d===".priority"){_(Dn(t)===1,"Can't have a priority with additional path components");const m=r.getNode();a=e.serverCache.getNode();const h=Mr(o,t,m,a);h!=null?l=n.filter.updatePriority(m,h):l=r.getNode()}else{const m=oe(t);let h;if(r.isCompleteForChild(d)){a=e.serverCache.getNode();const f=Mr(o,t,r.getNode(),a);f!=null?h=r.getNode().getImmediateChild(d).updateChild(m,f):h=r.getNode().getImmediateChild(d)}else h=fs(o,d,e.serverCache);h!=null?l=n.filter.updateChild(r.getNode(),d,h,m,i,s):l=r.getNode()}}return Tt(e,l,r.isFullyInitialized()||F(t),n.filter.filtersNodes())}}function Io(n,e,t,o,i,s,r,l){const a=e.serverCache;let d;const m=r?n.filter:n.filter.getIndexedFilter();if(F(t))d=m.updateFullNode(a.getNode(),o,null);else if(m.filtersNodes()&&!a.isFiltered()){const b=a.getNode().updateChild(t,o);d=m.updateFullNode(a.getNode(),b,null)}else{const b=L(t);if(!a.isCompleteForPath(t)&&Dn(t)>1)return e;const g=oe(t),D=a.getNode().getImmediateChild(b).updateChild(g,o);b===".priority"?d=m.updatePriority(a.getNode(),D):d=m.updateChild(a.getNode(),b,D,g,Ea,null)}const h=Aa(e,d,a.isFullyInitialized()||F(t),m.filtersNodes()),f=new ys(i,h,s);return Ba(n,h,t,i,f,l)}function Di(n,e,t,o,i,s,r){const l=e.eventCache;let a,d;const m=new ys(i,e,s);if(F(t))d=n.filter.updateFullNode(e.eventCache.getNode(),o,r),a=Tt(e,d,!0,n.filter.filtersNodes());else{const h=L(t);if(h===".priority")d=n.filter.updatePriority(e.eventCache.getNode(),o),a=Tt(e,d,l.isFullyInitialized(),l.isFiltered());else{const f=oe(t),b=l.getNode().getImmediateChild(h);let g;if(F(f))g=o;else{const B=m.getCompleteChild(h);B!=null?os(f)===".priority"&&B.getChild(ca(f)).isEmpty()?g=B:g=B.updateChild(f,o):g=N.EMPTY_NODE}if(b.equals(g))a=e;else{const B=n.filter.updateChild(l.getNode(),h,g,f,m,r);a=Tt(e,B,l.isFullyInitialized(),n.filter.filtersNodes())}}}return a}function Rr(n,e){return n.eventCache.isCompleteForChild(e)}function th(n,e,t,o,i,s,r){let l=e;return o.foreach((a,d)=>{const m=de(t,a);Rr(e,L(m))&&(l=Di(n,l,m,d,i,s,r))}),o.foreach((a,d)=>{const m=de(t,a);Rr(e,L(m))||(l=Di(n,l,m,d,i,s,r))}),l}function Or(n,e,t){return t.foreach((o,i)=>{e=e.updateChild(o,i)}),e}function Ti(n,e,t,o,i,s,r,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let a=e,d;F(t)?d=o:d=new ne(null).setTree(t,o);const m=e.serverCache.getNode();return d.children.inorderTraversal((h,f)=>{if(m.hasChild(h)){const b=e.serverCache.getNode().getImmediateChild(h),g=Or(n,b,f);a=Io(n,a,new q(h),g,i,s,r,l)}}),d.children.inorderTraversal((h,f)=>{const b=!e.serverCache.isCompleteForChild(h)&&f.value===null;if(!m.hasChild(h)&&!b){const g=e.serverCache.getNode().getImmediateChild(h),B=Or(n,g,f);a=Io(n,a,new q(h),B,i,s,r,l)}}),a}function oh(n,e,t,o,i,s,r){if(wo(i,t)!=null)return e;const l=e.serverCache.isFiltered(),a=e.serverCache;if(o.value!=null){if(F(t)&&a.isFullyInitialized()||a.isCompleteForPath(t))return Io(n,e,t,a.getNode().getChild(t),i,s,l,r);if(F(t)){let d=new ne(null);return a.getNode().forEachChild(jn,(m,h)=>{d=d.set(new q(m),h)}),Ti(n,e,t,d,i,s,l,r)}else return e}else{let d=new ne(null);return o.foreach((m,h)=>{const f=de(t,m);a.isCompleteForPath(f)&&(d=d.set(m,a.getNode().getChild(f)))}),Ti(n,e,t,d,i,s,l,r)}}function ih(n,e,t,o,i){const s=e.serverCache,r=Aa(e,s.getNode(),s.isFullyInitialized()||F(t),s.isFiltered());return Ba(n,r,t,o,Ea,i)}function sh(n,e,t,o,i,s){let r;if(wo(o,t)!=null)return e;{const l=new ys(o,e,i),a=e.eventCache.getNode();let d;if(F(t)||L(t)===".priority"){let m;if(e.serverCache.isFullyInitialized())m=Bo(o,Yn(e));else{const h=e.serverCache.getNode();_(h instanceof N,"serverChildren would be complete if leaf node"),m=ps(o,h)}m=m,d=n.filter.updateFullNode(a,m,s)}else{const m=L(t);let h=fs(o,m,e.serverCache);h==null&&e.serverCache.isCompleteForChild(m)&&(h=a.getImmediateChild(m)),h!=null?d=n.filter.updateChild(a,m,h,oe(t),l,s):e.eventCache.getNode().hasChild(m)?d=n.filter.updateChild(a,m,N.EMPTY_NODE,oe(t),l,s):d=a,d.isEmpty()&&e.serverCache.isFullyInitialized()&&(r=Bo(o,Yn(e)),r.isLeafNode()&&(d=n.filter.updateFullNode(d,r,s)))}return r=e.serverCache.isFullyInitialized()||wo(o,Q())!=null,Tt(e,d,r,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rh{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const o=this.query_._queryParams,i=new as(o.getIndex()),s=C0(o);this.processor_=$0(s);const r=t.serverCache,l=t.eventCache,a=i.updateFullNode(N.EMPTY_NODE,r.getNode(),null),d=s.updateFullNode(N.EMPTY_NODE,l.getNode(),null),m=new Qn(a,r.isFullyInitialized(),i.filtersNodes()),h=new Qn(d,l.isFullyInitialized(),s.filtersNodes());this.viewCache_=Oo(h,m),this.eventGenerator_=new D0(this.query_)}get query(){return this.query_}}function lh(n){return n.viewCache_.serverCache.getNode()}function ah(n,e){const t=Yn(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!F(e)&&!t.getImmediateChild(L(e)).isEmpty())?t.getChild(e):null}function xr(n){return n.eventRegistrations_.length===0}function ch(n,e){n.eventRegistrations_.push(e)}function Lr(n,e,t){const o=[];if(t){_(e==null,"A cancel should cancel all event registrations.");const i=n.query._path;n.eventRegistrations_.forEach(s=>{const r=s.createCancelEvent(t,i);r&&o.push(r)})}if(e){let i=[];for(let s=0;s<n.eventRegistrations_.length;++s){const r=n.eventRegistrations_[s];if(!r.matches(e))i.push(r);else if(e.hasAnyCallback()){i=i.concat(n.eventRegistrations_.slice(s+1));break}}n.eventRegistrations_=i}else n.eventRegistrations_=[];return o}function Fr(n,e,t,o){e.type===sn.MERGE&&e.source.queryId!==null&&(_(Yn(n.viewCache_),"We should always have a full cache before handling merges"),_(wi(n.viewCache_),"Missing event cache, even though we have a server cache"));const i=n.viewCache_,s=eh(n.processor_,i,e,t,o);return Z0(n.processor_,s.viewCache),_(s.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=s.viewCache,wa(n,s.changes,s.viewCache.eventCache.getNode(),null)}function dh(n,e){const t=n.viewCache_.eventCache,o=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(ae,(s,r)=>{o.push(at(s,r))}),t.isFullyInitialized()&&o.push(ba(t.getNode())),wa(n,o,t.getNode(),e)}function wa(n,e,t,o){const i=o?[o]:n.eventRegistrations_;return T0(n.eventGenerator_,e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let So;class hh{constructor(){this.views=new Map}}function uh(n){_(!So,"__referenceConstructor has already been defined"),So=n}function mh(){return _(So,"Reference.ts has not been loaded"),So}function ph(n){return n.views.size===0}function bs(n,e,t,o){const i=e.source.queryId;if(i!==null){const s=n.views.get(i);return _(s!=null,"SyncTree gave us an op for an invalid query."),Fr(s,e,t,o)}else{let s=[];for(const r of n.views.values())s=s.concat(Fr(r,e,t,o));return s}}function fh(n,e,t,o,i){const s=e._queryIdentifier,r=n.views.get(s);if(!r){let l=Bo(t,i?o:null),a=!1;l?a=!0:o instanceof N?(l=ps(t,o),a=!1):(l=N.EMPTY_NODE,a=!1);const d=Oo(new Qn(l,a,!1),new Qn(o,i,!1));return new rh(e,d)}return r}function yh(n,e,t,o,i,s){const r=fh(n,e,o,i,s);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,r),ch(r,t),dh(r,t)}function bh(n,e,t,o){const i=e._queryIdentifier,s=[];let r=[];const l=Tn(n);if(i==="default")for(const[a,d]of n.views.entries())r=r.concat(Lr(d,t,o)),xr(d)&&(n.views.delete(a),d.query._queryParams.loadsAllData()||s.push(d.query));else{const a=n.views.get(i);a&&(r=r.concat(Lr(a,t,o)),xr(a)&&(n.views.delete(i),a.query._queryParams.loadsAllData()||s.push(a.query)))}return l&&!Tn(n)&&s.push(new(mh())(e._repo,e._path)),{removed:s,events:r}}function Ia(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function rt(n,e){let t=null;for(const o of n.views.values())t=t||ah(o,e);return t}function Sa(n,e){if(e._queryParams.loadsAllData())return xo(n);{const o=e._queryIdentifier;return n.views.get(o)}}function ka(n,e){return Sa(n,e)!=null}function Tn(n){return xo(n)!=null}function xo(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ko;function gh(n){_(!ko,"__referenceConstructor has already been defined"),ko=n}function Ah(){return _(ko,"Reference.ts has not been loaded"),ko}let _h=1;class Hr{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ne(null),this.pendingWriteTree_=Y0(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Da(n,e,t,o,i){return O0(n.pendingWriteTree_,e,t,o,i),i?yt(n,new Kn(ds(),e,t)):[]}function vh(n,e,t,o){x0(n.pendingWriteTree_,e,t,o);const i=ne.fromObject(t);return yt(n,new ct(ds(),e,i))}function Bn(n,e,t=!1){const o=L0(n.pendingWriteTree_,e);if(F0(n.pendingWriteTree_,e)){let s=new ne(null);return o.snap!=null?s=s.set(Q(),!0):Ie(o.children,r=>{s=s.set(new q(r),!0)}),yt(n,new Eo(o.path,s,t))}else return[]}function Lo(n,e,t){return yt(n,new Kn(hs(),e,t))}function Ph(n,e,t){const o=ne.fromObject(t);return yt(n,new ct(hs(),e,o))}function Ch(n,e){return yt(n,new Gt(hs(),e))}function Uh(n,e,t){const o=As(n,t);if(o){const i=_s(o),s=i.path,r=i.queryId,l=Re(s,e),a=new Gt(us(r),l);return vs(n,s,a)}else return[]}function Ni(n,e,t,o,i=!1){const s=e._path,r=n.syncPointTree_.get(s);let l=[];if(r&&(e._queryIdentifier==="default"||ka(r,e))){const a=bh(r,e,t,o);ph(r)&&(n.syncPointTree_=n.syncPointTree_.remove(s));const d=a.removed;if(l=a.events,!i){const m=d.findIndex(f=>f._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(s,(f,b)=>Tn(b));if(m&&!h){const f=n.syncPointTree_.subtree(s);if(!f.isEmpty()){const b=wh(f);for(let g=0;g<b.length;++g){const B=b[g],D=B.query,U=Ma(n,B);n.listenProvider_.startListening(Mt(D),Do(n,D),U.hashFn,U.onComplete)}}}!h&&d.length>0&&!o&&(m?n.listenProvider_.stopListening(Mt(e),null):d.forEach(f=>{const b=n.queryToTagMap.get(Fo(f));n.listenProvider_.stopListening(Mt(f),b)}))}Ih(n,d)}return l}function Eh(n,e,t,o){const i=As(n,o);if(i!=null){const s=_s(i),r=s.path,l=s.queryId,a=Re(r,e),d=new Kn(us(l),a,t);return vs(n,r,d)}else return[]}function Bh(n,e,t,o){const i=As(n,o);if(i){const s=_s(i),r=s.path,l=s.queryId,a=Re(r,e),d=ne.fromObject(t),m=new ct(us(l),a,d);return vs(n,r,m)}else return[]}function zr(n,e,t,o=!1){const i=e._path;let s=null,r=!1;n.syncPointTree_.foreachOnPath(i,(f,b)=>{const g=Re(f,i);s=s||rt(b,g),r=r||Tn(b)});let l=n.syncPointTree_.get(i);l?(r=r||Tn(l),s=s||rt(l,Q())):(l=new hh,n.syncPointTree_=n.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=N.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((b,g)=>{const B=rt(g,Q());B&&(s=s.updateImmediateChild(b,B))}));const d=ka(l,e);if(!d&&!e._queryParams.loadsAllData()){const f=Fo(e);_(!n.queryToTagMap.has(f),"View does not exist, but we have a tag");const b=Sh();n.queryToTagMap.set(f,b),n.tagToQueryMap.set(b,f)}const m=ms(n.pendingWriteTree_,i);let h=yh(l,e,t,m,s,a);if(!d&&!r&&!o){const f=Sa(l,e);h=h.concat(kh(n,e,f))}return h}function gs(n,e,t){const i=n.pendingWriteTree_,s=n.syncPointTree_.findOnPath(e,(r,l)=>{const a=Re(r,e),d=rt(l,a);if(d)return d});return Pa(i,e,s,t,!0)}function yt(n,e){return Ta(e,n.syncPointTree_,null,ms(n.pendingWriteTree_,Q()))}function Ta(n,e,t,o){if(F(n.path))return Na(n,e,t,o);{const i=e.get(Q());t==null&&i!=null&&(t=rt(i,Q()));let s=[];const r=L(n.path),l=n.operationForChild(r),a=e.children.get(r);if(a&&l){const d=t?t.getImmediateChild(r):null,m=Ca(o,r);s=s.concat(Ta(l,a,d,m))}return i&&(s=s.concat(bs(i,n,o,t))),s}}function Na(n,e,t,o){const i=e.get(Q());t==null&&i!=null&&(t=rt(i,Q()));let s=[];return e.children.inorderTraversal((r,l)=>{const a=t?t.getImmediateChild(r):null,d=Ca(o,r),m=n.operationForChild(r);m&&(s=s.concat(Na(m,l,a,d)))}),i&&(s=s.concat(bs(i,n,o,t))),s}function Ma(n,e){const t=e.query,o=Do(n,t);return{hashFn:()=>(lh(e)||N.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return o?Uh(n,t._path,o):Ch(n,t._path);{const s=C2(i,t);return Ni(n,t,null,s)}}}}function Do(n,e){const t=Fo(e);return n.queryToTagMap.get(t)}function Fo(n){return n._path.toString()+"$"+n._queryIdentifier}function As(n,e){return n.tagToQueryMap.get(e)}function _s(n){const e=n.indexOf("$");return _(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new q(n.substr(0,e))}}function vs(n,e,t){const o=n.syncPointTree_.get(e);_(o,"Missing sync point for query tag that we're tracking");const i=ms(n.pendingWriteTree_,e);return bs(o,t,i,null)}function wh(n){return n.fold((e,t,o)=>{if(t&&Tn(t))return[xo(t)];{let i=[];return t&&(i=Ia(t)),Ie(o,(s,r)=>{i=i.concat(r)}),i}})}function Mt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Ah())(n._repo,n._path):n}function Ih(n,e){for(let t=0;t<e.length;++t){const o=e[t];if(!o._queryParams.loadsAllData()){const i=Fo(o),s=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(s)}}}function Sh(){return _h++}function kh(n,e,t){const o=e._path,i=Do(n,e),s=Ma(n,t),r=n.listenProvider_.startListening(Mt(e),i,s.hashFn,s.onComplete),l=n.syncPointTree_.subtree(o);if(i)_(!Tn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((d,m,h)=>{if(!F(d)&&m&&Tn(m))return[xo(m).query];{let f=[];return m&&(f=f.concat(Ia(m).map(b=>b.query))),Ie(h,(b,g)=>{f=f.concat(g)}),f}});for(let d=0;d<a.length;++d){const m=a[d];n.listenProvider_.stopListening(Mt(m),Do(n,m))}}return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ps{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Ps(t)}node(){return this.node_}}class Cs{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=de(this.path_,e);return new Cs(this.syncTree_,t)}node(){return gs(this.syncTree_,this.path_)}}const Dh=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},Vr=function(n,e,t){if(!n||typeof n!="object")return n;if(_(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return Th(n[".sv"],e,t);if(typeof n[".sv"]=="object")return Nh(n[".sv"],e);_(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},Th=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:_(!1,"Unexpected server value: "+n)}},Nh=function(n,e,t){n.hasOwnProperty("increment")||_(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const o=n.increment;typeof o!="number"&&_(!1,"Unexpected increment value: "+o);const i=e.node();if(_(i!==null&&typeof i!="undefined","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return o;const r=i.getValue();return typeof r!="number"?o:r+o},Ra=function(n,e,t,o){return Us(e,new Cs(t,n),o)},Oa=function(n,e,t){return Us(n,new Ps(e),t)};function Us(n,e,t){const o=n.getPriority().val(),i=Vr(o,e.getImmediateChild(".priority"),t);let s;if(n.isLeafNode()){const r=n,l=Vr(r.getValue(),e,t);return l!==r.getValue()||i!==r.getPriority().val()?new Ae(l,ve(i)):n}else{const r=n;return s=r,i!==r.getPriority().val()&&(s=s.updatePriority(new Ae(i))),r.forEachChild(ae,(l,a)=>{const d=Us(a,e.getImmediateChild(l),t);d!==a&&(s=s.updateImmediateChild(l,d))}),s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Es{constructor(e="",t=null,o={children:{},childCount:0}){this.name=e,this.parent=t,this.node=o}}function Bs(n,e){let t=e instanceof q?e:new q(e),o=n,i=L(t);for(;i!==null;){const s=lt(o.node.children,i)||{children:{},childCount:0};o=new Es(i,o,s),t=oe(t),i=L(t)}return o}function bt(n){return n.node.value}function xa(n,e){n.node.value=e,Mi(n)}function La(n){return n.node.childCount>0}function Mh(n){return bt(n)===void 0&&!La(n)}function Ho(n,e){Ie(n.node.children,(t,o)=>{e(new Es(t,n,o))})}function Fa(n,e,t,o){t&&!o&&e(n),Ho(n,i=>{Fa(i,e,!0,o)}),t&&o&&e(n)}function Rh(n,e,t){let o=n.parent;for(;o!==null;){if(e(o))return!0;o=o.parent}return!1}function Zt(n){return new q(n.parent===null?n.name:Zt(n.parent)+"/"+n.name)}function Mi(n){n.parent!==null&&Oh(n.parent,n.name,n)}function Oh(n,e,t){const o=Mh(t),i=hn(n.node.children,e);o&&i?(delete n.node.children[e],n.node.childCount--,Mi(n)):!o&&!i&&(n.node.children[e]=t.node,n.node.childCount++,Mi(n))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xh=/[\[\].#$\/\u0000-\u001F\u007F]/,Lh=/[\[\].#$\u0000-\u001F\u007F]/,di=10*1024*1024,ws=function(n){return typeof n=="string"&&n.length!==0&&!xh.test(n)},Ha=function(n){return typeof n=="string"&&n.length!==0&&!Lh.test(n)},Fh=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Ha(n)},Ri=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!$i(n)||n&&typeof n=="object"&&hn(n,".sv")},za=function(n,e,t,o){o&&e===void 0||zo(No(n,"value"),e,t)},zo=function(n,e,t){const o=t instanceof q?new o0(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+zn(o));if(typeof e=="function")throw new Error(n+"contains a function "+zn(o)+" with contents = "+e.toString());if($i(e))throw new Error(n+"contains "+e.toString()+" "+zn(o));if(typeof e=="string"&&e.length>di/3&&Mo(e)>di)throw new Error(n+"contains a string greater than "+di+" utf8 bytes "+zn(o)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,s=!1;if(Ie(e,(r,l)=>{if(r===".value")i=!0;else if(r!==".priority"&&r!==".sv"&&(s=!0,!ws(r)))throw new Error(n+" contains an invalid key ("+r+") "+zn(o)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);i0(o,r),zo(n,l,o),s0(o)}),i&&s)throw new Error(n+' contains ".value" child '+zn(o)+" in addition to actual children.")}},Hh=function(n,e){let t,o;for(t=0;t<e.length;t++){o=e[t];const s=zt(o);for(let r=0;r<s.length;r++)if(!(s[r]===".priority"&&r===s.length-1)){if(!ws(s[r]))throw new Error(n+"contains an invalid key ("+s[r]+") in path "+o.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(t0);let i=null;for(t=0;t<e.length;t++){if(o=e[t],i!==null&&Xe(i,o))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+o.toString());i=o}},zh=function(n,e,t,o){const i=No(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const s=[];Ie(e,(r,l)=>{const a=new q(r);if(zo(i,l,de(t,a)),os(a)===".priority"&&!Ri(l))throw new Error(i+"contains an invalid value for '"+a.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");s.push(a)}),Hh(i,s)},Is=function(n,e,t,o){if(!Ha(t))throw new Error(No(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Vh=function(n,e,t,o){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Is(n,e,t)},Ss=function(n,e){if(L(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},Wh=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!ws(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!Fh(t))throw new Error(No(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jh{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Vo(n,e){let t=null;for(let o=0;o<e.length;o++){const i=e[o],s=i.getPath();t!==null&&!is(s,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:s}),t.events.push(i)}t&&n.eventLists_.push(t)}function Va(n,e,t){Vo(n,t),Wa(n,o=>is(o,e))}function ln(n,e,t){Vo(n,t),Wa(n,o=>Xe(o,e)||Xe(e,o))}function Wa(n,e){n.recursionDepth_++;let t=!0;for(let o=0;o<n.eventLists_.length;o++){const i=n.eventLists_[o];if(i){const s=i.path;e(s)?(Gh(n.eventLists_[o]),n.eventLists_[o]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Gh(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const o=t.getEventRunner();kt&&we("event: "+t.toString()),ft(o)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kh="repo_interrupt",Qh=25;class Yh{constructor(e,t,o,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=o,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new jh,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Uo(),this.transactionQueueTree_=new Es,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Xh(n,e,t){if(n.stats_=ns(n.repoInfo_),n.forceRestClient_||w2())n.server_=new Co(n.repoInfo_,(o,i,s,r)=>{Wr(n,o,i,s,r)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>jr(n,!0),0);else{if(typeof t!="undefined"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Pe(t)}catch(o){throw new Error("Invalid authOverride provided: "+o)}}n.persistentConnection_=new pn(n.repoInfo_,e,(o,i,s,r)=>{Wr(n,o,i,s,r)},o=>{jr(n,o)},o=>{qh(n,o)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(o=>{n.server_.refreshAuthToken(o)}),n.appCheckProvider_.addTokenChangeListener(o=>{n.server_.refreshAppCheckToken(o.token)}),n.statsReporter_=T2(n.repoInfo_,()=>new k0(n.stats_,n.server_)),n.infoData_=new E0,n.infoSyncTree_=new Hr({startListening:(o,i,s,r)=>{let l=[];const a=n.infoData_.getNode(o._path);return a.isEmpty()||(l=Lo(n.infoSyncTree_,o._path,a),setTimeout(()=>{r("ok")},0)),l},stopListening:()=>{}}),ks(n,"connected",!1),n.serverSyncTree_=new Hr({startListening:(o,i,s,r)=>(n.server_.listen(o,s,i,(l,a)=>{const d=r(l,a);ln(n.eventQueue_,o._path,d)}),[]),stopListening:(o,i)=>{n.server_.unlisten(o,i)}})}function ja(n){const t=n.infoData_.getNode(new q(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Wo(n){return Dh({timestamp:ja(n)})}function Wr(n,e,t,o,i){n.dataUpdateCount++;const s=new q(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let r=[];if(i)if(o){const a=yo(t,d=>ve(d));r=Bh(n.serverSyncTree_,s,a,i)}else{const a=ve(t);r=Eh(n.serverSyncTree_,s,a,i)}else if(o){const a=yo(t,d=>ve(d));r=Ph(n.serverSyncTree_,s,a)}else{const a=ve(t);r=Lo(n.serverSyncTree_,s,a)}let l=s;r.length>0&&(l=ht(n,s)),ln(n.eventQueue_,l,r)}function jr(n,e){ks(n,"connected",e),e===!1&&Zh(n)}function qh(n,e){Ie(e,(t,o)=>{ks(n,t,o)})}function ks(n,e,t){const o=new q("/.info/"+e),i=ve(t);n.infoData_.updateSnapshot(o,i);const s=Lo(n.infoSyncTree_,o,i);ln(n.eventQueue_,o,s)}function Ds(n){return n.nextWriteId_++}function Jh(n,e,t,o,i){jo(n,"set",{path:e.toString(),value:t,priority:o});const s=Wo(n),r=ve(t,o),l=gs(n.serverSyncTree_,e),a=Oa(r,l,s),d=Ds(n),m=Da(n.serverSyncTree_,e,a,d,!0);Vo(n.eventQueue_,m),n.server_.put(e.toString(),r.val(!0),(f,b)=>{const g=f==="ok";g||Me("set at "+e+" failed: "+f);const B=Bn(n.serverSyncTree_,d,!g);ln(n.eventQueue_,e,B),xi(n,i,f,b)});const h=Ns(n,e);ht(n,h),ln(n.eventQueue_,h,[])}function $h(n,e,t,o){jo(n,"update",{path:e.toString(),value:t});let i=!0;const s=Wo(n),r={};if(Ie(t,(l,a)=>{i=!1,r[l]=Ra(de(e,l),ve(a),n.serverSyncTree_,s)}),i)we("update() called with empty data.  Don't do anything."),xi(n,o,"ok",void 0);else{const l=Ds(n),a=vh(n.serverSyncTree_,e,r,l);Vo(n.eventQueue_,a),n.server_.merge(e.toString(),t,(d,m)=>{const h=d==="ok";h||Me("update at "+e+" failed: "+d);const f=Bn(n.serverSyncTree_,l,!h),b=f.length>0?ht(n,e):e;ln(n.eventQueue_,b,f),xi(n,o,d,m)}),Ie(t,d=>{const m=Ns(n,de(e,d));ht(n,m)}),ln(n.eventQueue_,e,[])}}function Zh(n){jo(n,"onDisconnectEvents");const e=Wo(n),t=Uo();Bi(n.onDisconnect_,Q(),(i,s)=>{const r=Ra(i,s,n.serverSyncTree_,e);ga(t,i,r)});let o=[];Bi(t,Q(),(i,s)=>{o=o.concat(Lo(n.serverSyncTree_,i,s));const r=Ns(n,i);ht(n,r)}),n.onDisconnect_=Uo(),ln(n.eventQueue_,Q(),o)}function eu(n,e,t){let o;L(e._path)===".info"?o=zr(n.infoSyncTree_,e,t):o=zr(n.serverSyncTree_,e,t),Va(n.eventQueue_,e._path,o)}function Oi(n,e,t){let o;L(e._path)===".info"?o=Ni(n.infoSyncTree_,e,t):o=Ni(n.serverSyncTree_,e,t),Va(n.eventQueue_,e._path,o)}function nu(n){n.persistentConnection_&&n.persistentConnection_.interrupt(Kh)}function jo(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),we(t,...e)}function xi(n,e,t,o){e&&ft(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let s=i;o&&(s+=": "+o);const r=new Error(s);r.code=i,e(r)}})}function Ga(n,e,t){return gs(n.serverSyncTree_,e,t)||N.EMPTY_NODE}function Ts(n,e=n.transactionQueueTree_){if(e||Go(n,e),bt(e)){const t=Qa(n,e);_(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&tu(n,Zt(e),t)}else La(e)&&Ho(e,t=>{Ts(n,t)})}function tu(n,e,t){const o=t.map(d=>d.currentWriteId),i=Ga(n,e,o);let s=i;const r=i.hash();for(let d=0;d<t.length;d++){const m=t[d];_(m.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),m.status=1,m.retryCount++;const h=Re(e,m.path);s=s.updateChild(h,m.currentOutputSnapshotRaw)}const l=s.val(!0),a=e;n.server_.put(a.toString(),l,d=>{jo(n,"transaction put response",{path:a.toString(),status:d});let m=[];if(d==="ok"){const h=[];for(let f=0;f<t.length;f++)t[f].status=2,m=m.concat(Bn(n.serverSyncTree_,t[f].currentWriteId)),t[f].onComplete&&h.push(()=>t[f].onComplete(null,!0,t[f].currentOutputSnapshotResolved)),t[f].unwatcher();Go(n,Bs(n.transactionQueueTree_,e)),Ts(n,n.transactionQueueTree_),ln(n.eventQueue_,e,m);for(let f=0;f<h.length;f++)ft(h[f])}else{if(d==="datastale")for(let h=0;h<t.length;h++)t[h].status===3?t[h].status=4:t[h].status=0;else{Me("transaction at "+a.toString()+" failed: "+d);for(let h=0;h<t.length;h++)t[h].status=4,t[h].abortReason=d}ht(n,e)}},r)}function ht(n,e){const t=Ka(n,e),o=Zt(t),i=Qa(n,t);return ou(n,i,o),o}function ou(n,e,t){if(e.length===0)return;const o=[];let i=[];const r=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],d=Re(t,a.path);let m=!1,h;if(_(d!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)m=!0,h=a.abortReason,i=i.concat(Bn(n.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=Qh)m=!0,h="maxretry",i=i.concat(Bn(n.serverSyncTree_,a.currentWriteId,!0));else{const f=Ga(n,a.path,r);a.currentInputSnapshot=f;const b=e[l].update(f.val());if(b!==void 0){zo("transaction failed: Data returned ",b,a.path);let g=ve(b);typeof b=="object"&&b!=null&&hn(b,".priority")||(g=g.updatePriority(f.getPriority()));const D=a.currentWriteId,U=Wo(n),W=Oa(g,f,U);a.currentOutputSnapshotRaw=g,a.currentOutputSnapshotResolved=W,a.currentWriteId=Ds(n),r.splice(r.indexOf(D),1),i=i.concat(Da(n.serverSyncTree_,a.path,W,a.currentWriteId,a.applyLocally)),i=i.concat(Bn(n.serverSyncTree_,D,!0))}else m=!0,h="nodata",i=i.concat(Bn(n.serverSyncTree_,a.currentWriteId,!0))}ln(n.eventQueue_,t,i),i=[],m&&(e[l].status=2,function(f){setTimeout(f,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(h==="nodata"?o.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):o.push(()=>e[l].onComplete(new Error(h),!1,null))))}Go(n,n.transactionQueueTree_);for(let l=0;l<o.length;l++)ft(o[l]);Ts(n,n.transactionQueueTree_)}function Ka(n,e){let t,o=n.transactionQueueTree_;for(t=L(e);t!==null&&bt(o)===void 0;)o=Bs(o,t),e=oe(e),t=L(e);return o}function Qa(n,e){const t=[];return Ya(n,e,t),t.sort((o,i)=>o.order-i.order),t}function Ya(n,e,t){const o=bt(e);if(o)for(let i=0;i<o.length;i++)t.push(o[i]);Ho(e,i=>{Ya(n,i,t)})}function Go(n,e){const t=bt(e);if(t){let o=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[o]=t[i],o++);t.length=o,xa(e,t.length>0?t:void 0)}Ho(e,o=>{Go(n,o)})}function Ns(n,e){const t=Zt(Ka(n,e)),o=Bs(n.transactionQueueTree_,e);return Rh(o,i=>{hi(n,i)}),hi(n,o),Fa(o,i=>{hi(n,i)}),t}function hi(n,e){const t=bt(e);if(t){const o=[];let i=[],s=-1;for(let r=0;r<t.length;r++)t[r].status===3||(t[r].status===1?(_(s===r-1,"All SENT items should be at beginning of queue."),s=r,t[r].status=3,t[r].abortReason="set"):(_(t[r].status===0,"Unexpected transaction status in abort"),t[r].unwatcher(),i=i.concat(Bn(n.serverSyncTree_,t[r].currentWriteId,!0)),t[r].onComplete&&o.push(t[r].onComplete.bind(null,new Error("set"),!1,null))));s===-1?xa(e,void 0):t.length=s+1,ln(n.eventQueue_,Zt(e),i);for(let r=0;r<o.length;r++)ft(o[r])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iu(n){let e="";const t=n.split("/");for(let o=0;o<t.length;o++)if(t[o].length>0){let i=t[o];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch(s){}e+="/"+i}return e}function su(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const o=t.split("=");o.length===2?e[decodeURIComponent(o[0])]=decodeURIComponent(o[1]):Me(`Invalid query segment '${t}' in query '${n}'`)}return e}const Gr=function(n,e){const t=ru(n),o=t.namespace;t.domain==="firebase.com"&&yn(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!o||o==="undefined")&&t.domain!=="localhost"&&yn("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||g2();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new ea(t.host,t.secure,o,i,e,"",o!==t.subdomain),path:new q(t.pathString)}},ru=function(n){let e="",t="",o="",i="",s="",r=!0,l="https",a=443;if(typeof n=="string"){let d=n.indexOf("//");d>=0&&(l=n.substring(0,d-1),n=n.substring(d+2));let m=n.indexOf("/");m===-1&&(m=n.length);let h=n.indexOf("?");h===-1&&(h=n.length),e=n.substring(0,Math.min(m,h)),m<h&&(i=iu(n.substring(m,h)));const f=su(n.substring(Math.min(n.length,h)));d=e.indexOf(":"),d>=0?(r=l==="https"||l==="wss",a=parseInt(e.substring(d+1),10)):d=e.length;const b=e.slice(0,d);if(b.toLowerCase()==="localhost")t="localhost";else if(b.split(".").length<=2)t=b;else{const g=e.indexOf(".");o=e.substring(0,g).toLowerCase(),t=e.substring(g+1),s=o}"ns"in f&&(s=f.ns)}return{host:e,port:a,domain:t,subdomain:o,secure:r,scheme:l,pathString:i,namespace:s}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kr="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",lu=function(){let n=0;const e=[];return function(t){const o=t===n;n=t;let i;const s=new Array(8);for(i=7;i>=0;i--)s[i]=Kr.charAt(t%64),t=Math.floor(t/64);_(t===0,"Cannot push at time == 0");let r=s.join("");if(o){for(i=11;i>=0&&e[i]===63;i--)e[i]=0;e[i]++}else for(i=0;i<12;i++)e[i]=Math.floor(Math.random()*64);for(i=0;i<12;i++)r+=Kr.charAt(e[i]);return _(r.length===20,"nextPushId: Length should be 20."),r}}();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class au{constructor(e,t,o,i){this.eventType=e,this.eventRegistration=t,this.snapshot=o,this.prevName=i}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+Pe(this.snapshot.exportVal())}}class cu{constructor(e,t,o){this.eventRegistration=e,this.error=t,this.path=o}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ko{constructor(e,t,o,i){this._repo=e,this._path=t,this._queryParams=o,this._orderByCalled=i}get key(){return F(this._path)?null:os(this._path)}get ref(){return new Rn(this._repo,this._path)}get _queryIdentifier(){const e=kr(this._queryParams),t=Zi(e);return t==="{}"?"default":t}get _queryObject(){return kr(this._queryParams)}isEqual(e){if(e=qn(e),!(e instanceof Ko))return!1;const t=this._repo===e._repo,o=is(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&o&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+n0(this._path)}}function hu(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function uu(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===jn){const o="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==Gn)throw new Error(o);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==kn)throw new Error(o);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===ae){if(e!=null&&!Ri(e)||t!=null&&!Ri(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(_(n.getIndex()instanceof ls||n.getIndex()===ya,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class Rn extends Ko{constructor(e,t){super(e,t,new cs,!1)}get parent(){const e=ca(this._path);return e===null?null:new Rn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class To{constructor(e,t,o){this._node=e,this.ref=t,this._index=o}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new q(e),o=Kt(this.ref,e);return new To(this._node.getChild(t),o,ae)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(o,i)=>e(new To(i,Kt(this.ref,o),ae)))}hasChild(e){const t=new q(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function nn(n,e){return n=qn(n),n._checkNotDeleted("ref"),e!==void 0?Kt(n._root,e):n._root}function Kt(n,e){return n=qn(n),L(n._path)===null?Vh("child","path",e):Is("child","path",e),new Rn(n._repo,de(n._path,e))}function co(n,e){n=qn(n),Ss("push",n._path),za("push",e,n._path,!0);const t=ja(n._repo),o=lu(t),i=Kt(n,o),s=Kt(n,o);let r;return r=Promise.resolve(s),i.then=r.then.bind(r),i.catch=r.then.bind(r,void 0),i}function Xa(n){return Ss("remove",n._path),mu(n,null)}function mu(n,e){n=qn(n),Ss("set",n._path),za("set",e,n._path,!1);const t=new Yt;return Jh(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function Li(n,e){zh("update",e,n._path);const t=new Yt;return $h(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}class Ms{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const o=t._queryParams.getIndex();return new au("value",this,new To(e.snapshotNode,new Rn(t._repo,t._path),o))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new cu(this,e,t):null}matches(e){return e instanceof Ms?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function pu(n,e,t,o,i){let s;if(typeof o=="object"&&(s=void 0,i=o),typeof o=="function"&&(s=o),i&&i.onlyOnce){const a=t,d=(m,h)=>{Oi(n._repo,n,l),a(m,h)};d.userCallback=t.userCallback,d.context=t.context,t=d}const r=new du(t,s||void 0),l=new Ms(r);return eu(n._repo,n,l),()=>Oi(n._repo,n,l)}function qa(n,e,t,o){return pu(n,"value",e,t,o)}function Ja(n,e,t){Oi(n._repo,n,null)}class fu{}class yu extends fu{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){hu(e,"orderByChild");const t=new q(this._path);if(F(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const o=new ls(t),i=U0(e._queryParams,o);return uu(i),new Ko(e._repo,e._path,i,!0)}}function bu(n){return Is("orderByChild","path",n),new yu(n)}function gu(n,...e){let t=qn(n);for(const o of e)t=o._apply(t);return t}uh(Rn);gh(Rn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Au="FIREBASE_DATABASE_EMULATOR_HOST",Fi={};let _u=!1;function vu(n,e,t,o){const i=e.lastIndexOf(":"),s=e.substring(0,i),r=Nl(s);n.repoInfo_=new ea(e,r,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),o&&(n.authTokenProvider_=o)}function Pu(n,e,t,o,i){let s=o||n.options.databaseURL;s===void 0&&(n.options.projectId||yn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),we("Using default host for project ",n.options.projectId),s=`${n.options.projectId}-default-rtdb.firebaseio.com`);let r=Gr(s,i),l=r.repoInfo,a;typeof process!="undefined"&&ur&&(a=ur[Au]),a?(s=`http://${a}?ns=${l.namespace}`,r=Gr(s,i),l=r.repoInfo):r.repoInfo.secure;const d=new S2(n.name,n.options,e);Wh("Invalid Firebase Database URL",r),F(r.path)||yn("Database URL must point to the root of a Firebase Database (not including a child path).");const m=Uu(l,n,d,new I2(n,t));return new Eu(m,n)}function Cu(n,e){const t=Fi[e];(!t||t[n.key]!==n)&&yn(`Database ${e}(${n.repoInfo_}) has already been deleted.`),nu(n),delete t[n.key]}function Uu(n,e,t,o){let i=Fi[e.name];i||(i={},Fi[e.name]=i);let s=i[n.toURLString()];return s&&yn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new Yh(n,_u,t,o),i[n.toURLString()]=s,s}class Eu{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Xh(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Rn(this._repo,Q())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Cu(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&yn("Cannot call "+e+" on a deleted database.")}}function Bu(n=n2(),e){const t=q1(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const o=Fd("database");o&&wu(t,...o)}return t}function wu(n,e,t,o={}){n=qn(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,s=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&bo(o,s.repoInfo_.emulatorOptions))return;yn("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let r;if(s.repoInfo_.nodeAdmin)o.mockUserToken&&yn('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new ao(ao.OWNER);else if(o.mockUserToken){const l=typeof o.mockUserToken=="string"?o.mockUserToken:Hd(o.mockUserToken,n.app.options.projectId);r=new ao(l)}Nl(e)&&Zd(e),vu(s,i,o,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Iu(n){u2(e2),Ao(new Lt("database",(e,{instanceIdentifier:t})=>{const o=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return Pu(o,i,s,t)},"PUBLIC").setMultipleInstances(!0)),it(mr,pr,n),it(mr,pr,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Su={".sv":"timestamp"};function Vn(){return Su}pn.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};pn.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Iu();var ku="firebase",Du="12.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */it(ku,Du,"app");const Fn=n=>n?String(n).split(/[\r\n,=\s]/)[0].trim():"",Hi={apiKey:Fn("AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs"),authDomain:Fn("findparkinglot-2519e.firebaseapp.com"),projectId:Fn("findparkinglot-2519e"),databaseURL:Fn("https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app"),storageBucket:Fn("findparkinglot-2519e.firebasestorage.app"),messagingSenderId:Fn("976769533420"),appId:Fn("1:976769533420:web:f3108318b3def30017acc9")},dn=!!(Hi.apiKey&&Hi.databaseURL);let Qr=null,Ye=null;dn&&(Qr=xl(Hi),Ye=Bu(Qr));const ho="parking_overrides",St=E({}),$a=E(!1),zi=E(null);let Rt=null,ui=0;function uo(n,e){if(!n||!Array.isArray(e))return"";const t=Number(e[0]),o=Number(e[1]);return!isFinite(t)||!isFinite(o)?"":`${n}|${t.toFixed(6)},${o.toFixed(6)}`.replace(/[.#$/[\]]/g,"_")}function Za(n,e){if(!e)return n;const t={...n},o=i=>{const s=e[i];s!=null&&(typeof s=="string"&&s.trim()===""||(t[i]=s))};return o("description"),o("iconKey"),o("category"),o("friendliness"),o("priceInfo"),t}function Tu(){if(!(!dn||Rt))try{const n=nn(Ye,ho);Rt=n,qa(n,e=>{const t={};e.forEach(o=>{t[o.key]=o.val()||{}}),St.value=t,$a.value=!0},e=>{zi.value=e})}catch(n){zi.value=n}}function Nu(){Rt&&(Ja(Rt),Rt=null)}function Mu(){Xn(()=>{ui+=1,Tu()}),mt(()=>{ui-=1,ui<=0&&Nu()});const n=(s,r)=>{const l=uo(s,r);return l&&St.value[l]||null};return{overrides:St,ready:$a,error:zi,getOverride:n,hasOverride:(s,r)=>!!n(s,r),getOverrideHistory:(s,r)=>{const l=n(s,r);return!l||!l.history||typeof l.history!="object"?[]:Object.entries(l.history).map(([a,d])=>({...d||{},_key:a})).sort((a,d)=>a._key<d._key?1:a._key>d._key?-1:0)},upsertOverride:async(s,r,l)=>{var T,G,Ue;if(!dn)throw new Error("Firebase 尚未設定");const a=uo(s.name,s.geometry);if(!a)throw new Error("無法產生 override key (缺少 name 或 geometry)");const[d,m]=s.geometry,h={id:l.id,nickname:l.nickname||""},f={origName:s.name||"",origLng:Number(d),origLat:Number(m),description:typeof r.description=="string"?r.description.trim():"",iconKey:r.iconKey||"",category:r.category||"",friendliness:r.friendliness||"",priceInfo:typeof r.priceInfo=="string"?r.priceInfo.trim():"",updatedBy:h,updatedAt:Vn()},b=St.value[a]||null,g=Za(s,b),B=["description","iconKey","category","friendliness","priceInfo"],D={},U={};for(const ie of B){const Se=(T=g==null?void 0:g[ie])!=null?T:"",Te=(G=f[ie])!=null?G:"";String(Se)!==String(Te)&&(D[ie]=Se,U[ie]=Te)}const W=co(nn(Ye,`${ho}/${a}/history`)).key;return await Li(nn(Ye),{[`${ho}/${a}`]:{...f,history:{...((Ue=St.value[a])==null?void 0:Ue.history)||{},[W]:{action:"override",at:Vn(),by:h,before:D,after:U}}}}),a},resetOverride:async(s,r)=>{if(!dn)throw new Error("Firebase 尚未設定");const l=uo(s,r);l&&await Xa(nn(Ye,`${ho}/${l}`))}}}const an=(n,e)=>{const t=n.__vccOpts||n;for(const[o,i]of e)t[o]=i;return t},Ru={id:"map"},Ou=16,Yr=34,xu=84,Lu={__name:"MapBox",props:{parkingTypeKeyArray:Array,degreeOfFriendlinessKeyArray:Array,mapDataList:Array,getLngLat:Boolean,mapStylesSelected:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,goToParkingPlaceData:Object,routeData:Object,favoriteIds:{type:Object,default:()=>new Set},overrideKeys:{type:Object,default:()=>new Set},overrides:{type:Object,default:()=>({})},onlyFavorites:{type:Boolean,default:!1},showOfficial:{type:Boolean,default:!0},showOverridden:{type:Boolean,default:!0},showCommunity:{type:Boolean,default:!0},focusCoord:{type:Array,default:null},routeProfile:{type:String,default:"driving"},communityParkings:{type:Array,default:()=>[]}},emits:["parkingInfo","communityParkingClick","update:goToParkingPlaceData","update:routeData"],setup(n,{expose:e,emit:t}){const o=n,i=t,s="pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",r=E(null),l=E({accessToken:s,bounds:[[119.3620389067818,21.83282743468497],[122.07013958372167,25.34391086143183]],center:[121.5173399,25.0475613],zoom:14,userCoordinates:[null,null]}),a=E(null),d=E([]),m=C=>C>=15?60:C>=13?60+(15-C)*30:C>=11?120+(13-C)*60:240,h=C=>Array.isArray(C)&&C.length>=2&&Number.isFinite(Number(C[0]))&&Number.isFinite(Number(C[1])),f=(C,R,X,j,se)=>{const re=document.createElement("div");re.className="marker",j&&re.classList.add("is-override"),X&&re.classList.add("is-fav");const ke=document.createElement("div");ke.className="tag";const ue=document.createElement("div");ue.className="img";const xe=se||R.properties.icon;return xe&&(ue.style.backgroundImage=`url(${$(xe)})`,ue.style.backgroundSize="cover",ue.style.backgroundPosition="center center"),re.appendChild(ke),re.appendChild(ue),re.addEventListener("click",()=>{r.value.flyTo({center:R.geometry.coordinates,zoom:17,bearing:0,speed:1.5,curve:1.5,easing:A=>A,essential:!0}),i("parkingInfo",{name:C.name,properties:R.properties,geometry:R.geometry.coordinates,address:""})}),re},b=(C,R)=>{const X=document.createElement("div");X.className="marker is-community",R&&X.classList.add("is-fav");const j=document.createElement("div");j.className="tag";const se=document.createElement("div");return se.className="img",C.iconKey&&(se.style.backgroundImage=`url(${$(C.iconKey)})`,se.style.backgroundSize="cover",se.style.backgroundPosition="center center"),X.appendChild(j),X.appendChild(se),X.addEventListener("click",()=>{r.value.flyTo({center:C.coordinates,zoom:17,speed:1.5,curve:1.5,essential:!0}),i("communityParkingClick",C)}),X},g=C=>{const R=document.createElement("div");R.className="marker-cluster";const X=Math.min(1,Math.log2(Math.max(2,C))/Math.log2(500)),j=Math.round(Yr+(xu-Yr)*X),se=Math.round(12+10*X);return R.style.width=`${j}px`,R.style.height=`${j}px`,R.style.lineHeight=`${j}px`,R.style.fontSize=`${se}px`,R.textContent=String(C),R},B=()=>{var re,ke,ue,xe,Le,A,M,S,pe,Ge,Fe,$e;for(let z=d.value.length-1;z>=0;z--)d.value[z].remove();if(d.value=[],!r.value)return;const C=(ke=(re=r.value).getBounds)==null?void 0:ke.call(re),R=[];for(const z of o.mapDataList)for(const O of z.features){const J=O.geometry.coordinates;if(!h(J))continue;const he=yi(O.properties.name,J),De=(xe=(ue=o.favoriteIds)==null?void 0:ue.has)==null?void 0:xe.call(ue,he),le=uo(O.properties.name,J),He=le?(A=(Le=o.overrideKeys)==null?void 0:Le.has)==null?void 0:A.call(Le,le):!1;if(He){if(!o.showOfficial&&!o.showOverridden)continue}else if(!o.showOfficial)continue;const Ne=He?(M=o.overrides)==null?void 0:M[le]:null,xn=typeof(Ne==null?void 0:Ne.priceInfo)=="string"&&Ne.priceInfo.trim()!==""?Ne.priceInfo.trim():"",eo=xn||O.properties.priceInfo,Qo=xn?xn.split("|"):O.properties.priceArray,no=(typeof(Ne==null?void 0:Ne.iconKey)=="string"&&Ne.iconKey.trim()!==""?Ne.iconKey.trim():"")||O.properties.icon;!Zs(C,J)||o.onlyFavorites&&!De||!Js(no,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray)||!$s(eo,Qo,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)||R.push({coord:[Number(J[0]),Number(J[1])],createEl:()=>f(z,O,De,He,no)})}for(const z of o.communityParkings||[]){if(!o.showCommunity)break;const O=z.coordinates;if(!h(O)||!Zs(C,O))continue;const J=yi(z.name,O),he=(pe=(S=o.favoriteIds)==null?void 0:S.has)==null?void 0:pe.call(S,J);if(o.onlyFavorites&&!he||!Js(z.iconKey,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray))continue;const De=z.priceInfo||"",le=De?De.split("|"):[];$s(De,le,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)&&R.push({coord:[Number(O[0]),Number(O[1])],createEl:()=>b(z,he)})}const X=($e=(Fe=(Ge=r.value).getZoom)==null?void 0:Fe.call(Ge))!=null?$e:0;if(X>=Ou){for(const z of R){const O=new Ln.Marker(z.createEl()).setLngLat(z.coord).addTo(r.value);d.value.push(O)}return}const j=m(X),se=new Map;for(const z of R){const O=r.value.project(z.coord),J=Math.floor(O.x/j),he=Math.floor(O.y/j),De=`${J}:${he}`;let le=se.get(De);le||(le={points:[],sumLng:0,sumLat:0},se.set(De,le)),le.points.push(z),le.sumLng+=z.coord[0],le.sumLat+=z.coord[1]}for(const z of se.values())if(z.points.length===1){const O=z.points[0],J=new Ln.Marker(O.createEl()).setLngLat(O.coord).addTo(r.value);d.value.push(J)}else{const O=[z.sumLng/z.points.length,z.sumLat/z.points.length],J=g(z.points.length);J.addEventListener("click",()=>{var le,He,Ne;const De=Math.min(((Ne=(He=(le=r.value).getZoom)==null?void 0:He.call(le))!=null?Ne:0)+2,17);r.value.flyTo({center:O,zoom:De,speed:1.5,curve:1.5,essential:!0})});const he=new Ln.Marker(J).setLngLat(O).addTo(r.value);d.value.push(he)}};let D=null,U=null;const W=()=>{D!=null&&(clearTimeout(D),D=null),U!=null&&(typeof cancelIdleCallback=="function"&&cancelIdleCallback(U),U=null)},T=()=>{W(),D=setTimeout(()=>{D=null;const C=()=>{U=null,o.goToParkingPlaceData==null&&B()};typeof requestIdleCallback=="function"?U=requestIdleCallback(C,{timeout:250}):C()},80)},G=()=>{const C=document.getElementById("loading-cover");C&&(C.classList.add("active"),setTimeout(()=>C.remove(),600))},Ue=()=>{r.value.on("dragend",T),r.value.on("zoomend",T),B(),G(),r.value.once("load",()=>{const C=o.focusCoord;Array.isArray(C)&&C[0]!=null&&C[1]!=null&&r.value.flyTo({center:[Number(C[0]),Number(C[1])],zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})})},ie=()=>{r.value=new Ln.Map({container:"map",style:o.mapStylesSelected,center:l.value.center,zoom:16,trackResize:!0,maxBounds:l.value.bounds}),Ue(),r.value.addControl(new Ln.GeolocateControl({positionOptions:{enableHighAccuracy:!0},trackUserLocation:!0,showUserHeading:!0})),r.value.on("geolocate",C=>{r.value.easeTo({bearing:C.coords.heading,duration:1e3,offset:[0,0]})})},Se=C=>{const{longitude:R,latitude:X}=C.coords;R>=l.value.bounds[0][0]&&R<=l.value.bounds[1][0]&&X>=l.value.bounds[0][1]&&X<=l.value.bounds[1][1]?(l.value.userCoordinates=[R,X],l.value.center=[R,X]):l.value.center=[121.5173399,25.0475613],ie()},Te=()=>{ie()},Je=()=>{const C=document.getElementById("coordinates"),R=a.value.getLngLat();C.style.display="block",C.innerHTML=`[Longitude, Latitude]<br />[${R.lng}, ${R.lat}]`},ge=()=>{a.value=new Ln.Marker({draggable:!0,color:"#2ee7d6"}).setLngLat(r.value.getCenter()).addTo(r.value),Je(),a.value.on("dragend",Je)};async function ce(C,R){r.value.getLayer("point")||r.value.addLayer({id:"point",type:"circle",source:{type:"geojson",data:{type:"FeatureCollection",features:[{type:"Feature",properties:{},geometry:{type:"Point",coordinates:C}}]}},paint:{"circle-radius":10,"circle-color":"#2ee7d6"}});const se=(await(await fetch(`https://api.mapbox.com/directions/v5/mapbox/${o.routeProfile||"driving"}/${C[0]},${C[1]};${R[0]},${R[1]}?alternatives=false&language=zh-Hant&overview=full&steps=true&exclude=ferry&geometries=geojson&access_token=${l.value.accessToken}`,{method:"GET"})).json()).routes[0],re={type:"Feature",properties:{},geometry:{type:"LineString",coordinates:se.geometry.coordinates}};i("update:routeData",se),r.value.getSource("route")?r.value.getSource("route").setData(re):r.value.addLayer({id:"route",type:"line",source:{type:"geojson",data:re},layout:{"line-join":"round","line-cap":"round"},paint:{"line-color":"#2ee7d6","line-width":5,"line-opacity":.75}})}const Ee=C=>{if(l.value.userCoordinates[0]!==null){r.value.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point"));for(let X=d.value.length-1;X>=0;X--){const j=d.value[X].getLngLat();j.lng!=C[0]&&j.lat!=C[1]&&d.value[X].remove()}const R=[[l.value.userCoordinates[0],l.value.userCoordinates[1]],[C[0],C[1]]];r.value.fitBounds(R,{padding:{top:100,bottom:100,left:100,right:100}}),ce(l.value.userCoordinates,C)}else"geolocation"in navigator&&navigator.geolocation.getCurrentPosition(Se,Te)},je=()=>{var C,R;(C=r.value)!=null&&C.getSource("route")&&(r.value.removeLayer("route"),r.value.removeSource("route")),(R=r.value)!=null&&R.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point")),B(),i("update:goToParkingPlaceData",null)};return Xn(()=>{Ln.accessToken=l.value.accessToken,"geolocation"in navigator?navigator.geolocation.getCurrentPosition(Se,Te,{enableHighAccuracy:!1,timeout:8e3,maximumAge:6e4}):ie()}),mt(()=>{W()}),K([()=>o.parkingTypeKeyArray,()=>o.degreeOfFriendlinessKeyArray,()=>o.priceRangeMin,()=>o.priceRangeMax,()=>o.parkingPriceType,()=>o.onlyFavorites,()=>o.showOfficial,()=>o.showOverridden,()=>o.showCommunity,()=>o.favoriteIds,()=>o.communityParkings,()=>o.overrides],()=>T(),{deep:!0}),K(()=>o.focusCoord,C=>{!C||!r.value||r.value.flyTo({center:C,zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})}),K(()=>o.routeProfile,()=>{o.goToParkingPlaceData!==null&&l.value.userCoordinates[0]!==null&&ce(l.value.userCoordinates,o.goToParkingPlaceData)}),K(()=>o.goToParkingPlaceData,C=>{C!==null?Ee(C):je()}),K(()=>o.mapStylesSelected,(C,R)=>{R!==C&&r.value&&r.value.setStyle(C)}),K(()=>o.getLngLat,()=>{if(a.value!==null){a.value.remove();const C=document.getElementById("coordinates");C&&(C.style.display="none")}o.getLngLat===!0&&ge()}),e({getCenter:()=>{if(!r.value)return[...l.value.center];const C=r.value.getCenter();return[C.lng,C.lat]},flyTo:(C,R=17)=>{!r.value||!C||r.value.flyTo({center:C,zoom:R,essential:!0})}}),(C,R)=>(v(),P("div",Ru))}},Fu=an(Lu,[["__scopeId","data-v-98a3b97e"]]),Hu=n=>(Nn("data-v-4ef15e45"),n=n(),Mn(),n),zu={key:0,class:"modal-header"},Vu=Hu(()=>c("span",{class:"material-icons-outlined"},"close",-1)),Wu=[Vu],ju={class:"modal-body"},Gu={key:1,class:"modal-footer"},Ku={__name:"BaseModal",props:{modelValue:Boolean,title:{type:String,default:""},closeText:{type:String,default:"關閉"},size:{type:String,default:"md"}},emits:["update:modelValue","close"],setup(n,{emit:e}){const t=n,o=e,i=E(null),s=()=>{o("update:modelValue",!1),o("close")},r=l=>{l.key==="Escape"&&t.modelValue&&s()};return Xn(()=>window.addEventListener("keydown",r)),mt(()=>window.removeEventListener("keydown",r)),K(()=>t.modelValue,async l=>{var a;document.body.classList.toggle("modal-open",l),l&&(await hl(),(a=i.value)==null||a.scrollTo({top:0,behavior:"auto"}))}),(l,a)=>(v(),Ki(Nc,{to:"body"},[c("div",{class:Z(["modal-overlay",{active:n.modelValue}]),onClick:Qi(s,["self"]),role:"dialog","aria-modal":"true",ref_key:"overlayEl",ref:i},[c("div",{class:Z(["modal-card",[`size-${n.size}`,{active:n.modelValue}]])},[n.title||l.$slots.header?(v(),P("header",zu,[ei(l.$slots,"header",{},()=>[c("h3",null,w(n.title),1)]),c("button",{class:"modal-close",onClick:s,"aria-label":"關閉"},Wu)])):V("",!0),c("div",ju,[ei(l.$slots,"default",{},void 0)]),l.$slots.footer||n.closeText?(v(),P("footer",Gu,[ei(l.$slots,"footer",{},()=>[c("button",{class:"btn btn-primary",onClick:s},w(n.closeText),1)])])):V("",!0)],2)],2)]))}},Un=an(Ku,[["__scopeId","data-v-4ef15e45"]]),Qu=["onClick"],Yu={class:"material-icons-outlined"},Xu={class:"fab-item-label"},qu=["aria-label","aria-expanded"],Ju={class:"material-icons-outlined"},$u={__name:"FabMenu",props:{items:{type:Array,required:!0},placement:{type:String,default:"right"},mainIcon:{type:String,default:"apps"},mainLabel:{type:String,default:""}},setup(n){const e=E(!1),t=E(null),o=()=>e.value=!e.value,i=r=>{t.value&&!t.value.contains(r.target)&&(e.value=!1)},s=r=>{var l;e.value=!1,(l=r.onClick)==null||l.call(r)};return Xn(()=>document.addEventListener("click",i)),mt(()=>document.removeEventListener("click",i)),(r,l)=>(v(),P("div",{class:Z(["fab-root",`fab-placement-${n.placement}`]),ref_key:"rootEl",ref:t},[Be(Mc,{name:"fab-item",tag:"div",class:"fab-items"},{default:en(()=>[(v(!0),P(be,null,We(e.value?n.items:[],(a,d)=>(v(),P("button",{key:a.key,class:Z(["fab-item",{highlight:a.highlight}]),style:po({bottom:d*46+"px"}),onClick:m=>s(a)},[c("span",Yu,w(a.icon),1),c("span",Xu,w(a.label),1)],14,Qu))),128))]),_:1}),c("button",{class:Z(["fab-main",{active:e.value}]),onClick:Qi(o,["stop"]),"aria-label":e.value?"收合選單":n.mainLabel||"展開選單","aria-expanded":e.value},[c("span",Ju,w(e.value?"close":n.mainIcon),1)],10,qu)],2))}},Xr=an($u,[["__scopeId","data-v-b3399b6f"]]),ut=[{name:"全部",value:"",key:null},{name:"汽車：汽車格(含未確認是否有重機格)",value:"car",key:["icon-1.png","icon-2.png","icon-3.png","icon-5.png"]},{name:"重機：有設重機專用格",value:"motorcycle",key:["icon-6.png","icon-8.png","icon-12.png","icon-13.png"]},{name:"機車：機車格",value:"scooter",key:["icon-7.png","icon-9.png","icon-10.png","icon-11.png"]},{name:"綠星:路邊友善車格(機車格開放重機停放)",value:"greenStar",key:["icon-14.png"]},{name:"重機友善店家:用餐/消費可停重機",value:"friendlyShop",key:["icon-4.png"]},{name:"綠P:重機專用路邊停車格",value:"greenP",key:["icon-15.png"]},{name:"灰P:重機專用路邊停車格(未確認精準座標)",value:"greyP",key:["icon-16.png"]},{name:"藍P:普通大型共用機車格(台北市試辦)",value:"blueP",key:["icon-17.png"]},{name:"紫P:時段性汽機車共用停車格，注意使用時間喔!",value:"purpleP",key:["icon-18.png"]},{name:"紅X:停都不給停",value:"redX",key:["icon-19.png"]},{name:"?:類型未確認",value:"unknown",key:["icon-20.png"]}];function Zu(n){if(!n)return"未分類";const e=ut.find(t=>Array.isArray(t.key)&&t.key.includes(n));return e?e.name.split(/[：:]/)[0]:"未分類"}const Qt=[{name:"全部",value:"",key:null},{name:"最友善：有後牌辨析",value:"friendly",key:["icon-2.png","icon-4.png","icon-6.png","icon-9.png","icon-14.png","icon-15.png"]},{name:"最傳統：悠遊卡、按鈕取票",value:"normal",key:["icon-5.png","icon-11.png","icon-12.png","icon-17.png"]},{name:"最靠北：按鈕請管理員協助、前牌辨析",value:"unfriendly",key:["icon-1.png","icon-7.png","icon-13.png","icon-19.png"]},{name:"未確定",value:"unknown",key:["icon-3.png","icon-8.png","icon-10.png","icon-16.png","icon-20.png"]}],tt=[{name:"依系統設定",value:"system",theme:"system"},{name:"暗色模式",value:"mapbox://styles/jamestim9215/ckvkdj5cd1q4115nzwxa9rny3",theme:"dark"},{name:"亮色模式",value:"mapbox://styles/jamestim9215/ckvueghhu2woc14nrsgysx41v",theme:"light"}],e3="260923",n3=n=>(Nn("data-v-fc736dec"),n=n(),Mn(),n),t3={class:"range-slider"},o3={class:"range-track"},i3=["min","max","step","value"],s3=["min","max","step","value"],r3={class:"range-values"},l3=n3(()=>c("span",{class:"range-sep"},"~",-1)),a3={__name:"RangeSlider",props:{min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:10},modelMin:{type:Number,default:0},modelMax:{type:Number,default:100},suffix:{type:String,default:""}},emits:["update:modelMin","update:modelMax"],setup(n,{emit:e}){const t=n,o=e,i=Y(()=>t.max-t.min||1),s=Y(()=>(t.modelMin-t.min)/i.value*100),r=Y(()=>(t.modelMax-t.min)/i.value*100),l=d=>{let m=Number(d.target.value);m>t.modelMax&&(m=t.modelMax),o("update:modelMin",m)},a=d=>{let m=Number(d.target.value);m<t.modelMin&&(m=t.modelMin),o("update:modelMax",m)};return(d,m)=>(v(),P("div",t3,[c("div",o3,[c("div",{class:"range-fill",style:po({left:s.value+"%",right:100-r.value+"%"})},null,4),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMin,onInput:l,class:"range-input range-input-min","aria-label":"最低價格"},null,40,i3),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMax,onInput:a,class:"range-input range-input-max","aria-label":"最高價格"},null,40,s3)]),c("div",r3,[c("span",null,w(n.modelMin)+w(n.suffix),1),l3,c("span",null,w(n.modelMax)+w(n.suffix),1)])]))}},c3=an(a3,[["__scopeId","data-v-fc736dec"]]),Ce=n=>(Nn("data-v-ed90af5a"),n=n(),Mn(),n),d3=Ce(()=>c("span",{class:"material-icons-outlined"},"chevron_left",-1)),h3=[d3],u3=ul('<header class="side-panel-header" data-v-ed90af5a><img class="side-panel-logo" src="'+Yi+'" alt="重機能停哪" data-v-ed90af5a><div class="side-panel-titles" data-v-ed90af5a><h3 data-v-ed90af5a>重機能停哪?</h3><span class="side-panel-subtitle" data-v-ed90af5a><span class="material-icons-outlined" data-v-ed90af5a>tune</span>設定 </span></div></header>',1),m3={class:"side-panel-body"},p3={class:"form-group"},f3={class:"form-toggle"},y3={class:"form-toggle-text"},b3=Ce(()=>c("span",{class:"material-icons-outlined fav-icon"},"star",-1)),g3={class:"source-count"},A3=["checked"],_3={class:"form-group"},v3=Ce(()=>c("label",{class:"form-label"},"顯示分類",-1)),P3={class:"source-chips"},C3=["aria-pressed"],U3=Ce(()=>c("span",{class:"material-icons-outlined source-icon"},"place",-1)),E3={class:"chip-count"},B3=["aria-pressed"],w3=Ce(()=>c("span",{class:"material-icons-outlined source-icon"},"edit_location_alt",-1)),I3={class:"chip-count"},S3=["aria-pressed"],k3=Ce(()=>c("span",{class:"material-icons-outlined source-icon"},"add_location_alt",-1)),D3={class:"chip-count"},T3={class:"form-group"},N3=Ce(()=>c("label",{class:"form-label"},"甚麼格位",-1)),M3=["value"],R3=["value"],O3={class:"form-group"},x3=Ce(()=>c("label",{class:"form-label"},"友善程度",-1)),L3=["value"],F3=["value"],H3={class:"form-group"},z3=Ce(()=>c("label",{class:"form-label"},"收費範圍",-1)),V3={class:"price-chips"},W3=Ce(()=>c("span",{class:"material-icons-outlined"},"money_off",-1)),j3={class:"form-group"},G3=Ce(()=>c("label",{class:"form-label"},"主題顏色",-1)),K3=["value"],Q3=["value"],Y3=Ce(()=>c("section",{class:"form-group"},[c("label",{class:"form-label"},"停車場資料來源"),c("div",{class:"link-list"},[c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"btn btn-outline btn-sm"}," Alan大重停車記事 ")])],-1)),X3={class:"form-group"},q3=ul('<label class="form-label" data-v-ed90af5a>問題回報</label><p class="muted-text" data-v-ed90af5a> 1. 停車場資訊相關（新場地、收費錯誤）： </p><a href="https://forms.gle/euRCPCPSmvYLm5Rj8" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-ed90af5a> Alan大重停車記事 回報表單 </a><p class="muted-text mt-8" data-v-ed90af5a>2. 網頁 BUG、畫面跑版：</p><a href="https://forms.gle/iJCyfqVtpL35WtZM7" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-ed90af5a> 重機能停哪? 回報表單 </a>',5),J3={class:"form-group"},$3=Ce(()=>c("label",{class:"form-label"},"資訊",-1)),Z3={class:"info-list"},e5=Ce(()=>c("li",null,"版本：v2.3.0",-1)),n5=Ce(()=>c("li",null,"Web 製作：爽爽",-1)),t5=Ce(()=>c("li",null,"資料參考：Alan大重停車記事 Google My Map",-1)),o5=Ce(()=>c("li",null,"地圖：Mapbox GL JS API",-1)),i5=Ce(()=>c("li",null,"© 2026 爽爽 版權所有。本網頁未經准許，禁止任何商業行為",-1)),s5={__name:"SettingsPanel",props:{parkingType:String,degreeOfFriendliness:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,mapStyle:String,active:Boolean,onlyFavorites:Boolean,favoritesCount:{type:Number,default:0},showOfficial:{type:Boolean,default:!0},showOverridden:{type:Boolean,default:!0},showCommunity:{type:Boolean,default:!0},officialCount:{type:Number,default:0},overriddenCount:{type:Number,default:0},communityCount:{type:Number,default:0}},emits:["update:parkingType","update:degreeOfFriendliness","update:parkingPriceType","update:priceRangeMin","update:priceRangeMax","update:mapStyle","update:active","update:onlyFavorites","update:showOfficial","update:showOverridden","update:showCommunity","open-support"],setup(n,{emit:e}){const t=e,o=()=>t("update:active",!1);return(i,s)=>(v(),P("aside",{class:Z(["side-panel",{active:n.active}]),"aria-label":"設定面板"},[c("button",{class:"side-panel-close",onClick:o,"aria-label":"收合設定"},h3),u3,c("div",m3,[c("section",p3,[c("label",f3,[c("span",y3,[b3,k(" 只看我的最愛 "),c("span",g3,"("+w(n.favoritesCount)+")",1)]),c("input",{type:"checkbox",class:"switch",checked:n.onlyFavorites,onChange:s[0]||(s[0]=r=>t("update:onlyFavorites",r.target.checked))},null,40,A3)])]),c("section",_3,[v3,c("div",P3,[c("button",{type:"button",class:Z(["chip source-chip source-chip-official",{active:n.showOfficial}]),onClick:s[1]||(s[1]=r=>t("update:showOfficial",!n.showOfficial)),"aria-pressed":n.showOfficial},[U3,k(" 官方 "),c("span",E3,w(n.officialCount),1)],10,C3),c("button",{type:"button",class:Z(["chip source-chip source-chip-override",{active:n.showOverridden}]),onClick:s[2]||(s[2]=r=>t("update:showOverridden",!n.showOverridden)),"aria-pressed":n.showOverridden},[w3,k(" 修改 "),c("span",I3,w(n.overriddenCount),1)],10,B3),c("button",{type:"button",class:Z(["chip source-chip source-chip-community",{active:n.showCommunity}]),onClick:s[3]||(s[3]=r=>t("update:showCommunity",!n.showCommunity)),"aria-pressed":n.showCommunity},[k3,k(" 共筆 "),c("span",D3,w(n.communityCount),1)],10,S3)])]),c("section",T3,[N3,c("select",{class:"form-control",value:n.parkingType,onChange:s[4]||(s[4]=r=>t("update:parkingType",r.target.value))},[(v(!0),P(be,null,We(x(ut),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,R3))),128))],40,M3)]),c("section",O3,[x3,c("select",{class:"form-control",value:n.degreeOfFriendliness,onChange:s[5]||(s[5]=r=>t("update:degreeOfFriendliness",r.target.value))},[(v(!0),P(be,null,We(x(Qt),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,F3))),128))],40,L3)]),c("section",H3,[z3,c("div",V3,[c("button",{type:"button",class:Z(["chip",{active:n.parkingPriceType===""}]),onClick:s[6]||(s[6]=r=>t("update:parkingPriceType",""))},"全部",2),c("button",{type:"button",class:Z(["chip chip-free",{active:n.parkingPriceType==="free"}]),onClick:s[7]||(s[7]=r=>t("update:parkingPriceType",n.parkingPriceType==="free"?"":"free"))},[W3,k(" 免費 ")],2),c("button",{type:"button",class:Z(["chip",{active:n.parkingPriceType==="h"}]),onClick:s[8]||(s[8]=r=>t("update:parkingPriceType","h"))},"計時 /時",2),c("button",{type:"button",class:Z(["chip",{active:n.parkingPriceType==="d"}]),onClick:s[9]||(s[9]=r=>t("update:parkingPriceType","d"))},"計次 /日",2),c("button",{type:"button",class:Z(["chip",{active:n.parkingPriceType==="t"}]),onClick:s[10]||(s[10]=r=>t("update:parkingPriceType","t"))},"計次 /不限時",2)]),/d|h|t/.test(n.parkingPriceType)?(v(),Ki(c3,{key:0,class:"mt-8",min:0,max:300,step:10,"model-min":n.priceRangeMin,"model-max":n.priceRangeMax,suffix:n.parkingPriceType==="h"?" /時":n.parkingPriceType==="d"?" /日":" /次","onUpdate:modelMin":s[11]||(s[11]=r=>t("update:priceRangeMin",r)),"onUpdate:modelMax":s[12]||(s[12]=r=>t("update:priceRangeMax",r))},null,8,["model-min","model-max","suffix"])):V("",!0)]),c("section",j3,[G3,c("select",{class:"form-control",value:n.mapStyle,onChange:s[13]||(s[13]=r=>t("update:mapStyle",r.target.value))},[(v(!0),P(be,null,We(x(tt),r=>(v(),P("option",{value:r.value,key:r.value},w(r.name),9,Q3))),128))],40,K3)]),Y3,c("section",X3,[q3,c("button",{type:"button",class:"btn btn-coffee btn-sm mt-8",onClick:s[14]||(s[14]=r=>t("open-support"))}," ❤️ 贊助支持，讓我有動力繼續更新 ")]),c("section",J3,[$3,c("ul",Z3,[e5,c("li",null,"地圖資料更新：自動更新於"+w(x(e3)),1),n5,t5,o5,i5])])])],2))}},r5=an(s5,[["__scopeId","data-v-ed90af5a"]]),qe=n=>(Nn("data-v-d09400e9"),n=n(),Mn(),n),l5=qe(()=>c("span",{class:"material-icons-outlined"},"close",-1)),a5=[l5],c5={class:"info-header"},d5=["src"],h5={class:"info-title"},u5=["aria-label","title"],m5={class:"material-icons-outlined"},p5=["innerHTML"],f5={key:1,class:"info-address"},y5={key:2,class:"info-price"},b5=qe(()=>c("span",{class:"material-icons-outlined"},"payments",-1)),g5=qe(()=>c("span",{class:"info-price-label"},"收費",-1)),A5={class:"info-price-value"},_5={key:0,class:"info-price-tag"},v5={key:3,class:"community-tag"},P5=qe(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),C5={key:4,class:"override-tag"},U5=qe(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),E5={key:5,class:"source-tag"},B5=qe(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),w5={class:"info-meta"},I5={class:"badge-group"},S5={class:"badge"},k5={key:0,class:"badge badge-icon",title:"依圖示分類"},D5={class:"coord"},T5={class:"info-actions"},N5=qe(()=>c("span",{class:"material-icons-outlined"},"edit",-1)),M5=["title"],R5=qe(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),O5=qe(()=>c("span",{class:"material-icons-outlined"},"share",-1)),x5={class:"info-actions"},L5=qe(()=>c("span",{class:"material-icons-outlined"},"map",-1)),F5=qe(()=>c("span",{class:"material-icons-outlined"},"map",-1)),H5=qe(()=>c("span",{class:"material-icons-outlined"},"directions",-1)),z5={__name:"ParkingInfoPanel",props:{info:Object,active:Boolean,isMobile:Boolean,isApple:Boolean,isAndroid:Boolean,hasRoute:Boolean,isFavorite:Boolean,isCommunity:{type:Boolean,default:!1},communityMeta:{type:Object,default:null},isOverridden:{type:Boolean,default:!1},overrideMeta:{type:Object,default:null}},emits:["close","route","openMap","toggleFavorite","editCommunity","editOverride","share"],setup(n,{emit:e}){const t=n,o=e,i=new Set(["icon-4.png","icon-14.png","icon-19.png"]),s=l=>l!=null&&l.priceInfo?t.isCommunity||t.isOverridden?!0:!i.has(l==null?void 0:l.parkingIconKey):!1,r=l=>{if(!l)return"";if(/^free$/i.test(l.trim()))return"免費";const a=l.trim().match(/^(\d+(?:\.\d+)?)\s*\/\s*(h|d|次)$/i);if(!a)return l;const d=a[2].toLowerCase(),m=d==="h"?"小時":d==="d"?"日":"次 (不限時)";return`${a[1]} 元 / ${m}`};return(l,a)=>{var d,m,h,f,b,g,B,D;return v(),P("aside",{class:Z(["info-panel",{active:n.active}]),"aria-label":"停車場資訊"},[c("button",{class:"panel-close",onClick:a[0]||(a[0]=U=>o("close")),"aria-label":"關閉"},a5),c("header",c5,[n.info.parkingIcon?(v(),P("img",{key:0,class:"info-icon",src:n.info.parkingIcon,alt:""},null,8,d5)):V("",!0),c("h3",h5,w(n.info.parkingName),1),c("button",{class:Z(["fav-btn",{active:n.isFavorite}]),onClick:a[1]||(a[1]=U=>o("toggleFavorite")),"aria-label":n.isFavorite?"從我的最愛移除":"加入我的最愛",title:n.isFavorite?"從我的最愛移除":"加入我的最愛"},[c("span",m5,w(n.isFavorite?"star":"star_border"),1)],10,u5)]),n.info.parkingNameDes?(v(),P("div",{key:0,class:"info-desc",innerHTML:n.info.parkingNameDes},null,8,p5)):V("",!0),n.info.address?(v(),P("div",f5,w(n.info.address),1)):V("",!0),s(n.info)?(v(),P("div",y5,[b5,g5,c("span",A5,w(r(n.info.priceInfo)),1),n.isOverridden?(v(),P("span",_5,"車友修改")):V("",!0)])):V("",!0),n.isCommunity?(v(),P("div",v5,[P5,c("span",null,[k(" 共筆停車點 "),(m=(d=n.communityMeta)==null?void 0:d.updatedBy)!=null&&m.nickname||(f=(h=n.communityMeta)==null?void 0:h.updatedBy)!=null&&f.id?(v(),P(be,{key:0},[k(" · 由 "+w(n.communityMeta.updatedBy.nickname||`匿名#${n.communityMeta.updatedBy.id}`)+" 更新 ",1)],64)):V("",!0)])])):n.isOverridden?(v(),P("div",C5,[U5,c("span",null,[k(" 車友修改資訊 "),(g=(b=n.overrideMeta)==null?void 0:b.updatedBy)!=null&&g.nickname||(D=(B=n.overrideMeta)==null?void 0:B.updatedBy)!=null&&D.id?(v(),P(be,{key:0},[k(" · 由 "+w(n.overrideMeta.updatedBy.nickname||`匿名#${n.overrideMeta.updatedBy.id}`)+" 更新 ",1)],64)):V("",!0)])])):V("",!0),!n.isCommunity&&n.info.sourceLabel?(v(),P("div",E5,[B5,c("span",null,"資料來源 · "+w(n.info.sourceLabel),1)])):V("",!0),c("div",w5,[c("div",I5,[c("span",S5,w(n.info.parkingType),1),n.info.iconCategory&&n.info.iconCategory!==n.info.parkingType?(v(),P("span",k5,w(n.info.iconCategory),1)):V("",!0)]),c("span",D5,w(Number(n.info.geometry[0]).toFixed(5))+", "+w(Number(n.info.geometry[1]).toFixed(5)),1)]),c("div",T5,[n.isCommunity?(v(),P("button",{key:0,class:"btn btn-outline btn-sm",onClick:a[2]||(a[2]=U=>o("editCommunity"))},[N5,k(" 編輯 ")])):(v(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[3]||(a[3]=U=>o("editOverride")),title:n.isOverridden?"修改車友提供的資訊 (不會變動官方資料)":"異議 / 補充官方資料 (不會變動官方資料)"},[R5,k(" "+w(n.isOverridden?"修改車友資訊":"異議 / 補充"),1)],8,M5)),c("button",{class:"btn btn-outline btn-sm",onClick:a[4]||(a[4]=U=>o("share")),title:"分享這個停車點"},[O5,k(" 分享 ")])]),c("div",x5,[n.isAndroid?V("",!0):(v(),P("button",{key:0,class:"btn btn-primary btn-sm",onClick:a[5]||(a[5]=U=>o("openMap","apple"))},[L5,k(" Apple Map ")])),c("button",{class:Z(["btn","btn-sm",n.isAndroid?"btn-primary":"btn-outline"]),onClick:a[6]||(a[6]=U=>o("openMap","google"))},[F5,k(" Google Map ")],2),n.hasRoute?V("",!0):(v(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[7]||(a[7]=U=>o("route"))},[H5,k(" 路線規劃 ")]))])],2)}}},V5=an(z5,[["__scopeId","data-v-d09400e9"]]),Rs=n=>(Nn("data-v-caf0ec6e"),n=n(),Mn(),n),W5={class:"route-header"},j5=Rs(()=>c("h3",null,[c("span",{class:"material-icons-outlined"},"alt_route"),k(" 路線 ")],-1)),G5=["aria-expanded"],K5={class:"material-icons-outlined"},Q5={key:0,class:"route-summary"},Y5={class:"route-summary-item"},X5=Rs(()=>c("span",{class:"material-icons-outlined"},"schedule",-1)),q5={class:"route-summary-item"},J5=Rs(()=>c("span",{class:"material-icons-outlined"},"straighten",-1)),$5={class:"route-profile",role:"tablist","aria-label":"交通方式"},Z5=["onClick","aria-pressed"],e4={class:"material-icons-outlined"},n4={class:"profile-label"},t4={key:1,class:"route-steps"},o4={__name:"RouteSteps",props:{routeData:Object,active:Boolean,profile:{type:String,default:"driving"}},emits:["cancel","update:profile"],setup(n,{emit:e}){const t=n,o=e,i=E(!0),s=()=>i.value=!i.value,r=[{value:"driving",label:"汽機車",icon:"directions_car"},{value:"cycling",label:"單車",icon:"directions_bike"},{value:"walking",label:"步行",icon:"directions_walk"}],l=Y(()=>{var h;const m=(h=t.routeData)==null?void 0:h.distance;return typeof m!="number"?"":m>=1e3?`${(m/1e3).toFixed(1)} km`:`${Math.round(m)} m`}),a=Y(()=>{var g;const m=(g=t.routeData)==null?void 0:g.duration;if(typeof m!="number")return"";const h=Math.round(m/60);if(h<60)return`${h} 分`;const f=Math.floor(h/60),b=h%60;return b?`${f} 時 ${b} 分`:`${f} 時`}),d=m=>o("update:profile",m);return(m,h)=>(v(),P("aside",{class:Z(["route-panel",{active:n.active}])},[c("header",W5,[j5,c("button",{class:"route-toggle",onClick:s,"aria-expanded":i.value},[c("span",K5,w(i.value?"expand_less":"expand_more"),1)],8,G5)]),n.routeData?(v(),P("div",Q5,[c("div",Y5,[X5,c("strong",null,w(a.value),1)]),c("div",q5,[J5,c("strong",null,w(l.value),1)])])):V("",!0),c("div",$5,[(v(),P(be,null,We(r,f=>c("button",{key:f.value,class:Z(["profile-btn",{active:n.profile===f.value}]),onClick:b=>d(f.value),"aria-pressed":n.profile===f.value},[c("span",e4,w(f.icon),1),c("span",n4,w(f.label),1)],10,Z5)),64))]),n.routeData&&i.value?(v(),P("ol",t4,[(v(!0),P(be,null,We(n.routeData.legs[0].steps,(f,b)=>(v(),P("li",{key:b,class:"route-step"},w(f.maneuver.instruction),1))),128))])):V("",!0),c("button",{class:"btn btn-danger btn-sm route-cancel",onClick:h[0]||(h[0]=f=>o("cancel"))}," 取消路線規劃 ")],2))}},i4=an(o4,[["__scopeId","data-v-caf0ec6e"]]);function s4(n,e,t=20,o=[]){const i=(e||"").trim().toLowerCase();if(!i)return[];const s=[];if(Array.isArray(n))for(const r of n)for(const l of r.features){const a=(l.properties.name||"").toLowerCase(),d=(l.properties.description||"").toLowerCase();if((a.includes(i)||d.includes(i))&&(s.push({groupName:r.name,name:l.properties.name,description:l.properties.description,icon:l.properties.icon,geometry:l.geometry.coordinates,properties:l.properties,isCommunity:!1,score:(a.includes(i)?1e3:0)-(a.indexOf(i)===-1?0:a.indexOf(i))}),s.length>500))break}if(Array.isArray(o))for(const r of o){const l=(r.name||"").toLowerCase(),a=(r.description||"").toLowerCase();if(!l.includes(i)&&!a.includes(i))continue;const d=Array.isArray(r.coordinates)?r.coordinates:[null,null];if(!(d[0]==null||d[1]==null)&&(s.push({groupName:"共筆停車點",name:r.name,description:r.description,icon:r.iconKey,geometry:d,properties:{name:r.name,description:r.description,icon:r.iconKey},isCommunity:!0,community:r,score:(l.includes(i)?900:0)-(l.indexOf(i)===-1?0:l.indexOf(i))}),s.length>500))break}return s.sort((r,l)=>l.score-r.score),s.slice(0,t)}const ec=n=>(Nn("data-v-2b0f75f6"),n=n(),Mn(),n),r4={key:0,class:"search-results",role:"listbox"},l4=["aria-selected","onMouseenter","onClick"],a4=["src"],c4={class:"search-item-text"},d4={class:"search-item-name"},h4={class:"search-item-group"},u4={key:1,class:"search-empty"},m4={class:"search-box",role:"combobox","aria-expanded":"true"},p4=ec(()=>c("span",{class:"material-icons-outlined search-icon"},"search",-1)),f4=ec(()=>c("span",{class:"material-icons-outlined"},"close",-1)),y4=[f4],b4=["aria-label","aria-expanded"],g4={class:"material-icons-outlined"},A4={__name:"SearchBar",props:{mapDataList:Array,communityParkings:{type:Array,default:()=>[]}},emits:["select"],setup(n,{emit:e}){const t=n,o=e,i=E(!1),s=E(""),r=E(-1),l=Y(()=>s.value?s4(t.mapDataList,s.value,15,t.communityParkings):[]);K(s,()=>{r.value=-1});const a=()=>{i.value=!i.value,i.value||(s.value="")},d=()=>{i.value=!1,s.value=""},m=f=>{o("select",f),d()},h=f=>{if(l.value.length)if(f.key==="ArrowDown")f.preventDefault(),r.value=(r.value+1)%l.value.length;else if(f.key==="ArrowUp")f.preventDefault(),r.value=(r.value-1+l.value.length)%l.value.length;else if(f.key==="Enter"){f.preventDefault();const b=r.value>=0?r.value:0;m(l.value[b])}else f.key==="Escape"&&d()};return(f,b)=>(v(),P("div",{class:Z(["search-wrap",{open:i.value}])},[i.value&&l.value.length?(v(),P("ul",r4,[(v(!0),P(be,null,We(l.value,(g,B)=>(v(),P("li",{key:B,class:Z(["search-item",{active:B===r.value}]),role:"option","aria-selected":B===r.value,onMouseenter:D=>r.value=B,onClick:D=>m(g)},[g.icon?(v(),P("img",{key:0,src:x($)(g.icon),class:"search-item-icon",alt:""},null,8,a4)):V("",!0),c("div",c4,[c("div",d4,w(g.name),1),c("div",h4,w(g.groupName),1)])],42,l4))),128))])):i.value&&s.value&&!l.value.length?(v(),P("div",u4," 找不到「"+w(s.value)+"」相關停車場 ",1)):V("",!0),Qe(c("div",m4,[p4,Qe(c("input",{"onUpdate:modelValue":b[0]||(b[0]=g=>s.value=g),class:"search-input",type:"text",placeholder:"搜尋停車場名稱…",autofocus:"",onKeydown:h},null,544),[[It,s.value]]),s.value?(v(),P("button",{key:0,class:"search-clear",onClick:b[1]||(b[1]=g=>s.value=""),"aria-label":"清除"},y4)):V("",!0)],512),[[wt,i.value]]),c("button",{class:Z(["search-toggle",{active:i.value}]),onClick:a,"aria-label":i.value?"關閉搜尋":"開啟搜尋","aria-expanded":i.value},[c("span",g4,w(i.value?"close":"search"),1)],10,b4)],2))}},_4=an(A4,[["__scopeId","data-v-2b0f75f6"]]),On=n=>(Nn("data-v-2a54cb8a"),n=n(),Mn(),n),v4={class:"editor-body"},P4={key:0,class:"editor-note override-note"},C4=On(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),U4={key:1,class:"editor-note"},E4=On(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),B4={class:"form-group"},w4={class:"form-label"},I4={key:0},S4={key:1,class:"hint-inline"},k4=["readonly","disabled"],D4={class:"form-group"},T4=On(()=>c("label",{class:"form-label"},"類別",-1)),N4=["value"],M4={class:"form-group"},R4={class:"form-label"},O4={key:0,class:"hint-inline"},x4=["disabled"],L4=["value"],F4={class:"form-group"},H4=On(()=>c("label",{class:"form-label"},"收費",-1)),z4={class:"chip-row"},V4=["onClick"],W4={key:0,class:"price-amount"},j4={class:"unit"},G4={key:1,class:"price-amount"},K4={class:"form-group"},Q4=On(()=>c("label",{class:"form-label"},"說明(選填)",-1)),Y4={class:"form-group"},X4=On(()=>c("label",{class:"form-label"},"暱稱(選填)",-1)),q4=["value"],J4={key:2,class:"error-msg"},$4={key:3,class:"form-group history-section"},Z4={class:"form-label"},em=On(()=>c("span",{class:"material-icons-outlined",style:{"font-size":"14px","vertical-align":"-2px"}},"history",-1)),nm={class:"history-list"},tm={class:"h-row1"},om={class:"h-by"},im={class:"h-time"},sm={key:0,class:"h-diff h-diff-note"},rm={key:1,class:"h-diff-list"},lm={class:"h-diff-label"},am={class:"h-diff-old"},cm=On(()=>c("span",{class:"h-diff-arrow"},"→",-1)),dm={class:"h-diff-new"},hm={key:2,class:"h-diff h-diff-note"},um=["disabled"],mm=["disabled"],pm=["disabled"],fm=["disabled"],ym={__name:"CommunityParkingEditor",props:{open:Boolean,mode:{type:String,default:"add"},initial:{type:Object,default:null},defaultCoord:{type:Array,default:()=>[121.5173399,25.0475613]},nickname:{type:String,default:""},isOwner:{type:Boolean,default:!1},isAdmin:{type:Boolean,default:!1},submitting:{type:Boolean,default:!1},hasExistingOverride:{type:Boolean,default:!1},history:{type:Array,default:()=>[]}},emits:["update:open","update:nickname","submit","delete","reset"],setup(n,{emit:e}){const t=n,o=e,i=E(""),s=E(""),r=E("motorcycle"),l=E("friendly"),a=E("free"),d=E(""),m=E(""),h=E([null,null]),f=Y(()=>ut.filter(A=>A.value)),b=Y(()=>Qt.filter(A=>A.value)),g={greenStar:"icon-14.png",friendlyShop:"icon-4.png",greenP:"icon-15.png",greyP:"icon-16.png",blueP:"icon-17.png",purpleP:"icon-18.png",redX:"icon-19.png",unknown:"icon-20.png"},B=Y(()=>{if(g[r.value])return g[r.value];const A=ut.find(pe=>pe.value===r.value),M=Qt.find(pe=>pe.value===l.value);return A?M&&A.key.find(pe=>M.key.includes(pe))||A.key[0]:"icon-3.png"}),D=Y(()=>!!g[r.value]);function U(A){return A?String(A).replace(/<br\s*\/?>/gi,`
`):""}function W(A){return A?String(A).replace(/\r\n|\r|\n/g,"<br>"):""}function T(A){if(!A)return{type:"free",amount:"",custom:""};const M=A.trim();if(/^free$/i.test(M))return{type:"free",amount:"",custom:""};const S=M.match(/^(\d+(?:\.\d+)?)\s*\/\s*([hd次])$/i);return S?{type:S[2].toLowerCase(),amount:S[1],custom:""}:{type:"custom",amount:"",custom:M}}function G(){return a.value==="free"?"Free":a.value==="custom"?m.value.trim():d.value?`${d.value}/${a.value}`:""}const Ue=()=>{if((t.mode==="edit"||t.mode==="override")&&t.initial){i.value=t.initial.name||"",s.value=U(t.initial.description||""),r.value=t.initial.category||"motorcycle",l.value=t.initial.friendliness||"friendly";const A=T(t.initial.priceInfo||"");a.value=A.type,d.value=A.amount,m.value=A.custom,h.value=t.initial.coordinates?[...t.initial.coordinates]:[...t.defaultCoord]}else i.value="",s.value="",r.value="motorcycle",l.value="friendly",a.value="free",d.value="",m.value="",h.value=[...t.defaultCoord]};K(()=>t.open,A=>{A&&Ue()});const ie=E(""),Se=()=>{if(ie.value="",!i.value.trim()){ie.value="請輸入名稱";return}if(h.value[0]==null||h.value[1]==null||Number.isNaN(Number(h.value[0]))||Number.isNaN(Number(h.value[1]))){ie.value="座標無效";return}o("submit",{name:i.value,description:W(s.value),iconKey:B.value,category:r.value,friendliness:D.value?"":l.value,priceInfo:G(),coordinates:[Number(h.value[0]),Number(h.value[1])]})},Te=()=>{var A;(A=t.initial)!=null&&A.id&&window.confirm(`確定要刪除「${i.value}」?此動作無法復原。`)&&o("delete",t.initial.id)},Je=()=>{window.confirm(`確定要重設「${i.value}」回官方原始資料嗎?
你和其他車友先前的修改將被移除。`)&&o("reset")},ge=Y({get:()=>t.open,set:A=>o("update:open",A)}),ce=[{value:"free",label:"免費"},{value:"h",label:"計時 / 小時"},{value:"d",label:"計次 / 天"},{value:"次",label:"計次 / 不限時"},{value:"custom",label:"其他"}],Ee=E(!1),je=Y(()=>!t.history||t.history.length===0?[]:Ee.value?t.history:t.history.slice(0,5)),C={create:"新增",update:"修改",delete:"刪除",override:"覆寫",reset:"重設"};function R(A){return C[A]||A||"變更"}function X(A){return A?A.nickname||(A.id?`匿名#${A.id}`:"匿名"):"系統"}function j(A){if(!A||!isFinite(Number(A)))return"";const M=new Date(Number(A)),S=pe=>String(pe).padStart(2,"0");return`${M.getFullYear()}/${S(M.getMonth()+1)}/${S(M.getDate())} ${S(M.getHours())}:${S(M.getMinutes())}`}const se={name:"名稱",description:"說明",iconKey:"圖示",category:"類別",friendliness:"友善度",priceInfo:"收費",lng:"經度",lat:"緯度"};function re(A){if(A==null||A==="")return"(空)";if(typeof A=="number")return String(A);const M=String(A).replace(/<br\s*\/?>/gi,`
`);return M.length>80?M.slice(0,80)+"…":M}function ke(A){return A==null?"":typeof A=="string"?A.trim():String(A)}function ue(A){return ke(A)===""}function xe(A,M){if(!A||A.action==="delete"||A.action==="reset")return[];if(A.after&&typeof A.after=="object")return Object.keys(A.after).filter(J=>{var le;const he=(le=A.before)==null?void 0:le[J],De=A.after[J];return!(ue(he)&&ue(De)||ke(he)===ke(De)||ue(he))}).map(J=>{var he;return{label:se[J]||J,before:re((he=A.before)==null?void 0:he[J]),after:re(A.after[J]),hasBefore:!0}});const S=A.snapshot;if(!S||typeof S!="object")return[];const pe=new Set(["createdAt","createdBy","updatedAt","updatedBy","origName","origLng","origLat","history"]),Ge=t.history.findIndex(O=>O._key===A._key),Fe=Ge>=0?t.history[Ge+1]:null,$e=Fe?Fe.after&&typeof Fe.after=="object"?{...Fe.before||{},...Fe.after}:Fe.snapshot||null:null,z=[];for(const O of Object.keys(S)){if(pe.has(O))continue;const J=S[O];if($e&&Object.prototype.hasOwnProperty.call($e,O)){const he=$e[O];if(ke(he)===ke(J)||ue(he))continue;z.push({label:se[O]||O,before:re(he),after:re(J),hasBefore:!0})}}return z}function Le(A){return(A==null?void 0:A.action)==="delete"?"該項目被刪除":(A==null?void 0:A.action)==="reset"?"重設為官方資料":(A==null?void 0:A.action)==="create"?"新增此停車點":""}return(A,M)=>(v(),Ki(Un,{modelValue:ge.value,"onUpdate:modelValue":M[9]||(M[9]=S=>ge.value=S),title:n.mode==="override"?"修改官方停車點":n.mode==="edit"?"編輯停車場":"新增停車場",size:"md"},{footer:en(()=>[n.mode==="edit"&&n.isOwner?(v(),P("button",{key:0,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:Te}," 刪除 ",8,um)):V("",!0),n.mode==="override"&&n.hasExistingOverride&&n.isAdmin?(v(),P("button",{key:1,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:Je,title:"僅站方可使用"}," 重設為官方資料 ",8,mm)):V("",!0),c("button",{class:"btn btn-outline",disabled:n.submitting,onClick:M[8]||(M[8]=S=>ge.value=!1)}," 取消 ",8,pm),c("button",{class:"btn btn-primary",disabled:n.submitting,onClick:Se},w(n.submitting?"送出中…":n.mode==="override"||n.mode==="edit"?"儲存修改":"新增"),9,fm)]),default:en(()=>[c("div",v4,[n.mode==="override"?(v(),P("p",P4,[C4,k(" 你正在「修改官方停車點」:這層修改只會疊加在官方資料之上,不會覆蓋原始資料。所有車友都會看到你的修改,也可以再被其他人修改或重設。 ")])):(v(),P("p",U4,[E4,k(" 共筆停車點:任何人都可以新增或修改。請確認資訊正確、避免不雅內容。 ")])),c("section",B4,[c("label",w4,[k(" 名稱 "),n.mode!=="override"?(v(),P("span",I4,"*")):V("",!0),n.mode==="override"?(v(),P("span",S4,"(官方名稱不可修改)")):V("",!0)]),Qe(c("input",{"onUpdate:modelValue":M[0]||(M[0]=S=>i.value=S),class:"form-control",type:"text",placeholder:"例:三張里地下停車場",maxlength:"60",readonly:n.mode==="override",disabled:n.mode==="override"},null,8,k4),[[It,i.value]])]),c("section",D4,[T4,Qe(c("select",{"onUpdate:modelValue":M[1]||(M[1]=S=>r.value=S),class:"form-control"},[(v(!0),P(be,null,We(f.value,S=>(v(),P("option",{key:S.value,value:S.value},w(S.name),9,N4))),128))],512),[[Xs,r.value]])]),c("section",M4,[c("label",R4,[k(" 友善程度 "),D.value?(v(),P("span",O4,"(此類別不適用)")):V("",!0)]),Qe(c("select",{"onUpdate:modelValue":M[2]||(M[2]=S=>l.value=S),class:"form-control",disabled:D.value},[(v(!0),P(be,null,We(b.value,S=>(v(),P("option",{key:S.value,value:S.value},w(S.name),9,L4))),128))],8,x4),[[Xs,l.value]])]),c("section",F4,[H4,c("div",z4,[(v(),P(be,null,We(ce,S=>c("button",{key:S.value,type:"button",class:Z(["chip",{active:a.value===S.value}]),onClick:pe=>a.value=S.value},w(S.label),11,V4)),64))]),a.value==="h"||a.value==="d"||a.value==="次"?(v(),P("div",W4,[Qe(c("input",{"onUpdate:modelValue":M[3]||(M[3]=S=>d.value=S),type:"number",min:"0",step:"1",class:"form-control compact",placeholder:"金額"},null,512),[[It,d.value]]),c("span",j4," 元 / "+w(a.value==="h"?"小時":a.value==="d"?"天":"次 (不限時)"),1)])):a.value==="custom"?(v(),P("div",G4,[Qe(c("input",{"onUpdate:modelValue":M[4]||(M[4]=S=>m.value=S),type:"text",class:"form-control",placeholder:"如:平日 30/h、假日 50/d",maxlength:"40"},null,512),[[It,m.value]])])):V("",!0)]),c("section",K4,[Q4,Qe(c("textarea",{"onUpdate:modelValue":M[5]||(M[5]=S=>s.value=S),class:"form-control",rows:"3",placeholder:"後牌辨析、24h、注意事項...",maxlength:"500"},null,512),[[It,s.value]])]),c("section",Y4,[X4,c("input",{value:n.nickname,onInput:M[6]||(M[6]=S=>o("update:nickname",S.target.value)),class:"form-control",type:"text",placeholder:"留空將顯示「匿名#xxx-xxx」",maxlength:"20"},null,40,q4)]),ie.value?(v(),P("p",J4,w(ie.value),1)):V("",!0),n.history.length?(v(),P("section",$4,[c("label",Z4,[em,k(" 修改紀錄 ("+w(n.history.length)+") ",1)]),c("ul",nm,[(v(!0),P(be,null,We(je.value,(S,pe)=>(v(),P("li",{key:S._key,class:"history-item"},[c("div",tm,[c("span",{class:Z(["h-action",`h-action-${S.action||"other"}`])},w(R(S.action)),3),c("span",om,w(X(S.by)),1),c("span",im,w(j(S.at)),1)]),Le(S)?(v(),P("div",sm,w(Le(S)),1)):xe(S,pe).length?(v(),P("ul",rm,[(v(!0),P(be,null,We(xe(S,pe),(Ge,Fe)=>(v(),P("li",{key:Fe,class:"h-diff-item"},[c("span",lm,w(Ge.label),1),Ge.hasBefore?(v(),P(be,{key:0},[c("span",am,w(Ge.before),1),cm],64)):V("",!0),c("span",dm,w(Ge.after),1)]))),128))])):(v(),P("div",hm,"(與上一筆相同)"))]))),128))]),n.history.length>5?(v(),P("button",{key:0,type:"button",class:"history-toggle",onClick:M[7]||(M[7]=S=>Ee.value=!Ee.value)},w(Ee.value?"收起":`顯示全部 ${n.history.length} 筆`),1)):V("",!0)])):V("",!0)])]),_:1},8,["modelValue","title"]))}},bm=an(ym,[["__scopeId","data-v-2a54cb8a"]]),gm={class:"tour-card-head"},Am={class:"tour-step-index"},_m={class:"tour-title"},vm={key:0,class:"material-icons-outlined"},Pm={class:"tour-desc"},Cm={class:"tour-actions"},Um={key:0,class:"material-icons-outlined"},Em={key:1,class:"material-icons-outlined"},Pn=8,Bm=12,qr=300,lo=16,wm={__name:"OnboardingTour",props:{active:{type:Boolean,default:!1},steps:{type:Array,required:!0}},emits:["update:active","finish"],setup(n,{emit:e}){const t=n,o=e,i=E(0),s=E(null),r=E(!1),l=Y(()=>t.steps[i.value]||null),a=Y(()=>i.value>=t.steps.length-1),d=async()=>{await hl();const U=l.value;if(!U){s.value=null;return}const W=U.selector?document.querySelector(U.selector):null;if(!W){s.value=null;return}const T=W.getBoundingClientRect();if(T.width===0&&T.height===0){s.value=null;return}s.value={top:T.top,left:T.left,width:T.width,height:T.height}},m=async()=>{for(let U=0;U<8;U++){if(await d(),s.value)return;await new Promise(W=>setTimeout(W,150))}};K(()=>[t.active,i.value],async([U])=>{if(!U){r.value=!1;return}r.value=!1,await m(),r.value=!0},{immediate:!0});const h=()=>d();Xn(()=>{window.addEventListener("resize",h),window.addEventListener("scroll",h,!0)}),mt(()=>{window.removeEventListener("resize",h),window.removeEventListener("scroll",h,!0)});const f=Y(()=>{const U=s.value;return U?{top:U.top-Pn+"px",left:U.left-Pn+"px",width:U.width+Pn*2+"px",height:U.height+Pn*2+"px",borderRadius:Bm+"px"}:{display:"none"}}),b=Y(()=>{var ge;const U=s.value,W=window.innerWidth,T=window.innerHeight;if(!U)return{top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:Math.min(qr,W-32)+"px"};const G=((ge=l.value)==null?void 0:ge.placement)||"auto";let Ue=G;if(G==="auto"){const ce=T-(U.top+U.height),Ee=U.top;Ue=ce>=Ee?"bottom":"top"}const ie=Math.min(qr,W-32);let Se,Te,Je="";return Ue==="bottom"?(Se=U.top+U.height+lo+Pn,Te=Math.max(16,Math.min(W-ie-16,U.left+U.width/2-ie/2))):Ue==="top"?(Se=U.top-lo-Pn,Te=Math.max(16,Math.min(W-ie-16,U.left+U.width/2-ie/2)),Je="translateY(-100%)"):Ue==="right"?(Se=Math.max(16,U.top+U.height/2),Te=U.left+U.width+lo+Pn,Je="translateY(-50%)"):(Se=Math.max(16,U.top+U.height/2),Te=U.left-lo-Pn,Je="translate(-100%, -50%)"),{top:Se+"px",left:Te+"px",width:ie+"px",transform:Je}}),g=()=>{a.value?D():i.value+=1},B=()=>D(),D=()=>{o("update:active",!1),o("finish"),i.value=0};return K(()=>t.active,U=>{U&&(i.value=0)}),(U,W)=>n.active&&l.value?(v(),P("div",{key:0,class:Z(["tour-root",{"is-ready":r.value}])},[c("div",{class:"tour-spotlight",style:po(f.value)},null,4),c("div",{class:"tour-backdrop",onClick:Qi(g,["self"])}),c("div",{class:"tour-card",style:po(b.value),role:"dialog","aria-modal":"true"},[c("div",gm,[c("span",Am,w(i.value+1)+" / "+w(n.steps.length),1),c("button",{class:"tour-skip",onClick:B,"aria-label":"略過導覽"},"略過")]),c("h3",_m,[l.value.icon?(v(),P("span",vm,w(l.value.icon),1)):V("",!0),k(" "+w(l.value.title),1)]),c("p",Pm,w(l.value.description),1),c("div",Cm,[c("button",{class:"btn btn-primary tour-next",onClick:g},[k(w(a.value?"完成":"下一步")+" ",1),a.value?(v(),P("span",Em,"check")):(v(),P("span",Um,"arrow_forward"))])])],4)],2)):V("",!0)}},Im=an(wm,[["__scopeId","data-v-1d730a34"]]),En="community_parkings",Vi=E([]),nc=E(!1),Wi=E(null);let Ot=null,mi=0;function Sm(){if(!(!dn||Ot))try{const n=gu(nn(Ye,En),bu("updatedAt"));Ot=n,qa(n,e=>{const t=[];e.forEach(o=>{var s,r;const i=o.val()||{};t.push({id:o.key,name:i.name||"",description:i.description||"",iconKey:i.iconKey||"icon-3.png",category:i.category||"",friendliness:i.friendliness||"",priceInfo:i.priceInfo||"",coordinates:[(s=i.lng)!=null?s:null,(r=i.lat)!=null?r:null],createdBy:i.createdBy||null,updatedBy:i.updatedBy||null,createdAt:i.createdAt||null,updatedAt:i.updatedAt||null,history:Dm(i.history)})}),Vi.value=t.reverse(),nc.value=!0},e=>{Wi.value=e})}catch(n){Wi.value=n}}function km(){Ot&&(Ja(Ot),Ot=null)}function Dm(n){return!n||typeof n!="object"?[]:Object.entries(n).map(([e,t])=>({...t||{},_key:e})).sort((e,t)=>e._key<t._key?1:e._key>t._key?-1:0)}function Tm(){return Xn(()=>{mi+=1,Sm()}),mt(()=>{mi-=1,mi<=0&&km()}),{items:Vi,ready:nc,error:Wi,addParking:async(o,i)=>{var f,b,g;if(!dn)throw new Error("Firebase 尚未設定");const[s,r]=o.coordinates,a=co(nn(Ye,En)).key,d={id:i.id,nickname:i.nickname||""},m={name:((f=o.name)==null?void 0:f.trim())||"",description:((b=o.description)==null?void 0:b.trim())||"",iconKey:o.iconKey||"icon-3.png",category:o.category||"",friendliness:o.friendliness||"",priceInfo:((g=o.priceInfo)==null?void 0:g.trim())||"",lng:Number(s),lat:Number(r),createdBy:d,createdAt:Vn(),updatedBy:d,updatedAt:Vn()},h=co(nn(Ye,`${En}/${a}/history`)).key;return await Li(nn(Ye),{[`${En}/${a}`]:{...m,history:{[h]:{action:"create",at:Vn(),by:d,snapshot:m}}}}),a},updateParking:async(o,i,s)=>{var g,B,D,U,W;if(!dn)throw new Error("Firebase 尚未設定");const r={id:s.id,nickname:s.nickname||""},l=Vi.value.find(T=>T.id===o)||{},a={};if(i.name!==void 0&&(a.name=((g=i.name)==null?void 0:g.trim())||""),i.description!==void 0&&(a.description=((B=i.description)==null?void 0:B.trim())||""),i.iconKey!==void 0&&(a.iconKey=i.iconKey),i.category!==void 0&&(a.category=i.category),i.friendliness!==void 0&&(a.friendliness=i.friendliness),i.priceInfo!==void 0&&(a.priceInfo=((D=i.priceInfo)==null?void 0:D.trim())||""),i.coordinates){const[T,G]=i.coordinates;a.lng=Number(T),a.lat=Number(G)}const d={},m={};for(const T of Object.keys(a)){let G;T==="lng"?G=(U=l.coordinates)==null?void 0:U[0]:T==="lat"?G=(W=l.coordinates)==null?void 0:W[1]:G=l[T];const Ue=G==null?"":G,ie=a[T]===void 0||a[T]===null?"":a[T];Ue!==ie&&(d[T]=G!=null?G:"",m[T]=a[T])}const h={...a,updatedBy:r,updatedAt:Vn()},f=co(nn(Ye,`${En}/${o}/history`)).key,b={};for(const T of Object.keys(h))b[`${En}/${o}/${T}`]=h[T];return b[`${En}/${o}/history/${f}`]={action:"update",at:Vn(),by:r,before:d,after:m},Li(nn(Ye),b)},deleteParking:async o=>{if(!dn)throw new Error("Firebase 尚未設定");return Xa(nn(Ye,`${En}/${o}`))}}}var Nm={VITE_FIREBASE_DATABASE_URL:"https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app",VITE_FIREBASE_MESSAGING_SENDER_ID:"976769533420",VITE_FIREBASE_MEASUREMENT_ID:"G-XMR8C87T1P",VITE_FIREBASE_STORAGE_BUCKET:"findparkinglot-2519e.firebasestorage.app",VITE_FIREBASE_AUTH_DOMAIN:"findparkinglot-2519e.firebaseapp.com",VITE_MAPBOX_TOKEN:"pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",VITE_FIREBASE_PROJECT_ID:"findparkinglot-2519e",VITE_FIREBASE_APP_ID:"1:976769533420:web:f3108318b3def30017acc9",VITE_FIREBASE_API_KEY:"AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs",BASE_URL:"./",MODE:"production",DEV:!1,PROD:!0,SSR:!1};const tc="community_user_id",oc="community_user_nickname",Mm="community_is_admin",Rm=String(Nm.VITE_ADMIN_USER_IDS||"").split(",").map(n=>n.trim()).filter(Boolean);function Om(){const n=e=>Array.from(crypto.getRandomValues(new Uint8Array(e))).map(t=>t.toString(16).padStart(2,"0")).join("");return`${n(2)}-${n(2)}`}let mo=on.get(tc);mo||(mo=Om(),on.set(tc,mo));const ji=mo,Gi=E(on.get(oc)||""),xm=Rm.includes(ji)||on.get(Mm)==="1";K(Gi,n=>on.set(oc,n||""));function Lm(){return{userId:ji,nickname:Gi,displayName:()=>{var e;return((e=Gi.value)==null?void 0:e.trim())||`匿名#${ji}`},isAdmin:xm}}const Fm=()=>typeof window!="undefined"&&typeof window.gtag=="function",ye=(n,e={})=>{if(Fm())try{window.gtag("event",n,e)}catch(t){}},I=n=>(Nn("data-v-19f2d019"),n=n(),Mn(),n),Hm={class:"app-title"},zm=["aria-label","aria-expanded"],Vm={class:"material-icons-outlined"},Wm={key:1,class:"title-logo",src:Yi,alt:"重機能停哪"},jm=I(()=>c("h1",null,"重機能停哪?",-1)),Gm=I(()=>c("pre",{id:"coordinates",class:"coordinates"},null,-1)),Km=I(()=>c("h4",{class:"modal-section-title"},"圖案代表甚麼格位",-1)),Qm={class:"legend-list"},Ym={class:"legend-row"},Xm=["src"],qm={class:"legend-row"},Jm=["src"],$m={class:"legend-row"},Zm=["src"],ep={class:"legend-row"},np=["src"],tp={class:"legend-row"},op=["src"],ip={class:"legend-row"},sp=["src"],rp={class:"legend-row"},lp=["src"],ap={class:"legend-row"},cp=["src"],dp={class:"legend-row"},hp=["src"],up={class:"legend-row"},mp=["src"],pp={class:"legend-row"},fp=["src"],yp=I(()=>c("h4",{class:"modal-section-title"},"顏色代表入場方式",-1)),bp={class:"legend-list"},gp={class:"legend-row"},Ap=["src"],_p=["src"],vp=["src"],Pp={class:"legend-row"},Cp=["src"],Up=["src"],Ep=["src"],Bp={class:"legend-row"},wp=["src"],Ip=["src"],Sp=["src"],kp={class:"legend-row"},Dp=["src"],Tp=["src"],Np=["src"],Mp=I(()=>c("h4",{class:"modal-section-title"},"名稱前有價錢",-1)),Rp={class:"legend-list"},Op={class:"legend-row"},xp=["src"],Lp=I(()=>c("div",{class:"legend-row"},[c("div",{class:"legend-text"},[k(" ・數字:金額,時段費率複雜會以最高收費標示"),c("br"),k(" ・d/h:d 為計次,h 為計時"),c("br"),k(" ・Free 代表免費 ")])],-1)),Fp={class:"share-grid"},Hp=I(()=>c("img",{src:ml,alt:""},null,-1)),zp=I(()=>c("span",null,"Facebook",-1)),Vp=[Hp,zp],Wp=I(()=>c("img",{src:pl,alt:""},null,-1)),jp=I(()=>c("span",null,"LINE",-1)),Gp=[Wp,jp],Kp=I(()=>c("img",{src:fl,alt:""},null,-1)),Qp=I(()=>c("span",null,"Twitter",-1)),Yp=[Kp,Qp],Xp=I(()=>c("img",{src:yl,alt:""},null,-1)),qp=I(()=>c("span",null,"複製連結",-1)),Jp=[Xp,qp],$p={class:"modal-hint",style:{"word-break":"break-all"}},Zp={class:"share-grid"},ef=I(()=>c("img",{src:ml,alt:""},null,-1)),nf=I(()=>c("span",null,"Facebook",-1)),tf=[ef,nf],of=I(()=>c("img",{src:pl,alt:""},null,-1)),sf=I(()=>c("span",null,"LINE",-1)),rf=[of,sf],lf=I(()=>c("img",{src:fl,alt:""},null,-1)),af=I(()=>c("span",null,"Twitter",-1)),cf=[lf,af],df=I(()=>c("img",{src:yl,alt:""},null,-1)),hf=I(()=>c("span",null,"複製連結",-1)),uf=[df,hf],mf=I(()=>c("p",{class:"modal-hint"}," 若覺得本站有幫助，歡迎透過以下連結請我喝一杯咖啡，讓我有動力繼續維護更新！ ",-1)),pf={class:"support-list"},ff=["onClick"],yf={class:"material-icons-outlined support-btn-icon"},bf={class:"support-btn-body"},gf={class:"support-btn-label"},Af={key:0,class:"support-btn-badge"},_f={class:"support-btn-desc"},vf=I(()=>c("span",{class:"material-icons-outlined support-btn-arrow"},"open_in_new",-1)),Pf={class:"os-tabs",role:"tablist","aria-label":"作業系統"},Cf=["aria-selected"],Uf=I(()=>c("span",{class:"material-icons-outlined"},"phone_iphone",-1)),Ef=["aria-selected"],Bf=I(()=>c("span",{class:"material-icons-outlined"},"android",-1)),wf=I(()=>c("p",{class:"modal-hint"},"以下以 iOS Safari 為範例",-1)),If=I(()=>c("h4",{class:"modal-section-title"},"1. 使用 Safari 開啟網站並點擊下方分享按鈕",-1)),Sf=I(()=>c("img",{class:"full-img",src:Oc,alt:""},null,-1)),kf=I(()=>c("h4",{class:"modal-section-title"},"2. 點選「加入主畫面」",-1)),Df=I(()=>c("img",{class:"full-img",src:xc,alt:""},null,-1)),Tf=I(()=>c("h4",{class:"modal-section-title"},"3. 確認名稱後按「加入」",-1)),Nf=I(()=>c("img",{class:"full-img",src:Lc,alt:""},null,-1)),Mf=I(()=>c("h4",{class:"modal-section-title"},"4. 完成,圖示已加到主畫面",-1)),Rf=I(()=>c("img",{class:"full-img",src:Fc,alt:""},null,-1)),Of=I(()=>c("h4",{class:"modal-section-title"},"5. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),xf=I(()=>c("img",{class:"full-img",src:Hc,alt:""},null,-1)),Lf=I(()=>c("p",{class:"modal-hint"},"以下以 Android Chrome 為範例",-1)),Ff=I(()=>c("h4",{class:"modal-section-title"},"1. 使用 Chrome 開啟網站並點擊右上角選單，點選「加到主畫面」",-1)),Hf=I(()=>c("img",{class:"full-img",src:zc,alt:""},null,-1)),zf=I(()=>c("h4",{class:"modal-section-title"},"2. 點選「安裝」",-1)),Vf=I(()=>c("img",{class:"full-img",src:Vc,alt:""},null,-1)),Wf=I(()=>c("h4",{class:"modal-section-title"},"3. 完成,圖示已加到主畫面",-1)),jf=I(()=>c("img",{class:"full-img",src:Wc,alt:""},null,-1)),Gf=I(()=>c("h4",{class:"modal-section-title"},"4. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),Kf=I(()=>c("img",{class:"full-img",src:jc,alt:""},null,-1)),Qf=I(()=>c("div",{class:"welcome-logo-wrap"},[c("img",{class:"welcome-logo",src:Yi,alt:"重機能停哪"})],-1)),Yf=I(()=>c("div",{class:"welcome-badge"},"✨ 全新介面上線",-1)),Xf=I(()=>c("p",{class:"welcome-text"}," 這是一個提供重機停車資訊的地圖，你可以依據「友善程度」「停車格類型」「收費範圍」尋找合適的停車場，並一鍵開啟 Google 或 Apple Map 導航。 ",-1)),qf=I(()=>c("div",{class:"whatsnew-card"},[c("div",{class:"whatsnew-title"},[c("span",{class:"material-icons-outlined"},"auto_awesome"),k(" 本次新功能 ")]),c("ul",{class:"whatsnew-list"},[c("li",null,[c("span",{class:"material-icons-outlined"},"tune"),c("span",null,[c("strong",null,"顯示分類切換"),c("br"),k(" 設定頁新增「官方 / 修改 / 共筆」三個開關,可依需求快速隱藏或顯示對應來源的停車點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"tag"),c("span",null,[c("strong",null,"各分類即時筆數"),c("br"),k(" 每個分類旁會顯示對應停車場資料筆數")])])])],-1)),Jf=I(()=>c("p",{class:"welcome-text"},[k(" 資料取源於: "),c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"link"},"Alan大重停車記事"),k("，如有停車場相關問題請至該頁面填寫回報表單。 ")],-1)),$f=I(()=>c("p",{class:"welcome-text"},' 公告: 原始資料"大重停車記事已無更新" 已改由 Alan大重停車記事 提供，感謝Alan的辛苦整理與分享！ ',-1)),Zf=I(()=>c("p",{class:"welcome-text"},[k(" 本站僅提供資料整合服務，地圖免費提供車友使用，資料不定期更新；若發生無法使用情況，請至 "),c("a",{href:"https://forms.gle/iJCyfqVtpL35WtZM7",target:"_blank",rel:"noopener",class:"link"},"錯誤資訊回報"),k("，也歡迎贊助讓我有動力繼續更新。 ")],-1)),e6=I(()=>c("p",{class:"welcome-text right"},"— by 爽爽",-1)),n6={key:0,class:"pick-crosshair","aria-hidden":"true"},t6=I(()=>c("span",{class:"material-icons-outlined dot"},"gps_fixed",-1)),o6=[t6],i6={key:1,class:"pick-banner"},s6=I(()=>c("span",{class:"pick-banner-text"},[c("span",{class:"material-icons-outlined"},"touch_app"),k(" 拖動地圖，將十字線對準目標位置 ")],-1)),r6=I(()=>c("span",{class:"material-icons-outlined"},"check",-1)),l6=I(()=>c("p",{class:"welcome-text"},[c("strong",{style:{color:"var(--primary)"}},"這是一個公開共享的「共筆停車點」區。"),k(" 除了官方收錄的「大重停車記事」資料外,任何人都可以新增、修改、補充停車位置——不需要註冊、不需要審核。 ")],-1)),a6=I(()=>c("h4",{class:"modal-section-title"},"如何新增停車位置",-1)),c6=I(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"點左下角的「共筆停車點」按鈕,再點「新增停車位置」"),c("li",null,"畫面中心會出現青色十字游標,拖動地圖將游標對準目標位置"),c("li",null,"按頂部「使用此位置」,填寫名稱、類別、友善程度、收費等資料"),c("li",null,"按「新增」即完成(座標已自動記錄,圖示會依類別自動套用)")],-1)),d6=I(()=>c("h4",{class:"modal-section-title"},"如何編輯他人新增的位置",-1)),h6=I(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"地圖上「薰衣草紫色底」的標記即為使用者新增的「共筆停車點」"),c("li",null,"點擊該標記,在資訊面板按「編輯」"),c("li",null,"修改後按「儲存修改」")],-1)),u6=I(()=>c("h4",{class:"modal-section-title"},"注意事項",-1)),m6=I(()=>c("ul",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"請確認資訊正確,避免造成他人困擾"),c("li",null,"不要新增不雅、惡意或無關內容"),c("li",null,"暱稱可選填,留空將顯示為「匿名#xxx-xxx」"),c("li",null,"站方保留必要時清空所有「共筆停車點」資料的權利")],-1)),Jr="onboarding_tour_v1",$r="filters_v1",p6="https://findparkinglot.github.io/",f6={__name:"App",setup(n){var js,Gs,Ks;const e=navigator.userAgent,t=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(e),o=/iPhone|iPad|iPod/i.test(e),i=/Android/i.test(e),s=E([]),r=()=>{var u;return!!((u=window.matchMedia)!=null&&u.call(window,"(prefers-color-scheme: light)").matches)},l=u=>{var p;if(u==="system"){const y=r()?"light":"dark";return(p=tt.find(fe=>fe.theme===y))==null?void 0:p.value}return u},a=tt.find(u=>u.name===on.get("mapStyles")),d=(a==null?void 0:a.value)||((js=tt.find(u=>u.theme==="dark"))==null?void 0:js.value),m=E(d),h=E({getLngLat:!1,mapStylesSelected:l(d)}),f=u=>{const p=l(u);h.value.mapStylesSelected=p;const y=tt.find(me=>me.value===p),fe=(y==null?void 0:y.theme)==="light";document.body.classList.toggle("light-theme",fe),document.body.classList.toggle("dark-theme",!fe);const Ve=tt.find(me=>me.value===u);Ve&&on.set("mapStyles",Ve.name)};f(m.value),K(m,f);const b=(Gs=window.matchMedia)==null?void 0:Gs.call(window,"(prefers-color-scheme: light)");(Ks=b==null?void 0:b.addEventListener)==null||Ks.call(b,"change",()=>{m.value==="system"&&f("system")});const g=E(!0),B=E(!1),D=E(i?"android":"ios"),U=E(!1),W=E(!1),T=E(!1),G=E(!1),Ue=E(!1),ie=[{selector:".mapboxgl-ctrl-geolocate",icon:"my_location",title:"定位你的位置",description:"點右上角的定位按鈕,地圖會自動移到你目前位置,並追蹤方向。"},{selector:".fab-placement-right > .fab-main",icon:"help_outline",title:"功能與教學",description:"右下角的圓形按鈕展開後,可看到「地圖怎麼看」、「加到手機桌面」、「分享」等功能。"},{selector:".search-toggle",icon:"search",title:"搜尋停車點",description:"右下角的搜尋按鈕可依名稱快速找到想去的停車場,點選結果會自動飛到該位置並開啟資訊。"},{selector:".app-title .title-toggle",icon:"menu",title:"篩選與我的最愛",description:"左上角選單可以調整停車類型、友善程度、收費範圍,以及只顯示我的最愛、切換主題。"},{selector:".fab-placement-left > .fab-main",icon:"add_location_alt",title:"共筆停車點",description:"左下角按鈕可新增/編輯共筆停車點,大家一起分享真實的停車資訊。"}],Se=()=>{Ue.value=!0,ye("onboarding_tour_start")},Te=()=>{try{localStorage.setItem(Jr,"1")}catch(u){}ye("onboarding_tour_finish")},Je=()=>{g.value=!1},ge=E(!1),ce=E(!1),Ee=E(!1),je=u=>{u!=="menu"&&(ge.value=!1),u!=="info"&&(ce.value=!1),u!=="message"&&(g.value=!1),u!=="mobileFAQ"&&(B.value=!1),u!=="faq"&&(U.value=!1),u!=="share"&&(W.value=!1),u!=="communityHelp"&&(T.value=!1),u!=="support"&&(G.value=!1),ye("panel_open",{panel:u})};K(ge,u=>u&&je("menu")),K(ce,u=>u&&je("info")),K(g,u=>u&&je("message")),K(B,u=>u&&je("mobileFAQ")),K(B,u=>{u&&(i?D.value="android":o&&(D.value="ios"))}),K(U,u=>u&&je("faq")),K(W,u=>u&&je("share")),K(T,u=>u&&je("communityHelp")),K(G,u=>u&&je("support"));const C=[{key:"buymeacoffee",url:"https://buymeacoffee.com/jamestim923",label:"Buy Me a Coffee",description:"請我喝杯咖啡 ☕️ (美金贊助)",icon:"local_cafe",primary:!1}],R=()=>{G.value=!0,ye("support_open")},X=u=>{ye("support_click",{provider:u.key}),window.open(u.url,"_blank","noopener,noreferrer")},j=on.getJSON($r,{})||{},se=E(typeof j.parkingType=="string"?j.parkingType:""),re=E(typeof j.degreeOfFriendliness=="string"?j.degreeOfFriendliness:""),ke=E(typeof j.parkingPriceType=="string"?j.parkingPriceType:""),ue=E(typeof j.priceRangeMin=="number"?j.priceRangeMin:0),xe=E(typeof j.priceRangeMax=="number"?j.priceRangeMax:100),Le=E(j.showOfficial!==!1),A=E(j.showOverridden!==!1),M=E(j.showCommunity!==!1),{favorites:S,favoriteIdSet:pe,isFavorite:Ge,toggleFavorite:Fe}=Id(),$e=E(j.onlyFavorites===!0);K([se,re,ke,ue,xe,$e,Le,A,M],([u,p,y,fe,Ve,me,_n,vn,io])=>{on.setJSON($r,{parkingType:u,degreeOfFriendliness:p,parkingPriceType:y,priceRangeMin:fe,priceRangeMax:Ve,onlyFavorites:me,showOfficial:_n,showOverridden:vn,showCommunity:io})});const z=E("driving"),{items:O,addParking:J,updateParking:he,deleteParking:De}=Tm(),{userId:le,nickname:He,isAdmin:Ne}=Lm(),xn=E(null),{overrides:eo,getOverride:Qo,getOverrideHistory:no,upsertOverride:ic,resetOverride:sc}=Mu(),Os=Y(()=>new Set(Object.keys(eo.value||{}))),rc=Y(()=>(s.value||[]).reduce((u,p)=>{var y;return u+(((y=p==null?void 0:p.features)==null?void 0:y.length)||0)},0)),lc=Y(()=>Os.value.size),ac=Y(()=>(O.value||[]).length),Ze=E(!1),bn=E("add"),gn=E(null),un=E(!1),gt=E([121.5173399,25.0475613]),xs=E(!1),cn=E(!1),Yo=E(!1),Ls=Y(()=>!ce.value&&!Ee.value&&!cn.value&&!Ze.value),Fs=()=>{Yo.value&&Ls.value&&(Yo.value=!1,Se())};K(g,(u,p)=>{if(p&&!u)try{localStorage.getItem(Jr)||(Yo.value=!0,setTimeout(Fs,350))}catch(y){}}),K(Ls,u=>{u&&setTimeout(Fs,200)});const cc=Y(()=>{var u;if(!Ze.value)return[];if(bn.value==="override")return Ke.value?no(Ke.value.name,Ke.value.geometry):[];if(bn.value==="edit"&&((u=gn.value)!=null&&u.id)){const p=(O.value||[]).find(y=>y.id===gn.value.id);return(p==null?void 0:p.history)||[]}return[]}),ze=E(null),dc=()=>{if(!dn){alert("「共筆停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}cn.value=!0,ye("community_add_start")},hc=()=>{var p,y;const u=((y=(p=xn.value)==null?void 0:p.getCenter)==null?void 0:y.call(p))||[121.5173399,25.0475613];gt.value=u,bn.value="add",gn.value=null,cn.value=!1,Ze.value=!0},uc=()=>{cn.value=!1},mc=u=>{var p,y;gt.value=u.coordinates?[...u.coordinates]:((y=(p=xn.value)==null?void 0:p.getCenter)==null?void 0:y.call(p))||[121.5173399,25.0475613],bn.value="edit",gn.value=u,Ze.value=!0},Xo=u=>{ze.value=u,Zn({name:"共筆停車點",properties:{name:u.name,description:u.description,icon:u.iconKey,priceInfo:u.priceInfo,priceArray:[]},geometry:u.coordinates,address:""})},pc=()=>{ze.value&&(ce.value=!1,mc(ze.value))},fc=()=>{if(!dn){alert("「修改官方停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}if(!Ke.value)return;const u=Ke.value,p=to.value,y={id:null,name:u.name,description:(p==null?void 0:p.description)||u.description,iconKey:(p==null?void 0:p.iconKey)||u.iconKey,category:(p==null?void 0:p.category)||yc(u.iconKey),friendliness:(p==null?void 0:p.friendliness)||bc(u.iconKey),priceInfo:(p==null?void 0:p.priceInfo)||u.priceInfo,coordinates:u.geometry?[...u.geometry]:[...gt.value]};gt.value=y.coordinates,bn.value="override",gn.value=y,xs.value=!!p,ce.value=!1,Ze.value=!0,ye("override_edit_start",{name:u.name})};function yc(u){if(!u)return"motorcycle";const p=ut.find(y=>y.value&&y.key.includes(u));return(p==null?void 0:p.value)||"motorcycle"}function bc(u){if(!u)return"friendly";const p=Qt.find(y=>y.value&&y.key.includes(u));return(p==null?void 0:p.value)||"friendly"}const gc=async u=>{if(Ke.value){un.value=!0;try{const p={id:le,nickname:He.value};await ic(Ke.value,u,p),ye("override_submit",{name:Ke.value.name});const y=Ke.value;Ze.value=!1,Zn({name:y.parkingType,properties:{name:y.name,description:y.description,icon:y.iconKey,priceInfo:y.priceInfo,priceArray:[]},geometry:y.geometry,address:ee.value.address})}catch(p){alert("儲存失敗:"+((p==null?void 0:p.message)||p))}finally{un.value=!1}}},Ac=async()=>{if(Ke.value){un.value=!0;try{const u=Ke.value,p={id:le,nickname:He.value};await sc(u.name,u.geometry,p),ye("override_reset",{name:u.name}),Ze.value=!1,Zn({name:u.parkingType,properties:{name:u.name,description:u.description,icon:u.iconKey,priceInfo:u.priceInfo,priceArray:[]},geometry:u.geometry,address:ee.value.address})}catch(u){alert("重設失敗:"+((u==null?void 0:u.message)||u))}finally{un.value=!1}}},_c=async u=>{var p;un.value=!0;try{const y={id:le,nickname:He.value};bn.value==="edit"&&((p=gn.value)!=null&&p.id)?(await he(gn.value.id,u,y),ye("community_edit_submit",{name:u==null?void 0:u.name})):(await J(u,y),ye("community_add_submit",{name:u==null?void 0:u.name})),Ze.value=!1,ze.value=null}catch(y){alert("儲存失敗:"+((y==null?void 0:y.message)||y))}finally{un.value=!1}},vc=async u=>{un.value=!0;try{const p={id:le,nickname:He.value};await De(u,p),ye("community_delete",{id:u}),Ze.value=!1,ze.value=null}catch(p){alert("刪除失敗:"+((p==null?void 0:p.message)||p))}finally{un.value=!1}},qo=Y(()=>{var p,y;if(!ze.value||!ee.value.parkingName)return!1;const u=ze.value;return u.name===ee.value.parkingName&&Array.isArray(ee.value.geometry)&&((p=u.coordinates)==null?void 0:p[0])===ee.value.geometry[0]&&((y=u.coordinates)==null?void 0:y[1])===ee.value.geometry[1]});K(ce,u=>{u||(ze.value=null)});const At=E(null),Pc=Y(()=>{var u;return((u=ut.find(p=>p.value===se.value))==null?void 0:u.key)||[]}),Cc=Y(()=>{var u;return((u=Qt.find(p=>p.value===re.value))==null?void 0:u.key)||[]}),ee=E({parkingName:"",parkingNameDes:"",parkingType:"",parkingIcon:"",parkingIconKey:"",iconCategory:"",priceInfo:"",geometry:[null,null],address:"",sourceLabel:""}),Ke=E(null),to=E(null),Hs=Y(()=>yi(ee.value.parkingName,ee.value.geometry)),zs=Y(()=>Ge(Hs.value)),Zn=u=>{var _n,vn,io,Qs,Ys;const p=u.properties.icon,y={name:u.properties.name,description:u.properties.description,iconKey:p,priceInfo:u.properties.priceInfo||"",geometry:u.geometry,parkingType:u.name},fe=!!(ze.value&&ze.value.name===u.properties.name&&Array.isArray(u.geometry)&&((_n=ze.value.coordinates)==null?void 0:_n[0])===u.geometry[0]&&((vn=ze.value.coordinates)==null?void 0:vn[1])===u.geometry[1]);let Ve=null,me=y;fe||(Ve=Qo(y.name,y.geometry),Ve&&(me=Za(y,Ve))),Ke.value=fe?null:y,to.value=Ve,ee.value={parkingName:me.name,parkingNameDes:me.description,parkingType:y.parkingType,iconCategory:Zu(me.iconKey),parkingIcon:$(me.iconKey),parkingIconKey:me.iconKey,priceInfo:me.priceInfo||"",geometry:u.geometry,address:u.address,sourceLabel:fe?"":bd((io=u.properties)==null?void 0:io.sourceFolderIndex)},ce.value=!0,ye("parking_view",{parking_name:(Qs=u.properties)==null?void 0:Qs.name,parking_type:u.name,icon:(Ys=u.properties)==null?void 0:Ys.icon,overridden:!!Ve})},Uc=()=>{if(!ee.value.parkingName)return;const u=!zs.value;Fe({id:Hs.value,name:ee.value.parkingName,parkingType:ee.value.parkingType,geometry:ee.value.geometry,address:ee.value.address,icon:ee.value.parkingIconKey}),ye(u?"favorite_add":"favorite_remove",{parking_name:ee.value.parkingName,parking_type:ee.value.parkingType})},Ec=u=>"",Bc=u=>{var p;u.isCommunity&&u.community?Xo(u.community):Zn({name:u.groupName,properties:u.properties,geometry:u.geometry,address:Ec(u.geometry)}),At.value=[...u.geometry],ye("search_select",{parking_name:(p=u.properties)==null?void 0:p.name,group:u.groupName,community:!!u.isCommunity})},_t=E(null),vt=E(null),wc=u=>{z.value="driving",_t.value=u,ce.value=!1,vt.value=null,ye("route_start",{parking_name:ee.value.parkingName,profile:"driving"})},Ic=()=>{_t.value=null,Ee.value=!1};K(vt,u=>{Ee.value=u!==null});const Sc=u=>{const p=ee.value.geometry;let y="";u==="apple"?y=`https://maps.apple.com/?daddr=${p[1]},${p[0]}&dirflg=d&t=m`:u==="google"&&(y=`https://www.google.com/maps/dir/?api=1&destination=${p[1]},${p[0]}&travelmode=driving`),y&&(ye("open_external_map",{provider:u,parking_name:ee.value.parkingName}),window.open(y,"_blank","noopener,noreferrer"))},An=(u,p=null)=>{const y=p||"https://findparkinglot.github.io/";let fe="";u==="facebook"?fe=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(y)}`:u==="line"?fe=`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(y)}`:u==="twitter"&&(fe=`https://twitter.com/share?url=${encodeURIComponent(y)}`),ye("share",{method:u,scope:p?"spot":"site"}),u==="link"?navigator.clipboard.writeText(y).then(()=>alert("已複製連結"),()=>alert("複製失敗")):window.open(fe,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},Vs=()=>{const u=ee.value.geometry;if(!Array.isArray(u)||u[0]==null||u[1]==null)return"";const p=new URLSearchParams({lng:Number(u[0]).toFixed(6),lat:Number(u[1]).toFixed(6)});return`${p6}?${p.toString()}`},kc=()=>{const u=Vs();u&&(et.value=u,$o.value=ee.value.parkingName||"停車點",Jo.value=!0,ye("share_spot_open",{name:$o.value}))},Jo=E(!1),et=E(""),$o=E("");K([ce,ee],()=>{try{if(!ce.value){window.location.search&&window.history.replaceState({},"",window.location.pathname);return}const u=Vs();if(!u)return;const p=u.slice(u.indexOf("?"));window.history.replaceState({},"",window.location.pathname+p)}catch(u){}},{deep:!0});const Pt=E(null),oo=(u,p)=>Math.abs(Number(u)-Number(p))<1e-5,Zo=()=>{var Ve;const u=Pt.value;if(!u)return;const p=Number(u.lng),y=Number(u.lat);if(!isFinite(p)||!isFinite(y)){Pt.value=null;return}const fe=(O.value||[]).find(me=>me.coordinates&&oo(me.coordinates[0],p)&&oo(me.coordinates[1],y));if(fe){Xo(fe),At.value=[p,y],Pt.value=null;return}for(const me of s.value||[])for(const _n of me.features||[]){const vn=(Ve=_n.geometry)==null?void 0:Ve.coordinates;if(vn&&oo(vn[0],p)&&oo(vn[1],y)){Zn({name:me.name,properties:_n.properties,geometry:_n.geometry.coordinates,address:""}),At.value=[p,y],Pt.value=null;return}}Array.isArray(s.value)&&s.value.length>0&&(At.value=[p,y])},Ws=()=>{try{const u=new URLSearchParams(window.location.search),p=u.get("lng"),y=u.get("lat");if(!p||!y)return;Pt.value={lng:p,lat:y},Zo()}catch(u){}};K(O,Zo,{deep:!1}),K(s,Zo,{deep:!1}),Xn(()=>{s.value=Ed(fd()),g.value||Ws()}),K(g,(u,p)=>{p&&!u&&Ws()});const Dc=Y(()=>[{key:"share",icon:"share",label:"分享",highlight:!0,onClick:()=>W.value=!0},{key:"howto",icon:"help_outline",label:"怎麼用",onClick:Se},{key:"faq",icon:"map",label:"地圖怎麼看",onClick:()=>U.value=!0},{key:"mobile",icon:"add_to_home_screen",label:"加到手機桌面",onClick:()=>B.value=!0}]),Tc=Y(()=>[{key:"add",icon:"add_location_alt",label:"新增停車位置",highlight:!0,onClick:dc},{key:"help",icon:"menu_book",label:"編輯教學",onClick:()=>T.value=!0}]);return(u,p)=>(v(),P(be,null,[c("div",Hm,[cn.value?(v(),P("img",Wm)):(v(),P("button",{key:0,class:"title-toggle",onClick:p[0]||(p[0]=y=>ge.value=!ge.value),"aria-label":ge.value?"收合設定":"開啟設定","aria-expanded":ge.value},[c("span",Vm,w(ge.value?"close":"menu"),1)],8,zm)),jm]),Qe(Be(Xr,{items:Dc.value},null,8,["items"]),[[wt,!Ee.value&&!ce.value&&!cn.value]]),Qe(Be(Xr,{items:Tc.value,placement:"left","main-icon":"add_location_alt","main-label":"共筆停車點"},null,8,["items"]),[[wt,!Ee.value&&!ce.value&&!cn.value]]),Qe(Be(_4,{"map-data-list":s.value,"community-parkings":x(O),onSelect:Bc},null,8,["map-data-list","community-parkings"]),[[wt,!Ee.value&&!ce.value&&!cn.value]]),Gm,Be(Fu,{ref_key:"mapBoxRef",ref:xn,parkingTypeKeyArray:Pc.value,degreeOfFriendlinessKeyArray:Cc.value,mapDataList:s.value,getLngLat:h.value.getLngLat,mapStylesSelected:h.value.mapStylesSelected,parkingPriceType:ke.value,priceRangeMin:ue.value,priceRangeMax:xe.value,"favorite-ids":x(pe),"override-keys":Os.value,overrides:x(eo),"only-favorites":$e.value,"show-official":Le.value,"show-overridden":A.value,"show-community":M.value,"focus-coord":At.value,"route-profile":z.value,"community-parkings":x(O),goToParkingPlaceData:_t.value,"onUpdate:goToParkingPlaceData":p[1]||(p[1]=y=>_t.value=y),routeData:vt.value,"onUpdate:routeData":p[2]||(p[2]=y=>vt.value=y),onParkingInfo:Zn,onCommunityParkingClick:Xo},null,8,["parkingTypeKeyArray","degreeOfFriendlinessKeyArray","mapDataList","getLngLat","mapStylesSelected","parkingPriceType","priceRangeMin","priceRangeMax","favorite-ids","override-keys","overrides","only-favorites","show-official","show-overridden","show-community","focus-coord","route-profile","community-parkings","goToParkingPlaceData","routeData"]),Be(i4,{"route-data":vt.value,active:Ee.value,profile:z.value,"onUpdate:profile":p[3]||(p[3]=y=>z.value=y),onCancel:Ic},null,8,["route-data","active","profile"]),Be(r5,{parkingType:se.value,"onUpdate:parkingType":p[4]||(p[4]=y=>se.value=y),degreeOfFriendliness:re.value,"onUpdate:degreeOfFriendliness":p[5]||(p[5]=y=>re.value=y),parkingPriceType:ke.value,"onUpdate:parkingPriceType":p[6]||(p[6]=y=>ke.value=y),priceRangeMin:ue.value,"onUpdate:priceRangeMin":p[7]||(p[7]=y=>ue.value=y),priceRangeMax:xe.value,"onUpdate:priceRangeMax":p[8]||(p[8]=y=>xe.value=y),mapStyle:m.value,"onUpdate:mapStyle":p[9]||(p[9]=y=>m.value=y),active:ge.value,"onUpdate:active":p[10]||(p[10]=y=>ge.value=y),onlyFavorites:$e.value,"onUpdate:onlyFavorites":p[11]||(p[11]=y=>$e.value=y),showOfficial:Le.value,"onUpdate:showOfficial":p[12]||(p[12]=y=>Le.value=y),showOverridden:A.value,"onUpdate:showOverridden":p[13]||(p[13]=y=>A.value=y),showCommunity:M.value,"onUpdate:showCommunity":p[14]||(p[14]=y=>M.value=y),"favorites-count":x(S).length,"official-count":rc.value,"overridden-count":lc.value,"community-count":ac.value,onOpenSupport:R},null,8,["parkingType","degreeOfFriendliness","parkingPriceType","priceRangeMin","priceRangeMax","mapStyle","active","onlyFavorites","showOfficial","showOverridden","showCommunity","favorites-count","official-count","overridden-count","community-count"]),Qe(Be(V5,{info:ee.value,active:ce.value,"is-mobile":x(t),"is-apple":x(o),"is-android":x(i),"has-route":_t.value!==null,"is-favorite":zs.value,"is-community":qo.value,"community-meta":qo.value?ze.value:null,"is-overridden":!qo.value&&!!to.value,"override-meta":to.value,onClose:p[15]||(p[15]=y=>ce.value=!1),onRoute:p[16]||(p[16]=y=>wc(ee.value.geometry)),onOpenMap:Sc,onToggleFavorite:Uc,onEditCommunity:pc,onEditOverride:fc,onShare:kc},null,8,["info","active","is-mobile","is-apple","is-android","has-route","is-favorite","is-community","community-meta","is-overridden","override-meta"]),[[wt,!Ee.value]]),Be(Un,{modelValue:U.value,"onUpdate:modelValue":p[17]||(p[17]=y=>U.value=y),title:"地圖怎麼看?","close-text":"知道了",size:"lg"},{default:en(()=>[Km,c("div",Qm,[c("div",Ym,[c("img",{src:x($)("icon-3.png"),alt:""},null,8,Xm),k(" 汽車：汽車格(含未確認是否有重機格) ")]),c("div",qm,[c("img",{src:x($)("icon-8.png"),alt:""},null,8,Jm),k(" 重機(有人):有設重機專用格 ")]),c("div",$m,[c("img",{src:x($)("icon-10.png"),alt:""},null,8,Zm),k(" 機車(沒人):機車格 ")]),c("div",ep,[c("img",{src:x($)("icon-14.png"),alt:""},null,8,np),k(" 綠星:路邊友善車格 ")]),c("div",tp,[c("img",{src:x($)("icon-4.png"),alt:""},null,8,op),k(" 重機友善店家:用餐/消費時可停重機的店家 ")]),c("div",ip,[c("img",{src:x($)("icon-15.png"),alt:""},null,8,sp),k(" 綠P:重機專用路邊停車格 ")]),c("div",rp,[c("img",{src:x($)("icon-16.png"),alt:""},null,8,lp),k(" 灰P:重機專用路邊停車格(未確認精準座標,歡迎回報) ")]),c("div",ap,[c("img",{src:x($)("icon-17.png"),alt:""},null,8,cp),k(" 藍P:普通大型共用機車格(台北市試辦) ")]),c("div",dp,[c("img",{src:x($)("icon-18.png"),alt:""},null,8,hp),k(" 紫P:時段性汽機車共用停車格 ")]),c("div",up,[c("img",{src:x($)("icon-19.png"),alt:""},null,8,mp),k(" 紅X:停都不給停 ")]),c("div",pp,[c("img",{src:x($)("icon-20.png"),alt:""},null,8,fp),k(" ?:類型未確認,歡迎透過共筆回報 ")])]),yp,c("div",bp,[c("div",gp,[c("img",{src:x($)("icon-2.png"),alt:""},null,8,Ap),c("img",{src:x($)("icon-6.png"),alt:""},null,8,_p),c("img",{src:x($)("icon-9.png"),alt:""},null,8,vp),k(" 綠色最友善:有後牌辨析 ")]),c("div",Pp,[c("img",{src:x($)("icon-5.png"),alt:""},null,8,Cp),c("img",{src:x($)("icon-12.png"),alt:""},null,8,Up),c("img",{src:x($)("icon-11.png"),alt:""},null,8,Ep),k(" 藍色最傳統:悠遊卡 / 按鈕取票 ")]),c("div",Bp,[c("img",{src:x($)("icon-1.png"),alt:""},null,8,wp),c("img",{src:x($)("icon-13.png"),alt:""},null,8,Ip),c("img",{src:x($)("icon-7.png"),alt:""},null,8,Sp),k(" 紅色最靠北:請管理員協助 / 倒退嚕前牌辨析 ")]),c("div",kp,[c("img",{src:x($)("icon-3.png"),alt:""},null,8,Dp),c("img",{src:x($)("icon-8.png"),alt:""},null,8,Tp),c("img",{src:x($)("icon-10.png"),alt:""},null,8,Np),k(" 灰色未確定:有可能是上述任何情況,停到請回報 ")])]),Mp,c("div",Rp,[c("div",Op,[c("img",{src:x($)("icon-3.png"),alt:""},null,8,xp),k(" (30/h)三張里地下停車場 ")]),Lp])]),_:1},8,["modelValue"]),Be(Un,{modelValue:W.value,"onUpdate:modelValue":p[22]||(p[22]=y=>W.value=y),title:"分享給朋友",size:"sm"},{default:en(()=>[c("div",Fp,[c("button",{class:"share-btn",onClick:p[18]||(p[18]=y=>An("facebook")),"aria-label":"Facebook"},Vp),c("button",{class:"share-btn",onClick:p[19]||(p[19]=y=>An("line")),"aria-label":"LINE"},Gp),c("button",{class:"share-btn",onClick:p[20]||(p[20]=y=>An("twitter")),"aria-label":"Twitter"},Yp),c("button",{class:"share-btn",onClick:p[21]||(p[21]=y=>An("link")),"aria-label":"複製連結"},Jp)])]),_:1},8,["modelValue"]),Be(Un,{modelValue:Jo.value,"onUpdate:modelValue":p[27]||(p[27]=y=>Jo.value=y),title:`分享：${$o.value}`,size:"sm"},{default:en(()=>[c("p",$p,w(et.value),1),c("div",Zp,[c("button",{class:"share-btn",onClick:p[23]||(p[23]=y=>An("facebook",et.value)),"aria-label":"Facebook"},tf),c("button",{class:"share-btn",onClick:p[24]||(p[24]=y=>An("line",et.value)),"aria-label":"LINE"},rf),c("button",{class:"share-btn",onClick:p[25]||(p[25]=y=>An("twitter",et.value)),"aria-label":"Twitter"},cf),c("button",{class:"share-btn",onClick:p[26]||(p[26]=y=>An("link",et.value)),"aria-label":"複製連結"},uf)])]),_:1},8,["modelValue","title"]),Be(Un,{modelValue:G.value,"onUpdate:modelValue":p[28]||(p[28]=y=>G.value=y),title:"支持「重機能停哪?」","close-text":"關閉",size:"sm"},{default:en(()=>[mf,c("div",pf,[(v(),P(be,null,We(C,y=>c("button",{key:y.key,type:"button",class:Z(["support-btn",{"is-primary":y.primary}]),onClick:fe=>X(y)},[c("span",yf,w(y.icon),1),c("span",bf,[c("span",gf,[k(w(y.label)+" ",1),y.primary?(v(),P("span",Af,"推薦")):V("",!0)]),c("span",_f,w(y.description),1)]),vf],10,ff)),64))])]),_:1},8,["modelValue"]),Be(Un,{modelValue:B.value,"onUpdate:modelValue":p[31]||(p[31]=y=>B.value=y),title:"如何加入手機桌面?","close-text":"知道了",size:"lg"},{default:en(()=>[c("div",Pf,[c("button",{type:"button",role:"tab","aria-selected":D.value==="ios",class:Z(["os-tab",{"is-active":D.value==="ios"}]),onClick:p[29]||(p[29]=y=>D.value="ios")},[Uf,k(" iOS ")],10,Cf),c("button",{type:"button",role:"tab","aria-selected":D.value==="android",class:Z(["os-tab",{"is-active":D.value==="android"}]),onClick:p[30]||(p[30]=y=>D.value="android")},[Bf,k(" Android ")],10,Ef)]),D.value==="ios"?(v(),P(be,{key:0},[wf,If,Sf,kf,Df,Tf,Nf,Mf,Rf,Of,xf],64)):(v(),P(be,{key:1},[Lf,Ff,Hf,zf,Vf,Wf,jf,Gf,Kf],64))]),_:1},8,["modelValue"]),Be(Un,{modelValue:g.value,"onUpdate:modelValue":p[32]||(p[32]=y=>g.value=y),title:"嗨！歡迎使用 重機能停哪?","close-text":"開始使用"},{footer:en(()=>[c("button",{class:"btn btn-primary",onClick:Je},"開始使用")]),default:en(()=>[Qf,Yf,Xf,qf,Jf,$f,Zf,c("div",{class:"welcome-support-wrap"},[c("button",{type:"button",class:"btn btn-coffee btn-sm",onClick:R}," ❤️ 贊助支持，讓我有動力繼續更新 ")]),e6]),_:1},8,["modelValue"]),Be(bm,{open:Ze.value,"onUpdate:open":p[33]||(p[33]=y=>Ze.value=y),mode:bn.value,initial:gn.value,"default-coord":gt.value,nickname:x(He),"is-owner":!0,"is-admin":x(Ne),submitting:un.value,"has-existing-override":xs.value,history:cc.value,"onUpdate:nickname":p[34]||(p[34]=y=>He.value=y),onSubmit:p[35]||(p[35]=y=>bn.value==="override"?gc(y):_c(y)),onDelete:vc,onReset:Ac},null,8,["open","mode","initial","default-coord","nickname","is-admin","submitting","has-existing-override","history"]),cn.value?(v(),P("div",n6,o6)):V("",!0),cn.value?(v(),P("div",i6,[s6,c("div",{class:"pick-banner-actions"},[c("button",{class:"btn btn-outline btn-sm",onClick:uc},"取消"),c("button",{class:"btn btn-primary btn-sm",onClick:hc},[r6,k(" 使用此位置 ")])])])):V("",!0),Be(Un,{modelValue:T.value,"onUpdate:modelValue":p[36]||(p[36]=y=>T.value=y),title:"共筆停車點說明","close-text":"我知道了",size:"lg"},{default:en(()=>[l6,a6,c6,d6,h6,u6,m6]),_:1},8,["modelValue"]),Be(Im,{active:Ue.value,"onUpdate:active":p[37]||(p[37]=y=>Ue.value=y),steps:ie,onFinish:Te},null,8,["active"])],64))}},y6=an(f6,[["__scopeId","data-v-19f2d019"]]);Rc(y6).mount("#app");"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./serviceWorker.js").catch(()=>{})});
