...
`],description:["2023/6/1 重新開放17處坡度較陡停車場"],styleUrl:["#icon-1538-757575-labelson"],Point:[{coordinates:[`
          ...
          `]}]},{name:["(80/h)客限-板橋凱撒大飯店"],description:['<img src="https://mymaps.usercontent.google.com/hostedimage/m/*/3AAjQbR5sB7z0eyQB3mHRiacbw39llRynWqynzVRSKWosJplScbm4334lNxiaA5mgwlp8EeSSJgQbktOYt3PIKGTMCcUHwtTvHU1Ayvi41RhTT3jSNNPGVhHrgigCE-xXBLv1hBm8pwKXatCmH4oh0z060d0CLZHXOdkEwDqPR8o2s3eQFyTa3sUuPsVaNN-IdXahWX4O9C5buzrgI_nPJ-gGOHv9-dBg5547ynhS6V7Z-_sn-msaUtON0BofJ_k?fife=s16383" height="200" width="auto" /><br><br>感謝hoha5432提供<br>汽車費率 80h 按鈕取票 2 格 或以上 <br>目前對外說不開放臨停，僅供住宿與用餐客人停放。費用沒有公開，根據個人繳費經驗推估約 80h。<br>官網寫說「本飯店提供機車/汽車地下停車場(B2-B5) ，共220個車位。※B2停放機車（可供重型機車停靠，但如需要更大空間可改停靠汽車停車格）」但實際沒有機車格，而是只有大重停車格（為汽車格畫線切出）。  '],styleUrl:["#icon-1633-0288D1"],ExtendedData:[{Data:[{$:{name:"gx_media_links"},value:["https://mymaps.usercontent.google.com/hostedimage/m/*/3AAjQbR5sB7z0eyQB3mHRiacbw39llRynWqynzVRSKWosJplScbm4334lNxiaA5mgwlp8EeSSJgQbktOYt3PIKGTMCcUHwtTvHU1Ayvi41RhTT3jSNNPGVhHrgigCE-xXBLv1hBm8pwKXatCmH4oh0z060d0CLZHXOdkEwDqPR8o2s3eQFyTa3sUuPsVaNN-IdXahWX4O9C5buzrgI_nPJ-gGOHv9-dBg5547ynhS6V7Z-_sn-msaUtON0BofJ_k?fife=s16383"]}]}],Point:[{coordinates:[`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A=function(n,e){if(!n)throw pt(e)},pt=function(n){return new Error("Firebase Database ("+Cl.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const go=new Map,Y1=new Map,Pi=new Map;function ar(n,e){try{n.container.addComponent(e)}catch(t){mn.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Ao(n){const e=n.name;if(Pi.has(e))return mn.debug(`There were multiple attempts to register component ${e}.`),!1;Pi.set(e,n);for(const t of go.values())ar(t,n);for(const t of Y1.values())ar(t,n);return!0}function q1(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function J1(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const e0=Q1;function xl(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const o={name:vi,automaticDataCollectionEnabled:!0,...e},i=o.name;if(typeof i!="string"||!i)throw wn.create("bad-app-name",{appName:String(i)});if(t||(t=Sl()),!t)throw wn.create("no-options");const s=go.get(i);if(s){if(bo(t,s.options)&&bo(o,s.config))return s;throw wn.create("duplicate-app",{appName:i})}const r=new o1(i);for(const a of Pi.values())r.addComponent(a);const l=new Z1(t,o,r);return go.set(i,l),l}function n0(n=vi){const e=go.get(n);if(!e&&n===vi&&Sl())return xl();if(!e)throw wn.create("no-app",{appName:n});return e}function it(n,e,t){var r;let o=(r=X1[n])!=null?r:n;t&&(o+=`-${t}`);const i=o.match(/\s|\//),s=e.match(/\s|\//);if(i||s){const l=[`Unable to register library "${o}" with version "${e}":`];i&&l.push(`library name "${o}" contains illegal characters (whitespace or "/")`),i&&s&&l.push("and"),s&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),mn.warn(l.join(" "));return}Ao(new Lt(`${o}-version`,()=>({library:o,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const t0="firebase-heartbeat-database",o0=1,Ft="firebase-heartbeat-store";let ii=null;function Ll(){return ii||(ii=y1(t0,o0,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Ft)}catch(t){}}}}).catch(n=>{throw wn.create("idb-open",{originalErrorMessage:n.message})})),ii}async function i0(n){try{const t=(await Ll()).transaction(Ft),o=await t.objectStore(Ft).get(Fl(n));return await t.done,o}catch(e){if(e instanceof Yt)mn.warn(e.message);else{const t=wn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});mn.warn(t.message)}}}async function cr(n,e){try{const o=(await Ll()).transaction(Ft,"readwrite");await o.objectStore(Ft).put(e,Fl(n)),await o.done}catch(t){if(t instanceof Yt)mn.warn(t.message);else{const o=wn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});mn.warn(o.message)}}}function Fl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const s0=1024,r0=30;class l0{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new c0(t),this._heartbeatsCachePromise=this._storage.read().then(o=>(this._heartbeatsCache=o,o))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=dr();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(r=>r.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats.length>r0){const r=d0(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(o){mn.warn(o)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=dr(),{heartbeatsToSend:o,unsentEntries:i}=a0(this._heartbeatsCache.heartbeats),s=fo(JSON.stringify({version:2,heartbeats:o}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return mn.warn(t),""}}}function dr(){return new Date().toISOString().substring(0,10)}function a0(n,e=s0){const t=[];let o=n.slice();for(const i of n){const s=t.find(r=>r.agent===i.agent);if(s){if(s.dates.push(i.date),hr(t)>e){s.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),hr(t)>e){t.pop();break}o=o.slice(1)}return{heartbeatsToSend:t,unsentEntries:o}}class c0{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Wd()?jd().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await i0(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return cr(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var o;if(await this._canUseIndexedDBPromise){const i=await this.read();return cr(this.app,{lastSentHeartbeatDate:(o=e.lastSentHeartbeatDate)!=null?o:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function hr(n){return fo(JSON.stringify({version:2,heartbeats:n})).length}function d0(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let o=1;o<n.length;o++)n[o].date<t&&(t=n[o].date,e=o);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function h0(n){Ao(new Lt("platform-logger",e=>new A1(e),"PRIVATE")),Ao(new Lt("heartbeat",e=>new l0(e),"PRIVATE")),it(_i,lr,n),it(_i,lr,"esm2020"),it("fire-js","")}h0("");var ur={};const mr="@firebase/database",pr="1.1.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class p0{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return cn(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zl=function(n){try{if(typeof window!="undefined"&&typeof window[n]!="undefined"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new m0(e)}}catch(e){}return new p0},Wn=zl("localStorage"),f0=zl("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const st=new Ml("@firebase/database"),y0=function(){let n=1;return function(){return n++}}(),Vl=function(n){const e=$d(n),t=new Jd;t.update(e);const o=t.digest();return qi.encodeByteArray(o)},qt=function(...n){let e="";for(let t=0;t<n.length;t++){const o=n[t];Array.isArray(o)||o&&typeof o=="object"&&typeof o.length=="number"?e+=qt.apply(null,o):typeof o=="object"?e+=ve(o):e+=o,e+=" "}return e};let kt=null,fr=!0;const b0=function(n,e){A(!e,"Can't turn on custom loggers persistently."),st.logLevel=te.VERBOSE,kt=st.log.bind(st)},we=function(...n){if(fr===!0&&(fr=!1,kt===null&&f0.get("logging_enabled")===!0&&b0()),kt){const e=qt.apply(null,n);kt(e)}},Jt=function(n){return function(...e){we(n,...e)}},Ci=function(...n){const e="FIREBASE INTERNAL ERROR: "+qt(...n);st.error(e)},pn=function(...n){const e=`FIREBASE FATAL ERROR: ${qt(...n)}`;throw st.error(e),new Error(e)},De=function(...n){const e="FIREBASE WARNING: "+qt(...n);st.warn(e)},g0=function(){typeof window!="undefined"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&De("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},$i=function(n){return typeof n=="number"&&(n!==n||n===Number.POSITIVE_INFINITY||n===Number.NEGATIVE_INFINITY)},A0=function(n){if(document.readyState==="complete")n();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,n())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},Gn="[MIN_NAME]",In="[MAX_NAME]",Jn=function(n,e){if(n===e)return 0;if(n===Gn||e===In)return-1;if(e===Gn||n===In)return 1;{const t=yr(n),o=yr(e);return t!==null?o!==null?t-o===0?n.length-e.length:t-o:-1:o!==null?1:n<e?-1:1}},_0=function(n,e){return n===e?0:n<e?-1:1},Ct=function(n,e){if(e&&n in e)return e[n];throw new Error("Missing required key ("+n+") in object: "+ve(e))},Zi=function(n){if(typeof n!="object"||n===null)return ve(n);const e=[];for(const o in n)e.push(o);e.sort();let t="{";for(let o=0;o<e.length;o++)o!==0&&(t+=","),t+=ve(e[o]),t+=":",t+=Zi(n[e[o]]);return t+="}",t},Wl=function(n,e){const t=n.length;if(t<=e)return[n];const o=[];for(let i=0;i<t;i+=e)i+e>t?o.push(n.substring(i,t)):o.push(n.substring(i,i+e));return o};function Se(n,e){for(const t in n)n.hasOwnProperty(t)&&e(t,n[t])}const jl=function(n){A(!$i(n),"Invalid JSON number");const e=11,t=52,o=(1<<e-1)-1;let i,s,r,l,a;n===0?(s=0,r=0,i=1/n===-1/0?1:0):(i=n<0,n=Math.abs(n),n>=Math.pow(2,1-o)?(l=Math.min(Math.floor(Math.log(n)/Math.LN2),o),s=l+o,r=Math.round(n*Math.pow(2,t-l)-Math.pow(2,t))):(s=0,r=Math.round(n/Math.pow(2,1-o-t))));const d=[];for(a=t;a;a-=1)d.push(r%2?1:0),r=Math.floor(r/2);for(a=e;a;a-=1)d.push(s%2?1:0),s=Math.floor(s/2);d.push(i?1:0),d.reverse();const m=d.join("");let h="";for(a=0;a<64;a+=8){let f=parseInt(m.substr(a,8),2).toString(16);f.length===1&&(f="0"+f),h=h+f}return h.toLowerCase()},v0=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},P0=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function C0(n,e){let t="Unknown Error";n==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":n==="permission_denied"?t="Client doesn't have permission to access the desired data.":n==="unavailable"&&(t="The service is unavailable");const o=new Error(n+" at "+e._path.toString()+": "+t);return o.code=n.toUpperCase(),o}const U0=new RegExp("^-?(0*)\\d{1,10}$"),E0=-2147483648,B0=2147483647,yr=function(n){if(U0.test(n)){const e=Number(n);if(e>=E0&&e<=B0)return e}return null},ft=function(n){try{n()}catch(e){setTimeout(()=>{const t=e.stack||"";throw De("Exception was thrown by user callback.",t),e},Math.floor(0))}},w0=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Dt=function(n,e){const t=setTimeout(n,e);return typeof t=="number"&&typeof Deno!="undefined"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class S0{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,J1(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(o=>this.appCheck=o)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,o)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)==null||t.get().then(o=>o.addTokenListener(e))}notifyForInvalidToken(){De(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class I0{constructor(e,t,o){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=o,this.auth_=null,this.auth_=o.getImmediate({optional:!0}),this.auth_||o.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(we("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,o)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,o):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',De(e)}}class ao{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}ao.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class D0{constructor(){this.counters_={}}incrementCounter(e,t=1){cn(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return Td(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const si={},ri={};function ns(n){const e=n.toString();return si[e]||(si[e]=new D0),si[e]}function T0(n,e){const t=n.toString();return ri[t]||(ri[t]=e()),ri[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class N0{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const o=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<o.length;++i)o[i]&&ft(()=>{this.onMessage_(o[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const br="start",M0="close",R0="pLPCommand",O0="pRTLPCB",ta="id",oa="pw",ia="ser",x0="cb",L0="seg",F0="ts",H0="d",z0="dframe",sa=1870,ra=30,V0=sa-ra,W0=25e3,j0=3e4;class ot{constructor(e,t,o,i,s,r,l){this.connId=e,this.repoInfo=t,this.applicationId=o,this.appCheckToken=i,this.authToken=s,this.transportSessionId=r,this.lastSessionId=l,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=Jt(e),this.stats_=ns(t),this.urlFn=a=>(this.appCheckToken&&(a[Ui]=this.appCheckToken),na(t,Zl,a))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new N0(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(j0)),A0(()=>{if(this.isClosed_)return;this.scriptTagHolder=new ts((...s)=>{const[r,l,a,d,m]=s;if(this.incrementIncomingBytes_(s),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,r===br)this.id=l,this.password=a;else if(r===M0)l?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(l,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+r)},(...s)=>{const[r,l]=s;this.incrementIncomingBytes_(s),this.myPacketOrderer.handleResponse(r,l)},()=>{this.onClosed_()},this.urlFn);const o={};o[br]="t",o[ia]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(o[x0]=this.scriptTagHolder.uniqueCallbackIdentifier),o[Gl]=es,this.transportSessionId&&(o[Kl]=this.transportSessionId),this.lastSessionId&&(o[ql]=this.lastSessionId),this.applicationId&&(o[Jl]=this.applicationId),this.appCheckToken&&(o[Ui]=this.appCheckToken),typeof location!="undefined"&&location.hostname&&Yl.test(location.hostname)&&(o[Ql]=Xl);const i=this.urlFn(o);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){ot.forceAllow_=!0}static forceDisallow(){ot.forceDisallow_=!0}static isAvailable(){return ot.forceAllow_?!0:!ot.forceDisallow_&&typeof document!="undefined"&&document.createElement!=null&&!v0()&&!P0()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=ve(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const o=El(t),i=Wl(o,V0);for(let s=0;s<i.length;s++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[s]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const o={};o[z0]="t",o[ta]=e,o[oa]=t,this.myDisconnFrame.src=this.urlFn(o),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=ve(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class ts{constructor(e,t,o,i){this.onDisconnect=o,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=y0(),window[R0+this.uniqueCallbackIdentifier]=e,window[O0+this.uniqueCallbackIdentifier]=t,this.myIFrame=ts.createIFrame_();let s="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(s='<script>document.domain="'+document.domain+'";<\/script>');const r="<html><body>"+s+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(r),this.myIFrame.doc.close()}catch(l){we("frame writing exception"),l.stack&&we(l.stack),we(l)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||we("No IE domain setting required")}catch(t){const o=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+o+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[ta]=this.myID,e[oa]=this.myPW,e[ia]=this.currentSerial;let t=this.urlFn(e),o="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+ra+o.length<=sa;){const r=this.pendingSegs.shift();o=o+"&"+L0+i+"="+r.seg+"&"+F0+i+"="+r.ts+"&"+H0+i+"="+r.d,i++}return t=t+o,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,o){this.pendingSegs.push({seg:e,ts:t,d:o}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const o=()=>{this.outstandingRequests.delete(t),this.newRequest_()},i=setTimeout(o,Math.floor(W0)),s=()=>{clearTimeout(i),o()};this.addTag(e,s)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const o=this.myIFrame.doc.createElement("script");o.type="text/javascript",o.async=!0,o.src=e,o.onload=o.onreadystatechange=function(){const i=o.readyState;(!i||i==="loaded"||i==="complete")&&(o.onload=o.onreadystatechange=null,o.parentNode&&o.parentNode.removeChild(o),t())},o.onerror=()=>{we("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(o)}catch(o){}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo extends aa{static getInstance(){return new vo}constructor(){super(["online"]),this.online_=!0,typeof window!="undefined"&&typeof window.addEventListener!="undefined"&&!Il()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return A(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function h2(n,e){return Jn(n.name,e.name)}function rs(n,e){return Jn(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ei;function u2(n){Ei=n}const ua=function(n){return typeof n=="number"?"number:"+jl(n):"string:"+n},ma=function(n){if(n.isLeafNode()){const e=n.val();A(typeof e=="string"||typeof e=="number"||typeof e=="object"&&cn(e,".sv"),"Priority must be a string or number.")}else A(n===Ei||n.isEmpty(),"priority of unexpected type.");A(n===Ei||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let pa,fa;function m2(n){pa=n}function p2(n){fa=n}class f2 extends Ro{compare(e,t){const o=e.node.getPriority(),i=t.node.getPriority(),s=o.compareTo(i);return s===0?Jn(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return z.MIN}maxPost(){return new z(In,new ge("[PRIORITY-POST]",fa))}makePost(e,t){const o=pa(e);return new z(t,new ge("[PRIORITY-POST]",o))}toString(){return".priority"}}const se=new f2;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const y2=Math.log(2);class b2{constructor(e){const t=s=>parseInt(Math.log(s)/y2,10),o=s=>parseInt(Array(s+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=o(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Po=function(n,e,t,o){n.sort(e);const i=function(a,d){const m=d-a;let h,f;if(m===0)return null;if(m===1)return h=n[a],f=t?t(h):h,new Ae(f,h.node,Ae.BLACK,null,null);{const b=parseInt(m/2,10)+a,g=i(a,b),B=i(b+1,d);return h=n[b],f=t?t(h):h,new Ae(f,h.node,Ae.BLACK,g,B)}},s=function(a){let d=null,m=null,h=n.length;const f=function(g,B){const D=h-g,U=h;h-=g;const G=i(D+1,U),N=n[D],V=t?t(N):N;b(new Ae(V,N.node,B,null,G))},b=function(g){d?(d.left=g,d=g):(m=g,d=g)};for(let g=0;g<a.count;++g){const B=a.nextBitIsOne(),D=Math.pow(2,a.count-(g+1));B?f(D,Ae.BLACK):(f(D,Ae.BLACK),f(D,Ae.RED))}return m},r=new b2(n.length),l=s(r);return new Re(o||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A2=!0;function _e(n,e=null){if(n===null)return M.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),A(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new ge(t,_e(e))}if(!(n instanceof Array)&&A2){const t=[];let o=!1;if(Se(n,(r,l)=>{if(r.substring(0,1)!=="."){const a=_e(l);a.isEmpty()||(o=o||!a.getPriority().isEmpty(),t.push(new z(r,a)))}}),t.length===0)return M.EMPTY_NODE;const s=Po(t,h2,r=>r.name,rs);if(o){const r=Po(t,se.getCompare());return new M(s,_e(e),new hn({".priority":r},{".priority":se}))}else return new M(s,_e(e),hn.Default)}else{let t=M.EMPTY_NODE;return Se(n,(o,i)=>{if(cn(n,o)&&o.substring(0,1)!=="."){const s=_e(i);(s.isLeafNode()||!s.isEmpty())&&(t=t.updateImmediateChild(o,s))}}),t.updatePriority(_e(e))}}m2(_e);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ls extends Ro{constructor(e){super(),this.indexPath_=e,A(!H(e)&&F(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const o=this.extractChild(e.node),i=this.extractChild(t.node),s=o.compareTo(i);return s===0?Jn(e.name,t.name):s}makePost(e,t){const o=_e(e),i=M.EMPTY_NODE.updateChild(this.indexPath_,o);return new z(t,i)}maxPost(){const e=M.EMPTY_NODE.updateChild(this.indexPath_,$t);return new z(In,e)}toString(){return zt(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _2 extends Ro{compare(e,t){const o=e.node.compareTo(t.node);return o===0?Jn(e.name,t.name):o}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return z.MIN}maxPost(){return z.MAX}makePost(e,t){const o=_e(e);return new z(t,o)}toString(){return".value"}}const ya=new _2;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ba(n){return{type:"value",snapshotNode:n}}function at(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function Vt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Wt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function v2(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class as{constructor(e){this.index_=e}updateChild(e,t,o,i,s,r){A(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(t);return l.getChild(i).equals(o.getChild(i))&&l.isEmpty()===o.isEmpty()||(r!=null&&(o.isEmpty()?e.hasChild(t)?r.trackChildChange(Vt(t,l)):A(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?r.trackChildChange(at(t,o)):r.trackChildChange(Wt(t,o,l))),e.isLeafNode()&&o.isEmpty())?e:e.updateImmediateChild(t,o).withIndex(this.index_)}updateFullNode(e,t,o){return o!=null&&(e.isLeafNode()||e.forEachChild(se,(i,s)=>{t.hasChild(i)||o.trackChildChange(Vt(i,s))}),t.isLeafNode()||t.forEachChild(se,(i,s)=>{if(e.hasChild(i)){const r=e.getImmediateChild(i);r.equals(s)||o.trackChildChange(Wt(i,s,r))}else o.trackChildChange(at(i,s))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?M.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cs{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=se}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return A(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return A(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:Gn}hasEnd(){return this.endSet_}getIndexEndValue(){return A(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return A(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:In}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return A(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===se}copy(){const e=new cs;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function C2(n){return n.loadsAllData()?new as(n.getIndex()):n.hasLimit()?new P2(n):new jt(n)}function U2(n,e){const t=n.copy();return t.index_=e,t}function Ir(n){const e={};if(n.isDefault())return e;let t;if(n.index_===se?t="$priority":n.index_===ya?t="$value":n.index_===jn?t="$key":(A(n.index_ instanceof ls,"Unrecognized index type!"),t=n.index_.toString()),e.orderBy=ve(t),n.startSet_){const o=n.startAfterSet_?"startAfter":"startAt";e[o]=ve(n.indexStartValue_),n.startNameSet_&&(e[o]+=","+ve(n.indexStartName_))}if(n.endSet_){const o=n.endBeforeSet_?"endBefore":"endAt";e[o]=ve(n.indexEndValue_),n.endNameSet_&&(e[o]+=","+ve(n.indexEndName_))}return n.limitSet_&&(n.isViewFromLeft()?e.limitToFirst=n.limit_:e.limitToLast=n.limit_),e}function kr(n){const e={};if(n.startSet_&&(e.sp=n.indexStartValue_,n.startNameSet_&&(e.sn=n.indexStartName_),e.sin=!n.startAfterSet_),n.endSet_&&(e.ep=n.indexEndValue_,n.endNameSet_&&(e.en=n.indexEndName_),e.ein=!n.endBeforeSet_),n.limitSet_){e.l=n.limit_;let t=n.viewFrom_;t===""&&(n.isViewFromLeft()?t="l":t="r"),e.vf=t}return n.index_!==se&&(e.i=n.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Co extends la{reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return t!==void 0?"tag$"+t:(A(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}constructor(e,t,o,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=o,this.appCheckTokenProvider_=i,this.log_=Jt("p:rest:"),this.listens_={}}listen(e,t,o,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=Co.getListenId_(e,o),l={};this.listens_[r]=l;const a=Ir(e._queryParams);this.restRequest_(s+".json",a,(d,m)=>{let h=m;if(d===404&&(h=null,d=null),d===null&&this.onDataUpdate_(s,h,!1,o),lt(this.listens_,r)===l){let f;d?d===401?f="permission_denied":f="rest_error:"+d:f="ok",i(f,null)}})}unlisten(e,t){const o=Co.getListenId_(e,t);delete this.listens_[o]}get(e){const t=Ir(e._queryParams),o=e._path.toString(),i=new Xt;return this.restRequest_(o+".json",t,(s,r)=>{let l=r;s===404&&(l=null,s=null),s===null?(this.onDataUpdate_(o,l,!1,null),i.resolve(l)):i.reject(new Error(l))}),i.promise}refreshAuthToken(e){}restRequest_(e,t={},o){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+qd(t);this.log_("Sending REST request for "+r);const l=new XMLHttpRequest;l.onreadystatechange=()=>{if(o&&l.readyState===4){this.log_("REST Response for "+r+" received. status:",l.status,"response:",l.responseText);let a=null;if(l.status>=200&&l.status<300){try{a=xt(l.responseText)}catch(d){De("Failed to parse JSON response for "+r+": "+l.responseText)}o(null,a)}else l.status!==401&&l.status!==404&&De("Got unsuccessful REST response for "+r+" Status: "+l.status),o(l.status);o=null}},l.open("GET",r,!0),l.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class E2{constructor(){this.rootNode_=M.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Uo(){return{value:null,children:new Map}}function ga(n,e,t){if(H(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const o=F(e);n.children.has(o)||n.children.set(o,Uo());const i=n.children.get(o);e=oe(e),ga(i,e,t)}}function Bi(n,e,t){n.value!==null?t(e,n.value):B2(n,(o,i)=>{const s=new q(e.toString()+"/"+o);Bi(i,s,t)})}function B2(n,e){n.children.forEach((t,o)=>{e(o,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class w2{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t={...e};return this.last_&&Se(this.last_,(o,i)=>{t[o]=t[o]-i}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dr=10*1e3,S2=30*1e3,I2=5*60*1e3;class k2{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new w2(e);const o=Dr+(S2-Dr)*Math.random();Dt(this.reportStats_.bind(this),Math.floor(o))}reportStats_(){const e=this.statsListener_.get(),t={};let o=!1;Se(e,(i,s)=>{s>0&&cn(this.statsToReport_,i)&&(t[i]=s,o=!0)}),o&&this.server_.reportStats(t),Dt(this.reportStats_.bind(this),Math.floor(Math.random()*2*I2))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var tn;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(tn||(tn={}));function ds(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function hs(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function us(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eo{constructor(e,t,o){this.path=e,this.affectedTree=t,this.revert=o,this.type=tn.ACK_USER_WRITE,this.source=ds()}operationForChild(e){if(H(this.path)){if(this.affectedTree.value!=null)return A(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new q(e));return new Eo(Q(),t,this.revert)}}else return A(F(this.path)===e,"operationForChild called for unrelated child."),new Eo(oe(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class D2{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function T2(n,e,t,o){const i=[],s=[];return e.forEach(r=>{r.type==="child_changed"&&n.index_.indexedValueChanged(r.oldSnap,r.snapshotNode)&&s.push(v2(r.childName,r.snapshotNode))}),Bt(n,i,"child_removed",e,o,t),Bt(n,i,"child_added",e,o,t),Bt(n,i,"child_moved",s,o,t),Bt(n,i,"child_changed",e,o,t),Bt(n,i,"value",e,o,t),i}function Bt(n,e,t,o,i,s){const r=o.filter(l=>l.type===t);r.sort((l,a)=>M2(n,l,a)),r.forEach(l=>{const a=N2(n,l,s);i.forEach(d=>{d.respondsTo(l.type)&&e.push(d.createEvent(a,n.query_))})})}function N2(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function M2(n,e,t){if(e.childName==null||t.childName==null)throw pt("Should only compare child_ events.");const o=new z(e.childName,e.snapshotNode),i=new z(t.childName,t.snapshotNode);return n.index_.compare(o,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on{constructor(e){this.writeTree_=e}static empty(){return new on(new ne(null))}}function Nt(n,e,t){if(H(e))return new on(new ne(t));{const o=n.writeTree_.findRootMostValueAndPath(e);if(o!=null){const i=o.path;let s=o.value;const r=Me(i,e);return s=s.updateChild(r,t),new on(n.writeTree_.set(i,s))}else{const i=new ne(t),s=n.writeTree_.setTree(e,i);return new on(s)}}}function Si(n,e,t){let o=n;return Se(t,(i,s)=>{o=Nt(o,ae(e,i),s)}),o}function Tr(n,e){if(H(e))return on.empty();{const t=n.writeTree_.setTree(e,new ne(null));return new on(t)}}function Ii(n,e){return $n(n,e)!=null}function $n(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(Me(t.path,e)):null}function Nr(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(se,(o,i)=>{e.push(new z(o,i))}):n.writeTree_.children.inorderTraversal((o,i)=>{i.value!=null&&e.push(new z(o,i.value))}),e}function Sn(n,e){if(H(e))return n;{const t=$n(n,e);return t!=null?new on(new ne(t)):new on(n.writeTree_.subtree(e))}}function ki(n){return n.writeTree_.isEmpty()}function dt(n,e){return _a(Q(),n.writeTree_,e)}function _a(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let o=null;return e.children.inorderTraversal((i,s)=>{i===".priority"?(A(s.value!==null,"Priority writes must always be leaf nodes"),o=s.value):t=_a(ae(n,i),s,t)}),!t.getChild(n).isEmpty()&&o!==null&&(t=t.updateChild(ae(n,".priority"),o)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ms(n,e){return Ua(e,n)}function O2(n,e,t,o,i){A(o>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:o,visible:i}),i&&(n.visibleWrites=Nt(n.visibleWrites,e,t)),n.lastWriteId=o}function x2(n,e,t,o){A(o>n.lastWriteId,"Stacking an older merge on top of newer ones"),n.allWrites.push({path:e,children:t,writeId:o,visible:!0}),n.visibleWrites=Si(n.visibleWrites,e,t),n.lastWriteId=o}function L2(n,e){for(let t=0;t<n.allWrites.length;t++){const o=n.allWrites[t];if(o.writeId===e)return o}return null}function F2(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);A(t>=0,"removeWrite called with nonexistent writeId.");const o=n.allWrites[t];n.allWrites.splice(t,1);let i=o.visible,s=!1,r=n.allWrites.length-1;for(;i&&r>=0;){const l=n.allWrites[r];l.visible&&(r>=t&&H2(l,o.path)?i=!1:Xe(o.path,l.path)&&(s=!0)),r--}if(i){if(s)return z2(n),!0;if(o.snap)n.visibleWrites=Tr(n.visibleWrites,o.path);else{const l=o.children;Se(l,a=>{n.visibleWrites=Tr(n.visibleWrites,ae(o.path,a))})}return!0}else return!1}function H2(n,e){if(n.snap)return Xe(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&Xe(ae(n.path,t),e))return!0;return!1}function z2(n){n.visibleWrites=va(n.allWrites,V2,Q()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function V2(n){return n.visible}function va(n,e,t){let o=on.empty();for(let i=0;i<n.length;++i){const s=n[i];if(e(s)){const r=s.path;let l;if(s.snap)Xe(t,r)?(l=Me(t,r),o=Nt(o,l,s.snap)):Xe(r,t)&&(l=Me(r,t),o=Nt(o,Q(),s.snap.getChild(l)));else if(s.children){if(Xe(t,r))l=Me(t,r),o=Si(o,l,s.children);else if(Xe(r,t))if(l=Me(r,t),H(l))o=Si(o,Q(),s.children);else{const a=lt(s.children,F(l));if(a){const d=a.getChild(oe(l));o=Nt(o,Q(),d)}}}else throw pt("WriteRecord should have .snap or .children")}}return o}function Pa(n,e,t,o,i){if(!o&&!i){const s=$n(n.visibleWrites,e);if(s!=null)return s;{const r=Sn(n.visibleWrites,e);if(ki(r))return t;if(t==null&&!Ii(r,Q()))return null;{const l=t||M.EMPTY_NODE;return dt(r,l)}}}else{const s=Sn(n.visibleWrites,e);if(!i&&ki(s))return t;if(!i&&t==null&&!Ii(s,Q()))return null;{const r=function(d){return(d.visible||i)&&(!o||!~o.indexOf(d.writeId))&&(Xe(d.path,e)||Xe(e,d.path))},l=va(n.allWrites,r,e),a=t||M.EMPTY_NODE;return dt(l,a)}}}function W2(n,e,t){let o=M.EMPTY_NODE;const i=$n(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(se,(s,r)=>{o=o.updateImmediateChild(s,r)}),o;if(t){const s=Sn(n.visibleWrites,e);return t.forEachChild(se,(r,l)=>{const a=dt(Sn(s,new q(r)),l);o=o.updateImmediateChild(r,a)}),Nr(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}else{const s=Sn(n.visibleWrites,e);return Nr(s).forEach(r=>{o=o.updateImmediateChild(r.name,r.node)}),o}}function j2(n,e,t,o,i){A(o||i,"Either existingEventSnap or existingServerSnap must exist");const s=ae(e,t);if(Ii(n.visibleWrites,s))return null;{const r=Sn(n.visibleWrites,s);return ki(r)?i.getChild(t):dt(r,i.getChild(t))}}function G2(n,e,t,o){const i=ae(e,t),s=$n(n.visibleWrites,i);if(s!=null)return s;if(o.isCompleteForChild(t)){const r=Sn(n.visibleWrites,i);return dt(r,o.getNode().getImmediateChild(t))}else return null}function K2(n,e){return $n(n.visibleWrites,e)}function Q2(n,e,t,o,i,s,r){let l;const a=Sn(n.visibleWrites,e),d=$n(a,Q());if(d!=null)l=d;else if(t!=null)l=dt(a,t);else return[];if(l=l.withIndex(r),!l.isEmpty()&&!l.isLeafNode()){const m=[],h=r.getCompare(),f=s?l.getReverseIteratorFrom(o,r):l.getIteratorFrom(o,r);let b=f.getNext();for(;b&&m.length<i;)h(b,o)!==0&&m.push(b),b=f.getNext();return m}else return[]}function X2(){return{visibleWrites:on.empty(),allWrites:[],lastWriteId:-1}}function Bo(n,e,t,o){return Pa(n.writeTree,n.treePath,e,t,o)}function ps(n,e){return W2(n.writeTree,n.treePath,e)}function Mr(n,e,t,o){return j2(n.writeTree,n.treePath,e,t,o)}function wo(n,e){return K2(n.writeTree,ae(n.treePath,e))}function Y2(n,e,t,o,i,s){return Q2(n.writeTree,n.treePath,e,t,o,i,s)}function fs(n,e,t){return G2(n.writeTree,n.treePath,e,t)}function Ca(n,e){return Ua(ae(n.treePath,e),n.writeTree)}function Ua(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class q2{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,o=e.childName;A(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),A(o!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(o);if(i){const s=i.type;if(t==="child_added"&&s==="child_removed")this.changeMap.set(o,Wt(o,e.snapshotNode,i.snapshotNode));else if(t==="child_removed"&&s==="child_added")this.changeMap.delete(o);else if(t==="child_removed"&&s==="child_changed")this.changeMap.set(o,Vt(o,i.oldSnap));else if(t==="child_changed"&&s==="child_added")this.changeMap.set(o,at(o,e.snapshotNode));else if(t==="child_changed"&&s==="child_changed")this.changeMap.set(o,Wt(o,e.snapshotNode,i.oldSnap));else throw pt("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(o,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class J2{getCompleteChild(e){return null}getChildAfterChild(e,t,o){return null}}const Ea=new J2;class ys{constructor(e,t,o=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=o}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const o=this.optCompleteServerCache_!=null?new Qn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return fs(this.writes_,e,o)}}getChildAfterChild(e,t,o){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Xn(this.viewCache_),s=Y2(this.writes_,i,t,1,o,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $2(n){return{filter:n}}function Z2(n,e){A(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),A(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function eh(n,e,t,o,i){const s=new q2;let r,l;if(t.type===tn.OVERWRITE){const d=t;d.source.fromUser?r=Di(n,e,d.path,d.snap,o,i,s):(A(d.source.fromServer,"Unknown source."),l=d.source.tagged||e.serverCache.isFiltered()&&!H(d.path),r=So(n,e,d.path,d.snap,o,i,l,s))}else if(t.type===tn.MERGE){const d=t;d.source.fromUser?r=th(n,e,d.path,d.children,o,i,s):(A(d.source.fromServer,"Unknown source."),l=d.source.tagged||e.serverCache.isFiltered(),r=Ti(n,e,d.path,d.children,o,i,l,s))}else if(t.type===tn.ACK_USER_WRITE){const d=t;d.revert?r=sh(n,e,d.path,o,i,s):r=oh(n,e,d.path,d.affectedTree,o,i,s)}else if(t.type===tn.LISTEN_COMPLETE)r=ih(n,e,t.path,o,s);else throw pt("Unknown operation type: "+t.type);const a=s.getChanges();return nh(e,r,a),{viewCache:r,changes:a}}function nh(n,e,t){const o=e.eventCache;if(o.isFullyInitialized()){const i=o.getNode().isLeafNode()||o.getNode().isEmpty(),s=wi(n);(t.length>0||!n.eventCache.isFullyInitialized()||i&&!o.getNode().equals(s)||!o.getNode().getPriority().equals(s.getPriority()))&&t.push(ba(wi(e)))}}function Ba(n,e,t,o,i,s){const r=e.eventCache;if(wo(o,t)!=null)return e;{let l,a;if(H(t))if(A(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const d=Xn(e),m=d instanceof M?d:M.EMPTY_NODE,h=ps(o,m);l=n.filter.updateFullNode(e.eventCache.getNode(),h,s)}else{const d=Bo(o,Xn(e));l=n.filter.updateFullNode(e.eventCache.getNode(),d,s)}else{const d=F(t);if(d===".priority"){A(kn(t)===1,"Can't have a priority with additional path components");const m=r.getNode();a=e.serverCache.getNode();const h=Mr(o,t,m,a);h!=null?l=n.filter.updatePriority(m,h):l=r.getNode()}else{const m=oe(t);let h;if(r.isCompleteForChild(d)){a=e.serverCache.getNode();const f=Mr(o,t,r.getNode(),a);f!=null?h=r.getNode().getImmediateChild(d).updateChild(m,f):h=r.getNode().getImmediateChild(d)}else h=fs(o,d,e.serverCache);h!=null?l=n.filter.updateChild(r.getNode(),d,h,m,i,s):l=r.getNode()}}return Tt(e,l,r.isFullyInitialized()||H(t),n.filter.filtersNodes())}}function So(n,e,t,o,i,s,r,l){const a=e.serverCache;let d;const m=r?n.filter:n.filter.getIndexedFilter();if(H(t))d=m.updateFullNode(a.getNode(),o,null);else if(m.filtersNodes()&&!a.isFiltered()){const b=a.getNode().updateChild(t,o);d=m.updateFullNode(a.getNode(),b,null)}else{const b=F(t);if(!a.isCompleteForPath(t)&&kn(t)>1)return e;const g=oe(t),D=a.getNode().getImmediateChild(b).updateChild(g,o);b===".priority"?d=m.updatePriority(a.getNode(),D):d=m.updateChild(a.getNode(),b,D,g,Ea,null)}const h=Aa(e,d,a.isFullyInitialized()||H(t),m.filtersNodes()),f=new ys(i,h,s);return Ba(n,h,t,i,f,l)}function Di(n,e,t,o,i,s,r){const l=e.eventCache;let a,d;const m=new ys(i,e,s);if(H(t))d=n.filter.updateFullNode(e.eventCache.getNode(),o,r),a=Tt(e,d,!0,n.filter.filtersNodes());else{const h=F(t);if(h===".priority")d=n.filter.updatePriority(e.eventCache.getNode(),o),a=Tt(e,d,l.isFullyInitialized(),l.isFiltered());else{const f=oe(t),b=l.getNode().getImmediateChild(h);let g;if(H(f))g=o;else{const B=m.getCompleteChild(h);B!=null?os(f)===".priority"&&B.getChild(ca(f)).isEmpty()?g=B:g=B.updateChild(f,o):g=M.EMPTY_NODE}if(b.equals(g))a=e;else{const B=n.filter.updateChild(l.getNode(),h,g,f,m,r);a=Tt(e,B,l.isFullyInitialized(),n.filter.filtersNodes())}}}return a}function Rr(n,e){return n.eventCache.isCompleteForChild(e)}function th(n,e,t,o,i,s,r){let l=e;return o.foreach((a,d)=>{const m=ae(t,a);Rr(e,F(m))&&(l=Di(n,l,m,d,i,s,r))}),o.foreach((a,d)=>{const m=ae(t,a);Rr(e,F(m))||(l=Di(n,l,m,d,i,s,r))}),l}function Or(n,e,t){return t.foreach((o,i)=>{e=e.updateChild(o,i)}),e}function Ti(n,e,t,o,i,s,r,l){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let a=e,d;H(t)?d=o:d=new ne(null).setTree(t,o);const m=e.serverCache.getNode();return d.children.inorderTraversal((h,f)=>{if(m.hasChild(h)){const b=e.serverCache.getNode().getImmediateChild(h),g=Or(n,b,f);a=So(n,a,new q(h),g,i,s,r,l)}}),d.children.inorderTraversal((h,f)=>{const b=!e.serverCache.isCompleteForChild(h)&&f.value===null;if(!m.hasChild(h)&&!b){const g=e.serverCache.getNode().getImmediateChild(h),B=Or(n,g,f);a=So(n,a,new q(h),B,i,s,r,l)}}),a}function oh(n,e,t,o,i,s,r){if(wo(i,t)!=null)return e;const l=e.serverCache.isFiltered(),a=e.serverCache;if(o.value!=null){if(H(t)&&a.isFullyInitialized()||a.isCompleteForPath(t))return So(n,e,t,a.getNode().getChild(t),i,s,l,r);if(H(t)){let d=new ne(null);return a.getNode().forEachChild(jn,(m,h)=>{d=d.set(new q(m),h)}),Ti(n,e,t,d,i,s,l,r)}else return e}else{let d=new ne(null);return o.foreach((m,h)=>{const f=ae(t,m);a.isCompleteForPath(f)&&(d=d.set(m,a.getNode().getChild(f)))}),Ti(n,e,t,d,i,s,l,r)}}function ih(n,e,t,o,i){const s=e.serverCache,r=Aa(e,s.getNode(),s.isFullyInitialized()||H(t),s.isFiltered());return Ba(n,r,t,o,Ea,i)}function sh(n,e,t,o,i,s){let r;if(wo(o,t)!=null)return e;{const l=new ys(o,e,i),a=e.eventCache.getNode();let d;if(H(t)||F(t)===".priority"){let m;if(e.serverCache.isFullyInitialized())m=Bo(o,Xn(e));else{const h=e.serverCache.getNode();A(h instanceof M,"serverChildren would be complete if leaf node"),m=ps(o,h)}m=m,d=n.filter.updateFullNode(a,m,s)}else{const m=F(t);let h=fs(o,m,e.serverCache);h==null&&e.serverCache.isCompleteForChild(m)&&(h=a.getImmediateChild(m)),h!=null?d=n.filter.updateChild(a,m,h,oe(t),l,s):e.eventCache.getNode().hasChild(m)?d=n.filter.updateChild(a,m,M.EMPTY_NODE,oe(t),l,s):d=a,d.isEmpty()&&e.serverCache.isFullyInitialized()&&(r=Bo(o,Xn(e)),r.isLeafNode()&&(d=n.filter.updateFullNode(d,r,s)))}return r=e.serverCache.isFullyInitialized()||wo(o,Q())!=null,Tt(e,d,r,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rh{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const o=this.query_._queryParams,i=new as(o.getIndex()),s=C2(o);this.processor_=$2(s);const r=t.serverCache,l=t.eventCache,a=i.updateFullNode(M.EMPTY_NODE,r.getNode(),null),d=s.updateFullNode(M.EMPTY_NODE,l.getNode(),null),m=new Qn(a,r.isFullyInitialized(),i.filtersNodes()),h=new Qn(d,l.isFullyInitialized(),s.filtersNodes());this.viewCache_=Oo(h,m),this.eventGenerator_=new D2(this.query_)}get query(){return this.query_}}function lh(n){return n.viewCache_.serverCache.getNode()}function ah(n,e){const t=Xn(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!H(e)&&!t.getImmediateChild(F(e)).isEmpty())?t.getChild(e):null}function xr(n){return n.eventRegistrations_.length===0}function ch(n,e){n.eventRegistrations_.push(e)}function Lr(n,e,t){const o=[];if(t){A(e==null,"A cancel should cancel all event registrations.");const i=n.query._path;n.eventRegistrations_.forEach(s=>{const r=s.createCancelEvent(t,i);r&&o.push(r)})}if(e){let i=[];for(let s=0;s<n.eventRegistrations_.length;++s){const r=n.eventRegistrations_[s];if(!r.matches(e))i.push(r);else if(e.hasAnyCallback()){i=i.concat(n.eventRegistrations_.slice(s+1));break}}n.eventRegistrations_=i}else n.eventRegistrations_=[];return o}function Fr(n,e,t,o){e.type===tn.MERGE&&e.source.queryId!==null&&(A(Xn(n.viewCache_),"We should always have a full cache before handling merges"),A(wi(n.viewCache_),"Missing event cache, even though we have a server cache"));const i=n.viewCache_,s=eh(n.processor_,i,e,t,o);return Z2(n.processor_,s.viewCache),A(s.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=s.viewCache,wa(n,s.changes,s.viewCache.eventCache.getNode(),null)}function dh(n,e){const t=n.viewCache_.eventCache,o=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(se,(s,r)=>{o.push(at(s,r))}),t.isFullyInitialized()&&o.push(ba(t.getNode())),wa(n,o,t.getNode(),e)}function wa(n,e,t,o){const i=o?[o]:n.eventRegistrations_;return T2(n.eventGenerator_,e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Io;class hh{constructor(){this.views=new Map}}function uh(n){A(!Io,"__referenceConstructor has already been defined"),Io=n}function mh(){return A(Io,"Reference.ts has not been loaded"),Io}function ph(n){return n.views.size===0}function bs(n,e,t,o){const i=e.source.queryId;if(i!==null){const s=n.views.get(i);return A(s!=null,"SyncTree gave us an op for an invalid query."),Fr(s,e,t,o)}else{let s=[];for(const r of n.views.values())s=s.concat(Fr(r,e,t,o));return s}}function fh(n,e,t,o,i){const s=e._queryIdentifier,r=n.views.get(s);if(!r){let l=Bo(t,i?o:null),a=!1;l?a=!0:o instanceof M?(l=ps(t,o),a=!1):(l=M.EMPTY_NODE,a=!1);const d=Oo(new Qn(l,a,!1),new Qn(o,i,!1));return new rh(e,d)}return r}function yh(n,e,t,o,i,s){const r=fh(n,e,o,i,s);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,r),ch(r,t),dh(r,t)}function bh(n,e,t,o){const i=e._queryIdentifier,s=[];let r=[];const l=Dn(n);if(i==="default")for(const[a,d]of n.views.entries())r=r.concat(Lr(d,t,o)),xr(d)&&(n.views.delete(a),d.query._queryParams.loadsAllData()||s.push(d.query));else{const a=n.views.get(i);a&&(r=r.concat(Lr(a,t,o)),xr(a)&&(n.views.delete(i),a.query._queryParams.loadsAllData()||s.push(a.query)))}return l&&!Dn(n)&&s.push(new(mh())(e._repo,e._path)),{removed:s,events:r}}function Sa(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function rt(n,e){let t=null;for(const o of n.views.values())t=t||ah(o,e);return t}function Ia(n,e){if(e._queryParams.loadsAllData())return xo(n);{const o=e._queryIdentifier;return n.views.get(o)}}function ka(n,e){return Ia(n,e)!=null}function Dn(n){return xo(n)!=null}function xo(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ko;function gh(n){A(!ko,"__referenceConstructor has already been defined"),ko=n}function Ah(){return A(ko,"Reference.ts has not been loaded"),ko}let _h=1;class Hr{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ne(null),this.pendingWriteTree_=X2(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Da(n,e,t,o,i){return O2(n.pendingWriteTree_,e,t,o,i),i?yt(n,new Kn(ds(),e,t)):[]}function vh(n,e,t,o){x2(n.pendingWriteTree_,e,t,o);const i=ne.fromObject(t);return yt(n,new ct(ds(),e,i))}function En(n,e,t=!1){const o=L2(n.pendingWriteTree_,e);if(F2(n.pendingWriteTree_,e)){let s=new ne(null);return o.snap!=null?s=s.set(Q(),!0):Se(o.children,r=>{s=s.set(new q(r),!0)}),yt(n,new Eo(o.path,s,t))}else return[]}function Lo(n,e,t){return yt(n,new Kn(hs(),e,t))}function Ph(n,e,t){const o=ne.fromObject(t);return yt(n,new ct(hs(),e,o))}function Ch(n,e){return yt(n,new Gt(hs(),e))}function Uh(n,e,t){const o=As(n,t);if(o){const i=_s(o),s=i.path,r=i.queryId,l=Me(s,e),a=new Gt(us(r),l);return vs(n,s,a)}else return[]}function Ni(n,e,t,o,i=!1){const s=e._path,r=n.syncPointTree_.get(s);let l=[];if(r&&(e._queryIdentifier==="default"||ka(r,e))){const a=bh(r,e,t,o);ph(r)&&(n.syncPointTree_=n.syncPointTree_.remove(s));const d=a.removed;if(l=a.events,!i){const m=d.findIndex(f=>f._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(s,(f,b)=>Dn(b));if(m&&!h){const f=n.syncPointTree_.subtree(s);if(!f.isEmpty()){const b=wh(f);for(let g=0;g<b.length;++g){const B=b[g],D=B.query,U=Ma(n,B);n.listenProvider_.startListening(Mt(D),Do(n,D),U.hashFn,U.onComplete)}}}!h&&d.length>0&&!o&&(m?n.listenProvider_.stopListening(Mt(e),null):d.forEach(f=>{const b=n.queryToTagMap.get(Fo(f));n.listenProvider_.stopListening(Mt(f),b)}))}Sh(n,d)}return l}function Eh(n,e,t,o){const i=As(n,o);if(i!=null){const s=_s(i),r=s.path,l=s.queryId,a=Me(r,e),d=new Kn(us(l),a,t);return vs(n,r,d)}else return[]}function Bh(n,e,t,o){const i=As(n,o);if(i){const s=_s(i),r=s.path,l=s.queryId,a=Me(r,e),d=ne.fromObject(t),m=new ct(us(l),a,d);return vs(n,r,m)}else return[]}function zr(n,e,t,o=!1){const i=e._path;let s=null,r=!1;n.syncPointTree_.foreachOnPath(i,(f,b)=>{const g=Me(f,i);s=s||rt(b,g),r=r||Dn(b)});let l=n.syncPointTree_.get(i);l?(r=r||Dn(l),s=s||rt(l,Q())):(l=new hh,n.syncPointTree_=n.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=M.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((b,g)=>{const B=rt(g,Q());B&&(s=s.updateImmediateChild(b,B))}));const d=ka(l,e);if(!d&&!e._queryParams.loadsAllData()){const f=Fo(e);A(!n.queryToTagMap.has(f),"View does not exist, but we have a tag");const b=Ih();n.queryToTagMap.set(f,b),n.tagToQueryMap.set(b,f)}const m=ms(n.pendingWriteTree_,i);let h=yh(l,e,t,m,s,a);if(!d&&!r&&!o){const f=Ia(l,e);h=h.concat(kh(n,e,f))}return h}function gs(n,e,t){const i=n.pendingWriteTree_,s=n.syncPointTree_.findOnPath(e,(r,l)=>{const a=Me(r,e),d=rt(l,a);if(d)return d});return Pa(i,e,s,t,!0)}function yt(n,e){return Ta(e,n.syncPointTree_,null,ms(n.pendingWriteTree_,Q()))}function Ta(n,e,t,o){if(H(n.path))return Na(n,e,t,o);{const i=e.get(Q());t==null&&i!=null&&(t=rt(i,Q()));let s=[];const r=F(n.path),l=n.operationForChild(r),a=e.children.get(r);if(a&&l){const d=t?t.getImmediateChild(r):null,m=Ca(o,r);s=s.concat(Ta(l,a,d,m))}return i&&(s=s.concat(bs(i,n,o,t))),s}}function Na(n,e,t,o){const i=e.get(Q());t==null&&i!=null&&(t=rt(i,Q()));let s=[];return e.children.inorderTraversal((r,l)=>{const a=t?t.getImmediateChild(r):null,d=Ca(o,r),m=n.operationForChild(r);m&&(s=s.concat(Na(m,l,a,d)))}),i&&(s=s.concat(bs(i,n,o,t))),s}function Ma(n,e){const t=e.query,o=Do(n,t);return{hashFn:()=>(lh(e)||M.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return o?Uh(n,t._path,o):Ch(n,t._path);{const s=C0(i,t);return Ni(n,t,null,s)}}}}function Do(n,e){const t=Fo(e);return n.queryToTagMap.get(t)}function Fo(n){return n._path.toString()+"$"+n._queryIdentifier}function As(n,e){return n.tagToQueryMap.get(e)}function _s(n){const e=n.indexOf("$");return A(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new q(n.substr(0,e))}}function vs(n,e,t){const o=n.syncPointTree_.get(e);A(o,"Missing sync point for query tag that we're tracking");const i=ms(n.pendingWriteTree_,e);return bs(o,t,i,null)}function wh(n){return n.fold((e,t,o)=>{if(t&&Dn(t))return[xo(t)];{let i=[];return t&&(i=Sa(t)),Se(o,(s,r)=>{i=i.concat(r)}),i}})}function Mt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Ah())(n._repo,n._path):n}function Sh(n,e){for(let t=0;t<e.length;++t){const o=e[t];if(!o._queryParams.loadsAllData()){const i=Fo(o),s=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(s)}}}function Ih(){return _h++}function kh(n,e,t){const o=e._path,i=Do(n,e),s=Ma(n,t),r=n.listenProvider_.startListening(Mt(e),i,s.hashFn,s.onComplete),l=n.syncPointTree_.subtree(o);if(i)A(!Dn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((d,m,h)=>{if(!H(d)&&m&&Dn(m))return[xo(m).query];{let f=[];return m&&(f=f.concat(Sa(m).map(b=>b.query))),Se(h,(b,g)=>{f=f.concat(g)}),f}});for(let d=0;d<a.length;++d){const m=a[d];n.listenProvider_.stopListening(Mt(m),Do(n,m))}}return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ps{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Ps(t)}node(){return this.node_}}class Cs{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=ae(this.path_,e);return new Cs(this.syncTree_,t)}node(){return gs(this.syncTree_,this.path_)}}const Dh=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},Vr=function(n,e,t){if(!n||typeof n!="object")return n;if(A(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return Th(n[".sv"],e,t);if(typeof n[".sv"]=="object")return Nh(n[".sv"],e);A(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},Th=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:A(!1,"Unexpected server value: "+n)}},Nh=function(n,e,t){n.hasOwnProperty("increment")||A(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const o=n.increment;typeof o!="number"&&A(!1,"Unexpected increment value: "+o);const i=e.node();if(A(i!==null&&typeof i!="undefined","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return o;const r=i.getValue();return typeof r!="number"?o:r+o},Ra=function(n,e,t,o){return Us(e,new Cs(t,n),o)},Oa=function(n,e,t){return Us(n,new Ps(e),t)};function Us(n,e,t){const o=n.getPriority().val(),i=Vr(o,e.getImmediateChild(".priority"),t);let s;if(n.isLeafNode()){const r=n,l=Vr(r.getValue(),e,t);return l!==r.getValue()||i!==r.getPriority().val()?new ge(l,_e(i)):n}else{const r=n;return s=r,i!==r.getPriority().val()&&(s=s.updatePriority(new ge(i))),r.forEachChild(se,(l,a)=>{const d=Us(a,e.getImmediateChild(l),t);d!==a&&(s=s.updateImmediateChild(l,d))}),s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xh=/[\[\].#$\/\u0000-\u001F\u007F]/,Lh=/[\[\].#$\u0000-\u001F\u007F]/,di=10*1024*1024,ws=function(n){return typeof n=="string"&&n.length!==0&&!xh.test(n)},Ha=function(n){return typeof n=="string"&&n.length!==0&&!Lh.test(n)},Fh=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Ha(n)},Ri=function(n){return n===null||typeof n=="string"||typeof n=="number"&&!$i(n)||n&&typeof n=="object"&&cn(n,".sv")},za=function(n,e,t,o){o&&e===void 0||zo(No(n,"value"),e,t)},zo=function(n,e,t){const o=t instanceof q?new o2(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+zn(o));if(typeof e=="function")throw new Error(n+"contains a function "+zn(o)+" with contents = "+e.toString());if($i(e))throw new Error(n+"contains "+e.toString()+" "+zn(o));if(typeof e=="string"&&e.length>di/3&&Mo(e)>di)throw new Error(n+"contains a string greater than "+di+" utf8 bytes "+zn(o)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,s=!1;if(Se(e,(r,l)=>{if(r===".value")i=!0;else if(r!==".priority"&&r!==".sv"&&(s=!0,!ws(r)))throw new Error(n+" contains an invalid key ("+r+") "+zn(o)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);i2(o,r),zo(n,l,o),s2(o)}),i&&s)throw new Error(n+' contains ".value" child '+zn(o)+" in addition to actual children.")}},Hh=function(n,e){let t,o;for(t=0;t<e.length;t++){o=e[t];const s=zt(o);for(let r=0;r<s.length;r++)if(!(s[r]===".priority"&&r===s.length-1)){if(!ws(s[r]))throw new Error(n+"contains an invalid key ("+s[r]+") in path "+o.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(t2);let i=null;for(t=0;t<e.length;t++){if(o=e[t],i!==null&&Xe(i,o))throw new Error(n+"contains a path "+i.toString()+" that is ancestor of another path "+o.toString());i=o}},zh=function(n,e,t,o){const i=No(n,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const s=[];Se(e,(r,l)=>{const a=new q(r);if(zo(i,l,ae(t,a)),os(a)===".priority"&&!Ri(l))throw new Error(i+"contains an invalid value for '"+a.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");s.push(a)}),Hh(i,s)},Ss=function(n,e,t,o){if(!Ha(t))throw new Error(No(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Vh=function(n,e,t,o){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Ss(n,e,t)},Is=function(n,e){if(F(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},Wh=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!ws(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!Fh(t))throw new Error(No(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kh="repo_interrupt",Qh=25;class Xh{constructor(e,t,o,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=o,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new jh,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Uo(),this.transactionQueueTree_=new Es,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Yh(n,e,t){if(n.stats_=ns(n.repoInfo_),n.forceRestClient_||w0())n.server_=new Co(n.repoInfo_,(o,i,s,r)=>{Wr(n,o,i,s,r)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>jr(n,!0),0);else{if(typeof t!="undefined"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ve(t)}catch(o){throw new Error("Invalid authOverride provided: "+o)}}n.persistentConnection_=new un(n.repoInfo_,e,(o,i,s,r)=>{Wr(n,o,i,s,r)},o=>{jr(n,o)},o=>{qh(n,o)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(o=>{n.server_.refreshAuthToken(o)}),n.appCheckProvider_.addTokenChangeListener(o=>{n.server_.refreshAppCheckToken(o.token)}),n.statsReporter_=T0(n.repoInfo_,()=>new k2(n.stats_,n.server_)),n.infoData_=new E2,n.infoSyncTree_=new Hr({startListening:(o,i,s,r)=>{let l=[];const a=n.infoData_.getNode(o._path);return a.isEmpty()||(l=Lo(n.infoSyncTree_,o._path,a),setTimeout(()=>{r("ok")},0)),l},stopListening:()=>{}}),ks(n,"connected",!1),n.serverSyncTree_=new Hr({startListening:(o,i,s,r)=>(n.server_.listen(o,s,i,(l,a)=>{const d=r(l,a);sn(n.eventQueue_,o._path,d)}),[]),stopListening:(o,i)=>{n.server_.unlisten(o,i)}})}function ja(n){const t=n.infoData_.getNode(new q(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function Wo(n){return Dh({timestamp:ja(n)})}function Wr(n,e,t,o,i){n.dataUpdateCount++;const s=new q(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let r=[];if(i)if(o){const a=yo(t,d=>_e(d));r=Bh(n.serverSyncTree_,s,a,i)}else{const a=_e(t);r=Eh(n.serverSyncTree_,s,a,i)}else if(o){const a=yo(t,d=>_e(d));r=Ph(n.serverSyncTree_,s,a)}else{const a=_e(t);r=Lo(n.serverSyncTree_,s,a)}let l=s;r.length>0&&(l=ht(n,s)),sn(n.eventQueue_,l,r)}function jr(n,e){ks(n,"connected",e),e===!1&&Zh(n)}function qh(n,e){Se(e,(t,o)=>{ks(n,t,o)})}function ks(n,e,t){const o=new q("/.info/"+e),i=_e(t);n.infoData_.updateSnapshot(o,i);const s=Lo(n.infoSyncTree_,o,i);sn(n.eventQueue_,o,s)}function Ds(n){return n.nextWriteId_++}function Jh(n,e,t,o,i){jo(n,"set",{path:e.toString(),value:t,priority:o});const s=Wo(n),r=_e(t,o),l=gs(n.serverSyncTree_,e),a=Oa(r,l,s),d=Ds(n),m=Da(n.serverSyncTree_,e,a,d,!0);Vo(n.eventQueue_,m),n.server_.put(e.toString(),r.val(!0),(f,b)=>{const g=f==="ok";g||De("set at "+e+" failed: "+f);const B=En(n.serverSyncTree_,d,!g);sn(n.eventQueue_,e,B),xi(n,i,f,b)});const h=Ns(n,e);ht(n,h),sn(n.eventQueue_,h,[])}function $h(n,e,t,o){jo(n,"update",{path:e.toString(),value:t});let i=!0;const s=Wo(n),r={};if(Se(t,(l,a)=>{i=!1,r[l]=Ra(ae(e,l),_e(a),n.serverSyncTree_,s)}),i)we("update() called with empty data.  Don't do anything."),xi(n,o,"ok",void 0);else{const l=Ds(n),a=vh(n.serverSyncTree_,e,r,l);Vo(n.eventQueue_,a),n.server_.merge(e.toString(),t,(d,m)=>{const h=d==="ok";h||De("update at "+e+" failed: "+d);const f=En(n.serverSyncTree_,l,!h),b=f.length>0?ht(n,e):e;sn(n.eventQueue_,b,f),xi(n,o,d,m)}),Se(t,d=>{const m=Ns(n,ae(e,d));ht(n,m)}),sn(n.eventQueue_,e,[])}}function Zh(n){jo(n,"onDisconnectEvents");const e=Wo(n),t=Uo();Bi(n.onDisconnect_,Q(),(i,s)=>{const r=Ra(i,s,n.serverSyncTree_,e);ga(t,i,r)});let o=[];Bi(t,Q(),(i,s)=>{o=o.concat(Lo(n.serverSyncTree_,i,s));const r=Ns(n,i);ht(n,r)}),n.onDisconnect_=Uo(),sn(n.eventQueue_,Q(),o)}function eu(n,e,t){let o;F(e._path)===".info"?o=zr(n.infoSyncTree_,e,t):o=zr(n.serverSyncTree_,e,t),Va(n.eventQueue_,e._path,o)}function Oi(n,e,t){let o;F(e._path)===".info"?o=Ni(n.infoSyncTree_,e,t):o=Ni(n.serverSyncTree_,e,t),Va(n.eventQueue_,e._path,o)}function nu(n){n.persistentConnection_&&n.persistentConnection_.interrupt(Kh)}function jo(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),we(t,...e)}function xi(n,e,t,o){e&&ft(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let s=i;o&&(s+=": "+o);const r=new Error(s);r.code=i,e(r)}})}function Ga(n,e,t){return gs(n.serverSyncTree_,e,t)||M.EMPTY_NODE}function Ts(n,e=n.transactionQueueTree_){if(e||Go(n,e),bt(e)){const t=Qa(n,e);A(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&tu(n,Zt(e),t)}else La(e)&&Ho(e,t=>{Ts(n,t)})}function tu(n,e,t){const o=t.map(d=>d.currentWriteId),i=Ga(n,e,o);let s=i;const r=i.hash();for(let d=0;d<t.length;d++){const m=t[d];A(m.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),m.status=1,m.retryCount++;const h=Me(e,m.path);s=s.updateChild(h,m.currentOutputSnapshotRaw)}const l=s.val(!0),a=e;n.server_.put(a.toString(),l,d=>{jo(n,"transaction put response",{path:a.toString(),status:d});let m=[];if(d==="ok"){const h=[];for(let f=0;f<t.length;f++)t[f].status=2,m=m.concat(En(n.serverSyncTree_,t[f].currentWriteId)),t[f].onComplete&&h.push(()=>t[f].onComplete(null,!0,t[f].currentOutputSnapshotResolved)),t[f].unwatcher();Go(n,Bs(n.transactionQueueTree_,e)),Ts(n,n.transactionQueueTree_),sn(n.eventQueue_,e,m);for(let f=0;f<h.length;f++)ft(h[f])}else{if(d==="datastale")for(let h=0;h<t.length;h++)t[h].status===3?t[h].status=4:t[h].status=0;else{De("transaction at "+a.toString()+" failed: "+d);for(let h=0;h<t.length;h++)t[h].status=4,t[h].abortReason=d}ht(n,e)}},r)}function ht(n,e){const t=Ka(n,e),o=Zt(t),i=Qa(n,t);return ou(n,i,o),o}function ou(n,e,t){if(e.length===0)return;const o=[];let i=[];const r=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],d=Me(t,a.path);let m=!1,h;if(A(d!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)m=!0,h=a.abortReason,i=i.concat(En(n.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=Qh)m=!0,h="maxretry",i=i.concat(En(n.serverSyncTree_,a.currentWriteId,!0));else{const f=Ga(n,a.path,r);a.currentInputSnapshot=f;const b=e[l].update(f.val());if(b!==void 0){zo("transaction failed: Data returned ",b,a.path);let g=_e(b);typeof b=="object"&&b!=null&&cn(b,".priority")||(g=g.updatePriority(f.getPriority()));const D=a.currentWriteId,U=Wo(n),G=Oa(g,f,U);a.currentOutputSnapshotRaw=g,a.currentOutputSnapshotResolved=G,a.currentWriteId=Ds(n),r.splice(r.indexOf(D),1),i=i.concat(Da(n.serverSyncTree_,a.path,G,a.currentWriteId,a.applyLocally)),i=i.concat(En(n.serverSyncTree_,D,!0))}else m=!0,h="nodata",i=i.concat(En(n.serverSyncTree_,a.currentWriteId,!0))}sn(n.eventQueue_,t,i),i=[],m&&(e[l].status=2,function(f){setTimeout(f,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(h==="nodata"?o.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):o.push(()=>e[l].onComplete(new Error(h),!1,null))))}Go(n,n.transactionQueueTree_);for(let l=0;l<o.length;l++)ft(o[l]);Ts(n,n.transactionQueueTree_)}function Ka(n,e){let t,o=n.transactionQueueTree_;for(t=F(e);t!==null&&bt(o)===void 0;)o=Bs(o,t),e=oe(e),t=F(e);return o}function Qa(n,e){const t=[];return Xa(n,e,t),t.sort((o,i)=>o.order-i.order),t}function Xa(n,e,t){const o=bt(e);if(o)for(let i=0;i<o.length;i++)t.push(o[i]);Ho(e,i=>{Xa(n,i,t)})}function Go(n,e){const t=bt(e);if(t){let o=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[o]=t[i],o++);t.length=o,xa(e,t.length>0?t:void 0)}Ho(e,o=>{Go(n,o)})}function Ns(n,e){const t=Zt(Ka(n,e)),o=Bs(n.transactionQueueTree_,e);return Rh(o,i=>{hi(n,i)}),hi(n,o),Fa(o,i=>{hi(n,i)}),t}function hi(n,e){const t=bt(e);if(t){const o=[];let i=[],s=-1;for(let r=0;r<t.length;r++)t[r].status===3||(t[r].status===1?(A(s===r-1,"All SENT items should be at beginning of queue."),s=r,t[r].status=3,t[r].abortReason="set"):(A(t[r].status===0,"Unexpected transaction status in abort"),t[r].unwatcher(),i=i.concat(En(n.serverSyncTree_,t[r].currentWriteId,!0)),t[r].onComplete&&o.push(t[r].onComplete.bind(null,new Error("set"),!1,null))));s===-1?xa(e,void 0):t.length=s+1,sn(n.eventQueue_,Zt(e),i);for(let r=0;r<o.length;r++)ft(o[r])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kr="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",lu=function(){let n=0;const e=[];return function(t){const o=t===n;n=t;let i;const s=new Array(8);for(i=7;i>=0;i--)s[i]=Kr.charAt(t%64),t=Math.floor(t/64);A(t===0,"Cannot push at time == 0");let r=s.join("");if(o){for(i=11;i>=0&&e[i]===63;i--)e[i]=0;e[i]++}else for(i=0;i<12;i++)e[i]=Math.floor(Math.random()*64);for(i=0;i<12;i++)r+=Kr.charAt(e[i]);return A(r.length===20,"nextPushId: Length should be 20."),r}}();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class au{constructor(e,t,o,i){this.eventType=e,this.eventRegistration=t,this.snapshot=o,this.prevName=i}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+ve(this.snapshot.exportVal())}}class cu{constructor(e,t,o){this.eventRegistration=e,this.error=t,this.path=o}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ko{constructor(e,t,o,i){this._repo=e,this._path=t,this._queryParams=o,this._orderByCalled=i}get key(){return H(this._path)?null:os(this._path)}get ref(){return new Mn(this._repo,this._path)}get _queryIdentifier(){const e=kr(this._queryParams),t=Zi(e);return t==="{}"?"default":t}get _queryObject(){return kr(this._queryParams)}isEqual(e){if(e=qn(e),!(e instanceof Ko))return!1;const t=this._repo===e._repo,o=is(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&o&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+n2(this._path)}}function hu(n,e){if(n._orderByCalled===!0)throw new Error(e+": You can't combine multiple orderBy calls.")}function uu(n){let e=null,t=null;if(n.hasStart()&&(e=n.getIndexStartValue()),n.hasEnd()&&(t=n.getIndexEndValue()),n.getIndex()===jn){const o="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(n.hasStart()){if(n.getIndexStartName()!==Gn)throw new Error(o);if(typeof e!="string")throw new Error(i)}if(n.hasEnd()){if(n.getIndexEndName()!==In)throw new Error(o);if(typeof t!="string")throw new Error(i)}}else if(n.getIndex()===se){if(e!=null&&!Ri(e)||t!=null&&!Ri(t))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(A(n.getIndex()instanceof ls||n.getIndex()===ya,"unknown index type."),e!=null&&typeof e=="object"||t!=null&&typeof t=="object")throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}class Mn extends Ko{constructor(e,t){super(e,t,new cs,!1)}get parent(){const e=ca(this._path);return e===null?null:new Mn(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class To{constructor(e,t,o){this._node=e,this.ref=t,this._index=o}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new q(e),o=Kt(this.ref,e);return new To(this._node.getChild(t),o,se)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(o,i)=>e(new To(i,Kt(this.ref,o),se)))}hasChild(e){const t=new q(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ze(n,e){return n=qn(n),n._checkNotDeleted("ref"),e!==void 0?Kt(n._root,e):n._root}function Kt(n,e){return n=qn(n),F(n._path)===null?Vh("child","path",e):Ss("child","path",e),new Mn(n._repo,ae(n._path,e))}function co(n,e){n=qn(n),Is("push",n._path),za("push",e,n._path,!0);const t=ja(n._repo),o=lu(t),i=Kt(n,o),s=Kt(n,o);let r;return r=Promise.resolve(s),i.then=r.then.bind(r),i.catch=r.then.bind(r,void 0),i}function Ya(n){return Is("remove",n._path),mu(n,null)}function mu(n,e){n=qn(n),Is("set",n._path),za("set",e,n._path,!1);const t=new Xt;return Jh(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}function Li(n,e){zh("update",e,n._path);const t=new Xt;return $h(n._repo,n._path,e,t.wrapCallback(()=>{})),t.promise}class Ms{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const o=t._queryParams.getIndex();return new au("value",this,new To(e.snapshotNode,new Mn(t._repo,t._path),o))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new cu(this,e,t):null}matches(e){return e instanceof Ms?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function pu(n,e,t,o,i){let s;if(typeof o=="object"&&(s=void 0,i=o),typeof o=="function"&&(s=o),i&&i.onlyOnce){const a=t,d=(m,h)=>{Oi(n._repo,n,l),a(m,h)};d.userCallback=t.userCallback,d.context=t.context,t=d}const r=new du(t,s||void 0),l=new Ms(r);return eu(n._repo,n,l),()=>Oi(n._repo,n,l)}function qa(n,e,t,o){return pu(n,"value",e,t,o)}function Ja(n,e,t){Oi(n._repo,n,null)}class fu{}class yu extends fu{constructor(e){super(),this._path=e,this.type="orderByChild"}_apply(e){hu(e,"orderByChild");const t=new q(this._path);if(H(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const o=new ls(t),i=U2(e._queryParams,o);return uu(i),new Ko(e._repo,e._path,i,!0)}}function bu(n){return Ss("orderByChild","path",n),new yu(n)}function gu(n,...e){let t=qn(n);for(const o of e)t=o._apply(t);return t}uh(Mn);gh(Mn);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Au="FIREBASE_DATABASE_EMULATOR_HOST",Fi={};let _u=!1;function vu(n,e,t,o){const i=e.lastIndexOf(":"),s=e.substring(0,i),r=Nl(s);n.repoInfo_=new ea(e,r,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),o&&(n.authTokenProvider_=o)}function Pu(n,e,t,o,i){let s=o||n.options.databaseURL;s===void 0&&(n.options.projectId||pn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),we("Using default host for project ",n.options.projectId),s=`${n.options.projectId}-default-rtdb.firebaseio.com`);let r=Gr(s,i),l=r.repoInfo,a;typeof process!="undefined"&&ur&&(a=ur[Au]),a?(s=`http://${a}?ns=${l.namespace}`,r=Gr(s,i),l=r.repoInfo):r.repoInfo.secure;const d=new I0(n.name,n.options,e);Wh("Invalid Firebase Database URL",r),H(r.path)||pn("Database URL must point to the root of a Firebase Database (not including a child path).");const m=Uu(l,n,d,new S0(n,t));return new Eu(m,n)}function Cu(n,e){const t=Fi[e];(!t||t[n.key]!==n)&&pn(`Database ${e}(${n.repoInfo_}) has already been deleted.`),nu(n),delete t[n.key]}function Uu(n,e,t,o){let i=Fi[e.name];i||(i={},Fi[e.name]=i);let s=i[n.toURLString()];return s&&pn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new Xh(n,_u,t,o),i[n.toURLString()]=s,s}class Eu{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Yh(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Mn(this._repo,Q())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Cu(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&pn("Cannot call "+e+" on a deleted database.")}}function Bu(n=n0(),e){const t=q1(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const o=Fd("database");o&&wu(t,...o)}return t}function wu(n,e,t,o={}){n=qn(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,s=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&bo(o,s.repoInfo_.emulatorOptions))return;pn("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let r;if(s.repoInfo_.nodeAdmin)o.mockUserToken&&pn('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new ao(ao.OWNER);else if(o.mockUserToken){const l=typeof o.mockUserToken=="string"?o.mockUserToken:Hd(o.mockUserToken,n.app.options.projectId);r=new ao(l)}Nl(e)&&Zd(e),vu(s,i,o,r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Su(n){u0(e0),Ao(new Lt("database",(e,{instanceIdentifier:t})=>{const o=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return Pu(o,i,s,t)},"PUBLIC").setMultipleInstances(!0)),it(mr,pr,n),it(mr,pr,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Iu={".sv":"timestamp"};function Vn(){return Iu}un.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};un.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Su();var ku="firebase",Du="12.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */it(ku,Du,"app");const Fn=n=>n?String(n).split(/[\r\n,=\s]/)[0].trim():"",Hi={apiKey:Fn("AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs"),authDomain:Fn("findparkinglot-2519e.firebaseapp.com"),projectId:Fn("findparkinglot-2519e"),databaseURL:Fn("https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app"),storageBucket:Fn("findparkinglot-2519e.firebasestorage.app"),messagingSenderId:Fn("976769533420"),appId:Fn("1:976769533420:web:f3108318b3def30017acc9")},an=!!(Hi.apiKey&&Hi.databaseURL);let Qr=null,Qe=null;an&&(Qr=xl(Hi),Qe=Bu(Qr));const ho="parking_overrides",It=E({}),$a=E(!1),zi=E(null);let Rt=null,ui=0;function uo(n,e){if(!n||!Array.isArray(e))return"";const t=Number(e[0]),o=Number(e[1]);return!isFinite(t)||!isFinite(o)?"":`${n}|${t.toFixed(6)},${o.toFixed(6)}`.replace(/[.#$/[\]]/g,"_")}function Za(n,e){if(!e)return n;const t={...n},o=i=>{const s=e[i];s!=null&&(typeof s=="string"&&s.trim()===""||(t[i]=s))};return o("description"),o("iconKey"),o("category"),o("friendliness"),o("priceInfo"),t}function Tu(){if(!(!an||Rt))try{const n=Ze(Qe,ho);Rt=n,qa(n,e=>{const t={};e.forEach(o=>{t[o.key]=o.val()||{}}),It.value=t,$a.value=!0},e=>{zi.value=e})}catch(n){zi.value=n}}function Nu(){Rt&&(Ja(Rt),Rt=null)}function Mu(){Yn(()=>{ui+=1,Tu()}),mt(()=>{ui-=1,ui<=0&&Nu()});const n=(s,r)=>{const l=uo(s,r);return l&&It.value[l]||null};return{overrides:It,ready:$a,error:zi,getOverride:n,hasOverride:(s,r)=>!!n(s,r),getOverrideHistory:(s,r)=>{const l=n(s,r);return!l||!l.history||typeof l.history!="object"?[]:Object.entries(l.history).map(([a,d])=>({...d||{},_key:a})).sort((a,d)=>a._key<d._key?1:a._key>d._key?-1:0)},upsertOverride:async(s,r,l)=>{var N,V,Ce;if(!an)throw new Error("Firebase 尚未設定");const a=uo(s.name,s.geometry);if(!a)throw new Error("無法產生 override key (缺少 name 或 geometry)");const[d,m]=s.geometry,h={id:l.id,nickname:l.nickname||""},f={origName:s.name||"",origLng:Number(d),origLat:Number(m),description:typeof r.description=="string"?r.description.trim():"",iconKey:r.iconKey||"",category:r.category||"",friendliness:r.friendliness||"",priceInfo:typeof r.priceInfo=="string"?r.priceInfo.trim():"",updatedBy:h,updatedAt:Vn()},b=It.value[a]||null,g=Za(s,b),B=["description","iconKey","category","friendliness","priceInfo"],D={},U={};for(const ce of B){const Ie=(N=g==null?void 0:g[ce])!=null?N:"",Ue=(V=f[ce])!=null?V:"";String(Ie)!==String(Ue)&&(D[ce]=Ie,U[ce]=Ue)}const G=co(Ze(Qe,`${ho}/${a}/history`)).key;return await Li(Ze(Qe),{[`${ho}/${a}`]:{...f,history:{...((Ce=It.value[a])==null?void 0:Ce.history)||{},[G]:{action:"override",at:Vn(),by:h,before:D,after:U}}}}),a},resetOverride:async(s,r)=>{if(!an)throw new Error("Firebase 尚未設定");const l=uo(s,r);l&&await Ya(Ze(Qe,`${ho}/${l}`))}}}const rn=(n,e)=>{const t=n.__vccOpts||n;for(const[o,i]of e)t[o]=i;return t},Ru={id:"map"},Ou=16,Xr=34,xu=84,Lu={__name:"MapBox",props:{parkingTypeKeyArray:Array,degreeOfFriendlinessKeyArray:Array,mapDataList:Array,getLngLat:Boolean,mapStylesSelected:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,goToParkingPlaceData:Object,routeData:Object,favoriteIds:{type:Object,default:()=>new Set},overrideKeys:{type:Object,default:()=>new Set},overrides:{type:Object,default:()=>({})},onlyFavorites:{type:Boolean,default:!1},showOfficial:{type:Boolean,default:!0},showOverridden:{type:Boolean,default:!0},showCommunity:{type:Boolean,default:!0},focusCoord:{type:Array,default:null},routeProfile:{type:String,default:"driving"},communityParkings:{type:Array,default:()=>[]}},emits:["parkingInfo","communityParkingClick","update:goToParkingPlaceData","update:routeData"],setup(n,{expose:e,emit:t}){const o=n,i=t,s="pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",r=E(null),l=E({accessToken:s,bounds:[[119.3620389067818,21.83282743468497],[122.07013958372167,25.34391086143183]],center:[121.5173399,25.0475613],zoom:14,userCoordinates:[null,null]}),a=E(null),d=E([]),m=C=>C>=15?60:C>=13?60+(15-C)*30:C>=11?120+(13-C)*60:240,h=C=>Array.isArray(C)&&C.length>=2&&Number.isFinite(Number(C[0]))&&Number.isFinite(Number(C[1])),f=(C,R,X,W,Z)=>{const ie=document.createElement("div");ie.className="marker",W&&ie.classList.add("is-override"),X&&ie.classList.add("is-fav");const Oe=document.createElement("div");Oe.className="tag";const be=document.createElement("div");be.className="img";const _=Z||R.properties.icon;return _&&(be.style.backgroundImage=`url(${J(_)})`,be.style.backgroundSize="cover",be.style.backgroundPosition="center center"),ie.appendChild(Oe),ie.appendChild(be),ie.addEventListener("click",()=>{r.value.flyTo({center:R.geometry.coordinates,zoom:17,bearing:0,speed:1.5,curve:1.5,easing:w=>w,essential:!0}),i("parkingInfo",{name:C.name,properties:R.properties,geometry:R.geometry.coordinates,address:""})}),ie},b=(C,R)=>{const X=document.createElement("div");X.className="marker is-community",R&&X.classList.add("is-fav");const W=document.createElement("div");W.className="tag";const Z=document.createElement("div");return Z.className="img",C.iconKey&&(Z.style.backgroundImage=`url(${J(C.iconKey)})`,Z.style.backgroundSize="cover",Z.style.backgroundPosition="center center"),X.appendChild(W),X.appendChild(Z),X.addEventListener("click",()=>{r.value.flyTo({center:C.coordinates,zoom:17,speed:1.5,curve:1.5,essential:!0}),i("communityParkingClick",C)}),X},g=C=>{const R=document.createElement("div");R.className="marker-cluster";const X=Math.min(1,Math.log2(Math.max(2,C))/Math.log2(500)),W=Math.round(Xr+(xu-Xr)*X),Z=Math.round(12+10*X);return R.style.width=`${W}px`,R.style.height=`${W}px`,R.style.lineHeight=`${W}px`,R.style.fontSize=`${Z}px`,R.textContent=String(C),R},B=()=>{var ie,Oe,be,_,T,w,le,Ne,xe,fn,On,Ee;for(let O=d.value.length-1;O>=0;O--)d.value[O].remove();if(d.value=[],!r.value)return;const C=(Oe=(ie=r.value).getBounds)==null?void 0:Oe.call(ie),R=[];for(const O of o.mapDataList)for(const x of O.features){const de=x.geometry.coordinates;if(!h(de))continue;const Le=yi(x.properties.name,de),Fe=(_=(be=o.favoriteIds)==null?void 0:be.has)==null?void 0:_.call(be,Le),he=uo(x.properties.name,de),He=he?(w=(T=o.overrideKeys)==null?void 0:T.has)==null?void 0:w.call(T,he):!1;if(He){if(!o.showOfficial&&!o.showOverridden)continue}else if(!o.showOfficial)continue;const ke=He?(le=o.overrides)==null?void 0:le[he]:null,xn=typeof(ke==null?void 0:ke.priceInfo)=="string"&&ke.priceInfo.trim()!==""?ke.priceInfo.trim():"",eo=xn||x.properties.priceInfo,Qo=xn?xn.split("|"):x.properties.priceArray,no=(typeof(ke==null?void 0:ke.iconKey)=="string"&&ke.iconKey.trim()!==""?ke.iconKey.trim():"")||x.properties.icon;!Zs(C,de)||o.onlyFavorites&&!Fe||!Js(no,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray)||!$s(eo,Qo,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)||R.push({coord:[Number(de[0]),Number(de[1])],createEl:()=>f(O,x,Fe,He,no)})}for(const O of o.communityParkings||[]){if(!o.showCommunity)break;const x=O.coordinates;if(!h(x)||!Zs(C,x))continue;const de=yi(O.name,x),Le=(xe=(Ne=o.favoriteIds)==null?void 0:Ne.has)==null?void 0:xe.call(Ne,de);if(o.onlyFavorites&&!Le||!Js(O.iconKey,o.parkingTypeKeyArray,o.degreeOfFriendlinessKeyArray))continue;const Fe=O.priceInfo||"",he=Fe?Fe.split("|"):[];$s(Fe,he,o.parkingPriceType,o.priceRangeMin,o.priceRangeMax)&&R.push({coord:[Number(x[0]),Number(x[1])],createEl:()=>b(O,Le)})}const X=(Ee=(On=(fn=r.value).getZoom)==null?void 0:On.call(fn))!=null?Ee:0;if(X>=Ou){for(const O of R){const x=new Ln.Marker(O.createEl()).setLngLat(O.coord).addTo(r.value);d.value.push(x)}return}const W=m(X),Z=new Map;for(const O of R){const x=r.value.project(O.coord),de=Math.floor(x.x/W),Le=Math.floor(x.y/W),Fe=`${de}:${Le}`;let he=Z.get(Fe);he||(he={points:[],sumLng:0,sumLat:0},Z.set(Fe,he)),he.points.push(O),he.sumLng+=O.coord[0],he.sumLat+=O.coord[1]}for(const O of Z.values())if(O.points.length===1){const x=O.points[0],de=new Ln.Marker(x.createEl()).setLngLat(x.coord).addTo(r.value);d.value.push(de)}else{const x=[O.sumLng/O.points.length,O.sumLat/O.points.length],de=g(O.points.length);de.addEventListener("click",()=>{var he,He,ke;const Fe=Math.min(((ke=(He=(he=r.value).getZoom)==null?void 0:He.call(he))!=null?ke:0)+2,17);r.value.flyTo({center:x,zoom:Fe,speed:1.5,curve:1.5,essential:!0})});const Le=new Ln.Marker(de).setLngLat(x).addTo(r.value);d.value.push(Le)}};let D=null,U=null;const G=()=>{D!=null&&(clearTimeout(D),D=null),U!=null&&(typeof cancelIdleCallback=="function"&&cancelIdleCallback(U),U=null)},N=()=>{G(),D=setTimeout(()=>{D=null;const C=()=>{U=null,o.goToParkingPlaceData==null&&B()};typeof requestIdleCallback=="function"?U=requestIdleCallback(C,{timeout:250}):C()},80)},V=()=>{const C=document.getElementById("loading-cover");C&&(C.classList.add("active"),setTimeout(()=>C.remove(),600))},Ce=()=>{r.value.on("dragend",N),r.value.on("zoomend",N),B(),V(),r.value.once("load",()=>{const C=o.focusCoord;Array.isArray(C)&&C[0]!=null&&C[1]!=null&&r.value.flyTo({center:[Number(C[0]),Number(C[1])],zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})})},ce=()=>{r.value=new Ln.Map({container:"map",style:o.mapStylesSelected,center:l.value.center,zoom:16,trackResize:!0,maxBounds:l.value.bounds}),Ce(),r.value.addControl(new Ln.GeolocateControl({positionOptions:{enableHighAccuracy:!0},trackUserLocation:!0,showUserHeading:!0})),r.value.on("geolocate",C=>{r.value.easeTo({bearing:C.coords.heading,duration:1e3,offset:[0,0]})})},Ie=C=>{const{longitude:R,latitude:X}=C.coords;R>=l.value.bounds[0][0]&&R<=l.value.bounds[1][0]&&X>=l.value.bounds[0][1]&&X<=l.value.bounds[1][1]?(l.value.userCoordinates=[R,X],l.value.center=[R,X]):l.value.center=[121.5173399,25.0475613],ce()},Ue=()=>{ce()},qe=()=>{const C=document.getElementById("coordinates"),R=a.value.getLngLat();C.style.display="block",C.innerHTML=`[Longitude, Latitude]<br />[${R.lng}, ${R.lat}]`},me=()=>{a.value=new Ln.Marker({draggable:!0,color:"#2ee7d6"}).setLngLat(r.value.getCenter()).addTo(r.value),qe(),a.value.on("dragend",qe)};async function re(C,R){r.value.getLayer("point")||r.value.addLayer({id:"point",type:"circle",source:{type:"geojson",data:{type:"FeatureCollection",features:[{type:"Feature",properties:{},geometry:{type:"Point",coordinates:C}}]}},paint:{"circle-radius":10,"circle-color":"#2ee7d6"}});const Z=(await(await fetch(`https://api.mapbox.com/directions/v5/mapbox/${o.routeProfile||"driving"}/${C[0]},${C[1]};${R[0]},${R[1]}?alternatives=false&language=zh-Hant&overview=full&steps=true&exclude=ferry&geometries=geojson&access_token=${l.value.accessToken}`,{method:"GET"})).json()).routes[0],ie={type:"Feature",properties:{},geometry:{type:"LineString",coordinates:Z.geometry.coordinates}};i("update:routeData",Z),r.value.getSource("route")?r.value.getSource("route").setData(ie):r.value.addLayer({id:"route",type:"line",source:{type:"geojson",data:ie},layout:{"line-join":"round","line-cap":"round"},paint:{"line-color":"#2ee7d6","line-width":5,"line-opacity":.75}})}const Te=C=>{if(l.value.userCoordinates[0]!==null){r.value.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point"));for(let X=d.value.length-1;X>=0;X--){const W=d.value[X].getLngLat();W.lng!=C[0]&&W.lat!=C[1]&&d.value[X].remove()}const R=[[l.value.userCoordinates[0],l.value.userCoordinates[1]],[C[0],C[1]]];r.value.fitBounds(R,{padding:{top:100,bottom:100,left:100,right:100}}),re(l.value.userCoordinates,C)}else"geolocation"in navigator&&navigator.geolocation.getCurrentPosition(Ie,Ue)},je=()=>{var C,R;(C=r.value)!=null&&C.getSource("route")&&(r.value.removeLayer("route"),r.value.removeSource("route")),(R=r.value)!=null&&R.getSource("point")&&(r.value.removeLayer("point"),r.value.removeSource("point")),B(),i("update:goToParkingPlaceData",null)};return Yn(()=>{Ln.accessToken=l.value.accessToken,"geolocation"in navigator?navigator.geolocation.getCurrentPosition(Ie,Ue,{enableHighAccuracy:!1,timeout:8e3,maximumAge:6e4}):ce()}),mt(()=>{G()}),K([()=>o.parkingTypeKeyArray,()=>o.degreeOfFriendlinessKeyArray,()=>o.priceRangeMin,()=>o.priceRangeMax,()=>o.parkingPriceType,()=>o.onlyFavorites,()=>o.showOfficial,()=>o.showOverridden,()=>o.showCommunity,()=>o.favoriteIds,()=>o.communityParkings,()=>o.overrides],()=>N(),{deep:!0}),K(()=>o.focusCoord,C=>{!C||!r.value||r.value.flyTo({center:C,zoom:17,bearing:0,speed:1.5,curve:1.5,essential:!0})}),K(()=>o.routeProfile,()=>{o.goToParkingPlaceData!==null&&l.value.userCoordinates[0]!==null&&re(l.value.userCoordinates,o.goToParkingPlaceData)}),K(()=>o.goToParkingPlaceData,C=>{C!==null?Te(C):je()}),K(()=>o.mapStylesSelected,(C,R)=>{R!==C&&r.value&&r.value.setStyle(C)}),K(()=>o.getLngLat,()=>{if(a.value!==null){a.value.remove();const C=document.getElementById("coordinates");C&&(C.style.display="none")}o.getLngLat===!0&&me()}),e({getCenter:()=>{if(!r.value)return[...l.value.center];const C=r.value.getCenter();return[C.lng,C.lat]},flyTo:(C,R=17)=>{!r.value||!C||r.value.flyTo({center:C,zoom:R,essential:!0})}}),(C,R)=>(v(),P("div",Ru))}},Fu=rn(Lu,[["__scopeId","data-v-98a3b97e"]]),Hu=n=>(Tn("data-v-4ef15e45"),n=n(),Nn(),n),zu={key:0,class:"modal-header"},Vu=Hu(()=>c("span",{class:"material-icons-outlined"},"close",-1)),Wu=[Vu],ju={class:"modal-body"},Gu={key:1,class:"modal-footer"},Ku={__name:"BaseModal",props:{modelValue:Boolean,title:{type:String,default:""},closeText:{type:String,default:"關閉"},size:{type:String,default:"md"}},emits:["update:modelValue","close"],setup(n,{emit:e}){const t=n,o=e,i=E(null),s=()=>{o("update:modelValue",!1),o("close")},r=l=>{l.key==="Escape"&&t.modelValue&&s()};return Yn(()=>window.addEventListener("keydown",r)),mt(()=>window.removeEventListener("keydown",r)),K(()=>t.modelValue,async l=>{var a;document.body.classList.toggle("modal-open",l),l&&(await hl(),(a=i.value)==null||a.scrollTo({top:0,behavior:"auto"}))}),(l,a)=>(v(),Ki(Nc,{to:"body"},[c("div",{class:$(["modal-overlay",{active:n.modelValue}]),onClick:Qi(s,["self"]),role:"dialog","aria-modal":"true",ref_key:"overlayEl",ref:i},[c("div",{class:$(["modal-card",[`size-${n.size}`,{active:n.modelValue}]])},[n.title||l.$slots.header?(v(),P("header",zu,[ei(l.$slots,"header",{},()=>[c("h3",null,S(n.title),1)]),c("button",{class:"modal-close",onClick:s,"aria-label":"關閉"},Wu)])):j("",!0),c("div",ju,[ei(l.$slots,"default",{},void 0)]),l.$slots.footer||n.closeText?(v(),P("footer",Gu,[ei(l.$slots,"footer",{},()=>[c("button",{class:"btn btn-primary",onClick:s},S(n.closeText),1)])])):j("",!0)],2)],2)]))}},Cn=rn(Ku,[["__scopeId","data-v-4ef15e45"]]),Qu=["onClick"],Xu={class:"material-icons-outlined"},Yu={class:"fab-item-label"},qu=["aria-label","aria-expanded"],Ju={class:"material-icons-outlined"},$u={__name:"FabMenu",props:{items:{type:Array,required:!0},placement:{type:String,default:"right"},mainIcon:{type:String,default:"apps"},mainLabel:{type:String,default:""}},setup(n){const e=E(!1),t=E(null),o=()=>e.value=!e.value,i=r=>{t.value&&!t.value.contains(r.target)&&(e.value=!1)},s=r=>{var l;e.value=!1,(l=r.onClick)==null||l.call(r)};return Yn(()=>document.addEventListener("click",i)),mt(()=>document.removeEventListener("click",i)),(r,l)=>(v(),P("div",{class:$(["fab-root",`fab-placement-${n.placement}`]),ref_key:"rootEl",ref:t},[Be(Mc,{name:"fab-item",tag:"div",class:"fab-items"},{default:$e(()=>[(v(!0),P(ye,null,We(e.value?n.items:[],(a,d)=>(v(),P("button",{key:a.key,class:$(["fab-item",{highlight:a.highlight}]),style:po({bottom:d*46+"px"}),onClick:m=>s(a)},[c("span",Xu,S(a.icon),1),c("span",Yu,S(a.label),1)],14,Qu))),128))]),_:1}),c("button",{class:$(["fab-main",{active:e.value}]),onClick:Qi(o,["stop"]),"aria-label":e.value?"收合選單":n.mainLabel||"展開選單","aria-expanded":e.value},[c("span",Ju,S(e.value?"close":n.mainIcon),1)],10,qu)],2))}},Yr=rn($u,[["__scopeId","data-v-b3399b6f"]]),ut=[{name:"全部",value:"",key:null},{name:"汽車：汽車格(含未確認是否有重機格)",value:"car",key:["icon-1.png","icon-2.png","icon-3.png","icon-5.png"]},{name:"重機：有設重機專用格",value:"motorcycle",key:["icon-6.png","icon-8.png","icon-12.png","icon-13.png"]},{name:"機車：機車格",value:"scooter",key:["icon-7.png","icon-9.png","icon-10.png","icon-11.png"]},{name:"綠星:路邊友善車格(機車格開放重機停放)",value:"greenStar",key:["icon-14.png"]},{name:"重機友善店家:用餐/消費可停重機",value:"friendlyShop",key:["icon-4.png"]},{name:"綠P:重機專用路邊停車格",value:"greenP",key:["icon-15.png"]},{name:"灰P:重機專用路邊停車格(未確認精準座標)",value:"greyP",key:["icon-16.png"]},{name:"藍P:普通大型共用機車格(台北市試辦)",value:"blueP",key:["icon-17.png"]},{name:"紫P:時段性汽機車共用停車格，注意使用時間喔!",value:"purpleP",key:["icon-18.png"]},{name:"紅X:停都不給停",value:"redX",key:["icon-19.png"]},{name:"?:類型未確認",value:"unknown",key:["icon-20.png"]}];function Zu(n){if(!n)return"未分類";const e=ut.find(t=>Array.isArray(t.key)&&t.key.includes(n));return e?e.name.split(/[：:]/)[0]:"未分類"}const Qt=[{name:"全部",value:"",key:null},{name:"最友善：有後牌辨析",value:"friendly",key:["icon-2.png","icon-4.png","icon-6.png","icon-9.png","icon-14.png","icon-15.png"]},{name:"最傳統：悠遊卡、按鈕取票",value:"normal",key:["icon-5.png","icon-11.png","icon-12.png","icon-17.png"]},{name:"最靠北：按鈕請管理員協助、前牌辨析",value:"unfriendly",key:["icon-1.png","icon-7.png","icon-13.png","icon-19.png"]},{name:"未確定",value:"unknown",key:["icon-3.png","icon-8.png","icon-10.png","icon-16.png","icon-20.png"]}],tt=[{name:"依系統設定",value:"system",theme:"system"},{name:"暗色模式",value:"mapbox://styles/jamestim9215/ckvkdj5cd1q4115nzwxa9rny3",theme:"dark"},{name:"亮色模式",value:"mapbox://styles/jamestim9215/ckvueghhu2woc14nrsgysx41v",theme:"light"}],e3="260722",n3=n=>(Tn("data-v-fc736dec"),n=n(),Nn(),n),t3={class:"range-slider"},o3={class:"range-track"},i3=["min","max","step","value"],s3=["min","max","step","value"],r3={class:"range-values"},l3=n3(()=>c("span",{class:"range-sep"},"~",-1)),a3={__name:"RangeSlider",props:{min:{type:Number,default:0},max:{type:Number,default:100},step:{type:Number,default:10},modelMin:{type:Number,default:0},modelMax:{type:Number,default:100},suffix:{type:String,default:""}},emits:["update:modelMin","update:modelMax"],setup(n,{emit:e}){const t=n,o=e,i=Y(()=>t.max-t.min||1),s=Y(()=>(t.modelMin-t.min)/i.value*100),r=Y(()=>(t.modelMax-t.min)/i.value*100),l=d=>{let m=Number(d.target.value);m>t.modelMax&&(m=t.modelMax),o("update:modelMin",m)},a=d=>{let m=Number(d.target.value);m<t.modelMin&&(m=t.modelMin),o("update:modelMax",m)};return(d,m)=>(v(),P("div",t3,[c("div",o3,[c("div",{class:"range-fill",style:po({left:s.value+"%",right:100-r.value+"%"})},null,4),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMin,onInput:l,class:"range-input range-input-min","aria-label":"最低價格"},null,40,i3),c("input",{type:"range",min:n.min,max:n.max,step:n.step,value:n.modelMax,onInput:a,class:"range-input range-input-max","aria-label":"最高價格"},null,40,s3)]),c("div",r3,[c("span",null,S(n.modelMin)+S(n.suffix),1),l3,c("span",null,S(n.modelMax)+S(n.suffix),1)])]))}},c3=rn(a3,[["__scopeId","data-v-fc736dec"]]),Pe=n=>(Tn("data-v-ed90af5a"),n=n(),Nn(),n),d3=Pe(()=>c("span",{class:"material-icons-outlined"},"chevron_left",-1)),h3=[d3],u3=ul('<header class="side-panel-header" data-v-ed90af5a><img class="side-panel-logo" src="'+Xi+'" alt="重機能停哪" data-v-ed90af5a><div class="side-panel-titles" data-v-ed90af5a><h3 data-v-ed90af5a>重機能停哪?</h3><span class="side-panel-subtitle" data-v-ed90af5a><span class="material-icons-outlined" data-v-ed90af5a>tune</span>設定 </span></div></header>',1),m3={class:"side-panel-body"},p3={class:"form-group"},f3={class:"form-toggle"},y3={class:"form-toggle-text"},b3=Pe(()=>c("span",{class:"material-icons-outlined fav-icon"},"star",-1)),g3={class:"source-count"},A3=["checked"],_3={class:"form-group"},v3=Pe(()=>c("label",{class:"form-label"},"顯示分類",-1)),P3={class:"source-chips"},C3=["aria-pressed"],U3=Pe(()=>c("span",{class:"material-icons-outlined source-icon"},"place",-1)),E3={class:"chip-count"},B3=["aria-pressed"],w3=Pe(()=>c("span",{class:"material-icons-outlined source-icon"},"edit_location_alt",-1)),S3={class:"chip-count"},I3=["aria-pressed"],k3=Pe(()=>c("span",{class:"material-icons-outlined source-icon"},"add_location_alt",-1)),D3={class:"chip-count"},T3={class:"form-group"},N3=Pe(()=>c("label",{class:"form-label"},"甚麼格位",-1)),M3=["value"],R3=["value"],O3={class:"form-group"},x3=Pe(()=>c("label",{class:"form-label"},"友善程度",-1)),L3=["value"],F3=["value"],H3={class:"form-group"},z3=Pe(()=>c("label",{class:"form-label"},"收費範圍",-1)),V3={class:"price-chips"},W3=Pe(()=>c("span",{class:"material-icons-outlined"},"money_off",-1)),j3={class:"form-group"},G3=Pe(()=>c("label",{class:"form-label"},"主題顏色",-1)),K3=["value"],Q3=["value"],X3=Pe(()=>c("section",{class:"form-group"},[c("label",{class:"form-label"},"停車場資料來源"),c("div",{class:"link-list"},[c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"btn btn-outline btn-sm"}," Alan大重停車記事 ")])],-1)),Y3={class:"form-group"},q3=ul('<label class="form-label" data-v-ed90af5a>問題回報</label><p class="muted-text" data-v-ed90af5a> 1. 停車場資訊相關（新場地、收費錯誤）： </p><a href="https://forms.gle/euRCPCPSmvYLm5Rj8" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-ed90af5a> Alan大重停車記事 回報表單 </a><p class="muted-text mt-8" data-v-ed90af5a>2. 網頁 BUG、畫面跑版：</p><a href="https://forms.gle/iJCyfqVtpL35WtZM7" target="_blank" rel="noopener" class="btn btn-outline btn-sm" data-v-ed90af5a> 重機能停哪? 回報表單 </a>',5),J3={class:"form-group"},$3=Pe(()=>c("label",{class:"form-label"},"資訊",-1)),Z3={class:"info-list"},e5=Pe(()=>c("li",null,"版本：v2.3.0",-1)),n5=Pe(()=>c("li",null,"Web 製作：爽爽",-1)),t5=Pe(()=>c("li",null,"資料參考：Alan大重停車記事 Google My Map",-1)),o5=Pe(()=>c("li",null,"地圖：Mapbox GL JS API",-1)),i5=Pe(()=>c("li",null,"© 2026 爽爽 版權所有。本網頁未經准許，禁止任何商業行為",-1)),s5={__name:"SettingsPanel",props:{parkingType:String,degreeOfFriendliness:String,parkingPriceType:String,priceRangeMin:Number,priceRangeMax:Number,mapStyle:String,active:Boolean,onlyFavorites:Boolean,favoritesCount:{type:Number,default:0},showOfficial:{type:Boolean,default:!0},showOverridden:{type:Boolean,default:!0},showCommunity:{type:Boolean,default:!0},officialCount:{type:Number,default:0},overriddenCount:{type:Number,default:0},communityCount:{type:Number,default:0}},emits:["update:parkingType","update:degreeOfFriendliness","update:parkingPriceType","update:priceRangeMin","update:priceRangeMax","update:mapStyle","update:active","update:onlyFavorites","update:showOfficial","update:showOverridden","update:showCommunity","open-support"],setup(n,{emit:e}){const t=e,o=()=>t("update:active",!1);return(i,s)=>(v(),P("aside",{class:$(["side-panel",{active:n.active}]),"aria-label":"設定面板"},[c("button",{class:"side-panel-close",onClick:o,"aria-label":"收合設定"},h3),u3,c("div",m3,[c("section",p3,[c("label",f3,[c("span",y3,[b3,k(" 只看我的最愛 "),c("span",g3,"("+S(n.favoritesCount)+")",1)]),c("input",{type:"checkbox",class:"switch",checked:n.onlyFavorites,onChange:s[0]||(s[0]=r=>t("update:onlyFavorites",r.target.checked))},null,40,A3)])]),c("section",_3,[v3,c("div",P3,[c("button",{type:"button",class:$(["chip source-chip source-chip-official",{active:n.showOfficial}]),onClick:s[1]||(s[1]=r=>t("update:showOfficial",!n.showOfficial)),"aria-pressed":n.showOfficial},[U3,k(" 官方 "),c("span",E3,S(n.officialCount),1)],10,C3),c("button",{type:"button",class:$(["chip source-chip source-chip-override",{active:n.showOverridden}]),onClick:s[2]||(s[2]=r=>t("update:showOverridden",!n.showOverridden)),"aria-pressed":n.showOverridden},[w3,k(" 修改 "),c("span",S3,S(n.overriddenCount),1)],10,B3),c("button",{type:"button",class:$(["chip source-chip source-chip-community",{active:n.showCommunity}]),onClick:s[3]||(s[3]=r=>t("update:showCommunity",!n.showCommunity)),"aria-pressed":n.showCommunity},[k3,k(" 共筆 "),c("span",D3,S(n.communityCount),1)],10,I3)])]),c("section",T3,[N3,c("select",{class:"form-control",value:n.parkingType,onChange:s[4]||(s[4]=r=>t("update:parkingType",r.target.value))},[(v(!0),P(ye,null,We(L(ut),r=>(v(),P("option",{value:r.value,key:r.value},S(r.name),9,R3))),128))],40,M3)]),c("section",O3,[x3,c("select",{class:"form-control",value:n.degreeOfFriendliness,onChange:s[5]||(s[5]=r=>t("update:degreeOfFriendliness",r.target.value))},[(v(!0),P(ye,null,We(L(Qt),r=>(v(),P("option",{value:r.value,key:r.value},S(r.name),9,F3))),128))],40,L3)]),c("section",H3,[z3,c("div",V3,[c("button",{type:"button",class:$(["chip",{active:n.parkingPriceType===""}]),onClick:s[6]||(s[6]=r=>t("update:parkingPriceType",""))},"全部",2),c("button",{type:"button",class:$(["chip chip-free",{active:n.parkingPriceType==="free"}]),onClick:s[7]||(s[7]=r=>t("update:parkingPriceType",n.parkingPriceType==="free"?"":"free"))},[W3,k(" 免費 ")],2),c("button",{type:"button",class:$(["chip",{active:n.parkingPriceType==="h"}]),onClick:s[8]||(s[8]=r=>t("update:parkingPriceType","h"))},"計時 /時",2),c("button",{type:"button",class:$(["chip",{active:n.parkingPriceType==="d"}]),onClick:s[9]||(s[9]=r=>t("update:parkingPriceType","d"))},"計次 /日",2),c("button",{type:"button",class:$(["chip",{active:n.parkingPriceType==="t"}]),onClick:s[10]||(s[10]=r=>t("update:parkingPriceType","t"))},"計次 /不限時",2)]),/d|h|t/.test(n.parkingPriceType)?(v(),Ki(c3,{key:0,class:"mt-8",min:0,max:300,step:10,"model-min":n.priceRangeMin,"model-max":n.priceRangeMax,suffix:n.parkingPriceType==="h"?" /時":n.parkingPriceType==="d"?" /日":" /次","onUpdate:modelMin":s[11]||(s[11]=r=>t("update:priceRangeMin",r)),"onUpdate:modelMax":s[12]||(s[12]=r=>t("update:priceRangeMax",r))},null,8,["model-min","model-max","suffix"])):j("",!0)]),c("section",j3,[G3,c("select",{class:"form-control",value:n.mapStyle,onChange:s[13]||(s[13]=r=>t("update:mapStyle",r.target.value))},[(v(!0),P(ye,null,We(L(tt),r=>(v(),P("option",{value:r.value,key:r.value},S(r.name),9,Q3))),128))],40,K3)]),X3,c("section",Y3,[q3,c("button",{type:"button",class:"btn btn-coffee btn-sm mt-8",onClick:s[14]||(s[14]=r=>t("open-support"))}," ❤️ 贊助支持，讓我有動力繼續更新 ")]),c("section",J3,[$3,c("ul",Z3,[e5,c("li",null,"地圖資料更新：自動更新於"+S(L(e3)),1),n5,t5,o5,i5])])])],2))}},r5=rn(s5,[["__scopeId","data-v-ed90af5a"]]),Ye=n=>(Tn("data-v-d09400e9"),n=n(),Nn(),n),l5=Ye(()=>c("span",{class:"material-icons-outlined"},"close",-1)),a5=[l5],c5={class:"info-header"},d5=["src"],h5={class:"info-title"},u5=["aria-label","title"],m5={class:"material-icons-outlined"},p5=["innerHTML"],f5={key:1,class:"info-address"},y5={key:2,class:"info-price"},b5=Ye(()=>c("span",{class:"material-icons-outlined"},"payments",-1)),g5=Ye(()=>c("span",{class:"info-price-label"},"收費",-1)),A5={class:"info-price-value"},_5={key:0,class:"info-price-tag"},v5={key:3,class:"community-tag"},P5=Ye(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),C5={key:4,class:"override-tag"},U5=Ye(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),E5={key:5,class:"source-tag"},B5=Ye(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),w5={class:"info-meta"},S5={class:"badge-group"},I5={class:"badge"},k5={key:0,class:"badge badge-icon",title:"依圖示分類"},D5={class:"coord"},T5={class:"info-actions"},N5=Ye(()=>c("span",{class:"material-icons-outlined"},"edit",-1)),M5=["title"],R5=Ye(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),O5=Ye(()=>c("span",{class:"material-icons-outlined"},"share",-1)),x5={class:"info-actions"},L5=Ye(()=>c("span",{class:"material-icons-outlined"},"map",-1)),F5=Ye(()=>c("span",{class:"material-icons-outlined"},"map",-1)),H5=Ye(()=>c("span",{class:"material-icons-outlined"},"directions",-1)),z5={__name:"ParkingInfoPanel",props:{info:Object,active:Boolean,isMobile:Boolean,isApple:Boolean,isAndroid:Boolean,hasRoute:Boolean,isFavorite:Boolean,isCommunity:{type:Boolean,default:!1},communityMeta:{type:Object,default:null},isOverridden:{type:Boolean,default:!1},overrideMeta:{type:Object,default:null}},emits:["close","route","openMap","toggleFavorite","editCommunity","editOverride","share"],setup(n,{emit:e}){const t=n,o=e,i=new Set(["icon-4.png","icon-14.png","icon-19.png"]),s=l=>l!=null&&l.priceInfo?t.isCommunity||t.isOverridden?!0:!i.has(l==null?void 0:l.parkingIconKey):!1,r=l=>{if(!l)return"";if(/^free$/i.test(l.trim()))return"免費";const a=l.trim().match(/^(\d+(?:\.\d+)?)\s*\/\s*(h|d|次)$/i);if(!a)return l;const d=a[2].toLowerCase(),m=d==="h"?"小時":d==="d"?"日":"次 (不限時)";return`${a[1]} 元 / ${m}`};return(l,a)=>{var d,m,h,f,b,g,B,D;return v(),P("aside",{class:$(["info-panel",{active:n.active}]),"aria-label":"停車場資訊"},[c("button",{class:"panel-close",onClick:a[0]||(a[0]=U=>o("close")),"aria-label":"關閉"},a5),c("header",c5,[n.info.parkingIcon?(v(),P("img",{key:0,class:"info-icon",src:n.info.parkingIcon,alt:""},null,8,d5)):j("",!0),c("h3",h5,S(n.info.parkingName),1),c("button",{class:$(["fav-btn",{active:n.isFavorite}]),onClick:a[1]||(a[1]=U=>o("toggleFavorite")),"aria-label":n.isFavorite?"從我的最愛移除":"加入我的最愛",title:n.isFavorite?"從我的最愛移除":"加入我的最愛"},[c("span",m5,S(n.isFavorite?"star":"star_border"),1)],10,u5)]),n.info.parkingNameDes?(v(),P("div",{key:0,class:"info-desc",innerHTML:n.info.parkingNameDes},null,8,p5)):j("",!0),n.info.address?(v(),P("div",f5,S(n.info.address),1)):j("",!0),s(n.info)?(v(),P("div",y5,[b5,g5,c("span",A5,S(r(n.info.priceInfo)),1),n.isOverridden?(v(),P("span",_5,"車友修改")):j("",!0)])):j("",!0),n.isCommunity?(v(),P("div",v5,[P5,c("span",null,[k(" 共筆停車點 "),(m=(d=n.communityMeta)==null?void 0:d.updatedBy)!=null&&m.nickname||(f=(h=n.communityMeta)==null?void 0:h.updatedBy)!=null&&f.id?(v(),P(ye,{key:0},[k(" · 由 "+S(n.communityMeta.updatedBy.nickname||`匿名#${n.communityMeta.updatedBy.id}`)+" 更新 ",1)],64)):j("",!0)])])):n.isOverridden?(v(),P("div",C5,[U5,c("span",null,[k(" 車友修改資訊 "),(g=(b=n.overrideMeta)==null?void 0:b.updatedBy)!=null&&g.nickname||(D=(B=n.overrideMeta)==null?void 0:B.updatedBy)!=null&&D.id?(v(),P(ye,{key:0},[k(" · 由 "+S(n.overrideMeta.updatedBy.nickname||`匿名#${n.overrideMeta.updatedBy.id}`)+" 更新 ",1)],64)):j("",!0)])])):j("",!0),!n.isCommunity&&n.info.sourceLabel?(v(),P("div",E5,[B5,c("span",null,"資料來源 · "+S(n.info.sourceLabel),1)])):j("",!0),c("div",w5,[c("div",S5,[c("span",I5,S(n.info.parkingType),1),n.info.iconCategory&&n.info.iconCategory!==n.info.parkingType?(v(),P("span",k5,S(n.info.iconCategory),1)):j("",!0)]),c("span",D5,S(Number(n.info.geometry[0]).toFixed(5))+", "+S(Number(n.info.geometry[1]).toFixed(5)),1)]),c("div",T5,[n.isCommunity?(v(),P("button",{key:0,class:"btn btn-outline btn-sm",onClick:a[2]||(a[2]=U=>o("editCommunity"))},[N5,k(" 編輯 ")])):(v(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[3]||(a[3]=U=>o("editOverride")),title:n.isOverridden?"修改車友提供的資訊 (不會變動官方資料)":"異議 / 補充官方資料 (不會變動官方資料)"},[R5,k(" "+S(n.isOverridden?"修改車友資訊":"異議 / 補充"),1)],8,M5)),c("button",{class:"btn btn-outline btn-sm",onClick:a[4]||(a[4]=U=>o("share")),title:"分享這個停車點"},[O5,k(" 分享 ")])]),c("div",x5,[n.isAndroid?j("",!0):(v(),P("button",{key:0,class:"btn btn-primary btn-sm",onClick:a[5]||(a[5]=U=>o("openMap","apple"))},[L5,k(" Apple Map ")])),c("button",{class:$(["btn","btn-sm",n.isAndroid?"btn-primary":"btn-outline"]),onClick:a[6]||(a[6]=U=>o("openMap","google"))},[F5,k(" Google Map ")],2),n.hasRoute?j("",!0):(v(),P("button",{key:1,class:"btn btn-outline btn-sm",onClick:a[7]||(a[7]=U=>o("route"))},[H5,k(" 路線規劃 ")]))])],2)}}},V5=rn(z5,[["__scopeId","data-v-d09400e9"]]),Rs=n=>(Tn("data-v-caf0ec6e"),n=n(),Nn(),n),W5={class:"route-header"},j5=Rs(()=>c("h3",null,[c("span",{class:"material-icons-outlined"},"alt_route"),k(" 路線 ")],-1)),G5=["aria-expanded"],K5={class:"material-icons-outlined"},Q5={key:0,class:"route-summary"},X5={class:"route-summary-item"},Y5=Rs(()=>c("span",{class:"material-icons-outlined"},"schedule",-1)),q5={class:"route-summary-item"},J5=Rs(()=>c("span",{class:"material-icons-outlined"},"straighten",-1)),$5={class:"route-profile",role:"tablist","aria-label":"交通方式"},Z5=["onClick","aria-pressed"],e4={class:"material-icons-outlined"},n4={class:"profile-label"},t4={key:1,class:"route-steps"},o4={__name:"RouteSteps",props:{routeData:Object,active:Boolean,profile:{type:String,default:"driving"}},emits:["cancel","update:profile"],setup(n,{emit:e}){const t=n,o=e,i=E(!0),s=()=>i.value=!i.value,r=[{value:"driving",label:"汽機車",icon:"directions_car"},{value:"cycling",label:"單車",icon:"directions_bike"},{value:"walking",label:"步行",icon:"directions_walk"}],l=Y(()=>{var h;const m=(h=t.routeData)==null?void 0:h.distance;return typeof m!="number"?"":m>=1e3?`${(m/1e3).toFixed(1)} km`:`${Math.round(m)} m`}),a=Y(()=>{var g;const m=(g=t.routeData)==null?void 0:g.duration;if(typeof m!="number")return"";const h=Math.round(m/60);if(h<60)return`${h} 分`;const f=Math.floor(h/60),b=h%60;return b?`${f} 時 ${b} 分`:`${f} 時`}),d=m=>o("update:profile",m);return(m,h)=>(v(),P("aside",{class:$(["route-panel",{active:n.active}])},[c("header",W5,[j5,c("button",{class:"route-toggle",onClick:s,"aria-expanded":i.value},[c("span",K5,S(i.value?"expand_less":"expand_more"),1)],8,G5)]),n.routeData?(v(),P("div",Q5,[c("div",X5,[Y5,c("strong",null,S(a.value),1)]),c("div",q5,[J5,c("strong",null,S(l.value),1)])])):j("",!0),c("div",$5,[(v(),P(ye,null,We(r,f=>c("button",{key:f.value,class:$(["profile-btn",{active:n.profile===f.value}]),onClick:b=>d(f.value),"aria-pressed":n.profile===f.value},[c("span",e4,S(f.icon),1),c("span",n4,S(f.label),1)],10,Z5)),64))]),n.routeData&&i.value?(v(),P("ol",t4,[(v(!0),P(ye,null,We(n.routeData.legs[0].steps,(f,b)=>(v(),P("li",{key:b,class:"route-step"},S(f.maneuver.instruction),1))),128))])):j("",!0),c("button",{class:"btn btn-danger btn-sm route-cancel",onClick:h[0]||(h[0]=f=>o("cancel"))}," 取消路線規劃 ")],2))}},i4=rn(o4,[["__scopeId","data-v-caf0ec6e"]]);function s4(n,e,t=20,o=[]){const i=(e||"").trim().toLowerCase();if(!i)return[];const s=[];if(Array.isArray(n))for(const r of n)for(const l of r.features){const a=(l.properties.name||"").toLowerCase(),d=(l.properties.description||"").toLowerCase();if((a.includes(i)||d.includes(i))&&(s.push({groupName:r.name,name:l.properties.name,description:l.properties.description,icon:l.properties.icon,geometry:l.geometry.coordinates,properties:l.properties,isCommunity:!1,score:(a.includes(i)?1e3:0)-(a.indexOf(i)===-1?0:a.indexOf(i))}),s.length>500))break}if(Array.isArray(o))for(const r of o){const l=(r.name||"").toLowerCase(),a=(r.description||"").toLowerCase();if(!l.includes(i)&&!a.includes(i))continue;const d=Array.isArray(r.coordinates)?r.coordinates:[null,null];if(!(d[0]==null||d[1]==null)&&(s.push({groupName:"共筆停車點",name:r.name,description:r.description,icon:r.iconKey,geometry:d,properties:{name:r.name,description:r.description,icon:r.iconKey},isCommunity:!0,community:r,score:(l.includes(i)?900:0)-(l.indexOf(i)===-1?0:l.indexOf(i))}),s.length>500))break}return s.sort((r,l)=>l.score-r.score),s.slice(0,t)}const ec=n=>(Tn("data-v-2b0f75f6"),n=n(),Nn(),n),r4={key:0,class:"search-results",role:"listbox"},l4=["aria-selected","onMouseenter","onClick"],a4=["src"],c4={class:"search-item-text"},d4={class:"search-item-name"},h4={class:"search-item-group"},u4={key:1,class:"search-empty"},m4={class:"search-box",role:"combobox","aria-expanded":"true"},p4=ec(()=>c("span",{class:"material-icons-outlined search-icon"},"search",-1)),f4=ec(()=>c("span",{class:"material-icons-outlined"},"close",-1)),y4=[f4],b4=["aria-label","aria-expanded"],g4={class:"material-icons-outlined"},A4={__name:"SearchBar",props:{mapDataList:Array,communityParkings:{type:Array,default:()=>[]}},emits:["select"],setup(n,{emit:e}){const t=n,o=e,i=E(!1),s=E(""),r=E(-1),l=Y(()=>s.value?s4(t.mapDataList,s.value,15,t.communityParkings):[]);K(s,()=>{r.value=-1});const a=()=>{i.value=!i.value,i.value||(s.value="")},d=()=>{i.value=!1,s.value=""},m=f=>{o("select",f),d()},h=f=>{if(l.value.length)if(f.key==="ArrowDown")f.preventDefault(),r.value=(r.value+1)%l.value.length;else if(f.key==="ArrowUp")f.preventDefault(),r.value=(r.value-1+l.value.length)%l.value.length;else if(f.key==="Enter"){f.preventDefault();const b=r.value>=0?r.value:0;m(l.value[b])}else f.key==="Escape"&&d()};return(f,b)=>(v(),P("div",{class:$(["search-wrap",{open:i.value}])},[i.value&&l.value.length?(v(),P("ul",r4,[(v(!0),P(ye,null,We(l.value,(g,B)=>(v(),P("li",{key:B,class:$(["search-item",{active:B===r.value}]),role:"option","aria-selected":B===r.value,onMouseenter:D=>r.value=B,onClick:D=>m(g)},[g.icon?(v(),P("img",{key:0,src:L(J)(g.icon),class:"search-item-icon",alt:""},null,8,a4)):j("",!0),c("div",c4,[c("div",d4,S(g.name),1),c("div",h4,S(g.groupName),1)])],42,l4))),128))])):i.value&&s.value&&!l.value.length?(v(),P("div",u4," 找不到「"+S(s.value)+"」相關停車場 ",1)):j("",!0),Ke(c("div",m4,[p4,Ke(c("input",{"onUpdate:modelValue":b[0]||(b[0]=g=>s.value=g),class:"search-input",type:"text",placeholder:"搜尋停車場名稱…",autofocus:"",onKeydown:h},null,544),[[St,s.value]]),s.value?(v(),P("button",{key:0,class:"search-clear",onClick:b[1]||(b[1]=g=>s.value=""),"aria-label":"清除"},y4)):j("",!0)],512),[[wt,i.value]]),c("button",{class:$(["search-toggle",{active:i.value}]),onClick:a,"aria-label":i.value?"關閉搜尋":"開啟搜尋","aria-expanded":i.value},[c("span",g4,S(i.value?"close":"search"),1)],10,b4)],2))}},_4=rn(A4,[["__scopeId","data-v-2b0f75f6"]]),Rn=n=>(Tn("data-v-95843aaa"),n=n(),Nn(),n),v4={class:"editor-body"},P4={key:0,class:"editor-note override-note"},C4=Rn(()=>c("span",{class:"material-icons-outlined"},"edit_note",-1)),U4={key:1,class:"editor-note"},E4=Rn(()=>c("span",{class:"material-icons-outlined"},"push_pin",-1)),B4={class:"form-group"},w4={class:"form-label"},S4={key:0},I4={key:1,class:"hint-inline"},k4=["readonly","disabled"],D4={class:"form-group"},T4=Rn(()=>c("label",{class:"form-label"},"類別",-1)),N4=["value"],M4={class:"form-group"},R4={class:"form-label"},O4={key:0,class:"hint-inline"},x4=["disabled"],L4=["value"],F4={class:"form-group"},H4=Rn(()=>c("label",{class:"form-label"},"收費",-1)),z4={class:"chip-row"},V4=["onClick"],W4={key:0,class:"price-amount"},j4={class:"unit"},G4={key:1,class:"price-amount"},K4={class:"form-group"},Q4=Rn(()=>c("label",{class:"form-label"},"說明(選填)",-1)),X4={class:"form-group"},Y4=Rn(()=>c("label",{class:"form-label"},"暱稱(選填)",-1)),q4=["value"],J4={key:2,class:"error-msg"},$4={key:3,class:"form-group history-section"},Z4={class:"form-label"},em=Rn(()=>c("span",{class:"material-icons-outlined",style:{"font-size":"14px","vertical-align":"-2px"}},"history",-1)),nm={class:"history-list"},tm={class:"h-row1"},om={class:"h-by"},im={class:"h-time"},sm={key:0,class:"h-diff h-diff-note"},rm={key:1,class:"h-diff-list"},lm={class:"h-diff-label"},am={class:"h-diff-old"},cm=Rn(()=>c("span",{class:"h-diff-arrow"},"→",-1)),dm={class:"h-diff-new"},hm={key:2,class:"h-diff h-diff-note"},um=["disabled"],mm=["disabled"],pm=["disabled"],fm=["disabled"],ym={__name:"CommunityParkingEditor",props:{open:Boolean,mode:{type:String,default:"add"},initial:{type:Object,default:null},defaultCoord:{type:Array,default:()=>[121.5173399,25.0475613]},nickname:{type:String,default:""},isOwner:{type:Boolean,default:!1},isAdmin:{type:Boolean,default:!1},submitting:{type:Boolean,default:!1},hasExistingOverride:{type:Boolean,default:!1},history:{type:Array,default:()=>[]}},emits:["update:open","update:nickname","submit","delete","reset"],setup(n,{emit:e}){const t=n,o=e,i=E(""),s=E(""),r=E("motorcycle"),l=E("friendly"),a=E("free"),d=E(""),m=E(""),h=E([null,null]),f=Y(()=>ut.filter(_=>_.value)),b=Y(()=>Qt.filter(_=>_.value)),g={greenStar:"icon-14.png",friendlyShop:"icon-4.png",greenP:"icon-15.png",greyP:"icon-16.png",blueP:"icon-17.png",purpleP:"icon-18.png",redX:"icon-19.png",unknown:"icon-20.png"},B=Y(()=>{if(g[r.value])return g[r.value];const _=ut.find(le=>le.value===r.value),T=Qt.find(le=>le.value===l.value);return _?T&&_.key.find(le=>T.key.includes(le))||_.key[0]:"icon-3.png"}),D=Y(()=>!!g[r.value]);function U(_){if(!_)return{type:"free",amount:"",custom:""};const T=_.trim();if(/^free$/i.test(T))return{type:"free",amount:"",custom:""};const w=T.match(/^(\d+(?:\.\d+)?)\s*\/\s*([hd次])$/i);return w?{type:w[2].toLowerCase(),amount:w[1],custom:""}:{type:"custom",amount:"",custom:T}}function G(){return a.value==="free"?"Free":a.value==="custom"?m.value.trim():d.value?`${d.value}/${a.value}`:""}const N=()=>{if((t.mode==="edit"||t.mode==="override")&&t.initial){i.value=t.initial.name||"",s.value=t.initial.description||"",r.value=t.initial.category||"motorcycle",l.value=t.initial.friendliness||"friendly";const _=U(t.initial.priceInfo||"");a.value=_.type,d.value=_.amount,m.value=_.custom,h.value=t.initial.coordinates?[...t.initial.coordinates]:[...t.defaultCoord]}else i.value="",s.value="",r.value="motorcycle",l.value="friendly",a.value="free",d.value="",m.value="",h.value=[...t.defaultCoord]};K(()=>t.open,_=>{_&&N()});const V=E(""),Ce=()=>{if(V.value="",!i.value.trim()){V.value="請輸入名稱";return}if(h.value[0]==null||h.value[1]==null||Number.isNaN(Number(h.value[0]))||Number.isNaN(Number(h.value[1]))){V.value="座標無效";return}o("submit",{name:i.value,description:s.value,iconKey:B.value,category:r.value,friendliness:D.value?"":l.value,priceInfo:G(),coordinates:[Number(h.value[0]),Number(h.value[1])]})},ce=()=>{var _;(_=t.initial)!=null&&_.id&&window.confirm(`確定要刪除「${i.value}」?此動作無法復原。`)&&o("delete",t.initial.id)},Ie=()=>{window.confirm(`確定要重設「${i.value}」回官方原始資料嗎?
你和其他車友先前的修改將被移除。`)&&o("reset")},Ue=Y({get:()=>t.open,set:_=>o("update:open",_)}),qe=[{value:"free",label:"免費"},{value:"h",label:"計時 / 小時"},{value:"d",label:"計次 / 天"},{value:"次",label:"計次 / 不限時"},{value:"custom",label:"其他"}],me=E(!1),re=Y(()=>!t.history||t.history.length===0?[]:me.value?t.history:t.history.slice(0,5)),Te={create:"新增",update:"修改",delete:"刪除",override:"覆寫",reset:"重設"};function je(_){return Te[_]||_||"變更"}function C(_){return _?_.nickname||(_.id?`匿名#${_.id}`:"匿名"):"系統"}function R(_){if(!_||!isFinite(Number(_)))return"";const T=new Date(Number(_)),w=le=>String(le).padStart(2,"0");return`${T.getFullYear()}/${w(T.getMonth()+1)}/${w(T.getDate())} ${w(T.getHours())}:${w(T.getMinutes())}`}const X={name:"名稱",description:"說明",iconKey:"圖示",category:"類別",friendliness:"友善度",priceInfo:"收費",lng:"經度",lat:"緯度"};function W(_){if(_==null||_==="")return"(空)";if(typeof _=="number")return String(_);const T=String(_);return T.length>40?T.slice(0,40)+"…":T}function Z(_){return _==null?"":typeof _=="string"?_.trim():String(_)}function ie(_){return Z(_)===""}function Oe(_,T){if(!_||_.action==="delete"||_.action==="reset")return[];if(_.after&&typeof _.after=="object")return Object.keys(_.after).filter(O=>{var Le;const x=(Le=_.before)==null?void 0:Le[O],de=_.after[O];return!(ie(x)&&ie(de)||Z(x)===Z(de)||ie(x))}).map(O=>{var x;return{label:X[O]||O,before:W((x=_.before)==null?void 0:x[O]),after:W(_.after[O]),hasBefore:!0}});const w=_.snapshot;if(!w||typeof w!="object")return[];const le=new Set(["createdAt","createdBy","updatedAt","updatedBy","origName","origLng","origLat","history"]),Ne=t.history.findIndex(Ee=>Ee._key===_._key),xe=Ne>=0?t.history[Ne+1]:null,fn=xe?xe.after&&typeof xe.after=="object"?{...xe.before||{},...xe.after}:xe.snapshot||null:null,On=[];for(const Ee of Object.keys(w)){if(le.has(Ee))continue;const O=w[Ee];if(fn&&Object.prototype.hasOwnProperty.call(fn,Ee)){const x=fn[Ee];if(Z(x)===Z(O)||ie(x))continue;On.push({label:X[Ee]||Ee,before:W(x),after:W(O),hasBefore:!0})}}return On}function be(_){return(_==null?void 0:_.action)==="delete"?"該項目被刪除":(_==null?void 0:_.action)==="reset"?"重設為官方資料":(_==null?void 0:_.action)==="create"?"新增此停車點":""}return(_,T)=>(v(),Ki(Cn,{modelValue:Ue.value,"onUpdate:modelValue":T[9]||(T[9]=w=>Ue.value=w),title:n.mode==="override"?"修改官方停車點":n.mode==="edit"?"編輯停車場":"新增停車場",size:"md"},{footer:$e(()=>[n.mode==="edit"&&n.isOwner?(v(),P("button",{key:0,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:ce}," 刪除 ",8,um)):j("",!0),n.mode==="override"&&n.hasExistingOverride&&n.isAdmin?(v(),P("button",{key:1,class:"btn btn-danger btn-sm",disabled:n.submitting,onClick:Ie,title:"僅站方可使用"}," 重設為官方資料 ",8,mm)):j("",!0),c("button",{class:"btn btn-outline",disabled:n.submitting,onClick:T[8]||(T[8]=w=>Ue.value=!1)}," 取消 ",8,pm),c("button",{class:"btn btn-primary",disabled:n.submitting,onClick:Ce},S(n.submitting?"送出中…":n.mode==="override"||n.mode==="edit"?"儲存修改":"新增"),9,fm)]),default:$e(()=>[c("div",v4,[n.mode==="override"?(v(),P("p",P4,[C4,k(" 你正在「修改官方停車點」:這層修改只會疊加在官方資料之上,不會覆蓋原始資料。所有車友都會看到你的修改,也可以再被其他人修改或重設。 ")])):(v(),P("p",U4,[E4,k(" 共筆停車點:任何人都可以新增或修改。請確認資訊正確、避免不雅內容。 ")])),c("section",B4,[c("label",w4,[k(" 名稱 "),n.mode!=="override"?(v(),P("span",S4,"*")):j("",!0),n.mode==="override"?(v(),P("span",I4,"(官方名稱不可修改)")):j("",!0)]),Ke(c("input",{"onUpdate:modelValue":T[0]||(T[0]=w=>i.value=w),class:"form-control",type:"text",placeholder:"例:三張里地下停車場",maxlength:"60",readonly:n.mode==="override",disabled:n.mode==="override"},null,8,k4),[[St,i.value]])]),c("section",D4,[T4,Ke(c("select",{"onUpdate:modelValue":T[1]||(T[1]=w=>r.value=w),class:"form-control"},[(v(!0),P(ye,null,We(f.value,w=>(v(),P("option",{key:w.value,value:w.value},S(w.name),9,N4))),128))],512),[[Ys,r.value]])]),c("section",M4,[c("label",R4,[k(" 友善程度 "),D.value?(v(),P("span",O4,"(此類別不適用)")):j("",!0)]),Ke(c("select",{"onUpdate:modelValue":T[2]||(T[2]=w=>l.value=w),class:"form-control",disabled:D.value},[(v(!0),P(ye,null,We(b.value,w=>(v(),P("option",{key:w.value,value:w.value},S(w.name),9,L4))),128))],8,x4),[[Ys,l.value]])]),c("section",F4,[H4,c("div",z4,[(v(),P(ye,null,We(qe,w=>c("button",{key:w.value,type:"button",class:$(["chip",{active:a.value===w.value}]),onClick:le=>a.value=w.value},S(w.label),11,V4)),64))]),a.value==="h"||a.value==="d"||a.value==="次"?(v(),P("div",W4,[Ke(c("input",{"onUpdate:modelValue":T[3]||(T[3]=w=>d.value=w),type:"number",min:"0",step:"1",class:"form-control compact",placeholder:"金額"},null,512),[[St,d.value]]),c("span",j4," 元 / "+S(a.value==="h"?"小時":a.value==="d"?"天":"次 (不限時)"),1)])):a.value==="custom"?(v(),P("div",G4,[Ke(c("input",{"onUpdate:modelValue":T[4]||(T[4]=w=>m.value=w),type:"text",class:"form-control",placeholder:"如:平日 30/h、假日 50/d",maxlength:"40"},null,512),[[St,m.value]])])):j("",!0)]),c("section",K4,[Q4,Ke(c("textarea",{"onUpdate:modelValue":T[5]||(T[5]=w=>s.value=w),class:"form-control",rows:"3",placeholder:"後牌辨析、24h、注意事項...",maxlength:"500"},null,512),[[St,s.value]])]),c("section",X4,[Y4,c("input",{value:n.nickname,onInput:T[6]||(T[6]=w=>o("update:nickname",w.target.value)),class:"form-control",type:"text",placeholder:"留空將顯示「匿名#xxx-xxx」",maxlength:"20"},null,40,q4)]),V.value?(v(),P("p",J4,S(V.value),1)):j("",!0),n.history.length?(v(),P("section",$4,[c("label",Z4,[em,k(" 修改紀錄 ("+S(n.history.length)+") ",1)]),c("ul",nm,[(v(!0),P(ye,null,We(re.value,(w,le)=>(v(),P("li",{key:w._key,class:"history-item"},[c("div",tm,[c("span",{class:$(["h-action",`h-action-${w.action||"other"}`])},S(je(w.action)),3),c("span",om,S(C(w.by)),1),c("span",im,S(R(w.at)),1)]),be(w)?(v(),P("div",sm,S(be(w)),1)):Oe(w,le).length?(v(),P("ul",rm,[(v(!0),P(ye,null,We(Oe(w,le),(Ne,xe)=>(v(),P("li",{key:xe,class:"h-diff-item"},[c("span",lm,S(Ne.label),1),Ne.hasBefore?(v(),P(ye,{key:0},[c("span",am,S(Ne.before),1),cm],64)):j("",!0),c("span",dm,S(Ne.after),1)]))),128))])):(v(),P("div",hm,"(與上一筆相同)"))]))),128))]),n.history.length>5?(v(),P("button",{key:0,type:"button",class:"history-toggle",onClick:T[7]||(T[7]=w=>me.value=!me.value)},S(me.value?"收起":`顯示全部 ${n.history.length} 筆`),1)):j("",!0)])):j("",!0)])]),_:1},8,["modelValue","title"]))}},bm=rn(ym,[["__scopeId","data-v-95843aaa"]]),gm={class:"tour-card-head"},Am={class:"tour-step-index"},_m={class:"tour-title"},vm={key:0,class:"material-icons-outlined"},Pm={class:"tour-desc"},Cm={class:"tour-actions"},Um={key:0,class:"material-icons-outlined"},Em={key:1,class:"material-icons-outlined"},vn=8,Bm=12,qr=300,lo=16,wm={__name:"OnboardingTour",props:{active:{type:Boolean,default:!1},steps:{type:Array,required:!0}},emits:["update:active","finish"],setup(n,{emit:e}){const t=n,o=e,i=E(0),s=E(null),r=E(!1),l=Y(()=>t.steps[i.value]||null),a=Y(()=>i.value>=t.steps.length-1),d=async()=>{await hl();const U=l.value;if(!U){s.value=null;return}const G=U.selector?document.querySelector(U.selector):null;if(!G){s.value=null;return}const N=G.getBoundingClientRect();if(N.width===0&&N.height===0){s.value=null;return}s.value={top:N.top,left:N.left,width:N.width,height:N.height}},m=async()=>{for(let U=0;U<8;U++){if(await d(),s.value)return;await new Promise(G=>setTimeout(G,150))}};K(()=>[t.active,i.value],async([U])=>{if(!U){r.value=!1;return}r.value=!1,await m(),r.value=!0},{immediate:!0});const h=()=>d();Yn(()=>{window.addEventListener("resize",h),window.addEventListener("scroll",h,!0)}),mt(()=>{window.removeEventListener("resize",h),window.removeEventListener("scroll",h,!0)});const f=Y(()=>{const U=s.value;return U?{top:U.top-vn+"px",left:U.left-vn+"px",width:U.width+vn*2+"px",height:U.height+vn*2+"px",borderRadius:Bm+"px"}:{display:"none"}}),b=Y(()=>{var me;const U=s.value,G=window.innerWidth,N=window.innerHeight;if(!U)return{top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:Math.min(qr,G-32)+"px"};const V=((me=l.value)==null?void 0:me.placement)||"auto";let Ce=V;if(V==="auto"){const re=N-(U.top+U.height),Te=U.top;Ce=re>=Te?"bottom":"top"}const ce=Math.min(qr,G-32);let Ie,Ue,qe="";return Ce==="bottom"?(Ie=U.top+U.height+lo+vn,Ue=Math.max(16,Math.min(G-ce-16,U.left+U.width/2-ce/2))):Ce==="top"?(Ie=U.top-lo-vn,Ue=Math.max(16,Math.min(G-ce-16,U.left+U.width/2-ce/2)),qe="translateY(-100%)"):Ce==="right"?(Ie=Math.max(16,U.top+U.height/2),Ue=U.left+U.width+lo+vn,qe="translateY(-50%)"):(Ie=Math.max(16,U.top+U.height/2),Ue=U.left-lo-vn,qe="translate(-100%, -50%)"),{top:Ie+"px",left:Ue+"px",width:ce+"px",transform:qe}}),g=()=>{a.value?D():i.value+=1},B=()=>D(),D=()=>{o("update:active",!1),o("finish"),i.value=0};return K(()=>t.active,U=>{U&&(i.value=0)}),(U,G)=>n.active&&l.value?(v(),P("div",{key:0,class:$(["tour-root",{"is-ready":r.value}])},[c("div",{class:"tour-spotlight",style:po(f.value)},null,4),c("div",{class:"tour-backdrop",onClick:Qi(g,["self"])}),c("div",{class:"tour-card",style:po(b.value),role:"dialog","aria-modal":"true"},[c("div",gm,[c("span",Am,S(i.value+1)+" / "+S(n.steps.length),1),c("button",{class:"tour-skip",onClick:B,"aria-label":"略過導覽"},"略過")]),c("h3",_m,[l.value.icon?(v(),P("span",vm,S(l.value.icon),1)):j("",!0),k(" "+S(l.value.title),1)]),c("p",Pm,S(l.value.description),1),c("div",Cm,[c("button",{class:"btn btn-primary tour-next",onClick:g},[k(S(a.value?"完成":"下一步")+" ",1),a.value?(v(),P("span",Em,"check")):(v(),P("span",Um,"arrow_forward"))])])],4)],2)):j("",!0)}},Sm=rn(wm,[["__scopeId","data-v-1d730a34"]]),Un="community_parkings",Vi=E([]),nc=E(!1),Wi=E(null);let Ot=null,mi=0;function Im(){if(!(!an||Ot))try{const n=gu(Ze(Qe,Un),bu("updatedAt"));Ot=n,qa(n,e=>{const t=[];e.forEach(o=>{var s,r;const i=o.val()||{};t.push({id:o.key,name:i.name||"",description:i.description||"",iconKey:i.iconKey||"icon-3.png",category:i.category||"",friendliness:i.friendliness||"",priceInfo:i.priceInfo||"",coordinates:[(s=i.lng)!=null?s:null,(r=i.lat)!=null?r:null],createdBy:i.createdBy||null,updatedBy:i.updatedBy||null,createdAt:i.createdAt||null,updatedAt:i.updatedAt||null,history:Dm(i.history)})}),Vi.value=t.reverse(),nc.value=!0},e=>{Wi.value=e})}catch(n){Wi.value=n}}function km(){Ot&&(Ja(Ot),Ot=null)}function Dm(n){return!n||typeof n!="object"?[]:Object.entries(n).map(([e,t])=>({...t||{},_key:e})).sort((e,t)=>e._key<t._key?1:e._key>t._key?-1:0)}function Tm(){return Yn(()=>{mi+=1,Im()}),mt(()=>{mi-=1,mi<=0&&km()}),{items:Vi,ready:nc,error:Wi,addParking:async(o,i)=>{var f,b,g;if(!an)throw new Error("Firebase 尚未設定");const[s,r]=o.coordinates,a=co(Ze(Qe,Un)).key,d={id:i.id,nickname:i.nickname||""},m={name:((f=o.name)==null?void 0:f.trim())||"",description:((b=o.description)==null?void 0:b.trim())||"",iconKey:o.iconKey||"icon-3.png",category:o.category||"",friendliness:o.friendliness||"",priceInfo:((g=o.priceInfo)==null?void 0:g.trim())||"",lng:Number(s),lat:Number(r),createdBy:d,createdAt:Vn(),updatedBy:d,updatedAt:Vn()},h=co(Ze(Qe,`${Un}/${a}/history`)).key;return await Li(Ze(Qe),{[`${Un}/${a}`]:{...m,history:{[h]:{action:"create",at:Vn(),by:d,snapshot:m}}}}),a},updateParking:async(o,i,s)=>{var g,B,D,U,G;if(!an)throw new Error("Firebase 尚未設定");const r={id:s.id,nickname:s.nickname||""},l=Vi.value.find(N=>N.id===o)||{},a={};if(i.name!==void 0&&(a.name=((g=i.name)==null?void 0:g.trim())||""),i.description!==void 0&&(a.description=((B=i.description)==null?void 0:B.trim())||""),i.iconKey!==void 0&&(a.iconKey=i.iconKey),i.category!==void 0&&(a.category=i.category),i.friendliness!==void 0&&(a.friendliness=i.friendliness),i.priceInfo!==void 0&&(a.priceInfo=((D=i.priceInfo)==null?void 0:D.trim())||""),i.coordinates){const[N,V]=i.coordinates;a.lng=Number(N),a.lat=Number(V)}const d={},m={};for(const N of Object.keys(a)){let V;N==="lng"?V=(U=l.coordinates)==null?void 0:U[0]:N==="lat"?V=(G=l.coordinates)==null?void 0:G[1]:V=l[N];const Ce=V==null?"":V,ce=a[N]===void 0||a[N]===null?"":a[N];Ce!==ce&&(d[N]=V!=null?V:"",m[N]=a[N])}const h={...a,updatedBy:r,updatedAt:Vn()},f=co(Ze(Qe,`${Un}/${o}/history`)).key,b={};for(const N of Object.keys(h))b[`${Un}/${o}/${N}`]=h[N];return b[`${Un}/${o}/history/${f}`]={action:"update",at:Vn(),by:r,before:d,after:m},Li(Ze(Qe),b)},deleteParking:async o=>{if(!an)throw new Error("Firebase 尚未設定");return Ya(Ze(Qe,`${Un}/${o}`))}}}var Nm={VITE_FIREBASE_DATABASE_URL:"https://findparkinglot-2519e-default-rtdb.asia-southeast1.firebasedatabase.app",VITE_FIREBASE_MESSAGING_SENDER_ID:"976769533420",VITE_FIREBASE_MEASUREMENT_ID:"G-XMR8C87T1P",VITE_FIREBASE_STORAGE_BUCKET:"findparkinglot-2519e.firebasestorage.app",VITE_FIREBASE_AUTH_DOMAIN:"findparkinglot-2519e.firebaseapp.com",VITE_MAPBOX_TOKEN:"pk.eyJ1IjoiamFtZXN0aW05MjE1IiwiYSI6ImNrdmo2Y2I4aDVmejEzMm1zbThsdGdoajAifQ.UfBJAI7fFsv2wcAEBo6WUA",VITE_FIREBASE_PROJECT_ID:"findparkinglot-2519e",VITE_FIREBASE_APP_ID:"1:976769533420:web:f3108318b3def30017acc9",VITE_FIREBASE_API_KEY:"AIzaSyBoxwl4suSMEJu78PJBz51DsX3Tbd_wuqs",BASE_URL:"./",MODE:"production",DEV:!1,PROD:!0,SSR:!1};const tc="community_user_id",oc="community_user_nickname",Mm="community_is_admin",Rm=String(Nm.VITE_ADMIN_USER_IDS||"").split(",").map(n=>n.trim()).filter(Boolean);function Om(){const n=e=>Array.from(crypto.getRandomValues(new Uint8Array(e))).map(t=>t.toString(16).padStart(2,"0")).join("");return`${n(2)}-${n(2)}`}let mo=nn.get(tc);mo||(mo=Om(),nn.set(tc,mo));const ji=mo,Gi=E(nn.get(oc)||""),xm=Rm.includes(ji)||nn.get(Mm)==="1";K(Gi,n=>nn.set(oc,n||""));function Lm(){return{userId:ji,nickname:Gi,displayName:()=>{var e;return((e=Gi.value)==null?void 0:e.trim())||`匿名#${ji}`},isAdmin:xm}}const Fm=()=>typeof window!="undefined"&&typeof window.gtag=="function",fe=(n,e={})=>{if(Fm())try{window.gtag("event",n,e)}catch(t){}},I=n=>(Tn("data-v-19f2d019"),n=n(),Nn(),n),Hm={class:"app-title"},zm=["aria-label","aria-expanded"],Vm={class:"material-icons-outlined"},Wm={key:1,class:"title-logo",src:Xi,alt:"重機能停哪"},jm=I(()=>c("h1",null,"重機能停哪?",-1)),Gm=I(()=>c("pre",{id:"coordinates",class:"coordinates"},null,-1)),Km=I(()=>c("h4",{class:"modal-section-title"},"圖案代表甚麼格位",-1)),Qm={class:"legend-list"},Xm={class:"legend-row"},Ym=["src"],qm={class:"legend-row"},Jm=["src"],$m={class:"legend-row"},Zm=["src"],ep={class:"legend-row"},np=["src"],tp={class:"legend-row"},op=["src"],ip={class:"legend-row"},sp=["src"],rp={class:"legend-row"},lp=["src"],ap={class:"legend-row"},cp=["src"],dp={class:"legend-row"},hp=["src"],up={class:"legend-row"},mp=["src"],pp={class:"legend-row"},fp=["src"],yp=I(()=>c("h4",{class:"modal-section-title"},"顏色代表入場方式",-1)),bp={class:"legend-list"},gp={class:"legend-row"},Ap=["src"],_p=["src"],vp=["src"],Pp={class:"legend-row"},Cp=["src"],Up=["src"],Ep=["src"],Bp={class:"legend-row"},wp=["src"],Sp=["src"],Ip=["src"],kp={class:"legend-row"},Dp=["src"],Tp=["src"],Np=["src"],Mp=I(()=>c("h4",{class:"modal-section-title"},"名稱前有價錢",-1)),Rp={class:"legend-list"},Op={class:"legend-row"},xp=["src"],Lp=I(()=>c("div",{class:"legend-row"},[c("div",{class:"legend-text"},[k(" ・數字:金額,時段費率複雜會以最高收費標示"),c("br"),k(" ・d/h:d 為計次,h 為計時"),c("br"),k(" ・Free 代表免費 ")])],-1)),Fp={class:"share-grid"},Hp=I(()=>c("img",{src:ml,alt:""},null,-1)),zp=I(()=>c("span",null,"Facebook",-1)),Vp=[Hp,zp],Wp=I(()=>c("img",{src:pl,alt:""},null,-1)),jp=I(()=>c("span",null,"LINE",-1)),Gp=[Wp,jp],Kp=I(()=>c("img",{src:fl,alt:""},null,-1)),Qp=I(()=>c("span",null,"Twitter",-1)),Xp=[Kp,Qp],Yp=I(()=>c("img",{src:yl,alt:""},null,-1)),qp=I(()=>c("span",null,"複製連結",-1)),Jp=[Yp,qp],$p={class:"modal-hint",style:{"word-break":"break-all"}},Zp={class:"share-grid"},ef=I(()=>c("img",{src:ml,alt:""},null,-1)),nf=I(()=>c("span",null,"Facebook",-1)),tf=[ef,nf],of=I(()=>c("img",{src:pl,alt:""},null,-1)),sf=I(()=>c("span",null,"LINE",-1)),rf=[of,sf],lf=I(()=>c("img",{src:fl,alt:""},null,-1)),af=I(()=>c("span",null,"Twitter",-1)),cf=[lf,af],df=I(()=>c("img",{src:yl,alt:""},null,-1)),hf=I(()=>c("span",null,"複製連結",-1)),uf=[df,hf],mf=I(()=>c("p",{class:"modal-hint"}," 若覺得本站有幫助，歡迎透過以下連結請我喝一杯咖啡，讓我有動力繼續維護更新！ ",-1)),pf={class:"support-list"},ff=["onClick"],yf={class:"material-icons-outlined support-btn-icon"},bf={class:"support-btn-body"},gf={class:"support-btn-label"},Af={key:0,class:"support-btn-badge"},_f={class:"support-btn-desc"},vf=I(()=>c("span",{class:"material-icons-outlined support-btn-arrow"},"open_in_new",-1)),Pf={class:"os-tabs",role:"tablist","aria-label":"作業系統"},Cf=["aria-selected"],Uf=I(()=>c("span",{class:"material-icons-outlined"},"phone_iphone",-1)),Ef=["aria-selected"],Bf=I(()=>c("span",{class:"material-icons-outlined"},"android",-1)),wf=I(()=>c("p",{class:"modal-hint"},"以下以 iOS Safari 為範例",-1)),Sf=I(()=>c("h4",{class:"modal-section-title"},"1. 使用 Safari 開啟網站並點擊下方分享按鈕",-1)),If=I(()=>c("img",{class:"full-img",src:Oc,alt:""},null,-1)),kf=I(()=>c("h4",{class:"modal-section-title"},"2. 點選「加入主畫面」",-1)),Df=I(()=>c("img",{class:"full-img",src:xc,alt:""},null,-1)),Tf=I(()=>c("h4",{class:"modal-section-title"},"3. 確認名稱後按「加入」",-1)),Nf=I(()=>c("img",{class:"full-img",src:Lc,alt:""},null,-1)),Mf=I(()=>c("h4",{class:"modal-section-title"},"4. 完成,圖示已加到主畫面",-1)),Rf=I(()=>c("img",{class:"full-img",src:Fc,alt:""},null,-1)),Of=I(()=>c("h4",{class:"modal-section-title"},"5. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),xf=I(()=>c("img",{class:"full-img",src:Hc,alt:""},null,-1)),Lf=I(()=>c("p",{class:"modal-hint"},"以下以 Android Chrome 為範例",-1)),Ff=I(()=>c("h4",{class:"modal-section-title"},"1. 使用 Chrome 開啟網站並點擊右上角選單，點選「加到主畫面」",-1)),Hf=I(()=>c("img",{class:"full-img",src:zc,alt:""},null,-1)),zf=I(()=>c("h4",{class:"modal-section-title"},"2. 點選「安裝」",-1)),Vf=I(()=>c("img",{class:"full-img",src:Vc,alt:""},null,-1)),Wf=I(()=>c("h4",{class:"modal-section-title"},"3. 完成,圖示已加到主畫面",-1)),jf=I(()=>c("img",{class:"full-img",src:Wc,alt:""},null,-1)),Gf=I(()=>c("h4",{class:"modal-section-title"},"4. 點擊即可開啟,享受無瀏覽器網址列的體驗",-1)),Kf=I(()=>c("img",{class:"full-img",src:jc,alt:""},null,-1)),Qf=I(()=>c("div",{class:"welcome-logo-wrap"},[c("img",{class:"welcome-logo",src:Xi,alt:"重機能停哪"})],-1)),Xf=I(()=>c("div",{class:"welcome-badge"},"✨ 全新介面上線",-1)),Yf=I(()=>c("p",{class:"welcome-text"}," 這是一個提供重機停車資訊的地圖，你可以依據「友善程度」「停車格類型」「收費範圍」尋找合適的停車場，並一鍵開啟 Google 或 Apple Map 導航。 ",-1)),qf=I(()=>c("div",{class:"whatsnew-card"},[c("div",{class:"whatsnew-title"},[c("span",{class:"material-icons-outlined"},"auto_awesome"),k(" 本次新功能 ")]),c("ul",{class:"whatsnew-list"},[c("li",null,[c("span",{class:"material-icons-outlined"},"tune"),c("span",null,[c("strong",null,"顯示分類切換"),c("br"),k(" 設定頁新增「官方 / 修改 / 共筆」三個開關,可依需求快速隱藏或顯示對應來源的停車點")])]),c("li",null,[c("span",{class:"material-icons-outlined"},"tag"),c("span",null,[c("strong",null,"各分類即時筆數"),c("br"),k(" 每個分類旁會顯示對應停車場資料筆數")])])])],-1)),Jf=I(()=>c("p",{class:"welcome-text"},[k(" 資料取源於: "),c("a",{href:"https://www.google.com/maps/d/viewer?mid=1ORD5DnL6yqrCrtQJYB9TeTgOOlvo-Yc&g_ep=CAESBjI2LjguNRgAIN1iKpUBLDk0MjY3NzI3LDk0MjkyMTk1LDk0Mjk5NTMyLDEwMDc5NjQ5OCwxMDA3OTc3NTcsMTAwNzk2NTMxLDk0MjgwNTc2LDk0MjA3Mzk0LDk0MjA3NTA2LDk0MjA4NTA2LDk0MjE4NjUzLDk0MjI5ODM5LDk0Mjc1MTY4LDk0Mjc5NjE5LDEwMDc5MjU3MiwxMDA3OTE0ODNCAlRX&skid=9984dc32-0eac-4e02-b7a8-241e8910f915&shorturl=1&ll=25.078951126084913%2C121.45397636318671&z=11",target:"_blank",rel:"noopener",class:"link"},"Alan大重停車記事"),k("，如有停車場相關問題請至該頁面填寫回報表單。 ")],-1)),$f=I(()=>c("p",{class:"welcome-text"},' 公告: 原始資料"大重停車記事已無更新" 已改由 Alan大重停車記事 提供，感謝Alan的辛苦整理與分享！ ',-1)),Zf=I(()=>c("p",{class:"welcome-text"},[k(" 本站僅提供資料整合服務，地圖免費提供車友使用，資料不定期更新；若發生無法使用情況，請至 "),c("a",{href:"https://forms.gle/iJCyfqVtpL35WtZM7",target:"_blank",rel:"noopener",class:"link"},"錯誤資訊回報"),k("，也歡迎贊助讓我有動力繼續更新。 ")],-1)),e6=I(()=>c("p",{class:"welcome-text right"},"— by 爽爽",-1)),n6={key:0,class:"pick-crosshair","aria-hidden":"true"},t6=I(()=>c("span",{class:"material-icons-outlined dot"},"gps_fixed",-1)),o6=[t6],i6={key:1,class:"pick-banner"},s6=I(()=>c("span",{class:"pick-banner-text"},[c("span",{class:"material-icons-outlined"},"touch_app"),k(" 拖動地圖，將十字線對準目標位置 ")],-1)),r6=I(()=>c("span",{class:"material-icons-outlined"},"check",-1)),l6=I(()=>c("p",{class:"welcome-text"},[c("strong",{style:{color:"var(--primary)"}},"這是一個公開共享的「共筆停車點」區。"),k(" 除了官方收錄的「大重停車記事」資料外,任何人都可以新增、修改、補充停車位置——不需要註冊、不需要審核。 ")],-1)),a6=I(()=>c("h4",{class:"modal-section-title"},"如何新增停車位置",-1)),c6=I(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"點左下角的「共筆停車點」按鈕,再點「新增停車位置」"),c("li",null,"畫面中心會出現青色十字游標,拖動地圖將游標對準目標位置"),c("li",null,"按頂部「使用此位置」,填寫名稱、類別、友善程度、收費等資料"),c("li",null,"按「新增」即完成(座標已自動記錄,圖示會依類別自動套用)")],-1)),d6=I(()=>c("h4",{class:"modal-section-title"},"如何編輯他人新增的位置",-1)),h6=I(()=>c("ol",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"地圖上「薰衣草紫色底」的標記即為使用者新增的「共筆停車點」"),c("li",null,"點擊該標記,在資訊面板按「編輯」"),c("li",null,"修改後按「儲存修改」")],-1)),u6=I(()=>c("h4",{class:"modal-section-title"},"注意事項",-1)),m6=I(()=>c("ul",{class:"welcome-text",style:{"padding-left":"22px","line-height":"1.9"}},[c("li",null,"請確認資訊正確,避免造成他人困擾"),c("li",null,"不要新增不雅、惡意或無關內容"),c("li",null,"暱稱可選填,留空將顯示為「匿名#xxx-xxx」"),c("li",null,"站方保留必要時清空所有「共筆停車點」資料的權利")],-1)),Jr="onboarding_tour_v1",$r="filters_v1",p6="https://findparkinglot.github.io/",f6={__name:"App",setup(n){var js,Gs,Ks;const e=navigator.userAgent,t=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(e),o=/iPhone|iPad|iPod/i.test(e),i=/Android/i.test(e),s=E([]),r=()=>{var u;return!!((u=window.matchMedia)!=null&&u.call(window,"(prefers-color-scheme: light)").matches)},l=u=>{var p;if(u==="system"){const y=r()?"light":"dark";return(p=tt.find(pe=>pe.theme===y))==null?void 0:p.value}return u},a=tt.find(u=>u.name===nn.get("mapStyles")),d=(a==null?void 0:a.value)||((js=tt.find(u=>u.theme==="dark"))==null?void 0:js.value),m=E(d),h=E({getLngLat:!1,mapStylesSelected:l(d)}),f=u=>{const p=l(u);h.value.mapStylesSelected=p;const y=tt.find(ue=>ue.value===p),pe=(y==null?void 0:y.theme)==="light";document.body.classList.toggle("light-theme",pe),document.body.classList.toggle("dark-theme",!pe);const Ve=tt.find(ue=>ue.value===u);Ve&&nn.set("mapStyles",Ve.name)};f(m.value),K(m,f);const b=(Gs=window.matchMedia)==null?void 0:Gs.call(window,"(prefers-color-scheme: light)");(Ks=b==null?void 0:b.addEventListener)==null||Ks.call(b,"change",()=>{m.value==="system"&&f("system")});const g=E(!0),B=E(!1),D=E(i?"android":"ios"),U=E(!1),G=E(!1),N=E(!1),V=E(!1),Ce=E(!1),ce=[{selector:".mapboxgl-ctrl-geolocate",icon:"my_location",title:"定位你的位置",description:"點右上角的定位按鈕,地圖會自動移到你目前位置,並追蹤方向。"},{selector:".fab-placement-right > .fab-main",icon:"help_outline",title:"功能與教學",description:"右下角的圓形按鈕展開後,可看到「地圖怎麼看」、「加到手機桌面」、「分享」等功能。"},{selector:".search-toggle",icon:"search",title:"搜尋停車點",description:"右下角的搜尋按鈕可依名稱快速找到想去的停車場,點選結果會自動飛到該位置並開啟資訊。"},{selector:".app-title .title-toggle",icon:"menu",title:"篩選與我的最愛",description:"左上角選單可以調整停車類型、友善程度、收費範圍,以及只顯示我的最愛、切換主題。"},{selector:".fab-placement-left > .fab-main",icon:"add_location_alt",title:"共筆停車點",description:"左下角按鈕可新增/編輯共筆停車點,大家一起分享真實的停車資訊。"}],Ie=()=>{Ce.value=!0,fe("onboarding_tour_start")},Ue=()=>{try{localStorage.setItem(Jr,"1")}catch(u){}fe("onboarding_tour_finish")},qe=()=>{g.value=!1},me=E(!1),re=E(!1),Te=E(!1),je=u=>{u!=="menu"&&(me.value=!1),u!=="info"&&(re.value=!1),u!=="message"&&(g.value=!1),u!=="mobileFAQ"&&(B.value=!1),u!=="faq"&&(U.value=!1),u!=="share"&&(G.value=!1),u!=="communityHelp"&&(N.value=!1),u!=="support"&&(V.value=!1),fe("panel_open",{panel:u})};K(me,u=>u&&je("menu")),K(re,u=>u&&je("info")),K(g,u=>u&&je("message")),K(B,u=>u&&je("mobileFAQ")),K(B,u=>{u&&(i?D.value="android":o&&(D.value="ios"))}),K(U,u=>u&&je("faq")),K(G,u=>u&&je("share")),K(N,u=>u&&je("communityHelp")),K(V,u=>u&&je("support"));const C=[{key:"buymeacoffee",url:"https://buymeacoffee.com/jamestim923",label:"Buy Me a Coffee",description:"請我喝杯咖啡 ☕️ (美金贊助)",icon:"local_cafe",primary:!1}],R=()=>{V.value=!0,fe("support_open")},X=u=>{fe("support_click",{provider:u.key}),window.open(u.url,"_blank","noopener,noreferrer")},W=nn.getJSON($r,{})||{},Z=E(typeof W.parkingType=="string"?W.parkingType:""),ie=E(typeof W.degreeOfFriendliness=="string"?W.degreeOfFriendliness:""),Oe=E(typeof W.parkingPriceType=="string"?W.parkingPriceType:""),be=E(typeof W.priceRangeMin=="number"?W.priceRangeMin:0),_=E(typeof W.priceRangeMax=="number"?W.priceRangeMax:100),T=E(W.showOfficial!==!1),w=E(W.showOverridden!==!1),le=E(W.showCommunity!==!1),{favorites:Ne,favoriteIdSet:xe,isFavorite:fn,toggleFavorite:On}=Sd(),Ee=E(W.onlyFavorites===!0);K([Z,ie,Oe,be,_,Ee,T,w,le],([u,p,y,pe,Ve,ue,An,_n,io])=>{nn.setJSON($r,{parkingType:u,degreeOfFriendliness:p,parkingPriceType:y,priceRangeMin:pe,priceRangeMax:Ve,onlyFavorites:ue,showOfficial:An,showOverridden:_n,showCommunity:io})});const O=E("driving"),{items:x,addParking:de,updateParking:Le,deleteParking:Fe}=Tm(),{userId:he,nickname:He,isAdmin:ke}=Lm(),xn=E(null),{overrides:eo,getOverride:Qo,getOverrideHistory:no,upsertOverride:ic,resetOverride:sc}=Mu(),Os=Y(()=>new Set(Object.keys(eo.value||{}))),rc=Y(()=>(s.value||[]).reduce((u,p)=>{var y;return u+(((y=p==null?void 0:p.features)==null?void 0:y.length)||0)},0)),lc=Y(()=>Os.value.size),ac=Y(()=>(x.value||[]).length),Je=E(!1),yn=E("add"),bn=E(null),dn=E(!1),gt=E([121.5173399,25.0475613]),xs=E(!1),ln=E(!1),Xo=E(!1),Ls=Y(()=>!re.value&&!Te.value&&!ln.value&&!Je.value),Fs=()=>{Xo.value&&Ls.value&&(Xo.value=!1,Ie())};K(g,(u,p)=>{if(p&&!u)try{localStorage.getItem(Jr)||(Xo.value=!0,setTimeout(Fs,350))}catch(y){}}),K(Ls,u=>{u&&setTimeout(Fs,200)});const cc=Y(()=>{var u;if(!Je.value)return[];if(yn.value==="override")return Ge.value?no(Ge.value.name,Ge.value.geometry):[];if(yn.value==="edit"&&((u=bn.value)!=null&&u.id)){const p=(x.value||[]).find(y=>y.id===bn.value.id);return(p==null?void 0:p.history)||[]}return[]}),ze=E(null),dc=()=>{if(!an){alert("「共筆停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}ln.value=!0,fe("community_add_start")},hc=()=>{var p,y;const u=((y=(p=xn.value)==null?void 0:p.getCenter)==null?void 0:y.call(p))||[121.5173399,25.0475613];gt.value=u,yn.value="add",bn.value=null,ln.value=!1,Je.value=!0},uc=()=>{ln.value=!1},mc=u=>{var p,y;gt.value=u.coordinates?[...u.coordinates]:((y=(p=xn.value)==null?void 0:p.getCenter)==null?void 0:y.call(p))||[121.5173399,25.0475613],yn.value="edit",bn.value=u,Je.value=!0},Yo=u=>{ze.value=u,Zn({name:"共筆停車點",properties:{name:u.name,description:u.description,icon:u.iconKey,priceInfo:u.priceInfo,priceArray:[]},geometry:u.coordinates,address:""})},pc=()=>{ze.value&&(re.value=!1,mc(ze.value))},fc=()=>{if(!an){alert("「修改官方停車點」功能尚未設定。請讓站方設定 Firebase 後再試。");return}if(!Ge.value)return;const u=Ge.value,p=to.value,y={id:null,name:u.name,description:(p==null?void 0:p.description)||u.description,iconKey:(p==null?void 0:p.iconKey)||u.iconKey,category:(p==null?void 0:p.category)||yc(u.iconKey),friendliness:(p==null?void 0:p.friendliness)||bc(u.iconKey),priceInfo:(p==null?void 0:p.priceInfo)||u.priceInfo,coordinates:u.geometry?[...u.geometry]:[...gt.value]};gt.value=y.coordinates,yn.value="override",bn.value=y,xs.value=!!p,re.value=!1,Je.value=!0,fe("override_edit_start",{name:u.name})};function yc(u){if(!u)return"motorcycle";const p=ut.find(y=>y.value&&y.key.includes(u));return(p==null?void 0:p.value)||"motorcycle"}function bc(u){if(!u)return"friendly";const p=Qt.find(y=>y.value&&y.key.includes(u));return(p==null?void 0:p.value)||"friendly"}const gc=async u=>{if(Ge.value){dn.value=!0;try{const p={id:he,nickname:He.value};await ic(Ge.value,u,p),fe("override_submit",{name:Ge.value.name});const y=Ge.value;Je.value=!1,Zn({name:y.parkingType,properties:{name:y.name,description:y.description,icon:y.iconKey,priceInfo:y.priceInfo,priceArray:[]},geometry:y.geometry,address:ee.value.address})}catch(p){alert("儲存失敗:"+((p==null?void 0:p.message)||p))}finally{dn.value=!1}}},Ac=async()=>{if(Ge.value){dn.value=!0;try{const u=Ge.value,p={id:he,nickname:He.value};await sc(u.name,u.geometry,p),fe("override_reset",{name:u.name}),Je.value=!1,Zn({name:u.parkingType,properties:{name:u.name,description:u.description,icon:u.iconKey,priceInfo:u.priceInfo,priceArray:[]},geometry:u.geometry,address:ee.value.address})}catch(u){alert("重設失敗:"+((u==null?void 0:u.message)||u))}finally{dn.value=!1}}},_c=async u=>{var p;dn.value=!0;try{const y={id:he,nickname:He.value};yn.value==="edit"&&((p=bn.value)!=null&&p.id)?(await Le(bn.value.id,u,y),fe("community_edit_submit",{name:u==null?void 0:u.name})):(await de(u,y),fe("community_add_submit",{name:u==null?void 0:u.name})),Je.value=!1,ze.value=null}catch(y){alert("儲存失敗:"+((y==null?void 0:y.message)||y))}finally{dn.value=!1}},vc=async u=>{dn.value=!0;try{const p={id:he,nickname:He.value};await Fe(u,p),fe("community_delete",{id:u}),Je.value=!1,ze.value=null}catch(p){alert("刪除失敗:"+((p==null?void 0:p.message)||p))}finally{dn.value=!1}},qo=Y(()=>{var p,y;if(!ze.value||!ee.value.parkingName)return!1;const u=ze.value;return u.name===ee.value.parkingName&&Array.isArray(ee.value.geometry)&&((p=u.coordinates)==null?void 0:p[0])===ee.value.geometry[0]&&((y=u.coordinates)==null?void 0:y[1])===ee.value.geometry[1]});K(re,u=>{u||(ze.value=null)});const At=E(null),Pc=Y(()=>{var u;return((u=ut.find(p=>p.value===Z.value))==null?void 0:u.key)||[]}),Cc=Y(()=>{var u;return((u=Qt.find(p=>p.value===ie.value))==null?void 0:u.key)||[]}),ee=E({parkingName:"",parkingNameDes:"",parkingType:"",parkingIcon:"",parkingIconKey:"",iconCategory:"",priceInfo:"",geometry:[null,null],address:"",sourceLabel:""}),Ge=E(null),to=E(null),Hs=Y(()=>yi(ee.value.parkingName,ee.value.geometry)),zs=Y(()=>fn(Hs.value)),Zn=u=>{var An,_n,io,Qs,Xs;const p=u.properties.icon,y={name:u.properties.name,description:u.properties.description,iconKey:p,priceInfo:u.properties.priceInfo||"",geometry:u.geometry,parkingType:u.name},pe=!!(ze.value&&ze.value.name===u.properties.name&&Array.isArray(u.geometry)&&((An=ze.value.coordinates)==null?void 0:An[0])===u.geometry[0]&&((_n=ze.value.coordinates)==null?void 0:_n[1])===u.geometry[1]);let Ve=null,ue=y;pe||(Ve=Qo(y.name,y.geometry),Ve&&(ue=Za(y,Ve))),Ge.value=pe?null:y,to.value=Ve,ee.value={parkingName:ue.name,parkingNameDes:ue.description,parkingType:y.parkingType,iconCategory:Zu(ue.iconKey),parkingIcon:J(ue.iconKey),parkingIconKey:ue.iconKey,priceInfo:ue.priceInfo||"",geometry:u.geometry,address:u.address,sourceLabel:pe?"":bd((io=u.properties)==null?void 0:io.sourceFolderIndex)},re.value=!0,fe("parking_view",{parking_name:(Qs=u.properties)==null?void 0:Qs.name,parking_type:u.name,icon:(Xs=u.properties)==null?void 0:Xs.icon,overridden:!!Ve})},Uc=()=>{if(!ee.value.parkingName)return;const u=!zs.value;On({id:Hs.value,name:ee.value.parkingName,parkingType:ee.value.parkingType,geometry:ee.value.geometry,address:ee.value.address,icon:ee.value.parkingIconKey}),fe(u?"favorite_add":"favorite_remove",{parking_name:ee.value.parkingName,parking_type:ee.value.parkingType})},Ec=u=>"",Bc=u=>{var p;u.isCommunity&&u.community?Yo(u.community):Zn({name:u.groupName,properties:u.properties,geometry:u.geometry,address:Ec(u.geometry)}),At.value=[...u.geometry],fe("search_select",{parking_name:(p=u.properties)==null?void 0:p.name,group:u.groupName,community:!!u.isCommunity})},_t=E(null),vt=E(null),wc=u=>{O.value="driving",_t.value=u,re.value=!1,vt.value=null,fe("route_start",{parking_name:ee.value.parkingName,profile:"driving"})},Sc=()=>{_t.value=null,Te.value=!1};K(vt,u=>{Te.value=u!==null});const Ic=u=>{const p=ee.value.geometry;let y="";u==="apple"?y=`https://maps.apple.com/?daddr=${p[1]},${p[0]}&dirflg=d&t=m`:u==="google"&&(y=`https://www.google.com/maps/dir/?api=1&destination=${p[1]},${p[0]}&travelmode=driving`),y&&(fe("open_external_map",{provider:u,parking_name:ee.value.parkingName}),window.open(y,"_blank","noopener,noreferrer"))},gn=(u,p=null)=>{const y=p||"https://findparkinglot.github.io/";let pe="";u==="facebook"?pe=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(y)}`:u==="line"?pe=`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(y)}`:u==="twitter"&&(pe=`https://twitter.com/share?url=${encodeURIComponent(y)}`),fe("share",{method:u,scope:p?"spot":"site"}),u==="link"?navigator.clipboard.writeText(y).then(()=>alert("已複製連結"),()=>alert("複製失敗")):window.open(pe,"","menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600")},Vs=()=>{const u=ee.value.geometry;if(!Array.isArray(u)||u[0]==null||u[1]==null)return"";const p=new URLSearchParams({lng:Number(u[0]).toFixed(6),lat:Number(u[1]).toFixed(6)});return`${p6}?${p.toString()}`},kc=()=>{const u=Vs();u&&(et.value=u,$o.value=ee.value.parkingName||"停車點",Jo.value=!0,fe("share_spot_open",{name:$o.value}))},Jo=E(!1),et=E(""),$o=E("");K([re,ee],()=>{try{if(!re.value){window.location.search&&window.history.replaceState({},"",window.location.pathname);return}const u=Vs();if(!u)return;const p=u.slice(u.indexOf("?"));window.history.replaceState({},"",window.location.pathname+p)}catch(u){}},{deep:!0});const Pt=E(null),oo=(u,p)=>Math.abs(Number(u)-Number(p))<1e-5,Zo=()=>{var Ve;const u=Pt.value;if(!u)return;const p=Number(u.lng),y=Number(u.lat);if(!isFinite(p)||!isFinite(y)){Pt.value=null;return}const pe=(x.value||[]).find(ue=>ue.coordinates&&oo(ue.coordinates[0],p)&&oo(ue.coordinates[1],y));if(pe){Yo(pe),At.value=[p,y],Pt.value=null;return}for(const ue of s.value||[])for(const An of ue.features||[]){const _n=(Ve=An.geometry)==null?void 0:Ve.coordinates;if(_n&&oo(_n[0],p)&&oo(_n[1],y)){Zn({name:ue.name,properties:An.properties,geometry:An.geometry.coordinates,address:""}),At.value=[p,y],Pt.value=null;return}}Array.isArray(s.value)&&s.value.length>0&&(At.value=[p,y])},Ws=()=>{try{const u=new URLSearchParams(window.location.search),p=u.get("lng"),y=u.get("lat");if(!p||!y)return;Pt.value={lng:p,lat:y},Zo()}catch(u){}};K(x,Zo,{deep:!1}),K(s,Zo,{deep:!1}),Yn(()=>{s.value=Ed(fd()),g.value||Ws()}),K(g,(u,p)=>{p&&!u&&Ws()});const Dc=Y(()=>[{key:"share",icon:"share",label:"分享",highlight:!0,onClick:()=>G.value=!0},{key:"howto",icon:"help_outline",label:"怎麼用",onClick:Ie},{key:"faq",icon:"map",label:"地圖怎麼看",onClick:()=>U.value=!0},{key:"mobile",icon:"add_to_home_screen",label:"加到手機桌面",onClick:()=>B.value=!0}]),Tc=Y(()=>[{key:"add",icon:"add_location_alt",label:"新增停車位置",highlight:!0,onClick:dc},{key:"help",icon:"menu_book",label:"編輯教學",onClick:()=>N.value=!0}]);return(u,p)=>(v(),P(ye,null,[c("div",Hm,[ln.value?(v(),P("img",Wm)):(v(),P("button",{key:0,class:"title-toggle",onClick:p[0]||(p[0]=y=>me.value=!me.value),"aria-label":me.value?"收合設定":"開啟設定","aria-expanded":me.value},[c("span",Vm,S(me.value?"close":"menu"),1)],8,zm)),jm]),Ke(Be(Yr,{items:Dc.value},null,8,["items"]),[[wt,!Te.value&&!re.value&&!ln.value]]),Ke(Be(Yr,{items:Tc.value,placement:"left","main-icon":"add_location_alt","main-label":"共筆停車點"},null,8,["items"]),[[wt,!Te.value&&!re.value&&!ln.value]]),Ke(Be(_4,{"map-data-list":s.value,"community-parkings":L(x),onSelect:Bc},null,8,["map-data-list","community-parkings"]),[[wt,!Te.value&&!re.value&&!ln.value]]),Gm,Be(Fu,{ref_key:"mapBoxRef",ref:xn,parkingTypeKeyArray:Pc.value,degreeOfFriendlinessKeyArray:Cc.value,mapDataList:s.value,getLngLat:h.value.getLngLat,mapStylesSelected:h.value.mapStylesSelected,parkingPriceType:Oe.value,priceRangeMin:be.value,priceRangeMax:_.value,"favorite-ids":L(xe),"override-keys":Os.value,overrides:L(eo),"only-favorites":Ee.value,"show-official":T.value,"show-overridden":w.value,"show-community":le.value,"focus-coord":At.value,"route-profile":O.value,"community-parkings":L(x),goToParkingPlaceData:_t.value,"onUpdate:goToParkingPlaceData":p[1]||(p[1]=y=>_t.value=y),routeData:vt.value,"onUpdate:routeData":p[2]||(p[2]=y=>vt.value=y),onParkingInfo:Zn,onCommunityParkingClick:Yo},null,8,["parkingTypeKeyArray","degreeOfFriendlinessKeyArray","mapDataList","getLngLat","mapStylesSelected","parkingPriceType","priceRangeMin","priceRangeMax","favorite-ids","override-keys","overrides","only-favorites","show-official","show-overridden","show-community","focus-coord","route-profile","community-parkings","goToParkingPlaceData","routeData"]),Be(i4,{"route-data":vt.value,active:Te.value,profile:O.value,"onUpdate:profile":p[3]||(p[3]=y=>O.value=y),onCancel:Sc},null,8,["route-data","active","profile"]),Be(r5,{parkingType:Z.value,"onUpdate:parkingType":p[4]||(p[4]=y=>Z.value=y),degreeOfFriendliness:ie.value,"onUpdate:degreeOfFriendliness":p[5]||(p[5]=y=>ie.value=y),parkingPriceType:Oe.value,"onUpdate:parkingPriceType":p[6]||(p[6]=y=>Oe.value=y),priceRangeMin:be.value,"onUpdate:priceRangeMin":p[7]||(p[7]=y=>be.value=y),priceRangeMax:_.value,"onUpdate:priceRangeMax":p[8]||(p[8]=y=>_.value=y),mapStyle:m.value,"onUpdate:mapStyle":p[9]||(p[9]=y=>m.value=y),active:me.value,"onUpdate:active":p[10]||(p[10]=y=>me.value=y),onlyFavorites:Ee.value,"onUpdate:onlyFavorites":p[11]||(p[11]=y=>Ee.value=y),showOfficial:T.value,"onUpdate:showOfficial":p[12]||(p[12]=y=>T.value=y),showOverridden:w.value,"onUpdate:showOverridden":p[13]||(p[13]=y=>w.value=y),showCommunity:le.value,"onUpdate:showCommunity":p[14]||(p[14]=y=>le.value=y),"favorites-count":L(Ne).length,"official-count":rc.value,"overridden-count":lc.value,"community-count":ac.value,onOpenSupport:R},null,8,["parkingType","degreeOfFriendliness","parkingPriceType","priceRangeMin","priceRangeMax","mapStyle","active","onlyFavorites","showOfficial","showOverridden","showCommunity","favorites-count","official-count","overridden-count","community-count"]),Ke(Be(V5,{info:ee.value,active:re.value,"is-mobile":L(t),"is-apple":L(o),"is-android":L(i),"has-route":_t.value!==null,"is-favorite":zs.value,"is-community":qo.value,"community-meta":qo.value?ze.value:null,"is-overridden":!qo.value&&!!to.value,"override-meta":to.value,onClose:p[15]||(p[15]=y=>re.value=!1),onRoute:p[16]||(p[16]=y=>wc(ee.value.geometry)),onOpenMap:Ic,onToggleFavorite:Uc,onEditCommunity:pc,onEditOverride:fc,onShare:kc},null,8,["info","active","is-mobile","is-apple","is-android","has-route","is-favorite","is-community","community-meta","is-overridden","override-meta"]),[[wt,!Te.value]]),Be(Cn,{modelValue:U.value,"onUpdate:modelValue":p[17]||(p[17]=y=>U.value=y),title:"地圖怎麼看?","close-text":"知道了",size:"lg"},{default:$e(()=>[Km,c("div",Qm,[c("div",Xm,[c("img",{src:L(J)("icon-3.png"),alt:""},null,8,Ym),k(" 汽車：汽車格(含未確認是否有重機格) ")]),c("div",qm,[c("img",{src:L(J)("icon-8.png"),alt:""},null,8,Jm),k(" 重機(有人):有設重機專用格 ")]),c("div",$m,[c("img",{src:L(J)("icon-10.png"),alt:""},null,8,Zm),k(" 機車(沒人):機車格 ")]),c("div",ep,[c("img",{src:L(J)("icon-14.png"),alt:""},null,8,np),k(" 綠星:路邊友善車格 ")]),c("div",tp,[c("img",{src:L(J)("icon-4.png"),alt:""},null,8,op),k(" 重機友善店家:用餐/消費時可停重機的店家 ")]),c("div",ip,[c("img",{src:L(J)("icon-15.png"),alt:""},null,8,sp),k(" 綠P:重機專用路邊停車格 ")]),c("div",rp,[c("img",{src:L(J)("icon-16.png"),alt:""},null,8,lp),k(" 灰P:重機專用路邊停車格(未確認精準座標,歡迎回報) ")]),c("div",ap,[c("img",{src:L(J)("icon-17.png"),alt:""},null,8,cp),k(" 藍P:普通大型共用機車格(台北市試辦) ")]),c("div",dp,[c("img",{src:L(J)("icon-18.png"),alt:""},null,8,hp),k(" 紫P:時段性汽機車共用停車格 ")]),c("div",up,[c("img",{src:L(J)("icon-19.png"),alt:""},null,8,mp),k(" 紅X:停都不給停 ")]),c("div",pp,[c("img",{src:L(J)("icon-20.png"),alt:""},null,8,fp),k(" ?:類型未確認,歡迎透過共筆回報 ")])]),yp,c("div",bp,[c("div",gp,[c("img",{src:L(J)("icon-2.png"),alt:""},null,8,Ap),c("img",{src:L(J)("icon-6.png"),alt:""},null,8,_p),c("img",{src:L(J)("icon-9.png"),alt:""},null,8,vp),k(" 綠色最友善:有後牌辨析 ")]),c("div",Pp,[c("img",{src:L(J)("icon-5.png"),alt:""},null,8,Cp),c("img",{src:L(J)("icon-12.png"),alt:""},null,8,Up),c("img",{src:L(J)("icon-11.png"),alt:""},null,8,Ep),k(" 藍色最傳統:悠遊卡 / 按鈕取票 ")]),c("div",Bp,[c("img",{src:L(J)("icon-1.png"),alt:""},null,8,wp),c("img",{src:L(J)("icon-13.png"),alt:""},null,8,Sp),c("img",{src:L(J)("icon-7.png"),alt:""},null,8,Ip),k(" 紅色最靠北:請管理員協助 / 倒退嚕前牌辨析 ")]),c("div",kp,[c("img",{src:L(J)("icon-3.png"),alt:""},null,8,Dp),c("img",{src:L(J)("icon-8.png"),alt:""},null,8,Tp),c("img",{src:L(J)("icon-10.png"),alt:""},null,8,Np),k(" 灰色未確定:有可能是上述任何情況,停到請回報 ")])]),Mp,c("div",Rp,[c("div",Op,[c("img",{src:L(J)("icon-3.png"),alt:""},null,8,xp),k(" (30/h)三張里地下停車場 ")]),Lp])]),_:1},8,["modelValue"]),Be(Cn,{modelValue:G.value,"onUpdate:modelValue":p[22]||(p[22]=y=>G.value=y),title:"分享給朋友",size:"sm"},{default:$e(()=>[c("div",Fp,[c("button",{class:"share-btn",onClick:p[18]||(p[18]=y=>gn("facebook")),"aria-label":"Facebook"},Vp),c("button",{class:"share-btn",onClick:p[19]||(p[19]=y=>gn("line")),"aria-label":"LINE"},Gp),c("button",{class:"share-btn",onClick:p[20]||(p[20]=y=>gn("twitter")),"aria-label":"Twitter"},Xp),c("button",{class:"share-btn",onClick:p[21]||(p[21]=y=>gn("link")),"aria-label":"複製連結"},Jp)])]),_:1},8,["modelValue"]),Be(Cn,{modelValue:Jo.value,"onUpdate:modelValue":p[27]||(p[27]=y=>Jo.value=y),title:`分享：${$o.value}`,size:"sm"},{default:$e(()=>[c("p",$p,S(et.value),1),c("div",Zp,[c("button",{class:"share-btn",onClick:p[23]||(p[23]=y=>gn("facebook",et.value)),"aria-label":"Facebook"},tf),c("button",{class:"share-btn",onClick:p[24]||(p[24]=y=>gn("line",et.value)),"aria-label":"LINE"},rf),c("button",{class:"share-btn",onClick:p[25]||(p[25]=y=>gn("twitter",et.value)),"aria-label":"Twitter"},cf),c("button",{class:"share-btn",onClick:p[26]||(p[26]=y=>gn("link",et.value)),"aria-label":"複製連結"},uf)])]),_:1},8,["modelValue","title"]),Be(Cn,{modelValue:V.value,"onUpdate:modelValue":p[28]||(p[28]=y=>V.value=y),title:"支持「重機能停哪?」","close-text":"關閉",size:"sm"},{default:$e(()=>[mf,c("div",pf,[(v(),P(ye,null,We(C,y=>c("button",{key:y.key,type:"button",class:$(["support-btn",{"is-primary":y.primary}]),onClick:pe=>X(y)},[c("span",yf,S(y.icon),1),c("span",bf,[c("span",gf,[k(S(y.label)+" ",1),y.primary?(v(),P("span",Af,"推薦")):j("",!0)]),c("span",_f,S(y.description),1)]),vf],10,ff)),64))])]),_:1},8,["modelValue"]),Be(Cn,{modelValue:B.value,"onUpdate:modelValue":p[31]||(p[31]=y=>B.value=y),title:"如何加入手機桌面?","close-text":"知道了",size:"lg"},{default:$e(()=>[c("div",Pf,[c("button",{type:"button",role:"tab","aria-selected":D.value==="ios",class:$(["os-tab",{"is-active":D.value==="ios"}]),onClick:p[29]||(p[29]=y=>D.value="ios")},[Uf,k(" iOS ")],10,Cf),c("button",{type:"button",role:"tab","aria-selected":D.value==="android",class:$(["os-tab",{"is-active":D.value==="android"}]),onClick:p[30]||(p[30]=y=>D.value="android")},[Bf,k(" Android ")],10,Ef)]),D.value==="ios"?(v(),P(ye,{key:0},[wf,Sf,If,kf,Df,Tf,Nf,Mf,Rf,Of,xf],64)):(v(),P(ye,{key:1},[Lf,Ff,Hf,zf,Vf,Wf,jf,Gf,Kf],64))]),_:1},8,["modelValue"]),Be(Cn,{modelValue:g.value,"onUpdate:modelValue":p[32]||(p[32]=y=>g.value=y),title:"嗨！歡迎使用 重機能停哪?","close-text":"開始使用"},{footer:$e(()=>[c("button",{class:"btn btn-primary",onClick:qe},"開始使用")]),default:$e(()=>[Qf,Xf,Yf,qf,Jf,$f,Zf,c("div",{class:"welcome-support-wrap"},[c("button",{type:"button",class:"btn btn-coffee btn-sm",onClick:R}," ❤️ 贊助支持，讓我有動力繼續更新 ")]),e6]),_:1},8,["modelValue"]),Be(bm,{open:Je.value,"onUpdate:open":p[33]||(p[33]=y=>Je.value=y),mode:yn.value,initial:bn.value,"default-coord":gt.value,nickname:L(He),"is-owner":!0,"is-admin":L(ke),submitting:dn.value,"has-existing-override":xs.value,history:cc.value,"onUpdate:nickname":p[34]||(p[34]=y=>He.value=y),onSubmit:p[35]||(p[35]=y=>yn.value==="override"?gc(y):_c(y)),onDelete:vc,onReset:Ac},null,8,["open","mode","initial","default-coord","nickname","is-admin","submitting","has-existing-override","history"]),ln.value?(v(),P("div",n6,o6)):j("",!0),ln.value?(v(),P("div",i6,[s6,c("div",{class:"pick-banner-actions"},[c("button",{class:"btn btn-outline btn-sm",onClick:uc},"取消"),c("button",{class:"btn btn-primary btn-sm",onClick:hc},[r6,k(" 使用此位置 ")])])])):j("",!0),Be(Cn,{modelValue:N.value,"onUpdate:modelValue":p[36]||(p[36]=y=>N.value=y),title:"共筆停車點說明","close-text":"我知道了",size:"lg"},{default:$e(()=>[l6,a6,c6,d6,h6,u6,m6]),_:1},8,["modelValue"]),Be(Sm,{active:Ce.value,"onUpdate:active":p[37]||(p[37]=y=>Ce.value=y),steps:ce,onFinish:Ue},null,8,["active"])],64))}},y6=rn(f6,[["__scopeId","data-v-19f2d019"]]);Rc(y6).mount("#app");"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./serviceWorker.js").catch(()=>{})});
